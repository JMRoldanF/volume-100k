      ******************************************************************
      * ZCN012DC - CANCELLATION HANDLING                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCN012DC'.
      ...
      * Called module names
       01  MOD-ZCN01UM6              PIC X(8) VALUE 'ZCN01UM6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCN01UM6-001.
               CALL 'ZCN01UM6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCN01UM6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-POSTCODE-0001.
