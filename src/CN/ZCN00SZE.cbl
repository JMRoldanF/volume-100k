      ******************************************************************
      * ZCN00SZE - CANCELLATION HANDLING                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCN00SZE'.
      ...
      * Called module names
       01  MOD-ZCN01M9G              PIC X(8) VALUE 'ZCN01M9G'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCN01M9G-001.
               CALL 'ZCN01M9G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCN01M9G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZED01NKM-002.
