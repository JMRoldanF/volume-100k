      ******************************************************************
      * ZCN00WW5 - CANCELLATION HANDLING                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCN00WW5'.
      ...
      * Called module names
       ...
       01  MOD-ZED01J91              PIC X(8) VALUE 'ZED01J91'.
      ...
      *----------------------------------------------------------------*
       CALL-ZED01J91-002.
               CALL 'ZED01J91' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZED01J91 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
