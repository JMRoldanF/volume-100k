      ******************************************************************
      * ZCN00X0B - CANCELLATION HANDLING                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCN00X0B'.
      ...
      * Called module names
       01  MOD-ZCN01O16              PIC X(8) VALUE 'ZCN01O16'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCN01O16-002.
               CALL 'ZCN01O16' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCN01O16 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-COLOUR-0001.
