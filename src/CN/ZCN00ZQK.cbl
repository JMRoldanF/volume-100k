      ******************************************************************
      * ZCN00ZQK - CANCELLATION HANDLING                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCN00ZQK'.
      ...
      * Called module names
       01  MOD-ZCN01U65              PIC X(8) VALUE 'ZCN01U65'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCN01U65-001.
               CALL 'ZCN01U65' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCN01U65 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCN01FAM-002.
