      ******************************************************************
      * ZCN00RWP - CANCELLATION HANDLING                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCN00RWP'.
      ...
      * Called module names
       01  MOD-ZCN01MV8              PIC X(8) VALUE 'ZCN01MV8'.
       01  MOD-ZCN01K2S              PIC X(8) VALUE 'ZCN01K2S'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCN01MV8-001.
               PERFORM CALL-ZCN01K2S-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCN01MV8-001.
               CALL 'ZCN01MV8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCN01MV8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCN01K2S-002.
               CALL 'ZCN01K2S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCN01K2S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
