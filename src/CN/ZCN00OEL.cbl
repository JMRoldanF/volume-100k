      ******************************************************************
      * ZCN00OEL - CANCELLATION HANDLING                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCN00OEL'.
      ...
      * Called module names
       ...
       01  MOD-ZCN01TCU              PIC X(8) VALUE 'ZCN01TCU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCN01PZO-001.
               PERFORM CALL-ZCN01TCU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCN01TCU-002.
               CALL 'ZCN01TCU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCN01TCU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-COLOUR-0001.
