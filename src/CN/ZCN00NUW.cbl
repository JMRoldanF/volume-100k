      ******************************************************************
      * ZCN00NUW - CANCELLATION HANDLING                               *
      ******************************************************************
      *
      *  Generated volume-test source. Layer 2,
      *  type data_db2, domain CANCEL.
      ******************************************************************
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCN00NUW'.
      ...
      * Called module names
       01  MOD-ZCN01UMH              PIC X(8) VALUE 'ZCN01UMH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCN01UMH-001.
               CALL 'ZCN01UMH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCN01UMH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       ...
       SQL-ACCESS-0012.
               EXEC SQL
                     ...
                     SELECT POLICYNUMBER, PAYMENT
                       FROM GENACN.RESERVE A
                       JOIN GENACN.CUSTOMER B
