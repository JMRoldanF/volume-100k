      ******************************************************************
      * ZCN0129R - CANCELLATION HANDLING                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCN0129R'.
      ...
      * Called module names
       01  MOD-ZCN01IDD              PIC X(8) VALUE 'ZCN01IDD'.
       01  MOD-ZCN01NS4              PIC X(8) VALUE 'ZCN01NS4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCN01IDD-001.
               PERFORM CALL-ZCN01NS4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCN01IDD-001.
               CALL 'ZCN01IDD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCN01IDD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCN01NS4-002.
               CALL 'ZCN01NS4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCN01NS4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
