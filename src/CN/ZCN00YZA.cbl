      ******************************************************************
      * ZCN00YZA - CANCELLATION HANDLING                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCN00YZA'.
      ...
      * Called module names
       ...
       01  MOD-ZCN01JFV              PIC X(8) VALUE 'ZCN01JFV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCN01NF9-001.
               PERFORM CALL-ZCN01JFV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCN01JFV-002.
               CALL 'ZCN01JFV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCN01JFV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
