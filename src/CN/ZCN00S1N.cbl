      ******************************************************************
      * ZCN00S1N - CANCELLATION HANDLING                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCN00S1N'.
      ...
      * Called module names
       01  MOD-ZCN01N9S              PIC X(8) VALUE 'ZCN01N9S'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCN01N9S-001.
               PERFORM CALL-ZAV01GTR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCN01N9S-001.
               CALL 'ZCN01N9S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCN01N9S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAV01GTR-002.
               MOVE 'ZAV01GTR' TO WS-SUBNAME-8
