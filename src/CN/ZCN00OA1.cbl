      ******************************************************************
      * ZCN00OA1 - CANCELLATION HANDLING                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCN00OA1'.
      ...
      * Called module names
       01  MOD-ZCN01ITY              PIC X(8) VALUE 'ZCN01ITY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCN01ITY-001.
               CALL 'ZCN01ITY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCN01ITY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
