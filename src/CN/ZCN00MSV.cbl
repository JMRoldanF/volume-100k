      ******************************************************************
      * ZCN00MSV - CANCELLATION HANDLING                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCN00MSV'.
      ...
      * Called module names
       01  MOD-ZCN01GQ1              PIC X(8) VALUE 'ZCN01GQ1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCN01GQ1-001.
               CALL 'ZCN01GQ1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCN01GQ1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
