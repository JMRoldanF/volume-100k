      ******************************************************************
      * ZCN015CM - CANCELLATION HANDLING                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCN015CM'.
      ...
      * Called module names
       01  MOD-ZCN01FCW              PIC X(8) VALUE 'ZCN01FCW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCN01FCW-001.
               PERFORM CALL-ZEN0255N-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCN01FCW-001.
               CALL 'ZCN01FCW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
