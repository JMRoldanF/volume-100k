      ******************************************************************
      * ZCN00PDT - CANCELLATION HANDLING                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCN00PDT'.
      ...
      * Called module names
       01  MOD-ZEN01RTE              PIC X(8) VALUE 'ZEN01RTE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01RTE-001.
               CALL 'ZEN01RTE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01RTE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
