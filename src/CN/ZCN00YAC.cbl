      ******************************************************************
      * ZCN00YAC - CANCELLATION HANDLING                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCN00YAC'.
      ...
      * Called module names
       ...
       01  MOD-ZCN01MW3              PIC X(8) VALUE 'ZCN01MW3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCN01MW3-002.
               CALL 'ZCN01MW3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
