      ******************************************************************
      * ZCN00Z6X - CANCELLATION HANDLING                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCN00Z6X'.
      ...
      * Called module names
       01  MOD-ZCN01GYU              PIC X(8) VALUE 'ZCN01GYU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCN01GYU-001.
               CALL 'ZCN01GYU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCN01GYU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
