      ******************************************************************
      * ZCN00XZH - CANCELLATION HANDLING                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCN00XZH'.
      ...
      * Called module names
       01  MOD-ZAV01NJY              PIC X(8) VALUE 'ZAV01NJY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01NJY-001.
               CALL 'ZAV01NJY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01NJY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
