      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00VVL'.
      ...
      * Called module names
       01  MOD-ZEN01RMD              PIC X(8) VALUE 'ZEN01RMD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01RMD-001.
               PERFORM CALL-ZEN01OET-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01RMD-001.
               CALL 'ZEN01RMD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01RMD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01OET-002.
