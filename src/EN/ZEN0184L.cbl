      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN0184L'.
      ...
      * Called module names
       01  MOD-ZEN01HQO              PIC X(8) VALUE 'ZEN01HQO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01GHU-001.
               PERFORM CALL-ZEN01HQO-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01HQO-002.
               CALL 'ZEN01HQO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01HQO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-EXCESS-0001.
