      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00ZMV'.
      ...
      * Called module names
       01  MOD-ZEN01QLZ              PIC X(8) VALUE 'ZEN01QLZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01QLZ-001.
               CALL 'ZEN01QLZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01QLZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
