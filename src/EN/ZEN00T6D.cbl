      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00T6D'.
      ...
      * Called module names
       01  MOD-ZEN01DJP              PIC X(8) VALUE 'ZEN01DJP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01DJP-001.
               CALL 'ZEN01DJP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01DJP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
