      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00MO7'.
      ...
      * Called module names
       01  MOD-ZEN01IJF              PIC X(8) VALUE 'ZEN01IJF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01IJF-001.
               PERFORM CALL-ZEN01FOX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01IJF-001.
               CALL 'ZEN01IJF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
