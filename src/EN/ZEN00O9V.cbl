      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00O9V'.
      ...
      * Called module names
       01  MOD-ZEN01H8P              PIC X(8) VALUE 'ZEN01H8P'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01H8P-001.
               CALL 'ZEN01H8P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01H8P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01QLX-002.
