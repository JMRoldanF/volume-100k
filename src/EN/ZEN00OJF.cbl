      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00OJF'.
      ...
      * Called module names
       01  MOD-ZEN01KFR              PIC X(8) VALUE 'ZEN01KFR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01KFR-001.
               CALL 'ZEN01KFR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01KFR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-EXCESS-0001.
