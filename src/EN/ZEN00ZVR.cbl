      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00ZVR'.
      ...
      * Called module names
       01  MOD-ZEN01RL9              PIC X(8) VALUE 'ZEN01RL9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01RL9-001.
               CALL 'ZEN01RL9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01RL9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
