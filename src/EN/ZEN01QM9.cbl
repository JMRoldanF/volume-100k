      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN01QM9'.
      ...
      * Called module names
       01  MOD-ZEN01F61              PIC X(8) VALUE 'ZEN01F61'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01F61-001.
               CALL 'ZEN01F61' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01F61 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
