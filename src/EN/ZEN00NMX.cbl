      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00NMX'.
      ...
      * Called module names
       01  MOD-ZEN01PGB              PIC X(8) VALUE 'ZEN01PGB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01PGB-001.
               CALL 'ZEN01PGB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01PGB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
