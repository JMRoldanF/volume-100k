      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN015ED'.
      ...
      * Called module names
       01  MOD-ZEN01HE1              PIC X(8) VALUE 'ZEN01HE1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01HE1-001.
               PERFORM CALL-ZEN01KCZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01HE1-001.
               CALL 'ZEN01HE1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01HE1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01KCZ-002.
