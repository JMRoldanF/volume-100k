      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00XPZ'.
      ...
      * Called module names
       01  MOD-ZEN01DH7              PIC X(8) VALUE 'ZEN01DH7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01DH7-001.
               CALL 'ZEN01DH7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01DH7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
