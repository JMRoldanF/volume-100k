      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN010G3'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01KBG              PIC X(8) VALUE 'ZEN01KBG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01KBG-002.
               CALL 'ZEN01KBG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01KBG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
