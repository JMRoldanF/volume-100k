      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00MVN'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01HA0              PIC X(8) VALUE 'ZEN01HA0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01O74-001.
               PERFORM CALL-ZEN01HA0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01HA0-002.
               CALL 'ZEN01HA0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01HA0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
