      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN0115V'.
      ...
      * Called module names
       01  MOD-ZCU01JKO              PIC X(8) VALUE 'ZCU01JKO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01JKO-001.
               CALL 'ZCU01JKO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01JKO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
