      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00OOM'.
      ...
      * Called module names
       01  MOD-ZEN01EIO              PIC X(8) VALUE 'ZEN01EIO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01EIO-001.
               CALL 'ZEN01EIO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01EIO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
