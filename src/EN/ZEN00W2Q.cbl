      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00W2Q'.
      ...
      * Called module names
       01  MOD-ZEN01QM9              PIC X(8) VALUE 'ZEN01QM9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01QM9-001.
               CALL 'ZEN01QM9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01QM9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
