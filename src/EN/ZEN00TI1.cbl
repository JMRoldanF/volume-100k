      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00TI1'.
      ...
      * Called module names
       01  MOD-ZEN01MUP              PIC X(8) VALUE 'ZEN01MUP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01MUP-001.
               PERFORM CALL-ZEN01MHD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01MUP-001.
               CALL 'ZEN01MUP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01MUP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01MHD-002.
               MOVE 'ZEN01MHD' TO WS-SUBNAME-3
