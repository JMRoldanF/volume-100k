      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00V0S'.
      ...
      * Called module names
       01  MOD-ZEN01GSZ              PIC X(8) VALUE 'ZEN01GSZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01GSZ-001.
               CALL 'ZEN01GSZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01GSZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTR01GWF-002.
               MOVE 'ZTR01GWF' TO WS-SUBNAME-3
