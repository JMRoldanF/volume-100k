      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00VOX'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01QFL              PIC X(8) VALUE 'ZEN01QFL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01OXZ-001.
               PERFORM CALL-ZEN01QFL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01QFL-002.
               CALL 'ZEN01QFL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01QFL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
