      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00MNA'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01OSW              PIC X(8) VALUE 'ZEN01OSW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01OSW-002.
               CALL 'ZEN01OSW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01OSW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
