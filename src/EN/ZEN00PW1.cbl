      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00PW1'.
      ...
      * Called module names
       01  MOD-ZEN01NIV              PIC X(8) VALUE 'ZEN01NIV'.
       01  MOD-ZEN01ROB              PIC X(8) VALUE 'ZEN01ROB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01NIV-001.
               PERFORM CALL-ZEN01ROB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01NIV-001.
               CALL 'ZEN01NIV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01NIV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01ROB-002.
               CALL 'ZEN01ROB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01ROB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
