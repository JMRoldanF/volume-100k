      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN018XA'.
      ...
      * Called module names
       01  MOD-ZTR01PKW              PIC X(8) VALUE 'ZTR01PKW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01PKW-002.
               CALL 'ZTR01PKW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01PKW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
