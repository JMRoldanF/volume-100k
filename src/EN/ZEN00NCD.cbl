      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00NCD'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01EZD              PIC X(8) VALUE 'ZEN01EZD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01EZD-002.
               CALL 'ZEN01EZD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01EZD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
