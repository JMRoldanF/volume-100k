      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN016OR'.
      ...
      * Called module names
       01  MOD-ZEN01TWV              PIC X(8) VALUE 'ZEN01TWV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01TWV-001.
               CALL 'ZEN01TWV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01TWV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
