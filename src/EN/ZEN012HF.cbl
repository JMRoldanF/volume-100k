      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN012HF'.
      ...
      * Called module names
       01  MOD-ZEN01J9F              PIC X(8) VALUE 'ZEN01J9F'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01J9F-001.
               CALL 'ZEN01J9F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01J9F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
