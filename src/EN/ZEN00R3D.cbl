      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00R3D'.
      ...
      * Called module names
       01  MOD-ZEN01FT3              PIC X(8) VALUE 'ZEN01FT3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01FT3-001.
               CALL 'ZEN01FT3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01FT3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
