      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00YEZ'.
      ...
      * Called module names
       01  MOD-ZEN01D6N              PIC X(8) VALUE 'ZEN01D6N'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01D6N-001.
               PERFORM CALL-ZEN01E7B-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01D6N-001.
               CALL 'ZEN01D6N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01D6N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01E7B-002.
