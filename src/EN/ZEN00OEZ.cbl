      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00OEZ'.
      ...
      * Called module names
       01  MOD-ZHO01L0A              PIC X(8) VALUE 'ZHO01L0A'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01L0A-001.
               PERFORM CALL-ZCL01L0N-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01L0A-001.
               CALL 'ZHO01L0A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01L0A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01L0N-002.
