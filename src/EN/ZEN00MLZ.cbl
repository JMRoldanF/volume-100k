      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00MLZ'.
      ...
      * Called module names
       01  MOD-ZEN01UCZ              PIC X(8) VALUE 'ZEN01UCZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01UCZ-001.
               CALL 'ZEN01UCZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01UCZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
