      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00QBK'.
      ...
      * Called module names
       01  MOD-ZAV01QYQ              PIC X(8) VALUE 'ZAV01QYQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01QYQ-001.
               CALL 'ZAV01QYQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01QYQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-TERM-0001.
