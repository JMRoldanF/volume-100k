      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00QKH'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01HA5              PIC X(8) VALUE 'ZEN01HA5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01HA5-002.
               CALL 'ZEN01HA5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
