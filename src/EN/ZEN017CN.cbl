      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN017CN'.
      ...
      * Called module names
       01  MOD-ZEN01V0L              PIC X(8) VALUE 'ZEN01V0L'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01V0L-001.
               CALL 'ZEN01V0L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01V0L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
