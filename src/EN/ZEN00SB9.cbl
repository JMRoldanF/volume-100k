      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00SB9'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01FG1              PIC X(8) VALUE 'ZEN01FG1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01FG1-002.
               CALL 'ZEN01FG1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01FG1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
