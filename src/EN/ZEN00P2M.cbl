      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00P2M'.
      ...
      * Called module names
       01  MOD-ZLB01D2J              PIC X(8) VALUE 'ZLB01D2J'.
       01  MOD-ZLB01PAM              PIC X(8) VALUE 'ZLB01PAM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLB01D2J-001.
               PERFORM CALL-ZLB01PAM-002.
               PERFORM NORMALISE-SUM-ASSURED-0001.
               PERFORM RESOLVE-WITH-PROFITS-0002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZLB01D2J-001.
               CALL 'ZLB01D2J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01D2J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLB01PAM-002.
               CALL 'ZLB01PAM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01PAM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
