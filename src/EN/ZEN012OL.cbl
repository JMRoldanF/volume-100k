      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN012OL'.
      ...
      * Called module names
       01  MOD-ZEN01SQ3              PIC X(8) VALUE 'ZEN01SQ3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01SQ3-001.
               CALL 'ZEN01SQ3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01SQ3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-COLOUR-0001.
