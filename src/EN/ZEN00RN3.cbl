      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00RN3'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01N2R              PIC X(8) VALUE 'ZEN01N2R'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01DBX-001.
               PERFORM CALL-ZEN01N2R-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01N2R-002.
               CALL 'ZEN01N2R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01N2R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
