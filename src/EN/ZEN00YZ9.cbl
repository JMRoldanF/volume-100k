      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00YZ9'.
      ...
      * Called module names
       01  MOD-ZEN01PZH              PIC X(8) VALUE 'ZEN01PZH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01PZH-001.
               CALL 'ZEN01PZH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01PZH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
