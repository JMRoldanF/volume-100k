      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00NJB'.
      ...
      * Called module names
       01  MOD-ZEN01PJX              PIC X(8) VALUE 'ZEN01PJX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01PJX-001.
               CALL 'ZEN01PJX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01PJX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01MHD-002.
