      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN014OT'.
      ...
      * Called module names
       01  MOD-ZEN01LMT              PIC X(8) VALUE 'ZEN01LMT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01LMT-001.
               CALL 'ZEN01LMT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01LMT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
