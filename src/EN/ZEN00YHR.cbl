      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00YHR'.
      ...
      * Called module names
       01  MOD-ZEN01EJ9              PIC X(8) VALUE 'ZEN01EJ9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01EJ9-001.
               CALL 'ZEN01EJ9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01EJ9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
