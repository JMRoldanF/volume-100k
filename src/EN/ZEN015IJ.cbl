      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN015IJ'.
      ...
      * Called module names
       01  MOD-ZEN01G29              PIC X(8) VALUE 'ZEN01G29'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01G29-001.
               CALL 'ZEN01G29' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01G29 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
