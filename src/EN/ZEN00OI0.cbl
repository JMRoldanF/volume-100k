      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00OI0'.
      ...
      * Called module names
       01  MOD-ZTR01PGU              PIC X(8) VALUE 'ZTR01PGU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01PGU-001.
               CALL 'ZTR01PGU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01PGU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
