      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00WTH'.
      ...
      * Called module names
       01  MOD-ZEN01JH1              PIC X(8) VALUE 'ZEN01JH1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01JH1-001.
               CALL 'ZEN01JH1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01JH1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
