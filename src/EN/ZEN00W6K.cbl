      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00W6K'.
      ...
      * Called module names
       01  MOD-ZAV01KZ5              PIC X(8) VALUE 'ZAV01KZ5'.
       01  MOD-ZEN01CTY              PIC X(8) VALUE 'ZEN01CTY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01KZ5-001.
               CALL 'ZAV01KZ5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01KZ5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01CTY-002.
               CALL 'ZEN01CTY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01CTY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
