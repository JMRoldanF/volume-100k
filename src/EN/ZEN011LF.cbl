      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN011LF'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01N13              PIC X(8) VALUE 'ZEN01N13'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01N13-002.
               CALL 'ZEN01N13' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01N13 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
