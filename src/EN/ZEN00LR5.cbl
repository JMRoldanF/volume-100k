      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00LR5'.
      ...
      * Called module names
       01  MOD-ZEN01LZB              PIC X(8) VALUE 'ZEN01LZB'.
       01  MOD-ZEN01G4R              PIC X(8) VALUE 'ZEN01G4R'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01LZB-001.
               PERFORM CALL-ZEN01G4R-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01LZB-001.
               CALL 'ZEN01LZB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01LZB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01G4R-002.
               CALL 'ZEN01G4R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01G4R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
