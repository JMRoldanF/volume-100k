      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00VJD'.
      ...
      * Called module names
       01  MOD-ZUW01UFO              PIC X(8) VALUE 'ZUW01UFO'.
       01  MOD-ZEN01K5H              PIC X(8) VALUE 'ZEN01K5H'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01UFO-001.
               PERFORM CALL-ZEN01K5H-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01UFO-001.
               CALL 'ZUW01UFO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01UFO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01K5H-002.
               CALL 'ZEN01K5H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01K5H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
