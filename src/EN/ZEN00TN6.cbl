      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00TN6'.
      ...
      * Called module names
       01  MOD-ZEN01JFY              PIC X(8) VALUE 'ZEN01JFY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01JFY-001.
               PERFORM CALL-ZEN01RQQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01JFY-001.
               CALL 'ZEN01JFY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01JFY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01RQQ-002.
