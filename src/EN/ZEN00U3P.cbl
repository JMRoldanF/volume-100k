      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00U3P'.
      ...
      * Called module names
       01  MOD-ZUW01JGO              PIC X(8) VALUE 'ZUW01JGO'.
       01  MOD-ZEN01MVJ              PIC X(8) VALUE 'ZEN01MVJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01JGO-001.
               CALL 'ZUW01JGO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01JGO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01MVJ-002.
               CALL 'ZEN01MVJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01MVJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-EXCESS-0001.
