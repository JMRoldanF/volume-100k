      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00B39'.
      ...
      * Called module names
       01  MOD-ZCL0113F              PIC X(8) VALUE 'ZCL0113F'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL0113F-001.
               PERFORM CALL-ZEN00QZ7-002.
               PERFORM CALL-ZEN00ZC1-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL0113F-001.
               EXEC CICS LINK PROGRAM('ZCL0113F')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL0113F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN00QZ7-002.
               MOVE 'ZEN00QZ7' TO WS-PROGNAME-6
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN00QZ7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN00ZC1-003.
               MOVE 'ZEN00ZC1' TO WS-PROGNAME-7
