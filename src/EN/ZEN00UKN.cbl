      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00UKN'.
      ...
      * Called module names
       01  MOD-ZEN01SDL              PIC X(8) VALUE 'ZEN01SDL'.
       01  MOD-ZHO01UF6              PIC X(8) VALUE 'ZHO01UF6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01SDL-001.
               PERFORM CALL-ZHO01UF6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01SDL-001.
               CALL 'ZEN01SDL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01SDL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01UF6-002.
               CALL 'ZHO01UF6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01UF6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
