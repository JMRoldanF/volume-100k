      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00UY7'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01IIS              PIC X(8) VALUE 'ZEN01IIS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTR01KFM-001.
               PERFORM CALL-ZEN01IIS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01IIS-002.
               CALL 'ZEN01IIS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01IIS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
