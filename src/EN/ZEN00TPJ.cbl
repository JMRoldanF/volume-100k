      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00TPJ'.
      ...
      * Called module names
       01  MOD-ZEN01DSV              PIC X(8) VALUE 'ZEN01DSV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01DSV-001.
               CALL 'ZEN01DSV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01DSV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-VALUE-0001.
