      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00LT6'.
      ...
      * Called module names
       01  MOD-ZEN01RX8              PIC X(8) VALUE 'ZEN01RX8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01RX8-001.
               CALL 'ZEN01RX8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01RX8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
