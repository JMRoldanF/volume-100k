      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00TA9'.
      ...
      * Called module names
       01  MOD-ZEN01PW5              PIC X(8) VALUE 'ZEN01PW5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01PW5-001.
               CALL 'ZEN01PW5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01PW5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01CUF-002.
