      ...
      * Called module names
       ...
       01  MOD-ZEN01EMV              PIC X(8) VALUE 'ZEN01EMV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01L8D-001.
               PERFORM CALL-ZEN01EMV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01EMV-002.
               CALL 'ZEN01EMV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01EMV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
