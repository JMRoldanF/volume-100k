      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00UBH'.
      ...
      * Called module names
       01  MOD-ZRE01QRX              PIC X(8) VALUE 'ZRE01QRX'.
       01  MOD-ZEN01L8D              PIC X(8) VALUE 'ZEN01L8D'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01QRX-001.
               PERFORM CALL-ZEN01L8D-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01QRX-001.
               CALL 'ZRE01QRX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01QRX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01L8D-002.
               CALL 'ZEN01L8D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01L8D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
