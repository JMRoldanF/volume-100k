      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00LVV'.
      ...
      * Called module names
       01  MOD-ZCU01R24              PIC X(8) VALUE 'ZCU01R24'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01R24-001.
               CALL 'ZCU01R24' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01R24 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-MODEL-0001.
