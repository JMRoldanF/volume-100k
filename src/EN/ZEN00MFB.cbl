      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00MFB'.
      ...
      * Called module names
       01  MOD-ZEN01SO5              PIC X(8) VALUE 'ZEN01SO5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01SO5-001.
               PERFORM CALL-ZEN01PSJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01SO5-001.
               CALL 'ZEN01SO5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01SO5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01PSJ-002.
