      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00P7C'.
      ...
      * Called module names
       01  MOD-ZEN01H9K              PIC X(8) VALUE 'ZEN01H9K'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01H9K-001.
               CALL 'ZEN01H9K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01H9K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
