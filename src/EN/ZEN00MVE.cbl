      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00MVE'.
      ...
      * Called module names
       01  MOD-ZEN01TVT              PIC X(8) VALUE 'ZEN01TVT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01TVT-001.
               CALL 'ZEN01TVT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01TVT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
