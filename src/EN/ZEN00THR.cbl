      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00THR'.
      ...
      * Called module names
       01  MOD-ZEN01JPD              PIC X(8) VALUE 'ZEN01JPD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01JPD-001.
               PERFORM CALL-ZEN01NYP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01JPD-001.
               CALL 'ZEN01JPD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01JPD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01NYP-002.
