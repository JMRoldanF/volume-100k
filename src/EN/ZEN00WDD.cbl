      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00WDD'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01ITF              PIC X(8) VALUE 'ZEN01ITF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01ITF-002.
               CALL 'ZEN01ITF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01ITF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
