      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00QUE'.
      ...
      * Called module names
       01  MOD-ZEN01IS5              PIC X(8) VALUE 'ZEN01IS5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01IS5-001.
               CALL 'ZEN01IS5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01IS5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
