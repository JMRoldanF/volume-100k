      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00PRV'.
      ...
      * Called module names
       01  MOD-ZCU01SUA              PIC X(8) VALUE 'ZCU01SUA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01SUA-001.
               CALL 'ZCU01SUA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01SUA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
