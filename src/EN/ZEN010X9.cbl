      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN010X9'.
      ...
      * Called module names
       01  MOD-ZCU01LQG              PIC X(8) VALUE 'ZCU01LQG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01LQG-002.
               CALL 'ZCU01LQG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01LQG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
