      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00O26'.
      ...
      * Called module names
       01  MOD-ZEN01QH3              PIC X(8) VALUE 'ZEN01QH3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01QH3-001.
               CALL 'ZEN01QH3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01QH3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
