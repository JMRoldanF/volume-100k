      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00MXX'.
      ...
      * Called module names
       01  MOD-ZEN01QIN              PIC X(8) VALUE 'ZEN01QIN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01QIN-001.
               CALL 'ZEN01QIN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01QIN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
