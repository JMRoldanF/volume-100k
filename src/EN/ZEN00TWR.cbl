      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00TWR'.
      ...
      * Called module names
       01  MOD-ZEN01FJ3              PIC X(8) VALUE 'ZEN01FJ3'.
       01  MOD-ZEN01UM5              PIC X(8) VALUE 'ZEN01UM5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01FJ3-001.
               PERFORM CALL-ZEN01UM5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01FJ3-001.
               CALL 'ZEN01FJ3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01FJ3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01UM5-002.
               CALL 'ZEN01UM5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01UM5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
