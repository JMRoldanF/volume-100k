      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00WIX'.
      ...
      * Called module names
       01  MOD-ZEN01M4B              PIC X(8) VALUE 'ZEN01M4B'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01M4B-001.
               CALL 'ZEN01M4B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01M4B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-MODEL-0001.
