      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00U80'.
      ...
      * Called module names
       01  MOD-ZEN01DOP              PIC X(8) VALUE 'ZEN01DOP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01DOP-001.
               CALL 'ZEN01DOP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01DOP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
