      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN005UD'.
      ...
      * Called module names
       ...
       01  MOD-ZEN00LGL              PIC X(8) VALUE 'ZEN00LGL'.
       01  MOD-ZEN00B4D              PIC X(8) VALUE 'ZEN00B4D'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN00ETF-001.
               PERFORM CALL-ZEN00LGL-002.
               PERFORM CALL-ZEN00B4D-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN00LGL-002.
               EXEC CICS LINK PROGRAM('ZEN00LGL')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN00LGL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN00B4D-003.
               EXEC CICS LINK PROGRAM('ZEN00B4D')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN00B4D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-004.
