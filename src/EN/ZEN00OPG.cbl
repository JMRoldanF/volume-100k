      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00OPG'.
      ...
      * Called module names
       01  MOD-ZEN01Q7M              PIC X(8) VALUE 'ZEN01Q7M'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01Q7M-001.
               PERFORM CALL-ZAV01RFJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01Q7M-001.
               CALL 'ZEN01Q7M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01Q7M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAV01RFJ-002.
