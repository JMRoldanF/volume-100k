      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00UNM'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01UKM              PIC X(8) VALUE 'ZEN01UKM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01ED8-001.
               PERFORM CALL-ZEN01UKM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01UKM-002.
               CALL 'ZEN01UKM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01UKM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
