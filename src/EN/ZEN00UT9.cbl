      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00UT9'.
      ...
      * Called module names
       01  MOD-ZEN01FF7              PIC X(8) VALUE 'ZEN01FF7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01FF7-001.
               PERFORM CALL-ZEN01SYZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01FF7-001.
               CALL 'ZEN01FF7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01FF7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01SYZ-002.
