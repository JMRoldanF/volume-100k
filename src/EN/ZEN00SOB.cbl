      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00SOB'.
      ...
      * Called module names
       01  MOD-ZEN01QSN              PIC X(8) VALUE 'ZEN01QSN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01QSN-001.
               CALL 'ZEN01QSN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01QSN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
