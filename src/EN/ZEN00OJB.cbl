      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00OJB'.
      ...
      * Called module names
       01  MOD-ZEN01I6M              PIC X(8) VALUE 'ZEN01I6M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01I6M-001.
               CALL 'ZEN01I6M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01I6M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
