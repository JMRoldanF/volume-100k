      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00N23'.
      ...
      * Called module names
       01  MOD-ZEN01OWV              PIC X(8) VALUE 'ZEN01OWV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01OWV-001.
               PERFORM CALL-ZEN01T85-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01OWV-001.
               CALL 'ZEN01OWV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01OWV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01T85-002.
