      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN011P1'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01DTF              PIC X(8) VALUE 'ZEN01DTF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01EY9-001.
               PERFORM CALL-ZEN01DTF-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01DTF-002.
               CALL 'ZEN01DTF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
