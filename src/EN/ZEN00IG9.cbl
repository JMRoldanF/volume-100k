      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00IG9'.
      ...
      * Called module names
       ...
       01  MOD-ZEN00RQZ              PIC X(8) VALUE 'ZEN00RQZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN00RQZ-002.
               EXEC CICS LINK PROGRAM('ZEN00RQZ')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN00RQZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
