      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00NXH'.
      ...
      * Called module names
       01  MOD-ZEN01DIV              PIC X(8) VALUE 'ZEN01DIV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01DIV-001.
               CALL 'ZEN01DIV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01DIV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
