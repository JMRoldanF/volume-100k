      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00QJD'.
      ...
      * Called module names
       01  MOD-ZEN01QT7              PIC X(8) VALUE 'ZEN01QT7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01QT7-001.
               CALL 'ZEN01QT7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01QT7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01J3A-002.
