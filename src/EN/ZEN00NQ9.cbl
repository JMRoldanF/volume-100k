      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00NQ9'.
      ...
      * Called module names
       01  MOD-ZEN01KH5              PIC X(8) VALUE 'ZEN01KH5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01KH5-001.
               PERFORM CALL-ZEN01LV5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01KH5-001.
               CALL 'ZEN01KH5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01KH5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01LV5-002.
