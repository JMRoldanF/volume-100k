      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00YLD'.
      ...
      * Called module names
       01  MOD-ZEN01LER              PIC X(8) VALUE 'ZEN01LER'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01LER-001.
               CALL 'ZEN01LER' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01LER FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
