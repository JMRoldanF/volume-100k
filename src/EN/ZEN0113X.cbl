      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN0113X'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01HFT              PIC X(8) VALUE 'ZRE01HFT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01RIR-001.
               PERFORM CALL-ZRE01HFT-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01HFT-002.
               CALL 'ZRE01HFT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01HFT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
