      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00YNB'.
      ...
      * Called module names
       01  MOD-ZEN01KYN              PIC X(8) VALUE 'ZEN01KYN'.
       01  MOD-ZEN01T7B              PIC X(8) VALUE 'ZEN01T7B'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01KYN-001.
               PERFORM CALL-ZEN01T7B-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01KYN-001.
               CALL 'ZEN01KYN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01KYN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01T7B-002.
               CALL 'ZEN01T7B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01T7B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
