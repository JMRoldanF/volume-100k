      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00YK9'.
      ...
      * Called module names
       01  MOD-ZEN01I8L              PIC X(8) VALUE 'ZEN01I8L'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01I8L-001.
               CALL 'ZEN01I8L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01I8L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
