      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00SF8'.
      ...
      * Called module names
       01  MOD-ZEN01T1D              PIC X(8) VALUE 'ZEN01T1D'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01T1D-001.
               PERFORM CALL-ZTR01E2D-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01T1D-001.
               CALL 'ZEN01T1D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01T1D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTR01E2D-002.
