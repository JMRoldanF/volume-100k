      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN01025'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01LY7              PIC X(8) VALUE 'ZEN01LY7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01LY7-002.
               CALL 'ZEN01LY7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01LY7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
