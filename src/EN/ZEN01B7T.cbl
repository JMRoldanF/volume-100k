      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN01B7T'.
      ...
      * Called module names
       01  MOD-ZEN01D7R              PIC X(8) VALUE 'ZEN01D7R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01D7R-001.
               CALL 'ZEN01D7R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01D7R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
