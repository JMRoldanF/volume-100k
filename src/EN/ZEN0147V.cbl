      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN0147V'.
      ...
      * Called module names
       01  MOD-ZCU01I0U              PIC X(8) VALUE 'ZCU01I0U'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01I0U-001.
               CALL 'ZCU01I0U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01I0U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
