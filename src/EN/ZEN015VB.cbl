      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN015VB'.
      ...
      * Called module names
       01  MOD-ZPA01ETZ              PIC X(8) VALUE 'ZPA01ETZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01ETZ-001.
               CALL 'ZPA01ETZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01ETZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-TERM-0001.
