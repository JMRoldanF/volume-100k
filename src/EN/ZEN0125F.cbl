      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN0125F'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01M3H              PIC X(8) VALUE 'ZEN01M3H'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01M3H-002.
               CALL 'ZEN01M3H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
