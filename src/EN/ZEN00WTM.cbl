      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00WTM'.
      ...
      * Called module names
       01  MOD-ZEN01OVX              PIC X(8) VALUE 'ZEN01OVX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01OVX-002.
               CALL 'ZEN01OVX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01OVX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-COLOUR-0001.
