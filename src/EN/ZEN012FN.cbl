      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN012FN'.
      ...
      * Called module names
       01  MOD-ZEN01PI5              PIC X(8) VALUE 'ZEN01PI5'.
       01  MOD-ZEN01KT8              PIC X(8) VALUE 'ZEN01KT8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01PI5-001.
               PERFORM CALL-ZEN01KT8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01PI5-001.
               CALL 'ZEN01PI5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01PI5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01KT8-002.
               CALL 'ZEN01KT8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01KT8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
