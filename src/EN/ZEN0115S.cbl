      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN0115S'.
      ...
      * Called module names
       01  MOD-ZEN01OC7              PIC X(8) VALUE 'ZEN01OC7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01OC7-001.
               CALL 'ZEN01OC7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01OC7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
