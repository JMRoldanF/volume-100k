      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN011F7'.
      ...
      * Called module names
       01  MOD-ZEN01JZ5              PIC X(8) VALUE 'ZEN01JZ5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01JZ5-001.
               PERFORM CALL-ZEN01MYC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01JZ5-001.
               CALL 'ZEN01JZ5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01JZ5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01MYC-002.
