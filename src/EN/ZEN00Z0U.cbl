      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00Z0U'.
      ...
      * Called module names
       01  MOD-ZEN01POT              PIC X(8) VALUE 'ZEN01POT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01POT-001.
               PERFORM CALL-ZTR01ENE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01POT-001.
               CALL 'ZEN01POT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01POT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTR01ENE-002.
