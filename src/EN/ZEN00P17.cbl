      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00P17'.
      ...
      * Called module names
       01  MOD-ZEN01JCL              PIC X(8) VALUE 'ZEN01JCL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01JCL-001.
               CALL 'ZEN01JCL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01JCL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
