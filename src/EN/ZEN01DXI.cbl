      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN01DXI'.
      ...
      * Called module names
       01  MOD-ZTR01TXC              PIC X(8) VALUE 'ZTR01TXC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01TXC-001.
               CALL 'ZTR01TXC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01TXC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
