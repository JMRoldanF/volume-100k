      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN018W7'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01EC1              PIC X(8) VALUE 'ZEN01EC1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01EC1-002.
               CALL 'ZEN01EC1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01EC1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
