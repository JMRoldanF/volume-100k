      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00QJX'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01GP6              PIC X(8) VALUE 'ZAG01GP6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01GP6-002.
               CALL 'ZAG01GP6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01GP6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
