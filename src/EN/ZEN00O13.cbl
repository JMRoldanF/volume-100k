      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00O13'.
      ...
      * Called module names
       01  MOD-ZEN01IUJ              PIC X(8) VALUE 'ZEN01IUJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01IUJ-001.
               CALL 'ZEN01IUJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01IUJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
