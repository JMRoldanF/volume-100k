      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00QC8'.
      ...
      * Called module names
       01  MOD-ZEN01QT1              PIC X(8) VALUE 'ZEN01QT1'.
       01  MOD-ZEN01O47              PIC X(8) VALUE 'ZEN01O47'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01QT1-001.
               PERFORM CALL-ZEN01O47-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01QT1-001.
               CALL 'ZEN01QT1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01QT1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01O47-002.
               CALL 'ZEN01O47' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
