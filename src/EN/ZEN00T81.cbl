      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00T81'.
      ...
      * Called module names
       01  MOD-ZEN01RPP              PIC X(8) VALUE 'ZEN01RPP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01RPP-001.
               PERFORM CALL-ZAG01UZC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01RPP-001.
               CALL 'ZEN01RPP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01RPP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01UZC-002.
