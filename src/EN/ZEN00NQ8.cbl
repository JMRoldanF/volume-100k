      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00NQ8'.
      ...
      * Called module names
       01  MOD-ZEN01TKF              PIC X(8) VALUE 'ZEN01TKF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01TKF-001.
               CALL 'ZEN01TKF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01TKF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-MAKE-0001.
