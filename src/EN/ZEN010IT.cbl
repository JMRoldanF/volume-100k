      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN010IT'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01TBR              PIC X(8) VALUE 'ZEN01TBR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01UA7-001.
               PERFORM CALL-ZEN01TBR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01TBR-002.
               CALL 'ZEN01TBR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
