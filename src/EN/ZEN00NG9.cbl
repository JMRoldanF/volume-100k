      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00NG9'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01PVK              PIC X(8) VALUE 'ZHO01PVK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01PVK-002.
               CALL 'ZHO01PVK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01PVK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
