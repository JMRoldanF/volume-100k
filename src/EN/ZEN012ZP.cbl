      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN012ZP'.
      ...
      * Called module names
       01  MOD-ZEN01G97              PIC X(8) VALUE 'ZEN01G97'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01G97-001.
               CALL 'ZEN01G97' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01G97 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-MODEL-0001.
