      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00ZUN'.
      ...
      * Called module names
       01  MOD-ZEN01LAL              PIC X(8) VALUE 'ZEN01LAL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01LAL-001.
               CALL 'ZEN01LAL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01LAL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01P4D-002.
