      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00Z9J'.
      ...
      * Called module names
       01  MOD-ZMT01RXZ              PIC X(8) VALUE 'ZMT01RXZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01RXZ-001.
               CALL 'ZMT01RXZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01RXZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
