      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN015IS'.
      ...
      * Called module names
       01  MOD-ZEN01K9G              PIC X(8) VALUE 'ZEN01K9G'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01K9G-001.
               CALL 'ZEN01K9G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01K9G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
