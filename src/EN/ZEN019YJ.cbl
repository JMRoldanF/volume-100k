      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN019YJ'.
      ...
      * Called module names
       01  MOD-ZEN01GTH              PIC X(8) VALUE 'ZEN01GTH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01GTH-001.
               CALL 'ZEN01GTH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01GTH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01GUL-002.
