      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00PAX'.
      ...
      * Called module names
       01  MOD-ZEN01LVP              PIC X(8) VALUE 'ZEN01LVP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01LVP-001.
               CALL 'ZEN01LVP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01LVP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-TAX-BAND-0001.
