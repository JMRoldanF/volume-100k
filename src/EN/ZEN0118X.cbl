      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN0118X'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01QYR              PIC X(8) VALUE 'ZEN01QYR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01PLV-001.
               PERFORM CALL-ZEN01QYR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01QYR-002.
               CALL 'ZEN01QYR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01QYR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
