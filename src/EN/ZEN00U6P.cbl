      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00U6P'.
      ...
      * Called module names
       01  MOD-ZEN01OQL              PIC X(8) VALUE 'ZEN01OQL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01OQL-001.
               CALL 'ZEN01OQL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01OQL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
