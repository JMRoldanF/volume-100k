      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN01BXD'.
      ...
      * Called module names
       01  MOD-ZEN01SQX              PIC X(8) VALUE 'ZEN01SQX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01UTD-001.
               PERFORM CALL-ZEN01SQX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01SQX-002.
               CALL 'ZEN01SQX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01SQX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
