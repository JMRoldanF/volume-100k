      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00LP7'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01M1W              PIC X(8) VALUE 'ZEN01M1W'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01M1W-002.
               CALL 'ZEN01M1W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01M1W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
