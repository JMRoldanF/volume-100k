      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00LON'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01NHH              PIC X(8) VALUE 'ZEN01NHH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01NHH-002.
               CALL 'ZEN01NHH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01NHH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
