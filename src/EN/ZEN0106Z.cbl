      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN0106Z'.
      ...
      * Called module names
       01  MOD-ZEN01MCG              PIC X(8) VALUE 'ZEN01MCG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01MCG-001.
               CALL 'ZEN01MCG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01MCG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
