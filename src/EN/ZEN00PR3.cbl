      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00PR3'.
      ...
      * Called module names
       01  MOD-ZEN01M13              PIC X(8) VALUE 'ZEN01M13'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01M13-001.
               CALL 'ZEN01M13' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01M13 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
