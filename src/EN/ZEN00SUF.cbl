      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00SUF'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01DI1              PIC X(8) VALUE 'ZEN01DI1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01DI1-002.
               CALL 'ZEN01DI1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01DI1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
