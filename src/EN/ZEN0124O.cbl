      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN0124O'.
      ...
      * Called module names
       01  MOD-ZEN01FK3              PIC X(8) VALUE 'ZEN01FK3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01FK3-001.
               PERFORM CALL-ZLB01JH7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01FK3-001.
               CALL 'ZEN01FK3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01FK3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLB01JH7-002.
