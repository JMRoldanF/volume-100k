      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN004U9'.
      ...
      * Called module names
       ...
       01  MOD-ZEN0096D              PIC X(8) VALUE 'ZEN0096D'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN00E3V-001.
               PERFORM CALL-ZEN0096D-002.
               PERFORM CALL-ZEN00GO3-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN0096D-002.
               EXEC CICS LINK PROGRAM('ZEN0096D')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN0096D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN00GO3-003.
               MOVE 'ZEN00GO3' TO WS-PROGNAME-7
