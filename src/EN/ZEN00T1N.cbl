      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00T1N'.
      ...
      * Called module names
       01  MOD-ZEN01SEZ              PIC X(8) VALUE 'ZEN01SEZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01SEZ-001.
               PERFORM CALL-ZHO01NC6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01SEZ-001.
               CALL 'ZEN01SEZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01SEZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01NC6-002.
