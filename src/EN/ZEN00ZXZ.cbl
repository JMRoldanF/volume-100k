      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00ZXZ'.
      ...
      * Called module names
       01  MOD-ZEN01NJ5              PIC X(8) VALUE 'ZEN01NJ5'.
       01  MOD-ZEN01KW5              PIC X(8) VALUE 'ZEN01KW5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01NJ5-001.
               PERFORM CALL-ZEN01KW5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01NJ5-001.
               CALL 'ZEN01NJ5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01NJ5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01KW5-002.
               CALL 'ZEN01KW5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01KW5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
