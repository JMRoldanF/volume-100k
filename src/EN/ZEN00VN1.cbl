      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00VN1'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01FJ4              PIC X(8) VALUE 'ZEN01FJ4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01FJ4-002.
               CALL 'ZEN01FJ4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01FJ4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
