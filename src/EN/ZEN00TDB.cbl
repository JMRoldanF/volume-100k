      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00TDB'.
      ...
      * Called module names
       01  MOD-ZEN01UG3              PIC X(8) VALUE 'ZEN01UG3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01UG3-001.
               CALL 'ZEN01UG3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01UG3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
