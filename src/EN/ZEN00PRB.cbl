      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00PRB'.
      ...
      * Called module names
       01  MOD-ZEN01MQJ              PIC X(8) VALUE 'ZEN01MQJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01MQJ-001.
               CALL 'ZEN01MQJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01MQJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
