      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00WCT'.
      ...
      * Called module names
       01  MOD-ZEN01HY1              PIC X(8) VALUE 'ZEN01HY1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01HY1-001.
               CALL 'ZEN01HY1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01HY1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01QEH-002.
