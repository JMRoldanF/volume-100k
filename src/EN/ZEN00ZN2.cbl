      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00ZN2'.
      ...
      * Called module names
       01  MOD-ZEN01HGZ              PIC X(8) VALUE 'ZEN01HGZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01HGZ-001.
               CALL 'ZEN01HGZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01HGZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01UTK-002.
