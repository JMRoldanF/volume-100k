      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00ATT'.
      ...
      * Called module names
       01  MOD-ZEN00M2T              PIC X(8) VALUE 'ZEN00M2T'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN00M2T-001.
               PERFORM CALL-ZEN00S1T-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN00M2T-001.
               EXEC CICS LINK PROGRAM('ZEN00M2T')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN00M2T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN00S1T-002.
               MOVE 'ZEN00S1T' TO WS-PROGNAME-1
      ...
      *----------------------------------------------------------------*
       CALL-ZEN013FJ-003.
               MOVE 'ZEN013FJ' TO WS-PROGNAME-2
