      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00VP4'.
      ...
      * Called module names
       01  MOD-ZEN01QBL              PIC X(8) VALUE 'ZEN01QBL'.
       01  MOD-ZEN01TNG              PIC X(8) VALUE 'ZEN01TNG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01QBL-001.
               PERFORM CALL-ZEN01TNG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01QBL-001.
               CALL 'ZEN01QBL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01QBL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01TNG-002.
               CALL 'ZEN01TNG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01TNG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
