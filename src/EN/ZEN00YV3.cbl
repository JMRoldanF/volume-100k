      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00YV3'.
      ...
      * Called module names
       01  MOD-ZEN01RXR              PIC X(8) VALUE 'ZEN01RXR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01RXR-001.
               CALL 'ZEN01RXR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01RXR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
