      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN01CZW'.
      ...
      * Called module names
       01  MOD-ZEN01IOX              PIC X(8) VALUE 'ZEN01IOX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01IOX-001.
               CALL 'ZEN01IOX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01IOX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
