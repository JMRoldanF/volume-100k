      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00LQB'.
      ...
      * Called module names
       01  MOD-ZEN01KX9              PIC X(8) VALUE 'ZEN01KX9'.
       01  MOD-ZEN01J3F              PIC X(8) VALUE 'ZEN01J3F'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01KX9-001.
               PERFORM CALL-ZEN01J3F-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01KX9-001.
               CALL 'ZEN01KX9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01J3F-002.
               CALL 'ZEN01J3F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01J3F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
