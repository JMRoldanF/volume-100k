      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00XDG'.
      ...
      * Called module names
       01  MOD-ZTR01LB9              PIC X(8) VALUE 'ZTR01LB9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01LB9-001.
               CALL 'ZTR01LB9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01LB9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLB01KR9-002.
