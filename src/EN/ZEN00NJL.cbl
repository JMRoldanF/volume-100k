      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00NJL'.
      ...
      * Called module names
       01  MOD-ZHO01P38              PIC X(8) VALUE 'ZHO01P38'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01P38-001.
               CALL 'ZHO01P38' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01P38 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-PREMIUM-0001.
