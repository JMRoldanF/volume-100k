      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN011FL'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01GTE              PIC X(8) VALUE 'ZUW01GTE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01GTE-002.
               CALL 'ZUW01GTE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01GTE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-TERM-0001.
