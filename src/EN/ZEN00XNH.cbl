      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00XNH'.
      ...
      * Called module names
       01  MOD-ZEN01EKN              PIC X(8) VALUE 'ZEN01EKN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01EKN-001.
               CALL 'ZEN01EKN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01EKN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01KGB-002.
