      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00ZIZ'.
      ...
      * Called module names
       01  MOD-ZEN01KON              PIC X(8) VALUE 'ZEN01KON'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01KON-001.
               PERFORM CALL-ZEN01OOJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01KON-001.
               CALL 'ZEN01KON' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01KON FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01OOJ-002.
