      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00PT2'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01FP9              PIC X(8) VALUE 'ZEN01FP9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01KJF-001.
               PERFORM CALL-ZEN01FP9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01FP9-002.
               CALL 'ZEN01FP9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01FP9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
