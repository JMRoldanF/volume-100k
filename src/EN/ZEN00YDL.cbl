      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00YDL'.
      ...
      * Called module names
       01  MOD-ZEN01R2X              PIC X(8) VALUE 'ZEN01R2X'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01R2X-001.
               CALL 'ZEN01R2X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01R2X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
