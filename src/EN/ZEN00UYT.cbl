      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00UYT'.
      ...
      * Called module names
       01  MOD-ZEN01PHP              PIC X(8) VALUE 'ZEN01PHP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01PHP-001.
               CALL 'ZEN01PHP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01PHP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
