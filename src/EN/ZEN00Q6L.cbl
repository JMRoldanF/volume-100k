      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00Q6L'.
      ...
      * Called module names
       01  MOD-ZEN01L33              PIC X(8) VALUE 'ZEN01L33'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01L33-001.
               PERFORM CALL-ZHO01ML8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01L33-001.
               CALL 'ZEN01L33' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01L33 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01ML8-002.
