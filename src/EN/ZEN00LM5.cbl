      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00LM5'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01R1M              PIC X(8) VALUE 'ZBI01R1M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01R1M-002.
               CALL 'ZBI01R1M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01R1M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
