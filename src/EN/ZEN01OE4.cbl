      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN01OE4'.
      ...
      * Called module names
       01  MOD-ZEN01CSX              PIC X(8) VALUE 'ZEN01CSX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01CSX-001.
               CALL 'ZEN01CSX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01CSX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
