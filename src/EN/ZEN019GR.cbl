      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN019GR'.
      ...
      * Called module names
       01  MOD-ZEN01U2P              PIC X(8) VALUE 'ZEN01U2P'.
       01  MOD-ZEN01ODF              PIC X(8) VALUE 'ZEN01ODF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01U2P-001.
               CALL 'ZEN01U2P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01U2P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01ODF-002.
               CALL 'ZEN01ODF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
