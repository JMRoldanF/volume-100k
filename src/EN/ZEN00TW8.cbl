      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00TW8'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01FQ3              PIC X(8) VALUE 'ZEN01FQ3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01FQ3-002.
               CALL 'ZEN01FQ3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01FQ3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
