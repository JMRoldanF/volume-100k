      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN0114X'.
      ...
      * Called module names
       01  MOD-ZEN01J8M              PIC X(8) VALUE 'ZEN01J8M'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01HI3-001.
               PERFORM CALL-ZEN01J8M-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01J8M-002.
               CALL 'ZEN01J8M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01J8M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
