      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN011AL'.
      ...
      * Called module names
       01  MOD-ZEN01NP9              PIC X(8) VALUE 'ZEN01NP9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01NP9-001.
               CALL 'ZEN01NP9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01NP9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
