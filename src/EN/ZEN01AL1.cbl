      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN01AL1'.
      ...
      * Called module names
       01  MOD-ZEN01PX9              PIC X(8) VALUE 'ZEN01PX9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01PX9-001.
               CALL 'ZEN01PX9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01PX9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
