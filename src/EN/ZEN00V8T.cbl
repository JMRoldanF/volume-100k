      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00V8T'.
      ...
      * Called module names
       01  MOD-ZPA01DN7              PIC X(8) VALUE 'ZPA01DN7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01DN7-001.
               CALL 'ZPA01DN7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01DN7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
