      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN0037D'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN00BM5-001.
               PERFORM CALL-ZHO00F48-002.
               PERFORM CALL-ZPA003XD-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00F48-002.
               MOVE 'ZHO00F48' TO WS-PROGNAME-8
      ...
      *----------------------------------------------------------------*
       CALL-ZPA003XD-003.
               EXEC CICS START TRANSID('Z3XD')
                         FROM(WS-KEY-AREA)
                         LENGTH(20)
                         RESP(WS-RESP)
               END-EXEC.
      * TRANSID Z3XD is defined against ZPA003XD
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA003XD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-004.
