      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00WNX'.
      ...
      * Called module names
       01  MOD-ZBI01PPU              PIC X(8) VALUE 'ZBI01PPU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01PPU-001.
               PERFORM CALL-ZAG01USE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01PPU-001.
               CALL 'ZBI01PPU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01PPU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01USE-002.
