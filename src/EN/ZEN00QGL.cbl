      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00QGL'.
      ...
      * Called module names
       01  MOD-ZEN01HQ9              PIC X(8) VALUE 'ZEN01HQ9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01HQ9-001.
               CALL 'ZEN01HQ9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01HQ9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
