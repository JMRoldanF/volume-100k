      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN011AV'.
      ...
      * Called module names
       01  MOD-ZEN01S4F              PIC X(8) VALUE 'ZEN01S4F'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01S4F-001.
               CALL 'ZEN01S4F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01S4F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-COLOUR-0001.
