      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN000V2'.
      ...
      * Called module names
       ...
       01  MOD-ZEN009O1              PIC X(8) VALUE 'ZEN009O1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN00D55-001.
               PERFORM CALL-ZEN009O1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN009O1-002.
               EXEC CICS LINK PROGRAM('ZEN009O1')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN009O1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
