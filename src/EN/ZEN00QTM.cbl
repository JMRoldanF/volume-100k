      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00QTM'.
      ...
      * Called module names
       01  MOD-ZEN01LFH              PIC X(8) VALUE 'ZEN01LFH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01LFH-001.
               CALL 'ZEN01LFH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01LFH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
