      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00XW3'.
      ...
      * Called module names
       01  MOD-ZEN01K4D              PIC X(8) VALUE 'ZEN01K4D'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01K4D-001.
               CALL 'ZEN01K4D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01K4D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
