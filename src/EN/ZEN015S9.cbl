      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN015S9'.
      ...
      * Called module names
       01  MOD-ZEN01FTD              PIC X(8) VALUE 'ZEN01FTD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01FTD-001.
               CALL 'ZEN01FTD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01FTD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
