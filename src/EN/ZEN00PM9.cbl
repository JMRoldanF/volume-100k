      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00PM9'.
      ...
      * Called module names
       01  MOD-ZEN01T53              PIC X(8) VALUE 'ZEN01T53'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01T53-001.
               PERFORM CALL-ZEN01L7N-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01T53-001.
               CALL 'ZEN01T53' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01T53 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01L7N-002.
               MOVE 'ZEN01L7N' TO WS-SUBNAME-2
