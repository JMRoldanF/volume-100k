      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN01755'.
      ...
      * Called module names
       01  MOD-ZEN01RYL              PIC X(8) VALUE 'ZEN01RYL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01RYL-001.
               CALL 'ZEN01RYL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01RYL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
