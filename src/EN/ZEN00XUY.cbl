      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00XUY'.
      ...
      * Called module names
       01  MOD-ZEN01N1R              PIC X(8) VALUE 'ZEN01N1R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01N1R-001.
               CALL 'ZEN01N1R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01N1R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
