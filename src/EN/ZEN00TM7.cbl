      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00TM7'.
      ...
      * Called module names
       01  MOD-ZEN01GBZ              PIC X(8) VALUE 'ZEN01GBZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01GBZ-001.
               CALL 'ZEN01GBZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01GBZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-EXCESS-0001.
