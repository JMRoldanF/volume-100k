      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN010A7'.
      ...
      * Called module names
       01  MOD-ZEN01CRX              PIC X(8) VALUE 'ZEN01CRX'.
       01  MOD-ZHO01UAG              PIC X(8) VALUE 'ZHO01UAG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01CRX-001.
               PERFORM CALL-ZHO01UAG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01CRX-001.
               CALL 'ZEN01CRX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01CRX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01UAG-002.
               CALL 'ZHO01UAG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01UAG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
