      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00WAB'.
      ...
      * Called module names
       01  MOD-ZEN01DE5              PIC X(8) VALUE 'ZEN01DE5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01DE5-001.
               PERFORM CALL-ZEN01CPF-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01DE5-001.
               CALL 'ZEN01DE5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01DE5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01CPF-002.
