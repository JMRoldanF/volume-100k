      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00S7X'.
      ...
      * Called module names
       01  MOD-ZEN01F7Z              PIC X(8) VALUE 'ZEN01F7Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01F7Z-001.
               CALL 'ZEN01F7Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01F7Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
