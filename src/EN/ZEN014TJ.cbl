      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN014TJ'.
      ...
      * Called module names
       01  MOD-ZAG01PXY              PIC X(8) VALUE 'ZAG01PXY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01PXY-001.
               CALL 'ZAG01PXY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01PXY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
