      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00O4N'.
      ...
      * Called module names
       01  MOD-ZEN01LW3              PIC X(8) VALUE 'ZEN01LW3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01LW3-001.
               CALL 'ZEN01LW3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01LW3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
