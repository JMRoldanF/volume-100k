      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00PA4'.
      ...
      * Called module names
       01  MOD-ZEN01UKC              PIC X(8) VALUE 'ZEN01UKC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01UKC-001.
               CALL 'ZEN01UKC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01UKC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
