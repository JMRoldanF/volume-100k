      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN011AN'.
      ...
      * Called module names
       01  MOD-ZEN01QBX              PIC X(8) VALUE 'ZEN01QBX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01QBX-001.
               PERFORM CALL-ZEN01PX4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01QBX-001.
               CALL 'ZEN01QBX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01QBX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01PX4-002.
