      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN002XN'.
      ...
      * Called module names
       ...
       01  MOD-ZEN008F5              PIC X(8) VALUE 'ZEN008F5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN00ABH-001.
               PERFORM CALL-ZEN008F5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN008F5-002.
               EXEC CICS LINK PROGRAM('ZEN008F5')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN008F5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
