      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00W3D'.
      ...
      * Called module names
       01  MOD-ZEN01LPL              PIC X(8) VALUE 'ZEN01LPL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01LPL-001.
               CALL 'ZEN01LPL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01LPL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
