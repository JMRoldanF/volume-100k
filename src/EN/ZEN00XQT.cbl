      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00XQT'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01EIZ              PIC X(8) VALUE 'ZEN01EIZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01FBL-001.
               PERFORM CALL-ZEN01EIZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01EIZ-002.
               CALL 'ZEN01EIZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01EIZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
