      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00LVL'.
      ...
      * Called module names
       01  MOD-ZAG01SIG              PIC X(8) VALUE 'ZAG01SIG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01SIG-001.
               PERFORM CALL-ZEN01S3L-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01SIG-001.
               CALL 'ZAG01SIG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01SIG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01S3L-002.
               MOVE 'ZEN01S3L' TO WS-SUBNAME-4
