      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00NSR'.
      ...
      * Called module names
       01  MOD-ZEN01NUJ              PIC X(8) VALUE 'ZEN01NUJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01NUJ-001.
               CALL 'ZEN01NUJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01NUJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01M5Z-002.
