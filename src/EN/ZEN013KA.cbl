      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN013KA'.
      ...
      * Called module names
       01  MOD-ZEN01QA7              PIC X(8) VALUE 'ZEN01QA7'.
       01  MOD-ZEN01R34              PIC X(8) VALUE 'ZEN01R34'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01QA7-001.
               PERFORM CALL-ZEN01R34-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01QA7-001.
               CALL 'ZEN01QA7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01QA7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01R34-002.
               CALL 'ZEN01R34' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01R34 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
