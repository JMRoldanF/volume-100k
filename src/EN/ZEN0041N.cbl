      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN0041N'.
      ...
      * Called module names
       ...
       01  MOD-ZEN0091N              PIC X(8) VALUE 'ZEN0091N'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN0091N-002.
               EXEC CICS LINK PROGRAM('ZEN0091N')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN0091N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
