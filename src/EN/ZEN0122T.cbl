      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN0122T'.
      ...
      * Called module names
       01  MOD-ZEN01HHV              PIC X(8) VALUE 'ZEN01HHV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01HHV-001.
               CALL 'ZEN01HHV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01HHV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
