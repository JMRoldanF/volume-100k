      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN018C7'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01HBT              PIC X(8) VALUE 'ZEN01HBT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01HBT-002.
               CALL 'ZEN01HBT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01HBT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
