      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00YGN'.
      ...
      * Called module names
       01  MOD-ZEN01O6R              PIC X(8) VALUE 'ZEN01O6R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01O6R-001.
               CALL 'ZEN01O6R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01O6R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
