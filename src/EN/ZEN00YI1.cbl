      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00YI1'.
      ...
      * Called module names
       01  MOD-ZEN01T7L              PIC X(8) VALUE 'ZEN01T7L'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01T7L-001.
               CALL 'ZEN01T7L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01T7L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
