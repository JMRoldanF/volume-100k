      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00R65'.
      ...
      * Called module names
       01  MOD-ZEN01ED5              PIC X(8) VALUE 'ZEN01ED5'.
       01  MOD-ZEN01T35              PIC X(8) VALUE 'ZEN01T35'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01ED5-001.
               PERFORM CALL-ZEN01T35-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01ED5-001.
               CALL 'ZEN01ED5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01ED5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01T35-002.
               CALL 'ZEN01T35' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01T35 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
