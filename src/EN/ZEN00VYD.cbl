      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00VYD'.
      ...
      * Called module names
       01  MOD-ZEN01GKV              PIC X(8) VALUE 'ZEN01GKV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01GKV-001.
               CALL 'ZEN01GKV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01GKV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
