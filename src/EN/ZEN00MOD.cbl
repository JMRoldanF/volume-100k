      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00MOD'.
      ...
      * Called module names
       01  MOD-ZEN01I80              PIC X(8) VALUE 'ZEN01I80'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01I80-001.
               CALL 'ZEN01I80' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01I80 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
