      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00QEX'.
      ...
      * Called module names
       01  MOD-ZEN01MF5              PIC X(8) VALUE 'ZEN01MF5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01MF5-001.
               CALL 'ZEN01MF5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01MF5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-VALUE-0001.
