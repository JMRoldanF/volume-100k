      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00WNN'.
      ...
      * Called module names
       01  MOD-ZEN01JIF              PIC X(8) VALUE 'ZEN01JIF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01JIF-001.
               PERFORM CALL-ZEN01CNR-002.
               ...
               PERFORM REFRESH-HOUSE-TYPE-0025.
               PERFORM SQL-ACCESS-0027.
               PERFORM COMPUTE-WITH-PROFITS-0028.
               ...
               PERFORM NORMALISE-REG-NUMBER-0083.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01JIF-001.
               CALL 'ZEN01JIF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01JIF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01CNR-002.
               MOVE 'ZEN01CNR' TO WS-SUBNAME-1
               CALL WS-SUBNAME-1 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01CNR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
