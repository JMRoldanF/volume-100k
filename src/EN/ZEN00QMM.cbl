      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00QMM'.
      ...
      * Called module names
       01  MOD-ZEN01QZU              PIC X(8) VALUE 'ZEN01QZU'.
       01  MOD-ZEN01FBN              PIC X(8) VALUE 'ZEN01FBN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01QZU-001.
               PERFORM CALL-ZEN01FBN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01QZU-001.
               CALL 'ZEN01QZU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01QZU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01FBN-002.
               CALL 'ZEN01FBN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01FBN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
