      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00NZL'.
      ...
      * Called module names
       01  MOD-ZEN01E5O              PIC X(8) VALUE 'ZEN01E5O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01E5O-001.
               CALL 'ZEN01E5O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01E5O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
