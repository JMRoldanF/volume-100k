      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN010WZ'.
      ...
      * Called module names
       01  MOD-ZEN01O1H              PIC X(8) VALUE 'ZEN01O1H'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01O1H-001.
               CALL 'ZEN01O1H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01O1H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
