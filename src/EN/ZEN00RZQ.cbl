      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00RZQ'.
      ...
      * Called module names
       01  MOD-ZEN01G1J              PIC X(8) VALUE 'ZEN01G1J'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01G1J-001.
               CALL 'ZEN01G1J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01G1J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
