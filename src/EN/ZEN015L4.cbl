      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN015L4'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01F1W              PIC X(8) VALUE 'ZEN01F1W'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01F1W-002.
               CALL 'ZEN01F1W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01F1W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
