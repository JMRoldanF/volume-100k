      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00RFV'.
      ...
      * Called module names
       01  MOD-ZEN01S3B              PIC X(8) VALUE 'ZEN01S3B'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01S3B-001.
               CALL 'ZEN01S3B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01S3B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
