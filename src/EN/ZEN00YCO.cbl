      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00YCO'.
      ...
      * Called module names
       01  MOD-ZEN01DSY              PIC X(8) VALUE 'ZEN01DSY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01IYA-001.
               PERFORM CALL-ZEN01DSY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01DSY-002.
               CALL 'ZEN01DSY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01DSY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
