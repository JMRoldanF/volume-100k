      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00SYK'.
      ...
      * Called module names
       01  MOD-ZTR01PGJ              PIC X(8) VALUE 'ZTR01PGJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01PGJ-001.
               CALL 'ZTR01PGJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01PGJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
