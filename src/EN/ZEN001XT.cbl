      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN001XT'.
      ...
      * Called module names
       ...
       01  MOD-ZEN0075B              PIC X(8) VALUE 'ZEN0075B'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN0075B-002.
               EXEC CICS LINK PROGRAM('ZEN0075B')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN0075B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
