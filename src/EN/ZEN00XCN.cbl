      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00XCN'.
      ...
      * Called module names
       01  MOD-ZEN01KQB              PIC X(8) VALUE 'ZEN01KQB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01KQB-001.
               PERFORM CALL-ZEN01KGV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01KQB-001.
               CALL 'ZEN01KQB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01KQB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01KGV-002.
