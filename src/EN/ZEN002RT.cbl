      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN002RT'.
      ...
      * Called module names
       01  MOD-ZEN00GFR              PIC X(8) VALUE 'ZEN00GFR'.
       01  MOD-ZEN00963              PIC X(8) VALUE 'ZEN00963'.
       01  MOD-ZRE0004N              PIC X(8) VALUE 'ZRE0004N'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN00GFR-001.
               PERFORM CALL-ZEN00963-002.
               PERFORM CALL-ZEN00FML-003.
               PERFORM CALL-ZRE0004N-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN00GFR-001.
               EXEC CICS LINK PROGRAM('ZEN00GFR')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN00GFR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN00963-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN00FML-003.
               MOVE 'ZEN00FML' TO WS-PROGNAME-2
      ...
      *----------------------------------------------------------------*
       CALL-ZRE0004N-004.
               EXEC CICS XCTL PROGRAM('ZRE0004N')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE0004N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI000JC-005.
               EXEC CICS START TRANSID('Z0JC')
                         ...
                         RESP(WS-RESP)
               END-EXEC.
      * TRANSID Z0JC is defined against ZBI000JC
               IF WS-RESP NOT = DFHRESP(NORMAL)
