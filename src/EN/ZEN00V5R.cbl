      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00V5R'.
      ...
      * Called module names
       01  MOD-ZEN01HGJ              PIC X(8) VALUE 'ZEN01HGJ'.
       01  MOD-ZEN01J71              PIC X(8) VALUE 'ZEN01J71'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01HGJ-001.
               PERFORM CALL-ZEN01J71-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01HGJ-001.
               CALL 'ZEN01HGJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01HGJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01J71-002.
               CALL 'ZEN01J71' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01J71 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
