      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00UB5'.
      ...
      * Called module names
       01  MOD-ZEN01GZA              PIC X(8) VALUE 'ZEN01GZA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01GZA-001.
               PERFORM CALL-ZEN01JKA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01GZA-001.
               CALL 'ZEN01GZA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01JKA-002.
               MOVE 'ZEN01JKA' TO WS-SUBNAME-7
               CALL WS-SUBNAME-7 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01JKA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
