      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00X5R'.
      ...
      * Called module names
       01  MOD-ZEN01OXV              PIC X(8) VALUE 'ZEN01OXV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01OXV-001.
               CALL 'ZEN01OXV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01OXV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
