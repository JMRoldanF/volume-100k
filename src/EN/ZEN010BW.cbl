      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN010BW'.
      ...
      * Called module names
       01  MOD-ZEN01QUF              PIC X(8) VALUE 'ZEN01QUF'.
       01  MOD-ZEN01EV5              PIC X(8) VALUE 'ZEN01EV5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01QUF-001.
               PERFORM CALL-ZEN01EV5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01QUF-001.
               CALL 'ZEN01QUF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01QUF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01EV5-002.
               CALL 'ZEN01EV5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01EV5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
