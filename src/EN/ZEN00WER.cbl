      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00WER'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01DX1              PIC X(8) VALUE 'ZEN01DX1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01DX1-002.
               CALL 'ZEN01DX1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01DX1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
