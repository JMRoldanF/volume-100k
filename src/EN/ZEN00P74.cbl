      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00P74'.
      ...
      * Called module names
       01  MOD-ZEN01MF1              PIC X(8) VALUE 'ZEN01MF1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01MF1-001.
               CALL 'ZEN01MF1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01MF1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
