      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00QHA'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01FLZ              PIC X(8) VALUE 'ZEN01FLZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAV01HT5-001.
               PERFORM CALL-ZEN01FLZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01FLZ-002.
               CALL 'ZEN01FLZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01FLZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
