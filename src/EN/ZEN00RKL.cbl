      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00RKL'.
      ...
      * Called module names
       01  MOD-ZEN01FSJ              PIC X(8) VALUE 'ZEN01FSJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01FSJ-001.
               PERFORM CALL-ZEN01REL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01FSJ-001.
               CALL 'ZEN01FSJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01FSJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01REL-002.
               MOVE 'ZEN01REL' TO WS-SUBNAME-6
