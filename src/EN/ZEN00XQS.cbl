      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00XQS'.
      ...
      * Called module names
       01  MOD-ZTR01I0B              PIC X(8) VALUE 'ZTR01I0B'.
       01  MOD-ZTR01JA6              PIC X(8) VALUE 'ZTR01JA6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTR01I0B-001.
               PERFORM CALL-ZTR01JA6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01I0B-001.
               CALL 'ZTR01I0B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01I0B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTR01JA6-002.
               CALL 'ZTR01JA6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01JA6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
