      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00TRY'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01T15              PIC X(8) VALUE 'ZEN01T15'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTR01T6Z-001.
               PERFORM CALL-ZEN01T15-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01T15-002.
               CALL 'ZEN01T15' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01T15 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
