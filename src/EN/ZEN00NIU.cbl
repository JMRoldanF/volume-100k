      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00NIU'.
      ...
      * Called module names
       01  MOD-ZEN01UZV              PIC X(8) VALUE 'ZEN01UZV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01UZV-001.
               PERFORM CALL-ZTR01PY2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01UZV-001.
               CALL 'ZEN01UZV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01UZV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTR01PY2-002.
