      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00MCT'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01QZL              PIC X(8) VALUE 'ZEN01QZL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01OWL-001.
               PERFORM CALL-ZEN01QZL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01QZL-002.
               CALL 'ZEN01QZL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01QZL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
