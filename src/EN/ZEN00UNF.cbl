      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00UNF'.
      ...
      * Called module names
       01  MOD-ZUW01UXG              PIC X(8) VALUE 'ZUW01UXG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01UXG-001.
               CALL 'ZUW01UXG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01UXG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
