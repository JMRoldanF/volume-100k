      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00Y3N'.
      ...
      * Called module names
       01  MOD-ZEN01PB3              PIC X(8) VALUE 'ZEN01PB3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01PB3-001.
               PERFORM CALL-ZRE0255R-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZEN01PB3-001.
               CALL 'ZEN01PB3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
