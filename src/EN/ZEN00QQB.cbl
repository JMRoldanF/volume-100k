      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00QQB'.
      ...
      * Called module names
       01  MOD-ZEN01LOH              PIC X(8) VALUE 'ZEN01LOH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01LOH-001.
               CALL 'ZEN01LOH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01LOH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
