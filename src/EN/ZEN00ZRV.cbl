      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00ZRV'.
      ...
      * Called module names
       01  MOD-ZEN01DYF              PIC X(8) VALUE 'ZEN01DYF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01DYF-001.
               CALL 'ZEN01DYF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01DYF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01U2F-002.
