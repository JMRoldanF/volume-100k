      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00QWZ'.
      ...
      * Called module names
       01  MOD-ZEN01OW1              PIC X(8) VALUE 'ZEN01OW1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01OW1-001.
               CALL 'ZEN01OW1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01OW1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-BEDROOMS-0001.
