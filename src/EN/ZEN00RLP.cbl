      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00RLP'.
      ...
      * Called module names
       01  MOD-ZEN01MZZ              PIC X(8) VALUE 'ZEN01MZZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01MZZ-001.
               CALL 'ZEN01MZZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01MZZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
