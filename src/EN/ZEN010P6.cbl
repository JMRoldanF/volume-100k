      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN010P6'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01Q8P              PIC X(8) VALUE 'ZEN01Q8P'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01Q8P-002.
               CALL 'ZEN01Q8P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
