      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN013GE'.
      ...
      * Called module names
       01  MOD-ZEN01NKU              PIC X(8) VALUE 'ZEN01NKU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01NKU-001.
               CALL 'ZEN01NKU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01NKU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
