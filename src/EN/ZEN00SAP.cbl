      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00SAP'.
      ...
      * Called module names
       01  MOD-ZUW01GHQ              PIC X(8) VALUE 'ZUW01GHQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01GHQ-001.
               CALL 'ZUW01GHQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01GHQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
