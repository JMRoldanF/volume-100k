      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00QBJ'.
      ...
      * Called module names
       01  MOD-ZEN01FS5              PIC X(8) VALUE 'ZEN01FS5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01FS5-001.
               CALL 'ZEN01FS5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01FS5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01PUF-002.
