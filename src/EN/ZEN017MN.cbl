      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN017MN'.
      ...
      * Called module names
       01  MOD-ZUW01PJK              PIC X(8) VALUE 'ZUW01PJK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01PJK-001.
               CALL 'ZUW01PJK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01PJK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
