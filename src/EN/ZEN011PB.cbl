      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN011PB'.
      ...
      * Called module names
       01  MOD-ZEN01IEF              PIC X(8) VALUE 'ZEN01IEF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01IEF-001.
               CALL 'ZEN01IEF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01IEF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
