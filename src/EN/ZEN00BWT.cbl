      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00BWT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN00QPQ-002.
               PERFORM CALL-ZEN019T1-003.
               PERFORM CALL-ZLB01QSM-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN00QPQ-002.
               MOVE 'ZEN00QPQ' TO WS-PROGNAME-2
