      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00VM5'.
      ...
      * Called module names
       01  MOD-ZEN01G0L              PIC X(8) VALUE 'ZEN01G0L'.
       01  MOD-ZCU01EOA              PIC X(8) VALUE 'ZCU01EOA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01G0L-001.
               PERFORM CALL-ZCU01EOA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01G0L-001.
               CALL 'ZEN01G0L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01G0L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01EOA-002.
               CALL 'ZCU01EOA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
