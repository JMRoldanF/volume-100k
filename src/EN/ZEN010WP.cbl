      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN010WP'.
      ...
      * Called module names
       01  MOD-ZEN01TTT              PIC X(8) VALUE 'ZEN01TTT'.
       01  MOD-ZEN01MKZ              PIC X(8) VALUE 'ZEN01MKZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01TTT-001.
               PERFORM CALL-ZEN01MKZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01TTT-001.
               CALL 'ZEN01TTT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01TTT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01MKZ-002.
               CALL 'ZEN01MKZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01MKZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
