      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00MUJ'.
      ...
      * Called module names
       01  MOD-ZEN01KR8              PIC X(8) VALUE 'ZEN01KR8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01KR8-001.
               PERFORM CALL-ZEN01E0B-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01KR8-001.
               CALL 'ZEN01KR8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01KR8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01E0B-002.
