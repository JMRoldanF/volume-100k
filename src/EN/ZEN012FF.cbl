      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN012FF'.
      ...
      * Called module names
       01  MOD-ZEN01COL              PIC X(8) VALUE 'ZEN01COL'.
       01  MOD-ZEN01SLN              PIC X(8) VALUE 'ZEN01SLN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01COL-001.
               PERFORM CALL-ZEN01SLN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01COL-001.
               CALL 'ZEN01COL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01COL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01SLN-002.
               CALL 'ZEN01SLN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01SLN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-MAKE-0001.
