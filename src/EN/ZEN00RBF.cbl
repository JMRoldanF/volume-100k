      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00RBF'.
      ...
      * Called module names
       01  MOD-ZEN01D13              PIC X(8) VALUE 'ZEN01D13'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01D13-002.
               CALL 'ZEN01D13' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
