      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00ZUZ'.
      ...
      * Called module names
       01  MOD-ZEN01KYT              PIC X(8) VALUE 'ZEN01KYT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01KYT-001.
               CALL 'ZEN01KYT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01KYT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
