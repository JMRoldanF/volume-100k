      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00RLF'.
      ...
      * Called module names
       01  MOD-ZPA01NGT              PIC X(8) VALUE 'ZPA01NGT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01NGT-001.
               CALL 'ZPA01NGT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01NGT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
