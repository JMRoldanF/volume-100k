      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN016XD'.
      ...
      * Called module names
       01  MOD-ZEN01TPN              PIC X(8) VALUE 'ZEN01TPN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01TPN-001.
               CALL 'ZEN01TPN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01TPN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
