      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00SAI'.
      ...
      * Called module names
       01  MOD-ZEN01UTK              PIC X(8) VALUE 'ZEN01UTK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01UTK-001.
               PERFORM CALL-ZEN01TUS-002.
               PERFORM CALL-ZHO0255M-003.
               PERFORM VALIDATE-VALUE-0001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZEN01UTK-001.
               CALL 'ZEN01UTK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01UTK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01TUS-002.
