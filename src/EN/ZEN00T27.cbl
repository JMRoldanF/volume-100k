      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00T27'.
      ...
      * Called module names
       01  MOD-ZEN01UAH              PIC X(8) VALUE 'ZEN01UAH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01UAH-001.
               CALL 'ZEN01UAH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01UAH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
