      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN0220V'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01F07              PIC X(8) VALUE 'ZEN01F07'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01LGF-001.
               PERFORM CALL-ZEN01UG1-002.
               PERFORM CALL-ZEN01G8D-003.
               PERFORM CALL-ZEN01F07-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01F07-004.
               CALL 'ZEN01F07' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01F07 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
