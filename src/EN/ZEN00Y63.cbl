      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00Y63'.
      ...
      * Called module names
       01  MOD-ZRE01GS7              PIC X(8) VALUE 'ZRE01GS7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01GS7-001.
               PERFORM CALL-ZEN01P39-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01GS7-001.
               CALL 'ZRE01GS7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01GS7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01P39-002.
