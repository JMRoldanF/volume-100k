      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00WS3'.
      ...
      * Called module names
       01  MOD-ZEN01SLX              PIC X(8) VALUE 'ZEN01SLX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01SLX-001.
               CALL 'ZEN01SLX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01SLX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-EXCESS-0001.
