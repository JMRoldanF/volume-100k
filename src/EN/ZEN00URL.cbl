      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00URL'.
      ...
      * Called module names
       01  MOD-ZCL01GJ9              PIC X(8) VALUE 'ZCL01GJ9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01GJ9-001.
               CALL 'ZCL01GJ9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01GJ9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
