      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00M46'.
      ...
      * Called module names
       01  MOD-ZEN01RL3              PIC X(8) VALUE 'ZEN01RL3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01RL3-001.
               CALL 'ZEN01RL3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01RL3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01PJN-002.
