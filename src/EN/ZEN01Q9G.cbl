      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN01Q9G'.
      ...
      * Called module names
       01  MOD-ZEN01HYJ              PIC X(8) VALUE 'ZEN01HYJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01HYJ-001.
               CALL 'ZEN01HYJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01HYJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-EXCESS-0001.
