      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00YO4'.
      ...
      * Called module names
       01  MOD-ZEN01POI              PIC X(8) VALUE 'ZEN01POI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01POI-002.
               CALL 'ZEN01POI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01POI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
