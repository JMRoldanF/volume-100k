      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00XR8'.
      ...
      * Called module names
       01  MOD-ZEN01L4N              PIC X(8) VALUE 'ZEN01L4N'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01L4N-001.
               CALL 'ZEN01L4N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01L4N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-MODEL-0001.
