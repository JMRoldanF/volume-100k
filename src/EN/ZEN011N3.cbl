      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN011N3'.
      ...
      * Called module names
       01  MOD-ZRE01Q05              PIC X(8) VALUE 'ZRE01Q05'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01Q05-001.
               PERFORM CALL-ZEN01NOF-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01Q05-001.
               CALL 'ZRE01Q05' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01Q05 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01NOF-002.
