      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN01C6N'.
      ...
      * Called module names
       01  MOD-ZAV01O5V              PIC X(8) VALUE 'ZAV01O5V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01O5V-001.
               CALL 'ZAV01O5V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
