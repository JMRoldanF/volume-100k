      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00WU5'.
      ...
      * Called module names
       01  MOD-ZEN01T21              PIC X(8) VALUE 'ZEN01T21'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01T21-001.
               PERFORM CALL-ZAV01O5M-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01T21-001.
               CALL 'ZEN01T21' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01T21 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAV01O5M-002.
