      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00SBV'.
      ...
      * Called module names
       01  MOD-ZEN01T0F              PIC X(8) VALUE 'ZEN01T0F'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01T0F-001.
               CALL 'ZEN01T0F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01T0F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
