      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00XAN'.
      ...
      * Called module names
       01  MOD-ZEN01USM              PIC X(8) VALUE 'ZEN01USM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01USM-001.
               CALL 'ZEN01USM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01USM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
