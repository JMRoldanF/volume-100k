      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN003RN'.
      ...
      * Called module names
       01  MOD-ZEN00J4F              PIC X(8) VALUE 'ZEN00J4F'.
       01  MOD-ZEN00BZR              PIC X(8) VALUE 'ZEN00BZR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN00J4F-001.
               PERFORM CALL-ZEN00BZR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN00J4F-001.
               EXEC CICS LINK PROGRAM('ZEN00J4F')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN00J4F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN00BZR-002.
               EXEC CICS LINK PROGRAM('ZEN00BZR')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN00BZR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
