      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN0105D'.
      ...
      * Called module names
       01  MOD-ZEN01U3T              PIC X(8) VALUE 'ZEN01U3T'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01U3T-001.
               CALL 'ZEN01U3T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01U3T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01UOL-002.
