      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00RQP'.
      ...
      * Called module names
       01  MOD-ZHO01TES              PIC X(8) VALUE 'ZHO01TES'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01TES-001.
               CALL 'ZHO01TES' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01TES FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
