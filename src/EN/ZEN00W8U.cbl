      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00W8U'.
      ...
      * Called module names
       01  MOD-ZEN01QNJ              PIC X(8) VALUE 'ZEN01QNJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01QNJ-001.
               CALL 'ZEN01QNJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01QNJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
