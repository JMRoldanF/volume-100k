      ...
      * Called module names
       01  MOD-ZEN01O6M              PIC X(8) VALUE 'ZEN01O6M'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01KK9-001.
               PERFORM CALL-ZEN01O6M-002.
               PERFORM CALL-ZCL0255P-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZEN01KK9-001.
               MOVE 'ZEN01KK9' TO WS-SUBNAME-6
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01O6M-002.
               CALL 'ZEN01O6M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01O6M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
