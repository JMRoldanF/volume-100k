      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00X4L'.
      ...
      * Called module names
       01  MOD-ZEN01LKL              PIC X(8) VALUE 'ZEN01LKL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01LKL-001.
               CALL 'ZEN01LKL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01LKL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
