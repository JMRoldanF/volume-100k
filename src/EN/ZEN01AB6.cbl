      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN01AB6'.
      ...
      * Called module names
       01  MOD-ZEN01HDA              PIC X(8) VALUE 'ZEN01HDA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01HDA-001.
               CALL 'ZEN01HDA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01HDA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
