      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00PBK'.
      ...
      * Called module names
       01  MOD-ZTR01UYW              PIC X(8) VALUE 'ZTR01UYW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01UYW-001.
               CALL 'ZTR01UYW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01UYW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
