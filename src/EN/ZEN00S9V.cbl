      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00S9V'.
      ...
      * Called module names
       01  MOD-ZPA01Q0H              PIC X(8) VALUE 'ZPA01Q0H'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01Q0H-001.
               PERFORM CALL-ZEN01MJB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01Q0H-001.
               CALL 'ZPA01Q0H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
