      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00WG0'.
      ...
      * Called module names
       01  MOD-ZEN01NVI              PIC X(8) VALUE 'ZEN01NVI'.
       01  MOD-ZEN01HC9              PIC X(8) VALUE 'ZEN01HC9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01NVI-001.
               PERFORM CALL-ZEN01HC9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01NVI-001.
               CALL 'ZEN01NVI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01NVI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01HC9-002.
               CALL 'ZEN01HC9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01HC9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
