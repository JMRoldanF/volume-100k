      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00UWJ'.
      ...
      * Called module names
       01  MOD-ZEN01O44              PIC X(8) VALUE 'ZEN01O44'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01O44-001.
               CALL 'ZEN01O44' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01O44 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
