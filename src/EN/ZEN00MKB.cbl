      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00MKB'.
      ...
      * Called module names
       01  MOD-ZBI01Q2C              PIC X(8) VALUE 'ZBI01Q2C'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01Q2C-001.
               CALL 'ZBI01Q2C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01Q2C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
