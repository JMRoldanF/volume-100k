      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00WXX'.
      ...
      * Called module names
       01  MOD-ZHO01JYS              PIC X(8) VALUE 'ZHO01JYS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01JYS-001.
               CALL 'ZHO01JYS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01JYS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
