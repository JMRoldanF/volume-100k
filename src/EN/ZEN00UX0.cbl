      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00UX0'.
      ...
      * Called module names
       01  MOD-ZEN01PJI              PIC X(8) VALUE 'ZEN01PJI'.
       01  MOD-ZEN01LN9              PIC X(8) VALUE 'ZEN01LN9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01PJI-001.
               PERFORM CALL-ZEN01LN9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01PJI-001.
               CALL 'ZEN01PJI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01PJI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01LN9-002.
               CALL 'ZEN01LN9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01LN9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
