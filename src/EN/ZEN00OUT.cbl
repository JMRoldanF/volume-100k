      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00OUT'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01FON              PIC X(8) VALUE 'ZEN01FON'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01ISV-001.
               PERFORM CALL-ZEN01FON-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01FON-002.
               CALL 'ZEN01FON' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
