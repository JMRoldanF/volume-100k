      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00XT7'.
      ...
      * Called module names
       01  MOD-ZAV01F74              PIC X(8) VALUE 'ZAV01F74'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAV01F74-001.
               PERFORM CALL-ZEN01PS2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01F74-001.
               CALL 'ZAV01F74' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01F74 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01PS2-002.
