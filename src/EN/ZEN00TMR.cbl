      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00TMR'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01S8L              PIC X(8) VALUE 'ZEN01S8L'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01S8L-002.
               CALL 'ZEN01S8L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01S8L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
