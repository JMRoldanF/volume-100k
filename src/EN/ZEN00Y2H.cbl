      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00Y2H'.
      ...
      * Called module names
       01  MOD-ZEN01I8V              PIC X(8) VALUE 'ZEN01I8V'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01I8V-001.
               PERFORM CALL-ZEN01TB7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01I8V-001.
               CALL 'ZEN01I8V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01I8V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01TB7-002.
