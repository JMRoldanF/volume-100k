      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00VKH'.
      ...
      * Called module names
       01  MOD-ZPA01SS7              PIC X(8) VALUE 'ZPA01SS7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01SS7-001.
               CALL 'ZPA01SS7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01SS7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01MQ9-002.
