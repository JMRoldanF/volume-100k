      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00Q1B'.
      ...
      * Called module names
       01  MOD-ZEN01JTJ              PIC X(8) VALUE 'ZEN01JTJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01JTJ-001.
               CALL 'ZEN01JTJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01JTJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
