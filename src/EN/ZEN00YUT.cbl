      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00YUT'.
      ...
      * Called module names
       01  MOD-ZEN01NXV              PIC X(8) VALUE 'ZEN01NXV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01NXV-001.
               CALL 'ZEN01NXV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01NXV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01U2Z-002.
