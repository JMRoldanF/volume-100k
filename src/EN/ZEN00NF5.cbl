      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00NF5'.
      ...
      * Called module names
       01  MOD-ZEN01DSL              PIC X(8) VALUE 'ZEN01DSL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01DSL-001.
               CALL 'ZEN01DSL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01DSL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
