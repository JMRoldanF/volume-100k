      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00R9L'.
      ...
      * Called module names
       01  MOD-ZEN01SWD              PIC X(8) VALUE 'ZEN01SWD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01SWD-001.
               CALL 'ZEN01SWD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01SWD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-MAKE-0001.
