      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00MX9'.
      ...
      * Called module names
       01  MOD-ZEN01RRF              PIC X(8) VALUE 'ZEN01RRF'.
       01  MOD-ZEN01QN1              PIC X(8) VALUE 'ZEN01QN1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01RRF-001.
               PERFORM CALL-ZEN01QN1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01RRF-001.
               CALL 'ZEN01RRF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01RRF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01QN1-002.
               CALL 'ZEN01QN1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01QN1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
