      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00TOZ'.
      ...
      * Called module names
       01  MOD-ZEN01JJT              PIC X(8) VALUE 'ZEN01JJT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01JJT-001.
               PERFORM CALL-ZEN01SDB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01JJT-001.
               CALL 'ZEN01JJT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01JJT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01SDB-002.
