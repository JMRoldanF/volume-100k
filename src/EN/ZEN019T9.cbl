      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN019T9'.
      ...
      * Called module names
       01  MOD-ZEN01J0X              PIC X(8) VALUE 'ZEN01J0X'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01J0X-001.
               CALL 'ZEN01J0X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01J0X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-EQUITIES-0001.
