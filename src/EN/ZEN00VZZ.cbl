      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00VZZ'.
      ...
      * Called module names
       01  MOD-ZEN01N69              PIC X(8) VALUE 'ZEN01N69'.
       01  MOD-ZEN01TCF              PIC X(8) VALUE 'ZEN01TCF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01N69-001.
               PERFORM CALL-ZEN01TCF-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01N69-001.
               CALL 'ZEN01N69' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01N69 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01TCF-002.
               CALL 'ZEN01TCF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01TCF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
