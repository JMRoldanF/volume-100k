      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00UE9'.
      ...
      * Called module names
       01  MOD-ZEN01RWN              PIC X(8) VALUE 'ZEN01RWN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01RWN-001.
               CALL 'ZEN01RWN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01RWN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
