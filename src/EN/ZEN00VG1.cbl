      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00VG1'.
      ...
      * Called module names
       01  MOD-ZEN01JVH              PIC X(8) VALUE 'ZEN01JVH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01JVH-001.
               PERFORM CALL-ZEN01LXD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01JVH-001.
               CALL 'ZEN01JVH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01JVH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01LXD-002.
