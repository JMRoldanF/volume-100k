      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN0162F'.
      ...
      * Called module names
       01  MOD-ZEN01DQ7              PIC X(8) VALUE 'ZEN01DQ7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01DQ7-001.
               PERFORM CALL-ZLB01E12-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01DQ7-001.
               CALL 'ZEN01DQ7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01DQ7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLB01E12-002.
