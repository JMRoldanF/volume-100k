      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00PHB'.
      ...
      * Called module names
       01  MOD-ZEN01HUP              PIC X(8) VALUE 'ZEN01HUP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01HUP-001.
               CALL 'ZEN01HUP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01HUP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
