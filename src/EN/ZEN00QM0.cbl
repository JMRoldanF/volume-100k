      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00QM0'.
      ...
      * Called module names
       01  MOD-ZEN01M9R              PIC X(8) VALUE 'ZEN01M9R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01M9R-001.
               CALL 'ZEN01M9R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01M9R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-COLOUR-0001.
