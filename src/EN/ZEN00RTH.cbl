      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00RTH'.
      ...
      * Called module names
       01  MOD-ZEN01HS7              PIC X(8) VALUE 'ZEN01HS7'.
       01  MOD-ZEN01JXF              PIC X(8) VALUE 'ZEN01JXF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01HS7-001.
               PERFORM CALL-ZEN01JXF-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01HS7-001.
               CALL 'ZEN01HS7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01HS7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01JXF-002.
               CALL 'ZEN01JXF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01JXF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       VALIDATE-VALUE-0001.
