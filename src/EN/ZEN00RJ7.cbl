      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00RJ7'.
      ...
      * Called module names
       01  MOD-ZEN01U9N              PIC X(8) VALUE 'ZEN01U9N'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01U9N-001.
               CALL 'ZEN01U9N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01U9N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-VALUE-0001.
