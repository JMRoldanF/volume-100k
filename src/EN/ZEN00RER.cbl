      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00RER'.
      ...
      * Called module names
       01  MOD-ZEN01L01              PIC X(8) VALUE 'ZEN01L01'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01L01-001.
               CALL 'ZEN01L01' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01L01 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
