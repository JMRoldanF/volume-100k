      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00X9F'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01TXT              PIC X(8) VALUE 'ZEN01TXT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAV01Q0F-001.
               PERFORM CALL-ZEN01TXT-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01TXT-002.
               CALL 'ZEN01TXT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01TXT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       WRITE-ERROR-MESSAGE.
