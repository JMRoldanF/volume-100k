      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00MS1'.
      ...
      * Called module names
       01  MOD-ZEN01EU4              PIC X(8) VALUE 'ZEN01EU4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01EU4-001.
               PERFORM CALL-ZEN01O1A-002.
               ...
               PERFORM REFRESH-TAX-BAND-0065.
               PERFORM SQL-ACCESS-0066.
               PERFORM AUDIT-PREMIUM-0067.
               ...
               PERFORM REFRESH-AGENT-CODE-0107.
               PERFORM SQL-ACCESS-0108.
               PERFORM APPLY-TAX-BAND-0109.
               PERFORM VALIDATE-COLOUR-0110.
               PERFORM SQL-ACCESS-0111.
               PERFORM RECONCILE-CC-RATING-0112.
               PERFORM COMPUTE-AGENT-CODE-0113.
               PERFORM SQL-ACCESS-0114.
               PERFORM REFRESH-STATUS-CODE-0115.
               ...
               PERFORM VALIDATE-MODEL-0124.
               PERFORM AUDIT-POSTCODE-0125.
               PERFORM SQL-ACCESS-0126.
               PERFORM REFRESH-WITH-PROFITS-0127.
               PERFORM APPLY-EQUITIES-0128.
               ...
               PERFORM REFRESH-STATUS-CODE-0134.
               PERFORM SQL-ACCESS-0135.
               PERFORM CHECK-TERM-0136.
               PERFORM AUDIT-SUM-ASSURED-0137.
               PERFORM SQL-ACCESS-0138.
               PERFORM VALIDATE-HOUSE-TYPE-0139.
               PERFORM APPLY-BROKER-ID-0140.
               PERFORM SQL-ACCESS-0141.
               PERFORM NORMALISE-BEDROOMS-0142.
               PERFORM AUDIT-SUM-ASSURED-0143.
               PERFORM SQL-ACCESS-0144.
               PERFORM DERIVE-VALUE-0145.
               PERFORM SQL-ACCESS-0147.
               PERFORM RESOLVE-PREMIUM-0148.
               PERFORM APPLY-PREMIUM-0149.
               PERFORM SQL-ACCESS-0150.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZEN01EU4-001.
               CALL 'ZEN01EU4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01EU4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01O1A-002.
               MOVE 'ZEN01O1A' TO WS-SUBNAME-5
               CALL WS-SUBNAME-5 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01O1A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
      ...
      *----------------------------------------------------------------*
       VALIDATE-HOUSE-TYPE-0139.
               INSPECT WS-KEY-CHAR REPLACING ALL SPACES BY '0'.
               IF WS-STATUS-FAILED
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-BROKER-ID-0140.
