      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00Y1L'.
      ...
      * Called module names
       01  MOD-ZEN01K0H              PIC X(8) VALUE 'ZEN01K0H'.
       01  MOD-ZEN01MJU              PIC X(8) VALUE 'ZEN01MJU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01K0H-001.
               PERFORM CALL-ZEN01MJU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01K0H-001.
               CALL 'ZEN01K0H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01K0H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01MJU-002.
               CALL 'ZEN01MJU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01MJU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-TERM-0001.
