      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN005E1'.
      ...
      * Called module names
       01  MOD-ZEN0085D              PIC X(8) VALUE 'ZEN0085D'.
       01  MOD-ZEN00J12              PIC X(8) VALUE 'ZEN00J12'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN00DRM-001.
               MOVE 'ZEN00DRM' TO WS-PROGNAME-7
      ...
      *----------------------------------------------------------------*
       CALL-ZEN0085D-002.
               EXEC CICS LINK PROGRAM('ZEN0085D')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN00J12-003.
               EXEC CICS LINK PROGRAM('ZEN00J12')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN00J12 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-004.
