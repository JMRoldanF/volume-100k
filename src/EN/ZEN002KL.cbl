      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN002KL'.
      ...
      * Called module names
       01  MOD-ZEN00BPR              PIC X(8) VALUE 'ZEN00BPR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN00HK1-002.
               PERFORM CALL-ZEN0086T-003.
               PERFORM CALL-ZEN00693-004.
               PERFORM CALL-ZHO0060G-005.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN00BPR-001.
               EXEC CICS LINK PROGRAM('ZEN00BPR')
      ...
      *----------------------------------------------------------------*
       CALL-ZEN00HK1-002.
               MOVE 'ZEN00HK1' TO WS-PROGNAME-1
      ...
      *----------------------------------------------------------------*
       CALL-ZEN0086T-003.
               MOVE 'ZEN0086T' TO WS-PROGNAME-2
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN0086T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN00693-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO0060G-005.
               EXEC CICS START TRANSID('Z60G')
                         ...
                         RESP(WS-RESP)
               END-EXEC.
      * TRANSID Z60G is defined against ZHO0060G
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO0060G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-COLOUR-0001.
