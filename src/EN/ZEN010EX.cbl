      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN010EX'.
      ...
      * Called module names
       01  MOD-ZEN01SAT              PIC X(8) VALUE 'ZEN01SAT'.
       01  MOD-ZEN01FRF              PIC X(8) VALUE 'ZEN01FRF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01SAT-001.
               PERFORM CALL-ZEN01FRF-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01SAT-001.
               CALL 'ZEN01SAT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01SAT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01FRF-002.
               CALL 'ZEN01FRF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
