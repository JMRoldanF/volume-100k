      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00N9B'.
      ...
      * Called module names
       01  MOD-ZEN01KPR              PIC X(8) VALUE 'ZEN01KPR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01KPR-001.
               CALL 'ZEN01KPR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01KPR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
