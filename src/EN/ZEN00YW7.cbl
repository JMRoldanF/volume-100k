      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00YW7'.
      ...
      * Called module names
       01  MOD-ZEN01NU9              PIC X(8) VALUE 'ZEN01NU9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01NU9-001.
               CALL 'ZEN01NU9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01NU9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
