      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN011JS'.
      ...
      * Called module names
       01  MOD-ZEN01CQB              PIC X(8) VALUE 'ZEN01CQB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01CQB-001.
               CALL 'ZEN01CQB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01CQB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
