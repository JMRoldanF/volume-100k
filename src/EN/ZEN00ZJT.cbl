      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00ZJT'.
      ...
      * Called module names
       01  MOD-ZEN01F2F              PIC X(8) VALUE 'ZEN01F2F'.
       01  MOD-ZEN01JTT              PIC X(8) VALUE 'ZEN01JTT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01F2F-001.
               PERFORM CALL-ZEN01JTT-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01F2F-001.
               CALL 'ZEN01F2F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01F2F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01JTT-002.
               CALL 'ZEN01JTT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01JTT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
