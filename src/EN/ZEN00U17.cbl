      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00U17'.
      ...
      * Called module names
       01  MOD-ZEN01HDH              PIC X(8) VALUE 'ZEN01HDH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01HDH-001.
               CALL 'ZEN01HDH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01HDH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
