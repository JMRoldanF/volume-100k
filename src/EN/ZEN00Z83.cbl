      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00Z83'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01NRW              PIC X(8) VALUE 'ZEN01NRW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01P0R-001.
               PERFORM CALL-ZEN01NRW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01NRW-002.
               CALL 'ZEN01NRW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01NRW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
