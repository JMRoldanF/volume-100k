      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN017TR'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01O9E              PIC X(8) VALUE 'ZEN01O9E'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01TVW-001.
               PERFORM CALL-ZEN01O9E-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01O9E-002.
               CALL 'ZEN01O9E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01O9E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
