      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00Q6P'.
      ...
      * Called module names
       01  MOD-ZEN01QP0              PIC X(8) VALUE 'ZEN01QP0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01QP0-001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZEN01QP0-001.
               CALL 'ZEN01QP0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
