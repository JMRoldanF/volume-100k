      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN010Y3'.
      ...
      * Called module names
       01  MOD-ZEN01FHZ              PIC X(8) VALUE 'ZEN01FHZ'.
       01  MOD-ZEN01CSH              PIC X(8) VALUE 'ZEN01CSH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01FHZ-001.
               PERFORM CALL-ZEN01CSH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01FHZ-001.
               CALL 'ZEN01FHZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01FHZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01CSH-002.
               CALL 'ZEN01CSH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01CSH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
