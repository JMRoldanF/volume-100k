      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN017D7'.
      ...
      * Called module names
       01  MOD-ZEN01UVL              PIC X(8) VALUE 'ZEN01UVL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01UVL-001.
               CALL 'ZEN01UVL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01UVL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
