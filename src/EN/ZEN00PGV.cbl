      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00PGV'.
      ...
      * Called module names
       01  MOD-ZEN01PC6              PIC X(8) VALUE 'ZEN01PC6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01PC6-001.
               CALL 'ZEN01PC6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01PC6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01DT5-002.
