      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN015FH'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01QES              PIC X(8) VALUE 'ZCU01QES'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01HK5-001.
               PERFORM CALL-ZCU01QES-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01QES-002.
               CALL 'ZCU01QES' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01QES FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
