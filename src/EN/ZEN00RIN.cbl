      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00RIN'.
      ...
      * Called module names
       01  MOD-ZEN01GJH              PIC X(8) VALUE 'ZEN01GJH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01GJH-001.
               CALL 'ZEN01GJH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01GJH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01QM9-002.
