      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN001CZ'.
      ...
      * Called module names
       01  MOD-ZMT007M7              PIC X(8) VALUE 'ZMT007M7'.
       01  MOD-ZEN00KRV              PIC X(8) VALUE 'ZEN00KRV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT007M7-001.
               PERFORM CALL-ZEN006IT-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT007M7-001.
               EXEC CICS LINK PROGRAM('ZMT007M7')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT007M7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN00KRV-002.
               EXEC CICS LINK PROGRAM('ZEN00KRV')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN00KRV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN006IT-003.
               MOVE 'ZEN006IT' TO WS-PROGNAME-4
