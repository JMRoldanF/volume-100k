      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00RZ1'.
      ...
      * Called module names
       01  MOD-ZEN01U7Z              PIC X(8) VALUE 'ZEN01U7Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01U7Z-001.
               CALL 'ZEN01U7Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01U7Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01RAR-002.
               MOVE 'ZCL01RAR' TO WS-SUBNAME-4
