      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00VIT'.
      ...
      * Called module names
       01  MOD-ZEN01DLN              PIC X(8) VALUE 'ZEN01DLN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01DLN-001.
               PERFORM CALL-ZEN01TC1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01DLN-001.
               CALL 'ZEN01DLN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01DLN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01TC1-002.
