      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN011WT'.
      ...
      * Called module names
       01  MOD-ZBI01KPK              PIC X(8) VALUE 'ZBI01KPK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01KPK-001.
               PERFORM CALL-ZEN01FZH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01KPK-001.
               CALL 'ZBI01KPK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01KPK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01FZH-002.
