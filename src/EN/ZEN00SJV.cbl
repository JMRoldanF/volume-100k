      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00SJV'.
      ...
      * Called module names
       01  MOD-ZEN01M4V              PIC X(8) VALUE 'ZEN01M4V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01M4V-001.
               CALL 'ZEN01M4V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01M4V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01RPS-002.
