      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00TLX'.
      ...
      * Called module names
       01  MOD-ZEN01FK7              PIC X(8) VALUE 'ZEN01FK7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01FK7-001.
               CALL 'ZEN01FK7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01FK7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01I8K-002.
