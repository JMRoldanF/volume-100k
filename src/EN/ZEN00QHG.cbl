      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00QHG'.
      ...
      * Called module names
       01  MOD-ZEN01M22              PIC X(8) VALUE 'ZEN01M22'.
       01  MOD-ZEN01QKU              PIC X(8) VALUE 'ZEN01QKU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01M22-001.
               PERFORM CALL-ZEN01QKU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01M22-001.
               CALL 'ZEN01M22' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01M22 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01QKU-002.
               CALL 'ZEN01QKU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01QKU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
