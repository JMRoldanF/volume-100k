      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00O63'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01CNR              PIC X(8) VALUE 'ZEN01CNR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01CNR-002.
               CALL 'ZEN01CNR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
