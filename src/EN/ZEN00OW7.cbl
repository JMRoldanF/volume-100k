      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00OW7'.
      ...
      * Called module names
       01  MOD-ZEN01U7F              PIC X(8) VALUE 'ZEN01U7F'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01U7F-001.
               PERFORM CALL-ZRE01LAF-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01U7F-001.
               CALL 'ZEN01U7F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01U7F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01LAF-002.
