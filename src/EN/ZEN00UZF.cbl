      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00UZF'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01CW1              PIC X(8) VALUE 'ZEN01CW1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTR01J59-001.
               PERFORM CALL-ZEN01CW1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01CW1-002.
               CALL 'ZEN01CW1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01CW1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
