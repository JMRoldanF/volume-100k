      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00N19'.
      ...
      * Called module names
       01  MOD-ZEN01LBZ              PIC X(8) VALUE 'ZEN01LBZ'.
       01  MOD-ZCU01FJE              PIC X(8) VALUE 'ZCU01FJE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01LBZ-001.
               PERFORM CALL-ZCU01FJE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01LBZ-001.
               CALL 'ZEN01LBZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01LBZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01FJE-002.
               CALL 'ZCU01FJE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01FJE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
