      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00Z5N'.
      ...
      * Called module names
       01  MOD-ZBI01DO8              PIC X(8) VALUE 'ZBI01DO8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01DO8-001.
               CALL 'ZBI01DO8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01EAD-002.
               MOVE 'ZEN01EAD' TO WS-SUBNAME-3
               CALL WS-SUBNAME-3 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01EAD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
