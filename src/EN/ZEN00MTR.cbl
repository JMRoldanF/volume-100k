      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00MTR'.
      ...
      * Called module names
       01  MOD-ZEN01PXJ              PIC X(8) VALUE 'ZEN01PXJ'.
       01  MOD-ZEN01DN1              PIC X(8) VALUE 'ZEN01DN1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01PXJ-001.
               PERFORM CALL-ZEN01DN1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01PXJ-001.
               CALL 'ZEN01PXJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01PXJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01DN1-002.
               CALL 'ZEN01DN1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01DN1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
