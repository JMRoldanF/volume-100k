      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00FJT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTR01EVJ-002.
               PERFORM CALL-ZAV01HA8-003.
               PERFORM CALL-ZEN0255N-004.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZEN00TVF-001.
               MOVE 'ZEN00TVF' TO WS-PROGNAME-4
