      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00V4B'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01D65              PIC X(8) VALUE 'ZEN01D65'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAV01MNX-001.
               PERFORM CALL-ZEN01D65-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01D65-002.
               CALL 'ZEN01D65' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01D65 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
