      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN0159K'.
      ...
      * Called module names
       01  MOD-ZLB01IZD              PIC X(8) VALUE 'ZLB01IZD'.
       01  MOD-ZEN01NVR              PIC X(8) VALUE 'ZEN01NVR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLB01IZD-001.
               PERFORM CALL-ZEN01NVR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01IZD-001.
               CALL 'ZLB01IZD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01IZD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01NVR-002.
               CALL 'ZEN01NVR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01NVR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
