      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN010ZP'.
      ...
      * Called module names
       01  MOD-ZTR01F2X              PIC X(8) VALUE 'ZTR01F2X'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01F2X-001.
               CALL 'ZTR01F2X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01F2X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
