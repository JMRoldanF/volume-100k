      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00VLN'.
      ...
      * Called module names
       01  MOD-ZTR01H1U              PIC X(8) VALUE 'ZTR01H1U'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01H1U-001.
               CALL 'ZTR01H1U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01H1U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
