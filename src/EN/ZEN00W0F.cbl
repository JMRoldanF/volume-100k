      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00W0F'.
      ...
      * Called module names
       01  MOD-ZEN01UIB              PIC X(8) VALUE 'ZEN01UIB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01UIB-001.
               CALL 'ZEN01UIB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01UIB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
