      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00U51'.
      ...
      * Called module names
       01  MOD-ZEN01R93              PIC X(8) VALUE 'ZEN01R93'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01R93-001.
               CALL 'ZEN01R93' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01R93 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
