      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN011KB'.
      ...
      * Called module names
       01  MOD-ZEN01FST              PIC X(8) VALUE 'ZEN01FST'.
       01  MOD-ZUW01FIQ              PIC X(8) VALUE 'ZUW01FIQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01FST-001.
               PERFORM CALL-ZUW01FIQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01FST-001.
               CALL 'ZEN01FST' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01FST FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01FIQ-002.
               CALL 'ZUW01FIQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01FIQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
