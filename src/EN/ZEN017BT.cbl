      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN017BT'.
      ...
      * Called module names
       01  MOD-ZEN01DGD              PIC X(8) VALUE 'ZEN01DGD'.
       01  MOD-ZEN01H9B              PIC X(8) VALUE 'ZEN01H9B'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01DGD-001.
               PERFORM CALL-ZEN01H9B-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01DGD-001.
               CALL 'ZEN01DGD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01DGD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01H9B-002.
               CALL 'ZEN01H9B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01H9B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
