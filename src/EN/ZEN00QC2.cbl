      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00QC2'.
      ...
      * Called module names
       01  MOD-ZEN01N3M              PIC X(8) VALUE 'ZEN01N3M'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01N3M-001.
               PERFORM CALL-ZEN01R3N-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01N3M-001.
               CALL 'ZEN01N3M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01N3M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01R3N-002.
