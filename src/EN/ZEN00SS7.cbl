      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00SS7'.
      ...
      * Called module names
       01  MOD-ZEN01HV9              PIC X(8) VALUE 'ZEN01HV9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01HV9-001.
               CALL 'ZEN01HV9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01HV9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
