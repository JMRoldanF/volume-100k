      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00KIL'.
      ...
      * Called module names
       01  MOD-ZAV010PJ              PIC X(8) VALUE 'ZAV010PJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV010PJ-001.
               EXEC CICS LINK PROGRAM('ZAV010PJ')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV010PJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
