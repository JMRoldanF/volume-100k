      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN011FT'.
      ...
      * Called module names
       01  MOD-ZEN01IQT              PIC X(8) VALUE 'ZEN01IQT'.
       01  MOD-ZAV01D3P              PIC X(8) VALUE 'ZAV01D3P'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01IQT-001.
               PERFORM CALL-ZAV01D3P-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01IQT-001.
               CALL 'ZEN01IQT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01IQT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAV01D3P-002.
               CALL 'ZAV01D3P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
