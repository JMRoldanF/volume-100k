      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00X2X'.
      ...
      * Called module names
       01  MOD-ZEN01OVR              PIC X(8) VALUE 'ZEN01OVR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01OVR-001.
               CALL 'ZEN01OVR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01OVR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
