      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00X19'.
      ...
      * Called module names
       01  MOD-ZEN01D3B              PIC X(8) VALUE 'ZEN01D3B'.
       01  MOD-ZEN01KCP              PIC X(8) VALUE 'ZEN01KCP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01D3B-001.
               PERFORM CALL-ZEN01KCP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01D3B-001.
               CALL 'ZEN01D3B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01D3B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01KCP-002.
               CALL 'ZEN01KCP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01KCP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
