      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00W29'.
      ...
      * Called module names
       01  MOD-ZEN01SC7              PIC X(8) VALUE 'ZEN01SC7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01SC7-001.
               CALL 'ZEN01SC7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01SC7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
