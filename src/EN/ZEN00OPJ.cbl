      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00OPJ'.
      ...
      * Called module names
       01  MOD-ZRE01NQ7              PIC X(8) VALUE 'ZRE01NQ7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01NQ7-001.
               CALL 'ZRE01NQ7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01NQ7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
