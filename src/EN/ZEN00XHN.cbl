      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00XHN'.
      ...
      * Called module names
       01  MOD-ZEN01L0V              PIC X(8) VALUE 'ZEN01L0V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01L0V-001.
               CALL 'ZEN01L0V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01L0V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
