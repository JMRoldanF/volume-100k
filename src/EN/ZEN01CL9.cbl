      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN01CL9'.
      ...
      * Called module names
       01  MOD-ZEN01S8B              PIC X(8) VALUE 'ZEN01S8B'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01S8B-001.
               CALL 'ZEN01S8B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01S8B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
