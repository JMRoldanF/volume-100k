      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN011CJ'.
      ...
      * Called module names
       01  MOD-ZEN01KCF              PIC X(8) VALUE 'ZEN01KCF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01KCF-001.
               CALL 'ZEN01KCF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01KCF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
