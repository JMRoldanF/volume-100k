      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00W97'.
      ...
      * Called module names
       01  MOD-ZEN01D2H              PIC X(8) VALUE 'ZEN01D2H'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01D2H-001.
               CALL 'ZEN01D2H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01D2H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
