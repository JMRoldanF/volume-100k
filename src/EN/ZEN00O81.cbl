      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00O81'.
      ...
      * Called module names
       01  MOD-ZAG01M82              PIC X(8) VALUE 'ZAG01M82'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01M82-001.
               CALL 'ZAG01M82' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01M82 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
