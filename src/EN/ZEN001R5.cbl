      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN001R5'.
      ...
      * Called module names
       01  MOD-ZCU00KR2              PIC X(8) VALUE 'ZCU00KR2'.
       01  MOD-ZCU00D3S              PIC X(8) VALUE 'ZCU00D3S'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU00KR2-001.
               EXEC CICS LINK PROGRAM('ZCU00KR2')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00KR2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU00D3S-002.
               EXEC CICS LINK PROGRAM('ZCU00D3S')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00D3S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
