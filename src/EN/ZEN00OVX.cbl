      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00OVX'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01OL7              PIC X(8) VALUE 'ZEN01OL7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01OL7-002.
               CALL 'ZEN01OL7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01OL7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-BEDROOMS-0001.
