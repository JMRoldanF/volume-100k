      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00TJ5'.
      ...
      * Called module names
       01  MOD-ZEN01JUD              PIC X(8) VALUE 'ZEN01JUD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01JUD-001.
               CALL 'ZEN01JUD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01JUD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
