      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00U49'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01IQX              PIC X(8) VALUE 'ZEN01IQX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01IQX-002.
               CALL 'ZEN01IQX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01IQX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
