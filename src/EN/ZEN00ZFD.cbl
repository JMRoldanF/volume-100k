      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00ZFD'.
      ...
      * Called module names
       01  MOD-ZEN01J49              PIC X(8) VALUE 'ZEN01J49'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01J49-001.
               CALL 'ZEN01J49' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01J49 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
