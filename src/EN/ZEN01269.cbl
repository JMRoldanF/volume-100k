      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN01269'.
      ...
      * Called module names
       01  MOD-ZEN01FE3              PIC X(8) VALUE 'ZEN01FE3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01FE3-001.
               CALL 'ZEN01FE3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01FE3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
