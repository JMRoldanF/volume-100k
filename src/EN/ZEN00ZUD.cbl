      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00ZUD'.
      ...
      * Called module names
       01  MOD-ZEN01GNX              PIC X(8) VALUE 'ZEN01GNX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01GNX-001.
               CALL 'ZEN01GNX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01GNX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
