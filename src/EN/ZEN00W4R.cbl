      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00W4R'.
      ...
      * Called module names
       01  MOD-ZEN01G9R              PIC X(8) VALUE 'ZEN01G9R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01G9R-002.
               CALL 'ZEN01G9R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01G9R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
