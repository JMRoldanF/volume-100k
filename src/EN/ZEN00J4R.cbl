      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00J4R'.
      ...
      * Called module names
       01  MOD-ZEN00YU4              PIC X(8) VALUE 'ZEN00YU4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN00YU4-001.
               PERFORM CALL-ZEN01AJW-003.
               PERFORM CALL-ZEN01U6A-004.
               PERFORM CALL-ZEN01NK7-005.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN00YU4-001.
               EXEC CICS LINK PROGRAM('ZEN00YU4')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN00YU4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN00XX2-002.
