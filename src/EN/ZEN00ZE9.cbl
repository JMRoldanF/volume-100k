      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00ZE9'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01F93              PIC X(8) VALUE 'ZEN01F93'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01P43-001.
               PERFORM CALL-ZEN01F93-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01F93-002.
               CALL 'ZEN01F93' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01F93 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
