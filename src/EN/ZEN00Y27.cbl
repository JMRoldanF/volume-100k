      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00Y27'.
      ...
      * Called module names
       01  MOD-ZEN01QND              PIC X(8) VALUE 'ZEN01QND'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01QND-001.
               PERFORM CALL-ZEN01RD7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01QND-001.
               CALL 'ZEN01QND' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01QND FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01RD7-002.
