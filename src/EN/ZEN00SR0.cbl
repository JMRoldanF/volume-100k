      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00SR0'.
      ...
      * Called module names
       01  MOD-ZEN01TXN              PIC X(8) VALUE 'ZEN01TXN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01TXN-001.
               PERFORM CALL-ZEN01EU4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01TXN-001.
               CALL 'ZEN01TXN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01TXN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01EU4-002.
