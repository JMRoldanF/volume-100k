      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00U5X'.
      ...
      * Called module names
       01  MOD-ZEN01D4Z              PIC X(8) VALUE 'ZEN01D4Z'.
       01  MOD-ZEN01GZB              PIC X(8) VALUE 'ZEN01GZB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01D4Z-001.
               PERFORM CALL-ZEN01GZB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01D4Z-001.
               CALL 'ZEN01D4Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01D4Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01GZB-002.
               CALL 'ZEN01GZB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
