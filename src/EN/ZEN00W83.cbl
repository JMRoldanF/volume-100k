      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00W83'.
      ...
      * Called module names
       01  MOD-ZEN01S5T              PIC X(8) VALUE 'ZEN01S5T'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01S5T-001.
               CALL 'ZEN01S5T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01S5T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01QY7-002.
