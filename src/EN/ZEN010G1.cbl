      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN010G1'.
      ...
      * Called module names
       01  MOD-ZEN01NOZ              PIC X(8) VALUE 'ZEN01NOZ'.
       01  MOD-ZEN01G8X              PIC X(8) VALUE 'ZEN01G8X'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01NOZ-001.
               CALL 'ZEN01NOZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01NOZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01G8X-002.
               CALL 'ZEN01G8X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01G8X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-MODEL-0001.
