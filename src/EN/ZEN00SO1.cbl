      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00SO1'.
      ...
      * Called module names
       01  MOD-ZEN01EDZ              PIC X(8) VALUE 'ZEN01EDZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01EDZ-001.
               CALL 'ZEN01EDZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01EDZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
