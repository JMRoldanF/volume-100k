      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN010ON'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01H87              PIC X(8) VALUE 'ZEN01H87'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01H87-002.
               CALL 'ZEN01H87' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
