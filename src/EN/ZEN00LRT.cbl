      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00LRT'.
      ...
      * Called module names
       01  MOD-ZEN01G19              PIC X(8) VALUE 'ZEN01G19'.
       01  MOD-ZEN01T66              PIC X(8) VALUE 'ZEN01T66'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01G19-001.
               PERFORM CALL-ZEN01T66-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01G19-001.
               CALL 'ZEN01G19' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01G19 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01T66-002.
               CALL 'ZEN01T66' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01T66 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
