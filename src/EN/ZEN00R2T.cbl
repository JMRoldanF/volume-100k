      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00R2T'.
      ...
      * Called module names
       01  MOD-ZEN01DM7              PIC X(8) VALUE 'ZEN01DM7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01DM7-001.
               CALL 'ZEN01DM7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01DM7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
