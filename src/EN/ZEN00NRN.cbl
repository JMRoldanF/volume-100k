      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00NRN'.
      ...
      * Called module names
       01  MOD-ZEN01EXZ              PIC X(8) VALUE 'ZEN01EXZ'.
       01  MOD-ZEN01FAR              PIC X(8) VALUE 'ZEN01FAR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01EXZ-001.
               CALL 'ZEN01EXZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01EXZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01FAR-002.
               CALL 'ZEN01FAR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01FAR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
