      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00NJV'.
      ...
      * Called module names
       01  MOD-ZEN01GLF              PIC X(8) VALUE 'ZEN01GLF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01GLF-001.
               CALL 'ZEN01GLF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01GLF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
