      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00WUB'.
      ...
      * Called module names
       01  MOD-ZEN01L9H              PIC X(8) VALUE 'ZEN01L9H'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01L9H-001.
               CALL 'ZEN01L9H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01L9H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-MODEL-0001.
