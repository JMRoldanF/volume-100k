      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00P5N'.
      ...
      * Called module names
       01  MOD-ZEN01MPP              PIC X(8) VALUE 'ZEN01MPP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01MPP-001.
               CALL 'ZEN01MPP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01MPP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
