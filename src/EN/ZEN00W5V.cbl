      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00W5V'.
      ...
      * Called module names
       01  MOD-ZEN01Q3D              PIC X(8) VALUE 'ZEN01Q3D'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01Q3D-001.
               PERFORM CALL-ZEN01MPZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01Q3D-001.
               CALL 'ZEN01Q3D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01Q3D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01MPZ-002.
