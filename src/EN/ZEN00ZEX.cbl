      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00ZEX'.
      ...
      * Called module names
       01  MOD-ZEN01LPZ              PIC X(8) VALUE 'ZEN01LPZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01LPZ-001.
               CALL 'ZEN01LPZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01LPZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
