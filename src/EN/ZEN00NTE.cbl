      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00NTE'.
      ...
      * Called module names
       01  MOD-ZEN01GRK              PIC X(8) VALUE 'ZEN01GRK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01GRK-002.
               CALL 'ZEN01GRK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01GRK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
