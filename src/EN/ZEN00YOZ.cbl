      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00YOZ'.
      ...
      * Called module names
       01  MOD-ZEN01S77              PIC X(8) VALUE 'ZEN01S77'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01S77-001.
               CALL 'ZEN01S77' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01S77 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
