      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00W01'.
      ...
      * Called module names
       01  MOD-ZEN01P8T              PIC X(8) VALUE 'ZEN01P8T'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01P8T-001.
               CALL 'ZEN01P8T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01P8T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
