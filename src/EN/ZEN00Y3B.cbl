      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00Y3B'.
      ...
      * Called module names
       01  MOD-ZEN01KYX              PIC X(8) VALUE 'ZEN01KYX'.
       01  MOD-ZMT01L1D              PIC X(8) VALUE 'ZMT01L1D'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01KYX-001.
               PERFORM CALL-ZMT01L1D-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01KYX-001.
               CALL 'ZEN01KYX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01KYX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01L1D-002.
               CALL 'ZMT01L1D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01L1D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
