      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN01BII'.
      ...
      * Called module names
       01  MOD-ZEN01RC5              PIC X(8) VALUE 'ZEN01RC5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01RC5-001.
               CALL 'ZEN01RC5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01RC5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
