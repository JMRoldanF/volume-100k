      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00WOH'.
      ...
      * Called module names
       01  MOD-ZHO01N4O              PIC X(8) VALUE 'ZHO01N4O'.
       01  MOD-ZEN01SJF              PIC X(8) VALUE 'ZEN01SJF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01N4O-001.
               PERFORM CALL-ZEN01SJF-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01N4O-001.
               CALL 'ZHO01N4O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01N4O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01SJF-002.
               CALL 'ZEN01SJF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01SJF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
