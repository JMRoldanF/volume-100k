      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00P2P'.
      ...
      * Called module names
       01  MOD-ZEN01OE4              PIC X(8) VALUE 'ZEN01OE4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01OE4-001.
               CALL 'ZEN01OE4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01OE4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-COLOUR-0001.
