      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00MHJ'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01M6T              PIC X(8) VALUE 'ZEN01M6T'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01EZ3-001.
               PERFORM CALL-ZEN01M6T-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01M6T-002.
               CALL 'ZEN01M6T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01M6T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
