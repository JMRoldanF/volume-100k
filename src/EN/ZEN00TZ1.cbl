      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00TZ1'.
      ...
      * Called module names
       01  MOD-ZEN01J9P              PIC X(8) VALUE 'ZEN01J9P'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01J9P-001.
               CALL 'ZEN01J9P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01J9P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-VALUE-0001.
