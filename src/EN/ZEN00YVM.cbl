      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00YVM'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01QDC              PIC X(8) VALUE 'ZEN01QDC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01QDC-002.
               CALL 'ZEN01QDC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01QDC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
