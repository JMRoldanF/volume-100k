      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00P9I'.
      ...
      * Called module names
       01  MOD-ZEN01NRH              PIC X(8) VALUE 'ZEN01NRH'.
       01  MOD-ZLB01HHT              PIC X(8) VALUE 'ZLB01HHT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01NRH-001.
               CALL 'ZEN01NRH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01NRH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLB01HHT-002.
               CALL 'ZLB01HHT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01HHT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RECONCILE-TERM-0001.
