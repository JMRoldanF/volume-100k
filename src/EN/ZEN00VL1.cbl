      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00VL1'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01SSL              PIC X(8) VALUE 'ZEN01SSL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01SSL-002.
               CALL 'ZEN01SSL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01SSL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
