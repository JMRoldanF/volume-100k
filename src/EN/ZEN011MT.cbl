      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN011MT'.
      ...
      * Called module names
       01  MOD-ZCU01U6W              PIC X(8) VALUE 'ZCU01U6W'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01U6W-001.
               PERFORM CALL-ZCU01L0M-002.
               PERFORM CHECK-BROKER-ID-0001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCU01U6W-001.
               CALL 'ZCU01U6W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01U6W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01L0M-002.
               MOVE 'ZCU01L0M' TO WS-SUBNAME-6
