      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00W4H'.
      ...
      * Called module names
       01  MOD-ZPA01QKH              PIC X(8) VALUE 'ZPA01QKH'.
       01  MOD-ZEN01FAH              PIC X(8) VALUE 'ZEN01FAH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01QKH-001.
               PERFORM CALL-ZEN01FAH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01QKH-001.
               CALL 'ZPA01QKH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01QKH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01FAH-002.
               CALL 'ZEN01FAH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01FAH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
