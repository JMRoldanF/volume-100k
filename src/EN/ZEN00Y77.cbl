      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00Y77'.
      ...
      * Called module names
       01  MOD-ZEN01UV1              PIC X(8) VALUE 'ZEN01UV1'.
       01  MOD-ZCU01PQM              PIC X(8) VALUE 'ZCU01PQM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01UV1-001.
               PERFORM CALL-ZCU01PQM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01UV1-001.
               CALL 'ZEN01UV1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01UV1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01PQM-002.
               CALL 'ZCU01PQM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01PQM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
