      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00UM1'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01UD9              PIC X(8) VALUE 'ZEN01UD9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01GW9-001.
               PERFORM CALL-ZEN01UD9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01UD9-002.
               CALL 'ZEN01UD9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
