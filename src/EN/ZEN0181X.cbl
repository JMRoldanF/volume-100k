      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN0181X'.
      ...
      * Called module names
       01  MOD-ZEN01SNL              PIC X(8) VALUE 'ZEN01SNL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01SNL-001.
               CALL 'ZEN01SNL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01SNL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
