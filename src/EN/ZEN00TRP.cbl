      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00TRP'.
      ...
      * Called module names
       01  MOD-ZEN01KEB              PIC X(8) VALUE 'ZEN01KEB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01KEB-002.
               CALL 'ZEN01KEB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01KEB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
