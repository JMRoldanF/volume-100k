      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN01UGI'.
      ...
      * Called module names
       01  MOD-ZEN01KRS              PIC X(8) VALUE 'ZEN01KRS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01KRS-001.
               CALL 'ZEN01KRS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01KRS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
