      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00YL3'.
      ...
      * Called module names
       01  MOD-ZEN01GWJ              PIC X(8) VALUE 'ZEN01GWJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01GWJ-001.
               CALL 'ZEN01GWJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01GWJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
