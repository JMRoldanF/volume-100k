      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00HXX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN00TDV-001.
               EXEC CICS LINK PROGRAM('ZEN00TDV')
      ...
      *----------------------------------------------------------------*
       CALL-ZEN010YD-003.
               MOVE 'ZEN010YD' TO WS-PROGNAME-2
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN010YD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-004.
