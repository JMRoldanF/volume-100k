      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00P4A'.
      ...
      * Called module names
       01  MOD-ZEN01KD0              PIC X(8) VALUE 'ZEN01KD0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01KD0-001.
               CALL 'ZEN01KD0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01KD0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       NORMALISE-TERM-0001.
