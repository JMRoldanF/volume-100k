      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00ZPX'.
      ...
      * Called module names
       01  MOD-ZEN01F1B              PIC X(8) VALUE 'ZEN01F1B'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01Q29-001.
               PERFORM CALL-ZEN01F1B-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01F1B-002.
               CALL 'ZEN01F1B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01F1B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
