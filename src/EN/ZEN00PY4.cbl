      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00PY4'.
      ...
      * Called module names
       01  MOD-ZLB01O9J              PIC X(8) VALUE 'ZLB01O9J'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01O9J-001.
               CALL 'ZLB01O9J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01O9J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-EQUITIES-0001.
