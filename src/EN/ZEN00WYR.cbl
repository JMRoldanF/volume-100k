      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00WYR'.
      ...
      * Called module names
       01  MOD-ZEN01LN3              PIC X(8) VALUE 'ZEN01LN3'.
       01  MOD-ZEN01F7P              PIC X(8) VALUE 'ZEN01F7P'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01LN3-001.
               PERFORM CALL-ZEN01F7P-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01LN3-001.
               CALL 'ZEN01LN3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01LN3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01F7P-002.
               CALL 'ZEN01F7P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
