      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN005SF'.
      ...
      * Called module names
       ...
       01  MOD-ZEN00GDT              PIC X(8) VALUE 'ZEN00GDT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN00CZB-001.
               PERFORM CALL-ZEN00GDT-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN00GDT-002.
               EXEC CICS LINK PROGRAM('ZEN00GDT')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN00GDT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
