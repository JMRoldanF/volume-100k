      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00ZY7'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01TLD              PIC X(8) VALUE 'ZEN01TLD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLB01LLH-001.
               PERFORM CALL-ZEN01TLD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01TLD-002.
               CALL 'ZEN01TLD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01TLD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
