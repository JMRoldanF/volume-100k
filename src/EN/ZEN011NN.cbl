      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN011NN'.
      ...
      * Called module names
       01  MOD-ZAG01CNW              PIC X(8) VALUE 'ZAG01CNW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01CNW-001.
               CALL 'ZAG01CNW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01CNW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
