      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN004QN'.
      ...
      * Called module names
       01  MOD-ZEN00HFL              PIC X(8) VALUE 'ZEN00HFL'.
       01  MOD-ZEN00GXJ              PIC X(8) VALUE 'ZEN00GXJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN00HFL-001.
               PERFORM CALL-ZEN00GXJ-002.
               PERFORM CALL-ZMT0012D-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN00HFL-001.
               EXEC CICS LINK PROGRAM('ZEN00HFL')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN00HFL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN00GXJ-002.
               EXEC CICS LINK PROGRAM('ZEN00GXJ')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN00GXJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0012D-003.
               EXEC CICS START TRANSID('Z12D')
                         ...
                         RESP(WS-RESP)
               END-EXEC.
      * TRANSID Z12D is defined against ZMT0012D
               IF WS-RESP NOT = DFHRESP(NORMAL)
