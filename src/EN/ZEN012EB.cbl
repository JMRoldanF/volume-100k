      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN012EB'.
      ...
      * Called module names
       01  MOD-ZEN01J5N              PIC X(8) VALUE 'ZEN01J5N'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01J5N-001.
               CALL 'ZEN01J5N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01J5N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
