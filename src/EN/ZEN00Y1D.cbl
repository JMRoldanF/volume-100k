      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00Y1D'.
      ...
      * Called module names
       01  MOD-ZHO01DJO              PIC X(8) VALUE 'ZHO01DJO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01DJO-001.
               CALL 'ZHO01DJO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01DJO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-EQUITIES-0001.
