      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN011GL'.
      ...
      * Called module names
       01  MOD-ZEN01PMV              PIC X(8) VALUE 'ZEN01PMV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01PMV-001.
               CALL 'ZEN01PMV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01PMV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01DEA-002.
