      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN011G5'.
      ...
      * Called module names
       01  MOD-ZEN01MAF              PIC X(8) VALUE 'ZEN01MAF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01MAF-001.
               CALL 'ZEN01MAF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01MAF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
