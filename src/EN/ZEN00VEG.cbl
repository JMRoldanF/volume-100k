      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00VEG'.
      ...
      * Called module names
       01  MOD-ZEN01PXR              PIC X(8) VALUE 'ZEN01PXR'.
       01  MOD-ZEN01SXP              PIC X(8) VALUE 'ZEN01SXP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01PXR-001.
               PERFORM CALL-ZEN01SXP-002.
               PERFORM APPLY-TERM-0001.
               PERFORM REFRESH-SUM-ASSURED-0002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZEN01PXR-001.
               CALL 'ZEN01PXR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01PXR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01SXP-002.
               CALL 'ZEN01SXP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01SXP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-TERM-0001.
