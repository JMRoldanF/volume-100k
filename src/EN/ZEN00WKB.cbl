      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00WKB'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01IEZ              PIC X(8) VALUE 'ZEN01IEZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01IEZ-002.
               CALL 'ZEN01IEZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01IEZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
