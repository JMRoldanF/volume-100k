      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00E8N'.
      ...
      * Called module names
       01  MOD-ZEN00R15              PIC X(8) VALUE 'ZEN00R15'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN00R15-001.
               PERFORM CALL-ZAV01SSJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN00R15-001.
               EXEC CICS LINK PROGRAM('ZEN00R15')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN00R15 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAV01SSJ-002.
