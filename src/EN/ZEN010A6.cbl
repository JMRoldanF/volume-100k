      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN010A6'.
      ...
      * Called module names
       01  MOD-ZEN01LK6              PIC X(8) VALUE 'ZEN01LK6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01LK6-001.
               CALL 'ZEN01LK6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01LK6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       VALIDATE-TERM-0001.
