      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00U5M'.
      ...
      * Called module names
       01  MOD-ZEN01COE              PIC X(8) VALUE 'ZEN01COE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01COE-001.
               PERFORM CALL-ZEN01HGK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01COE-001.
               CALL 'ZEN01COE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01COE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01HGK-002.
