      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN013NB'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01UEX              PIC X(8) VALUE 'ZEN01UEX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01UEX-002.
               CALL 'ZEN01UEX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
