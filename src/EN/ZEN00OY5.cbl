      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00OY5'.
      ...
      * Called module names
       01  MOD-ZEN01IKT              PIC X(8) VALUE 'ZEN01IKT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01IKT-002.
               PERFORM CALL-ZAG0255S-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZEN01O49-001.
               MOVE 'ZEN01O49' TO WS-SUBNAME-3
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01IKT-002.
               CALL 'ZEN01IKT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
