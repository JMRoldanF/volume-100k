      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN018QM'.
      ...
      * Called module names
       01  MOD-ZEN01RU1              PIC X(8) VALUE 'ZEN01RU1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01RU1-001.
               CALL 'ZEN01RU1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01RU1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
