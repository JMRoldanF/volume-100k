      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN010FT'.
      ...
      * Called module names
       01  MOD-ZEN01PA7              PIC X(8) VALUE 'ZEN01PA7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01PA7-001.
               CALL 'ZEN01PA7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01PA7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
