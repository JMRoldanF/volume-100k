      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN011T8'.
      ...
      * Called module names
       01  MOD-ZEN01DOU              PIC X(8) VALUE 'ZEN01DOU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01DOU-001.
               CALL 'ZEN01DOU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01DOU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
