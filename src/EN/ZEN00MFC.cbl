      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00MFC'.
      ...
      * Called module names
       01  MOD-ZEN01PHH              PIC X(8) VALUE 'ZEN01PHH'.
       01  MOD-ZEN01MSD              PIC X(8) VALUE 'ZEN01MSD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01PHH-001.
               PERFORM CALL-ZEN01MSD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01PHH-001.
               CALL 'ZEN01PHH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01PHH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01MSD-002.
               CALL 'ZEN01MSD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01MSD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
