      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00NYL'.
      ...
      * Called module names
       01  MOD-ZEN01R9L              PIC X(8) VALUE 'ZEN01R9L'.
       01  MOD-ZEN01LUV              PIC X(8) VALUE 'ZEN01LUV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01R9L-001.
               PERFORM CALL-ZEN01LUV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01R9L-001.
               CALL 'ZEN01R9L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01R9L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01LUV-002.
               CALL 'ZEN01LUV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01LUV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
