      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN000D5'.
      ...
      * Called module names
       ...
       01  MOD-ZEN00HND              PIC X(8) VALUE 'ZEN00HND'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN006WF-002.
               PERFORM CALL-ZEN00HND-003.
               PERFORM CALL-ZEN009P9-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN00HND-003.
               EXEC CICS LINK PROGRAM('ZEN00HND')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN00HND FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN009P9-004.
