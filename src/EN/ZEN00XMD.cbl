      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00XMD'.
      ...
      * Called module names
       01  MOD-ZEN01PXT              PIC X(8) VALUE 'ZEN01PXT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01PXT-001.
               CALL 'ZEN01PXT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01PXT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
