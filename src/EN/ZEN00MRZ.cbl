      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00MRZ'.
      ...
      * Called module names
       01  MOD-ZEN01DR3              PIC X(8) VALUE 'ZEN01DR3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01DR3-001.
               CALL 'ZEN01DR3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01DR3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
