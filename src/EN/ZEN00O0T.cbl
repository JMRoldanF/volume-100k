      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00O0T'.
      ...
      * Called module names
       01  MOD-ZEN01PT3              PIC X(8) VALUE 'ZEN01PT3'.
       01  MOD-ZEN01IGX              PIC X(8) VALUE 'ZEN01IGX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01PT3-001.
               PERFORM CALL-ZEN01IGX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01PT3-001.
               CALL 'ZEN01PT3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01PT3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01IGX-002.
               CALL 'ZEN01IGX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
