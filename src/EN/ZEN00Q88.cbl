      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00Q88'.
      ...
      * Called module names
       01  MOD-ZTR01N3U              PIC X(8) VALUE 'ZTR01N3U'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01N3U-001.
               CALL 'ZTR01N3U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01N3U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01NK6-002.
