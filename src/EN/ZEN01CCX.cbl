      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN01CCX'.
      ...
      * Called module names
       01  MOD-ZRE01Q7D              PIC X(8) VALUE 'ZRE01Q7D'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01Q7D-001.
               CALL 'ZRE01Q7D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01Q7D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
