      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00WRP'.
      ...
      * Called module names
       01  MOD-ZLB01N2F              PIC X(8) VALUE 'ZLB01N2F'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01N2F-001.
               CALL 'ZLB01N2F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01N2F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
