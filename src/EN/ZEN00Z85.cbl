      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00Z85'.
      ...
      * Called module names
       01  MOD-ZEN01MUF              PIC X(8) VALUE 'ZEN01MUF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01MUF-001.
               PERFORM CALL-ZEN01JRB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01MUF-001.
               CALL 'ZEN01MUF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01MUF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01JRB-002.
