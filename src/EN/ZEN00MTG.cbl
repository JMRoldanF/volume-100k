      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00MTG'.
      ...
      * Called module names
       01  MOD-ZEN01G6X              PIC X(8) VALUE 'ZEN01G6X'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01G6X-001.
               CALL 'ZEN01G6X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01G6X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
