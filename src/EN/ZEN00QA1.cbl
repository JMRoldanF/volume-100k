      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00QA1'.
      ...
      * Called module names
       01  MOD-ZEN01DDQ              PIC X(8) VALUE 'ZEN01DDQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01DDQ-001.
               CALL 'ZEN01DDQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01DDQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
