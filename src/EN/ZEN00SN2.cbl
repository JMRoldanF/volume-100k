      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00SN2'.
      ...
      * Called module names
       01  MOD-ZEN01U7O              PIC X(8) VALUE 'ZEN01U7O'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01U7O-001.
               PERFORM CALL-ZTR01OG7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01U7O-001.
               CALL 'ZEN01U7O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01U7O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTR01OG7-002.
