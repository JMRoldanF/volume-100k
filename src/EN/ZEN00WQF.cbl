      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00WQF'.
      ...
      * Called module names
       01  MOD-ZEN01LO7              PIC X(8) VALUE 'ZEN01LO7'.
       01  MOD-ZEN01GPB              PIC X(8) VALUE 'ZEN01GPB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01LO7-001.
               PERFORM CALL-ZEN01GPB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01LO7-001.
               CALL 'ZEN01LO7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01LO7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01GPB-002.
               CALL 'ZEN01GPB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01GPB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
