      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN011HT'.
      ...
      * Called module names
       01  MOD-ZEN01FV1              PIC X(8) VALUE 'ZEN01FV1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01FV1-001.
               CALL 'ZEN01FV1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01FV1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
