      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00W0L'.
      ...
      * Called module names
       01  MOD-ZUW01PM2              PIC X(8) VALUE 'ZUW01PM2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01PM2-001.
               CALL 'ZUW01PM2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01PM2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01NQ3-002.
