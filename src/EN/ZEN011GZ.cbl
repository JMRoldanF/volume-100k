      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN011GZ'.
      ...
      * Called module names
       01  MOD-ZEN01NK9              PIC X(8) VALUE 'ZEN01NK9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01NK9-001.
               CALL 'ZEN01NK9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01NK9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
