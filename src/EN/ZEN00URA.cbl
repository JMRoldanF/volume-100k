      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00URA'.
      ...
      * Called module names
       01  MOD-ZEN01TTH              PIC X(8) VALUE 'ZEN01TTH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01TTH-001.
               CALL 'ZEN01TTH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01TTH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
