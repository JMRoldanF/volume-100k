      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00ZLU'.
      ...
      * Called module names
       01  MOD-ZEN01SFL              PIC X(8) VALUE 'ZEN01SFL'.
       01  MOD-ZEN01IZW              PIC X(8) VALUE 'ZEN01IZW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01SFL-001.
               PERFORM CALL-ZEN01IZW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01SFL-001.
               CALL 'ZEN01SFL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01SFL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01IZW-002.
               CALL 'ZEN01IZW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01IZW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
