      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00MR9'.
      ...
      * Called module names
       01  MOD-ZEN01PHZ              PIC X(8) VALUE 'ZEN01PHZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01PHZ-001.
               PERFORM CALL-ZEN01TLH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01PHZ-001.
               CALL 'ZEN01PHZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01PHZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01TLH-002.
