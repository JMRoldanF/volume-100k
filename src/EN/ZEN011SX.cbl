      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN011SX'.
      ...
      * Called module names
       01  MOD-ZEN01RNR              PIC X(8) VALUE 'ZEN01RNR'.
       01  MOD-ZEN01KBL              PIC X(8) VALUE 'ZEN01KBL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01RNR-001.
               CALL 'ZEN01RNR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01RNR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01KBL-002.
               CALL 'ZEN01KBL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01KBL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-EXCESS-0001.
