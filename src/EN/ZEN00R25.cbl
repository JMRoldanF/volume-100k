      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00R25'.
      ...
      * Called module names
       01  MOD-ZEN01UPT              PIC X(8) VALUE 'ZEN01UPT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01UPT-001.
               CALL 'ZEN01UPT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01UPT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
