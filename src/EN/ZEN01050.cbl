      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN01050'.
      ...
      * Called module names
       01  MOD-ZEN01GHK              PIC X(8) VALUE 'ZEN01GHK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01GHK-001.
               CALL 'ZEN01GHK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01GHK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLB01CVL-002.
