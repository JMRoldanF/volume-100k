      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00X1M'.
      ...
      * Called module names
       01  MOD-ZEN01LZ3              PIC X(8) VALUE 'ZEN01LZ3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01LZ3-001.
               PERFORM CALL-ZEN01N29-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01LZ3-001.
               CALL 'ZEN01LZ3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01LZ3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01N29-002.
