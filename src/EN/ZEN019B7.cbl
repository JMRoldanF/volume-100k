      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN019B7'.
      ...
      * Called module names
       01  MOD-ZEN01H37              PIC X(8) VALUE 'ZEN01H37'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01H37-001.
               CALL 'ZEN01H37' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01H37 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
