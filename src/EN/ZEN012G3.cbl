      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN012G3'.
      ...
      * Called module names
       01  MOD-ZAV01OSV              PIC X(8) VALUE 'ZAV01OSV'.
       01  MOD-ZEN01MBS              PIC X(8) VALUE 'ZEN01MBS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01OSV-001.
               CALL 'ZAV01OSV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01OSV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01MBS-002.
               CALL 'ZEN01MBS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
