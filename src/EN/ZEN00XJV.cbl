      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00XJV'.
      ...
      * Called module names
       01  MOD-ZEN01EUD              PIC X(8) VALUE 'ZEN01EUD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01EUD-001.
               CALL 'ZEN01EUD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01EUD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
