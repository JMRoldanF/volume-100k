      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00T8L'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01RFZ              PIC X(8) VALUE 'ZEN01RFZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01RFZ-002.
               CALL 'ZEN01RFZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01RFZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
