      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN005CV'.
      ...
      * Called module names
       01  MOD-ZEN00DUF              PIC X(8) VALUE 'ZEN00DUF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN00DUF-001.
               PERFORM CALL-ZEN00J7H-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN00DUF-001.
               EXEC CICS LINK PROGRAM('ZEN00DUF')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN00DUF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN00J7H-002.
