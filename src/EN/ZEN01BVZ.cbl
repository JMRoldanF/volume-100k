      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN01BVZ'.
      ...
      * Called module names
       01  MOD-ZEN01U8J              PIC X(8) VALUE 'ZEN01U8J'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01U8J-001.
               PERFORM CALL-ZEN01I81-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01U8J-001.
               CALL 'ZEN01U8J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01U8J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01I81-002.
