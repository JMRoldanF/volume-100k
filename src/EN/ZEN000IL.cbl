      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN000IL'.
      ...
      * Called module names
       01  MOD-ZEN00J94              PIC X(8) VALUE 'ZEN00J94'.
       01  MOD-ZAV00998              PIC X(8) VALUE 'ZAV00998'.
       01  MOD-ZEN00F22              PIC X(8) VALUE 'ZEN00F22'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN00J94-001.
               PERFORM CALL-ZAV00998-002.
               PERFORM CALL-ZEN00F22-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN00J94-001.
               EXEC CICS LINK PROGRAM('ZEN00J94')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN00J94 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAV00998-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN00F22-003.
               EXEC CICS LINK PROGRAM('ZEN00F22')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN00F22 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-004.
