      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00M1X'.
      ...
      * Called module names
       01  MOD-ZEN01DCB              PIC X(8) VALUE 'ZEN01DCB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01DCB-001.
               CALL 'ZEN01DCB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01DCB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
