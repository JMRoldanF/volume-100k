      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00WX5'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01DEA              PIC X(8) VALUE 'ZEN01DEA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01DEA-002.
               CALL 'ZEN01DEA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01DEA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
