      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00YA9'.
      ...
      * Called module names
       01  MOD-ZPA01LCF              PIC X(8) VALUE 'ZPA01LCF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01LCF-001.
               CALL 'ZPA01LCF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01LCF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01P39-002.
