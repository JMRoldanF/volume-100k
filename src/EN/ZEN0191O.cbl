      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN0191O'.
      ...
      * Called module names
       01  MOD-ZAV01PK7              PIC X(8) VALUE 'ZAV01PK7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01UBV-001.
               PERFORM CALL-ZAV01PK7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01PK7-002.
               CALL 'ZAV01PK7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01PK7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
