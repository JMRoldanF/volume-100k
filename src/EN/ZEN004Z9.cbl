      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN004Z9'.
      ...
      * Called module names
       ...
       01  MOD-ZEN00BWF              PIC X(8) VALUE 'ZEN00BWF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN00BWF-002.
               EXEC CICS LINK PROGRAM('ZEN00BWF')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN00BWF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
