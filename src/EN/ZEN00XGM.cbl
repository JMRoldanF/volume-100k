      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00XGM'.
      ...
      * Called module names
       01  MOD-ZEN01PZW              PIC X(8) VALUE 'ZEN01PZW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01PZW-001.
               PERFORM CALL-ZLB01JMB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01PZW-001.
               CALL 'ZEN01PZW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01PZW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLB01JMB-002.
