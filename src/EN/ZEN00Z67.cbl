      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00Z67'.
      ...
      * Called module names
       01  MOD-ZEN01HFZ              PIC X(8) VALUE 'ZEN01HFZ'.
       01  MOD-ZEN01NKT              PIC X(8) VALUE 'ZEN01NKT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01HFZ-001.
               PERFORM CALL-ZEN01NKT-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01HFZ-001.
               CALL 'ZEN01HFZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01HFZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01NKT-002.
               CALL 'ZEN01NKT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01NKT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-MODEL-0001.
