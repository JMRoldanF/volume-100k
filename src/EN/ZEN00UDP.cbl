      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00UDP'.
      ...
      * Called module names
       01  MOD-ZEN01MGJ              PIC X(8) VALUE 'ZEN01MGJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01MGJ-001.
               PERFORM CALL-ZEN01JE9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01MGJ-001.
               CALL 'ZEN01MGJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01MGJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01JE9-002.
