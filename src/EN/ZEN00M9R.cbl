      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00M9R'.
      ...
      * Called module names
       01  MOD-ZEN01Q2T              PIC X(8) VALUE 'ZEN01Q2T'.
       01  MOD-ZEN01D63              PIC X(8) VALUE 'ZEN01D63'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01Q2T-001.
               PERFORM CALL-ZEN01D63-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01Q2T-001.
               CALL 'ZEN01Q2T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01Q2T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01D63-002.
               CALL 'ZEN01D63' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01D63 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
