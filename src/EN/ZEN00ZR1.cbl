      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN00ZR1'.
      ...
      * Called module names
       01  MOD-ZEN01GMT              PIC X(8) VALUE 'ZEN01GMT'.
       01  MOD-ZEN01HYB              PIC X(8) VALUE 'ZEN01HYB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01GMT-001.
               PERFORM CALL-ZEN01HYB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01GMT-001.
               CALL 'ZEN01GMT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01GMT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01HYB-002.
               CALL 'ZEN01HYB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01HYB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
