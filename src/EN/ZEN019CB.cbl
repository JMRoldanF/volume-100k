      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEN019CB'.
      ...
      * Called module names
       01  MOD-ZPA01KKX              PIC X(8) VALUE 'ZPA01KKX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01KKX-001.
               CALL 'ZPA01KKX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01KKX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
