      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00R4X'.
      ...
      * Called module names
       01  MOD-ZHE01RSY              PIC X(8) VALUE 'ZHE01RSY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHE01RSY-001.
               PERFORM CALL-ZHE01F2K-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01RSY-001.
               CALL 'ZHE01RSY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01RSY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHE01F2K-002.
               MOVE 'ZHE01F2K' TO WS-SUBNAME-6
