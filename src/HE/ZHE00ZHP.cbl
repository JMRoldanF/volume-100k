      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00ZHP'.
      ...
      * Called module names
       01  MOD-ZRC01SE2              PIC X(8) VALUE 'ZRC01SE2'.
       01  MOD-ZHE01GVS              PIC X(8) VALUE 'ZHE01GVS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRC01SE2-001.
               CALL 'ZRC01SE2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRC01SE2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHE01GVS-002.
               CALL 'ZHE01GVS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01GVS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
