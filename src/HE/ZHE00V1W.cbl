      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00V1W'.
      ...
      * Called module names
       01  MOD-ZHE01M50              PIC X(8) VALUE 'ZHE01M50'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01M50-001.
               CALL 'ZHE01M50' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01M50 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCR01MCU-002.
