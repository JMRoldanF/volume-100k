      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE02514'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHE01PCH-001.
               PERFORM CALL-ZHE01IW9-002.
               PERFORM CALL-ZHE01UQU-003.
               PERFORM CALL-ZHE01L6D-004.
               PERFORM CALL-ZHE00ZWX-005.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE00ZWX-005.
               CALL 'ZHE00ZWX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
