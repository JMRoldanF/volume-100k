      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE012K7'.
      ...
      * Called module names
       01  MOD-ZHE01EI5              PIC X(8) VALUE 'ZHE01EI5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01EI5-001.
               CALL 'ZHE01EI5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01EI5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-TERM-0001.
