      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00SS2'.
      ...
      * Called module names
       01  MOD-ZHE01V20              PIC X(8) VALUE 'ZHE01V20'.
       01  MOD-ZHE01D7P              PIC X(8) VALUE 'ZHE01D7P'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHE01V20-001.
               PERFORM CALL-ZHE01D7P-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01V20-001.
               CALL 'ZHE01V20' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01V20 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHE01D7P-002.
               CALL 'ZHE01D7P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01D7P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
