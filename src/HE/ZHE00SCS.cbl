      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00SCS'.
      ...
      * Called module names
       01  MOD-ZHE01EPG              PIC X(8) VALUE 'ZHE01EPG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01EPG-001.
               CALL 'ZHE01EPG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01EPG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHE01RT8-002.
