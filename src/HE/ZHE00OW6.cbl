      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00OW6'.
      ...
      * Called module names
       01  MOD-ZHE01HER              PIC X(8) VALUE 'ZHE01HER'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01HER-001.
               CALL 'ZHE01HER' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01HER FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
