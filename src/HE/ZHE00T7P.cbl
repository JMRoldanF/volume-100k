      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00T7P'.
      ...
      * Called module names
       01  MOD-ZHE01PFY              PIC X(8) VALUE 'ZHE01PFY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01PFY-001.
               CALL 'ZHE01PFY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01PFY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHE01MOU-002.
