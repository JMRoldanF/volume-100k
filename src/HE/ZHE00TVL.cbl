      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00TVL'.
      ...
      * Called module names
       ...
       01  MOD-ZHE01DBZ              PIC X(8) VALUE 'ZHE01DBZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHE01M66-001.
               PERFORM CALL-ZHE01DBZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01DBZ-002.
               CALL 'ZHE01DBZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01DBZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-TERM-0001.
