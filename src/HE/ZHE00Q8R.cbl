      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00Q8R'.
      ...
      * Called module names
       01  MOD-ZHE01FL9              PIC X(8) VALUE 'ZHE01FL9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01FL9-001.
               CALL 'ZHE01FL9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01FL9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
