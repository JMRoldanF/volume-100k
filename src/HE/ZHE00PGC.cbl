      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00PGC'.
      ...
      * Called module names
       ...
       01  MOD-ZHE01MS0              PIC X(8) VALUE 'ZHE01MS0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01MS0-002.
               CALL 'ZHE01MS0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01MS0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
