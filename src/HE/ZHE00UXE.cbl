      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00UXE'.
      ...
      * Called module names
       01  MOD-ZHE01MDV              PIC X(8) VALUE 'ZHE01MDV'.
       01  MOD-ZHE01SZZ              PIC X(8) VALUE 'ZHE01SZZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHE01MDV-001.
               PERFORM CALL-ZHE01SZZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01MDV-001.
               CALL 'ZHE01MDV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01MDV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHE01SZZ-002.
               CALL 'ZHE01SZZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01SZZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-MODEL-0001.
