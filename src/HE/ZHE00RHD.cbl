      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00RHD'.
      ...
      * Called module names
       01  MOD-ZHE01O89              PIC X(8) VALUE 'ZHE01O89'.
       01  MOD-ZAG01J5J              PIC X(8) VALUE 'ZAG01J5J'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHE01O89-001.
               PERFORM CALL-ZAG01J5J-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01O89-001.
               CALL 'ZHE01O89' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01O89 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01J5J-002.
               CALL 'ZAG01J5J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01J5J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-EXCESS-0001.
