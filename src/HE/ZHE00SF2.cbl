      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00SF2'.
      ...
      * Called module names
       01  MOD-ZHE01OIL              PIC X(8) VALUE 'ZHE01OIL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01OIL-001.
               CALL 'ZHE01OIL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01OIL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
