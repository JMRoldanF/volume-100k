      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE010LH'.
      ...
      * Called module names
       01  MOD-ZRC01EDE              PIC X(8) VALUE 'ZRC01EDE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRC01EDE-001.
               CALL 'ZRC01EDE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRC01EDE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
