      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE0114P'.
      ...
      * Called module names
       01  MOD-ZHE01TM8              PIC X(8) VALUE 'ZHE01TM8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01TM8-002.
               CALL 'ZHE01TM8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
