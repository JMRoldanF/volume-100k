      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00QLM'.
      ...
      * Called module names
       01  MOD-ZHE01I9Z              PIC X(8) VALUE 'ZHE01I9Z'.
       01  MOD-ZHE01HQW              PIC X(8) VALUE 'ZHE01HQW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHE01I9Z-001.
               PERFORM CALL-ZHE01HQW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01I9Z-001.
               CALL 'ZHE01I9Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01I9Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHE01HQW-002.
               CALL 'ZHE01HQW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01HQW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
