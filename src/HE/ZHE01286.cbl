      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE01286'.
      ...
      * Called module names
       01  MOD-ZAG01K39              PIC X(8) VALUE 'ZAG01K39'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01K39-001.
               CALL 'ZAG01K39' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01K39 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
