      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00LRB'.
      ...
      * Called module names
       01  MOD-ZHE01MCI              PIC X(8) VALUE 'ZHE01MCI'.
       01  MOD-ZAG01UQN              PIC X(8) VALUE 'ZAG01UQN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHE01MCI-001.
               PERFORM CALL-ZAG01UQN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01MCI-001.
               CALL 'ZHE01MCI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01MCI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01UQN-002.
               CALL 'ZAG01UQN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01UQN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
