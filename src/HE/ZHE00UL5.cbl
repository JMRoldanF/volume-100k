      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00UL5'.
      ...
      * Called module names
       ...
       01  MOD-ZHE01SYL              PIC X(8) VALUE 'ZHE01SYL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01SYL-002.
               CALL 'ZHE01SYL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01SYL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
