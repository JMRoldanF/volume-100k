      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00R8D'.
      ...
      * Called module names
       01  MOD-ZHE01TJ0              PIC X(8) VALUE 'ZHE01TJ0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01TJ0-001.
               CALL 'ZHE01TJ0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01TJ0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHE01STT-002.
               MOVE 'ZHE01STT' TO WS-SUBNAME-7
