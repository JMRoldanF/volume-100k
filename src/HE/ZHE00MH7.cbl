      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00MH7'.
      ...
      * Called module names
       01  MOD-ZHE01GIR              PIC X(8) VALUE 'ZHE01GIR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHE01GIR-001.
               PERFORM CALL-ZHE01KOU-002.
               PERFORM CALL-ZMT0255L-003.
               PERFORM FORMAT-MODEL-0001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZHE01GIR-001.
               CALL 'ZHE01GIR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
