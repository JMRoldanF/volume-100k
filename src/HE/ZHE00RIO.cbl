      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00RIO'.
      ...
      * Called module names
       01  MOD-ZHE01Q7G              PIC X(8) VALUE 'ZHE01Q7G'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01Q7G-001.
               CALL 'ZHE01Q7G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01Q7G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
