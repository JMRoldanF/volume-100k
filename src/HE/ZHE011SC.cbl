      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE011SC'.
      ...
      * Called module names
       ...
       01  MOD-ZHE01HIH              PIC X(8) VALUE 'ZHE01HIH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01HIH-002.
               CALL 'ZHE01HIH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01HIH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
