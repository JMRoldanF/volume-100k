      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00NNF'.
      ...
      * Called module names
       01  MOD-ZHE01IXC              PIC X(8) VALUE 'ZHE01IXC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01IXC-001.
               CALL 'ZHE01IXC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01IXC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHE01RQZ-002.
