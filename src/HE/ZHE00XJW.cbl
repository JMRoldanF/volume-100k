      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00XJW'.
      ...
      * Called module names
       01  MOD-ZSL01SB2              PIC X(8) VALUE 'ZSL01SB2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSL01SB2-001.
               CALL 'ZSL01SB2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSL01SB2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
