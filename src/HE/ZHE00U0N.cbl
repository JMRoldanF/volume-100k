      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00U0N'.
      ...
      * Called module names
       01  MOD-ZHE01S0A              PIC X(8) VALUE 'ZHE01S0A'.
       01  MOD-ZHE01E29              PIC X(8) VALUE 'ZHE01E29'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHE01S0A-001.
               PERFORM CALL-ZHE01E29-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01S0A-001.
               CALL 'ZHE01S0A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01S0A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHE01E29-002.
               CALL 'ZHE01E29' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01E29 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
