      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00YIR'.
      ...
      * Called module names
       01  MOD-ZHE01FTK              PIC X(8) VALUE 'ZHE01FTK'.
       01  MOD-ZHE01DWK              PIC X(8) VALUE 'ZHE01DWK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01FTK-001.
               CALL 'ZHE01FTK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01FTK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHE01DWK-002.
               CALL 'ZHE01DWK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01DWK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
