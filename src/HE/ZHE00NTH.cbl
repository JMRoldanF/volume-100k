      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00NTH'.
      ...
      * Called module names
       01  MOD-ZAG01G15              PIC X(8) VALUE 'ZAG01G15'.
       01  MOD-ZHE01PXZ              PIC X(8) VALUE 'ZHE01PXZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01G15-001.
               CALL 'ZAG01G15' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01G15 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHE01PXZ-002.
               CALL 'ZHE01PXZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
