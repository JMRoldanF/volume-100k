      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE010UT'.
      ...
      * Called module names
       01  MOD-ZCO01QH9              PIC X(8) VALUE 'ZCO01QH9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01QH9-001.
               CALL 'ZCO01QH9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01QH9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
