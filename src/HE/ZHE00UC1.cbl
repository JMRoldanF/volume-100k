      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00UC1'.
      ...
      * Called module names
       01  MOD-ZHE01EJK              PIC X(8) VALUE 'ZHE01EJK'.
       01  MOD-ZHE01JHE              PIC X(8) VALUE 'ZHE01JHE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHE01EJK-001.
               PERFORM CALL-ZHE01JHE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01EJK-001.
               CALL 'ZHE01EJK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01EJK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHE01JHE-002.
               CALL 'ZHE01JHE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01JHE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
