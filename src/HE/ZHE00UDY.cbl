      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00UDY'.
      ...
      * Called module names
       01  MOD-ZHE01N7C              PIC X(8) VALUE 'ZHE01N7C'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHE01N7C-001.
               PERFORM CALL-ZHE01N7C-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01N7C-001.
               CALL 'ZHE01N7C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01N7C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHE01N7C-002.
               MOVE 'ZHE01N7C' TO WS-SUBNAME-1
