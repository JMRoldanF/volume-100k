      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00Z9I'.
      ...
      * Called module names
       01  MOD-ZHE01RIU              PIC X(8) VALUE 'ZHE01RIU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01RIU-001.
               CALL 'ZHE01RIU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01RIU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
