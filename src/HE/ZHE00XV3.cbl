      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00XV3'.
      ...
      * Called module names
       01  MOD-ZHE01OLS              PIC X(8) VALUE 'ZHE01OLS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01OLS-001.
               CALL 'ZHE01OLS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01OLS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
