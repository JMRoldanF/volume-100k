      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00NS6'.
      ...
      * Called module names
       01  MOD-ZHE01I7Y              PIC X(8) VALUE 'ZHE01I7Y'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHE01I7Y-001.
               PERFORM CALL-ZHE01KZD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01I7Y-001.
               CALL 'ZHE01I7Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01I7Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHE01KZD-002.
