      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE011NQ'.
      ...
      * Called module names
       01  MOD-ZHE01R19              PIC X(8) VALUE 'ZHE01R19'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01R19-001.
               CALL 'ZHE01R19' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01R19 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRC01U0Y-002.
