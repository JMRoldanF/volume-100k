      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00VKA'.
      ...
      * Called module names
       ...
       01  MOD-ZSL01UN9              PIC X(8) VALUE 'ZSL01UN9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSL01UN9-002.
               CALL 'ZSL01UN9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSL01UN9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
