      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00TW0'.
      ...
      * Called module names
       01  MOD-ZCO01QZO              PIC X(8) VALUE 'ZCO01QZO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01QZO-001.
               CALL 'ZCO01QZO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01QZO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
