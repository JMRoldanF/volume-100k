      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00R3M'.
      ...
      * Called module names
       01  MOD-ZHE01GT3              PIC X(8) VALUE 'ZHE01GT3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHE01GT3-001.
               PERFORM CALL-ZHE01EG0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01GT3-001.
               CALL 'ZHE01GT3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01GT3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHE01EG0-002.
