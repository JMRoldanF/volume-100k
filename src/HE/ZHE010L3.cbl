      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE010L3'.
      ...
      * Called module names
       ...
       01  MOD-ZRC01GAZ              PIC X(8) VALUE 'ZRC01GAZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRC01GAZ-002.
               CALL 'ZRC01GAZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRC01GAZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
