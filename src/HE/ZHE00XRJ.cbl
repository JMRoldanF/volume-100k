      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00XRJ'.
      ...
      * Called module names
       01  MOD-ZHE01S64              PIC X(8) VALUE 'ZHE01S64'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01S64-001.
               CALL 'ZHE01S64' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01STP-002.
               MOVE 'ZHE01STP' TO WS-SUBNAME-5
               CALL WS-SUBNAME-5 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01STP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
