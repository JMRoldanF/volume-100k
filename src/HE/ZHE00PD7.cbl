      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00PD7'.
      ...
      * Called module names
       01  MOD-ZHE01GFN              PIC X(8) VALUE 'ZHE01GFN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01GFN-001.
               CALL 'ZHE01GFN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01GFN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
