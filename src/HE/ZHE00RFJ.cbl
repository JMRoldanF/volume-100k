      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00RFJ'.
      ...
      * Called module names
       01  MOD-ZHE01T5O              PIC X(8) VALUE 'ZHE01T5O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01T5O-001.
               CALL 'ZHE01T5O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01T5O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-VALUE-0001.
