      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00ZCE'.
      ...
      * Called module names
       01  MOD-ZHE01MWR              PIC X(8) VALUE 'ZHE01MWR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHE01MWR-001.
               PERFORM CALL-ZHE01HPN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01MWR-001.
               CALL 'ZHE01MWR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01MWR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHE01HPN-002.
