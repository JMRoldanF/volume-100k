      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00XUN'.
      ...
      * Called module names
       ...
       01  MOD-ZHE01LVX              PIC X(8) VALUE 'ZHE01LVX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01LVX-002.
               CALL 'ZHE01LVX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01LVX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
