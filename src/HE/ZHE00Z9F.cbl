      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00Z9F'.
      ...
      * Called module names
       01  MOD-ZHE01SE0              PIC X(8) VALUE 'ZHE01SE0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01SE0-001.
               CALL 'ZHE01SE0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01SE0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-VALUE-0001.
