      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00YDB'.
      ...
      * Called module names
       01  MOD-ZHE01MLU              PIC X(8) VALUE 'ZHE01MLU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01MLU-001.
               CALL 'ZHE01MLU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01MLU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
