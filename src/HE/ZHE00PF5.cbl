      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00PF5'.
      ...
      * Called module names
       01  MOD-ZHE01JPX              PIC X(8) VALUE 'ZHE01JPX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01JPX-001.
               CALL 'ZHE01JPX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01JPX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
