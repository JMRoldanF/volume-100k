      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00T8O'.
      ...
      * Called module names
       01  MOD-ZHE01H9J              PIC X(8) VALUE 'ZHE01H9J'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01NHI-001.
               PERFORM CALL-ZHE01H9J-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01H9J-002.
               CALL 'ZHE01H9J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01H9J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
