      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00QZP'.
      ...
      * Called module names
       01  MOD-ZCO01GP7              PIC X(8) VALUE 'ZCO01GP7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCO01GP7-001.
               PERFORM CALL-ZHE01KH7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01GP7-001.
               CALL 'ZCO01GP7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01GP7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHE01KH7-002.
