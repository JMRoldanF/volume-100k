      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00X92'.
      ...
      * Called module names
       01  MOD-ZHE01KQ2              PIC X(8) VALUE 'ZHE01KQ2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01KQ2-001.
               CALL 'ZHE01KQ2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01KQ2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
