      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00X04'.
      ...
      * Called module names
       01  MOD-ZHE01L5Q              PIC X(8) VALUE 'ZHE01L5Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01L5Q-001.
               CALL 'ZHE01L5Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01L5Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHE01NXE-002.
