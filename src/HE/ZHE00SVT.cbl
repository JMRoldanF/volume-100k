      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00SVT'.
      ...
      * Called module names
       01  MOD-ZHE01CXK              PIC X(8) VALUE 'ZHE01CXK'.
       01  MOD-ZHE01NM2              PIC X(8) VALUE 'ZHE01NM2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01CXK-001.
               CALL 'ZHE01CXK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01CXK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHE01NM2-002.
               CALL 'ZHE01NM2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01NM2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
