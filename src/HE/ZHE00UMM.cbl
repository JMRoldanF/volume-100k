      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00UMM'.
      ...
      * Called module names
       01  MOD-ZHE01LUZ              PIC X(8) VALUE 'ZHE01LUZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01LUZ-001.
               CALL 'ZHE01LUZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01LUZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
