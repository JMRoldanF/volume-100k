      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE01037'.
      ...
      * Called module names
       01  MOD-ZHE01JRU              PIC X(8) VALUE 'ZHE01JRU'.
       01  MOD-ZHE01MZU              PIC X(8) VALUE 'ZHE01MZU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHE01JRU-001.
               PERFORM CALL-ZHE01MZU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01JRU-001.
               CALL 'ZHE01JRU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01JRU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHE01MZU-002.
               CALL 'ZHE01MZU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01MZU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
