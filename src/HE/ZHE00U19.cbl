      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00U19'.
      ...
      * Called module names
       01  MOD-ZRC01E7V              PIC X(8) VALUE 'ZRC01E7V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRC01E7V-001.
               CALL 'ZRC01E7V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRC01E7V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
