      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00UNL'.
      ...
      * Called module names
       01  MOD-ZHE01EB6              PIC X(8) VALUE 'ZHE01EB6'.
       01  MOD-ZHE01NYL              PIC X(8) VALUE 'ZHE01NYL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01EB6-001.
               CALL 'ZHE01EB6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01EB6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHE01NYL-002.
               CALL 'ZHE01NYL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01NYL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
