      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE01017'.
      ...
      * Called module names
       01  MOD-ZHE01MBC              PIC X(8) VALUE 'ZHE01MBC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01MBC-001.
               CALL 'ZHE01MBC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01MBC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
