      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00WS9'.
      ...
      * Called module names
       01  MOD-ZCO01N0Y              PIC X(8) VALUE 'ZCO01N0Y'.
       01  MOD-ZHE01T7N              PIC X(8) VALUE 'ZHE01T7N'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCO01N0Y-001.
               PERFORM CALL-ZHE01T7N-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01N0Y-001.
               CALL 'ZCO01N0Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01N0Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHE01T7N-002.
               CALL 'ZHE01T7N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01T7N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
