      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00M90'.
      ...
      * Called module names
       01  MOD-ZHE01NZA              PIC X(8) VALUE 'ZHE01NZA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01NZA-001.
               CALL 'ZHE01NZA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01NZA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
