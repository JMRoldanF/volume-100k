      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00MH8'.
      ...
      * Called module names
       01  MOD-ZHE01E4H              PIC X(8) VALUE 'ZHE01E4H'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHE01E4H-001.
               PERFORM CALL-ZRC01GFV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01E4H-001.
               CALL 'ZHE01E4H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01E4H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRC01GFV-002.
