      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE011FB'.
      ...
      * Called module names
       01  MOD-ZHE01KTA              PIC X(8) VALUE 'ZHE01KTA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHE01KTA-001.
               PERFORM CALL-ZHE01EZN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01KTA-001.
               CALL 'ZHE01KTA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01KTA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHE01EZN-002.
