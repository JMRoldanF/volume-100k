      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00W1U'.
      ...
      * Called module names
       01  MOD-ZHE01RU3              PIC X(8) VALUE 'ZHE01RU3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01RU3-001.
               CALL 'ZHE01RU3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01RU3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
