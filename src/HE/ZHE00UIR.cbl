      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00UIR'.
      ...
      * Called module names
       01  MOD-ZHE01L17              PIC X(8) VALUE 'ZHE01L17'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01L17-001.
               CALL 'ZHE01L17' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01L17 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
