      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE00Z3O'.
      ...
      * Called module names
       01  MOD-ZCO01DG2              PIC X(8) VALUE 'ZCO01DG2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01DG2-001.
               CALL 'ZCO01DG2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01DG2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHE01KHZ-002.
