      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHE012CK'.
      ...
      * Called module names
       01  MOD-ZAG01PV1              PIC X(8) VALUE 'ZAG01PV1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01PV1-001.
               PERFORM CALL-ZSL01KYW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01PV1-001.
               CALL 'ZAG01PV1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01PV1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSL01KYW-002.
