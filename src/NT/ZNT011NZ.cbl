      ******************************************************************
      * ZNT011NZ - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT011NZ'.
      ...
      * Called module names
       01  MOD-ZNT01FXJ              PIC X(8) VALUE 'ZNT01FXJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01FXJ-001.
               CALL 'ZNT01FXJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01FXJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
