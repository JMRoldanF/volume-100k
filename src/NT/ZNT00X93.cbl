      ******************************************************************
      * ZNT00X93 - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT00X93'.
      ...
      * Called module names
       ...
       01  MOD-ZNT01DD1              PIC X(8) VALUE 'ZNT01DD1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01DD1-002.
               CALL 'ZNT01DD1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
