      ******************************************************************
      * ZNT0193A - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT0193A'.
      ...
      * Called module names
       01  MOD-ZNT01NZQ              PIC X(8) VALUE 'ZNT01NZQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01NZQ-001.
               CALL 'ZNT01NZQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       FILE-ACCESS-0009.
               EXEC CICS REWRITE FILE('KSDSNT03')
                         FROM(KSDSNT03-REC)
                         LENGTH(WS-FILE-LEN)
                         RIDFLD(WS-KEY-AREA)
                         RESP(WS-RESP)
