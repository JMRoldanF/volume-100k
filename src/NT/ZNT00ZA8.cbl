      ******************************************************************
      * ZNT00ZA8 - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT00ZA8'.
      ...
      * Called module names
       01  MOD-ZNT01INK              PIC X(8) VALUE 'ZNT01INK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01INK-001.
               CALL 'ZNT01INK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01INK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
