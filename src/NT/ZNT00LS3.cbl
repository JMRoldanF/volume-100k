      ******************************************************************
      * ZNT00LS3 - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT00LS3'.
      ...
      * Called module names
       01  MOD-ZNT01GMB              PIC X(8) VALUE 'ZNT01GMB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01GMB-001.
               CALL 'ZNT01GMB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01GMB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
