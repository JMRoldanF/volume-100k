      ******************************************************************
      * ZNT00Z14 - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT00Z14'.
      ...
      * Called module names
       01  MOD-ZNT01KGX              PIC X(8) VALUE 'ZNT01KGX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01KGX-001.
               CALL 'ZNT01KGX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01KGX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
