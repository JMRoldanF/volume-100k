      ******************************************************************
      * ZNT00Z4J - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT00Z4J'.
      ...
      * Called module names
       01  MOD-ZNT01OTY              PIC X(8) VALUE 'ZNT01OTY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01OTY-002.
               CALL 'ZNT01OTY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01OTY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
