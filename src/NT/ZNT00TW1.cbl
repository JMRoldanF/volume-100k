      ******************************************************************
      * ZNT00TW1 - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT00TW1'.
      ...
      * Called module names
       ...
       01  MOD-ZNT01UKD              PIC X(8) VALUE 'ZNT01UKD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01UKD-002.
               CALL 'ZNT01UKD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
