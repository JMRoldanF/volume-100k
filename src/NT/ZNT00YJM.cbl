      ******************************************************************
      * ZNT00YJM - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT00YJM'.
      ...
      * Called module names
       01  MOD-ZGW01OC8              PIC X(8) VALUE 'ZGW01OC8'.
       01  MOD-ZNT01INP              PIC X(8) VALUE 'ZNT01INP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZGW01OC8-001.
               PERFORM CALL-ZNT01INP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01OC8-001.
               CALL 'ZGW01OC8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01OC8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZNT01INP-002.
               CALL 'ZNT01INP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
