      ******************************************************************
      * ZNT00XWC - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT00XWC'.
      ...
      * Called module names
       01  MOD-ZNT01KM2              PIC X(8) VALUE 'ZNT01KM2'.
       01  MOD-ZNT01JE6              PIC X(8) VALUE 'ZNT01JE6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZNT01KM2-001.
               PERFORM CALL-ZNT01JE6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01KM2-001.
               CALL 'ZNT01KM2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01KM2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZNT01JE6-002.
               CALL 'ZNT01JE6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01JE6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
