      ******************************************************************
      * ZNT00NA6 - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT00NA6'.
      ...
      * Called module names
       01  MOD-ZGW01DK3              PIC X(8) VALUE 'ZGW01DK3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZGW01DK3-001.
               PERFORM CALL-ZNT01CS7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01DK3-001.
               CALL 'ZGW01DK3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01DK3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZNT01CS7-002.
               MOVE 'ZNT01CS7' TO WS-SUBNAME-8
