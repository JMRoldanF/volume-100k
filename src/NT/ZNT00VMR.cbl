      ******************************************************************
      * ZNT00VMR - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT00VMR'.
      ...
      * Called module names
       01  MOD-ZNT01E5D              PIC X(8) VALUE 'ZNT01E5D'.
       01  MOD-ZNT01D3C              PIC X(8) VALUE 'ZNT01D3C'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZNT01E5D-001.
               PERFORM CALL-ZNT01D3C-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01E5D-001.
               CALL 'ZNT01E5D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01E5D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZNT01D3C-002.
               CALL 'ZNT01D3C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01D3C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
