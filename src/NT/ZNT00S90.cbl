      ******************************************************************
      * ZNT00S90 - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT00S90'.
      ...
      * Called module names
       ...
       01  MOD-ZNT01RME              PIC X(8) VALUE 'ZNT01RME'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZNT01P4E-001.
               PERFORM CALL-ZNT01RME-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01RME-002.
               CALL 'ZNT01RME' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01RME FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
