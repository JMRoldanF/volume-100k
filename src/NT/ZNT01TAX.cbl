      ******************************************************************
      * ZNT01TAX - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT01TAX'.
      ...
      * Called module names
       01  MOD-ZNT01D5C              PIC X(8) VALUE 'ZNT01D5C'.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01D5C-001.
               CALL 'ZNT01D5C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01D5C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
