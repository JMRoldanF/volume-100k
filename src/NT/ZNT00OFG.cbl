      ******************************************************************
      * ZNT00OFG - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT00OFG'.
      ...
      * Called module names
       01  MOD-ZGW01MY1              PIC X(8) VALUE 'ZGW01MY1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01MY1-001.
               CALL 'ZGW01MY1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01MY1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZNT01GBC-002.
