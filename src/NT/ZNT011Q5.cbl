      ******************************************************************
      * ZNT011Q5 - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT011Q5'.
      ...
      * Called module names
       01  MOD-ZNT01NDD              PIC X(8) VALUE 'ZNT01NDD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01NDD-002.
               CALL 'ZNT01NDD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01NDD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
