      ******************************************************************
      * ZNT00WKR - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT00WKR'.
      ...
      * Called module names
       01  MOD-ZTR01J6K              PIC X(8) VALUE 'ZTR01J6K'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTR01J6K-001.
               PERFORM CALL-ZNT01O2T-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01J6K-001.
               CALL 'ZTR01J6K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01J6K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZNT01O2T-002.
