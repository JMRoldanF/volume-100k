      ******************************************************************
      * ZNT000PF - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT000PF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZNT008VA-001.
               PERFORM CALL-ZNT00E7C-002.
               PERFORM CALL-ZNT005LY-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT008VA-001.
               MOVE 'ZNT008VA' TO WS-PROGNAME-2
      ...
      *----------------------------------------------------------------*
       CALL-ZNT005LY-003.
               EXEC CICS START TRANSID('Z5LY')
                         FROM(WS-KEY-AREA)
                         LENGTH(20)
                         RESP(WS-RESP)
               END-EXEC.
      * TRANSID Z5LY is defined against ZNT005LY
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT005LY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-004.
