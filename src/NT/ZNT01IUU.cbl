      ******************************************************************
      * ZNT01IUU - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT01IUU'.
      ...
      * Called module names
       01  MOD-ZNT01FG7              PIC X(8) VALUE 'ZNT01FG7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01FG7-001.
               CALL 'ZNT01FG7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01FG7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
