      ******************************************************************
      * ZNT011H6 - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT011H6'.
      ...
      * Called module names
       01  MOD-ZNT01UPL              PIC X(8) VALUE 'ZNT01UPL'.
       01  MOD-ZNT01GBA              PIC X(8) VALUE 'ZNT01GBA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZNT01UPL-001.
               PERFORM CALL-ZNT01GBA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01UPL-001.
               CALL 'ZNT01UPL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01UPL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZNT01GBA-002.
               CALL 'ZNT01GBA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01GBA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
