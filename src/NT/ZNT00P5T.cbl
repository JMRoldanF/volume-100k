      ******************************************************************
      * ZNT00P5T - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT00P5T'.
      ...
      * Called module names
       ...
       01  MOD-ZNT01V18              PIC X(8) VALUE 'ZNT01V18'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZNT01LTC-001.
               PERFORM CALL-ZNT01V18-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01V18-002.
               CALL 'ZNT01V18' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01V18 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
