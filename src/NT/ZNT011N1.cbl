      ******************************************************************
      * ZNT011N1 - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT011N1'.
      ...
      * Called module names
       01  MOD-ZNT01OZN              PIC X(8) VALUE 'ZNT01OZN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01OZN-001.
               CALL 'ZNT01OZN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01OZN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTR01UHS-002.
