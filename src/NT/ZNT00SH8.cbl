      ******************************************************************
      * ZNT00SH8 - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT00SH8'.
      ...
      * Called module names
       01  MOD-ZPA01UDV              PIC X(8) VALUE 'ZPA01UDV'.
       01  MOD-ZNT01OJW              PIC X(8) VALUE 'ZNT01OJW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01UDV-001.
               PERFORM CALL-ZNT01OJW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01UDV-001.
               CALL 'ZPA01UDV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01UDV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZNT01OJW-002.
               CALL 'ZNT01OJW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01OJW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
