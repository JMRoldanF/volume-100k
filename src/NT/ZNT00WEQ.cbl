      ******************************************************************
      * ZNT00WEQ - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT00WEQ'.
      ...
      * Called module names
       01  MOD-ZNT01DRH              PIC X(8) VALUE 'ZNT01DRH'.
       01  MOD-ZNT01PXV              PIC X(8) VALUE 'ZNT01PXV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01DRH-001.
               CALL 'ZNT01DRH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01DRH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZNT01PXV-002.
               CALL 'ZNT01PXV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01PXV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
