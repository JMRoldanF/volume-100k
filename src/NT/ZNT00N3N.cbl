      ******************************************************************
      * ZNT00N3N - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT00N3N'.
      ...
      * Called module names
       01  MOD-ZNT01HJL              PIC X(8) VALUE 'ZNT01HJL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01HJL-001.
               CALL 'ZNT01HJL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01HJL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
