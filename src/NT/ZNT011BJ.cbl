      ******************************************************************
      * ZNT011BJ - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT011BJ'.
      ...
      * Called module names
       01  MOD-ZNT01OYY              PIC X(8) VALUE 'ZNT01OYY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZNT01OYY-001.
               PERFORM CALL-ZNT01CMZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01OYY-001.
               CALL 'ZNT01OYY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01OYY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZNT01CMZ-002.
