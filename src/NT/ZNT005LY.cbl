      ******************************************************************
      * ZNT005LY - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT005LY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZNT00DPT-002.
               PERFORM CALL-ZNT00A9C-003.
               PERFORM CALL-ZNT005ZF-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT00DPT-002.
               MOVE 'ZNT00DPT' TO WS-PROGNAME-5
      ...
      *----------------------------------------------------------------*
       CALL-ZNT005ZF-004.
               EXEC CICS START TRANSID('Z5ZF')
                         FROM(WS-KEY-AREA)
                         LENGTH(20)
                         RESP(WS-RESP)
               END-EXEC.
      * TRANSID Z5ZF is defined against ZNT005ZF
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT005ZF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-005.
