      ******************************************************************
      * ZNT00R4B - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT00R4B'.
      ...
      * Called module names
       01  MOD-ZNT01HLG              PIC X(8) VALUE 'ZNT01HLG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01HLG-001.
               CALL 'ZNT01HLG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01HLG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
