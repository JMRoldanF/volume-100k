      ******************************************************************
      * ZNT00TFD - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT00TFD'.
      ...
      * Called module names
       ...
       01  MOD-ZNT01DNP              PIC X(8) VALUE 'ZNT01DNP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZNT01KZG-001.
               PERFORM CALL-ZNT01DNP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01DNP-002.
               CALL 'ZNT01DNP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01DNP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-MAKE-0001.
