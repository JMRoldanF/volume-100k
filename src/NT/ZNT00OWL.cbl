      ******************************************************************
      * ZNT00OWL - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT00OWL'.
      ...
      * Called module names
       01  MOD-ZNT01GBC              PIC X(8) VALUE 'ZNT01GBC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZNT01OY0-001.
               PERFORM CALL-ZNT01GBC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01GBC-002.
               CALL 'ZNT01GBC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01GBC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
