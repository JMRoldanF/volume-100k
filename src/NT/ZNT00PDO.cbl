      ******************************************************************
      * ZNT00PDO - NOTIFICATION DISPATCH                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZNT00PDO'.
      ...
      * Called module names
       01  MOD-ZNT01PC5              PIC X(8) VALUE 'ZNT01PC5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01PC5-001.
               CALL 'ZNT01PC5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01PC5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTR01EP0-002.
