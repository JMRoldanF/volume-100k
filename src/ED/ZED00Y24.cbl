      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZED00Y24'.
      ...
      * Called module names
       01  MOD-ZED01N1D              PIC X(8) VALUE 'ZED01N1D'.
      ...
      *----------------------------------------------------------------*
       CALL-ZED01N1D-001.
               CALL 'ZED01N1D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZED01N1D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
