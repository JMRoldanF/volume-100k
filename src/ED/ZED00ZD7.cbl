      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZED00ZD7'.
      ...
      * Called module names
       01  MOD-ZED01O3Q              PIC X(8) VALUE 'ZED01O3Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZED01O3Q-001.
               CALL 'ZED01O3Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZED01O3Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
