      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZED00R5Z'.
      ...
      * Called module names
       01  MOD-ZED01L5H              PIC X(8) VALUE 'ZED01L5H'.
      ...
      *----------------------------------------------------------------*
       CALL-ZED01L5H-001.
               CALL 'ZED01L5H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZED01L5H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
