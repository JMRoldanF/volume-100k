      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZED00RTV'.
      ...
      * Called module names
       01  MOD-ZED01FFP              PIC X(8) VALUE 'ZED01FFP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZED01UZU-001.
               PERFORM CALL-ZED01FFP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZED01FFP-002.
               CALL 'ZED01FFP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
