      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZED00SG5'.
      ...
      * Called module names
       ...
       01  MOD-ZED01F89              PIC X(8) VALUE 'ZED01F89'.
      ...
      *----------------------------------------------------------------*
       CALL-ZED01F89-002.
               CALL 'ZED01F89' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZED01F89 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
