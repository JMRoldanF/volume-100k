      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZED00MUS'.
      ...
      * Called module names
       ...
       01  MOD-ZHE01DX0              PIC X(8) VALUE 'ZHE01DX0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZED01Q4W-001.
               PERFORM CALL-ZHE01DX0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01DX0-002.
               CALL 'ZHE01DX0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01DX0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
