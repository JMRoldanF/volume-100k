      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZED00ROV'.
      ...
      * Called module names
       01  MOD-ZED01OEG              PIC X(8) VALUE 'ZED01OEG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZED01OEG-001.
               PERFORM CALL-ZED01LPR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZED01OEG-001.
               CALL 'ZED01OEG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZED01OEG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZED01LPR-002.
