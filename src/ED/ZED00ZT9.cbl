      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZED00ZT9'.
      ...
      * Called module names
       01  MOD-ZED01K2Q              PIC X(8) VALUE 'ZED01K2Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZED01K2Q-001.
               CALL 'ZED01K2Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZED01K2Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-COLOUR-0001.
