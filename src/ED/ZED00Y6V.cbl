      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZED00Y6V'.
      ...
      * Called module names
       01  MOD-ZLB01P67              PIC X(8) VALUE 'ZLB01P67'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01P67-001.
               CALL 'ZLB01P67' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01P67 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZED01N4U-002.
