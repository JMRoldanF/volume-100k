      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZED00LTG'.
      ...
      * Called module names
       ...
       01  MOD-ZLB01N1T              PIC X(8) VALUE 'ZLB01N1T'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01N1T-002.
               CALL 'ZLB01N1T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01N1T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
