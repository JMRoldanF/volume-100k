      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZED00SIQ'.
      ...
      * Called module names
       01  MOD-ZED01E0Z              PIC X(8) VALUE 'ZED01E0Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZED01E0Z-001.
               CALL 'ZED01E0Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZED01E0Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
