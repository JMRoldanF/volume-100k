      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZED00R1Y'.
      ...
      * Called module names
       ...
       01  MOD-ZRG01PEY              PIC X(8) VALUE 'ZRG01PEY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZED01NK8-001.
               PERFORM CALL-ZRG01PEY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01PEY-002.
               CALL 'ZRG01PEY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01PEY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-COLOUR-0001.
