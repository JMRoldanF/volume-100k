      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZED00G4N'.
      ...
      * Called module names
       01  MOD-ZED00Y3R              PIC X(8) VALUE 'ZED00Y3R'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZED00Y3R-002.
               PERFORM CALL-ZED0167V-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZED00S6B-001.
               MOVE 'ZED00S6B' TO WS-PROGNAME-5
      ...
      *----------------------------------------------------------------*
       CALL-ZED00Y3R-002.
               EXEC CICS LINK PROGRAM('ZED00Y3R')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZED00Y3R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZED0167V-003.
               MOVE 'ZED0167V' TO WS-PROGNAME-6
