      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZED00S0Z'.
      ...
      * Called module names
       01  MOD-ZED01PO8              PIC X(8) VALUE 'ZED01PO8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZED01PO8-001.
               PERFORM CALL-ZED01QXV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZED01PO8-001.
               CALL 'ZED01PO8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZED01PO8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZED01QXV-002.
               MOVE 'ZED01QXV' TO WS-SUBNAME-4
