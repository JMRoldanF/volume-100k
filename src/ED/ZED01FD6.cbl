      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZED01FD6'.
      ...
      * Called module names
       01  MOD-ZED01NJX              PIC X(8) VALUE 'ZED01NJX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZED01NJX-001.
               CALL 'ZED01NJX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZED01NJX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
