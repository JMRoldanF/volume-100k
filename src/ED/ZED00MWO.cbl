      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZED00MWO'.
      ...
      * Called module names
       ...
       01  MOD-ZRG01OPV              PIC X(8) VALUE 'ZRG01OPV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZED01NQW-001.
               PERFORM CALL-ZRG01OPV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01OPV-002.
               CALL 'ZRG01OPV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01OPV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
