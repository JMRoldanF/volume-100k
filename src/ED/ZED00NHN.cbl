      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZED00NHN'.
      ...
      * Called module names
       01  MOD-ZED01EYN              PIC X(8) VALUE 'ZED01EYN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZED01EYN-001.
               CALL 'ZED01EYN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZED01EYN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
