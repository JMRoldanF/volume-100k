      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZED00IOQ'.
      ...
      * Called module names
       01  MOD-ZED00Y7D              PIC X(8) VALUE 'ZED00Y7D'.
       01  MOD-ZED012OO              PIC X(8) VALUE 'ZED012OO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZED00Y7D-001.
               PERFORM CALL-ZED016XB-002.
               PERFORM CALL-ZED012OO-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZED00Y7D-001.
               EXEC CICS LINK PROGRAM('ZED00Y7D')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZED00Y7D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZED016XB-002.
               MOVE 'ZED016XB' TO WS-PROGNAME-3
      ...
      *----------------------------------------------------------------*
       CALL-ZED012OO-003.
               EXEC CICS LINK PROGRAM('ZED012OO')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZED012OO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-004.
