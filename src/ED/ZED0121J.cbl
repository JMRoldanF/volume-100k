      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZED0121J'.
      ...
      * Called module names
       01  MOD-ZED01QN0              PIC X(8) VALUE 'ZED01QN0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZED01QN0-001.
               PERFORM CALL-ZED01NP4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZED01QN0-001.
               CALL 'ZED01QN0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZED01QN0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZED01NP4-002.
