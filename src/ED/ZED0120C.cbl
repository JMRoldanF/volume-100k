      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZED0120C'.
      ...
      * Called module names
       01  MOD-ZRG01FVV              PIC X(8) VALUE 'ZRG01FVV'.
       01  MOD-ZED01R0I              PIC X(8) VALUE 'ZED01R0I'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRG01FVV-001.
               PERFORM CALL-ZED01R0I-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01FVV-001.
               CALL 'ZRG01FVV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01FVV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZED01R0I-002.
               CALL 'ZED01R0I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZED01R0I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
