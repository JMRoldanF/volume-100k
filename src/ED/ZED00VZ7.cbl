      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZED00VZ7'.
      ...
      * Called module names
       ...
       01  MOD-ZED01O6R              PIC X(8) VALUE 'ZED01O6R'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLB01IMK-001.
               PERFORM CALL-ZED01O6R-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZED01O6R-002.
               CALL 'ZED01O6R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZED01O6R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
