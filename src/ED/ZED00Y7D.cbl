      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZED00Y7D'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZED01DDZ-001.
               PERFORM CALL-ZED01DZ6-002.
               ...
               PERFORM DERIVE-WITH-PROFITS-0070.
      ...
      *----------------------------------------------------------------*
       CALL-ZED01DDZ-001.
               MOVE 'ZED01DDZ' TO WS-SUBNAME-5
               CALL WS-SUBNAME-5 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZED01DDZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZED01DZ6-002.
