      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZED00WAL'.
      ...
      * Called module names
       01  MOD-ZED01HIT              PIC X(8) VALUE 'ZED01HIT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZED01HIT-001.
               CALL 'ZED01HIT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZED01HIT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-VALUE-0001.
