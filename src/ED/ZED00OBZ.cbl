      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZED00OBZ'.
      ...
      * Called module names
       01  MOD-ZED01GLE              PIC X(8) VALUE 'ZED01GLE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZED01GLE-001.
               PERFORM CALL-ZED01DBN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZED01GLE-001.
               CALL 'ZED01GLE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZED01GLE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZED01DBN-002.
