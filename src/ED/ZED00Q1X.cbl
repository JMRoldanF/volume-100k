      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZED00Q1X'.
      ...
      * Called module names
       01  MOD-ZED01EHC              PIC X(8) VALUE 'ZED01EHC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZED01EHC-001.
               CALL 'ZED01EHC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZED01EHC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
