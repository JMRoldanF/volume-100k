      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZED00VYE'.
      ...
      * Called module names
       01  MOD-ZED01R2P              PIC X(8) VALUE 'ZED01R2P'.
      ...
      *----------------------------------------------------------------*
       CALL-ZED01R2P-001.
               CALL 'ZED01R2P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZED01R2P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
