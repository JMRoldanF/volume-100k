      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZED00WIU'.
      ...
      * Called module names
       01  MOD-ZED01FJH              PIC X(8) VALUE 'ZED01FJH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZED01FJH-001.
               CALL 'ZED01FJH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZED01FJH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
