      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZED00YE1'.
      ...
      * Called module names
       01  MOD-ZED01QXV              PIC X(8) VALUE 'ZED01QXV'.
       01  MOD-ZED01H2S              PIC X(8) VALUE 'ZED01H2S'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZED01QXV-001.
               PERFORM CALL-ZED01H2S-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZED01QXV-001.
               CALL 'ZED01QXV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZED01QXV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZED01H2S-002.
               CALL 'ZED01H2S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZED01H2S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
