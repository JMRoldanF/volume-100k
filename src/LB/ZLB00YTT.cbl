      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLB00YTT'.
      ...
      * Called module names
       01  MOD-ZLB01MO2              PIC X(8) VALUE 'ZLB01MO2'.
       01  MOD-ZLB01M2Q              PIC X(8) VALUE 'ZLB01M2Q'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLB01MO2-001.
               PERFORM CALL-ZLB01M2Q-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01MO2-001.
               CALL 'ZLB01MO2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01MO2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLB01M2Q-002.
               CALL 'ZLB01M2Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01M2Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-TERM-0001.
