      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLB00OCE'.
      ...
      * Called module names
       01  MOD-ZLB01KJ4              PIC X(8) VALUE 'ZLB01KJ4'.
       01  MOD-ZLB01CRQ              PIC X(8) VALUE 'ZLB01CRQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01KJ4-001.
               CALL 'ZLB01KJ4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01CRQ-002.
               CALL 'ZLB01CRQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01CRQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
