      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLB012JF'.
      ...
      * Called module names
       ...
       01  MOD-ZLB01CMJ              PIC X(8) VALUE 'ZLB01CMJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01CMJ-002.
               CALL 'ZLB01CMJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01CMJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
