      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLB010RK'.
      ...
      * Called module names
       01  MOD-ZLB01GXG              PIC X(8) VALUE 'ZLB01GXG'.
       01  MOD-ZPL01L46              PIC X(8) VALUE 'ZPL01L46'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLB01GXG-001.
               PERFORM CALL-ZPL01L46-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01GXG-001.
               CALL 'ZLB01GXG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01GXG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPL01L46-002.
               CALL 'ZPL01L46' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPL01L46 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
