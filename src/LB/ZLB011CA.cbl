      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLB011CA'.
      ...
      * Called module names
       01  MOD-ZLB01GDX              PIC X(8) VALUE 'ZLB01GDX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01GDX-001.
               CALL 'ZLB01GDX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01GDX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RECONCILE-TERM-0001.
