      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLB0128M'.
      ...
      * Called module names
       01  MOD-ZLB01KTT              PIC X(8) VALUE 'ZLB01KTT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01KTT-001.
               CALL 'ZLB01KTT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01KTT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
