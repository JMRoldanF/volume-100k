      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLB00TC4'.
      ...
      * Called module names
       01  MOD-ZLB01E12              PIC X(8) VALUE 'ZLB01E12'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01E12-001.
               CALL 'ZLB01E12' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01E12 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
