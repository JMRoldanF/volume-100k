      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLB00P1P'.
      ...
      * Called module names
       01  MOD-ZLB01QEA              PIC X(8) VALUE 'ZLB01QEA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01QEA-001.
               CALL 'ZLB01QEA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01QEA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLB01PU3-002.
               MOVE 'ZLB01PU3' TO WS-SUBNAME-5
