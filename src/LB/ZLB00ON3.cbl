      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLB00ON3'.
      ...
      * Called module names
       01  MOD-ZLB01G2S              PIC X(8) VALUE 'ZLB01G2S'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01G2S-001.
               CALL 'ZLB01G2S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01G2S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-EXCESS-0001.
