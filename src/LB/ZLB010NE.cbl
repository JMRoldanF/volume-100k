      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLB010NE'.
      ...
      * Called module names
       01  MOD-ZLB01P34              PIC X(8) VALUE 'ZLB01P34'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01P34-001.
               CALL 'ZLB01P34' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01P34 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
