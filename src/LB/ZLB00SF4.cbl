      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLB00SF4'.
      ...
      * Called module names
       01  MOD-ZLB01GPW              PIC X(8) VALUE 'ZLB01GPW'.
       01  MOD-ZLB01MIG              PIC X(8) VALUE 'ZLB01MIG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLB01GPW-001.
               PERFORM CALL-ZLB01MIG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01GPW-001.
               CALL 'ZLB01GPW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01GPW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLB01MIG-002.
               CALL 'ZLB01MIG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01MIG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
