      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLB010P8'.
      ...
      * Called module names
       01  MOD-ZLB01CVL              PIC X(8) VALUE 'ZLB01CVL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRC01QLR-001.
               PERFORM CALL-ZLB01CVL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01CVL-002.
               CALL 'ZLB01CVL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01CVL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
