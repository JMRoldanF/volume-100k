      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLB00J74'.
      ...
      * Called module names
       ...
       01  MOD-ZPL00TS6              PIC X(8) VALUE 'ZPL00TS6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLB00TBF-001.
               PERFORM CALL-ZPL00TS6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB00TBF-001.
               EXEC CICS LINK PROGRAM('ZLB00TBF')
      ...
      *----------------------------------------------------------------*
       CALL-ZPL00TS6-002.
               EXEC CICS LINK PROGRAM('ZPL00TS6')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
