      ******************************************************************
      * ZLB00U9T - LIABILITY COVER                                     *
      ******************************************************************
      *
      *  Generated volume-test source. Layer 2,
      *  type data_db2, domain LIABLTY.
      ******************************************************************
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLB00U9T'.
      ...
      * Called module names
       01  MOD-ZSB01LTI              PIC X(8) VALUE 'ZSB01LTI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM FORMAT-SUM-ASSURED-0103.
               ...
               PERFORM NORMALISE-BEDROOMS-0112.
      ...
      *----------------------------------------------------------------*
       CALL-ZSB01LTI-001.
               CALL 'ZSB01LTI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
       ...
       SQL-ACCESS-0006.
               EXEC SQL
                     ...
                     SELECT POLICYNUMBER, PAYMENT
                       FROM GENALB.RESERVE A
                       JOIN GENALB.CUSTOMER B
