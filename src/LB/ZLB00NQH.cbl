      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLB00NQH'.
      ...
      * Called module names
       ...
       01  MOD-ZSB01OO8              PIC X(8) VALUE 'ZSB01OO8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLB01CVL-001.
               PERFORM CALL-ZSB01OO8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSB01OO8-002.
               CALL 'ZSB01OO8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSB01OO8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
