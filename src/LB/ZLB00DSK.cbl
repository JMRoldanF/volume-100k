      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLB00DSK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLB00ZNB-001.
               PERFORM CALL-ZLB00PET-002.
               PERFORM CALL-ZLB01JKW-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB00ZNB-001.
               MOVE 'ZLB00ZNB' TO WS-PROGNAME-4
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB00ZNB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLB00PET-002.
               MOVE 'ZLB00PET' TO WS-PROGNAME-5
