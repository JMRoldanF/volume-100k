      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLB00RHQ'.
      ...
      * Called module names
       01  MOD-ZLB01GZP              PIC X(8) VALUE 'ZLB01GZP'.
       01  MOD-ZLB01SC6              PIC X(8) VALUE 'ZLB01SC6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLB01GZP-001.
               PERFORM CALL-ZLB01SC6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01GZP-001.
               CALL 'ZLB01GZP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01GZP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLB01SC6-002.
               CALL 'ZLB01SC6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01SC6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
