      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLB012A5'.
      ...
      * Called module names
       01  MOD-ZLB01S68              PIC X(8) VALUE 'ZLB01S68'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01S68-001.
               CALL 'ZLB01S68' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01S68 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
