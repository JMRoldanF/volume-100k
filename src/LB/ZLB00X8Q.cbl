      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLB00X8Q'.
      ...
      * Called module names
       01  MOD-ZLB01T1K              PIC X(8) VALUE 'ZLB01T1K'.
       01  MOD-ZPL01JFC              PIC X(8) VALUE 'ZPL01JFC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLB01T1K-001.
               PERFORM CALL-ZPL01JFC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01T1K-001.
               CALL 'ZLB01T1K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01T1K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPL01JFC-002.
               CALL 'ZPL01JFC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPL01JFC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
