      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLB00ZO1'.
      ...
      * Called module names
       01  MOD-ZLB01T6L              PIC X(8) VALUE 'ZLB01T6L'.
       01  MOD-ZLB01JUN              PIC X(8) VALUE 'ZLB01JUN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLB01T6L-001.
               PERFORM CALL-ZLB01JUN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01T6L-001.
               CALL 'ZLB01T6L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01T6L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLB01JUN-002.
               CALL 'ZLB01JUN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01JUN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
