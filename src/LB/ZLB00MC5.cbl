      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLB00MC5'.
      ...
      * Called module names
       01  MOD-ZPL01JO2              PIC X(8) VALUE 'ZPL01JO2'.
       01  MOD-ZLB01M8P              PIC X(8) VALUE 'ZLB01M8P'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPL01JO2-001.
               PERFORM CALL-ZLB01M8P-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPL01JO2-001.
               CALL 'ZPL01JO2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPL01JO2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLB01M8P-002.
               CALL 'ZLB01M8P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01M8P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
