      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLB00PUX'.
      ...
      * Called module names
       01  MOD-ZLB01PKB              PIC X(8) VALUE 'ZLB01PKB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01PKB-001.
               CALL 'ZLB01PKB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01PKB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
