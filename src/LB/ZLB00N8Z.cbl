      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLB00N8Z'.
      ...
      * Called module names
       01  MOD-ZLB01NRP              PIC X(8) VALUE 'ZLB01NRP'.
       01  MOD-ZLB01CW2              PIC X(8) VALUE 'ZLB01CW2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLB01NRP-001.
               PERFORM CALL-ZLB01CW2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01NRP-001.
               CALL 'ZLB01NRP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01NRP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLB01CW2-002.
               CALL 'ZLB01CW2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01CW2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
