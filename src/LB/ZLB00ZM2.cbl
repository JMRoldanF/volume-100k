      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLB00ZM2'.
      ...
      * Called module names
       01  MOD-ZLB01RYS              PIC X(8) VALUE 'ZLB01RYS'.
       01  MOD-ZLB01FA5              PIC X(8) VALUE 'ZLB01FA5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLB01RYS-001.
               PERFORM CALL-ZLB01FA5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01RYS-001.
               CALL 'ZLB01RYS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01RYS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLB01FA5-002.
               CALL 'ZLB01FA5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
