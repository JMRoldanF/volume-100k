      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLB00OYU'.
      ...
      * Called module names
       01  MOD-ZLB01PYJ              PIC X(8) VALUE 'ZLB01PYJ'.
       01  MOD-ZLB01EN3              PIC X(8) VALUE 'ZLB01EN3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLB01PYJ-001.
               PERFORM CALL-ZLB01EN3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01PYJ-001.
               CALL 'ZLB01PYJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01PYJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLB01EN3-002.
               CALL 'ZLB01EN3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01EN3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
