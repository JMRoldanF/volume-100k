      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLB00RCB'.
      ...
      * Called module names
       01  MOD-ZLB01L9G              PIC X(8) VALUE 'ZLB01L9G'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01L9G-001.
               CALL 'ZLB01L9G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01L9G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRC01M2C-002.
