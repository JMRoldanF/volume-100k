      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLB0063G'.
      ...
      * Called module names
       01  MOD-ZSB00E3V              PIC X(8) VALUE 'ZSB00E3V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSB00E3V-001.
               EXEC CICS LINK PROGRAM('ZSB00E3V')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSB00E3V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZVA009XV-002.
