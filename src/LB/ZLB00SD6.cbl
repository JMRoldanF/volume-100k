      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLB00SD6'.
      ...
      * Called module names
       01  MOD-ZLB01RKR              PIC X(8) VALUE 'ZLB01RKR'.
       01  MOD-ZLB01ILC              PIC X(8) VALUE 'ZLB01ILC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLB01RKR-001.
               PERFORM CALL-ZLB01ILC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01RKR-001.
               CALL 'ZLB01RKR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01RKR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLB01ILC-002.
               CALL 'ZLB01ILC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01ILC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
