      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLB00M13'.
      ...
      * Called module names
       01  MOD-ZLB01JGV              PIC X(8) VALUE 'ZLB01JGV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLB01JGV-001.
               PERFORM CALL-ZLB01DRU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01JGV-001.
               CALL 'ZLB01JGV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01JGV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLB01DRU-002.
