      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLB00T3U'.
      ...
      * Called module names
       01  MOD-ZSB01RRW              PIC X(8) VALUE 'ZSB01RRW'.
       01  MOD-ZLB01JL8              PIC X(8) VALUE 'ZLB01JL8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSB01RRW-001.
               PERFORM CALL-ZLB01JL8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSB01RRW-001.
               CALL 'ZSB01RRW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSB01RRW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLB01JL8-002.
               CALL 'ZLB01JL8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01JL8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
