      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRC00PJK'.
      ...
      * Called module names
       01  MOD-ZRC01F7S              PIC X(8) VALUE 'ZRC01F7S'.
       01  MOD-ZRC01Q34              PIC X(8) VALUE 'ZRC01Q34'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRC01F7S-001.
               PERFORM CALL-ZRC01Q34-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRC01F7S-001.
               CALL 'ZRC01F7S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRC01F7S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRC01Q34-002.
               CALL 'ZRC01Q34' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRC01Q34 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-COLOUR-0001.
