      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRC00URF'.
      ...
      * Called module names
       01  MOD-ZRC01H5D              PIC X(8) VALUE 'ZRC01H5D'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRC01H5D-001.
               CALL 'ZRC01H5D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRC01H5D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
