      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRC0106F'.
      ...
      * Called module names
       01  MOD-ZRC01T41              PIC X(8) VALUE 'ZRC01T41'.
       01  MOD-ZRC01NUX              PIC X(8) VALUE 'ZRC01NUX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRC01T41-001.
               PERFORM CALL-ZRC01NUX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRC01T41-001.
               CALL 'ZRC01T41' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRC01T41 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRC01NUX-002.
               CALL 'ZRC01NUX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRC01NUX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
