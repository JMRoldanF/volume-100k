      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRC01060'.
      ...
      * Called module names
       01  MOD-ZRC01IQK              PIC X(8) VALUE 'ZRC01IQK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRC01IQK-001.
               CALL 'ZRC01IQK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRC01IQK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-EQUITIES-0001.
