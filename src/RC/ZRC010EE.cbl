      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRC010EE'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01GUA              PIC X(8) VALUE 'ZCU01GUA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01GUA-002.
               CALL 'ZCU01GUA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01GUA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-TERM-0001.
