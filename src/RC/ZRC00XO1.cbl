      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRC00XO1'.
      ...
      * Called module names
       01  MOD-ZRC01K23              PIC X(8) VALUE 'ZRC01K23'.
       01  MOD-ZBA01V27              PIC X(8) VALUE 'ZBA01V27'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRC01K23-001.
               PERFORM CALL-ZBA01V27-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRC01K23-001.
               CALL 'ZRC01K23' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRC01K23 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBA01V27-002.
               CALL 'ZBA01V27' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBA01V27 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
