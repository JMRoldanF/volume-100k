      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRC00V84'.
      ...
      * Called module names
       ...
       01  MOD-ZRC01NE4              PIC X(8) VALUE 'ZRC01NE4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRC01NE4-002.
               CALL 'ZRC01NE4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRC01NE4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
