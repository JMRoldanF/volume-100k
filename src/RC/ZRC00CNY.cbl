      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRC00CNY'.
      ...
      * Called module names
       01  MOD-ZRC00OJG              PIC X(8) VALUE 'ZRC00OJG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRC00OJG-001.
               PERFORM CALL-ZCP00W3I-002.
               PERFORM CALL-ZRC00RGD-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZRC00OJG-001.
               EXEC CICS LINK PROGRAM('ZRC00OJG')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRC00OJG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCP00W3I-002.
