      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRC00TQM'.
      ...
      * Called module names
       ...
       01  MOD-ZRC01LMG              PIC X(8) VALUE 'ZRC01LMG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRC01LMG-002.
               CALL 'ZRC01LMG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRC01LMG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
