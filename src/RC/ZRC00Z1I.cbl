      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRC00Z1I'.
      ...
      * Called module names
       ...
       01  MOD-ZRC01EE0              PIC X(8) VALUE 'ZRC01EE0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRC01EE0-002.
               CALL 'ZRC01EE0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRC01EE0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
