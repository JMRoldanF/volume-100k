      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRC01102'.
      ...
      * Called module names
       01  MOD-ZBA01Q2R              PIC X(8) VALUE 'ZBA01Q2R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBA01Q2R-001.
               CALL 'ZBA01Q2R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBA01Q2R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
