      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRC00ODK'.
      ...
      * Called module names
       01  MOD-ZRC01R6T              PIC X(8) VALUE 'ZRC01R6T'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRC01R6T-001.
               CALL 'ZRC01R6T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRC01R6T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
