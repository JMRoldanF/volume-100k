      ******************************************************************
      * ZRC00RXG - RECOVERY ACTIONS                                    *
      ******************************************************************
      *
      *  Generated volume-test source. Layer 2,
      *  type data_db2, domain RECOVER.
      ******************************************************************
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRC00RXG'.
      ...
      * Called module names
       01  MOD-ZRC01OCT              PIC X(8) VALUE 'ZRC01OCT'.
       01  MOD-ZCU01OV2              PIC X(8) VALUE 'ZCU01OV2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRC01OCT-001.
               PERFORM CALL-ZCU01OV2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRC01OCT-001.
               CALL 'ZRC01OCT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRC01OCT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01OV2-002.
               CALL 'ZCU01OV2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01OV2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
       ...
       SQL-ACCESS-0015.
               EXEC SQL
                     ...
                     SELECT POLICYNUMBER, PAYMENT
                       FROM GENARC.RESERVE A
                       JOIN GENARC.CUSTOMER B
