      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRC00N01'.
      ...
      * Called module names
       01  MOD-ZRC01G4P              PIC X(8) VALUE 'ZRC01G4P'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRC01G4P-001.
               CALL 'ZRC01G4P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRC01G4P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
