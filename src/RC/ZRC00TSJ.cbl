      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRC00TSJ'.
      ...
      * Called module names
       01  MOD-ZBA01I2C              PIC X(8) VALUE 'ZBA01I2C'.
       01  MOD-ZRC01TYR              PIC X(8) VALUE 'ZRC01TYR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBA01I2C-001.
               PERFORM CALL-ZRC01TYR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBA01I2C-001.
               CALL 'ZBA01I2C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBA01I2C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRC01TYR-002.
               CALL 'ZRC01TYR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRC01TYR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
