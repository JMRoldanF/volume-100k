      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRC00MTE'.
      ...
      * Called module names
       01  MOD-ZBA01OYQ              PIC X(8) VALUE 'ZBA01OYQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRC01N2W-001.
               PERFORM CALL-ZBA01OYQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBA01OYQ-002.
               CALL 'ZBA01OYQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
