      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRC00QLR'.
      ...
      * Called module names
       01  MOD-ZRC01D49              PIC X(8) VALUE 'ZRC01D49'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRC01D49-001.
               CALL 'ZRC01D49' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRC01D49 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
