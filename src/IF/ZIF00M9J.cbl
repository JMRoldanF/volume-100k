      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIF00M9J'.
      ...
      * Called module names
       01  MOD-ZAC01MR3              PIC X(8) VALUE 'ZAC01MR3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAC01MR3-001.
               PERFORM CALL-ZIF01SYV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01MR3-001.
               CALL 'ZAC01MR3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01MR3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIF01SYV-002.
