      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIF00P30'.
      ...
      * Called module names
       01  MOD-ZIF01GHT              PIC X(8) VALUE 'ZIF01GHT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIF01GHT-001.
               PERFORM CALL-ZIF01CS2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZIF01GHT-001.
               CALL 'ZIF01GHT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIF01GHT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIF01CS2-002.
