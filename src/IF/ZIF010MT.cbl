      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIF010MT'.
      ...
      * Called module names
       01  MOD-ZPA01OCM              PIC X(8) VALUE 'ZPA01OCM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01OCM-001.
               CALL 'ZPA01OCM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01OCM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
