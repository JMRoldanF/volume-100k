      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIF010MD'.
      ...
      * Called module names
       01  MOD-ZIF01UKG              PIC X(8) VALUE 'ZIF01UKG'.
       01  MOD-ZIF01H8D              PIC X(8) VALUE 'ZIF01H8D'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIF01UKG-001.
               PERFORM CALL-ZIF01H8D-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZIF01UKG-001.
               CALL 'ZIF01UKG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIF01UKG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIF01H8D-002.
               CALL 'ZIF01H8D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
