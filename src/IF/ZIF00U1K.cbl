      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIF00U1K'.
      ...
      * Called module names
       01  MOD-ZIF01ECZ              PIC X(8) VALUE 'ZIF01ECZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIF01ECZ-001.
               CALL 'ZIF01ECZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIF01ECZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
