      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIF01DK1'.
      ...
      * Called module names
       01  MOD-ZPA01HDB              PIC X(8) VALUE 'ZPA01HDB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01HDB-001.
               CALL 'ZPA01HDB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01HDB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RECONCILE-TERM-0001.
