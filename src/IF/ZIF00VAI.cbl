      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIF00VAI'.
      ...
      * Called module names
       01  MOD-ZIF01DK1              PIC X(8) VALUE 'ZIF01DK1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIF01DK1-001.
               PERFORM CALL-ZIF01DYT-002.
               PERFORM CALL-ZBI0255Q-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZIF01DK1-001.
               CALL 'ZIF01DK1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIF01DK1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIF01DYT-002.
