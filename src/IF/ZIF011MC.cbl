      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIF011MC'.
      ...
      * Called module names
       01  MOD-ZIF01ET6              PIC X(8) VALUE 'ZIF01ET6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIF01ET6-001.
               PERFORM CALL-ZIF01U1R-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZIF01ET6-001.
               CALL 'ZIF01ET6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIF01ET6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIF01U1R-002.
