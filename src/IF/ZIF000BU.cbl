      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIF000BU'.
      ...
      * Called module names
       01  MOD-ZIF00B7V              PIC X(8) VALUE 'ZIF00B7V'.
       01  MOD-ZIF00JRP              PIC X(8) VALUE 'ZIF00JRP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIF00B7V-001.
               PERFORM CALL-ZIF00JRP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZIF00B7V-001.
               EXEC CICS LINK PROGRAM('ZIF00B7V')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIF00B7V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIF00JRP-002.
               EXEC CICS LINK PROGRAM('ZIF00JRP')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIF00JRP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
