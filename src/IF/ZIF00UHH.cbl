      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIF00UHH'.
      ...
      * Called module names
       01  MOD-ZAC01F4X              PIC X(8) VALUE 'ZAC01F4X'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01F4X-001.
               CALL 'ZAC01F4X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01F4X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIF01OP9-002.
               MOVE 'ZIF01OP9' TO WS-SUBNAME-8
