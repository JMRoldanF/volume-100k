      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIF00QU3'.
      ...
      * Called module names
       01  MOD-ZIF01TAQ              PIC X(8) VALUE 'ZIF01TAQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIF01TAQ-001.
               PERFORM CALL-ZPN01L4B-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZIF01TAQ-001.
               CALL 'ZIF01TAQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIF01TAQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPN01L4B-002.
