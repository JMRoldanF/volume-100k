      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIF01FAP'.
      ...
      * Called module names
       01  MOD-ZAC01TKC              PIC X(8) VALUE 'ZAC01TKC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01TKC-001.
               CALL 'ZAC01TKC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
