      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIF00MYE'.
      ...
      * Called module names
       01  MOD-ZIF01HB1              PIC X(8) VALUE 'ZIF01HB1'.
       01  MOD-ZAC01CMS              PIC X(8) VALUE 'ZAC01CMS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIF01HB1-001.
               PERFORM CALL-ZAC01CMS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZIF01HB1-001.
               CALL 'ZIF01HB1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIF01HB1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAC01CMS-002.
               CALL 'ZAC01CMS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01CMS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
