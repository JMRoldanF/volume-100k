      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIF01BNK'.
      ...
      * Called module names
       01  MOD-ZFR01RB4              PIC X(8) VALUE 'ZFR01RB4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01RB4-001.
               CALL 'ZFR01RB4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01RB4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFR01LP6-002.
