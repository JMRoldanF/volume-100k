      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIF00TBC'.
      ...
      * Called module names
       01  MOD-ZIF01IO4              PIC X(8) VALUE 'ZIF01IO4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIF01IO4-001.
               CALL 'ZIF01IO4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIF01IO4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
