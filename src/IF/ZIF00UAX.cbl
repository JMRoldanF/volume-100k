      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIF00UAX'.
      ...
      * Called module names
       ...
       01  MOD-ZIF01GGA              PIC X(8) VALUE 'ZIF01GGA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIF01GGA-002.
               CALL 'ZIF01GGA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIF01GGA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
