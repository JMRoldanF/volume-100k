      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIF00YPX'.
      ...
      * Called module names
       01  MOD-ZPA01OF7              PIC X(8) VALUE 'ZPA01OF7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01OF7-001.
               PERFORM CALL-ZIF01SSS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01OF7-001.
               CALL 'ZPA01OF7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
