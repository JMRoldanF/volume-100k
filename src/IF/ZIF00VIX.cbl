      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIF00VIX'.
      ...
      * Called module names
       01  MOD-ZIF01EM8              PIC X(8) VALUE 'ZIF01EM8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIF01EM8-001.
               CALL 'ZIF01EM8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIF01EM8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
