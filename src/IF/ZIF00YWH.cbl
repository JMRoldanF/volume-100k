      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIF00YWH'.
      ...
      * Called module names
       01  MOD-ZFR01P0K              PIC X(8) VALUE 'ZFR01P0K'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFR01P0K-001.
               PERFORM CALL-ZIF01TRL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01P0K-001.
               CALL 'ZFR01P0K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
