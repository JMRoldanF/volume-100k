      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIF0117D'.
      ...
      * Called module names
       01  MOD-ZIF01N6N              PIC X(8) VALUE 'ZIF01N6N'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIF01N6N-001.
               CALL 'ZIF01N6N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIF01N6N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
