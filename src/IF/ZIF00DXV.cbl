      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIF00DXV'.
      ...
      * Called module names
       01  MOD-ZPN011JA              PIC X(8) VALUE 'ZPN011JA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPN011JA-001.
               PERFORM CALL-ZIF01AIQ-002.
               PERFORM CALL-ZIF01RJM-003.
               PERFORM CALL-ZIF01HCW-004.
               PERFORM CALL-ZAG0255S-005.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZPN011JA-001.
               EXEC CICS LINK PROGRAM('ZPN011JA')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN011JA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIF01AIQ-002.
