      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIF00747'.
      ...
      * Called module names
       ...
       01  MOD-ZIF013X6              PIC X(8) VALUE 'ZIF013X6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIF013X6-002.
               PERFORM CALL-ZIF01H24-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZIF013X6-002.
               EXEC CICS LINK PROGRAM('ZIF013X6')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIF013X6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIF01H24-003.
