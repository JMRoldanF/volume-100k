      ******************************************************************
      * ZCR0114T - CUSTOMER CORRESPONDENCE                             *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCR0114T'.
      ...
      * Called module names
       01  MOD-ZCR01HPD              PIC X(8) VALUE 'ZCR01HPD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSE01KZO-001.
               PERFORM CALL-ZCR01HPD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCR01HPD-002.
               CALL 'ZCR01HPD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCR01HPD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
