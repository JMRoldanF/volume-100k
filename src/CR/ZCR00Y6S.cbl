      ******************************************************************
      * ZCR00Y6S - CUSTOMER CORRESPONDENCE                             *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCR00Y6S'.
      ...
      * Called module names
       01  MOD-ZCR01PCZ              PIC X(8) VALUE 'ZCR01PCZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCR01PCZ-001.
               CALL 'ZCR01PCZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCR01PCZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
