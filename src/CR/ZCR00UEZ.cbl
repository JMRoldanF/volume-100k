      ******************************************************************
      * ZCR00UEZ - CUSTOMER CORRESPONDENCE                             *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCR00UEZ'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01FVN              PIC X(8) VALUE 'ZAG01FVN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCR01S85-001.
               PERFORM CALL-ZAG01FVN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01FVN-002.
               CALL 'ZAG01FVN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01FVN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
