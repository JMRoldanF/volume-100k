      ******************************************************************
      * ZCR00PHG - CUSTOMER CORRESPONDENCE                             *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCR00PHG'.
      ...
      * Called module names
       01  MOD-ZPA01STR              PIC X(8) VALUE 'ZPA01STR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01STR-001.
               CALL 'ZPA01STR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01STR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
