      ******************************************************************
      * ZCR00PMM - CUSTOMER CORRESPONDENCE                             *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCR00PMM'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01IQ0              PIC X(8) VALUE 'ZAG01IQ0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01IQ0-002.
               CALL 'ZAG01IQ0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01IQ0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       WRITE-ERROR-MESSAGE.
