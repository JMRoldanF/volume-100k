      ******************************************************************
      * ZCR00ZCK - CUSTOMER CORRESPONDENCE                             *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCR00ZCK'.
      ...
      * Called module names
       ...
       01  MOD-ZCR01M4B              PIC X(8) VALUE 'ZCR01M4B'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCR01SAF-001.
               PERFORM CALL-ZCR01M4B-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCR01M4B-002.
               CALL 'ZCR01M4B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCR01M4B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-TERM-0001.
