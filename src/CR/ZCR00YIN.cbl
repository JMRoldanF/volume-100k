      ******************************************************************
      * ZCR00YIN - CUSTOMER CORRESPONDENCE                             *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCR00YIN'.
      ...
      * Called module names
       01  MOD-ZCR01NR5              PIC X(8) VALUE 'ZCR01NR5'.
       01  MOD-ZCR01EOC              PIC X(8) VALUE 'ZCR01EOC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCR01NR5-001.
               PERFORM CALL-ZCR01EOC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCR01NR5-001.
               CALL 'ZCR01NR5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCR01NR5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCR01EOC-002.
               CALL 'ZCR01EOC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCR01EOC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
