      ******************************************************************
      * ZCR00UNY - CUSTOMER CORRESPONDENCE                             *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCR00UNY'.
      ...
      * Called module names
       01  MOD-ZCR01E56              PIC X(8) VALUE 'ZCR01E56'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCR01E56-001.
               PERFORM CALL-ZCR01L74-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCR01E56-001.
               CALL 'ZCR01E56' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCR01E56 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCR01L74-002.
