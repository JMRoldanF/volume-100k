      ******************************************************************
      * ZCR00YH9 - CUSTOMER CORRESPONDENCE                             *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCR00YH9'.
      ...
      * Called module names
       01  MOD-ZAG01TEU              PIC X(8) VALUE 'ZAG01TEU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01TEU-001.
               CALL 'ZAG01TEU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
