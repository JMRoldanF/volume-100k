      ******************************************************************
      * ZCR015OJ - CUSTOMER CORRESPONDENCE                             *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCR015OJ'.
      ...
      * Called module names
       ...
       01  MOD-ZCR01QHY              PIC X(8) VALUE 'ZCR01QHY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCR01KPF-001.
               PERFORM CALL-ZCR01QHY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCR01QHY-002.
               CALL 'ZCR01QHY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCR01QHY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
