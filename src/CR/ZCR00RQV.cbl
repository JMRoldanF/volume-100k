      ******************************************************************
      * ZCR00RQV - CUSTOMER CORRESPONDENCE                             *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCR00RQV'.
      ...
      * Called module names
       01  MOD-ZCR01JOH              PIC X(8) VALUE 'ZCR01JOH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCR01JOH-001.
               PERFORM REFRESH-CC-RATING-0001.
               PERFORM FORMAT-BROKER-ID-0002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCR01JOH-001.
               CALL 'ZCR01JOH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCR01JOH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
