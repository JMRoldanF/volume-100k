      ******************************************************************
      * ZCR00U4K - CUSTOMER CORRESPONDENCE                             *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCR00U4K'.
      ...
      * Called module names
       01  MOD-ZCR01IVG              PIC X(8) VALUE 'ZCR01IVG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCR01IVG-001.
               CALL 'ZCR01IVG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCR01IVG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCR01RX1-002.
