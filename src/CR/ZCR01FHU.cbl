      ******************************************************************
      * ZCR01FHU - CUSTOMER CORRESPONDENCE                             *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCR01FHU'.
      ...
      * Called module names
       01  MOD-ZPA01S60              PIC X(8) VALUE 'ZPA01S60'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01S60-001.
               CALL 'ZPA01S60' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01S60 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
