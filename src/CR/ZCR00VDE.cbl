      ******************************************************************
      * ZCR00VDE - CUSTOMER CORRESPONDENCE                             *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCR00VDE'.
      ...
      * Called module names
       01  MOD-ZCR01PD2              PIC X(8) VALUE 'ZCR01PD2'.
       01  MOD-ZAG01EF6              PIC X(8) VALUE 'ZAG01EF6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCR01PD2-001.
               PERFORM CALL-ZAG01EF6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCR01PD2-001.
               CALL 'ZCR01PD2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCR01PD2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01EF6-002.
               CALL 'ZAG01EF6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01EF6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
