      ******************************************************************
      * ZCR00S3T - CUSTOMER CORRESPONDENCE                             *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCR00S3T'.
      ...
      * Called module names
       01  MOD-ZCR01UCC              PIC X(8) VALUE 'ZCR01UCC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCR01UCC-001.
               CALL 'ZCR01UCC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCR01UCC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RECONCILE-MAKE-0001.
