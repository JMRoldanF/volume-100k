      ******************************************************************
      * ZCR00U73 - CUSTOMER CORRESPONDENCE                             *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCR00U73'.
      ...
      * Called module names
       01  MOD-ZAN01LDA              PIC X(8) VALUE 'ZAN01LDA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAN01LDA-001.
               PERFORM CALL-ZCR01S1H-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01LDA-001.
               CALL 'ZAN01LDA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01LDA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCR01S1H-002.
