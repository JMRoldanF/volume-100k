      ******************************************************************
      * ZCR00VWG - CUSTOMER CORRESPONDENCE                             *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCR00VWG'.
      ...
      * Called module names
       01  MOD-ZCR01NRI              PIC X(8) VALUE 'ZCR01NRI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCR01NRI-001.
               CALL 'ZCR01NRI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCR01NRI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01UA0-002.
