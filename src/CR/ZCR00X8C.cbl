      ******************************************************************
      * ZCR00X8C - CUSTOMER CORRESPONDENCE                             *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCR00X8C'.
      ...
      * Called module names
       01  MOD-ZCR01RBR              PIC X(8) VALUE 'ZCR01RBR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCR01RBR-001.
               CALL 'ZCR01RBR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCR01RBR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
