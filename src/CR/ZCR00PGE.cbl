      ******************************************************************
      * ZCR00PGE - CUSTOMER CORRESPONDENCE                             *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCR00PGE'.
      ...
      * Called module names
       01  MOD-ZAG01LQF              PIC X(8) VALUE 'ZAG01LQF'.
       01  MOD-ZCR01QII              PIC X(8) VALUE 'ZCR01QII'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01LQF-001.
               PERFORM CALL-ZCR01QII-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01LQF-001.
               CALL 'ZAG01LQF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01LQF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCR01QII-002.
               CALL 'ZCR01QII' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCR01QII FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
