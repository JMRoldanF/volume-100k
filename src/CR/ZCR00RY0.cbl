      ******************************************************************
      * ZCR00RY0 - CUSTOMER CORRESPONDENCE                             *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCR00RY0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSE01EJI-001.
               PERFORM CALL-ZCR01JZ2-002.
               PERFORM DERIVE-MANAGED-FUND-0001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZSE01EJI-001.
               MOVE 'ZSE01EJI' TO WS-SUBNAME-3
