      ******************************************************************
      * ZCR00XP2 - CUSTOMER CORRESPONDENCE                             *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCR00XP2'.
      ...
      * Called module names
       ...
       01  MOD-ZCR01UPQ              PIC X(8) VALUE 'ZCR01UPQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCR01UPQ-002.
               CALL 'ZCR01UPQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCR01UPQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
