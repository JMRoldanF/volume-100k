      ******************************************************************
      * ZCR00YFA - CUSTOMER CORRESPONDENCE                             *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCR00YFA'.
      ...
      * Called module names
       01  MOD-ZCR01NZK              PIC X(8) VALUE 'ZCR01NZK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCR01NZK-001.
               PERFORM CALL-ZCR01IIL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCR01NZK-001.
               CALL 'ZCR01NZK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCR01NZK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCR01IIL-002.
