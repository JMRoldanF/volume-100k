      ******************************************************************
      * ZCR00P15 - CUSTOMER CORRESPONDENCE                             *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCR00P15'.
      ...
      * Called module names
       ...
       01  MOD-ZCR01NB0              PIC X(8) VALUE 'ZCR01NB0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCR01NB0-002.
               CALL 'ZCR01NB0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCR01NB0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-COLOUR-0001.
