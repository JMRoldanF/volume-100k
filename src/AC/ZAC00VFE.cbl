      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC00VFE'.
      ...
      * Called module names
       01  MOD-ZAC01IMS              PIC X(8) VALUE 'ZAC01IMS'.
       01  MOD-ZAC01IXV              PIC X(8) VALUE 'ZAC01IXV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAC01IMS-001.
               PERFORM CALL-ZAC01IXV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01IMS-001.
               CALL 'ZAC01IMS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01IMS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAC01IXV-002.
               CALL 'ZAC01IXV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01IXV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
