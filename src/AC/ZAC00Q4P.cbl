      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC00Q4P'.
      ...
      * Called module names
       01  MOD-ZRC01RNP              PIC X(8) VALUE 'ZRC01RNP'.
       01  MOD-ZAC01RXY              PIC X(8) VALUE 'ZAC01RXY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRC01RNP-001.
               PERFORM CALL-ZAC01RXY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRC01RNP-001.
               CALL 'ZRC01RNP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRC01RNP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAC01RXY-002.
               CALL 'ZAC01RXY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01RXY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
