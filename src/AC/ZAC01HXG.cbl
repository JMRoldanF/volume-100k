      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC01HXG'.
      ...
      * Called module names
       01  MOD-ZAC01F8T              PIC X(8) VALUE 'ZAC01F8T'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01F8T-001.
               CALL 'ZAC01F8T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01F8T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
