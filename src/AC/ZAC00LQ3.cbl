      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC00LQ3'.
      ...
      * Called module names
       01  MOD-ZCO01IUM              PIC X(8) VALUE 'ZCO01IUM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01IUM-002.
               CALL 'ZCO01IUM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01IUM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
