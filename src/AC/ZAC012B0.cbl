      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC012B0'.
      ...
      * Called module names
       01  MOD-ZAC01SRH              PIC X(8) VALUE 'ZAC01SRH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAC01SRH-001.
               PERFORM CALL-ZAC01HS5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01SRH-001.
               CALL 'ZAC01SRH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01SRH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAC01HS5-002.
               MOVE 'ZAC01HS5' TO WS-SUBNAME-1
