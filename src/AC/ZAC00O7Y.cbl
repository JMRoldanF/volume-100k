      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC00O7Y'.
      ...
      * Called module names
       01  MOD-ZAC01UT2              PIC X(8) VALUE 'ZAC01UT2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01UT2-002.
               CALL 'ZAC01UT2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01UT2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
