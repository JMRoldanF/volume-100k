      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC00Q7P'.
      ...
      * Called module names
       01  MOD-ZCO01QQW              PIC X(8) VALUE 'ZCO01QQW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAC01HJU-002.
               PERFORM CALL-ZHO0255M-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCO01QQW-001.
               CALL 'ZCO01QQW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
