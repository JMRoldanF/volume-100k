      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC00S9O'.
      ...
      * Called module names
       01  MOD-ZCO01RXV              PIC X(8) VALUE 'ZCO01RXV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCO01RXV-001.
               PERFORM CALL-ZAC01UW0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01RXV-001.
               CALL 'ZCO01RXV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
