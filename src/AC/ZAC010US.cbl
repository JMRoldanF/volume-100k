      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC010US'.
      ...
      * Called module names
       01  MOD-ZAC01L29              PIC X(8) VALUE 'ZAC01L29'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01L29-001.
               CALL 'ZAC01L29' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01L29 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-TERM-0001.
