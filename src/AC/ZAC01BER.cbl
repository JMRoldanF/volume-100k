      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC01BER'.
      ...
      * Called module names
       ...
       01  MOD-ZAC01TEG              PIC X(8) VALUE 'ZAC01TEG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIF01H1Z-001.
               PERFORM CALL-ZAC01TEG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01TEG-002.
               CALL 'ZAC01TEG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01TEG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
