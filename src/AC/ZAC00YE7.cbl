      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC00YE7'.
      ...
      * Called module names
       01  MOD-ZAC01PVC              PIC X(8) VALUE 'ZAC01PVC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01PVC-001.
               CALL 'ZAC01PVC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01PVC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
