      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC015RU'.
      ...
      * Called module names
       01  MOD-ZAC01PGX              PIC X(8) VALUE 'ZAC01PGX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01PGX-001.
               CALL 'ZAC01PGX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01PGX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
