      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC0037K'.
      ...
      * Called module names
       ...
       01  MOD-ZAC00JL8              PIC X(8) VALUE 'ZAC00JL8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAC00KJO-001.
               PERFORM CALL-ZAC00A14-002.
               PERFORM CALL-ZAC00JL8-003.
               PERFORM CALL-ZAC00JAC-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC00JL8-003.
               EXEC CICS LINK PROGRAM('ZAC00JL8')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
