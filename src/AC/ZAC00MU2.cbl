      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC00MU2'.
      ...
      * Called module names
       01  MOD-ZAC01L0Z              PIC X(8) VALUE 'ZAC01L0Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01L0Z-001.
               CALL 'ZAC01L0Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01L0Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
