      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC00PB4'.
      ...
      * Called module names
       ...
       01  MOD-ZAC01PX5              PIC X(8) VALUE 'ZAC01PX5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAC01SUO-001.
               PERFORM CALL-ZAC01PX5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01PX5-002.
               CALL 'ZAC01PX5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01PX5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
