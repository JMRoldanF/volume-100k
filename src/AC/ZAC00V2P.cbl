      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC00V2P'.
      ...
      * Called module names
       01  MOD-ZAC01D53              PIC X(8) VALUE 'ZAC01D53'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAC01D53-001.
               PERFORM CALL-ZCU0255O-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZAC01D53-001.
               CALL 'ZAC01D53' USING DFHCOMMAREA
                         WS-STATUS-CODE.
