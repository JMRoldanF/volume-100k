      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC00X3M'.
      ...
      * Called module names
       ...
       01  MOD-ZAC01S4S              PIC X(8) VALUE 'ZAC01S4S'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAC01UOH-001.
               PERFORM CALL-ZAC01S4S-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01S4S-002.
               CALL 'ZAC01S4S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01S4S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-MAKE-0001.
