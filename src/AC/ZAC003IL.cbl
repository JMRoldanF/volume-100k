      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC003IL'.
      ...
      * Called module names
       01  MOD-ZIF00AMF              PIC X(8) VALUE 'ZIF00AMF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIF00AMF-001.
               PERFORM CALL-ZAC00A14-002.
               PERFORM CALL-ZMT0255L-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZIF00AMF-001.
               EXEC CICS LINK PROGRAM('ZIF00AMF')
