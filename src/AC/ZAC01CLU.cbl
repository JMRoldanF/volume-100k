      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC01CLU'.
      ...
      * Called module names
       01  MOD-ZAC01O7T              PIC X(8) VALUE 'ZAC01O7T'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAC01O7T-001.
               PERFORM CALL-ZAC01IZU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01O7T-001.
               CALL 'ZAC01O7T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01O7T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAC01IZU-002.
               MOVE 'ZAC01IZU' TO WS-SUBNAME-4
