      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC00VMI'.
      ...
      * Called module names
       ...
       01  MOD-ZAC01SQT              PIC X(8) VALUE 'ZAC01SQT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI01S2T-001.
               PERFORM CALL-ZAC01SQT-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01SQT-002.
               CALL 'ZAC01SQT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01SQT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
