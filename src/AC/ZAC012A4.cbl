      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC012A4'.
      ...
      * Called module names
       01  MOD-ZAC01M9U              PIC X(8) VALUE 'ZAC01M9U'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAC01M9U-001.
               PERFORM CALL-ZAZ01DPR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01M9U-001.
               CALL 'ZAC01M9U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01M9U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAZ01DPR-002.
