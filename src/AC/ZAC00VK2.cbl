      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC00VK2'.
      ...
      * Called module names
       ...
       01  MOD-ZAC01UQ5              PIC X(8) VALUE 'ZAC01UQ5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIF01GCX-001.
               PERFORM CALL-ZAC01UQ5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01UQ5-002.
               CALL 'ZAC01UQ5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01UQ5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-VALUE-0001.
