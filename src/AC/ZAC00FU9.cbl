      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC00FU9'.
      ...
      * Called module names
       01  MOD-ZAC00YIQ              PIC X(8) VALUE 'ZAC00YIQ'.
       01  MOD-ZAC0139N              PIC X(8) VALUE 'ZAC0139N'.
       01  MOD-ZAC01DKY              PIC X(8) VALUE 'ZAC01DKY'.
       01  MOD-ZAC01G25              PIC X(8) VALUE 'ZAC01G25'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAC00YIQ-001.
               PERFORM CALL-ZAC0139N-002.
               PERFORM CALL-ZAC01DKY-003.
               PERFORM CALL-ZAC01G25-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC00YIQ-001.
               EXEC CICS LINK PROGRAM('ZAC00YIQ')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC00YIQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAC0139N-002.
               EXEC CICS LINK PROGRAM('ZAC0139N')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC0139N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAC01DKY-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01G25-004.
               CALL 'ZAC01G25' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
