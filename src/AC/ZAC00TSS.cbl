      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC00TSS'.
      ...
      * Called module names
       01  MOD-ZIF01OCD              PIC X(8) VALUE 'ZIF01OCD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIF01OCD-001.
               CALL 'ZIF01OCD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIF01OCD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
