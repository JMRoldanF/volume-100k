      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC00VZ0'.
      ...
      * Called module names
       01  MOD-ZAC01LFD              PIC X(8) VALUE 'ZAC01LFD'.
       01  MOD-ZAC01HFP              PIC X(8) VALUE 'ZAC01HFP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAC01LFD-001.
               PERFORM CALL-ZAC01HFP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01LFD-001.
               CALL 'ZAC01LFD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01LFD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAC01HFP-002.
               CALL 'ZAC01HFP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01HFP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
