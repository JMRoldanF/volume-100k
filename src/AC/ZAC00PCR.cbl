      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC00PCR'.
      ...
      * Called module names
       01  MOD-ZAC01L8S              PIC X(8) VALUE 'ZAC01L8S'.
       01  MOD-ZIF01T19              PIC X(8) VALUE 'ZIF01T19'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAC01L8S-001.
               PERFORM CALL-ZIF01T19-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01L8S-001.
               CALL 'ZAC01L8S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01L8S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIF01T19-002.
               CALL 'ZIF01T19' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIF01T19 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
