      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC00R59'.
      ...
      * Called module names
       01  MOD-ZAC01P73              PIC X(8) VALUE 'ZAC01P73'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01P73-001.
               CALL 'ZAC01P73' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01P73 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
