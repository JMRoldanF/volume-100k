      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC00M5T'.
      ...
      * Called module names
       01  MOD-ZAC01JF9              PIC X(8) VALUE 'ZAC01JF9'.
       01  MOD-ZAC01KVJ              PIC X(8) VALUE 'ZAC01KVJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAC01JF9-001.
               PERFORM CALL-ZAC01KVJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01JF9-001.
               CALL 'ZAC01JF9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01JF9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAC01KVJ-002.
               CALL 'ZAC01KVJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01KVJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
