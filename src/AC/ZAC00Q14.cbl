      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC00Q14'.
      ...
      * Called module names
       01  MOD-ZAC01JAJ              PIC X(8) VALUE 'ZAC01JAJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01JAJ-001.
               CALL 'ZAC01JAJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01JAJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
