      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC00SX3'.
      ...
      * Called module names
       ...
       01  MOD-ZAC01SGH              PIC X(8) VALUE 'ZAC01SGH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAC01OP5-001.
               PERFORM CALL-ZAC01SGH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01SGH-002.
               CALL 'ZAC01SGH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01SGH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
