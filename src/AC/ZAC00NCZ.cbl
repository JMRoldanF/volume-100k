      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC00NCZ'.
      ...
      * Called module names
       01  MOD-ZAC01EPU              PIC X(8) VALUE 'ZAC01EPU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01EPU-001.
               CALL 'ZAC01EPU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01EPU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
