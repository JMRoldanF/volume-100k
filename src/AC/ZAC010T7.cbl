      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC010T7'.
      ...
      * Called module names
       01  MOD-ZAC01S3E              PIC X(8) VALUE 'ZAC01S3E'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01S3E-001.
               CALL 'ZAC01S3E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01S3E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-COLOUR-0001.
