      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAC00VXO'.
      ...
      * Called module names
       ...
       01  MOD-ZLI01QBT              PIC X(8) VALUE 'ZLI01QBT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01QBT-002.
               CALL 'ZLI01QBT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01QBT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-POSTCODE-0001.
