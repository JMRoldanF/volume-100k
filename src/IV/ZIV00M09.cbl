      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00M09'.
      ...
      * Called module names
       01  MOD-ZIV01KOX              PIC X(8) VALUE 'ZIV01KOX'.
       01  MOD-ZWF01SJC              PIC X(8) VALUE 'ZWF01SJC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIV01KOX-001.
               PERFORM CALL-ZWF01SJC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01KOX-001.
               CALL 'ZIV01KOX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZWF01SJC-002.
               CALL 'ZWF01SJC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZWF01SJC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
