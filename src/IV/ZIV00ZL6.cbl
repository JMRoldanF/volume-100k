      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00ZL6'.
      ...
      * Called module names
       01  MOD-ZIV01PAW              PIC X(8) VALUE 'ZIV01PAW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01PAW-001.
               CALL 'ZIV01PAW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01PAW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIV01MFN-002.
