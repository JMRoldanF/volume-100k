      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00ODT'.
      ...
      * Called module names
       01  MOD-ZWF01THJ              PIC X(8) VALUE 'ZWF01THJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZWF01THJ-001.
               PERFORM CALL-ZIV01HK3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZWF01THJ-001.
               CALL 'ZWF01THJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZWF01THJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIV01HK3-002.
