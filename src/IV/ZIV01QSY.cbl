      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV01QSY'.
      ...
      * Called module names
       01  MOD-ZIV01NP9              PIC X(8) VALUE 'ZIV01NP9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01NP9-001.
               CALL 'ZIV01NP9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01NP9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
