      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00M57'.
      ...
      * Called module names
       01  MOD-ZIV01LQA              PIC X(8) VALUE 'ZIV01LQA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01LQA-001.
               CALL 'ZIV01LQA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01LQA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
