      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00XH2'.
      ...
      * Called module names
       01  MOD-ZIV01N78              PIC X(8) VALUE 'ZIV01N78'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIV01N78-001.
               PERFORM CALL-ZIV01GO0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01N78-001.
               CALL 'ZIV01N78' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01N78 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIV01GO0-002.
