      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV012DV'.
      ...
      * Called module names
       01  MOD-ZWF01EQS              PIC X(8) VALUE 'ZWF01EQS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZWF01EQS-001.
               CALL 'ZWF01EQS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZWF01EQS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
