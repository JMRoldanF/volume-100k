      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00TZ3'.
      ...
      * Called module names
       01  MOD-ZIV01EP4              PIC X(8) VALUE 'ZIV01EP4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01EP4-001.
               CALL 'ZIV01EP4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01EP4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCR01MCS-002.
