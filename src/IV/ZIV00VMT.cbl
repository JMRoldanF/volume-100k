      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00VMT'.
      ...
      * Called module names
       01  MOD-ZIV01FW6              PIC X(8) VALUE 'ZIV01FW6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01FW6-001.
               CALL 'ZIV01FW6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01FW6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
