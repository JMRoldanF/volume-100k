      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00YFP'.
      ...
      * Called module names
       01  MOD-ZCR01DW4              PIC X(8) VALUE 'ZCR01DW4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCR01DW4-001.
               CALL 'ZCR01DW4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCR01DW4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
