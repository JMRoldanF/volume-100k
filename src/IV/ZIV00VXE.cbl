      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00VXE'.
      ...
      * Called module names
       01  MOD-ZIV01D8W              PIC X(8) VALUE 'ZIV01D8W'.
       01  MOD-ZCR01UDO              PIC X(8) VALUE 'ZCR01UDO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIV01D8W-001.
               PERFORM CALL-ZCR01UDO-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01D8W-001.
               CALL 'ZIV01D8W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01D8W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCR01UDO-002.
               CALL 'ZCR01UDO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCR01UDO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
