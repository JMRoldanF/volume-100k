      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00P0R'.
      ...
      * Called module names
       01  MOD-ZIV01Q2K              PIC X(8) VALUE 'ZIV01Q2K'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01Q2K-001.
               CALL 'ZIV01Q2K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01Q2K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
