      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00VK3'.
      ...
      * Called module names
       01  MOD-ZIV01FY6              PIC X(8) VALUE 'ZIV01FY6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIV01FY6-001.
               PERFORM CALL-ZIV01E9V-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01FY6-001.
               CALL 'ZIV01FY6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01FY6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIV01E9V-002.
