      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00ST5'.
      ...
      * Called module names
       01  MOD-ZIV01JDM              PIC X(8) VALUE 'ZIV01JDM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01JDM-001.
               CALL 'ZIV01JDM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01JDM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIV01T91-002.
