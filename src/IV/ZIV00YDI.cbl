      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00YDI'.
      ...
      * Called module names
       01  MOD-ZIV01U3Z              PIC X(8) VALUE 'ZIV01U3Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01U3Z-001.
               CALL 'ZIV01U3Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01U3Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIV01GPE-002.
