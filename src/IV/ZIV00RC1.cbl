      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00RC1'.
      ...
      * Called module names
       ...
       01  MOD-ZIV01UC4              PIC X(8) VALUE 'ZIV01UC4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01UC4-002.
               CALL 'ZIV01UC4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01UC4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
