      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00RK1'.
      ...
      * Called module names
       01  MOD-ZIV01L1Q              PIC X(8) VALUE 'ZIV01L1Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01L1Q-001.
               CALL 'ZIV01L1Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01L1Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
