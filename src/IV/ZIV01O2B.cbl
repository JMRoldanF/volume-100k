      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV01O2B'.
      ...
      * Called module names
       01  MOD-ZIV01F8P              PIC X(8) VALUE 'ZIV01F8P'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01F8P-001.
               CALL 'ZIV01F8P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01F8P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
