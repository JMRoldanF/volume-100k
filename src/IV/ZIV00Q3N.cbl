      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00Q3N'.
      ...
      * Called module names
       01  MOD-ZIV01ONN              PIC X(8) VALUE 'ZIV01ONN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIV01ONN-001.
               PERFORM CALL-ZIV01IZ3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01ONN-001.
               CALL 'ZIV01ONN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01ONN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIV01IZ3-002.
               MOVE 'ZIV01IZ3' TO WS-SUBNAME-4
