      ******************************************************************
      * ZIV00MOZ - INVESTMENT FUNDS                                    *
      ******************************************************************
      *
      *  Generated volume-test source. Layer 2,
      *  type data_db2, domain INVEST.
      ******************************************************************
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00MOZ'.
      ...
      * Called module names
       01  MOD-ZIV01RMM              PIC X(8) VALUE 'ZIV01RMM'.
       01  MOD-ZIV01LF6              PIC X(8) VALUE 'ZIV01LF6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIV01RMM-001.
               PERFORM CALL-ZIV01LF6-002.
               ...
               PERFORM COMPUTE-SUM-ASSURED-0059.
               PERFORM SQL-ACCESS-0060.
               PERFORM REFRESH-MODEL-0061.
               PERFORM NORMALISE-PREMIUM-0062.
               ...
               PERFORM AUDIT-CC-RATING-0071.
               PERFORM SQL-ACCESS-0072.
               PERFORM RESOLVE-BEDROOMS-0073.
               ...
               PERFORM NORMALISE-AGENT-CODE-0115.
               ...
               PERFORM EXPAND-CC-RATING-0127.
               PERFORM VALIDATE-MODEL-0128.
               PERFORM SQL-ACCESS-0129.
               PERFORM RESOLVE-AGENT-CODE-0130.
               PERFORM FORMAT-CC-RATING-0131.
               ...
               PERFORM DERIVE-EXCESS-0139.
               PERFORM AUDIT-EQUITIES-0140.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZIV01RMM-001.
               CALL 'ZIV01RMM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01RMM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIV01LF6-002.
               CALL 'ZIV01LF6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01LF6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-VALUE-0001.
