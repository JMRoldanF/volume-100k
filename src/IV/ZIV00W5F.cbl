      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00W5F'.
      ...
      * Called module names
       01  MOD-ZIV01ODZ              PIC X(8) VALUE 'ZIV01ODZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01ODZ-001.
               CALL 'ZIV01ODZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01ODZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
