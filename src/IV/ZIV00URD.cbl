      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00URD'.
      ...
      * Called module names
       01  MOD-ZIV01LVB              PIC X(8) VALUE 'ZIV01LVB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIV01LVB-001.
               PERFORM CALL-ZIV01HGX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01LVB-001.
               CALL 'ZIV01LVB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01LVB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIV01HGX-002.
