      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00YYJ'.
      ...
      * Called module names
       01  MOD-ZIV01OVB              PIC X(8) VALUE 'ZIV01OVB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIV01OVB-001.
               PERFORM CALL-ZIV01O3W-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01OVB-001.
               CALL 'ZIV01OVB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
