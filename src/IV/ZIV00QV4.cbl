      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00QV4'.
      ...
      * Called module names
       ...
       01  MOD-ZIV01GM3              PIC X(8) VALUE 'ZIV01GM3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCR01HHE-001.
               PERFORM CALL-ZIV01GM3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01GM3-002.
               CALL 'ZIV01GM3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01GM3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
