      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00E1T'.
      ...
      * Called module names
       01  MOD-ZIV00ME3              PIC X(8) VALUE 'ZIV00ME3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV00ME3-001.
               EXEC CICS LINK PROGRAM('ZIV00ME3')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV00ME3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
