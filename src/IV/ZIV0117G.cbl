      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV0117G'.
      ...
      * Called module names
       01  MOD-ZIV01NAR              PIC X(8) VALUE 'ZIV01NAR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01NAR-001.
               CALL 'ZIV01NAR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01NAR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
