      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00LQA'.
      ...
      * Called module names
       01  MOD-ZIV01D7G              PIC X(8) VALUE 'ZIV01D7G'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIV01D7G-001.
               PERFORM CALL-ZIV01Q1V-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01D7G-001.
               CALL 'ZIV01D7G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01D7G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIV01Q1V-002.
               MOVE 'ZIV01Q1V' TO WS-SUBNAME-6
