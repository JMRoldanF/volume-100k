      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV011ZN'.
      ...
      * Called module names
       01  MOD-ZIV01F4O              PIC X(8) VALUE 'ZIV01F4O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01F4O-001.
               CALL 'ZIV01F4O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01F4O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
