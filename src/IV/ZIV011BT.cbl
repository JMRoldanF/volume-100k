      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV011BT'.
      ...
      * Called module names
       01  MOD-ZIV01G04              PIC X(8) VALUE 'ZIV01G04'.
       01  MOD-ZIV01FZ3              PIC X(8) VALUE 'ZIV01FZ3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIV01G04-001.
               PERFORM CALL-ZIV01FZ3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01G04-001.
               CALL 'ZIV01G04' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01G04 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIV01FZ3-002.
               CALL 'ZIV01FZ3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01FZ3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
