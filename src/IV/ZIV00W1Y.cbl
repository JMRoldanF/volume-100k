      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00W1Y'.
      ...
      * Called module names
       01  MOD-ZIV01EOS              PIC X(8) VALUE 'ZIV01EOS'.
       01  MOD-ZIV01FWV              PIC X(8) VALUE 'ZIV01FWV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIV01EOS-001.
               PERFORM CALL-ZIV01FWV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01EOS-001.
               CALL 'ZIV01EOS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01EOS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIV01FWV-002.
               CALL 'ZIV01FWV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01FWV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
