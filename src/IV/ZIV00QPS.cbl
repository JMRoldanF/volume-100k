      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00QPS'.
      ...
      * Called module names
       01  MOD-ZIV01NNW              PIC X(8) VALUE 'ZIV01NNW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01NNW-001.
               CALL 'ZIV01NNW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01NNW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
