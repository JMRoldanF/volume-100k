      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00P0W'.
      ...
      * Called module names
       ...
       01  MOD-ZIV01JMC              PIC X(8) VALUE 'ZIV01JMC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIV01NX5-001.
               PERFORM CALL-ZIV01JMC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01JMC-002.
               CALL 'ZIV01JMC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01JMC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
