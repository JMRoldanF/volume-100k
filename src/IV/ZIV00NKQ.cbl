      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00NKQ'.
      ...
      * Called module names
       01  MOD-ZIV01PS5              PIC X(8) VALUE 'ZIV01PS5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01PS5-001.
               CALL 'ZIV01PS5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01PS5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
