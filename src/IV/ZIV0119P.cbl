      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV0119P'.
      ...
      * Called module names
       01  MOD-ZWF01EWG              PIC X(8) VALUE 'ZWF01EWG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZWF01EWG-001.
               CALL 'ZWF01EWG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZWF01EWG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
