      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00ZVU'.
      ...
      * Called module names
       01  MOD-ZIV01TOX              PIC X(8) VALUE 'ZIV01TOX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01TOX-002.
               CALL 'ZIV01TOX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01TOX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
