      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV010PZ'.
      ...
      * Called module names
       01  MOD-ZIV01L1T              PIC X(8) VALUE 'ZIV01L1T'.
       01  MOD-ZIV01OQ4              PIC X(8) VALUE 'ZIV01OQ4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIV01L1T-001.
               PERFORM CALL-ZIV01OQ4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01L1T-001.
               CALL 'ZIV01L1T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01L1T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIV01OQ4-002.
               CALL 'ZIV01OQ4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01OQ4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
