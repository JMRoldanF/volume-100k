      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00TPA'.
      ...
      * Called module names
       01  MOD-ZIV01S4B              PIC X(8) VALUE 'ZIV01S4B'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01S4B-001.
               CALL 'ZIV01S4B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01S4B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
