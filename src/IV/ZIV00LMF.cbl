      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00LMF'.
      ...
      * Called module names
       ...
       01  MOD-ZIV01FOL              PIC X(8) VALUE 'ZIV01FOL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIV01T91-001.
               PERFORM CALL-ZIV01FOL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01FOL-002.
               CALL 'ZIV01FOL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01FOL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
