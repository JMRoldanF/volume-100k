      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00NC4'.
      ...
      * Called module names
       01  MOD-ZIV01E9V              PIC X(8) VALUE 'ZIV01E9V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01E9V-001.
               CALL 'ZIV01E9V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01E9V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-COLOUR-0001.
