      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV011NE'.
      ...
      * Called module names
       01  MOD-ZIV01QH4              PIC X(8) VALUE 'ZIV01QH4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01QH4-001.
               CALL 'ZIV01QH4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01QH4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
