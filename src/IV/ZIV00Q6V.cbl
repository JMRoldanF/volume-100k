      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZIV00Q6V'.
      ...
      * Called module names
       01  MOD-ZIV01EU1              PIC X(8) VALUE 'ZIV01EU1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01EU1-001.
               CALL 'ZIV01EU1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01EU1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
