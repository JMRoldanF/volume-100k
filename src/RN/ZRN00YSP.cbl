      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRN00YSP'.
      ...
      * Called module names
       01  MOD-ZRN01UYK              PIC X(8) VALUE 'ZRN01UYK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRN01UYK-002.
               PERFORM CALL-ZMT0255L-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZRN01SKU-001.
               MOVE 'ZRN01SKU' TO WS-SUBNAME-7
      ...
      *----------------------------------------------------------------*
       CALL-ZRN01UYK-002.
               CALL 'ZRN01UYK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01UYK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
