      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRN00NIC'.
      ...
      * Called module names
       01  MOD-ZRN01EQ6              PIC X(8) VALUE 'ZRN01EQ6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRN01EQ6-001.
               CALL 'ZRN01EQ6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01EQ6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
