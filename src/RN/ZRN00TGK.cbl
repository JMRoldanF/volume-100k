      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRN00TGK'.
      ...
      * Called module names
       01  MOD-ZRN01SMV              PIC X(8) VALUE 'ZRN01SMV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRN01SMV-001.
               CALL 'ZRN01SMV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01SMV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
