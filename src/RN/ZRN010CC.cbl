      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRN010CC'.
      ...
      * Called module names
       01  MOD-ZRN01I8B              PIC X(8) VALUE 'ZRN01I8B'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRN01I8B-001.
               CALL 'ZRN01I8B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01I8B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRN01KKY-002.
               MOVE 'ZRN01KKY' TO WS-SUBNAME-5
