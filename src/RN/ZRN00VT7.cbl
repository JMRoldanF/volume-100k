      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRN00VT7'.
      ...
      * Called module names
       01  MOD-ZRN01LDJ              PIC X(8) VALUE 'ZRN01LDJ'.
       01  MOD-ZRN01H6U              PIC X(8) VALUE 'ZRN01H6U'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRN01LDJ-001.
               PERFORM CALL-ZRN01H6U-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRN01LDJ-001.
               CALL 'ZRN01LDJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01LDJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRN01H6U-002.
               CALL 'ZRN01H6U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01H6U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
