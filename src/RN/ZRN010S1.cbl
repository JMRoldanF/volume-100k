      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRN010S1'.
      ...
      * Called module names
       01  MOD-ZAN01Q8G              PIC X(8) VALUE 'ZAN01Q8G'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01Q8G-001.
               CALL 'ZAN01Q8G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01Q8G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
