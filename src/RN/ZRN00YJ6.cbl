      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRN00YJ6'.
      ...
      * Called module names
       01  MOD-ZAV01EY3              PIC X(8) VALUE 'ZAV01EY3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01EY3-001.
               CALL 'ZAV01EY3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01EY3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
