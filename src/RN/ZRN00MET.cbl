      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRN00MET'.
      ...
      * Called module names
       01  MOD-ZRN01ORI              PIC X(8) VALUE 'ZRN01ORI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRN01KHS-001.
               PERFORM CALL-ZRN01ORI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRN01ORI-002.
               CALL 'ZRN01ORI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01ORI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
