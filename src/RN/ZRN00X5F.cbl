      ******************************************************************
      * ZRN00X5F - RENEWAL PROCESSING                                  *
      ******************************************************************
      *
      *  Generated volume-test source. Layer 2,
      *  type data_db2, domain RENEWAL.
      ******************************************************************
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRN00X5F'.
      ...
      * Called module names
       01  MOD-ZRN01CTI              PIC X(8) VALUE 'ZRN01CTI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRN01NOA-001.
               PERFORM CALL-ZRN01CTI-002.
               ...
               PERFORM RESOLVE-HOUSE-TYPE-0089.
               ...
               PERFORM APPLY-HOUSE-TYPE-0098.
               PERFORM SQL-ACCESS-0099.
               PERFORM CHECK-POSTCODE-0100.
               PERFORM APPLY-REG-NUMBER-0101.
      ...
      *----------------------------------------------------------------*
       CALL-ZRN01NOA-001.
               MOVE 'ZRN01NOA' TO WS-SUBNAME-6
               CALL WS-SUBNAME-6 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01NOA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRN01CTI-002.
               CALL 'ZRN01CTI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01CTI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       ...
       SQL-ACCESS-0003.
               EXEC SQL
                     ...
                     SELECT POLICYNUMBER, PAYMENT
                       FROM GENARN.PAYMENT A
                       JOIN GENARN.CUSTOMER B
