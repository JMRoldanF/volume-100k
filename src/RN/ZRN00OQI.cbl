      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRN00OQI'.
      ...
      * Called module names
       ...
       01  MOD-ZRN01OAW              PIC X(8) VALUE 'ZRN01OAW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRN01OAW-002.
               CALL 'ZRN01OAW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01OAW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-EXCESS-0001.
