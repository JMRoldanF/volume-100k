      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRN00ZR4'.
      ...
      * Called module names
       01  MOD-ZRN01EM4              PIC X(8) VALUE 'ZRN01EM4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRN01EM4-001.
               CALL 'ZRN01EM4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01EM4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
