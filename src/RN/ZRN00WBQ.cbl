      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRN00WBQ'.
      ...
      * Called module names
       01  MOD-ZAN01HA9              PIC X(8) VALUE 'ZAN01HA9'.
       01  MOD-ZIF01G6U              PIC X(8) VALUE 'ZIF01G6U'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAN01HA9-001.
               PERFORM CALL-ZIF01G6U-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01HA9-001.
               CALL 'ZAN01HA9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01HA9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIF01G6U-002.
               CALL 'ZIF01G6U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIF01G6U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
