      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRN00T39'.
      ...
      * Called module names
       ...
       01  MOD-ZRN01LOD              PIC X(8) VALUE 'ZRN01LOD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRN01LOD-002.
               CALL 'ZRN01LOD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01LOD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
