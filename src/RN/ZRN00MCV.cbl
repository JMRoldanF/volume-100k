      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRN00MCV'.
      ...
      * Called module names
       01  MOD-ZRN01SZB              PIC X(8) VALUE 'ZRN01SZB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRN01SZB-001.
               CALL 'ZRN01SZB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01SZB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAV01H9T-002.
