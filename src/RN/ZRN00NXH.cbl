      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRN00NXH'.
      ...
      * Called module names
       01  MOD-ZAV01Q21              PIC X(8) VALUE 'ZAV01Q21'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01Q21-001.
               CALL 'ZAV01Q21' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01Q21 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRN01IAN-002.
