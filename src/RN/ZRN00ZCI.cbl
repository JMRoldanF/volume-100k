      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRN00ZCI'.
      ...
      * Called module names
       ...
       01  MOD-ZRN01JD1              PIC X(8) VALUE 'ZRN01JD1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRN01OBI-001.
               PERFORM CALL-ZRN01JD1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRN01JD1-002.
               CALL 'ZRN01JD1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01JD1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
