      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRN00TRQ'.
      ...
      * Called module names
       01  MOD-ZRN01SKU              PIC X(8) VALUE 'ZRN01SKU'.
       01  MOD-ZRN01FRP              PIC X(8) VALUE 'ZRN01FRP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRN01SKU-001.
               CALL 'ZRN01SKU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZRN01FRP-002.
               CALL 'ZRN01FRP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01FRP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
