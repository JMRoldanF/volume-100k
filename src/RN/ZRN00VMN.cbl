      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRN00VMN'.
      ...
      * Called module names
       01  MOD-ZRN01F33              PIC X(8) VALUE 'ZRN01F33'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRN01F33-001.
               CALL 'ZRN01F33' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01F33 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
