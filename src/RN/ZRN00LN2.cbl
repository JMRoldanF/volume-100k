      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRN00LN2'.
      ...
      * Called module names
       ...
       01  MOD-ZRN01JUT              PIC X(8) VALUE 'ZRN01JUT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRN01JUT-002.
               CALL 'ZRN01JUT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01JUT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
