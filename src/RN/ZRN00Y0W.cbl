      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRN00Y0W'.
      ...
      * Called module names
       01  MOD-ZAV01MPH              PIC X(8) VALUE 'ZAV01MPH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01MPH-001.
               CALL 'ZAV01MPH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01MPH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
