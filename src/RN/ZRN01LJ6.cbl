      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRN01LJ6'.
      ...
      * Called module names
       01  MOD-ZRN01KGR              PIC X(8) VALUE 'ZRN01KGR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRN01KGR-001.
               CALL 'ZRN01KGR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01KGR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
