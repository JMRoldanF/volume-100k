      ******************************************************************
      * ZTX01A3E - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX01A3E'.
      ...
      * Called module names
       01  MOD-ZTX01ISO              PIC X(8) VALUE 'ZTX01ISO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01ISO-001.
               CALL 'ZTX01ISO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01ISO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
