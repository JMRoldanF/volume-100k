      ******************************************************************
      * ZTX00Q0X - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX00Q0X'.
      ...
      * Called module names
       ...
       01  MOD-ZTX01PCU              PIC X(8) VALUE 'ZTX01PCU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01PCU-002.
               CALL 'ZTX01PCU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
