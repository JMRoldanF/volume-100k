      ******************************************************************
      * ZTX00X7C - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX00X7C'.
      ...
      * Called module names
       ...
       01  MOD-ZTX01I7B              PIC X(8) VALUE 'ZTX01I7B'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTX01T9M-001.
               PERFORM CALL-ZTX01I7B-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01I7B-002.
               CALL 'ZTX01I7B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01I7B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-MAKE-0001.
