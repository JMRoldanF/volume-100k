      ******************************************************************
      * ZTX001C7 - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX001C7'.
      ...
      * Called module names
       01  MOD-ZAR00KQ6              PIC X(8) VALUE 'ZAR00KQ6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAR00KQ6-001.
               PERFORM CALL-ZTX00I09-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR00KQ6-001.
               EXEC CICS LINK PROGRAM('ZAR00KQ6')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR00KQ6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTX00I09-002.
               MOVE 'ZTX00I09' TO WS-PROGNAME-7
