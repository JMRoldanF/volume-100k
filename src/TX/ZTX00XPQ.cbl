      ******************************************************************
      * ZTX00XPQ - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX00XPQ'.
      ...
      * Called module names
       01  MOD-ZTX01THU              PIC X(8) VALUE 'ZTX01THU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01THU-001.
               CALL 'ZTX01THU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01THU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
