      ******************************************************************
      * ZTX00MP4 - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX00MP4'.
      ...
      * Called module names
       01  MOD-ZTX01EYP              PIC X(8) VALUE 'ZTX01EYP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTX01PCU-001.
               PERFORM CALL-ZTX01EYP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01EYP-002.
               CALL 'ZTX01EYP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01EYP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
