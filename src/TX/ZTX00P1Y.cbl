      ******************************************************************
      * ZTX00P1Y - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX00P1Y'.
      ...
      * Called module names
       01  MOD-ZTX01LV1              PIC X(8) VALUE 'ZTX01LV1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01LV1-001.
               CALL 'ZTX01LV1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01LV1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTX01NTU-002.
