      ******************************************************************
      * ZTX00WX9 - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX00WX9'.
      ...
      * Called module names
       01  MOD-ZTX01OJ8              PIC X(8) VALUE 'ZTX01OJ8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTX01OJ8-001.
               PERFORM CALL-ZAG0255S-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZTX01OJ8-001.
               CALL 'ZTX01OJ8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
