      ******************************************************************
      * ZTX00SUX - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX00SUX'.
      ...
      * Called module names
       01  MOD-ZTX01EYX              PIC X(8) VALUE 'ZTX01EYX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01EYX-001.
               CALL 'ZTX01EYX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01EYX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
