      ******************************************************************
      * ZTX00ZK6 - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX00ZK6'.
      ...
      * Called module names
       ...
       01  MOD-ZTX01DTM              PIC X(8) VALUE 'ZTX01DTM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTX01OMI-001.
               PERFORM CALL-ZTX01DTM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01DTM-002.
               CALL 'ZTX01DTM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01DTM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
