      ******************************************************************
      * ZTX00XZU - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX00XZU'.
      ...
      * Called module names
       01  MOD-ZTX01SJU              PIC X(8) VALUE 'ZTX01SJU'.
       01  MOD-ZTX01JPC              PIC X(8) VALUE 'ZTX01JPC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01SJU-001.
               CALL 'ZTX01SJU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01SJU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTX01JPC-002.
               CALL 'ZTX01JPC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01JPC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-MODEL-0001.
