      ******************************************************************
      * ZTX00AFO - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX00AFO'.
      ...
      * Called module names
       01  MOD-ZTX00SC3              PIC X(8) VALUE 'ZTX00SC3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPT00QZZ-001.
               MOVE 'ZPT00QZZ' TO WS-PROGNAME-4
      ...
      *----------------------------------------------------------------*
       CALL-ZTX00SC3-002.
               EXEC CICS LINK PROGRAM('ZTX00SC3')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
