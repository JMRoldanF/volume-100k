      ******************************************************************
      * ZTX00WF8 - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX00WF8'.
      ...
      * Called module names
       ...
       01  MOD-ZTX01LR2              PIC X(8) VALUE 'ZTX01LR2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTX01CT1-001.
               PERFORM CALL-ZTX01LR2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01LR2-002.
               CALL 'ZTX01LR2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01LR2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
