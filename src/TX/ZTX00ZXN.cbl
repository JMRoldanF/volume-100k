      ******************************************************************
      * ZTX00ZXN - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX00ZXN'.
      ...
      * Called module names
       01  MOD-ZTX01TOS              PIC X(8) VALUE 'ZTX01TOS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01TOS-001.
               CALL 'ZTX01TOS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01TOS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
