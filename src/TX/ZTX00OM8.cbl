      ******************************************************************
      * ZTX00OM8 - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX00OM8'.
      ...
      * Called module names
       01  MOD-ZTX01LRR              PIC X(8) VALUE 'ZTX01LRR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01LRR-001.
               CALL 'ZTX01LRR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01LRR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
