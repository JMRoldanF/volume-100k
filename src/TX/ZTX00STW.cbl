      ******************************************************************
      * ZTX00STW - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX00STW'.
      ...
      * Called module names
       01  MOD-ZTX01LNG              PIC X(8) VALUE 'ZTX01LNG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01LNG-001.
               CALL 'ZTX01LNG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01LNG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
