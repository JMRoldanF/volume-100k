      ******************************************************************
      * ZTX012BA - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX012BA'.
      ...
      * Called module names
       01  MOD-ZPT01S1U              PIC X(8) VALUE 'ZPT01S1U'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPT01S1U-001.
               CALL 'ZPT01S1U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01S1U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPT01LBB-002.
