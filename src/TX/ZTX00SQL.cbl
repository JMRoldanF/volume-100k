      ******************************************************************
      * ZTX00SQL - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX00SQL'.
      ...
      * Called module names
       ...
       01  MOD-ZTX01TMQ              PIC X(8) VALUE 'ZTX01TMQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01TMQ-002.
               CALL 'ZTX01TMQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01TMQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
