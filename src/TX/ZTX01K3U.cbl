      ******************************************************************
      * ZTX01K3U - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX01K3U'.
      ...
      * Called module names
       01  MOD-ZTX01SFE              PIC X(8) VALUE 'ZTX01SFE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01SFE-001.
               CALL 'ZTX01SFE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01SFE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
