      ******************************************************************
      * ZTX00Y3F - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX00Y3F'.
      ...
      * Called module names
       01  MOD-ZTX01GOT              PIC X(8) VALUE 'ZTX01GOT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTX01GOT-001.
               PERFORM CALL-ZAR01MY9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01GOT-001.
               CALL 'ZTX01GOT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01GOT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAR01MY9-002.
               MOVE 'ZAR01MY9' TO WS-SUBNAME-6
