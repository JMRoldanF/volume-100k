      ******************************************************************
      * ZTX01B66 - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX01B66'.
      ...
      * Called module names
       ...
       01  MOD-ZTX01GRZ              PIC X(8) VALUE 'ZTX01GRZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01GRZ-002.
               CALL 'ZTX01GRZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01GRZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
