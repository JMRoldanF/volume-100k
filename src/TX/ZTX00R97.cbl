      ******************************************************************
      * ZTX00R97 - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX00R97'.
      ...
      * Called module names
       01  MOD-ZIF01FFR              PIC X(8) VALUE 'ZIF01FFR'.
       01  MOD-ZTX01HH8              PIC X(8) VALUE 'ZTX01HH8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIF01FFR-001.
               CALL 'ZIF01FFR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIF01FFR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTX01HH8-002.
               CALL 'ZTX01HH8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01HH8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
