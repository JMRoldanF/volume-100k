      ******************************************************************
      * ZTX00Q20 - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX00Q20'.
      ...
      * Called module names
       01  MOD-ZTX01TY5              PIC X(8) VALUE 'ZTX01TY5'.
       01  MOD-ZTX01OQI              PIC X(8) VALUE 'ZTX01OQI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTX01TY5-001.
               PERFORM CALL-ZTX01OQI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01TY5-001.
               CALL 'ZTX01TY5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01TY5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTX01OQI-002.
               CALL 'ZTX01OQI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01OQI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
