      ******************************************************************
      * ZTX00PKJ - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX00PKJ'.
      ...
      * Called module names
       01  MOD-ZAR01KFV              PIC X(8) VALUE 'ZAR01KFV'.
       01  MOD-ZTX01J3C              PIC X(8) VALUE 'ZTX01J3C'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAR01KFV-001.
               PERFORM CALL-ZTX01J3C-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01KFV-001.
               CALL 'ZAR01KFV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01KFV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTX01J3C-002.
               CALL 'ZTX01J3C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01J3C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
