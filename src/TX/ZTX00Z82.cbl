      ******************************************************************
      * ZTX00Z82 - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX00Z82'.
      ...
      * Called module names
       ...
       01  MOD-ZTX01EQ2              PIC X(8) VALUE 'ZTX01EQ2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01EQ2-002.
               CALL 'ZTX01EQ2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
