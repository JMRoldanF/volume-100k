      ******************************************************************
      * ZTX004L0 - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX004L0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTX00KEX-001.
               PERFORM CALL-ZIF007YL-002.
               PERFORM CALL-ZAR00KR9-003.
               PERFORM CALL-ZTX0095U-004.
               PERFORM CALL-ZCL0255P-005.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZTX00KEX-001.
               MOVE 'ZTX00KEX' TO WS-PROGNAME-3
      ...
      *----------------------------------------------------------------*
       CALL-ZTX0095U-004.
               MOVE 'ZTX0095U' TO WS-PROGNAME-4
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX0095U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-005.
