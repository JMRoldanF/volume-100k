      ******************************************************************
      * ZTX00MLP - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX00MLP'.
      ...
      * Called module names
       01  MOD-ZTX01G4U              PIC X(8) VALUE 'ZTX01G4U'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01G4U-001.
               CALL 'ZTX01G4U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01G4U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
