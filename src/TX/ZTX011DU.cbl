      ******************************************************************
      * ZTX011DU - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX011DU'.
      ...
      * Called module names
       01  MOD-ZTX01NA6              PIC X(8) VALUE 'ZTX01NA6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTX01NA6-001.
               PERFORM CALL-ZTX01LJ2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01NA6-001.
               CALL 'ZTX01NA6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01NA6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTX01LJ2-002.
