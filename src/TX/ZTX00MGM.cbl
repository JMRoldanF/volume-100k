      ******************************************************************
      * ZTX00MGM - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX00MGM'.
      ...
      * Called module names
       ...
       01  MOD-ZTX01FPY              PIC X(8) VALUE 'ZTX01FPY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIF01D2B-001.
               PERFORM CALL-ZTX01FPY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01FPY-002.
               CALL 'ZTX01FPY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01FPY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
