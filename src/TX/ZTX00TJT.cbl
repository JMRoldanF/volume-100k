      ******************************************************************
      * ZTX00TJT - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX00TJT'.
      ...
      * Called module names
       01  MOD-ZTX01O09              PIC X(8) VALUE 'ZTX01O09'.
       01  MOD-ZTX01K26              PIC X(8) VALUE 'ZTX01K26'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01O09-001.
               CALL 'ZTX01O09' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01O09 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTX01K26-002.
               CALL 'ZTX01K26' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01K26 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
