      ******************************************************************
      * ZTX011G1 - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX011G1'.
      ...
      * Called module names
       01  MOD-ZTX01GUH              PIC X(8) VALUE 'ZTX01GUH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01GUH-001.
               CALL 'ZTX01GUH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01GUH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
