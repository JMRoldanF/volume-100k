      ******************************************************************
      * ZTX00LWQ - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX00LWQ'.
      ...
      * Called module names
       01  MOD-ZTX01G6Z              PIC X(8) VALUE 'ZTX01G6Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01G6Z-001.
               CALL 'ZTX01G6Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01G6Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
