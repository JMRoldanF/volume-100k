      ******************************************************************
      * ZTX00RT4 - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX00RT4'.
      ...
      * Called module names
       01  MOD-ZTX01F8B              PIC X(8) VALUE 'ZTX01F8B'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTX01F8B-001.
               PERFORM CALL-ZTX01SK3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01F8B-001.
               CALL 'ZTX01F8B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01F8B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTX01SK3-002.
