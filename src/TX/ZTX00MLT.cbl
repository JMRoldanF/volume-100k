      ******************************************************************
      * ZTX00MLT - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX00MLT'.
      ...
      * Called module names
       01  MOD-ZTX01O5H              PIC X(8) VALUE 'ZTX01O5H'.
       01  MOD-ZTX01FV0              PIC X(8) VALUE 'ZTX01FV0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTX01O5H-001.
               PERFORM CALL-ZTX01FV0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01O5H-001.
               CALL 'ZTX01O5H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01O5H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTX01FV0-002.
               CALL 'ZTX01FV0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
