      ******************************************************************
      * ZTX00QRI - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX00QRI'.
      ...
      * Called module names
       01  MOD-ZAR01SPF              PIC X(8) VALUE 'ZAR01SPF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01SPF-001.
               CALL 'ZAR01SPF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01SPF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
