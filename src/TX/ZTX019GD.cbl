      ******************************************************************
      * ZTX019GD - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX019GD'.
      ...
      * Called module names
       01  MOD-ZAR01S6W              PIC X(8) VALUE 'ZAR01S6W'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01S6W-001.
               CALL 'ZAR01S6W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01S6W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIF01T0N-002.
               MOVE 'ZIF01T0N' TO WS-SUBNAME-6
