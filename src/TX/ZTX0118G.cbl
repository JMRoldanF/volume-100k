      ******************************************************************
      * ZTX0118G - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX0118G'.
      ...
      * Called module names
       01  MOD-ZAR01IXD              PIC X(8) VALUE 'ZAR01IXD'.
       01  MOD-ZAR01CUV              PIC X(8) VALUE 'ZAR01CUV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAR01IXD-001.
               PERFORM CALL-ZAR01CUV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01IXD-001.
               CALL 'ZAR01IXD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01IXD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAR01CUV-002.
               CALL 'ZAR01CUV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01CUV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
