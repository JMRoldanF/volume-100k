      ******************************************************************
      * ZTX01NZO - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX01NZO'.
      ...
      * Called module names
       01  MOD-ZTX01OII              PIC X(8) VALUE 'ZTX01OII'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01OII-001.
               CALL 'ZTX01OII' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01OII FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
