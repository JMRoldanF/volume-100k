      ******************************************************************
      * ZTX00RIF - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX00RIF'.
      ...
      * Called module names
       01  MOD-ZTX01NZX              PIC X(8) VALUE 'ZTX01NZX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01NZX-001.
               CALL 'ZTX01NZX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01NZX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIF01LOI-002.
