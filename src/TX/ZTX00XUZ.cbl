      ******************************************************************
      * ZTX00XUZ - PREMIUM TAX AND LEVIES                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTX00XUZ'.
      ...
      * Called module names
       01  MOD-ZTX01IZR              PIC X(8) VALUE 'ZTX01IZR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTX01IZR-001.
               PERFORM CALL-ZTX01PJY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01IZR-001.
               CALL 'ZTX01IZR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01IZR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTX01PJY-002.
