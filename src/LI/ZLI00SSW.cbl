      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00SSW'.
      ...
      * Called module names
       01  MOD-ZLI01FVD              PIC X(8) VALUE 'ZLI01FVD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01FVD-001.
               CALL 'ZLI01FVD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01FVD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
