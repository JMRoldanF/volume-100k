      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00YIP'.
      ...
      * Called module names
       01  MOD-ZLI01N96              PIC X(8) VALUE 'ZLI01N96'.
       01  MOD-ZLI01U3N              PIC X(8) VALUE 'ZLI01U3N'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI01N96-001.
               PERFORM CALL-ZLI01U3N-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01N96-001.
               CALL 'ZLI01N96' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01N96 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLI01U3N-002.
               CALL 'ZLI01U3N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01U3N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
