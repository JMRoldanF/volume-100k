      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00UGD'.
      ...
      * Called module names
       01  MOD-ZLI01OSH              PIC X(8) VALUE 'ZLI01OSH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01OSH-001.
               CALL 'ZLI01OSH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01OSH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLI01DVH-002.
