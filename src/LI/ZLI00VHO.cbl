      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00VHO'.
      ...
      * Called module names
       01  MOD-ZLI01NV9              PIC X(8) VALUE 'ZLI01NV9'.
       01  MOD-ZLI01RL7              PIC X(8) VALUE 'ZLI01RL7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI01NV9-001.
               PERFORM CALL-ZLI01RL7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01NV9-001.
               CALL 'ZLI01NV9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01NV9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLI01RL7-002.
               CALL 'ZLI01RL7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01RL7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
