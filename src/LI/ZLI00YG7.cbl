      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00YG7'.
      ...
      * Called module names
       01  MOD-ZLI01ILV              PIC X(8) VALUE 'ZLI01ILV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01ILV-001.
               CALL 'ZLI01ILV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01ILV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
