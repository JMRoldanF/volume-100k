      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00S5W'.
      ...
      * Called module names
       01  MOD-ZLI01SI7              PIC X(8) VALUE 'ZLI01SI7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI01SI7-001.
               PERFORM CALL-ZLI01QFA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01SI7-001.
               CALL 'ZLI01SI7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01SI7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLI01QFA-002.
