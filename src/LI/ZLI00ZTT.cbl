      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00ZTT'.
      ...
      * Called module names
       ...
       01  MOD-ZFL01HKS              PIC X(8) VALUE 'ZFL01HKS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01HKS-002.
               CALL 'ZFL01HKS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01HKS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
