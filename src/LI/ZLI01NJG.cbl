      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI01NJG'.
      ...
      * Called module names
       01  MOD-ZLI01UFE              PIC X(8) VALUE 'ZLI01UFE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01UFE-001.
               CALL 'ZLI01UFE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01UFE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
