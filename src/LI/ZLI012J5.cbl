      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI012J5'.
      ...
      * Called module names
       01  MOD-ZLI01NJO              PIC X(8) VALUE 'ZLI01NJO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01NJO-001.
               CALL 'ZLI01NJO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01NJO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBR01S3M-002.
