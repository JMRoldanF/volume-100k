      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00NCU'.
      ...
      * Called module names
       01  MOD-ZLI01IHZ              PIC X(8) VALUE 'ZLI01IHZ'.
       01  MOD-ZLI01GL5              PIC X(8) VALUE 'ZLI01GL5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI01IHZ-001.
               PERFORM CALL-ZLI01GL5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01IHZ-001.
               CALL 'ZLI01IHZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01IHZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLI01GL5-002.
               CALL 'ZLI01GL5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01GL5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
