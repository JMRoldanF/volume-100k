      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00PLH'.
      ...
      * Called module names
       01  MOD-ZLI01JE4              PIC X(8) VALUE 'ZLI01JE4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01JE4-001.
               CALL 'ZLI01JE4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01JE4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
