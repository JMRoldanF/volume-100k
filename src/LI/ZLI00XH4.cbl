      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00XH4'.
      ...
      * Called module names
       01  MOD-ZLI01TF7              PIC X(8) VALUE 'ZLI01TF7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01TF7-001.
               CALL 'ZLI01TF7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01TF7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRS01SGY-002.
