      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00PO8'.
      ...
      * Called module names
       01  MOD-ZLI01MC1              PIC X(8) VALUE 'ZLI01MC1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01MC1-001.
               CALL 'ZLI01MC1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01MC1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
