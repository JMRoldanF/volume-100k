      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00LR4'.
      ...
      * Called module names
       01  MOD-ZLI01PHI              PIC X(8) VALUE 'ZLI01PHI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI01PHI-001.
               PERFORM CALL-ZRS01T5I-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01PHI-001.
               CALL 'ZLI01PHI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01PHI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRS01T5I-002.
