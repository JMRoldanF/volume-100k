      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00U5S'.
      ...
      * Called module names
       01  MOD-ZLI01L1G              PIC X(8) VALUE 'ZLI01L1G'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01L1G-001.
               CALL 'ZLI01L1G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01L1G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-MODEL-0001.
