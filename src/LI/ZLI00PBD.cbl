      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00PBD'.
      ...
      * Called module names
       01  MOD-ZLI01QEY              PIC X(8) VALUE 'ZLI01QEY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI01QEY-001.
               PERFORM CALL-ZEX01KXY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01QEY-001.
               CALL 'ZLI01QEY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01QEY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEX01KXY-002.
