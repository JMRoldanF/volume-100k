      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00N4T'.
      ...
      * Called module names
       01  MOD-ZEX01EVM              PIC X(8) VALUE 'ZEX01EVM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEX01EVM-001.
               CALL 'ZEX01EVM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEX01EVM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-MAKE-0001.
