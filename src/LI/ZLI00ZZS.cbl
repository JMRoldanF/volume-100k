      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00ZZS'.
      ...
      * Called module names
       01  MOD-ZBR01V2R              PIC X(8) VALUE 'ZBR01V2R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01V2R-001.
               CALL 'ZBR01V2R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01V2R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
