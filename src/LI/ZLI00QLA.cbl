      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00QLA'.
      ...
      * Called module names
       01  MOD-ZLI01QM1              PIC X(8) VALUE 'ZLI01QM1'.
       01  MOD-ZBR01TTR              PIC X(8) VALUE 'ZBR01TTR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI01QM1-001.
               PERFORM CALL-ZBR01TTR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01QM1-001.
               CALL 'ZLI01QM1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01QM1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBR01TTR-002.
               CALL 'ZBR01TTR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01TTR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
