      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI010EO'.
      ...
      * Called module names
       01  MOD-ZLI01LBX              PIC X(8) VALUE 'ZLI01LBX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01LBX-001.
               CALL 'ZLI01LBX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01LBX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
