      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00UJT'.
      ...
      * Called module names
       01  MOD-ZLI01P4O              PIC X(8) VALUE 'ZLI01P4O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01P4O-001.
               CALL 'ZLI01P4O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01P4O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
