      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI002XR'.
      ...
      * Called module names
       01  MOD-ZLI007JE              PIC X(8) VALUE 'ZLI007JE'.
       01  MOD-ZLI00D25              PIC X(8) VALUE 'ZLI00D25'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI007JE-001.
               PERFORM CALL-ZLI00D25-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI007JE-001.
               EXEC CICS LINK PROGRAM('ZLI007JE')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI007JE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLI00D25-002.
               EXEC CICS LINK PROGRAM('ZLI00D25')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI00D25 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
