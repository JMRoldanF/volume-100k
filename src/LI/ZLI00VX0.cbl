      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00VX0'.
      ...
      * Called module names
       01  MOD-ZLI01UWN              PIC X(8) VALUE 'ZLI01UWN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01UWN-001.
               CALL 'ZLI01UWN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01UWN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
