      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00VRH'.
      ...
      * Called module names
       01  MOD-ZLI01G7H              PIC X(8) VALUE 'ZLI01G7H'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01G7H-001.
               CALL 'ZLI01G7H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01G7H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-VALUE-0001.
