      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI019OE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI01EIU-001.
               PERFORM CALL-ZLI01FVD-002.
               PERFORM COMPUTE-PREMIUM-0001.
               PERFORM VALIDATE-ROOF-TYPE-0002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZLI01EIU-001.
               MOVE 'ZLI01EIU' TO WS-SUBNAME-8
