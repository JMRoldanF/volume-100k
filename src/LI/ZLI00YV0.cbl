      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00YV0'.
      ...
      * Called module names
       ...
       01  MOD-ZRS01LTG              PIC X(8) VALUE 'ZRS01LTG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01LTG-002.
               CALL 'ZRS01LTG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01LTG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
