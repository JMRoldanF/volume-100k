      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00VF0'.
      ...
      * Called module names
       01  MOD-ZLI01NTB              PIC X(8) VALUE 'ZLI01NTB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI01NTB-001.
               PERFORM CALL-ZLI01N96-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01NTB-001.
               CALL 'ZLI01NTB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01NTB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLI01N96-002.
