      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00ON1'.
      ...
      * Called module names
       01  MOD-ZLI01JRV              PIC X(8) VALUE 'ZLI01JRV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01JRV-001.
               CALL 'ZLI01JRV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01JRV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLI01QWI-002.
