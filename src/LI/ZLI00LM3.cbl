      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00LM3'.
      ...
      * Called module names
       01  MOD-ZLI01E46              PIC X(8) VALUE 'ZLI01E46'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01E46-001.
               CALL 'ZLI01E46' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01E46 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
