      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00YJ0'.
      ...
      * Called module names
       01  MOD-ZLI01PZZ              PIC X(8) VALUE 'ZLI01PZZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01PZZ-001.
               CALL 'ZLI01PZZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01PZZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
