      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00X3S'.
      ...
      * Called module names
       01  MOD-ZLI01TSP              PIC X(8) VALUE 'ZLI01TSP'.
       01  MOD-ZLI01HMR              PIC X(8) VALUE 'ZLI01HMR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI01TSP-001.
               PERFORM CALL-ZLI01HMR-002.
               ...
               PERFORM AUDIT-POSTCODE-0026.
               PERFORM SQL-ACCESS-0027.
               PERFORM FORMAT-TAX-BAND-0028.
               PERFORM FORMAT-MAKE-0029.
               ...
               PERFORM REFRESH-MAKE-0074.
               PERFORM SQL-ACCESS-0075.
               PERFORM REFRESH-EXCESS-0076.
               PERFORM SQL-ACCESS-0078.
               PERFORM VALIDATE-SUM-ASSURED-0079.
               ...
               PERFORM NORMALISE-ROOF-TYPE-0095.
               PERFORM APPLY-HOUSE-TYPE-0097.
               ...
               PERFORM NORMALISE-AGENT-CODE-0109.
               PERFORM DERIVE-PREMIUM-0110.
               PERFORM SQL-ACCESS-0111.
               PERFORM CHECK-MODEL-0112.
               PERFORM NORMALISE-MAKE-0113.
               PERFORM COMPUTE-MODEL-0115.
               PERFORM DERIVE-EXCESS-0116.
               PERFORM SQL-ACCESS-0117.
               PERFORM COMPUTE-STATUS-CODE-0118.
               PERFORM FORMAT-MAKE-0119.
               PERFORM SQL-ACCESS-0120.
               PERFORM EXPAND-MANAGED-FUND-0121.
               PERFORM RECONCILE-TERM-0122.
               PERFORM SQL-ACCESS-0123.
               PERFORM VALIDATE-HOUSE-TYPE-0124.
               PERFORM VALIDATE-MANAGED-FUND-0125.
               PERFORM SQL-ACCESS-0126.
               PERFORM AUDIT-TAX-BAND-0127.
               PERFORM NORMALISE-WITH-PROFITS-0128.
               PERFORM SQL-ACCESS-0129.
               PERFORM NORMALISE-PREMIUM-0130.
               PERFORM COMPUTE-NCD-YEARS-0131.
               PERFORM SQL-ACCESS-0132.
               PERFORM CHECK-CC-RATING-0134.
               PERFORM SQL-ACCESS-0135.
               PERFORM NORMALISE-MAKE-0136.
               PERFORM COMPUTE-CC-RATING-0137.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZLI01TSP-001.
               CALL 'ZLI01TSP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01TSP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLI01HMR-002.
               CALL 'ZLI01HMR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01HMR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
