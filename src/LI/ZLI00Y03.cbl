      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00Y03'.
      ...
      * Called module names
       01  MOD-ZLI01H6F              PIC X(8) VALUE 'ZLI01H6F'.
       01  MOD-ZLI01K9Z              PIC X(8) VALUE 'ZLI01K9Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01H6F-001.
               CALL 'ZLI01H6F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01H6F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLI01K9Z-002.
               CALL 'ZLI01K9Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01K9Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
