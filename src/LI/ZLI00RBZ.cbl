      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00RBZ'.
      ...
      * Called module names
       01  MOD-ZEX01QZA              PIC X(8) VALUE 'ZEX01QZA'.
       01  MOD-ZLI01UUX              PIC X(8) VALUE 'ZLI01UUX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEX01QZA-001.
               PERFORM CALL-ZLI01UUX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEX01QZA-001.
               CALL 'ZEX01QZA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01UUX-002.
               CALL 'ZLI01UUX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01UUX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
