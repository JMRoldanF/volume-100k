      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI0124X'.
      ...
      * Called module names
       01  MOD-ZLI01EWK              PIC X(8) VALUE 'ZLI01EWK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01EWK-001.
               CALL 'ZLI01EWK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01EWK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
