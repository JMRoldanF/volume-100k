      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00RG1'.
      ...
      * Called module names
       01  MOD-ZLI01G6O              PIC X(8) VALUE 'ZLI01G6O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01G6O-001.
               CALL 'ZLI01G6O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01G6O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
