      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI01823'.
      ...
      * Called module names
       01  MOD-ZLI01OZI              PIC X(8) VALUE 'ZLI01OZI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01OZI-001.
               CALL 'ZLI01OZI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01OZI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
