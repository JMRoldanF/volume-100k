      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI012EI'.
      ...
      * Called module names
       01  MOD-ZLI01CRB              PIC X(8) VALUE 'ZLI01CRB'.
       01  MOD-ZFL01UCM              PIC X(8) VALUE 'ZFL01UCM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI01CRB-001.
               PERFORM CALL-ZFL01UCM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01CRB-001.
               CALL 'ZLI01CRB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01CRB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFL01UCM-002.
               CALL 'ZFL01UCM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01UCM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
