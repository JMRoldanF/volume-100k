      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00XD4'.
      ...
      * Called module names
       01  MOD-ZLI01MR6              PIC X(8) VALUE 'ZLI01MR6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI01MR6-001.
               PERFORM CALL-ZLI01PGS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01MR6-001.
               CALL 'ZLI01MR6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01MR6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLI01PGS-002.
