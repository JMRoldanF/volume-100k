      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00PRT'.
      ...
      * Called module names
       01  MOD-ZLI01ELW              PIC X(8) VALUE 'ZLI01ELW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01ELW-001.
               CALL 'ZLI01ELW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01ELW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
