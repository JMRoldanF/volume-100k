      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00RLB'.
      ...
      * Called module names
       01  MOD-ZEX01L1K              PIC X(8) VALUE 'ZEX01L1K'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEX01L1K-001.
               PERFORM CALL-ZLI01S4N-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEX01L1K-001.
               CALL 'ZEX01L1K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEX01L1K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLI01S4N-002.
