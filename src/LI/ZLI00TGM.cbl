      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00TGM'.
      ...
      * Called module names
       01  MOD-ZLI01PXP              PIC X(8) VALUE 'ZLI01PXP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI01PXP-001.
               PERFORM NORMALISE-ROOF-TYPE-0001.
               PERFORM COMPUTE-MAKE-0002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZLI01PXP-001.
               CALL 'ZLI01PXP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01PXP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
