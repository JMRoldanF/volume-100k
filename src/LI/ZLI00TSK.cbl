      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00TSK'.
      ...
      * Called module names
       01  MOD-ZLI01FU6              PIC X(8) VALUE 'ZLI01FU6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01FU6-001.
               CALL 'ZLI01FU6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01FU6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
