      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00PU6'.
      ...
      * Called module names
       01  MOD-ZLI01SM2              PIC X(8) VALUE 'ZLI01SM2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01SM2-001.
               CALL 'ZLI01SM2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01SM2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
