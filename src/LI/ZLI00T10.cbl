      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00T10'.
      ...
      * Called module names
       01  MOD-ZLI01H0U              PIC X(8) VALUE 'ZLI01H0U'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01H0U-001.
               CALL 'ZLI01H0U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01H0U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
