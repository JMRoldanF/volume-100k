      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI011TM'.
      ...
      * Called module names
       ...
       01  MOD-ZLI01FVG              PIC X(8) VALUE 'ZLI01FVG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01FVG-002.
               CALL 'ZLI01FVG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01FVG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
