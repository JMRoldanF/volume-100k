      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI01A8N'.
      ...
      * Called module names
       01  MOD-ZFL01GJY              PIC X(8) VALUE 'ZFL01GJY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01GJY-001.
               CALL 'ZFL01GJY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01GJY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
