      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00TLT'.
      ...
      * Called module names
       01  MOD-ZLI01NMP              PIC X(8) VALUE 'ZLI01NMP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01NMP-001.
               CALL 'ZLI01NMP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01NMP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
