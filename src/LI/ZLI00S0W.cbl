      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00S0W'.
      ...
      * Called module names
       01  MOD-ZLI01SA7              PIC X(8) VALUE 'ZLI01SA7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI01SA7-001.
               PERFORM CALL-ZLI01GBG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01SA7-001.
               CALL 'ZLI01SA7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01SA7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLI01GBG-002.
