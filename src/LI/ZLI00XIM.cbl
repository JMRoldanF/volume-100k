      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00XIM'.
      ...
      * Called module names
       01  MOD-ZLI01I5W              PIC X(8) VALUE 'ZLI01I5W'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI01I5W-001.
               PERFORM CALL-ZLI01Q8X-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01I5W-001.
               CALL 'ZLI01I5W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01Q8X-002.
               MOVE 'ZLI01Q8X' TO WS-SUBNAME-2
               CALL WS-SUBNAME-2 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01Q8X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
