      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI01066'.
      ...
      * Called module names
       01  MOD-ZLI01KQ9              PIC X(8) VALUE 'ZLI01KQ9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI01KQ9-001.
               PERFORM CALL-ZLI01O8D-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01KQ9-001.
               CALL 'ZLI01KQ9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01KQ9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLI01O8D-002.
