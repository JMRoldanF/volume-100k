      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00LRR'.
      ...
      * Called module names
       01  MOD-ZBR01F0N              PIC X(8) VALUE 'ZBR01F0N'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01F0N-001.
               CALL 'ZBR01F0N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01F0N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
