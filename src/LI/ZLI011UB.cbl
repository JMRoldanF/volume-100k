      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI011UB'.
      ...
      * Called module names
       01  MOD-ZLI01PMH              PIC X(8) VALUE 'ZLI01PMH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01PMH-001.
               CALL 'ZLI01PMH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01PMH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
