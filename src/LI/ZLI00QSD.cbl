      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00QSD'.
      ...
      * Called module names
       01  MOD-ZLI01LJF              PIC X(8) VALUE 'ZLI01LJF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01LJF-001.
               CALL 'ZLI01LJF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01LJF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-EXCESS-0001.
