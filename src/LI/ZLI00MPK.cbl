      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00MPK'.
      ...
      * Called module names
       01  MOD-ZLI01MFZ              PIC X(8) VALUE 'ZLI01MFZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01MFZ-001.
               CALL 'ZLI01MFZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01MFZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
