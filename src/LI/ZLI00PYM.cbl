      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00PYM'.
      ...
      * Called module names
       01  MOD-ZLI01UK4              PIC X(8) VALUE 'ZLI01UK4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01UK4-001.
               CALL 'ZLI01UK4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01UK4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
