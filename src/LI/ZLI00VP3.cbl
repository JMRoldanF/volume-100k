      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00VP3'.
      ...
      * Called module names
       ...
       01  MOD-ZBR01K2G              PIC X(8) VALUE 'ZBR01K2G'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01K2G-002.
               CALL 'ZBR01K2G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
