      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00ZGH'.
      ...
      * Called module names
       01  MOD-ZLI01TZR              PIC X(8) VALUE 'ZLI01TZR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01TZR-001.
               CALL 'ZLI01TZR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01TZR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
