      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00N77'.
      ...
      * Called module names
       01  MOD-ZLI01O8T              PIC X(8) VALUE 'ZLI01O8T'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01O8T-001.
               CALL 'ZLI01O8T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01RB1-002.
               MOVE 'ZLI01RB1' TO WS-SUBNAME-3
               CALL WS-SUBNAME-3 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01RB1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-EXCESS-0001.
