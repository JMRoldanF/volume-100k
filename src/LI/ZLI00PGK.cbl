      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00PGK'.
      ...
      * Called module names
       01  MOD-ZLI01S3X              PIC X(8) VALUE 'ZLI01S3X'.
       01  MOD-ZLI01FK2              PIC X(8) VALUE 'ZLI01FK2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI01S3X-001.
               PERFORM CALL-ZLI01FK2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01S3X-001.
               CALL 'ZLI01S3X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01S3X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLI01FK2-002.
               CALL 'ZLI01FK2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01FK2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
