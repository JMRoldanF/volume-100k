      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00ZK1'.
      ...
      * Called module names
       01  MOD-ZFL01SQ9              PIC X(8) VALUE 'ZFL01SQ9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01SQ9-001.
               CALL 'ZFL01SQ9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01SQ9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
