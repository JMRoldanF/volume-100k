      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00QNC'.
      ...
      * Called module names
       01  MOD-ZLI01NV3              PIC X(8) VALUE 'ZLI01NV3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI01NV3-001.
               PERFORM CALL-ZLI01Q2P-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01NV3-001.
               CALL 'ZLI01NV3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
