      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00R8I'.
      ...
      * Called module names
       01  MOD-ZLI01OK2              PIC X(8) VALUE 'ZLI01OK2'.
       01  MOD-ZLI01TYB              PIC X(8) VALUE 'ZLI01TYB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI01OK2-001.
               PERFORM CALL-ZLI01TYB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01OK2-001.
               CALL 'ZLI01OK2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01OK2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLI01TYB-002.
               CALL 'ZLI01TYB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01TYB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
