      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI01298'.
      ...
      * Called module names
       01  MOD-ZLI01RZJ              PIC X(8) VALUE 'ZLI01RZJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01RZJ-001.
               CALL 'ZLI01RZJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01RZJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
