      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI0104F'.
      ...
      * Called module names
       01  MOD-ZLI01OTE              PIC X(8) VALUE 'ZLI01OTE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01OTE-001.
               CALL 'ZLI01OTE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01OTE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
