      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00MCB'.
      ...
      * Called module names
       01  MOD-ZLI01S5Q              PIC X(8) VALUE 'ZLI01S5Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01S5Q-001.
               CALL 'ZLI01S5Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01S5Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
