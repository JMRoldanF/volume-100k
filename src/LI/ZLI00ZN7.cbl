      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00ZN7'.
      ...
      * Called module names
       01  MOD-ZLI01NCA              PIC X(8) VALUE 'ZLI01NCA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI01E4S-001.
               PERFORM CALL-ZLI01NCA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01NCA-002.
               CALL 'ZLI01NCA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01NCA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
