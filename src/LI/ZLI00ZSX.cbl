      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00ZSX'.
      ...
      * Called module names
       01  MOD-ZLI01MJB              PIC X(8) VALUE 'ZLI01MJB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI01MJB-001.
               PERFORM CALL-ZLI01JTU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01MJB-001.
               CALL 'ZLI01MJB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01MJB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLI01JTU-002.
               MOVE 'ZLI01JTU' TO WS-SUBNAME-8
