      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00W1H'.
      ...
      * Called module names
       01  MOD-ZLI01EKW              PIC X(8) VALUE 'ZLI01EKW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01EKW-001.
               CALL 'ZLI01EKW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01EKW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
