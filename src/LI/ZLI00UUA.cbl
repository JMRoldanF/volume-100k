      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00UUA'.
      ...
      * Called module names
       01  MOD-ZRS01L3L              PIC X(8) VALUE 'ZRS01L3L'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01L3L-001.
               CALL 'ZRS01L3L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01L3L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
