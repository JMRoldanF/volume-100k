      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00VPZ'.
      ...
      * Called module names
       01  MOD-ZLI01OYN              PIC X(8) VALUE 'ZLI01OYN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01OYN-001.
               CALL 'ZLI01OYN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01OYN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
