      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00OHY'.
      ...
      * Called module names
       01  MOD-ZLI01QVD              PIC X(8) VALUE 'ZLI01QVD'.
       01  MOD-ZFL01FL7              PIC X(8) VALUE 'ZFL01FL7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI01QVD-001.
               PERFORM CALL-ZFL01FL7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01QVD-001.
               CALL 'ZLI01QVD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01QVD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFL01FL7-002.
               CALL 'ZFL01FL7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01FL7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
