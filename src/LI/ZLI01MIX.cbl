      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI01MIX'.
      ...
      * Called module names
       01  MOD-ZLI01V1E              PIC X(8) VALUE 'ZLI01V1E'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01V1E-001.
               CALL 'ZLI01V1E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01V1E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
