      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI010AH'.
      ...
      * Called module names
       01  MOD-ZLI01TCJ              PIC X(8) VALUE 'ZLI01TCJ'.
       01  MOD-ZLI01NPB              PIC X(8) VALUE 'ZLI01NPB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI01TCJ-001.
               PERFORM CALL-ZLI01NPB-002.
               PERFORM CALL-ZRE0255R-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZLI01TCJ-001.
               CALL 'ZLI01TCJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01NPB-002.
               CALL 'ZLI01NPB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01NPB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
