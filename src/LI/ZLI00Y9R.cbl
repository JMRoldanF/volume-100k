      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00Y9R'.
      ...
      * Called module names
       01  MOD-ZEX01JNH              PIC X(8) VALUE 'ZEX01JNH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEX01JNH-001.
               CALL 'ZEX01JNH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEX01JNH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
