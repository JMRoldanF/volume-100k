      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00R1G'.
      ...
      * Called module names
       01  MOD-ZLI01I3A              PIC X(8) VALUE 'ZLI01I3A'.
       01  MOD-ZLI01GWV              PIC X(8) VALUE 'ZLI01GWV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI01I3A-001.
               PERFORM CALL-ZLI01GWV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01I3A-001.
               CALL 'ZLI01I3A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01I3A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLI01GWV-002.
               CALL 'ZLI01GWV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01GWV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
