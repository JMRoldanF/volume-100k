      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00QG3'.
      ...
      * Called module names
       ...
       01  MOD-ZLI01PB1              PIC X(8) VALUE 'ZLI01PB1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBR01RKU-001.
               PERFORM CALL-ZLI01PB1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01PB1-002.
               CALL 'ZLI01PB1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01PB1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
