      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00UC4'.
      ...
      * Called module names
       01  MOD-ZLI01LKH              PIC X(8) VALUE 'ZLI01LKH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI01LKH-001.
               PERFORM CALL-ZLI01TP0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01LKH-001.
               CALL 'ZLI01LKH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01LKH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLI01TP0-002.
               MOVE 'ZLI01TP0' TO WS-SUBNAME-8
