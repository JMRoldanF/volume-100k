      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00RYJ'.
      ...
      * Called module names
       01  MOD-ZLI01GDF              PIC X(8) VALUE 'ZLI01GDF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01GDF-001.
               CALL 'ZLI01GDF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01GDF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLI01N9A-002.
