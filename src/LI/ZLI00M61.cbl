      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00M61'.
      ...
      * Called module names
       01  MOD-ZLI01L4O              PIC X(8) VALUE 'ZLI01L4O'.
       01  MOD-ZLI01NJ4              PIC X(8) VALUE 'ZLI01NJ4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI01L4O-001.
               PERFORM CALL-ZLI01NJ4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01L4O-001.
               CALL 'ZLI01L4O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01L4O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLI01NJ4-002.
               CALL 'ZLI01NJ4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01NJ4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
