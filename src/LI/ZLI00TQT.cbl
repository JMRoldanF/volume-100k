      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI00TQT'.
      ...
      * Called module names
       01  MOD-ZFL01TRX              PIC X(8) VALUE 'ZFL01TRX'.
       01  MOD-ZLI01DVH              PIC X(8) VALUE 'ZLI01DVH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01TRX-001.
               CALL 'ZFL01TRX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01TRX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLI01DVH-002.
               CALL 'ZLI01DVH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01DVH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-PREMIUM-0001.
