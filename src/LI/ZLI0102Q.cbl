      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLI0102Q'.
      ...
      * Called module names
       01  MOD-ZLI01H7M              PIC X(8) VALUE 'ZLI01H7M'.
       01  MOD-ZLI01MIP              PIC X(8) VALUE 'ZLI01MIP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI01H7M-001.
               PERFORM CALL-ZLI01MIP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01H7M-001.
               CALL 'ZLI01H7M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01H7M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLI01MIP-002.
               CALL 'ZLI01MIP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01MIP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
