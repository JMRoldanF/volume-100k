      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSB00MTI'.
      ...
      * Called module names
       01  MOD-ZSB01KI2              PIC X(8) VALUE 'ZSB01KI2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSB01KI2-001.
               CALL 'ZSB01KI2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSB01KI2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
