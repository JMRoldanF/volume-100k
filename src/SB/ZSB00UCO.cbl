      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSB00UCO'.
      ...
      * Called module names
       01  MOD-ZED01HQF              PIC X(8) VALUE 'ZED01HQF'.
       01  MOD-ZSB01O6G              PIC X(8) VALUE 'ZSB01O6G'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZED01HQF-001.
               PERFORM CALL-ZSB01O6G-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZED01HQF-001.
               CALL 'ZED01HQF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZED01HQF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSB01O6G-002.
               CALL 'ZSB01O6G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSB01O6G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
