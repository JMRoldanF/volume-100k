      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSB00MS9'.
      ...
      * Called module names
       ...
       01  MOD-ZIF01LQB              PIC X(8) VALUE 'ZIF01LQB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIF01LQB-002.
               CALL 'ZIF01LQB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIF01LQB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
