      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSB00U88'.
      ...
      * Called module names
       01  MOD-ZSB01TRO              PIC X(8) VALUE 'ZSB01TRO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSB01OQ6-001.
               PERFORM CALL-ZSB01TRO-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSB01TRO-002.
               CALL 'ZSB01TRO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSB01TRO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
