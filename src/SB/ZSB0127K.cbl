      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSB0127K'.
      ...
      * Called module names
       01  MOD-ZSB01NXI              PIC X(8) VALUE 'ZSB01NXI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSB01NXI-001.
               CALL 'ZSB01NXI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSB01NXI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
