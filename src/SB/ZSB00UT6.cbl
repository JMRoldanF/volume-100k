      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSB00UT6'.
      ...
      * Called module names
       01  MOD-ZSB01SNI              PIC X(8) VALUE 'ZSB01SNI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSB01SNI-001.
               PERFORM CALL-ZSB01SFH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSB01SNI-001.
               CALL 'ZSB01SNI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSB01SNI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSB01SFH-002.
