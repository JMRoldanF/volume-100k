      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSB014BS'.
      ...
      * Called module names
       01  MOD-ZSB01J7H              PIC X(8) VALUE 'ZSB01J7H'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSB01J7H-001.
               PERFORM CALL-ZSB01QCA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSB01J7H-001.
               CALL 'ZSB01J7H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSB01J7H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSB01QCA-002.
      ...
      *----------------------------------------------------------------*
       FILE-ACCESS-0006.
               EXEC CICS DELETE FILE('KSDSSB22')
                         RIDFLD(WS-KEY-AREA)
                         RESP(WS-RESP)
               END-EXEC.
               EVALUATE WS-RESP
