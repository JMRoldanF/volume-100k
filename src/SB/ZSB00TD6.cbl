      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSB00TD6'.
      ...
      * Called module names
       01  MOD-ZSB01TPN              PIC X(8) VALUE 'ZSB01TPN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSB01TPN-001.
               CALL 'ZSB01TPN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSB01TPN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
