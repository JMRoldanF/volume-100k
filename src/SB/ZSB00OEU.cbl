      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSB00OEU'.
      ...
      * Called module names
       01  MOD-ZIF01U1R              PIC X(8) VALUE 'ZIF01U1R'.
       01  MOD-ZSB01DO8              PIC X(8) VALUE 'ZSB01DO8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIF01U1R-001.
               PERFORM CALL-ZSB01DO8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZIF01U1R-001.
               CALL 'ZIF01U1R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIF01U1R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSB01DO8-002.
               CALL 'ZSB01DO8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSB01DO8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
