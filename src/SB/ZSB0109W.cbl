      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSB0109W'.
      ...
      * Called module names
       01  MOD-ZSB01U91              PIC X(8) VALUE 'ZSB01U91'.
       01  MOD-ZSB01I4R              PIC X(8) VALUE 'ZSB01I4R'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSB01U91-001.
               PERFORM CALL-ZSB01I4R-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSB01U91-001.
               CALL 'ZSB01U91' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSB01U91 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSB01I4R-002.
               CALL 'ZSB01I4R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSB01I4R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
