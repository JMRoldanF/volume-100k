      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSB011CE'.
      ...
      * Called module names
       01  MOD-ZSB01HKE              PIC X(8) VALUE 'ZSB01HKE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSB01HKE-001.
               CALL 'ZSB01HKE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSB01HKE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
