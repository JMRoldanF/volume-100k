      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSB01015'.
      ...
      * Called module names
       01  MOD-ZSB01EBB              PIC X(8) VALUE 'ZSB01EBB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSB01EBB-001.
               CALL 'ZSB01EBB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSB01EBB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
