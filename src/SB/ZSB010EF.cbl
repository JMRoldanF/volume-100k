      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSB010EF'.
      ...
      * Called module names
       01  MOD-ZSB01RR9              PIC X(8) VALUE 'ZSB01RR9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSB01RR9-001.
               CALL 'ZSB01RR9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSB01RR9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
