      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSB00YKY'.
      ...
      * Called module names
       01  MOD-ZSB01E5W              PIC X(8) VALUE 'ZSB01E5W'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSB01E5W-002.
               CALL 'ZSB01E5W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
