      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSB00T3C'.
      ...
      * Called module names
       01  MOD-ZIF01THM              PIC X(8) VALUE 'ZIF01THM'.
       01  MOD-ZLB01TQI              PIC X(8) VALUE 'ZLB01TQI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIF01THM-001.
               PERFORM CALL-ZLB01TQI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZIF01THM-001.
               CALL 'ZIF01THM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIF01THM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLB01TQI-002.
               CALL 'ZLB01TQI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01TQI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-TERM-0001.
