      ...
      ******************************************************************
       ...
       FILE-CONTROL.
               SELECT INPUT-FILE  ASSIGN TO DDSBIN89
                         ORGANIZATION IS SEQUENTIAL
                         FILE STATUS  IS WS-FILE-STATUS.
               SELECT OUTPUT-FILE ASSIGN TO DDSBOT89
                         ORGANIZATION IS SEQUENTIAL
                         FILE STATUS  IS WS-FILE-STATUS.
               SELECT REPORT-FILE ASSIGN TO DDSBRP89
                         ORGANIZATION IS SEQUENTIAL
                         FILE STATUS  IS WS-FILE-STATUS.
       DATA DIVISION.
       FILE SECTION.
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSB023GF'.
      ...
      * Called module names
       01  MOD-ZSB01UXP              PIC X(8) VALUE 'ZSB01UXP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSB01UXP-001.
               PERFORM CALL-ZSB01KEN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSB01UXP-001.
               CALL 'ZSB01UXP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSB01UXP FAILED' TO EM-VARIABLE
