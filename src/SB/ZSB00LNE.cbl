      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSB00LNE'.
      ...
      * Called module names
       01  MOD-ZSB01O38              PIC X(8) VALUE 'ZSB01O38'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSB01O38-001.
               PERFORM CALL-ZSB01COQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSB01O38-001.
               CALL 'ZSB01O38' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSB01O38 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSB01COQ-002.
