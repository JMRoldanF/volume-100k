      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSB011K8'.
      ...
      * Called module names
       01  MOD-ZIF01GLR              PIC X(8) VALUE 'ZIF01GLR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIF01GLR-001.
               CALL 'ZIF01GLR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIF01GLR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
