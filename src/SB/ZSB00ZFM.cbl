      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSB00ZFM'.
      ...
      * Called module names
       ...
       01  MOD-ZSB01TZW              PIC X(8) VALUE 'ZSB01TZW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSB01TZW-002.
               CALL 'ZSB01TZW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSB01TZW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
