      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE0114V'.
      ...
      * Called module names
       01  MOD-ZRE01GRN              PIC X(8) VALUE 'ZRE01GRN'.
       01  MOD-ZRE01K0B              PIC X(8) VALUE 'ZRE01K0B'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01GRN-001.
               PERFORM CALL-ZRE01K0B-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01GRN-001.
               CALL 'ZRE01GRN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01GRN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01K0B-002.
               CALL 'ZRE01K0B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01K0B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
