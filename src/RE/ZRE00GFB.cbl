      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00GFB'.
      ...
      * Called module names
       01  MOD-ZRE010QZ              PIC X(8) VALUE 'ZRE010QZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE010QZ-001.
               EXEC CICS LINK PROGRAM('ZRE010QZ')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE010QZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
