      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE017LD'.
      ...
      * Called module names
       01  MOD-ZRE01K3X              PIC X(8) VALUE 'ZRE01K3X'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01K3X-001.
               CALL 'ZRE01K3X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01K3X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
