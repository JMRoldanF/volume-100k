      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01AZ1'.
      ...
      * Called module names
       01  MOD-ZRE01Q7X              PIC X(8) VALUE 'ZRE01Q7X'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01Q7X-001.
               PERFORM CALL-ZRE01DAX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01Q7X-001.
               CALL 'ZRE01Q7X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01Q7X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01DAX-002.
