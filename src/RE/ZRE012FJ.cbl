      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE012FJ'.
      ...
      * Called module names
       01  MOD-ZRE01NVH              PIC X(8) VALUE 'ZRE01NVH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01NVH-001.
               CALL 'ZRE01NVH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01NVH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-VALUE-0001.
