      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00PRZ'.
      ...
      * Called module names
       01  MOD-ZRE01H2H              PIC X(8) VALUE 'ZRE01H2H'.
       01  MOD-ZUW01M16              PIC X(8) VALUE 'ZUW01M16'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01H2H-001.
               PERFORM CALL-ZUW01M16-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01H2H-001.
               CALL 'ZRE01H2H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01H2H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01M16-002.
               CALL 'ZUW01M16' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01M16 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
