      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00ZFH'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01IZX              PIC X(8) VALUE 'ZRE01IZX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01NV7-001.
               PERFORM CALL-ZRE01IZX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01IZX-002.
               CALL 'ZRE01IZX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01IZX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-TERM-0001.
