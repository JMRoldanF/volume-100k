      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00QX3'.
      ...
      * Called module names
       01  MOD-ZUW01CX4              PIC X(8) VALUE 'ZUW01CX4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01CX4-001.
               CALL 'ZUW01CX4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01CX4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-TAX-BAND-0001.
