      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00YWL'.
      ...
      * Called module names
       01  MOD-ZRE01EQV              PIC X(8) VALUE 'ZRE01EQV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01FMT-001.
               PERFORM CALL-ZRE01EQV-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZRE01FMT-001.
               MOVE 'ZRE01FMT' TO WS-SUBNAME-2
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01EQV-002.
               CALL 'ZRE01EQV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01EQV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       WRITE-ERROR-MESSAGE.
