      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00XIB'.
      ...
      * Called module names
       01  MOD-ZRE01MLN              PIC X(8) VALUE 'ZRE01MLN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01MLN-001.
               CALL 'ZRE01MLN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01MLN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
