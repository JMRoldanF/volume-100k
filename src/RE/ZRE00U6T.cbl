      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00U6T'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01Q68-001.
               PERFORM CALL-ZRE01OH0-002.
               PERFORM CALL-ZBI0255Q-003.
               PERFORM NORMALISE-CC-RATING-0001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZRE01Q68-001.
               MOVE 'ZRE01Q68' TO WS-SUBNAME-1
