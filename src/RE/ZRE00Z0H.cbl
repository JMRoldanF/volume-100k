      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00Z0H'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01PNN              PIC X(8) VALUE 'ZRE01PNN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01EZH-001.
               PERFORM CALL-ZRE01PNN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01PNN-002.
               CALL 'ZRE01PNN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01PNN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
