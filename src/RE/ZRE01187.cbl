      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01187'.
      ...
      * Called module names
       01  MOD-ZRE01GI7              PIC X(8) VALUE 'ZRE01GI7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01GI7-001.
               CALL 'ZRE01GI7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01GI7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
