      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE011NR'.
      ...
      * Called module names
       01  MOD-ZPA01M5V              PIC X(8) VALUE 'ZPA01M5V'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01M5V-001.
               PERFORM CALL-ZRE01NYJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01M5V-001.
               CALL 'ZPA01M5V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01M5V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01NYJ-002.
               MOVE 'ZRE01NYJ' TO WS-SUBNAME-2
