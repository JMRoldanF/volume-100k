      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00O17'.
      ...
      * Called module names
       01  MOD-ZRE01TE3              PIC X(8) VALUE 'ZRE01TE3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01TE3-001.
               CALL 'ZRE01TE3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01TE3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
