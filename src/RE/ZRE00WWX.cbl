      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00WWX'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01SR1              PIC X(8) VALUE 'ZRE01SR1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01ER5-001.
               PERFORM CALL-ZRE01SR1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01SR1-002.
               CALL 'ZRE01SR1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01SR1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
