      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00D3J'.
      ...
      * Called module names
       01  MOD-ZMB01CID              PIC X(8) VALUE 'ZMB01CID'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMB00Y73-001.
               PERFORM CALL-ZMB01CID-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMB00Y73-001.
               MOVE 'ZMB00Y73' TO WS-PROGNAME-6
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMB00Y73 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMB01CID-002.
               EXEC CICS LINK PROGRAM('ZMB01CID')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMB01CID FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01QCW-003.
               MOVE 'ZRE01QCW' TO WS-SUBNAME-7
