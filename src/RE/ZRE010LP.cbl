      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE010LP'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01H0T              PIC X(8) VALUE 'ZRE01H0T'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01UY7-001.
               PERFORM CALL-ZRE01H0T-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01H0T-002.
               CALL 'ZRE01H0T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01H0T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
