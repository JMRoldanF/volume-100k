      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE011CN'.
      ...
      * Called module names
       01  MOD-ZRE01DRB              PIC X(8) VALUE 'ZRE01DRB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01DRB-001.
               CALL 'ZRE01DRB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01DRB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
