      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00PLL'.
      ...
      * Called module names
       01  MOD-ZRE01EJ3              PIC X(8) VALUE 'ZRE01EJ3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01EJ3-001.
               CALL 'ZRE01EJ3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01EJ3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01JNX-002.
