      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00RTV'.
      ...
      * Called module names
       01  MOD-ZRE01OON              PIC X(8) VALUE 'ZRE01OON'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01OON-001.
               CALL 'ZRE01OON' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01OON FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-TERM-0001.
