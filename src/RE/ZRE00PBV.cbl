      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00PBV'.
      ...
      * Called module names
       01  MOD-ZRE01GYB              PIC X(8) VALUE 'ZRE01GYB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01GYB-001.
               PERFORM CALL-ZRE01JYX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01GYB-001.
               CALL 'ZRE01GYB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01GYB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01JYX-002.
