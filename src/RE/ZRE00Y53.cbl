      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00Y53'.
      ...
      * Called module names
       01  MOD-ZRE01NG7              PIC X(8) VALUE 'ZRE01NG7'.
       01  MOD-ZRE01UIX              PIC X(8) VALUE 'ZRE01UIX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01NG7-001.
               PERFORM CALL-ZRE01UIX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01NG7-001.
               CALL 'ZRE01NG7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01NG7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01UIX-002.
               CALL 'ZRE01UIX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
