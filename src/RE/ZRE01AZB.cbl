      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01AZB'.
      ...
      * Called module names
       01  MOD-ZRE01K47              PIC X(8) VALUE 'ZRE01K47'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01K47-001.
               CALL 'ZRE01K47' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01K47 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
