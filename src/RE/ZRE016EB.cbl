      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE016EB'.
      ...
      * Called module names
       01  MOD-ZRE01PKV              PIC X(8) VALUE 'ZRE01PKV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01PKV-001.
               CALL 'ZRE01PKV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01PKV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
