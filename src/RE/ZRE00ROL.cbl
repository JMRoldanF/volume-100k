      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00ROL'.
      ...
      * Called module names
       01  MOD-ZRE01ICB              PIC X(8) VALUE 'ZRE01ICB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01ICB-001.
               CALL 'ZRE01ICB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01ICB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
