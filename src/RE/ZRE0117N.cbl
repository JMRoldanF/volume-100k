      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE0117N'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01H4Z              PIC X(8) VALUE 'ZRE01H4Z'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01SS5-001.
               PERFORM CALL-ZRE01H4Z-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01H4Z-002.
               CALL 'ZRE01H4Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01H4Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
