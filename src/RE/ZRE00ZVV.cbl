      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00ZVV'.
      ...
      * Called module names
       01  MOD-ZRE01DOT              PIC X(8) VALUE 'ZRE01DOT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01DOT-001.
               CALL 'ZRE01DOT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01DOT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
