      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00VMJ'.
      ...
      * Called module names
       01  MOD-ZRE01OWF              PIC X(8) VALUE 'ZRE01OWF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01OWF-001.
               CALL 'ZRE01OWF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01OWF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
