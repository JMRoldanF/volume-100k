      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE000VL'.
      ...
      * Called module names
       ...
       01  MOD-ZRE00F2Z              PIC X(8) VALUE 'ZRE00F2Z'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE008J5-001.
               PERFORM CALL-ZRE00F2Z-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE00F2Z-002.
               EXEC CICS LINK PROGRAM('ZRE00F2Z')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00F2Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
