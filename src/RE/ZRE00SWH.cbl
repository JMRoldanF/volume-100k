      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00SWH'.
      ...
      * Called module names
       01  MOD-ZRE01L0Z              PIC X(8) VALUE 'ZRE01L0Z'.
       01  MOD-ZRE01STJ              PIC X(8) VALUE 'ZRE01STJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01L0Z-001.
               PERFORM CALL-ZRE01STJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01L0Z-001.
               CALL 'ZRE01L0Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01L0Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01STJ-002.
               CALL 'ZRE01STJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01STJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
