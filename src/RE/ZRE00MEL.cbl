      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00MEL'.
      ...
      * Called module names
       01  MOD-ZRE01FJR              PIC X(8) VALUE 'ZRE01FJR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01FJR-001.
               CALL 'ZRE01FJR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01FJR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
