      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00TYH'.
      ...
      * Called module names
       01  MOD-ZRE01R8R              PIC X(8) VALUE 'ZRE01R8R'.
       01  MOD-ZRE01F0P              PIC X(8) VALUE 'ZRE01F0P'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01R8R-001.
               PERFORM CALL-ZRE01F0P-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01R8R-001.
               CALL 'ZRE01R8R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01R8R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01F0P-002.
               CALL 'ZRE01F0P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01F0P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
