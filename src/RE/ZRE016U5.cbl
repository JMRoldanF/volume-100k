      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE016U5'.
      ...
      * Called module names
       01  MOD-ZRE01N7V              PIC X(8) VALUE 'ZRE01N7V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01N7V-001.
               CALL 'ZRE01N7V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01N7V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
