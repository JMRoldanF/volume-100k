      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00URF'.
      ...
      * Called module names
       01  MOD-ZRE01QKP              PIC X(8) VALUE 'ZRE01QKP'.
       01  MOD-ZRE01KL5              PIC X(8) VALUE 'ZRE01KL5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01QKP-001.
               PERFORM CALL-ZRE01KL5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01QKP-001.
               CALL 'ZRE01QKP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01QKP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01KL5-002.
               CALL 'ZRE01KL5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01KL5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-POSTCODE-0001.
