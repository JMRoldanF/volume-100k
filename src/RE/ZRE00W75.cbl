      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00W75'.
      ...
      * Called module names
       01  MOD-ZRE01NLA              PIC X(8) VALUE 'ZRE01NLA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01NLA-001.
               PERFORM CALL-ZRE01JE0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01NLA-001.
               CALL 'ZRE01NLA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01NLA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01JE0-002.
