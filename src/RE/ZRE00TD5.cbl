      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00TD5'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01SFY              PIC X(8) VALUE 'ZAG01SFY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01KPB-001.
               PERFORM CALL-ZAG01SFY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01SFY-002.
               CALL 'ZAG01SFY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01SFY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
