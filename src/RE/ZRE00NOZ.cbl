      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00NOZ'.
      ...
      * Called module names
       01  MOD-ZCL01MBB              PIC X(8) VALUE 'ZCL01MBB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01MBB-001.
               CALL 'ZCL01MBB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01MBB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
