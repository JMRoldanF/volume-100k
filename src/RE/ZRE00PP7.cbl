      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00PP7'.
      ...
      * Called module names
       01  MOD-ZRE01EOD              PIC X(8) VALUE 'ZRE01EOD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01EOD-001.
               PERFORM CALL-ZRE01TLL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01EOD-001.
               CALL 'ZRE01EOD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01EOD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01TLL-002.
               MOVE 'ZRE01TLL' TO WS-SUBNAME-8
