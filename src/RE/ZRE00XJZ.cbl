      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00XJZ'.
      ...
      * Called module names
       01  MOD-ZAG01DTA              PIC X(8) VALUE 'ZAG01DTA'.
       01  MOD-ZRE01GRX              PIC X(8) VALUE 'ZRE01GRX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01DTA-001.
               PERFORM CALL-ZRE01GRX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01DTA-001.
               CALL 'ZAG01DTA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01DTA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01GRX-002.
               CALL 'ZRE01GRX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01GRX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
