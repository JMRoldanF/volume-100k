      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE0142Z'.
      ...
      * Called module names
       01  MOD-ZRE01MGX              PIC X(8) VALUE 'ZRE01MGX'.
       01  MOD-ZHO01F7E              PIC X(8) VALUE 'ZHO01F7E'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01MGX-001.
               PERFORM CALL-ZHO01F7E-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01MGX-001.
               CALL 'ZRE01MGX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01MGX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01F7E-002.
               CALL 'ZHO01F7E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01F7E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
