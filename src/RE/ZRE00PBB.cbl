      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00PBB'.
      ...
      * Called module names
       01  MOD-ZRE01LB9              PIC X(8) VALUE 'ZRE01LB9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01LB9-001.
               CALL 'ZRE01LB9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01LB9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-EQUITIES-0001.
