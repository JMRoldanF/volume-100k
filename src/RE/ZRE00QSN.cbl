      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00QSN'.
      ...
      * Called module names
       01  MOD-ZRE01Q87              PIC X(8) VALUE 'ZRE01Q87'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01Q87-001.
               CALL 'ZRE01Q87' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01Q87 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
