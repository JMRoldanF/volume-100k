      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00P1L'.
      ...
      * Called module names
       01  MOD-ZHO01D3K              PIC X(8) VALUE 'ZHO01D3K'.
       01  MOD-ZRE01R3B              PIC X(8) VALUE 'ZRE01R3B'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01D3K-001.
               CALL 'ZHO01D3K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01D3K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01R3B-002.
               CALL 'ZRE01R3B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
