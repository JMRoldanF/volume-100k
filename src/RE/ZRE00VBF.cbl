      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00VBF'.
      ...
      * Called module names
       01  MOD-ZRE01S0D              PIC X(8) VALUE 'ZRE01S0D'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01S0D-001.
               CALL 'ZRE01S0D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01S0D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
