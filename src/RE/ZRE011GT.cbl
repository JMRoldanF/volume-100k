      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE011GT'.
      ...
      * Called module names
       01  MOD-ZRE01I8F              PIC X(8) VALUE 'ZRE01I8F'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01I8F-001.
               PERFORM CALL-ZMT01GAT-002.
               PERFORM CALL-ZAG0255S-003.
               PERFORM EXPAND-AGENT-CODE-0001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZRE01I8F-001.
               CALL 'ZRE01I8F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01I8F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01GAT-002.
