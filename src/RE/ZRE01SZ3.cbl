      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01SZ3'.
      ...
      * Called module names
       01  MOD-ZRE01MD1              PIC X(8) VALUE 'ZRE01MD1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01MD1-001.
               CALL 'ZRE01MD1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01MD1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
