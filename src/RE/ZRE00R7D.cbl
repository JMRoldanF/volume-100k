      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00R7D'.
      ...
      * Called module names
       01  MOD-ZRE01F4R              PIC X(8) VALUE 'ZRE01F4R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01F4R-001.
               CALL 'ZRE01F4R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01F4R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
