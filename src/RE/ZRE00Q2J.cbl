      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00Q2J'.
      ...
      * Called module names
       01  MOD-ZRE01TGV              PIC X(8) VALUE 'ZRE01TGV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01TGV-001.
               CALL 'ZRE01TGV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01TGV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
