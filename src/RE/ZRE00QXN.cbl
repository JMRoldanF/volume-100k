      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00QXN'.
      ...
      * Called module names
       01  MOD-ZRE01GTL              PIC X(8) VALUE 'ZRE01GTL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01GTL-001.
               CALL 'ZRE01GTL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01GTL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
