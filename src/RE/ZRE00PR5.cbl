      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00PR5'.
      ...
      * Called module names
       01  MOD-ZRE01FFL              PIC X(8) VALUE 'ZRE01FFL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01FFL-001.
               CALL 'ZRE01FFL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01FFL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
