      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00UBL'.
      ...
      * Called module names
       01  MOD-ZRE01K0V              PIC X(8) VALUE 'ZRE01K0V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01K0V-001.
               CALL 'ZRE01K0V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01K0V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
