      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE012FT'.
      ...
      * Called module names
       01  MOD-ZUW01LWG              PIC X(8) VALUE 'ZUW01LWG'.
       01  MOD-ZBI01UR8              PIC X(8) VALUE 'ZBI01UR8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01LWG-001.
               PERFORM CALL-ZBI01UR8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01LWG-001.
               CALL 'ZUW01LWG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01LWG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01UR8-002.
               CALL 'ZBI01UR8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01UR8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
