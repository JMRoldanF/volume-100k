      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00WZ1'.
      ...
      * Called module names
       01  MOD-ZRE01IC9              PIC X(8) VALUE 'ZRE01IC9'.
       01  MOD-ZSU01DFA              PIC X(8) VALUE 'ZSU01DFA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01IC9-001.
               PERFORM CALL-ZSU01DFA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01IC9-001.
               CALL 'ZRE01IC9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01IC9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSU01DFA-002.
               CALL 'ZSU01DFA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01DFA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-BEDROOMS-0001.
