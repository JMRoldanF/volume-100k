      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00MKZ'.
      ...
      * Called module names
       01  MOD-ZRE01HMR              PIC X(8) VALUE 'ZRE01HMR'.
       01  MOD-ZPA01RFV              PIC X(8) VALUE 'ZPA01RFV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01HMR-001.
               PERFORM CALL-ZPA01RFV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01HMR-001.
               CALL 'ZRE01HMR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01HMR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01RFV-002.
               CALL 'ZPA01RFV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01RFV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
