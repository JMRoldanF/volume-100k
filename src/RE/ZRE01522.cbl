      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01522'.
      ...
      * Called module names
       01  MOD-ZRE01SOB              PIC X(8) VALUE 'ZRE01SOB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01SOB-002.
               CALL 'ZRE01SOB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
