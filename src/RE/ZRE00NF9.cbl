      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00NF9'.
      ...
      * Called module names
       01  MOD-ZRE01PF1              PIC X(8) VALUE 'ZRE01PF1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01PF1-001.
               CALL 'ZRE01PF1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01PF1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-COLOUR-0001.
