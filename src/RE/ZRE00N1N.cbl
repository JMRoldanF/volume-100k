      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00N1N'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01ST9              PIC X(8) VALUE 'ZRE01ST9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01ST9-002.
               CALL 'ZRE01ST9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01ST9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
