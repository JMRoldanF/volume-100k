      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00U9D'.
      ...
      * Called module names
       01  MOD-ZRE01T4N              PIC X(8) VALUE 'ZRE01T4N'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01T4N-001.
               CALL 'ZRE01T4N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01T4N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
