      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00T7I'.
      ...
      * Called module names
       01  MOD-ZRE01TR6              PIC X(8) VALUE 'ZRE01TR6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01TR6-002.
               CALL 'ZRE01TR6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
