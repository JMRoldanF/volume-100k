      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00Y5M'.
      ...
      * Called module names
       01  MOD-ZRE01P9L              PIC X(8) VALUE 'ZRE01P9L'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01P9L-001.
               CALL 'ZRE01P9L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01P9L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-EXCESS-0001.
