      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00Y2L'.
      ...
      * Called module names
       01  MOD-ZRE01LKF              PIC X(8) VALUE 'ZRE01LKF'.
       01  MOD-ZRE01LXH              PIC X(8) VALUE 'ZRE01LXH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01LKF-001.
               PERFORM CALL-ZRE01LXH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01LKF-001.
               CALL 'ZRE01LKF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01LKF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01LXH-002.
               CALL 'ZRE01LXH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01LXH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
