      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE010XX'.
      ...
      * Called module names
       01  MOD-ZHO01NVM              PIC X(8) VALUE 'ZHO01NVM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01NVM-001.
               CALL 'ZHO01NVM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01NVM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01H8B-002.
