      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00QMH'.
      ...
      * Called module names
       01  MOD-ZRE01DE5              PIC X(8) VALUE 'ZRE01DE5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01DE5-001.
               CALL 'ZRE01DE5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01DE5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
