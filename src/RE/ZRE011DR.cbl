      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE011DR'.
      ...
      * Called module names
       01  MOD-ZRE01SRV              PIC X(8) VALUE 'ZRE01SRV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01SRV-001.
               CALL 'ZRE01SRV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01SRV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
