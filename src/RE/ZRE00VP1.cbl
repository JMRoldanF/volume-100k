      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00VP1'.
      ...
      * Called module names
       01  MOD-ZRE01G5Z              PIC X(8) VALUE 'ZRE01G5Z'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01G5Z-001.
               PERFORM CALL-ZPA01LMZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01G5Z-001.
               CALL 'ZRE01G5Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01G5Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01LMZ-002.
