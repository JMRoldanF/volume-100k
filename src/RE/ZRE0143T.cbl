      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE0143T'.
      ...
      * Called module names
       01  MOD-ZRE01DAN              PIC X(8) VALUE 'ZRE01DAN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01DAN-001.
               CALL 'ZRE01DAN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01DAN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
