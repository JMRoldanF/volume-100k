      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00ZZR'.
      ...
      * Called module names
       01  MOD-ZRE01MZJ              PIC X(8) VALUE 'ZRE01MZJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01MZJ-001.
               PERFORM CALL-ZEN01I45-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01MZJ-001.
               CALL 'ZRE01MZJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01MZJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01I45-002.
               MOVE 'ZEN01I45' TO WS-SUBNAME-2
