      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01HXV'.
      ...
      * Called module names
       01  MOD-ZAG01JIA              PIC X(8) VALUE 'ZAG01JIA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01JIA-001.
               CALL 'ZAG01JIA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01JIA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
