      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE016MS'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01GDJ              PIC X(8) VALUE 'ZRE01GDJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01RCK-001.
               PERFORM CALL-ZRE01GDJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01GDJ-002.
               CALL 'ZRE01GDJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01GDJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       VALIDATE-TERM-0001.
