      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00Y1H'.
      ...
      * Called module names
       01  MOD-ZMT01HD5              PIC X(8) VALUE 'ZMT01HD5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01RTF-002.
               PERFORM CALL-ZAG0255S-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZMT01HD5-001.
               CALL 'ZMT01HD5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
