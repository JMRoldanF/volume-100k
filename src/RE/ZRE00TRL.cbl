      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00TRL'.
      ...
      * Called module names
       01  MOD-ZCL01R5R              PIC X(8) VALUE 'ZCL01R5R'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01R5R-001.
               PERFORM CALL-ZRE01U7T-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01R5R-001.
               CALL 'ZCL01R5R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
