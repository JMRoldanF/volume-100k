      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00XM7'.
      ...
      * Called module names
       01  MOD-ZRE01UAL              PIC X(8) VALUE 'ZRE01UAL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01UAL-001.
               CALL 'ZRE01UAL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01UAL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
