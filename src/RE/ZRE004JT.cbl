      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE004JT'.
      ...
      * Called module names
       01  MOD-ZRE00EX5              PIC X(8) VALUE 'ZRE00EX5'.
       01  MOD-ZRE00D77              PIC X(8) VALUE 'ZRE00D77'.
       01  MOD-ZEN000YJ              PIC X(8) VALUE 'ZEN000YJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE00EX5-001.
               PERFORM CALL-ZRE00D77-002.
               PERFORM CALL-ZEN000YJ-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE00EX5-001.
               EXEC CICS LINK PROGRAM('ZRE00EX5')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00EX5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE00D77-002.
               EXEC CICS LINK PROGRAM('ZRE00D77')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00D77 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN000YJ-003.
               EXEC CICS XCTL PROGRAM('ZEN000YJ')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN000YJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-004.
