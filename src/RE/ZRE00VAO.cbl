      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00VAO'.
      ...
      * Called module names
       01  MOD-ZRE01CVA              PIC X(8) VALUE 'ZRE01CVA'.
       01  MOD-ZRE01IRT              PIC X(8) VALUE 'ZRE01IRT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01CVA-001.
               PERFORM CALL-ZRE01IRT-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01CVA-001.
               CALL 'ZRE01CVA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01CVA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01IRT-002.
               CALL 'ZRE01IRT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01IRT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
