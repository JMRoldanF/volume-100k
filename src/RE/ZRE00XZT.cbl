      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00XZT'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01MVD              PIC X(8) VALUE 'ZRE01MVD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01LJL-001.
               PERFORM CALL-ZRE01MVD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01MVD-002.
               CALL 'ZRE01MVD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01MVD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-MAKE-0001.
