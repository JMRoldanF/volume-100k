      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00LOY'.
      ...
      * Called module names
       01  MOD-ZRE01D33              PIC X(8) VALUE 'ZRE01D33'.
       01  MOD-ZRE01LXE              PIC X(8) VALUE 'ZRE01LXE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01D33-001.
               PERFORM CALL-ZRE01LXE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01D33-001.
               CALL 'ZRE01D33' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01D33 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01LXE-002.
               CALL 'ZRE01LXE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01LXE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
