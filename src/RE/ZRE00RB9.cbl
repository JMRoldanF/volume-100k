      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00RB9'.
      ...
      * Called module names
       01  MOD-ZRE01FS3              PIC X(8) VALUE 'ZRE01FS3'.
       01  MOD-ZRE01E9N              PIC X(8) VALUE 'ZRE01E9N'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01FS3-001.
               PERFORM CALL-ZRE01E9N-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01FS3-001.
               CALL 'ZRE01FS3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01FS3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01E9N-002.
               CALL 'ZRE01E9N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01E9N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
