      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00WZZ'.
      ...
      * Called module names
       01  MOD-ZPA01QH5              PIC X(8) VALUE 'ZPA01QH5'.
       01  MOD-ZRE01RQD              PIC X(8) VALUE 'ZRE01RQD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01QH5-001.
               PERFORM CALL-ZRE01RQD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01QH5-001.
               CALL 'ZPA01QH5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01QH5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01RQD-002.
               CALL 'ZRE01RQD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01RQD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
