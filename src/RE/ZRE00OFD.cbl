      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00OFD'.
      ...
      * Called module names
       01  MOD-ZRE01RE5              PIC X(8) VALUE 'ZRE01RE5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01RE5-001.
               CALL 'ZRE01RE5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01RE5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
