      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE010VP'.
      ...
      * Called module names
       01  MOD-ZRE01FP1              PIC X(8) VALUE 'ZRE01FP1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01FP1-001.
               CALL 'ZRE01FP1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01FP1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
