      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE018VH'.
      ...
      * Called module names
       01  MOD-ZRE01QRD              PIC X(8) VALUE 'ZRE01QRD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01QRD-001.
               PERFORM CALL-ZRE01PZV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01QRD-001.
               CALL 'ZRE01QRD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01QRD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01PZV-002.
