      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00TNZ'.
      ...
      * Called module names
       01  MOD-ZRE01R7R              PIC X(8) VALUE 'ZRE01R7R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01R7R-001.
               CALL 'ZRE01R7R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01R7R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       VALIDATE-MODEL-0001.
