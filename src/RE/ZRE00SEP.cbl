      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00SEP'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01KLZ              PIC X(8) VALUE 'ZRE01KLZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01U4H-001.
               PERFORM CALL-ZRE01KLZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01KLZ-002.
               CALL 'ZRE01KLZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01KLZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
