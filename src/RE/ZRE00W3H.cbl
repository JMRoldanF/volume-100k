      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00W3H'.
      ...
      * Called module names
       01  MOD-ZRE01KPL              PIC X(8) VALUE 'ZRE01KPL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01KPL-001.
               CALL 'ZRE01KPL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01KPL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
