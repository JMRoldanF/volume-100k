      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00S45'.
      ...
      * Called module names
       01  MOD-ZRE01KWJ              PIC X(8) VALUE 'ZRE01KWJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01O39-001.
               PERFORM CALL-ZRE01KWJ-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZRE01O39-001.
               MOVE 'ZRE01O39' TO WS-SUBNAME-6
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01KWJ-002.
               CALL 'ZRE01KWJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01KWJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       WRITE-ERROR-MESSAGE.
