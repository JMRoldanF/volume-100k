      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE0126X'.
      ...
      * Called module names
       01  MOD-ZRE01NNZ              PIC X(8) VALUE 'ZRE01NNZ'.
       01  MOD-ZRE01IWV              PIC X(8) VALUE 'ZRE01IWV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01NNZ-001.
               PERFORM CALL-ZRE01IWV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01NNZ-001.
               CALL 'ZRE01NNZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01NNZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01IWV-002.
               CALL 'ZRE01IWV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01IWV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
