      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01CLO'.
      ...
      * Called module names
       01  MOD-ZRE01QHH              PIC X(8) VALUE 'ZRE01QHH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01QHH-001.
               PERFORM CALL-ZRE01UL3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01QHH-001.
               CALL 'ZRE01QHH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01QHH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01UL3-002.
