      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00YKX'.
      ...
      * Called module names
       01  MOD-ZRE01GFP              PIC X(8) VALUE 'ZRE01GFP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01GFP-001.
               CALL 'ZRE01GFP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01GFP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
