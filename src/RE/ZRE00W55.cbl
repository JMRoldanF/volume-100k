      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00W55'.
      ...
      * Called module names
       01  MOD-ZRE01DWB              PIC X(8) VALUE 'ZRE01DWB'.
       01  MOD-ZRE01NCL              PIC X(8) VALUE 'ZRE01NCL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01DWB-001.
               PERFORM CALL-ZRE01NCL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01DWB-001.
               CALL 'ZRE01DWB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01DWB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01NCL-002.
               CALL 'ZRE01NCL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01NCL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
