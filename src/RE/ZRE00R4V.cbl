      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00R4V'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01R9F              PIC X(8) VALUE 'ZRE01R9F'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01UR9-001.
               PERFORM CALL-ZRE01R9F-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01R9F-002.
               CALL 'ZRE01R9F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01R9F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
