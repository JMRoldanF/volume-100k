      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00T2L'.
      ...
      * Called module names
       01  MOD-ZRE01QCN              PIC X(8) VALUE 'ZRE01QCN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01QCN-001.
               CALL 'ZRE01QCN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01QCN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
