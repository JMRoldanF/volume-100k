      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00XUT'.
      ...
      * Called module names
       01  MOD-ZRE01M3B              PIC X(8) VALUE 'ZRE01M3B'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01M3B-001.
               CALL 'ZRE01M3B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01M3B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01R9F-002.
