      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00TJC'.
      ...
      * Called module names
       01  MOD-ZRE01NUL              PIC X(8) VALUE 'ZRE01NUL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01NUL-001.
               CALL 'ZRE01NUL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01NUL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
