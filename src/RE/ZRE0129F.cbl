      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE0129F'.
      ...
      * Called module names
       01  MOD-ZRE01IXP              PIC X(8) VALUE 'ZRE01IXP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01IXP-001.
               PERFORM CALL-ZEN01MFP-002.
               PERFORM CALL-ZMT0255L-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZRE01IXP-001.
               CALL 'ZRE01IXP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01IXP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01MFP-002.
