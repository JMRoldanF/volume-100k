      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00V2J'.
      ...
      * Called module names
       01  MOD-ZRE01THZ              PIC X(8) VALUE 'ZRE01THZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01THZ-001.
               PERFORM CALL-ZRE01KH9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01THZ-001.
               CALL 'ZRE01THZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01THZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01KH9-002.
