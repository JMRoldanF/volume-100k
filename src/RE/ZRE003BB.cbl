      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE003BB'.
      ...
      * Called module names
       ...
       01  MOD-ZRE00C49              PIC X(8) VALUE 'ZRE00C49'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMB00K87-001.
               PERFORM CALL-ZRE00JLT-002.
               PERFORM CALL-ZRE00C49-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE00JLT-002.
               MOVE 'ZRE00JLT' TO WS-PROGNAME-1
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00JLT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE00C49-003.
               EXEC CICS LINK PROGRAM('ZRE00C49')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00C49 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-004.
