      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01NET'.
      ...
      * Called module names
       01  MOD-ZEN01GFV              PIC X(8) VALUE 'ZEN01GFV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01GFV-001.
               CALL 'ZEN01GFV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01GFV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-EXCESS-0001.
