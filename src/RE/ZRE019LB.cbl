      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE019LB'.
      ...
      * Called module names
       01  MOD-ZRE01LHX              PIC X(8) VALUE 'ZRE01LHX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01LHX-001.
               CALL 'ZRE01LHX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01LHX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
