      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00REZ'.
      ...
      * Called module names
       01  MOD-ZRE01IT1              PIC X(8) VALUE 'ZRE01IT1'.
       01  MOD-ZRE01UAC              PIC X(8) VALUE 'ZRE01UAC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01IT1-001.
               PERFORM CALL-ZRE01UAC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01IT1-001.
               CALL 'ZRE01IT1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01IT1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01UAC-002.
               CALL 'ZRE01UAC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01UAC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
