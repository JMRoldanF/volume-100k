      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00US9'.
      ...
      * Called module names
       01  MOD-ZRE01UWT              PIC X(8) VALUE 'ZRE01UWT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01UWT-001.
               CALL 'ZRE01UWT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01UWT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
