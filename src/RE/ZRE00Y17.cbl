      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00Y17'.
      ...
      * Called module names
       01  MOD-ZRE01T9N              PIC X(8) VALUE 'ZRE01T9N'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01T9N-001.
               CALL 'ZRE01T9N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01T9N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
