      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00V7J'.
      ...
      * Called module names
       01  MOD-ZRE01FDX              PIC X(8) VALUE 'ZRE01FDX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01FDX-001.
               CALL 'ZRE01FDX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01FDX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
