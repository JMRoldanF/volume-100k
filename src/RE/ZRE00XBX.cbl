      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00XBX'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01OXJ              PIC X(8) VALUE 'ZRE01OXJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01T5R-001.
               PERFORM CALL-ZRE01OXJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01OXJ-002.
               CALL 'ZRE01OXJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01OXJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
