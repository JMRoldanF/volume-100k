      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00NNB'.
      ...
      * Called module names
       01  MOD-ZRE01OS9              PIC X(8) VALUE 'ZRE01OS9'.
       01  MOD-ZMT01GEF              PIC X(8) VALUE 'ZMT01GEF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01OS9-001.
               PERFORM CALL-ZMT01GEF-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01OS9-001.
               CALL 'ZRE01OS9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01OS9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01GEF-002.
               CALL 'ZMT01GEF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01GEF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
