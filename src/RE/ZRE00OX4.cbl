      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00OX4'.
      ...
      * Called module names
       01  MOD-ZRE01TYI              PIC X(8) VALUE 'ZRE01TYI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01TYI-001.
               CALL 'ZRE01TYI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01TYI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
