      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00DWQ'.
      ...
      * Called module names
       01  MOD-ZRE00Z6S              PIC X(8) VALUE 'ZRE00Z6S'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE00Z6S-001.
               EXEC CICS LINK PROGRAM('ZRE00Z6S')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00Z6S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
