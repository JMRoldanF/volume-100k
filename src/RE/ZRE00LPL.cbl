      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00LPL'.
      ...
      * Called module names
       01  MOD-ZRE01FXD              PIC X(8) VALUE 'ZRE01FXD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01FXD-001.
               PERFORM CALL-ZBI01FKU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01FXD-001.
               CALL 'ZRE01FXD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01FXD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01FKU-002.
