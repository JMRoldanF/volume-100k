      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00V33'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01M6N              PIC X(8) VALUE 'ZRE01M6N'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01IDP-001.
               PERFORM CALL-ZRE01M6N-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01M6N-002.
               CALL 'ZRE01M6N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01M6N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
