      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00MPP'.
      ...
      * Called module names
       01  MOD-ZRE01I0N              PIC X(8) VALUE 'ZRE01I0N'.
       01  MOD-ZRE01FDN              PIC X(8) VALUE 'ZRE01FDN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01I0N-001.
               PERFORM CALL-ZRE01FDN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01I0N-001.
               CALL 'ZRE01I0N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01I0N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01FDN-002.
               CALL 'ZRE01FDN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01FDN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
