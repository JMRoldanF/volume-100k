      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00MGW'.
      ...
      * Called module names
       01  MOD-ZRE01SNR              PIC X(8) VALUE 'ZRE01SNR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01SNR-001.
               CALL 'ZRE01SNR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01SNR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
