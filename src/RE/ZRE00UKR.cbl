      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00UKR'.
      ...
      * Called module names
       01  MOD-ZRE01R3L              PIC X(8) VALUE 'ZRE01R3L'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01R3L-001.
               CALL 'ZRE01R3L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01R3L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
