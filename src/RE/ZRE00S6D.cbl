      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00S6D'.
      ...
      * Called module names
       01  MOD-ZRE01PZV              PIC X(8) VALUE 'ZRE01PZV'.
       01  MOD-ZRE01K2J              PIC X(8) VALUE 'ZRE01K2J'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01PZV-001.
               PERFORM CALL-ZRE01K2J-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01PZV-001.
               CALL 'ZRE01PZV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01PZV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01K2J-002.
               CALL 'ZRE01K2J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01K2J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
