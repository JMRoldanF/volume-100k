      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00SXB'.
      ...
      * Called module names
       01  MOD-ZRE01IG7              PIC X(8) VALUE 'ZRE01IG7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01IG7-001.
               CALL 'ZRE01IG7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01IG7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
