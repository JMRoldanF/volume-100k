      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00V65'.
      ...
      * Called module names
       01  MOD-ZRE01HM7              PIC X(8) VALUE 'ZRE01HM7'.
       01  MOD-ZRE01FJ7              PIC X(8) VALUE 'ZRE01FJ7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01HM7-001.
               CALL 'ZRE01HM7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01FJ7-002.
               CALL 'ZRE01FJ7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01FJ7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
