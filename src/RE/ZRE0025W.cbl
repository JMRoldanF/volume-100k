      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE0025W'.
      ...
      * Called module names
       01  MOD-ZRE00AMX              PIC X(8) VALUE 'ZRE00AMX'.
       01  MOD-ZRE00KK6              PIC X(8) VALUE 'ZRE00KK6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE00AMX-001.
               PERFORM CALL-ZRE00KK6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE00AMX-001.
               EXEC CICS LINK PROGRAM('ZRE00AMX')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00AMX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE00KK6-002.
               EXEC CICS LINK PROGRAM('ZRE00KK6')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00KK6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
