      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00ZIT'.
      ...
      * Called module names
       01  MOD-ZRE01HB3              PIC X(8) VALUE 'ZRE01HB3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01HB3-001.
               CALL 'ZRE01HB3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01HB3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
