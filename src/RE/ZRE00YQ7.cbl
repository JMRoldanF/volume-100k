      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00YQ7'.
      ...
      * Called module names
       01  MOD-ZRE01LOB              PIC X(8) VALUE 'ZRE01LOB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01LOB-001.
               CALL 'ZRE01LOB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01LOB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-TERM-0001.
