      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00TSP'.
      ...
      * Called module names
       01  MOD-ZRE01D9J              PIC X(8) VALUE 'ZRE01D9J'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01D9J-001.
               CALL 'ZRE01D9J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01D9J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-MAKE-0001.
