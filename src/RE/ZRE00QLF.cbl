      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00QLF'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01RTZ              PIC X(8) VALUE 'ZRE01RTZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01RTZ-002.
               CALL 'ZRE01RTZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01RTZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
