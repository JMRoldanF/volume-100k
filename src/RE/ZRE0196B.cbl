      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE0196B'.
      ...
      * Called module names
       01  MOD-ZRE01JLV              PIC X(8) VALUE 'ZRE01JLV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01JLV-001.
               CALL 'ZRE01JLV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01JLV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
