      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00OL7'.
      ...
      * Called module names
       01  MOD-ZRE01HAJ              PIC X(8) VALUE 'ZRE01HAJ'.
       01  MOD-ZRE01KQP              PIC X(8) VALUE 'ZRE01KQP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01HAJ-001.
               PERFORM CALL-ZRE01KQP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01HAJ-001.
               CALL 'ZRE01HAJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01HAJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01KQP-002.
               CALL 'ZRE01KQP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01KQP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
