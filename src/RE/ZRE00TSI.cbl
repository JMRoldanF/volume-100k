      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00TSI'.
      ...
      * Called module names
       01  MOD-ZRE01G47              PIC X(8) VALUE 'ZRE01G47'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01G47-001.
               CALL 'ZRE01G47' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01G47 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
