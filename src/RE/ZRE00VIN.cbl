      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00VIN'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01JV1              PIC X(8) VALUE 'ZRE01JV1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01S0F-001.
               PERFORM CALL-ZRE01JV1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01JV1-002.
               CALL 'ZRE01JV1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01JV1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
