      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE011LJ'.
      ...
      * Called module names
       01  MOD-ZRE01G05              PIC X(8) VALUE 'ZRE01G05'.
       01  MOD-ZRE01NPN              PIC X(8) VALUE 'ZRE01NPN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01G05-001.
               PERFORM CALL-ZRE01NPN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01G05-001.
               CALL 'ZRE01G05' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01NPN-002.
               CALL 'ZRE01NPN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01NPN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
