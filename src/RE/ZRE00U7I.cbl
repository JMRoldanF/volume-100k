      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00U7I'.
      ...
      * Called module names
       01  MOD-ZRE01GCT              PIC X(8) VALUE 'ZRE01GCT'.
       01  MOD-ZRE01OMQ              PIC X(8) VALUE 'ZRE01OMQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01GCT-001.
               PERFORM CALL-ZRE01OMQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01GCT-001.
               CALL 'ZRE01GCT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01GCT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01OMQ-002.
               CALL 'ZRE01OMQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01OMQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
