      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00VFV'.
      ...
      * Called module names
       01  MOD-ZRE01G6T              PIC X(8) VALUE 'ZRE01G6T'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01G6T-001.
               CALL 'ZRE01G6T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01G6T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
