      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01CCR'.
      ...
      * Called module names
       01  MOD-ZRE01HFJ              PIC X(8) VALUE 'ZRE01HFJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01HFJ-002.
               CALL 'ZRE01HFJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01HFJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
