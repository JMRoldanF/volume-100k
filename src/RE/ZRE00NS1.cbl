      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00NS1'.
      ...
      * Called module names
       01  MOD-ZRE01TAR              PIC X(8) VALUE 'ZRE01TAR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01TAR-001.
               CALL 'ZRE01TAR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01TAR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
