      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00WI7'.
      ...
      * Called module names
       01  MOD-ZRE01OYN              PIC X(8) VALUE 'ZRE01OYN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01OYN-001.
               PERFORM CALL-ZAG01JOO-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01OYN-001.
               CALL 'ZRE01OYN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01OYN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01JOO-002.
