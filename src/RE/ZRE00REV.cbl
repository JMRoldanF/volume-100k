      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00REV'.
      ...
      * Called module names
       01  MOD-ZRE01HG3              PIC X(8) VALUE 'ZRE01HG3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01HG3-001.
               CALL 'ZRE01HG3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01HG3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-TERM-0001.
