      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE000U7'.
      ...
      * Called module names
       01  MOD-ZCU00H20              PIC X(8) VALUE 'ZCU00H20'.
       01  MOD-ZRE00H7N              PIC X(8) VALUE 'ZRE00H7N'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU00A4A-001.
               PERFORM CALL-ZCU00H20-002.
               PERFORM CALL-ZRE00FLB-003.
               PERFORM CALL-ZRE00H7N-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU00A4A-001.
               MOVE 'ZCU00A4A' TO WS-PROGNAME-1
      ...
      *----------------------------------------------------------------*
       CALL-ZCU00H20-002.
               EXEC CICS LINK PROGRAM('ZCU00H20')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00H20 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE00FLB-003.
               MOVE 'ZRE00FLB' TO WS-PROGNAME-2
      ...
      *----------------------------------------------------------------*
       CALL-ZRE00H7N-004.
               EXEC CICS LINK PROGRAM('ZRE00H7N')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
