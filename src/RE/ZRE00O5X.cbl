      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00O5X'.
      ...
      * Called module names
       01  MOD-ZRE01N3P              PIC X(8) VALUE 'ZRE01N3P'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01N3P-001.
               CALL 'ZRE01N3P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01N3P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
