      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00T3F'.
      ...
      * Called module names
       01  MOD-ZRE01IEJ              PIC X(8) VALUE 'ZRE01IEJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01IEJ-001.
               CALL 'ZRE01IEJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01IEJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
