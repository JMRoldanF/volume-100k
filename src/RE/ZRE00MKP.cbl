      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00MKP'.
      ...
      * Called module names
       01  MOD-ZRE01H3L              PIC X(8) VALUE 'ZRE01H3L'.
       01  MOD-ZRE01L9V              PIC X(8) VALUE 'ZRE01L9V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01H3L-001.
               CALL 'ZRE01H3L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01H3L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01L9V-002.
               CALL 'ZRE01L9V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01L9V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
