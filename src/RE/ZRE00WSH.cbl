      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00WSH'.
      ...
      * Called module names
       01  MOD-ZRE01JBB              PIC X(8) VALUE 'ZRE01JBB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01JBB-001.
               CALL 'ZRE01JBB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01JBB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01FEH-002.
