      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00UPJ'.
      ...
      * Called module names
       01  MOD-ZRE01ELQ              PIC X(8) VALUE 'ZRE01ELQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01ELQ-001.
               PERFORM DERIVE-TERM-0001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZRE01ELQ-001.
               CALL 'ZRE01ELQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
