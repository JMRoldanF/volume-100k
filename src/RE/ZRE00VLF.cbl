      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00VLF'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01KS3              PIC X(8) VALUE 'ZRE01KS3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01KS3-002.
               CALL 'ZRE01KS3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01KS3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
