      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00RLT'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01H6N              PIC X(8) VALUE 'ZRE01H6N'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01I2B-001.
               PERFORM CALL-ZRE01H6N-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01H6N-002.
               CALL 'ZRE01H6N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01H6N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
