      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00M4V'.
      ...
      * Called module names
       01  MOD-ZRE01J9D              PIC X(8) VALUE 'ZRE01J9D'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01J9D-001.
               CALL 'ZRE01J9D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01J9D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
