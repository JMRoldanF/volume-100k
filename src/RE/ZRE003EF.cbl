      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE003EF'.
      ...
      * Called module names
       01  MOD-ZRE00KEN              PIC X(8) VALUE 'ZRE00KEN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE00KEN-001.
               PERFORM CALL-ZRE009BH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE00KEN-001.
               EXEC CICS LINK PROGRAM('ZRE00KEN')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00KEN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE009BH-002.
