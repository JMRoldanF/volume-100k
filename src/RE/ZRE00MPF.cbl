      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00MPF'.
      ...
      * Called module names
       01  MOD-ZRE01I5N              PIC X(8) VALUE 'ZRE01I5N'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01I5N-001.
               CALL 'ZRE01I5N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01I5N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
