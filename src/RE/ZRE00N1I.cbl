      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00N1I'.
      ...
      * Called module names
       01  MOD-ZRE01UEP              PIC X(8) VALUE 'ZRE01UEP'.
       01  MOD-ZRE01H8N              PIC X(8) VALUE 'ZRE01H8N'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01UEP-001.
               PERFORM CALL-ZRE01H8N-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01UEP-001.
               CALL 'ZRE01UEP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01UEP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01H8N-002.
               CALL 'ZRE01H8N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01H8N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
