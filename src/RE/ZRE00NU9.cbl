      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00NU9'.
      ...
      * Called module names
       01  MOD-ZRE01L6T              PIC X(8) VALUE 'ZRE01L6T'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01L6T-001.
               CALL 'ZRE01L6T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01L6T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
