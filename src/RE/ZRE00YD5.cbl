      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00YD5'.
      ...
      * Called module names
       01  MOD-ZRE01Q0Z              PIC X(8) VALUE 'ZRE01Q0Z'.
       01  MOD-ZRE01DET              PIC X(8) VALUE 'ZRE01DET'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01Q0Z-001.
               CALL 'ZRE01Q0Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01Q0Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01DET-002.
               CALL 'ZRE01DET' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01DET FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
