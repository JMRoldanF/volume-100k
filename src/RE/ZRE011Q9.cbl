      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE011Q9'.
      ...
      * Called module names
       01  MOD-ZRE01JZR              PIC X(8) VALUE 'ZRE01JZR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01JZR-001.
               CALL 'ZRE01JZR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01JZR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
