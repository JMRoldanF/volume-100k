      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE014CZ'.
      ...
      * Called module names
       01  MOD-ZRE01PIN              PIC X(8) VALUE 'ZRE01PIN'.
       01  MOD-ZRE01OLL              PIC X(8) VALUE 'ZRE01OLL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01PIN-001.
               PERFORM CALL-ZRE01OLL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01PIN-001.
               CALL 'ZRE01PIN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01PIN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01OLL-002.
               CALL 'ZRE01OLL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01OLL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
