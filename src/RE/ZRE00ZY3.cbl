      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00ZY3'.
      ...
      * Called module names
       01  MOD-ZMT01UIR              PIC X(8) VALUE 'ZMT01UIR'.
       01  MOD-ZRE01UQF              PIC X(8) VALUE 'ZRE01UQF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01UIR-001.
               CALL 'ZMT01UIR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01UIR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01UQF-002.
               CALL 'ZRE01UQF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01UQF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
