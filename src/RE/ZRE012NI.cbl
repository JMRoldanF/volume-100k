      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE012NI'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01RWI              PIC X(8) VALUE 'ZRE01RWI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01RWI-002.
               CALL 'ZRE01RWI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01RWI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
