      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00WTL'.
      ...
      * Called module names
       01  MOD-ZRE01M7R              PIC X(8) VALUE 'ZRE01M7R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01M7R-001.
               CALL 'ZRE01M7R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01M7R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
