      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00XJ5'.
      ...
      * Called module names
       01  MOD-ZRE01ISF              PIC X(8) VALUE 'ZRE01ISF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01ISF-001.
               CALL 'ZRE01ISF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01ISF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
