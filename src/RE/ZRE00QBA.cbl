      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00QBA'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01SR6              PIC X(8) VALUE 'ZRE01SR6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01FKR-001.
               PERFORM CALL-ZRE01SR6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01SR6-002.
               CALL 'ZRE01SR6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01SR6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
