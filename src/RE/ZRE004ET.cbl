      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE004ET'.
      ...
      * Called module names
       ...
       01  MOD-ZRE00L3D              PIC X(8) VALUE 'ZRE00L3D'.
       01  MOD-ZCL002R1              PIC X(8) VALUE 'ZCL002R1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE00KRF-001.
               PERFORM CALL-ZRE00L3D-002.
               PERFORM CALL-ZCL002R1-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE00L3D-002.
               EXEC CICS LINK PROGRAM('ZRE00L3D')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00L3D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL002R1-003.
               EXEC CICS XCTL PROGRAM('ZCL002R1')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL002R1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-004.
