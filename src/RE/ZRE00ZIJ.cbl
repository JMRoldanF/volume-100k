      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00ZIJ'.
      ...
      * Called module names
       01  MOD-ZRE01QPF              PIC X(8) VALUE 'ZRE01QPF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01QPF-001.
               PERFORM CALL-ZRE01SQH-002.
               PERFORM CALL-ZEN0255N-003.
               PERFORM CHECK-TERM-0001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZRE01QPF-001.
               CALL 'ZRE01QPF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01QPF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01SQH-002.
