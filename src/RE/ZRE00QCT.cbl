      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00QCT'.
      ...
      * Called module names
       01  MOD-ZRE01U97              PIC X(8) VALUE 'ZRE01U97'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01U97-001.
               CALL 'ZRE01U97' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01U97 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
