      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01UHL'.
      ...
      * Called module names
       01  MOD-ZRE01U17              PIC X(8) VALUE 'ZRE01U17'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01U17-001.
               CALL 'ZRE01U17' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01U17 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
