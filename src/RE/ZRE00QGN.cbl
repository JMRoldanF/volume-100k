      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00QGN'.
      ...
      * Called module names
       01  MOD-ZRE01L4U              PIC X(8) VALUE 'ZRE01L4U'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01GB3-001.
               PERFORM CALL-ZRE01L4U-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01L4U-002.
               CALL 'ZRE01L4U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01L4U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
