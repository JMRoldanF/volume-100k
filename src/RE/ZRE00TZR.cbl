      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00TZR'.
      ...
      * Called module names
       01  MOD-ZRE01RWM              PIC X(8) VALUE 'ZRE01RWM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01RWM-001.
               CALL 'ZRE01RWM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01RWM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
