      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00ZAR'.
      ...
      * Called module names
       01  MOD-ZBI01EPG              PIC X(8) VALUE 'ZBI01EPG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01EPG-001.
               CALL 'ZBI01EPG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01EPG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
