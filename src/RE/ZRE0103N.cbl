      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE0103N'.
      ...
      * Called module names
       01  MOD-ZRE01DD5              PIC X(8) VALUE 'ZRE01DD5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01DD5-001.
               CALL 'ZRE01DD5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01DD5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
