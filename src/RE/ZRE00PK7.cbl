      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00PK7'.
      ...
      * Called module names
       01  MOD-ZBI01NL6              PIC X(8) VALUE 'ZBI01NL6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01NL6-001.
               PERFORM CALL-ZRE01D4T-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01NL6-001.
               CALL 'ZBI01NL6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01NL6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01D4T-002.
