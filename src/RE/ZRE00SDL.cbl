      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00SDL'.
      ...
      * Called module names
       01  MOD-ZRE01IXF              PIC X(8) VALUE 'ZRE01IXF'.
       01  MOD-ZRE01EIJ              PIC X(8) VALUE 'ZRE01EIJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01IXF-001.
               PERFORM CALL-ZRE01EIJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01IXF-001.
               CALL 'ZRE01IXF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01IXF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01EIJ-002.
               CALL 'ZRE01EIJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01EIJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
