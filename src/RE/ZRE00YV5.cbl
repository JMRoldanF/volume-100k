      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00YV5'.
      ...
      * Called module names
       01  MOD-ZRE01O17              PIC X(8) VALUE 'ZRE01O17'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01O17-001.
               PERFORM CALL-ZRE01OS6-002.
               PERFORM CALL-ZEN0255N-003.
               PERFORM APPLY-NCD-YEARS-0001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZRE01O17-001.
               CALL 'ZRE01O17' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01O17 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01OS6-002.
