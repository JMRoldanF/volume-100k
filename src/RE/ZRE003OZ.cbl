      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE003OZ'.
      ...
      * Called module names
       ...
       01  MOD-ZUW00FIW              PIC X(8) VALUE 'ZUW00FIW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE00HF5-001.
               PERFORM CALL-ZUW001J0-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW00FIW-002.
               EXEC CICS LINK PROGRAM('ZUW00FIW')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW00FIW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW001J0-003.
               EXEC CICS START TRANSID('Z1J0')
                         FROM(WS-KEY-AREA)
                         LENGTH(20)
                         RESP(WS-RESP)
               END-EXEC.
      * TRANSID Z1J0 is defined against ZUW001J0
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW001J0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-004.
