      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00QPV'.
      ...
      * Called module names
       01  MOD-ZRE01UZ1              PIC X(8) VALUE 'ZRE01UZ1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01UZ1-001.
               CALL 'ZRE01UZ1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01UZ1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
