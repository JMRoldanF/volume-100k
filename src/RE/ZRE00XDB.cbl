      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00XDB'.
      ...
      * Called module names
       01  MOD-ZRE01Q2N              PIC X(8) VALUE 'ZRE01Q2N'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01Q2N-001.
               CALL 'ZRE01Q2N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01Q2N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01M2R-002.
