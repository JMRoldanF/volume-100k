      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00NFT'.
      ...
      * Called module names
       01  MOD-ZUW01N4W              PIC X(8) VALUE 'ZUW01N4W'.
       01  MOD-ZCL01GB7              PIC X(8) VALUE 'ZCL01GB7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01N4W-001.
               PERFORM CALL-ZCL01GB7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01N4W-001.
               CALL 'ZUW01N4W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01N4W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01GB7-002.
               CALL 'ZCL01GB7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01GB7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
