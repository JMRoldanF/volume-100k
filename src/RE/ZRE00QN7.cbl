      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00QN7'.
      ...
      * Called module names
       01  MOD-ZSU01IYW              PIC X(8) VALUE 'ZSU01IYW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSU01IYW-001.
               CALL 'ZSU01IYW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01IYW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-VALUE-0001.
