      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00OPN'.
      ...
      * Called module names
       01  MOD-ZRE01KVP              PIC X(8) VALUE 'ZRE01KVP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01KVP-001.
               CALL 'ZRE01KVP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01KVP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01S67-002.
