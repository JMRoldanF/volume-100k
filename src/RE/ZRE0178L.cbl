      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE0178L'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01TWP              PIC X(8) VALUE 'ZRE01TWP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01Q0P-001.
               PERFORM CALL-ZRE01TWP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01TWP-002.
               CALL 'ZRE01TWP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
