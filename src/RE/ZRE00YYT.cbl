      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00YYT'.
      ...
      * Called module names
       01  MOD-ZRE01CR7              PIC X(8) VALUE 'ZRE01CR7'.
       01  MOD-ZRE01IIF              PIC X(8) VALUE 'ZRE01IIF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01CR7-001.
               PERFORM CALL-ZRE01IIF-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01CR7-001.
               CALL 'ZRE01CR7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01CR7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01IIF-002.
               CALL 'ZRE01IIF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01IIF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-VALUE-0001.
