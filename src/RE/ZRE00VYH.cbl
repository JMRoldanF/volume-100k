      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00VYH'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01GXH              PIC X(8) VALUE 'ZRE01GXH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01LZ5-001.
               PERFORM CALL-ZRE01GXH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01GXH-002.
               CALL 'ZRE01GXH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01GXH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-MAKE-0001.
