      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00UHF'.
      ...
      * Called module names
       01  MOD-ZEN01ICR              PIC X(8) VALUE 'ZEN01ICR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01ICR-001.
               PERFORM CALL-ZRE01CMH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01ICR-001.
               CALL 'ZEN01ICR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01ICR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01CMH-002.
