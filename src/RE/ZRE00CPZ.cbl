      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00CPZ'.
      ...
      * Called module names
       01  MOD-ZRE00RFP              PIC X(8) VALUE 'ZRE00RFP'.
       01  MOD-ZBI00UM4              PIC X(8) VALUE 'ZBI00UM4'.
       01  MOD-ZMT016GX              PIC X(8) VALUE 'ZMT016GX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE00TFD-002.
               PERFORM CALL-ZBI00UM4-003.
               PERFORM CALL-ZMT016GX-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE00RFP-001.
               EXEC CICS LINK PROGRAM('ZRE00RFP')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00RFP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE00TFD-002.
               MOVE 'ZRE00TFD' TO WS-PROGNAME-7
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00TFD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI00UM4-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT016GX-004.
               EXEC CICS LINK PROGRAM('ZMT016GX')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT016GX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-005.
