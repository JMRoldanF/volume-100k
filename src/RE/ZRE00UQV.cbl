      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00UQV'.
      ...
      * Called module names
       01  MOD-ZRE01R95              PIC X(8) VALUE 'ZRE01R95'.
       01  MOD-ZRE01S3P              PIC X(8) VALUE 'ZRE01S3P'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01R95-001.
               PERFORM CALL-ZRE01S3P-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01R95-001.
               CALL 'ZRE01R95' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01R95 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01S3P-002.
               CALL 'ZRE01S3P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01S3P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
