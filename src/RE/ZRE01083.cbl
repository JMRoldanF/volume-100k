      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01083'.
      ...
      * Called module names
       01  MOD-ZRE01OH0              PIC X(8) VALUE 'ZRE01OH0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01OH0-001.
               CALL 'ZRE01OH0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01OH0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
