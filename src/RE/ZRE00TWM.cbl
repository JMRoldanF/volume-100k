      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00TWM'.
      ...
      * Called module names
       01  MOD-ZRE01FIN              PIC X(8) VALUE 'ZRE01FIN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01FIN-001.
               CALL 'ZRE01FIN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01FIN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
