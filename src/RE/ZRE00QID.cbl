      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00QID'.
      ...
      * Called module names
       01  MOD-ZMT01DCZ              PIC X(8) VALUE 'ZMT01DCZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01DCZ-001.
               PERFORM CALL-ZRE01GZF-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01DCZ-001.
               CALL 'ZMT01DCZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01DCZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01GZF-002.
