      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00MLT'.
      ...
      * Called module names
       01  MOD-ZRE01HMH              PIC X(8) VALUE 'ZRE01HMH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01HMH-001.
               CALL 'ZRE01HMH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01HMH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
