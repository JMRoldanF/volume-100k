      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00T71'.
      ...
      * Called module names
       01  MOD-ZCL01EAP              PIC X(8) VALUE 'ZCL01EAP'.
       01  MOD-ZRE01HXB              PIC X(8) VALUE 'ZRE01HXB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01EAP-001.
               PERFORM CALL-ZRE01HXB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01EAP-001.
               CALL 'ZCL01EAP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01EAP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01HXB-002.
               CALL 'ZRE01HXB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01HXB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
