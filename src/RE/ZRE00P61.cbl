      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00P61'.
      ...
      * Called module names
       01  MOD-ZRE01ROZ              PIC X(8) VALUE 'ZRE01ROZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01ROZ-001.
               PERFORM CALL-ZRE01H6X-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01ROZ-001.
               CALL 'ZRE01ROZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01ROZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01H6X-002.
