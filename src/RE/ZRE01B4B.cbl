      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01B4B'.
      ...
      * Called module names
       01  MOD-ZRE01D17              PIC X(8) VALUE 'ZRE01D17'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01D17-001.
               CALL 'ZRE01D17' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01D17 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-PREMIUM-0001.
