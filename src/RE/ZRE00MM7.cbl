      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00MM7'.
      ...
      * Called module names
       01  MOD-ZRE01ILG              PIC X(8) VALUE 'ZRE01ILG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01ILG-001.
               PERFORM CALL-ZRE01QQY-002.
               PERFORM VALIDATE-COLOUR-0001.
               PERFORM SQL-ACCESS-0003.
               PERFORM REFRESH-COLOUR-0004.
               ...
               PERFORM VALIDATE-CC-RATING-0013.
               ...
               PERFORM FORMAT-EQUITIES-0022.
               PERFORM DERIVE-MAKE-0023.
               PERFORM SQL-ACCESS-0024.
               PERFORM CHECK-AGENT-CODE-0025.
               ...
               PERFORM APPLY-MANAGED-FUND-0041.
               ...
               PERFORM DERIVE-AGENT-CODE-0088.
               ...
               PERFORM RESOLVE-BROKER-ID-0109.
               ...
               PERFORM CHECK-NCD-YEARS-0140.
               PERFORM SQL-ACCESS-0141.
               PERFORM EXPAND-ROOF-TYPE-0142.
               PERFORM EXPAND-CC-RATING-0143.
               PERFORM SQL-ACCESS-0144.
               PERFORM COMPUTE-REG-NUMBER-0145.
               PERFORM FORMAT-TAX-BAND-0146.
               PERFORM SQL-ACCESS-0147.
               PERFORM DERIVE-MODEL-0148.
               PERFORM VALIDATE-EXCESS-0149.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZRE01ILG-001.
               CALL 'ZRE01ILG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01ILG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01QQY-002.
               MOVE 'ZRE01QQY' TO WS-SUBNAME-4
               CALL WS-SUBNAME-4 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01QQY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
