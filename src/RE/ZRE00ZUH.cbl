      ...
      * Called module names
       01  MOD-ZRE01U9H              PIC X(8) VALUE 'ZRE01U9H'.
       01  MOD-ZRE01HSB              PIC X(8) VALUE 'ZRE01HSB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01U9H-001.
               PERFORM CALL-ZRE01HSB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01U9H-001.
               CALL 'ZRE01U9H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01U9H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01HSB-002.
               CALL 'ZRE01HSB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
