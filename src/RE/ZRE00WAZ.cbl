      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00WAZ'.
      ...
      * Called module names
       01  MOD-ZRE01R6D              PIC X(8) VALUE 'ZRE01R6D'.
       01  MOD-ZRE01SCL              PIC X(8) VALUE 'ZRE01SCL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01R6D-001.
               PERFORM CALL-ZRE01SCL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01R6D-001.
               CALL 'ZRE01R6D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01R6D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01SCL-002.
               CALL 'ZRE01SCL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01SCL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
