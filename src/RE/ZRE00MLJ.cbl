      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00MLJ'.
      ...
      * Called module names
       01  MOD-ZRE01OCZ              PIC X(8) VALUE 'ZRE01OCZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01OCZ-001.
               CALL 'ZRE01OCZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01OCZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01OUR-002.
