      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00TG7'.
      ...
      * Called module names
       01  MOD-ZRE01T39              PIC X(8) VALUE 'ZRE01T39'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01T39-001.
               CALL 'ZRE01T39' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01T39 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01R2R-002.
