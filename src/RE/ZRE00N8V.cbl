      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00N8V'.
      ...
      * Called module names
       01  MOD-ZRE01GZP              PIC X(8) VALUE 'ZRE01GZP'.
       01  MOD-ZRE01UDN              PIC X(8) VALUE 'ZRE01UDN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01GZP-001.
               PERFORM CALL-ZRE01UDN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01GZP-001.
               CALL 'ZRE01GZP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01GZP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01UDN-002.
               CALL 'ZRE01UDN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01UDN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
