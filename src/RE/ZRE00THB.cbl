      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00THB'.
      ...
      * Called module names
       01  MOD-ZRE01DC1              PIC X(8) VALUE 'ZRE01DC1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01DC1-001.
               CALL 'ZRE01DC1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01DC1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
