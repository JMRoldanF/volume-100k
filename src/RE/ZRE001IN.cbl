      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE001IN'.
      ...
      * Called module names
       01  MOD-ZRE00D4F              PIC X(8) VALUE 'ZRE00D4F'.
       01  MOD-ZRE006QZ              PIC X(8) VALUE 'ZRE006QZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE00D4F-001.
               PERFORM CALL-ZRE006QZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE00D4F-001.
               EXEC CICS LINK PROGRAM('ZRE00D4F')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00D4F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE006QZ-002.
               EXEC CICS LINK PROGRAM('ZRE006QZ')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE006QZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
