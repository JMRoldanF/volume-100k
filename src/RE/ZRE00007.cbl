      ...
      * Called module names
       ...
       01  MOD-ZRE00C1C              PIC X(8) VALUE 'ZRE00C1C'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMB00A9S-002.
               PERFORM CALL-ZRE00GMB-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZMB00A9S-002.
               MOVE 'ZMB00A9S' TO WS-PROGNAME-4
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMB00A9S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE00C1C-003.
               EXEC CICS LINK PROGRAM('ZRE00C1C')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00C1C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE00GMB-004.
