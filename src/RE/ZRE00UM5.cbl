      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00UM5'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01JEX              PIC X(8) VALUE 'ZRE01JEX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01JEX-002.
               CALL 'ZRE01JEX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01JEX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
