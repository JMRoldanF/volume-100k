      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01AXX'.
      ...
      * Called module names
       01  MOD-ZRE01N85              PIC X(8) VALUE 'ZRE01N85'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01N85-001.
               PERFORM CALL-ZRE01F83-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01N85-001.
               CALL 'ZRE01N85' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01N85 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01F83-002.
               MOVE 'ZRE01F83' TO WS-SUBNAME-1
