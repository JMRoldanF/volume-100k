      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00O0D'.
      ...
      * Called module names
       01  MOD-ZRE01TV1              PIC X(8) VALUE 'ZRE01TV1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01TV1-001.
               CALL 'ZRE01TV1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01TV1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
