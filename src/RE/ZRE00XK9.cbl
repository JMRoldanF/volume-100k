      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00XK9'.
      ...
      * Called module names
       01  MOD-ZRE01PCT              PIC X(8) VALUE 'ZRE01PCT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01PCT-001.
               PERFORM CALL-ZRE01EIT-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01PCT-001.
               CALL 'ZRE01PCT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01PCT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01EIT-002.
