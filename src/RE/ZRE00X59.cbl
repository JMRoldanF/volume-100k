      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00X59'.
      ...
      * Called module names
       01  MOD-ZRE01E6V              PIC X(8) VALUE 'ZRE01E6V'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01M79-001.
               PERFORM CALL-ZRE01E6V-002.
               PERFORM AUDIT-MANAGED-FUND-0001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZPA01M79-001.
               MOVE 'ZPA01M79' TO WS-SUBNAME-6
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01E6V-002.
               CALL 'ZRE01E6V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
