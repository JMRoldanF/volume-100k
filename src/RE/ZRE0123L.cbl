      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE0123L'.
      ...
      * Called module names
       01  MOD-ZRE01QT1              PIC X(8) VALUE 'ZRE01QT1'.
       01  MOD-ZAG01JQ2              PIC X(8) VALUE 'ZAG01JQ2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01QT1-001.
               PERFORM CALL-ZAG01JQ2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01QT1-001.
               CALL 'ZRE01QT1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01QT1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01JQ2-002.
               CALL 'ZAG01JQ2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01JQ2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
