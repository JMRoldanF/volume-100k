      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00VYR'.
      ...
      * Called module names
       01  MOD-ZRE01SOT              PIC X(8) VALUE 'ZRE01SOT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01SOT-001.
               CALL 'ZRE01SOT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01SOT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01EK7-002.
