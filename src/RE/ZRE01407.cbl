      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01407'.
      ...
      * Called module names
       01  MOD-ZRE01F9R              PIC X(8) VALUE 'ZRE01F9R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01F9R-001.
               CALL 'ZRE01F9R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       FILE-ACCESS-0003.
               EXEC CICS REWRITE FILE('KSDSRE05')
                         FROM(KSDSRE05-REC)
                         LENGTH(WS-FILE-LEN)
                         RIDFLD(WS-KEY-AREA)
                         RESP(WS-RESP)
