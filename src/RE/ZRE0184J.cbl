      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE0184J'.
      ...
      * Called module names
       01  MOD-ZRE01EYN              PIC X(8) VALUE 'ZRE01EYN'.
       01  MOD-ZPA01GR5              PIC X(8) VALUE 'ZPA01GR5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01EYN-001.
               PERFORM CALL-ZPA01GR5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01EYN-001.
               CALL 'ZRE01EYN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01EYN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01GR5-002.
               CALL 'ZPA01GR5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01GR5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
