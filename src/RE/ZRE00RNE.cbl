      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00RNE'.
      ...
      * Called module names
       01  MOD-ZRE01H4Q              PIC X(8) VALUE 'ZRE01H4Q'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01V0E-001.
               PERFORM CALL-ZRE01H4Q-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01H4Q-002.
               CALL 'ZRE01H4Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01H4Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
