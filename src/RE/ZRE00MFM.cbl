      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00MFM'.
      ...
      * Called module names
       01  MOD-ZSU01UIH              PIC X(8) VALUE 'ZSU01UIH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSU01UIH-001.
               CALL 'ZSU01UIH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01UIH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
