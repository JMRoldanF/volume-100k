      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE001W9'.
      ...
      * Called module names
       ...
       01  MOD-ZRE007FF              PIC X(8) VALUE 'ZRE007FF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE007FF-002.
               EXEC CICS LINK PROGRAM('ZRE007FF')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE007FF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-COLOUR-0001.
