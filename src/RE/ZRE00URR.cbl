      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00URR'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01TGP              PIC X(8) VALUE 'ZRE01TGP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01L6G-001.
               PERFORM CALL-ZRE01TGP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01TGP-002.
               CALL 'ZRE01TGP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01TGP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
