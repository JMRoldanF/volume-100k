      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00WVJ'.
      ...
      * Called module names
       01  MOD-ZRE01FJH              PIC X(8) VALUE 'ZRE01FJH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01FJH-001.
               CALL 'ZRE01FJH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01FJH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
