      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00SP9'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01IOJ              PIC X(8) VALUE 'ZRE01IOJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01QRM-001.
               PERFORM CALL-ZRE01IOJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01IOJ-002.
               CALL 'ZRE01IOJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01IOJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
