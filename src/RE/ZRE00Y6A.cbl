      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00Y6A'.
      ...
      * Called module names
       01  MOD-ZRE01KKL              PIC X(8) VALUE 'ZRE01KKL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01L3Z-001.
               PERFORM CALL-ZRE01KKL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01L3Z-001.
               MOVE 'ZRE01L3Z' TO WS-SUBNAME-3
               CALL WS-SUBNAME-3 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01L3Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01KKL-002.
               CALL 'ZRE01KKL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
