      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00SBX'.
      ...
      * Called module names
       01  MOD-ZRE01LOL              PIC X(8) VALUE 'ZRE01LOL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01LOL-002.
               CALL 'ZRE01LOL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01LOL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
