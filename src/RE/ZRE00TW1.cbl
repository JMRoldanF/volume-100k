      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00TW1'.
      ...
      * Called module names
       01  MOD-ZCU01PKI              PIC X(8) VALUE 'ZCU01PKI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01PKI-001.
               CALL 'ZCU01PKI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01PKI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01CWH-002.
               MOVE 'ZRE01CWH' TO WS-SUBNAME-4
