      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00SD1'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01JAH              PIC X(8) VALUE 'ZRE01JAH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01JED-001.
               PERFORM CALL-ZRE01JAH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01JAH-002.
               CALL 'ZRE01JAH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
