      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00VAV'.
      ...
      * Called module names
       01  MOD-ZCL01SV5              PIC X(8) VALUE 'ZCL01SV5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01SV5-001.
               PERFORM CALL-ZRE01HR7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01SV5-001.
               CALL 'ZCL01SV5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01SV5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01HR7-002.
