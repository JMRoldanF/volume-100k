      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00ODP'.
      ...
      * Called module names
       01  MOD-ZRE01IK3              PIC X(8) VALUE 'ZRE01IK3'.
       01  MOD-ZPA01K85              PIC X(8) VALUE 'ZPA01K85'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01IK3-001.
               PERFORM CALL-ZPA01K85-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01IK3-001.
               CALL 'ZRE01IK3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01IK3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01K85-002.
               CALL 'ZPA01K85' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01K85 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
