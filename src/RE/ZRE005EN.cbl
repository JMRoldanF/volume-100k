      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE005EN'.
      ...
      * Called module names
       ...
       01  MOD-ZRE00D3V              PIC X(8) VALUE 'ZRE00D3V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE00D3V-002.
               EXEC CICS LINK PROGRAM('ZRE00D3V')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00D3V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
