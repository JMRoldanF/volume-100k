      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE0124Z'.
      ...
      * Called module names
       01  MOD-ZUW01QTE              PIC X(8) VALUE 'ZUW01QTE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01QTE-001.
               CALL 'ZUW01QTE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01QTE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
