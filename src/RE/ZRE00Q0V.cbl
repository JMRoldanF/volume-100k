      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00Q0V'.
      ...
      * Called module names
       01  MOD-ZRE01TLV              PIC X(8) VALUE 'ZRE01TLV'.
       01  MOD-ZRE01PSD              PIC X(8) VALUE 'ZRE01PSD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01TLV-001.
               PERFORM CALL-ZRE01PSD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01TLV-001.
               CALL 'ZRE01TLV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01TLV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01PSD-002.
               CALL 'ZRE01PSD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01PSD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
