      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00PTN'.
      ...
      * Called module names
       01  MOD-ZRE01DWV              PIC X(8) VALUE 'ZRE01DWV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01DWV-001.
               CALL 'ZRE01DWV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01DWV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
