      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00Q6H'.
      ...
      * Called module names
       01  MOD-ZRE01JNX              PIC X(8) VALUE 'ZRE01JNX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01JNX-001.
               CALL 'ZRE01JNX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01JNX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-EXCESS-0001.
