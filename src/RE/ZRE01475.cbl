      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01475'.
      ...
      * Called module names
       01  MOD-ZRE01DSP              PIC X(8) VALUE 'ZRE01DSP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01DSP-001.
               CALL 'ZRE01DSP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01DSP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-EXCESS-0001.
