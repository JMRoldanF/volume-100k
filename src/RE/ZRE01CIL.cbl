      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01CIL'.
      ...
      * Called module names
       01  MOD-ZRE01R13              PIC X(8) VALUE 'ZRE01R13'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01R13-001.
               CALL 'ZRE01R13' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01R13 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
