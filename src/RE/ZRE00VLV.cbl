      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00VLV'.
      ...
      * Called module names
       01  MOD-ZSU01D4H              PIC X(8) VALUE 'ZSU01D4H'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSU01D4H-001.
               CALL 'ZSU01D4H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01D4H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-MAKE-0001.
