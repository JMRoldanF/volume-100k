      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00M4B'.
      ...
      * Called module names
       01  MOD-ZRE01IP3              PIC X(8) VALUE 'ZRE01IP3'.
       01  MOD-ZRE01M0T              PIC X(8) VALUE 'ZRE01M0T'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01IP3-001.
               PERFORM CALL-ZRE01M0T-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01IP3-001.
               CALL 'ZRE01IP3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01IP3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01M0T-002.
               CALL 'ZRE01M0T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01M0T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
