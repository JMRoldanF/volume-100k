      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00WW0'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01NZI              PIC X(8) VALUE 'ZRE01NZI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01NZI-002.
               CALL 'ZRE01NZI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01NZI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
