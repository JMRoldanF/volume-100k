      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00LOR'.
      ...
      * Called module names
       01  MOD-ZRE01OYD              PIC X(8) VALUE 'ZRE01OYD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01OYD-001.
               PERFORM CALL-ZRE01HL3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01OYD-001.
               CALL 'ZRE01OYD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01OYD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01HL3-002.
