      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE010WT'.
      ...
      * Called module names
       01  MOD-ZRE01EC5              PIC X(8) VALUE 'ZRE01EC5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01EC5-001.
               CALL 'ZRE01EC5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01EC5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
