      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00R8H'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01KIN              PIC X(8) VALUE 'ZRE01KIN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01KIN-002.
               CALL 'ZRE01KIN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01KIN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
