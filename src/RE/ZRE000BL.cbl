      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE000BL'.
      ...
      * Called module names
       ...
       01  MOD-ZRE00FN9              PIC X(8) VALUE 'ZRE00FN9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW00CPS-001.
               PERFORM CALL-ZRE00FN9-002.
               PERFORM CALL-ZRE00CPF-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE00FN9-002.
               EXEC CICS LINK PROGRAM('ZRE00FN9')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00FN9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE00CPF-003.
