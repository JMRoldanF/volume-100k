      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00LOH'.
      ...
      * Called module names
       01  MOD-ZRE01RK9              PIC X(8) VALUE 'ZRE01RK9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01RK9-001.
               CALL 'ZRE01RK9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01RK9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
