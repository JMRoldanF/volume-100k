      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE0112X'.
      ...
      * Called module names
       01  MOD-ZRE01CZJ              PIC X(8) VALUE 'ZRE01CZJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01CZJ-001.
               PERFORM CALL-ZMT01ICP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01CZJ-001.
               CALL 'ZRE01CZJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01CZJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01ICP-002.
