      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00XV3'.
      ...
      * Called module names
       01  MOD-ZPA01T95              PIC X(8) VALUE 'ZPA01T95'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01T95-001.
               PERFORM CALL-ZRE01RDL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01T95-001.
               CALL 'ZPA01T95' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01T95 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01RDL-002.
