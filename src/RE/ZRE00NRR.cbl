      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00NRR'.
      ...
      * Called module names
       01  MOD-ZRE01HGD              PIC X(8) VALUE 'ZRE01HGD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01HGD-001.
               CALL 'ZRE01HGD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01HGD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
