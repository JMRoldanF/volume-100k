      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00TQJ'.
      ...
      * Called module names
       01  MOD-ZMB01SZ5              PIC X(8) VALUE 'ZMB01SZ5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMB01SZ5-001.
               PERFORM CALL-ZRE01JUL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMB01SZ5-001.
               CALL 'ZMB01SZ5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
