      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00Y5X'.
      ...
      * Called module names
       01  MOD-ZRE01UXN              PIC X(8) VALUE 'ZRE01UXN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01UXN-001.
               PERFORM CALL-ZRE01ODT-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01UXN-001.
               CALL 'ZRE01UXN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01UXN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01ODT-002.
