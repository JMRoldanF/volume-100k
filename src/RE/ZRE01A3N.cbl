      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01A3N'.
      ...
      * Called module names
       01  MOD-ZRE01JEN              PIC X(8) VALUE 'ZRE01JEN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01JEN-001.
               CALL 'ZRE01JEN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01JEN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
