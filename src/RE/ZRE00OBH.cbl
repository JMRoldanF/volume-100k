      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00OBH'.
      ...
      * Called module names
       01  MOD-ZRE01GMN              PIC X(8) VALUE 'ZRE01GMN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01GMN-001.
               PERFORM CALL-ZRE01JS9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01GMN-001.
               CALL 'ZRE01GMN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
