      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00YMB'.
      ...
      * Called module names
       01  MOD-ZRE01HBD              PIC X(8) VALUE 'ZRE01HBD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01HBD-001.
               PERFORM CALL-ZRE01KXD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01HBD-001.
               CALL 'ZRE01HBD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01HBD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01KXD-002.
