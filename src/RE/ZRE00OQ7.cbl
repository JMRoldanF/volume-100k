      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00OQ7'.
      ...
      * Called module names
       01  MOD-ZRE01FX3              PIC X(8) VALUE 'ZRE01FX3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01FX3-001.
               CALL 'ZRE01FX3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01FX3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01LAP-002.
               MOVE 'ZRE01LAP' TO WS-SUBNAME-2
