      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE011CD'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01TYX              PIC X(8) VALUE 'ZRE01TYX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01TYX-002.
               CALL 'ZRE01TYX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
