      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE016V9'.
      ...
      * Called module names
       01  MOD-ZRE01PXN              PIC X(8) VALUE 'ZRE01PXN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01PXN-001.
               CALL 'ZRE01PXN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01PXN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
