      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01BMD'.
      ...
      * Called module names
       01  MOD-ZRE01I9J              PIC X(8) VALUE 'ZRE01I9J'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01I9J-002.
               CALL 'ZRE01I9J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01I9J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
