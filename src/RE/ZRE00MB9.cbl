      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00MB9'.
      ...
      * Called module names
       01  MOD-ZRE01M27              PIC X(8) VALUE 'ZRE01M27'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01M27-001.
               CALL 'ZRE01M27' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01M27 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
