      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00ZON'.
      ...
      * Called module names
       01  MOD-ZRE01TVB              PIC X(8) VALUE 'ZRE01TVB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01TVB-001.
               CALL 'ZRE01TVB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01TVB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
