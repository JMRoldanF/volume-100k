      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00M05'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01IFN              PIC X(8) VALUE 'ZRE01IFN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01GJB-001.
               PERFORM CALL-ZRE01IFN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01IFN-002.
               CALL 'ZRE01IFN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01IFN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
