      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00WYV'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01NOJ              PIC X(8) VALUE 'ZRE01NOJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01V3H-001.
               PERFORM CALL-ZRE01NOJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01NOJ-002.
               CALL 'ZRE01NOJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01NOJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
