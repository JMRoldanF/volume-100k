      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE010QP'.
      ...
      * Called module names
       01  MOD-ZRE01E67              PIC X(8) VALUE 'ZRE01E67'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01E67-001.
               CALL 'ZRE01E67' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01E67 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
