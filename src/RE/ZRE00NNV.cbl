      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00NNV'.
      ...
      * Called module names
       01  MOD-ZRE01UTH              PIC X(8) VALUE 'ZRE01UTH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01UTH-001.
               CALL 'ZRE01UTH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01UTH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
