      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00PGV'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01UFL              PIC X(8) VALUE 'ZRE01UFL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01UFL-002.
               CALL 'ZRE01UFL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01UFL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
