      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00UYT'.
      ...
      * Called module names
       01  MOD-ZRE01EX3              PIC X(8) VALUE 'ZRE01EX3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01EX3-001.
               CALL 'ZRE01EX3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01EX3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01KTS-002.
               MOVE 'ZRE01KTS' TO WS-SUBNAME-7
