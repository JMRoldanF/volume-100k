      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00MQJ'.
      ...
      * Called module names
       01  MOD-ZCU01KCQ              PIC X(8) VALUE 'ZCU01KCQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01KCQ-001.
               PERFORM CALL-ZRE01DKN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01KCQ-001.
               CALL 'ZCU01KCQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01KCQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01DKN-002.
