      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00ZBV'.
      ...
      * Called module names
       01  MOD-ZCL01IXN              PIC X(8) VALUE 'ZCL01IXN'.
       01  MOD-ZRE01RAJ              PIC X(8) VALUE 'ZRE01RAJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01IXN-001.
               CALL 'ZCL01IXN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01IXN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01RAJ-002.
               CALL 'ZRE01RAJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01RAJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
