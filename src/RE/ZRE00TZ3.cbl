      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00TZ3'.
      ...
      * Called module names
       01  MOD-ZRE01J4X              PIC X(8) VALUE 'ZRE01J4X'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01J4X-001.
               CALL 'ZRE01J4X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01J4X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
