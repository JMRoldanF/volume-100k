      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE012D1'.
      ...
      * Called module names
       01  MOD-ZRE01OJD              PIC X(8) VALUE 'ZRE01OJD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01OJD-001.
               CALL 'ZRE01OJD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01OJD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01COZ-002.
