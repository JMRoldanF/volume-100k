      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00XDV'.
      ...
      * Called module names
       01  MOD-ZRE01TRP              PIC X(8) VALUE 'ZRE01TRP'.
       01  MOD-ZRE01SBH              PIC X(8) VALUE 'ZRE01SBH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01TRP-001.
               PERFORM CALL-ZRE01SBH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01TRP-001.
               CALL 'ZRE01TRP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01TRP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01SBH-002.
               CALL 'ZRE01SBH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01SBH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
