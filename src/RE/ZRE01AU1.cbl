      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01AU1'.
      ...
      * Called module names
       01  MOD-ZRE01DWL              PIC X(8) VALUE 'ZRE01DWL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01DWL-001.
               CALL 'ZRE01DWL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01DWL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
