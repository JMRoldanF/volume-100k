      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00IKE'.
      ...
      * Called module names
       ...
       01  MOD-ZRE012R9              PIC X(8) VALUE 'ZRE012R9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSU00VNX-001.
               PERFORM CALL-ZRE00Q6Y-002.
               PERFORM CALL-ZRE012R9-003.
               PERFORM CALL-ZRE01JPI-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZSU00VNX-001.
               MOVE 'ZSU00VNX' TO WS-PROGNAME-2
      ...
      *----------------------------------------------------------------*
       CALL-ZRE012R9-003.
               EXEC CICS LINK PROGRAM('ZRE012R9')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE012R9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01JPI-004.
