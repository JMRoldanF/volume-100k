      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00NQX'.
      ...
      * Called module names
       01  MOD-ZRE01RZ9              PIC X(8) VALUE 'ZRE01RZ9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01RZ9-001.
               CALL 'ZRE01RZ9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01RZ9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
