      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00XO5'.
      ...
      * Called module names
       01  MOD-ZRE01GM3              PIC X(8) VALUE 'ZRE01GM3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01GM3-001.
               PERFORM CALL-ZRE01SOJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01GM3-001.
               CALL 'ZRE01GM3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
