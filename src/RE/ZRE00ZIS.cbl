      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00ZIS'.
      ...
      * Called module names
       01  MOD-ZSU01OEP              PIC X(8) VALUE 'ZSU01OEP'.
       01  MOD-ZRE01LP4              PIC X(8) VALUE 'ZRE01LP4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSU01OEP-001.
               PERFORM CALL-ZRE01LP4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSU01OEP-001.
               CALL 'ZSU01OEP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01OEP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01LP4-002.
               CALL 'ZRE01LP4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01LP4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
