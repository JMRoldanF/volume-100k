      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00R3R'.
      ...
      * Called module names
       01  MOD-ZHO01JIO              PIC X(8) VALUE 'ZHO01JIO'.
       01  MOD-ZRE01KIX              PIC X(8) VALUE 'ZRE01KIX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01JIO-001.
               PERFORM CALL-ZRE01KIX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01JIO-001.
               CALL 'ZHO01JIO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01JIO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01KIX-002.
               CALL 'ZRE01KIX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01KIX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
