      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00TU3'.
      ...
      * Called module names
       01  MOD-ZRE01KYR              PIC X(8) VALUE 'ZRE01KYR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01KYR-001.
               CALL 'ZRE01KYR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01KYR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
