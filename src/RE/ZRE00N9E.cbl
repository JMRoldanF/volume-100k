      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00N9E'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01JOT              PIC X(8) VALUE 'ZRE01JOT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01J7N-001.
               PERFORM CALL-ZRE01JOT-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01JOT-002.
               CALL 'ZRE01JOT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01JOT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
