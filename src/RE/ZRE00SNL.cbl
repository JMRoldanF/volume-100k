      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00SNL'.
      ...
      * Called module names
       01  MOD-ZRE01OBX              PIC X(8) VALUE 'ZRE01OBX'.
       01  MOD-ZRE01UWL              PIC X(8) VALUE 'ZRE01UWL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01OBX-001.
               PERFORM CALL-ZRE01UWL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01OBX-001.
               CALL 'ZRE01OBX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01OBX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01UWL-002.
               CALL 'ZRE01UWL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01UWL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
