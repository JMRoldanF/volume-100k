      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00WP5'.
      ...
      * Called module names
       01  MOD-ZRE01HWH              PIC X(8) VALUE 'ZRE01HWH'.
       01  MOD-ZRE01K7T              PIC X(8) VALUE 'ZRE01K7T'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01HWH-001.
               PERFORM CALL-ZRE01K7T-002.
               ...
               PERFORM RESOLVE-WITH-PROFITS-0092.
               ...
               PERFORM DERIVE-TAX-BAND-0107.
               PERFORM SQL-ACCESS-0108.
               PERFORM EXPAND-VALUE-0109.
               PERFORM COMPUTE-REG-NUMBER-0110.
               PERFORM SQL-ACCESS-0111.
               PERFORM DERIVE-EXCESS-0112.
               PERFORM SQL-ACCESS-0114.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZRE01HWH-001.
               CALL 'ZRE01HWH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01HWH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01K7T-002.
               CALL 'ZRE01K7T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01K7T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
