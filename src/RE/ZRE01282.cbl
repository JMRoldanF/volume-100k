      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01282'.
      ...
      * Called module names
       01  MOD-ZRE01JBC              PIC X(8) VALUE 'ZRE01JBC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01JBC-001.
               CALL 'ZRE01JBC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01JBC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
