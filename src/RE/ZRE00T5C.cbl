      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00T5C'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01PBB              PIC X(8) VALUE 'ZRE01PBB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01DO4-001.
               PERFORM CALL-ZRE01PBB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01PBB-002.
               CALL 'ZRE01PBB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
