      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00VBP'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01INP              PIC X(8) VALUE 'ZRE01INP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01INP-002.
               CALL 'ZRE01INP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01INP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
