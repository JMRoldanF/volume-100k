      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00ND1'.
      ...
      * Called module names
       01  MOD-ZRE01JAR              PIC X(8) VALUE 'ZRE01JAR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01JAR-001.
               CALL 'ZRE01JAR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01JAR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-TERM-0001.
