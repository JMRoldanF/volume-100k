      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00YC1'.
      ...
      * Called module names
       01  MOD-ZRE01PMT              PIC X(8) VALUE 'ZRE01PMT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01PMT-001.
               PERFORM CALL-ZRE01JW5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01PMT-001.
               CALL 'ZRE01PMT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01PMT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01JW5-002.
