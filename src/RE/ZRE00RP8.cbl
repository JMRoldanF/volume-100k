      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00RP8'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01L2C              PIC X(8) VALUE 'ZRE01L2C'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSU01S7J-001.
               PERFORM CALL-ZRE01L2C-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01L2C-002.
               CALL 'ZRE01L2C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01L2C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
