      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00UFR'.
      ...
      * Called module names
       01  MOD-ZRE01GMD              PIC X(8) VALUE 'ZRE01GMD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01GMD-001.
               PERFORM CALL-ZRE01P1F-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01GMD-001.
               CALL 'ZRE01GMD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01GMD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01P1F-002.
