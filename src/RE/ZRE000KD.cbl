      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE000KD'.
      ...
      * Called module names
       01  MOD-ZRE007R0              PIC X(8) VALUE 'ZRE007R0'.
       01  MOD-ZRE007RN              PIC X(8) VALUE 'ZRE007RN'.
       01  MOD-ZRE007SC              PIC X(8) VALUE 'ZRE007SC'.
       01  MOD-ZRE00FI7              PIC X(8) VALUE 'ZRE00FI7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE007R0-001.
               PERFORM CALL-ZRE007RN-002.
               PERFORM CALL-ZRE00FI7-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE007R0-001.
               EXEC CICS LINK PROGRAM('ZRE007R0')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE007R0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE007RN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE00FI7-004.
               EXEC CICS LINK PROGRAM('ZRE00FI7')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00FI7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-005.
