      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00THV'.
      ...
      * Called module names
       01  MOD-ZRE01P1Z              PIC X(8) VALUE 'ZRE01P1Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01P1Z-001.
               CALL 'ZRE01P1Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01P1Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-TERM-0001.
