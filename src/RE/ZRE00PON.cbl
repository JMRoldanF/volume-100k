      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00PON'.
      ...
      * Called module names
       01  MOD-ZAG01S2W              PIC X(8) VALUE 'ZAG01S2W'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01S2W-001.
               CALL 'ZAG01S2W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01S2W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
