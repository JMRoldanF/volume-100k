      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00W5F'.
      ...
      * Called module names
       01  MOD-ZRE01QFF              PIC X(8) VALUE 'ZRE01QFF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01QFF-001.
               CALL 'ZRE01QFF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01QFF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
