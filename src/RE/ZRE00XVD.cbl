      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00XVD'.
      ...
      * Called module names
       01  MOD-ZBI01HDU              PIC X(8) VALUE 'ZBI01HDU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01HDU-001.
               PERFORM CALL-ZRE01DWL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01HDU-001.
               CALL 'ZBI01HDU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01HDU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01DWL-002.
