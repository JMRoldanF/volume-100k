      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE011J1'.
      ...
      * Called module names
       01  MOD-ZRE01KWT              PIC X(8) VALUE 'ZRE01KWT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01KWT-001.
               CALL 'ZRE01KWT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01KWT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01GAW-002.
