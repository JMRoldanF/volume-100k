      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00MR3'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01NUN              PIC X(8) VALUE 'ZRE01NUN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01HCH-001.
               PERFORM CALL-ZRE01NUN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01NUN-002.
               CALL 'ZRE01NUN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01NUN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
