      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE000TN'.
      ...
      * Called module names
       ...
       01  MOD-ZCU0054A              PIC X(8) VALUE 'ZCU0054A'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE00L1Z-001.
               PERFORM CALL-ZRE009LR-002.
               PERFORM CALL-ZCU0054A-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE00L1Z-001.
               MOVE 'ZRE00L1Z' TO WS-PROGNAME-2
      ...
      *----------------------------------------------------------------*
       CALL-ZCU0054A-003.
               EXEC CICS XCTL PROGRAM('ZCU0054A')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
