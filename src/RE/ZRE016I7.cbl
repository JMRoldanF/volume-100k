      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE016I7'.
      ...
      * Called module names
       01  MOD-ZRE01NXP              PIC X(8) VALUE 'ZRE01NXP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01NXP-001.
               CALL 'ZRE01NXP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01NXP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
