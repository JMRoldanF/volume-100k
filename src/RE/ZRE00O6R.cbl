      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00O6R'.
      ...
      * Called module names
       01  MOD-ZRE01KRT              PIC X(8) VALUE 'ZRE01KRT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01KRT-001.
               PERFORM CALL-ZHO01G6Y-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01KRT-001.
               CALL 'ZRE01KRT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01KRT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01G6Y-002.
               MOVE 'ZHO01G6Y' TO WS-SUBNAME-2
