      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00QL5'.
      ...
      * Called module names
       01  MOD-ZRE01KCT              PIC X(8) VALUE 'ZRE01KCT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01KCT-001.
               PERFORM CALL-ZRE01JOX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01KCT-001.
               CALL 'ZRE01KCT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01KCT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01JOX-002.
