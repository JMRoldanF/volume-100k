      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00Z1V'.
      ...
      * Called module names
       01  MOD-ZRE01COP              PIC X(8) VALUE 'ZRE01COP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01COP-001.
               CALL 'ZRE01COP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01COP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
