      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00Z2Z'.
      ...
      * Called module names
       01  MOD-ZRE01R1X              PIC X(8) VALUE 'ZRE01R1X'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01R1X-001.
               CALL 'ZRE01R1X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01R1X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01SM1-002.
