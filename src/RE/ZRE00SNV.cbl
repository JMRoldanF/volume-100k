      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00SNV'.
      ...
      * Called module names
       01  MOD-ZRE01O07              PIC X(8) VALUE 'ZRE01O07'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01O07-001.
               CALL 'ZRE01O07' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01O07 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
