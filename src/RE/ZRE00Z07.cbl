      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00Z07'.
      ...
      * Called module names
       01  MOD-ZRE01RUT              PIC X(8) VALUE 'ZRE01RUT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01RUT-001.
               CALL 'ZRE01RUT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01RUT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
