      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00R1T'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01FI3              PIC X(8) VALUE 'ZRE01FI3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01SAN-001.
               PERFORM CALL-ZRE01FI3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01FI3-002.
               CALL 'ZRE01FI3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01FI3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
