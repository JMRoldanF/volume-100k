      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE017O3'.
      ...
      * Called module names
       01  MOD-ZRE01DXE              PIC X(8) VALUE 'ZRE01DXE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01DXE-001.
               CALL 'ZRE01DXE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01DXE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
