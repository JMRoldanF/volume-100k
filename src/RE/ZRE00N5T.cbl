      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00N5T'.
      ...
      * Called module names
       01  MOD-ZRE01IUD              PIC X(8) VALUE 'ZRE01IUD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01IUD-001.
               CALL 'ZRE01IUD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01IUD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
