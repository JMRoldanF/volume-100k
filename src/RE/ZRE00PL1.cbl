      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00PL1'.
      ...
      * Called module names
       01  MOD-ZPA01P5D              PIC X(8) VALUE 'ZPA01P5D'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01P5D-001.
               CALL 'ZPA01P5D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01P5D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
