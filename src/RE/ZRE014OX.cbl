      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE014OX'.
      ...
      * Called module names
       01  MOD-ZRE01UA1              PIC X(8) VALUE 'ZRE01UA1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01UA1-001.
               CALL 'ZRE01UA1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01UA1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
