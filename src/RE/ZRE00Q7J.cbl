      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00Q7J'.
      ...
      * Called module names
       01  MOD-ZRE01S7V              PIC X(8) VALUE 'ZRE01S7V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01S7V-001.
               CALL 'ZRE01S7V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01S7V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
