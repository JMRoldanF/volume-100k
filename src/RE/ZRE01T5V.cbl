      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01T5V'.
      ...
      * Called module names
       01  MOD-ZRE01QRM              PIC X(8) VALUE 'ZRE01QRM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01QRM-001.
               CALL 'ZRE01QRM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01QRM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
