      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00V0V'.
      ...
      * Called module names
       01  MOD-ZRE01JFH              PIC X(8) VALUE 'ZRE01JFH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01JFH-002.
               CALL 'ZRE01JFH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01JFH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
