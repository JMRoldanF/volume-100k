      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00R07'.
      ...
      * Called module names
       01  MOD-ZSU01T4S              PIC X(8) VALUE 'ZSU01T4S'.
       01  MOD-ZMB01JGO              PIC X(8) VALUE 'ZMB01JGO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSU01T4S-001.
               PERFORM CALL-ZMB01JGO-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSU01T4S-001.
               CALL 'ZSU01T4S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01T4S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMB01JGO-002.
               CALL 'ZMB01JGO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMB01JGO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
