      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00RCX'.
      ...
      * Called module names
       01  MOD-ZRE01O3J              PIC X(8) VALUE 'ZRE01O3J'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01O3J-001.
               CALL 'ZRE01O3J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01O3J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
