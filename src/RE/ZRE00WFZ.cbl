      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00WFZ'.
      ...
      * Called module names
       01  MOD-ZRE01SUN              PIC X(8) VALUE 'ZRE01SUN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01SUN-001.
               CALL 'ZRE01SUN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01SUN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
