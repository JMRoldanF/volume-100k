      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00RNR'.
      ...
      * Called module names
       01  MOD-ZRE01NN5              PIC X(8) VALUE 'ZRE01NN5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01NN5-001.
               CALL 'ZRE01NN5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01NN5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
