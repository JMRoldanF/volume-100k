      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE011QT'.
      ...
      * Called module names
       01  MOD-ZHO01EH0              PIC X(8) VALUE 'ZHO01EH0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01EH0-001.
               CALL 'ZHO01EH0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01EH0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
