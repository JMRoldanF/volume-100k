      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01335'.
      ...
      * Called module names
       01  MOD-ZRE01FD3              PIC X(8) VALUE 'ZRE01FD3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01UC9-001.
               PERFORM CALL-ZRE01FD3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01FD3-002.
               CALL 'ZRE01FD3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
