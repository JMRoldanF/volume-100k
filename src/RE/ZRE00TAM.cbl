      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00TAM'.
      ...
      * Called module names
       01  MOD-ZRE01Q53              PIC X(8) VALUE 'ZRE01Q53'.
       01  MOD-ZMB01PMT              PIC X(8) VALUE 'ZMB01PMT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01Q53-001.
               CALL 'ZRE01Q53' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01Q53 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMB01PMT-002.
               CALL 'ZMB01PMT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
