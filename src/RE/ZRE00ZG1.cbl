      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00ZG1'.
      ...
      * Called module names
       01  MOD-ZRE01G0F              PIC X(8) VALUE 'ZRE01G0F'.
       01  MOD-ZRE01PGP              PIC X(8) VALUE 'ZRE01PGP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01G0F-001.
               PERFORM CALL-ZRE01PGP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01G0F-001.
               CALL 'ZRE01G0F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01G0F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01PGP-002.
               CALL 'ZRE01PGP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01PGP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
