      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE0112N'.
      ...
      * Called module names
       01  MOD-ZUW01GBC              PIC X(8) VALUE 'ZUW01GBC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01GBC-001.
               CALL 'ZUW01GBC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01GBC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-COLOUR-0001.
