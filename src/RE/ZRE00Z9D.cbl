      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00Z9D'.
      ...
      * Called module names
       01  MOD-ZRE01UCJ              PIC X(8) VALUE 'ZRE01UCJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01UCJ-001.
               CALL 'ZRE01UCJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01UCJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
