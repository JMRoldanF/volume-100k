      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00X6X'.
      ...
      * Called module names
       01  MOD-ZRE01CVN              PIC X(8) VALUE 'ZRE01CVN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01CVN-001.
               CALL 'ZRE01CVN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01CVN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
