      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00MWX'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01HRH              PIC X(8) VALUE 'ZRE01HRH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01P33-001.
               PERFORM CALL-ZRE01HRH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01HRH-002.
               CALL 'ZRE01HRH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01HRH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
