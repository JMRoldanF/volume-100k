      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00JY9'.
      ...
      * Called module names
       01  MOD-ZRE00MC3              PIC X(8) VALUE 'ZRE00MC3'.
       01  MOD-ZRE01N6R              PIC X(8) VALUE 'ZRE01N6R'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE00MC3-001.
               PERFORM CALL-ZRE01N6R-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE00MC3-001.
               EXEC CICS LINK PROGRAM('ZRE00MC3')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00MC3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01N6R-002.
               CALL 'ZRE01N6R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01N6R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
