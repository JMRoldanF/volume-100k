      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00OO9'.
      ...
      * Called module names
       01  MOD-ZRE01DMB              PIC X(8) VALUE 'ZRE01DMB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01DMB-001.
               CALL 'ZRE01DMB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01DMB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01NPD-002.
