      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00LUJ'.
      ...
      * Called module names
       01  MOD-ZRE01RW1              PIC X(8) VALUE 'ZRE01RW1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01RW1-001.
               CALL 'ZRE01RW1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01RW1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
