      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE015C9'.
      ...
      * Called module names
       01  MOD-ZRE01ELL              PIC X(8) VALUE 'ZRE01ELL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01ELL-001.
               PERFORM CALL-ZAG0255S-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZRE01ELL-001.
               CALL 'ZRE01ELL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
