      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00XA9'.
      ...
      * Called module names
       01  MOD-ZRE01TKH              PIC X(8) VALUE 'ZRE01TKH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01TKH-001.
               CALL 'ZRE01TKH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01TKH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-MODEL-0001.
