      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00WL8'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01DUH              PIC X(8) VALUE 'ZRE01DUH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMB01HGF-001.
               PERFORM CALL-ZRE01DUH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01DUH-002.
               CALL 'ZRE01DUH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01DUH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
