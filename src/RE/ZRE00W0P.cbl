      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00W0P'.
      ...
      * Called module names
       01  MOD-ZCU01PI0              PIC X(8) VALUE 'ZCU01PI0'.
       01  MOD-ZRE01JMZ              PIC X(8) VALUE 'ZRE01JMZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01PI0-001.
               CALL 'ZCU01PI0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01JMZ-002.
               CALL 'ZRE01JMZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01JMZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
