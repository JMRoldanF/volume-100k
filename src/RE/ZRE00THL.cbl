      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00THL'.
      ...
      * Called module names
       01  MOD-ZRE01FTR              PIC X(8) VALUE 'ZRE01FTR'.
       01  MOD-ZCU01SAA              PIC X(8) VALUE 'ZCU01SAA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01FTR-001.
               PERFORM CALL-ZCU01SAA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01FTR-001.
               CALL 'ZRE01FTR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01FTR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01SAA-002.
               CALL 'ZCU01SAA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01SAA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
