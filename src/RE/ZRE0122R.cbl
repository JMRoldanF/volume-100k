      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE0122R'.
      ...
      * Called module names
       01  MOD-ZUW01L5I              PIC X(8) VALUE 'ZUW01L5I'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01L5I-001.
               PERFORM CALL-ZRE01IYJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01L5I-001.
               CALL 'ZUW01L5I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01L5I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01IYJ-002.
