      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00QZU'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01PPZ              PIC X(8) VALUE 'ZRE01PPZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01PPZ-002.
               CALL 'ZRE01PPZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01PPZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
