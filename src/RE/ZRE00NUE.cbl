      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00NUE'.
      ...
      * Called module names
       01  MOD-ZRE01OKL              PIC X(8) VALUE 'ZRE01OKL'.
       01  MOD-ZRE01MCQ              PIC X(8) VALUE 'ZRE01MCQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01OKL-001.
               PERFORM CALL-ZRE01MCQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01OKL-001.
               CALL 'ZRE01OKL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01OKL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01MCQ-002.
               CALL 'ZRE01MCQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01MCQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
