      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00QV5'.
      ...
      * Called module names
       01  MOD-ZRE01IAX              PIC X(8) VALUE 'ZRE01IAX'.
       01  MOD-ZRE01H5J              PIC X(8) VALUE 'ZRE01H5J'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01IAX-001.
               CALL 'ZRE01IAX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01H5J-002.
               CALL 'ZRE01H5J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01H5J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
