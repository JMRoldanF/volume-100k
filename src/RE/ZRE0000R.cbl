      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE0000R'.
      ...
      * Called module names
       01  MOD-ZRE00D6D              PIC X(8) VALUE 'ZRE00D6D'.
       01  MOD-ZRE00LB5              PIC X(8) VALUE 'ZRE00LB5'.
       01  MOD-ZPA004P5              PIC X(8) VALUE 'ZPA004P5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE00D6D-001.
               PERFORM CALL-ZRE00LB5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE00D6D-001.
               EXEC CICS LINK PROGRAM('ZRE00D6D')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00D6D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE00LB5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA004P5-003.
               EXEC CICS XCTL PROGRAM('ZPA004P5')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
