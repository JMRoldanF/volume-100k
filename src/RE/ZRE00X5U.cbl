      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00X5U'.
      ...
      * Called module names
       01  MOD-ZRE01MHS              PIC X(8) VALUE 'ZRE01MHS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01MHS-001.
               PERFORM CALL-ZRE01J1Y-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01MHS-001.
               CALL 'ZRE01MHS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01MHS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01J1Y-002.
               MOVE 'ZRE01J1Y' TO WS-SUBNAME-2
