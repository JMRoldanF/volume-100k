      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE016KZ'.
      ...
      * Called module names
       01  MOD-ZRE01TWF              PIC X(8) VALUE 'ZRE01TWF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01TWF-001.
               CALL 'ZRE01TWF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01TWF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
