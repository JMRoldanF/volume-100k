      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE0002M'.
      ...
      * Called module names
       ...
       01  MOD-ZRE00JPY              PIC X(8) VALUE 'ZRE00JPY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE00JPY-002.
               EXEC CICS LINK PROGRAM('ZRE00JPY')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00JPY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
