      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE014IG'.
      ...
      * Called module names
       01  MOD-ZRE01UIO              PIC X(8) VALUE 'ZRE01UIO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01UIO-001.
               CALL 'ZRE01UIO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01UIO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
