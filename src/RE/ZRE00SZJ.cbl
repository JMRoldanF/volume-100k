      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00SZJ'.
      ...
      * Called module names
       01  MOD-ZRE01LEB              PIC X(8) VALUE 'ZRE01LEB'.
       01  MOD-ZRE01P5L              PIC X(8) VALUE 'ZRE01P5L'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01LEB-001.
               PERFORM CALL-ZRE01P5L-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01LEB-001.
               CALL 'ZRE01LEB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01LEB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01P5L-002.
               CALL 'ZRE01P5L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01P5L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
