      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00QDD'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01GPP              PIC X(8) VALUE 'ZRE01GPP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01P15-001.
               PERFORM CALL-ZRE01GPP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01GPP-002.
               CALL 'ZRE01GPP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01GPP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
