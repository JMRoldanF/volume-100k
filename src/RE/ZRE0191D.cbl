      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE0191D'.
      ...
      * Called module names
       01  MOD-ZRE01E63              PIC X(8) VALUE 'ZRE01E63'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01E63-001.
               CALL 'ZRE01E63' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01E63 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
