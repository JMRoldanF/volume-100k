      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE0183G'.
      ...
      * Called module names
       01  MOD-ZRE01GWY              PIC X(8) VALUE 'ZRE01GWY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01GWY-001.
               CALL 'ZRE01GWY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01GWY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
