      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00MXL'.
      ...
      * Called module names
       ...
       01  MOD-ZSU01KNM              PIC X(8) VALUE 'ZSU01KNM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01HHQ-001.
               PERFORM CALL-ZSU01KNM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSU01KNM-002.
               CALL 'ZSU01KNM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01KNM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
