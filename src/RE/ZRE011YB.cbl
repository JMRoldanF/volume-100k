      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE011YB'.
      ...
      * Called module names
       01  MOD-ZRE01HR7              PIC X(8) VALUE 'ZRE01HR7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01HR7-001.
               CALL 'ZRE01HR7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01HR7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
