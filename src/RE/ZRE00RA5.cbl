      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00RA5'.
      ...
      * Called module names
       01  MOD-ZRE01OPH              PIC X(8) VALUE 'ZRE01OPH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01OPH-001.
               CALL 'ZRE01OPH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01OPH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
