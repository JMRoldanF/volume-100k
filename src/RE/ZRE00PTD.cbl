      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00PTD'.
      ...
      * Called module names
       01  MOD-ZRE01E6L              PIC X(8) VALUE 'ZRE01E6L'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01E6L-002.
               CALL 'ZRE01E6L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01E6L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
