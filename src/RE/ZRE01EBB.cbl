      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01EBB'.
      ...
      * Called module names
       01  MOD-ZRE01T7Z              PIC X(8) VALUE 'ZRE01T7Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01T7Z-001.
               CALL 'ZRE01T7Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
