      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00U6L'.
      ...
      * Called module names
       01  MOD-ZRE01CZT              PIC X(8) VALUE 'ZRE01CZT'.
       01  MOD-ZRE01MCH              PIC X(8) VALUE 'ZRE01MCH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01CZT-001.
               PERFORM CALL-ZRE01MCH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01CZT-001.
               CALL 'ZRE01CZT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01MCH-002.
               CALL 'ZRE01MCH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01MCH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
