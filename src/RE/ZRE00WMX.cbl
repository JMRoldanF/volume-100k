      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00WMX'.
      ...
      * Called module names
       01  MOD-ZRE01JIJ              PIC X(8) VALUE 'ZRE01JIJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01JIJ-001.
               CALL 'ZRE01JIJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01JIJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
