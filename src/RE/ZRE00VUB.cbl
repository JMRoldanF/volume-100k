      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00VUB'.
      ...
      * Called module names
       01  MOD-ZRE01NP3              PIC X(8) VALUE 'ZRE01NP3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01NP3-001.
               CALL 'ZRE01NP3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01NP3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01KBP-002.
