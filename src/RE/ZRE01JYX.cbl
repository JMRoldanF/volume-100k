      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01JYX'.
      ...
      * Called module names
       01  MOD-ZRE01ERP              PIC X(8) VALUE 'ZRE01ERP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01ERP-001.
               CALL 'ZRE01ERP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01ERP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
