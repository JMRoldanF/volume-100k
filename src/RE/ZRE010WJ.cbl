      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE010WJ'.
      ...
      * Called module names
       01  MOD-ZPA01OF9              PIC X(8) VALUE 'ZPA01OF9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01OF9-001.
               PERFORM CALL-ZRE01T6V-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01OF9-001.
               CALL 'ZPA01OF9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01OF9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01T6V-002.
