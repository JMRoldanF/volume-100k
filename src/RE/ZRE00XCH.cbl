      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00XCH'.
      ...
      * Called module names
       01  MOD-ZAG01Q6K              PIC X(8) VALUE 'ZAG01Q6K'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01Q6K-001.
               CALL 'ZAG01Q6K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01Q6K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
