      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01N54'.
      ...
      * Called module names
       01  MOD-ZRE01EJC              PIC X(8) VALUE 'ZRE01EJC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01EJC-001.
               CALL 'ZRE01EJC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01EJC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
