      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00PZH'.
      ...
      * Called module names
       01  MOD-ZRE01NPD              PIC X(8) VALUE 'ZRE01NPD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01NPD-001.
               PERFORM CALL-ZRE01GMN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01NPD-001.
               CALL 'ZRE01NPD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01NPD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01GMN-002.
