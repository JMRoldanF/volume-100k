      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00VVQ'.
      ...
      * Called module names
       01  MOD-ZRE01N9E              PIC X(8) VALUE 'ZRE01N9E'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01N9E-001.
               PERFORM CALL-ZRE01HZF-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01N9E-001.
               CALL 'ZRE01N9E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01N9E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01HZF-002.
