      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01HY5'.
      ...
      * Called module names
       01  MOD-ZRE01IZD              PIC X(8) VALUE 'ZRE01IZD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01IZD-001.
               CALL 'ZRE01IZD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01IZD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
