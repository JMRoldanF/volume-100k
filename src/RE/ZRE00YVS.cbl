      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00YVS'.
      ...
      * Called module names
       01  MOD-ZMB01OZ1              PIC X(8) VALUE 'ZMB01OZ1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMB01OZ1-001.
               CALL 'ZMB01OZ1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMB01OZ1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
