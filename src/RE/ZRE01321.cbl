      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01321'.
      ...
      * Called module names
       01  MOD-ZRE01OQL              PIC X(8) VALUE 'ZRE01OQL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01OQL-001.
               PERFORM CALL-ZRE01IG7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01OQL-001.
               CALL 'ZRE01OQL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01OQL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01IG7-002.
