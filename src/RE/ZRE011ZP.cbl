      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE011ZP'.
      ...
      * Called module names
       01  MOD-ZRE01G6J              PIC X(8) VALUE 'ZRE01G6J'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01G6J-001.
               PERFORM CALL-ZRE01V05-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01G6J-001.
               CALL 'ZRE01G6J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01G6J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01V05-002.
