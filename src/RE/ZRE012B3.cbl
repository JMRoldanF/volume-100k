      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE012B3'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01GOV              PIC X(8) VALUE 'ZRE01GOV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01OMP-001.
               PERFORM CALL-ZRE01GOV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01GOV-002.
               CALL 'ZRE01GOV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01GOV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
