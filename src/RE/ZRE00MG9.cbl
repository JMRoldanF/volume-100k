      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00MG9'.
      ...
      * Called module names
       01  MOD-ZRE01OA7              PIC X(8) VALUE 'ZRE01OA7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01OA7-001.
               CALL 'ZRE01OA7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01OA7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
