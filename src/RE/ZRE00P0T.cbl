      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00P0T'.
      ...
      * Called module names
       01  MOD-ZRE01D6T              PIC X(8) VALUE 'ZRE01D6T'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01D6T-002.
               CALL 'ZRE01D6T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01D6T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
