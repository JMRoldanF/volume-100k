      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00Z8D'.
      ...
      * Called module names
       01  MOD-ZRE01IQJ              PIC X(8) VALUE 'ZRE01IQJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01IQJ-001.
               PERFORM CALL-ZRE01OOO-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01IQJ-001.
               CALL 'ZRE01IQJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01IQJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01OOO-002.
