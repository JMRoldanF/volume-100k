      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00GD3'.
      ...
      * Called module names
       01  MOD-ZRE00OML              PIC X(8) VALUE 'ZRE00OML'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE00OML-001.
               PERFORM CALL-ZRE01QKP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE00OML-001.
               EXEC CICS LINK PROGRAM('ZRE00OML')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00OML FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01QKP-002.
