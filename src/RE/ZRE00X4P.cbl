      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00X4P'.
      ...
      * Called module names
       01  MOD-ZRE01FH9              PIC X(8) VALUE 'ZRE01FH9'.
       01  MOD-ZRE01HCR              PIC X(8) VALUE 'ZRE01HCR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01FH9-001.
               PERFORM CALL-ZRE01HCR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01FH9-001.
               CALL 'ZRE01FH9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01FH9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01HCR-002.
               CALL 'ZRE01HCR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01HCR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
