      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01277'.
      ...
      * Called module names
       01  MOD-ZRE01ISZ              PIC X(8) VALUE 'ZRE01ISZ'.
       01  MOD-ZHO01L4Q              PIC X(8) VALUE 'ZHO01L4Q'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01ISZ-001.
               PERFORM CALL-ZHO01L4Q-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01ISZ-001.
               CALL 'ZRE01ISZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01ISZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01L4Q-002.
               CALL 'ZHO01L4Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01L4Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
