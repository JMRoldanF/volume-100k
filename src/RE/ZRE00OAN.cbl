      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00OAN'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01PQ5              PIC X(8) VALUE 'ZRE01PQ5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01PQ5-002.
               CALL 'ZRE01PQ5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
