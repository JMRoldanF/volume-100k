      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00V17'.
      ...
      * Called module names
       01  MOD-ZRE01HWM              PIC X(8) VALUE 'ZRE01HWM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01HWM-001.
               PERFORM CALL-ZRE01HPZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01HWM-001.
               CALL 'ZRE01HWM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01HWM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01HPZ-002.
