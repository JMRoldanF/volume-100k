      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01DHL'.
      ...
      * Called module names
       01  MOD-ZPA01NW3              PIC X(8) VALUE 'ZPA01NW3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01NW3-001.
               CALL 'ZPA01NW3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01NW3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
