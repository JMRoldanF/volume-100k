      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00TH1'.
      ...
      * Called module names
       01  MOD-ZRE01T61              PIC X(8) VALUE 'ZRE01T61'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01T61-001.
               CALL 'ZRE01T61' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01T61 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-BEDROOMS-0001.
