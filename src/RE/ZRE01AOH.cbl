      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01AOH'.
      ...
      * Called module names
       01  MOD-ZMT01T15              PIC X(8) VALUE 'ZMT01T15'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01T15-001.
               PERFORM CALL-ZRE01EQ1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01T15-001.
               CALL 'ZMT01T15' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01T15 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01EQ1-002.
