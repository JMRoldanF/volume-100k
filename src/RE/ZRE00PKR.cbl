      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00PKR'.
      ...
      * Called module names
       01  MOD-ZRE01QQ9              PIC X(8) VALUE 'ZRE01QQ9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01QQ9-001.
               CALL 'ZRE01QQ9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01QQ9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
