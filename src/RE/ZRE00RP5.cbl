      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00RP5'.
      ...
      * Called module names
       01  MOD-ZRE01NC1              PIC X(8) VALUE 'ZRE01NC1'.
       01  MOD-ZRE01K33              PIC X(8) VALUE 'ZRE01K33'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01NC1-001.
               PERFORM CALL-ZRE01K33-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01NC1-001.
               CALL 'ZRE01NC1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01NC1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01K33-002.
               CALL 'ZRE01K33' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01K33 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
