      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00UPR'.
      ...
      * Called module names
       01  MOD-ZRE01V2N              PIC X(8) VALUE 'ZRE01V2N'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01V2N-001.
               PERFORM CALL-ZRE01R4F-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01V2N-001.
               CALL 'ZRE01V2N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01V2N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01R4F-002.
               MOVE 'ZRE01R4F' TO WS-SUBNAME-1
