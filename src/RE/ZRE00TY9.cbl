      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00TY9'.
      ...
      * Called module names
       01  MOD-ZRE01I9T              PIC X(8) VALUE 'ZRE01I9T'.
       01  MOD-ZRE01CRR              PIC X(8) VALUE 'ZRE01CRR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01I9T-001.
               PERFORM CALL-ZRE01CRR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01I9T-001.
               CALL 'ZRE01I9T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01I9T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01CRR-002.
               CALL 'ZRE01CRR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01CRR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-BEDROOMS-0001.
