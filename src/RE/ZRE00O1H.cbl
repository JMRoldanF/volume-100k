      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00O1H'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01PWU              PIC X(8) VALUE 'ZAG01PWU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01PWU-002.
               CALL 'ZAG01PWU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01PWU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
