      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00PQL'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01O6B              PIC X(8) VALUE 'ZRE01O6B'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01L3E-001.
               PERFORM CALL-ZRE01O6B-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01O6B-002.
               CALL 'ZRE01O6B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01O6B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
