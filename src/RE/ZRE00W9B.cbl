      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00W9B'.
      ...
      * Called module names
       01  MOD-ZAG01P02              PIC X(8) VALUE 'ZAG01P02'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01P02-001.
               CALL 'ZAG01P02' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01P02 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
