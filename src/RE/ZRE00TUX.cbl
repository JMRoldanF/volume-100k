      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00TUX'.
      ...
      * Called module names
       01  MOD-ZRE01KJ7              PIC X(8) VALUE 'ZRE01KJ7'.
       01  MOD-ZRE01F3X              PIC X(8) VALUE 'ZRE01F3X'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01KJ7-001.
               PERFORM CALL-ZRE01F3X-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01KJ7-001.
               CALL 'ZRE01KJ7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01KJ7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01F3X-002.
               CALL 'ZRE01F3X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01F3X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
