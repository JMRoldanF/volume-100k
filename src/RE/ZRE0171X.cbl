      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE0171X'.
      ...
      * Called module names
       01  MOD-ZRE01IO9              PIC X(8) VALUE 'ZRE01IO9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01IO9-001.
               CALL 'ZRE01IO9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01IO9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
