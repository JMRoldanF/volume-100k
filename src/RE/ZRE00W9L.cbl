      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00W9L'.
      ...
      * Called module names
       01  MOD-ZRE01Q5Z              PIC X(8) VALUE 'ZRE01Q5Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01Q5Z-001.
               CALL 'ZRE01Q5Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01Q5Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
