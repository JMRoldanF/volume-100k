      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE006KJ'.
      ...
      * Called module names
       01  MOD-ZRE011EC              PIC X(8) VALUE 'ZRE011EC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE011EC-001.
               EXEC CICS LINK PROGRAM('ZRE011EC')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE011EC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01SBZ-002.
