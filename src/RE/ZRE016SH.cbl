      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE016SH'.
      ...
      * Called module names
       01  MOD-ZRE01QFP              PIC X(8) VALUE 'ZRE01QFP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01QFP-001.
               CALL 'ZRE01QFP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01QFP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
