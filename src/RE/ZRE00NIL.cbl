      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00NIL'.
      ...
      * Called module names
       01  MOD-ZRE01KVZ              PIC X(8) VALUE 'ZRE01KVZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01KVZ-001.
               CALL 'ZRE01KVZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01KVZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01H1X-002.
