      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00WOV'.
      ...
      * Called module names
       01  MOD-ZRE01S35              PIC X(8) VALUE 'ZRE01S35'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01S35-001.
               PERFORM CALL-ZRE01SA3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01S35-001.
               CALL 'ZRE01S35' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01S35 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01SA3-002.
