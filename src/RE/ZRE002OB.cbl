      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE002OB'.
      ...
      * Called module names
       01  MOD-ZRE00DLD              PIC X(8) VALUE 'ZRE00DLD'.
       01  MOD-ZRE00J8P              PIC X(8) VALUE 'ZRE00J8P'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE00DLD-001.
               PERFORM CALL-ZRE00J8P-002.
               PERFORM CALL-ZRE00KAR-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE00DLD-001.
               EXEC CICS LINK PROGRAM('ZRE00DLD')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00DLD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE00J8P-002.
               EXEC CICS LINK PROGRAM('ZRE00J8P')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00J8P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE00KAR-003.
