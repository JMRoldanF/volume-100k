      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00ZD9'.
      ...
      * Called module names
       01  MOD-ZRE01GFF              PIC X(8) VALUE 'ZRE01GFF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01GFF-001.
               CALL 'ZRE01GFF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01GFF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
