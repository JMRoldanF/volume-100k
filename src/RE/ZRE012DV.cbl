      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE012DV'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01FIR              PIC X(8) VALUE 'ZMT01FIR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01FIR-002.
               CALL 'ZMT01FIR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01FIR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
