      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00TCB'.
      ...
      * Called module names
       01  MOD-ZRE01MEF              PIC X(8) VALUE 'ZRE01MEF'.
       01  MOD-ZRE01DLR              PIC X(8) VALUE 'ZRE01DLR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01MEF-001.
               PERFORM CALL-ZRE01DLR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01MEF-001.
               CALL 'ZRE01MEF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01MEF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01DLR-002.
               CALL 'ZRE01DLR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01DLR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-PREMIUM-0001.
