      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE011JB'.
      ...
      * Called module names
       01  MOD-ZRE01IIU              PIC X(8) VALUE 'ZRE01IIU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01IIU-001.
               PERFORM CALL-ZRE01LPJ-002.
               PERFORM CALL-ZBI0255Q-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZRE01IIU-001.
               CALL 'ZRE01IIU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01IIU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01LPJ-002.
