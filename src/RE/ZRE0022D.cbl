      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE0022D'.
      ...
      * Called module names
       01  MOD-ZRE00DJP              PIC X(8) VALUE 'ZRE00DJP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE00DIB-001.
               PERFORM CALL-ZRE00DJP-002.
               PERFORM CALL-ZRE008BN-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE00DIB-001.
               MOVE 'ZRE00DIB' TO WS-PROGNAME-8
      ...
      *----------------------------------------------------------------*
       CALL-ZRE00DJP-002.
               EXEC CICS LINK PROGRAM('ZRE00DJP')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00DJP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE008BN-003.
