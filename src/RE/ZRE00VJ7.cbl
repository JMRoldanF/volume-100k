      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00VJ7'.
      ...
      * Called module names
       01  MOD-ZRE01EP7              PIC X(8) VALUE 'ZRE01EP7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01EP7-001.
               CALL 'ZRE01EP7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01EP7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
