      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00XJF'.
      ...
      * Called module names
       01  MOD-ZRE01M7H              PIC X(8) VALUE 'ZRE01M7H'.
       01  MOD-ZRE01OC5              PIC X(8) VALUE 'ZRE01OC5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01M7H-001.
               PERFORM CALL-ZRE01OC5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01M7H-001.
               CALL 'ZRE01M7H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01M7H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01OC5-002.
               CALL 'ZRE01OC5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
