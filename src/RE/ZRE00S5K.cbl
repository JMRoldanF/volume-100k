      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00S5K'.
      ...
      * Called module names
       01  MOD-ZRE01H2K              PIC X(8) VALUE 'ZRE01H2K'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01H2K-001.
               CALL 'ZRE01H2K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01H2K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
