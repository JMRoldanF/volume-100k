      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE001MJ'.
      ...
      * Called module names
       01  MOD-ZRE00FK7              PIC X(8) VALUE 'ZRE00FK7'.
       01  MOD-ZRE00FI9              PIC X(8) VALUE 'ZRE00FI9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE00FK7-001.
               PERFORM CALL-ZRE00FI9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE00FK7-001.
               EXEC CICS LINK PROGRAM('ZRE00FK7')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00FK7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE00FI9-002.
               EXEC CICS LINK PROGRAM('ZRE00FI9')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00FI9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
