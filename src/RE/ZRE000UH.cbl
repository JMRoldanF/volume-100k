      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE000UH'.
      ...
      * Called module names
       01  MOD-ZRE00B47              PIC X(8) VALUE 'ZRE00B47'.
       01  MOD-ZRE00CAP              PIC X(8) VALUE 'ZRE00CAP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE008Z9-001.
               PERFORM CALL-ZRE008V3-002.
               PERFORM CALL-ZRE00B47-003.
               PERFORM CALL-ZRE00CAP-004.
               PERFORM CALL-ZRE00IPT-005.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE008Z9-001.
               MOVE 'ZRE008Z9' TO WS-PROGNAME-7
      ...
      *----------------------------------------------------------------*
       CALL-ZRE008V3-002.
               MOVE 'ZRE008V3' TO WS-PROGNAME-8
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE008V3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE00B47-003.
               EXEC CICS LINK PROGRAM('ZRE00B47')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00B47 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE00CAP-004.
               EXEC CICS LINK PROGRAM('ZRE00CAP')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00CAP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE00IPT-005.
