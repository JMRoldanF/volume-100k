      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00SEL'.
      ...
      * Called module names
       01  MOD-ZRE01TU9              PIC X(8) VALUE 'ZRE01TU9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01TU9-001.
               PERFORM CALL-ZMB01E68-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01TU9-001.
               CALL 'ZRE01TU9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01TU9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMB01E68-002.
               MOVE 'ZMB01E68' TO WS-SUBNAME-4
