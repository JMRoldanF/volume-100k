      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00MWN'.
      ...
      * Called module names
       01  MOD-ZRE01R31              PIC X(8) VALUE 'ZRE01R31'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01R31-001.
               CALL 'ZRE01R31' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01R31 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
