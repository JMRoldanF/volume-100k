      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00TMB'.
      ...
      * Called module names
       01  MOD-ZHO01UYC              PIC X(8) VALUE 'ZHO01UYC'.
       01  MOD-ZRE01UPV              PIC X(8) VALUE 'ZRE01UPV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01UYC-001.
               PERFORM CALL-ZRE01UPV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01UYC-001.
               CALL 'ZHO01UYC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01UYC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01UPV-002.
               CALL 'ZRE01UPV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01UPV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
