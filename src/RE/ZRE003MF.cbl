      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE003MF'.
      ...
      * Called module names
       01  MOD-ZRE00D17              PIC X(8) VALUE 'ZRE00D17'.
       01  MOD-ZSU006RP              PIC X(8) VALUE 'ZSU006RP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE00D17-001.
               PERFORM CALL-ZSU006RP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE00D17-001.
               EXEC CICS LINK PROGRAM('ZRE00D17')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00D17 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSU006RP-002.
               EXEC CICS LINK PROGRAM('ZSU006RP')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU006RP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
