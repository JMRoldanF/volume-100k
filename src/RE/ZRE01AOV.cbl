      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01AOV'.
      ...
      * Called module names
       01  MOD-ZRE01L37              PIC X(8) VALUE 'ZRE01L37'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01L37-001.
               CALL 'ZRE01L37' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01L37 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
