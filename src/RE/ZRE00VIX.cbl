      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00VIX'.
      ...
      * Called module names
       01  MOD-ZRE01CTP              PIC X(8) VALUE 'ZRE01CTP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01OIB-001.
               PERFORM CALL-ZRE01CTP-002.
               PERFORM CALL-ZMT0255L-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZPA01OIB-001.
               MOVE 'ZPA01OIB' TO WS-SUBNAME-4
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01CTP-002.
               CALL 'ZRE01CTP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01CTP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
