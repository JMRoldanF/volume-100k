      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00R91'.
      ...
      * Called module names
       01  MOD-ZRE01P1F              PIC X(8) VALUE 'ZRE01P1F'.
       01  MOD-ZHO01HT0              PIC X(8) VALUE 'ZHO01HT0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01P1F-001.
               PERFORM CALL-ZHO01HT0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01P1F-001.
               CALL 'ZRE01P1F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01P1F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01HT0-002.
               CALL 'ZHO01HT0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01HT0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
