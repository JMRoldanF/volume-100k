      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00GC9'.
      ...
      * Called module names
       01  MOD-ZRE00ZJN              PIC X(8) VALUE 'ZRE00ZJN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE011F5-001.
               MOVE 'ZRE011F5' TO WS-PROGNAME-3
      ...
      *----------------------------------------------------------------*
       CALL-ZRE00ZJN-002.
               EXEC CICS LINK PROGRAM('ZRE00ZJN')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00ZJN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
