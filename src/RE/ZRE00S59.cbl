      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00S59'.
      ...
      * Called module names
       01  MOD-ZRE01PZ1              PIC X(8) VALUE 'ZRE01PZ1'.
       01  MOD-ZMT01HLH              PIC X(8) VALUE 'ZMT01HLH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01PZ1-001.
               PERFORM CALL-ZMT01HLH-002.
               ...
               PERFORM CHECK-MANAGED-FUND-0098.
               ...
               PERFORM CHECK-BROKER-ID-0106.
               PERFORM COMPUTE-MODEL-0107.
               PERFORM SQL-ACCESS-0108.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZRE01PZ1-001.
               CALL 'ZRE01PZ1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01PZ1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01HLH-002.
               CALL 'ZMT01HLH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01HLH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
