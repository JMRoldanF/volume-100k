      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE01A3D'.
      ...
      * Called module names
       01  MOD-ZRE01KFV              PIC X(8) VALUE 'ZRE01KFV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01KFV-001.
               PERFORM CALL-ZRE01L69-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01KFV-001.
               CALL 'ZRE01KFV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01KFV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01L69-002.
