      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00ODZ'.
      ...
      * Called module names
       01  MOD-ZCL01ROX              PIC X(8) VALUE 'ZCL01ROX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01ROX-001.
               CALL 'ZCL01ROX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01ROX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
