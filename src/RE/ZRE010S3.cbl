      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE010S3'.
      ...
      * Called module names
       01  MOD-ZRE01E1L              PIC X(8) VALUE 'ZRE01E1L'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01E1L-001.
               CALL 'ZRE01E1L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01E1L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
