      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00OBR'.
      ...
      * Called module names
       01  MOD-ZRE01OX9              PIC X(8) VALUE 'ZRE01OX9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01OX9-001.
               CALL 'ZRE01OX9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01OX9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-MAKE-0001.
