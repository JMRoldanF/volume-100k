      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00WU5'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01IKU              PIC X(8) VALUE 'ZCU01IKU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01NMS-001.
               PERFORM CALL-ZCU01IKU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01IKU-002.
               CALL 'ZCU01IKU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01IKU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
