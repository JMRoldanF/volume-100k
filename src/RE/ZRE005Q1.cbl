      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE005Q1'.
      ...
      * Called module names
       01  MOD-ZCL0061X              PIC X(8) VALUE 'ZCL0061X'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE007N7-001.
               PERFORM CALL-ZRE00J5D-002.
               PERFORM CALL-ZCL0061X-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE007N7-001.
               MOVE 'ZRE007N7' TO WS-PROGNAME-8
      ...
      *----------------------------------------------------------------*
       CALL-ZRE00J5D-002.
               MOVE 'ZRE00J5D' TO WS-PROGNAME-1
      ...
      *----------------------------------------------------------------*
       CALL-ZCL0061X-003.
               EXEC CICS XCTL PROGRAM('ZCL0061X')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL0061X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-004.
