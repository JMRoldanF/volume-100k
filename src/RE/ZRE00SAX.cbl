      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00SAX'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01PMS              PIC X(8) VALUE 'ZRE01PMS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01PMS-002.
               CALL 'ZRE01PMS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01PMS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
