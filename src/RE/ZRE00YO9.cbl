      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRE00YO9'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01DXP              PIC X(8) VALUE 'ZRE01DXP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01K15-001.
               PERFORM CALL-ZRE01DXP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01DXP-002.
               CALL 'ZRE01DXP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01DXP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-MAKE-0001.
