      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI001JQ'.
      ...
      * Called module names
       01  MOD-ZCU00EU0              PIC X(8) VALUE 'ZCU00EU0'.
       01  MOD-ZEN00ENV              PIC X(8) VALUE 'ZEN00ENV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU00EU0-001.
               PERFORM CALL-ZEN00ENV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU00EU0-001.
               EXEC CICS LINK PROGRAM('ZCU00EU0')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00EU0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN00ENV-002.
               EXEC CICS LINK PROGRAM('ZEN00ENV')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN00ENV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
