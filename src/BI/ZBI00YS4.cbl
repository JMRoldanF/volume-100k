      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00YS4'.
      ...
      * Called module names
       01  MOD-ZCU01EXQ              PIC X(8) VALUE 'ZCU01EXQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01EXQ-001.
               CALL 'ZCU01EXQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01EXQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
