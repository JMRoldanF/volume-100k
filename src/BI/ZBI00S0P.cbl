      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00S0P'.
      ...
      * Called module names
       01  MOD-ZBI01N7A              PIC X(8) VALUE 'ZBI01N7A'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01N7A-001.
               CALL 'ZBI01N7A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01N7A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
