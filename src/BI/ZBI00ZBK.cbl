      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00ZBK'.
      ...
      * Called module names
       01  MOD-ZBI01O0G              PIC X(8) VALUE 'ZBI01O0G'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01O0G-001.
               CALL 'ZBI01O0G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01O0G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
