      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00QQY'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01EXS              PIC X(8) VALUE 'ZBI01EXS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01E42-001.
               PERFORM CALL-ZBI01EXS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01EXS-002.
               CALL 'ZBI01EXS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01EXS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-TERM-0001.
