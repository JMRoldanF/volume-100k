      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00YIY'.
      ...
      * Called module names
       01  MOD-ZBI01HIU              PIC X(8) VALUE 'ZBI01HIU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01DJI-001.
               PERFORM CALL-ZBI01HIU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01DJI-001.
               MOVE 'ZBI01DJI' TO WS-SUBNAME-3
               CALL WS-SUBNAME-3 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01DJI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01HIU-002.
               CALL 'ZBI01HIU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
