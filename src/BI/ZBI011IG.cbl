      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI011IG'.
      ...
      * Called module names
       01  MOD-ZBI01K14              PIC X(8) VALUE 'ZBI01K14'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01K14-001.
               CALL 'ZBI01K14' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01K14 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
