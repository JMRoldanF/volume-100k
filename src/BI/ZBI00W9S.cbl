      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00W9S'.
      ...
      * Called module names
       01  MOD-ZBI01S5E              PIC X(8) VALUE 'ZBI01S5E'.
       01  MOD-ZBI01TA0              PIC X(8) VALUE 'ZBI01TA0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01S5E-001.
               PERFORM CALL-ZBI01TA0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01S5E-001.
               CALL 'ZBI01S5E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01S5E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01TA0-002.
               CALL 'ZBI01TA0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01TA0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
