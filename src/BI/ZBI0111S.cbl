      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI0111S'.
      ...
      * Called module names
       01  MOD-ZPA01DLT              PIC X(8) VALUE 'ZPA01DLT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01DLT-001.
               CALL 'ZPA01DLT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01DLT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
