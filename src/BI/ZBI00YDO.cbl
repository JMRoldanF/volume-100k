      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00YDO'.
      ...
      * Called module names
       01  MOD-ZAG01S0Y              PIC X(8) VALUE 'ZAG01S0Y'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01S0Y-001.
               CALL 'ZAG01S0Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01S0Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
