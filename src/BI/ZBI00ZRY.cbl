      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00ZRY'.
      ...
      * Called module names
       01  MOD-ZBI01RJO              PIC X(8) VALUE 'ZBI01RJO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01RJO-001.
               CALL 'ZBI01RJO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01RJO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
