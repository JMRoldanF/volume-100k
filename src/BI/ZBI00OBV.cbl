      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00OBV'.
      ...
      * Called module names
       01  MOD-ZBI01E9X              PIC X(8) VALUE 'ZBI01E9X'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01E9X-001.
               PERFORM CALL-ZBI01OH3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01E9X-001.
               CALL 'ZBI01E9X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01E9X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01OH3-002.
