      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI021BO'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01NIO              PIC X(8) VALUE 'ZBI01NIO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01NIO-002.
               CALL 'ZBI01NIO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01NIO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
