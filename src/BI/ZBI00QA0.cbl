      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00QA0'.
      ...
      * Called module names
       01  MOD-ZBI01S8Y              PIC X(8) VALUE 'ZBI01S8Y'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01S8Y-001.
               CALL 'ZBI01S8Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01S8Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
