      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00SUV'.
      ...
      * Called module names
       01  MOD-ZBI01KNF              PIC X(8) VALUE 'ZBI01KNF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01KNF-001.
               PERFORM CALL-ZQU01QY8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01KNF-001.
               CALL 'ZBI01KNF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01KNF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZQU01QY8-002.
