      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00RZ7'.
      ...
      * Called module names
       01  MOD-ZBI01ORZ              PIC X(8) VALUE 'ZBI01ORZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01ORZ-001.
               CALL 'ZBI01ORZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01ORZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01SSI-002.
