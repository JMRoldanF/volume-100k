      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI001W8'.
      ...
      * Called module names
       01  MOD-ZBI00DDA              PIC X(8) VALUE 'ZBI00DDA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI00BGE-001.
               PERFORM CALL-ZBI00DDA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI00BGE-001.
               MOVE 'ZBI00BGE' TO WS-PROGNAME-7
      ...
      *----------------------------------------------------------------*
       CALL-ZBI00DDA-002.
               EXEC CICS LINK PROGRAM('ZBI00DDA')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI00DDA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
