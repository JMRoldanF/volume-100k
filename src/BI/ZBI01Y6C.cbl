      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI01Y6C'.
      ...
      * Called module names
       01  MOD-ZEN01UBV              PIC X(8) VALUE 'ZEN01UBV'.
       01  MOD-ZBI01J5G              PIC X(8) VALUE 'ZBI01J5G'.
       01  MOD-ZBI00NBM              PIC X(8) VALUE 'ZBI00NBM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01UBV-002.
               PERFORM CALL-ZBI01J5G-003.
               PERFORM CALL-ZBI00NBM-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01UBV-002.
               CALL 'ZEN01UBV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
      ...
      *----------------------------------------------------------------*
       CALL-ZBI00NBM-004.
               CALL 'ZBI00NBM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI00NBM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
