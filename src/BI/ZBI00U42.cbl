      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00U42'.
      ...
      * Called module names
       01  MOD-ZBI01KBE              PIC X(8) VALUE 'ZBI01KBE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01KBE-001.
               CALL 'ZBI01KBE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01KBE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
