      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI002OA'.
      ...
      * Called module names
       01  MOD-ZBI009WU              PIC X(8) VALUE 'ZBI009WU'.
       01  MOD-ZBI00LFK              PIC X(8) VALUE 'ZBI00LFK'.
       01  MOD-ZPA00DSX              PIC X(8) VALUE 'ZPA00DSX'.
       01  MOD-ZEN00355              PIC X(8) VALUE 'ZEN00355'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI009WU-001.
               PERFORM CALL-ZBI00LFK-002.
               PERFORM CALL-ZPA00DSX-003.
               PERFORM CALL-ZEN00355-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI009WU-001.
               EXEC CICS LINK PROGRAM('ZBI009WU')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI009WU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI00LFK-002.
               EXEC CICS LINK PROGRAM('ZBI00LFK')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI00LFK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA00DSX-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN00355-004.
               EXEC CICS XCTL PROGRAM('ZEN00355')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN00355 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-005.
