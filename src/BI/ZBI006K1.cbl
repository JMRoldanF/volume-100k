      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI006K1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI013KF-002.
               PERFORM CALL-ZBI01PNS-003.
               PERFORM CALL-ZBI01P3H-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI013KF-002.
               MOVE 'ZBI013KF' TO WS-PROGNAME-3
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI013KF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01PNS-003.
               MOVE 'ZBI01PNS' TO WS-SUBNAME-4
