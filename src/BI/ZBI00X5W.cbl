      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00X5W'.
      ...
      * Called module names
       01  MOD-ZBI01HFK              PIC X(8) VALUE 'ZBI01HFK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01HFK-001.
               CALL 'ZBI01HFK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01HFK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01NBK-002.
