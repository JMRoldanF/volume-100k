      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00XJC'.
      ...
      * Called module names
       01  MOD-ZBI01LPY              PIC X(8) VALUE 'ZBI01LPY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01LPY-001.
               CALL 'ZBI01LPY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01LPY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
