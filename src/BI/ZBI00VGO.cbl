      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00VGO'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01NR0              PIC X(8) VALUE 'ZBI01NR0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01DFM-001.
               PERFORM CALL-ZBI01NR0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01NR0-002.
               CALL 'ZBI01NR0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
