      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00VX2'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01CQW              PIC X(8) VALUE 'ZBI01CQW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01CQW-002.
               CALL 'ZBI01CQW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01CQW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-POSTCODE-0001.
