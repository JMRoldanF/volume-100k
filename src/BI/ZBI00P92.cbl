      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00P92'.
      ...
      * Called module names
       01  MOD-ZBI01N48              PIC X(8) VALUE 'ZBI01N48'.
       01  MOD-ZBI01K46              PIC X(8) VALUE 'ZBI01K46'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01N48-001.
               PERFORM CALL-ZBI01K46-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01N48-001.
               CALL 'ZBI01N48' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01N48 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01K46-002.
               CALL 'ZBI01K46' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01K46 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-EXCESS-0001.
