      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00R2N'.
      ...
      * Called module names
       01  MOD-ZLB01FG2              PIC X(8) VALUE 'ZLB01FG2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01FG2-001.
               CALL 'ZLB01FG2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01FG2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
