      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00ZR4'.
      ...
      * Called module names
       01  MOD-ZBI01HI0              PIC X(8) VALUE 'ZBI01HI0'.
       01  MOD-ZBI01FPK              PIC X(8) VALUE 'ZBI01FPK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01HI0-001.
               PERFORM CALL-ZBI01FPK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01HI0-001.
               CALL 'ZBI01HI0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01HI0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01FPK-002.
               CALL 'ZBI01FPK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01FPK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
