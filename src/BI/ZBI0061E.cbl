      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI0061E'.
      ...
      * Called module names
       ...
       01  MOD-ZBI00BWI              PIC X(8) VALUE 'ZBI00BWI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL00K7D-001.
               PERFORM CALL-ZBI00BWI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI00BWI-002.
               EXEC CICS LINK PROGRAM('ZBI00BWI')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI00BWI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
