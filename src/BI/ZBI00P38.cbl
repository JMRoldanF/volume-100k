      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00P38'.
      ...
      * Called module names
       01  MOD-ZBI01TZ6              PIC X(8) VALUE 'ZBI01TZ6'.
       01  MOD-ZBI01MQC              PIC X(8) VALUE 'ZBI01MQC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01TZ6-001.
               PERFORM CALL-ZBI01MQC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01TZ6-001.
               CALL 'ZBI01TZ6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01TZ6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01MQC-002.
               CALL 'ZBI01MQC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01MQC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
