      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI0041V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZQU00DBS-001.
               MOVE 'ZQU00DBS' TO WS-PROGNAME-4
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU00DBS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI00LH9-002.
