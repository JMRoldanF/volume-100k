      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00VD2'.
      ...
      * Called module names
       01  MOD-ZBI01ISY              PIC X(8) VALUE 'ZBI01ISY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01ISY-001.
               CALL 'ZBI01ISY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01ISY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
