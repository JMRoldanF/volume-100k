      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00ZUJ'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01V24              PIC X(8) VALUE 'ZBI01V24'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01U5U-001.
               PERFORM CALL-ZBI01V24-002.
               ...
               PERFORM RESOLVE-SUM-ASSURED-0094.
               ...
               PERFORM APPLY-STATUS-CODE-0107.
               PERFORM SQL-ACCESS-0108.
               PERFORM EXPAND-EXCESS-0109.
               ...
               PERFORM RESOLVE-BROKER-ID-0115.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01V24-002.
               CALL 'ZBI01V24' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01V24 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
