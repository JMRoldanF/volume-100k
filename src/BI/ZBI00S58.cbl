      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00S58'.
      ...
      * Called module names
       01  MOD-ZMT01GGN              PIC X(8) VALUE 'ZMT01GGN'.
       01  MOD-ZMT01N2Z              PIC X(8) VALUE 'ZMT01N2Z'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01GGN-001.
               PERFORM CALL-ZMT01N2Z-002.
               ...
               PERFORM COMPUTE-MANAGED-FUND-0053.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01GGN-001.
               CALL 'ZMT01GGN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01GGN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01N2Z-002.
               CALL 'ZMT01N2Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01N2Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
