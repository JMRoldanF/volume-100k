      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00SV2'.
      ...
      * Called module names
       01  MOD-ZUW01HAC              PIC X(8) VALUE 'ZUW01HAC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01HAC-001.
               PERFORM CALL-ZBI01EQ0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01HAC-001.
               CALL 'ZUW01HAC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01HAC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01EQ0-002.
