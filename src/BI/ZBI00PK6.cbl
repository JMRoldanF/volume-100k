      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00PK6'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01FSM              PIC X(8) VALUE 'ZBI01FSM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01FSM-002.
               CALL 'ZBI01FSM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01FSM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
