      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI019U6'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01IE0              PIC X(8) VALUE 'ZAG01IE0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01IE0-002.
               CALL 'ZAG01IE0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01IE0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
