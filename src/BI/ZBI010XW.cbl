      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI010XW'.
      ...
      * Called module names
       01  MOD-ZAG01GBA              PIC X(8) VALUE 'ZAG01GBA'.
       01  MOD-ZCL01TKP              PIC X(8) VALUE 'ZCL01TKP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01GBA-001.
               PERFORM CALL-ZCL01TKP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01GBA-001.
               CALL 'ZAG01GBA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01GBA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01TKP-002.
               CALL 'ZCL01TKP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01TKP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
