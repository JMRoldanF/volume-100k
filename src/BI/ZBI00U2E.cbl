      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00U2E'.
      ...
      * Called module names
       01  MOD-ZBI01FUU              PIC X(8) VALUE 'ZBI01FUU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01FUU-001.
               CALL 'ZBI01FUU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01FUU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-PREMIUM-0001.
