      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI0126W'.
      ...
      * Called module names
       01  MOD-ZBI01HRG              PIC X(8) VALUE 'ZBI01HRG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01HRG-001.
               CALL 'ZBI01HRG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01HRG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01O74-002.
