      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00NP1'.
      ...
      * Called module names
       01  MOD-ZBI01LCW              PIC X(8) VALUE 'ZBI01LCW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01LCW-001.
               CALL 'ZBI01LCW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01LCW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
