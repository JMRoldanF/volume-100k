      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00YDP'.
      ...
      * Called module names
       01  MOD-ZBI01Q5Z              PIC X(8) VALUE 'ZBI01Q5Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01Q5Z-001.
               CALL 'ZBI01Q5Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01Q5Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-MODEL-0001.
