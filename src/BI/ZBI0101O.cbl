      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI0101O'.
      ...
      * Called module names
       01  MOD-ZBI01K4Q              PIC X(8) VALUE 'ZBI01K4Q'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01K4Q-001.
               PERFORM CALL-ZBI01TII-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01K4Q-001.
               CALL 'ZBI01K4Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01K4Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01TII-002.
