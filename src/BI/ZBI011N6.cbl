      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI011N6'.
      ...
      * Called module names
       01  MOD-ZBI01R76              PIC X(8) VALUE 'ZBI01R76'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01R76-001.
               CALL 'ZBI01R76' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01R76 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-POSTCODE-0001.
