      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00VFK'.
      ...
      * Called module names
       01  MOD-ZBI01EL0              PIC X(8) VALUE 'ZBI01EL0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01EL0-001.
               CALL 'ZBI01EL0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01EL0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01RT5-002.
