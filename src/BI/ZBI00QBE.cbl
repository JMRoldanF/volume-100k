      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00QBE'.
      ...
      * Called module names
       01  MOD-ZBI01NWA              PIC X(8) VALUE 'ZBI01NWA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01NWA-001.
               CALL 'ZBI01NWA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01NWA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
