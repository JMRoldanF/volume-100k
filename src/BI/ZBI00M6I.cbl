      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00M6I'.
      ...
      * Called module names
       01  MOD-ZUW01P6I              PIC X(8) VALUE 'ZUW01P6I'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01P6I-001.
               CALL 'ZUW01P6I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01P6I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
