      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00UHW'.
      ...
      * Called module names
       01  MOD-ZBI01JAD              PIC X(8) VALUE 'ZBI01JAD'.
       01  MOD-ZBI01IB7              PIC X(8) VALUE 'ZBI01IB7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01JAD-001.
               PERFORM CALL-ZBI01IB7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01JAD-001.
               CALL 'ZBI01JAD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01JAD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01IB7-002.
               CALL 'ZBI01IB7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01IB7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
