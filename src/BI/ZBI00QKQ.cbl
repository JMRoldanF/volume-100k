      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00QKQ'.
      ...
      * Called module names
       01  MOD-ZBI01S12              PIC X(8) VALUE 'ZBI01S12'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01S12-001.
               CALL 'ZBI01S12' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01S12 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
