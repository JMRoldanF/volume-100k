      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI005WJ'.
      ...
      * Called module names
       01  MOD-ZBI00C2Q              PIC X(8) VALUE 'ZBI00C2Q'.
       01  MOD-ZRN00HVM              PIC X(8) VALUE 'ZRN00HVM'.
       01  MOD-ZBI002IG              PIC X(8) VALUE 'ZBI002IG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI00C2Q-001.
               PERFORM CALL-ZBI00BZT-002.
               PERFORM CALL-ZRN00HVM-003.
               PERFORM CALL-ZBI002IG-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI00C2Q-001.
               EXEC CICS LINK PROGRAM('ZBI00C2Q')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI00C2Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI00BZT-002.
               MOVE 'ZBI00BZT' TO WS-PROGNAME-1
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI00BZT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRN00HVM-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI002IG-004.
               EXEC CICS XCTL PROGRAM('ZBI002IG')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI002IG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-005.
