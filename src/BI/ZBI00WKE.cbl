      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00WKE'.
      ...
      * Called module names
       01  MOD-ZBI01FCI              PIC X(8) VALUE 'ZBI01FCI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01FCI-001.
               PERFORM CALL-ZBI01OGU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01FCI-001.
               CALL 'ZBI01FCI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01FCI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01OGU-002.
