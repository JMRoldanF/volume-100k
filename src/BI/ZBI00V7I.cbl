      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00V7I'.
      ...
      * Called module names
       01  MOD-ZBI01OWY              PIC X(8) VALUE 'ZBI01OWY'.
       01  MOD-ZHO01F5G              PIC X(8) VALUE 'ZHO01F5G'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01OWY-001.
               PERFORM CALL-ZHO01F5G-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01OWY-001.
               CALL 'ZBI01OWY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01OWY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01F5G-002.
               CALL 'ZHO01F5G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01F5G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-MAKE-0001.
