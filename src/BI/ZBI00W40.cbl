      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00W40'.
      ...
      * Called module names
       01  MOD-ZBI01CQ2              PIC X(8) VALUE 'ZBI01CQ2'.
       01  MOD-ZBI01QOU              PIC X(8) VALUE 'ZBI01QOU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01CQ2-001.
               PERFORM CALL-ZBI01QOU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01CQ2-001.
               CALL 'ZBI01CQ2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01CQ2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01QOU-002.
               CALL 'ZBI01QOU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01QOU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
