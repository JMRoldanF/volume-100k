      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00LM8'.
      ...
      * Called module names
       01  MOD-ZUW01EG4              PIC X(8) VALUE 'ZUW01EG4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01EG4-001.
               PERFORM CALL-ZEN01CPP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01EG4-001.
               CALL 'ZUW01EG4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01EG4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01CPP-002.
