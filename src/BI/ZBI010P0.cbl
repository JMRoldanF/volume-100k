      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI010P0'.
      ...
      * Called module names
       01  MOD-ZBI01SB6              PIC X(8) VALUE 'ZBI01SB6'.
       01  MOD-ZBI01CYY              PIC X(8) VALUE 'ZBI01CYY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01SB6-001.
               PERFORM CALL-ZBI01CYY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01SB6-001.
               CALL 'ZBI01SB6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01SB6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01CYY-002.
               CALL 'ZBI01CYY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01CYY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-TERM-0001.
