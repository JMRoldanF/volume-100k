      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00U2N'.
      ...
      * Called module names
       01  MOD-ZBI01R5G              PIC X(8) VALUE 'ZBI01R5G'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01R5G-001.
               CALL 'ZBI01R5G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01R5G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01INQ-002.
