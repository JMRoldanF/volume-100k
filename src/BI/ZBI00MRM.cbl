      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00MRM'.
      ...
      * Called module names
       01  MOD-ZBI01G8Q              PIC X(8) VALUE 'ZBI01G8Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01G8Q-001.
               CALL 'ZBI01G8Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01G8Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-COLOUR-0001.
