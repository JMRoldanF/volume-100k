      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00O70'.
      ...
      * Called module names
       01  MOD-ZBI01SIY              PIC X(8) VALUE 'ZBI01SIY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01SIY-001.
               CALL 'ZBI01SIY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01SIY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
