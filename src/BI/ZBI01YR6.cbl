      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI01YR6'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01JZ6              PIC X(8) VALUE 'ZBI01JZ6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01JZ6-002.
               CALL 'ZBI01JZ6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01JZ6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
