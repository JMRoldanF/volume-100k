      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI011HC'.
      ...
      * Called module names
       01  MOD-ZBI01K3W              PIC X(8) VALUE 'ZBI01K3W'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01K3W-001.
               PERFORM CALL-ZUW01DP6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01K3W-001.
               CALL 'ZBI01K3W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01K3W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01DP6-002.
