      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00NN0'.
      ...
      * Called module names
       01  MOD-ZPA01INR              PIC X(8) VALUE 'ZPA01INR'.
       01  MOD-ZBI01URI              PIC X(8) VALUE 'ZBI01URI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01INR-001.
               PERFORM CALL-ZBI01URI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01INR-001.
               CALL 'ZPA01INR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01INR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01URI-002.
               CALL 'ZBI01URI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01URI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
