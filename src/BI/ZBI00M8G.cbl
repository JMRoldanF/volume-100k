      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00M8G'.
      ...
      * Called module names
       01  MOD-ZBI01E2E              PIC X(8) VALUE 'ZBI01E2E'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01E2E-001.
               CALL 'ZBI01E2E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01E2E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
