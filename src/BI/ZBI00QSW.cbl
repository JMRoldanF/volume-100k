      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00QSW'.
      ...
      * Called module names
       01  MOD-ZBI01KVO              PIC X(8) VALUE 'ZBI01KVO'.
       01  MOD-ZBI01RL2              PIC X(8) VALUE 'ZBI01RL2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01KVO-001.
               PERFORM CALL-ZBI01RL2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01KVO-001.
               CALL 'ZBI01KVO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01KVO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01RL2-002.
               CALL 'ZBI01RL2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
