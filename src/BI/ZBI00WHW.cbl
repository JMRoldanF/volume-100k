      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00WHW'.
      ...
      * Called module names
       01  MOD-ZBI01RYE              PIC X(8) VALUE 'ZBI01RYE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01RYE-001.
               CALL 'ZBI01RYE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01RYE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
