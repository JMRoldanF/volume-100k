      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI010LE'.
      ...
      * Called module names
       01  MOD-ZBI01NXE              PIC X(8) VALUE 'ZBI01NXE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01NXE-001.
               CALL 'ZBI01NXE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01NXE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
