      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00SD5'.
      ...
      * Called module names
       01  MOD-ZBI01FPT              PIC X(8) VALUE 'ZBI01FPT'.
       01  MOD-ZBI01MRA              PIC X(8) VALUE 'ZBI01MRA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01FPT-001.
               CALL 'ZBI01FPT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01FPT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01MRA-002.
               CALL 'ZBI01MRA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01MRA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
