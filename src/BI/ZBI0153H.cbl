      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI0153H'.
      ...
      * Called module names
       01  MOD-ZRN01LQC              PIC X(8) VALUE 'ZRN01LQC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRN01LQC-001.
               CALL 'ZRN01LQC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01LQC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLB01NAD-002.
               MOVE 'ZLB01NAD' TO WS-SUBNAME-2
