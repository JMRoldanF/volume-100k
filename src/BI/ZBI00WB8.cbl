      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00WB8'.
      ...
      * Called module names
       01  MOD-ZMT01LUT              PIC X(8) VALUE 'ZMT01LUT'.
       01  MOD-ZBI01REE              PIC X(8) VALUE 'ZBI01REE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01LUT-001.
               PERFORM CALL-ZBI01REE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01LUT-001.
               CALL 'ZMT01LUT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01LUT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01REE-002.
               CALL 'ZBI01REE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01REE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-MODEL-0001.
