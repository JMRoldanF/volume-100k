      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00OYI'.
      ...
      * Called module names
       01  MOD-ZBI01S1Q              PIC X(8) VALUE 'ZBI01S1Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01S1Q-001.
               CALL 'ZBI01S1Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01S1Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
