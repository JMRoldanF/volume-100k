      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00TJI'.
      ...
      * Called module names
       01  MOD-ZBI01SIE              PIC X(8) VALUE 'ZBI01SIE'.
       01  MOD-ZBI01NMK              PIC X(8) VALUE 'ZBI01NMK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01SIE-001.
               PERFORM CALL-ZBI01NMK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01SIE-001.
               CALL 'ZBI01SIE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01SIE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01NMK-002.
               CALL 'ZBI01NMK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01NMK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
