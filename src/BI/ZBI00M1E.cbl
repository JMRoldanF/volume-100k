      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00M1E'.
      ...
      * Called module names
       01  MOD-ZBI01SUW              PIC X(8) VALUE 'ZBI01SUW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01SUW-002.
               CALL 'ZBI01SUW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01SUW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
