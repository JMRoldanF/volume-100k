      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI01046'.
      ...
      * Called module names
       01  MOD-ZBI01PLO              PIC X(8) VALUE 'ZBI01PLO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01PLO-001.
               CALL 'ZBI01PLO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01PLO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
