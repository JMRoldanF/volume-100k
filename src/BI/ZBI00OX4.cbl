      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00OX4'.
      ...
      * Called module names
       01  MOD-ZBI01CXA              PIC X(8) VALUE 'ZBI01CXA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01CXA-001.
               CALL 'ZBI01CXA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01CXA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
