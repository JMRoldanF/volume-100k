      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00OS4'.
      ...
      * Called module names
       01  MOD-ZBI01S7A              PIC X(8) VALUE 'ZBI01S7A'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01S7A-001.
               CALL 'ZBI01S7A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01S7A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-TERM-0001.
