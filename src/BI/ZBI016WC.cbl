      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI016WC'.
      ...
      * Called module names
       01  MOD-ZBI01K0U              PIC X(8) VALUE 'ZBI01K0U'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01K0U-001.
               CALL 'ZBI01K0U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01K0U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
