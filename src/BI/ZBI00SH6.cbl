      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00SH6'.
      ...
      * Called module names
       01  MOD-ZEN01RJ1              PIC X(8) VALUE 'ZEN01RJ1'.
       01  MOD-ZBI01GGS              PIC X(8) VALUE 'ZBI01GGS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01RJ1-001.
               PERFORM CALL-ZBI01GGS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01RJ1-001.
               CALL 'ZEN01RJ1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01RJ1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01GGS-002.
               CALL 'ZBI01GGS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01GGS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
