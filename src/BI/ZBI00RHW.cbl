      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00RHW'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01PIM              PIC X(8) VALUE 'ZBI01PIM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01PIM-002.
               CALL 'ZBI01PIM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01PIM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
