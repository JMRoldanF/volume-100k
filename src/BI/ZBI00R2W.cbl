      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00R2W'.
      ...
      * Called module names
       01  MOD-ZBI01H7Q              PIC X(8) VALUE 'ZBI01H7Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01H7Q-001.
               CALL 'ZBI01H7Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01H7Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
