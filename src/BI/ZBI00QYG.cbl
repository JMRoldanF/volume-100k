      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00QYG'.
      ...
      * Called module names
       01  MOD-ZBI01PHI              PIC X(8) VALUE 'ZBI01PHI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01PHI-001.
               PERFORM CALL-ZBI01ULY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01PHI-001.
               CALL 'ZBI01PHI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
