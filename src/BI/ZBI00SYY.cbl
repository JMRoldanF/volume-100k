      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00SYY'.
      ...
      * Called module names
       01  MOD-ZBI01RYY              PIC X(8) VALUE 'ZBI01RYY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01RYY-001.
               PERFORM CALL-ZBI01ONI-002.
               PERFORM CALL-ZCL0255P-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZBI01RYY-001.
               CALL 'ZBI01RYY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
