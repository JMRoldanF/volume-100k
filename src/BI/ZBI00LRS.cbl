      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00LRS'.
      ...
      * Called module names
       01  MOD-ZPA01GGV              PIC X(8) VALUE 'ZPA01GGV'.
       01  MOD-ZBI01QLI              PIC X(8) VALUE 'ZBI01QLI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01GGV-001.
               PERFORM CALL-ZBI01QLI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01GGV-001.
               CALL 'ZPA01GGV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01GGV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01QLI-002.
               CALL 'ZBI01QLI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01QLI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-TERM-0001.
