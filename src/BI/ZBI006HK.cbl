      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI006HK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI00QKQ-001.
               PERFORM CALL-ZBI00PLI-002.
               PERFORM CALL-ZBI013LX-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI00QKQ-001.
               MOVE 'ZBI00QKQ' TO WS-PROGNAME-5
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI00QKQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI00PLI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI013LX-003.
               MOVE 'ZBI013LX' TO WS-PROGNAME-6
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI013LX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-004.
