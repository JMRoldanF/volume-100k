      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00XZT'.
      ...
      * Called module names
       01  MOD-ZBI01DEB              PIC X(8) VALUE 'ZBI01DEB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01DEB-001.
               CALL 'ZBI01DEB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01DEB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-MAKE-0001.
