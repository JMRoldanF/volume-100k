      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00SDA'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01FEQ              PIC X(8) VALUE 'ZBI01FEQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01FEQ-002.
               CALL 'ZBI01FEQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01FEQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
