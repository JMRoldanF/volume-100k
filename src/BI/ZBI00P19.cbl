      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00P19'.
      ...
      * Called module names
       01  MOD-ZBI01U9E              PIC X(8) VALUE 'ZBI01U9E'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01LCA-002.
               PERFORM CALL-ZEN0255N-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZBI01U9E-001.
               CALL 'ZBI01U9E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
