      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00SO4'.
      ...
      * Called module names
       01  MOD-ZHO01NYE              PIC X(8) VALUE 'ZHO01NYE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01NYE-001.
               CALL 'ZHO01NYE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01NYE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
