      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00QOQ'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01IBG              PIC X(8) VALUE 'ZBI01IBG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01IBG-002.
               CALL 'ZBI01IBG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01IBG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
