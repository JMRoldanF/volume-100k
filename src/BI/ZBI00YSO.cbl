      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00YSO'.
      ...
      * Called module names
       01  MOD-ZEN01RZF              PIC X(8) VALUE 'ZEN01RZF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01RZF-001.
               CALL 'ZEN01RZF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01RZF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
