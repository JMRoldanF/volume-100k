      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI01BKZ'.
      ...
      * Called module names
       01  MOD-ZBI01IPT              PIC X(8) VALUE 'ZBI01IPT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01IPT-001.
               CALL 'ZBI01IPT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01IPT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZQU01U69-002.
