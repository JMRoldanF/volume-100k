      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00RM2'.
      ...
      * Called module names
       01  MOD-ZCU01TCC              PIC X(8) VALUE 'ZCU01TCC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01TCC-001.
               PERFORM CALL-ZBI01DKW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01TCC-001.
               CALL 'ZCU01TCC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01TCC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01DKW-002.
