      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI011Y0'.
      ...
      * Called module names
       01  MOD-ZBI01F3C              PIC X(8) VALUE 'ZBI01F3C'.
       01  MOD-ZBI01F32              PIC X(8) VALUE 'ZBI01F32'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01F3C-001.
               PERFORM CALL-ZBI01F32-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01F3C-001.
               CALL 'ZBI01F3C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01F3C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01F32-002.
               CALL 'ZBI01F32' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01F32 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
