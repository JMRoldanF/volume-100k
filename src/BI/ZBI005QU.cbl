      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI005QU'.
      ...
      * Called module names
       ...
       01  MOD-ZBI00B6O              PIC X(8) VALUE 'ZBI00B6O'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI00KT2-001.
               PERFORM CALL-ZBI00B6O-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI00B6O-002.
               EXEC CICS LINK PROGRAM('ZBI00B6O')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI00B6O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
