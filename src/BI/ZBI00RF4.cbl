      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00RF4'.
      ...
      * Called module names
       01  MOD-ZBI01QNG              PIC X(8) VALUE 'ZBI01QNG'.
       01  MOD-ZBI01EQA              PIC X(8) VALUE 'ZBI01EQA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01QNG-001.
               PERFORM CALL-ZBI01EQA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01QNG-001.
               CALL 'ZBI01QNG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01QNG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01EQA-002.
               CALL 'ZBI01EQA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01EQA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
