      ...
      * Called module names
       01  MOD-ZBI01HHC              PIC X(8) VALUE 'ZBI01HHC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRN01UIC-001.
               PERFORM CALL-ZBI01HHC-002.
               PERFORM CALL-ZAG0255S-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZRN01UIC-001.
               MOVE 'ZRN01UIC' TO WS-SUBNAME-1
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01HHC-002.
               CALL 'ZBI01HHC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01HHC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
