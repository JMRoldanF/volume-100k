      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI012KJ'.
      ...
      * Called module names
       01  MOD-ZBI01JCD              PIC X(8) VALUE 'ZBI01JCD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01JCD-001.
               CALL 'ZBI01JCD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01JCD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
