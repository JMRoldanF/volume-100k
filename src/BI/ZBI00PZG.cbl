      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00PZG'.
      ...
      * Called module names
       01  MOD-ZMT01UL9              PIC X(8) VALUE 'ZMT01UL9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01UL9-001.
               CALL 'ZMT01UL9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01UL9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-POSTCODE-0001.
