      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI0087G'.
      ...
      * Called module names
       01  MOD-ZBI00OI4              PIC X(8) VALUE 'ZBI00OI4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI00OI4-001.
               PERFORM CALL-ZBI011EK-002.
               PERFORM CALL-ZBI00WS6-003.
               PERFORM CALL-ZBI0159G-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI00OI4-001.
               EXEC CICS LINK PROGRAM('ZBI00OI4')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI00OI4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI011EK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI00WS6-003.
               MOVE 'ZBI00WS6' TO WS-PROGNAME-8
