      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00YAD'.
      ...
      * Called module names
       ...
       01  MOD-ZQU01IA5              PIC X(8) VALUE 'ZQU01IA5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01HSJ-001.
               PERFORM CALL-ZQU01IA5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZQU01IA5-002.
               CALL 'ZQU01IA5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU01IA5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
