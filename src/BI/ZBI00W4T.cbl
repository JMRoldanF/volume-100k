      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00W4T'.
      ...
      * Called module names
       01  MOD-ZBI01OGF              PIC X(8) VALUE 'ZBI01OGF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01OGF-001.
               CALL 'ZBI01OGF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01OGF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
