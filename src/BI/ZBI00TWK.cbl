      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00TWK'.
      ...
      * Called module names
       01  MOD-ZBI01E6A              PIC X(8) VALUE 'ZBI01E6A'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01E6A-001.
               PERFORM CALL-ZBI01KM8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01E6A-001.
               CALL 'ZBI01E6A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01E6A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01KM8-002.
