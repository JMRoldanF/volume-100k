      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00TIY'.
      ...
      * Called module names
       01  MOD-ZBI01MUI              PIC X(8) VALUE 'ZBI01MUI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01MUI-001.
               CALL 'ZBI01MUI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01MUI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
