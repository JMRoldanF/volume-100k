      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00JUR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZQU00QUM-001.
               MOVE 'ZQU00QUM' TO WS-PROGNAME-1
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU00QUM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01HC4-002.
               MOVE 'ZBI01HC4' TO WS-SUBNAME-2
