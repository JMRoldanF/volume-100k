      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00PQ0'.
      ...
      * Called module names
       01  MOD-ZBI01ODS              PIC X(8) VALUE 'ZBI01ODS'.
       01  MOD-ZBI01IXE              PIC X(8) VALUE 'ZBI01IXE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01ODS-001.
               PERFORM CALL-ZBI01IXE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01ODS-001.
               CALL 'ZBI01ODS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01ODS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01IXE-002.
               CALL 'ZBI01IXE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01IXE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
