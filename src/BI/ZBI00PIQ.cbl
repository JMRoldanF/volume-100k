      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00PIQ'.
      ...
      * Called module names
       01  MOD-ZBI01ERA              PIC X(8) VALUE 'ZBI01ERA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01ERA-001.
               CALL 'ZBI01ERA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01ERA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
