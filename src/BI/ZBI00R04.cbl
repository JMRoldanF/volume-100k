      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00R04'.
      ...
      * Called module names
       01  MOD-ZBI01JVK              PIC X(8) VALUE 'ZBI01JVK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01JVK-001.
               CALL 'ZBI01JVK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01JVK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
