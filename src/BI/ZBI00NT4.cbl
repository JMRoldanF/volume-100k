      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00NT4'.
      ...
      * Called module names
       01  MOD-ZHO01NTO              PIC X(8) VALUE 'ZHO01NTO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01NTO-001.
               CALL 'ZHO01NTO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01NTO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
