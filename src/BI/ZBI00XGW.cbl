      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00XGW'.
      ...
      * Called module names
       01  MOD-ZBI01OYW              PIC X(8) VALUE 'ZBI01OYW'.
       01  MOD-ZBI01TBA              PIC X(8) VALUE 'ZBI01TBA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01OYW-001.
               CALL 'ZBI01OYW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01OYW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01TBA-002.
               CALL 'ZBI01TBA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01TBA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
