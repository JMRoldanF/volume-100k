      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00X3A'.
      ...
      * Called module names
       01  MOD-ZBI01SAW              PIC X(8) VALUE 'ZBI01SAW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01SAW-001.
               CALL 'ZBI01SAW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01SAW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
