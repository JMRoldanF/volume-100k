      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00TNE'.
      ...
      * Called module names
       01  MOD-ZBI01EAU              PIC X(8) VALUE 'ZBI01EAU'.
       01  MOD-ZBI01SSI              PIC X(8) VALUE 'ZBI01SSI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01EAU-001.
               PERFORM CALL-ZBI01SSI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01EAU-001.
               CALL 'ZBI01EAU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01EAU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01SSI-002.
               CALL 'ZBI01SSI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01SSI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
