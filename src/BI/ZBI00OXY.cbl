      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00OXY'.
      ...
      * Called module names
       01  MOD-ZEN01I45              PIC X(8) VALUE 'ZEN01I45'.
       01  MOD-ZBI01GI6              PIC X(8) VALUE 'ZBI01GI6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01I45-001.
               PERFORM CALL-ZBI01GI6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01I45-001.
               CALL 'ZEN01I45' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01I45 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01GI6-002.
               CALL 'ZBI01GI6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01GI6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
