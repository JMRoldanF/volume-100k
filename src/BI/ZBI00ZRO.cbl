      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00ZRO'.
      ...
      * Called module names
       01  MOD-ZBI01IPM              PIC X(8) VALUE 'ZBI01IPM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01IPM-001.
               CALL 'ZBI01IPM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01IPM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
