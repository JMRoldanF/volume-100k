      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00VG8'.
      ...
      * Called module names
       01  MOD-ZQU01ET3              PIC X(8) VALUE 'ZQU01ET3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZQU01ET3-001.
               PERFORM CALL-ZBI01QOS-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZQU01ET3-001.
               CALL 'ZQU01ET3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU01ET3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01QOS-002.
               MOVE 'ZBI01QOS' TO WS-SUBNAME-4
