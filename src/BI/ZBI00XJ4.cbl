      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00XJ4'.
      ...
      * Called module names
       01  MOD-ZBI01EHY              PIC X(8) VALUE 'ZBI01EHY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01EHY-001.
               PERFORM CALL-ZBI01HJE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01EHY-001.
               CALL 'ZBI01EHY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01EHY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01HJE-002.
