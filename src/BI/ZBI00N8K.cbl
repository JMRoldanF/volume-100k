      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00N8K'.
      ...
      * Called module names
       01  MOD-ZBI01MGC              PIC X(8) VALUE 'ZBI01MGC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01MGC-001.
               PERFORM CALL-ZBI01PJG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01MGC-001.
               CALL 'ZBI01MGC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01MGC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01PJG-002.
