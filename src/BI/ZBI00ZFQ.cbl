      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00ZFQ'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01KZQ              PIC X(8) VALUE 'ZHO01KZQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01KZQ-002.
               CALL 'ZHO01KZQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01KZQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
