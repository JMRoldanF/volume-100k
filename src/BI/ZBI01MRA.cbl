      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI01MRA'.
      ...
      * Called module names
       01  MOD-ZBI01PA8              PIC X(8) VALUE 'ZBI01PA8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01PA8-001.
               CALL 'ZBI01PA8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01PA8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
