      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00T7A'.
      ...
      * Called module names
       01  MOD-ZBI01IQQ              PIC X(8) VALUE 'ZBI01IQQ'.
       01  MOD-ZBI01KNC              PIC X(8) VALUE 'ZBI01KNC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01IQQ-001.
               PERFORM CALL-ZBI01KNC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01IQQ-001.
               CALL 'ZBI01IQQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01IQQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01KNC-002.
               CALL 'ZBI01KNC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01KNC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
