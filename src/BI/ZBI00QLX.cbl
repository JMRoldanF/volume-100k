      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00QLX'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01GIB              PIC X(8) VALUE 'ZBI01GIB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZQU01KXK-001.
               PERFORM CALL-ZBI01GIB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01GIB-002.
               CALL 'ZBI01GIB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
