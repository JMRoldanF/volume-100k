      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI01N8E'.
      ...
      * Called module names
       01  MOD-ZCL01OZF              PIC X(8) VALUE 'ZCL01OZF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01OZF-001.
               CALL 'ZCL01OZF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01OZF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
