      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI004QW'.
      ...
      * Called module names
       01  MOD-ZBI00DQS              PIC X(8) VALUE 'ZBI00DQS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI00DQS-001.
               PERFORM CALL-ZBI007AE-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI00DQS-001.
               EXEC CICS LINK PROGRAM('ZBI00DQS')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI00DQS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI00DJM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI007AE-003.
               MOVE 'ZBI007AE' TO WS-PROGNAME-4
