      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI01VBA'.
      ...
      * Called module names
       01  MOD-ZBI01DS4              PIC X(8) VALUE 'ZBI01DS4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01DS4-001.
               PERFORM CALL-ZAG01UAC-002.
               PERFORM CALL-ZBI01NR0-003.
               PERFORM CALL-ZBI01IOI-004.
               PERFORM CALL-ZBI01RYO-005.
               PERFORM CALL-ZEN00QYD-006.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01DS4-001.
               CALL 'ZBI01DS4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01DS4 FAILED' TO EM-VARIABLE
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01NR0-003.
               MOVE 'ZBI01NR0' TO WS-SUBNAME-1
               CALL WS-SUBNAME-1 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01NR0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01IOI-004.
