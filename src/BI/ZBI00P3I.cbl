      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00P3I'.
      ...
      * Called module names
       01  MOD-ZMT01TGZ              PIC X(8) VALUE 'ZMT01TGZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01TGZ-001.
               CALL 'ZMT01TGZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01TGZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
