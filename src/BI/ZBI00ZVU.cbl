      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00ZVU'.
      ...
      * Called module names
       01  MOD-ZBI01SSY              PIC X(8) VALUE 'ZBI01SSY'.
       01  MOD-ZCU01D0A              PIC X(8) VALUE 'ZCU01D0A'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01SSY-001.
               PERFORM CALL-ZCU01D0A-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01SSY-001.
               CALL 'ZBI01SSY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01D0A-002.
               CALL 'ZCU01D0A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01D0A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
