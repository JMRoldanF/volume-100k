      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00MMM'.
      ...
      * Called module names
       01  MOD-ZBI01K9Q              PIC X(8) VALUE 'ZBI01K9Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01K9Q-001.
               CALL 'ZBI01K9Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01K9Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-COLOUR-0001.
