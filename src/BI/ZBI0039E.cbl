      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI0039E'.
      ...
      * Called module names
       01  MOD-ZBI00CIG              PIC X(8) VALUE 'ZBI00CIG'.
       01  MOD-ZPA009PZ              PIC X(8) VALUE 'ZPA009PZ'.
       01  MOD-ZEN0039V              PIC X(8) VALUE 'ZEN0039V'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI00CIG-001.
               PERFORM CALL-ZEN0039V-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI00CIG-001.
               EXEC CICS LINK PROGRAM('ZBI00CIG')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI00CIG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA009PZ-002.
               EXEC CICS LINK PROGRAM('ZPA009PZ')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA009PZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0039V-003.
               EXEC CICS XCTL PROGRAM('ZEN0039V')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN0039V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
