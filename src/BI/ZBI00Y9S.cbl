      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00Y9S'.
      ...
      * Called module names
       01  MOD-ZAG01LGK              PIC X(8) VALUE 'ZAG01LGK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01LGK-001.
               CALL 'ZAG01LGK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01LGK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
