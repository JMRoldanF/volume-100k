      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00TA8'.
      ...
      * Called module names
       01  MOD-ZBI01J71              PIC X(8) VALUE 'ZBI01J71'.
       01  MOD-ZBI01H3N              PIC X(8) VALUE 'ZBI01H3N'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01J71-001.
               PERFORM CALL-ZBI01H3N-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01J71-001.
               CALL 'ZBI01J71' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01J71 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01H3N-002.
               CALL 'ZBI01H3N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01H3N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
