      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI0089P'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI00RL0-002.
               PERFORM CALL-ZBI00T2Q-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI00RL0-002.
               MOVE 'ZBI00RL0' TO WS-PROGNAME-5
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI00RL0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI00T2Q-003.
               MOVE 'ZBI00T2Q' TO WS-PROGNAME-6
