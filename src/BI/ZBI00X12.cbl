      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00X12'.
      ...
      * Called module names
       01  MOD-ZBI01PLE              PIC X(8) VALUE 'ZBI01PLE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01PLE-001.
               CALL 'ZBI01PLE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01PLE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
