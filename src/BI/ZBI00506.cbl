      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00506'.
      ...
      * Called module names
       01  MOD-ZBI00E1G              PIC X(8) VALUE 'ZBI00E1G'.
       01  MOD-ZBI00K60              PIC X(8) VALUE 'ZBI00K60'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI00E1G-001.
               PERFORM CALL-ZBI00K60-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI00E1G-001.
               EXEC CICS LINK PROGRAM('ZBI00E1G')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI00E1G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI00K60-002.
               EXEC CICS LINK PROGRAM('ZBI00K60')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
