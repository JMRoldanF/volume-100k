      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00MC9'.
      ...
      * Called module names
       01  MOD-ZBI01R74              PIC X(8) VALUE 'ZBI01R74'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01R74-001.
               PERFORM CALL-ZQU01T72-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01R74-001.
               CALL 'ZBI01R74' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01R74 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZQU01T72-002.
