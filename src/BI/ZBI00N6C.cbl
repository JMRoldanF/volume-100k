      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00N6C'.
      ...
      * Called module names
       01  MOD-ZBI01UGO              PIC X(8) VALUE 'ZBI01UGO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01UGO-001.
               CALL 'ZBI01UGO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01UGO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
