      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI010C5'.
      ...
      * Called module names
       01  MOD-ZBI01F5Y              PIC X(8) VALUE 'ZBI01F5Y'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01F5Y-001.
               CALL 'ZBI01F5Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01F5Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
