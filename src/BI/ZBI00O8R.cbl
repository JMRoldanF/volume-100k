      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00O8R'.
      ...
      * Called module names
       01  MOD-ZBI01MHE              PIC X(8) VALUE 'ZBI01MHE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01MHE-001.
               CALL 'ZBI01MHE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01MHE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
