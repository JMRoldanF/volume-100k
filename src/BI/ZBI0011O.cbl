      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI0011O'.
      ...
      * Called module names
       01  MOD-ZBI00INA              PIC X(8) VALUE 'ZBI00INA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI00KKQ-001.
               PERFORM CALL-ZBI00INA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI00INA-002.
               EXEC CICS LINK PROGRAM('ZBI00INA')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI00INA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
