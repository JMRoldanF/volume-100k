      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI015K0'.
      ...
      * Called module names
       01  MOD-ZBI01UKA              PIC X(8) VALUE 'ZBI01UKA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01UKA-001.
               CALL 'ZBI01UKA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01UKA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
