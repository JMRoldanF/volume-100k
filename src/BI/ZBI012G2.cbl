      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI012G2'.
      ...
      * Called module names
       01  MOD-ZBI01MCQ              PIC X(8) VALUE 'ZBI01MCQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01MCQ-001.
               CALL 'ZBI01MCQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01MCQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
