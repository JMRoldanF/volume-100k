      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00Z8I'.
      ...
      * Called module names
       01  MOD-ZBI01FMS              PIC X(8) VALUE 'ZBI01FMS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01FMS-001.
               CALL 'ZBI01FMS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01FMS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
