      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00OTS'.
      ...
      * Called module names
       01  MOD-ZBI01H62              PIC X(8) VALUE 'ZBI01H62'.
       01  MOD-ZBI01FTG              PIC X(8) VALUE 'ZBI01FTG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01H62-001.
               PERFORM CALL-ZBI01FTG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01H62-001.
               CALL 'ZBI01H62' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01H62 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01FTG-002.
               CALL 'ZBI01FTG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01FTG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
