      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI016TK'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01NMA              PIC X(8) VALUE 'ZBI01NMA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01O6K-001.
               PERFORM CALL-ZBI01NMA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01NMA-002.
               CALL 'ZBI01NMA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01NMA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-TERM-0001.
