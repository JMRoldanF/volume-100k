      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI0001A'.
      ...
      * Called module names
       01  MOD-ZAG00IHI              PIC X(8) VALUE 'ZAG00IHI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG00IHI-001.
               EXEC CICS LINK PROGRAM('ZAG00IHI')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG00IHI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI00D08-002.
