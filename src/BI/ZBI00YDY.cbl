      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00YDY'.
      ...
      * Called module names
       01  MOD-ZBI01JYM              PIC X(8) VALUE 'ZBI01JYM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01JYM-001.
               CALL 'ZBI01JYM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01JYM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
