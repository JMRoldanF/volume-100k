      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00UMS'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01TD9              PIC X(8) VALUE 'ZBI01TD9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01DLL-001.
               PERFORM CALL-ZBI01TD9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01TD9-002.
               CALL 'ZBI01TD9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01TD9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
