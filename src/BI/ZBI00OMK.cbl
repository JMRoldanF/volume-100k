      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00OMK'.
      ...
      * Called module names
       01  MOD-ZBI01UTG              PIC X(8) VALUE 'ZBI01UTG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01UTG-001.
               CALL 'ZBI01UTG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01UTG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
