      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00RJU'.
      ...
      * Called module names
       01  MOD-ZBI01FIC              PIC X(8) VALUE 'ZBI01FIC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01FIC-001.
               CALL 'ZBI01FIC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
