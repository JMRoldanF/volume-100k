      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00SGA'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01DZH              PIC X(8) VALUE 'ZBI01DZH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01DZH-002.
               CALL 'ZBI01DZH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01DZH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
