      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI008XU'.
      ...
      * Called module names
       01  MOD-ZBI00U9C              PIC X(8) VALUE 'ZBI00U9C'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI00U9C-001.
               EXEC CICS LINK PROGRAM('ZBI00U9C')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI00U9C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
