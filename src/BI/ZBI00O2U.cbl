      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00O2U'.
      ...
      * Called module names
       01  MOD-ZBI01PF0              PIC X(8) VALUE 'ZBI01PF0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01PF0-001.
               CALL 'ZBI01PF0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01PF0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
