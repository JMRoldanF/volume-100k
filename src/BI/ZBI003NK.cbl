      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI003NK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI00KD8-001.
               MOVE 'ZBI00KD8' TO WS-PROGNAME-6
      ...
      *----------------------------------------------------------------*
       CALL-ZCU008FG-002.
               MOVE 'ZCU008FG' TO WS-PROGNAME-7
