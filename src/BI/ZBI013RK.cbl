      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI013RK'.
      ...
      * Called module names
       01  MOD-ZAG01SHC              PIC X(8) VALUE 'ZAG01SHC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01SHC-001.
               CALL 'ZAG01SHC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01SHC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
