      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00WYU'.
      ...
      * Called module names
       01  MOD-ZBI01TME              PIC X(8) VALUE 'ZBI01TME'.
       01  MOD-ZBI01PEG              PIC X(8) VALUE 'ZBI01PEG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01TME-001.
               PERFORM CALL-ZBI01PEG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01TME-001.
               CALL 'ZBI01TME' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01TME FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01PEG-002.
               CALL 'ZBI01PEG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01PEG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
