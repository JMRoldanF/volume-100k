      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00SJ4'.
      ...
      * Called module names
       01  MOD-ZBI01FDM              PIC X(8) VALUE 'ZBI01FDM'.
       01  MOD-ZBI01OV0              PIC X(8) VALUE 'ZBI01OV0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01FDM-001.
               CALL 'ZBI01FDM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01FDM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01OV0-002.
               CALL 'ZBI01OV0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01OV0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
