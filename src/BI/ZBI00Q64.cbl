      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00Q64'.
      ...
      * Called module names
       01  MOD-ZBI01CR6              PIC X(8) VALUE 'ZBI01CR6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01CR6-001.
               CALL 'ZBI01CR6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01CR6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
