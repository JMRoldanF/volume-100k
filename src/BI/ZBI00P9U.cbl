      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00P9U'.
      ...
      * Called module names
       01  MOD-ZBI01NPI              PIC X(8) VALUE 'ZBI01NPI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01NPI-001.
               CALL 'ZBI01NPI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01NPI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
