      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI011RM'.
      ...
      * Called module names
       01  MOD-ZBI01J7E              PIC X(8) VALUE 'ZBI01J7E'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01J7E-001.
               CALL 'ZBI01J7E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01J7E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01NAN-002.
               MOVE 'ZRE01NAN' TO WS-SUBNAME-8
