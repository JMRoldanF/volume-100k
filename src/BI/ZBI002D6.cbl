      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI002D6'.
      ...
      * Called module names
       01  MOD-ZBI00K3I              PIC X(8) VALUE 'ZBI00K3I'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI00K3I-001.
               PERFORM CALL-ZCU00BZ8-002.
               PERFORM CALL-ZBI00DQ2-003.
               PERFORM CALL-ZCL0004L-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI00K3I-001.
               EXEC CICS LINK PROGRAM('ZBI00K3I')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI00K3I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU00BZ8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI00DQ2-003.
               MOVE 'ZBI00DQ2' TO WS-PROGNAME-5
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI00DQ2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0004L-004.
               EXEC CICS START TRANSID('Z04L')
                         FROM(WS-KEY-AREA)
                         LENGTH(20)
                         RESP(WS-RESP)
               END-EXEC.
      * TRANSID Z04L is defined against ZCL0004L
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL0004L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-005.
