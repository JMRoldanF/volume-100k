      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00OLQ'.
      ...
      * Called module names
       01  MOD-ZBI01LA4              PIC X(8) VALUE 'ZBI01LA4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01LA4-001.
               CALL 'ZBI01LA4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01LA4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01OM4-002.
