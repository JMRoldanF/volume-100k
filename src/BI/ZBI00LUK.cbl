      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00LUK'.
      ...
      * Called module names
       01  MOD-ZUW01KE0              PIC X(8) VALUE 'ZUW01KE0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01KE0-001.
               PERFORM CALL-ZBI01P78-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01KE0-001.
               CALL 'ZUW01KE0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01KE0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01P78-002.
