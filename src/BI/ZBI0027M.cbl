      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI0027M'.
      ...
      * Called module names
       ...
       01  MOD-ZBI00JOI              PIC X(8) VALUE 'ZBI00JOI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI006KU-002.
               PERFORM CALL-ZBI007MM-003.
               PERFORM CALL-ZBI00JOI-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI00DC6-001.
               MOVE 'ZBI00DC6' TO WS-PROGNAME-8
      ...
      *----------------------------------------------------------------*
       CALL-ZBI006KU-002.
               MOVE 'ZBI006KU' TO WS-PROGNAME-1
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI006KU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI007MM-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI00JOI-004.
               EXEC CICS LINK PROGRAM('ZBI00JOI')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI00JOI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-005.
