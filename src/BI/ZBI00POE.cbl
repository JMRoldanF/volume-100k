      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00POE'.
      ...
      * Called module names
       01  MOD-ZLB01NDS              PIC X(8) VALUE 'ZLB01NDS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLB01NDS-001.
               PERFORM CALL-ZLB01ETR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01NDS-001.
               CALL 'ZLB01NDS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01NDS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLB01ETR-002.
               MOVE 'ZLB01ETR' TO WS-SUBNAME-2
