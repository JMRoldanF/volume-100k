      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00UQA'.
      ...
      * Called module names
       01  MOD-ZCL01TSH              PIC X(8) VALUE 'ZCL01TSH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01TSH-001.
               CALL 'ZCL01TSH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01TSH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
