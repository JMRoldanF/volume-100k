      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00UJC'.
      ...
      * Called module names
       01  MOD-ZBI01FFK              PIC X(8) VALUE 'ZBI01FFK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01FFK-001.
               CALL 'ZBI01FFK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01FFK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-VALUE-0001.
