      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00PTW'.
      ...
      * Called module names
       01  MOD-ZBI01HID              PIC X(8) VALUE 'ZBI01HID'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01HID-001.
               CALL 'ZBI01HID' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01HID FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-EQUITIES-0001.
