      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00VZA'.
      ...
      * Called module names
       01  MOD-ZBI01HXD              PIC X(8) VALUE 'ZBI01HXD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01HXD-001.
               PERFORM CALL-ZBI01KXZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01HXD-001.
               CALL 'ZBI01HXD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01HXD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01KXZ-002.
