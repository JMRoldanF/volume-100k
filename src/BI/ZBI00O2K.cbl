      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00O2K'.
      ...
      * Called module names
       01  MOD-ZBI01QEU              PIC X(8) VALUE 'ZBI01QEU'.
       01  MOD-ZBI01NPC              PIC X(8) VALUE 'ZBI01NPC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01QEU-001.
               PERFORM CALL-ZBI01NPC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01QEU-001.
               CALL 'ZBI01QEU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01QEU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01NPC-002.
               CALL 'ZBI01NPC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01NPC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
