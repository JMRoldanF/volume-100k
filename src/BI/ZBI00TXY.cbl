      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00TXY'.
      ...
      * Called module names
       01  MOD-ZBI01M0I              PIC X(8) VALUE 'ZBI01M0I'.
       01  MOD-ZBI01HO4              PIC X(8) VALUE 'ZBI01HO4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01M0I-001.
               PERFORM CALL-ZBI01HO4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01M0I-001.
               CALL 'ZBI01M0I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01M0I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01HO4-002.
               CALL 'ZBI01HO4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01HO4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
