      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00N1M'.
      ...
      * Called module names
       01  MOD-ZBI01FTQ              PIC X(8) VALUE 'ZBI01FTQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM EXPAND-POSTCODE-0076.
               PERFORM COMPUTE-BROKER-ID-0077.
               PERFORM SQL-ACCESS-0078.
               PERFORM COMPUTE-TAX-BAND-0079.
               ...
               PERFORM RESOLVE-ROOF-TYPE-0107.
               ...
               PERFORM VALIDATE-BROKER-ID-0113.
               PERFORM SQL-ACCESS-0114.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZBI01FTQ-001.
               CALL 'ZBI01FTQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01FTQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-VALUE-0001.
