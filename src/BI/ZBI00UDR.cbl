      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00UDR'.
      ...
      * Called module names
       01  MOD-ZBI01ESN              PIC X(8) VALUE 'ZBI01ESN'.
       01  MOD-ZBI01N8H              PIC X(8) VALUE 'ZBI01N8H'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01ESN-001.
               PERFORM CALL-ZBI01N8H-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01ESN-001.
               CALL 'ZBI01ESN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01ESN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01N8H-002.
               CALL 'ZBI01N8H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01N8H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
