      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI0162V'.
      ...
      * Called module names
       01  MOD-ZBI01TA1              PIC X(8) VALUE 'ZBI01TA1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01TA1-001.
               CALL 'ZBI01TA1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01TA1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
