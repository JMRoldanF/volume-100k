      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00PZQ'.
      ...
      * Called module names
       01  MOD-ZBI01Q22              PIC X(8) VALUE 'ZBI01Q22'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01Q22-001.
               CALL 'ZBI01Q22' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01Q22 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-EQUITIES-0001.
