      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI019B0'.
      ...
      * Called module names
       01  MOD-ZBI01RQC              PIC X(8) VALUE 'ZBI01RQC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01RQC-001.
               CALL 'ZBI01RQC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01RQC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
