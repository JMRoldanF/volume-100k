      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00PWQ'.
      ...
      * Called module names
       01  MOD-ZBI01H86              PIC X(8) VALUE 'ZBI01H86'.
       01  MOD-ZBI01MRN              PIC X(8) VALUE 'ZBI01MRN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01H86-001.
               PERFORM CALL-ZBI01MRN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01H86-001.
               CALL 'ZBI01H86' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01H86 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01MRN-002.
               CALL 'ZBI01MRN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01MRN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
