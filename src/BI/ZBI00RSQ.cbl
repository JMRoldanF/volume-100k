      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00RSQ'.
      ...
      * Called module names
       01  MOD-ZBI01T10              PIC X(8) VALUE 'ZBI01T10'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01T10-001.
               CALL 'ZBI01T10' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01T10 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
