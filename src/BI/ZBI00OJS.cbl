      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00OJS'.
      ...
      * Called module names
       01  MOD-ZBI01LAE              PIC X(8) VALUE 'ZBI01LAE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01LAE-001.
               CALL 'ZBI01LAE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01LAE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
