      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00T6Q'.
      ...
      * Called module names
       01  MOD-ZBI01OMY              PIC X(8) VALUE 'ZBI01OMY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01OMY-001.
               PERFORM CALL-ZBI01MQ2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01OMY-001.
               CALL 'ZBI01OMY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01OMY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01MQ2-002.
