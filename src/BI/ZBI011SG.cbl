      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI011SG'.
      ...
      * Called module names
       01  MOD-ZBI01NAW              PIC X(8) VALUE 'ZBI01NAW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01NAW-001.
               CALL 'ZBI01NAW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01NAW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
