      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00YK2'.
      ...
      * Called module names
       01  MOD-ZBI01MWQ              PIC X(8) VALUE 'ZBI01MWQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01MWQ-001.
               PERFORM CALL-ZRE01IXZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01MWQ-001.
               CALL 'ZBI01MWQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01MWQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01IXZ-002.
