      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI01Q0L'.
      ...
      * Called module names
       01  MOD-ZBI01PFP              PIC X(8) VALUE 'ZBI01PFP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01PFP-001.
               CALL 'ZBI01PFP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01PFP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
