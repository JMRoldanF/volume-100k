      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00YZC'.
      ...
      * Called module names
       01  MOD-ZBI01U1E              PIC X(8) VALUE 'ZBI01U1E'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01U1E-001.
               CALL 'ZBI01U1E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01U1E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
