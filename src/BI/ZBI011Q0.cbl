      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI011Q0'.
      ...
      * Called module names
       01  MOD-ZBI01TS1              PIC X(8) VALUE 'ZBI01TS1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01TS1-001.
               CALL 'ZBI01TS1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01TS1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
