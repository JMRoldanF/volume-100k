      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00M9U'.
      ...
      * Called module names
       01  MOD-ZBI01LGI              PIC X(8) VALUE 'ZBI01LGI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01LGI-001.
               CALL 'ZBI01LGI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01LGI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01TEM-002.
