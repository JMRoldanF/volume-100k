      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00YES'.
      ...
      * Called module names
       01  MOD-ZCU01Q8O              PIC X(8) VALUE 'ZCU01Q8O'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01Q8O-001.
               PERFORM CALL-ZRE01ROF-002.
               PERFORM CALL-ZAG0255S-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCU01Q8O-001.
               CALL 'ZCU01Q8O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01Q8O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01ROF-002.
