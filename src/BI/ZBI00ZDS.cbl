      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00ZDS'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01MY4              PIC X(8) VALUE 'ZBI01MY4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01KDM-001.
               PERFORM CALL-ZBI01MY4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01MY4-002.
               CALL 'ZBI01MY4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01MY4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
