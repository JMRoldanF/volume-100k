      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00YKT'.
      ...
      * Called module names
       01  MOD-ZRN01R14              PIC X(8) VALUE 'ZRN01R14'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRN01R14-001.
               PERFORM CALL-ZBI01NEG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRN01R14-001.
               CALL 'ZRN01R14' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01R14 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01NEG-002.
