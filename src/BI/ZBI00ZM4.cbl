      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00ZM4'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01LMC              PIC X(8) VALUE 'ZBI01LMC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01PEQ-001.
               PERFORM CALL-ZBI01LMC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01LMC-002.
               CALL 'ZBI01LMC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01LMC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
