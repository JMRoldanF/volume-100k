      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00X80'.
      ...
      * Called module names
       01  MOD-ZBI01SY8              PIC X(8) VALUE 'ZBI01SY8'.
       01  MOD-ZBI01J4W              PIC X(8) VALUE 'ZBI01J4W'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01SY8-001.
               PERFORM CALL-ZBI01J4W-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01SY8-001.
               CALL 'ZBI01SY8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01SY8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01J4W-002.
               CALL 'ZBI01J4W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01J4W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
