      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00Q4Q'.
      ...
      * Called module names
       01  MOD-ZBI01FSW              PIC X(8) VALUE 'ZBI01FSW'.
       01  MOD-ZBI01IA2              PIC X(8) VALUE 'ZBI01IA2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01FSW-001.
               PERFORM CALL-ZBI01IA2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01FSW-001.
               CALL 'ZBI01FSW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01FSW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01IA2-002.
               CALL 'ZBI01IA2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01IA2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
