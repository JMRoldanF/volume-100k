      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00SLW'.
      ...
      * Called module names
       01  MOD-ZBI01M7G              PIC X(8) VALUE 'ZBI01M7G'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01M7G-001.
               CALL 'ZBI01M7G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01M7G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-EXCESS-0001.
