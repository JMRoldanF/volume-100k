      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00N6L'.
      ...
      * Called module names
       01  MOD-ZBI01EBC              PIC X(8) VALUE 'ZBI01EBC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01EBC-001.
               CALL 'ZBI01EBC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01EBC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01LIG-002.
