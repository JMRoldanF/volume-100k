      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00NJY'.
      ...
      * Called module names
       01  MOD-ZMT01OIX              PIC X(8) VALUE 'ZMT01OIX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01OIX-001.
               CALL 'ZMT01OIX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01OIX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
