      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00PAG'.
      ...
      * Called module names
       01  MOD-ZRE01FKV              PIC X(8) VALUE 'ZRE01FKV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01FKV-001.
               CALL 'ZRE01FKV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01FKV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
