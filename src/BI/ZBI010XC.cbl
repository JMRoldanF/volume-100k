      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI010XC'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01LO0              PIC X(8) VALUE 'ZBI01LO0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01GXQ-001.
               PERFORM CALL-ZBI01LO0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01LO0-002.
               CALL 'ZBI01LO0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01LO0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
