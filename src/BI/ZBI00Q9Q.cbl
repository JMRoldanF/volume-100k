      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00Q9Q'.
      ...
      * Called module names
       01  MOD-ZBI01OZQ              PIC X(8) VALUE 'ZBI01OZQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01OZQ-001.
               CALL 'ZBI01OZQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01OZQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-TERM-0001.
