      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00Z2Y'.
      ...
      * Called module names
       01  MOD-ZBI01V1S              PIC X(8) VALUE 'ZBI01V1S'.
       01  MOD-ZPA01G4N              PIC X(8) VALUE 'ZPA01G4N'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01V1S-001.
               PERFORM CALL-ZPA01G4N-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01V1S-001.
               CALL 'ZBI01V1S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01V1S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01G4N-002.
               CALL 'ZPA01G4N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01G4N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
