      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00VKA'.
      ...
      * Called module names
       01  MOD-ZBI01OHO              PIC X(8) VALUE 'ZBI01OHO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01OHO-001.
               PERFORM CALL-ZCL01IIX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01OHO-001.
               CALL 'ZBI01OHO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01OHO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01IIX-002.
