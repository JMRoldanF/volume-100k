      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00X4F'.
      ...
      * Called module names
       01  MOD-ZBI01PGP              PIC X(8) VALUE 'ZBI01PGP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01PGP-001.
               CALL 'ZBI01PGP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01PGP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01H86-002.
