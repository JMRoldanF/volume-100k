      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00SY4'.
      ...
      * Called module names
       01  MOD-ZMT01S4X              PIC X(8) VALUE 'ZMT01S4X'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01S4X-001.
               CALL 'ZMT01S4X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01S4X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
