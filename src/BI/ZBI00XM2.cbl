      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00XM2'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01SEL              PIC X(8) VALUE 'ZBI01SEL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLB01EGR-001.
               PERFORM CALL-ZBI01SEL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01SEL-002.
               CALL 'ZBI01SEL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01SEL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       VALIDATE-MAKE-0001.
