      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00VP0'.
      ...
      * Called module names
       01  MOD-ZBI01HYO              PIC X(8) VALUE 'ZBI01HYO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01HYO-001.
               CALL 'ZBI01HYO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01HYO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
