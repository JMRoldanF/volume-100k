      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI017BW'.
      ...
      * Called module names
       01  MOD-ZBI01LYA              PIC X(8) VALUE 'ZBI01LYA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01LYA-001.
               CALL 'ZBI01LYA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01LYA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
