      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00ZUQ'.
      ...
      * Called module names
       01  MOD-ZBI01H08              PIC X(8) VALUE 'ZBI01H08'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01H08-001.
               PERFORM CALL-ZAG01UDE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01H08-001.
               CALL 'ZBI01H08' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01H08 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01UDE-002.
