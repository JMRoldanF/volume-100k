      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00RGS'.
      ...
      * Called module names
       01  MOD-ZBI01OT2              PIC X(8) VALUE 'ZBI01OT2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01OT2-001.
               CALL 'ZBI01OT2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01OT2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01J4W-002.
