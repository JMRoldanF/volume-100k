      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00S6T'.
      ...
      * Called module names
       01  MOD-ZLB01EL6              PIC X(8) VALUE 'ZLB01EL6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01EL6-001.
               CALL 'ZLB01EL6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01EL6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
