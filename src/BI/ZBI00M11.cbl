      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00M11'.
      ...
      * Called module names
       01  MOD-ZBI01QKJ              PIC X(8) VALUE 'ZBI01QKJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01QKJ-001.
               CALL 'ZBI01QKJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01QKJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
