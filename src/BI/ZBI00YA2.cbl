      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00YA2'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01TOC              PIC X(8) VALUE 'ZBI01TOC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01EC4-001.
               PERFORM CALL-ZBI01TOC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01TOC-002.
               CALL 'ZBI01TOC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01TOC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
