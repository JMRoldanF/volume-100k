      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00NRQ'.
      ...
      * Called module names
       01  MOD-ZBI01QZY              PIC X(8) VALUE 'ZBI01QZY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01QZY-001.
               CALL 'ZBI01QZY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01QZY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
