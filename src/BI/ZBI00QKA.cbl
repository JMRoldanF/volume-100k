      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00QKA'.
      ...
      * Called module names
       01  MOD-ZMT01KI7              PIC X(8) VALUE 'ZMT01KI7'.
       01  MOD-ZBI01Q6S              PIC X(8) VALUE 'ZBI01Q6S'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01KI7-001.
               PERFORM CALL-ZBI01Q6S-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01KI7-001.
               CALL 'ZMT01KI7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01KI7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01Q6S-002.
               CALL 'ZBI01Q6S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01Q6S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
