      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI0040M'.
      ...
      * Called module names
       ...
       01  MOD-ZPA00HR5              PIC X(8) VALUE 'ZPA00HR5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA00GBR-001.
               PERFORM CALL-ZBI00HFO-002.
               PERFORM CALL-ZPA00HR5-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00GBR-001.
               MOVE 'ZPA00GBR' TO WS-PROGNAME-6
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00HR5-003.
               EXEC CICS LINK PROGRAM('ZPA00HR5')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
