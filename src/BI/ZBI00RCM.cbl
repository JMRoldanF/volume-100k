      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00RCM'.
      ...
      * Called module names
       01  MOD-ZBI01GK4              PIC X(8) VALUE 'ZBI01GK4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01GK4-001.
               CALL 'ZBI01GK4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01GK4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
