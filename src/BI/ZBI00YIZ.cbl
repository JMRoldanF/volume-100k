      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00YIZ'.
      ...
      * Called module names
       01  MOD-ZBI01QZC              PIC X(8) VALUE 'ZBI01QZC'.
       01  MOD-ZBI01KIE              PIC X(8) VALUE 'ZBI01KIE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01QZC-001.
               PERFORM CALL-ZBI01KIE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01QZC-001.
               CALL 'ZBI01QZC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01KIE-002.
               CALL 'ZBI01KIE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01KIE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
