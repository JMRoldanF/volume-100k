      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI0110I'.
      ...
      * Called module names
       01  MOD-ZLB01ODP              PIC X(8) VALUE 'ZLB01ODP'.
       01  MOD-ZBI01D76              PIC X(8) VALUE 'ZBI01D76'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01ODP-001.
               CALL 'ZLB01ODP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01ODP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01D76-002.
               CALL 'ZBI01D76' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01D76 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-EXCESS-0001.
