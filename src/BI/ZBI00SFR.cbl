      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00SFR'.
      ...
      * Called module names
       01  MOD-ZBI01EN9              PIC X(8) VALUE 'ZBI01EN9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01EN9-001.
               PERFORM CALL-ZBI01UOQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01EN9-001.
               CALL 'ZBI01EN9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01EN9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01UOQ-002.
