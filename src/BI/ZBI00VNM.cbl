      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00VNM'.
      ...
      * Called module names
       01  MOD-ZBI01H6C              PIC X(8) VALUE 'ZBI01H6C'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01H6C-001.
               CALL 'ZBI01H6C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01H6C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
