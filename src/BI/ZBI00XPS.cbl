      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00XPS'.
      ...
      * Called module names
       01  MOD-ZBI01DDO              PIC X(8) VALUE 'ZBI01DDO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01DDO-001.
               CALL 'ZBI01DDO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01DDO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
