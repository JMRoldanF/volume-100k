      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI01K5U'.
      ...
      * Called module names
       01  MOD-ZBI01SES              PIC X(8) VALUE 'ZBI01SES'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01SES-001.
               CALL 'ZBI01SES' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01SES FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
