      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00SB2'.
      ...
      * Called module names
       01  MOD-ZMT01NR5              PIC X(8) VALUE 'ZMT01NR5'.
       01  MOD-ZHO01E7A              PIC X(8) VALUE 'ZHO01E7A'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01NR5-001.
               PERFORM CALL-ZHO01E7A-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01NR5-001.
               CALL 'ZMT01NR5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01NR5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01E7A-002.
               CALL 'ZHO01E7A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
