      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00XAI'.
      ...
      * Called module names
       01  MOD-ZBI01GGI              PIC X(8) VALUE 'ZBI01GGI'.
       01  MOD-ZBI01R9O              PIC X(8) VALUE 'ZBI01R9O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01GGI-001.
               CALL 'ZBI01GGI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01GGI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01R9O-002.
               CALL 'ZBI01R9O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01R9O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
