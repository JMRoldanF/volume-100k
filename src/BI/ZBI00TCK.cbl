      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00TCK'.
      ...
      * Called module names
       01  MOD-ZBI01ORY              PIC X(8) VALUE 'ZBI01ORY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01ORY-001.
               PERFORM CALL-ZBI01OP6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01ORY-001.
               CALL 'ZBI01ORY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
