      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI010XM'.
      ...
      * Called module names
       01  MOD-ZBI01FA0              PIC X(8) VALUE 'ZBI01FA0'.
       01  MOD-ZMT01HRB              PIC X(8) VALUE 'ZMT01HRB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01FA0-001.
               PERFORM CALL-ZMT01HRB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01FA0-001.
               CALL 'ZBI01FA0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01FA0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01HRB-002.
               CALL 'ZMT01HRB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01HRB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
