      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00NI0'.
      ...
      * Called module names
       01  MOD-ZAG01IAY              PIC X(8) VALUE 'ZAG01IAY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01IAY-001.
               CALL 'ZAG01IAY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01IAY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01PTQ-002.
