      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00YY8'.
      ...
      * Called module names
       01  MOD-ZCU01QZW              PIC X(8) VALUE 'ZCU01QZW'.
       01  MOD-ZMT01QVD              PIC X(8) VALUE 'ZMT01QVD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01QZW-001.
               CALL 'ZCU01QZW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01QZW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01QVD-002.
               CALL 'ZMT01QVD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01QVD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
