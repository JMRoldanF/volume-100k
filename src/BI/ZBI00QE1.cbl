      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00QE1'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01NB8              PIC X(8) VALUE 'ZBI01NB8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01E2W-001.
               PERFORM CALL-ZBI01NB8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01NB8-002.
               CALL 'ZBI01NB8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01NB8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
