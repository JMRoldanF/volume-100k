      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00WXU'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01ETT              PIC X(8) VALUE 'ZBI01ETT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01ETT-002.
               CALL 'ZBI01ETT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01ETT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
