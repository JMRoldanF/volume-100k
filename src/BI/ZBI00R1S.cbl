      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00R1S'.
      ...
      * Called module names
       01  MOD-ZRE01N35              PIC X(8) VALUE 'ZRE01N35'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01N35-001.
               CALL 'ZRE01N35' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01N35 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
