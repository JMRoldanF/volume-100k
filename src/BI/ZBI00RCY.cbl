      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00RCY'.
      ...
      * Called module names
       01  MOD-ZBI01HE2              PIC X(8) VALUE 'ZBI01HE2'.
       01  MOD-ZBI01GUW              PIC X(8) VALUE 'ZBI01GUW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01HE2-001.
               CALL 'ZBI01HE2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01HE2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01GUW-002.
               CALL 'ZBI01GUW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01GUW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
