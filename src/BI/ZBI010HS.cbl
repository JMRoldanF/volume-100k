      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI010HS'.
      ...
      * Called module names
       01  MOD-ZBI01KX2              PIC X(8) VALUE 'ZBI01KX2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01KX2-001.
               CALL 'ZBI01KX2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01KX2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
