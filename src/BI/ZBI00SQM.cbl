      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00SQM'.
      ...
      * Called module names
       01  MOD-ZBI01P4Q              PIC X(8) VALUE 'ZBI01P4Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01P4Q-001.
               CALL 'ZBI01P4Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01P4Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
