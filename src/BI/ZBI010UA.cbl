      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI010UA'.
      ...
      * Called module names
       01  MOD-ZBI01JMO              PIC X(8) VALUE 'ZBI01JMO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01JMO-001.
               CALL 'ZBI01JMO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01JMO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01RMQ-002.
