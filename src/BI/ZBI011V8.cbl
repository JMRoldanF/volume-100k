      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI011V8'.
      ...
      * Called module names
       01  MOD-ZBI01FLY              PIC X(8) VALUE 'ZBI01FLY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01FLY-001.
               CALL 'ZBI01FLY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01FLY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
