      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI011MC'.
      ...
      * Called module names
       01  MOD-ZUW01T5K              PIC X(8) VALUE 'ZUW01T5K'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01T5K-001.
               PERFORM CALL-ZBI01R3K-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01T5K-001.
               CALL 'ZUW01T5K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01T5K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01R3K-002.
