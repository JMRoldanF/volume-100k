      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI0119A'.
      ...
      * Called module names
       01  MOD-ZBI01O6A              PIC X(8) VALUE 'ZBI01O6A'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01O6A-001.
               CALL 'ZBI01O6A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01O6A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01QTK-002.
               MOVE 'ZBI01QTK' TO WS-SUBNAME-6
