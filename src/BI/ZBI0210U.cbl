      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI0210U'.
      ...
      * Called module names
       01  MOD-ZBI01IHU              PIC X(8) VALUE 'ZBI01IHU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01IHU-002.
               CALL 'ZBI01IHU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01IHU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
