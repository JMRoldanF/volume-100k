      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00X94'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01OA6              PIC X(8) VALUE 'ZBI01OA6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01F1E-001.
               PERFORM CALL-ZBI01OA6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01OA6-002.
               CALL 'ZBI01OA6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01OA6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
