      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI000WQ'.
      ...
      * Called module names
       01  MOD-ZBI00CXP              PIC X(8) VALUE 'ZBI00CXP'.
       01  MOD-ZBI00APS              PIC X(8) VALUE 'ZBI00APS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI00CXP-001.
               PERFORM CALL-ZBI00APS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI00CXP-001.
               EXEC CICS LINK PROGRAM('ZBI00CXP')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI00CXP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI00APS-002.
               EXEC CICS LINK PROGRAM('ZBI00APS')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI00APS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
