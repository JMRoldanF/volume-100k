      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00S76'.
      ...
      * Called module names
       01  MOD-ZBI01LNQ              PIC X(8) VALUE 'ZBI01LNQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01LNQ-001.
               CALL 'ZBI01LNQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01LNQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
