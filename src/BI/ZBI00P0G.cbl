      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00P0G'.
      ...
      * Called module names
       01  MOD-ZEN01RVJ              PIC X(8) VALUE 'ZEN01RVJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM VALIDATE-TAX-BAND-0076.
               PERFORM NORMALISE-EQUITIES-0077.
               PERFORM SQL-ACCESS-0078.
               PERFORM VALIDATE-CC-RATING-0079.
               ...
               PERFORM FORMAT-MODEL-0119.
               PERFORM SQL-ACCESS-0120.
               PERFORM VALIDATE-MODEL-0121.
               PERFORM AUDIT-VALUE-0122.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZEN01RVJ-001.
               CALL 'ZEN01RVJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01RVJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
