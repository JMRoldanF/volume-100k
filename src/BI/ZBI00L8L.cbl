      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00L8L'.
      ...
      * Called module names
       01  MOD-ZBI011VT              PIC X(8) VALUE 'ZBI011VT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI011VT-001.
               PERFORM CALL-ZBI00MWN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI011VT-001.
               EXEC CICS LINK PROGRAM('ZBI011VT')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI011VT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI00MWN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01C9R-003.
               MOVE 'ZBI01C9R' TO WS-PROGNAME-6
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01C9R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-004.
