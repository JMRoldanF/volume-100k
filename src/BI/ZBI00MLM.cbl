      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00MLM'.
      ...
      * Called module names
       01  MOD-ZBI01D2S              PIC X(8) VALUE 'ZBI01D2S'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01D2S-001.
               CALL 'ZBI01D2S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01D2S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-PREMIUM-0001.
