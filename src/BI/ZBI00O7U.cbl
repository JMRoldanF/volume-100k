      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00O7U'.
      ...
      * Called module names
       01  MOD-ZBI01TRO              PIC X(8) VALUE 'ZBI01TRO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01TRO-001.
               PERFORM CALL-ZAG01TAS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01TRO-001.
               CALL 'ZBI01TRO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01TRO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01TAS-002.
               MOVE 'ZAG01TAS' TO WS-SUBNAME-1
