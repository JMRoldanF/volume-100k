      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00WJA'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01FXJ              PIC X(8) VALUE 'ZEN01FXJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01FXJ-002.
               CALL 'ZEN01FXJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01FXJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
