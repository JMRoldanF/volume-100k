      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI019QK'.
      ...
      * Called module names
       01  MOD-ZBI01M4O              PIC X(8) VALUE 'ZBI01M4O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01M4O-001.
               CALL 'ZBI01M4O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01M4O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
