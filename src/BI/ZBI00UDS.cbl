      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00UDS'.
      ...
      * Called module names
       01  MOD-ZBI01JFG              PIC X(8) VALUE 'ZBI01JFG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01JFG-002.
               CALL 'ZBI01JFG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
