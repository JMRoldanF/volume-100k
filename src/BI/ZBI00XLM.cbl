      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00XLM'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01TXI              PIC X(8) VALUE 'ZBI01TXI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01TXI-002.
               CALL 'ZBI01TXI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01TXI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-PREMIUM-0001.
