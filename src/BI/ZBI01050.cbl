      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI01050'.
      ...
      * Called module names
       01  MOD-ZBI01MNA              PIC X(8) VALUE 'ZBI01MNA'.
       01  MOD-ZBI01O5Q              PIC X(8) VALUE 'ZBI01O5Q'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01MNA-001.
               PERFORM CALL-ZBI01O5Q-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01MNA-001.
               CALL 'ZBI01MNA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01MNA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01O5Q-002.
               CALL 'ZBI01O5Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01O5Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
