      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00NCG'.
      ...
      * Called module names
       01  MOD-ZBI01HR6              PIC X(8) VALUE 'ZBI01HR6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01HR6-002.
               CALL 'ZBI01HR6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
