      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00TYI'.
      ...
      * Called module names
       01  MOD-ZBI01L0O              PIC X(8) VALUE 'ZBI01L0O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01L0O-001.
               CALL 'ZBI01L0O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01L0O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
