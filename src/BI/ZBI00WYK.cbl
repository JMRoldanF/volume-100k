      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00WYK'.
      ...
      * Called module names
       01  MOD-ZBI01P0K              PIC X(8) VALUE 'ZBI01P0K'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01P0K-001.
               PERFORM CALL-ZBI01HC6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01P0K-001.
               CALL 'ZBI01P0K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01P0K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01HC6-002.
