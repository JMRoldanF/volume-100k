      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00WEK'.
      ...
      * Called module names
       01  MOD-ZBI01RQW              PIC X(8) VALUE 'ZBI01RQW'.
       01  MOD-ZBI01KDM              PIC X(8) VALUE 'ZBI01KDM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01RQW-001.
               PERFORM CALL-ZBI01KDM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01RQW-001.
               CALL 'ZBI01RQW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01RQW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01KDM-002.
               CALL 'ZBI01KDM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01KDM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-VALUE-0001.
