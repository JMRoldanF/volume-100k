      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00VNN'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01PK8              PIC X(8) VALUE 'ZBI01PK8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01KXZ-001.
               PERFORM CALL-ZBI01PK8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01PK8-002.
               CALL 'ZBI01PK8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
