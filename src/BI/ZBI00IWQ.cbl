      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00IWQ'.
      ...
      * Called module names
       01  MOD-ZBI011O0              PIC X(8) VALUE 'ZBI011O0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI011O0-001.
               EXEC CICS LINK PROGRAM('ZBI011O0')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI011O0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
