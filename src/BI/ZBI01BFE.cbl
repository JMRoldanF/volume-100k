      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI01BFE'.
      ...
      * Called module names
       01  MOD-ZBI01CVW              PIC X(8) VALUE 'ZBI01CVW'.
       01  MOD-ZBI01DGG              PIC X(8) VALUE 'ZBI01DGG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01CVW-001.
               PERFORM CALL-ZBI01DGG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01CVW-001.
               CALL 'ZBI01CVW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01CVW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01DGG-002.
               CALL 'ZBI01DGG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01DGG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
