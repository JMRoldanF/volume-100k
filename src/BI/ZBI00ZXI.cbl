      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00ZXI'.
      ...
      * Called module names
       01  MOD-ZBI01E8S              PIC X(8) VALUE 'ZBI01E8S'.
       01  MOD-ZPA01V1L              PIC X(8) VALUE 'ZPA01V1L'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01E8S-001.
               PERFORM CALL-ZPA01V1L-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01E8S-001.
               CALL 'ZBI01E8S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01E8S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01V1L-002.
               CALL 'ZPA01V1L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01V1L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
