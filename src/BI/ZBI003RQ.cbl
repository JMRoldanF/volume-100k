      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI003RQ'.
      ...
      * Called module names
       01  MOD-ZBI00AJW              PIC X(8) VALUE 'ZBI00AJW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU00H5M-001.
               PERFORM CALL-ZBI00AJW-002.
               PERFORM CALL-ZBI00JPC-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU00H5M-001.
               MOVE 'ZCU00H5M' TO WS-PROGNAME-2
      ...
      *----------------------------------------------------------------*
       CALL-ZBI00AJW-002.
               EXEC CICS LINK PROGRAM('ZBI00AJW')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI00AJW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI00JPC-003.
