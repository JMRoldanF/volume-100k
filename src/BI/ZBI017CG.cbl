      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI017CG'.
      ...
      * Called module names
       01  MOD-ZBI01P32              PIC X(8) VALUE 'ZBI01P32'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01P32-002.
               CALL 'ZBI01P32' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01P32 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
