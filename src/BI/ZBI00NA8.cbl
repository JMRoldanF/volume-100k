      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00NA8'.
      ...
      * Called module names
       01  MOD-ZBI01SA2              PIC X(8) VALUE 'ZBI01SA2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01SA2-001.
               CALL 'ZBI01SA2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01SA2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
