      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI010WI'.
      ...
      * Called module names
       01  MOD-ZBI01LBI              PIC X(8) VALUE 'ZBI01LBI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01LBI-001.
               PERFORM CALL-ZBI01O8I-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01LBI-001.
               CALL 'ZBI01LBI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
