      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00MWW'.
      ...
      * Called module names
       01  MOD-ZCL01PF9              PIC X(8) VALUE 'ZCL01PF9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01PF9-001.
               CALL 'ZCL01PF9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01PF9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
