      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00V8E'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01HSP              PIC X(8) VALUE 'ZBI01HSP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01HSP-002.
               CALL 'ZBI01HSP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01HSP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
