      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00RTK'.
      ...
      * Called module names
       01  MOD-ZBI01MF8              PIC X(8) VALUE 'ZBI01MF8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01MF8-001.
               CALL 'ZBI01MF8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01MF8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
