      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00N7Q'.
      ...
      * Called module names
       01  MOD-ZBI01GNQ              PIC X(8) VALUE 'ZBI01GNQ'.
       01  MOD-ZBI01TDI              PIC X(8) VALUE 'ZBI01TDI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01GNQ-001.
               PERFORM CALL-ZBI01TDI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01GNQ-001.
               CALL 'ZBI01GNQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01GNQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01TDI-002.
               CALL 'ZBI01TDI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01TDI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
