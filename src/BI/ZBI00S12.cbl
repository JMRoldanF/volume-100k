      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00S12'.
      ...
      * Called module names
       01  MOD-ZCL01OJV              PIC X(8) VALUE 'ZCL01OJV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01OJV-001.
               CALL 'ZCL01OJV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01OJV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
