      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00TCF'.
      ...
      * Called module names
       01  MOD-ZBI01TQ5              PIC X(8) VALUE 'ZBI01TQ5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01TQ5-001.
               CALL 'ZBI01TQ5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01TQ5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
