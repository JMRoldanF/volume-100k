      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00UML'.
      ...
      * Called module names
       01  MOD-ZBI01RBO              PIC X(8) VALUE 'ZBI01RBO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01RBO-001.
               PERFORM CALL-ZBI01H40-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01RBO-001.
               CALL 'ZBI01RBO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01RBO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01H40-002.
