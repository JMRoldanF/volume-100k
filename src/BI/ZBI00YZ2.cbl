      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00YZ2'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01K1E              PIC X(8) VALUE 'ZBI01K1E'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01MRQ-001.
               PERFORM CALL-ZBI01K1E-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01K1E-002.
               CALL 'ZBI01K1E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01K1E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
