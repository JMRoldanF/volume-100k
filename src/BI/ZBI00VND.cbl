      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00VND'.
      ...
      * Called module names
       01  MOD-ZBI01F54              PIC X(8) VALUE 'ZBI01F54'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01F54-001.
               CALL 'ZBI01F54' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01F54 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
