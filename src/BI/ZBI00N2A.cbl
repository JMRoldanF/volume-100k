      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00N2A'.
      ...
      * Called module names
       01  MOD-ZBI01EL3              PIC X(8) VALUE 'ZBI01EL3'.
       01  MOD-ZBI01IKN              PIC X(8) VALUE 'ZBI01IKN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01EL3-001.
               PERFORM CALL-ZBI01IKN-002.
               PERFORM FORMAT-TERM-0001.
               ...
               PERFORM COMPUTE-REG-NUMBER-0065.
               ...
               PERFORM DERIVE-WITH-PROFITS-0124.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01EL3-001.
               CALL 'ZBI01EL3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01EL3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01IKN-002.
               CALL 'ZBI01IKN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01IKN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-TERM-0001.
