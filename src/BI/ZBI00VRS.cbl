      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00VRS'.
      ...
      * Called module names
       01  MOD-ZBI01F4G              PIC X(8) VALUE 'ZBI01F4G'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01F4G-001.
               CALL 'ZBI01F4G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01F4G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
