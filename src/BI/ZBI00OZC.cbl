      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00OZC'.
      ...
      * Called module names
       01  MOD-ZBI01IJI              PIC X(8) VALUE 'ZBI01IJI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01IJI-001.
               CALL 'ZBI01IJI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01IJI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
