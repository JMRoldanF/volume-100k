      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI011E0'.
      ...
      * Called module names
       01  MOD-ZBI01EIS              PIC X(8) VALUE 'ZBI01EIS'.
       01  MOD-ZBI01CNA              PIC X(8) VALUE 'ZBI01CNA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01EIS-001.
               PERFORM CALL-ZBI01CNA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01EIS-001.
               CALL 'ZBI01EIS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01EIS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01CNA-002.
               CALL 'ZBI01CNA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01CNA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
