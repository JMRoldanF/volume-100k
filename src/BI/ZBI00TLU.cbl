      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00TLU'.
      ...
      * Called module names
       01  MOD-ZBI01D03              PIC X(8) VALUE 'ZBI01D03'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01D03-001.
               PERFORM CALL-ZRN01PHK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01D03-001.
               CALL 'ZBI01D03' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01D03 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRN01PHK-002.
