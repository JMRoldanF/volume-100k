      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00Q7S'.
      ...
      * Called module names
       01  MOD-ZHO01MO0              PIC X(8) VALUE 'ZHO01MO0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01MO0-001.
               CALL 'ZHO01MO0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01MO0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
