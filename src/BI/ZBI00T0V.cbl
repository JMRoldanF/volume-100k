      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00T0V'.
      ...
      * Called module names
       01  MOD-ZBI01RRX              PIC X(8) VALUE 'ZBI01RRX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01RRX-001.
               CALL 'ZBI01RRX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01RRX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
