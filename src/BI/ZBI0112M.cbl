      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI0112M'.
      ...
      * Called module names
       01  MOD-ZBI01U32              PIC X(8) VALUE 'ZBI01U32'.
       01  MOD-ZBI01MBC              PIC X(8) VALUE 'ZBI01MBC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01U32-001.
               PERFORM CALL-ZBI01MBC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01U32-001.
               CALL 'ZBI01U32' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01U32 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01MBC-002.
               CALL 'ZBI01MBC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01MBC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
