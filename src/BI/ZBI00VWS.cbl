      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00VWS'.
      ...
      * Called module names
       01  MOD-ZBI01EDI              PIC X(8) VALUE 'ZBI01EDI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01EDI-001.
               CALL 'ZBI01EDI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01EDI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
