      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00Z5Z'.
      ...
      * Called module names
       01  MOD-ZBI01KUZ              PIC X(8) VALUE 'ZBI01KUZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01KUZ-001.
               CALL 'ZBI01KUZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01KUZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01QS8-002.
