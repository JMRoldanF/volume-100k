      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI001CI'.
      ...
      * Called module names
       01  MOD-ZBI00HXG              PIC X(8) VALUE 'ZBI00HXG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI00HXG-001.
               PERFORM CALL-ZBI00H1S-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI00HXG-001.
               EXEC CICS LINK PROGRAM('ZBI00HXG')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI00HXG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI00H1S-002.
