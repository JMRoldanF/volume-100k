      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00OCK'.
      ...
      * Called module names
       01  MOD-ZBI01NJ8              PIC X(8) VALUE 'ZBI01NJ8'.
       01  MOD-ZBI01JBU              PIC X(8) VALUE 'ZBI01JBU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01NJ8-001.
               PERFORM CALL-ZBI01JBU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01NJ8-001.
               CALL 'ZBI01NJ8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01NJ8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01JBU-002.
               CALL 'ZBI01JBU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01JBU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
