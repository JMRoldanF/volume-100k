      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00R4U'.
      ...
      * Called module names
       01  MOD-ZBI01SEI              PIC X(8) VALUE 'ZBI01SEI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01SEI-001.
               CALL 'ZBI01SEI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01SEI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
