      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00PRE'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01DEI              PIC X(8) VALUE 'ZBI01DEI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01HLC-001.
               PERFORM CALL-ZBI01DEI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01DEI-002.
               CALL 'ZBI01DEI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01DEI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
