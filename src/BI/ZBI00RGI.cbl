      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00RGI'.
      ...
      * Called module names
       01  MOD-ZBI01DYI              PIC X(8) VALUE 'ZBI01DYI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01DYI-001.
               CALL 'ZBI01DYI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01DYI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
