      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00ZQ2'.
      ...
      * Called module names
       01  MOD-ZRN01M28              PIC X(8) VALUE 'ZRN01M28'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRN01M28-001.
               CALL 'ZRN01M28' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01M28 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
