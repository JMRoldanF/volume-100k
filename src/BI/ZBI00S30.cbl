      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00S30'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01R80              PIC X(8) VALUE 'ZBI01R80'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01QMC-001.
               PERFORM CALL-ZBI01R80-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01R80-002.
               CALL 'ZBI01R80' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01R80 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
