      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00PSI'.
      ...
      * Called module names
       01  MOD-ZBI01GJK              PIC X(8) VALUE 'ZBI01GJK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01GJK-001.
               CALL 'ZBI01GJK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01GJK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
