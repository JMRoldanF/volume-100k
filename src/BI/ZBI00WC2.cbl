      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00WC2'.
      ...
      * Called module names
       01  MOD-ZCU01FEE              PIC X(8) VALUE 'ZCU01FEE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01FEE-001.
               CALL 'ZCU01FEE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01FEE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
