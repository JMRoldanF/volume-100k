      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00WHC'.
      ...
      * Called module names
       01  MOD-ZBI01MP8              PIC X(8) VALUE 'ZBI01MP8'.
       01  MOD-ZBI01LKY              PIC X(8) VALUE 'ZBI01LKY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01MP8-001.
               CALL 'ZBI01MP8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01MP8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01LKY-002.
               CALL 'ZBI01LKY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
