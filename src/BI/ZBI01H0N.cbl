      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI01H0N'.
      ...
      * Called module names
       01  MOD-ZBI01HXC              PIC X(8) VALUE 'ZBI01HXC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01HXC-001.
               CALL 'ZBI01HXC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01HXC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
