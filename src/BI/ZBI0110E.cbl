      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI0110E'.
      ...
      * Called module names
       01  MOD-ZBI01UDW              PIC X(8) VALUE 'ZBI01UDW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01UDW-001.
               CALL 'ZBI01UDW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01UDW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-PREMIUM-0001.
