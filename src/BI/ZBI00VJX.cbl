      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00VJX'.
      ...
      * Called module names
       01  MOD-ZBI01UH9              PIC X(8) VALUE 'ZBI01UH9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01UH9-001.
               CALL 'ZBI01UH9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01UH9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01EQO-002.
