      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00WFY'.
      ...
      * Called module names
       01  MOD-ZBI01OQA              PIC X(8) VALUE 'ZBI01OQA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01OQA-002.
               CALL 'ZBI01OQA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01OQA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
