      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00RAE'.
      ...
      * Called module names
       01  MOD-ZBI01JLA              PIC X(8) VALUE 'ZBI01JLA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01JLA-001.
               PERFORM CALL-ZBI01PYG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01JLA-001.
               CALL 'ZBI01JLA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01JLA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01PYG-002.
               MOVE 'ZBI01PYG' TO WS-SUBNAME-5
