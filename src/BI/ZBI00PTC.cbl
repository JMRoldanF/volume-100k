      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00PTC'.
      ...
      * Called module names
       01  MOD-ZHO01FB0              PIC X(8) VALUE 'ZHO01FB0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01FB0-001.
               CALL 'ZHO01FB0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01FB0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01J49-002.
               MOVE 'ZEN01J49' TO WS-SUBNAME-4
