      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00MXP'.
      ...
      * Called module names
       01  MOD-ZLB01MRT              PIC X(8) VALUE 'ZLB01MRT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01MRT-001.
               CALL 'ZLB01MRT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01MRT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
