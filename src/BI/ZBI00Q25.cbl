      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00Q25'.
      ...
      * Called module names
       01  MOD-ZBI01DX9              PIC X(8) VALUE 'ZBI01DX9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01DX9-002.
               CALL 'ZBI01DX9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01DX9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
