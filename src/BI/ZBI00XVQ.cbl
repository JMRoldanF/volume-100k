      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00XVQ'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01OCQ              PIC X(8) VALUE 'ZBI01OCQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01V3J-001.
               PERFORM CALL-ZBI01OCQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01OCQ-002.
               CALL 'ZBI01OCQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01OCQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
