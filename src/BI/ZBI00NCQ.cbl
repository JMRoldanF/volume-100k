      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00NCQ'.
      ...
      * Called module names
       01  MOD-ZBI01QAE              PIC X(8) VALUE 'ZBI01QAE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01QAE-001.
               CALL 'ZBI01QAE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01QAE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
