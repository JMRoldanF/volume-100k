      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00UYM'.
      ...
      * Called module names
       01  MOD-ZBI01LWG              PIC X(8) VALUE 'ZBI01LWG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01LWG-001.
               CALL 'ZBI01LWG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01LWG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01PDW-002.
