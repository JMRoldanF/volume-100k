      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00PCI'.
      ...
      * Called module names
       01  MOD-ZBI01U5O              PIC X(8) VALUE 'ZBI01U5O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01U5O-001.
               CALL 'ZBI01U5O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01U5O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
