      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00PLK'.
      ...
      * Called module names
       01  MOD-ZBI01PGO              PIC X(8) VALUE 'ZBI01PGO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01PGO-001.
               PERFORM CALL-ZBI01NF2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01PGO-001.
               CALL 'ZBI01PGO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01PGO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01NF2-002.
               MOVE 'ZBI01NF2' TO WS-SUBNAME-8
