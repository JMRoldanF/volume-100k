      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00WNG'.
      ...
      * Called module names
       01  MOD-ZBI01PS2              PIC X(8) VALUE 'ZBI01PS2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01PS2-001.
               CALL 'ZBI01PS2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01PS2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
