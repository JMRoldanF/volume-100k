      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00YPW'.
      ...
      * Called module names
       01  MOD-ZBI01OTW              PIC X(8) VALUE 'ZBI01OTW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01OTW-001.
               CALL 'ZBI01OTW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01OTW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
