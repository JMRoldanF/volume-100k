      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00PIB'.
      ...
      * Called module names
       01  MOD-ZBI01QUW              PIC X(8) VALUE 'ZBI01QUW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM RECONCILE-BEDROOMS-0014.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01QUW-001.
               CALL 'ZBI01QUW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01QUW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
