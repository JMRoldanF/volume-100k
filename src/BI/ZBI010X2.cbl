      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI010X2'.
      ...
      * Called module names
       01  MOD-ZBI01SYS              PIC X(8) VALUE 'ZBI01SYS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01SYS-001.
               CALL 'ZBI01SYS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01SYS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-VALUE-0001.
