      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00PFQ'.
      ...
      * Called module names
       01  MOD-ZUW01MMA              PIC X(8) VALUE 'ZUW01MMA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01MMA-001.
               CALL 'ZUW01MMA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01MMA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
