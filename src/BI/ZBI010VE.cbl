      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI010VE'.
      ...
      * Called module names
       01  MOD-ZBI01OQK              PIC X(8) VALUE 'ZBI01OQK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01OQK-001.
               PERFORM CALL-ZBI01OFQ-002.
               PERFORM CALL-ZHO0255M-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZBI01OQK-001.
               CALL 'ZBI01OQK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
