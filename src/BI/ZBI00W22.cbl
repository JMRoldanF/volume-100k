      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00W22'.
      ...
      * Called module names
       01  MOD-ZCU01GC0              PIC X(8) VALUE 'ZCU01GC0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01GC0-001.
               CALL 'ZCU01GC0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01GC0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
