      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI011P4'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01V3Q              PIC X(8) VALUE 'ZBI01V3Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01V3Q-002.
               CALL 'ZBI01V3Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01V3Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
