      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00MIG'.
      ...
      * Called module names
       01  MOD-ZBI01LAO              PIC X(8) VALUE 'ZBI01LAO'.
       01  MOD-ZBI01JCY              PIC X(8) VALUE 'ZBI01JCY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01LAO-001.
               CALL 'ZBI01LAO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01JCY-002.
               CALL 'ZBI01JCY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01JCY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
