      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00N5R'.
      ...
      * Called module names
       01  MOD-ZBI01N07              PIC X(8) VALUE 'ZBI01N07'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01RMR-001.
               PERFORM CALL-ZBI01N07-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01N07-002.
               CALL 'ZBI01N07' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01N07 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-MAKE-0001.
