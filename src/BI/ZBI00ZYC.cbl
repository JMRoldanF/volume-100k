      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00ZYC'.
      ...
      * Called module names
       01  MOD-ZBI01CW6              PIC X(8) VALUE 'ZBI01CW6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01CW6-001.
               CALL 'ZBI01CW6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01CW6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
