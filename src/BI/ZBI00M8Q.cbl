      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00M8Q'.
      ...
      * Called module names
       01  MOD-ZBI01M3K              PIC X(8) VALUE 'ZBI01M3K'.
       01  MOD-ZBI01D4I              PIC X(8) VALUE 'ZBI01D4I'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01M3K-001.
               PERFORM CALL-ZBI01D4I-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01M3K-001.
               CALL 'ZBI01M3K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01M3K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01D4I-002.
               CALL 'ZBI01D4I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01D4I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
