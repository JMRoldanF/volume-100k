      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00ZZG'.
      ...
      * Called module names
       01  MOD-ZBI01HV2              PIC X(8) VALUE 'ZBI01HV2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01HV2-001.
               CALL 'ZBI01HV2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01HV2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
