      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI0154G'.
      ...
      * Called module names
       01  MOD-ZBI01K28              PIC X(8) VALUE 'ZBI01K28'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01K28-001.
               CALL 'ZBI01K28' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01K28 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
