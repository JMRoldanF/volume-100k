      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00QVE'.
      ...
      * Called module names
       01  MOD-ZBI01KJ6              PIC X(8) VALUE 'ZBI01KJ6'.
       01  MOD-ZUW01MVG              PIC X(8) VALUE 'ZUW01MVG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01KJ6-001.
               PERFORM CALL-ZUW01MVG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01KJ6-001.
               CALL 'ZBI01KJ6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01KJ6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01MVG-002.
               CALL 'ZUW01MVG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
