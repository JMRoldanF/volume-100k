      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00ZME'.
      ...
      * Called module names
       01  MOD-ZMT01UHN              PIC X(8) VALUE 'ZMT01UHN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01UHN-001.
               CALL 'ZMT01UHN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01UHN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-MODEL-0001.
