      ...
      * Called module names
       01  MOD-ZBI01L0G              PIC X(8) VALUE 'ZBI01L0G'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01IUC-001.
               PERFORM CALL-ZBI01L0G-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01L0G-002.
               CALL 'ZBI01L0G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01L0G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
