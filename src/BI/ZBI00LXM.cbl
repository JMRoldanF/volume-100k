      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00LXM'.
      ...
      * Called module names
       01  MOD-ZBI01TGU              PIC X(8) VALUE 'ZBI01TGU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01TGU-001.
               CALL 'ZBI01TGU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01TGU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
