      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00R3G'.
      ...
      * Called module names
       01  MOD-ZPA01GRF              PIC X(8) VALUE 'ZPA01GRF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01GRF-001.
               CALL 'ZPA01GRF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01GRF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
