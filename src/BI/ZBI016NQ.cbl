      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI016NQ'.
      ...
      * Called module names
       01  MOD-ZBI01PCI              PIC X(8) VALUE 'ZBI01PCI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01PCI-001.
               CALL 'ZBI01PCI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01PCI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
