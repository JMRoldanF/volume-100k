      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI011S6'.
      ...
      * Called module names
       01  MOD-ZBI01HSU              PIC X(8) VALUE 'ZBI01HSU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM VALIDATE-NCD-YEARS-0101.
               PERFORM SQL-ACCESS-0102.
               PERFORM RECONCILE-EXCESS-0103.
               PERFORM REFRESH-EQUITIES-0104.
               ...
               PERFORM COMPUTE-TERM-0121.
               PERFORM AUDIT-TERM-0122.
               ...
               PERFORM RESOLVE-MANAGED-FUND-0128.
               PERFORM SQL-ACCESS-0129.
               PERFORM REFRESH-EQUITIES-0130.
               PERFORM VALIDATE-POSTCODE-0131.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZBI01HSU-001.
               CALL 'ZBI01HSU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01HSU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
               ...
               EXEC SQL
                     SELECT POLICYNUMBER, ISSUEDATE, EXPIRYDATE,
                       ...
                       INTO :HV-POLICY-NUM, :HV-ISSUE-DATE,
                            :HV-EXPIRY-DATE, :HV-BROKERID,
                            :HV-PAYMENT, :HV-LASTCHANGED
                       FROM GENABI.COMMISSION
                      WHERE CUSTOMERNUMBER = :HV-CUSTOMER-NUM
               END-EXEC.
      *----------------------------------------------------------------*
       NORMALISE-EXCESS-0082.
               PERFORM VARYING WS-IX FROM 1 BY 1
                           UNTIL WS-IX > WS-TABLE-COUNT
                  ADD WS-T-AMOUNT(WS-IX) TO WS-PREMIUM-TOTAL
                  IF WS-T-AMOUNT(WS-IX) = ZERO
