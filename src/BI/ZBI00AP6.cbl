      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00AP6'.
      ...
      * Called module names
       01  MOD-ZBI00Q4G              PIC X(8) VALUE 'ZBI00Q4G'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI00Q4G-001.
               PERFORM CALL-ZBI00S12-002.
               PERFORM CALL-ZBI016TA-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI00Q4G-001.
               EXEC CICS LINK PROGRAM('ZBI00Q4G')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI00Q4G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI00S12-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI016TA-003.
               MOVE 'ZBI016TA' TO WS-PROGNAME-4
