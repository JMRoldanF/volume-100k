      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00WRC'.
      ...
      * Called module names
       01  MOD-ZCL01F2H              PIC X(8) VALUE 'ZCL01F2H'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01F2H-001.
               CALL 'ZCL01F2H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01F2H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
