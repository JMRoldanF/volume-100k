      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00XOE'.
      ...
      * Called module names
       01  MOD-ZBI01CP8              PIC X(8) VALUE 'ZBI01CP8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01CP8-001.
               CALL 'ZBI01CP8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01CP8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01PYQ-002.
