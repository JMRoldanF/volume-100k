      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI016YA'.
      ...
      * Called module names
       01  MOD-ZBI01OFQ              PIC X(8) VALUE 'ZBI01OFQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01OFQ-001.
               CALL 'ZBI01OFQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01OFQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01SIW-002.
