      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00TX4'.
      ...
      * Called module names
       01  MOD-ZBI01RDA              PIC X(8) VALUE 'ZBI01RDA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01RDA-001.
               CALL 'ZBI01RDA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01RDA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
