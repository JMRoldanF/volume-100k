      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00TFM'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01HNA              PIC X(8) VALUE 'ZBI01HNA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01HNA-002.
               CALL 'ZBI01HNA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01HNA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
