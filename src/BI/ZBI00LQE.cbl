      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00LQE'.
      ...
      * Called module names
       01  MOD-ZBI01RBM              PIC X(8) VALUE 'ZBI01RBM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01RBM-001.
               CALL 'ZBI01RBM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01RBM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01KHI-002.
