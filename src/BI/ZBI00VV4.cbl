      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00VV4'.
      ...
      * Called module names
       01  MOD-ZBI01ENI              PIC X(8) VALUE 'ZBI01ENI'.
       01  MOD-ZBI01UWS              PIC X(8) VALUE 'ZBI01UWS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01ENI-001.
               PERFORM CALL-ZBI01UWS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01ENI-001.
               CALL 'ZBI01ENI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01ENI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01UWS-002.
               CALL 'ZBI01UWS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01UWS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
