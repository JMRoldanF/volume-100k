      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI005UG'.
      ...
      * Called module names
       ...
       01  MOD-ZUW005AU              PIC X(8) VALUE 'ZUW005AU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE00AGL-001.
               PERFORM CALL-ZBI00C0E-002.
               PERFORM CALL-ZUW005AU-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI00C0E-002.
               MOVE 'ZBI00C0E' TO WS-PROGNAME-8
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI00C0E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW005AU-003.
               EXEC CICS XCTL PROGRAM('ZUW005AU')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW005AU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-004.
