      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00UKG'.
      ...
      * Called module names
       01  MOD-ZRE01E9X              PIC X(8) VALUE 'ZRE01E9X'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01E9X-001.
               PERFORM CALL-ZBI01LLS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01E9X-001.
               CALL 'ZRE01E9X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
