      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00XG2'.
      ...
      * Called module names
       01  MOD-ZCU01MBK              PIC X(8) VALUE 'ZCU01MBK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM APPLY-SUM-ASSURED-0008.
               ...
               PERFORM RECONCILE-EQUITIES-0031.
               ...
               PERFORM COMPUTE-HOUSE-TYPE-0061.
               ...
               PERFORM RESOLVE-ROOF-TYPE-0073.
               ...
               PERFORM RESOLVE-SUM-ASSURED-0083.
               ...
               PERFORM VALIDATE-MANAGED-FUND-0127.
               PERFORM REFRESH-HOUSE-TYPE-0128.
               PERFORM SQL-ACCESS-0129.
               PERFORM REFRESH-SUM-ASSURED-0130.
               PERFORM AUDIT-POSTCODE-0131.
               PERFORM APPLY-TAX-BAND-0133.
               PERFORM DERIVE-TERM-0134.
               PERFORM SQL-ACCESS-0135.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCU01MBK-001.
               CALL 'ZCU01MBK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01MBK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
