      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00MZA'.
      ...
      * Called module names
       01  MOD-ZBI01D2Q              PIC X(8) VALUE 'ZBI01D2Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01D2Q-001.
               CALL 'ZBI01D2Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01D2Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-MODEL-0001.
