      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00UJ3'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01SHM              PIC X(8) VALUE 'ZBI01SHM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01SHM-002.
               CALL 'ZBI01SHM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01SHM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
