      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00XIZ'.
      ...
      * Called module names
       01  MOD-ZBI01TNX              PIC X(8) VALUE 'ZBI01TNX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01TNX-001.
               CALL 'ZBI01TNX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01TNX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
