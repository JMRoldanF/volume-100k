      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00XQW'.
      ...
      * Called module names
       01  MOD-ZBI01DSY              PIC X(8) VALUE 'ZBI01DSY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01DSY-001.
               CALL 'ZBI01DSY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01DSY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
