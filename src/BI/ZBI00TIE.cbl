      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00TIE'.
      ...
      * Called module names
       01  MOD-ZBI01PBY              PIC X(8) VALUE 'ZBI01PBY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01PBY-001.
               CALL 'ZBI01PBY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01PBY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
