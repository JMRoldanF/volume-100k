      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00X62'.
      ...
      * Called module names
       01  MOD-ZBI01KM8              PIC X(8) VALUE 'ZBI01KM8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01KM8-001.
               CALL 'ZBI01KM8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01KM8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
