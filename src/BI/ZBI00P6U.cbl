      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00P6U'.
      ...
      * Called module names
       01  MOD-ZBI01O56              PIC X(8) VALUE 'ZBI01O56'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01O56-001.
               CALL 'ZBI01O56' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01O56 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
