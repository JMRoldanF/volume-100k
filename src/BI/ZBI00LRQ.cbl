      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00LRQ'.
      ...
      * Called module names
       01  MOD-ZBI01FGL              PIC X(8) VALUE 'ZBI01FGL'.
       01  MOD-ZBI01LJJ              PIC X(8) VALUE 'ZBI01LJJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01FGL-001.
               PERFORM CALL-ZBI01LJJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01FGL-001.
               CALL 'ZBI01FGL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01FGL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01LJJ-002.
               CALL 'ZBI01LJJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01LJJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
