      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00PCE'.
      ...
      * Called module names
       01  MOD-ZAG01EPS              PIC X(8) VALUE 'ZAG01EPS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01EPS-001.
               PERFORM CALL-ZBI01NAM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01EPS-001.
               CALL 'ZAG01EPS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01EPS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01NAM-002.
               MOVE 'ZBI01NAM' TO WS-SUBNAME-8
