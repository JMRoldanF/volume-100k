      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI0135M'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01I5M              PIC X(8) VALUE 'ZBI01I5M'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01L86-001.
               PERFORM CALL-ZBI01I5M-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01I5M-002.
               CALL 'ZBI01I5M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01I5M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
