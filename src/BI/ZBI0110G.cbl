      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI0110G'.
      ...
      * Called module names
       01  MOD-ZQU01TPC              PIC X(8) VALUE 'ZQU01TPC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZQU01TPC-001.
               CALL 'ZQU01TPC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU01TPC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
