      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00S94'.
      ...
      * Called module names
       01  MOD-ZBI01LF4              PIC X(8) VALUE 'ZBI01LF4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01LF4-001.
               CALL 'ZBI01LF4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01LF4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
