      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00V5A'.
      ...
      * Called module names
       01  MOD-ZBI01PQE              PIC X(8) VALUE 'ZBI01PQE'.
       01  MOD-ZBI01Q6I              PIC X(8) VALUE 'ZBI01Q6I'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01PQE-001.
               PERFORM CALL-ZBI01Q6I-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01PQE-001.
               CALL 'ZBI01PQE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01PQE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01Q6I-002.
               CALL 'ZBI01Q6I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01Q6I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
