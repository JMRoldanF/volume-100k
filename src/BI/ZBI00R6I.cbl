      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00R6I'.
      ...
      * Called module names
       01  MOD-ZEN01MOB              PIC X(8) VALUE 'ZEN01MOB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01MOB-001.
               CALL 'ZEN01MOB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01MOB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
