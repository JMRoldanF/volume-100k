      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00WM2'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01P1Y              PIC X(8) VALUE 'ZBI01P1Y'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01ML5-001.
               PERFORM CALL-ZBI01P1Y-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01P1Y-002.
               CALL 'ZBI01P1Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01P1Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
