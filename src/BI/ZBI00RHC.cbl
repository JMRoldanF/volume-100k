      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00RHC'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01NZM              PIC X(8) VALUE 'ZBI01NZM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01HVM-001.
               PERFORM CALL-ZBI01NZM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01NZM-002.
               CALL 'ZBI01NZM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01NZM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
