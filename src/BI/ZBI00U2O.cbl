      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00U2O'.
      ...
      * Called module names
       01  MOD-ZBI01V18              PIC X(8) VALUE 'ZBI01V18'.
       01  MOD-ZBI01KJQ              PIC X(8) VALUE 'ZBI01KJQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01V18-001.
               PERFORM CALL-ZBI01KJQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01V18-001.
               CALL 'ZBI01V18' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01V18 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01KJQ-002.
               CALL 'ZBI01KJQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01KJQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-MODEL-0001.
