      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI001M8'.
      ...
      * Called module names
       ...
       01  MOD-ZBI00BMS              PIC X(8) VALUE 'ZBI00BMS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI00BMS-002.
               EXEC CICS LINK PROGRAM('ZBI00BMS')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI00BMS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
