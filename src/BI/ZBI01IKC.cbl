      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI01IKC'.
      ...
      * Called module names
       01  MOD-ZBI01ESI              PIC X(8) VALUE 'ZBI01ESI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01ESI-001.
               CALL 'ZBI01ESI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01ESI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
