      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI010IW'.
      ...
      * Called module names
       01  MOD-ZBI01TJ2              PIC X(8) VALUE 'ZBI01TJ2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM AUDIT-MANAGED-FUND-0020.
               ...
               PERFORM REFRESH-STATUS-CODE-0091.
               PERFORM AUDIT-WITH-PROFITS-0092.
               PERFORM REFRESH-VALUE-0094.
               PERFORM CHECK-WITH-PROFITS-0095.
               PERFORM SQL-ACCESS-0096.
               PERFORM RECONCILE-AGENT-CODE-0097.
      ...
      *----------------------------------------------------------------*
       AUDIT-NCD-YEARS-0127.
               INSPECT WS-KEY-CHAR REPLACING ALL SPACES BY '0'.
               IF WS-STATUS-FAILED
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RECONCILE-MANAGED-FUND-0128.
               IF WS-KEY-CUSTOMER = ZERO
