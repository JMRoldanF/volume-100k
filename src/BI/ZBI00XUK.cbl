      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00XUK'.
      ...
      * Called module names
       01  MOD-ZRN01GXZ              PIC X(8) VALUE 'ZRN01GXZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRN01GXZ-001.
               CALL 'ZRN01GXZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01GXZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
