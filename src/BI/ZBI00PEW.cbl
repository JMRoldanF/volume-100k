      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00PEW'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01LWH              PIC X(8) VALUE 'ZMT01LWH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01LWH-002.
               CALL 'ZMT01LWH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01LWH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
