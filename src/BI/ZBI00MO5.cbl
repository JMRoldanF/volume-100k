      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00MO5'.
      ...
      * Called module names
       ...
       01  MOD-ZRN01M0X              PIC X(8) VALUE 'ZRN01M0X'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01D76-001.
               PERFORM CALL-ZRN01M0X-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRN01M0X-002.
               CALL 'ZRN01M0X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01M0X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
