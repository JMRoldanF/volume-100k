      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00W0E'.
      ...
      * Called module names
       01  MOD-ZBI01GSQ              PIC X(8) VALUE 'ZBI01GSQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01GSQ-001.
               CALL 'ZBI01GSQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01GSQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
