      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00RT0'.
      ...
      * Called module names
       01  MOD-ZBI01IK2              PIC X(8) VALUE 'ZBI01IK2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01IK2-001.
               CALL 'ZBI01IK2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01IK2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
