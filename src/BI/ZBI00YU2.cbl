      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00YU2'.
      ...
      * Called module names
       01  MOD-ZBI01TII              PIC X(8) VALUE 'ZBI01TII'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01TII-001.
               CALL 'ZBI01TII' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01TII FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
