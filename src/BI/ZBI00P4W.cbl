      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00P4W'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01NJS              PIC X(8) VALUE 'ZBI01NJS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01NJS-002.
               CALL 'ZBI01NJS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
