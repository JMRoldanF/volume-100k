      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00LWS'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01RI0              PIC X(8) VALUE 'ZBI01RI0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01REY-001.
               PERFORM CALL-ZBI01RI0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01RI0-002.
               CALL 'ZBI01RI0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01RI0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
