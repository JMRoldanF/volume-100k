      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00WAE'.
      ...
      * Called module names
       01  MOD-ZMT01JO7              PIC X(8) VALUE 'ZMT01JO7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01JO7-001.
               CALL 'ZMT01JO7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
