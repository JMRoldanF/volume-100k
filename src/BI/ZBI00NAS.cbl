      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00NAS'.
      ...
      * Called module names
       01  MOD-ZBI01J10              PIC X(8) VALUE 'ZBI01J10'.
       01  MOD-ZBI01L7M              PIC X(8) VALUE 'ZBI01L7M'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01J10-001.
               PERFORM CALL-ZBI01L7M-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01J10-001.
               CALL 'ZBI01J10' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01L7M-002.
               CALL 'ZBI01L7M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01L7M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
