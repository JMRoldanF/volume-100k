      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00YUM'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01FVO              PIC X(8) VALUE 'ZBI01FVO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01FVO-002.
               CALL 'ZBI01FVO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01FVO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
