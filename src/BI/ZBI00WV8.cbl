      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00WV8'.
      ...
      * Called module names
       01  MOD-ZBI01T4M              PIC X(8) VALUE 'ZBI01T4M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01T4M-001.
               CALL 'ZBI01T4M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01T4M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
