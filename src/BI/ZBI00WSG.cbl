      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00WSG'.
      ...
      * Called module names
       01  MOD-ZBI01FZ0              PIC X(8) VALUE 'ZBI01FZ0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01FZ0-001.
               CALL 'ZBI01FZ0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01FZ0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-VALUE-0001.
