      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00UHE'.
      ...
      * Called module names
       01  MOD-ZBI01P1E              PIC X(8) VALUE 'ZBI01P1E'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01P1E-001.
               CALL 'ZBI01P1E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01P1E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
