      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI012JE'.
      ...
      * Called module names
       01  MOD-ZCU01PP8              PIC X(8) VALUE 'ZCU01PP8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01PP8-001.
               PERFORM CALL-ZBI01D02-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01PP8-001.
               CALL 'ZCU01PP8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01PP8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01D02-002.
