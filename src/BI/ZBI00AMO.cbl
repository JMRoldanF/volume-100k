      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00AMO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI00MAY-001.
               PERFORM CALL-ZBI01C2G-002.
               PERFORM CALL-ZBI01PUU-003.
               PERFORM CALL-ZBI01IZC-004.
               PERFORM CALL-ZMT0255L-005.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZBI00MAY-001.
               EXEC CICS LINK PROGRAM('ZBI00MAY')
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01C2G-002.
               MOVE 'ZBI01C2G' TO WS-PROGNAME-4
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01C2G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01PUU-003.
