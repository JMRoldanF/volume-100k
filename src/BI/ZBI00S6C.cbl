      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00S6C'.
      ...
      * Called module names
       01  MOD-ZBI01ELK              PIC X(8) VALUE 'ZBI01ELK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01ELK-001.
               CALL 'ZBI01ELK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01ELK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
