      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00JA9'.
      ...
      * Called module names
       01  MOD-ZBI00VEP              PIC X(8) VALUE 'ZBI00VEP'.
       01  MOD-ZLB00MP1              PIC X(8) VALUE 'ZLB00MP1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI00VEP-001.
               PERFORM CALL-ZLB00MP1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI00VEP-001.
               EXEC CICS LINK PROGRAM('ZBI00VEP')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI00VEP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLB00MP1-002.
               EXEC CICS LINK PROGRAM('ZLB00MP1')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB00MP1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
