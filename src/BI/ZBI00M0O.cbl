      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00M0O'.
      ...
      * Called module names
       01  MOD-ZBI01O74              PIC X(8) VALUE 'ZBI01O74'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01O74-001.
               PERFORM CALL-ZBI01T92-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01O74-001.
               CALL 'ZBI01O74' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01O74 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01T92-002.
