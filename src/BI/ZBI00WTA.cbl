      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00WTA'.
      ...
      * Called module names
       01  MOD-ZBI01N3E              PIC X(8) VALUE 'ZBI01N3E'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01N3E-001.
               PERFORM CALL-ZMT0255L-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZBI01N3E-001.
               CALL 'ZBI01N3E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
