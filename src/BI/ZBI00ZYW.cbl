      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00ZYW'.
      ...
      * Called module names
       01  MOD-ZBI01MZ8              PIC X(8) VALUE 'ZBI01MZ8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01MZ8-001.
               CALL 'ZBI01MZ8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01MZ8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
