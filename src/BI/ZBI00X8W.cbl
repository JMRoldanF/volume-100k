      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00X8W'.
      ...
      * Called module names
       01  MOD-ZBI01FU7              PIC X(8) VALUE 'ZBI01FU7'.
       01  MOD-ZBI01JT6              PIC X(8) VALUE 'ZBI01JT6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01FU7-001.
               PERFORM CALL-ZBI01JT6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01FU7-001.
               CALL 'ZBI01FU7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01FU7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01JT6-002.
               CALL 'ZBI01JT6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01JT6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
