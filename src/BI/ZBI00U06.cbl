      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00U06'.
      ...
      * Called module names
       01  MOD-ZBI01CVM              PIC X(8) VALUE 'ZBI01CVM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01CVM-001.
               CALL 'ZBI01CVM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01CVM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-TERM-0001.
