      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00MCW'.
      ...
      * Called module names
       01  MOD-ZBI01NFM              PIC X(8) VALUE 'ZBI01NFM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01NFM-001.
               CALL 'ZBI01NFM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01NFM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
