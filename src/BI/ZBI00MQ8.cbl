      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00MQ8'.
      ...
      * Called module names
       01  MOD-ZBI01S4S              PIC X(8) VALUE 'ZBI01S4S'.
       01  MOD-ZBI01TFG              PIC X(8) VALUE 'ZBI01TFG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01S4S-001.
               PERFORM CALL-ZBI01TFG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01S4S-001.
               CALL 'ZBI01S4S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01S4S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01TFG-002.
               CALL 'ZBI01TFG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01TFG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
