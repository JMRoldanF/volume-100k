      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI010A0'.
      ...
      * Called module names
       01  MOD-ZBI01RNA              PIC X(8) VALUE 'ZBI01RNA'.
       01  MOD-ZBI01TVA              PIC X(8) VALUE 'ZBI01TVA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01RNA-001.
               CALL 'ZBI01RNA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01RNA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01TVA-002.
               CALL 'ZBI01TVA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
