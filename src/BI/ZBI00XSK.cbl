      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00XSK'.
      ...
      * Called module names
       01  MOD-ZRE01KJR              PIC X(8) VALUE 'ZRE01KJR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01KJR-001.
               PERFORM CALL-ZBI01J8I-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01KJR-001.
               CALL 'ZRE01KJR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01KJR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01J8I-002.
