      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00RLS'.
      ...
      * Called module names
       01  MOD-ZBI01QB8              PIC X(8) VALUE 'ZBI01QB8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01QB8-001.
               CALL 'ZBI01QB8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01QB8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
