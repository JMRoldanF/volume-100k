      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00YOG'.
      ...
      * Called module names
       01  MOD-ZBI01KIC              PIC X(8) VALUE 'ZBI01KIC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01KIC-001.
               PERFORM CALL-ZBI01F3Z-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01KIC-001.
               CALL 'ZBI01KIC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01KIC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01F3Z-002.
