      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00XYE'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01RDK              PIC X(8) VALUE 'ZBI01RDK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01RDK-002.
               CALL 'ZBI01RDK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01RDK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
