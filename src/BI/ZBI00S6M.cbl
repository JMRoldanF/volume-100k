      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00S6M'.
      ...
      * Called module names
       01  MOD-ZBI01H58              PIC X(8) VALUE 'ZBI01H58'.
       01  MOD-ZBI01RY4              PIC X(8) VALUE 'ZBI01RY4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01H58-001.
               CALL 'ZBI01H58' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01RY4-002.
               CALL 'ZBI01RY4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01RY4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
