      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00VVY'.
      ...
      * Called module names
       01  MOD-ZBI01FGY              PIC X(8) VALUE 'ZBI01FGY'.
       01  MOD-ZBI01TM4              PIC X(8) VALUE 'ZBI01TM4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01FGY-001.
               PERFORM CALL-ZBI01TM4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01FGY-001.
               CALL 'ZBI01FGY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01FGY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01TM4-002.
               CALL 'ZBI01TM4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01TM4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
