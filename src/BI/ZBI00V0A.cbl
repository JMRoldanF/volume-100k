      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00V0A'.
      ...
      * Called module names
       01  MOD-ZBI01DIE              PIC X(8) VALUE 'ZBI01DIE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01DIE-001.
               CALL 'ZBI01DIE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01DIE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
