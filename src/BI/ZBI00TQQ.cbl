      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBI00TQQ'.
      ...
      * Called module names
       01  MOD-ZEN01LH9              PIC X(8) VALUE 'ZEN01LH9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01I2U-001.
               PERFORM CALL-ZEN01LH9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01LH9-002.
               CALL 'ZEN01LH9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01LH9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
