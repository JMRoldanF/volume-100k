      ******************************************************************
      * ZEX00M22 - EXCESS AND DEDUCTIBLE                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEX00M22'.
      ...
      * Called module names
       01  MOD-ZCU01R94              PIC X(8) VALUE 'ZCU01R94'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01R94-001.
               CALL 'ZCU01R94' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01R94 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEX01DM1-002.
