      ******************************************************************
      * ZEX00NNG - EXCESS AND DEDUCTIBLE                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEX00NNG'.
      ...
      * Called module names
       01  MOD-ZST01NAU              PIC X(8) VALUE 'ZST01NAU'.
       01  MOD-ZEX01HXY              PIC X(8) VALUE 'ZEX01HXY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZST01NAU-001.
               PERFORM CALL-ZEX01HXY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZST01NAU-001.
               CALL 'ZST01NAU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01NAU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEX01HXY-002.
               CALL 'ZEX01HXY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEX01HXY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
