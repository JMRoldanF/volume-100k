      ******************************************************************
      * ZEX00R3T - EXCESS AND DEDUCTIBLE                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEX00R3T'.
      ...
      * Called module names
       01  MOD-ZEX01QWD              PIC X(8) VALUE 'ZEX01QWD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEX01QWD-001.
               CALL 'ZEX01QWD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEX01QWD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-POSTCODE-0001.
