      ******************************************************************
      * ZEX00P94 - EXCESS AND DEDUCTIBLE                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEX00P94'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01SL3              PIC X(8) VALUE 'ZMT01SL3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01SL3-002.
               CALL 'ZMT01SL3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01SL3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
