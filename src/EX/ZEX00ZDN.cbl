      ******************************************************************
      * ZEX00ZDN - EXCESS AND DEDUCTIBLE                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEX00ZDN'.
      ...
      * Called module names
       01  MOD-ZEX01MFG              PIC X(8) VALUE 'ZEX01MFG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEX01MFG-001.
               PERFORM CALL-ZEX01F2F-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEX01MFG-001.
               CALL 'ZEX01MFG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEX01MFG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEX01F2F-002.
