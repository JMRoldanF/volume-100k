      ******************************************************************
      * ZEX00VJR - EXCESS AND DEDUCTIBLE                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEX00VJR'.
      ...
      * Called module names
       01  MOD-ZEX01TLP              PIC X(8) VALUE 'ZEX01TLP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEX01TLP-001.
               PERFORM CALL-ZCU01STI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEX01TLP-001.
               CALL 'ZEX01TLP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEX01TLP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01STI-002.
               MOVE 'ZCU01STI' TO WS-SUBNAME-7
