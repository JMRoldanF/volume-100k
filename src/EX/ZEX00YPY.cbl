      ******************************************************************
      * ZEX00YPY - EXCESS AND DEDUCTIBLE                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEX00YPY'.
      ...
      * Called module names
       01  MOD-ZEX01N7S              PIC X(8) VALUE 'ZEX01N7S'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEX01N7S-001.
               CALL 'ZEX01N7S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEX01N7S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
