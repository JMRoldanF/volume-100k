      ******************************************************************
      * ZEX00TT8 - EXCESS AND DEDUCTIBLE                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEX00TT8'.
      ...
      * Called module names
       01  MOD-ZCU01D1Z              PIC X(8) VALUE 'ZCU01D1Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01D1Z-001.
               CALL 'ZCU01D1Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01D1Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
