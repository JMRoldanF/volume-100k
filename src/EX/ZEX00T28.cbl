      ******************************************************************
      * ZEX00T28 - EXCESS AND DEDUCTIBLE                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEX00T28'.
      ...
      * Called module names
       ...
       01  MOD-ZEX01S8L              PIC X(8) VALUE 'ZEX01S8L'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEX01S8L-002.
               CALL 'ZEX01S8L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEX01S8L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
