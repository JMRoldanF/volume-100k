      ******************************************************************
      * ZEX01181 - EXCESS AND DEDUCTIBLE                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEX01181'.
      ...
      * Called module names
       01  MOD-ZEX01EGA              PIC X(8) VALUE 'ZEX01EGA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEX01EGA-001.
               CALL 'ZEX01EGA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEX01EGA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
