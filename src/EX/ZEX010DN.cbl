      ******************************************************************
      * ZEX010DN - EXCESS AND DEDUCTIBLE                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEX010DN'.
      ...
      * Called module names
       01  MOD-ZEX01NY5              PIC X(8) VALUE 'ZEX01NY5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEX01NFI-001.
               PERFORM CALL-ZEX01NY5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEX01NY5-002.
               CALL 'ZEX01NY5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEX01NY5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-MAKE-0001.
