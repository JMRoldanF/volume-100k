      ******************************************************************
      * ZEX00U7X - EXCESS AND DEDUCTIBLE                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEX00U7X'.
      ...
      * Called module names
       01  MOD-ZWF01S7E              PIC X(8) VALUE 'ZWF01S7E'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZWF01S7E-001.
               PERFORM CALL-ZWF01SUF-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZWF01S7E-001.
               CALL 'ZWF01S7E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZWF01S7E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZWF01SUF-002.
               MOVE 'ZWF01SUF' TO WS-SUBNAME-1
