      ******************************************************************
      * ZEX00SFH - EXCESS AND DEDUCTIBLE                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEX00SFH'.
      ...
      * Called module names
       01  MOD-ZST01HIY              PIC X(8) VALUE 'ZST01HIY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZST01HIY-001.
               CALL 'ZST01HIY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01HIY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
