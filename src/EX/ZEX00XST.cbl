      ******************************************************************
      * ZEX00XST - EXCESS AND DEDUCTIBLE                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEX00XST'.
      ...
      * Called module names
       01  MOD-ZMT01NJF              PIC X(8) VALUE 'ZMT01NJF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01NJF-001.
               CALL 'ZMT01NJF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01NJF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
