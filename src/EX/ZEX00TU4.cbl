      ******************************************************************
      * ZEX00TU4 - EXCESS AND DEDUCTIBLE                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEX00TU4'.
      ...
      * Called module names
       01  MOD-ZEX01QZE              PIC X(8) VALUE 'ZEX01QZE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEX01QZE-001.
               CALL 'ZEX01QZE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEX01QZE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
