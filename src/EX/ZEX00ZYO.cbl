      ******************************************************************
      * ZEX00ZYO - EXCESS AND DEDUCTIBLE                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEX00ZYO'.
      ...
      * Called module names
       01  MOD-ZEX01DS1              PIC X(8) VALUE 'ZEX01DS1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEX01DS1-001.
               CALL 'ZEX01DS1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEX01DS1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-EXCESS-0001.
