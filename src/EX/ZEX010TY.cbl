      ******************************************************************
      * ZEX010TY - EXCESS AND DEDUCTIBLE                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEX010TY'.
      ...
      * Called module names
       ...
       01  MOD-ZEX01I9E              PIC X(8) VALUE 'ZEX01I9E'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEX01UNB-001.
               PERFORM CALL-ZEX01I9E-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEX01I9E-002.
               CALL 'ZEX01I9E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEX01I9E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
