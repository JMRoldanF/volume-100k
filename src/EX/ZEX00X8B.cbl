      ******************************************************************
      * ZEX00X8B - EXCESS AND DEDUCTIBLE                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEX00X8B'.
      ...
      * Called module names
       ...
       01  MOD-ZPT01OW1              PIC X(8) VALUE 'ZPT01OW1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEX01FOR-001.
               PERFORM CALL-ZPT01OW1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPT01OW1-002.
               CALL 'ZPT01OW1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
