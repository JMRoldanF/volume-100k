      ******************************************************************
      * ZEX00Q6E - EXCESS AND DEDUCTIBLE                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZEX00Q6E'.
      ...
      * Called module names
       01  MOD-ZEX01Q64              PIC X(8) VALUE 'ZEX01Q64'.
       01  MOD-ZCU01PFN              PIC X(8) VALUE 'ZCU01PFN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEX01Q64-001.
               CALL 'ZEX01Q64' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEX01Q64 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01PFN-002.
               CALL 'ZCU01PFN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01PFN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
