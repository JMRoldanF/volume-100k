      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00MGI'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01JXN              PIC X(8) VALUE 'ZHO01JXN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01JXN-002.
               CALL 'ZHO01JXN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01JXN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-MODEL-0001.
