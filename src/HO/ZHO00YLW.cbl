      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00YLW'.
      ...
      * Called module names
       01  MOD-ZHO01FAG              PIC X(8) VALUE 'ZHO01FAG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01FAG-001.
               CALL 'ZHO01FAG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01FAG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
