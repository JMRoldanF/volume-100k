      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00WL4'.
      ...
      * Called module names
       01  MOD-ZHO01QJQ              PIC X(8) VALUE 'ZHO01QJQ'.
       01  MOD-ZHO01M7M              PIC X(8) VALUE 'ZHO01M7M'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01QJQ-001.
               PERFORM CALL-ZHO01M7M-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01QJQ-001.
               CALL 'ZHO01QJQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01QJQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01M7M-002.
               CALL 'ZHO01M7M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01M7M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
