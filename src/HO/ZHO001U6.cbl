      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO001U6'.
      ...
      * Called module names
       ...
       01  MOD-ZHO0098A              PIC X(8) VALUE 'ZHO0098A'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO009HQ-001.
               PERFORM CALL-ZHO00DD6-002.
               PERFORM CALL-ZHO0098A-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO0098A-003.
               EXEC CICS LINK PROGRAM('ZHO0098A')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO0098A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-004.
