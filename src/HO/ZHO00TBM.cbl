      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00TBM'.
      ...
      * Called module names
       01  MOD-ZHO01LWS              PIC X(8) VALUE 'ZHO01LWS'.
       01  MOD-ZHO01OBQ              PIC X(8) VALUE 'ZHO01OBQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01LWS-001.
               CALL 'ZHO01LWS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01LWS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01OBQ-002.
               CALL 'ZHO01OBQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01OBQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
