      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00IXJ'.
      ...
      * Called module names
       01  MOD-ZHO00TFG              PIC X(8) VALUE 'ZHO00TFG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO00TFG-001.
               PERFORM CALL-ZSL01MQT-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00TFG-001.
               EXEC CICS LINK PROGRAM('ZHO00TFG')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO00TFG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSL01MQT-002.
