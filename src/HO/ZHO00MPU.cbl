      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00MPU'.
      ...
      * Called module names
       01  MOD-ZAG01JTO              PIC X(8) VALUE 'ZAG01JTO'.
       01  MOD-ZHO01GLO              PIC X(8) VALUE 'ZHO01GLO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01JTO-001.
               PERFORM CALL-ZHO01GLO-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01JTO-001.
               CALL 'ZAG01JTO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01JTO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01GLO-002.
               CALL 'ZHO01GLO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01GLO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
