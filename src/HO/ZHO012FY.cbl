      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO012FY'.
      ...
      * Called module names
       01  MOD-ZPA01L25              PIC X(8) VALUE 'ZPA01L25'.
       01  MOD-ZCU01RKG              PIC X(8) VALUE 'ZCU01RKG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01L25-001.
               PERFORM CALL-ZCU01RKG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01L25-001.
               CALL 'ZPA01L25' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01L25 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01RKG-002.
               CALL 'ZCU01RKG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01RKG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
