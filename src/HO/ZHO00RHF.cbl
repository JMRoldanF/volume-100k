      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00RHF'.
      ...
      * Called module names
       01  MOD-ZHO01OYP              PIC X(8) VALUE 'ZHO01OYP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01OYP-001.
               CALL 'ZHO01OYP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01OYP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01HA7-002.
