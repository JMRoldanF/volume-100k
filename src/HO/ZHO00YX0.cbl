      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00YX0'.
      ...
      * Called module names
       01  MOD-ZBI01NGG              PIC X(8) VALUE 'ZBI01NGG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01NGG-002.
               CALL 'ZBI01NGG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01NGG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
