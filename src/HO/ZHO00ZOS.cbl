      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00ZOS'.
      ...
      * Called module names
       01  MOD-ZHO01MMC              PIC X(8) VALUE 'ZHO01MMC'.
       01  MOD-ZHO01GBE              PIC X(8) VALUE 'ZHO01GBE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01MMC-001.
               PERFORM CALL-ZHO01GBE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01MMC-001.
               CALL 'ZHO01MMC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01MMC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01GBE-002.
               CALL 'ZHO01GBE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01GBE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
