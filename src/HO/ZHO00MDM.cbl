      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00MDM'.
      ...
      * Called module names
       01  MOD-ZHO01N94              PIC X(8) VALUE 'ZHO01N94'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01N94-001.
               CALL 'ZHO01N94' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01N94 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
