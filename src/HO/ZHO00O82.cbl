      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00O82'.
      ...
      * Called module names
       01  MOD-ZHO01TTD              PIC X(8) VALUE 'ZHO01TTD'.
       01  MOD-ZHO01JYM              PIC X(8) VALUE 'ZHO01JYM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01TTD-001.
               PERFORM CALL-ZHO01JYM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01TTD-001.
               CALL 'ZHO01TTD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01TTD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01JYM-002.
               CALL 'ZHO01JYM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01JYM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
