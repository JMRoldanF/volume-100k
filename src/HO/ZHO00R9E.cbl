      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00R9E'.
      ...
      * Called module names
       01  MOD-ZHO01QIL              PIC X(8) VALUE 'ZHO01QIL'.
       01  MOD-ZPR01LVI              PIC X(8) VALUE 'ZPR01LVI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01QIL-001.
               CALL 'ZHO01QIL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01QIL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPR01LVI-002.
               CALL 'ZPR01LVI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01LVI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
