      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00T6W'.
      ...
      * Called module names
       01  MOD-ZHO01G32              PIC X(8) VALUE 'ZHO01G32'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01G32-001.
               CALL 'ZHO01G32' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01G32 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
