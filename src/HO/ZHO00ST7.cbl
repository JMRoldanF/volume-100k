      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00ST7'.
      ...
      * Called module names
       01  MOD-ZSL01L8C              PIC X(8) VALUE 'ZSL01L8C'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSL01L8C-001.
               CALL 'ZSL01L8C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSL01L8C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
