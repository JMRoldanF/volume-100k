      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01EMK'.
      ...
      * Called module names
       01  MOD-ZHO01O2A              PIC X(8) VALUE 'ZHO01O2A'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01O2A-001.
               CALL 'ZHO01O2A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
