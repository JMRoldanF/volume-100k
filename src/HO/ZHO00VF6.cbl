      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00VF6'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01LZD              PIC X(8) VALUE 'ZCL01LZD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01N1M-001.
               PERFORM CALL-ZCL01LZD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01LZD-002.
               CALL 'ZCL01LZD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01LZD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
