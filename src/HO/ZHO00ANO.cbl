      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00ANO'.
      ...
      * Called module names
       01  MOD-ZHO00N7M              PIC X(8) VALUE 'ZHO00N7M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00N7M-001.
               EXEC CICS LINK PROGRAM('ZHO00N7M')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO00N7M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU00O3C-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01A4M-003.
               MOVE 'ZHO01A4M' TO WS-PROGNAME-8
