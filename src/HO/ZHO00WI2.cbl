      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00WI2'.
      ...
      * Called module names
       01  MOD-ZHO01UWY              PIC X(8) VALUE 'ZHO01UWY'.
       01  MOD-ZHO01QKK              PIC X(8) VALUE 'ZHO01QKK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01UWY-001.
               PERFORM CALL-ZHO01QKK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01UWY-001.
               CALL 'ZHO01UWY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01UWY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01QKK-002.
               CALL 'ZHO01QKK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01QKK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
