      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO011YP'.
      ...
      * Called module names
       01  MOD-ZHO01KOC              PIC X(8) VALUE 'ZHO01KOC'.
       01  MOD-ZHO01IXR              PIC X(8) VALUE 'ZHO01IXR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01KOC-001.
               PERFORM CALL-ZHO01IXR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01KOC-001.
               CALL 'ZHO01KOC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01KOC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01IXR-002.
               CALL 'ZHO01IXR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01IXR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
