      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO011W1'.
      ...
      * Called module names
       01  MOD-ZHO01SLY              PIC X(8) VALUE 'ZHO01SLY'.
       01  MOD-ZFL01FBB              PIC X(8) VALUE 'ZFL01FBB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01SLY-001.
               PERFORM CALL-ZFL01FBB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01SLY-001.
               CALL 'ZHO01SLY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01SLY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFL01FBB-002.
               CALL 'ZFL01FBB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01FBB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
