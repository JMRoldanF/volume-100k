      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00RQY'.
      ...
      * Called module names
       01  MOD-ZHO01FBU              PIC X(8) VALUE 'ZHO01FBU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01FBU-001.
               CALL 'ZHO01FBU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01FBU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01NMQ-002.
