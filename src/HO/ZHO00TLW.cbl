      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00TLW'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01FCE              PIC X(8) VALUE 'ZHO01FCE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01FCE-002.
               CALL 'ZHO01FCE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01FCE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
