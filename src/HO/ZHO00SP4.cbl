      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00SP4'.
      ...
      * Called module names
       01  MOD-ZBI01LEU              PIC X(8) VALUE 'ZBI01LEU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01LEU-001.
               CALL 'ZBI01LEU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01LEU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-VALUE-0001.
