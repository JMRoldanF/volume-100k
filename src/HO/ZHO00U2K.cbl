      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00U2K'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01R04              PIC X(8) VALUE 'ZHO01R04'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01IE4-001.
               PERFORM CALL-ZHO01R04-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01R04-002.
               CALL 'ZHO01R04' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01R04 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
