      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00PUC'.
      ...
      * Called module names
       01  MOD-ZHO01KRE              PIC X(8) VALUE 'ZHO01KRE'.
       01  MOD-ZHO01FYM              PIC X(8) VALUE 'ZHO01FYM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01KRE-001.
               PERFORM CALL-ZHO01FYM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01KRE-001.
               CALL 'ZHO01KRE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01KRE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01FYM-002.
               CALL 'ZHO01FYM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01FYM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
