      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01FZK'.
      ...
      * Called module names
       01  MOD-ZHO01JLC              PIC X(8) VALUE 'ZHO01JLC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01JLC-001.
               CALL 'ZHO01JLC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01JLC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
