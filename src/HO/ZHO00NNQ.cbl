      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00NNQ'.
      ...
      * Called module names
       01  MOD-ZHO01J3Y              PIC X(8) VALUE 'ZHO01J3Y'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01J3Y-001.
               CALL 'ZHO01J3Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01J3Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
