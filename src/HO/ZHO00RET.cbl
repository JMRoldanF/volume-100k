      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00RET'.
      ...
      * Called module names
       01  MOD-ZFL01K0G              PIC X(8) VALUE 'ZFL01K0G'.
       01  MOD-ZSL01UR3              PIC X(8) VALUE 'ZSL01UR3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFL01K0G-001.
               PERFORM CALL-ZSL01UR3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01K0G-001.
               CALL 'ZFL01K0G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01K0G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSL01UR3-002.
               CALL 'ZSL01UR3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSL01UR3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
