      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00SDG'.
      ...
      * Called module names
       01  MOD-ZHO01UBA              PIC X(8) VALUE 'ZHO01UBA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01UBA-001.
               CALL 'ZHO01UBA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01UBA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
