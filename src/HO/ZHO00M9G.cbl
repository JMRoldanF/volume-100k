      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00M9G'.
      ...
      * Called module names
       01  MOD-ZHO01IQM              PIC X(8) VALUE 'ZHO01IQM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01IQM-001.
               CALL 'ZHO01IQM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01IQM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
