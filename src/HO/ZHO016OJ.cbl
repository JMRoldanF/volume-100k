      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO016OJ'.
      ...
      * Called module names
       01  MOD-ZFL01GV2              PIC X(8) VALUE 'ZFL01GV2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01GV2-001.
               CALL 'ZFL01GV2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01GV2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
