      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO011OA'.
      ...
      * Called module names
       01  MOD-ZHO01UY3              PIC X(8) VALUE 'ZHO01UY3'.
       01  MOD-ZHO01RDG              PIC X(8) VALUE 'ZHO01RDG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01UY3-001.
               PERFORM CALL-ZHO01RDG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01UY3-001.
               CALL 'ZHO01UY3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01UY3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01RDG-002.
               CALL 'ZHO01RDG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01RDG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
