      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00VCY'.
      ...
      * Called module names
       01  MOD-ZRE01K2T              PIC X(8) VALUE 'ZRE01K2T'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01K2T-001.
               CALL 'ZRE01K2T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01K2T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
