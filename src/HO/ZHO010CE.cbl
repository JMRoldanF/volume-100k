      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO010CE'.
      ...
      * Called module names
       01  MOD-ZHO01EUM              PIC X(8) VALUE 'ZHO01EUM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01OH0-002.
               PERFORM CALL-ZBI0255Q-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZHO01EUM-001.
               CALL 'ZHO01EUM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
