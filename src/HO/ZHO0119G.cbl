      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO0119G'.
      ...
      * Called module names
       01  MOD-ZHO01J2A              PIC X(8) VALUE 'ZHO01J2A'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01J2A-001.
               CALL 'ZHO01J2A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01J2A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
