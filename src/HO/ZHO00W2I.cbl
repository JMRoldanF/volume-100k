      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00W2I'.
      ...
      * Called module names
       01  MOD-ZHO01FEC              PIC X(8) VALUE 'ZHO01FEC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01FEC-001.
               CALL 'ZHO01FEC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01FEC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
