      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00PGZ'.
      ...
      * Called module names
       01  MOD-ZPR01ICQ              PIC X(8) VALUE 'ZPR01ICQ'.
       01  MOD-ZHO01THW              PIC X(8) VALUE 'ZHO01THW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPR01ICQ-001.
               PERFORM CALL-ZHO01THW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR01ICQ-001.
               CALL 'ZPR01ICQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01ICQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01THW-002.
               CALL 'ZHO01THW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01THW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
