      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00Q7W'.
      ...
      * Called module names
       01  MOD-ZHO01K0V              PIC X(8) VALUE 'ZHO01K0V'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01K0V-001.
               PERFORM CALL-ZHO01G7M-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01K0V-001.
               CALL 'ZHO01K0V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01K0V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01G7M-002.
