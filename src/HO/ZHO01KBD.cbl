      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01KBD'.
      ...
      * Called module names
       01  MOD-ZHO01TE4              PIC X(8) VALUE 'ZHO01TE4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01TE4-001.
               CALL 'ZHO01TE4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01TE4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
