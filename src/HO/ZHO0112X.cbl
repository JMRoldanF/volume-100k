      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO0112X'.
      ...
      * Called module names
       01  MOD-ZHO01EQ1              PIC X(8) VALUE 'ZHO01EQ1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01EQ1-001.
               CALL 'ZHO01EQ1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01EQ1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
