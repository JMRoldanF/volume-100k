      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO019TP'.
      ...
      * Called module names
       01  MOD-ZHO01NGQ              PIC X(8) VALUE 'ZHO01NGQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01NGQ-002.
               CALL 'ZHO01NGQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01NGQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
