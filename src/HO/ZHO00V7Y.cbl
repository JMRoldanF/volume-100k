      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00V7Y'.
      ...
      * Called module names
       01  MOD-ZHO01GJG              PIC X(8) VALUE 'ZHO01GJG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01GJG-001.
               CALL 'ZHO01GJG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01GJG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01IDK-002.
