      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00OL8'.
      ...
      * Called module names
       01  MOD-ZHO01N8O              PIC X(8) VALUE 'ZHO01N8O'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01N8O-001.
               PERFORM CALL-ZHO01DN4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01N8O-001.
               CALL 'ZHO01N8O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01N8O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01DN4-002.
