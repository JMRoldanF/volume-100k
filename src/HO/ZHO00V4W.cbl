      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00V4W'.
      ...
      * Called module names
       01  MOD-ZHO01SF8              PIC X(8) VALUE 'ZHO01SF8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01SF8-001.
               CALL 'ZHO01SF8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01SF8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01QZ0-002.
