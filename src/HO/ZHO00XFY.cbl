      ...
      * Called module names
       01  MOD-ZHO01HG8              PIC X(8) VALUE 'ZHO01HG8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01HG8-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZHO01PF6-001.
               MOVE 'ZHO01PF6' TO WS-SUBNAME-5
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01HG8-002.
               CALL 'ZHO01HG8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01HG8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       WRITE-ERROR-MESSAGE.
