      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00XFY'.
      ...
      * Called module names
       01  MOD-ZHO01H3Q              PIC X(8) VALUE 'ZHO01H3Q'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01H3Q-001.
               PERFORM CALL-ZHO01SC9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01H3Q-001.
               CALL 'ZHO01H3Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01H3Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01SC9-002.
               MOVE 'ZHO01SC9' TO WS-SUBNAME-3
