      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00P02'.
      ...
      * Called module names
       01  MOD-ZHO01ODO              PIC X(8) VALUE 'ZHO01ODO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01ODO-001.
               PERFORM CALL-ZHO01J7A-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01ODO-001.
               CALL 'ZHO01ODO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01ODO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01J7A-002.
