      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00UKC'.
      ...
      * Called module names
       01  MOD-ZCU01U3K              PIC X(8) VALUE 'ZCU01U3K'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01U3K-001.
               CALL 'ZCU01U3K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01U3K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
