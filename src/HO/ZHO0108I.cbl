      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO0108I'.
      ...
      * Called module names
       01  MOD-ZHO01E70              PIC X(8) VALUE 'ZHO01E70'.
       01  MOD-ZHO01RGI              PIC X(8) VALUE 'ZHO01RGI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01E70-001.
               PERFORM CALL-ZHO01RGI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01E70-001.
               CALL 'ZHO01E70' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01E70 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01RGI-002.
               CALL 'ZHO01RGI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01RGI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
