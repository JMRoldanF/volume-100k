      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00Z6Q'.
      ...
      * Called module names
       01  MOD-ZHO01TU2              PIC X(8) VALUE 'ZHO01TU2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01TU2-001.
               CALL 'ZHO01TU2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01TU2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
