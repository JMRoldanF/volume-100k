      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00ZPH'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01H0Z              PIC X(8) VALUE 'ZHO01H0Z'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01NIE-001.
               PERFORM CALL-ZHO01H0Z-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01H0Z-002.
               CALL 'ZHO01H0Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
