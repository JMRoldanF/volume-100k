      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01NUM'.
      ...
      * Called module names
       01  MOD-ZHO01PIL              PIC X(8) VALUE 'ZHO01PIL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01PIL-001.
               CALL 'ZHO01PIL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01PIL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
