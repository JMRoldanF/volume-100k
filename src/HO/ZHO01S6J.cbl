      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01S6J'.
      ...
      * Called module names
       01  MOD-ZHO01URC              PIC X(8) VALUE 'ZHO01URC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01URC-001.
               CALL 'ZHO01URC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01URC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
