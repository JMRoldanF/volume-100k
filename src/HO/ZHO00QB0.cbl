      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00QB0'.
      ...
      * Called module names
       01  MOD-ZHO01OKM              PIC X(8) VALUE 'ZHO01OKM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01OKM-001.
               CALL 'ZHO01OKM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01OKM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
