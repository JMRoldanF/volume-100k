      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00VEC'.
      ...
      * Called module names
       01  MOD-ZHO01HS6              PIC X(8) VALUE 'ZHO01HS6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01HS6-001.
               CALL 'ZHO01HS6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01HS6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
