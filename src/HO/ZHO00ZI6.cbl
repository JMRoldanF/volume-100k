      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00ZI6'.
      ...
      * Called module names
       01  MOD-ZFL01JZ6              PIC X(8) VALUE 'ZFL01JZ6'.
       01  MOD-ZHO01MFW              PIC X(8) VALUE 'ZHO01MFW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFL01JZ6-001.
               PERFORM CALL-ZHO01MFW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01JZ6-001.
               CALL 'ZFL01JZ6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01JZ6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01MFW-002.
               CALL 'ZHO01MFW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01MFW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
