      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00R14'.
      ...
      * Called module names
       01  MOD-ZRE01QXR              PIC X(8) VALUE 'ZRE01QXR'.
       01  MOD-ZHO01GAA              PIC X(8) VALUE 'ZHO01GAA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01QXR-001.
               PERFORM CALL-ZHO01GAA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01QXR-001.
               CALL 'ZRE01QXR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01QXR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01GAA-002.
               CALL 'ZHO01GAA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01GAA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
