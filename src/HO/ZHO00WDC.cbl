      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00WDC'.
      ...
      * Called module names
       01  MOD-ZHO01RY0              PIC X(8) VALUE 'ZHO01RY0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01RY0-001.
               CALL 'ZHO01RY0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01RY0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
