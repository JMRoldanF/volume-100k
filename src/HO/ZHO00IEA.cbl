      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00IEA'.
      ...
      * Called module names
       01  MOD-ZUW00RXU              PIC X(8) VALUE 'ZUW00RXU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW00RXU-001.
               EXEC CICS LINK PROGRAM('ZUW00RXU')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW00RXU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
