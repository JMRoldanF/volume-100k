      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00O52'.
      ...
      * Called module names
       01  MOD-ZHO01IRB              PIC X(8) VALUE 'ZHO01IRB'.
       01  MOD-ZHO01FYH              PIC X(8) VALUE 'ZHO01FYH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01IRB-001.
               PERFORM CALL-ZHO01FYH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01IRB-001.
               CALL 'ZHO01IRB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01FYH-002.
               CALL 'ZHO01FYH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01FYH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
