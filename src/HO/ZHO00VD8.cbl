      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00VD8'.
      ...
      * Called module names
       01  MOD-ZHO01FVK              PIC X(8) VALUE 'ZHO01FVK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01FVK-001.
               PERFORM CALL-ZHO01QFU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01FVK-001.
               CALL 'ZHO01FVK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01FVK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01QFU-002.
