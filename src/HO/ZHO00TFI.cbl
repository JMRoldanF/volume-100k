      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00TFI'.
      ...
      * Called module names
       01  MOD-ZHO01GTQ              PIC X(8) VALUE 'ZHO01GTQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01GTQ-001.
               CALL 'ZHO01GTQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01GTQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-EXCESS-0001.
