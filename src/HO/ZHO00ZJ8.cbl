      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00ZJ8'.
      ...
      * Called module names
       01  MOD-ZHO01PL0              PIC X(8) VALUE 'ZHO01PL0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01PL0-001.
               CALL 'ZHO01PL0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01PL0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       VALIDATE-MODEL-0001.
