      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01IP8'.
      ...
      * Called module names
       01  MOD-ZPA01OO5              PIC X(8) VALUE 'ZPA01OO5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01OO5-001.
               CALL 'ZPA01OO5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01OO5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
