      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01AGF'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01RMP              PIC X(8) VALUE 'ZHO01RMP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01RMP-002.
               CALL 'ZHO01RMP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01RMP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
