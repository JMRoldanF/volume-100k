      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00ORQ'.
      ...
      * Called module names
       01  MOD-ZHO01FRV              PIC X(8) VALUE 'ZHO01FRV'.
       01  MOD-ZHO01L0Q              PIC X(8) VALUE 'ZHO01L0Q'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01FRV-001.
               PERFORM CALL-ZHO01L0Q-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01FRV-001.
               CALL 'ZHO01FRV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01FRV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01L0Q-002.
               CALL 'ZHO01L0Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01L0Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-VALUE-0001.
