      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01FUE'.
      ...
      * Called module names
       01  MOD-ZHO01JBZ              PIC X(8) VALUE 'ZHO01JBZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01JBZ-001.
               CALL 'ZHO01JBZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01JBZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       VALIDATE-MAKE-0001.
