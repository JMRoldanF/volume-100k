      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01IY1'.
      ...
      * Called module names
       01  MOD-ZHO01D8J              PIC X(8) VALUE 'ZHO01D8J'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01D8J-001.
               CALL 'ZHO01D8J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01D8J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
