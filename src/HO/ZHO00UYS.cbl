      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00UYS'.
      ...
      * Called module names
       01  MOD-ZMT01P1T              PIC X(8) VALUE 'ZMT01P1T'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01P1T-001.
               CALL 'ZMT01P1T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01P1T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
