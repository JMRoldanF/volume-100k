      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00S2W'.
      ...
      * Called module names
       01  MOD-ZUW01J14              PIC X(8) VALUE 'ZUW01J14'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01J14-001.
               PERFORM CALL-ZHO01RYA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01J14-001.
               CALL 'ZUW01J14' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01J14 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01RYA-002.
