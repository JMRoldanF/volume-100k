      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO011RI'.
      ...
      * Called module names
       01  MOD-ZHO01EHU              PIC X(8) VALUE 'ZHO01EHU'.
       01  MOD-ZHO01JDO              PIC X(8) VALUE 'ZHO01JDO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01EHU-001.
               CALL 'ZHO01EHU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01EHU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01JDO-002.
               CALL 'ZHO01JDO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01JDO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
