      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00N6S'.
      ...
      * Called module names
       01  MOD-ZHO01D9E              PIC X(8) VALUE 'ZHO01D9E'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01D9E-001.
               CALL 'ZHO01D9E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01D9E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
