      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO013FI'.
      ...
      * Called module names
       01  MOD-ZEN01QSD              PIC X(8) VALUE 'ZEN01QSD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01QSD-001.
               CALL 'ZEN01QSD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01QSD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
