      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01VKM'.
      ...
      * Called module names
       ...
       01  MOD-ZPA00TUF              PIC X(8) VALUE 'ZPA00TUF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01O86-001.
               PERFORM CALL-ZHO01ETS-002.
               PERFORM CALL-ZPA00TUF-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00TUF-003.
               CALL 'ZPA00TUF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA00TUF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
