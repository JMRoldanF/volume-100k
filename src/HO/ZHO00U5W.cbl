      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00U5W'.
      ...
      * Called module names
       01  MOD-ZBI01T6K              PIC X(8) VALUE 'ZBI01T6K'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01T6K-001.
               CALL 'ZBI01T6K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01T6K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
