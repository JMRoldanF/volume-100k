      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00PGH'.
      ...
      * Called module names
       01  MOD-ZHO01SYS              PIC X(8) VALUE 'ZHO01SYS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01SYS-001.
               CALL 'ZHO01SYS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01SYS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-MODEL-0001.
