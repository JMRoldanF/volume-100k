      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00VGA'.
      ...
      * Called module names
       01  MOD-ZEN01LGP              PIC X(8) VALUE 'ZEN01LGP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01LGP-001.
               CALL 'ZEN01LGP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01LGP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
