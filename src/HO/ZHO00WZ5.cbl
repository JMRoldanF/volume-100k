      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00WZ5'.
      ...
      * Called module names
       01  MOD-ZHO01F3J              PIC X(8) VALUE 'ZHO01F3J'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01F3J-001.
               CALL 'ZHO01F3J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01F3J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
