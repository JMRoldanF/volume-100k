      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO012JZ'.
      ...
      * Called module names
       01  MOD-ZHO01L6J              PIC X(8) VALUE 'ZHO01L6J'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01GEP-001.
               PERFORM CALL-ZHO01L6J-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01L6J-002.
               CALL 'ZHO01L6J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01L6J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-TAX-BAND-0001.
