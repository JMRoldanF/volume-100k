      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00SIQ'.
      ...
      * Called module names
       01  MOD-ZHO01FQK              PIC X(8) VALUE 'ZHO01FQK'.
       01  MOD-ZBI01D02              PIC X(8) VALUE 'ZBI01D02'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01FQK-001.
               CALL 'ZHO01FQK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01FQK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01D02-002.
               CALL 'ZBI01D02' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01D02 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
