      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00NI2'.
      ...
      * Called module names
       01  MOD-ZHO01M4O              PIC X(8) VALUE 'ZHO01M4O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01M4O-001.
               CALL 'ZHO01M4O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01M4O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSL01U6F-002.
