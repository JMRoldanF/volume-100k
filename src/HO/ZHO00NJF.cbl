      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00NJF'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01QS5              PIC X(8) VALUE 'ZHO01QS5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01IRV-001.
               PERFORM CALL-ZHO01QS5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01QS5-002.
               CALL 'ZHO01QS5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01QS5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-VALUE-0001.
