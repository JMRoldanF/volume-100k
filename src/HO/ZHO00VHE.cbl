      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00VHE'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01P60              PIC X(8) VALUE 'ZHO01P60'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01QET-001.
               PERFORM CALL-ZHO01P60-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01P60-002.
               CALL 'ZHO01P60' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01P60 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
