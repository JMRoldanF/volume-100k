      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO011MS'.
      ...
      * Called module names
       01  MOD-ZHO01JU2              PIC X(8) VALUE 'ZHO01JU2'.
       01  MOD-ZHO01D58              PIC X(8) VALUE 'ZHO01D58'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01JU2-001.
               PERFORM CALL-ZHO01D58-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01JU2-001.
               CALL 'ZHO01JU2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01JU2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01D58-002.
               CALL 'ZHO01D58' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01D58 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
