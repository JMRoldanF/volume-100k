      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO016OG'.
      ...
      * Called module names
       01  MOD-ZHO01NKI              PIC X(8) VALUE 'ZHO01NKI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01NKI-001.
               PERFORM CALL-ZHO01SVC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01NKI-001.
               CALL 'ZHO01NKI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01NKI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01SVC-002.
