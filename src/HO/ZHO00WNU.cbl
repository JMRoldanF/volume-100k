      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00WNU'.
      ...
      * Called module names
       01  MOD-ZHO01Q8B              PIC X(8) VALUE 'ZHO01Q8B'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM EXPAND-MANAGED-FUND-0059.
               ...
               PERFORM RESOLVE-MODEL-0113.
               PERFORM SQL-ACCESS-0114.
               PERFORM DERIVE-STATUS-CODE-0115.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZHO01Q8B-001.
               CALL 'ZHO01Q8B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01Q8B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
