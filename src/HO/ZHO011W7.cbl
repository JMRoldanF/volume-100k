      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO011W7'.
      ...
      * Called module names
       01  MOD-ZHO01IF5              PIC X(8) VALUE 'ZHO01IF5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01IF5-001.
               CALL 'ZHO01IF5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01IF5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01JKO-002.
