      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01114'.
      ...
      * Called module names
       01  MOD-ZHO01OLG              PIC X(8) VALUE 'ZHO01OLG'.
       01  MOD-ZPA01ILT              PIC X(8) VALUE 'ZPA01ILT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01OLG-001.
               CALL 'ZHO01OLG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01OLG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01ILT-002.
               CALL 'ZPA01ILT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
