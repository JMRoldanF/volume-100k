      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00W0K'.
      ...
      * Called module names
       01  MOD-ZEN01R6J              PIC X(8) VALUE 'ZEN01R6J'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01R6J-001.
               CALL 'ZEN01R6J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01R6J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01P4M-002.
