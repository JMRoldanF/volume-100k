      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00OLC'.
      ...
      * Called module names
       01  MOD-ZHO01UC4              PIC X(8) VALUE 'ZHO01UC4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01UC4-001.
               PERFORM CALL-ZHO01QZA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01UC4-001.
               CALL 'ZHO01UC4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01UC4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01QZA-002.
