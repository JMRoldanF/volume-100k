      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00MQO'.
      ...
      * Called module names
       01  MOD-ZHO01TZW              PIC X(8) VALUE 'ZHO01TZW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01TZW-001.
               CALL 'ZHO01TZW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01TZW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-COLOUR-0001.
