      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00U54'.
      ...
      * Called module names
       01  MOD-ZHO01U0J              PIC X(8) VALUE 'ZHO01U0J'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01U0J-001.
               PERFORM CALL-ZHO01TMX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01U0J-001.
               CALL 'ZHO01U0J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01U0J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01TMX-002.
