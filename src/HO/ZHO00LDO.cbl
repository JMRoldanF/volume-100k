      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00LDO'.
      ...
      * Called module names
       01  MOD-ZHO00T6J              PIC X(8) VALUE 'ZHO00T6J'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00T6J-001.
               EXEC CICS LINK PROGRAM('ZHO00T6J')
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01BAU-003.
               MOVE 'ZHO01BAU' TO WS-PROGNAME-7
