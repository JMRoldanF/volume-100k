      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00WMI'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01O3E              PIC X(8) VALUE 'ZHO01O3E'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01UZ6-001.
               PERFORM CALL-ZHO01O3E-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01O3E-002.
               CALL 'ZHO01O3E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01O3E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
