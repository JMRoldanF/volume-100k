      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO000NO'.
      ...
      * Called module names
       ...
       01  MOD-ZHO009YE              PIC X(8) VALUE 'ZHO009YE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO009YE-002.
               EXEC CICS LINK PROGRAM('ZHO009YE')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
