      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00W5B'.
      ...
      * Called module names
       01  MOD-ZHO01IEY              PIC X(8) VALUE 'ZHO01IEY'.
       01  MOD-ZHO01U1C              PIC X(8) VALUE 'ZHO01U1C'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01IEY-001.
               PERFORM CALL-ZHO01U1C-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01IEY-001.
               CALL 'ZHO01IEY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01IEY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01U1C-002.
               CALL 'ZHO01U1C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01U1C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
