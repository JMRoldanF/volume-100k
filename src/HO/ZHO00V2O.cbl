      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00V2O'.
      ...
      * Called module names
       01  MOD-ZHO01NE4              PIC X(8) VALUE 'ZHO01NE4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01NE4-001.
               CALL 'ZHO01NE4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01NE4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-EXCESS-0001.
