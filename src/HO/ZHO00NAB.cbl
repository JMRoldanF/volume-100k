      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00NAB'.
      ...
      * Called module names
       01  MOD-ZSL01M0W              PIC X(8) VALUE 'ZSL01M0W'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSL01M0W-001.
               CALL 'ZSL01M0W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSL01M0W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
