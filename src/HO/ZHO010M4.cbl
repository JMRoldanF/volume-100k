      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO010M4'.
      ...
      * Called module names
       01  MOD-ZHO01N5I              PIC X(8) VALUE 'ZHO01N5I'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01N5I-001.
               CALL 'ZHO01N5I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01N5I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
