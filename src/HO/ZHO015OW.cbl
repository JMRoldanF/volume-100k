      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO015OW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01SMG-001.
               PERFORM CALL-ZHO01D9E-002.
               PERFORM COMPUTE-WITH-PROFITS-0001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZHO01SMG-001.
               MOVE 'ZHO01SMG' TO WS-SUBNAME-3
