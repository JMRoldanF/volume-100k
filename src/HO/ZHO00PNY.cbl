      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00PNY'.
      ...
      * Called module names
       01  MOD-ZHO01OV6              PIC X(8) VALUE 'ZHO01OV6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01OV6-001.
               PERFORM CALL-ZHO01O20-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01OV6-001.
               CALL 'ZHO01OV6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01OV6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01O20-002.
