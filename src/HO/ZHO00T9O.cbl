      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00T9O'.
      ...
      * Called module names
       01  MOD-ZHO01MB8              PIC X(8) VALUE 'ZHO01MB8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01MB8-001.
               CALL 'ZHO01MB8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01MB8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
