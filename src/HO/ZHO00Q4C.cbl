      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00Q4C'.
      ...
      * Called module names
       01  MOD-ZHO01EGG              PIC X(8) VALUE 'ZHO01EGG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01EGG-001.
               PERFORM CALL-ZHO01IUI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01EGG-001.
               CALL 'ZHO01EGG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01EGG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01IUI-002.
