      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00RSC'.
      ...
      * Called module names
       01  MOD-ZHO01HJA              PIC X(8) VALUE 'ZHO01HJA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01HJA-001.
               CALL 'ZHO01HJA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01HJA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
