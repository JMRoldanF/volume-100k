      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00RVW'.
      ...
      * Called module names
       01  MOD-ZHO01DYU              PIC X(8) VALUE 'ZHO01DYU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01DYU-001.
               CALL 'ZHO01DYU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01DYU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-TERM-0001.
