      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00U34'.
      ...
      * Called module names
       01  MOD-ZHO01S9O              PIC X(8) VALUE 'ZHO01S9O'.
       01  MOD-ZHO01PNS              PIC X(8) VALUE 'ZHO01PNS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01S9O-001.
               PERFORM CALL-ZHO01PNS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01S9O-001.
               CALL 'ZHO01S9O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01S9O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01PNS-002.
               CALL 'ZHO01PNS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
