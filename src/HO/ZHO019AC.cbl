      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO019AC'.
      ...
      * Called module names
       01  MOD-ZHO01O0M              PIC X(8) VALUE 'ZHO01O0M'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01O0M-001.
               PERFORM CALL-ZHO01NI0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01O0M-001.
               CALL 'ZHO01O0M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01O0M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01NI0-002.
               MOVE 'ZHO01NI0' TO WS-SUBNAME-1
