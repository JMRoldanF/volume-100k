      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00444'.
      ...
      * Called module names
       ...
       01  MOD-ZHO006JM              PIC X(8) VALUE 'ZHO006JM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO00C8W-001.
               PERFORM CALL-ZHO006JM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO006JM-002.
               EXEC CICS LINK PROGRAM('ZHO006JM')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO006JM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
