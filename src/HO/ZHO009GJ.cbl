      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO009GJ'.
      ...
      * Called module names
       01  MOD-ZHO00MAL              PIC X(8) VALUE 'ZHO00MAL'.
       01  MOD-ZHO00XPA              PIC X(8) VALUE 'ZHO00XPA'.
       01  MOD-ZHO016TB              PIC X(8) VALUE 'ZHO016TB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO00MAL-001.
               PERFORM CALL-ZHO00XPA-002.
               PERFORM CALL-ZHO016TB-003.
               PERFORM CALL-ZHO01GVR-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00MAL-001.
               EXEC CICS LINK PROGRAM('ZHO00MAL')
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00XPA-002.
               EXEC CICS LINK PROGRAM('ZHO00XPA')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO00XPA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO016TB-003.
               EXEC CICS LINK PROGRAM('ZHO016TB')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO016TB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01GVR-004.
