      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO012IQ'.
      ...
      * Called module names
       01  MOD-ZHO01LRS              PIC X(8) VALUE 'ZHO01LRS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01LRS-001.
               PERFORM CALL-ZHO01EPW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01LRS-001.
               CALL 'ZHO01LRS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
