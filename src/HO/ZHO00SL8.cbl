      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00SL8'.
      ...
      * Called module names
       01  MOD-ZHO01K0G              PIC X(8) VALUE 'ZHO01K0G'.
       01  MOD-ZHO01RM2              PIC X(8) VALUE 'ZHO01RM2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01K0G-001.
               PERFORM CALL-ZHO01RM2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01K0G-001.
               CALL 'ZHO01K0G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01K0G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01RM2-002.
               CALL 'ZHO01RM2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01RM2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
