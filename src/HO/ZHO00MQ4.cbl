      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00MQ4'.
      ...
      * Called module names
       01  MOD-ZHO01EQ6              PIC X(8) VALUE 'ZHO01EQ6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01EQ6-001.
               PERFORM CALL-ZHO01D0S-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01EQ6-001.
               CALL 'ZHO01EQ6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01EQ6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01D0S-002.
