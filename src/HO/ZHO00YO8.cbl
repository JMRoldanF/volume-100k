      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00YO8'.
      ...
      * Called module names
       01  MOD-ZHO01K1U              PIC X(8) VALUE 'ZHO01K1U'.
       01  MOD-ZHO01QI6              PIC X(8) VALUE 'ZHO01QI6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01K1U-001.
               PERFORM CALL-ZHO01QI6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01K1U-001.
               CALL 'ZHO01K1U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01K1U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01QI6-002.
               CALL 'ZHO01QI6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01QI6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
