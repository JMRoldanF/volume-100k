      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00RH8'.
      ...
      * Called module names
       01  MOD-ZUW01L0S              PIC X(8) VALUE 'ZUW01L0S'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01L0S-001.
               PERFORM CALL-ZHO01DS0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01L0S-001.
               CALL 'ZUW01L0S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01L0S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01DS0-002.
