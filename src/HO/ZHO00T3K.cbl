      ...
      * Called module names
       ...
       01  MOD-ZFL01QSX              PIC X(8) VALUE 'ZFL01QSX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01KOF-001.
               PERFORM CALL-ZFL01QSX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01QSX-002.
               CALL 'ZFL01QSX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01QSX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
