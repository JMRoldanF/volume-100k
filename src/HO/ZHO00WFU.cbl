      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00WFU'.
      ...
      * Called module names
       01  MOD-ZHO01UIS              PIC X(8) VALUE 'ZHO01UIS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01UIS-001.
               PERFORM CALL-ZHO01MCW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01UIS-001.
               CALL 'ZHO01UIS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01UIS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01MCW-002.
