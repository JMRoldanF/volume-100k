      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00MOG'.
      ...
      * Called module names
       01  MOD-ZCU01QFW              PIC X(8) VALUE 'ZCU01QFW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01QFW-001.
               CALL 'ZCU01QFW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01QFW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
