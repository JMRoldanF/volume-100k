      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01BSC'.
      ...
      * Called module names
       01  MOD-ZHO01QMI              PIC X(8) VALUE 'ZHO01QMI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01QMI-001.
               CALL 'ZHO01QMI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01QMI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
