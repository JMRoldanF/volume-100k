      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00W4E'.
      ...
      * Called module names
       01  MOD-ZHO01UIE              PIC X(8) VALUE 'ZHO01UIE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01UIE-001.
               CALL 'ZHO01UIE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01UIE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-EXCESS-0001.
