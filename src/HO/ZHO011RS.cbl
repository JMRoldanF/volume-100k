      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO011RS'.
      ...
      * Called module names
       01  MOD-ZHO01MVS              PIC X(8) VALUE 'ZHO01MVS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01MVS-001.
               CALL 'ZHO01MVS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01MVS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
