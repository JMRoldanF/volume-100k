      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO011GE'.
      ...
      * Called module names
       01  MOD-ZHO01ONY              PIC X(8) VALUE 'ZHO01ONY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01ONY-001.
               PERFORM CALL-ZHO01E34-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01ONY-001.
               CALL 'ZHO01ONY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01ONY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01E34-002.
