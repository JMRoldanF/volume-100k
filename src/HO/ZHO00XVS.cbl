      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00XVS'.
      ...
      * Called module names
       01  MOD-ZHO01QEG              PIC X(8) VALUE 'ZHO01QEG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01CYU-001.
               PERFORM CALL-ZHO01QEG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01QEG-002.
               CALL 'ZHO01QEG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
