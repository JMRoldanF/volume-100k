      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO011ZU'.
      ...
      * Called module names
       01  MOD-ZHO01FFB              PIC X(8) VALUE 'ZHO01FFB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01FFB-001.
               CALL 'ZHO01FFB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01FFB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01RP2-002.
