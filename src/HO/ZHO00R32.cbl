      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00R32'.
      ...
      * Called module names
       01  MOD-ZRE01CSL              PIC X(8) VALUE 'ZRE01CSL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01CSL-001.
               CALL 'ZRE01CSL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01CSL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
