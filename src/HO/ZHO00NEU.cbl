      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00NEU'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01LX2              PIC X(8) VALUE 'ZHO01LX2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01OXY-001.
               PERFORM CALL-ZHO01LX2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01LX2-002.
               CALL 'ZHO01LX2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01LX2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
