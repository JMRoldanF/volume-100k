      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00QWO'.
      ...
      * Called module names
       01  MOD-ZHO01HL8              PIC X(8) VALUE 'ZHO01HL8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01HL8-001.
               CALL 'ZHO01HL8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01HL8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
