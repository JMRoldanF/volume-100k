      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00LXI'.
      ...
      * Called module names
       01  MOD-ZHO01EJS              PIC X(8) VALUE 'ZHO01EJS'.
       01  MOD-ZHO01GNC              PIC X(8) VALUE 'ZHO01GNC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01EJS-001.
               CALL 'ZHO01EJS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01EJS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01GNC-002.
               CALL 'ZHO01GNC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
