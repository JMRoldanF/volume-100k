      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01U93'.
      ...
      * Called module names
       01  MOD-ZHO01R7F              PIC X(8) VALUE 'ZHO01R7F'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01R7F-001.
               CALL 'ZHO01R7F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01R7F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
