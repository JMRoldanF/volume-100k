      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00Y6W'.
      ...
      * Called module names
       01  MOD-ZHO01JO8              PIC X(8) VALUE 'ZHO01JO8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01JO8-001.
               CALL 'ZHO01JO8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01JO8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
