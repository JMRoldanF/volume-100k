      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO011JQ'.
      ...
      * Called module names
       01  MOD-ZHO01UNI              PIC X(8) VALUE 'ZHO01UNI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01UNI-001.
               CALL 'ZHO01UNI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01UNI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01E6Q-002.
               MOVE 'ZHO01E6Q' TO WS-SUBNAME-6
