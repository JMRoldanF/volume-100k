      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00Q91'.
      ...
      * Called module names
       01  MOD-ZHO01POL              PIC X(8) VALUE 'ZHO01POL'.
       01  MOD-ZHO01OYK              PIC X(8) VALUE 'ZHO01OYK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01POL-001.
               PERFORM CALL-ZHO01OYK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01POL-001.
               CALL 'ZHO01POL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01POL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01OYK-002.
               CALL 'ZHO01OYK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01OYK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
