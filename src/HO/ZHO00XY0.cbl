      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00XY0'.
      ...
      * Called module names
       01  MOD-ZAG01SOK              PIC X(8) VALUE 'ZAG01SOK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01SOK-001.
               PERFORM CALL-ZHO01ET8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01SOK-001.
               CALL 'ZAG01SOK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
