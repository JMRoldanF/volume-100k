      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00U48'.
      ...
      * Called module names
       01  MOD-ZHO01GY6              PIC X(8) VALUE 'ZHO01GY6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01GY6-001.
               CALL 'ZHO01GY6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01GY6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
