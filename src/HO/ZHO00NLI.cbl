      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00NLI'.
      ...
      * Called module names
       01  MOD-ZHO01EL6              PIC X(8) VALUE 'ZHO01EL6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01EL6-001.
               CALL 'ZHO01EL6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01EL6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
