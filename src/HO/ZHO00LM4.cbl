      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00LM4'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01JYV              PIC X(8) VALUE 'ZCL01JYV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01CUE-001.
               PERFORM CALL-ZCL01JYV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01JYV-002.
               CALL 'ZCL01JYV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01JYV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-VALUE-0001.
