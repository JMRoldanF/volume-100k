      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO012B8'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01N1C              PIC X(8) VALUE 'ZHO01N1C'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01UOC-001.
               PERFORM CALL-ZHO01N1C-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01N1C-002.
               CALL 'ZHO01N1C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01N1C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
