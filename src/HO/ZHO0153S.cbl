      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO0153S'.
      ...
      * Called module names
       01  MOD-ZHO01HXG              PIC X(8) VALUE 'ZHO01HXG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01HXG-001.
               CALL 'ZHO01HXG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01HXG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
