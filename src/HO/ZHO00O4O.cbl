      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00O4O'.
      ...
      * Called module names
       01  MOD-ZHO01GRI              PIC X(8) VALUE 'ZHO01GRI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM DERIVE-AGENT-CODE-0104.
               PERFORM NORMALISE-STATUS-CODE-0106.
               PERFORM AUDIT-MODEL-0107.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01GRI-001.
               CALL 'ZHO01GRI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01GRI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
