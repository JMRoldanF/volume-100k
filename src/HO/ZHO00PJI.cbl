      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00PJI'.
      ...
      * Called module names
       01  MOD-ZHO01O6G              PIC X(8) VALUE 'ZHO01O6G'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01O6G-001.
               PERFORM CALL-ZHO01E2A-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01O6G-001.
               CALL 'ZHO01O6G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01O6G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01E2A-002.
