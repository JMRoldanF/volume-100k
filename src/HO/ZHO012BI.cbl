      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO012BI'.
      ...
      * Called module names
       01  MOD-ZHO01KJC              PIC X(8) VALUE 'ZHO01KJC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01KJC-001.
               CALL 'ZHO01KJC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01KJC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
