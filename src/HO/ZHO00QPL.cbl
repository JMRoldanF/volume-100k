      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00QPL'.
      ...
      * Called module names
       01  MOD-ZHO01UC9              PIC X(8) VALUE 'ZHO01UC9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01UC9-001.
               PERFORM CALL-ZHO01CRM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01UC9-001.
               CALL 'ZHO01UC9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01UC9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01CRM-002.
               MOVE 'ZHO01CRM' TO WS-SUBNAME-3
