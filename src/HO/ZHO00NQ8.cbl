      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00NQ8'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01PW4              PIC X(8) VALUE 'ZHO01PW4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01UF6-001.
               PERFORM CALL-ZHO01PW4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01PW4-002.
               CALL 'ZHO01PW4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01PW4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       NORMALISE-MAKE-0001.
