      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO017LS'.
      ...
      * Called module names
       01  MOD-ZCL01UHR              PIC X(8) VALUE 'ZCL01UHR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01UHR-001.
               CALL 'ZCL01UHR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01UHR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01DNA-002.
