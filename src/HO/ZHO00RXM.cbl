      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00RXM'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01M2C              PIC X(8) VALUE 'ZHO01M2C'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01ENE-001.
               PERFORM CALL-ZHO01M2C-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01M2C-002.
               CALL 'ZHO01M2C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01M2C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
