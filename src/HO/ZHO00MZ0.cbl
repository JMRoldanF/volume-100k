      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00MZ0'.
      ...
      * Called module names
       01  MOD-ZUW01LQM              PIC X(8) VALUE 'ZUW01LQM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01LQM-001.
               CALL 'ZUW01LQM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01LQM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
