      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00R00'.
      ...
      * Called module names
       01  MOD-ZHO01O1G              PIC X(8) VALUE 'ZHO01O1G'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01O1G-001.
               CALL 'ZHO01O1G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01O1G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
