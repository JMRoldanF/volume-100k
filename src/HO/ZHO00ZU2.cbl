      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00ZU2'.
      ...
      * Called module names
       01  MOD-ZHO01OAC              PIC X(8) VALUE 'ZHO01OAC'.
       01  MOD-ZHO01QUK              PIC X(8) VALUE 'ZHO01QUK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01OAC-001.
               PERFORM CALL-ZHO01QUK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01OAC-001.
               CALL 'ZHO01OAC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01OAC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01QUK-002.
               CALL 'ZHO01QUK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01QUK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
