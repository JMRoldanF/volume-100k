      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO000IY'.
      ...
      * Called module names
       01  MOD-ZUW00CSA              PIC X(8) VALUE 'ZUW00CSA'.
       01  MOD-ZHO00EJO              PIC X(8) VALUE 'ZHO00EJO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW00CSA-001.
               PERFORM CALL-ZHO00CMS-002.
               PERFORM CALL-ZHO00EJO-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW00CSA-001.
               EXEC CICS LINK PROGRAM('ZUW00CSA')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW00CSA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO00CMS-002.
               MOVE 'ZHO00CMS' TO WS-PROGNAME-6
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00EJO-003.
               EXEC CICS LINK PROGRAM('ZHO00EJO')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO00EJO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-004.
