      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00N5A'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01NEJ              PIC X(8) VALUE 'ZHO01NEJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01NEJ-002.
               CALL 'ZHO01NEJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01NEJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
