      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00YS4'.
      ...
      * Called module names
       01  MOD-ZHO01K0X              PIC X(8) VALUE 'ZHO01K0X'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01K0X-001.
               PERFORM CALL-ZHO01TJK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01K0X-001.
               CALL 'ZHO01K0X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
