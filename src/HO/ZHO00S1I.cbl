      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00S1I'.
      ...
      * Called module names
       01  MOD-ZHO01UCE              PIC X(8) VALUE 'ZHO01UCE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01UCE-001.
               PERFORM CALL-ZHO01K2E-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01UCE-001.
               CALL 'ZHO01UCE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01UCE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01K2E-002.
