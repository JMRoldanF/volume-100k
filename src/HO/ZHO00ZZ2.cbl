      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00ZZ2'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01RBI              PIC X(8) VALUE 'ZHO01RBI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01PCY-001.
               PERFORM CALL-ZHO01RBI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01RBI-002.
               CALL 'ZHO01RBI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
