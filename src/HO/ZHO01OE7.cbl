      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01OE7'.
      ...
      * Called module names
       01  MOD-ZHO01D8B              PIC X(8) VALUE 'ZHO01D8B'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01D8B-001.
               CALL 'ZHO01D8B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01D8B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-VALUE-0001.
