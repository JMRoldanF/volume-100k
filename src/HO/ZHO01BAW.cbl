      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01BAW'.
      ...
      * Called module names
       01  MOD-ZHO01F52              PIC X(8) VALUE 'ZHO01F52'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01F52-001.
               PERFORM CALL-ZHO01F30-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01F52-001.
               CALL 'ZHO01F52' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01F52 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01F30-002.
