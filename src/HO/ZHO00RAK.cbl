      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00RAK'.
      ...
      * Called module names
       01  MOD-ZHO01JCU              PIC X(8) VALUE 'ZHO01JCU'.
       01  MOD-ZHO01KB0              PIC X(8) VALUE 'ZHO01KB0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01JCU-001.
               CALL 'ZHO01JCU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01JCU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01KB0-002.
               CALL 'ZHO01KB0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
