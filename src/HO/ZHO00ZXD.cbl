      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00ZXD'.
      ...
      * Called module names
       01  MOD-ZHO01H9G              PIC X(8) VALUE 'ZHO01H9G'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01H9G-001.
               CALL 'ZHO01H9G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01H9G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01N1X-002.
               MOVE 'ZHO01N1X' TO WS-SUBNAME-3
