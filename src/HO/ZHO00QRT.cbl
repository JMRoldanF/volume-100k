      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00QRT'.
      ...
      * Called module names
       01  MOD-ZHO01I6J              PIC X(8) VALUE 'ZHO01I6J'.
       01  MOD-ZHO01TBC              PIC X(8) VALUE 'ZHO01TBC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01I6J-001.
               PERFORM CALL-ZHO01TBC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01I6J-001.
               CALL 'ZHO01I6J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01I6J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01TBC-002.
               CALL 'ZHO01TBC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01TBC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
