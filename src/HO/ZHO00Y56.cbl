      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00Y56'.
      ...
      * Called module names
       01  MOD-ZHO01RZ2              PIC X(8) VALUE 'ZHO01RZ2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01RZ2-001.
               PERFORM CALL-ZFL01DC0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01RZ2-001.
               CALL 'ZHO01RZ2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01RZ2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFL01DC0-002.
