      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00MJG'.
      ...
      * Called module names
       01  MOD-ZPA01DGT              PIC X(8) VALUE 'ZPA01DGT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01DGT-001.
               PERFORM CALL-ZCL0255P-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZPA01DGT-001.
               CALL 'ZPA01DGT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
