      ...
      * Called module names
       01  MOD-ZHO01ODN              PIC X(8) VALUE 'ZHO01ODN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01ODN-001.
               PERFORM CALL-ZHO01LOR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01ODN-001.
               CALL 'ZHO01ODN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01ODN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01LOR-002.
