      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00ZSO'.
      ...
      * Called module names
       01  MOD-ZHO01DXK              PIC X(8) VALUE 'ZHO01DXK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01DXK-001.
               CALL 'ZHO01DXK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01DXK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
