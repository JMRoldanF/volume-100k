      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01046'.
      ...
      * Called module names
       01  MOD-ZHO01GQ9              PIC X(8) VALUE 'ZHO01GQ9'.
       01  MOD-ZHO01PJA              PIC X(8) VALUE 'ZHO01PJA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01GQ9-001.
               CALL 'ZHO01GQ9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01GQ9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01PJA-002.
               CALL 'ZHO01PJA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01PJA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
