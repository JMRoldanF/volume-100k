      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00P8O'.
      ...
      * Called module names
       01  MOD-ZHO01PFG              PIC X(8) VALUE 'ZHO01PFG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01PFG-001.
               PERFORM CALL-ZHO01FA6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01PFG-001.
               CALL 'ZHO01PFG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01PFG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01FA6-002.
