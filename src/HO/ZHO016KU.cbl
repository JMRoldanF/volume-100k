      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO016KU'.
      ...
      * Called module names
       01  MOD-ZMT01IB1              PIC X(8) VALUE 'ZMT01IB1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01IB1-001.
               CALL 'ZMT01IB1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01IB1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
