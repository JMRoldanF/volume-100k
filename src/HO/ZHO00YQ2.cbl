      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00YQ2'.
      ...
      * Called module names
       01  MOD-ZHO01NIK              PIC X(8) VALUE 'ZHO01NIK'.
       01  MOD-ZHO01OFM              PIC X(8) VALUE 'ZHO01OFM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01NIK-001.
               PERFORM CALL-ZHO01OFM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01NIK-001.
               CALL 'ZHO01NIK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01NIK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01OFM-002.
               CALL 'ZHO01OFM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01OFM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
