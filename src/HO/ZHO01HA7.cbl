      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01HA7'.
      ...
      * Called module names
       01  MOD-ZFL01RSD              PIC X(8) VALUE 'ZFL01RSD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01RSD-001.
               CALL 'ZFL01RSD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01RSD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
