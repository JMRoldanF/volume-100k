      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO016BY'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01EOI              PIC X(8) VALUE 'ZHO01EOI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01MMM-001.
               PERFORM CALL-ZHO01EOI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01EOI-002.
               CALL 'ZHO01EOI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01EOI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
