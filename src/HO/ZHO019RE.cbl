      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO019RE'.
      ...
      * Called module names
       01  MOD-ZHO01Q1M              PIC X(8) VALUE 'ZHO01Q1M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01Q1M-001.
               CALL 'ZHO01Q1M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01Q1M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
