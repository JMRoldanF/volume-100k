      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00VRL'.
      ...
      * Called module names
       01  MOD-ZHO01DU8              PIC X(8) VALUE 'ZHO01DU8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01DU8-001.
               CALL 'ZHO01DU8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01DU8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
