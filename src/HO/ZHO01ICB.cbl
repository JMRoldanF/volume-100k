      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01ICB'.
      ...
      * Called module names
       01  MOD-ZHO01DKE              PIC X(8) VALUE 'ZHO01DKE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01DKE-001.
               CALL 'ZHO01DKE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01DKE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
