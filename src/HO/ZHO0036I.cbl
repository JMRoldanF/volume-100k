      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO0036I'.
      ...
      * Called module names
       ...
       01  MOD-ZAG004ZO              PIC X(8) VALUE 'ZAG004ZO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO00KP2-002.
               PERFORM CALL-ZAG004ZO-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00CSM-001.
               MOVE 'ZHO00CSM' TO WS-PROGNAME-3
      ...
      *----------------------------------------------------------------*
       CALL-ZAG004ZO-003.
               EXEC CICS XCTL PROGRAM('ZAG004ZO')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG004ZO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-004.
