      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO010YC'.
      ...
      * Called module names
       01  MOD-ZAG01OOO              PIC X(8) VALUE 'ZAG01OOO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01OOO-001.
               CALL 'ZAG01OOO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01OOO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-MAKE-0001.
