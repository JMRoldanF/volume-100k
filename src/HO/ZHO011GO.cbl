      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO011GO'.
      ...
      * Called module names
       01  MOD-ZHO01Q8W              PIC X(8) VALUE 'ZHO01Q8W'.
       01  MOD-ZHO01FZQ              PIC X(8) VALUE 'ZHO01FZQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01Q8W-001.
               PERFORM CALL-ZHO01FZQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01Q8W-001.
               CALL 'ZHO01Q8W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01Q8W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01FZQ-002.
               CALL 'ZHO01FZQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01FZQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
