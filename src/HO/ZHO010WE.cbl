      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO010WE'.
      ...
      * Called module names
       01  MOD-ZHO01DSA              PIC X(8) VALUE 'ZHO01DSA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01DSA-001.
               CALL 'ZHO01DSA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01DSA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01ID0-002.
