      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO0039R'.
      ...
      * Called module names
       ...
       01  MOD-ZHO005VK              PIC X(8) VALUE 'ZHO005VK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO00J83-001.
               PERFORM CALL-ZHO00HPH-002.
               PERFORM CALL-ZHO00F8K-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00HPH-002.
               MOVE 'ZHO00HPH' TO WS-PROGNAME-8
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO00HPH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO00F8K-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO005VK-004.
               EXEC CICS XCTL PROGRAM('ZHO005VK')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
