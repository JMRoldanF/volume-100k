      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00OVE'.
      ...
      * Called module names
       01  MOD-ZFL01HJG              PIC X(8) VALUE 'ZFL01HJG'.
       01  MOD-ZHO01DC3              PIC X(8) VALUE 'ZHO01DC3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFL01HJG-001.
               PERFORM CALL-ZHO01DC3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01HJG-001.
               CALL 'ZFL01HJG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01HJG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01DC3-002.
               CALL 'ZHO01DC3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01DC3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
