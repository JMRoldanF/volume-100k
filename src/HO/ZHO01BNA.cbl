      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01BNA'.
      ...
      * Called module names
       01  MOD-ZHO01TW9              PIC X(8) VALUE 'ZHO01TW9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01TW9-001.
               CALL 'ZHO01TW9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01TW9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
