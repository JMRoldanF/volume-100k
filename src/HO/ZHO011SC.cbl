      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO011SC'.
      ...
      * Called module names
       01  MOD-ZHO01S80              PIC X(8) VALUE 'ZHO01S80'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01S80-001.
               CALL 'ZHO01S80' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01S80 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01RTA-002.
               MOVE 'ZHO01RTA' TO WS-SUBNAME-8
