      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00TCQ'.
      ...
      * Called module names
       01  MOD-ZHO01U1K              PIC X(8) VALUE 'ZHO01U1K'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01U1K-001.
               PERFORM CALL-ZHO01TWA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01U1K-001.
               CALL 'ZHO01U1K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01U1K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01TWA-002.
