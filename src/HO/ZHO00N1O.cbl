      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00N1O'.
      ...
      * Called module names
       01  MOD-ZHO01SHU              PIC X(8) VALUE 'ZHO01SHU'.
       01  MOD-ZHO01DQJ              PIC X(8) VALUE 'ZHO01DQJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01SHU-001.
               PERFORM CALL-ZHO01DQJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01SHU-001.
               CALL 'ZHO01SHU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01SHU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01DQJ-002.
               CALL 'ZHO01DQJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01DQJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-EXCESS-0001.
