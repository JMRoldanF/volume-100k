      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO0056G'.
      ...
      * Called module names
       01  MOD-ZHO007J6              PIC X(8) VALUE 'ZHO007J6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO007J6-001.
               PERFORM CALL-ZHO008C2-002.
               PERFORM CALL-ZHO00700-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO007J6-001.
               EXEC CICS LINK PROGRAM('ZHO007J6')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO007J6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO008C2-002.
