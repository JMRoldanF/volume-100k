      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00MEP'.
      ...
      * Called module names
       01  MOD-ZHO01S5R              PIC X(8) VALUE 'ZHO01S5R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01S5R-001.
               CALL 'ZHO01S5R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01S5R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
