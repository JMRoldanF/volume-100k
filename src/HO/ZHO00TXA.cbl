      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00TXA'.
      ...
      * Called module names
       01  MOD-ZRE01DR1              PIC X(8) VALUE 'ZRE01DR1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01DR1-001.
               CALL 'ZRE01DR1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01DR1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
