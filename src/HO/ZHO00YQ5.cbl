      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00YQ5'.
      ...
      * Called module names
       01  MOD-ZHO01HL0              PIC X(8) VALUE 'ZHO01HL0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01HL0-001.
               CALL 'ZHO01HL0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01HL0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
