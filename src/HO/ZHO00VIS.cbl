      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00VIS'.
      ...
      * Called module names
       01  MOD-ZHO01LUK              PIC X(8) VALUE 'ZHO01LUK'.
       01  MOD-ZHO01NLC              PIC X(8) VALUE 'ZHO01NLC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01LUK-001.
               PERFORM CALL-ZHO01NLC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01LUK-001.
               CALL 'ZHO01LUK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01LUK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01NLC-002.
               CALL 'ZHO01NLC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01NLC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
