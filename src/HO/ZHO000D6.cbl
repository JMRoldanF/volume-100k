      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO000D6'.
      ...
      * Called module names
       ...
       01  MOD-ZHO00JWQ              PIC X(8) VALUE 'ZHO00JWQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00JWQ-002.
               EXEC CICS LINK PROGRAM('ZHO00JWQ')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO00JWQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-TAX-BAND-0001.
