      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00MBY'.
      ...
      * Called module names
       01  MOD-ZHO01ENO              PIC X(8) VALUE 'ZHO01ENO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01ENO-001.
               CALL 'ZHO01ENO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01ENO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
