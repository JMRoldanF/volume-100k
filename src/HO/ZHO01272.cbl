      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01272'.
      ...
      * Called module names
       01  MOD-ZHO01F7O              PIC X(8) VALUE 'ZHO01F7O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01F7O-001.
               CALL 'ZHO01F7O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01F7O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
