      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00Y2Q'.
      ...
      * Called module names
       01  MOD-ZHO01LQE              PIC X(8) VALUE 'ZHO01LQE'.
       01  MOD-ZHO01OKC              PIC X(8) VALUE 'ZHO01OKC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01LQE-001.
               PERFORM CALL-ZHO01OKC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01LQE-001.
               CALL 'ZHO01LQE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01LQE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01OKC-002.
               CALL 'ZHO01OKC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01OKC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
