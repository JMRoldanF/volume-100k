      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO010H4'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01G78              PIC X(8) VALUE 'ZHO01G78'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01TZH-001.
               PERFORM CALL-ZHO01G78-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01G78-002.
               CALL 'ZHO01G78' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01G78 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
