      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00ZFW'.
      ...
      * Called module names
       01  MOD-ZHO01JNO              PIC X(8) VALUE 'ZHO01JNO'.
       01  MOD-ZHO01DI0              PIC X(8) VALUE 'ZHO01DI0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01JNO-001.
               CALL 'ZHO01JNO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01JNO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01DI0-002.
               CALL 'ZHO01DI0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01DI0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
