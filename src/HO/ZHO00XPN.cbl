      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00XPN'.
      ...
      * Called module names
       01  MOD-ZHO01FV9              PIC X(8) VALUE 'ZHO01FV9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01FV9-001.
               CALL 'ZHO01FV9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01FV9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
