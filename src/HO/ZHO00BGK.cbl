      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00BGK'.
      ...
      * Called module names
       01  MOD-ZHO00X54              PIC X(8) VALUE 'ZHO00X54'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO011ZK-001.
               MOVE 'ZHO011ZK' TO WS-PROGNAME-8
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00X54-002.
               EXEC CICS LINK PROGRAM('ZHO00X54')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO00X54 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
