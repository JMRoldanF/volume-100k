      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00TB2'.
      ...
      * Called module names
       01  MOD-ZHO01FYW              PIC X(8) VALUE 'ZHO01FYW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01FYW-001.
               CALL 'ZHO01FYW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01FYW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
