      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00X04'.
      ...
      * Called module names
       01  MOD-ZHO01DRQ              PIC X(8) VALUE 'ZHO01DRQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01DRQ-001.
               CALL 'ZHO01DRQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01DRQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
