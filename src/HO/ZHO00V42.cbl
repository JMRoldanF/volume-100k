      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00V42'.
      ...
      * Called module names
       01  MOD-ZAG01FHA              PIC X(8) VALUE 'ZAG01FHA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01FHA-001.
               CALL 'ZAG01FHA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01FHA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
