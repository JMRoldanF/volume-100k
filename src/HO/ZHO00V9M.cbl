      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00V9M'.
      ...
      * Called module names
       01  MOD-ZHO01DZ8              PIC X(8) VALUE 'ZHO01DZ8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01DZ8-001.
               CALL 'ZHO01DZ8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01DZ8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
