      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00WXX'.
      ...
      * Called module names
       01  MOD-ZHO01UXH              PIC X(8) VALUE 'ZHO01UXH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01UXH-001.
               CALL 'ZHO01UXH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01UXH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01HYB-002.
