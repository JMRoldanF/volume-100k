      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO012JK'.
      ...
      * Called module names
       01  MOD-ZHO01LDM              PIC X(8) VALUE 'ZHO01LDM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01LDM-001.
               CALL 'ZHO01LDM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01LDM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
