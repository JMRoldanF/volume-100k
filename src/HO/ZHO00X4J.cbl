      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00X4J'.
      ...
      * Called module names
       01  MOD-ZHO01FRO              PIC X(8) VALUE 'ZHO01FRO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01FRO-001.
               CALL 'ZHO01FRO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01FRO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
