      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO012F1'.
      ...
      * Called module names
       01  MOD-ZPR01UEJ              PIC X(8) VALUE 'ZPR01UEJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR01UEJ-001.
               CALL 'ZPR01UEJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01UEJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
