      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01LH8'.
      ...
      * Called module names
       01  MOD-ZHO01Q4G              PIC X(8) VALUE 'ZHO01Q4G'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01Q4G-001.
               CALL 'ZHO01Q4G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01Q4G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
