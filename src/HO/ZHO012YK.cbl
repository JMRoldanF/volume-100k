      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO012YK'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01OA8              PIC X(8) VALUE 'ZAG01OA8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01F5Q-001.
               PERFORM CALL-ZAG01OA8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01OA8-002.
               CALL 'ZAG01OA8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
