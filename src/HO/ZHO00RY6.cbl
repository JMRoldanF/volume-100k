      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00RY6'.
      ...
      * Called module names
       01  MOD-ZAG01T1M              PIC X(8) VALUE 'ZAG01T1M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01T1M-001.
               CALL 'ZAG01T1M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01T1M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
