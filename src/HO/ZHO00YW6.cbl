      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00YW6'.
      ...
      * Called module names
       01  MOD-ZUW01EVY              PIC X(8) VALUE 'ZUW01EVY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01EVY-001.
               CALL 'ZUW01EVY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01EVY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
