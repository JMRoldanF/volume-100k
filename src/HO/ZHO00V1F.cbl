      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00V1F'.
      ...
      * Called module names
       01  MOD-ZHO01IRZ              PIC X(8) VALUE 'ZHO01IRZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01IRZ-001.
               CALL 'ZHO01IRZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01IRZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-COLOUR-0001.
