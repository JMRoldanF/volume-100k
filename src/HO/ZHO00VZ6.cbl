      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00VZ6'.
      ...
      * Called module names
       01  MOD-ZHO01DLM              PIC X(8) VALUE 'ZHO01DLM'.
       01  MOD-ZMT01UI7              PIC X(8) VALUE 'ZMT01UI7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01DLM-001.
               PERFORM CALL-ZMT01UI7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01DLM-001.
               CALL 'ZHO01DLM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01DLM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01UI7-002.
               CALL 'ZMT01UI7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01UI7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
