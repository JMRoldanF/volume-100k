      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00HMU'.
      ...
      * Called module names
       01  MOD-ZHO00N4R              PIC X(8) VALUE 'ZHO00N4R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00N4R-001.
               EXEC CICS LINK PROGRAM('ZHO00N4R')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO00N4R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
