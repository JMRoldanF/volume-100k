      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00SRC'.
      ...
      * Called module names
       01  MOD-ZCL01JJ1              PIC X(8) VALUE 'ZCL01JJ1'.
       01  MOD-ZHO01PSS              PIC X(8) VALUE 'ZHO01PSS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01JJ1-001.
               CALL 'ZCL01JJ1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01PSS-002.
               CALL 'ZHO01PSS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
