      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00QBB'.
      ...
      * Called module names
       01  MOD-ZHO01HXX              PIC X(8) VALUE 'ZHO01HXX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01HXX-001.
               CALL 'ZHO01HXX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01HXX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
