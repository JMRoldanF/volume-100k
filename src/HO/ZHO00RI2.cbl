      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00RI2'.
      ...
      * Called module names
       01  MOD-ZHO01KF6              PIC X(8) VALUE 'ZHO01KF6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01KF6-001.
               PERFORM CALL-ZHO01MEK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01KF6-001.
               CALL 'ZHO01KF6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01KF6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01MEK-002.
