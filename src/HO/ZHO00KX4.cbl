      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00KX4'.
      ...
      * Called module names
       01  MOD-ZHO011HS              PIC X(8) VALUE 'ZHO011HS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO011HS-001.
               EXEC CICS LINK PROGRAM('ZHO011HS')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO011HS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
