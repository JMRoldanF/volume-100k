      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO0113C'.
      ...
      * Called module names
       01  MOD-ZHO01GF0              PIC X(8) VALUE 'ZHO01GF0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01GF0-001.
               CALL 'ZHO01GF0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01GF0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
