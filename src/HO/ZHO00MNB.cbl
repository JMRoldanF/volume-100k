      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00MNB'.
      ...
      * Called module names
       01  MOD-ZHO01UR8              PIC X(8) VALUE 'ZHO01UR8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01UR8-001.
               PERFORM CALL-ZHO01SSN-002.
               ...
               PERFORM RECONCILE-EQUITIES-0028.
               ...
               PERFORM NORMALISE-NCD-YEARS-0040.
               ...
               PERFORM EXPAND-AGENT-CODE-0098.
               ...
               PERFORM REFRESH-COLOUR-0154.
               PERFORM AUDIT-NCD-YEARS-0155.
               PERFORM SQL-ACCESS-0156.
               PERFORM CHECK-BROKER-ID-0157.
               PERFORM SQL-ACCESS-0159.
               PERFORM VALIDATE-COLOUR-0160.
               PERFORM EXPAND-BEDROOMS-0161.
               PERFORM SQL-ACCESS-0162.
               PERFORM REFRESH-TAX-BAND-0163.
               PERFORM RECONCILE-EXCESS-0164.
               PERFORM SQL-ACCESS-0165.
               PERFORM AUDIT-EXCESS-0166.
               PERFORM RECONCILE-NCD-YEARS-0167.
               PERFORM SQL-ACCESS-0168.
               PERFORM COMPUTE-POSTCODE-0169.
               PERFORM AUDIT-PREMIUM-0170.
               PERFORM SQL-ACCESS-0171.
               PERFORM DERIVE-BEDROOMS-0172.
               PERFORM APPLY-TERM-0173.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZHO01UR8-001.
               CALL 'ZHO01UR8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01UR8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01SSN-002.
