      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO016IC'.
      ...
      * Called module names
       01  MOD-ZHO01G0U              PIC X(8) VALUE 'ZHO01G0U'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01G0U-001.
               CALL 'ZHO01G0U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01G0U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01TFC-002.
