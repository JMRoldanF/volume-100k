      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00R69'.
      ...
      * Called module names
       01  MOD-ZSL01Q65              PIC X(8) VALUE 'ZSL01Q65'.
       01  MOD-ZSL01MKR              PIC X(8) VALUE 'ZSL01MKR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSL01Q65-001.
               PERFORM CALL-ZSL01MKR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSL01Q65-001.
               CALL 'ZSL01Q65' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSL01Q65 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSL01MKR-002.
               CALL 'ZSL01MKR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSL01MKR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
               MOVE 'ZEN0255N' TO WS-PROGNAME-7
