      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00TJ4'.
      ...
      * Called module names
       01  MOD-ZHO01MSQ              PIC X(8) VALUE 'ZHO01MSQ'.
       01  MOD-ZHO01I1C              PIC X(8) VALUE 'ZHO01I1C'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01MSQ-001.
               PERFORM CALL-ZHO01I1C-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01MSQ-001.
               CALL 'ZHO01MSQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01MSQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01I1C-002.
               CALL 'ZHO01I1C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01I1C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
