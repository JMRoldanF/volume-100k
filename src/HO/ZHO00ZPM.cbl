      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00ZPM'.
      ...
      * Called module names
       01  MOD-ZHO01SXU              PIC X(8) VALUE 'ZHO01SXU'.
       01  MOD-ZHO01GWI              PIC X(8) VALUE 'ZHO01GWI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01SXU-001.
               PERFORM CALL-ZHO01GWI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01SXU-001.
               CALL 'ZHO01SXU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01SXU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01GWI-002.
               CALL 'ZHO01GWI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01GWI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
