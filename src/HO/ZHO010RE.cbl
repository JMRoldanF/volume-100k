      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO010RE'.
      ...
      * Called module names
       01  MOD-ZHO01HMC              PIC X(8) VALUE 'ZHO01HMC'.
       01  MOD-ZHO01JMK              PIC X(8) VALUE 'ZHO01JMK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01HMC-001.
               PERFORM CALL-ZHO01JMK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01HMC-001.
               CALL 'ZHO01HMC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01HMC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01JMK-002.
               CALL 'ZHO01JMK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
