      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO018OE'.
      ...
      * Called module names
       01  MOD-ZBI01QA4              PIC X(8) VALUE 'ZBI01QA4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01QA4-001.
               CALL 'ZBI01QA4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01QA4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
