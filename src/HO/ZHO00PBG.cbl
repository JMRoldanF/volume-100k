      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00PBG'.
      ...
      * Called module names
       01  MOD-ZHO01EUW              PIC X(8) VALUE 'ZHO01EUW'.
       01  MOD-ZHO01DL2              PIC X(8) VALUE 'ZHO01DL2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01EUW-001.
               PERFORM CALL-ZHO01DL2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01EUW-001.
               CALL 'ZHO01EUW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01EUW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01DL2-002.
               CALL 'ZHO01DL2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01DL2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
