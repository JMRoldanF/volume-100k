      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00MHI'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01TT8              PIC X(8) VALUE 'ZHO01TT8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01J7K-001.
               PERFORM CALL-ZHO01TT8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01TT8-002.
               CALL 'ZHO01TT8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
