      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00PYN'.
      ...
      * Called module names
       01  MOD-ZHO01Q4E              PIC X(8) VALUE 'ZHO01Q4E'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01Q4E-001.
               CALL 'ZHO01Q4E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01Q4E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-MODEL-0001.
