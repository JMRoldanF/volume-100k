      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00XRX'.
      ...
      * Called module names
       01  MOD-ZHO01MVU              PIC X(8) VALUE 'ZHO01MVU'.
       01  MOD-ZHO01JTP              PIC X(8) VALUE 'ZHO01JTP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01MVU-001.
               PERFORM CALL-ZHO01JTP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01MVU-001.
               CALL 'ZHO01MVU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01MVU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01JTP-002.
               CALL 'ZHO01JTP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
