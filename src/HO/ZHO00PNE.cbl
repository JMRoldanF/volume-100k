      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00PNE'.
      ...
      * Called module names
       01  MOD-ZHO01DQT              PIC X(8) VALUE 'ZHO01DQT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01DQT-001.
               CALL 'ZHO01DQT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01DQT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
