      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00WV4'.
      ...
      * Called module names
       01  MOD-ZHO01R7C              PIC X(8) VALUE 'ZHO01R7C'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01R7C-001.
               PERFORM CALL-ZHO01NMQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01R7C-001.
               CALL 'ZHO01R7C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01R7C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01NMQ-002.
