      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00SOU'.
      ...
      * Called module names
       01  MOD-ZHO01NM6              PIC X(8) VALUE 'ZHO01NM6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01NM6-001.
               CALL 'ZHO01NM6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01NM6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-BEDROOMS-0001.
