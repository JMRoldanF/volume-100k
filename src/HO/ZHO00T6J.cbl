      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00T6J'.
      ...
      * Called module names
       01  MOD-ZHO01N9H              PIC X(8) VALUE 'ZHO01N9H'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01N9H-001.
               CALL 'ZHO01N9H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01N9H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01H61-002.
