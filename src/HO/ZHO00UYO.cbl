      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00UYO'.
      ...
      * Called module names
       01  MOD-ZHO01H28              PIC X(8) VALUE 'ZHO01H28'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01H28-001.
               CALL 'ZHO01H28' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01H28 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
