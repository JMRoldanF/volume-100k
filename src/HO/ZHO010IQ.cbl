      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO010IQ'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01UYI              PIC X(8) VALUE 'ZHO01UYI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSL01SMM-001.
               PERFORM CALL-ZHO01UYI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01UYI-002.
               CALL 'ZHO01UYI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01UYI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
