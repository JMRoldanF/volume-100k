      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00P88'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01L7T              PIC X(8) VALUE 'ZHO01L7T'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01SR7-001.
               PERFORM CALL-ZHO01L7T-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01L7T-002.
               CALL 'ZHO01L7T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
