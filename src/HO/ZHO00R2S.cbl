      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00R2S'.
      ...
      * Called module names
       01  MOD-ZMT01P3R              PIC X(8) VALUE 'ZMT01P3R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01P3R-002.
               CALL 'ZMT01P3R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01P3R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
