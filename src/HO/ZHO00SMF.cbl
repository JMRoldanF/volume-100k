      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00SMF'.
      ...
      * Called module names
       01  MOD-ZHO01P5I              PIC X(8) VALUE 'ZHO01P5I'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01P5I-001.
               CALL 'ZHO01P5I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01P5I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
