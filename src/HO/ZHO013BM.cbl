      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO013BM'.
      ...
      * Called module names
       01  MOD-ZHO01HTK              PIC X(8) VALUE 'ZHO01HTK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01HTK-001.
               CALL 'ZHO01HTK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01HTK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
