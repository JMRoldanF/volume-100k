      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00TNK'.
      ...
      * Called module names
       01  MOD-ZHO01SEY              PIC X(8) VALUE 'ZHO01SEY'.
       01  MOD-ZHO01TR0              PIC X(8) VALUE 'ZHO01TR0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01SEY-001.
               PERFORM CALL-ZHO01TR0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01SEY-001.
               CALL 'ZHO01SEY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01SEY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01TR0-002.
               CALL 'ZHO01TR0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01TR0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
