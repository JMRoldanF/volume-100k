      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00MZA'.
      ...
      * Called module names
       01  MOD-ZRE01QX7              PIC X(8) VALUE 'ZRE01QX7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01QX7-001.
               CALL 'ZRE01QX7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01QX7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01EKW-002.
