      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01H9G'.
      ...
      * Called module names
       01  MOD-ZHO01PAS              PIC X(8) VALUE 'ZHO01PAS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01PAS-001.
               CALL 'ZHO01PAS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01PAS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-POSTCODE-0001.
