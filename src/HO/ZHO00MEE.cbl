      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00MEE'.
      ...
      * Called module names
       01  MOD-ZHO01U4E              PIC X(8) VALUE 'ZHO01U4E'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01U4E-001.
               PERFORM CALL-ZHO01JR9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01U4E-001.
               CALL 'ZHO01U4E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01U4E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01JR9-002.
