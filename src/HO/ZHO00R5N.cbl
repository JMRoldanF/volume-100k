      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00R5N'.
      ...
      * Called module names
       01  MOD-ZHO01HDJ              PIC X(8) VALUE 'ZHO01HDJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01HDJ-001.
               CALL 'ZHO01HDJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01HDJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
