      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00XLS'.
      ...
      * Called module names
       01  MOD-ZHO01PHY              PIC X(8) VALUE 'ZHO01PHY'.
       01  MOD-ZHO01EWK              PIC X(8) VALUE 'ZHO01EWK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01PHY-001.
               PERFORM CALL-ZHO01EWK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01PHY-001.
               CALL 'ZHO01PHY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01PHY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01EWK-002.
               CALL 'ZHO01EWK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01EWK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
