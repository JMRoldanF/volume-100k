      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00SGF'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01JY0              PIC X(8) VALUE 'ZHO01JY0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01TC7-001.
               PERFORM CALL-ZHO01JY0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01JY0-002.
               CALL 'ZHO01JY0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
