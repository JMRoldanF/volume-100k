      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00XTK'.
      ...
      * Called module names
       01  MOD-ZHO01HEK              PIC X(8) VALUE 'ZHO01HEK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01HEK-001.
               CALL 'ZHO01HEK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01HEK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
