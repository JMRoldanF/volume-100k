      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00SAO'.
      ...
      * Called module names
       01  MOD-ZHO01GYG              PIC X(8) VALUE 'ZHO01GYG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01GYG-001.
               CALL 'ZHO01GYG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01GYG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
