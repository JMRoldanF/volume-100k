      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00OG2'.
      ...
      * Called module names
       01  MOD-ZHO01MD6              PIC X(8) VALUE 'ZHO01MD6'.
       01  MOD-ZCU01K9O              PIC X(8) VALUE 'ZCU01K9O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01MD6-001.
               CALL 'ZHO01MD6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01MD6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01K9O-002.
               CALL 'ZCU01K9O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01K9O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
