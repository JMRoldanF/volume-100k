      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO018ES'.
      ...
      * Called module names
       01  MOD-ZHO01JV4              PIC X(8) VALUE 'ZHO01JV4'.
       01  MOD-ZFL01DGZ              PIC X(8) VALUE 'ZFL01DGZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01JV4-001.
               PERFORM CALL-ZFL01DGZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01JV4-001.
               CALL 'ZHO01JV4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01JV4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFL01DGZ-002.
               CALL 'ZFL01DGZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01DGZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
