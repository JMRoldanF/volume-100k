      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00NDI'.
      ...
      * Called module names
       ...
       01  MOD-ZSL01O4J              PIC X(8) VALUE 'ZSL01O4J'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSL01O4J-002.
               CALL 'ZSL01O4J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
