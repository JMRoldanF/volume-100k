      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00T76'.
      ...
      * Called module names
       01  MOD-ZPA01LL1              PIC X(8) VALUE 'ZPA01LL1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01EWU-001.
               PERFORM CALL-ZPA01LL1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01LL1-002.
               CALL 'ZPA01LL1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01LL1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
