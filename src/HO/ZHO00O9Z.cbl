      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00O9Z'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM REFRESH-MANAGED-FUND-0031.
               ...
               PERFORM NORMALISE-CC-RATING-0067.
               ...
               PERFORM RECONCILE-EQUITIES-0088.
               ...
               PERFORM FORMAT-CC-RATING-0109.
               PERFORM RESOLVE-BEDROOMS-0110.
               PERFORM SQL-ACCESS-0111.
               PERFORM VALIDATE-WITH-PROFITS-0112.
               ...
               PERFORM RECONCILE-TAX-BAND-0131.
               PERFORM SQL-ACCESS-0132.
               PERFORM FORMAT-BROKER-ID-0133.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZHO01JRK-001.
               MOVE 'ZHO01JRK' TO WS-SUBNAME-7
               CALL WS-SUBNAME-7 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01JRK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
