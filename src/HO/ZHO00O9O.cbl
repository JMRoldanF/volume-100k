      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00O9O'.
      ...
      * Called module names
       01  MOD-ZPA01UDZ              PIC X(8) VALUE 'ZPA01UDZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01UDZ-002.
               CALL 'ZPA01UDZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01UDZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
