      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00UB1'.
      ...
      * Called module names
       01  MOD-ZHO01QG2              PIC X(8) VALUE 'ZHO01QG2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01QG2-001.
               CALL 'ZHO01QG2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01QG2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
