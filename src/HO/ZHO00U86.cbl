      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00U86'.
      ...
      * Called module names
       ...
       01  MOD-ZPR01HBX              PIC X(8) VALUE 'ZPR01HBX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR01HBX-002.
               CALL 'ZPR01HBX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01HBX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
