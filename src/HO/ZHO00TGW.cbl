      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00TGW'.
      ...
      * Called module names
       01  MOD-ZHO01P4W              PIC X(8) VALUE 'ZHO01P4W'.
       01  MOD-ZHO01T2U              PIC X(8) VALUE 'ZHO01T2U'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01P4W-001.
               PERFORM CALL-ZHO01T2U-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01P4W-001.
               CALL 'ZHO01P4W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01P4W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01T2U-002.
               CALL 'ZHO01T2U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01T2U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-EXCESS-0001.
