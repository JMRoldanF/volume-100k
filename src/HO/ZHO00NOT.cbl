      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00NOT'.
      ...
      * Called module names
       01  MOD-ZHO01CYJ              PIC X(8) VALUE 'ZHO01CYJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPR01LGL-001.
               PERFORM CALL-ZHO01CYJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01CYJ-002.
               CALL 'ZHO01CYJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01CYJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       NORMALISE-TERM-0001.
