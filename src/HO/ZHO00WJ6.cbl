      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00WJ6'.
      ...
      * Called module names
       01  MOD-ZHO01IH6              PIC X(8) VALUE 'ZHO01IH6'.
       01  MOD-ZHO01E6Q              PIC X(8) VALUE 'ZHO01E6Q'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01IH6-001.
               PERFORM CALL-ZHO01E6Q-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01IH6-001.
               CALL 'ZHO01IH6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01IH6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01E6Q-002.
               CALL 'ZHO01E6Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01E6Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
