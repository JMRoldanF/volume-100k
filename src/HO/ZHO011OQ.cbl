      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO011OQ'.
      ...
      * Called module names
       01  MOD-ZHO01E5M              PIC X(8) VALUE 'ZHO01E5M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01E5M-001.
               CALL 'ZHO01E5M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01E5M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
