      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00SFI'.
      ...
      * Called module names
       01  MOD-ZSL01SNB              PIC X(8) VALUE 'ZSL01SNB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSL01SNB-001.
               PERFORM CALL-ZHO01UY3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSL01SNB-001.
               CALL 'ZSL01SNB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSL01SNB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01UY3-002.
