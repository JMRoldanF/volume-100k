      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00ZJD'.
      ...
      * Called module names
       01  MOD-ZHO01IAP              PIC X(8) VALUE 'ZHO01IAP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01IAP-001.
               CALL 'ZHO01IAP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01IAP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
