      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO011IW'.
      ...
      * Called module names
       01  MOD-ZEN01D6X              PIC X(8) VALUE 'ZEN01D6X'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01D6X-001.
               CALL 'ZEN01D6X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01D6X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
