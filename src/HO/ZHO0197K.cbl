      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO0197K'.
      ...
      * Called module names
       01  MOD-ZHO01JUM              PIC X(8) VALUE 'ZHO01JUM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01JUM-001.
               CALL 'ZHO01JUM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01JUM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
