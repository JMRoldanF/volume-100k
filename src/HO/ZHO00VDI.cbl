      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00VDI'.
      ...
      * Called module names
       01  MOD-ZHO01U8S              PIC X(8) VALUE 'ZHO01U8S'.
       01  MOD-ZHO01NKS              PIC X(8) VALUE 'ZHO01NKS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01U8S-001.
               PERFORM CALL-ZHO01NKS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01U8S-001.
               CALL 'ZHO01U8S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01U8S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01NKS-002.
               CALL 'ZHO01NKS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01NKS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
