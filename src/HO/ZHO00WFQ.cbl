      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00WFQ'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01PC2              PIC X(8) VALUE 'ZHO01PC2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSL01IHV-001.
               PERFORM CALL-ZHO01PC2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01PC2-002.
               CALL 'ZHO01PC2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01PC2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
