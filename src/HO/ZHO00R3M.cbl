      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00R3M'.
      ...
      * Called module names
       01  MOD-ZHO01H2M              PIC X(8) VALUE 'ZHO01H2M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01H2M-001.
               CALL 'ZHO01H2M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01H2M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
