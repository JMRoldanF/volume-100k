      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00V7O'.
      ...
      * Called module names
       01  MOD-ZHO01G50              PIC X(8) VALUE 'ZHO01G50'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01G50-001.
               CALL 'ZHO01G50' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01G50 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01F8I-002.
               MOVE 'ZHO01F8I' TO WS-SUBNAME-2
