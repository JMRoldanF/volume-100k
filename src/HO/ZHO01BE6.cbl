      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01BE6'.
      ...
      * Called module names
       01  MOD-ZHO01QW8              PIC X(8) VALUE 'ZHO01QW8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01QW8-001.
               CALL 'ZHO01QW8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01QW8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
