      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00U4Y'.
      ...
      * Called module names
       01  MOD-ZHO01HWI              PIC X(8) VALUE 'ZHO01HWI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01HWI-001.
               PERFORM CALL-ZHO01FJY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01HWI-001.
               CALL 'ZHO01HWI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01HWI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01FJY-002.
