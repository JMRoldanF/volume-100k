      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00QPE'.
      ...
      * Called module names
       01  MOD-ZHO01K8P              PIC X(8) VALUE 'ZHO01K8P'.
       01  MOD-ZHO01GR9              PIC X(8) VALUE 'ZHO01GR9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01K8P-001.
               PERFORM CALL-ZHO01GR9-002.
               ...
               PERFORM RECONCILE-HOUSE-TYPE-0068.
               ...
               PERFORM NORMALISE-TAX-BAND-0088.
               ...
               PERFORM COMPUTE-WITH-PROFITS-0100.
               ...
               PERFORM APPLY-AGENT-CODE-0137.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZHO01K8P-001.
               CALL 'ZHO01K8P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01K8P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01GR9-002.
               CALL 'ZHO01GR9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01GR9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
