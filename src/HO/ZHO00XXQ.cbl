      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00XXQ'.
      ...
      * Called module names
       01  MOD-ZHO01HBS              PIC X(8) VALUE 'ZHO01HBS'.
       01  MOD-ZHO01GBY              PIC X(8) VALUE 'ZHO01GBY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01HBS-001.
               CALL 'ZHO01HBS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01HBS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01GBY-002.
               CALL 'ZHO01GBY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01GBY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
