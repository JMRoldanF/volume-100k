      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO010BA'.
      ...
      * Called module names
       01  MOD-ZHO01FNI              PIC X(8) VALUE 'ZHO01FNI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01FNI-001.
               PERFORM CALL-ZHO01E4I-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01FNI-001.
               CALL 'ZHO01FNI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01FNI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01E4I-002.
