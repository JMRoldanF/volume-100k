      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00VLK'.
      ...
      * Called module names
       01  MOD-ZHO01D6W              PIC X(8) VALUE 'ZHO01D6W'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01D6W-002.
               CALL 'ZHO01D6W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01D6W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
