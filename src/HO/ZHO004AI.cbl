      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO004AI'.
      ...
      * Called module names
       ...
       01  MOD-ZAG005SU              PIC X(8) VALUE 'ZAG005SU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO00L6K-001.
               PERFORM CALL-ZHO00D5Y-002.
               PERFORM CALL-ZHO00C3M-003.
               PERFORM CALL-ZAG005SU-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00L6K-001.
               MOVE 'ZHO00L6K' TO WS-PROGNAME-1
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO00L6K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO00D5Y-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG005SU-004.
               EXEC CICS XCTL PROGRAM('ZAG005SU')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG005SU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-005.
