      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00XPE'.
      ...
      * Called module names
       01  MOD-ZMT01USR              PIC X(8) VALUE 'ZMT01USR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01USR-001.
               CALL 'ZMT01USR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01USR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
