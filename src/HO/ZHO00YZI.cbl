      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00YZI'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01MHA              PIC X(8) VALUE 'ZUW01MHA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01MHA-002.
               CALL 'ZUW01MHA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
