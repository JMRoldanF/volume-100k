      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO014YS'.
      ...
      * Called module names
       01  MOD-ZHO01FT2              PIC X(8) VALUE 'ZHO01FT2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01FT2-001.
               CALL 'ZHO01FT2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01FT2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-COLOUR-0001.
