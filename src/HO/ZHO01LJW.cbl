      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01LJW'.
      ...
      * Called module names
       01  MOD-ZHO01FPR              PIC X(8) VALUE 'ZHO01FPR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01FPR-001.
               CALL 'ZHO01FPR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01FPR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
