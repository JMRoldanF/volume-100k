      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00SU4'.
      ...
      * Called module names
       01  MOD-ZHO01E66              PIC X(8) VALUE 'ZHO01E66'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01E66-001.
               CALL 'ZHO01E66' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01E66 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
