      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01HIV'.
      ...
      * Called module names
       01  MOD-ZHO01KI5              PIC X(8) VALUE 'ZHO01KI5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01KI5-001.
               CALL 'ZHO01KI5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01KI5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
