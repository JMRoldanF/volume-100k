      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO016K0'.
      ...
      * Called module names
       01  MOD-ZHO01JRA              PIC X(8) VALUE 'ZHO01JRA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01JRA-001.
               CALL 'ZHO01JRA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01JRA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
