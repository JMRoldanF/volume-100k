      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO010ZM'.
      ...
      * Called module names
       01  MOD-ZHO01TG0              PIC X(8) VALUE 'ZHO01TG0'.
       01  MOD-ZHO01OH8              PIC X(8) VALUE 'ZHO01OH8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01TG0-001.
               PERFORM CALL-ZHO01OH8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01TG0-001.
               CALL 'ZHO01TG0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01TG0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01OH8-002.
               CALL 'ZHO01OH8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01OH8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
