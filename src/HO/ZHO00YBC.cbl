      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00YBC'.
      ...
      * Called module names
       01  MOD-ZHO01MIQ              PIC X(8) VALUE 'ZHO01MIQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01MIQ-001.
               CALL 'ZHO01MIQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01MIQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
