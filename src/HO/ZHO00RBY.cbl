      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00RBY'.
      ...
      * Called module names
       01  MOD-ZRE01PG5              PIC X(8) VALUE 'ZRE01PG5'.
       01  MOD-ZHO01NZ8              PIC X(8) VALUE 'ZHO01NZ8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01PG5-001.
               PERFORM CALL-ZHO01NZ8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01PG5-001.
               CALL 'ZRE01PG5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01PG5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01NZ8-002.
               CALL 'ZHO01NZ8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
