      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO010AQ'.
      ...
      * Called module names
       01  MOD-ZHO01MDQ              PIC X(8) VALUE 'ZHO01MDQ'.
       01  MOD-ZHO01IYY              PIC X(8) VALUE 'ZHO01IYY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01MDQ-001.
               PERFORM CALL-ZHO01IYY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01MDQ-001.
               CALL 'ZHO01MDQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01MDQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01IYY-002.
               CALL 'ZHO01IYY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01IYY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
