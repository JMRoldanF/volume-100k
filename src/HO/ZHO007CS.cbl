      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO007CS'.
      ...
      * Called module names
       01  MOD-ZHO00UHU              PIC X(8) VALUE 'ZHO00UHU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00UHU-001.
               EXEC CICS LINK PROGRAM('ZHO00UHU')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO00UHU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
