      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO0092Q'.
      ...
      * Called module names
       ...
       01  MOD-ZHO00T76              PIC X(8) VALUE 'ZHO00T76'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO010F6-002.
               PERFORM CALL-ZHO00T76-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00T76-003.
               EXEC CICS LINK PROGRAM('ZHO00T76')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO00T76 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-004.
