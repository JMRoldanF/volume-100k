      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO011BY'.
      ...
      * Called module names
       01  MOD-ZEN01DW7              PIC X(8) VALUE 'ZEN01DW7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01DW7-001.
               PERFORM CALL-ZHO01GDM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01DW7-001.
               CALL 'ZEN01DW7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01DW7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01GDM-002.
