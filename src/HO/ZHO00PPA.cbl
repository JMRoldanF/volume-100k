      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00PPA'.
      ...
      * Called module names
       01  MOD-ZHO01E3U              PIC X(8) VALUE 'ZHO01E3U'.
       01  MOD-ZHO01LAU              PIC X(8) VALUE 'ZHO01LAU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01E3U-001.
               PERFORM CALL-ZHO01LAU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01E3U-001.
               CALL 'ZHO01E3U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01E3U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01LAU-002.
               CALL 'ZHO01LAU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01LAU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
