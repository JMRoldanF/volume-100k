      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00LVA'.
      ...
      * Called module names
       01  MOD-ZHO01JHU              PIC X(8) VALUE 'ZHO01JHU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01JHU-001.
               CALL 'ZHO01JHU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01JHU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
