      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00Y3K'.
      ...
      * Called module names
       01  MOD-ZAG01OFS              PIC X(8) VALUE 'ZAG01OFS'.
       01  MOD-ZHO01I9Y              PIC X(8) VALUE 'ZHO01I9Y'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01OFS-001.
               PERFORM CALL-ZHO01I9Y-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01OFS-001.
               CALL 'ZAG01OFS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01OFS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01I9Y-002.
               CALL 'ZHO01I9Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01I9Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-COLOUR-0001.
