      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00QDS'.
      ...
      * Called module names
       01  MOD-ZHO01L3M              PIC X(8) VALUE 'ZHO01L3M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01L3M-001.
               CALL 'ZHO01L3M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01L3M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
