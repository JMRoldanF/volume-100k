      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00RNW'.
      ...
      * Called module names
       01  MOD-ZHO01L9Q              PIC X(8) VALUE 'ZHO01L9Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01L9Q-001.
               CALL 'ZHO01L9Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01L9Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01M4A-002.
