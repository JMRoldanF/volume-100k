      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00G7O'.
      ...
      * Called module names
       01  MOD-ZHO00OB2              PIC X(8) VALUE 'ZHO00OB2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00OB2-001.
               EXEC CICS LINK PROGRAM('ZHO00OB2')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO00OB2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-MODEL-0001.
