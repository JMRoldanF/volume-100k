      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00Z3L'.
      ...
      * Called module names
       01  MOD-ZHO01U8Y              PIC X(8) VALUE 'ZHO01U8Y'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01U8Y-001.
               CALL 'ZHO01U8Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01U8Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
