      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00Z4A'.
      ...
      * Called module names
       01  MOD-ZHO01RT6              PIC X(8) VALUE 'ZHO01RT6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01RT6-001.
               CALL 'ZHO01RT6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01RT6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
