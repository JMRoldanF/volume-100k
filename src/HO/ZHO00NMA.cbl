      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00NMA'.
      ...
      * Called module names
       01  MOD-ZPR01UK2              PIC X(8) VALUE 'ZPR01UK2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR01UK2-001.
               CALL 'ZPR01UK2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01UK2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
