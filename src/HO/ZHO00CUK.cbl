      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00CUK'.
      ...
      * Called module names
       01  MOD-ZHO00W50              PIC X(8) VALUE 'ZHO00W50'.
       01  MOD-ZHO010BK              PIC X(8) VALUE 'ZHO010BK'.
       01  MOD-ZHO00LVK              PIC X(8) VALUE 'ZHO00LVK'.
       01  MOD-ZHO0179A              PIC X(8) VALUE 'ZHO0179A'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO00W50-001.
               PERFORM CALL-ZHO010BK-002.
               PERFORM CALL-ZHO0179A-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00W50-001.
               EXEC CICS LINK PROGRAM('ZHO00W50')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO00W50 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO010BK-002.
               EXEC CICS LINK PROGRAM('ZHO010BK')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO010BK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO00LVK-003.
               EXEC CICS LINK PROGRAM('ZHO00LVK')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO00LVK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0179A-004.
               EXEC CICS LINK PROGRAM('ZHO0179A')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO0179A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-005.
