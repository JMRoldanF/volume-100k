      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00LMY'.
      ...
      * Called module names
       01  MOD-ZHO01DX0              PIC X(8) VALUE 'ZHO01DX0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01DX0-001.
               CALL 'ZHO01DX0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01DX0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
