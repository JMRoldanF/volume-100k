      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00QXI'.
      ...
      * Called module names
       01  MOD-ZBI01F6Y              PIC X(8) VALUE 'ZBI01F6Y'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01F6Y-001.
               PERFORM CALL-ZHO01K4W-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01F6Y-001.
               CALL 'ZBI01F6Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
