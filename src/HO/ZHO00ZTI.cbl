      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00ZTI'.
      ...
      * Called module names
       01  MOD-ZHO01GLE              PIC X(8) VALUE 'ZHO01GLE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01GLE-001.
               CALL 'ZHO01GLE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01GLE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01TK2-002.
