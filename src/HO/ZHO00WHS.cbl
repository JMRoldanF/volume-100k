      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00WHS'.
      ...
      * Called module names
       01  MOD-ZHO01R3Q              PIC X(8) VALUE 'ZHO01R3Q'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01R3Q-001.
               PERFORM CALL-ZHO01DBC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01R3Q-001.
               CALL 'ZHO01R3Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01R3Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01DBC-002.
               MOVE 'ZHO01DBC' TO WS-SUBNAME-2
