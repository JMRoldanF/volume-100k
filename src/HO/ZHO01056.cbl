      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01056'.
      ...
      * Called module names
       01  MOD-ZPA01R5V              PIC X(8) VALUE 'ZPA01R5V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01R5V-001.
               CALL 'ZPA01R5V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01R5V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-EXCESS-0001.
