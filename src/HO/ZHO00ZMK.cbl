      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00ZMK'.
      ...
      * Called module names
       01  MOD-ZHO01SBW              PIC X(8) VALUE 'ZHO01SBW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01SBW-001.
               CALL 'ZHO01SBW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01SBW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01N3K-002.
