      ...
      * Called module names
       01  MOD-ZHO01DKM              PIC X(8) VALUE 'ZHO01DKM'.
       01  MOD-ZHO01DDD              PIC X(8) VALUE 'ZHO01DDD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01DKM-001.
               PERFORM CALL-ZHO01DDD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01DKM-001.
               CALL 'ZHO01DKM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01DKM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01DDD-002.
               CALL 'ZHO01DDD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01DDD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
