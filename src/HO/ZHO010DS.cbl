      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO010DS'.
      ...
      * Called module names
       01  MOD-ZHO01T3O              PIC X(8) VALUE 'ZHO01T3O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01T3O-001.
               CALL 'ZHO01T3O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01T3O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
