      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO0148O'.
      ...
      * Called module names
       01  MOD-ZHO01SOY              PIC X(8) VALUE 'ZHO01SOY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01SOY-001.
               CALL 'ZHO01SOY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01SOY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
