      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00YSU'.
      ...
      * Called module names
       01  MOD-ZHO01MBS              PIC X(8) VALUE 'ZHO01MBS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01MBS-001.
               CALL 'ZHO01MBS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01MBS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01RUE-002.
               MOVE 'ZHO01RUE' TO WS-SUBNAME-6
