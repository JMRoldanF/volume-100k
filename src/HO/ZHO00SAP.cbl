      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00SAP'.
      ...
      * Called module names
       01  MOD-ZHO01LGM              PIC X(8) VALUE 'ZHO01LGM'.
       01  MOD-ZHO01H7N              PIC X(8) VALUE 'ZHO01H7N'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01LGM-001.
               PERFORM CALL-ZHO01H7N-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01LGM-001.
               CALL 'ZHO01LGM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01LGM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01H7N-002.
               CALL 'ZHO01H7N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01H7N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
