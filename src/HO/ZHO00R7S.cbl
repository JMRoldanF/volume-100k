      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00R7S'.
      ...
      * Called module names
       01  MOD-ZHO01FAQ              PIC X(8) VALUE 'ZHO01FAQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01FAQ-002.
               CALL 'ZHO01FAQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
