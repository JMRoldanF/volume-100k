      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO0117S'.
      ...
      * Called module names
       01  MOD-ZHO01PGK              PIC X(8) VALUE 'ZHO01PGK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01PGK-001.
               PERFORM CALL-ZHO01JHA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01PGK-001.
               CALL 'ZHO01PGK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01PGK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01JHA-002.
