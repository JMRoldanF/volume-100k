      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00R64'.
      ...
      * Called module names
       01  MOD-ZHO01MBI              PIC X(8) VALUE 'ZHO01MBI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01E5W-001.
               PERFORM CALL-ZHO01MBI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01MBI-002.
               CALL 'ZHO01MBI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01MBI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
