      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00WC8'.
      ...
      * Called module names
       01  MOD-ZHO01K0Q              PIC X(8) VALUE 'ZHO01K0Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01K0Q-001.
               CALL 'ZHO01K0Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01K0Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
