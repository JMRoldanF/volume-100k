      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO0007U'.
      ...
      * Called module names
       ...
       01  MOD-ZHO00I1I              PIC X(8) VALUE 'ZHO00I1I'.
       01  MOD-ZHO00KUC              PIC X(8) VALUE 'ZHO00KUC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO00I1I-002.
               PERFORM CALL-ZHO00KUC-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00I1I-002.
               EXEC CICS LINK PROGRAM('ZHO00I1I')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO00I1I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO00KUC-003.
               EXEC CICS LINK PROGRAM('ZHO00KUC')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO00KUC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-004.
