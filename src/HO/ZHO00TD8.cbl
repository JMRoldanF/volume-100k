      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00TD8'.
      ...
      * Called module names
       01  MOD-ZHO01M9E              PIC X(8) VALUE 'ZHO01M9E'.
       01  MOD-ZHO01NW6              PIC X(8) VALUE 'ZHO01NW6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01M9E-001.
               PERFORM CALL-ZHO01NW6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01M9E-001.
               CALL 'ZHO01M9E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01NW6-002.
               CALL 'ZHO01NW6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01NW6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
