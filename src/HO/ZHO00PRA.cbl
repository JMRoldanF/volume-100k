      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00PRA'.
      ...
      * Called module names
       01  MOD-ZCU01QVG              PIC X(8) VALUE 'ZCU01QVG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01QVG-001.
               CALL 'ZCU01QVG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01QVG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
