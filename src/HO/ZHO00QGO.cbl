      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00QGO'.
      ...
      * Called module names
       ...
       01  MOD-ZFL01MLX              PIC X(8) VALUE 'ZFL01MLX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFL01IWM-001.
               PERFORM CALL-ZFL01MLX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01MLX-002.
               CALL 'ZFL01MLX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01MLX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
