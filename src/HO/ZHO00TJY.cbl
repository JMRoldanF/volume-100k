      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00TJY'.
      ...
      * Called module names
       01  MOD-ZHO01RA4              PIC X(8) VALUE 'ZHO01RA4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01KV0-001.
               PERFORM CALL-ZHO01RA4-002.
               PERFORM CALL-ZCU0255O-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZHO01KV0-001.
               MOVE 'ZHO01KV0' TO WS-SUBNAME-2
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01RA4-002.
               CALL 'ZHO01RA4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
