      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00WNI'.
      ...
      * Called module names
       01  MOD-ZHO01DK0              PIC X(8) VALUE 'ZHO01DK0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01DK0-001.
               CALL 'ZHO01DK0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01DK0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
