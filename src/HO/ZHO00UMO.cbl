      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00UMO'.
      ...
      * Called module names
       01  MOD-ZFL01S06              PIC X(8) VALUE 'ZFL01S06'.
       01  MOD-ZHO01M6T              PIC X(8) VALUE 'ZHO01M6T'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFL01S06-001.
               PERFORM CALL-ZHO01M6T-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01S06-001.
               CALL 'ZFL01S06' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01S06 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01M6T-002.
               CALL 'ZHO01M6T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
