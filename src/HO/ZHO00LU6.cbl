      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00LU6'.
      ...
      * Called module names
       01  MOD-ZUW01SCY              PIC X(8) VALUE 'ZUW01SCY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01SCY-001.
               CALL 'ZUW01SCY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01SCY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
