      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00OSA'.
      ...
      * Called module names
       01  MOD-ZHO01IBC              PIC X(8) VALUE 'ZHO01IBC'.
       01  MOD-ZHO01RQI              PIC X(8) VALUE 'ZHO01RQI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01IBC-001.
               PERFORM CALL-ZHO01RQI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01IBC-001.
               CALL 'ZHO01IBC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01IBC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01RQI-002.
               CALL 'ZHO01RQI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01RQI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-VALUE-0001.
