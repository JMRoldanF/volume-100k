      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01MCW'.
      ...
      * Called module names
       01  MOD-ZHO01FW4              PIC X(8) VALUE 'ZHO01FW4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01FW4-001.
               CALL 'ZHO01FW4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01FW4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-TERM-0001.
