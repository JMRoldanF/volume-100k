      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00ZHU'.
      ...
      * Called module names
       01  MOD-ZHO01DWG              PIC X(8) VALUE 'ZHO01DWG'.
       01  MOD-ZMT01NLB              PIC X(8) VALUE 'ZMT01NLB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01DWG-001.
               PERFORM CALL-ZMT01NLB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01DWG-001.
               CALL 'ZHO01DWG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01DWG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01NLB-002.
               CALL 'ZMT01NLB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01NLB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
