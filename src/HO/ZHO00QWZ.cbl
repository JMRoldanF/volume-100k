      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00QWZ'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01IQR              PIC X(8) VALUE 'ZHO01IQR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01IQR-002.
               CALL 'ZHO01IQR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01IQR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
