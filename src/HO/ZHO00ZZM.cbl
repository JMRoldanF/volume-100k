      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00ZZM'.
      ...
      * Called module names
       01  MOD-ZHO01LIC              PIC X(8) VALUE 'ZHO01LIC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01LIC-001.
               CALL 'ZHO01LIC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01LIC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
