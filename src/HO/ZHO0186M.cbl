      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO0186M'.
      ...
      * Called module names
       01  MOD-ZUW01DII              PIC X(8) VALUE 'ZUW01DII'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01DII-001.
               CALL 'ZUW01DII' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01DII FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01P1K-002.
