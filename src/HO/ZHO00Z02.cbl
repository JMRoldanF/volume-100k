      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00Z02'.
      ...
      * Called module names
       01  MOD-ZMT01MNF              PIC X(8) VALUE 'ZMT01MNF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01MNF-001.
               PERFORM CALL-ZHO01OWU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01MNF-001.
               CALL 'ZMT01MNF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01MNF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01OWU-002.
               MOVE 'ZHO01OWU' TO WS-SUBNAME-7
