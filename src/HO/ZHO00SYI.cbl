      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00SYI'.
      ...
      * Called module names
       01  MOD-ZHO01O7V              PIC X(8) VALUE 'ZHO01O7V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01O7V-001.
               CALL 'ZHO01O7V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01O7V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01FXU-002.
