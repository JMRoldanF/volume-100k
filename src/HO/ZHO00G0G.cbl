      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00G0G'.
      ...
      * Called module names
       01  MOD-ZHO00WJG              PIC X(8) VALUE 'ZHO00WJG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00WJG-001.
               EXEC CICS LINK PROGRAM('ZHO00WJG')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO00WJG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
