      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00O15'.
      ...
      * Called module names
       01  MOD-ZHO01LD4              PIC X(8) VALUE 'ZHO01LD4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01LD4-001.
               CALL 'ZHO01LD4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01LD4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
