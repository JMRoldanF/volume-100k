      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00LSU'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01SCK              PIC X(8) VALUE 'ZHO01SCK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01SCK-002.
               CALL 'ZHO01SCK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01SCK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
