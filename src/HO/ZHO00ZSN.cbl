      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00ZSN'.
      ...
      * Called module names
       01  MOD-ZHO01P1M              PIC X(8) VALUE 'ZHO01P1M'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSL01SXZ-001.
               PERFORM CALL-ZHO01P1M-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01P1M-002.
               CALL 'ZHO01P1M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01P1M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
