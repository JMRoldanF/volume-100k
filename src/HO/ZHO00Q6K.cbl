      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00Q6K'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01N1W              PIC X(8) VALUE 'ZHO01N1W'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01D80-001.
               PERFORM CALL-ZHO01N1W-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01N1W-002.
               CALL 'ZHO01N1W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01N1W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
