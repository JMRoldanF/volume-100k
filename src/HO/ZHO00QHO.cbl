      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00QHO'.
      ...
      * Called module names
       01  MOD-ZHO01UA6              PIC X(8) VALUE 'ZHO01UA6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01UA6-001.
               CALL 'ZHO01UA6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01UA6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
