      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00SM0'.
      ...
      * Called module names
       01  MOD-ZHO01UAL              PIC X(8) VALUE 'ZHO01UAL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01UAL-001.
               PERFORM CALL-ZSL01KBH-002.
               ...
               PERFORM RECONCILE-BROKER-ID-0109.
               ...
               PERFORM CHECK-PREMIUM-0119.
               PERFORM SQL-ACCESS-0120.
               PERFORM RESOLVE-EXCESS-0121.
               PERFORM RESOLVE-WITH-PROFITS-0122.
               PERFORM SQL-ACCESS-0123.
               PERFORM APPLY-POSTCODE-0125.
               PERFORM SQL-ACCESS-0126.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZHO01UAL-001.
               CALL 'ZHO01UAL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01UAL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSL01KBH-002.
               MOVE 'ZSL01KBH' TO WS-SUBNAME-4
               CALL WS-SUBNAME-4 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSL01KBH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-PREMIUM-0001.
