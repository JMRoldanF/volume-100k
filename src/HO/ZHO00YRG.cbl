      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00YRG'.
      ...
      * Called module names
       01  MOD-ZHO01DQC              PIC X(8) VALUE 'ZHO01DQC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01DQC-001.
               CALL 'ZHO01DQC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01DQC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-EXCESS-0001.
