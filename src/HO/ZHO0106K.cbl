      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO0106K'.
      ...
      * Called module names
       01  MOD-ZHO01PQU              PIC X(8) VALUE 'ZHO01PQU'.
       01  MOD-ZHO01PQK              PIC X(8) VALUE 'ZHO01PQK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01PQU-001.
               CALL 'ZHO01PQU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01PQU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01PQK-002.
               CALL 'ZHO01PQK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01PQK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
