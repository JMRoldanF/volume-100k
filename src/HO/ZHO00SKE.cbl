      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00SKE'.
      ...
      * Called module names
       01  MOD-ZCL01RH5              PIC X(8) VALUE 'ZCL01RH5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01RH5-001.
               CALL 'ZCL01RH5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01RH5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
