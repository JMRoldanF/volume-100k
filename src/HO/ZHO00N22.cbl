      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00N22'.
      ...
      * Called module names
       01  MOD-ZHO01GSW              PIC X(8) VALUE 'ZHO01GSW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01GSW-001.
               PERFORM CALL-ZHO01EZM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01GSW-001.
               CALL 'ZHO01GSW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01GSW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01EZM-002.
