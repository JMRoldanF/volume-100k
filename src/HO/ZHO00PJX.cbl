      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00PJX'.
      ...
      * Called module names
       01  MOD-ZPR01DRJ              PIC X(8) VALUE 'ZPR01DRJ'.
       01  MOD-ZHO01JNT              PIC X(8) VALUE 'ZHO01JNT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPR01DRJ-001.
               PERFORM CALL-ZHO01JNT-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR01DRJ-001.
               CALL 'ZPR01DRJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01DRJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01JNT-002.
               CALL 'ZHO01JNT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01JNT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
