      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01TN4'.
      ...
      * Called module names
       01  MOD-ZHO01M5E              PIC X(8) VALUE 'ZHO01M5E'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01M5E-001.
               CALL 'ZHO01M5E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01M5E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
