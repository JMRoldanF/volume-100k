      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00VTT'.
      ...
      * Called module names
       01  MOD-ZHO01TFY              PIC X(8) VALUE 'ZHO01TFY'.
       01  MOD-ZHO01IZG              PIC X(8) VALUE 'ZHO01IZG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01TFY-001.
               CALL 'ZHO01TFY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01TFY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01IZG-002.
               CALL 'ZHO01IZG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01IZG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
