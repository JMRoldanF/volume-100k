      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO016NF'.
      ...
      * Called module names
       01  MOD-ZHO01FUE              PIC X(8) VALUE 'ZHO01FUE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01FUE-002.
               CALL 'ZHO01FUE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01FUE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
