      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00XKD'.
      ...
      * Called module names
       01  MOD-ZPR01OJA              PIC X(8) VALUE 'ZPR01OJA'.
       01  MOD-ZHO01O92              PIC X(8) VALUE 'ZHO01O92'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPR01OJA-001.
               PERFORM CALL-ZHO01O92-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR01OJA-001.
               CALL 'ZPR01OJA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01OJA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01O92-002.
               CALL 'ZHO01O92' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01O92 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
