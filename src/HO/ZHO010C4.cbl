      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO010C4'.
      ...
      * Called module names
       01  MOD-ZHO01RXG              PIC X(8) VALUE 'ZHO01RXG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01RXG-001.
               CALL 'ZHO01RXG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01RXG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
