      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00OC6'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01JES              PIC X(8) VALUE 'ZHO01JES'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01UWE-001.
               PERFORM CALL-ZHO01JES-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01JES-002.
               CALL 'ZHO01JES' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01JES FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
