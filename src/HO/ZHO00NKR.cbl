      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00NKR'.
      ...
      * Called module names
       01  MOD-ZHO01OJ1              PIC X(8) VALUE 'ZHO01OJ1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01OJ1-001.
               CALL 'ZHO01OJ1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01OJ1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
