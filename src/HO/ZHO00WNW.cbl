      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00WNW'.
      ...
      * Called module names
       01  MOD-ZHO01LCI              PIC X(8) VALUE 'ZHO01LCI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01LCI-001.
               PERFORM CALL-ZHO01ONE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01LCI-001.
               CALL 'ZHO01LCI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01LCI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01ONE-002.
