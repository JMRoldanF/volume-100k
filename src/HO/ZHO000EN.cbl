      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO000EN'.
      ...
      * Called module names
       01  MOD-ZHO00HMU              PIC X(8) VALUE 'ZHO00HMU'.
       01  MOD-ZHO0099L              PIC X(8) VALUE 'ZHO0099L'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO00HMU-001.
               PERFORM CALL-ZHO0099L-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00HMU-001.
               EXEC CICS LINK PROGRAM('ZHO00HMU')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO00HMU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0099L-002.
               EXEC CICS LINK PROGRAM('ZHO0099L')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO0099L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
