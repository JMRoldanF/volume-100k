      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO010YG'.
      ...
      * Called module names
       01  MOD-ZHO01NUI              PIC X(8) VALUE 'ZHO01NUI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01NUI-001.
               CALL 'ZHO01NUI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01NUI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
