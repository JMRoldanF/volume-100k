      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00MX2'.
      ...
      * Called module names
       01  MOD-ZHO01CXQ              PIC X(8) VALUE 'ZHO01CXQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01CXQ-001.
               CALL 'ZHO01CXQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01CXQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-MAKE-0001.
