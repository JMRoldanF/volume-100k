      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00TEY'.
      ...
      * Called module names
       01  MOD-ZUW01GCG              PIC X(8) VALUE 'ZUW01GCG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01GCG-001.
               PERFORM CALL-ZHO01QAA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01GCG-001.
               CALL 'ZUW01GCG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01GCG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01QAA-002.
