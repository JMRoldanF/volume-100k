      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO002DW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00D7C-001.
               MOVE 'ZHO00D7C' TO WS-PROGNAME-3
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00ATG-002.
               MOVE 'ZHO00ATG' TO WS-PROGNAME-4
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO00ATG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
