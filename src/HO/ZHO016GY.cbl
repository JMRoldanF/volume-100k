      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO016GY'.
      ...
      * Called module names
       01  MOD-ZHO01JM0              PIC X(8) VALUE 'ZHO01JM0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01JM0-001.
               CALL 'ZHO01JM0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01JM0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
