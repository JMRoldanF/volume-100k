      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00U12'.
      ...
      * Called module names
       01  MOD-ZHO01GNX              PIC X(8) VALUE 'ZHO01GNX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01GNX-001.
               CALL 'ZHO01GNX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01GNX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSL01SKA-002.
