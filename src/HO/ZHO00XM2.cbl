      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00XM2'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01UDI              PIC X(8) VALUE 'ZHO01UDI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01M3G-001.
               PERFORM CALL-ZHO01UDI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01UDI-002.
               CALL 'ZHO01UDI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01UDI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
