      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00WWS'.
      ...
      * Called module names
       01  MOD-ZHO01O7K              PIC X(8) VALUE 'ZHO01O7K'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01O7K-001.
               CALL 'ZHO01O7K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01O7K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-TERM-0001.
