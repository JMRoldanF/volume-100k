      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00TL2'.
      ...
      * Called module names
       01  MOD-ZHO01JKM              PIC X(8) VALUE 'ZHO01JKM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01JKM-001.
               CALL 'ZHO01JKM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01JKM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
