      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00QSI'.
      ...
      * Called module names
       01  MOD-ZHO01NSK              PIC X(8) VALUE 'ZHO01NSK'.
       01  MOD-ZHO01ULK              PIC X(8) VALUE 'ZHO01ULK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01NSK-001.
               PERFORM CALL-ZHO01ULK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01NSK-001.
               CALL 'ZHO01NSK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01NSK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01ULK-002.
               CALL 'ZHO01ULK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01ULK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
