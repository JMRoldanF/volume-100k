      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00XC5'.
      ...
      * Called module names
       01  MOD-ZHO01P84              PIC X(8) VALUE 'ZHO01P84'.
       01  MOD-ZHO01O2V              PIC X(8) VALUE 'ZHO01O2V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01P84-001.
               CALL 'ZHO01P84' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01P84 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01O2V-002.
               CALL 'ZHO01O2V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01O2V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
