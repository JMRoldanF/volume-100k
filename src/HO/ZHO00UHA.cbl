      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00UHA'.
      ...
      * Called module names
       01  MOD-ZHO01CYA              PIC X(8) VALUE 'ZHO01CYA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01CYA-001.
               CALL 'ZHO01CYA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01CYA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
