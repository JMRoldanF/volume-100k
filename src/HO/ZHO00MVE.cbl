      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00MVE'.
      ...
      * Called module names
       01  MOD-ZHO01FBA              PIC X(8) VALUE 'ZHO01FBA'.
       01  MOD-ZHO01KM4              PIC X(8) VALUE 'ZHO01KM4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01FBA-001.
               PERFORM CALL-ZHO01KM4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01FBA-001.
               CALL 'ZHO01FBA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01FBA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01KM4-002.
               CALL 'ZHO01KM4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01KM4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
