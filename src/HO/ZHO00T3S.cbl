      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00T3S'.
      ...
      * Called module names
       01  MOD-ZHO01FZK              PIC X(8) VALUE 'ZHO01FZK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01FZK-001.
               PERFORM CALL-ZHO01N1Q-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01FZK-001.
               CALL 'ZHO01FZK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01FZK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01N1Q-002.
