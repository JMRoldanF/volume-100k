      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00MAU'.
      ...
      * Called module names
       01  MOD-ZHO01JPM              PIC X(8) VALUE 'ZHO01JPM'.
       01  MOD-ZHO01SR6              PIC X(8) VALUE 'ZHO01SR6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01JPM-001.
               PERFORM CALL-ZHO01SR6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01JPM-001.
               CALL 'ZHO01JPM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01JPM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01SR6-002.
               CALL 'ZHO01SR6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01SR6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
