      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO0026O'.
      ...
      * Called module names
       ...
       01  MOD-ZHO00IFY              PIC X(8) VALUE 'ZHO00IFY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO00AHA-001.
               PERFORM CALL-ZHO00IEK-002.
               PERFORM CALL-ZHO00IFY-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00AHA-001.
               MOVE 'ZHO00AHA' TO WS-PROGNAME-1
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO00AHA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO00IEK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00IFY-003.
               EXEC CICS LINK PROGRAM('ZHO00IFY')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO00IFY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-004.
