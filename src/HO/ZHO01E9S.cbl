      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01E9S'.
      ...
      * Called module names
       01  MOD-ZRE01UGZ              PIC X(8) VALUE 'ZRE01UGZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01UGZ-001.
               CALL 'ZRE01UGZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01UGZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
