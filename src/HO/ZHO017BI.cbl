      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO017BI'.
      ...
      * Called module names
       01  MOD-ZHO01JOG              PIC X(8) VALUE 'ZHO01JOG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01JOG-001.
               CALL 'ZHO01JOG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01JOG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01LSM-002.
