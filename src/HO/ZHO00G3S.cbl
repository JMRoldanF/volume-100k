      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00G3S'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01E5W              PIC X(8) VALUE 'ZHO01E5W'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU014NG-002.
               PERFORM CALL-ZUW01AUY-003.
               PERFORM CALL-ZHO01E5W-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO012IG-001.
               MOVE 'ZHO012IG' TO WS-PROGNAME-1
      ...
      *----------------------------------------------------------------*
       CALL-ZCU014NG-002.
               MOVE 'ZCU014NG' TO WS-PROGNAME-2
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU014NG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01AUY-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01E5W-004.
               CALL 'ZHO01E5W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
