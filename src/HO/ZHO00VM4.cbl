      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00VM4'.
      ...
      * Called module names
       01  MOD-ZHO01JJI              PIC X(8) VALUE 'ZHO01JJI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01JJI-001.
               CALL 'ZHO01JJI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01JJI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
