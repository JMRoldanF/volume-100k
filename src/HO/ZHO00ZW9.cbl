      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00ZW9'.
      ...
      * Called module names
       01  MOD-ZHO01KC4              PIC X(8) VALUE 'ZHO01KC4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01KC4-001.
               PERFORM CALL-ZHO01D5J-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01KC4-001.
               CALL 'ZHO01KC4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01KC4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01D5J-002.
