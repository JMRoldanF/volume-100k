      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00OSU'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01MUE              PIC X(8) VALUE 'ZHO01MUE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01MUE-002.
               CALL 'ZHO01MUE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01MUE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
