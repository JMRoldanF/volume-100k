      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00MRS'.
      ...
      * Called module names
       01  MOD-ZHO01MEU              PIC X(8) VALUE 'ZHO01MEU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01MEU-001.
               CALL 'ZHO01MEU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01MEU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
