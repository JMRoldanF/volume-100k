      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO010FG'.
      ...
      * Called module names
       01  MOD-ZHO01U9M              PIC X(8) VALUE 'ZHO01U9M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01U9M-001.
               CALL 'ZHO01U9M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01U9M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01E02-002.
