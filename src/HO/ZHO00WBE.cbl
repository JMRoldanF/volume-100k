      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00WBE'.
      ...
      * Called module names
       01  MOD-ZHO01HIG              PIC X(8) VALUE 'ZHO01HIG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01HIG-001.
               CALL 'ZHO01HIG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01HIG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
