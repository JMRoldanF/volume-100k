      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO0109F'.
      ...
      * Called module names
       01  MOD-ZHO01HE5              PIC X(8) VALUE 'ZHO01HE5'.
       01  MOD-ZFL01GGD              PIC X(8) VALUE 'ZFL01GGD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01HE5-001.
               PERFORM CALL-ZFL01GGD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01HE5-001.
               CALL 'ZHO01HE5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01HE5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFL01GGD-002.
               CALL 'ZFL01GGD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01GGD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
