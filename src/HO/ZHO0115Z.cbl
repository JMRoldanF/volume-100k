      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO0115Z'.
      ...
      * Called module names
       01  MOD-ZHO01UF8              PIC X(8) VALUE 'ZHO01UF8'.
       01  MOD-ZHO01GO2              PIC X(8) VALUE 'ZHO01GO2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01UF8-001.
               PERFORM CALL-ZHO01GO2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01UF8-001.
               CALL 'ZHO01UF8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01UF8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01GO2-002.
               CALL 'ZHO01GO2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01GO2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       VALIDATE-MODEL-0001.
