      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00VQA'.
      ...
      * Called module names
       01  MOD-ZHO01D7G              PIC X(8) VALUE 'ZHO01D7G'.
       01  MOD-ZHO01P88              PIC X(8) VALUE 'ZHO01P88'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01D7G-001.
               PERFORM CALL-ZHO01P88-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01D7G-001.
               CALL 'ZHO01D7G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01D7G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01P88-002.
               CALL 'ZHO01P88' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01P88 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
