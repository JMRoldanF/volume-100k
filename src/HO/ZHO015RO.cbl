      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO015RO'.
      ...
      * Called module names
       01  MOD-ZHO01MYK              PIC X(8) VALUE 'ZHO01MYK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01MYK-001.
               CALL 'ZHO01MYK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01MYK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
