      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00T61'.
      ...
      * Called module names
       01  MOD-ZHO01D79              PIC X(8) VALUE 'ZHO01D79'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01D79-001.
               CALL 'ZHO01D79' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01D79 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
