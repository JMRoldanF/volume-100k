      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00QBA'.
      ...
      * Called module names
       01  MOD-ZHO01L2S              PIC X(8) VALUE 'ZHO01L2S'.
       01  MOD-ZHO01IL2              PIC X(8) VALUE 'ZHO01IL2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01L2S-001.
               PERFORM CALL-ZHO01IL2-002.
               PERFORM CALL-ZRE0255R-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZHO01L2S-001.
               CALL 'ZHO01L2S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01IL2-002.
               CALL 'ZHO01IL2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
