      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO0185I'.
      ...
      * Called module names
       01  MOD-ZHO01E0C              PIC X(8) VALUE 'ZHO01E0C'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01E0C-001.
               CALL 'ZHO01E0C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01E0C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
