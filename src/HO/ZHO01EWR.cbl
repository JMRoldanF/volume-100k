      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01EWR'.
      ...
      * Called module names
       01  MOD-ZHO01E23              PIC X(8) VALUE 'ZHO01E23'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01E23-001.
               CALL 'ZHO01E23' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01E23 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
