      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00RJG'.
      ...
      * Called module names
       01  MOD-ZHO01GWS              PIC X(8) VALUE 'ZHO01GWS'.
       01  MOD-ZCU01K4Y              PIC X(8) VALUE 'ZCU01K4Y'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01GWS-001.
               PERFORM CALL-ZCU01K4Y-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01GWS-001.
               CALL 'ZHO01GWS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01GWS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01K4Y-002.
               CALL 'ZCU01K4Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01K4Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
