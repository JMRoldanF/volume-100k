      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00V7E'.
      ...
      * Called module names
       01  MOD-ZHO01LIM              PIC X(8) VALUE 'ZHO01LIM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01LIM-001.
               PERFORM CALL-ZHO01RU4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01LIM-001.
               CALL 'ZHO01LIM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01LIM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01RU4-002.
