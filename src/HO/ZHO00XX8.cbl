      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00XX8'.
      ...
      * Called module names
       01  MOD-ZHO01NO6              PIC X(8) VALUE 'ZHO01NO6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01NO6-001.
               PERFORM CALL-ZSL01OZA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01NO6-001.
               CALL 'ZHO01NO6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01NO6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSL01OZA-002.
