      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00WEO'.
      ...
      * Called module names
       01  MOD-ZSL01G7D              PIC X(8) VALUE 'ZSL01G7D'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSL01G7D-001.
               CALL 'ZSL01G7D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSL01G7D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
