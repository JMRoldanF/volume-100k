      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00OIU'.
      ...
      * Called module names
       01  MOD-ZHO01NJY              PIC X(8) VALUE 'ZHO01NJY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01NJY-001.
               CALL 'ZHO01NJY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01NJY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
