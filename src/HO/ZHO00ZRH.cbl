      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00ZRH'.
      ...
      * Called module names
       01  MOD-ZHO01JTQ              PIC X(8) VALUE 'ZHO01JTQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01JTQ-001.
               CALL 'ZHO01JTQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01JTQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01STZ-002.
