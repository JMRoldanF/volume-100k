      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00P34'.
      ...
      * Called module names
       01  MOD-ZHO01FGU              PIC X(8) VALUE 'ZHO01FGU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01FGU-001.
               CALL 'ZHO01FGU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01FGU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
