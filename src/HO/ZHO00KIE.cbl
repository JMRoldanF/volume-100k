      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00KIE'.
      ...
      * Called module names
       ...
       01  MOD-ZHO00OOO              PIC X(8) VALUE 'ZHO00OOO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00OOO-002.
               EXEC CICS LINK PROGRAM('ZHO00OOO')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO00OOO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
