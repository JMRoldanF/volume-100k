      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO0087C'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO00YO4-001.
               PERFORM CALL-ZHO018NK-002.
               PERFORM CALL-ZHO01AHO-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00YO4-001.
               MOVE 'ZHO00YO4' TO WS-PROGNAME-3
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO00YO4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO018NK-002.
               MOVE 'ZHO018NK' TO WS-PROGNAME-4
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01AHO-003.
               MOVE 'ZHO01AHO' TO WS-PROGNAME-5
