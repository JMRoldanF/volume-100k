      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00SSQ'.
      ...
      * Called module names
       01  MOD-ZRE01H7R              PIC X(8) VALUE 'ZRE01H7R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01H7R-001.
               CALL 'ZRE01H7R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01H7R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-MODEL-0001.
