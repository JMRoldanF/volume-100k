      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00TYR'.
      ...
      * Called module names
       01  MOD-ZHO01F3M              PIC X(8) VALUE 'ZHO01F3M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01F3M-001.
               CALL 'ZHO01F3M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01F3M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01LSM-002.
