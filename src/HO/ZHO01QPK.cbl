      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01QPK'.
      ...
      * Called module names
       01  MOD-ZHO01MJ3              PIC X(8) VALUE 'ZHO01MJ3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01MJ3-001.
               CALL 'ZHO01MJ3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01MJ3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
