      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00P6G'.
      ...
      * Called module names
       01  MOD-ZHO01S7Q              PIC X(8) VALUE 'ZHO01S7Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01S7Q-001.
               CALL 'ZHO01S7Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01S7Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
