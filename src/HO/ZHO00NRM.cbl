      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00NRM'.
      ...
      * Called module names
       01  MOD-ZHO01P7Y              PIC X(8) VALUE 'ZHO01P7Y'.
       01  MOD-ZHO01TUC              PIC X(8) VALUE 'ZHO01TUC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01P7Y-001.
               PERFORM CALL-ZHO01TUC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01P7Y-001.
               CALL 'ZHO01P7Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01P7Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01TUC-002.
               CALL 'ZHO01TUC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01TUC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
