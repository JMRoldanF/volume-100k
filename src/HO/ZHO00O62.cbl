      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00O62'.
      ...
      * Called module names
       01  MOD-ZHO01M4U              PIC X(8) VALUE 'ZHO01M4U'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01M4U-001.
               CALL 'ZHO01M4U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01M4U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-POSTCODE-0001.
