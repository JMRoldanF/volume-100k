      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01J6J'.
      ...
      * Called module names
       01  MOD-ZHO01E2K              PIC X(8) VALUE 'ZHO01E2K'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01E2K-001.
               CALL 'ZHO01E2K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01E2K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-EQUITIES-0001.
