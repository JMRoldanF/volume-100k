      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00OHG'.
      ...
      * Called module names
       01  MOD-ZHO01MUO              PIC X(8) VALUE 'ZHO01MUO'.
       01  MOD-ZHO01IP8              PIC X(8) VALUE 'ZHO01IP8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01MUO-001.
               PERFORM CALL-ZHO01IP8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01MUO-001.
               CALL 'ZHO01MUO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01IP8-002.
               CALL 'ZHO01IP8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01IP8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-VALUE-0001.
