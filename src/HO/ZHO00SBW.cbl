      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00SBW'.
      ...
      * Called module names
       01  MOD-ZHO01U18              PIC X(8) VALUE 'ZHO01U18'.
       01  MOD-ZHO01M4I              PIC X(8) VALUE 'ZHO01M4I'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01U18-001.
               PERFORM CALL-ZHO01M4I-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01U18-001.
               CALL 'ZHO01U18' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01U18 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01M4I-002.
               CALL 'ZHO01M4I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01M4I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
