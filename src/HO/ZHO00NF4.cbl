      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00NF4'.
      ...
      * Called module names
       01  MOD-ZEN01GUL              PIC X(8) VALUE 'ZEN01GUL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01GUL-001.
               CALL 'ZEN01GUL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01GUL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01KOC-002.
