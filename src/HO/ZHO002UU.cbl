      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO002UU'.
      ...
      * Called module names
       ...
       01  MOD-ZHO00C5U              PIC X(8) VALUE 'ZHO00C5U'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO00J0I-001.
               PERFORM CALL-ZHO00C5U-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00C5U-002.
               EXEC CICS LINK PROGRAM('ZHO00C5U')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO00C5U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO009TE-003.
