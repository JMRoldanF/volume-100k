      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00MKS'.
      ...
      * Called module names
       01  MOD-ZHO01KYN              PIC X(8) VALUE 'ZHO01KYN'.
       01  MOD-ZSL01NNG              PIC X(8) VALUE 'ZSL01NNG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01KYN-001.
               PERFORM CALL-ZSL01NNG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01KYN-001.
               CALL 'ZHO01KYN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01KYN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSL01NNG-002.
               CALL 'ZSL01NNG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
