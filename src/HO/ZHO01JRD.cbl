      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01JRD'.
      ...
      * Called module names
       01  MOD-ZHO01DM5              PIC X(8) VALUE 'ZHO01DM5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01DM5-001.
               CALL 'ZHO01DM5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01DM5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
