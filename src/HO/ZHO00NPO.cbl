      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00NPO'.
      ...
      * Called module names
       01  MOD-ZHO01L8M              PIC X(8) VALUE 'ZHO01L8M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01L8M-001.
               CALL 'ZHO01L8M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01L8M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
