      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00ZHK'.
      ...
      * Called module names
       01  MOD-ZHO01FEW              PIC X(8) VALUE 'ZHO01FEW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01FEW-001.
               CALL 'ZHO01FEW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01FEW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01RWH-002.
