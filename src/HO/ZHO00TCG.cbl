      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00TCG'.
      ...
      * Called module names
       01  MOD-ZHO01PJC              PIC X(8) VALUE 'ZHO01PJC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01PJC-001.
               CALL 'ZHO01PJC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01PJC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
