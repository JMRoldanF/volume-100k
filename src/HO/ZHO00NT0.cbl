      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00NT0'.
      ...
      * Called module names
       01  MOD-ZUW01N06              PIC X(8) VALUE 'ZUW01N06'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01N06-001.
               CALL 'ZUW01N06' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01N06 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01MQI-002.
               MOVE 'ZHO01MQI' TO WS-SUBNAME-8
