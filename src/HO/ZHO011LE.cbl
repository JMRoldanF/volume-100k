      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO011LE'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01R2M              PIC X(8) VALUE 'ZHO01R2M'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01CR2-001.
               PERFORM CALL-ZHO01R2M-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01R2M-002.
               CALL 'ZHO01R2M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01R2M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
