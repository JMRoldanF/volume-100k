      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00NJ0'.
      ...
      * Called module names
       01  MOD-ZHO01LKA              PIC X(8) VALUE 'ZHO01LKA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01LKA-001.
               PERFORM CALL-ZHO01G9G-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01LKA-001.
               CALL 'ZHO01LKA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01LKA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01G9G-002.
               MOVE 'ZHO01G9G' TO WS-SUBNAME-1
