      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00UFP'.
      ...
      * Called module names
       01  MOD-ZFL01OUW              PIC X(8) VALUE 'ZFL01OUW'.
       01  MOD-ZHO01U8W              PIC X(8) VALUE 'ZHO01U8W'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFL01OUW-001.
               PERFORM CALL-ZHO01U8W-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01OUW-001.
               CALL 'ZFL01OUW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01OUW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01U8W-002.
               CALL 'ZHO01U8W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01U8W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-EXCESS-0001.
