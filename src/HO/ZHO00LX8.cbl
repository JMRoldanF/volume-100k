      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00LX8'.
      ...
      * Called module names
       01  MOD-ZHO01H8Q              PIC X(8) VALUE 'ZHO01H8Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01H8Q-001.
               CALL 'ZHO01H8Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01H8Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
