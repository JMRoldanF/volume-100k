      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00VKT'.
      ...
      * Called module names
       01  MOD-ZHO01TEH              PIC X(8) VALUE 'ZHO01TEH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFL01DC0-001.
               PERFORM CALL-ZHO01TEH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01TEH-002.
               CALL 'ZHO01TEH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01TEH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
