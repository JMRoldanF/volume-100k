      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00PEI'.
      ...
      * Called module names
       01  MOD-ZHO01RB8              PIC X(8) VALUE 'ZHO01RB8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01RB8-001.
               CALL 'ZHO01RB8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01RB8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01JZ2-002.
