      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00OZ8'.
      ...
      * Called module names
       01  MOD-ZHO01RPE              PIC X(8) VALUE 'ZHO01RPE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01RPE-001.
               CALL 'ZHO01RPE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01RPE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-EQUITIES-0001.
