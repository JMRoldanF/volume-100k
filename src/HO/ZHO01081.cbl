      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01081'.
      ...
      * Called module names
       01  MOD-ZHO01PDB              PIC X(8) VALUE 'ZHO01PDB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01PDB-001.
               CALL 'ZHO01PDB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01PDB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
