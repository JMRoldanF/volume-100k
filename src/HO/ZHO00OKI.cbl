      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00OKI'.
      ...
      * Called module names
       01  MOD-ZHO01KUQ              PIC X(8) VALUE 'ZHO01KUQ'.
       01  MOD-ZHO01HC2              PIC X(8) VALUE 'ZHO01HC2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01KUQ-001.
               PERFORM CALL-ZHO01HC2-002.
               ...
               PERFORM DERIVE-REG-NUMBER-0094.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01KUQ-001.
               CALL 'ZHO01KUQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01KUQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01HC2-002.
               CALL 'ZHO01HC2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01HC2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
