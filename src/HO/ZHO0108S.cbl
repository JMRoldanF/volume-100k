      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO0108S'.
      ...
      * Called module names
       01  MOD-ZHO01RUE              PIC X(8) VALUE 'ZHO01RUE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01RUE-001.
               PERFORM CALL-ZHO01MQI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01RUE-001.
               CALL 'ZHO01RUE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01RUE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01MQI-002.
