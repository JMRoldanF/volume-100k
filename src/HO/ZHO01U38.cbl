      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01U38'.
      ...
      * Called module names
       01  MOD-ZUW01NS8              PIC X(8) VALUE 'ZUW01NS8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01NS8-001.
               CALL 'ZUW01NS8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01NS8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
