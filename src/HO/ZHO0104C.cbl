      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO0104C'.
      ...
      * Called module names
       01  MOD-ZHO01E5C              PIC X(8) VALUE 'ZHO01E5C'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01E5C-001.
               CALL 'ZHO01E5C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01E5C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01IRG-002.
