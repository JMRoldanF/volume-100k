      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO01QJQ'.
      ...
      * Called module names
       01  MOD-ZHO01G82              PIC X(8) VALUE 'ZHO01G82'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01G82-001.
               CALL 'ZHO01G82' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01G82 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-COLOUR-0001.
