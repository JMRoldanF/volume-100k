      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00Y1W'.
      ...
      * Called module names
       01  MOD-ZHO01SG2              PIC X(8) VALUE 'ZHO01SG2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01SG2-001.
               CALL 'ZHO01SG2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01SG2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
