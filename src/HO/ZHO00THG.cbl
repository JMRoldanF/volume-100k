      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00THG'.
      ...
      * Called module names
       01  MOD-ZHO01GPA              PIC X(8) VALUE 'ZHO01GPA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01GPA-002.
               CALL 'ZHO01GPA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01GPA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
