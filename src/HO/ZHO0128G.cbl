      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO0128G'.
      ...
      * Called module names
       01  MOD-ZHO01SDU              PIC X(8) VALUE 'ZHO01SDU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01SDU-001.
               CALL 'ZHO01SDU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01SDU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
