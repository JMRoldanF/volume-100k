      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00XHW'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01RL6              PIC X(8) VALUE 'ZUW01RL6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01RL6-002.
               CALL 'ZUW01RL6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01RL6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
