      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO000Y8'.
      ...
      * Called module names
       01  MOD-ZHO00JV2              PIC X(8) VALUE 'ZHO00JV2'.
       01  MOD-ZHO00HI2              PIC X(8) VALUE 'ZHO00HI2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO00JV2-001.
               PERFORM CALL-ZHO00HI2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00JV2-001.
               EXEC CICS LINK PROGRAM('ZHO00JV2')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO00JV2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO00HI2-002.
               EXEC CICS LINK PROGRAM('ZHO00HI2')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
