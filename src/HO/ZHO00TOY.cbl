      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00TOY'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01LH0              PIC X(8) VALUE 'ZCU01LH0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01LH0-002.
               CALL 'ZCU01LH0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01LH0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
