      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO004HE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO00ARN-001.
               PERFORM CALL-ZFL00H2Z-002.
               PERFORM CALL-ZHO0255M-003.
               PERFORM RECONCILE-MODEL-0001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZHO00ARN-001.
               MOVE 'ZHO00ARN' TO WS-PROGNAME-8
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO00ARN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFL00H2Z-002.
