      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO00ZI4'.
      ...
      * Called module names
       01  MOD-ZHO01QVO              PIC X(8) VALUE 'ZHO01QVO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01QVO-001.
               CALL 'ZHO01QVO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01QVO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01OPL-002.
