      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZHO004MQ'.
      ...
      * Called module names
       01  MOD-ZHO008WC              PIC X(8) VALUE 'ZHO008WC'.
       01  MOD-ZHO00CZK              PIC X(8) VALUE 'ZHO00CZK'.
       01  MOD-ZBI001QY              PIC X(8) VALUE 'ZBI001QY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO008WC-001.
               PERFORM CALL-ZHO00CZK-002.
               PERFORM CALL-ZBI001QY-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO008WC-001.
               EXEC CICS LINK PROGRAM('ZHO008WC')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO008WC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO00CZK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI001QY-003.
               EXEC CICS XCTL PROGRAM('ZBI001QY')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI001QY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-004.
