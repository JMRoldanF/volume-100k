      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT00N0F'.
      ...
      * Called module names
       01  MOD-ZLT01JF0              PIC X(8) VALUE 'ZLT01JF0'.
       01  MOD-ZLT01HWA              PIC X(8) VALUE 'ZLT01HWA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLT01JF0-001.
               PERFORM CALL-ZLT01HWA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLT01JF0-001.
               CALL 'ZLT01JF0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLT01JF0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLT01HWA-002.
               CALL 'ZLT01HWA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLT01HWA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
