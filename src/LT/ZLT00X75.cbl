      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT00X75'.
      ...
      * Called module names
       01  MOD-ZLT01NOP              PIC X(8) VALUE 'ZLT01NOP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLT01NOP-001.
               PERFORM CALL-ZLT01QYZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLT01NOP-001.
               CALL 'ZLT01NOP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLT01NOP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLT01QYZ-002.
               MOVE 'ZLT01QYZ' TO WS-SUBNAME-3
