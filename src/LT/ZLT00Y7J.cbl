      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT00Y7J'.
      ...
      * Called module names
       01  MOD-ZBR01MDI              PIC X(8) VALUE 'ZBR01MDI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01MDI-001.
               CALL 'ZBR01MDI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01MDI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
