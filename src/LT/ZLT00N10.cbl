      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT00N10'.
      ...
      * Called module names
       01  MOD-ZLT01KBI              PIC X(8) VALUE 'ZLT01KBI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLT01KBI-001.
               CALL 'ZLT01KBI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLT01KBI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
