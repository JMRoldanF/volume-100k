      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT00V6O'.
      ...
      * Called module names
       ...
       01  MOD-ZLT01EYG              PIC X(8) VALUE 'ZLT01EYG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLT01O62-001.
               PERFORM CALL-ZLT01EYG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLT01EYG-002.
               CALL 'ZLT01EYG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLT01EYG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
