      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT00P65'.
      ...
      * Called module names
       01  MOD-ZLT01ONS              PIC X(8) VALUE 'ZLT01ONS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLT01ONS-001.
               CALL 'ZLT01ONS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLT01ONS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
