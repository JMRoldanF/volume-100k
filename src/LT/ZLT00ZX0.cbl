      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT00ZX0'.
      ...
      * Called module names
       01  MOD-ZLT01LL1              PIC X(8) VALUE 'ZLT01LL1'.
       01  MOD-ZLT01MAL              PIC X(8) VALUE 'ZLT01MAL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLT01LL1-001.
               PERFORM CALL-ZLT01MAL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLT01LL1-001.
               CALL 'ZLT01LL1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLT01LL1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLT01MAL-002.
               CALL 'ZLT01MAL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLT01MAL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
