      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT00OAK'.
      ...
      * Called module names
       01  MOD-ZLT01M8F              PIC X(8) VALUE 'ZLT01M8F'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLT01M8F-001.
               PERFORM CALL-ZLT01O4O-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLT01M8F-001.
               CALL 'ZLT01M8F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLT01M8F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLT01O4O-002.
               MOVE 'ZLT01O4O' TO WS-SUBNAME-6
