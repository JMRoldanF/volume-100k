      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT00XBN'.
      ...
      * Called module names
       01  MOD-ZAN01FAY              PIC X(8) VALUE 'ZAN01FAY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01FAY-001.
               CALL 'ZAN01FAY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01FAY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
