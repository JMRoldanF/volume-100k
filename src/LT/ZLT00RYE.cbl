      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT00RYE'.
      ...
      * Called module names
       01  MOD-ZCL01HV8              PIC X(8) VALUE 'ZCL01HV8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01HV8-001.
               CALL 'ZCL01HV8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01HV8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
