      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT00RKM'.
      ...
      * Called module names
       01  MOD-ZLT01NZW              PIC X(8) VALUE 'ZLT01NZW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLT01NZW-001.
               CALL 'ZLT01NZW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLT01NZW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
