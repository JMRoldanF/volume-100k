      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT00YZ6'.
      ...
      * Called module names
       01  MOD-ZLT01DYS              PIC X(8) VALUE 'ZLT01DYS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLT01DYS-001.
               CALL 'ZLT01DYS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLT01DYS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
