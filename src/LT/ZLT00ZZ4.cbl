      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT00ZZ4'.
      ...
      * Called module names
       01  MOD-ZLT01JW3              PIC X(8) VALUE 'ZLT01JW3'.
       01  MOD-ZCL01G3O              PIC X(8) VALUE 'ZCL01G3O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLT01JW3-001.
               CALL 'ZLT01JW3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLT01JW3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01G3O-002.
               CALL 'ZCL01G3O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01G3O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
