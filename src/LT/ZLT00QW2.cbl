      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT00QW2'.
      ...
      * Called module names
       01  MOD-ZBR01L06              PIC X(8) VALUE 'ZBR01L06'.
       01  MOD-ZBR01TQY              PIC X(8) VALUE 'ZBR01TQY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBR01L06-001.
               PERFORM CALL-ZBR01TQY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01L06-001.
               CALL 'ZBR01L06' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01L06 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBR01TQY-002.
               CALL 'ZBR01TQY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01TQY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
