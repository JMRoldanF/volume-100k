      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT0111S'.
      ...
      * Called module names
       01  MOD-ZAN01TT8              PIC X(8) VALUE 'ZAN01TT8'.
       01  MOD-ZLT01H9I              PIC X(8) VALUE 'ZLT01H9I'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAN01TT8-001.
               PERFORM CALL-ZLT01H9I-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01TT8-001.
               CALL 'ZAN01TT8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01TT8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLT01H9I-002.
               CALL 'ZLT01H9I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLT01H9I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
