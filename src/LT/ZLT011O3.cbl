      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT011O3'.
      ...
      * Called module names
       ...
       01  MOD-ZLT01E4W              PIC X(8) VALUE 'ZLT01E4W'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLT01UVS-001.
               PERFORM CALL-ZLT01E4W-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLT01E4W-002.
               CALL 'ZLT01E4W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLT01E4W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
