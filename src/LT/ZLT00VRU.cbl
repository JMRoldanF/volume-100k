      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT00VRU'.
      ...
      * Called module names
       01  MOD-ZLT01LSD              PIC X(8) VALUE 'ZLT01LSD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLT01LSD-001.
               CALL 'ZLT01LSD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLT01LSD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-COLOUR-0001.
