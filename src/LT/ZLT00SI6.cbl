      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT00SI6'.
      ...
      * Called module names
       01  MOD-ZLT01EPW              PIC X(8) VALUE 'ZLT01EPW'.
       01  MOD-ZLT01TKR              PIC X(8) VALUE 'ZLT01TKR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLT01EPW-001.
               PERFORM CALL-ZLT01TKR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLT01EPW-001.
               CALL 'ZLT01EPW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZLT01TKR-002.
               CALL 'ZLT01TKR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLT01TKR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
