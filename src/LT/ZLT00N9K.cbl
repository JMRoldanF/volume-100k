      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT00N9K'.
      ...
      * Called module names
       01  MOD-ZLT01TZ8              PIC X(8) VALUE 'ZLT01TZ8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLT01TZ8-001.
               CALL 'ZLT01TZ8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLT01TZ8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
