      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT00P1J'.
      ...
      * Called module names
       01  MOD-ZLT01DFH              PIC X(8) VALUE 'ZLT01DFH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLT01DFH-001.
               CALL 'ZLT01DFH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLT01DFH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
