      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT0033R'.
      ...
      * Called module names
       01  MOD-ZLT0098L              PIC X(8) VALUE 'ZLT0098L'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLT0098L-002.
               PERFORM CALL-ZLT005EP-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZLT00DW8-001.
               MOVE 'ZLT00DW8' TO WS-PROGNAME-1
      ...
      *----------------------------------------------------------------*
       CALL-ZLT0098L-002.
               EXEC CICS LINK PROGRAM('ZLT0098L')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLT0098L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLT005EP-003.
               EXEC CICS START TRANSID('Z5EP')
                         ...
                         RESP(WS-RESP)
               END-EXEC.
      * TRANSID Z5EP is defined against ZLT005EP
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLT005EP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-004.
