      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT00YD1'.
      ...
      * Called module names
       ...
       01  MOD-ZLT01SIM              PIC X(8) VALUE 'ZLT01SIM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLT01PAX-001.
               PERFORM CALL-ZLT01SIM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLT01SIM-002.
               CALL 'ZLT01SIM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLT01SIM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
