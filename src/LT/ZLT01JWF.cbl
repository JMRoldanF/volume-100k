      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT01JWF'.
      ...
      * Called module names
       01  MOD-ZLT01V1J              PIC X(8) VALUE 'ZLT01V1J'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLT01V1J-001.
               CALL 'ZLT01V1J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLT01V1J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
