      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT00Z1B'.
      ...
      * Called module names
       01  MOD-ZLT01JQP              PIC X(8) VALUE 'ZLT01JQP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLT01JQP-001.
               CALL 'ZLT01JQP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLT01JQP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
