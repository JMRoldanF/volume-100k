      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT00Y86'.
      ...
      * Called module names
       01  MOD-ZRN01RRR              PIC X(8) VALUE 'ZRN01RRR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRN01RRR-001.
               CALL 'ZRN01RRR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01RRR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
