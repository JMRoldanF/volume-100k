      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT00OXB'.
      ...
      * Called module names
       01  MOD-ZLT01PTM              PIC X(8) VALUE 'ZLT01PTM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLT01PTM-001.
               CALL 'ZLT01PTM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLT01PTM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
