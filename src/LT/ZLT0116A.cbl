      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT0116A'.
      ...
      * Called module names
       01  MOD-ZCL01U3L              PIC X(8) VALUE 'ZCL01U3L'.
       01  MOD-ZLT01R3C              PIC X(8) VALUE 'ZLT01R3C'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01U3L-001.
               CALL 'ZCL01U3L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01U3L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLT01R3C-002.
               CALL 'ZLT01R3C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLT01R3C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
