      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT010ZW'.
      ...
      * Called module names
       ...
       01  MOD-ZLT01IAR              PIC X(8) VALUE 'ZLT01IAR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLT01IAR-002.
               CALL 'ZLT01IAR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
