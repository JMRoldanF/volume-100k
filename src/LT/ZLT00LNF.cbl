      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT00LNF'.
      ...
      * Called module names
       ...
       01  MOD-ZLT01T1N              PIC X(8) VALUE 'ZLT01T1N'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01PEI-001.
               PERFORM CALL-ZLT01T1N-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLT01T1N-002.
               CALL 'ZLT01T1N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLT01T1N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
