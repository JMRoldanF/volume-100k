      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT00LWO'.
      ...
      * Called module names
       01  MOD-ZLT01TS2              PIC X(8) VALUE 'ZLT01TS2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLT01TS2-001.
               CALL 'ZLT01TS2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLT01TS2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLT01PVW-002.
