      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZLT00M6L'.
      ...
      * Called module names
       01  MOD-ZLT01GJN              PIC X(8) VALUE 'ZLT01GJN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLT01GJN-001.
               PERFORM CALL-ZLT01H3O-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLT01GJN-001.
               CALL 'ZLT01GJN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLT01GJN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLT01H3O-002.
