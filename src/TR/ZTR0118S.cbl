      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR0118S'.
      ...
      * Called module names
       ...
       01  MOD-ZTR01QHF              PIC X(8) VALUE 'ZTR01QHF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTR01QKY-001.
               PERFORM CALL-ZTR01QHF-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01QHF-002.
               CALL 'ZTR01QHF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01QHF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
