      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00MZG'.
      ...
      * Called module names
       01  MOD-ZTR01TZI              PIC X(8) VALUE 'ZTR01TZI'.
       01  MOD-ZSE01F8Z              PIC X(8) VALUE 'ZSE01F8Z'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTR01TZI-001.
               PERFORM CALL-ZSE01F8Z-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01TZI-001.
               CALL 'ZTR01TZI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01TZI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSE01F8Z-002.
               CALL 'ZSE01F8Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01F8Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-EQUITIES-0001.
