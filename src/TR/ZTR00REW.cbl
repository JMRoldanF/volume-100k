      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00REW'.
      ...
      * Called module names
       ...
       01  MOD-ZTR01CZR              PIC X(8) VALUE 'ZTR01CZR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01CZR-002.
               CALL 'ZTR01CZR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01CZR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
