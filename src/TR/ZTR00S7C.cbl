      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00S7C'.
      ...
      * Called module names
       01  MOD-ZTR01FEP              PIC X(8) VALUE 'ZTR01FEP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01FEP-001.
               CALL 'ZTR01FEP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01FEP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
