      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR0129T'.
      ...
      * Called module names
       01  MOD-ZTR01IGZ              PIC X(8) VALUE 'ZTR01IGZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01IGZ-001.
               CALL 'ZTR01IGZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01IGZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
