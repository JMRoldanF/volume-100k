      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00N3P'.
      ...
      * Called module names
       01  MOD-ZTR01EFI              PIC X(8) VALUE 'ZTR01EFI'.
       01  MOD-ZTR01PAJ              PIC X(8) VALUE 'ZTR01PAJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTR01EFI-001.
               PERFORM CALL-ZTR01PAJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01EFI-001.
               CALL 'ZTR01EFI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01EFI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTR01PAJ-002.
               CALL 'ZTR01PAJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01PAJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
