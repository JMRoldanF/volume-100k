      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00T68'.
      ...
      * Called module names
       01  MOD-ZTR01LKE              PIC X(8) VALUE 'ZTR01LKE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01LKE-001.
               CALL 'ZTR01LKE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01LKE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
