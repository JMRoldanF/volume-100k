      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00VRV'.
      ...
      * Called module names
       01  MOD-ZTR01KMW              PIC X(8) VALUE 'ZTR01KMW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01KMW-001.
               CALL 'ZTR01KMW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01KMW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
