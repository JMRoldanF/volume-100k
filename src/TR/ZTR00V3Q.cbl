      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00V3Q'.
      ...
      * Called module names
       01  MOD-ZTR01FAI              PIC X(8) VALUE 'ZTR01FAI'.
       01  MOD-ZCU01JYR              PIC X(8) VALUE 'ZCU01JYR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01FAI-001.
               CALL 'ZTR01FAI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01FAI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01JYR-002.
               CALL 'ZCU01JYR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
