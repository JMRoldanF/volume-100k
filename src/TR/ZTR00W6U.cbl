      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00W6U'.
      ...
      * Called module names
       01  MOD-ZTR01PJJ              PIC X(8) VALUE 'ZTR01PJJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01PJJ-001.
               CALL 'ZTR01PJJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01PJJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
