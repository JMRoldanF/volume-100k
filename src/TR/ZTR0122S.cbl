      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR0122S'.
      ...
      * Called module names
       01  MOD-ZSB01F0B              PIC X(8) VALUE 'ZSB01F0B'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSB01F0B-001.
               PERFORM CALL-ZTR01LNO-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSB01F0B-001.
               CALL 'ZSB01F0B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSB01F0B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTR01LNO-002.
               MOVE 'ZTR01LNO' TO WS-SUBNAME-7
