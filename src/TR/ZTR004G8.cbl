      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR004G8'.
      ...
      * Called module names
       01  MOD-ZTR006CV              PIC X(8) VALUE 'ZTR006CV'.
       01  MOD-ZTR00BJC              PIC X(8) VALUE 'ZTR00BJC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTR006CV-001.
               PERFORM CALL-ZTR00BJC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR006CV-001.
               EXEC CICS LINK PROGRAM('ZTR006CV')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR006CV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTR00BJC-002.
               EXEC CICS LINK PROGRAM('ZTR00BJC')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR00BJC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
