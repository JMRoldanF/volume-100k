      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00R1L'.
      ...
      * Called module names
       01  MOD-ZCU01GKY              PIC X(8) VALUE 'ZCU01GKY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01GKY-001.
               PERFORM CALL-ZTR01MHV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01GKY-001.
               CALL 'ZCU01GKY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01GKY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTR01MHV-002.
