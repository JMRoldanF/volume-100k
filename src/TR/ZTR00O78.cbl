      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00O78'.
      ...
      * Called module names
       01  MOD-ZTR01U1M              PIC X(8) VALUE 'ZTR01U1M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01U1M-001.
               CALL 'ZTR01U1M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01U1M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-VALUE-0001.
