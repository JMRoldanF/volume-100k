      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00RW1'.
      ...
      * Called module names
       01  MOD-ZTR01S37              PIC X(8) VALUE 'ZTR01S37'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01S37-001.
               CALL 'ZTR01S37' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01S37 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
