      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00TZX'.
      ...
      * Called module names
       01  MOD-ZTR01F4W              PIC X(8) VALUE 'ZTR01F4W'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01F4W-001.
               CALL 'ZTR01F4W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01F4W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-MODEL-0001.
