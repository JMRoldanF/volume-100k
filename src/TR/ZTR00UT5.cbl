      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00UT5'.
      ...
      * Called module names
       01  MOD-ZTR01SBS              PIC X(8) VALUE 'ZTR01SBS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01SBS-001.
               CALL 'ZTR01SBS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01SBS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
