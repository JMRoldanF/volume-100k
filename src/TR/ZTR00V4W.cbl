      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00V4W'.
      ...
      * Called module names
       01  MOD-ZTR01KBB              PIC X(8) VALUE 'ZTR01KBB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTR01KBB-001.
               PERFORM CALL-ZSB01GXS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01KBB-001.
               CALL 'ZTR01KBB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01KBB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSB01GXS-002.
