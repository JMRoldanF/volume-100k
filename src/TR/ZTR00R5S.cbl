      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00R5S'.
      ...
      * Called module names
       01  MOD-ZTR01UUA              PIC X(8) VALUE 'ZTR01UUA'.
       01  MOD-ZTR01E6X              PIC X(8) VALUE 'ZTR01E6X'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTR01UUA-001.
               PERFORM CALL-ZTR01E6X-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01UUA-001.
               CALL 'ZTR01UUA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01UUA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTR01E6X-002.
               CALL 'ZTR01E6X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01E6X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
