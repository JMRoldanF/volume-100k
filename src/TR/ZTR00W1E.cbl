      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00W1E'.
      ...
      * Called module names
       01  MOD-ZTR01N18              PIC X(8) VALUE 'ZTR01N18'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01N18-001.
               CALL 'ZTR01N18' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01N18 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTR01FQ7-002.
               MOVE 'ZTR01FQ7' TO WS-SUBNAME-7
