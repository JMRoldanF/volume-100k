      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00GHY'.
      ...
      * Called module names
       01  MOD-ZTR00XGO              PIC X(8) VALUE 'ZTR00XGO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTR00XGO-001.
               PERFORM CALL-ZTR017TL-002.
               PERFORM CALL-ZTR01TH0-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR00XGO-001.
               EXEC CICS LINK PROGRAM('ZTR00XGO')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR00XGO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTR017TL-002.
               MOVE 'ZTR017TL' TO WS-PROGNAME-4
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR017TL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTR01TH0-003.
