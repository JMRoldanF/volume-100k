      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00PUI'.
      ...
      * Called module names
       01  MOD-ZCU01FP5              PIC X(8) VALUE 'ZCU01FP5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01FP5-001.
               CALL 'ZCU01FP5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01FP5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTR01HPK-002.
