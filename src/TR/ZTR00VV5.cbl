      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00VV5'.
      ...
      * Called module names
       01  MOD-ZTR01OJ6              PIC X(8) VALUE 'ZTR01OJ6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01OJ6-001.
               CALL 'ZTR01OJ6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01OJ6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTR01JA6-002.
