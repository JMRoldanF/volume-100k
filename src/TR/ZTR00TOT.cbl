      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00TOT'.
      ...
      * Called module names
       01  MOD-ZTR01RQY              PIC X(8) VALUE 'ZTR01RQY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01RQY-001.
               CALL 'ZTR01RQY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01RQY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
