      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00E8K'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTR00Q4D-001.
               PERFORM CALL-ZTR00N31-002.
               PERFORM CALL-ZTR01AXB-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR00SPX-003.
               EXEC CICS LINK PROGRAM('ZTR00SPX')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01AXB-004.
               MOVE 'ZTR01AXB' TO WS-PROGNAME-5
