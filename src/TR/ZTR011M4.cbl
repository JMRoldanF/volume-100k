      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR011M4'.
      ...
      * Called module names
       ...
       01  MOD-ZTR01OTR              PIC X(8) VALUE 'ZTR01OTR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01GZ0-001.
               PERFORM CALL-ZTR01OTR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01OTR-002.
               CALL 'ZTR01OTR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01OTR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
