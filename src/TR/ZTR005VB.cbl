      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR005VB'.
      ...
      * Called module names
       01  MOD-ZTR00DS5              PIC X(8) VALUE 'ZTR00DS5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTR00DO4-002.
               PERFORM CALL-ZTR00DH7-003.
               PERFORM CALL-ZTR00HBX-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR00DS5-001.
               EXEC CICS LINK PROGRAM('ZTR00DS5')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR00DS5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTR00DO4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR00DH7-003.
               MOVE 'ZTR00DH7' TO WS-PROGNAME-2
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR00DH7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTR00HBX-004.
               MOVE 'ZTR00HBX' TO WS-PROGNAME-3
