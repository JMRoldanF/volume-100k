      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR000EK'.
      ...
      * Called module names
       01  MOD-ZTR008QM              PIC X(8) VALUE 'ZTR008QM'.
       01  MOD-ZCU00AFG              PIC X(8) VALUE 'ZCU00AFG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTR008QM-001.
               PERFORM CALL-ZCU00AFG-002.
               PERFORM CALL-ZCU00EZZ-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR008QM-001.
               EXEC CICS LINK PROGRAM('ZTR008QM')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR008QM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU00AFG-002.
               EXEC CICS LINK PROGRAM('ZCU00AFG')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00AFG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU00EZZ-003.
