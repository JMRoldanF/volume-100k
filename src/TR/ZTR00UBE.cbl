      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00UBE'.
      ...
      * Called module names
       01  MOD-ZTR01LW4              PIC X(8) VALUE 'ZTR01LW4'.
       01  MOD-ZTR01Q0Q              PIC X(8) VALUE 'ZTR01Q0Q'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTR01LW4-001.
               PERFORM CALL-ZTR01Q0Q-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01LW4-001.
               CALL 'ZTR01LW4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01LW4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTR01Q0Q-002.
               CALL 'ZTR01Q0Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01Q0Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-COLOUR-0001.
