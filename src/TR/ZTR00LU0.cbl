      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00LU0'.
      ...
      * Called module names
       01  MOD-ZTR01UK0              PIC X(8) VALUE 'ZTR01UK0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01UK0-001.
               CALL 'ZTR01UK0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01UK0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-MAKE-0001.
