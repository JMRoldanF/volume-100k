      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00VHS'.
      ...
      * Called module names
       01  MOD-ZEN01D54              PIC X(8) VALUE 'ZEN01D54'.
       01  MOD-ZSL01MUO              PIC X(8) VALUE 'ZSL01MUO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01D54-001.
               PERFORM CALL-ZSL01MUO-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01D54-001.
               CALL 'ZEN01D54' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01D54 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSL01MUO-002.
               CALL 'ZSL01MUO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
