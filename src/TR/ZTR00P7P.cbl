      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00P7P'.
      ...
      * Called module names
       01  MOD-ZTR01S7C              PIC X(8) VALUE 'ZTR01S7C'.
       01  MOD-ZTR01UFA              PIC X(8) VALUE 'ZTR01UFA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTR01S7C-001.
               PERFORM CALL-ZTR01UFA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01S7C-001.
               CALL 'ZTR01S7C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01S7C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTR01UFA-002.
               CALL 'ZTR01UFA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01UFA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-MODEL-0001.
