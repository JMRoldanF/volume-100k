      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00O9D'.
      ...
      * Called module names
       01  MOD-ZTR01D02              PIC X(8) VALUE 'ZTR01D02'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01D02-001.
               CALL 'ZTR01D02' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01D02 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-COLOUR-0001.
