      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00SVJ'.
      ...
      * Called module names
       01  MOD-ZTR01CYO              PIC X(8) VALUE 'ZTR01CYO'.
       01  MOD-ZTR01JUH              PIC X(8) VALUE 'ZTR01JUH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTR01CYO-001.
               PERFORM CALL-ZTR01JUH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01CYO-001.
               CALL 'ZTR01CYO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01CYO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTR01JUH-002.
               CALL 'ZTR01JUH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01JUH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
