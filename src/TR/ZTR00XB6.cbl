      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00XB6'.
      ...
      * Called module names
       01  MOD-ZTR01LFP              PIC X(8) VALUE 'ZTR01LFP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01LFP-001.
               CALL 'ZTR01LFP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01LFP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
