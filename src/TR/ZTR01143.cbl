      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR01143'.
      ...
      * Called module names
       01  MOD-ZTR01F4K              PIC X(8) VALUE 'ZTR01F4K'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01F4K-001.
               CALL 'ZTR01F4K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01F4K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
