      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR01070'.
      ...
      * Called module names
       ...
       01  MOD-ZTR01M0D              PIC X(8) VALUE 'ZTR01M0D'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTR01OKV-001.
               PERFORM CALL-ZTR01M0D-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01M0D-002.
               CALL 'ZTR01M0D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01M0D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
