      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00VDF'.
      ...
      * Called module names
       01  MOD-ZTR01IPF              PIC X(8) VALUE 'ZTR01IPF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01IPF-001.
               CALL 'ZTR01IPF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01IPF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-MAKE-0001.
