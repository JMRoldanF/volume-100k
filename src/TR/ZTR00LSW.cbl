      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00LSW'.
      ...
      * Called module names
       ...
       01  MOD-ZTR01TH0              PIC X(8) VALUE 'ZTR01TH0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01TH0-002.
               CALL 'ZTR01TH0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01TH0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
