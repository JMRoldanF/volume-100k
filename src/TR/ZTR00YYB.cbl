      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00YYB'.
      ...
      * Called module names
       01  MOD-ZTR01NS7              PIC X(8) VALUE 'ZTR01NS7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01NS7-001.
               CALL 'ZTR01NS7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01NS7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
