      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00N58'.
      ...
      * Called module names
       01  MOD-ZTR01HST              PIC X(8) VALUE 'ZTR01HST'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01HST-001.
               CALL 'ZTR01HST' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01HST FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-TAX-BAND-0001.
