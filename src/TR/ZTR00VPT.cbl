      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00VPT'.
      ...
      * Called module names
       01  MOD-ZTR01RCC              PIC X(8) VALUE 'ZTR01RCC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01RCC-002.
               CALL 'ZTR01RCC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01RCC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-MODEL-0001.
