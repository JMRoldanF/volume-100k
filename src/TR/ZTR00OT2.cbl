      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00OT2'.
      ...
      * Called module names
       01  MOD-ZTR01K44              PIC X(8) VALUE 'ZTR01K44'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01K44-002.
               CALL 'ZTR01K44' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01K44 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
