      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR01D0R'.
      ...
      * Called module names
       01  MOD-ZTR01JC4              PIC X(8) VALUE 'ZTR01JC4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01JC4-001.
               CALL 'ZTR01JC4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01JC4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
