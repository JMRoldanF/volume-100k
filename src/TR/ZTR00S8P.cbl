      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00S8P'.
      ...
      * Called module names
       01  MOD-ZTR01RHP              PIC X(8) VALUE 'ZTR01RHP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTR01RHP-001.
               PERFORM CALL-ZTR01EFI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01RHP-001.
               CALL 'ZTR01RHP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01RHP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTR01EFI-002.
