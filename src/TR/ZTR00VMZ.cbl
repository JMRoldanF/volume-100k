      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00VMZ'.
      ...
      * Called module names
       01  MOD-ZTR01EVF              PIC X(8) VALUE 'ZTR01EVF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01EVF-001.
               CALL 'ZTR01EVF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01EVF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
