      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTR00M1M'.
      ...
      * Called module names
       01  MOD-ZTR01H6X              PIC X(8) VALUE 'ZTR01H6X'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01H6X-001.
               CALL 'ZTR01H6X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01H6X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTR01FM0-002.
