      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZGW00LQW'.
      ...
      * Called module names
       01  MOD-ZGW01HKI              PIC X(8) VALUE 'ZGW01HKI'.
       01  MOD-ZGW01ORU              PIC X(8) VALUE 'ZGW01ORU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZGW01HKI-001.
               PERFORM CALL-ZGW01ORU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01HKI-001.
               CALL 'ZGW01HKI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01HKI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZGW01ORU-002.
               CALL 'ZGW01ORU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01ORU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-EXCESS-0001.
