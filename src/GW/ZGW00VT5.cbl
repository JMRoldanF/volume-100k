      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZGW00VT5'.
      ...
      * Called module names
       01  MOD-ZGW01T8S              PIC X(8) VALUE 'ZGW01T8S'.
       01  MOD-ZGW01KOZ              PIC X(8) VALUE 'ZGW01KOZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZGW01T8S-001.
               PERFORM CALL-ZGW01KOZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01T8S-001.
               CALL 'ZGW01T8S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01T8S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZGW01KOZ-002.
               CALL 'ZGW01KOZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01KOZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
