      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZGW01222'.
      ...
      * Called module names
       01  MOD-ZDO01J73              PIC X(8) VALUE 'ZDO01J73'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01J73-001.
               CALL 'ZDO01J73' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01J73 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
