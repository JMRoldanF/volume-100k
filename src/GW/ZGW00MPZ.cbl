      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZGW00MPZ'.
      ...
      * Called module names
       01  MOD-ZGW01GGM              PIC X(8) VALUE 'ZGW01GGM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01GGM-001.
               CALL 'ZGW01GGM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01GGM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
