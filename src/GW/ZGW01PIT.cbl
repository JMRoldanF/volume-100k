      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZGW01PIT'.
      ...
      * Called module names
       01  MOD-ZGW01SGS              PIC X(8) VALUE 'ZGW01SGS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01SGS-001.
               CALL 'ZGW01SGS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01SGS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
