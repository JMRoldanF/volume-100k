      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZGW00R1U'.
      ...
      * Called module names
       ...
       01  MOD-ZGW01IY2              PIC X(8) VALUE 'ZGW01IY2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01IY2-002.
               CALL 'ZGW01IY2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01IY2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
