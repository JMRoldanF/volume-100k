      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZGW00V9U'.
      ...
      * Called module names
       01  MOD-ZGW01U5W              PIC X(8) VALUE 'ZGW01U5W'.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01U5W-001.
               CALL 'ZGW01U5W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01U5W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
