      ******************************************************************
      * ZGW00YXW - SERVICE GATEWAY                                     *
      ******************************************************************
      *
      *  Generated volume-test source. Layer 2,
      *  type data_db2, domain GATEWAY.
      ******************************************************************
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZGW00YXW'.
      ...
      * Called module names
       01  MOD-ZGW01E9I              PIC X(8) VALUE 'ZGW01E9I'.
       01  MOD-ZCP01H4P              PIC X(8) VALUE 'ZCP01H4P'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZGW01E9I-001.
               PERFORM CALL-ZCP01H4P-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01E9I-001.
               CALL 'ZGW01E9I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01E9I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCP01H4P-002.
               CALL 'ZCP01H4P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01H4P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
