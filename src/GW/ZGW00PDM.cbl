      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZGW00PDM'.
      ...
      * Called module names
       01  MOD-ZGW01RIC              PIC X(8) VALUE 'ZGW01RIC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01RIC-001.
               CALL 'ZGW01RIC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01RIC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
