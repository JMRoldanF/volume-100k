      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZGW010Y5'.
      ...
      * Called module names
       01  MOD-ZGW01RTF              PIC X(8) VALUE 'ZGW01RTF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZGW01RTF-001.
               PERFORM CALL-ZCP01K1Z-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01RTF-001.
               CALL 'ZGW01RTF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
