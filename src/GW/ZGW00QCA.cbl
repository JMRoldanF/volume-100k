      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZGW00QCA'.
      ...
      * Called module names
       01  MOD-ZGW01RCT              PIC X(8) VALUE 'ZGW01RCT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01RCT-001.
               CALL 'ZGW01RCT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01RCT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
