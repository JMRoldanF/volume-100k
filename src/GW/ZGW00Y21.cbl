      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZGW00Y21'.
      ...
      * Called module names
       01  MOD-ZGW01TN4              PIC X(8) VALUE 'ZGW01TN4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01TN4-001.
               CALL 'ZGW01TN4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01TN4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-EXCESS-0001.
