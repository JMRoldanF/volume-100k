      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZGW00XOI'.
      ...
      * Called module names
       ...
       01  MOD-ZGW01TUP              PIC X(8) VALUE 'ZGW01TUP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01TUP-002.
               CALL 'ZGW01TUP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01TUP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
