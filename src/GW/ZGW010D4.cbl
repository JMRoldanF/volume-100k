      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZGW010D4'.
      ...
      * Called module names
       ...
       01  MOD-ZGW01FTY              PIC X(8) VALUE 'ZGW01FTY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01FTY-002.
               CALL 'ZGW01FTY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01FTY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
