      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZGW00TJD'.
      ...
      * Called module names
       01  MOD-ZGW01SDF              PIC X(8) VALUE 'ZGW01SDF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01SDF-001.
               CALL 'ZGW01SDF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01SDF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-TERM-0001.
