      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZGW00X1Y'.
      ...
      * Called module names
       01  MOD-ZDO01KYA              PIC X(8) VALUE 'ZDO01KYA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZGW01Q7Y-001.
               PERFORM CALL-ZDO01KYA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01KYA-002.
               CALL 'ZDO01KYA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01KYA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
