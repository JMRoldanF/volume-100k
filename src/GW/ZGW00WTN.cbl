      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZGW00WTN'.
      ...
      * Called module names
       ...
       01  MOD-ZGW01NVL              PIC X(8) VALUE 'ZGW01NVL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01NVL-002.
               CALL 'ZGW01NVL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01NVL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
