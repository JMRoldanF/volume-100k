      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZGW00RI2'.
      ...
      * Called module names
       01  MOD-ZDO01FMZ              PIC X(8) VALUE 'ZDO01FMZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01FMZ-001.
               CALL 'ZDO01FMZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01FMZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
