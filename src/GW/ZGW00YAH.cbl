      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZGW00YAH'.
      ...
      * Called module names
       01  MOD-ZGW01EFO              PIC X(8) VALUE 'ZGW01EFO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01EFO-001.
               CALL 'ZGW01EFO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01EFO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZDO01II2-002.
