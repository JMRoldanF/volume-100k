      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZGW00Y7M'.
      ...
      * Called module names
       01  MOD-ZGW01OVC              PIC X(8) VALUE 'ZGW01OVC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01OVC-001.
               CALL 'ZGW01OVC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01OVC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       NORMALISE-TERM-0001.
