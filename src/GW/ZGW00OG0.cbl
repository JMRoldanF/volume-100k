      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZGW00OG0'.
      ...
      * Called module names
       01  MOD-ZCP01Q3E              PIC X(8) VALUE 'ZCP01Q3E'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01Q3E-001.
               CALL 'ZCP01Q3E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01Q3E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
