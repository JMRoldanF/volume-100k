      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZGW00NUN'.
      ...
      * Called module names
       01  MOD-ZGW01UYO              PIC X(8) VALUE 'ZGW01UYO'.
       01  MOD-ZDO01MVD              PIC X(8) VALUE 'ZDO01MVD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZGW01UYO-001.
               PERFORM CALL-ZDO01MVD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01UYO-001.
               CALL 'ZGW01UYO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01UYO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZDO01MVD-002.
               CALL 'ZDO01MVD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01MVD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
