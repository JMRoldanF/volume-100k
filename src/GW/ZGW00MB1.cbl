      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZGW00MB1'.
      ...
      * Called module names
       01  MOD-ZGW01KOV              PIC X(8) VALUE 'ZGW01KOV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZGW01KOV-002.
               PERFORM CALL-ZRE0255R-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZGW01H3W-001.
               MOVE 'ZGW01H3W' TO WS-SUBNAME-1
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01KOV-002.
               CALL 'ZGW01KOV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01KOV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
