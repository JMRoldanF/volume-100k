      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZGW00YII'.
      ...
      * Called module names
       01  MOD-ZGW01SMC              PIC X(8) VALUE 'ZGW01SMC'.
       01  MOD-ZGW01OEK              PIC X(8) VALUE 'ZGW01OEK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZGW01SMC-001.
               PERFORM CALL-ZGW01OEK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01SMC-001.
               CALL 'ZGW01SMC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01SMC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZGW01OEK-002.
               CALL 'ZGW01OEK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01OEK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
