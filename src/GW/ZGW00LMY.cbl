      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZGW00LMY'.
      ...
      * Called module names
       01  MOD-ZGW01THH              PIC X(8) VALUE 'ZGW01THH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZGW01THH-001.
               PERFORM CALL-ZGW01HO4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01THH-001.
               CALL 'ZGW01THH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01THH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZGW01HO4-002.
