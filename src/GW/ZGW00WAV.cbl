      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZGW00WAV'.
      ...
      * Called module names
       ...
       01  MOD-ZGW01FEE              PIC X(8) VALUE 'ZGW01FEE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01FEE-002.
               CALL 'ZGW01FEE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01FEE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
