      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZGW00ND0'.
      ...
      * Called module names
       01  MOD-ZGW01M96              PIC X(8) VALUE 'ZGW01M96'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZGW01M96-001.
               PERFORM CALL-ZCP01LZL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01M96-001.
               CALL 'ZGW01M96' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01M96 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCP01LZL-002.
