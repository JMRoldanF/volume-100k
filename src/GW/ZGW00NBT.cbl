      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZGW00NBT'.
      ...
      * Called module names
       01  MOD-ZGW01IFJ              PIC X(8) VALUE 'ZGW01IFJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01IFJ-001.
               CALL 'ZGW01IFJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01IFJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
