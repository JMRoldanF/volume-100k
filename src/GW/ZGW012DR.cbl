      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZGW012DR'.
      ...
      * Called module names
       01  MOD-ZGW01NPU              PIC X(8) VALUE 'ZGW01NPU'.
       01  MOD-ZGW01M2Z              PIC X(8) VALUE 'ZGW01M2Z'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZGW01NPU-001.
               PERFORM CALL-ZGW01M2Z-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01NPU-001.
               CALL 'ZGW01NPU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01NPU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZGW01M2Z-002.
               CALL 'ZGW01M2Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01M2Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
