      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZGW010DT'.
      ...
      * Called module names
       01  MOD-ZGW01CU3              PIC X(8) VALUE 'ZGW01CU3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01CU3-001.
               CALL 'ZGW01CU3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01CU3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
