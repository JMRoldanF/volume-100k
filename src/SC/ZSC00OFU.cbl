      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSC00OFU'.
      ...
      * Called module names
       01  MOD-ZSC01PFF              PIC X(8) VALUE 'ZSC01PFF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZNT01PFW-001.
               PERFORM CALL-ZSC01PFF-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSC01PFF-002.
               CALL 'ZSC01PFF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC01PFF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
