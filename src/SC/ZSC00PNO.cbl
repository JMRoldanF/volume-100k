      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSC00PNO'.
      ...
      * Called module names
       01  MOD-ZSC01ES3              PIC X(8) VALUE 'ZSC01ES3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSC01ES3-001.
               CALL 'ZSC01ES3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC01ES3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
