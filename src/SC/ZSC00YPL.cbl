      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSC00YPL'.
      ...
      * Called module names
       01  MOD-ZBA01KI4              PIC X(8) VALUE 'ZBA01KI4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBA01KI4-001.
               CALL 'ZBA01KI4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBA01KI4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
