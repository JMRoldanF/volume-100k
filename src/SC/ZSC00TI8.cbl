      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSC00TI8'.
      ...
      * Called module names
       01  MOD-ZSC01SQJ              PIC X(8) VALUE 'ZSC01SQJ'.
       01  MOD-ZSC01P7J              PIC X(8) VALUE 'ZSC01P7J'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSC01SQJ-001.
               PERFORM CALL-ZSC01P7J-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSC01SQJ-001.
               CALL 'ZSC01SQJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC01SQJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSC01P7J-002.
               CALL 'ZSC01P7J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC01P7J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
