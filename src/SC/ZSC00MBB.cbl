      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSC00MBB'.
      ...
      * Called module names
       01  MOD-ZSC01PA5              PIC X(8) VALUE 'ZSC01PA5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSC01PA5-001.
               CALL 'ZSC01PA5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC01PA5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
