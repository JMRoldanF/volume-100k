      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSC00WLO'.
      ...
      * Called module names
       01  MOD-ZSC01NTN              PIC X(8) VALUE 'ZSC01NTN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSC01NTN-002.
               CALL 'ZSC01NTN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC01NTN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
