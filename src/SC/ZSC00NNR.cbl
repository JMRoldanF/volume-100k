      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSC00NNR'.
      ...
      * Called module names
       01  MOD-ZSC01UEH              PIC X(8) VALUE 'ZSC01UEH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSC01UEH-001.
               CALL 'ZSC01UEH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC01UEH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
