      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSC00OFZ'.
      ...
      * Called module names
       01  MOD-ZCN01RCX              PIC X(8) VALUE 'ZCN01RCX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCN01RCX-001.
               PERFORM CALL-ZBA01SQU-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCN01RCX-001.
               CALL 'ZCN01RCX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCN01RCX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBA01SQU-002.
               MOVE 'ZBA01SQU' TO WS-SUBNAME-7
