      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSC00BU8'.
      ...
      * Called module names
       01  MOD-ZSC01BMK              PIC X(8) VALUE 'ZSC01BMK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSC011IS-001.
               PERFORM CALL-ZSC01BMK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSC011IS-001.
               MOVE 'ZSC011IS' TO WS-PROGNAME-7
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC011IS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSC01BMK-002.
               EXEC CICS LINK PROGRAM('ZSC01BMK')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC01BMK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
