      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSC00VEQ'.
      ...
      * Called module names
       ...
       01  MOD-ZSC01DA0              PIC X(8) VALUE 'ZSC01DA0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSC01I84-001.
               PERFORM CALL-ZSC01DA0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSC01DA0-002.
               CALL 'ZSC01DA0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC01DA0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       WRITE-ERROR-MESSAGE.
