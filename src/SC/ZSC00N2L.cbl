      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSC00N2L'.
      ...
      * Called module names
       01  MOD-ZSC01TVR              PIC X(8) VALUE 'ZSC01TVR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSC01TVR-001.
               CALL 'ZSC01TVR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC01TVR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSC01NFE-002.
