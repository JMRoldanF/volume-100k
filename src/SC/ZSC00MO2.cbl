      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSC00MO2'.
      ...
      * Called module names
       01  MOD-ZSC01NKT              PIC X(8) VALUE 'ZSC01NKT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSC01NKT-001.
               CALL 'ZSC01NKT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC01NKT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSC01P4G-002.
