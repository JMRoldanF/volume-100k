      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSC00XVA'.
      ...
      * Called module names
       01  MOD-ZSC01UC8              PIC X(8) VALUE 'ZSC01UC8'.
       01  MOD-ZSC01QTD              PIC X(8) VALUE 'ZSC01QTD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSC01UC8-001.
               PERFORM CALL-ZSC01QTD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSC01UC8-001.
               CALL 'ZSC01UC8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC01UC8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSC01QTD-002.
               CALL 'ZSC01QTD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC01QTD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
