      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSC00XQM'.
      ...
      * Called module names
       01  MOD-ZBA01UIV              PIC X(8) VALUE 'ZBA01UIV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBA01UIV-001.
               CALL 'ZBA01UIV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBA01UIV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-TERM-0001.
