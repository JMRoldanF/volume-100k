      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSC01AXI'.
      ...
      * Called module names
       01  MOD-ZSC01RMB              PIC X(8) VALUE 'ZSC01RMB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSC01RMB-001.
               CALL 'ZSC01RMB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC01RMB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSC01D09-002.
               MOVE 'ZSC01D09' TO WS-SUBNAME-3
