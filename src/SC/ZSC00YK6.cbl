      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSC00YK6'.
      ...
      * Called module names
       01  MOD-ZSC01UGP              PIC X(8) VALUE 'ZSC01UGP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSC01UGP-001.
               PERFORM CALL-ZSC01TI2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSC01UGP-001.
               CALL 'ZSC01UGP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC01UGP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSC01TI2-002.
