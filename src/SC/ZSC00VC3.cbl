      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSC00VC3'.
      ...
      * Called module names
       01  MOD-ZSC01V0K              PIC X(8) VALUE 'ZSC01V0K'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSC01V0K-001.
               CALL 'ZSC01V0K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC01V0K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
