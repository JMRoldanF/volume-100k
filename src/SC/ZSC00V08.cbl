      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSC00V08'.
      ...
      * Called module names
       01  MOD-ZSC01UTY              PIC X(8) VALUE 'ZSC01UTY'.
       01  MOD-ZAV01DPX              PIC X(8) VALUE 'ZAV01DPX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSC01UTY-001.
               PERFORM CALL-ZAV01DPX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSC01UTY-001.
               CALL 'ZSC01UTY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC01UTY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAV01DPX-002.
               CALL 'ZAV01DPX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01DPX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
