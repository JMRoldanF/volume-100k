      ******************************************************************
      * ZSC00R49 - JOB SCHEDULING                                      *
      ******************************************************************
      *
      *  Generated volume-test source. Layer 2,
      *  type data_db2, domain SCHEDUL.
      ******************************************************************
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSC00R49'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM AUDIT-MANAGED-FUND-0067.
               ...
               PERFORM COMPUTE-REG-NUMBER-0092.
               ...
               PERFORM VALIDATE-BROKER-ID-0098.
               ...
               PERFORM CHECK-AGENT-CODE-0112.
               PERFORM CHECK-MANAGED-FUND-0113.
       ...
       SQL-ACCESS-0006.
               EXEC SQL
                     ...
                     SELECT POLICYNUMBER, PAYMENT
                       FROM GENASC.CONTACT A
                       JOIN GENASC.CUSTOMER B
