      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSC00OZB'.
      ...
      * Called module names
       01  MOD-ZSC01R7A              PIC X(8) VALUE 'ZSC01R7A'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSC01R7A-001.
               CALL 'ZSC01R7A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC01R7A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
