      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSC00SKY'.
      ...
      * Called module names
       01  MOD-ZSC01M17              PIC X(8) VALUE 'ZSC01M17'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSC01M17-001.
               PERFORM CALL-ZSC01JN7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSC01M17-001.
               CALL 'ZSC01M17' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC01M17 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSC01JN7-002.
