      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSC00W44'.
      ...
      * Called module names
       01  MOD-ZSC01GTB              PIC X(8) VALUE 'ZSC01GTB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSC01GTB-001.
               CALL 'ZSC01GTB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC01GTB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
