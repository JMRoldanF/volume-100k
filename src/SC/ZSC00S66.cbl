      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSC00S66'.
      ...
      * Called module names
       01  MOD-ZSC01D1K              PIC X(8) VALUE 'ZSC01D1K'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSC01D1K-001.
               CALL 'ZSC01D1K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC01D1K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-EQUITIES-0001.
