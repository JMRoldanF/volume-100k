      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSC00LUF'.
      ...
      * Called module names
       01  MOD-ZSC01MML              PIC X(8) VALUE 'ZSC01MML'.
       01  MOD-ZSC01PTI              PIC X(8) VALUE 'ZSC01PTI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSC01MML-001.
               PERFORM CALL-ZSC01PTI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSC01MML-001.
               CALL 'ZSC01MML' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC01MML FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSC01PTI-002.
               CALL 'ZSC01PTI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC01PTI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
