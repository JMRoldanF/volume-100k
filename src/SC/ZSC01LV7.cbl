      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSC01LV7'.
      ...
      * Called module names
       01  MOD-ZSC01DIZ              PIC X(8) VALUE 'ZSC01DIZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSC01DIZ-001.
               CALL 'ZSC01DIZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC01DIZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-MODEL-0001.
