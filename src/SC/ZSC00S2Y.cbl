      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSC00S2Y'.
      ...
      * Called module names
       01  MOD-ZSC01K13              PIC X(8) VALUE 'ZSC01K13'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSC01O56-001.
               PERFORM CALL-ZSC01K13-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSC01K13-002.
               CALL 'ZSC01K13' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC01K13 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
