      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA024I0'.
      ...
      * Called module names
       01  MOD-ZVA01FFK              PIC X(8) VALUE 'ZVA01FFK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZVA01FFK-001.
               PERFORM CALL-ZVA01O9F-002.
               PERFORM CALL-ZVA00MBR-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZVA01FFK-001.
               CALL 'ZVA01FFK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZVA01FFK FAILED' TO EM-VARIABLE
      ...
      *----------------------------------------------------------------*
       CALL-ZVA00MBR-003.
               MOVE 'ZVA00MBR' TO WS-SUBNAME-7
               CALL WS-SUBNAME-7 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZVA00MBR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
