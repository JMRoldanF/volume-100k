      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA00QSB'.
      ...
      * Called module names
       01  MOD-ZVA01RXM              PIC X(8) VALUE 'ZVA01RXM'.
       01  MOD-ZVA01N0I              PIC X(8) VALUE 'ZVA01N0I'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZVA01RXM-001.
               PERFORM CALL-ZVA01N0I-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZVA01RXM-001.
               CALL 'ZVA01RXM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZVA01RXM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZVA01N0I-002.
               CALL 'ZVA01N0I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZVA01N0I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
