      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA0058E'.
      ...
      * Called module names
       01  MOD-ZVA00GRU              PIC X(8) VALUE 'ZVA00GRU'.
       01  MOD-ZVA00IAN              PIC X(8) VALUE 'ZVA00IAN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZVA00GRU-001.
               PERFORM CALL-ZVA00IAN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZVA00GRU-001.
               EXEC CICS LINK PROGRAM('ZVA00GRU')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZVA00GRU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZVA00IAN-002.
               EXEC CICS LINK PROGRAM('ZVA00IAN')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZVA00IAN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
