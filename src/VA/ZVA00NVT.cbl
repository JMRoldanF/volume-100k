      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA00NVT'.
      ...
      * Called module names
       ...
       01  MOD-ZVA01H5O              PIC X(8) VALUE 'ZVA01H5O'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFL01E74-001.
               PERFORM CALL-ZVA01H5O-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZVA01H5O-002.
               CALL 'ZVA01H5O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZVA01H5O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
