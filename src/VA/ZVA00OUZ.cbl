      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA00OUZ'.
      ...
      * Called module names
       01  MOD-ZVA01MC4              PIC X(8) VALUE 'ZVA01MC4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZVA01MC4-001.
               CALL 'ZVA01MC4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZVA01MC4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
