      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA00LVN'.
      ...
      * Called module names
       01  MOD-ZVA01TAG              PIC X(8) VALUE 'ZVA01TAG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZVA01TAG-001.
               CALL 'ZVA01TAG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZVA01TAG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
