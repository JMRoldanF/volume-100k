      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA011FJ'.
      ...
      * Called module names
       01  MOD-ZVA01HLT              PIC X(8) VALUE 'ZVA01HLT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZVA01HLT-001.
               CALL 'ZVA01HLT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZVA01HLT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
