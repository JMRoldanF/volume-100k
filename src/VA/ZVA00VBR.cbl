      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA00VBR'.
      ...
      * Called module names
       01  MOD-ZVA01U45              PIC X(8) VALUE 'ZVA01U45'.
      ...
      *----------------------------------------------------------------*
       CALL-ZVA01U45-001.
               CALL 'ZVA01U45' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZVA01U45 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZVA01O5F-002.
