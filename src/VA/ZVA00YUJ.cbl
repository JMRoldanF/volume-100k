      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA00YUJ'.
      ...
      * Called module names
       01  MOD-ZVA01JKD              PIC X(8) VALUE 'ZVA01JKD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZVA01JKD-001.
               CALL 'ZVA01JKD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZVA01JKD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
