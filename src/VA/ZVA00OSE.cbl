      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA00OSE'.
      ...
      * Called module names
       ...
       01  MOD-ZVA01QOT              PIC X(8) VALUE 'ZVA01QOT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZVA01QOT-002.
               CALL 'ZVA01QOT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZVA01QOT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
