      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA00Z7S'.
      ...
      * Called module names
       ...
       01  MOD-ZVA01SB3              PIC X(8) VALUE 'ZVA01SB3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZVA01NM8-001.
               PERFORM CALL-ZVA01SB3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZVA01SB3-002.
               CALL 'ZVA01SB3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZVA01SB3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
