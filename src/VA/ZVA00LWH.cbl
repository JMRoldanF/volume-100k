      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA00LWH'.
      ...
      * Called module names
       01  MOD-ZVA01CO3              PIC X(8) VALUE 'ZVA01CO3'.
       01  MOD-ZVA01EGP              PIC X(8) VALUE 'ZVA01EGP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZVA01CO3-001.
               PERFORM CALL-ZVA01EGP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZVA01CO3-001.
               CALL 'ZVA01CO3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZVA01CO3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZVA01EGP-002.
               CALL 'ZVA01EGP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
