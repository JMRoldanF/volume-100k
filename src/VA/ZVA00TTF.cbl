      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA00TTF'.
      ...
      * Called module names
       01  MOD-ZVA01FA9              PIC X(8) VALUE 'ZVA01FA9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZVA01FA9-001.
               CALL 'ZVA01FA9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZVA01FA9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
