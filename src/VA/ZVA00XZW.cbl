      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA00XZW'.
      ...
      * Called module names
       01  MOD-ZVA01P8M              PIC X(8) VALUE 'ZVA01P8M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZVA01P8M-001.
               CALL 'ZVA01P8M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZVA01P8M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZVA01OC3-002.
