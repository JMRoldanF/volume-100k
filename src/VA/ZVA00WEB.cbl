      ******************************************************************
      * ZVA00WEB - ASSET VALUATION                                     *
      ******************************************************************
      *
      *  Generated volume-test source. Layer 2,
      *  type data_db2, domain VALUATN.
      ******************************************************************
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA00WEB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM NORMALISE-WITH-PROFITS-0022.
               PERFORM VALIDATE-CC-RATING-0023.
               PERFORM NORMALISE-REG-NUMBER-0025.
               PERFORM CHECK-REG-NUMBER-0026.
               ...
               PERFORM NORMALISE-ROOF-TYPE-0056.
               ...
               PERFORM DERIVE-SUM-ASSURED-0125.
       ...
       SQL-ACCESS-0009.
               EXEC SQL
                     ...
                     SELECT POLICYNUMBER, PAYMENT
                       FROM GENAVA.ENDORSE A
                       JOIN GENAVA.CUSTOMER B
