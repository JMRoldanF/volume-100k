      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA00RK6'.
      ...
      * Called module names
       01  MOD-ZFL01NLI              PIC X(8) VALUE 'ZFL01NLI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01NLI-001.
               CALL 'ZFL01NLI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01NLI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
