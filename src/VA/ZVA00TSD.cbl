      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA00TSD'.
      ...
      * Called module names
       01  MOD-ZVA01QOP              PIC X(8) VALUE 'ZVA01QOP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZVA01QOP-001.
               CALL 'ZVA01QOP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZVA01QOP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
