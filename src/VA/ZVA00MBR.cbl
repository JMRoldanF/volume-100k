      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA00MBR'.
      ...
      * Called module names
       01  MOD-ZVA01FU2              PIC X(8) VALUE 'ZVA01FU2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZVA01FU2-001.
               PERFORM CALL-ZVA01JHY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZVA01FU2-001.
               CALL 'ZVA01FU2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZVA01FU2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZVA01JHY-002.
