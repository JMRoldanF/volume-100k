      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA012BB'.
      ...
      * Called module names
       01  MOD-ZVA01PBQ              PIC X(8) VALUE 'ZVA01PBQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZVA01PBQ-001.
               CALL 'ZVA01PBQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZVA01PBQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
