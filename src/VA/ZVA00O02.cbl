      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA00O02'.
      ...
      * Called module names
       01  MOD-ZFL01IUA              PIC X(8) VALUE 'ZFL01IUA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01IUA-001.
               CALL 'ZFL01IUA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01IUA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
