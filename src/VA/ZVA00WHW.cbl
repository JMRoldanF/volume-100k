      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA00WHW'.
      ...
      * Called module names
       01  MOD-ZVA01HZ5              PIC X(8) VALUE 'ZVA01HZ5'.
       01  MOD-ZVA01GHR              PIC X(8) VALUE 'ZVA01GHR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZVA01HZ5-001.
               PERFORM CALL-ZVA01GHR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZVA01HZ5-001.
               CALL 'ZVA01HZ5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZVA01GHR-002.
               CALL 'ZVA01GHR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZVA01GHR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
