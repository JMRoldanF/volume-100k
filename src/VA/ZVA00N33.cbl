      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA00N33'.
      ...
      * Called module names
       01  MOD-ZBR01UB1              PIC X(8) VALUE 'ZBR01UB1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01UB1-001.
               CALL 'ZBR01UB1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01UB1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-POSTCODE-0001.
