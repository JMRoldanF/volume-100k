      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA00S9Q'.
      ...
      * Called module names
       ...
       01  MOD-ZVA01JM1              PIC X(8) VALUE 'ZVA01JM1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFL01OHW-001.
               PERFORM CALL-ZVA01JM1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZVA01JM1-002.
               CALL 'ZVA01JM1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZVA01JM1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
