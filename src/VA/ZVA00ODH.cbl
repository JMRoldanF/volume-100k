      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA00ODH'.
      ...
      * Called module names
       01  MOD-ZVA01OEC              PIC X(8) VALUE 'ZVA01OEC'.
       01  MOD-ZVA01FK0              PIC X(8) VALUE 'ZVA01FK0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZVA01OEC-001.
               PERFORM CALL-ZVA01FK0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZVA01OEC-001.
               CALL 'ZVA01OEC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZVA01OEC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZVA01FK0-002.
               CALL 'ZVA01FK0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZVA01FK0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
