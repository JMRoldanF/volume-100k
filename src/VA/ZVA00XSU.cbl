      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA00XSU'.
      ...
      * Called module names
       ...
       01  MOD-ZSB01G27              PIC X(8) VALUE 'ZSB01G27'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZVA01SQL-001.
               PERFORM CALL-ZSB01G27-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSB01G27-002.
               CALL 'ZSB01G27' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSB01G27 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
