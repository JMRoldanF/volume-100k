      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA010CR'.
      ...
      * Called module names
       01  MOD-ZBR01G6G              PIC X(8) VALUE 'ZBR01G6G'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01G6G-001.
               CALL 'ZBR01G6G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01G6G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
