      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA00XBR'.
      ...
      * Called module names
       01  MOD-ZVA01F5Z              PIC X(8) VALUE 'ZVA01F5Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZVA01F5Z-001.
               CALL 'ZVA01F5Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZVA01F5Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
