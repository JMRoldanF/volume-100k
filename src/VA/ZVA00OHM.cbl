      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA00OHM'.
      ...
      * Called module names
       01  MOD-ZVA01PWB              PIC X(8) VALUE 'ZVA01PWB'.
       01  MOD-ZVA01UAD              PIC X(8) VALUE 'ZVA01UAD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZVA01PWB-001.
               PERFORM CALL-ZVA01UAD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZVA01PWB-001.
               CALL 'ZVA01PWB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZVA01PWB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZVA01UAD-002.
               CALL 'ZVA01UAD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZVA01UAD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
