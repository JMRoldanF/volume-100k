      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA00Q8E'.
      ...
      * Called module names
       01  MOD-ZVA01Q2Y              PIC X(8) VALUE 'ZVA01Q2Y'.
      ...
      *----------------------------------------------------------------*
       CALL-ZVA01Q2Y-001.
               CALL 'ZVA01Q2Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZVA01Q2Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
