      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA00WLE'.
      ...
      * Called module names
       01  MOD-ZVA01MLQ              PIC X(8) VALUE 'ZVA01MLQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZVA01MLQ-001.
               CALL 'ZVA01MLQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZVA01MLQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
