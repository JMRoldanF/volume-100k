      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZVA00ZZ1'.
      ...
      * Called module names
       01  MOD-ZBR01NQM              PIC X(8) VALUE 'ZBR01NQM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBR01NQM-001.
               PERFORM CALL-ZSB01MEI-002.
               PERFORM CALL-ZCU0255O-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZBR01NQM-001.
               CALL 'ZBR01NQM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
