      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMB00OUE'.
      ...
      * Called module names
       01  MOD-ZMB01PRL              PIC X(8) VALUE 'ZMB01PRL'.
       01  MOD-ZMB01QQP              PIC X(8) VALUE 'ZMB01QQP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMB01PRL-001.
               PERFORM CALL-ZMB01QQP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMB01PRL-001.
               CALL 'ZMB01PRL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMB01PRL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMB01QQP-002.
               CALL 'ZMB01QQP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMB01QQP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
