      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMB00WYP'.
      ...
      * Called module names
       ...
       01  MOD-ZPE01LEZ              PIC X(8) VALUE 'ZPE01LEZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMB01M8C-001.
               PERFORM CALL-ZPE01LEZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01LEZ-002.
               CALL 'ZPE01LEZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01LEZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-COLOUR-0001.
