      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMB00M4J'.
      ...
      * Called module names
       ...
       01  MOD-ZRS01EVS              PIC X(8) VALUE 'ZRS01EVS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMB01LBK-001.
               PERFORM CALL-ZRS01EVS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01EVS-002.
               CALL 'ZRS01EVS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01EVS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
