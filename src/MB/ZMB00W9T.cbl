      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMB00W9T'.
      ...
      * Called module names
       01  MOD-ZMB01NFL              PIC X(8) VALUE 'ZMB01NFL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMB01NFL-001.
               CALL 'ZMB01NFL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMB01NFL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMB01QQG-002.
