      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMB00OMK'.
      ...
      * Called module names
       01  MOD-ZPE01JPL              PIC X(8) VALUE 'ZPE01JPL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPE01JPL-001.
               PERFORM CALL-ZSC01N7I-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01JPL-001.
               CALL 'ZPE01JPL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01JPL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSC01N7I-002.
