      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMB00RGE'.
      ...
      * Called module names
       01  MOD-ZPE01I3Y              PIC X(8) VALUE 'ZPE01I3Y'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM NORMALISE-BEDROOMS-0092.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01I3Y-001.
               CALL 'ZPE01I3Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01I3Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
