      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMB00YTJ'.
      ...
      * Called module names
       01  MOD-ZMB01EVK              PIC X(8) VALUE 'ZMB01EVK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMB01EVK-001.
               CALL 'ZMB01EVK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMB01EVK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
