      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMB00SO9'.
      ...
      * Called module names
       01  MOD-ZMB01DSR              PIC X(8) VALUE 'ZMB01DSR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMB01DSR-001.
               CALL 'ZMB01DSR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMB01DSR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMB01RUE-002.
               MOVE 'ZMB01RUE' TO WS-SUBNAME-2
