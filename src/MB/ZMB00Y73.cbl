      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMB00Y73'.
      ...
      * Called module names
       01  MOD-ZMB01U5E              PIC X(8) VALUE 'ZMB01U5E'.
       01  MOD-ZMB01U7W              PIC X(8) VALUE 'ZMB01U7W'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMB01U5E-001.
               CALL 'ZMB01U5E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMB01U5E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMB01U7W-002.
               CALL 'ZMB01U7W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMB01U7W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
