      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMB01R0M'.
      ...
      * Called module names
       01  MOD-ZMB01TG1              PIC X(8) VALUE 'ZMB01TG1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMB01TG1-001.
               PERFORM CALL-ZMB01F77-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMB01TG1-001.
               CALL 'ZMB01TG1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMB01TG1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMB01F77-002.
