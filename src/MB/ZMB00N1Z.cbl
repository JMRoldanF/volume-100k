      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMB00N1Z'.
      ...
      * Called module names
       01  MOD-ZRS01R1O              PIC X(8) VALUE 'ZRS01R1O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01R1O-001.
               CALL 'ZRS01R1O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01R1O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSC01U64-002.
