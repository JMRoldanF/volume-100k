      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMB00Q1L'.
      ...
      * Called module names
       01  MOD-ZMB01E68              PIC X(8) VALUE 'ZMB01E68'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMB01E68-001.
               CALL 'ZMB01E68' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMB01E68 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
