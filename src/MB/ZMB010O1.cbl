      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMB010O1'.
      ...
      * Called module names
       01  MOD-ZPE01OI7              PIC X(8) VALUE 'ZPE01OI7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01OI7-001.
               CALL 'ZPE01OI7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01OI7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMB01LID-002.
