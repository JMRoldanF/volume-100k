      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMB00OR1'.
      ...
      * Called module names
       01  MOD-ZRS01G5K              PIC X(8) VALUE 'ZRS01G5K'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRS01G5K-001.
               PERFORM CALL-ZMB01S0P-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01G5K-001.
               CALL 'ZRS01G5K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01G5K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMB01S0P-002.
