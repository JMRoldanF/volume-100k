      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMB00YCB'.
      ...
      * Called module names
       ...
       01  MOD-ZMB01KIY              PIC X(8) VALUE 'ZMB01KIY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMB01GPS-001.
               PERFORM CALL-ZMB01KIY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMB01KIY-002.
               CALL 'ZMB01KIY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMB01KIY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
