      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMB0111K'.
      ...
      * Called module names
       ...
       01  MOD-ZMB01CP5              PIC X(8) VALUE 'ZMB01CP5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMB01CP5-002.
               CALL 'ZMB01CP5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMB01CP5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
