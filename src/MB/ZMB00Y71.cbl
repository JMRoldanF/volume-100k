      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMB00Y71'.
      ...
      * Called module names
       01  MOD-ZMB01L1C              PIC X(8) VALUE 'ZMB01L1C'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMB01L1C-001.
               CALL 'ZMB01L1C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMB01L1C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
