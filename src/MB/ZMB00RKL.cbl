      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMB00RKL'.
      ...
      * Called module names
       01  MOD-ZMB01QE7              PIC X(8) VALUE 'ZMB01QE7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMB01QE7-001.
               CALL 'ZMB01QE7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMB01QE7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
