      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMB00ONI'.
      ...
      * Called module names
       01  MOD-ZMB01UOA              PIC X(8) VALUE 'ZMB01UOA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMB01UOA-001.
               CALL 'ZMB01UOA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMB01UOA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-TAX-BAND-0001.
