      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMB010GJ'.
      ...
      * Called module names
       01  MOD-ZMB01E8D              PIC X(8) VALUE 'ZMB01E8D'.
       01  MOD-ZMB01KGE              PIC X(8) VALUE 'ZMB01KGE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMB01E8D-001.
               PERFORM CALL-ZMB01KGE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMB01E8D-001.
               CALL 'ZMB01E8D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMB01E8D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMB01KGE-002.
               CALL 'ZMB01KGE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMB01KGE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
