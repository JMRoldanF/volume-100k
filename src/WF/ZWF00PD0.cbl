      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZWF00PD0'.
      ...
      * Called module names
       01  MOD-ZWF01SNV              PIC X(8) VALUE 'ZWF01SNV'.
       01  MOD-ZWF01PV3              PIC X(8) VALUE 'ZWF01PV3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZWF01SNV-001.
               PERFORM CALL-ZWF01PV3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZWF01SNV-001.
               CALL 'ZWF01SNV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZWF01SNV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZWF01PV3-002.
               CALL 'ZWF01PV3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZWF01PV3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
