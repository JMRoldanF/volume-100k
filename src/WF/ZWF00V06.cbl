      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZWF00V06'.
      ...
      * Called module names
       ...
       01  MOD-ZWF01D3W              PIC X(8) VALUE 'ZWF01D3W'.
      ...
      *----------------------------------------------------------------*
       CALL-ZWF01D3W-002.
               CALL 'ZWF01D3W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZWF01D3W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-MODEL-0001.
