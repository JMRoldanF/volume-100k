      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZWF00XNH'.
      ...
      * Called module names
       ...
       01  MOD-ZWF01R5M              PIC X(8) VALUE 'ZWF01R5M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZWF01R5M-002.
               CALL 'ZWF01R5M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
