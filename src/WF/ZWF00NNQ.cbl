      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZWF00NNQ'.
      ...
      * Called module names
       ...
       01  MOD-ZWF01JS0              PIC X(8) VALUE 'ZWF01JS0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZWF01JS0-002.
               CALL 'ZWF01JS0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZWF01JS0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
