      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZWF00SI2'.
      ...
      * Called module names
       01  MOD-ZWF01N7E              PIC X(8) VALUE 'ZWF01N7E'.
      ...
      *----------------------------------------------------------------*
       CALL-ZWF01N7E-001.
               CALL 'ZWF01N7E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZWF01N7E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
