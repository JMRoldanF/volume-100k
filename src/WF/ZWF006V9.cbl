      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZWF006V9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZWF00YCV-001.
               PERFORM CALL-ZWF010NQ-002.
               PERFORM CALL-ZWF01V3V-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZWF00YCV-001.
               MOVE 'ZWF00YCV' TO WS-PROGNAME-6
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZWF00YCV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZWF010NQ-002.
               MOVE 'ZWF010NQ' TO WS-PROGNAME-7
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZWF010NQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZWF01V3V-003.
