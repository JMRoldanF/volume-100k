      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZWF00SH9'.
      ...
      * Called module names
       01  MOD-ZWF01EHU              PIC X(8) VALUE 'ZWF01EHU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZWF01EHU-001.
               CALL 'ZWF01EHU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZWF01EHU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
