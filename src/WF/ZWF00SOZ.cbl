      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZWF00SOZ'.
      ...
      * Called module names
       01  MOD-ZWF01IKT              PIC X(8) VALUE 'ZWF01IKT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZWF01IKT-001.
               CALL 'ZWF01IKT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZWF01IKT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
