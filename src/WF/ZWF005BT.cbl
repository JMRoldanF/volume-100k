      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZWF005BT'.
      ...
      * Called module names
       01  MOD-ZWF00IWU              PIC X(8) VALUE 'ZWF00IWU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZWF007EV-001.
               PERFORM CALL-ZWF00547-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZWF007EV-001.
               MOVE 'ZWF007EV' TO WS-PROGNAME-3
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZWF007EV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZWF00IWU-002.
               EXEC CICS LINK PROGRAM('ZWF00IWU')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZWF00IWU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZWF00547-003.
               EXEC CICS START TRANSID('Z547')
                         FROM(WS-KEY-AREA)
                         LENGTH(20)
                         RESP(WS-RESP)
               END-EXEC.
      * TRANSID Z547 is defined against ZWF00547
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZWF00547 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
