      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZWF00LMT'.
      ...
      * Called module names
       ...
       01  MOD-ZWF01HSQ              PIC X(8) VALUE 'ZWF01HSQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZWF01JG1-001.
               PERFORM CALL-ZWF01HSQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZWF01HSQ-002.
               CALL 'ZWF01HSQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZWF01HSQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
