      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZWF00PFO'.
      ...
      * Called module names
       ...
       01  MOD-ZWF01TAJ              PIC X(8) VALUE 'ZWF01TAJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZWF01TAJ-002.
               CALL 'ZWF01TAJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZWF01TAJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
