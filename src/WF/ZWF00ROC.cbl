      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZWF00ROC'.
      ...
      * Called module names
       01  MOD-ZWF01G2U              PIC X(8) VALUE 'ZWF01G2U'.
      ...
      *----------------------------------------------------------------*
       CALL-ZWF01G2U-002.
               CALL 'ZWF01G2U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
