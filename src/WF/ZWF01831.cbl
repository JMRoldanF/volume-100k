      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZWF01831'.
      ...
      * Called module names
       01  MOD-ZSL01GO5              PIC X(8) VALUE 'ZSL01GO5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSL01GO5-001.
               CALL 'ZSL01GO5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSL01GO5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
