      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZWF0122U'.
      ...
      * Called module names
       01  MOD-ZWF01GVO              PIC X(8) VALUE 'ZWF01GVO'.
       01  MOD-ZWF01CPG              PIC X(8) VALUE 'ZWF01CPG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZWF01GVO-001.
               PERFORM CALL-ZWF01CPG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZWF01GVO-001.
               CALL 'ZWF01GVO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZWF01GVO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZWF01CPG-002.
               CALL 'ZWF01CPG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZWF01CPG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
