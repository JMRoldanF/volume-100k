      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZWF00TDJ'.
      ...
      * Called module names
       01  MOD-ZWF01P3X              PIC X(8) VALUE 'ZWF01P3X'.
      ...
      *----------------------------------------------------------------*
       CALL-ZWF01P3X-001.
               CALL 'ZWF01P3X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZWF01P3X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
