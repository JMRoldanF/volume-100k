      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZWF00TJX'.
      ...
      * Called module names
       01  MOD-ZWF01PD1              PIC X(8) VALUE 'ZWF01PD1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZWF01PD1-001.
               CALL 'ZWF01PD1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZWF01PD1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
