      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZWF00YYP'.
      ...
      * Called module names
       01  MOD-ZCU01MR5              PIC X(8) VALUE 'ZCU01MR5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01MR5-001.
               CALL 'ZCU01MR5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01MR5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
