      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZWF00OWA'.
      ...
      * Called module names
       01  MOD-ZWF01F25              PIC X(8) VALUE 'ZWF01F25'.
      ...
      *----------------------------------------------------------------*
       CALL-ZWF01F25-001.
               CALL 'ZWF01F25' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZWF01F25 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
