      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZWF00T4O'.
      ...
      * Called module names
       01  MOD-ZWF01JL4              PIC X(8) VALUE 'ZWF01JL4'.
       01  MOD-ZWF01PZR              PIC X(8) VALUE 'ZWF01PZR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZWF01JL4-001.
               PERFORM CALL-ZWF01PZR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZWF01JL4-001.
               CALL 'ZWF01JL4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZWF01JL4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZWF01PZR-002.
               CALL 'ZWF01PZR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZWF01PZR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
