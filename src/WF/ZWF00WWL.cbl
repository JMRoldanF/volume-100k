      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZWF00WWL'.
      ...
      * Called module names
       01  MOD-ZWF01QEK              PIC X(8) VALUE 'ZWF01QEK'.
       01  MOD-ZCU01IVO              PIC X(8) VALUE 'ZCU01IVO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZWF01QEK-001.
               CALL 'ZWF01QEK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZWF01QEK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01IVO-002.
               CALL 'ZCU01IVO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01IVO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
