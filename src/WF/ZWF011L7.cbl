      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZWF011L7'.
      ...
      * Called module names
       01  MOD-ZWF01ENS              PIC X(8) VALUE 'ZWF01ENS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZWF01ENS-001.
               CALL 'ZWF01ENS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZWF01ENS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
