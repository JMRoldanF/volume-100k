      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZWF00QXX'.
      ...
      * Called module names
       01  MOD-ZWF01DL9              PIC X(8) VALUE 'ZWF01DL9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZWF01DL9-001.
               CALL 'ZWF01DL9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZWF01DL9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
