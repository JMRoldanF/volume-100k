      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG01200'.
      ...
      * Called module names
       01  MOD-ZRG01IPL              PIC X(8) VALUE 'ZRG01IPL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01IPL-001.
               CALL 'ZRG01IPL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01IPL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
