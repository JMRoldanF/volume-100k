      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00NI3'.
      ...
      * Called module names
       01  MOD-ZRG01R6R              PIC X(8) VALUE 'ZRG01R6R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01R6R-001.
               CALL 'ZRG01R6R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01R6R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRG01REB-002.
