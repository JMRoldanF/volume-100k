      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00TI1'.
      ...
      * Called module names
       ...
       01  MOD-ZRG01TXH              PIC X(8) VALUE 'ZRG01TXH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01TXH-002.
               CALL 'ZRG01TXH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01TXH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
