      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00Z80'.
      ...
      * Called module names
       01  MOD-ZRG01P6U              PIC X(8) VALUE 'ZRG01P6U'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01P6U-001.
               CALL 'ZRG01P6U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01P6U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
