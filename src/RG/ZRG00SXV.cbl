      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00SXV'.
      ...
      * Called module names
       01  MOD-ZRG01ST0              PIC X(8) VALUE 'ZRG01ST0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRG01ST0-001.
               PERFORM CALL-ZRG01FFV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01ST0-001.
               CALL 'ZRG01ST0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01ST0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRG01FFV-002.
               MOVE 'ZRG01FFV' TO WS-SUBNAME-7
