      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00M8O'.
      ...
      * Called module names
       01  MOD-ZRG01UYE              PIC X(8) VALUE 'ZRG01UYE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01UYE-001.
               CALL 'ZRG01UYE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01UYE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
