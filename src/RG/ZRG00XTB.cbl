      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00XTB'.
      ...
      * Called module names
       01  MOD-ZRG01REB              PIC X(8) VALUE 'ZRG01REB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRG01REB-001.
               PERFORM CALL-ZRG01G40-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01REB-001.
               CALL 'ZRG01REB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01REB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRG01G40-002.
               MOVE 'ZRG01G40' TO WS-SUBNAME-7
