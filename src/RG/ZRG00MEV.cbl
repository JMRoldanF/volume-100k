      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00MEV'.
      ...
      * Called module names
       01  MOD-ZRG01OJ0              PIC X(8) VALUE 'ZRG01OJ0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01OJ0-001.
               CALL 'ZRG01OJ0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01OJ0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
