      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00RFW'.
      ...
      * Called module names
       01  MOD-ZRG01Q01              PIC X(8) VALUE 'ZRG01Q01'.
       01  MOD-ZRG01G53              PIC X(8) VALUE 'ZRG01G53'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRG01Q01-001.
               PERFORM CALL-ZRG01G53-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01Q01-001.
               CALL 'ZRG01Q01' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01Q01 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRG01G53-002.
               CALL 'ZRG01G53' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01G53 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
