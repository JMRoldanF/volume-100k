      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00RS9'.
      ...
      * Called module names
       01  MOD-ZRG01T5M              PIC X(8) VALUE 'ZRG01T5M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01T5M-001.
               CALL 'ZRG01T5M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01T5M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
