      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00PLP'.
      ...
      * Called module names
       01  MOD-ZRG01N7F              PIC X(8) VALUE 'ZRG01N7F'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01N7F-001.
               CALL 'ZRG01N7F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01N7F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
