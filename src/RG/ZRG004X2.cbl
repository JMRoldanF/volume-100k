      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG004X2'.
      ...
      * Called module names
       01  MOD-ZRG00IY8              PIC X(8) VALUE 'ZRG00IY8'.
       01  MOD-ZRG00B6L              PIC X(8) VALUE 'ZRG00B6L'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRG00IY8-001.
               PERFORM CALL-ZRG00B6L-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG00IY8-001.
               EXEC CICS LINK PROGRAM('ZRG00IY8')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG00IY8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRG00B6L-002.
               EXEC CICS LINK PROGRAM('ZRG00B6L')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG00B6L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
