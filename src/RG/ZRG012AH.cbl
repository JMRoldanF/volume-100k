      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG012AH'.
      ...
      * Called module names
       01  MOD-ZPR01LQS              PIC X(8) VALUE 'ZPR01LQS'.
       01  MOD-ZRG01M11              PIC X(8) VALUE 'ZRG01M11'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPR01LQS-001.
               PERFORM CALL-ZRG01M11-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR01LQS-001.
               CALL 'ZPR01LQS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01LQS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRG01M11-002.
               CALL 'ZRG01M11' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01M11 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
