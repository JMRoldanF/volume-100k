      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00PMK'.
      ...
      * Called module names
       01  MOD-ZRG01CR6              PIC X(8) VALUE 'ZRG01CR6'.
       01  MOD-ZRG01SCH              PIC X(8) VALUE 'ZRG01SCH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01CR6-001.
               CALL 'ZRG01CR6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01CR6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRG01SCH-002.
               CALL 'ZRG01SCH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01SCH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
