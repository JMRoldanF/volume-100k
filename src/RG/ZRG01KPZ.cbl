      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG01KPZ'.
      ...
      * Called module names
       01  MOD-ZRG01P4B              PIC X(8) VALUE 'ZRG01P4B'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01P4B-001.
               CALL 'ZRG01P4B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
