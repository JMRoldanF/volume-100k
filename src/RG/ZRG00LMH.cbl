      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00LMH'.
      ...
      * Called module names
       01  MOD-ZRG01M45              PIC X(8) VALUE 'ZRG01M45'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRG01M45-001.
               PERFORM CALL-ZRG01KXX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01M45-001.
               CALL 'ZRG01M45' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01M45 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRG01KXX-002.
