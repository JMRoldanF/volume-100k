      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00OE1'.
      ...
      * Called module names
       01  MOD-ZRG01UMN              PIC X(8) VALUE 'ZRG01UMN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01UMN-002.
               CALL 'ZRG01UMN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01UMN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
