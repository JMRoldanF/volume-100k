      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00Y6Y'.
      ...
      * Called module names
       01  MOD-ZRG01I1J              PIC X(8) VALUE 'ZRG01I1J'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRG01I1J-001.
               PERFORM CALL-ZRG01HFU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01I1J-001.
               CALL 'ZRG01I1J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01I1J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRG01HFU-002.
