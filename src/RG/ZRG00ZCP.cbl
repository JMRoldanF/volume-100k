      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00ZCP'.
      ...
      * Called module names
       01  MOD-ZRG01TXY              PIC X(8) VALUE 'ZRG01TXY'.
       01  MOD-ZSL01O8I              PIC X(8) VALUE 'ZSL01O8I'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRG01TXY-001.
               PERFORM CALL-ZSL01O8I-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01TXY-001.
               CALL 'ZRG01TXY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01TXY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSL01O8I-002.
               CALL 'ZSL01O8I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSL01O8I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-VALUE-0001.
