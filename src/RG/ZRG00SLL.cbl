      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00SLL'.
      ...
      * Called module names
       01  MOD-ZRG01ICN              PIC X(8) VALUE 'ZRG01ICN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01ICN-001.
               CALL 'ZRG01ICN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01ICN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRG01DUK-002.
               MOVE 'ZRG01DUK' TO WS-SUBNAME-2
