      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00V9A'.
      ...
      * Called module names
       01  MOD-ZRG01CRU              PIC X(8) VALUE 'ZRG01CRU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRG01CRU-001.
               PERFORM CALL-ZSL01MW2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01CRU-001.
               CALL 'ZRG01CRU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01CRU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSL01MW2-002.
