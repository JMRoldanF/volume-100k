      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00O6N'.
      ...
      * Called module names
       01  MOD-ZRG01USA              PIC X(8) VALUE 'ZRG01USA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01USA-001.
               CALL 'ZRG01USA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01USA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
