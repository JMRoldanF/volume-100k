      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00T50'.
      ...
      * Called module names
       01  MOD-ZRG01NUU              PIC X(8) VALUE 'ZRG01NUU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRG01NUU-001.
               PERFORM CALL-ZDO01IVM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01NUU-001.
               CALL 'ZRG01NUU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01NUU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZDO01IVM-002.
