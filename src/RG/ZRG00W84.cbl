      ******************************************************************
      * ZRG00W84 - REGULATORY REPORTING                                *
      ******************************************************************
      *
      *  Generated volume-test source. Layer 2,
      *  type data_db2, domain REGLTRY.
      ******************************************************************
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00W84'.
      ...
      * Called module names
       01  MOD-ZRG01SFY              PIC X(8) VALUE 'ZRG01SFY'.
       01  MOD-ZRG01H4S              PIC X(8) VALUE 'ZRG01H4S'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRG01SFY-001.
               PERFORM CALL-ZRG01H4S-002.
               ...
               PERFORM REFRESH-NCD-YEARS-0010.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01SFY-001.
               CALL 'ZRG01SFY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01SFY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRG01H4S-002.
               CALL 'ZRG01H4S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01H4S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
