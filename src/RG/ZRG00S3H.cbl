      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00S3H'.
      ...
      * Called module names
       01  MOD-ZRG01LLG              PIC X(8) VALUE 'ZRG01LLG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01LLG-001.
               CALL 'ZRG01LLG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01LLG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSL01E28-002.
