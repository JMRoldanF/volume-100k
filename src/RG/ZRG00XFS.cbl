      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00XFS'.
      ...
      * Called module names
       01  MOD-ZRG01PCY              PIC X(8) VALUE 'ZRG01PCY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRG01PCY-001.
               PERFORM CALL-ZRG01OU6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01PCY-001.
               CALL 'ZRG01PCY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01PCY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRG01OU6-002.
