      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00SM4'.
      ...
      * Called module names
       01  MOD-ZRG01P0W              PIC X(8) VALUE 'ZRG01P0W'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01P0W-001.
               CALL 'ZRG01P0W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01P0W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZDO01MDZ-002.
