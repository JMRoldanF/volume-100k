      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00T3J'.
      ...
      * Called module names
       01  MOD-ZRG01HBD              PIC X(8) VALUE 'ZRG01HBD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01HBD-001.
               CALL 'ZRG01HBD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01HBD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
