      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00XZD'.
      ...
      * Called module names
       01  MOD-ZRG01QET              PIC X(8) VALUE 'ZRG01QET'.
       01  MOD-ZRG01O52              PIC X(8) VALUE 'ZRG01O52'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRG01QET-001.
               PERFORM CALL-ZRG01O52-002.
               PERFORM CALL-ZMT0255L-003.
               PERFORM AUDIT-BEDROOMS-0001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZRG01QET-001.
               CALL 'ZRG01QET' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01QET FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRG01O52-002.
               CALL 'ZRG01O52' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01O52 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
