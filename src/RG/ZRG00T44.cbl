      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00T44'.
      ...
      * Called module names
       01  MOD-ZRG01DYR              PIC X(8) VALUE 'ZRG01DYR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01DYR-001.
               CALL 'ZRG01DYR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01DYR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
