      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00LVD'.
      ...
      * Called module names
       01  MOD-ZRG01ELF              PIC X(8) VALUE 'ZRG01ELF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01ELF-001.
               CALL 'ZRG01ELF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01ELF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
