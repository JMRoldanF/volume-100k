      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00Q9L'.
      ...
      * Called module names
       ...
       01  MOD-ZRG01LM6              PIC X(8) VALUE 'ZRG01LM6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSL01CR5-001.
               PERFORM CALL-ZRG01LM6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01LM6-002.
               CALL 'ZRG01LM6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01LM6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
