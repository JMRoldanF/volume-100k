      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00NJE'.
      ...
      * Called module names
       01  MOD-ZRG01T20              PIC X(8) VALUE 'ZRG01T20'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01T20-001.
               CALL 'ZRG01T20' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01T20 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRG01SKC-002.
               MOVE 'ZRG01SKC' TO WS-SUBNAME-6
