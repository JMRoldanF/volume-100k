      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00O2D'.
      ...
      * Called module names
       01  MOD-ZRG01G9M              PIC X(8) VALUE 'ZRG01G9M'.
       01  MOD-ZRG01FE2              PIC X(8) VALUE 'ZRG01FE2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRG01G9M-001.
               PERFORM CALL-ZRG01FE2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01G9M-001.
               CALL 'ZRG01G9M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01G9M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRG01FE2-002.
               CALL 'ZRG01FE2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01FE2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
