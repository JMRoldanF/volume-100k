      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG0167Q'.
      ...
      * Called module names
       01  MOD-ZRG01P90              PIC X(8) VALUE 'ZRG01P90'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01P90-001.
               CALL 'ZRG01P90' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01P90 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
