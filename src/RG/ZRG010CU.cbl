      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG010CU'.
      ...
      * Called module names
       01  MOD-ZRG01IHQ              PIC X(8) VALUE 'ZRG01IHQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01IHQ-001.
               CALL 'ZRG01IHQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01IHQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
