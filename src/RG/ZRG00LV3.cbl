      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00LV3'.
      ...
      * Called module names
       01  MOD-ZSE01D94              PIC X(8) VALUE 'ZSE01D94'.
       01  MOD-ZSE01UYB              PIC X(8) VALUE 'ZSE01UYB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01D94-001.
               CALL 'ZSE01D94' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01D94 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSE01UYB-002.
               CALL 'ZSE01UYB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01UYB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
