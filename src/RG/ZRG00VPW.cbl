      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00VPW'.
      ...
      * Called module names
       01  MOD-ZRG01HXQ              PIC X(8) VALUE 'ZRG01HXQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01HXQ-001.
               CALL 'ZRG01HXQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01HXQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
