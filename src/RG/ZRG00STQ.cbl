      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00STQ'.
      ...
      * Called module names
       01  MOD-ZRG01FZT              PIC X(8) VALUE 'ZRG01FZT'.
       01  MOD-ZRG01NKP              PIC X(8) VALUE 'ZRG01NKP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01FZT-001.
               CALL 'ZRG01FZT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01FZT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRG01NKP-002.
               CALL 'ZRG01NKP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
