      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00SH7'.
      ...
      * Called module names
       ...
       01  MOD-ZRG01RCU              PIC X(8) VALUE 'ZRG01RCU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSL01OZA-001.
               PERFORM CALL-ZRG01RCU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01RCU-002.
               CALL 'ZRG01RCU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01RCU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
