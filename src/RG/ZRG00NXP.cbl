      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00NXP'.
      ...
      * Called module names
       01  MOD-ZRG01UUY              PIC X(8) VALUE 'ZRG01UUY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01UUY-001.
               CALL 'ZRG01UUY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01UUY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
