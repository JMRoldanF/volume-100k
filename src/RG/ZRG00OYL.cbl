      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRG00OYL'.
      ...
      * Called module names
       ...
       01  MOD-ZRG01H8X              PIC X(8) VALUE 'ZRG01H8X'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01H8X-002.
               CALL 'ZRG01H8X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01H8X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
