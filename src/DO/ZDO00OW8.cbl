      ******************************************************************
      * ZDO00OW8 - DOCUMENT PRODUCTION                                 *
      ******************************************************************
      *
      *  Generated volume-test source. Layer 2,
      *  type data_db2, domain DOCUMNT.
      ******************************************************************
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO00OW8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM EXPAND-TAX-BAND-0020.
               PERFORM FORMAT-EXCESS-0022.
               PERFORM SQL-ACCESS-0024.
               PERFORM DERIVE-VALUE-0025.
               PERFORM APPLY-POSTCODE-0026.
               ...
               PERFORM NORMALISE-MANAGED-FUND-0052.
               PERFORM DERIVE-COLOUR-0053.
               ...
               PERFORM RECONCILE-MANAGED-FUND-0073.
               ...
               PERFORM NORMALISE-PREMIUM-0080.
       ...
       SQL-ACCESS-0009.
               EXEC SQL
                     ...
                     SELECT POLICYNUMBER, PAYMENT
                       FROM GENADO.POLICY A
                       JOIN GENADO.CUSTOMER B
