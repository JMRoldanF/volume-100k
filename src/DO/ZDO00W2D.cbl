      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO00W2D'.
      ...
      * Called module names
       01  MOD-ZDO01O7P              PIC X(8) VALUE 'ZDO01O7P'.
       01  MOD-ZDO01LZ2              PIC X(8) VALUE 'ZDO01LZ2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZDO01O7P-001.
               PERFORM CALL-ZDO01LZ2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01O7P-001.
               CALL 'ZDO01O7P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01O7P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZDO01LZ2-002.
               CALL 'ZDO01LZ2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
