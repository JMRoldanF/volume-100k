      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO00LOO'.
      ...
      * Called module names
       01  MOD-ZDO01HSZ              PIC X(8) VALUE 'ZDO01HSZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01HSZ-001.
               CALL 'ZDO01HSZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01HSZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
