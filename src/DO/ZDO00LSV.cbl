      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO00LSV'.
      ...
      * Called module names
       01  MOD-ZDO01OYC              PIC X(8) VALUE 'ZDO01OYC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01OYC-001.
               CALL 'ZDO01OYC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01OYC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZDO01OEX-002.
