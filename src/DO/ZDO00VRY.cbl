      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO00VRY'.
      ...
      * Called module names
       01  MOD-ZDO01CR0              PIC X(8) VALUE 'ZDO01CR0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01CR0-001.
               CALL 'ZDO01CR0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01CR0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-POSTCODE-0001.
