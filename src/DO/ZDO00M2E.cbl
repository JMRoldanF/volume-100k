      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO00M2E'.
      ...
      * Called module names
       01  MOD-ZDO01T51              PIC X(8) VALUE 'ZDO01T51'.
       01  MOD-ZDO01RXQ              PIC X(8) VALUE 'ZDO01RXQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZDO01T51-001.
               PERFORM CALL-ZDO01RXQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01T51-001.
               CALL 'ZDO01T51' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01T51 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZDO01RXQ-002.
               CALL 'ZDO01RXQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01RXQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
