      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO00YGG'.
      ...
      * Called module names
       01  MOD-ZDO01EPN              PIC X(8) VALUE 'ZDO01EPN'.
       01  MOD-ZDO01NY3              PIC X(8) VALUE 'ZDO01NY3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZDO01EPN-001.
               PERFORM CALL-ZDO01NY3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01EPN-001.
               CALL 'ZDO01EPN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01EPN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZDO01NY3-002.
               CALL 'ZDO01NY3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01NY3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
