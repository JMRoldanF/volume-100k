      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO00UF9'.
      ...
      * Called module names
       01  MOD-ZAZ01S9R              PIC X(8) VALUE 'ZAZ01S9R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAZ01S9R-001.
               CALL 'ZAZ01S9R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01S9R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
