      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO00OYO'.
      ...
      * Called module names
       01  MOD-ZDO01UBA              PIC X(8) VALUE 'ZDO01UBA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01UBA-001.
               CALL 'ZDO01UBA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01UBA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
