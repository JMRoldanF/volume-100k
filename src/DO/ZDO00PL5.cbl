      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO00PL5'.
      ...
      * Called module names
       01  MOD-ZDO01F3R              PIC X(8) VALUE 'ZDO01F3R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01F3R-001.
               CALL 'ZDO01F3R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01F3R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
