      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO00WHK'.
      ...
      * Called module names
       01  MOD-ZDO01SN0              PIC X(8) VALUE 'ZDO01SN0'.
       01  MOD-ZNT01TC2              PIC X(8) VALUE 'ZNT01TC2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZDO01SN0-001.
               PERFORM CALL-ZNT01TC2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01SN0-001.
               CALL 'ZDO01SN0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01SN0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZNT01TC2-002.
               CALL 'ZNT01TC2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01TC2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-COLOUR-0001.
