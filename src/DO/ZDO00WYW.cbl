      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO00WYW'.
      ...
      * Called module names
       01  MOD-ZDO01SD9              PIC X(8) VALUE 'ZDO01SD9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01SD9-001.
               CALL 'ZDO01SD9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01SD9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
