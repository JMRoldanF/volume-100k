      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO004WU'.
      ...
      * Called module names
       ...
       01  MOD-ZDO005DU              PIC X(8) VALUE 'ZDO005DU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZDO00FVW-001.
               PERFORM CALL-ZDO0079J-002.
               PERFORM CALL-ZDO005DU-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO0079J-002.
               MOVE 'ZDO0079J' TO WS-PROGNAME-5
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO0079J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZDO005DU-003.
               EXEC CICS XCTL PROGRAM('ZDO005DU')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO005DU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-004.
