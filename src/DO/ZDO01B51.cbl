      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO01B51'.
      ...
      * Called module names
       ...
       01  MOD-ZDO01MUV              PIC X(8) VALUE 'ZDO01MUV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZDO01SI2-001.
               PERFORM CALL-ZDO01MUV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01MUV-002.
               CALL 'ZDO01MUV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
