      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO00OPH'.
      ...
      * Called module names
       01  MOD-ZPL01U97              PIC X(8) VALUE 'ZPL01U97'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPL01U97-001.
               CALL 'ZPL01U97' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPL01U97 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZDO01M74-002.
