      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO00T89'.
      ...
      * Called module names
       01  MOD-ZDO01JAC              PIC X(8) VALUE 'ZDO01JAC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01JAC-001.
               CALL 'ZDO01JAC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01JAC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-COLOUR-0001.
