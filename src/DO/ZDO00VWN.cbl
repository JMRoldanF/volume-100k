      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO00VWN'.
      ...
      * Called module names
       ...
       01  MOD-ZDO01J9J              PIC X(8) VALUE 'ZDO01J9J'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZDO01EC6-001.
               PERFORM CALL-ZDO01J9J-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01J9J-002.
               CALL 'ZDO01J9J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01J9J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
