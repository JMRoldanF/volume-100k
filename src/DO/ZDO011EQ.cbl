      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO011EQ'.
      ...
      * Called module names
       01  MOD-ZDO01RN0              PIC X(8) VALUE 'ZDO01RN0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZDO01MVD-001.
               PERFORM CALL-ZDO01RN0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01RN0-002.
               CALL 'ZDO01RN0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01RN0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
