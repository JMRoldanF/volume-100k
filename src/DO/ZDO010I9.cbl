      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO010I9'.
      ...
      * Called module names
       01  MOD-ZDO01NW4              PIC X(8) VALUE 'ZDO01NW4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM FORMAT-CC-RATING-0020.
               PERFORM SQL-ACCESS-0021.
               PERFORM CHECK-REG-NUMBER-0022.
               ...
               PERFORM VALIDATE-MANAGED-FUND-0053.
               PERFORM SQL-ACCESS-0054.
               PERFORM RESOLVE-SUM-ASSURED-0055.
               PERFORM AUDIT-ROOF-TYPE-0056.
               PERFORM SQL-ACCESS-0057.
               PERFORM AUDIT-MAKE-0058.
               ...
               PERFORM AUDIT-EQUITIES-0071.
               PERFORM SQL-ACCESS-0072.
               PERFORM COMPUTE-STATUS-CODE-0073.
               ...
               PERFORM AUDIT-AGENT-CODE-0094.
               PERFORM DERIVE-MANAGED-FUND-0095.
               PERFORM SQL-ACCESS-0096.
               PERFORM FORMAT-EXCESS-0097.
               PERFORM APPLY-COLOUR-0098.
               PERFORM SQL-ACCESS-0099.
               PERFORM CHECK-POSTCODE-0100.
               ...
               PERFORM DERIVE-SUM-ASSURED-0122.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01NW4-001.
               CALL 'ZDO01NW4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01NW4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-MAKE-0001.
