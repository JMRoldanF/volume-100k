      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO00LY3'.
      ...
      * Called module names
       ...
       01  MOD-ZDO01M7V              PIC X(8) VALUE 'ZDO01M7V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01M7V-002.
               CALL 'ZDO01M7V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01M7V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
