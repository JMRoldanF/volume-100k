      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO012KS'.
      ...
      * Called module names
       01  MOD-ZDO01KI9              PIC X(8) VALUE 'ZDO01KI9'.
       01  MOD-ZDO01LLN              PIC X(8) VALUE 'ZDO01LLN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZDO01KI9-001.
               PERFORM CALL-ZDO01LLN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01KI9-001.
               CALL 'ZDO01KI9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01KI9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZDO01LLN-002.
               CALL 'ZDO01LLN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01LLN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
