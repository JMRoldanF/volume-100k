      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO00SE1'.
      ...
      * Called module names
       01  MOD-ZDO01PFL              PIC X(8) VALUE 'ZDO01PFL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01PFL-001.
               CALL 'ZDO01PFL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01PFL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
