      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO011FE'.
      ...
      * Called module names
       01  MOD-ZDO01OW7              PIC X(8) VALUE 'ZDO01OW7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01OW7-001.
               CALL 'ZDO01OW7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01OW7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHE01EV3-002.
