      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO00VXB'.
      ...
      * Called module names
       ...
       01  MOD-ZDO01UAS              PIC X(8) VALUE 'ZDO01UAS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZDO01U9U-001.
               PERFORM CALL-ZDO01UAS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01UAS-002.
               CALL 'ZDO01UAS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01UAS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
