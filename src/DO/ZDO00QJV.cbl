      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO00QJV'.
      ...
      * Called module names
       01  MOD-ZDO01EZ3              PIC X(8) VALUE 'ZDO01EZ3'.
       01  MOD-ZNT01KZQ              PIC X(8) VALUE 'ZNT01KZQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZDO01EZ3-001.
               PERFORM CALL-ZNT01KZQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01EZ3-001.
               CALL 'ZDO01EZ3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01EZ3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZNT01KZQ-002.
               CALL 'ZNT01KZQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01KZQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
