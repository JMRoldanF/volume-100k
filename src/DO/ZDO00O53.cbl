      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO00O53'.
      ...
      * Called module names
       01  MOD-ZNT01FBL              PIC X(8) VALUE 'ZNT01FBL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM COMPUTE-MANAGED-FUND-0097.
               PERFORM VALIDATE-VALUE-0098.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZNT01FBL-001.
               CALL 'ZNT01FBL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01FBL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
