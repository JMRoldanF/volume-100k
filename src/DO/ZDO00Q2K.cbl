      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO00Q2K'.
      ...
      * Called module names
       01  MOD-ZDO01GJW              PIC X(8) VALUE 'ZDO01GJW'.
       01  MOD-ZDO01II2              PIC X(8) VALUE 'ZDO01II2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZDO01GJW-001.
               PERFORM CALL-ZDO01II2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01GJW-001.
               CALL 'ZDO01GJW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01GJW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZDO01II2-002.
               CALL 'ZDO01II2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01II2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-EQUITIES-0001.
