      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO00REJ'.
      ...
      * Called module names
       01  MOD-ZDO01KJB              PIC X(8) VALUE 'ZDO01KJB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01KJB-001.
               CALL 'ZDO01KJB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01KJB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-MODEL-0001.
