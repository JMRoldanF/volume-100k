      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO00ZJ9'.
      ...
      * Called module names
       01  MOD-ZCN01V3C              PIC X(8) VALUE 'ZCN01V3C'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCN01V3C-001.
               PERFORM CALL-ZNT01CZ6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCN01V3C-001.
               CALL 'ZCN01V3C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCN01V3C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZNT01CZ6-002.
