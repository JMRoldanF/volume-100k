      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO01WKS'.
      ...
      * Called module names
       01  MOD-ZNT01JD8              PIC X(8) VALUE 'ZNT01JD8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZNT01JD8-001.
               PERFORM CALL-ZDO01IPE-002.
               PERFORM CALL-ZDO01O7J-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01JD8-001.
               CALL 'ZNT01JD8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01JD8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZDO01IPE-002.
               MOVE 'ZDO01IPE' TO WS-SUBNAME-7
