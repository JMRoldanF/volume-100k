      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO00SB3'.
      ...
      * Called module names
       01  MOD-ZDO01KKP              PIC X(8) VALUE 'ZDO01KKP'.
       01  MOD-ZDO01RPK              PIC X(8) VALUE 'ZDO01RPK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZDO01KKP-001.
               PERFORM CALL-ZDO01RPK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01KKP-001.
               CALL 'ZDO01KKP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01KKP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZDO01RPK-002.
               CALL 'ZDO01RPK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01RPK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-VALUE-0001.
