      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO00NTF'.
      ...
      * Called module names
       01  MOD-ZHE01KX7              PIC X(8) VALUE 'ZHE01KX7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHE01KX7-001.
               CALL 'ZHE01KX7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHE01KX7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZDO01NY3-002.
