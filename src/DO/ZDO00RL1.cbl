      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO00RL1'.
      ...
      * Called module names
       ...
       01  MOD-ZDO01TDR              PIC X(8) VALUE 'ZDO01TDR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01TDR-002.
               CALL 'ZDO01TDR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01TDR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-VALUE-0001.
