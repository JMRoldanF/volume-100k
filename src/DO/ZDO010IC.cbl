      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO010IC'.
      ...
      * Called module names
       01  MOD-ZDO01NFK              PIC X(8) VALUE 'ZDO01NFK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZDO01NFK-001.
               PERFORM CALL-ZHE01G2W-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01NFK-001.
               CALL 'ZDO01NFK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01NFK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHE01G2W-002.
