      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO011S4'.
      ...
      * Called module names
       01  MOD-ZDO01KMJ              PIC X(8) VALUE 'ZDO01KMJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM RECONCILE-BROKER-ID-0092.
               ...
               PERFORM EXPAND-WITH-PROFITS-0109.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01KMJ-001.
               CALL 'ZDO01KMJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01KMJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
