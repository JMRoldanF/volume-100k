      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO00S2V'.
      ...
      * Called module names
       01  MOD-ZDO01TBV              PIC X(8) VALUE 'ZDO01TBV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01TBV-001.
               CALL 'ZDO01TBV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01TBV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
