      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO00YYE'.
      ...
      * Called module names
       01  MOD-ZDO01R4S              PIC X(8) VALUE 'ZDO01R4S'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01R4S-001.
               CALL 'ZDO01R4S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01R4S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-PREMIUM-0001.
