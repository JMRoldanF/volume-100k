      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO00P8H'.
      ...
      * Called module names
       01  MOD-ZCN01OO3              PIC X(8) VALUE 'ZCN01OO3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCN01OO3-001.
               PERFORM CALL-ZDO01O5Q-002.
               PERFORM EXPAND-SUM-ASSURED-0001.
               PERFORM REFRESH-BROKER-ID-0002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCN01OO3-001.
               CALL 'ZCN01OO3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCN01OO3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZDO01O5Q-002.
