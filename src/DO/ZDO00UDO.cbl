      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDO00UDO'.
      ...
      * Called module names
       01  MOD-ZDO01KJQ              PIC X(8) VALUE 'ZDO01KJQ'.
       01  MOD-ZDO01EGJ              PIC X(8) VALUE 'ZDO01EGJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZDO01KJQ-001.
               PERFORM CALL-ZDO01EGJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01KJQ-001.
               CALL 'ZDO01KJQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01KJQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZDO01EGJ-002.
               CALL 'ZDO01EGJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01EGJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
