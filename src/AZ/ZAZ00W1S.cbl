      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00W1S'.
      ...
      * Called module names
       01  MOD-ZCL01JIX              PIC X(8) VALUE 'ZCL01JIX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01JIX-001.
               PERFORM CALL-ZAZ01JW8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01JIX-001.
               CALL 'ZCL01JIX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
