      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00Y0T'.
      ...
      * Called module names
       01  MOD-ZAZ01LH8              PIC X(8) VALUE 'ZAZ01LH8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAZ01LH8-001.
               CALL 'ZAZ01LH8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01LH8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
