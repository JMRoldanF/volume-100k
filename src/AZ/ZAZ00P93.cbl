      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00P93'.
      ...
      * Called module names
       01  MOD-ZAZ01DD4              PIC X(8) VALUE 'ZAZ01DD4'.
       01  MOD-ZAZ01NSO              PIC X(8) VALUE 'ZAZ01NSO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAZ01DD4-001.
               CALL 'ZAZ01DD4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01DD4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAZ01NSO-002.
               CALL 'ZAZ01NSO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
