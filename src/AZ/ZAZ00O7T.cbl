      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00O7T'.
      ...
      * Called module names
       ...
       01  MOD-ZAZ01H8H              PIC X(8) VALUE 'ZAZ01H8H'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAZ01FYU-001.
               PERFORM CALL-ZAZ01H8H-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAZ01H8H-002.
               CALL 'ZAZ01H8H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01H8H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
