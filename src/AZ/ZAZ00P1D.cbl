      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00P1D'.
      ...
      * Called module names
       01  MOD-ZAZ01IU4              PIC X(8) VALUE 'ZAZ01IU4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAZ01IU4-001.
               PERFORM CALL-ZMB01R0M-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAZ01IU4-001.
               CALL 'ZAZ01IU4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01IU4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMB01R0M-002.
