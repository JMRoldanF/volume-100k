      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00USC'.
      ...
      * Called module names
       01  MOD-ZAZ01K1P              PIC X(8) VALUE 'ZAZ01K1P'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAZ01K1P-001.
               CALL 'ZAZ01K1P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01K1P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAZ01EDJ-002.
