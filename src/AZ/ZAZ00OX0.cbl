      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00OX0'.
      ...
      * Called module names
       01  MOD-ZCL01K9D              PIC X(8) VALUE 'ZCL01K9D'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01K9D-001.
               PERFORM CALL-ZMB01LD0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01K9D-001.
               CALL 'ZCL01K9D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01K9D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMB01LD0-002.
               MOVE 'ZMB01LD0' TO WS-SUBNAME-4
