      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00YFH'.
      ...
      * Called module names
       01  MOD-ZAZ01QYS              PIC X(8) VALUE 'ZAZ01QYS'.
       01  MOD-ZAZ01IF2              PIC X(8) VALUE 'ZAZ01IF2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAZ01QYS-001.
               CALL 'ZAZ01QYS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01QYS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAZ01IF2-002.
               CALL 'ZAZ01IF2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01IF2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
