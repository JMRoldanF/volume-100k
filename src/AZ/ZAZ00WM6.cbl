      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00WM6'.
      ...
      * Called module names
       01  MOD-ZAZ01EDN              PIC X(8) VALUE 'ZAZ01EDN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAZ01EDN-001.
               CALL 'ZAZ01EDN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01EDN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
