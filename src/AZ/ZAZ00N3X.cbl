      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00N3X'.
      ...
      * Called module names
       01  MOD-ZAZ01TY9              PIC X(8) VALUE 'ZAZ01TY9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAZ01TY9-001.
               CALL 'ZAZ01TY9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01TY9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
