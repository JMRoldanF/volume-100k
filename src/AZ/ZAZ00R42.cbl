      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00R42'.
      ...
      * Called module names
       01  MOD-ZCL01PED              PIC X(8) VALUE 'ZCL01PED'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01PED-001.
               PERFORM CALL-ZAZ01KVC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01PED-001.
               CALL 'ZCL01PED' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01PED FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAZ01KVC-002.
