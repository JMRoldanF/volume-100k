      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00RX7'.
      ...
      * Called module names
       01  MOD-ZAZ01E05              PIC X(8) VALUE 'ZAZ01E05'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAZ01E05-001.
               CALL 'ZAZ01E05' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01E05 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
