      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00T4K'.
      ...
      * Called module names
       01  MOD-ZAZ01RR8              PIC X(8) VALUE 'ZAZ01RR8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAZ01RR8-001.
               PERFORM CALL-ZAZ01RDF-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAZ01RR8-001.
               CALL 'ZAZ01RR8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01RR8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAZ01RDF-002.
               MOVE 'ZAZ01RDF' TO WS-SUBNAME-7
