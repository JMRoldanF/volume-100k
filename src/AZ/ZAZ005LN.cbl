      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ005LN'.
      ...
      * Called module names
       01  MOD-ZAZ00CGB              PIC X(8) VALUE 'ZAZ00CGB'.
       01  MOD-ZAZ000IZ              PIC X(8) VALUE 'ZAZ000IZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAZ00CGB-002.
               PERFORM CALL-ZAZ000IZ-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZAZ006AZ-001.
               MOVE 'ZAZ006AZ' TO WS-PROGNAME-6
      ...
      *----------------------------------------------------------------*
       CALL-ZAZ00CGB-002.
               EXEC CICS LINK PROGRAM('ZAZ00CGB')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ00CGB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAZ000IZ-003.
               EXEC CICS XCTL PROGRAM('ZAZ000IZ')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ000IZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-004.
