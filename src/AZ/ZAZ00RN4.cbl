      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00RN4'.
      ...
      * Called module names
       01  MOD-ZCL01S2K              PIC X(8) VALUE 'ZCL01S2K'.
       01  MOD-ZAZ01S3Z              PIC X(8) VALUE 'ZAZ01S3Z'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01S2K-001.
               PERFORM CALL-ZAZ01S3Z-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01S2K-001.
               CALL 'ZCL01S2K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01S2K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAZ01S3Z-002.
               CALL 'ZAZ01S3Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01S3Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
