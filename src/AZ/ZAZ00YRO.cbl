      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00YRO'.
      ...
      * Called module names
       01  MOD-ZCL01LJN              PIC X(8) VALUE 'ZCL01LJN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01LJN-001.
               CALL 'ZCL01LJN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01LJN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
