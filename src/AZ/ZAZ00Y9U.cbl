      ******************************************************************
      * ZAZ00Y9U - AUTHORISATION RULES                                 *
      ******************************************************************
      *
      *  Generated volume-test source. Layer 2,
      *  type data_db2, domain AUTHZ.
      ******************************************************************
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00Y9U'.
      ...
      * Called module names
       01  MOD-ZAZ01I64              PIC X(8) VALUE 'ZAZ01I64'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAZ01I64-001.
               CALL 'ZAZ01I64' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01I64 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       ...
       SQL-ACCESS-0033.
               EXEC SQL
                     ...
                     SELECT POLICYNUMBER, PAYMENT
                       FROM GENAAZ.SURCHARGE A
                       JOIN GENAAZ.CUSTOMER B
