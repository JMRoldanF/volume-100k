      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00TDR'.
      ...
      * Called module names
       01  MOD-ZAZ01FG9              PIC X(8) VALUE 'ZAZ01FG9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAZ01FG9-001.
               CALL 'ZAZ01FG9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01FG9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
