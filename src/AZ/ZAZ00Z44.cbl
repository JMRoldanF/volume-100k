      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00Z44'.
      ...
      * Called module names
       01  MOD-ZCL01T4W              PIC X(8) VALUE 'ZCL01T4W'.
       01  MOD-ZAZ01DMQ              PIC X(8) VALUE 'ZAZ01DMQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01T4W-001.
               PERFORM CALL-ZAZ01DMQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01T4W-001.
               CALL 'ZCL01T4W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01T4W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAZ01DMQ-002.
               CALL 'ZAZ01DMQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01DMQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
