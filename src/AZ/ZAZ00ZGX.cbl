      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00ZGX'.
      ...
      * Called module names
       01  MOD-ZAZ01JZP              PIC X(8) VALUE 'ZAZ01JZP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAZ01JZP-001.
               CALL 'ZAZ01JZP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01JZP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-VALUE-0001.
