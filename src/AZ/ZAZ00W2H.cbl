      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00W2H'.
      ...
      * Called module names
       01  MOD-ZAZ01T1Z              PIC X(8) VALUE 'ZAZ01T1Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAZ01T1Z-001.
               CALL 'ZAZ01T1Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01T1Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
