      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00S2P'.
      ...
      * Called module names
       01  MOD-ZAZ01NUZ              PIC X(8) VALUE 'ZAZ01NUZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAZ01NUZ-001.
               CALL 'ZAZ01NUZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01NUZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-MAKE-0001.
