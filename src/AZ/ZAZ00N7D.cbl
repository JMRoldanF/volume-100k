      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00N7D'.
      ...
      * Called module names
       ...
       01  MOD-ZAZ01S8K              PIC X(8) VALUE 'ZAZ01S8K'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAZ01S8K-002.
               CALL 'ZAZ01S8K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01S8K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
