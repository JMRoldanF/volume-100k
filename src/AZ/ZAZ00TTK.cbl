      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00TTK'.
      ...
      * Called module names
       01  MOD-ZAZ01E9T              PIC X(8) VALUE 'ZAZ01E9T'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAZ01E9T-001.
               CALL 'ZAZ01E9T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01E9T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMB01D17-002.
