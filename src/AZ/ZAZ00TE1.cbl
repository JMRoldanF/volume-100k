      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00TE1'.
      ...
      * Called module names
       01  MOD-ZAZ01STS              PIC X(8) VALUE 'ZAZ01STS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAZ01STS-001.
               CALL 'ZAZ01STS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01STS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
