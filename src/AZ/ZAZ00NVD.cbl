      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00NVD'.
      ...
      * Called module names
       01  MOD-ZAZ01F3T              PIC X(8) VALUE 'ZAZ01F3T'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAZ01F3T-001.
               CALL 'ZAZ01F3T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01F3T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-TERM-0001.
