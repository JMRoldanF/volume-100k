      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ011GM'.
      ...
      * Called module names
       01  MOD-ZAZ01LB6              PIC X(8) VALUE 'ZAZ01LB6'.
       01  MOD-ZAZ01TN9              PIC X(8) VALUE 'ZAZ01TN9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAZ01LB6-001.
               PERFORM CALL-ZAZ01TN9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAZ01LB6-001.
               CALL 'ZAZ01LB6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01LB6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAZ01TN9-002.
               CALL 'ZAZ01TN9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01TN9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
