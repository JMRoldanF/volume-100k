      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00MGN'.
      ...
      * Called module names
       ...
       01  MOD-ZAZ01LWU              PIC X(8) VALUE 'ZAZ01LWU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAZ01LWU-002.
               CALL 'ZAZ01LWU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
