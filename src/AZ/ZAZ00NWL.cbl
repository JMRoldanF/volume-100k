      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00NWL'.
      ...
      * Called module names
       01  MOD-ZAZ01E10              PIC X(8) VALUE 'ZAZ01E10'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAZ01E10-001.
               CALL 'ZAZ01E10' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01E10 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
