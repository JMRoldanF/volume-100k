      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00ZJ4'.
      ...
      * Called module names
       01  MOD-ZAZ01F0I              PIC X(8) VALUE 'ZAZ01F0I'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAZ01F0I-001.
               PERFORM CALL-ZAZ01IFG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAZ01F0I-001.
               CALL 'ZAZ01F0I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01F0I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAZ01IFG-002.
