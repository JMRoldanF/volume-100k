      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00TR6'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01Q07              PIC X(8) VALUE 'ZCL01Q07'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01Q07-002.
               CALL 'ZCL01Q07' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01Q07 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
