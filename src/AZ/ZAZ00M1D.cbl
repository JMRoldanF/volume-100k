      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00M1D'.
      ...
      * Called module names
       01  MOD-ZMB01JGT              PIC X(8) VALUE 'ZMB01JGT'.
       01  MOD-ZAZ01OKM              PIC X(8) VALUE 'ZAZ01OKM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMB01JGT-001.
               PERFORM CALL-ZAZ01OKM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMB01JGT-001.
               CALL 'ZMB01JGT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMB01JGT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAZ01OKM-002.
               CALL 'ZAZ01OKM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01OKM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
