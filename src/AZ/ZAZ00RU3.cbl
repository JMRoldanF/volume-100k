      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00RU3'.
      ...
      * Called module names
       01  MOD-ZAZ01H54              PIC X(8) VALUE 'ZAZ01H54'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAZ01H54-001.
               CALL 'ZAZ01H54' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01H54 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAZ01DMQ-002.
