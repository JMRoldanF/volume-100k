      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ011OI'.
      ...
      * Called module names
       01  MOD-ZAZ01O0L              PIC X(8) VALUE 'ZAZ01O0L'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAZ01O0L-001.
               CALL 'ZAZ01O0L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01O0L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
