      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAZ00PV8'.
      ...
      * Called module names
       01  MOD-ZAZ01O3R              PIC X(8) VALUE 'ZAZ01O3R'.
       01  MOD-ZAZ01KCV              PIC X(8) VALUE 'ZAZ01KCV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAZ01O3R-001.
               PERFORM CALL-ZAZ01KCV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAZ01O3R-001.
               CALL 'ZAZ01O3R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01O3R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAZ01KCV-002.
               CALL 'ZAZ01KCV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAZ01KCV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
