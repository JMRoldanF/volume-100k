      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00XJ9'.
      ...
      * Called module names
       01  MOD-ZAN01G5D              PIC X(8) VALUE 'ZAN01G5D'.
       01  MOD-ZAN01GDE              PIC X(8) VALUE 'ZAN01GDE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAN01G5D-001.
               PERFORM CALL-ZAN01GDE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01G5D-001.
               CALL 'ZAN01G5D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01G5D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAN01GDE-002.
               CALL 'ZAN01GDE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01GDE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
