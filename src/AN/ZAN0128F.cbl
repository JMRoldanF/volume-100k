      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN0128F'.
      ...
      * Called module names
       01  MOD-ZAN01JHB              PIC X(8) VALUE 'ZAN01JHB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAN01JHB-001.
               PERFORM CALL-ZAN01MXB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01JHB-001.
               CALL 'ZAN01JHB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01JHB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAN01MXB-002.
