      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN01I4I'.
      ...
      * Called module names
       01  MOD-ZAN01UIS              PIC X(8) VALUE 'ZAN01UIS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01UIS-001.
               CALL 'ZAN01UIS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01UIS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
