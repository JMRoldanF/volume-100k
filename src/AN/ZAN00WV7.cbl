      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00WV7'.
      ...
      * Called module names
       01  MOD-ZAN01NML              PIC X(8) VALUE 'ZAN01NML'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01NML-001.
               CALL 'ZAN01NML' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01NML FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
