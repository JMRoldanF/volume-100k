      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00YQR'.
      ...
      * Called module names
       01  MOD-ZAN01MHL              PIC X(8) VALUE 'ZAN01MHL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01MHL-001.
               CALL 'ZAN01MHL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01MHL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
