      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00Q9E'.
      ...
      * Called module names
       01  MOD-ZLI01DL8              PIC X(8) VALUE 'ZLI01DL8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01DL8-001.
               CALL 'ZLI01DL8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01DL8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAN01E49-002.
