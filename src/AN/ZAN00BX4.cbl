      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00BX4'.
      ...
      * Called module names
       ...
       01  MOD-ZAN015FZ              PIC X(8) VALUE 'ZAN015FZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAN015FZ-003.
               PERFORM CALL-ZAN01LNE-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN015FZ-003.
               EXEC CICS LINK PROGRAM('ZAN015FZ')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN015FZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAN01LNE-004.
               MOVE 'ZAN01LNE' TO WS-SUBNAME-7
