      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN01BUX'.
      ...
      * Called module names
       01  MOD-ZDO01PJ2              PIC X(8) VALUE 'ZDO01PJ2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZDO01PJ2-001.
               PERFORM CALL-ZAN01LSU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01PJ2-001.
               CALL 'ZDO01PJ2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01PJ2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAN01LSU-002.
