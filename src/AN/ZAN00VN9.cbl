      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00VN9'.
      ...
      * Called module names
       01  MOD-ZAN01OV3              PIC X(8) VALUE 'ZAN01OV3'.
       01  MOD-ZAN01J4N              PIC X(8) VALUE 'ZAN01J4N'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAN01OV3-001.
               PERFORM CALL-ZAN01J4N-002.
               ...
               PERFORM RECONCILE-CC-RATING-0034.
               ...
               PERFORM RECONCILE-MANAGED-FUND-0107.
               PERFORM SQL-ACCESS-0108.
               PERFORM CHECK-TERM-0110.
               PERFORM SQL-ACCESS-0111.
               PERFORM DERIVE-WITH-PROFITS-0112.
               ...
               PERFORM NORMALISE-NCD-YEARS-0122.
               ...
               PERFORM NORMALISE-BROKER-ID-0131.
               PERFORM SQL-ACCESS-0132.
               PERFORM CHECK-AGENT-CODE-0133.
               PERFORM NORMALISE-REG-NUMBER-0134.
               PERFORM SQL-ACCESS-0135.
               PERFORM DERIVE-VALUE-0137.
               PERFORM SQL-ACCESS-0138.
               PERFORM DERIVE-NCD-YEARS-0139.
               PERFORM EXPAND-NCD-YEARS-0140.
               PERFORM SQL-ACCESS-0141.
               PERFORM VALIDATE-HOUSE-TYPE-0142.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZAN01OV3-001.
               CALL 'ZAN01OV3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01OV3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAN01J4N-002.
               CALL 'ZAN01J4N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01J4N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
