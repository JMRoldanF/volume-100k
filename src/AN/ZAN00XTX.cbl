      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00XTX'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01R10              PIC X(8) VALUE 'ZHO01R10'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01R10-002.
               CALL 'ZHO01R10' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01R10 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
