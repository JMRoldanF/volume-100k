      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN010MB'.
      ...
      * Called module names
       01  MOD-ZAN01E3K              PIC X(8) VALUE 'ZAN01E3K'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01E3K-001.
               CALL 'ZAN01E3K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01E3K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
