      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN010Y3'.
      ...
      * Called module names
       01  MOD-ZAN01OK5              PIC X(8) VALUE 'ZAN01OK5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01OK5-001.
               CALL 'ZAN01OK5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01OK5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
