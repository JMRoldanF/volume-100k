      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN01MOQ'.
      ...
      * Called module names
       01  MOD-ZAN01NPE              PIC X(8) VALUE 'ZAN01NPE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01NPE-001.
               CALL 'ZAN01NPE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01NPE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
