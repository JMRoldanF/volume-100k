      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00Z5V'.
      ...
      * Called module names
       01  MOD-ZAN01MXF              PIC X(8) VALUE 'ZAN01MXF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI01UUX-001.
               PERFORM CALL-ZAN01MXF-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01MXF-002.
               CALL 'ZAN01MXF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01MXF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
