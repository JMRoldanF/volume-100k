      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN010WK'.
      ...
      * Called module names
       01  MOD-ZAN01Q1C              PIC X(8) VALUE 'ZAN01Q1C'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01Q1C-001.
               CALL 'ZAN01Q1C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01Q1C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
