      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00NHI'.
      ...
      * Called module names
       ...
       01  MOD-ZAN01TX3              PIC X(8) VALUE 'ZAN01TX3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01TX3-002.
               CALL 'ZAN01TX3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01TX3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
