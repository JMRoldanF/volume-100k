      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN012BK'.
      ...
      * Called module names
       01  MOD-ZAN01GFB              PIC X(8) VALUE 'ZAN01GFB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01GFB-001.
               CALL 'ZAN01GFB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01GFB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
