      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00NLV'.
      ...
      * Called module names
       01  MOD-ZAN01NHB              PIC X(8) VALUE 'ZAN01NHB'.
       01  MOD-ZAN01TOK              PIC X(8) VALUE 'ZAN01TOK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01NHB-001.
               CALL 'ZAN01NHB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01NHB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAN01TOK-002.
               CALL 'ZAN01TOK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
