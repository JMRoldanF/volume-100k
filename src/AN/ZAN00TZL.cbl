      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00TZL'.
      ...
      * Called module names
       01  MOD-ZAN01SAR              PIC X(8) VALUE 'ZAN01SAR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAN01SAR-001.
               PERFORM CALL-ZAN01EHZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01SAR-001.
               CALL 'ZAN01SAR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01SAR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAN01EHZ-002.
