      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00ZLH'.
      ...
      * Called module names
       01  MOD-ZDO01SS4              PIC X(8) VALUE 'ZDO01SS4'.
       01  MOD-ZAN01RSJ              PIC X(8) VALUE 'ZAN01RSJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZDO01SS4-001.
               PERFORM CALL-ZAN01RSJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01SS4-001.
               CALL 'ZDO01SS4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01SS4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAN01RSJ-002.
               CALL 'ZAN01RSJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01RSJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
