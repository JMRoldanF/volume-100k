      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00UFL'.
      ...
      * Called module names
       ...
       01  MOD-ZLI01N1O              PIC X(8) VALUE 'ZLI01N1O'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAN01FLN-001.
               PERFORM CALL-ZLI01N1O-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01N1O-002.
               CALL 'ZLI01N1O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01N1O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
