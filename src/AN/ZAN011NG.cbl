      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN011NG'.
      ...
      * Called module names
       01  MOD-ZAN01TG6              PIC X(8) VALUE 'ZAN01TG6'.
       01  MOD-ZDO01JO0              PIC X(8) VALUE 'ZDO01JO0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAN01TG6-001.
               PERFORM CALL-ZDO01JO0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01TG6-001.
               CALL 'ZAN01TG6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01TG6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZDO01JO0-002.
               CALL 'ZDO01JO0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
