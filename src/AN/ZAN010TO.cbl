      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN010TO'.
      ...
      * Called module names
       01  MOD-ZDO01GB5              PIC X(8) VALUE 'ZDO01GB5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZDO01GB5-001.
               PERFORM CALL-ZHO0255M-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZDO01GB5-001.
               CALL 'ZDO01GB5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01GB5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
