      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00O4C'.
      ...
      * Called module names
       01  MOD-ZAN01HWU              PIC X(8) VALUE 'ZAN01HWU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAN01HWU-001.
               PERFORM CALL-ZAN01JX5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01HWU-001.
               CALL 'ZAN01HWU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01HWU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAN01JX5-002.
