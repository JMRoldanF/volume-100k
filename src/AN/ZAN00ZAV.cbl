      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00ZAV'.
      ...
      * Called module names
       01  MOD-ZAN01S1Q              PIC X(8) VALUE 'ZAN01S1Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01S1Q-001.
               CALL 'ZAN01S1Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01S1Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
