      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00PUA'.
      ...
      * Called module names
       ...
       01  MOD-ZAN01MWV              PIC X(8) VALUE 'ZAN01MWV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01MWV-002.
               CALL 'ZAN01MWV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
