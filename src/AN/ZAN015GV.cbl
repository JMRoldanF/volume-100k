      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN015GV'.
      ...
      * Called module names
       01  MOD-ZAN01NVO              PIC X(8) VALUE 'ZAN01NVO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01NVO-001.
               CALL 'ZAN01NVO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01NVO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
