      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN0112U'.
      ...
      * Called module names
       01  MOD-ZDO01LL8              PIC X(8) VALUE 'ZDO01LL8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01LL8-001.
               CALL 'ZDO01LL8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01LL8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
