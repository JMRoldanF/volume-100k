      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00UI1'.
      ...
      * Called module names
       01  MOD-ZAN01GW5              PIC X(8) VALUE 'ZAN01GW5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01GW5-001.
               CALL 'ZAN01GW5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01GW5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
