      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00QF7'.
      ...
      * Called module names
       01  MOD-ZAN01EQ9              PIC X(8) VALUE 'ZAN01EQ9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAN01EQ9-001.
               PERFORM CALL-ZAN01GV8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01EQ9-001.
               CALL 'ZAN01EQ9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
