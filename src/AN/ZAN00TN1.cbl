      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00TN1'.
      ...
      * Called module names
       01  MOD-ZHO01N7J              PIC X(8) VALUE 'ZHO01N7J'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01N7J-001.
               CALL 'ZHO01N7J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01N7J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
