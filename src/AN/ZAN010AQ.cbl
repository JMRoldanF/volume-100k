      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN010AQ'.
      ...
      * Called module names
       01  MOD-ZAN01TFN              PIC X(8) VALUE 'ZAN01TFN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAN01REZ-001.
               PERFORM CALL-ZAN01TFN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01TFN-002.
               CALL 'ZAN01TFN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01TFN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
