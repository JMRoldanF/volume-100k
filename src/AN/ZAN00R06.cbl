      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00R06'.
      ...
      * Called module names
       01  MOD-ZAN01LVD              PIC X(8) VALUE 'ZAN01LVD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01LVD-001.
               CALL 'ZAN01LVD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01LVD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
