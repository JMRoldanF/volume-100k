      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00XHE'.
      ...
      * Called module names
       01  MOD-ZAN01K1T              PIC X(8) VALUE 'ZAN01K1T'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01K1T-001.
               CALL 'ZAN01K1T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01K1T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
