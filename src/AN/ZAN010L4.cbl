      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN010L4'.
      ...
      * Called module names
       01  MOD-ZHO01QPK              PIC X(8) VALUE 'ZHO01QPK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01QPK-001.
               CALL 'ZHO01QPK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01QPK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
