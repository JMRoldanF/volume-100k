      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00WPX'.
      ...
      * Called module names
       01  MOD-ZAN01MZA              PIC X(8) VALUE 'ZAN01MZA'.
       01  MOD-ZLI01R1K              PIC X(8) VALUE 'ZLI01R1K'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAN01MZA-001.
               PERFORM CALL-ZLI01R1K-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01MZA-001.
               CALL 'ZAN01MZA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01MZA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLI01R1K-002.
               CALL 'ZLI01R1K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01R1K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-TERM-0001.
