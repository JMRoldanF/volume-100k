      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00TX1'.
      ...
      * Called module names
       01  MOD-ZHO01PK6              PIC X(8) VALUE 'ZHO01PK6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAN01N3T-001.
               PERFORM CALL-ZHO01PK6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01PK6-002.
               CALL 'ZHO01PK6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
