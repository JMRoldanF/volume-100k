      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00OHS'.
      ...
      * Called module names
       01  MOD-ZAN01IS4              PIC X(8) VALUE 'ZAN01IS4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01IS4-001.
               CALL 'ZAN01IS4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01IS4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
