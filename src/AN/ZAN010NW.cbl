      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN010NW'.
      ...
      * Called module names
       01  MOD-ZAN01QE8              PIC X(8) VALUE 'ZAN01QE8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01QE8-001.
               CALL 'ZAN01QE8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01QE8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
