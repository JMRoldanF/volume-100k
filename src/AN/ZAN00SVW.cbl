      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00SVW'.
      ...
      * Called module names
       01  MOD-ZAN01JDY              PIC X(8) VALUE 'ZAN01JDY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01JDY-002.
               CALL 'ZAN01JDY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01JDY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
