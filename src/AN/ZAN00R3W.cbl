      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00R3W'.
      ...
      * Called module names
       01  MOD-ZAN01FX0              PIC X(8) VALUE 'ZAN01FX0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAN01FX0-001.
               PERFORM CALL-ZAN01KFT-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01FX0-001.
               CALL 'ZAN01FX0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01FX0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAN01KFT-002.
