      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00UA6'.
      ...
      * Called module names
       01  MOD-ZAN01IYZ              PIC X(8) VALUE 'ZAN01IYZ'.
       01  MOD-ZAN01I66              PIC X(8) VALUE 'ZAN01I66'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAN01IYZ-001.
               PERFORM CALL-ZAN01I66-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01IYZ-001.
               CALL 'ZAN01IYZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01I66-002.
               CALL 'ZAN01I66' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01I66 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
