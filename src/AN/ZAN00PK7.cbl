      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00PK7'.
      ...
      * Called module names
       01  MOD-ZHO01FXP              PIC X(8) VALUE 'ZHO01FXP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01FXP-001.
               PERFORM CALL-ZAN01OF5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01FXP-001.
               CALL 'ZHO01FXP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01FXP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAN01OF5-002.
