      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00OKB'.
      ...
      * Called module names
       01  MOD-ZAN01G1U              PIC X(8) VALUE 'ZAN01G1U'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01G1U-001.
               CALL 'ZAN01G1U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01G1U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01IB1-002.
               MOVE 'ZHO01IB1' TO WS-SUBNAME-5
