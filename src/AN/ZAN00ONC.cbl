      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00ONC'.
      ...
      * Called module names
       01  MOD-ZAN01JBI              PIC X(8) VALUE 'ZAN01JBI'.
       01  MOD-ZAN01J9L              PIC X(8) VALUE 'ZAN01J9L'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAN01JBI-001.
               PERFORM CALL-ZAN01J9L-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01JBI-001.
               CALL 'ZAN01JBI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01JBI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAN01J9L-002.
               CALL 'ZAN01J9L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01J9L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
