      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00ZFU'.
      ...
      * Called module names
       01  MOD-ZAN01H3U              PIC X(8) VALUE 'ZAN01H3U'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAN01H3U-001.
               PERFORM CALL-ZAN01CWD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01H3U-001.
               CALL 'ZAN01H3U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01H3U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAN01CWD-002.
               MOVE 'ZAN01CWD' TO WS-SUBNAME-5
