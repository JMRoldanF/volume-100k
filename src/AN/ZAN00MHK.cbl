      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAN00MHK'.
      ...
      * Called module names
       01  MOD-ZDO01HIR              PIC X(8) VALUE 'ZDO01HIR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDO01HIR-001.
               CALL 'ZDO01HIR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDO01HIR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
