      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRT00PY5'.
      ...
      * Called module names
       01  MOD-ZRT01MJM              PIC X(8) VALUE 'ZRT01MJM'.
       01  MOD-ZRT01NB4              PIC X(8) VALUE 'ZRT01NB4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRT01MJM-001.
               PERFORM CALL-ZRT01NB4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRT01MJM-001.
               CALL 'ZRT01MJM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRT01MJM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRT01NB4-002.
               CALL 'ZRT01NB4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRT01NB4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-PREMIUM-0001.
