      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRT00YDF'.
      ...
      * Called module names
       01  MOD-ZRT01TBE              PIC X(8) VALUE 'ZRT01TBE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRT01TBE-001.
               CALL 'ZRT01TBE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRT01TBE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
