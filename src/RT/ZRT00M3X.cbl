      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRT00M3X'.
      ...
      * Called module names
       ...
       01  MOD-ZRT01JE2              PIC X(8) VALUE 'ZRT01JE2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRT01JE2-002.
               CALL 'ZRT01JE2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRT01JE2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
