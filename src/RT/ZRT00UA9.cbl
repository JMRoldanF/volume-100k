      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRT00UA9'.
      ...
      * Called module names
       ...
       01  MOD-ZMA01UW6              PIC X(8) VALUE 'ZMA01UW6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRT01HQJ-001.
               PERFORM CALL-ZMA01UW6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01UW6-002.
               CALL 'ZMA01UW6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
