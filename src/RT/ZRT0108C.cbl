      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRT0108C'.
      ...
      * Called module names
       01  MOD-ZRT01CRH              PIC X(8) VALUE 'ZRT01CRH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRT01CRH-001.
               CALL 'ZRT01CRH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRT01CRH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
