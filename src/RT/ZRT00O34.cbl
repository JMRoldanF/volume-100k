      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRT00O34'.
      ...
      * Called module names
       01  MOD-ZRT01INW              PIC X(8) VALUE 'ZRT01INW'.
       01  MOD-ZRT01M6G              PIC X(8) VALUE 'ZRT01M6G'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRT01INW-001.
               PERFORM CALL-ZRT01M6G-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRT01INW-001.
               CALL 'ZRT01INW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRT01INW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRT01M6G-002.
               CALL 'ZRT01M6G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRT01M6G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
