      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRT019WF'.
      ...
      * Called module names
       01  MOD-ZRT01NDG              PIC X(8) VALUE 'ZRT01NDG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRT01NDG-001.
               CALL 'ZRT01NDG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRT01NDG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
