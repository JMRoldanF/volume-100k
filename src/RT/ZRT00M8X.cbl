      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRT00M8X'.
      ...
      * Called module names
       01  MOD-ZRT01GZ6              PIC X(8) VALUE 'ZRT01GZ6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRT01GZ6-001.
               CALL 'ZRT01GZ6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRT01GZ6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
