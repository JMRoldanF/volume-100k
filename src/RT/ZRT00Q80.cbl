      ******************************************************************
      * ZRT00Q80 - RATING TABLES                                       *
      ******************************************************************
      *
      *  Generated volume-test source. Layer 2,
      *  type data_db2, domain RATING.
      ******************************************************************
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRT00Q80'.
      ...
      * Called module names
       01  MOD-ZRT01J67              PIC X(8) VALUE 'ZRT01J67'.
       01  MOD-ZRT01PXY              PIC X(8) VALUE 'ZRT01PXY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRT01J67-001.
               PERFORM CALL-ZRT01PXY-002.
               ...
               PERFORM NORMALISE-MANAGED-FUND-0092.
               ...
               PERFORM RECONCILE-TERM-0110.
               PERFORM SQL-ACCESS-0111.
               PERFORM APPLY-BEDROOMS-0112.
               PERFORM EXPAND-WITH-PROFITS-0113.
               ...
               PERFORM FORMAT-MODEL-0122.
               PERFORM SQL-ACCESS-0123.
               PERFORM VALIDATE-EXCESS-0124.
               PERFORM FORMAT-TAX-BAND-0125.
               PERFORM SQL-ACCESS-0126.
               PERFORM AUDIT-AGENT-CODE-0127.
               PERFORM COMPUTE-MANAGED-FUND-0128.
               PERFORM SQL-ACCESS-0129.
               PERFORM FORMAT-BROKER-ID-0130.
               PERFORM AUDIT-NCD-YEARS-0131.
               PERFORM REFRESH-VALUE-0133.
               PERFORM RESOLVE-EQUITIES-0134.
               PERFORM SQL-ACCESS-0135.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZRT01J67-001.
               CALL 'ZRT01J67' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRT01J67 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRT01PXY-002.
               CALL 'ZRT01PXY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRT01PXY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       ...
       SQL-ACCESS-0009.
               EXEC SQL
                     ...
                     SELECT POLICYNUMBER, PAYMENT
                       FROM GENART.DISCOUNT A
                       JOIN GENART.CUSTOMER B
