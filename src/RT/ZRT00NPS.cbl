      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRT00NPS'.
      ...
      * Called module names
       ...
       01  MOD-ZRT01UOV              PIC X(8) VALUE 'ZRT01UOV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRT01UOV-002.
               CALL 'ZRT01UOV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRT01UOV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
