      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRT00ZXP'.
      ...
      * Called module names
       01  MOD-ZSC01SMY              PIC X(8) VALUE 'ZSC01SMY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSC01SMY-001.
               CALL 'ZSC01SMY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC01SMY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRT01JVK-002.
