      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRT00VOU'.
      ...
      * Called module names
       ...
       01  MOD-ZSC01DEY              PIC X(8) VALUE 'ZSC01DEY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRT01QHU-001.
               PERFORM CALL-ZSC01DEY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSC01DEY-002.
               CALL 'ZSC01DEY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC01DEY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
