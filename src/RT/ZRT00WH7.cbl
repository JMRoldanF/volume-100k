      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRT00WH7'.
      ...
      * Called module names
       01  MOD-ZRT01IDM              PIC X(8) VALUE 'ZRT01IDM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRT01IDM-001.
               CALL 'ZRT01IDM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRT01IDM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-MAKE-0001.
