      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRT00R6O'.
      ...
      * Called module names
       01  MOD-ZRT01TWS              PIC X(8) VALUE 'ZRT01TWS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRT01TWS-001.
               CALL 'ZRT01TWS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRT01TWS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-PREMIUM-0001.
