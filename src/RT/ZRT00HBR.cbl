      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRT00HBR'.
      ...
      * Called module names
       01  MOD-ZRT014K4              PIC X(8) VALUE 'ZRT014K4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRT010XI-001.
               MOVE 'ZRT010XI' TO WS-PROGNAME-1
      ...
      *----------------------------------------------------------------*
       CALL-ZRT014K4-002.
               EXEC CICS LINK PROGRAM('ZRT014K4')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRT014K4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
