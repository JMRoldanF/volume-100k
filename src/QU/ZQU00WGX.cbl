      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZQU00WGX'.
      ...
      * Called module names
       01  MOD-ZQU01ML7              PIC X(8) VALUE 'ZQU01ML7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZQU01ML7-001.
               CALL 'ZQU01ML7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU01ML7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
