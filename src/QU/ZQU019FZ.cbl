      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZQU019FZ'.
      ...
      * Called module names
       01  MOD-ZQU01OOZ              PIC X(8) VALUE 'ZQU01OOZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZQU01OOZ-001.
               CALL 'ZQU01OOZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU01OOZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZQU01FXV-002.
               MOVE 'ZQU01FXV' TO WS-SUBNAME-3
      ...
      *----------------------------------------------------------------*
       FILE-ACCESS-0006.
               EXEC CICS DELETE FILE('KSDSQU68')
                         RIDFLD(WS-KEY-AREA)
                         RESP(WS-RESP)
               END-EXEC.
               EVALUATE WS-RESP
