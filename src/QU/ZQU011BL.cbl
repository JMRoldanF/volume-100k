      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZQU011BL'.
      ...
      * Called module names
       01  MOD-ZQU01KHR              PIC X(8) VALUE 'ZQU01KHR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZQU01KHR-001.
               PERFORM NORMALISE-WITH-PROFITS-0001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZQU01KHR-001.
               CALL 'ZQU01KHR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
