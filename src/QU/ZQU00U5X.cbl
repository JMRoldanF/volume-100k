      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZQU00U5X'.
      ...
      * Called module names
       ...
       01  MOD-ZQU01HWB              PIC X(8) VALUE 'ZQU01HWB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZQU01HWB-002.
               CALL 'ZQU01HWB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
