      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZQU00V8L'.
      ...
      * Called module names
       01  MOD-ZQU01PVU              PIC X(8) VALUE 'ZQU01PVU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZQU01PVU-001.
               CALL 'ZQU01PVU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU01PVU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-MAKE-0001.
