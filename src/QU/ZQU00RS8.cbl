      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZQU00RS8'.
      ...
      * Called module names
       01  MOD-ZIF01KLZ              PIC X(8) VALUE 'ZIF01KLZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIF01KLZ-001.
               CALL 'ZIF01KLZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIF01KLZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
