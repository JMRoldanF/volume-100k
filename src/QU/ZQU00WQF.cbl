      ******************************************************************
      * ZQU00WQF - QUOTATION ENGINE                                    *
      ******************************************************************
      *
      *  Generated volume-test source. Layer 2,
      *  type data_db2, domain QUOTE.
      ******************************************************************
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZQU00WQF'.
      ...
      * Called module names
       01  MOD-ZQU01NEA              PIC X(8) VALUE 'ZQU01NEA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZQU01NEA-001.
               CALL 'ZQU01NEA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU01NEA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
