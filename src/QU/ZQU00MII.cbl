      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZQU00MII'.
      ...
      * Called module names
       01  MOD-ZQU01GX5              PIC X(8) VALUE 'ZQU01GX5'.
       01  MOD-ZQU01EPE              PIC X(8) VALUE 'ZQU01EPE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZQU01GX5-001.
               PERFORM CALL-ZQU01EPE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZQU01GX5-001.
               CALL 'ZQU01GX5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU01GX5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZQU01EPE-002.
               CALL 'ZQU01EPE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU01EPE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
