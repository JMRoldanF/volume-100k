      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZQU00VTD'.
      ...
      * Called module names
       01  MOD-ZCU01QCE              PIC X(8) VALUE 'ZCU01QCE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01QCE-001.
               PERFORM CALL-ZIF01DY3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01QCE-001.
               CALL 'ZCU01QCE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01QCE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIF01DY3-002.
