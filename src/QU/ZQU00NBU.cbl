      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZQU00NBU'.
      ...
      * Called module names
       01  MOD-ZQU01IOQ              PIC X(8) VALUE 'ZQU01IOQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZQU01IOQ-001.
               CALL 'ZQU01IOQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU01IOQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-EXCESS-0001.
