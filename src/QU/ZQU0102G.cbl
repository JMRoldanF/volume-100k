      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZQU0102G'.
      ...
      * Called module names
       01  MOD-ZQU01DTY              PIC X(8) VALUE 'ZQU01DTY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZQU01DTY-001.
               CALL 'ZQU01DTY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU01DTY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
