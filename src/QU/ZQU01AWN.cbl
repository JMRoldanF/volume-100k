      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZQU01AWN'.
      ...
      * Called module names
       ...
       01  MOD-ZQU01UXX              PIC X(8) VALUE 'ZQU01UXX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZQU01N6C-001.
               PERFORM CALL-ZQU01UXX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZQU01UXX-002.
               CALL 'ZQU01UXX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU01UXX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
