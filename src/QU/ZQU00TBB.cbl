      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZQU00TBB'.
      ...
      * Called module names
       01  MOD-ZQU01GYC              PIC X(8) VALUE 'ZQU01GYC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZQU01GYC-001.
               PERFORM CALL-ZQU01OK3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZQU01GYC-001.
               CALL 'ZQU01GYC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU01GYC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZQU01OK3-002.
               MOVE 'ZQU01OK3' TO WS-SUBNAME-3
