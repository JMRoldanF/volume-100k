      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZQU00MCS'.
      ...
      * Called module names
       01  MOD-ZQU01IBV              PIC X(8) VALUE 'ZQU01IBV'.
       01  MOD-ZQU01SG1              PIC X(8) VALUE 'ZQU01SG1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZQU01IBV-001.
               CALL 'ZQU01IBV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU01IBV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZQU01SG1-002.
               CALL 'ZQU01SG1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU01SG1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
