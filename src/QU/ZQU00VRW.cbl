      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZQU00VRW'.
      ...
      * Called module names
       01  MOD-ZQU01FX5              PIC X(8) VALUE 'ZQU01FX5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZQU01FX5-001.
               PERFORM CALL-ZQU01TAU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZQU01FX5-001.
               CALL 'ZQU01FX5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU01FX5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZQU01TAU-002.
