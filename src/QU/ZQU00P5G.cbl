      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZQU00P5G'.
      ...
      * Called module names
       01  MOD-ZQU01RQ9              PIC X(8) VALUE 'ZQU01RQ9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZQU01RQ9-001.
               CALL 'ZQU01RQ9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU01RQ9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZQU01EPE-002.
