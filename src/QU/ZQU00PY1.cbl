      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZQU00PY1'.
      ...
      * Called module names
       01  MOD-ZQU01LQW              PIC X(8) VALUE 'ZQU01LQW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZQU01LQW-001.
               PERFORM CALL-ZFL01CZI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZQU01LQW-001.
               CALL 'ZQU01LQW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU01LQW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFL01CZI-002.
