      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZQU00ODP'.
      ...
      * Called module names
       01  MOD-ZQU01P81              PIC X(8) VALUE 'ZQU01P81'.
      ...
      *----------------------------------------------------------------*
       CALL-ZQU01P81-001.
               CALL 'ZQU01P81' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU01P81 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
