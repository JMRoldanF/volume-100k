      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZQU00OER'.
      ...
      * Called module names
       01  MOD-ZQU01HO7              PIC X(8) VALUE 'ZQU01HO7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZQU01HO7-001.
               CALL 'ZQU01HO7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU01HO7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
