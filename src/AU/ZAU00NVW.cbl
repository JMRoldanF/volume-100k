      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAU00NVW'.
      ...
      * Called module names
       01  MOD-ZAU01G6H              PIC X(8) VALUE 'ZAU01G6H'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAU01G6H-001.
               PERFORM CALL-ZPA01HCI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAU01G6H-001.
               CALL 'ZAU01G6H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAU01G6H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01HCI-002.
               MOVE 'ZPA01HCI' TO WS-SUBNAME-8
