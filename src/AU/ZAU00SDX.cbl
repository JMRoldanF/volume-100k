      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAU00SDX'.
      ...
      * Called module names
       01  MOD-ZPE01NIP              PIC X(8) VALUE 'ZPE01NIP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01NIP-001.
               CALL 'ZPE01NIP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01NIP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
