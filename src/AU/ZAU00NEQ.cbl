      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAU00NEQ'.
      ...
      * Called module names
       01  MOD-ZAU01ESB              PIC X(8) VALUE 'ZAU01ESB'.
       01  MOD-ZAU01T23              PIC X(8) VALUE 'ZAU01T23'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAU01ESB-001.
               CALL 'ZAU01ESB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAU01ESB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAU01T23-002.
               CALL 'ZAU01T23' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAU01T23 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
