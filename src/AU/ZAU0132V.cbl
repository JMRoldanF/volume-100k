      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAU0132V'.
      ...
      * Called module names
       01  MOD-ZAU01NA9              PIC X(8) VALUE 'ZAU01NA9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAU01NA9-001.
               CALL 'ZAU01NA9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAU01NA9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
