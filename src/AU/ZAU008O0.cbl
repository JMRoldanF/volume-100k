      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAU008O0'.
      ...
      * Called module names
       ...
       01  MOD-ZAU00WFB              PIC X(8) VALUE 'ZAU00WFB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAU00TLD-001.
               PERFORM CALL-ZAU00MIL-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZAU00WFB-002.
               EXEC CICS LINK PROGRAM('ZAU00WFB')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAU00WFB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAU00MIL-003.
