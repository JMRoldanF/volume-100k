      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAU00X95'.
      ...
      * Called module names
       01  MOD-ZAU01F5P              PIC X(8) VALUE 'ZAU01F5P'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAU01F5P-001.
               CALL 'ZAU01F5P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAU01F5P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
