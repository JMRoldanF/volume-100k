      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAU00QRZ'.
      ...
      * Called module names
       01  MOD-ZPA01PQ0              PIC X(8) VALUE 'ZPA01PQ0'.
       01  MOD-ZAU01FM1              PIC X(8) VALUE 'ZAU01FM1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01PQ0-001.
               PERFORM CALL-ZAU01FM1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01PQ0-001.
               CALL 'ZPA01PQ0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01PQ0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAU01FM1-002.
               CALL 'ZAU01FM1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAU01FM1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
