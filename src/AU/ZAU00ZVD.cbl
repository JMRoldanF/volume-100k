      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAU00ZVD'.
      ...
      * Called module names
       ...
       01  MOD-ZAU01EKC              PIC X(8) VALUE 'ZAU01EKC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAU01EKC-002.
               CALL 'ZAU01EKC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAU01EKC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
