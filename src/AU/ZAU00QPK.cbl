      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAU00QPK'.
      ...
      * Called module names
       01  MOD-ZPE01IS9              PIC X(8) VALUE 'ZPE01IS9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01IS9-001.
               CALL 'ZPE01IS9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01IS9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
