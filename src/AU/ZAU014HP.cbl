      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAU014HP'.
      ...
      * Called module names
       01  MOD-ZAU01IPX              PIC X(8) VALUE 'ZAU01IPX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAU01IPX-001.
               CALL 'ZAU01IPX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAU01IPX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
