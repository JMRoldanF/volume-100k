      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAU01132'.
      ...
      * Called module names
       01  MOD-ZAU01JJI              PIC X(8) VALUE 'ZAU01JJI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAU01JJI-001.
               CALL 'ZAU01JJI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAU01JJI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAU01DLA-002.
