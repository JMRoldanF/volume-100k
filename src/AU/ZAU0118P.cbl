      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAU0118P'.
      ...
      * Called module names
       01  MOD-ZAU01NFM              PIC X(8) VALUE 'ZAU01NFM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAU01NFM-001.
               CALL 'ZAU01NFM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAU01NFM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
