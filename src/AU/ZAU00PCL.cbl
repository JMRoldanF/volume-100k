      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAU00PCL'.
      ...
      * Called module names
       01  MOD-ZPE01DYW              PIC X(8) VALUE 'ZPE01DYW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPE01DYW-001.
               PERFORM CALL-ZAU01CN2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01DYW-001.
               CALL 'ZPE01DYW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01DYW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAU01CN2-002.
