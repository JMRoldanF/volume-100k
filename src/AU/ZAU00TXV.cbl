      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAU00TXV'.
      ...
      * Called module names
       01  MOD-ZAU01MYB              PIC X(8) VALUE 'ZAU01MYB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAU01MYB-001.
               CALL 'ZAU01MYB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAU01MYB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
