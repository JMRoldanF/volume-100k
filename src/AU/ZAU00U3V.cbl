      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAU00U3V'.
      ...
      * Called module names
       01  MOD-ZTX01GUS              PIC X(8) VALUE 'ZTX01GUS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01GUS-001.
               CALL 'ZTX01GUS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01GUS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-POSTCODE-0001.
