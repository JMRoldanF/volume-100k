      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAU00SUG'.
      ...
      * Called module names
       01  MOD-ZAU01E5X              PIC X(8) VALUE 'ZAU01E5X'.
       01  MOD-ZAU01NZV              PIC X(8) VALUE 'ZAU01NZV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAU01E5X-001.
               PERFORM CALL-ZAU01NZV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAU01E5X-001.
               CALL 'ZAU01E5X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZAU01NZV-002.
               CALL 'ZAU01NZV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAU01NZV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
