      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAU00T8N'.
      ...
      * Called module names
       01  MOD-ZAU01LQK              PIC X(8) VALUE 'ZAU01LQK'.
       01  MOD-ZAU01DLA              PIC X(8) VALUE 'ZAU01DLA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAU01LQK-001.
               PERFORM CALL-ZAU01DLA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAU01LQK-001.
               CALL 'ZAU01LQK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAU01LQK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAU01DLA-002.
               CALL 'ZAU01DLA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAU01DLA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-COLOUR-0001.
