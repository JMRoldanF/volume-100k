      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAU00U22'.
      ...
      * Called module names
       01  MOD-ZPE01EG6              PIC X(8) VALUE 'ZPE01EG6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01EG6-001.
               CALL 'ZPE01EG6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01EG6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
