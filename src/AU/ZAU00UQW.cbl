      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAU00UQW'.
      ...
      * Called module names
       01  MOD-ZAU01LIR              PIC X(8) VALUE 'ZAU01LIR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAU01LIR-001.
               CALL 'ZAU01LIR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAU01LIR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
