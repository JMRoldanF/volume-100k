      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAU00N7Z'.
      ...
      * Called module names
       01  MOD-ZAU01UDE              PIC X(8) VALUE 'ZAU01UDE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAU01UDE-001.
               CALL 'ZAU01UDE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAU01UDE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
