      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAU00SLT'.
      ...
      * Called module names
       01  MOD-ZAU01IUT              PIC X(8) VALUE 'ZAU01IUT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAU01IUT-001.
               CALL 'ZAU01IUT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAU01IUT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
