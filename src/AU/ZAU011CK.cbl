      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAU011CK'.
      ...
      * Called module names
       01  MOD-ZPA01HMP              PIC X(8) VALUE 'ZPA01HMP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01HMP-001.
               PERFORM CALL-ZAU01FUD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01HMP-001.
               CALL 'ZPA01HMP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01HMP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAU01FUD-002.
