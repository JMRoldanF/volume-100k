      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAU00XYX'.
      ...
      * Called module names
       ...
       01  MOD-ZPE01JW9              PIC X(8) VALUE 'ZPE01JW9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01JW9-002.
               CALL 'ZPE01JW9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01JW9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
