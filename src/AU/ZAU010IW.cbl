      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAU010IW'.
      ...
      * Called module names
       01  MOD-ZAU01QQ1              PIC X(8) VALUE 'ZAU01QQ1'.
       01  MOD-ZAU01IDI              PIC X(8) VALUE 'ZAU01IDI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAU01QQ1-001.
               PERFORM CALL-ZAU01IDI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAU01QQ1-001.
               CALL 'ZAU01QQ1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAU01QQ1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAU01IDI-002.
               CALL 'ZAU01IDI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAU01IDI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
