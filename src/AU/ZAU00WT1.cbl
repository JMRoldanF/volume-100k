      ******************************************************************
      * ZAU00WT1 - AUDIT TRAIL                                         *
      ******************************************************************
      *
      *  Generated volume-test source. Layer 2,
      *  type data_db2, domain AUDIT.
      ******************************************************************
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAU00WT1'.
       ...
       SQL-ACCESS-0027.
               EXEC SQL
                     ...
                     SELECT POLICYNUMBER, PAYMENT
                       FROM GENAAU.RESERVE A
                       JOIN GENAAU.CUSTOMER B
