      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAU00SBL'.
      ...
      * Called module names
       ...
       01  MOD-ZAU01E8M              PIC X(8) VALUE 'ZAU01E8M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAU01E8M-002.
               CALL 'ZAU01E8M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAU01E8M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-MAKE-0001.
