      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAU00OK8'.
      ...
      * Called module names
       01  MOD-ZAU01ETV              PIC X(8) VALUE 'ZAU01ETV'.
       01  MOD-ZAU01N58              PIC X(8) VALUE 'ZAU01N58'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAU01ETV-001.
               PERFORM CALL-ZAU01N58-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAU01ETV-001.
               CALL 'ZAU01ETV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAU01ETV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAU01N58-002.
               CALL 'ZAU01N58' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAU01N58 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
