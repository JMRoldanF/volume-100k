      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAU011WR'.
      ...
      * Called module names
       01  MOD-ZAU01EUA              PIC X(8) VALUE 'ZAU01EUA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAU01EUA-001.
               CALL 'ZAU01EUA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAU01EUA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-PREMIUM-0001.
