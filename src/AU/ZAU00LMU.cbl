      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAU00LMU'.
      ...
      * Called module names
       01  MOD-ZAU01IIM              PIC X(8) VALUE 'ZAU01IIM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAU01IIM-001.
               CALL 'ZAU01IIM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAU01IIM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
