      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAU00Z71'.
      ...
      * Called module names
       01  MOD-ZAU01U3O              PIC X(8) VALUE 'ZAU01U3O'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAU01RIO-001.
               PERFORM CALL-ZAU01U3O-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAU01U3O-002.
               CALL 'ZAU01U3O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAU01U3O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
