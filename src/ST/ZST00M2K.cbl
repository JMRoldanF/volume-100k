      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZST00M2K'.
      ...
      * Called module names
       01  MOD-ZST01ELG              PIC X(8) VALUE 'ZST01ELG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZST01ELG-001.
               CALL 'ZST01ELG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01ELG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
