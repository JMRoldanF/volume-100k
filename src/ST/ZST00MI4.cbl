      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZST00MI4'.
      ...
      * Called module names
       01  MOD-ZST01JHG              PIC X(8) VALUE 'ZST01JHG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZST01JHG-001.
               PERFORM CALL-ZST01KSC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZST01JHG-001.
               CALL 'ZST01JHG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01JHG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZST01KSC-002.
