      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZST00MS2'.
      ...
      * Called module names
       01  MOD-ZST01QO8              PIC X(8) VALUE 'ZST01QO8'.
       01  MOD-ZST01KNY              PIC X(8) VALUE 'ZST01KNY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZST01QO8-001.
               PERFORM CALL-ZST01KNY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZST01QO8-001.
               CALL 'ZST01QO8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01QO8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZST01KNY-002.
               CALL 'ZST01KNY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01KNY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-MAKE-0001.
