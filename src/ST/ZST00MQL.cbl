      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZST00MQL'.
      ...
      * Called module names
       01  MOD-ZST01R4M              PIC X(8) VALUE 'ZST01R4M'.
       01  MOD-ZEX01P3O              PIC X(8) VALUE 'ZEX01P3O'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZST01R4M-001.
               PERFORM CALL-ZEX01P3O-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZST01R4M-001.
               CALL 'ZST01R4M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01R4M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEX01P3O-002.
               CALL 'ZEX01P3O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
