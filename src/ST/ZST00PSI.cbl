      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZST00PSI'.
      ...
      * Called module names
       ...
       01  MOD-ZST01THT              PIC X(8) VALUE 'ZST01THT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZST01THT-002.
               CALL 'ZST01THT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01THT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
