      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZST00MD1'.
      ...
      * Called module names
       01  MOD-ZST01T34              PIC X(8) VALUE 'ZST01T34'.
       01  MOD-ZST01ICG              PIC X(8) VALUE 'ZST01ICG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZST01T34-001.
               PERFORM CALL-ZST01ICG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZST01T34-001.
               CALL 'ZST01T34' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01T34 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZST01ICG-002.
               CALL 'ZST01ICG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01ICG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
