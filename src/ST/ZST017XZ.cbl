      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZST017XZ'.
      ...
      * Called module names
       ...
       01  MOD-ZST01PM1              PIC X(8) VALUE 'ZST01PM1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZST01PM1-002.
               CALL 'ZST01PM1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01PM1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-MODEL-0001.
