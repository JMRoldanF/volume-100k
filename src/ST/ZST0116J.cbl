      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZST0116J'.
      ...
      * Called module names
       01  MOD-ZST01OOS              PIC X(8) VALUE 'ZST01OOS'.
       01  MOD-ZST01E45              PIC X(8) VALUE 'ZST01E45'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZST01OOS-001.
               PERFORM CALL-ZST01E45-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZST01OOS-001.
               CALL 'ZST01OOS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01OOS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZST01E45-002.
               CALL 'ZST01E45' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01E45 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
