      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZST00ZB8'.
      ...
      * Called module names
       01  MOD-ZST01PQL              PIC X(8) VALUE 'ZST01PQL'.
       01  MOD-ZST01QAA              PIC X(8) VALUE 'ZST01QAA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZST01PQL-001.
               PERFORM CALL-ZST01QAA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZST01PQL-001.
               CALL 'ZST01PQL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01PQL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZST01QAA-002.
               CALL 'ZST01QAA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01QAA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
