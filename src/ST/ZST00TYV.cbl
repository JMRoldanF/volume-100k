      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZST00TYV'.
      ...
      * Called module names
       01  MOD-ZCO01QK6              PIC X(8) VALUE 'ZCO01QK6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01QK6-001.
               CALL 'ZCO01QK6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01QK6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZST01L94-002.
