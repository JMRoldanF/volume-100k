      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZST00R81'.
      ...
      * Called module names
       01  MOD-ZST01GXJ              PIC X(8) VALUE 'ZST01GXJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZST01GXJ-001.
               PERFORM CALL-ZST01TWI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZST01GXJ-001.
               CALL 'ZST01GXJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01GXJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZST01TWI-002.
