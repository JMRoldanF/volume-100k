      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZST00RCX'.
      ...
      * Called module names
       01  MOD-ZST01EDX              PIC X(8) VALUE 'ZST01EDX'.
       01  MOD-ZST01K4H              PIC X(8) VALUE 'ZST01K4H'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZST01EDX-001.
               PERFORM CALL-ZST01K4H-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZST01EDX-001.
               CALL 'ZST01EDX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01EDX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZST01K4H-002.
               CALL 'ZST01K4H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01K4H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
