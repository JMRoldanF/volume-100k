      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZST00TFX'.
      ...
      * Called module names
       01  MOD-ZST01SNK              PIC X(8) VALUE 'ZST01SNK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZST01SNK-001.
               PERFORM CALL-ZST01R4M-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZST01SNK-001.
               CALL 'ZST01SNK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01SNK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZST01R4M-002.
