      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZST00LNB'.
      ...
      * Called module names
       01  MOD-ZST01CYM              PIC X(8) VALUE 'ZST01CYM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZST01CYM-001.
               CALL 'ZST01CYM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01CYM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZST01G5O-002.
               MOVE 'ZST01G5O' TO WS-SUBNAME-4
