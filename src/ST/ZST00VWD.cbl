      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZST00VWD'.
      ...
      * Called module names
       01  MOD-ZST01K1R              PIC X(8) VALUE 'ZST01K1R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZST01K1R-001.
               CALL 'ZST01K1R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01K1R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
