      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZST0113Y'.
      ...
      * Called module names
       01  MOD-ZST01T08              PIC X(8) VALUE 'ZST01T08'.
      ...
      *----------------------------------------------------------------*
       CALL-ZST01T08-001.
               CALL 'ZST01T08' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01T08 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEX01R8Z-002.
               MOVE 'ZEX01R8Z' TO WS-SUBNAME-8
