      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZST00MSA'.
      ...
      * Called module names
       01  MOD-ZST01MP9              PIC X(8) VALUE 'ZST01MP9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZST01MP9-001.
               CALL 'ZST01MP9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01MP9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
