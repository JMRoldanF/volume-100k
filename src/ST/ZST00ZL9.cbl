      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZST00ZL9'.
      ...
      * Called module names
       01  MOD-ZST01DY2              PIC X(8) VALUE 'ZST01DY2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZST01DY2-001.
               CALL 'ZST01DY2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01DY2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
