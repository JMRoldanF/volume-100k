      ******************************************************************
      * ZST00V7M - CLAIM SETTLEMENT                                    *
      ******************************************************************
      *
      *  Generated volume-test source. Layer 2,
      *  type data_db2, domain SETTLE.
      ******************************************************************
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZST00V7M'.
      ...
      * Called module names
       01  MOD-ZST01K5I              PIC X(8) VALUE 'ZST01K5I'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM DERIVE-REG-NUMBER-0106.
               ...
               PERFORM VALIDATE-HOUSE-TYPE-0122.
               PERFORM REFRESH-NCD-YEARS-0124.
               PERFORM EXPAND-EQUITIES-0125.
               PERFORM SQL-ACCESS-0126.
               PERFORM EXPAND-TERM-0127.
      ...
      *----------------------------------------------------------------*
       CALL-ZST01K5I-001.
               CALL 'ZST01K5I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01K5I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
       ...
       SQL-ACCESS-0003.
               EXEC SQL
                     ...
                     SELECT POLICYNUMBER, PAYMENT
                       FROM GENAST.PAYMENT A
                       JOIN GENAST.CUSTOMER B
