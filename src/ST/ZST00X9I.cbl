      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZST00X9I'.
      ...
      * Called module names
       01  MOD-ZCO01MQV              PIC X(8) VALUE 'ZCO01MQV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01MQV-001.
               CALL 'ZCO01MQV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01MQV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
