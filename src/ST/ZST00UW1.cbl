      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZST00UW1'.
      ...
      * Called module names
       01  MOD-ZCO01LNY              PIC X(8) VALUE 'ZCO01LNY'.
       01  MOD-ZST01SEO              PIC X(8) VALUE 'ZST01SEO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCO01LNY-001.
               PERFORM CALL-ZST01SEO-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01LNY-001.
               CALL 'ZCO01LNY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01LNY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZST01SEO-002.
               CALL 'ZST01SEO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01SEO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
