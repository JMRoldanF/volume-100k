      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZST00WP3'.
      ...
      * Called module names
       01  MOD-ZST01DXM              PIC X(8) VALUE 'ZST01DXM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZST01DXM-001.
               PERFORM CALL-ZST01DXM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZST01DXM-001.
               MOVE 'ZST01DXM' TO WS-SUBNAME-1
               CALL WS-SUBNAME-1 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01DXM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZST01DXM-002.
               CALL 'ZST01DXM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01DXM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
