      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZST00ZF6'.
      ...
      * Called module names
       01  MOD-ZST01DOH              PIC X(8) VALUE 'ZST01DOH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZST01DOH-001.
               CALL 'ZST01DOH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01DOH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
