      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZST00RDD'.
      ...
      * Called module names
       01  MOD-ZST01EAD              PIC X(8) VALUE 'ZST01EAD'.
       01  MOD-ZST01DE2              PIC X(8) VALUE 'ZST01DE2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZST01EAD-001.
               PERFORM CALL-ZST01DE2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZST01EAD-001.
               CALL 'ZST01EAD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01EAD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZST01DE2-002.
               CALL 'ZST01DE2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01DE2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       VALIDATE-TERM-0001.
