      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZST00TC2'.
      ...
      * Called module names
       01  MOD-ZST01L94              PIC X(8) VALUE 'ZST01L94'.
       01  MOD-ZST01PV8              PIC X(8) VALUE 'ZST01PV8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZST01L94-001.
               PERFORM CALL-ZST01PV8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZST01L94-001.
               CALL 'ZST01L94' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01L94 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZST01PV8-002.
               CALL 'ZST01PV8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01PV8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
