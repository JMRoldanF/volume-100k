      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZST00YN5'.
      ...
      * Called module names
       01  MOD-ZST01DXG              PIC X(8) VALUE 'ZST01DXG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZST01DXG-001.
               PERFORM CALL-ZST01K5I-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZST01DXG-001.
               CALL 'ZST01DXG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01DXG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZST01K5I-002.
