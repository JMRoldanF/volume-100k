      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZST00P7Q'.
      ...
      * Called module names
       01  MOD-ZST01R7S              PIC X(8) VALUE 'ZST01R7S'.
      ...
      *----------------------------------------------------------------*
       CALL-ZST01R7S-001.
               CALL 'ZST01R7S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZST01R7S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
