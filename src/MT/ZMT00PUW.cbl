      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00PUW'.
      ...
      * Called module names
       01  MOD-ZMT01MKT              PIC X(8) VALUE 'ZMT01MKT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01MKT-001.
               CALL 'ZMT01MKT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01MKT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
