      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT010TA'.
      ...
      * Called module names
       01  MOD-ZMT01GLG              PIC X(8) VALUE 'ZMT01GLG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01GLG-001.
               CALL 'ZMT01GLG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01GLG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RECONCILE-TERM-0001.
