      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00SJK'.
      ...
      * Called module names
       01  MOD-ZPT01O9Q              PIC X(8) VALUE 'ZPT01O9Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPT01O9Q-001.
               CALL 'ZPT01O9Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01O9Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01QBU-002.
