      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00LPN'.
      ...
      * Called module names
       01  MOD-ZMT01P4S              PIC X(8) VALUE 'ZMT01P4S'.
       01  MOD-ZMT01LLV              PIC X(8) VALUE 'ZMT01LLV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01P4S-001.
               PERFORM CALL-ZMT01LLV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01P4S-001.
               CALL 'ZMT01P4S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01P4S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01LLV-002.
               CALL 'ZMT01LLV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01LLV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
