      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00SA8'.
      ...
      * Called module names
       01  MOD-ZMT01DOT              PIC X(8) VALUE 'ZMT01DOT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM APPLY-WITH-PROFITS-0091.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01DOT-001.
               CALL 'ZMT01DOT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01DOT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
