      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00ZLZ'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01RIP              PIC X(8) VALUE 'ZMT01RIP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01RIP-002.
               CALL 'ZMT01RIP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01RIP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
