      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01GQ7'.
      ...
      * Called module names
       01  MOD-ZMT01T7Z              PIC X(8) VALUE 'ZMT01T7Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01T7Z-001.
               CALL 'ZMT01T7Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01T7Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
