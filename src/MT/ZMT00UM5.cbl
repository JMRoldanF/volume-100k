      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00UM5'.
      ...
      * Called module names
       01  MOD-ZMT01LVG              PIC X(8) VALUE 'ZMT01LVG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01LVG-001.
               CALL 'ZMT01LVG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01LVG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-MODEL-0001.
