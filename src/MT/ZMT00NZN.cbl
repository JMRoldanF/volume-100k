      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00NZN'.
      ...
      * Called module names
       01  MOD-ZMT01DXT              PIC X(8) VALUE 'ZMT01DXT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01DXT-001.
               CALL 'ZMT01DXT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01DXT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
