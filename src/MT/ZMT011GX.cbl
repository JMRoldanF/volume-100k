      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT011GX'.
      ...
      * Called module names
       01  MOD-ZMT01L4F              PIC X(8) VALUE 'ZMT01L4F'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01L4F-001.
               CALL 'ZMT01L4F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01L4F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
