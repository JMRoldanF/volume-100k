      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00PDN'.
      ...
      * Called module names
       01  MOD-ZAG01O4Y              PIC X(8) VALUE 'ZAG01O4Y'.
       01  MOD-ZCL01UJ5              PIC X(8) VALUE 'ZCL01UJ5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01O4Y-001.
               PERFORM CALL-ZCL01UJ5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01O4Y-001.
               CALL 'ZAG01O4Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01O4Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01UJ5-002.
               CALL 'ZCL01UJ5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01UJ5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
