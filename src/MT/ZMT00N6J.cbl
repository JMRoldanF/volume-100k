      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00N6J'.
      ...
      * Called module names
       01  MOD-ZMT01LG0              PIC X(8) VALUE 'ZMT01LG0'.
       01  MOD-ZMT01PW3              PIC X(8) VALUE 'ZMT01PW3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01LG0-001.
               CALL 'ZMT01LG0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01LG0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01PW3-002.
               CALL 'ZMT01PW3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01PW3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
