      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00TF7'.
      ...
      * Called module names
       01  MOD-ZMT01RXF              PIC X(8) VALUE 'ZMT01RXF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01RXF-001.
               CALL 'ZMT01RXF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01RXF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-EXCESS-0001.
