      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00Y2V'.
      ...
      * Called module names
       01  MOD-ZMT01R7N              PIC X(8) VALUE 'ZMT01R7N'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01R7N-001.
               CALL 'ZMT01R7N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01R7N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
