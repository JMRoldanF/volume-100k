      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00TNT'.
      ...
      * Called module names
       01  MOD-ZMT01TCT              PIC X(8) VALUE 'ZMT01TCT'.
       01  MOD-ZPA01DWX              PIC X(8) VALUE 'ZPA01DWX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01TCT-001.
               PERFORM CALL-ZPA01DWX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01TCT-001.
               CALL 'ZMT01TCT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01TCT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01DWX-002.
               CALL 'ZPA01DWX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01DWX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
