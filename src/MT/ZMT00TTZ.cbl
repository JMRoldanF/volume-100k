      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00TTZ'.
      ...
      * Called module names
       01  MOD-ZMT01RSK              PIC X(8) VALUE 'ZMT01RSK'.
       01  MOD-ZMT01MK7              PIC X(8) VALUE 'ZMT01MK7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01RSK-001.
               PERFORM CALL-ZMT01MK7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01RSK-001.
               CALL 'ZMT01RSK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01RSK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01MK7-002.
               CALL 'ZMT01MK7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
