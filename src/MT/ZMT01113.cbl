      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01113'.
      ...
      * Called module names
       01  MOD-ZMT01P3H              PIC X(8) VALUE 'ZMT01P3H'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01P3H-001.
               CALL 'ZMT01P3H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01P3H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
