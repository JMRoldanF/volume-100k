      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00S87'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01M1G-001.
               PERFORM CALL-ZMT01TJ6-002.
               PERFORM CALL-ZBI0255Q-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZMT01M1G-001.
               MOVE 'ZMT01M1G' TO WS-SUBNAME-8
