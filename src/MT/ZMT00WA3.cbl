      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00WA3'.
      ...
      * Called module names
       01  MOD-ZMT01T47              PIC X(8) VALUE 'ZMT01T47'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01T47-001.
               CALL 'ZMT01T47' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01T47 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
