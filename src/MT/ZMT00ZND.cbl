      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00ZND'.
      ...
      * Called module names
       01  MOD-ZMT01TAB              PIC X(8) VALUE 'ZMT01TAB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01TAB-001.
               CALL 'ZMT01TAB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01TAB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01KX7-002.
