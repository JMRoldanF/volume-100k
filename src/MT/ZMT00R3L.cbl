      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00R3L'.
      ...
      * Called module names
       01  MOD-ZMT01R7V              PIC X(8) VALUE 'ZMT01R7V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01R7V-001.
               CALL 'ZMT01R7V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01R7V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
