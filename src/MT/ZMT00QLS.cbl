      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00QLS'.
      ...
      * Called module names
       01  MOD-ZMT01RJR              PIC X(8) VALUE 'ZMT01RJR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01RJR-001.
               CALL 'ZMT01RJR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01RJR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
