      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01T7Y'.
      ...
      * Called module names
       01  MOD-ZMT01M9B              PIC X(8) VALUE 'ZMT01M9B'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01M9B-001.
               CALL 'ZMT01M9B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01M9B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
