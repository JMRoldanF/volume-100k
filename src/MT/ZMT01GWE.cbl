      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01GWE'.
      ...
      * Called module names
       01  MOD-ZMT01EEW              PIC X(8) VALUE 'ZMT01EEW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01EEW-001.
               CALL 'ZMT01EEW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01EEW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
