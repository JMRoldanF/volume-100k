      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00XGK'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01H0P              PIC X(8) VALUE 'ZMT01H0P'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01MQE-001.
               PERFORM CALL-ZMT01H0P-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01H0P-002.
               CALL 'ZMT01H0P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01H0P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
