      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00N71'.
      ...
      * Called module names
       01  MOD-ZMT01U1J              PIC X(8) VALUE 'ZMT01U1J'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01U1J-001.
               CALL 'ZMT01U1J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01U1J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
