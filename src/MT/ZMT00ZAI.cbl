      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00ZAI'.
      ...
      * Called module names
       01  MOD-ZQU01KFS              PIC X(8) VALUE 'ZQU01KFS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZQU01KFS-001.
               PERFORM CALL-ZPT01N5Z-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZQU01KFS-001.
               CALL 'ZQU01KFS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU01KFS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPT01N5Z-002.
               MOVE 'ZPT01N5Z' TO WS-SUBNAME-2
