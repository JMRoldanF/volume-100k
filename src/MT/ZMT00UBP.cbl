      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00UBP'.
      ...
      * Called module names
       01  MOD-ZMT01KKF              PIC X(8) VALUE 'ZMT01KKF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01GJ5-002.
               PERFORM FORMAT-VALUE-0001.
               PERFORM COMPUTE-TERM-0002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZMT01KKF-001.
               CALL 'ZMT01KKF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
