      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00ZYT'.
      ...
      * Called module names
       01  MOD-ZMT01H8M              PIC X(8) VALUE 'ZMT01H8M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01H8M-001.
               CALL 'ZMT01H8M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01H8M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
