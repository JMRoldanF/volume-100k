      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT010ZA'.
      ...
      * Called module names
       01  MOD-ZMT01G6Y              PIC X(8) VALUE 'ZMT01G6Y'.
       01  MOD-ZCP01R98              PIC X(8) VALUE 'ZCP01R98'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01G6Y-001.
               PERFORM CALL-ZCP01R98-002.
               ...
               PERFORM REFRESH-CC-RATING-0112.
               PERFORM FORMAT-NCD-YEARS-0113.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZMT01G6Y-001.
               CALL 'ZMT01G6Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01G6Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCP01R98-002.
               CALL 'ZCP01R98' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01R98 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
