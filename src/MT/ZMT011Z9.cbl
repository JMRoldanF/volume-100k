      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT011Z9'.
      ...
      * Called module names
       01  MOD-ZMT01GZ9              PIC X(8) VALUE 'ZMT01GZ9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01GZ9-001.
               CALL 'ZMT01GZ9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01GZ9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
