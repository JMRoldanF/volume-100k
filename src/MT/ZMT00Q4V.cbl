      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00Q4V'.
      ...
      * Called module names
       01  MOD-ZMT01RNF              PIC X(8) VALUE 'ZMT01RNF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01RNF-001.
               CALL 'ZMT01RNF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01RNF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01NN9-002.
