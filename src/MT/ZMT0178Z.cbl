      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT0178Z'.
      ...
      * Called module names
       01  MOD-ZMT01IV1              PIC X(8) VALUE 'ZMT01IV1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01IV1-001.
               PERFORM CALL-ZMT01PT1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01IV1-001.
               CALL 'ZMT01IV1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01IV1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01PT1-002.
