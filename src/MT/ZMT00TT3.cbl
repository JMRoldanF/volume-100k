      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00TT3'.
      ...
      * Called module names
       01  MOD-ZMT01K41              PIC X(8) VALUE 'ZMT01K41'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01K41-001.
               CALL 'ZMT01K41' USING DFHCOMMAREA
                         WS-STATUS-CODE.
