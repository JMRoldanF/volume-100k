      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01F23'.
      ...
      * Called module names
       01  MOD-ZMT01E2O              PIC X(8) VALUE 'ZMT01E2O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01E2O-001.
               CALL 'ZMT01E2O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01E2O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
