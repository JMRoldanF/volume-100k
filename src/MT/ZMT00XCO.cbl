      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00XCO'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01RD3              PIC X(8) VALUE 'ZMT01RD3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01CV2-001.
               PERFORM CALL-ZMT01RD3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01RD3-002.
               CALL 'ZMT01RD3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01RD3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-COLOUR-0001.
