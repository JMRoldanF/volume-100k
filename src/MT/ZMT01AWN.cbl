      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01AWN'.
      ...
      * Called module names
       01  MOD-ZMT01H4T              PIC X(8) VALUE 'ZMT01H4T'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01H4T-001.
               CALL 'ZMT01H4T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01H4T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
