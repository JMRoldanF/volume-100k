      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00ID5'.
      ...
      * Called module names
       ...
       01  MOD-ZMT00QAZ              PIC X(8) VALUE 'ZMT00QAZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT00QAZ-002.
               PERFORM CALL-ZMT01F9V-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00QAZ-002.
               EXEC CICS LINK PROGRAM('ZMT00QAZ')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00QAZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01F9V-003.
