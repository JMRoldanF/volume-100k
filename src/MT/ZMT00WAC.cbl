      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00WAC'.
      ...
      * Called module names
       01  MOD-ZMT01L1R              PIC X(8) VALUE 'ZMT01L1R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01L1R-001.
               CALL 'ZMT01L1R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01L1R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
