      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00UJH'.
      ...
      * Called module names
       01  MOD-ZMT01E8N              PIC X(8) VALUE 'ZMT01E8N'.
       01  MOD-ZMT01JNX              PIC X(8) VALUE 'ZMT01JNX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01E8N-001.
               PERFORM CALL-ZMT01JNX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01E8N-001.
               CALL 'ZMT01E8N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01E8N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01JNX-002.
               CALL 'ZMT01JNX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01JNX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
