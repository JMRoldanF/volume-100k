      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00OXJ'.
      ...
      * Called module names
       01  MOD-ZMT01O9R              PIC X(8) VALUE 'ZMT01O9R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01O9R-001.
               CALL 'ZMT01O9R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01O9R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
