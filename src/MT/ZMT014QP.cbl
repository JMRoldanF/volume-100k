      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT014QP'.
      ...
      * Called module names
       01  MOD-ZMT01IJM              PIC X(8) VALUE 'ZMT01IJM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01IJM-001.
               CALL 'ZMT01IJM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01IJM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-COLOUR-0001.
