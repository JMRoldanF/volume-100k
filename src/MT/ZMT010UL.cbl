      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT010UL'.
      ...
      * Called module names
       01  MOD-ZMT01R0Q              PIC X(8) VALUE 'ZMT01R0Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01R0Q-001.
               CALL 'ZMT01R0Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01R0Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
