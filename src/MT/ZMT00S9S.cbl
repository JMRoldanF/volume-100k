      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00S9S'.
      ...
      * Called module names
       01  MOD-ZMT01NPK              PIC X(8) VALUE 'ZMT01NPK'.
       01  MOD-ZMT01RM7              PIC X(8) VALUE 'ZMT01RM7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01NPK-001.
               CALL 'ZMT01NPK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01NPK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01RM7-002.
               CALL 'ZMT01RM7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01RM7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
