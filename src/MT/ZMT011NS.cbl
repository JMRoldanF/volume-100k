      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT011NS'.
      ...
      * Called module names
       01  MOD-ZMT01FUQ              PIC X(8) VALUE 'ZMT01FUQ'.
       01  MOD-ZQU01PDM              PIC X(8) VALUE 'ZQU01PDM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01FUQ-001.
               PERFORM CALL-ZQU01PDM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01FUQ-001.
               CALL 'ZMT01FUQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZQU01PDM-002.
               CALL 'ZQU01PDM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU01PDM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
