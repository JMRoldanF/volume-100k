      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00R27'.
      ...
      * Called module names
       01  MOD-ZMT01IHP              PIC X(8) VALUE 'ZMT01IHP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01IHP-001.
               CALL 'ZMT01IHP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01IHP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
