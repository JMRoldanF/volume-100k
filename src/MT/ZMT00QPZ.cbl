      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00QPZ'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01EY7              PIC X(8) VALUE 'ZMT01EY7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01RTN-001.
               PERFORM CALL-ZMT01EY7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01EY7-002.
               CALL 'ZMT01EY7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01EY7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
