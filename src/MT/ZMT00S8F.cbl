      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00S8F'.
      ...
      * Called module names
       01  MOD-ZBI01S4I              PIC X(8) VALUE 'ZBI01S4I'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01S4I-001.
               CALL 'ZBI01S4I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01S4I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-MODEL-0001.
