      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00VDS'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01O30              PIC X(8) VALUE 'ZMT01O30'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01PZJ-001.
               PERFORM CALL-ZMT01O30-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01O30-002.
               CALL 'ZMT01O30' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01O30 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
