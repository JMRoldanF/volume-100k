      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00Z4R'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01RR1              PIC X(8) VALUE 'ZMT01RR1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01QP0-001.
               PERFORM CALL-ZMT01RR1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01RR1-002.
               CALL 'ZMT01RR1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
