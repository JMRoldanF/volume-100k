      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT010PL'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01NQ3              PIC X(8) VALUE 'ZMT01NQ3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01NQ3-002.
               CALL 'ZMT01NQ3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01NQ3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
