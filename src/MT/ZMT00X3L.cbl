      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00X3L'.
      ...
      * Called module names
       01  MOD-ZMT01GVD              PIC X(8) VALUE 'ZMT01GVD'.
       01  MOD-ZMT01PZ4              PIC X(8) VALUE 'ZMT01PZ4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01GVD-001.
               PERFORM CALL-ZMT01PZ4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01GVD-001.
               CALL 'ZMT01GVD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01GVD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01PZ4-002.
               CALL 'ZMT01PZ4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01PZ4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
