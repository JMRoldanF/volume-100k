      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00Z8X'.
      ...
      * Called module names
       01  MOD-ZMT01T79              PIC X(8) VALUE 'ZMT01T79'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01T79-001.
               CALL 'ZMT01T79' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01T79 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01EX3-002.
