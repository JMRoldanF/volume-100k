      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT012HV'.
      ...
      * Called module names
       01  MOD-ZMT01HJJ              PIC X(8) VALUE 'ZMT01HJJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01HJJ-002.
               CALL 'ZMT01HJJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01HJJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
