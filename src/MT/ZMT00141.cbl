      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00141'.
      ...
      * Called module names
       01  MOD-ZHO00G92              PIC X(8) VALUE 'ZHO00G92'.
       01  MOD-ZMT00LFZ              PIC X(8) VALUE 'ZMT00LFZ'.
       01  MOD-ZBI00682              PIC X(8) VALUE 'ZBI00682'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT006X7-001.
               PERFORM CALL-ZHO00G92-002.
               PERFORM CALL-ZMT00LFZ-003.
               PERFORM CALL-ZBI00682-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT006X7-001.
               MOVE 'ZMT006X7' TO WS-PROGNAME-4
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT006X7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO00G92-002.
               EXEC CICS LINK PROGRAM('ZHO00G92')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO00G92 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT00LFZ-003.
               EXEC CICS LINK PROGRAM('ZMT00LFZ')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00LFZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI00682-004.
               EXEC CICS LINK PROGRAM('ZBI00682')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI00682 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
