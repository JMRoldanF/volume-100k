      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT001QT'.
      ...
      * Called module names
       01  MOD-ZRE008BN              PIC X(8) VALUE 'ZRE008BN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE008BN-001.
               EXEC CICS LINK PROGRAM('ZRE008BN')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE008BN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU008MO-002.
