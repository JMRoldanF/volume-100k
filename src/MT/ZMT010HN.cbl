      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT010HN'.
      ...
      * Called module names
       01  MOD-ZMT01P2N              PIC X(8) VALUE 'ZMT01P2N'.
       01  MOD-ZHO01SH6              PIC X(8) VALUE 'ZHO01SH6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01P2N-001.
               PERFORM CALL-ZHO01SH6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01P2N-001.
               CALL 'ZMT01P2N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01P2N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01SH6-002.
               CALL 'ZHO01SH6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01SH6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
