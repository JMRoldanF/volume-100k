      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT012DP'.
      ...
      * Called module names
       01  MOD-ZMT01TBZ              PIC X(8) VALUE 'ZMT01TBZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01TBZ-001.
               PERFORM CALL-ZMT01LDV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01TBZ-001.
               CALL 'ZMT01TBZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01TBZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01LDV-002.
