      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00OJN'.
      ...
      * Called module names
       01  MOD-ZMT01FQT              PIC X(8) VALUE 'ZMT01FQT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01FQT-001.
               CALL 'ZMT01FQT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01FQT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
