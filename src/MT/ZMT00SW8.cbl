      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00SW8'.
      ...
      * Called module names
       01  MOD-ZMT01IXF              PIC X(8) VALUE 'ZMT01IXF'.
       01  MOD-ZRN01N4W              PIC X(8) VALUE 'ZRN01N4W'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01IXF-001.
               PERFORM CALL-ZRN01N4W-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01IXF-001.
               CALL 'ZMT01IXF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZRN01N4W-002.
               CALL 'ZRN01N4W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01N4W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
