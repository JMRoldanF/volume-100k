      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT001TV'.
      ...
      * Called module names
       01  MOD-ZMT00H3B              PIC X(8) VALUE 'ZMT00H3B'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT00EFH-001.
               PERFORM CALL-ZMT00H3B-002.
               PERFORM CALL-ZMT00JGL-003.
               PERFORM CALL-ZMT00K8N-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00EFH-001.
               MOVE 'ZMT00EFH' TO WS-PROGNAME-6
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00H3B-002.
               EXEC CICS LINK PROGRAM('ZMT00H3B')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00H3B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT00JGL-003.
               MOVE 'ZMT00JGL' TO WS-PROGNAME-7
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00JGL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT00K8N-004.
               MOVE 'ZMT00K8N' TO WS-PROGNAME-8
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00K8N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
