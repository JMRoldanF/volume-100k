      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00QR5'.
      ...
      * Called module names
       01  MOD-ZMT01E4J              PIC X(8) VALUE 'ZMT01E4J'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01E4J-001.
               CALL 'ZMT01E4J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01E4J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
