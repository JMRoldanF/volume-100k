      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00ZAV'.
      ...
      * Called module names
       01  MOD-ZMT01LTP              PIC X(8) VALUE 'ZMT01LTP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01LTP-001.
               PERFORM CALL-ZMT01RAD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01LTP-001.
               CALL 'ZMT01LTP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01LTP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01RAD-002.
