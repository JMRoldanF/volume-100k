      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT010ML'.
      ...
      * Called module names
       01  MOD-ZMT01EAY              PIC X(8) VALUE 'ZMT01EAY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01EAY-001.
               PERFORM CALL-ZMT01DJA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01EAY-001.
               CALL 'ZMT01EAY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01EAY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01DJA-002.
