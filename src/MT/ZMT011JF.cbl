      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT011JF'.
      ...
      * Called module names
       01  MOD-ZMT01DTX              PIC X(8) VALUE 'ZMT01DTX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01DTX-001.
               CALL 'ZMT01DTX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01DTX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01JXN-002.
               MOVE 'ZMT01JXN' TO WS-SUBNAME-3
