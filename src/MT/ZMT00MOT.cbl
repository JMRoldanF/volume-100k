      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00MOT'.
      ...
      * Called module names
       01  MOD-ZMT01PJ9              PIC X(8) VALUE 'ZMT01PJ9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01PJ9-001.
               PERFORM CALL-ZMT01CX1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01PJ9-001.
               CALL 'ZMT01PJ9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01PJ9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01CX1-002.
