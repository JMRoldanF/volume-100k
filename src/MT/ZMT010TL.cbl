      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT010TL'.
      ...
      * Called module names
       01  MOD-ZPA01HLF              PIC X(8) VALUE 'ZPA01HLF'.
       01  MOD-ZMT01TKV              PIC X(8) VALUE 'ZMT01TKV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01HLF-001.
               PERFORM CALL-ZMT01TKV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01HLF-001.
               CALL 'ZPA01HLF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01HLF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01TKV-002.
               CALL 'ZMT01TKV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01TKV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
