      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00XI6'.
      ...
      * Called module names
       01  MOD-ZMT01QL8              PIC X(8) VALUE 'ZMT01QL8'.
       01  MOD-ZMT01T8N              PIC X(8) VALUE 'ZMT01T8N'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01QL8-001.
               PERFORM CALL-ZMT01T8N-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01QL8-001.
               CALL 'ZMT01QL8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01QL8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01T8N-002.
               CALL 'ZMT01T8N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01T8N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
