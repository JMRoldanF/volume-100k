      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT0181B'.
      ...
      * Called module names
       01  MOD-ZMT01NKR              PIC X(8) VALUE 'ZMT01NKR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01NKR-001.
               CALL 'ZMT01NKR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01NKR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
