      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00UY7'.
      ...
      * Called module names
       01  MOD-ZMT01V1X              PIC X(8) VALUE 'ZMT01V1X'.
       01  MOD-ZMT01KAP              PIC X(8) VALUE 'ZMT01KAP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01V1X-001.
               CALL 'ZMT01V1X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01V1X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01KAP-002.
               CALL 'ZMT01KAP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01KAP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-MODEL-0001.
