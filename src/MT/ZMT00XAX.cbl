      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00XAX'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01GCR              PIC X(8) VALUE 'ZMT01GCR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01GCR-002.
               CALL 'ZMT01GCR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01GCR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
