      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00M8L'.
      ...
      * Called module names
       01  MOD-ZMT01U5Z              PIC X(8) VALUE 'ZMT01U5Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01U5Z-001.
               CALL 'ZMT01U5Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01U5Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-PREMIUM-0001.
