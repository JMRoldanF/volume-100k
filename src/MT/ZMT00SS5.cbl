      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00SS5'.
      ...
      * Called module names
       01  MOD-ZRE01CQX              PIC X(8) VALUE 'ZRE01CQX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01CQX-001.
               PERFORM CALL-ZMT01DDT-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01CQX-001.
               CALL 'ZRE01CQX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01CQX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01DDT-002.
               MOVE 'ZMT01DDT' TO WS-SUBNAME-2
