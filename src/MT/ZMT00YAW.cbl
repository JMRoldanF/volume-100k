      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00YAW'.
      ...
      * Called module names
       01  MOD-ZMT01EDA              PIC X(8) VALUE 'ZMT01EDA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01EDA-001.
               CALL 'ZMT01EDA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01EDA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
