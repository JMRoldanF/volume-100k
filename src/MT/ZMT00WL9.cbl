      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00WL9'.
      ...
      * Called module names
       01  MOD-ZMT01KWV              PIC X(8) VALUE 'ZMT01KWV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01KWV-001.
               CALL 'ZMT01KWV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01KWV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
