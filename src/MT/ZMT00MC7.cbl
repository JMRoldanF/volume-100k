      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00MC7'.
      ...
      * Called module names
       01  MOD-ZMT01LVD              PIC X(8) VALUE 'ZMT01LVD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01LVD-001.
               CALL 'ZMT01LVD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01LVD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
