      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT0183E'.
      ...
      * Called module names
       01  MOD-ZMT01JAF              PIC X(8) VALUE 'ZMT01JAF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01JAF-001.
               CALL 'ZMT01JAF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01JAF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
