      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00VAP'.
      ...
      * Called module names
       01  MOD-ZMT01JT7              PIC X(8) VALUE 'ZMT01JT7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01JT7-001.
               CALL 'ZMT01JT7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01JT7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01TIN-002.
