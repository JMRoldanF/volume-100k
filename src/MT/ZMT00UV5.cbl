      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00UV5'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01JGZ              PIC X(8) VALUE 'ZMT01JGZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01FEY-001.
               PERFORM CALL-ZMT01JGZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01JGZ-002.
               CALL 'ZMT01JGZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01JGZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
