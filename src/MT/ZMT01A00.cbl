      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01A00'.
      ...
      * Called module names
       01  MOD-ZMT01SY0              PIC X(8) VALUE 'ZMT01SY0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01SY0-001.
               CALL 'ZMT01SY0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01SY0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
