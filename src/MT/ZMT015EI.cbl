      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT015EI'.
      ...
      * Called module names
       01  MOD-ZMT01KGH              PIC X(8) VALUE 'ZMT01KGH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01KGH-001.
               CALL 'ZMT01KGH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01KGH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
