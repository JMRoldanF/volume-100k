      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT011LC'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01UP0              PIC X(8) VALUE 'ZMT01UP0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01PE3-001.
               PERFORM CALL-ZMT01UP0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01UP0-002.
               CALL 'ZMT01UP0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01UP0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
