      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00YMF'.
      ...
      * Called module names
       01  MOD-ZMT01CQ7              PIC X(8) VALUE 'ZMT01CQ7'.
       01  MOD-ZBI01UIM              PIC X(8) VALUE 'ZBI01UIM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01CQ7-001.
               PERFORM CALL-ZBI01UIM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01CQ7-001.
               CALL 'ZMT01CQ7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01CQ7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01UIM-002.
               CALL 'ZBI01UIM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01UIM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
