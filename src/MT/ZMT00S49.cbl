      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00S49'.
      ...
      * Called module names
       01  MOD-ZUW01MVQ              PIC X(8) VALUE 'ZUW01MVQ'.
       01  MOD-ZMT01MR1              PIC X(8) VALUE 'ZMT01MR1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01MVQ-001.
               PERFORM CALL-ZMT01MR1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01MVQ-001.
               CALL 'ZUW01MVQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01MVQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01MR1-002.
               CALL 'ZMT01MR1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01MR1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
