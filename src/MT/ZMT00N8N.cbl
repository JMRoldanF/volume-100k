      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00N8N'.
      ...
      * Called module names
       01  MOD-ZMT01CSI              PIC X(8) VALUE 'ZMT01CSI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01CSI-001.
               CALL 'ZMT01CSI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01CSI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
