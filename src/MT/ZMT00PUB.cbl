      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00PUB'.
      ...
      * Called module names
       01  MOD-ZMT01HUX              PIC X(8) VALUE 'ZMT01HUX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01HUX-001.
               CALL 'ZMT01HUX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01HUX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01U4V-002.
