      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00S9T'.
      ...
      * Called module names
       01  MOD-ZMT01EFL              PIC X(8) VALUE 'ZMT01EFL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01EFL-001.
               CALL 'ZMT01EFL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01EFL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
