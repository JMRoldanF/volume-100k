      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00NZG'.
      ...
      * Called module names
       01  MOD-ZMT01M7Q              PIC X(8) VALUE 'ZMT01M7Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01M7Q-001.
               CALL 'ZMT01M7Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01M7Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
