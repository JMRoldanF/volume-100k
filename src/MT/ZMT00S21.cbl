      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00S21'.
      ...
      * Called module names
       01  MOD-ZMT01R5D              PIC X(8) VALUE 'ZMT01R5D'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01R5D-001.
               CALL 'ZMT01R5D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01R5D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
