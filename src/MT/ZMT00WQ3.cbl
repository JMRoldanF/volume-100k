      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00WQ3'.
      ...
      * Called module names
       01  MOD-ZMT01KT1              PIC X(8) VALUE 'ZMT01KT1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01KT1-001.
               CALL 'ZMT01KT1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01KT1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01TM9-002.
