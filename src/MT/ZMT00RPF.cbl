      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00RPF'.
      ...
      * Called module names
       01  MOD-ZQU01LNW              PIC X(8) VALUE 'ZQU01LNW'.
       01  MOD-ZMT01TDI              PIC X(8) VALUE 'ZMT01TDI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZQU01LNW-001.
               PERFORM CALL-ZMT01TDI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZQU01LNW-001.
               CALL 'ZQU01LNW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU01LNW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01TDI-002.
               CALL 'ZMT01TDI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01TDI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
