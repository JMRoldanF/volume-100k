      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00TWC'.
      ...
      * Called module names
       01  MOD-ZMT01IAT              PIC X(8) VALUE 'ZMT01IAT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01IAT-001.
               CALL 'ZMT01IAT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01IAT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
