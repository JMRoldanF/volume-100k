      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT019KV'.
      ...
      * Called module names
       01  MOD-ZMT01RQH              PIC X(8) VALUE 'ZMT01RQH'.
       01  MOD-ZMT01MVR              PIC X(8) VALUE 'ZMT01MVR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01RQH-001.
               PERFORM CALL-ZMT01MVR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01RQH-001.
               CALL 'ZMT01RQH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01RQH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01MVR-002.
               CALL 'ZMT01MVR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01MVR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
