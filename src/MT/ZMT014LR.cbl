      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT014LR'.
      ...
      * Called module names
       01  MOD-ZMT01FA1              PIC X(8) VALUE 'ZMT01FA1'.
       01  MOD-ZMT01DN5              PIC X(8) VALUE 'ZMT01DN5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01FA1-001.
               PERFORM CALL-ZMT01DN5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01FA1-001.
               CALL 'ZMT01FA1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01FA1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01DN5-002.
               CALL 'ZMT01DN5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01DN5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
