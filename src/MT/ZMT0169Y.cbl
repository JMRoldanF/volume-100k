      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT0169Y'.
      ...
      * Called module names
       01  MOD-ZMT01SHI              PIC X(8) VALUE 'ZMT01SHI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01SHI-002.
               CALL 'ZMT01SHI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01SHI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
