      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00MY8'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01OX2              PIC X(8) VALUE 'ZMT01OX2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01OX2-002.
               CALL 'ZMT01OX2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01OX2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-POSTCODE-0001.
