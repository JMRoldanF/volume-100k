      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00N6N'.
      ...
      * Called module names
       01  MOD-ZMT01KRT              PIC X(8) VALUE 'ZMT01KRT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01KRT-001.
               CALL 'ZMT01KRT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01KRT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
