      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT012B4'.
      ...
      * Called module names
       01  MOD-ZMT01JOQ              PIC X(8) VALUE 'ZMT01JOQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01JOQ-001.
               CALL 'ZMT01JOQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01JOQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
