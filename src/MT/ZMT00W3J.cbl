      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00W3J'.
      ...
      * Called module names
       01  MOD-ZMT01QKH              PIC X(8) VALUE 'ZMT01QKH'.
       01  MOD-ZMT01HH4              PIC X(8) VALUE 'ZMT01HH4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01QKH-001.
               PERFORM CALL-ZMT01HH4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01QKH-001.
               CALL 'ZMT01QKH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01QKH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01HH4-002.
               CALL 'ZMT01HH4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01HH4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-COLOUR-0001.
