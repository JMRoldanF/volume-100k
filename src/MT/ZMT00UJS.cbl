      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00UJS'.
      ...
      * Called module names
       01  MOD-ZMT01EZ7              PIC X(8) VALUE 'ZMT01EZ7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01EZ7-001.
               PERFORM CALL-ZMT01UZO-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01EZ7-001.
               CALL 'ZMT01EZ7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01EZ7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01UZO-002.
