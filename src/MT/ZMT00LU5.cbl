      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00LU5'.
      ...
      * Called module names
       01  MOD-ZMT01KMX              PIC X(8) VALUE 'ZMT01KMX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01KMX-001.
               PERFORM CALL-ZMT01CWV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01KMX-001.
               CALL 'ZMT01KMX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01KMX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01CWV-002.
