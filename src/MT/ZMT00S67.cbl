      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00S67'.
      ...
      * Called module names
       01  MOD-ZMT01N93              PIC X(8) VALUE 'ZMT01N93'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01N93-001.
               CALL 'ZMT01N93' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01N93 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01SEN-002.
               MOVE 'ZMT01SEN' TO WS-SUBNAME-8
