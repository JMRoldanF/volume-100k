      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00Z9N'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01NP1              PIC X(8) VALUE 'ZMT01NP1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01NP1-002.
               CALL 'ZMT01NP1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01NP1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
