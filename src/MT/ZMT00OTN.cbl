      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00OTN'.
      ...
      * Called module names
       01  MOD-ZMT01KUP              PIC X(8) VALUE 'ZMT01KUP'.
       01  MOD-ZMT01RBH              PIC X(8) VALUE 'ZMT01RBH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01KUP-001.
               PERFORM CALL-ZMT01RBH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01KUP-001.
               CALL 'ZMT01KUP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01KUP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01RBH-002.
               CALL 'ZMT01RBH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01RBH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
