      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT011BP'.
      ...
      * Called module names
       01  MOD-ZMT01S8G              PIC X(8) VALUE 'ZMT01S8G'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01S8G-001.
               CALL 'ZMT01S8G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01S8G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
