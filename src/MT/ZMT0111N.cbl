      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT0111N'.
      ...
      * Called module names
       01  MOD-ZMT01MJT              PIC X(8) VALUE 'ZMT01MJT'.
       01  MOD-ZMT01NX9              PIC X(8) VALUE 'ZMT01NX9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01MJT-001.
               PERFORM CALL-ZMT01NX9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01MJT-001.
               CALL 'ZMT01MJT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01MJT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01NX9-002.
               CALL 'ZMT01NX9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01NX9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-VALUE-0001.
