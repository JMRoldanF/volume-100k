      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00R7H'.
      ...
      * Called module names
       01  MOD-ZMT01QY5              PIC X(8) VALUE 'ZMT01QY5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01QY5-001.
               PERFORM CALL-ZPA01RXX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01QY5-001.
               CALL 'ZMT01QY5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
