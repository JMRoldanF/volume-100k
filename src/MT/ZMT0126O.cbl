      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT0126O'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01SQ0              PIC X(8) VALUE 'ZMT01SQ0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01MXE-001.
               PERFORM CALL-ZMT01SQ0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01SQ0-002.
               CALL 'ZMT01SQ0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01SQ0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
