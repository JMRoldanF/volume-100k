      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00RRH'.
      ...
      * Called module names
       01  MOD-ZPA01DXR              PIC X(8) VALUE 'ZPA01DXR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01DXR-001.
               CALL 'ZPA01DXR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01DXR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
