      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00P65'.
      ...
      * Called module names
       01  MOD-ZMT01J8D              PIC X(8) VALUE 'ZMT01J8D'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01J8D-001.
               CALL 'ZMT01J8D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01J8D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
