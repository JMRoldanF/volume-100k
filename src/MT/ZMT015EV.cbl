      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT015EV'.
      ...
      * Called module names
       01  MOD-ZCU01K8U              PIC X(8) VALUE 'ZCU01K8U'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01K8U-001.
               CALL 'ZCU01K8U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01K8U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01SHF-002.
