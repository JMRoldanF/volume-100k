      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00YAN'.
      ...
      * Called module names
       01  MOD-ZMT01RJA              PIC X(8) VALUE 'ZMT01RJA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01RJA-001.
               CALL 'ZMT01RJA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01RJA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
