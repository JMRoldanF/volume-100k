      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT0019B'.
      ...
      * Called module names
       01  MOD-ZCL008G1              PIC X(8) VALUE 'ZCL008G1'.
       01  MOD-ZEN006N9              PIC X(8) VALUE 'ZEN006N9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT008QH-001.
               PERFORM CALL-ZMT006NH-002.
               PERFORM CALL-ZCL008G1-003.
               PERFORM CALL-ZEN006N9-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT008QH-001.
               MOVE 'ZMT008QH' TO WS-PROGNAME-6
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT008QH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT006NH-002.
               MOVE 'ZMT006NH' TO WS-PROGNAME-7
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT006NH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL008G1-003.
               EXEC CICS LINK PROGRAM('ZCL008G1')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL008G1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN006N9-004.
               EXEC CICS LINK PROGRAM('ZEN006N9')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN006N9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-005.
