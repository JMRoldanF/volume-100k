      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00OLV'.
      ...
      * Called module names
       01  MOD-ZMT01G95              PIC X(8) VALUE 'ZMT01G95'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01G95-001.
               PERFORM CALL-ZMT01LGX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01G95-001.
               CALL 'ZMT01G95' USING DFHCOMMAREA
                         WS-STATUS-CODE.
