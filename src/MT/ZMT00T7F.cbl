      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00T7F'.
      ...
      * Called module names
       01  MOD-ZMT01IWF              PIC X(8) VALUE 'ZMT01IWF'.
       01  MOD-ZMT01U5F              PIC X(8) VALUE 'ZMT01U5F'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01IWF-001.
               CALL 'ZMT01IWF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01U5F-002.
               CALL 'ZMT01U5F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01U5F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       VALIDATE-MODEL-0001.
