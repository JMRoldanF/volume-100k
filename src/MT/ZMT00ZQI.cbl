      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00ZQI'.
      ...
      * Called module names
       01  MOD-ZMT01DLN              PIC X(8) VALUE 'ZMT01DLN'.
       01  MOD-ZMT01K8O              PIC X(8) VALUE 'ZMT01K8O'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01DLN-001.
               PERFORM CALL-ZMT01K8O-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01DLN-001.
               CALL 'ZMT01DLN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01DLN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01K8O-002.
               CALL 'ZMT01K8O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01K8O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
