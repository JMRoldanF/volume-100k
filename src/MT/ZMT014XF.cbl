      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT014XF'.
      ...
      * Called module names
       01  MOD-ZMT01KK2              PIC X(8) VALUE 'ZMT01KK2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01KK2-001.
               CALL 'ZMT01KK2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01KK2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
