      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00RDV'.
      ...
      * Called module names
       01  MOD-ZMT01TBP              PIC X(8) VALUE 'ZMT01TBP'.
       01  MOD-ZMT01GR7              PIC X(8) VALUE 'ZMT01GR7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01TBP-001.
               PERFORM CALL-ZMT01GR7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01TBP-001.
               CALL 'ZMT01TBP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01TBP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01GR7-002.
               CALL 'ZMT01GR7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01GR7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
