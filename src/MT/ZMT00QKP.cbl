      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00QKP'.
      ...
      * Called module names
       01  MOD-ZMT01K73              PIC X(8) VALUE 'ZMT01K73'.
       01  MOD-ZMT01LJZ              PIC X(8) VALUE 'ZMT01LJZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01K73-001.
               PERFORM CALL-ZMT01LJZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01K73-001.
               CALL 'ZMT01K73' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01K73 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01LJZ-002.
               CALL 'ZMT01LJZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01LJZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
