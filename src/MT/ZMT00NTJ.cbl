      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00NTJ'.
      ...
      * Called module names
       01  MOD-ZMT01COJ              PIC X(8) VALUE 'ZMT01COJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01COJ-001.
               CALL 'ZMT01COJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01COJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01OLF-002.
