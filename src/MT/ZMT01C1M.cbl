      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01C1M'.
      ...
      * Called module names
       01  MOD-ZMT01L59              PIC X(8) VALUE 'ZMT01L59'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01L59-001.
               CALL 'ZMT01L59' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01L59 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
