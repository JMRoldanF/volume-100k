      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00ZF1'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01HPD              PIC X(8) VALUE 'ZMT01HPD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01HPD-002.
               CALL 'ZMT01HPD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01HPD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
