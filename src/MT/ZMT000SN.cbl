      ...
      * Called module names
       01  MOD-ZQU00GY6              PIC X(8) VALUE 'ZQU00GY6'.
       01  MOD-ZEX009I5              PIC X(8) VALUE 'ZEX009I5'.
       01  MOD-ZMT00CI5              PIC X(8) VALUE 'ZMT00CI5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZQU00GY6-001.
               PERFORM CALL-ZMT00CI5-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZQU00GY6-001.
               EXEC CICS LINK PROGRAM('ZQU00GY6')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU00GY6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEX009I5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00CI5-003.
               EXEC CICS LINK PROGRAM('ZMT00CI5')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00CI5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-004.
