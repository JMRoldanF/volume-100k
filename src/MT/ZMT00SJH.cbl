      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00SJH'.
      ...
      * Called module names
       01  MOD-ZMT01PL8              PIC X(8) VALUE 'ZMT01PL8'.
       01  MOD-ZMT01J4M              PIC X(8) VALUE 'ZMT01J4M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01PL8-001.
               CALL 'ZMT01PL8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01PL8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01J4M-002.
               CALL 'ZMT01J4M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01J4M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
