      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00XD5'.
      ...
      * Called module names
       01  MOD-ZMT01QDV              PIC X(8) VALUE 'ZMT01QDV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01QDV-001.
               CALL 'ZMT01QDV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01QDV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-TERM-0001.
