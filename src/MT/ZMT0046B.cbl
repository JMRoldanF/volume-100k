      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT0046B'.
      ...
      * Called module names
       ...
       01  MOD-ZMT00E61              PIC X(8) VALUE 'ZMT00E61'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT00BKF-001.
               PERFORM CALL-ZMT00E61-002.
               PERFORM CALL-ZHO00LGU-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00E61-002.
               EXEC CICS LINK PROGRAM('ZMT00E61')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00E61 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO00LGU-003.
               MOVE 'ZHO00LGU' TO WS-PROGNAME-3
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO00LGU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT00E4X-004.
