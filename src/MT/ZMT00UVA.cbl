      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00UVA'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01TNL              PIC X(8) VALUE 'ZMT01TNL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01TNL-002.
               CALL 'ZMT01TNL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01TNL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
