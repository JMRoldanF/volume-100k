      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00VRX'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01SVL              PIC X(8) VALUE 'ZMT01SVL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01SVL-002.
               CALL 'ZMT01SVL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01SVL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
