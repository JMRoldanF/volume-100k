      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00UKB'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01P4L              PIC X(8) VALUE 'ZMT01P4L'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01EWD-001.
               PERFORM CALL-ZMT01P4L-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01P4L-002.
               CALL 'ZMT01P4L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01P4L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
