      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT024BC'.
      ...
      * Called module names
       ...
       01  MOD-ZMT00ZXH              PIC X(8) VALUE 'ZMT00ZXH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01K5T-001.
               PERFORM CALL-ZPT01OXW-002.
               PERFORM CALL-ZMT01L6M-003.
               PERFORM CALL-ZMT00ZXH-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00ZXH-004.
               CALL 'ZMT00ZXH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00ZXH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-PREMIUM-0001.
