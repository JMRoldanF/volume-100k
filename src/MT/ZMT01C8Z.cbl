      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01C8Z'.
      ...
      * Called module names
       01  MOD-ZMT01FL9              PIC X(8) VALUE 'ZMT01FL9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01FL9-001.
               CALL 'ZMT01FL9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01FL9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
