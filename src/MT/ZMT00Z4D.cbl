      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00Z4D'.
      ...
      * Called module names
       01  MOD-ZMT01R1F              PIC X(8) VALUE 'ZMT01R1F'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01R1F-001.
               CALL 'ZMT01R1F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01R1F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01R0V-002.
