      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00PUL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM RESOLVE-NCD-YEARS-0118.
               PERFORM FORMAT-VALUE-0119.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-001.
               MOVE 'ZCU0255O' TO WS-PROGNAME-7
