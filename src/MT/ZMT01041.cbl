      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01041'.
      ...
      * Called module names
       01  MOD-ZMT01GOP              PIC X(8) VALUE 'ZMT01GOP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01GOP-001.
               CALL 'ZMT01GOP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01GOP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-EXCESS-0001.
