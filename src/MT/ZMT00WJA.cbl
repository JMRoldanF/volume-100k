      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00WJA'.
      ...
      * Called module names
       01  MOD-ZMT01LAK              PIC X(8) VALUE 'ZMT01LAK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01LAK-001.
               PERFORM CALL-ZCU0255O-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZMT01LAK-001.
               CALL 'ZMT01LAK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
