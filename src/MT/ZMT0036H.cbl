      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT0036H'.
      ...
      * Called module names
       01  MOD-ZMT00BI7              PIC X(8) VALUE 'ZMT00BI7'.
       01  MOD-ZHO00KFC              PIC X(8) VALUE 'ZHO00KFC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT00BI7-001.
               PERFORM CALL-ZHO00KFC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00BI7-001.
               EXEC CICS LINK PROGRAM('ZMT00BI7')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00BI7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO00KFC-002.
               EXEC CICS LINK PROGRAM('ZHO00KFC')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE0043F-003.
               EXEC CICS START TRANSID('Z43F')
                         FROM(WS-KEY-AREA)
                         LENGTH(20)
                         RESP(WS-RESP)
               END-EXEC.
      * TRANSID Z43F is defined against ZRE0043F
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE0043F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-004.
