      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00Q41'.
      ...
      * Called module names
       01  MOD-ZMT01UD7              PIC X(8) VALUE 'ZMT01UD7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01UD7-001.
               CALL 'ZMT01UD7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01UD7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
