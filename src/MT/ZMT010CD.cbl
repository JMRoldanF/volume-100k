      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT010CD'.
      ...
      * Called module names
       01  MOD-ZMT01L9F              PIC X(8) VALUE 'ZMT01L9F'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01L9F-001.
               CALL 'ZMT01L9F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01L9F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
