      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT0102X'.
      ...
      * Called module names
       01  MOD-ZCU01V02              PIC X(8) VALUE 'ZCU01V02'.
       01  MOD-ZMT01PH3              PIC X(8) VALUE 'ZMT01PH3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01V02-001.
               PERFORM CALL-ZMT01PH3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01V02-001.
               CALL 'ZCU01V02' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01V02 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01PH3-002.
               CALL 'ZMT01PH3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01PH3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
