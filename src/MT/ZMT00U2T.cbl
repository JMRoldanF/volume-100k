      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00U2T'.
      ...
      * Called module names
       01  MOD-ZMT01M3Z              PIC X(8) VALUE 'ZMT01M3Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01M3Z-001.
               CALL 'ZMT01M3Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
