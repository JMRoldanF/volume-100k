      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00WXJ'.
      ...
      * Called module names
       01  MOD-ZMT01FKX              PIC X(8) VALUE 'ZMT01FKX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01FKX-001.
               CALL 'ZMT01FKX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01Q06-002.
               MOVE 'ZMT01Q06' TO WS-SUBNAME-6
               CALL WS-SUBNAME-6 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01Q06 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
