      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00U65'.
      ...
      * Called module names
       01  MOD-ZMT01FLT              PIC X(8) VALUE 'ZMT01FLT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01FLT-001.
               CALL 'ZMT01FLT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01FLT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
