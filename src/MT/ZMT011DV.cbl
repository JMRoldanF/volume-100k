      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT011DV'.
      ...
      * Called module names
       01  MOD-ZMT01PCN              PIC X(8) VALUE 'ZMT01PCN'.
       01  MOD-ZMT01OQZ              PIC X(8) VALUE 'ZMT01OQZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01PCN-001.
               PERFORM CALL-ZMT01OQZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01PCN-001.
               CALL 'ZMT01PCN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01PCN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01OQZ-002.
               CALL 'ZMT01OQZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01OQZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
