      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00XZ7'.
      ...
      * Called module names
       01  MOD-ZMT01Q9U              PIC X(8) VALUE 'ZMT01Q9U'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01Q9U-001.
               CALL 'ZMT01Q9U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01Q9U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
