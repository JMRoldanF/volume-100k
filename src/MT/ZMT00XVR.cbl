      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00XVR'.
      ...
      * Called module names
       01  MOD-ZMT01OT7              PIC X(8) VALUE 'ZMT01OT7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01OT7-001.
               CALL 'ZMT01OT7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01OT7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
