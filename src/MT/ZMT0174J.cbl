      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT0174J'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01CYT              PIC X(8) VALUE 'ZMT01CYT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01FNR-001.
               PERFORM CALL-ZMT01CYT-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01CYT-002.
               CALL 'ZMT01CYT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01CYT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
