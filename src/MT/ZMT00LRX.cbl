      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00LRX'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01IMZ              PIC X(8) VALUE 'ZMT01IMZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01IMZ-002.
               CALL 'ZMT01IMZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01IMZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
