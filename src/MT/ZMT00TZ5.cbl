      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00TZ5'.
      ...
      * Called module names
       01  MOD-ZMT01PYD              PIC X(8) VALUE 'ZMT01PYD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01PYD-001.
               CALL 'ZMT01PYD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01PYD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
