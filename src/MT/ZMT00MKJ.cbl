      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00MKJ'.
      ...
      * Called module names
       01  MOD-ZMT01NMZ              PIC X(8) VALUE 'ZMT01NMZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01NMZ-001.
               CALL 'ZMT01NMZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01NMZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
