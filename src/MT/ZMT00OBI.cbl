      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00OBI'.
      ...
      * Called module names
       01  MOD-ZMT01LX3              PIC X(8) VALUE 'ZMT01LX3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01LX3-001.
               CALL 'ZMT01LX3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01LX3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
