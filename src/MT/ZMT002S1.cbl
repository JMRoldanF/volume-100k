      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT002S1'.
      ...
      * Called module names
       01  MOD-ZBI00AAG              PIC X(8) VALUE 'ZBI00AAG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL00H0N-001.
               PERFORM CALL-ZBI00AAG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL00H0N-001.
               MOVE 'ZCL00H0N' TO WS-PROGNAME-6
      ...
      *----------------------------------------------------------------*
       CALL-ZBI00AAG-002.
               EXEC CICS LINK PROGRAM('ZBI00AAG')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI00AAG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
