      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00PE7'.
      ...
      * Called module names
       01  MOD-ZMT01G9Z              PIC X(8) VALUE 'ZMT01G9Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01G9Z-001.
               CALL 'ZMT01G9Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01G9Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01U3R-002.
