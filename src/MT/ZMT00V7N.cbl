      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00V7N'.
      ...
      * Called module names
       01  MOD-ZMT01O7T              PIC X(8) VALUE 'ZMT01O7T'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01O7T-001.
               PERFORM CALL-ZMT01O1P-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01O7T-001.
               CALL 'ZMT01O7T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01O7T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01O1P-002.
