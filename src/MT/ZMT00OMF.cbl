      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00OMF'.
      ...
      * Called module names
       01  MOD-ZMT01S6L              PIC X(8) VALUE 'ZMT01S6L'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01S6L-001.
               CALL 'ZMT01S6L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01S6L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
