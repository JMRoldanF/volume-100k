      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01212'.
      ...
      * Called module names
       01  MOD-ZMT01HBT              PIC X(8) VALUE 'ZMT01HBT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01HBT-001.
               PERFORM CALL-ZPT01ST7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01HBT-001.
               CALL 'ZMT01HBT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01HBT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPT01ST7-002.
