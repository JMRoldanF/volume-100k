      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT011N1'.
      ...
      * Called module names
       01  MOD-ZMT01FJ1              PIC X(8) VALUE 'ZMT01FJ1'.
       01  MOD-ZMT01DL1              PIC X(8) VALUE 'ZMT01DL1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01FJ1-001.
               PERFORM CALL-ZMT01DL1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01FJ1-001.
               CALL 'ZMT01FJ1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01DL1-002.
               CALL 'ZMT01DL1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01DL1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
