      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00UOR'.
      ...
      * Called module names
       01  MOD-ZMT01RLH              PIC X(8) VALUE 'ZMT01RLH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01RLH-001.
               PERFORM CALL-ZMT01URX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01RLH-001.
               CALL 'ZMT01RLH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01RLH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01URX-002.
