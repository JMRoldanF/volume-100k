      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00WUE'.
      ...
      * Called module names
       01  MOD-ZMT01ESA              PIC X(8) VALUE 'ZMT01ESA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01ESA-001.
               CALL 'ZMT01ESA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01ESA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
