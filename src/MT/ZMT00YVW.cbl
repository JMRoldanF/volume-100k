      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00YVW'.
      ...
      * Called module names
       01  MOD-ZMT01PTW              PIC X(8) VALUE 'ZMT01PTW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01PTW-001.
               CALL 'ZMT01PTW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01PTW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
