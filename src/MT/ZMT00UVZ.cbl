      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00UVZ'.
      ...
      * Called module names
       01  MOD-ZMT01U8R              PIC X(8) VALUE 'ZMT01U8R'.
       01  MOD-ZMT01MS5              PIC X(8) VALUE 'ZMT01MS5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01U8R-001.
               PERFORM CALL-ZMT01MS5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01U8R-001.
               CALL 'ZMT01U8R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01U8R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01MS5-002.
               CALL 'ZMT01MS5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01MS5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
