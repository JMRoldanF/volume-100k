      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00SQH'.
      ...
      * Called module names
       01  MOD-ZMT01U05              PIC X(8) VALUE 'ZMT01U05'.
       01  MOD-ZMT01PQ9              PIC X(8) VALUE 'ZMT01PQ9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01U05-001.
               PERFORM CALL-ZMT01PQ9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01U05-001.
               CALL 'ZMT01U05' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01U05 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01PQ9-002.
               CALL 'ZMT01PQ9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01PQ9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
