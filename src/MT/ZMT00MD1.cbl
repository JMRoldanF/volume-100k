      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00MD1'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01R0X              PIC X(8) VALUE 'ZMT01R0X'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01R0X-002.
               CALL 'ZMT01R0X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01R0X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
