      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00PQP'.
      ...
      * Called module names
       01  MOD-ZMT01RBR              PIC X(8) VALUE 'ZMT01RBR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01RBR-001.
               PERFORM CALL-ZMT01K23-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01RBR-001.
               CALL 'ZMT01RBR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01RBR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01K23-002.
