      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00XIZ'.
      ...
      * Called module names
       01  MOD-ZMT01DD9              PIC X(8) VALUE 'ZMT01DD9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01DD9-001.
               CALL 'ZMT01DD9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01DD9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
