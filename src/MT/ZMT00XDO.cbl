      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00XDO'.
      ...
      * Called module names
       ...
       01  MOD-ZCP01K0O              PIC X(8) VALUE 'ZCP01K0O'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01E97-001.
               PERFORM CALL-ZCP01K0O-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01K0O-002.
               CALL 'ZCP01K0O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01K0O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
