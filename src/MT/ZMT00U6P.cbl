      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00U6P'.
      ...
      * Called module names
       01  MOD-ZMT01TN3              PIC X(8) VALUE 'ZMT01TN3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01TN3-001.
               CALL 'ZMT01TN3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01TN3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-MODEL-0001.
