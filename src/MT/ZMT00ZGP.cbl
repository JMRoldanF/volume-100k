      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00ZGP'.
      ...
      * Called module names
       01  MOD-ZMT01EF1              PIC X(8) VALUE 'ZMT01EF1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01EF1-001.
               PERFORM CALL-ZAG01QG0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01EF1-001.
               CALL 'ZMT01EF1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
