      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00PAA'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01GI0              PIC X(8) VALUE 'ZMT01GI0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01QPS-001.
               PERFORM CALL-ZMT01GI0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01GI0-002.
               CALL 'ZMT01GI0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01GI0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
