      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00SMB'.
      ...
      * Called module names
       01  MOD-ZMT01FI7              PIC X(8) VALUE 'ZMT01FI7'.
       01  MOD-ZMT01T33              PIC X(8) VALUE 'ZMT01T33'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01FI7-001.
               PERFORM CALL-ZMT01T33-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01FI7-001.
               CALL 'ZMT01FI7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01FI7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01T33-002.
               CALL 'ZMT01T33' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01T33 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
