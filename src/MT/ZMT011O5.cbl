      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT011O5'.
      ...
      * Called module names
       01  MOD-ZMT01G09              PIC X(8) VALUE 'ZMT01G09'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01G09-002.
               CALL 'ZMT01G09' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01G09 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
