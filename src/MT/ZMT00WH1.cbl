      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00WH1'.
      ...
      * Called module names
       01  MOD-ZMT01MSC              PIC X(8) VALUE 'ZMT01MSC'.
       01  MOD-ZMT01IGE              PIC X(8) VALUE 'ZMT01IGE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01MSC-001.
               PERFORM CALL-ZMT01IGE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01MSC-001.
               CALL 'ZMT01MSC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01MSC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01IGE-002.
               CALL 'ZMT01IGE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
