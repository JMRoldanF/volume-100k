      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00YZM'.
      ...
      * Called module names
       01  MOD-ZMT01FOK              PIC X(8) VALUE 'ZMT01FOK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01FOK-001.
               PERFORM CALL-ZMT01HYU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01FOK-001.
               CALL 'ZMT01FOK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01FOK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01HYU-002.
