      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00S1P'.
      ...
      * Called module names
       01  MOD-ZMT01M5Z              PIC X(8) VALUE 'ZMT01M5Z'.
       01  MOD-ZMT01J88              PIC X(8) VALUE 'ZMT01J88'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01M5Z-001.
               PERFORM CALL-ZMT01J88-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01M5Z-001.
               CALL 'ZMT01M5Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01M5Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01J88-002.
               CALL 'ZMT01J88' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01J88 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
