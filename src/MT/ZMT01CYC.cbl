      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01CYC'.
      ...
      * Called module names
       01  MOD-ZMT01KDY              PIC X(8) VALUE 'ZMT01KDY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01KDY-001.
               CALL 'ZMT01KDY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01KDY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
