      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00VTV'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01GF9              PIC X(8) VALUE 'ZMT01GF9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01GF9-002.
               CALL 'ZMT01GF9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01GF9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
