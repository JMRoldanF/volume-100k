      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01GUL'.
      ...
      * Called module names
       01  MOD-ZMT01O0K              PIC X(8) VALUE 'ZMT01O0K'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01O0K-001.
               CALL 'ZMT01O0K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01O0K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
