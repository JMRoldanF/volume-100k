      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00SES'.
      ...
      * Called module names
       01  MOD-ZCP01QMS              PIC X(8) VALUE 'ZCP01QMS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01QMS-001.
               CALL 'ZCP01QMS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01QMS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
