      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00MUJ'.
      ...
      * Called module names
       01  MOD-ZMT01UOV              PIC X(8) VALUE 'ZMT01UOV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01UOV-001.
               CALL 'ZMT01UOV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01UOV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
