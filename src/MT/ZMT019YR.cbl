      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT019YR'.
      ...
      * Called module names
       01  MOD-ZMT01JK1              PIC X(8) VALUE 'ZMT01JK1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01JK1-001.
               CALL 'ZMT01JK1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01JK1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
