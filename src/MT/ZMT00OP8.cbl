      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00OP8'.
      ...
      * Called module names
       01  MOD-ZMT01UNE              PIC X(8) VALUE 'ZMT01UNE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01UNE-001.
               CALL 'ZMT01UNE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01UNE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-MAKE-0001.
