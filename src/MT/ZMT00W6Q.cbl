      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00W6Q'.
      ...
      * Called module names
       01  MOD-ZMT01S2W              PIC X(8) VALUE 'ZMT01S2W'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01S2W-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZMT01PIU-001.
               MOVE 'ZMT01PIU' TO WS-SUBNAME-5
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01S2W-002.
               CALL 'ZMT01S2W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01S2W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       WRITE-ERROR-MESSAGE.
