      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00VQY'.
      ...
      * Called module names
       01  MOD-ZMT01DPE              PIC X(8) VALUE 'ZMT01DPE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01DPE-001.
               CALL 'ZMT01DPE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01DPE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
