      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT011R7'.
      ...
      * Called module names
       01  MOD-ZHO01JZW              PIC X(8) VALUE 'ZHO01JZW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01JZW-001.
               CALL 'ZHO01JZW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01JZW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
