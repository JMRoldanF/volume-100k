      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT006Y1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT0108R-001.
               PERFORM CALL-ZMT00VI7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT0108R-001.
               EXEC CICS LINK PROGRAM('ZMT0108R')
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00VI7-002.
               MOVE 'ZMT00VI7' TO WS-PROGNAME-1
