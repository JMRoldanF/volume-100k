      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT010QJ'.
      ...
      * Called module names
       01  MOD-ZMT01O6P              PIC X(8) VALUE 'ZMT01O6P'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01O6P-001.
               PERFORM CALL-ZEN01FEN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01O6P-001.
               CALL 'ZMT01O6P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01O6P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01FEN-002.
