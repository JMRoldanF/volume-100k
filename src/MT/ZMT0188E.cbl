      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT0188E'.
      ...
      * Called module names
       01  MOD-ZMT01H70              PIC X(8) VALUE 'ZMT01H70'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01H70-001.
               CALL 'ZMT01H70' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01H70 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
