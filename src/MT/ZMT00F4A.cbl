      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00F4A'.
      ...
      * Called module names
       01  MOD-ZEX00RXR              PIC X(8) VALUE 'ZEX00RXR'.
       01  MOD-ZMT01962              PIC X(8) VALUE 'ZMT01962'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPT00QCL-001.
               PERFORM CALL-ZEX00RXR-002.
               PERFORM CALL-ZMT012B1-003.
               PERFORM CALL-ZMT01962-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZPT00QCL-001.
               MOVE 'ZPT00QCL' TO WS-PROGNAME-3
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT00QCL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEX00RXR-002.
               EXEC CICS LINK PROGRAM('ZEX00RXR')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEX00RXR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT012B1-003.
               MOVE 'ZMT012B1' TO WS-PROGNAME-4
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01962-004.
               EXEC CICS LINK PROGRAM('ZMT01962')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01962 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-005.
