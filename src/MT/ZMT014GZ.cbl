      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT014GZ'.
      ...
      * Called module names
       01  MOD-ZMT01OBF              PIC X(8) VALUE 'ZMT01OBF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01OBF-001.
               CALL 'ZMT01OBF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01OBF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
