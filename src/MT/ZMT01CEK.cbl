      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01CEK'.
      ...
      * Called module names
       01  MOD-ZMT01EXX              PIC X(8) VALUE 'ZMT01EXX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01EXX-001.
               CALL 'ZMT01EXX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01EXX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01N2T-002.
               MOVE 'ZMT01N2T' TO WS-SUBNAME-7
