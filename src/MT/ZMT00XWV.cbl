      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00XWV'.
      ...
      * Called module names
       01  MOD-ZMT01UDR              PIC X(8) VALUE 'ZMT01UDR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01UDR-001.
               CALL 'ZMT01UDR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01UDR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-MAKE-0001.
