      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00RRR'.
      ...
      * Called module names
       01  MOD-ZMT01KL9              PIC X(8) VALUE 'ZMT01KL9'.
       01  MOD-ZPA01QQV              PIC X(8) VALUE 'ZPA01QQV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01KL9-001.
               PERFORM CALL-ZPA01QQV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01KL9-001.
               CALL 'ZMT01KL9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01KL9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01QQV-002.
               CALL 'ZPA01QQV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01QQV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
