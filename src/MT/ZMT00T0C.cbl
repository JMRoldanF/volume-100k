      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00T0C'.
      ...
      * Called module names
       01  MOD-ZCP01NAC              PIC X(8) VALUE 'ZCP01NAC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01NAC-001.
               CALL 'ZCP01NAC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01NAC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
