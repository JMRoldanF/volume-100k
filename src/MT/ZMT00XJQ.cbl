      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00XJQ'.
      ...
      * Called module names
       01  MOD-ZMT01R6C              PIC X(8) VALUE 'ZMT01R6C'.
       01  MOD-ZMT01HVW              PIC X(8) VALUE 'ZMT01HVW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01R6C-001.
               PERFORM CALL-ZMT01HVW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01R6C-001.
               CALL 'ZMT01R6C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01R6C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01HVW-002.
               CALL 'ZMT01HVW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01HVW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
