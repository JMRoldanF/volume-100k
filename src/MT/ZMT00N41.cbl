      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00N41'.
      ...
      * Called module names
       01  MOD-ZMT01LIN              PIC X(8) VALUE 'ZMT01LIN'.
       01  MOD-ZMT01SWW              PIC X(8) VALUE 'ZMT01SWW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01LIN-001.
               PERFORM CALL-ZMT01SWW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01LIN-001.
               CALL 'ZMT01LIN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01LIN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01SWW-002.
               CALL 'ZMT01SWW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01SWW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
