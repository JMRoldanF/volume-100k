      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00NKN'.
      ...
      * Called module names
       01  MOD-ZMT01MIP              PIC X(8) VALUE 'ZMT01MIP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01MIP-001.
               CALL 'ZMT01MIP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01MIP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
