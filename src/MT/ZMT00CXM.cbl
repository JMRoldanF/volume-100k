      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00CXM'.
      ...
      * Called module names
       01  MOD-ZMT00UDK              PIC X(8) VALUE 'ZMT00UDK'.
       01  MOD-ZMT01SLB              PIC X(8) VALUE 'ZMT01SLB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT00UDK-001.
               PERFORM CALL-ZMT01SLB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00UDK-001.
               EXEC CICS LINK PROGRAM('ZMT00UDK')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00UDK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01SLB-002.
               CALL 'ZMT01SLB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01SLB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
