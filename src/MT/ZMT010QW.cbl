      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT010QW'.
      ...
      * Called module names
       01  MOD-ZMT01RCZ              PIC X(8) VALUE 'ZMT01RCZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01RCZ-001.
               CALL 'ZMT01RCZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01RCZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
