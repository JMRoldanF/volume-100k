      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00RJZ'.
      ...
      * Called module names
       01  MOD-ZMT01F05              PIC X(8) VALUE 'ZMT01F05'.
       01  MOD-ZMT01I9N              PIC X(8) VALUE 'ZMT01I9N'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01F05-001.
               PERFORM CALL-ZMT01I9N-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01F05-001.
               CALL 'ZMT01F05' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01I9N-002.
               CALL 'ZMT01I9N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01I9N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
