      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00TYY'.
      ...
      * Called module names
       01  MOD-ZMT01D5L              PIC X(8) VALUE 'ZMT01D5L'.
       01  MOD-ZMT01N03              PIC X(8) VALUE 'ZMT01N03'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01D5L-001.
               PERFORM CALL-ZMT01N03-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01D5L-001.
               CALL 'ZMT01D5L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01D5L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01N03-002.
               CALL 'ZMT01N03' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01N03 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
