      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT001L9'.
      ...
      * Called module names
       01  MOD-ZMT00DMV              PIC X(8) VALUE 'ZMT00DMV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT00DMV-001.
               PERFORM CALL-ZMT0082B-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00DMV-001.
               EXEC CICS LINK PROGRAM('ZMT00DMV')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00DMV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0082B-002.
