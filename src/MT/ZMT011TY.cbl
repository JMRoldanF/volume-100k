      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT011TY'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01ESL              PIC X(8) VALUE 'ZMT01ESL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01ESL-002.
               CALL 'ZMT01ESL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01ESL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
