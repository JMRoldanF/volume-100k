      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT000LN'.
      ...
      * Called module names
       ...
       01  MOD-ZMT00H23              PIC X(8) VALUE 'ZMT00H23'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT00KJA-001.
               PERFORM CALL-ZMT00DDE-002.
               PERFORM CALL-ZMT00H23-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00DDE-002.
               MOVE 'ZMT00DDE' TO WS-PROGNAME-5
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00H23-003.
               EXEC CICS LINK PROGRAM('ZMT00H23')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
