      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00OBL'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01OTH              PIC X(8) VALUE 'ZMT01OTH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01ELZ-001.
               PERFORM CALL-ZMT01OTH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01OTH-002.
               CALL 'ZMT01OTH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01OTH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
