      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00TWZ'.
      ...
      * Called module names
       01  MOD-ZMT01O1P              PIC X(8) VALUE 'ZMT01O1P'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01O1P-001.
               CALL 'ZMT01O1P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01O1P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-TERM-0001.
