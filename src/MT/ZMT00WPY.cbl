      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00WPY'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01LA7              PIC X(8) VALUE 'ZMT01LA7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZQU01NL7-001.
               PERFORM CALL-ZMT01LA7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01LA7-002.
               CALL 'ZMT01LA7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01LA7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
