      ...
      * Called module names
       01  MOD-ZMT01JKL              PIC X(8) VALUE 'ZMT01JKL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01JKL-001.
               PERFORM CALL-ZMT01DK7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01JKL-001.
               CALL 'ZMT01JKL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01JKL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01DK7-002.
