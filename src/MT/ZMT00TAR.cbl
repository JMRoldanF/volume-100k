      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00TAR'.
      ...
      * Called module names
       01  MOD-ZMT01DNR              PIC X(8) VALUE 'ZMT01DNR'.
       01  MOD-ZMT01EK8              PIC X(8) VALUE 'ZMT01EK8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01DNR-001.
               PERFORM CALL-ZMT01EK8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01DNR-001.
               CALL 'ZMT01DNR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01DNR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01EK8-002.
               CALL 'ZMT01EK8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01EK8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
