      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00WXB'.
      ...
      * Called module names
       01  MOD-ZPA01R1F              PIC X(8) VALUE 'ZPA01R1F'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01R1F-001.
               CALL 'ZPA01R1F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01R1F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
