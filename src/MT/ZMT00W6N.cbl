      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00W6N'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01JOH              PIC X(8) VALUE 'ZMT01JOH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01M35-001.
               PERFORM CALL-ZMT01JOH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01JOH-002.
               CALL 'ZMT01JOH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01JOH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
