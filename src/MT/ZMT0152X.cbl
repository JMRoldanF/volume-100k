      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT0152X'.
      ...
      * Called module names
       01  MOD-ZMT01DBB              PIC X(8) VALUE 'ZMT01DBB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01DBB-001.
               CALL 'ZMT01DBB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01DBB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
