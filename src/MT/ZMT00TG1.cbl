      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00TG1'.
      ...
      * Called module names
       01  MOD-ZMT01HY9              PIC X(8) VALUE 'ZMT01HY9'.
       01  MOD-ZMT01KF5              PIC X(8) VALUE 'ZMT01KF5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01HY9-001.
               PERFORM CALL-ZMT01KF5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01HY9-001.
               CALL 'ZMT01HY9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01HY9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01KF5-002.
               CALL 'ZMT01KF5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01KF5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
