      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00SZA'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01K5Q              PIC X(8) VALUE 'ZMT01K5Q'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01QR8-001.
               PERFORM CALL-ZMT01K5Q-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01K5Q-002.
               CALL 'ZMT01K5Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01K5Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
