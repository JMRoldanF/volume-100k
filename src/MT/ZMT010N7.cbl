      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT010N7'.
      ...
      * Called module names
       01  MOD-ZMT01S61              PIC X(8) VALUE 'ZMT01S61'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01S61-001.
               CALL 'ZMT01S61' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01S61 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
