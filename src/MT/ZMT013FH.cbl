      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT013FH'.
      ...
      * Called module names
       01  MOD-ZMT01S0R              PIC X(8) VALUE 'ZMT01S0R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01S0R-001.
               CALL 'ZMT01S0R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01S0R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
