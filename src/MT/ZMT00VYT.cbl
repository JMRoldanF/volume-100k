      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00VYT'.
      ...
      * Called module names
       01  MOD-ZRN01R41              PIC X(8) VALUE 'ZRN01R41'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRN01R41-002.
               CALL 'ZRN01R41' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01R41 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
