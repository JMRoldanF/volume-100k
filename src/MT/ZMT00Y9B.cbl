      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00Y9B'.
      ...
      * Called module names
       01  MOD-ZMT01LWO              PIC X(8) VALUE 'ZMT01LWO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01LWO-001.
               PERFORM CALL-ZCL0255P-002.
               PERFORM REFRESH-MAKE-0001.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01LWO-001.
               CALL 'ZMT01LWO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01LWO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
