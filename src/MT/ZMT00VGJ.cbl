      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00VGJ'.
      ...
      * Called module names
       01  MOD-ZMT01ODX              PIC X(8) VALUE 'ZMT01ODX'.
       01  MOD-ZMT01NZ7              PIC X(8) VALUE 'ZMT01NZ7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01ODX-001.
               PERFORM CALL-ZMT01NZ7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01ODX-001.
               CALL 'ZMT01ODX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01ODX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01NZ7-002.
               CALL 'ZMT01NZ7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01NZ7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-VALUE-0001.
