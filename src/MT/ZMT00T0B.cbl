      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00T0B'.
      ...
      * Called module names
       01  MOD-ZMT01U7G              PIC X(8) VALUE 'ZMT01U7G'.
       01  MOD-ZMT01CXC              PIC X(8) VALUE 'ZMT01CXC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01U7G-001.
               PERFORM CALL-ZMT01CXC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01U7G-001.
               CALL 'ZMT01U7G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01U7G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01CXC-002.
               CALL 'ZMT01CXC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01CXC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
