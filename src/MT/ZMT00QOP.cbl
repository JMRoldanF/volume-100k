      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00QOP'.
      ...
      * Called module names
       01  MOD-ZCP01FC2              PIC X(8) VALUE 'ZCP01FC2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCP01FC2-001.
               PERFORM CALL-ZMT01HPO-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01FC2-001.
               CALL 'ZCP01FC2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01FC2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01HPO-002.
