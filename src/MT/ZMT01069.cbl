      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01069'.
      ...
      * Called module names
       01  MOD-ZMT01T3D              PIC X(8) VALUE 'ZMT01T3D'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01T3D-001.
               CALL 'ZMT01T3D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01T3D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01ME9-002.
