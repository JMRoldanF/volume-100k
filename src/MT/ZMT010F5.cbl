      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT010F5'.
      ...
      * Called module names
       01  MOD-ZMT01SNG              PIC X(8) VALUE 'ZMT01SNG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01SNG-001.
               CALL 'ZMT01SNG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01SNG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
