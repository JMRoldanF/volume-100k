      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00QZZ'.
      ...
      * Called module names
       01  MOD-ZMT01GA9              PIC X(8) VALUE 'ZMT01GA9'.
       01  MOD-ZMT01RB7              PIC X(8) VALUE 'ZMT01RB7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01GA9-001.
               PERFORM CALL-ZMT01RB7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01GA9-001.
               CALL 'ZMT01GA9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01GA9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01RB7-002.
               CALL 'ZMT01RB7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01RB7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
