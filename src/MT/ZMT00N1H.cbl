      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00N1H'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01S5X              PIC X(8) VALUE 'ZRE01S5X'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01R0D-001.
               PERFORM CALL-ZRE01S5X-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01S5X-002.
               CALL 'ZRE01S5X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01S5X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
