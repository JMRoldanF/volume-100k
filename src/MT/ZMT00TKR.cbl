      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00TKR'.
      ...
      * Called module names
       01  MOD-ZMT01IL1              PIC X(8) VALUE 'ZMT01IL1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01IL1-001.
               CALL 'ZMT01IL1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01IL1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01GEF-002.
