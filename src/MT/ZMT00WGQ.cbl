      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00WGQ'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01SWN              PIC X(8) VALUE 'ZMT01SWN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEX01PYV-001.
               PERFORM CALL-ZMT01SWN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01SWN-002.
               CALL 'ZMT01SWN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01SWN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
