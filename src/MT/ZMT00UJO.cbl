      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00UJO'.
      ...
      * Called module names
       01  MOD-ZMT01UDF              PIC X(8) VALUE 'ZMT01UDF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01UDF-001.
               CALL 'ZMT01UDF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01UDF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
