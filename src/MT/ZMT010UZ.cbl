      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT010UZ'.
      ...
      * Called module names
       01  MOD-ZCL01S1Z              PIC X(8) VALUE 'ZCL01S1Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01S1Z-001.
               CALL 'ZCL01S1Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01S1Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
