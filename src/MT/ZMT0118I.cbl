      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT0118I'.
      ...
      * Called module names
       01  MOD-ZMT01KH4              PIC X(8) VALUE 'ZMT01KH4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01KH4-001.
               CALL 'ZMT01KH4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01KH4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
