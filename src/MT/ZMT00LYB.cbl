      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00LYB'.
      ...
      * Called module names
       01  MOD-ZAG01LU6              PIC X(8) VALUE 'ZAG01LU6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01LU6-001.
               PERFORM CALL-ZMT01S8T-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01LU6-001.
               CALL 'ZAG01LU6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01LU6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01S8T-002.
