      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00VW7'.
      ...
      * Called module names
       01  MOD-ZMT01P2O              PIC X(8) VALUE 'ZMT01P2O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01P2O-001.
               CALL 'ZMT01P2O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01P2O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-TERM-0001.
