      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT013S3'.
      ...
      * Called module names
       01  MOD-ZMT01H9O              PIC X(8) VALUE 'ZMT01H9O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01H9O-001.
               CALL 'ZMT01H9O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01H9O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
