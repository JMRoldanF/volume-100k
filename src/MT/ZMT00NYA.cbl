      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00NYA'.
      ...
      * Called module names
       01  MOD-ZMT01PFX              PIC X(8) VALUE 'ZMT01PFX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01PFX-001.
               CALL 'ZMT01PFX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01PFX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
