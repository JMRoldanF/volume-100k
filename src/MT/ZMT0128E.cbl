      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT0128E'.
      ...
      * Called module names
       01  MOD-ZMT01IC8              PIC X(8) VALUE 'ZMT01IC8'.
       01  MOD-ZMT01CTF              PIC X(8) VALUE 'ZMT01CTF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01IC8-001.
               PERFORM CALL-ZMT01CTF-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01IC8-001.
               CALL 'ZMT01IC8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01IC8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01CTF-002.
               CALL 'ZMT01CTF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01CTF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
