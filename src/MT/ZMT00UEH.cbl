      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00UEH'.
      ...
      * Called module names
       01  MOD-ZMT01E2J              PIC X(8) VALUE 'ZMT01E2J'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01E2J-001.
               PERFORM CALL-ZMT01SGB-002.
               PERFORM CALL-ZCU0255O-003.
               PERFORM REFRESH-REG-NUMBER-0001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZMT01E2J-001.
               CALL 'ZMT01E2J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01E2J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01SGB-002.
