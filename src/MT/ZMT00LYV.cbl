      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00LYV'.
      ...
      * Called module names
       01  MOD-ZMT01FMN              PIC X(8) VALUE 'ZMT01FMN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01FMN-001.
               CALL 'ZMT01FMN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01FMN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-MODEL-0001.
