      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01LCV'.
      ...
      * Called module names
       01  MOD-ZMT01RE3              PIC X(8) VALUE 'ZMT01RE3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01RE3-001.
               CALL 'ZMT01RE3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01RE3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
