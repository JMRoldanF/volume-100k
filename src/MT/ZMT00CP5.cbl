      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00CP5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT00NSD-001.
               PERFORM CALL-ZPT00T2A-002.
               PERFORM COMPUTE-PREMIUM-0001.
               PERFORM AUDIT-NCD-YEARS-0002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZMT00NSD-001.
               MOVE 'ZMT00NSD' TO WS-PROGNAME-6
      ...
      *----------------------------------------------------------------*
       CALL-ZPT00T2A-002.
               MOVE 'ZPT00T2A' TO WS-PROGNAME-7
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT00T2A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
