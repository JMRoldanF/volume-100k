      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT009BL'.
      ...
      * Called module names
       01  MOD-ZMT00SN5              PIC X(8) VALUE 'ZMT00SN5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00SN5-001.
               EXEC CICS LINK PROGRAM('ZMT00SN5')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00SN5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
