      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00SZ6'.
      ...
      * Called module names
       01  MOD-ZMT01DKB              PIC X(8) VALUE 'ZMT01DKB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01DKB-001.
               CALL 'ZMT01DKB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01DKB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
