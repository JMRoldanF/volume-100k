      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT011LD'.
      ...
      * Called module names
       01  MOD-ZMT01JZV              PIC X(8) VALUE 'ZMT01JZV'.
       01  MOD-ZMT01FGT              PIC X(8) VALUE 'ZMT01FGT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01JZV-001.
               CALL 'ZMT01JZV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01JZV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01FGT-002.
               CALL 'ZMT01FGT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01FGT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
