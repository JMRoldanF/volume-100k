      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00OGG'.
      ...
      * Called module names
       01  MOD-ZMT01SQ6              PIC X(8) VALUE 'ZMT01SQ6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01SQ6-001.
               CALL 'ZMT01SQ6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01SQ6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
