      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01T9A'.
      ...
      * Called module names
       01  MOD-ZMT01O3V              PIC X(8) VALUE 'ZMT01O3V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01O3V-001.
               CALL 'ZMT01O3V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01O3V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
