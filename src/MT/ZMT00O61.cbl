      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00O61'.
      ...
      * Called module names
       01  MOD-ZMT01RPD              PIC X(8) VALUE 'ZMT01RPD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01RPD-001.
               CALL 'ZMT01RPD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01RPD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
