      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00MMR'.
      ...
      * Called module names
       01  MOD-ZMT01G0T              PIC X(8) VALUE 'ZMT01G0T'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01G0T-001.
               CALL 'ZMT01G0T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01G0T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
