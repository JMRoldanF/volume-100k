      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00VVJ'.
      ...
      * Called module names
       01  MOD-ZCU01TKY              PIC X(8) VALUE 'ZCU01TKY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01TKY-001.
               CALL 'ZCU01TKY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01TKY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
