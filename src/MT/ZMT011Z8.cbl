      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT011Z8'.
      ...
      * Called module names
       01  MOD-ZMT01KT7              PIC X(8) VALUE 'ZMT01KT7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01KT7-001.
               CALL 'ZMT01KT7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01KT7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
