      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00NWI'.
      ...
      * Called module names
       01  MOD-ZMT01JH6              PIC X(8) VALUE 'ZMT01JH6'.
       01  MOD-ZMT01RY2              PIC X(8) VALUE 'ZMT01RY2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01JH6-001.
               PERFORM CALL-ZMT01RY2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01JH6-001.
               CALL 'ZMT01JH6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01JH6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01RY2-002.
               CALL 'ZMT01RY2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01RY2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
