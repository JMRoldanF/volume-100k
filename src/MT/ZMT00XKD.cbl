      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00XKD'.
      ...
      * Called module names
       01  MOD-ZMT01I0H              PIC X(8) VALUE 'ZMT01I0H'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01I0H-001.
               CALL 'ZMT01I0H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01I0H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
