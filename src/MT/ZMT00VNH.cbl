      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00VNH'.
      ...
      * Called module names
       01  MOD-ZMT01PWN              PIC X(8) VALUE 'ZMT01PWN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01PWN-001.
               CALL 'ZMT01PWN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01PWN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
