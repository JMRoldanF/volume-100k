      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00ZL5'.
      ...
      * Called module names
       01  MOD-ZMT01U0Z              PIC X(8) VALUE 'ZMT01U0Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01U0Z-001.
               CALL 'ZMT01U0Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01U0Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-VALUE-0001.
