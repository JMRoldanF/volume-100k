      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00Y8O'.
      ...
      * Called module names
       01  MOD-ZMT01QCZ              PIC X(8) VALUE 'ZMT01QCZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01QCZ-001.
               CALL 'ZMT01QCZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01QCZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
