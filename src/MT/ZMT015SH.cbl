      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT015SH'.
      ...
      * Called module names
       01  MOD-ZMT01K6J              PIC X(8) VALUE 'ZMT01K6J'.
       01  MOD-ZRE01UC9              PIC X(8) VALUE 'ZRE01UC9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01K6J-001.
               PERFORM CALL-ZRE01UC9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01K6J-001.
               CALL 'ZMT01K6J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01K6J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01UC9-002.
               CALL 'ZRE01UC9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01UC9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
