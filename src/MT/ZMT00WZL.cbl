      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00WZL'.
      ...
      * Called module names
       01  MOD-ZCP01GPG              PIC X(8) VALUE 'ZCP01GPG'.
       01  MOD-ZMT01OWW              PIC X(8) VALUE 'ZMT01OWW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCP01GPG-001.
               PERFORM CALL-ZMT01OWW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01GPG-001.
               CALL 'ZCP01GPG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01GPG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01OWW-002.
               CALL 'ZMT01OWW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01OWW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
