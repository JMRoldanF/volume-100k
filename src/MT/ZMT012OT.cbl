      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT012OT'.
      ...
      * Called module names
       01  MOD-ZMT01Q9P              PIC X(8) VALUE 'ZMT01Q9P'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01Q9P-001.
               CALL 'ZMT01Q9P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01Q9P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-MODEL-0001.
