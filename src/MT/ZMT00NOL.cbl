      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00NOL'.
      ...
      * Called module names
       01  MOD-ZQU01KOW              PIC X(8) VALUE 'ZQU01KOW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZQU01KOW-001.
               CALL 'ZQU01KOW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU01KOW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
