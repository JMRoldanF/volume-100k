      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00X49'.
      ...
      * Called module names
       01  MOD-ZMT01R6H              PIC X(8) VALUE 'ZMT01R6H'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01R6H-001.
               PERFORM CALL-ZMT01RLH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01R6H-001.
               CALL 'ZMT01R6H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01R6H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01RLH-002.
