      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT011RC'.
      ...
      * Called module names
       01  MOD-ZMT01UUT              PIC X(8) VALUE 'ZMT01UUT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01UUT-001.
               CALL 'ZMT01UUT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01UUT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
