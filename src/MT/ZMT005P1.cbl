      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT005P1'.
      ...
      * Called module names
       01  MOD-ZMT00BJ1              PIC X(8) VALUE 'ZMT00BJ1'.
       01  MOD-ZMT00IET              PIC X(8) VALUE 'ZMT00IET'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT00BJ1-001.
               PERFORM CALL-ZAG00KGC-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00BJ1-001.
               EXEC CICS LINK PROGRAM('ZMT00BJ1')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00BJ1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT00IET-002.
               EXEC CICS LINK PROGRAM('ZMT00IET')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00IET FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG00KGC-003.
               MOVE 'ZAG00KGC' TO WS-PROGNAME-4
