      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00WYH'.
      ...
      * Called module names
       01  MOD-ZCP01O91              PIC X(8) VALUE 'ZCP01O91'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01O91-001.
               CALL 'ZCP01O91' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01O91 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
