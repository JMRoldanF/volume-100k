      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT010KB'.
      ...
      * Called module names
       01  MOD-ZMT01JNM              PIC X(8) VALUE 'ZMT01JNM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01JNM-001.
               CALL 'ZMT01JNM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01JNM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-MAKE-0001.
