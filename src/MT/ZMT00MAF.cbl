      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00MAF'.
      ...
      * Called module names
       01  MOD-ZMT01RHZ              PIC X(8) VALUE 'ZMT01RHZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01RHZ-001.
               CALL 'ZMT01RHZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01RHZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-EXCESS-0001.
