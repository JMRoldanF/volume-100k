      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00T0H'.
      ...
      * Called module names
       01  MOD-ZRE01KP1              PIC X(8) VALUE 'ZRE01KP1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01KP1-001.
               CALL 'ZRE01KP1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01KP1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
