      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00QNQ'.
      ...
      * Called module names
       01  MOD-ZMT01TOG              PIC X(8) VALUE 'ZMT01TOG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01TOG-001.
               PERFORM CALL-ZMT01KBM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01TOG-001.
               CALL 'ZMT01TOG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
