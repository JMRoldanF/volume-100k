      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT016FH'.
      ...
      * Called module names
       01  MOD-ZMT01TUY              PIC X(8) VALUE 'ZMT01TUY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01TUY-001.
               CALL 'ZMT01TUY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01TUY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
