      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00M5T'.
      ...
      * Called module names
       01  MOD-ZPA01EDB              PIC X(8) VALUE 'ZPA01EDB'.
       01  MOD-ZMT01IE3              PIC X(8) VALUE 'ZMT01IE3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01EDB-001.
               PERFORM CALL-ZMT01IE3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01EDB-001.
               CALL 'ZPA01EDB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01EDB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01IE3-002.
               CALL 'ZMT01IE3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01IE3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
