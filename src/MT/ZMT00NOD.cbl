      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00NOD'.
      ...
      * Called module names
       01  MOD-ZCP01I7U              PIC X(8) VALUE 'ZCP01I7U'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01I7U-001.
               CALL 'ZCP01I7U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01I7U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
