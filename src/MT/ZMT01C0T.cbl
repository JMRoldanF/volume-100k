      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01C0T'.
      ...
      * Called module names
       01  MOD-ZMT01LSN              PIC X(8) VALUE 'ZMT01LSN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01LSN-001.
               CALL 'ZMT01LSN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01LSN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
