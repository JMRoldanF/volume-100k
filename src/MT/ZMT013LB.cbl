      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT013LB'.
      ...
      * Called module names
       01  MOD-ZMT01KCX              PIC X(8) VALUE 'ZMT01KCX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01KCX-001.
               CALL 'ZMT01KCX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01KCX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
