      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00OEW'.
      ...
      * Called module names
       01  MOD-ZMT01T4O              PIC X(8) VALUE 'ZMT01T4O'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01O53-001.
               PERFORM CALL-ZMT01T4O-002.
               PERFORM CALL-ZMT0255L-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZMT01O53-001.
               MOVE 'ZMT01O53' TO WS-SUBNAME-7
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01T4O-002.
               CALL 'ZMT01T4O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
