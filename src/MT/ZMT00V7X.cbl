      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00V7X'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01MB7              PIC X(8) VALUE 'ZMT01MB7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01NAS-001.
               PERFORM CALL-ZMT01MB7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01MB7-002.
               CALL 'ZMT01MB7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01MB7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
