      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT010NH'.
      ...
      * Called module names
       01  MOD-ZCU01SJQ              PIC X(8) VALUE 'ZCU01SJQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01SJQ-001.
               PERFORM CALL-ZMT01MBR-002.
               PERFORM CALL-ZMT0255L-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCU01SJQ-001.
               CALL 'ZCU01SJQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
