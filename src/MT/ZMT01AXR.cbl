      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01AXR'.
      ...
      * Called module names
       01  MOD-ZMT01DCF              PIC X(8) VALUE 'ZMT01DCF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01DCF-001.
               CALL 'ZMT01DCF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01DCF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
