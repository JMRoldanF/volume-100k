      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT005TH'.
      ...
      * Called module names
       01  MOD-ZMT006DH              PIC X(8) VALUE 'ZMT006DH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT006DH-001.
               PERFORM CALL-ZCU00FCC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT006DH-001.
               EXEC CICS LINK PROGRAM('ZMT006DH')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT006DH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU00FCC-002.
