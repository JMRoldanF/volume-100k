      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00SGH'.
      ...
      * Called module names
       01  MOD-ZMT01O47              PIC X(8) VALUE 'ZMT01O47'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01O47-001.
               PERFORM CALL-ZMT01JBZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01O47-001.
               CALL 'ZMT01O47' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01O47 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01JBZ-002.
