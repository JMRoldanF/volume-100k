      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00W4F'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01EVP              PIC X(8) VALUE 'ZMT01EVP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01GLN-001.
               PERFORM CALL-ZMT01EVP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01EVP-002.
               CALL 'ZMT01EVP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
