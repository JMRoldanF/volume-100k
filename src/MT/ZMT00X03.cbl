      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00X03'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01MWL              PIC X(8) VALUE 'ZMT01MWL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01T3H-001.
               PERFORM CALL-ZMT01MWL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01MWL-002.
               CALL 'ZMT01MWL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01MWL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       VALIDATE-MAKE-0001.
