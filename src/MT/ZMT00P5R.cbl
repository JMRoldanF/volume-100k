      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00P5R'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01UOW              PIC X(8) VALUE 'ZMT01UOW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01R84-001.
               PERFORM CALL-ZMT01UOW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01UOW-002.
               CALL 'ZMT01UOW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01UOW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
