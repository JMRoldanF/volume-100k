      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00SH1'.
      ...
      * Called module names
       01  MOD-ZMT01IBB              PIC X(8) VALUE 'ZMT01IBB'.
       01  MOD-ZAG01JHQ              PIC X(8) VALUE 'ZAG01JHQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01IBB-001.
               PERFORM CALL-ZAG01JHQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01IBB-001.
               CALL 'ZMT01IBB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01IBB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01JHQ-002.
               CALL 'ZAG01JHQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01JHQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
