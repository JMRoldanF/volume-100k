      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00V0J'.
      ...
      * Called module names
       ...
       01  MOD-ZCP01KXI              PIC X(8) VALUE 'ZCP01KXI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01KXI-002.
               CALL 'ZCP01KXI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01KXI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
