      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00XPS'.
      ...
      * Called module names
       01  MOD-ZQU01GGI              PIC X(8) VALUE 'ZQU01GGI'.
       01  MOD-ZMT01MJP              PIC X(8) VALUE 'ZMT01MJP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZQU01GGI-001.
               CALL 'ZQU01GGI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU01GGI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01MJP-002.
               CALL 'ZMT01MJP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01MJP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
