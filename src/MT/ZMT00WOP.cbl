      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00WOP'.
      ...
      * Called module names
       01  MOD-ZMT01DAR              PIC X(8) VALUE 'ZMT01DAR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM RECONCILE-CC-RATING-0041.
               ...
               PERFORM VALIDATE-MAKE-0088.
               PERFORM APPLY-BROKER-ID-0089.
               PERFORM SQL-ACCESS-0090.
               PERFORM FORMAT-BROKER-ID-0091.
               PERFORM SQL-ACCESS-0093.
               PERFORM EXPAND-TERM-0094.
               PERFORM EXPAND-MAKE-0095.
               PERFORM SQL-ACCESS-0096.
               PERFORM CHECK-COLOUR-0097.
               PERFORM CHECK-MODEL-0098.
               ...
               PERFORM VALIDATE-COLOUR-0109.
               PERFORM COMPUTE-STATUS-CODE-0110.
               ...
               PERFORM CHECK-TERM-0127.
               PERFORM RECONCILE-COLOUR-0128.
               PERFORM SQL-ACCESS-0129.
               PERFORM REFRESH-SUM-ASSURED-0130.
               PERFORM APPLY-EQUITIES-0131.
               PERFORM SQL-ACCESS-0132.
               PERFORM NORMALISE-EXCESS-0133.
               PERFORM RESOLVE-MANAGED-FUND-0134.
               PERFORM SQL-ACCESS-0135.
               PERFORM FORMAT-PREMIUM-0136.
               PERFORM AUDIT-WITH-PROFITS-0137.
               PERFORM SQL-ACCESS-0138.
               PERFORM FORMAT-AGENT-CODE-0139.
               PERFORM VALIDATE-TERM-0140.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZMT01DAR-001.
               CALL 'ZMT01DAR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01DAR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
