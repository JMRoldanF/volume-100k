      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT018IT'.
      ...
      * Called module names
       01  MOD-ZCU01SGY              PIC X(8) VALUE 'ZCU01SGY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01SGY-001.
               CALL 'ZCU01SGY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01SGY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01OQZ-002.
