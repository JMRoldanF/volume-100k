      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01DL6'.
      ...
      * Called module names
       01  MOD-ZMT01KY6              PIC X(8) VALUE 'ZMT01KY6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01KY6-001.
               CALL 'ZMT01KY6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01KY6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
