      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT015RN'.
      ...
      * Called module names
       01  MOD-ZMT01NN8              PIC X(8) VALUE 'ZMT01NN8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01NN8-001.
               CALL 'ZMT01NN8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01NN8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
