      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00VOB'.
      ...
      * Called module names
       01  MOD-ZAG01JDU              PIC X(8) VALUE 'ZAG01JDU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01JDU-001.
               PERFORM CALL-ZMT01OC9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01JDU-001.
               CALL 'ZAG01JDU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01JDU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01OC9-002.
