      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00KA8'.
      ...
      * Called module names
       01  MOD-ZMT00Z4M              PIC X(8) VALUE 'ZMT00Z4M'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT00Z4M-001.
               PERFORM CALL-ZMT01CZV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00Z4M-001.
               EXEC CICS LINK PROGRAM('ZMT00Z4M')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00Z4M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01CZV-002.
