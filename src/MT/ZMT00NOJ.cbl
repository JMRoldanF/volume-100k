      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00NOJ'.
      ...
      * Called module names
       01  MOD-ZMT01M4J              PIC X(8) VALUE 'ZMT01M4J'.
       01  MOD-ZMT01J6P              PIC X(8) VALUE 'ZMT01J6P'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01M4J-001.
               CALL 'ZMT01M4J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01J6P-002.
               CALL 'ZMT01J6P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01J6P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
