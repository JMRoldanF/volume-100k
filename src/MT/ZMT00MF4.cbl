      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00MF4'.
      ...
      * Called module names
       01  MOD-ZEX01F2V              PIC X(8) VALUE 'ZEX01F2V'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEX01F2V-001.
               PERFORM CALL-ZMT01KDQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEX01F2V-001.
               CALL 'ZEX01F2V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEX01F2V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01KDQ-002.
