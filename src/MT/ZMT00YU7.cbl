      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00YU7'.
      ...
      * Called module names
       01  MOD-ZMT01PRN              PIC X(8) VALUE 'ZMT01PRN'.
       01  MOD-ZMT01GT5              PIC X(8) VALUE 'ZMT01GT5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01PRN-001.
               PERFORM CALL-ZMT01GT5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01PRN-001.
               CALL 'ZMT01PRN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01PRN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01GT5-002.
               CALL 'ZMT01GT5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01GT5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
