      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01195'.
      ...
      * Called module names
       01  MOD-ZMT01HZ3              PIC X(8) VALUE 'ZMT01HZ3'.
       01  MOD-ZMT01LV3              PIC X(8) VALUE 'ZMT01LV3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01HZ3-001.
               PERFORM CALL-ZMT01LV3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01HZ3-001.
               CALL 'ZMT01HZ3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01HZ3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01LV3-002.
               CALL 'ZMT01LV3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01LV3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
