      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00U1Z'.
      ...
      * Called module names
       01  MOD-ZRE01EDT              PIC X(8) VALUE 'ZRE01EDT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01EDT-001.
               PERFORM CALL-ZCL01GOT-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01EDT-001.
               CALL 'ZRE01EDT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01EDT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01GOT-002.
