      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00N4N'.
      ...
      * Called module names
       01  MOD-ZMT01L4D              PIC X(8) VALUE 'ZMT01L4D'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01L4D-001.
               PERFORM CALL-ZMT01IMI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01L4D-001.
               CALL 'ZMT01L4D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01L4D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01IMI-002.
