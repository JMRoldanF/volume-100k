      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00XYI'.
      ...
      * Called module names
       01  MOD-ZMT01QJS              PIC X(8) VALUE 'ZMT01QJS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01QJS-001.
               CALL 'ZMT01QJS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01QJS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
