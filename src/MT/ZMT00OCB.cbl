      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00OCB'.
      ...
      * Called module names
       01  MOD-ZMT01EWO              PIC X(8) VALUE 'ZMT01EWO'.
       01  MOD-ZQU01OG1              PIC X(8) VALUE 'ZQU01OG1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01EWO-001.
               CALL 'ZMT01EWO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01EWO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZQU01OG1-002.
               CALL 'ZQU01OG1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU01OG1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-COLOUR-0001.
