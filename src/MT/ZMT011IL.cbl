      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT011IL'.
      ...
      * Called module names
       01  MOD-ZMT01CNP              PIC X(8) VALUE 'ZMT01CNP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01CNP-001.
               CALL 'ZMT01CNP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01CNP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
