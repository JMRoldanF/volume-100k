      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00OWP'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01Q27              PIC X(8) VALUE 'ZMT01Q27'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01Q27-002.
               CALL 'ZMT01Q27' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01Q27 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
