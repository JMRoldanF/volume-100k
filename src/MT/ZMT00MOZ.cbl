      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00MOZ'.
      ...
      * Called module names
       01  MOD-ZMT01KSR              PIC X(8) VALUE 'ZMT01KSR'.
       01  MOD-ZMT01SAR              PIC X(8) VALUE 'ZMT01SAR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01KSR-001.
               PERFORM CALL-ZMT01SAR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01KSR-001.
               CALL 'ZMT01KSR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01KSR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01SAR-002.
               CALL 'ZMT01SAR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01SAR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
