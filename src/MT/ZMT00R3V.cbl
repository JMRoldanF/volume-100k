      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00R3V'.
      ...
      * Called module names
       01  MOD-ZMT01T2J              PIC X(8) VALUE 'ZMT01T2J'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01T2J-001.
               PERFORM CALL-ZMT01E2T-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01T2J-001.
               CALL 'ZMT01T2J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01T2J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01E2T-002.
