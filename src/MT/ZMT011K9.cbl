      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT011K9'.
      ...
      * Called module names
       01  MOD-ZMT01M8Z              PIC X(8) VALUE 'ZMT01M8Z'.
       01  MOD-ZBI01M3A              PIC X(8) VALUE 'ZBI01M3A'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01M8Z-001.
               PERFORM CALL-ZBI01M3A-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01M8Z-001.
               CALL 'ZMT01M8Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01M8Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01M3A-002.
               CALL 'ZBI01M3A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01M3A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
