      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00XYJ'.
      ...
      * Called module names
       01  MOD-ZMT01PQT              PIC X(8) VALUE 'ZMT01PQT'.
       01  MOD-ZMT01PLJ              PIC X(8) VALUE 'ZMT01PLJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01PQT-001.
               PERFORM CALL-ZMT01PLJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01PQT-001.
               CALL 'ZMT01PQT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01PQT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01PLJ-002.
               CALL 'ZMT01PLJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01PLJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
