      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00SUP'.
      ...
      * Called module names
       01  MOD-ZMT01O2M              PIC X(8) VALUE 'ZMT01O2M'.
       01  MOD-ZMT01M7I              PIC X(8) VALUE 'ZMT01M7I'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01O2M-001.
               CALL 'ZMT01O2M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01M7I-002.
               CALL 'ZMT01M7I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01M7I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
