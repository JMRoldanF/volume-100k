      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00O75'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01HML              PIC X(8) VALUE 'ZMT01HML'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01IS9-001.
               PERFORM CALL-ZMT01HML-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01HML-002.
               CALL 'ZMT01HML' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01HML FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
