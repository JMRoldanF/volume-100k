      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00T6G'.
      ...
      * Called module names
       01  MOD-ZMT01K7I              PIC X(8) VALUE 'ZMT01K7I'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01K7I-001.
               CALL 'ZMT01K7I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01K7I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
