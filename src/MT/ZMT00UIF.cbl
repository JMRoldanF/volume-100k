      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00UIF'.
      ...
      * Called module names
       01  MOD-ZMT01S5K              PIC X(8) VALUE 'ZMT01S5K'.
       01  MOD-ZMT01HYT              PIC X(8) VALUE 'ZMT01HYT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01S5K-001.
               PERFORM CALL-ZMT01HYT-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01S5K-001.
               CALL 'ZMT01S5K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01S5K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01HYT-002.
               CALL 'ZMT01HYT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01HYT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
