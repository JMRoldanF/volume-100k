      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT012G4'.
      ...
      * Called module names
       01  MOD-ZMT01L6M              PIC X(8) VALUE 'ZMT01L6M'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01L6M-001.
               PERFORM CALL-ZMT01RC7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01L6M-001.
               CALL 'ZMT01L6M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01L6M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01RC7-002.
