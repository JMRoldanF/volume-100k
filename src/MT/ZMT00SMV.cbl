      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00SMV'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01LHR              PIC X(8) VALUE 'ZMT01LHR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01LHR-002.
               CALL 'ZMT01LHR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01LHR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
