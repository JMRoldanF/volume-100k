      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT014A1'.
      ...
      * Called module names
       01  MOD-ZMT01DNT              PIC X(8) VALUE 'ZMT01DNT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01DNT-001.
               CALL 'ZMT01DNT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01DNT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
