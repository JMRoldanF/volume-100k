      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00QF5'.
      ...
      * Called module names
       01  MOD-ZMT01EH9              PIC X(8) VALUE 'ZMT01EH9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01EH9-001.
               CALL 'ZMT01EH9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01EH9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-VALUE-0001.
