      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00W1W'.
      ...
      * Called module names
       01  MOD-ZMT01MNT              PIC X(8) VALUE 'ZMT01MNT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01MNT-001.
               CALL 'ZMT01MNT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01MNT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPT01NU3-002.
