      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00YCZ'.
      ...
      * Called module names
       01  MOD-ZMT01FSH              PIC X(8) VALUE 'ZMT01FSH'.
       01  MOD-ZMT01H2L              PIC X(8) VALUE 'ZMT01H2L'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01FSH-001.
               PERFORM CALL-ZMT01H2L-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01FSH-001.
               CALL 'ZMT01FSH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01FSH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01H2L-002.
               CALL 'ZMT01H2L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01H2L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
