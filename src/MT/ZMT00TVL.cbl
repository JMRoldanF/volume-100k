      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00TVL'.
      ...
      * Called module names
       01  MOD-ZMT01DS9              PIC X(8) VALUE 'ZMT01DS9'.
       01  MOD-ZRE01RS1              PIC X(8) VALUE 'ZRE01RS1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01DS9-001.
               PERFORM CALL-ZRE01RS1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01DS9-001.
               CALL 'ZMT01DS9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01DS9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01RS1-002.
               CALL 'ZRE01RS1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01RS1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
