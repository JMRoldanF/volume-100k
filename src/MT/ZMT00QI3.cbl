      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00QI3'.
      ...
      * Called module names
       01  MOD-ZMT01U4I              PIC X(8) VALUE 'ZMT01U4I'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01U4I-001.
               PERFORM CALL-ZQU01KJY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01U4I-001.
               CALL 'ZMT01U4I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01U4I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZQU01KJY-002.
               MOVE 'ZQU01KJY' TO WS-SUBNAME-5
