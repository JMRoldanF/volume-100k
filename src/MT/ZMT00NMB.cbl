      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00NMB'.
      ...
      * Called module names
       01  MOD-ZMT01SAH              PIC X(8) VALUE 'ZMT01SAH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01SAH-001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZMT01SAH-001.
               CALL 'ZMT01SAH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
