      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT000LS'.
      ...
      * Called module names
       01  MOD-ZMT00DND              PIC X(8) VALUE 'ZMT00DND'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT008Z1-001.
               PERFORM CALL-ZMT00DND-002.
               PERFORM CALL-ZMT00KO7-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT008Z1-001.
               MOVE 'ZMT008Z1' TO WS-PROGNAME-8
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00DND-002.
               EXEC CICS LINK PROGRAM('ZMT00DND')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00DND FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT00KO7-003.
               MOVE 'ZMT00KO7' TO WS-PROGNAME-1
