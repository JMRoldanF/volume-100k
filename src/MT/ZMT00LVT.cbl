      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00LVT'.
      ...
      * Called module names
       01  MOD-ZMT01JPL              PIC X(8) VALUE 'ZMT01JPL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01JPL-001.
               PERFORM CALL-ZUW01Q6M-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01JPL-001.
               CALL 'ZMT01JPL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01JPL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01Q6M-002.
