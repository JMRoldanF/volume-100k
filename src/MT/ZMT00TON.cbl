      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00TON'.
      ...
      * Called module names
       01  MOD-ZMT01HOT              PIC X(8) VALUE 'ZMT01HOT'.
       01  MOD-ZMT01PV9              PIC X(8) VALUE 'ZMT01PV9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01HOT-001.
               PERFORM CALL-ZMT01PV9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01HOT-001.
               CALL 'ZMT01HOT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01HOT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01PV9-002.
               CALL 'ZMT01PV9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01PV9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
