      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00N74'.
      ...
      * Called module names
       01  MOD-ZRN01QVS              PIC X(8) VALUE 'ZRN01QVS'.
       01  MOD-ZMT01PMW              PIC X(8) VALUE 'ZMT01PMW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRN01QVS-001.
               PERFORM CALL-ZMT01PMW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRN01QVS-001.
               CALL 'ZRN01QVS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01QVS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01PMW-002.
               CALL 'ZMT01PMW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01PMW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
