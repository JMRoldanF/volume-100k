      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00OLK'.
      ...
      * Called module names
       01  MOD-ZMT01H2N              PIC X(8) VALUE 'ZMT01H2N'.
       01  MOD-ZRN01KW4              PIC X(8) VALUE 'ZRN01KW4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01H2N-001.
               PERFORM CALL-ZRN01KW4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01H2N-001.
               CALL 'ZMT01H2N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01H2N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRN01KW4-002.
               CALL 'ZRN01KW4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01KW4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
