      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00UCJ'.
      ...
      * Called module names
       01  MOD-ZMT01MSO              PIC X(8) VALUE 'ZMT01MSO'.
       01  MOD-ZMT01JPO              PIC X(8) VALUE 'ZMT01JPO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01MSO-001.
               PERFORM CALL-ZMT01JPO-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01MSO-001.
               CALL 'ZMT01MSO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01MSO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01JPO-002.
               CALL 'ZMT01JPO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01JPO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
