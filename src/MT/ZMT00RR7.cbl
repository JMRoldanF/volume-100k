      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00RR7'.
      ...
      * Called module names
       01  MOD-ZMT01LIL              PIC X(8) VALUE 'ZMT01LIL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01LIL-001.
               CALL 'ZMT01LIL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01LIL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-MAKE-0001.
