      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT014G5'.
      ...
      * Called module names
       01  MOD-ZMT01MZN              PIC X(8) VALUE 'ZMT01MZN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01MZN-001.
               CALL 'ZMT01MZN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01MZN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
