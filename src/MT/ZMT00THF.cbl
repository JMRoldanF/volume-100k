      ...
      * Called module names
       ...
       01  MOD-ZMT01OGT              PIC X(8) VALUE 'ZMT01OGT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01M5N-001.
               PERFORM CALL-ZMT01OGT-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01OGT-002.
               CALL 'ZMT01OGT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01OGT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
