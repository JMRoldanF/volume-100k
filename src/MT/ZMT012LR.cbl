      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT012LR'.
      ...
      * Called module names
       01  MOD-ZMT01UNR              PIC X(8) VALUE 'ZMT01UNR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01FXZ-001.
               PERFORM CALL-ZMT01UNR-002.
               PERFORM CALL-ZBI0255Q-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZPA01FXZ-001.
               MOVE 'ZPA01FXZ' TO WS-SUBNAME-8
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01UNR-002.
               CALL 'ZMT01UNR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
