      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00WM1'.
      ...
      * Called module names
       01  MOD-ZMT01F7R              PIC X(8) VALUE 'ZMT01F7R'.
       01  MOD-ZMT01KJ8              PIC X(8) VALUE 'ZMT01KJ8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01F7R-001.
               PERFORM CALL-ZMT01KJ8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01F7R-001.
               CALL 'ZMT01F7R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01F7R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01KJ8-002.
               CALL 'ZMT01KJ8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01KJ8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
