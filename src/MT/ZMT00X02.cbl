      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00X02'.
      ...
      * Called module names
       01  MOD-ZMT01UCE              PIC X(8) VALUE 'ZMT01UCE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01UCE-001.
               CALL 'ZMT01UCE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01UCE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
