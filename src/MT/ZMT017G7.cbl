      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT017G7'.
      ...
      * Called module names
       01  MOD-ZMT01LQX              PIC X(8) VALUE 'ZMT01LQX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01LQX-001.
               CALL 'ZMT01LQX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01LQX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
