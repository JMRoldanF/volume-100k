      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT010P9'.
      ...
      * Called module names
       01  MOD-ZMT01PQN              PIC X(8) VALUE 'ZMT01PQN'.
       01  MOD-ZMT01SP4              PIC X(8) VALUE 'ZMT01SP4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01PQN-001.
               PERFORM CALL-ZMT01SP4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01PQN-001.
               CALL 'ZMT01PQN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01PQN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01SP4-002.
               CALL 'ZMT01SP4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01SP4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
