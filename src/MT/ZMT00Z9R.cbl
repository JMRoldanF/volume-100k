      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00Z9R'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01I4D              PIC X(8) VALUE 'ZMT01I4D'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01K9B-001.
               PERFORM CALL-ZMT01I4D-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01I4D-002.
               CALL 'ZMT01I4D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01I4D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
