      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00VUM'.
      ...
      * Called module names
       01  MOD-ZMT01JTT              PIC X(8) VALUE 'ZMT01JTT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01JTT-001.
               CALL 'ZMT01JTT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01JTT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
