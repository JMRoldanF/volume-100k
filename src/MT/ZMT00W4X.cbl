      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00W4X'.
      ...
      * Called module names
       01  MOD-ZMT01KW5              PIC X(8) VALUE 'ZMT01KW5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01KW5-001.
               CALL 'ZMT01KW5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01KW5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
