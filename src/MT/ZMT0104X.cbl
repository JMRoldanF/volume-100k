      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT0104X'.
      ...
      * Called module names
       01  MOD-ZRN01SA2              PIC X(8) VALUE 'ZRN01SA2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRN01SA2-001.
               CALL 'ZRN01SA2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01SA2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01Q3F-002.
