      ...
      * Called module names
       ...
       01  MOD-ZMT0055V              PIC X(8) VALUE 'ZMT0055V'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO00HSC-001.
               PERFORM CALL-ZMT0066T-002.
               PERFORM CALL-ZMT0055V-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT0055V-003.
               EXEC CICS XCTL PROGRAM('ZMT0055V')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT0055V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-004.
