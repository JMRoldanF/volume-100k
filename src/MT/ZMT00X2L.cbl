      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00X2L'.
      ...
      * Called module names
       01  MOD-ZMT01S7P              PIC X(8) VALUE 'ZMT01S7P'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01S7P-001.
               CALL 'ZMT01S7P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01S7P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
