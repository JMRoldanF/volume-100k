      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00AEH'.
      ...
      * Called module names
       01  MOD-ZMT00SSF              PIC X(8) VALUE 'ZMT00SSF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00SSF-001.
               EXEC CICS LINK PROGRAM('ZMT00SSF')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00SSF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
