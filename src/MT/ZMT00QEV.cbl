      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00QEV'.
      ...
      * Called module names
       01  MOD-ZMT01FSR              PIC X(8) VALUE 'ZMT01FSR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01FSR-001.
               PERFORM CALL-ZMT01IL1-002.
               PERFORM REFRESH-BROKER-ID-0001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZMT01FSR-001.
               CALL 'ZMT01FSR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01FSR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01IL1-002.
               MOVE 'ZMT01IL1' TO WS-SUBNAME-7
