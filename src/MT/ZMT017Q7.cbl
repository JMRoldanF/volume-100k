      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT017Q7'.
      ...
      * Called module names
       01  MOD-ZMT01G1D              PIC X(8) VALUE 'ZMT01G1D'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01G1D-001.
               CALL 'ZMT01G1D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01G1D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-MAKE-0001.
