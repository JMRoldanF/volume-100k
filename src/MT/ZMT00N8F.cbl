      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00N8F'.
      ...
      * Called module names
       01  MOD-ZMT01EKB              PIC X(8) VALUE 'ZMT01EKB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01EKB-001.
               CALL 'ZMT01EKB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01EKB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-COLOUR-0001.
