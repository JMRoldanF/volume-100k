      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT0107N'.
      ...
      * Called module names
       01  MOD-ZMT01K7X              PIC X(8) VALUE 'ZMT01K7X'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01ONX-001.
               PERFORM CALL-ZMT01K7X-002.
               PERFORM CALL-ZEN0255N-003.
               PERFORM AUDIT-SUM-ASSURED-0001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZMT01ONX-001.
               MOVE 'ZMT01ONX' TO WS-SUBNAME-4
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01K7X-002.
               CALL 'ZMT01K7X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01K7X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
