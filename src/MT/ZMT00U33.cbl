      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00U33'.
      ...
      * Called module names
       01  MOD-ZMT01UFK              PIC X(8) VALUE 'ZMT01UFK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01UFK-001.
               CALL 'ZMT01UFK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01UFK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
