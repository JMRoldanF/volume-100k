      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00OFR'.
      ...
      * Called module names
       01  MOD-ZCL01TRX              PIC X(8) VALUE 'ZCL01TRX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01TRX-001.
               CALL 'ZCL01TRX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01TRX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
