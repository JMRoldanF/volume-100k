      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00T0R'.
      ...
      * Called module names
       01  MOD-ZEX01LGC              PIC X(8) VALUE 'ZEX01LGC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEX01LGC-001.
               PERFORM CALL-ZMT01TXF-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEX01LGC-001.
               CALL 'ZEX01LGC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEX01LGC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01TXF-002.
