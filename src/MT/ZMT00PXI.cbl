      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00PXI'.
      ...
      * Called module names
       01  MOD-ZMT01RES              PIC X(8) VALUE 'ZMT01RES'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01RES-001.
               CALL 'ZMT01RES' USING DFHCOMMAREA
                         WS-STATUS-CODE.
