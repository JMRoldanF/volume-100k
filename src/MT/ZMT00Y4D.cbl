      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00Y4D'.
      ...
      * Called module names
       01  MOD-ZMT01QMH              PIC X(8) VALUE 'ZMT01QMH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01QMH-001.
               CALL 'ZMT01QMH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01QMH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
