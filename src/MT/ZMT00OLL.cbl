      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00OLL'.
      ...
      * Called module names
       01  MOD-ZMT01TSF              PIC X(8) VALUE 'ZMT01TSF'.
       01  MOD-ZMT01D1P              PIC X(8) VALUE 'ZMT01D1P'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01TSF-001.
               PERFORM CALL-ZMT01D1P-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01TSF-001.
               CALL 'ZMT01TSF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01TSF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01D1P-002.
               CALL 'ZMT01D1P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01D1P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
