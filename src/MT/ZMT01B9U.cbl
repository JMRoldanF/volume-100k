      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01B9U'.
      ...
      * Called module names
       01  MOD-ZMT01GKC              PIC X(8) VALUE 'ZMT01GKC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01GKC-001.
               CALL 'ZMT01GKC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01GKC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
