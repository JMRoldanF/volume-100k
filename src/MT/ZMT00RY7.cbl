      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00RY7'.
      ...
      * Called module names
       01  MOD-ZMT01QLW              PIC X(8) VALUE 'ZMT01QLW'.
       01  MOD-ZMT01LZK              PIC X(8) VALUE 'ZMT01LZK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01QLW-001.
               PERFORM CALL-ZMT01LZK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01QLW-001.
               CALL 'ZMT01QLW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01QLW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01LZK-002.
               CALL 'ZMT01LZK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01LZK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-EXCESS-0001.
