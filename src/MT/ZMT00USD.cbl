      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00USD'.
      ...
      * Called module names
       01  MOD-ZMT01N75              PIC X(8) VALUE 'ZMT01N75'.
       01  MOD-ZMT01EX3              PIC X(8) VALUE 'ZMT01EX3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01N75-001.
               PERFORM CALL-ZMT01EX3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01N75-001.
               CALL 'ZMT01N75' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01N75 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01EX3-002.
               CALL 'ZMT01EX3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01EX3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-MODEL-0001.
