      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00N6R'.
      ...
      * Called module names
       01  MOD-ZMT01GC7              PIC X(8) VALUE 'ZMT01GC7'.
       01  MOD-ZMT01SW5              PIC X(8) VALUE 'ZMT01SW5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01GC7-001.
               PERFORM CALL-ZMT01SW5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01GC7-001.
               CALL 'ZMT01GC7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01GC7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01SW5-002.
               CALL 'ZMT01SW5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01SW5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
