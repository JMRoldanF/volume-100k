      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01950'.
      ...
      * Called module names
       01  MOD-ZMT01L3O              PIC X(8) VALUE 'ZMT01L3O'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01L3O-001.
               PERFORM CALL-ZMT01FF0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01L3O-001.
               CALL 'ZMT01L3O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01L3O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01FF0-002.
               MOVE 'ZMT01FF0' TO WS-SUBNAME-3
