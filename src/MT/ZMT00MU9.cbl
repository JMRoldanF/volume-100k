      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00MU9'.
      ...
      * Called module names
       01  MOD-ZMT01KOL              PIC X(8) VALUE 'ZMT01KOL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01KOL-001.
               PERFORM CALL-ZMT01TJH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01KOL-001.
               CALL 'ZMT01KOL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01KOL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01TJH-002.
