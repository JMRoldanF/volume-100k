      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00S5L'.
      ...
      * Called module names
       01  MOD-ZMT01GIS              PIC X(8) VALUE 'ZMT01GIS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01GIS-001.
               CALL 'ZMT01GIS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01GIS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
