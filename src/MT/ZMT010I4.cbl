      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT010I4'.
      ...
      * Called module names
       01  MOD-ZPT01HZH              PIC X(8) VALUE 'ZPT01HZH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPT01HZH-001.
               CALL 'ZPT01HZH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01HZH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
