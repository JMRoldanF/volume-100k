      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00YUZ'.
      ...
      * Called module names
       01  MOD-ZMT01DW6              PIC X(8) VALUE 'ZMT01DW6'.
       01  MOD-ZMT01ROF              PIC X(8) VALUE 'ZMT01ROF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01DW6-001.
               PERFORM CALL-ZMT01ROF-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01DW6-001.
               CALL 'ZMT01DW6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01DW6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01ROF-002.
               CALL 'ZMT01ROF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01ROF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
