      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT0009F'.
      ...
      * Called module names
       01  MOD-ZMT00HSR              PIC X(8) VALUE 'ZMT00HSR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT00HSR-001.
               PERFORM CALL-ZMT00G16-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00HSR-001.
               EXEC CICS LINK PROGRAM('ZMT00HSR')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00HSR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT00G16-002.
