      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00Q5D'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01S8M-001.
               PERFORM CALL-ZMT01QDM-002.
               PERFORM CALL-ZHO0255M-003.
               PERFORM REFRESH-MODEL-0001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZMT01S8M-001.
               MOVE 'ZMT01S8M' TO WS-SUBNAME-1
