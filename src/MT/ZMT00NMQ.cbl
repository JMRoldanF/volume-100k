      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00NMQ'.
      ...
      * Called module names
       01  MOD-ZMT01CRL              PIC X(8) VALUE 'ZMT01CRL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01CRL-001.
               CALL 'ZMT01CRL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01CRL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
