      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00UZU'.
      ...
      * Called module names
       01  MOD-ZMT01T76              PIC X(8) VALUE 'ZMT01T76'.
       01  MOD-ZRN01LJ6              PIC X(8) VALUE 'ZRN01LJ6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01T76-001.
               PERFORM CALL-ZRN01LJ6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01T76-001.
               CALL 'ZMT01T76' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01T76 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRN01LJ6-002.
               CALL 'ZRN01LJ6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01LJ6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-TERM-0001.
