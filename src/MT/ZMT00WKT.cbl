      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00WKT'.
      ...
      * Called module names
       01  MOD-ZMT01OXD              PIC X(8) VALUE 'ZMT01OXD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01OXD-001.
               CALL 'ZMT01OXD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01OXD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
