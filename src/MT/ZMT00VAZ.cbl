      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00VAZ'.
      ...
      * Called module names
       01  MOD-ZMT01RI5              PIC X(8) VALUE 'ZMT01RI5'.
       01  MOD-ZMT01I0R              PIC X(8) VALUE 'ZMT01I0R'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01RI5-001.
               PERFORM CALL-ZMT01I0R-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01RI5-001.
               CALL 'ZMT01RI5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01RI5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01I0R-002.
               CALL 'ZMT01I0R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01I0R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
