      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00XHV'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01SZH              PIC X(8) VALUE 'ZMT01SZH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01SZH-002.
               CALL 'ZMT01SZH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01SZH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
