      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00O39'.
      ...
      * Called module names
       01  MOD-ZMT01RP3              PIC X(8) VALUE 'ZMT01RP3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01RP3-001.
               PERFORM CALL-ZMT01LO5-002.
               PERFORM CALL-ZCU0255O-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZMT01RP3-001.
               CALL 'ZMT01RP3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
