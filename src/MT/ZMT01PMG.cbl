      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01PMG'.
      ...
      * Called module names
       01  MOD-ZMT01PIU              PIC X(8) VALUE 'ZMT01PIU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01PIU-001.
               CALL 'ZMT01PIU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01PIU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
