      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00NFX'.
      ...
      * Called module names
       01  MOD-ZMT01MO9              PIC X(8) VALUE 'ZMT01MO9'.
       01  MOD-ZAG01TWG              PIC X(8) VALUE 'ZAG01TWG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01MO9-001.
               PERFORM CALL-ZAG01TWG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01MO9-001.
               CALL 'ZMT01MO9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01MO9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01TWG-002.
               CALL 'ZAG01TWG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01TWG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
