      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00V73'.
      ...
      * Called module names
       01  MOD-ZMT01HBR              PIC X(8) VALUE 'ZMT01HBR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01HBR-002.
               CALL 'ZMT01HBR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
