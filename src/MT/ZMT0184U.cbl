      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT0184U'.
      ...
      * Called module names
       01  MOD-ZMT01K1C              PIC X(8) VALUE 'ZMT01K1C'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01K1C-001.
               CALL 'ZMT01K1C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01K1C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
