      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00V0Y'.
      ...
      * Called module names
       01  MOD-ZMT01JWO              PIC X(8) VALUE 'ZMT01JWO'.
       01  MOD-ZMT01MLL              PIC X(8) VALUE 'ZMT01MLL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01JWO-001.
               CALL 'ZMT01JWO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01MLL-002.
               CALL 'ZMT01MLL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
