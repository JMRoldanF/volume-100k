      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT001WX'.
      ...
      * Called module names
       01  MOD-ZMT00LA5              PIC X(8) VALUE 'ZMT00LA5'.
       01  MOD-ZMT00EWZ              PIC X(8) VALUE 'ZMT00EWZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT00LA5-001.
               PERFORM CALL-ZMT00EWZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00LA5-001.
               EXEC CICS LINK PROGRAM('ZMT00LA5')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00LA5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT00EWZ-002.
               EXEC CICS LINK PROGRAM('ZMT00EWZ')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00EWZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
