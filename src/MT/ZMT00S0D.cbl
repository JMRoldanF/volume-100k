      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00S0D'.
      ...
      * Called module names
       01  MOD-ZMT01GEZ              PIC X(8) VALUE 'ZMT01GEZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01GEZ-001.
               PERFORM CALL-ZMT01LDB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01GEZ-001.
               CALL 'ZMT01GEZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01GEZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01LDB-002.
