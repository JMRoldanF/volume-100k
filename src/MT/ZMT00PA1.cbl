      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00PA1'.
      ...
      * Called module names
       01  MOD-ZMT01RXP              PIC X(8) VALUE 'ZMT01RXP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01RXP-001.
               CALL 'ZMT01RXP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01RXP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
