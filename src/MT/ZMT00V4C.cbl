      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00V4C'.
      ...
      * Called module names
       01  MOD-ZMT01N6L              PIC X(8) VALUE 'ZMT01N6L'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01N6L-001.
               CALL 'ZMT01N6L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01N6L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
