      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00WVJ'.
      ...
      * Called module names
       01  MOD-ZMT01QN4              PIC X(8) VALUE 'ZMT01QN4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01QN4-001.
               PERFORM CALL-ZMT01HOU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01QN4-001.
               CALL 'ZMT01QN4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01QN4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01HOU-002.
