      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT0100P'.
      ...
      * Called module names
       01  MOD-ZMT01P0Z              PIC X(8) VALUE 'ZMT01P0Z'.
       01  MOD-ZMT01JSN              PIC X(8) VALUE 'ZMT01JSN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01P0Z-001.
               PERFORM CALL-ZMT01JSN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01P0Z-001.
               CALL 'ZMT01P0Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01P0Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01JSN-002.
               CALL 'ZMT01JSN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01JSN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
