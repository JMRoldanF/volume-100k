      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00U43'.
      ...
      * Called module names
       01  MOD-ZMT01F6K              PIC X(8) VALUE 'ZMT01F6K'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01F6K-001.
               CALL 'ZMT01F6K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01F6K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
