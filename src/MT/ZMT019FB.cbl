      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT019FB'.
      ...
      * Called module names
       01  MOD-ZMT01G8V              PIC X(8) VALUE 'ZMT01G8V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01G8V-001.
               CALL 'ZMT01G8V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01G8V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-POSTCODE-0001.
