      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00Z9H'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01M99              PIC X(8) VALUE 'ZMT01M99'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01M99-002.
               CALL 'ZMT01M99' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01M99 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
