      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00R9F'.
      ...
      * Called module names
       01  MOD-ZMT01SN9              PIC X(8) VALUE 'ZMT01SN9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01SN9-001.
               CALL 'ZMT01SN9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01SN9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
