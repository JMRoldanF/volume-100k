      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00V4V'.
      ...
      * Called module names
       01  MOD-ZMT01LW7              PIC X(8) VALUE 'ZMT01LW7'.
       01  MOD-ZBI01KOQ              PIC X(8) VALUE 'ZBI01KOQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01LW7-001.
               PERFORM CALL-ZBI01KOQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01LW7-001.
               CALL 'ZMT01LW7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01LW7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01KOQ-002.
               CALL 'ZBI01KOQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01KOQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
