      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01JKB'.
      ...
      * Called module names
       01  MOD-ZMT01HUD              PIC X(8) VALUE 'ZMT01HUD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01HUD-001.
               CALL 'ZMT01HUD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01HUD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
