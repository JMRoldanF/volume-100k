      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00UQR'.
      ...
      * Called module names
       01  MOD-ZMT01RCG              PIC X(8) VALUE 'ZMT01RCG'.
       01  MOD-ZMT01TH4              PIC X(8) VALUE 'ZMT01TH4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01RCG-001.
               PERFORM CALL-ZMT01TH4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01RCG-001.
               CALL 'ZMT01RCG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01RCG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01TH4-002.
               CALL 'ZMT01TH4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01TH4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
