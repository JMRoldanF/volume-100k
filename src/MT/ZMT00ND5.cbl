      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00ND5'.
      ...
      * Called module names
       01  MOD-ZRE01UX3              PIC X(8) VALUE 'ZRE01UX3'.
       01  MOD-ZPA01K1H              PIC X(8) VALUE 'ZPA01K1H'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01UX3-001.
               PERFORM CALL-ZPA01K1H-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01UX3-001.
               CALL 'ZRE01UX3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01UX3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01K1H-002.
               CALL 'ZPA01K1H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01K1H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
