      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00S2V'.
      ...
      * Called module names
       01  MOD-ZMT01KPZ              PIC X(8) VALUE 'ZMT01KPZ'.
       01  MOD-ZMT01UFZ              PIC X(8) VALUE 'ZMT01UFZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01KPZ-001.
               PERFORM CALL-ZMT01UFZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01KPZ-001.
               CALL 'ZMT01KPZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01UFZ-002.
               CALL 'ZMT01UFZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01UFZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
