      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00OS9'.
      ...
      * Called module names
       01  MOD-ZMT01QZT              PIC X(8) VALUE 'ZMT01QZT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01QZT-001.
               CALL 'ZMT01QZT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01QZT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
