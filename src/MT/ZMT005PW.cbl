      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT005PW'.
      ...
      * Called module names
       01  MOD-ZMT00D4D              PIC X(8) VALUE 'ZMT00D4D'.
       01  MOD-ZMT00KRV              PIC X(8) VALUE 'ZMT00KRV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT00D4D-001.
               PERFORM CALL-ZMT00KRV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00D4D-001.
               EXEC CICS LINK PROGRAM('ZMT00D4D')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00D4D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT00KRV-002.
               EXEC CICS LINK PROGRAM('ZMT00KRV')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00KRV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
