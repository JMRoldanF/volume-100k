      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00MUY'.
      ...
      * Called module names
       01  MOD-ZMT01QYH              PIC X(8) VALUE 'ZMT01QYH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01QYH-001.
               CALL 'ZMT01QYH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01QYH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
