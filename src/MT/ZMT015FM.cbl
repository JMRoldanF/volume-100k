      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT015FM'.
      ...
      * Called module names
       01  MOD-ZMT01RJW              PIC X(8) VALUE 'ZMT01RJW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01RJW-001.
               CALL 'ZMT01RJW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01RJW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
