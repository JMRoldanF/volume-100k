      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00NM1'.
      ...
      * Called module names
       01  MOD-ZMT01S9N              PIC X(8) VALUE 'ZMT01S9N'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01S9N-001.
               CALL 'ZMT01S9N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01S9N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
