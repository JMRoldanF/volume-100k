      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00UZ1'.
      ...
      * Called module names
       01  MOD-ZMT01P0F              PIC X(8) VALUE 'ZMT01P0F'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01P0F-001.
               CALL 'ZMT01P0F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01P0F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01JHJ-002.
