      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00R05'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01V1S              PIC X(8) VALUE 'ZMT01V1S'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01V1S-002.
               CALL 'ZMT01V1S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
