      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01AH1'.
      ...
      * Called module names
       01  MOD-ZMT01UN4              PIC X(8) VALUE 'ZMT01UN4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01UN4-001.
               PERFORM CALL-ZMT01MFU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01UN4-001.
               CALL 'ZMT01UN4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01UN4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01MFU-002.
