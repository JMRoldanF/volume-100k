      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00V8X'.
      ...
      * Called module names
       01  MOD-ZMT01K2U              PIC X(8) VALUE 'ZMT01K2U'.
       01  MOD-ZMT01OJQ              PIC X(8) VALUE 'ZMT01OJQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01K2U-001.
               PERFORM CALL-ZMT01OJQ-002.
               ...
               PERFORM REFRESH-SUM-ASSURED-0007.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01K2U-001.
               CALL 'ZMT01K2U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01K2U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01OJQ-002.
               CALL 'ZMT01OJQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01OJQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
