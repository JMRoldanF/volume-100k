      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00QWX'.
      ...
      * Called module names
       01  MOD-ZMT01JDD              PIC X(8) VALUE 'ZMT01JDD'.
       01  MOD-ZUW01H4S              PIC X(8) VALUE 'ZUW01H4S'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01JDD-001.
               PERFORM CALL-ZUW01H4S-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01JDD-001.
               CALL 'ZMT01JDD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01JDD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01H4S-002.
               CALL 'ZUW01H4S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01H4S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
