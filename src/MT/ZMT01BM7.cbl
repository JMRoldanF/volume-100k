      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01BM7'.
      ...
      * Called module names
       01  MOD-ZMT01KZF              PIC X(8) VALUE 'ZMT01KZF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01KZF-001.
               PERFORM CALL-ZMT01TD3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01KZF-001.
               CALL 'ZMT01KZF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01KZF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01TD3-002.
               MOVE 'ZMT01TD3' TO WS-SUBNAME-8
