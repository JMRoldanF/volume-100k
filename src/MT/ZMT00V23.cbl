      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00V23'.
      ...
      * Called module names
       01  MOD-ZMT01OVF              PIC X(8) VALUE 'ZMT01OVF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01OVF-001.
               CALL 'ZMT01OVF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01OVF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
