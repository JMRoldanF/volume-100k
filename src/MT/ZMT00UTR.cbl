      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00UTR'.
      ...
      * Called module names
       01  MOD-ZMT01JFL              PIC X(8) VALUE 'ZMT01JFL'.
       01  MOD-ZCU01MRE              PIC X(8) VALUE 'ZCU01MRE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01JFL-001.
               PERFORM CALL-ZCU01MRE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01JFL-001.
               CALL 'ZMT01JFL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01JFL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01MRE-002.
               CALL 'ZCU01MRE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01MRE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
