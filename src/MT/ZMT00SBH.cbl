      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00SBH'.
      ...
      * Called module names
       01  MOD-ZMT01JD3              PIC X(8) VALUE 'ZMT01JD3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01JD3-001.
               PERFORM CALL-ZMT01GL3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01JD3-001.
               CALL 'ZMT01JD3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01JD3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01GL3-002.
