      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT013ZR'.
      ...
      * Called module names
       01  MOD-ZMT01MX5              PIC X(8) VALUE 'ZMT01MX5'.
       01  MOD-ZMT01TWT              PIC X(8) VALUE 'ZMT01TWT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01MX5-001.
               PERFORM CALL-ZMT01TWT-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01MX5-001.
               CALL 'ZMT01MX5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01MX5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01TWT-002.
               CALL 'ZMT01TWT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
