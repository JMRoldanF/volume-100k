      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00S52'.
      ...
      * Called module names
       01  MOD-ZMT01OIJ              PIC X(8) VALUE 'ZMT01OIJ'.
       01  MOD-ZEX01OTP              PIC X(8) VALUE 'ZEX01OTP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01OIJ-001.
               PERFORM CALL-ZEX01OTP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01OIJ-001.
               CALL 'ZMT01OIJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01OIJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEX01OTP-002.
               CALL 'ZEX01OTP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEX01OTP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
