      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00RVN'.
      ...
      * Called module names
       01  MOD-ZMT01CNZ              PIC X(8) VALUE 'ZMT01CNZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01CNZ-001.
               CALL 'ZMT01CNZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01CNZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
