      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00WP9'.
      ...
      * Called module names
       01  MOD-ZMT01LLN              PIC X(8) VALUE 'ZMT01LLN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01LLN-001.
               CALL 'ZMT01LLN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01LLN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
