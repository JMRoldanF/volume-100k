      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT005ZL'.
      ...
      * Called module names
       01  MOD-ZMT00CG3              PIC X(8) VALUE 'ZMT00CG3'.
       01  MOD-ZMT00H4Z              PIC X(8) VALUE 'ZMT00H4Z'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT00CG3-001.
               PERFORM CALL-ZMT00H4Z-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00CG3-001.
               EXEC CICS LINK PROGRAM('ZMT00CG3')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00CG3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT00H4Z-002.
               EXEC CICS LINK PROGRAM('ZMT00H4Z')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00H4Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
