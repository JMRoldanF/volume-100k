      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT010E1'.
      ...
      * Called module names
       01  MOD-ZMT01SRZ              PIC X(8) VALUE 'ZMT01SRZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01SRZ-001.
               CALL 'ZMT01SRZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01SRZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
