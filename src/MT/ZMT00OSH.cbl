      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00OSH'.
      ...
      * Called module names
       01  MOD-ZMT01ENQ              PIC X(8) VALUE 'ZMT01ENQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01ENQ-001.
               CALL 'ZMT01ENQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01ENQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
