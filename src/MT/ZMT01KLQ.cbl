      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01KLQ'.
      ...
      * Called module names
       01  MOD-ZMT01LP1              PIC X(8) VALUE 'ZMT01LP1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01LP1-001.
               CALL 'ZMT01LP1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01LP1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
