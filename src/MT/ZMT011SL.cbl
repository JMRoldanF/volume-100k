      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT011SL'.
      ...
      * Called module names
       01  MOD-ZMT01HET              PIC X(8) VALUE 'ZMT01HET'.
       01  MOD-ZMT01IY3              PIC X(8) VALUE 'ZMT01IY3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01HET-001.
               PERFORM CALL-ZMT01IY3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01HET-001.
               CALL 'ZMT01HET' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01HET FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01IY3-002.
               CALL 'ZMT01IY3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01IY3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
