      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00T8A'.
      ...
      * Called module names
       01  MOD-ZMT01GO9              PIC X(8) VALUE 'ZMT01GO9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01GO9-001.
               CALL 'ZMT01GO9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01GO9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
