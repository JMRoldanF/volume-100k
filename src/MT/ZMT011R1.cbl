      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT011R1'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01JTF              PIC X(8) VALUE 'ZMT01JTF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01JTF-002.
               CALL 'ZMT01JTF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
