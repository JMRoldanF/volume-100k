      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01SP4'.
      ...
      * Called module names
       01  MOD-ZMT01PGK              PIC X(8) VALUE 'ZMT01PGK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01PGK-001.
               CALL 'ZMT01PGK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01PGK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
