      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00PN7'.
      ...
      * Called module names
       01  MOD-ZMT01I8D              PIC X(8) VALUE 'ZMT01I8D'.
       01  MOD-ZMT01UCA              PIC X(8) VALUE 'ZMT01UCA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01I8D-001.
               PERFORM CALL-ZMT01UCA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01I8D-001.
               CALL 'ZMT01I8D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01I8D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01UCA-002.
               CALL 'ZMT01UCA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01UCA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
