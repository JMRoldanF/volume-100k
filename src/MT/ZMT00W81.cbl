      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00W81'.
      ...
      * Called module names
       01  MOD-ZMT01KUZ              PIC X(8) VALUE 'ZMT01KUZ'.
       01  MOD-ZMT01OG5              PIC X(8) VALUE 'ZMT01OG5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01KUZ-001.
               CALL 'ZMT01KUZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01KUZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01OG5-002.
               CALL 'ZMT01OG5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01OG5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
