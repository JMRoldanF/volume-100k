      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00N5X'.
      ...
      * Called module names
       01  MOD-ZMT01HR1              PIC X(8) VALUE 'ZMT01HR1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01HR1-001.
               PERFORM CALL-ZMT01UIR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01HR1-001.
               CALL 'ZMT01HR1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
