      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00UNN'.
      ...
      * Called module names
       01  MOD-ZRE01H8L              PIC X(8) VALUE 'ZRE01H8L'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01H8L-001.
               CALL 'ZRE01H8L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01H8L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
