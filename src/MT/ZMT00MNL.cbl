      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00MNL'.
      ...
      * Called module names
       01  MOD-ZMT01RFN              PIC X(8) VALUE 'ZMT01RFN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01RFN-001.
               PERFORM CALL-ZMT01UVJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01RFN-001.
               CALL 'ZMT01RFN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01RFN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01UVJ-002.
