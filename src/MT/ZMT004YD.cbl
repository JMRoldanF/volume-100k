      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT004YD'.
      ...
      * Called module names
       01  MOD-ZMT00KAV              PIC X(8) VALUE 'ZMT00KAV'.
       01  MOD-ZMT00JRF              PIC X(8) VALUE 'ZMT00JRF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00KAV-001.
               EXEC CICS LINK PROGRAM('ZMT00KAV')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00KAV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT00JRF-002.
               EXEC CICS LINK PROGRAM('ZMT00JRF')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00JRF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
