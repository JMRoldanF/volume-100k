      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00NUM'.
      ...
      * Called module names
       01  MOD-ZMT01EYR              PIC X(8) VALUE 'ZMT01EYR'.
       01  MOD-ZMT01JS1              PIC X(8) VALUE 'ZMT01JS1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01EYR-001.
               PERFORM CALL-ZMT01JS1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01EYR-001.
               CALL 'ZMT01EYR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01EYR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01JS1-002.
               CALL 'ZMT01JS1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01JS1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
