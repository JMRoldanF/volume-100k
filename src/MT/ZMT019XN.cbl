      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT019XN'.
      ...
      * Called module names
       01  MOD-ZMT01HIP              PIC X(8) VALUE 'ZMT01HIP'.
       01  MOD-ZPA01P8F              PIC X(8) VALUE 'ZPA01P8F'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01HIP-001.
               CALL 'ZMT01HIP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01P8F-002.
               CALL 'ZPA01P8F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01P8F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
