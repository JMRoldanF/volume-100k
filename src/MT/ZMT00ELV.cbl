      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00ELV'.
      ...
      * Called module names
       01  MOD-ZMT00NZ3              PIC X(8) VALUE 'ZMT00NZ3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT00S99-001.
               PERFORM CALL-ZMT00NZ3-002.
               PERFORM CALL-ZMT01IP7-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00S99-001.
               MOVE 'ZMT00S99' TO WS-PROGNAME-1
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00NZ3-002.
               EXEC CICS LINK PROGRAM('ZMT00NZ3')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00NZ3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01IP7-003.
