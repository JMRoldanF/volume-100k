      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00WEF'.
      ...
      * Called module names
       01  MOD-ZMT01RRV              PIC X(8) VALUE 'ZMT01RRV'.
       01  MOD-ZMT01OLP              PIC X(8) VALUE 'ZMT01OLP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01RRV-001.
               PERFORM CALL-ZMT01OLP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01RRV-001.
               CALL 'ZMT01RRV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01RRV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01OLP-002.
               CALL 'ZMT01OLP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01OLP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
