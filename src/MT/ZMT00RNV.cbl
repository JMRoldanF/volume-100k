      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00RNV'.
      ...
      * Called module names
       01  MOD-ZMT01UTB              PIC X(8) VALUE 'ZMT01UTB'.
       01  MOD-ZMT01TNX              PIC X(8) VALUE 'ZMT01TNX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01UTB-001.
               PERFORM CALL-ZMT01TNX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01UTB-001.
               CALL 'ZMT01UTB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01UTB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01TNX-002.
               CALL 'ZMT01TNX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01TNX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
