      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00ZTR'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01QC7              PIC X(8) VALUE 'ZMT01QC7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01F8R-001.
               PERFORM CALL-ZMT01QC7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01QC7-002.
               CALL 'ZMT01QC7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01QC7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
