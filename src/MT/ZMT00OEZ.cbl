      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00OEZ'.
      ...
      * Called module names
       01  MOD-ZMT01QBR              PIC X(8) VALUE 'ZMT01QBR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01QBR-001.
               CALL 'ZMT01QBR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01QBR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEX01TRD-002.
