      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT015TB'.
      ...
      * Called module names
       01  MOD-ZMT01IYX              PIC X(8) VALUE 'ZMT01IYX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01IYX-001.
               CALL 'ZMT01IYX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01IYX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
