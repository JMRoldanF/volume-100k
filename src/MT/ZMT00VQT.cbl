      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00VQT'.
      ...
      * Called module names
       01  MOD-ZPA01H3N              PIC X(8) VALUE 'ZPA01H3N'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01JP1-001.
               PERFORM CALL-ZPA01H3N-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZMT01JP1-001.
               MOVE 'ZMT01JP1' TO WS-SUBNAME-1
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01H3N-002.
               CALL 'ZPA01H3N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01H3N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       WRITE-ERROR-MESSAGE.
