      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00QB9'.
      ...
      * Called module names
       01  MOD-ZMT01HCL              PIC X(8) VALUE 'ZMT01HCL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01HCL-001.
               CALL 'ZMT01HCL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01HCL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
