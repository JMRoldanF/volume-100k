      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00X9G'.
      ...
      * Called module names
       01  MOD-ZCP01U0U              PIC X(8) VALUE 'ZCP01U0U'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01U0U-001.
               CALL 'ZCP01U0U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01U0U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-EQUITIES-0001.
