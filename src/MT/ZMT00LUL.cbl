      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00LUL'.
      ...
      * Called module names
       01  MOD-ZMT01FGU              PIC X(8) VALUE 'ZMT01FGU'.
       01  MOD-ZMT01H1D              PIC X(8) VALUE 'ZMT01H1D'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01FGU-001.
               PERFORM CALL-ZMT01H1D-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01FGU-001.
               CALL 'ZMT01FGU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01FGU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01H1D-002.
               CALL 'ZMT01H1D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
