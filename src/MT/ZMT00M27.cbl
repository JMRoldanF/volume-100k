      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00M27'.
      ...
      * Called module names
       01  MOD-ZMT01JTR              PIC X(8) VALUE 'ZMT01JTR'.
       01  MOD-ZMT01DZR              PIC X(8) VALUE 'ZMT01DZR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01JTR-001.
               CALL 'ZMT01JTR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01JTR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01DZR-002.
               CALL 'ZMT01DZR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01DZR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-COLOUR-0001.
