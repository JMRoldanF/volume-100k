      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT011A9'.
      ...
      * Called module names
       01  MOD-ZMT01K91              PIC X(8) VALUE 'ZMT01K91'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01K91-001.
               CALL 'ZMT01K91' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01K91 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
