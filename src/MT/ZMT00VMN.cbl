      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00VMN'.
      ...
      * Called module names
       01  MOD-ZMT01TE7              PIC X(8) VALUE 'ZMT01TE7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM DERIVE-VALUE-0121.
               PERFORM EXPAND-MANAGED-FUND-0122.
               PERFORM SQL-ACCESS-0123.
               PERFORM REFRESH-REG-NUMBER-0124.
               PERFORM NORMALISE-EXCESS-0125.
               PERFORM SQL-ACCESS-0126.
               PERFORM DERIVE-MAKE-0127.
               PERFORM VALIDATE-TAX-BAND-0128.
               PERFORM SQL-ACCESS-0129.
               PERFORM FORMAT-MANAGED-FUND-0130.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZMT01TE7-001.
               CALL 'ZMT01TE7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01TE7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
