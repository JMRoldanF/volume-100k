      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00V0R'.
      ...
      * Called module names
       01  MOD-ZCP01LLD              PIC X(8) VALUE 'ZCP01LLD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01LLD-001.
               CALL 'ZCP01LLD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01LLD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
