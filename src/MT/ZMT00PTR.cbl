      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00PTR'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01SQ9              PIC X(8) VALUE 'ZPA01SQ9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01SQ9-002.
               CALL 'ZPA01SQ9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01SQ9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
