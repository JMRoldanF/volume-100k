      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT011YB'.
      ...
      * Called module names
       01  MOD-ZMT01DHV              PIC X(8) VALUE 'ZMT01DHV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01DHV-001.
               PERFORM CALL-ZMT01HNX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01DHV-001.
               CALL 'ZMT01DHV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
