      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00RBX'.
      ...
      * Called module names
       01  MOD-ZMT01UV9              PIC X(8) VALUE 'ZMT01UV9'.
       01  MOD-ZMT01II9              PIC X(8) VALUE 'ZMT01II9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01UV9-001.
               PERFORM CALL-ZMT01II9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01UV9-001.
               CALL 'ZMT01UV9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01UV9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01II9-002.
               CALL 'ZMT01II9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01II9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-TERM-0001.
