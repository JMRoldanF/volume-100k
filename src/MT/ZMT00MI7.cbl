      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00MI7'.
      ...
      * Called module names
       01  MOD-ZEX01IAC              PIC X(8) VALUE 'ZEX01IAC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEX01IAC-001.
               CALL 'ZEX01IAC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEX01IAC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       VALIDATE-MODEL-0001.
