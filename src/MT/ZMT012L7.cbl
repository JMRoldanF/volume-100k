      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT012L7'.
      ...
      * Called module names
       01  MOD-ZRE01GEL              PIC X(8) VALUE 'ZRE01GEL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01GEL-001.
               PERFORM CALL-ZMT01QIL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01GEL-001.
               CALL 'ZRE01GEL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01QIL-002.
               MOVE 'ZMT01QIL' TO WS-SUBNAME-6
               CALL WS-SUBNAME-6 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01QIL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
