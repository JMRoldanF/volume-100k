      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT005WB'.
      ...
      * Called module names
       01  MOD-ZMT00CP2              PIC X(8) VALUE 'ZMT00CP2'.
       01  MOD-ZMT006ZS              PIC X(8) VALUE 'ZMT006ZS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT00CP2-001.
               PERFORM CALL-ZMT00E76-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00CP2-001.
               EXEC CICS LINK PROGRAM('ZMT00CP2')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00CP2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT006ZS-002.
               EXEC CICS LINK PROGRAM('ZMT006ZS')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT006ZS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT00E76-003.
