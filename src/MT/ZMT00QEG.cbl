      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00QEG'.
      ...
      * Called module names
       01  MOD-ZMT01N2A              PIC X(8) VALUE 'ZMT01N2A'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01N2A-001.
               CALL 'ZMT01N2A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01N2A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01OWW-002.
