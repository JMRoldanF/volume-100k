      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01MCC'.
      ...
      * Called module names
       01  MOD-ZMT01G8W              PIC X(8) VALUE 'ZMT01G8W'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01G8W-001.
               CALL 'ZMT01G8W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01G8W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
