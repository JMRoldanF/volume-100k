      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00O5H'.
      ...
      * Called module names
       01  MOD-ZMT01KPP              PIC X(8) VALUE 'ZMT01KPP'.
       01  MOD-ZMT01GIL              PIC X(8) VALUE 'ZMT01GIL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01KPP-001.
               PERFORM CALL-ZMT01GIL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01KPP-001.
               CALL 'ZMT01KPP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01KPP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01GIL-002.
               CALL 'ZMT01GIL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01GIL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
