      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00TMG'.
      ...
      * Called module names
       01  MOD-ZMT01P1N              PIC X(8) VALUE 'ZMT01P1N'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01IMV-001.
               PERFORM CALL-ZMT01P1N-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01P1N-002.
               CALL 'ZMT01P1N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01P1N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
