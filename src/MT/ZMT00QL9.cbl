      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00QL9'.
      ...
      * Called module names
       01  MOD-ZMT01ME9              PIC X(8) VALUE 'ZMT01ME9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01ME9-001.
               CALL 'ZMT01ME9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01ME9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
