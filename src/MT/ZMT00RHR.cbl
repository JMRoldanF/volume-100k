      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00RHR'.
      ...
      * Called module names
       01  MOD-ZMT01H67              PIC X(8) VALUE 'ZMT01H67'.
       01  MOD-ZMT01R6R              PIC X(8) VALUE 'ZMT01R6R'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01H67-001.
               PERFORM CALL-ZMT01R6R-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01H67-001.
               CALL 'ZMT01H67' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01H67 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01R6R-002.
               CALL 'ZMT01R6R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01R6R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
