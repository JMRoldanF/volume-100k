      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT0153H'.
      ...
      * Called module names
       01  MOD-ZCL01MED              PIC X(8) VALUE 'ZCL01MED'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01MED-001.
               CALL 'ZCL01MED' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01MED FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
