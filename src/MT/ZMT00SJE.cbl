      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00SJE'.
      ...
      * Called module names
       01  MOD-ZMT01PA0              PIC X(8) VALUE 'ZMT01PA0'.
       01  MOD-ZMT01JR8              PIC X(8) VALUE 'ZMT01JR8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01PA0-001.
               PERFORM CALL-ZMT01JR8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01PA0-001.
               CALL 'ZMT01PA0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01PA0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01JR8-002.
               CALL 'ZMT01JR8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
