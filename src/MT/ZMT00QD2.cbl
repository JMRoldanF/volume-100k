      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00QD2'.
      ...
      * Called module names
       01  MOD-ZMT01UB0              PIC X(8) VALUE 'ZMT01UB0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01UB0-001.
               CALL 'ZMT01UB0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01UB0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-MAKE-0001.
