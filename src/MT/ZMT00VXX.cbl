      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00VXX'.
      ...
      * Called module names
       01  MOD-ZMT01M51              PIC X(8) VALUE 'ZMT01M51'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01M51-001.
               CALL 'ZMT01M51' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01M51 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
