      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT010KP'.
      ...
      * Called module names
       01  MOD-ZBI01S2K              PIC X(8) VALUE 'ZBI01S2K'.
       01  MOD-ZMT01G5J              PIC X(8) VALUE 'ZMT01G5J'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01S2K-001.
               PERFORM CALL-ZMT01G5J-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01S2K-001.
               CALL 'ZBI01S2K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01S2K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01G5J-002.
               CALL 'ZMT01G5J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01G5J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
