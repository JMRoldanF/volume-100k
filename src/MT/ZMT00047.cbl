      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00047'.
      ...
      * Called module names
       01  MOD-ZMT00IAN              PIC X(8) VALUE 'ZMT00IAN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT00IAN-002.
               PERFORM CALL-ZMT00ASX-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00FCT-001.
               MOVE 'ZMT00FCT' TO WS-PROGNAME-6
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00IAN-002.
               EXEC CICS LINK PROGRAM('ZMT00IAN')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00IAN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT00ASX-003.
