      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00RX1'.
      ...
      * Called module names
       01  MOD-ZPA01J8L              PIC X(8) VALUE 'ZPA01J8L'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01J8L-001.
               CALL 'ZPA01J8L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01J8L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
