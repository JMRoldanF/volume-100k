      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00ZXA'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01OFR              PIC X(8) VALUE 'ZMT01OFR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01OFR-002.
               CALL 'ZMT01OFR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01OFR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-TERM-0001.
