      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00PID'.
      ...
      * Called module names
       01  MOD-ZMT01RQR              PIC X(8) VALUE 'ZMT01RQR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01RQR-001.
               CALL 'ZMT01RQR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01RQR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01HYT-002.
