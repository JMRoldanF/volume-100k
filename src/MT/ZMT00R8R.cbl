      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00R8R'.
      ...
      * Called module names
       01  MOD-ZMT01LUX              PIC X(8) VALUE 'ZMT01LUX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01LUX-001.
               CALL 'ZMT01LUX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01LUX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
