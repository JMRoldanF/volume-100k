      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00YD8'.
      ...
      * Called module names
       01  MOD-ZQU01IQF              PIC X(8) VALUE 'ZQU01IQF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZQU01IQF-001.
               PERFORM CALL-ZMT01KGI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZQU01IQF-001.
               CALL 'ZQU01IQF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU01IQF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01KGI-002.
