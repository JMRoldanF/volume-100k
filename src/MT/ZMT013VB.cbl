      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT013VB'.
      ...
      * Called module names
       01  MOD-ZMT01QTF              PIC X(8) VALUE 'ZMT01QTF'.
       01  MOD-ZAG01HLE              PIC X(8) VALUE 'ZAG01HLE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01QTF-001.
               PERFORM CALL-ZAG01HLE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01QTF-001.
               CALL 'ZMT01QTF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01QTF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01HLE-002.
               CALL 'ZAG01HLE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01HLE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
