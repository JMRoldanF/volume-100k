      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00RPT'.
      ...
      * Called module names
       01  MOD-ZAG01ISQ              PIC X(8) VALUE 'ZAG01ISQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01ISQ-001.
               CALL 'ZAG01ISQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01ISQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
