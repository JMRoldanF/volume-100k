      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00Z59'.
      ...
      * Called module names
       01  MOD-ZMT01T86              PIC X(8) VALUE 'ZMT01T86'.
       01  MOD-ZMT01N59              PIC X(8) VALUE 'ZMT01N59'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01T86-001.
               PERFORM CALL-ZMT01N59-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01T86-001.
               CALL 'ZMT01T86' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01T86 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01N59-002.
               CALL 'ZMT01N59' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01N59 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
