      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00RV5'.
      ...
      * Called module names
       01  MOD-ZMT01URV              PIC X(8) VALUE 'ZMT01URV'.
       01  MOD-ZMT01G49              PIC X(8) VALUE 'ZMT01G49'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01URV-001.
               PERFORM CALL-ZMT01G49-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01URV-001.
               CALL 'ZMT01URV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01URV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01G49-002.
               CALL 'ZMT01G49' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01G49 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
