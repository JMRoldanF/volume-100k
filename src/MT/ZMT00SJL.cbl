      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00SJL'.
      ...
      * Called module names
       01  MOD-ZMT01DGD              PIC X(8) VALUE 'ZMT01DGD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01DGD-001.
               CALL 'ZMT01DGD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01DGD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
