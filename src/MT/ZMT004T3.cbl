      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT004T3'.
      ...
      * Called module names
       01  MOD-ZMT00IGH              PIC X(8) VALUE 'ZMT00IGH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT00KT7-001.
               PERFORM CALL-ZMT00IGH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00KT7-001.
               MOVE 'ZMT00KT7' TO WS-PROGNAME-2
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00IGH-002.
               EXEC CICS LINK PROGRAM('ZMT00IGH')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00IGH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
