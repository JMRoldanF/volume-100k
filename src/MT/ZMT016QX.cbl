      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT016QX'.
      ...
      * Called module names
       01  MOD-ZMT01E3X              PIC X(8) VALUE 'ZMT01E3X'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01E3X-001.
               CALL 'ZMT01E3X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01E3X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01QGN-002.
