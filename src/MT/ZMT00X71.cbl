      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00X71'.
      ...
      * Called module names
       01  MOD-ZMT01HHL              PIC X(8) VALUE 'ZMT01HHL'.
       01  MOD-ZMT01FB9              PIC X(8) VALUE 'ZMT01FB9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01HHL-001.
               PERFORM CALL-ZMT01FB9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01HHL-001.
               CALL 'ZMT01HHL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01HHL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01FB9-002.
               CALL 'ZMT01FB9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01FB9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
