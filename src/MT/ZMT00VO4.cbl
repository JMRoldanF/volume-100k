      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00VO4'.
      ...
      * Called module names
       01  MOD-ZMT01OHY              PIC X(8) VALUE 'ZMT01OHY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01OHY-001.
               CALL 'ZMT01OHY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01OHY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-COLOUR-0001.
