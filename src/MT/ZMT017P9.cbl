      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT017P9'.
      ...
      * Called module names
       01  MOD-ZMT01REV              PIC X(8) VALUE 'ZMT01REV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01REV-001.
               PERFORM CALL-ZMT01USN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01REV-001.
               CALL 'ZMT01REV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01REV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01USN-002.
               MOVE 'ZMT01USN' TO WS-SUBNAME-2
