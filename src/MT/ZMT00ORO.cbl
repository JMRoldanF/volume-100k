      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00ORO'.
      ...
      * Called module names
       01  MOD-ZMT01M2U              PIC X(8) VALUE 'ZMT01M2U'.
       01  MOD-ZMT01MTS              PIC X(8) VALUE 'ZMT01MTS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01M2U-001.
               CALL 'ZMT01M2U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01M2U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01MTS-002.
               CALL 'ZMT01MTS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01MTS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
