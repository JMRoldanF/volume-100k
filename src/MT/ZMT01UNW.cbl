      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01UNW'.
      ...
      * Called module names
       01  MOD-ZMT01CYI              PIC X(8) VALUE 'ZMT01CYI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01CYI-001.
               CALL 'ZMT01CYI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01CYI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
