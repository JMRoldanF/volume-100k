      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00MVN'.
      ...
      * Called module names
       01  MOD-ZPA01DTB              PIC X(8) VALUE 'ZPA01DTB'.
       01  MOD-ZCU01KMG              PIC X(8) VALUE 'ZCU01KMG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01DTB-001.
               PERFORM CALL-ZCU01KMG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01DTB-001.
               CALL 'ZPA01DTB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01DTB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01KMG-002.
               CALL 'ZCU01KMG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01KMG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
