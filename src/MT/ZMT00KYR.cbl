      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00KYR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT00WBX-001.
               PERFORM CALL-ZAG017CS-002.
               PERFORM CALL-ZMT0144H-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00WBX-001.
               MOVE 'ZMT00WBX' TO WS-PROGNAME-2
      ...
      *----------------------------------------------------------------*
       CALL-ZAG017CS-002.
               MOVE 'ZAG017CS' TO WS-PROGNAME-3
