      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01V0U'.
      ...
      * Called module names
       01  MOD-ZMT01RMQ              PIC X(8) VALUE 'ZMT01RMQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01RMQ-001.
               CALL 'ZMT01RMQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
