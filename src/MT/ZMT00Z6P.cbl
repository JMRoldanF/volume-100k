      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00Z6P'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01TVF              PIC X(8) VALUE 'ZMT01TVF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01TVF-002.
               CALL 'ZMT01TVF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01TVF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
