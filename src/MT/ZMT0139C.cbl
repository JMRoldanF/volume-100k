      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT0139C'.
      ...
      * Called module names
       01  MOD-ZMT01DJC              PIC X(8) VALUE 'ZMT01DJC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01DJC-001.
               CALL 'ZMT01DJC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01DJC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
