      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00RGX'.
      ...
      * Called module names
       01  MOD-ZMT01DAH              PIC X(8) VALUE 'ZMT01DAH'.
       01  MOD-ZMT01RU3              PIC X(8) VALUE 'ZMT01RU3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01DAH-001.
               PERFORM CALL-ZMT01RU3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01DAH-001.
               CALL 'ZMT01DAH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01DAH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01RU3-002.
               CALL 'ZMT01RU3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01RU3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
