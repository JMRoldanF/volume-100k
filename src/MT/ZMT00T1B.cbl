      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00T1B'.
      ...
      * Called module names
       01  MOD-ZMT01QJF              PIC X(8) VALUE 'ZMT01QJF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01QJF-001.
               CALL 'ZMT01QJF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01QJF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
