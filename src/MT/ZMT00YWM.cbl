      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00YWM'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01QZV              PIC X(8) VALUE 'ZMT01QZV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01GNG-001.
               PERFORM CALL-ZMT01QZV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01QZV-002.
               CALL 'ZMT01QZV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01QZV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
