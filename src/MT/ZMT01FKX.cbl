      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01FKX'.
      ...
      * Called module names
       01  MOD-ZMT01R4G              PIC X(8) VALUE 'ZMT01R4G'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01R4G-001.
               CALL 'ZMT01R4G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01R4G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
