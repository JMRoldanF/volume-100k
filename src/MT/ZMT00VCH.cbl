      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00VCH'.
      ...
      * Called module names
       01  MOD-ZMT01GXY              PIC X(8) VALUE 'ZMT01GXY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01GXY-001.
               PERFORM CALL-ZMT01U7G-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01GXY-001.
               CALL 'ZMT01GXY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01GXY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01U7G-002.
               MOVE 'ZMT01U7G' TO WS-SUBNAME-7
