      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT0126W'.
      ...
      * Called module names
       01  MOD-ZMT01MKH              PIC X(8) VALUE 'ZMT01MKH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01MKH-001.
               PERFORM CALL-ZMT01JGY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01MKH-001.
               CALL 'ZMT01MKH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
