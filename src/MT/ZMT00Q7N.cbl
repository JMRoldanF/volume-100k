      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00Q7N'.
      ...
      * Called module names
       01  MOD-ZMT01J5L              PIC X(8) VALUE 'ZMT01J5L'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01J5L-001.
               CALL 'ZMT01J5L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01J5L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
