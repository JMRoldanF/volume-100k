      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00VHP'.
      ...
      * Called module names
       01  MOD-ZMT01LOG              PIC X(8) VALUE 'ZMT01LOG'.
       01  MOD-ZMT01H5A              PIC X(8) VALUE 'ZMT01H5A'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01LOG-001.
               PERFORM CALL-ZMT01H5A-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01LOG-001.
               CALL 'ZMT01LOG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01LOG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01H5A-002.
               CALL 'ZMT01H5A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01H5A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
