      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00ZH2'.
      ...
      * Called module names
       01  MOD-ZMT01U6O              PIC X(8) VALUE 'ZMT01U6O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01U6O-002.
               CALL 'ZMT01U6O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01U6O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
