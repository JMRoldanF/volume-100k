      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00OQV'.
      ...
      * Called module names
       01  MOD-ZHO01CQI              PIC X(8) VALUE 'ZHO01CQI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01CQI-001.
               CALL 'ZHO01CQI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01CQI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
