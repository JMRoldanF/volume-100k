      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT010W7'.
      ...
      * Called module names
       01  MOD-ZMT01HQ3              PIC X(8) VALUE 'ZMT01HQ3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM NORMALISE-REG-NUMBER-0034.
               PERFORM RESOLVE-TAX-BAND-0035.
               PERFORM SQL-ACCESS-0036.
               PERFORM RECONCILE-MAKE-0037.
               ...
               PERFORM VALIDATE-MAKE-0049.
               PERFORM CHECK-EQUITIES-0050.
               PERFORM SQL-ACCESS-0051.
               PERFORM RECONCILE-VALUE-0052.
               PERFORM REFRESH-VALUE-0053.
               PERFORM RECONCILE-TERM-0055.
               PERFORM AUDIT-MANAGED-FUND-0056.
               PERFORM SQL-ACCESS-0057.
               PERFORM COMPUTE-EXCESS-0058.
               PERFORM EXPAND-MAKE-0059.
               PERFORM SQL-ACCESS-0060.
               PERFORM EXPAND-TAX-BAND-0061.
               PERFORM REFRESH-TAX-BAND-0062.
               PERFORM VALIDATE-HOUSE-TYPE-0064.
               PERFORM EXPAND-STATUS-CODE-0065.
               ...
               PERFORM FORMAT-WITH-PROFITS-0071.
               PERFORM SQL-ACCESS-0072.
               PERFORM RECONCILE-MAKE-0073.
               PERFORM CHECK-TERM-0074.
               PERFORM SQL-ACCESS-0075.
               PERFORM VALIDATE-HOUSE-TYPE-0076.
               PERFORM CHECK-EXCESS-0077.
               PERFORM SQL-ACCESS-0078.
               PERFORM NORMALISE-BROKER-ID-0080.
               ...
               PERFORM RESOLVE-TERM-0092.
               PERFORM SQL-ACCESS-0093.
               PERFORM NORMALISE-HOUSE-TYPE-0094.
               PERFORM COMPUTE-MODEL-0095.
               PERFORM SQL-ACCESS-0096.
               PERFORM REFRESH-BROKER-ID-0097.
               PERFORM EXPAND-ROOF-TYPE-0098.
               ...
               PERFORM DERIVE-HOUSE-TYPE-0151.
               PERFORM APPLY-MODEL-0152.
               PERFORM SQL-ACCESS-0153.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZMT01HQ3-001.
               CALL 'ZMT01HQ3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01HQ3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
      ...
      *----------------------------------------------------------------*
       SQL-ACCESS-0033.
               ...
               END-EXEC.
      *----------------------------------------------------------------*
       NORMALISE-REG-NUMBER-0034.
               UNSTRING WS-KEY-CHAR DELIMITED BY '/'
                             INTO WS-KEY-CUSTOMER
                                  WS-KEY-POLICY
               END-UNSTRING.
      *----------------------------------------------------------------*
       RESOLVE-TAX-BAND-0035.
               IF WS-KEY-CUSTOMER = ZERO
