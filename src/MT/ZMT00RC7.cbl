      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00RC7'.
      ...
      * Called module names
       01  MOD-ZMT01Q5J              PIC X(8) VALUE 'ZMT01Q5J'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01Q5J-001.
               CALL 'ZMT01Q5J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01Q5J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
