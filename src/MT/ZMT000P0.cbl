      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT000P0'.
      ...
      * Called module names
       ...
       01  MOD-ZMT00IM7              PIC X(8) VALUE 'ZMT00IM7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT00D34-001.
               PERFORM CALL-ZMT00IM7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00IM7-002.
               EXEC CICS LINK PROGRAM('ZMT00IM7')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00IM7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPT001NI-003.
               EXEC CICS START TRANSID('Z1NI')
                         FROM(WS-KEY-AREA)
                         LENGTH(20)
                         RESP(WS-RESP)
               END-EXEC.
      * TRANSID Z1NI is defined against ZPT001NI
               IF WS-RESP NOT = DFHRESP(NORMAL)
