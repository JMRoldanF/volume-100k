      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT01BXM'.
      ...
      * Called module names
       01  MOD-ZMT01MB3              PIC X(8) VALUE 'ZMT01MB3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01MB3-001.
               CALL 'ZMT01MB3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01MB3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
