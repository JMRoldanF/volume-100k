      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00PNX'.
      ...
      * Called module names
       01  MOD-ZMT01ISJ              PIC X(8) VALUE 'ZMT01ISJ'.
       01  MOD-ZMT01OA1              PIC X(8) VALUE 'ZMT01OA1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01ISJ-001.
               CALL 'ZMT01ISJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01ISJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01OA1-002.
               CALL 'ZMT01OA1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
