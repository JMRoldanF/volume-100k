      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00M3L'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01JX3              PIC X(8) VALUE 'ZMT01JX3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01U4L-001.
               PERFORM CALL-ZMT01JX3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01JX3-002.
               CALL 'ZMT01JX3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01JX3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
