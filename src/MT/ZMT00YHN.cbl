      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00YHN'.
      ...
      * Called module names
       01  MOD-ZMT01QYY              PIC X(8) VALUE 'ZMT01QYY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01QYY-001.
               CALL 'ZMT01QYY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01QYY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-EXCESS-0001.
