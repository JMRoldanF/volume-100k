      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT003HO'.
      ...
      * Called module names
       01  MOD-ZMT008AR              PIC X(8) VALUE 'ZMT008AR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT00AJ9-002.
               PERFORM CALL-ZMT004T7-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT008AR-001.
               EXEC CICS LINK PROGRAM('ZMT008AR')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT008AR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT00AJ9-002.
               MOVE 'ZMT00AJ9' TO WS-PROGNAME-1
      ...
      *----------------------------------------------------------------*
       CALL-ZMT004T7-003.
               EXEC CICS START TRANSID('Z4T7')
                         FROM(WS-KEY-AREA)
                         LENGTH(20)
                         RESP(WS-RESP)
               END-EXEC.
      * TRANSID Z4T7 is defined against ZMT004T7
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT004T7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-MODEL-0001.
