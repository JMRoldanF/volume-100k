      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00SXF'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01DT3              PIC X(8) VALUE 'ZMT01DT3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01DT3-002.
               CALL 'ZMT01DT3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01DT3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
