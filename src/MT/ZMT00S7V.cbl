      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00S7V'.
      ...
      * Called module names
       01  MOD-ZMT01IXJ              PIC X(8) VALUE 'ZMT01IXJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01IXJ-001.
               CALL 'ZMT01IXJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01IXJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
