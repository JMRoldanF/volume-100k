      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT00Z97'.
      ...
      * Called module names
       01  MOD-ZMT01UH3              PIC X(8) VALUE 'ZMT01UH3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01UH3-001.
               CALL 'ZMT01UH3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01UH3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
