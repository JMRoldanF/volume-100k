      ...
      * Called module names
       01  MOD-ZMT01LSC              PIC X(8) VALUE 'ZMT01LSC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01LSC-001.
               PERFORM CALL-ZMT01UDD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01LSC-001.
               CALL 'ZMT01LSC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01LSC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01UDD-002.
