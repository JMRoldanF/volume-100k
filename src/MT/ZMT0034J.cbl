      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMT0034J'.
      ...
      * Called module names
       01  MOD-ZMT00JE3              PIC X(8) VALUE 'ZMT00JE3'.
       01  MOD-ZMT00A5L              PIC X(8) VALUE 'ZMT00A5L'.
       01  MOD-ZMT00JA7              PIC X(8) VALUE 'ZMT00JA7'.
       01  MOD-ZMT003YT              PIC X(8) VALUE 'ZMT003YT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT00JE3-001.
               PERFORM CALL-ZMT00A5L-002.
               PERFORM CALL-ZMT00JA7-003.
               PERFORM CALL-ZEN00BTN-004.
               PERFORM CALL-ZMT003YT-005.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00JE3-001.
               EXEC CICS LINK PROGRAM('ZMT00JE3')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00JE3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT00A5L-002.
               EXEC CICS LINK PROGRAM('ZMT00A5L')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00A5L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT00JA7-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT003YT-005.
               EXEC CICS XCTL PROGRAM('ZMT003YT')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT003YT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-006.
