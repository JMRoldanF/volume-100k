      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00TXI'.
      ...
      * Called module names
       01  MOD-ZUW01D24              PIC X(8) VALUE 'ZUW01D24'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01D24-001.
               CALL 'ZUW01D24' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01D24 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
