      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00OAY'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01R1C              PIC X(8) VALUE 'ZUW01R1C'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01R1C-002.
               CALL 'ZUW01R1C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01R1C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-TERM-0001.
