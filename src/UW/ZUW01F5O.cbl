      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW01F5O'.
      ...
      * Called module names
       01  MOD-ZRE01G8H              PIC X(8) VALUE 'ZRE01G8H'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01G8H-001.
               CALL 'ZRE01G8H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01G8H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
