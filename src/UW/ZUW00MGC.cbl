      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00MGC'.
      ...
      * Called module names
       01  MOD-ZUW01MWA              PIC X(8) VALUE 'ZUW01MWA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01MWA-001.
               CALL 'ZUW01MWA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01MWA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01H8O-002.
               MOVE 'ZUW01H8O' TO WS-SUBNAME-3
