      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW004R4'.
      ...
      * Called module names
       ...
       01  MOD-ZMT006TB              PIC X(8) VALUE 'ZMT006TB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT006TB-002.
               EXEC CICS LINK PROGRAM('ZMT006TB')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW00H7G-003.
               MOVE 'ZUW00H7G' TO WS-PROGNAME-8
