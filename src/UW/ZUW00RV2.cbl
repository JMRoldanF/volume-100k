      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00RV2'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01OIM              PIC X(8) VALUE 'ZUW01OIM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01OIM-002.
               CALL 'ZUW01OIM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01OIM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-COLOUR-0001.
