      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00TIH'.
      ...
      * Called module names
       01  MOD-ZUW01KB1              PIC X(8) VALUE 'ZUW01KB1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01KB1-001.
               CALL 'ZUW01KB1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01KB1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
