      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW012G1'.
      ...
      * Called module names
       01  MOD-ZPL01P41              PIC X(8) VALUE 'ZPL01P41'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPL01P41-001.
               CALL 'ZPL01P41' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPL01P41 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
