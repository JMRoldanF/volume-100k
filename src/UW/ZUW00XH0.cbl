      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00XH0'.
      ...
      * Called module names
       01  MOD-ZUW01S0G              PIC X(8) VALUE 'ZUW01S0G'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01S0G-001.
               CALL 'ZUW01S0G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01S0G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
