      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00ZZ0'.
      ...
      * Called module names
       01  MOD-ZUW01DWE              PIC X(8) VALUE 'ZUW01DWE'.
       01  MOD-ZUW01O6O              PIC X(8) VALUE 'ZUW01O6O'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01DWE-001.
               PERFORM CALL-ZUW01O6O-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01DWE-001.
               CALL 'ZUW01DWE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01DWE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01O6O-002.
               CALL 'ZUW01O6O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01O6O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
