      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00PPK'.
      ...
      * Called module names
       01  MOD-ZUW01N74              PIC X(8) VALUE 'ZUW01N74'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01N74-002.
               CALL 'ZUW01N74' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01N74 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-PREMIUM-0001.
