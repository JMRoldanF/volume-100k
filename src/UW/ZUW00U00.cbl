      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00U00'.
      ...
      * Called module names
       01  MOD-ZUW01F3Q              PIC X(8) VALUE 'ZUW01F3Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01F3Q-001.
               CALL 'ZUW01F3Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01F3Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
