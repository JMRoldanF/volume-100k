      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW01TIC'.
      ...
      * Called module names
       01  MOD-ZUW01I2Y              PIC X(8) VALUE 'ZUW01I2Y'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01I2Y-001.
               CALL 'ZUW01I2Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01I2Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
