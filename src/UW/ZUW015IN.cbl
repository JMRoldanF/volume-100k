      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW015IN'.
      ...
      * Called module names
       ...
       01  MOD-ZPL01D8O              PIC X(8) VALUE 'ZPL01D8O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPL01D8O-002.
               CALL 'ZPL01D8O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPL01D8O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       WRITE-ERROR-MESSAGE.
