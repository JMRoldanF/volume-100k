      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00RCQ'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01OOG              PIC X(8) VALUE 'ZUW01OOG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01OOG-002.
               CALL 'ZUW01OOG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01OOG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
