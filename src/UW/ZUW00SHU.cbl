      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00SHU'.
      ...
      * Called module names
       01  MOD-ZCL01HSJ              PIC X(8) VALUE 'ZCL01HSJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01HSJ-001.
               CALL 'ZCL01HSJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01HSJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
