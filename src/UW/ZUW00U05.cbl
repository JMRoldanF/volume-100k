      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00U05'.
      ...
      * Called module names
       01  MOD-ZUW01MGL              PIC X(8) VALUE 'ZUW01MGL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01MGL-002.
               CALL 'ZUW01MGL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01MGL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
