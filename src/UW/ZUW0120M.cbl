      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW0120M'.
      ...
      * Called module names
       01  MOD-ZUW01SGU              PIC X(8) VALUE 'ZUW01SGU'.
       01  MOD-ZUW01L44              PIC X(8) VALUE 'ZUW01L44'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01SGU-001.
               PERFORM CALL-ZUW01L44-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01SGU-001.
               CALL 'ZUW01SGU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01SGU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01L44-002.
               CALL 'ZUW01L44' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01L44 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
