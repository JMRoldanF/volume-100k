      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00PLY'.
      ...
      * Called module names
       01  MOD-ZUW01GH6              PIC X(8) VALUE 'ZUW01GH6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01GH6-001.
               CALL 'ZUW01GH6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01GH6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
