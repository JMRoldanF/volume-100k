      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00ZRI'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01S27              PIC X(8) VALUE 'ZEN01S27'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01S27-002.
               CALL 'ZEN01S27' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01S27 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
