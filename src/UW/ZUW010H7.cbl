      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW010H7'.
      ...
      * Called module names
       01  MOD-ZUW01T30              PIC X(8) VALUE 'ZUW01T30'.
       01  MOD-ZPL01UVD              PIC X(8) VALUE 'ZPL01UVD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01T30-001.
               CALL 'ZUW01T30' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZPL01UVD-002.
               CALL 'ZPL01UVD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPL01UVD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
