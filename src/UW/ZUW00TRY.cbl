      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00TRY'.
      ...
      * Called module names
       01  MOD-ZUW01D7Y              PIC X(8) VALUE 'ZUW01D7Y'.
       01  MOD-ZUW01DF6              PIC X(8) VALUE 'ZUW01DF6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01D7Y-001.
               PERFORM CALL-ZUW01DF6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01D7Y-001.
               CALL 'ZUW01D7Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01D7Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01DF6-002.
               CALL 'ZUW01DF6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01DF6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
