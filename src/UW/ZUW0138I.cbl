      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW0138I'.
      ...
      * Called module names
       01  MOD-ZUW01EKK              PIC X(8) VALUE 'ZUW01EKK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01EKK-001.
               CALL 'ZUW01EKK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01EKK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
