      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW0015O'.
      ...
      * Called module names
       01  MOD-ZCU00CUC              PIC X(8) VALUE 'ZCU00CUC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW00BJA-001.
               PERFORM CALL-ZCU00CUC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW00BJA-001.
               MOVE 'ZUW00BJA' TO WS-PROGNAME-3
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW00BJA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU00CUC-002.
               EXEC CICS LINK PROGRAM('ZCU00CUC')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00CUC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW000XC-003.
               EXEC CICS START TRANSID('Z0XC')
                         FROM(WS-KEY-AREA)
                         LENGTH(20)
                         RESP(WS-RESP)
               END-EXEC.
      * TRANSID Z0XC is defined against ZUW000XC
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW000XC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-BEDROOMS-0001.
