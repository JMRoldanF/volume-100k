      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW01AOU'.
      ...
      * Called module names
       01  MOD-ZUW01M2U              PIC X(8) VALUE 'ZUW01M2U'.
       01  MOD-ZUW01OPU              PIC X(8) VALUE 'ZUW01OPU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01M2U-001.
               PERFORM CALL-ZUW01OPU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01M2U-001.
               CALL 'ZUW01M2U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01OPU-002.
               CALL 'ZUW01OPU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01OPU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
