      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00TEM'.
      ...
      * Called module names
       01  MOD-ZUW01IT2              PIC X(8) VALUE 'ZUW01IT2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01IT2-001.
               CALL 'ZUW01IT2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01IT2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
