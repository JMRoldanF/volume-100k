      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00YRL'.
      ...
      * Called module names
       01  MOD-ZUW01NPV              PIC X(8) VALUE 'ZUW01NPV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01NPV-001.
               CALL 'ZUW01NPV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01NPV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
