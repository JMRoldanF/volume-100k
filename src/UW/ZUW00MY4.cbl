      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00MY4'.
      ...
      * Called module names
       01  MOD-ZSU01U3J              PIC X(8) VALUE 'ZSU01U3J'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSU01U3J-001.
               CALL 'ZSU01U3J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01U3J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
