      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00XIY'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01DME              PIC X(8) VALUE 'ZUW01DME'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01UC2-001.
               PERFORM CALL-ZUW01DME-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01DME-002.
               CALL 'ZUW01DME' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01DME FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
