      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00V2W'.
      ...
      * Called module names
       01  MOD-ZUW01SRY              PIC X(8) VALUE 'ZUW01SRY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01SRY-001.
               CALL 'ZUW01SRY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01SRY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
