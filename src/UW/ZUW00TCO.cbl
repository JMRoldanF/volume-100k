      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00TCO'.
      ...
      * Called module names
       01  MOD-ZUW01GX0              PIC X(8) VALUE 'ZUW01GX0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01GX0-001.
               CALL 'ZUW01GX0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01GX0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
