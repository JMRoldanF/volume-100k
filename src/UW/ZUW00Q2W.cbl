      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00Q2W'.
      ...
      * Called module names
       01  MOD-ZUW01M98              PIC X(8) VALUE 'ZUW01M98'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01M98-001.
               PERFORM CALL-ZUW01K0O-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01M98-001.
               CALL 'ZUW01M98' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01M98 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01K0O-002.
