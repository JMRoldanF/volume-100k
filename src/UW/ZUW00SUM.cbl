      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00SUM'.
      ...
      * Called module names
       01  MOD-ZUW01JA0              PIC X(8) VALUE 'ZUW01JA0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01JA0-001.
               CALL 'ZUW01JA0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01JA0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
