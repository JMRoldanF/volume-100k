      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW01LSU'.
      ...
      * Called module names
       01  MOD-ZHO01UII              PIC X(8) VALUE 'ZHO01UII'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01UII-001.
               CALL 'ZHO01UII' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01UII FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
