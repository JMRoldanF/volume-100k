      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00SN4'.
      ...
      * Called module names
       01  MOD-ZUW01PO0              PIC X(8) VALUE 'ZUW01PO0'.
       01  MOD-ZUW01HHA              PIC X(8) VALUE 'ZUW01HHA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01PO0-001.
               PERFORM CALL-ZUW01HHA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01PO0-001.
               CALL 'ZUW01PO0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01PO0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01HHA-002.
               CALL 'ZUW01HHA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01HHA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
