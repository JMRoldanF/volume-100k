      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00NPW'.
      ...
      * Called module names
       01  MOD-ZUW01OAA              PIC X(8) VALUE 'ZUW01OAA'.
       01  MOD-ZUW01KA4              PIC X(8) VALUE 'ZUW01KA4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01OAA-001.
               PERFORM CALL-ZUW01KA4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01OAA-001.
               CALL 'ZUW01OAA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01OAA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01KA4-002.
               CALL 'ZUW01KA4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01KA4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
