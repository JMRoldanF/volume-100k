      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00S98'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01R8O              PIC X(8) VALUE 'ZUW01R8O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01R8O-002.
               CALL 'ZUW01R8O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
