      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00T56'.
      ...
      * Called module names
       01  MOD-ZUW01IBK              PIC X(8) VALUE 'ZUW01IBK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01IBK-001.
               CALL 'ZUW01IBK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01IBK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-TERM-0001.
