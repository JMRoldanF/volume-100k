      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW011Q9'.
      ...
      * Called module names
       ...
       01  MOD-ZRT01ICS              PIC X(8) VALUE 'ZRT01ICS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01OHP-001.
               PERFORM CALL-ZRT01ICS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRT01ICS-002.
               CALL 'ZRT01ICS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRT01ICS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
