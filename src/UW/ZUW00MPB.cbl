      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00MPB'.
      ...
      * Called module names
       01  MOD-ZUW01GCD              PIC X(8) VALUE 'ZUW01GCD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01GCD-001.
               CALL 'ZUW01GCD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01GCD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
