      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00XXC'.
      ...
      * Called module names
       01  MOD-ZUW01IDP              PIC X(8) VALUE 'ZUW01IDP'.
       01  MOD-ZUW01P92              PIC X(8) VALUE 'ZUW01P92'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01IDP-001.
               PERFORM CALL-ZUW01P92-002.
               ...
               PERFORM FORMAT-MANAGED-FUND-0095.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01IDP-001.
               CALL 'ZUW01IDP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01IDP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01P92-002.
               CALL 'ZUW01P92' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01P92 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
