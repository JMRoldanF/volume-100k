      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW01130'.
      ...
      * Called module names
       01  MOD-ZUW01SLA              PIC X(8) VALUE 'ZUW01SLA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01SLA-002.
               CALL 'ZUW01SLA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01SLA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
