      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW012TI'.
      ...
      * Called module names
       01  MOD-ZUW01Q30              PIC X(8) VALUE 'ZUW01Q30'.
       01  MOD-ZUW01IVK              PIC X(8) VALUE 'ZUW01IVK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01Q30-001.
               CALL 'ZUW01Q30' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01IVK-002.
               CALL 'ZUW01IVK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
