      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00RR6'.
      ...
      * Called module names
       01  MOD-ZUW01OPK              PIC X(8) VALUE 'ZUW01OPK'.
       01  MOD-ZUW01PMW              PIC X(8) VALUE 'ZUW01PMW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01OPK-001.
               CALL 'ZUW01OPK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01OPK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01PMW-002.
               CALL 'ZUW01PMW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01PMW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
