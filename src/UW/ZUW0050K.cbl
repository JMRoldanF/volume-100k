      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW0050K'.
      ...
      * Called module names
       01  MOD-ZUW00GWW              PIC X(8) VALUE 'ZUW00GWW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU0086K-001.
               MOVE 'ZCU0086K' TO WS-PROGNAME-2
      ...
      *----------------------------------------------------------------*
       CALL-ZUW00GWW-002.
               EXEC CICS LINK PROGRAM('ZUW00GWW')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW00GWW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
