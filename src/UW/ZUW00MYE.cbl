      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00MYE'.
      ...
      * Called module names
       01  MOD-ZUW01EXM              PIC X(8) VALUE 'ZUW01EXM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01EXM-001.
               PERFORM CALL-ZUW01J3M-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01EXM-001.
               CALL 'ZUW01EXM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01EXM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01J3M-002.
