      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW0010R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW00GEC-001.
               MOVE 'ZUW00GEC' TO WS-PROGNAME-1
      ...
      *----------------------------------------------------------------*
       CALL-ZUW002ZT-003.
               EXEC CICS START TRANSID('Z2ZT')
                         ...
                         RESP(WS-RESP)
               END-EXEC.
      * TRANSID Z2ZT is defined against ZUW002ZT
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW002ZT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-004.
