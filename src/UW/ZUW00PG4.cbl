      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00PG4'.
      ...
      * Called module names
       01  MOD-ZCU01HTW              PIC X(8) VALUE 'ZCU01HTW'.
       01  MOD-ZUW01UFE              PIC X(8) VALUE 'ZUW01UFE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01HTW-001.
               PERFORM CALL-ZUW01UFE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01HTW-001.
               CALL 'ZCU01HTW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01HTW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01UFE-002.
               CALL 'ZUW01UFE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01UFE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
