      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW01A36'.
      ...
      * Called module names
       01  MOD-ZEN01I77              PIC X(8) VALUE 'ZEN01I77'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01I77-001.
               CALL 'ZEN01I77' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01I77 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-BEDROOMS-0001.
