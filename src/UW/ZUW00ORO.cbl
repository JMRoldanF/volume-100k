      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00ORO'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01HPW              PIC X(8) VALUE 'ZUW01HPW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01HPW-002.
               CALL 'ZUW01HPW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01HPW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
