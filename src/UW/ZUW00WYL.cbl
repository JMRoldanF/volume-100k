      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00WYL'.
      ...
      * Called module names
       01  MOD-ZUW01IC0              PIC X(8) VALUE 'ZUW01IC0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01IC0-001.
               PERFORM CALL-ZPL01FBI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01IC0-001.
               CALL 'ZUW01IC0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01IC0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPL01FBI-002.
