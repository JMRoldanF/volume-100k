      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00WHQ'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01IAQ              PIC X(8) VALUE 'ZUW01IAQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01IAQ-002.
               CALL 'ZUW01IAQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
