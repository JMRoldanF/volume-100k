      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW01S5Q'.
      ...
      * Called module names
       01  MOD-ZUW01IGK              PIC X(8) VALUE 'ZUW01IGK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01IGK-001.
               CALL 'ZUW01IGK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01IGK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
