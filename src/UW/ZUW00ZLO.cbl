      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00ZLO'.
      ...
      * Called module names
       01  MOD-ZUW01TAK              PIC X(8) VALUE 'ZUW01TAK'.
       01  MOD-ZUW01LMQ              PIC X(8) VALUE 'ZUW01LMQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01TAK-001.
               PERFORM CALL-ZUW01LMQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01TAK-001.
               CALL 'ZUW01TAK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01TAK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01LMQ-002.
               CALL 'ZUW01LMQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01LMQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
