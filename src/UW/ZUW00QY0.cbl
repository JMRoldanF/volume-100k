      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00QY0'.
      ...
      * Called module names
       01  MOD-ZUW01SKQ              PIC X(8) VALUE 'ZUW01SKQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01SKQ-001.
               CALL 'ZUW01SKQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01SKQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
