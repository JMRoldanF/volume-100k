      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00Y06'.
      ...
      * Called module names
       01  MOD-ZUW01DCO              PIC X(8) VALUE 'ZUW01DCO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01DCO-001.
               CALL 'ZUW01DCO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01DCO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
