      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00YME'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01L2Q              PIC X(8) VALUE 'ZUW01L2Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01L2Q-002.
               CALL 'ZUW01L2Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01L2Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
