      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00PJQ'.
      ...
      * Called module names
       01  MOD-ZUW01E82              PIC X(8) VALUE 'ZUW01E82'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01E82-001.
               CALL 'ZUW01E82' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01E82 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
