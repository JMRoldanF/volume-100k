      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00OJU'.
      ...
      * Called module names
       01  MOD-ZUW01Q2A              PIC X(8) VALUE 'ZUW01Q2A'.
       01  MOD-ZNT01DHP              PIC X(8) VALUE 'ZNT01DHP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01Q2A-001.
               PERFORM CALL-ZNT01DHP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01Q2A-001.
               CALL 'ZUW01Q2A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01Q2A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZNT01DHP-002.
               CALL 'ZNT01DHP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01DHP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
