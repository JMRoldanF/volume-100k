      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00SB6'.
      ...
      * Called module names
       01  MOD-ZUW01MBG              PIC X(8) VALUE 'ZUW01MBG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01MBG-001.
               PERFORM CALL-ZUW01ULS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01MBG-001.
               CALL 'ZUW01MBG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01MBG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01ULS-002.
