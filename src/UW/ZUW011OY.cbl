      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW011OY'.
      ...
      * Called module names
       01  MOD-ZUW01ROG              PIC X(8) VALUE 'ZUW01ROG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01ROG-001.
               CALL 'ZUW01ROG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01ROG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
