      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00XKC'.
      ...
      * Called module names
       01  MOD-ZUW01J8C              PIC X(8) VALUE 'ZUW01J8C'.
       01  MOD-ZUW01FV8              PIC X(8) VALUE 'ZUW01FV8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01J8C-001.
               PERFORM CALL-ZUW01FV8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01J8C-001.
               CALL 'ZUW01J8C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01J8C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01FV8-002.
               CALL 'ZUW01FV8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01FV8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
