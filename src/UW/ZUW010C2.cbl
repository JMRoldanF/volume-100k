      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW010C2'.
      ...
      * Called module names
       01  MOD-ZUW01UWM              PIC X(8) VALUE 'ZUW01UWM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01UWM-002.
               CALL 'ZUW01UWM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01UWM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
