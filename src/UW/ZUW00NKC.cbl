      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00NKC'.
      ...
      * Called module names
       01  MOD-ZUW01LDK              PIC X(8) VALUE 'ZUW01LDK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM RECONCILE-BROKER-ID-0061.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01LDK-001.
               CALL 'ZUW01LDK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01LDK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01LOO-002.
