      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00WVW'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01DEC              PIC X(8) VALUE 'ZUW01DEC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01DEC-002.
               CALL 'ZUW01DEC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01DEC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
