      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW0173Y'.
      ...
      * Called module names
       01  MOD-ZUW01L3A              PIC X(8) VALUE 'ZUW01L3A'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01L3A-001.
               CALL 'ZUW01L3A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01L3A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-COLOUR-0001.
