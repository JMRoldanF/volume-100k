      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00V9U'.
      ...
      * Called module names
       01  MOD-ZUW01OW8              PIC X(8) VALUE 'ZUW01OW8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01OW8-001.
               CALL 'ZUW01OW8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01OW8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       NORMALISE-MAKE-0001.
