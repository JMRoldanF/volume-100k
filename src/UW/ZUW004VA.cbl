      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW004VA'.
      ...
      * Called module names
       01  MOD-ZPA009KF              PIC X(8) VALUE 'ZPA009KF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA009KF-001.
               PERFORM CALL-ZUW006OA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA009KF-001.
               EXEC CICS LINK PROGRAM('ZPA009KF')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA009KF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW006OA-002.
               MOVE 'ZUW006OA' TO WS-PROGNAME-3
