      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00NUM'.
      ...
      * Called module names
       01  MOD-ZUW01DO2              PIC X(8) VALUE 'ZUW01DO2'.
       01  MOD-ZUW01LD0              PIC X(8) VALUE 'ZUW01LD0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01DO2-001.
               PERFORM CALL-ZUW01LD0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01DO2-001.
               CALL 'ZUW01DO2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01DO2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01LD0-002.
               CALL 'ZUW01LD0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01LD0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
