      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW01U7M'.
      ...
      * Called module names
       01  MOD-ZUW01JXM              PIC X(8) VALUE 'ZUW01JXM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01JXM-001.
               CALL 'ZUW01JXM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01JXM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
