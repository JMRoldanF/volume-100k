      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00TBU'.
      ...
      * Called module names
       01  MOD-ZUW01LIU              PIC X(8) VALUE 'ZUW01LIU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01LIU-001.
               CALL 'ZUW01LIU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01LIU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
