      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00M7Q'.
      ...
      * Called module names
       01  MOD-ZUW01JPA              PIC X(8) VALUE 'ZUW01JPA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01JPA-001.
               CALL 'ZUW01JPA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01JPA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
