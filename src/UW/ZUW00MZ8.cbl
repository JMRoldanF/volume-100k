      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00MZ8'.
      ...
      * Called module names
       01  MOD-ZUW01KB8              PIC X(8) VALUE 'ZUW01KB8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01KB8-001.
               CALL 'ZUW01KB8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01KB8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
