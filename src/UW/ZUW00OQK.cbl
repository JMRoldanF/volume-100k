      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00OQK'.
      ...
      * Called module names
       01  MOD-ZHO01KD8              PIC X(8) VALUE 'ZHO01KD8'.
       01  MOD-ZUW01T6O              PIC X(8) VALUE 'ZUW01T6O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01KD8-001.
               CALL 'ZHO01KD8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01KD8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01T6O-002.
               CALL 'ZUW01T6O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01T6O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
