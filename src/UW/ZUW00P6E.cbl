      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00P6E'.
      ...
      * Called module names
       01  MOD-ZUW01MNY              PIC X(8) VALUE 'ZUW01MNY'.
       01  MOD-ZUW01H02              PIC X(8) VALUE 'ZUW01H02'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01MNY-001.
               CALL 'ZUW01MNY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01MNY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01H02-002.
               CALL 'ZUW01H02' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
