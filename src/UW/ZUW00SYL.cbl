      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00SYL'.
      ...
      * Called module names
       01  MOD-ZUW01K3M              PIC X(8) VALUE 'ZUW01K3M'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01HU4-002.
               PERFORM CALL-ZAG0255S-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZUW01K3M-001.
               CALL 'ZUW01K3M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
