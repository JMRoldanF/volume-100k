      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00ZEG'.
      ...
      * Called module names
       01  MOD-ZUW01JIW              PIC X(8) VALUE 'ZUW01JIW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01JIW-001.
               CALL 'ZUW01JIW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01JIW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-EXCESS-0001.
