      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00VFY'.
      ...
      * Called module names
       01  MOD-ZAG01CSW              PIC X(8) VALUE 'ZAG01CSW'.
       01  MOD-ZUW01POA              PIC X(8) VALUE 'ZUW01POA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01CSW-001.
               PERFORM CALL-ZUW01POA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01CSW-001.
               CALL 'ZAG01CSW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01CSW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01POA-002.
               CALL 'ZUW01POA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01POA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
