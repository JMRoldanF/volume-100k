      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00GH2'.
      ...
      * Called module names
       01  MOD-ZUW00UQO              PIC X(8) VALUE 'ZUW00UQO'.
       01  MOD-ZUW010VI              PIC X(8) VALUE 'ZUW010VI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW00UQO-001.
               PERFORM CALL-ZUW010VI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW00UQO-001.
               EXEC CICS LINK PROGRAM('ZUW00UQO')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW00UQO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW010VI-002.
               EXEC CICS LINK PROGRAM('ZUW010VI')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW010VI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01BYE-003.
