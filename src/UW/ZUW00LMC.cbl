      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00LMC'.
      ...
      * Called module names
       01  MOD-ZUW01JWS              PIC X(8) VALUE 'ZUW01JWS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM COMPUTE-CC-RATING-0092.
               PERFORM SQL-ACCESS-0093.
               PERFORM VALIDATE-STATUS-CODE-0094.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZUW01JWS-001.
               CALL 'ZUW01JWS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01JWS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
