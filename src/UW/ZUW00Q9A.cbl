      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00Q9A'.
      ...
      * Called module names
       01  MOD-ZRE01UBF              PIC X(8) VALUE 'ZRE01UBF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01UBF-001.
               CALL 'ZRE01UBF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01UBF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
