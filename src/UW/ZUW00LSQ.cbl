      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00LSQ'.
      ...
      * Called module names
       01  MOD-ZUW01LIK              PIC X(8) VALUE 'ZUW01LIK'.
       01  MOD-ZUW01V1M              PIC X(8) VALUE 'ZUW01V1M'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01LIK-001.
               PERFORM CALL-ZUW01V1M-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01LIK-001.
               CALL 'ZUW01LIK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01LIK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01V1M-002.
               CALL 'ZUW01V1M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01V1M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-COLOUR-0001.
