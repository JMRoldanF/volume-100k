      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00WKI'.
      ...
      * Called module names
       01  MOD-ZUW01DE2              PIC X(8) VALUE 'ZUW01DE2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01DE2-001.
               CALL 'ZUW01DE2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01DE2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
