      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00XP7'.
      ...
      * Called module names
       01  MOD-ZUW01E7T              PIC X(8) VALUE 'ZUW01E7T'.
       01  MOD-ZUW01JX6              PIC X(8) VALUE 'ZUW01JX6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01E7T-001.
               PERFORM CALL-ZUW01JX6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01E7T-001.
               CALL 'ZUW01E7T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01E7T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01JX6-002.
               CALL 'ZUW01JX6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01JX6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
