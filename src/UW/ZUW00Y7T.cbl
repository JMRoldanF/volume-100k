      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00Y7T'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01DF7              PIC X(8) VALUE 'ZUW01DF7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01USY-001.
               PERFORM CALL-ZUW01DF7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01DF7-002.
               CALL 'ZUW01DF7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01DF7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
