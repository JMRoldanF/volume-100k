      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00XEI'.
      ...
      * Called module names
       01  MOD-ZBI01UBY              PIC X(8) VALUE 'ZBI01UBY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01UBY-001.
               CALL 'ZBI01UBY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01UBY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-EXCESS-0001.
