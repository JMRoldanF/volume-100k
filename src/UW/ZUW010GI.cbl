      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW010GI'.
      ...
      * Called module names
       01  MOD-ZUW01CWU              PIC X(8) VALUE 'ZUW01CWU'.
       01  MOD-ZUW01GJ4              PIC X(8) VALUE 'ZUW01GJ4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01CWU-001.
               PERFORM CALL-ZUW01GJ4-002.
               ...
               PERFORM AUDIT-SUM-ASSURED-0055.
               ...
               PERFORM APPLY-MODEL-0091.
               PERFORM FORMAT-TERM-0092.
               PERFORM SQL-ACCESS-0093.
               PERFORM AUDIT-REG-NUMBER-0094.
               ...
               PERFORM NORMALISE-VALUE-0118.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZUW01CWU-001.
               CALL 'ZUW01CWU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01CWU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01GJ4-002.
               CALL 'ZUW01GJ4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01GJ4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
