      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW010U4'.
      ...
      * Called module names
       01  MOD-ZHO01LW8              PIC X(8) VALUE 'ZHO01LW8'.
       01  MOD-ZMT01JHJ              PIC X(8) VALUE 'ZMT01JHJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01LW8-001.
               PERFORM CALL-ZMT01JHJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01LW8-001.
               CALL 'ZHO01LW8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01LW8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01JHJ-002.
               CALL 'ZMT01JHJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01JHJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
