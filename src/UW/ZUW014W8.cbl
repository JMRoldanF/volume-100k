      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW014W8'.
      ...
      * Called module names
       01  MOD-ZUW01OTQ              PIC X(8) VALUE 'ZUW01OTQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01OTQ-001.
               CALL 'ZUW01OTQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01OTQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
