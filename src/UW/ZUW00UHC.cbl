      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00UHC'.
      ...
      * Called module names
       01  MOD-ZRT01SAG              PIC X(8) VALUE 'ZRT01SAG'.
       01  MOD-ZUW01FHD              PIC X(8) VALUE 'ZUW01FHD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRT01SAG-001.
               PERFORM CALL-ZUW01FHD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRT01SAG-001.
               CALL 'ZRT01SAG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRT01SAG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01FHD-002.
               CALL 'ZUW01FHD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01FHD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
