      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW015WW'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01KEK              PIC X(8) VALUE 'ZUW01KEK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01KEK-002.
               CALL 'ZUW01KEK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01KEK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
