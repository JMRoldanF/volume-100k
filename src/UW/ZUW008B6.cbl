      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW008B6'.
      ...
      * Called module names
       01  MOD-ZUW0147I              PIC X(8) VALUE 'ZUW0147I'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW00R76-001.
               MOVE 'ZUW00R76' TO WS-PROGNAME-1
      ...
      *----------------------------------------------------------------*
       CALL-ZUW0147I-002.
               EXEC CICS LINK PROGRAM('ZUW0147I')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW0147I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
