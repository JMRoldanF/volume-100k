      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00XPM'.
      ...
      * Called module names
       01  MOD-ZUW01U7W              PIC X(8) VALUE 'ZUW01U7W'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01U7W-001.
               CALL 'ZUW01U7W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01U7W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
