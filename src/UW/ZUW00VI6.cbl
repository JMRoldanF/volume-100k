      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00VI6'.
      ...
      * Called module names
       01  MOD-ZUW01PT0              PIC X(8) VALUE 'ZUW01PT0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01PT0-001.
               CALL 'ZUW01PT0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01PT0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
