      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00M4Y'.
      ...
      * Called module names
       01  MOD-ZUW01QB2              PIC X(8) VALUE 'ZUW01QB2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01QB2-001.
               CALL 'ZUW01QB2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01QB2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-MAKE-0001.
