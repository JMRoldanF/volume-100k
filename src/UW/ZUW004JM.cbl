      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW004JM'.
      ...
      * Called module names
       ...
       01  MOD-ZCL007SP              PIC X(8) VALUE 'ZCL007SP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW00BB8-001.
               PERFORM CALL-ZCL007SP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL007SP-002.
               EXEC CICS LINK PROGRAM('ZCL007SP')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL007SP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
