      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00X6Q'.
      ...
      * Called module names
       01  MOD-ZUW01QTO              PIC X(8) VALUE 'ZUW01QTO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01QTO-001.
               PERFORM CALL-ZUW01QVW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01QTO-001.
               CALL 'ZUW01QTO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01QTO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01QVW-002.
