      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW020PK'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01CUU              PIC X(8) VALUE 'ZAG01CUU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01N9W-004.
               PERFORM CALL-ZUW01MQQ-005.
               PERFORM CALL-ZAG01CUU-006.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01CUU-006.
               CALL 'ZAG01CUU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01CUU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
