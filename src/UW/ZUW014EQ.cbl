      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW014EQ'.
      ...
      * Called module names
       01  MOD-ZUW01JUA              PIC X(8) VALUE 'ZUW01JUA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01JUA-001.
               CALL 'ZUW01JUA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01JUA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
