      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00W76'.
      ...
      * Called module names
       01  MOD-ZUW01I5G              PIC X(8) VALUE 'ZUW01I5G'.
       01  MOD-ZUW01FJK              PIC X(8) VALUE 'ZUW01FJK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01I5G-001.
               PERFORM CALL-ZUW01FJK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01I5G-001.
               CALL 'ZUW01I5G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01I5G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01FJK-002.
               CALL 'ZUW01FJK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01FJK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
