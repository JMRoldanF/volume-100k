      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW008ZW'.
      ...
      * Called module names
       01  MOD-ZUW00TXI              PIC X(8) VALUE 'ZUW00TXI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW00TXI-001.
               EXEC CICS LINK PROGRAM('ZUW00TXI')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW00TXI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-EQUITIES-0001.
