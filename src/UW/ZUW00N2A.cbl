      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00N2A'.
      ...
      * Called module names
       01  MOD-ZUW01GVC              PIC X(8) VALUE 'ZUW01GVC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01GVC-001.
               PERFORM CALL-ZUW01M34-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01GVC-001.
               CALL 'ZUW01GVC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01GVC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01M34-002.
