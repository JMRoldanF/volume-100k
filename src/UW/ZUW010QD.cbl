      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW010QD'.
      ...
      * Called module names
       01  MOD-ZUW01E22              PIC X(8) VALUE 'ZUW01E22'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM APPLY-SUM-ASSURED-0034.
               PERFORM NORMALISE-BROKER-ID-0035.
               ...
               PERFORM VALIDATE-BEDROOMS-0056.
               ...
               PERFORM REFRESH-SUM-ASSURED-0068.
               PERFORM SQL-ACCESS-0069.
               PERFORM EXPAND-PREMIUM-0070.
               PERFORM EXPAND-REG-NUMBER-0071.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01E22-001.
               CALL 'ZUW01E22' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01E22 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
