      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00Q18'.
      ...
      * Called module names
       01  MOD-ZUW01GO4              PIC X(8) VALUE 'ZUW01GO4'.
       01  MOD-ZHO01G28              PIC X(8) VALUE 'ZHO01G28'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01GO4-001.
               PERFORM CALL-ZHO01G28-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01GO4-001.
               CALL 'ZUW01GO4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01GO4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01G28-002.
               CALL 'ZHO01G28' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01G28 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
