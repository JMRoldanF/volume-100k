      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW004S8'.
      ...
      * Called module names
       01  MOD-ZUW00KQY              PIC X(8) VALUE 'ZUW00KQY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW00KQY-001.
               PERFORM CALL-ZUW007SK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW00KQY-001.
               EXEC CICS LINK PROGRAM('ZUW00KQY')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW00KQY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW007SK-002.
               MOVE 'ZUW007SK' TO WS-PROGNAME-3
