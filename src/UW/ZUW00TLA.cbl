      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00TLA'.
      ...
      * Called module names
       01  MOD-ZUW01O1O              PIC X(8) VALUE 'ZUW01O1O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01O1O-001.
               CALL 'ZUW01O1O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01O1O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-COLOUR-0001.
