      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00LYA'.
      ...
      * Called module names
       01  MOD-ZCU01CMY              PIC X(8) VALUE 'ZCU01CMY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01CMY-001.
               CALL 'ZCU01CMY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01CMY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
