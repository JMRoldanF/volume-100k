      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00QRM'.
      ...
      * Called module names
       01  MOD-ZUW01GA8              PIC X(8) VALUE 'ZUW01GA8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01GA8-001.
               CALL 'ZUW01GA8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01GA8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-VALUE-0001.
