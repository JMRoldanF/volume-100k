      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00P14'.
      ...
      * Called module names
       01  MOD-ZUW01QY4              PIC X(8) VALUE 'ZUW01QY4'.
       01  MOD-ZUW01LVC              PIC X(8) VALUE 'ZUW01LVC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01QY4-001.
               PERFORM CALL-ZUW01LVC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01QY4-001.
               CALL 'ZUW01QY4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01LVC-002.
               CALL 'ZUW01LVC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01LVC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
