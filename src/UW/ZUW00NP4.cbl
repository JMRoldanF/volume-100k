      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00NP4'.
      ...
      * Called module names
       01  MOD-ZUW01TQ4              PIC X(8) VALUE 'ZUW01TQ4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01TQ4-001.
               CALL 'ZUW01TQ4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01TQ4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
