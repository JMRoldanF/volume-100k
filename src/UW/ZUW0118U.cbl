      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW0118U'.
      ...
      * Called module names
       01  MOD-ZUW01ELE              PIC X(8) VALUE 'ZUW01ELE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01ELE-001.
               CALL 'ZUW01ELE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01ELE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
