      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00ZGE'.
      ...
      * Called module names
       01  MOD-ZUW01EWS              PIC X(8) VALUE 'ZUW01EWS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01EWS-001.
               CALL 'ZUW01EWS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01EWS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
