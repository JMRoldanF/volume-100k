      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00M94'.
      ...
      * Called module names
       01  MOD-ZUW01IQU              PIC X(8) VALUE 'ZUW01IQU'.
       01  MOD-ZUW01TCS              PIC X(8) VALUE 'ZUW01TCS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01IQU-001.
               PERFORM CALL-ZUW01TCS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01IQU-001.
               CALL 'ZUW01IQU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01IQU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01TCS-002.
               CALL 'ZUW01TCS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
