      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00O1U'.
      ...
      * Called module names
       01  MOD-ZEN01HHD              PIC X(8) VALUE 'ZEN01HHD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01HHD-001.
               CALL 'ZEN01HHD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01HHD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
