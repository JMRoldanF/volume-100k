      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW013TP'.
      ...
      * Called module names
       01  MOD-ZUW01OU0              PIC X(8) VALUE 'ZUW01OU0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01OU0-001.
               PERFORM CALL-ZUW01PUV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01OU0-001.
               CALL 'ZUW01OU0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01OU0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01PUV-002.
