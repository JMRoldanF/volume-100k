      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00YNS'.
      ...
      * Called module names
       01  MOD-ZUW01PR2              PIC X(8) VALUE 'ZUW01PR2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01PR2-001.
               PERFORM CALL-ZUW01MQ6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01PR2-001.
               CALL 'ZUW01PR2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01PR2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01MQ6-002.
               MOVE 'ZUW01MQ6' TO WS-SUBNAME-5
