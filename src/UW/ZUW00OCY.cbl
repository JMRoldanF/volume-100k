      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00OCY'.
      ...
      * Called module names
       01  MOD-ZUW01DMO              PIC X(8) VALUE 'ZUW01DMO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01DMO-001.
               CALL 'ZUW01DMO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01DMO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
