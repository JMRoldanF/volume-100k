      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW007JY'.
      ...
      * Called module names
       ...
       01  MOD-ZUW00ZFA              PIC X(8) VALUE 'ZUW00ZFA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW00YVA-001.
               PERFORM CALL-ZUW00ZFA-002.
               PERFORM CALL-ZUW00SFC-003.
               PERFORM CALL-ZUW01NS8-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW00ZFA-002.
               EXEC CICS LINK PROGRAM('ZUW00ZFA')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW00ZFA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW00SFC-003.
