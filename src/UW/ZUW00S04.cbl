      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00S04'.
      ...
      * Called module names
       01  MOD-ZUW01NUC              PIC X(8) VALUE 'ZUW01NUC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01NUC-001.
               CALL 'ZUW01NUC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01NUC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
