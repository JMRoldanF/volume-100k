      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW01B9E'.
      ...
      * Called module names
       01  MOD-ZHO01T0W              PIC X(8) VALUE 'ZHO01T0W'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01T0W-001.
               CALL 'ZHO01T0W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01T0W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01GDA-002.
               MOVE 'ZUW01GDA' TO WS-SUBNAME-3
