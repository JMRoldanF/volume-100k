      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00W3A'.
      ...
      * Called module names
       01  MOD-ZUW01S8S              PIC X(8) VALUE 'ZUW01S8S'.
       01  MOD-ZMT01MBR              PIC X(8) VALUE 'ZMT01MBR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01S8S-001.
               PERFORM CALL-ZMT01MBR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01S8S-001.
               CALL 'ZUW01S8S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01S8S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01MBR-002.
               CALL 'ZMT01MBR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01MBR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
