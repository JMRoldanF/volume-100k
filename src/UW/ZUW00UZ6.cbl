      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00UZ6'.
      ...
      * Called module names
       01  MOD-ZUW01L5B              PIC X(8) VALUE 'ZUW01L5B'.
       01  MOD-ZNT01D3K              PIC X(8) VALUE 'ZNT01D3K'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01L5B-001.
               PERFORM CALL-ZNT01D3K-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01L5B-001.
               CALL 'ZUW01L5B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01L5B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZNT01D3K-002.
               CALL 'ZNT01D3K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01D3K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
