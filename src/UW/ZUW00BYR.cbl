      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00BYR'.
      ...
      * Called module names
       01  MOD-ZUW00Q95              PIC X(8) VALUE 'ZUW00Q95'.
       01  MOD-ZUW01939              PIC X(8) VALUE 'ZUW01939'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW00Q95-001.
               EXEC CICS LINK PROGRAM('ZUW00Q95')
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01939-002.
               EXEC CICS LINK PROGRAM('ZUW01939')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
