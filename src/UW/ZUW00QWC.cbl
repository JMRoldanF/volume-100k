      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00QWC'.
      ...
      * Called module names
       01  MOD-ZCL01SFV              PIC X(8) VALUE 'ZCL01SFV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01SFV-001.
               CALL 'ZCL01SFV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01SFV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
