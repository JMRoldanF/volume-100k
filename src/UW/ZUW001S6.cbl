      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW001S6'.
      ...
      * Called module names
       ...
       01  MOD-ZUW00DDO              PIC X(8) VALUE 'ZUW00DDO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW008NY-001.
               PERFORM CALL-ZUW00JK6-002.
               PERFORM CALL-ZUW00DDO-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW008NY-001.
               MOVE 'ZUW008NY' TO WS-PROGNAME-3
      ...
      *----------------------------------------------------------------*
       CALL-ZUW00DDO-003.
               EXEC CICS LINK PROGRAM('ZUW00DDO')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW00DDO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-004.
