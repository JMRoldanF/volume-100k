      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00STO'.
      ...
      * Called module names
       01  MOD-ZUW01LW5              PIC X(8) VALUE 'ZUW01LW5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01LW5-001.
               CALL 'ZUW01LW5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01LW5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
