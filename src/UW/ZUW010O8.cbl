      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW010O8'.
      ...
      * Called module names
       01  MOD-ZUW01NHN              PIC X(8) VALUE 'ZUW01NHN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01NHN-001.
               CALL 'ZUW01NHN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01NHN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
