      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW011YY'.
      ...
      * Called module names
       01  MOD-ZUW01NC4              PIC X(8) VALUE 'ZUW01NC4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01NC4-002.
               CALL 'ZUW01NC4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01NC4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-COLOUR-0001.
