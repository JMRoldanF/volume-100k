      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00YB0'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01DTM              PIC X(8) VALUE 'ZUW01DTM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01DTM-002.
               CALL 'ZUW01DTM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01DTM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
