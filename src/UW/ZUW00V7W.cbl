      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00V7W'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01RAM              PIC X(8) VALUE 'ZUW01RAM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01RAM-002.
               CALL 'ZUW01RAM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01RAM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-EXCESS-0001.
