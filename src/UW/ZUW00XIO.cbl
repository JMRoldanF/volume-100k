      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00XIO'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01GEY              PIC X(8) VALUE 'ZUW01GEY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01GEY-002.
               CALL 'ZUW01GEY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01GEY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
