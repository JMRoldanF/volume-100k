      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00TLU'.
      ...
      * Called module names
       01  MOD-ZUW01D0G              PIC X(8) VALUE 'ZUW01D0G'.
       01  MOD-ZMT01R0D              PIC X(8) VALUE 'ZMT01R0D'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01D0G-001.
               PERFORM CALL-ZMT01R0D-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01D0G-001.
               CALL 'ZUW01D0G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01D0G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01R0D-002.
               CALL 'ZMT01R0D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01R0D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
