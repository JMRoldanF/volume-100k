      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00XR0'.
      ...
      * Called module names
       01  MOD-ZUW01S7E              PIC X(8) VALUE 'ZUW01S7E'.
       01  MOD-ZEN01QVP              PIC X(8) VALUE 'ZEN01QVP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01S7E-001.
               PERFORM CALL-ZEN01QVP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01S7E-001.
               CALL 'ZUW01S7E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01S7E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01QVP-002.
               CALL 'ZEN01QVP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01QVP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
