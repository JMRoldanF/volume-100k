      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00VR2'.
      ...
      * Called module names
       01  MOD-ZUW01QLW              PIC X(8) VALUE 'ZUW01QLW'.
       01  MOD-ZUW01JJQ              PIC X(8) VALUE 'ZUW01JJQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01QLW-001.
               CALL 'ZUW01QLW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01QLW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01JJQ-002.
               CALL 'ZUW01JJQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01JJQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
