      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00O2E'.
      ...
      * Called module names
       01  MOD-ZUW01LBM              PIC X(8) VALUE 'ZUW01LBM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01LBM-001.
               CALL 'ZUW01LBM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01LBM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01FRM-002.
