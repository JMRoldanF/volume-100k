      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00VBJ'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01S66              PIC X(8) VALUE 'ZUW01S66'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01LXH-001.
               PERFORM CALL-ZUW01S66-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01S66-002.
               CALL 'ZUW01S66' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01S66 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-MAKE-0001.
