      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW0007I'.
      ...
      * Called module names
       01  MOD-ZUW00HYY              PIC X(8) VALUE 'ZUW00HYY'.
       01  MOD-ZUW00IHU              PIC X(8) VALUE 'ZUW00IHU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW00HYY-001.
               EXEC CICS LINK PROGRAM('ZUW00HYY')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW00HYY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW00IHU-002.
               EXEC CICS LINK PROGRAM('ZUW00IHU')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW00IHU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
