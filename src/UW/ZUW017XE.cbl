      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW017XE'.
      ...
      * Called module names
       01  MOD-ZUW01TNC              PIC X(8) VALUE 'ZUW01TNC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01TNC-001.
               CALL 'ZUW01TNC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01TNC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
