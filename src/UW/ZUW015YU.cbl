      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW015YU'.
      ...
      * Called module names
       01  MOD-ZUW01KTA              PIC X(8) VALUE 'ZUW01KTA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01KTA-001.
               CALL 'ZUW01KTA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       FILE-ACCESS-0003.
               EXEC CICS DELETE FILE('KSDSUW74')
                         RIDFLD(WS-KEY-AREA)
                         RESP(WS-RESP)
               END-EXEC.
               EVALUATE WS-RESP
