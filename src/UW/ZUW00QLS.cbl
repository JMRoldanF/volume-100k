      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00QLS'.
      ...
      * Called module names
       01  MOD-ZUW01KH2              PIC X(8) VALUE 'ZUW01KH2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01KH2-001.
               PERFORM CALL-ZUW01FOA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01KH2-001.
               CALL 'ZUW01KH2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01KH2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01FOA-002.
