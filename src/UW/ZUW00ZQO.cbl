      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00ZQO'.
      ...
      * Called module names
       01  MOD-ZUW01NM4              PIC X(8) VALUE 'ZUW01NM4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01NM4-001.
               CALL 'ZUW01NM4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01NM4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-TERM-0001.
