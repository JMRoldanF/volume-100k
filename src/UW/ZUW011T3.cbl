      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW011T3'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01F2R              PIC X(8) VALUE 'ZUW01F2R'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01SX6-001.
               PERFORM CALL-ZUW01F2R-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01F2R-002.
               CALL 'ZUW01F2R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01F2R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
