      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00P0K'.
      ...
      * Called module names
       01  MOD-ZBI01SU2              PIC X(8) VALUE 'ZBI01SU2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01SU2-001.
               CALL 'ZBI01SU2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01SU2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
