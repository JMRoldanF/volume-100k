      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00MM2'.
      ...
      * Called module names
       01  MOD-ZUW01QAM              PIC X(8) VALUE 'ZUW01QAM'.
       01  MOD-ZUW01DN8              PIC X(8) VALUE 'ZUW01DN8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01QAM-001.
               PERFORM CALL-ZUW01DN8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01QAM-001.
               CALL 'ZUW01QAM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01QAM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01DN8-002.
               CALL 'ZUW01DN8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01DN8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
