      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW010MC'.
      ...
      * Called module names
       01  MOD-ZAG01S4A              PIC X(8) VALUE 'ZAG01S4A'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01S4A-001.
               PERFORM CALL-ZUW01V3K-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01S4A-001.
               CALL 'ZAG01S4A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01S4A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01V3K-002.
