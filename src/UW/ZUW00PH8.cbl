      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00PH8'.
      ...
      * Called module names
       01  MOD-ZUW01E32              PIC X(8) VALUE 'ZUW01E32'.
       01  MOD-ZUW01O00              PIC X(8) VALUE 'ZUW01O00'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01E32-001.
               PERFORM CALL-ZUW01O00-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01E32-001.
               CALL 'ZUW01E32' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01E32 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01O00-002.
               CALL 'ZUW01O00' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01O00 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
