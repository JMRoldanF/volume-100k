      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00MQC'.
      ...
      * Called module names
       01  MOD-ZUW01DT2              PIC X(8) VALUE 'ZUW01DT2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01DT2-001.
               PERFORM CALL-ZUW01CYS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01DT2-001.
               CALL 'ZUW01DT2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01DT2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01CYS-002.
