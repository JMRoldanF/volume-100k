      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW01JHS'.
      ...
      * Called module names
       01  MOD-ZEN01MD7              PIC X(8) VALUE 'ZEN01MD7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01MD7-001.
               CALL 'ZEN01MD7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01MD7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
