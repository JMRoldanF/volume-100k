      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00RPI'.
      ...
      * Called module names
       01  MOD-ZUW01DWO              PIC X(8) VALUE 'ZUW01DWO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01DWO-002.
               CALL 'ZUW01DWO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01DWO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
