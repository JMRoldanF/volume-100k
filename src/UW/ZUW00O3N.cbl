      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00O3N'.
      ...
      * Called module names
       01  MOD-ZUW01GOF              PIC X(8) VALUE 'ZUW01GOF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01GOF-001.
               CALL 'ZUW01GOF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01GOF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
