      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00VWC'.
      ...
      * Called module names
       01  MOD-ZUW01JTQ              PIC X(8) VALUE 'ZUW01JTQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01JTQ-001.
               CALL 'ZUW01JTQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01JTQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01MFM-002.
