      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00TP3'.
      ...
      * Called module names
       01  MOD-ZUW01LXH              PIC X(8) VALUE 'ZUW01LXH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01LXH-001.
               CALL 'ZUW01LXH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01LXH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
