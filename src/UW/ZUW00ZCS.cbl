      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00ZCS'.
      ...
      * Called module names
       01  MOD-ZUW01F36              PIC X(8) VALUE 'ZUW01F36'.
       01  MOD-ZUW01SY2              PIC X(8) VALUE 'ZUW01SY2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01F36-001.
               PERFORM CALL-ZUW01SY2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01F36-001.
               CALL 'ZUW01F36' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01F36 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01SY2-002.
               CALL 'ZUW01SY2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01SY2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
