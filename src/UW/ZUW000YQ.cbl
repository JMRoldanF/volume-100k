      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW000YQ'.
      ...
      * Called module names
       01  MOD-ZUW00C4O              PIC X(8) VALUE 'ZUW00C4O'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW00C4O-001.
               PERFORM CALL-ZUW00BXG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW00C4O-001.
               EXEC CICS LINK PROGRAM('ZUW00C4O')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW00C4O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW00BXG-002.
