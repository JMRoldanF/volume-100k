      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00UW8'.
      ...
      * Called module names
       01  MOD-ZUW01TQE              PIC X(8) VALUE 'ZUW01TQE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01TV4-001.
               PERFORM CALL-ZUW01TQE-002.
               PERFORM CALL-ZEN0255N-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZUW01TV4-001.
               MOVE 'ZUW01TV4' TO WS-SUBNAME-4
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01TQE-002.
               CALL 'ZUW01TQE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01TQE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
