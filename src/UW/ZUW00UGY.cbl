      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00UGY'.
      ...
      * Called module names
       01  MOD-ZUW01IFG              PIC X(8) VALUE 'ZUW01IFG'.
       01  MOD-ZUW01EJ6              PIC X(8) VALUE 'ZUW01EJ6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01IFG-001.
               CALL 'ZUW01IFG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01IFG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01EJ6-002.
               CALL 'ZUW01EJ6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
