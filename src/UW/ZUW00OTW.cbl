      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00OTW'.
      ...
      * Called module names
       01  MOD-ZUW01SYM              PIC X(8) VALUE 'ZUW01SYM'.
       01  MOD-ZUW01DLA              PIC X(8) VALUE 'ZUW01DLA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01SYM-001.
               PERFORM CALL-ZUW01DLA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01SYM-001.
               CALL 'ZUW01SYM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01SYM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01DLA-002.
               CALL 'ZUW01DLA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01DLA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
