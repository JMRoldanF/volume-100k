      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW0028U'.
      ...
      * Called module names
       01  MOD-ZUW00FGO              PIC X(8) VALUE 'ZUW00FGO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00I4K-001.
               MOVE 'ZHO00I4K' TO WS-PROGNAME-1
      ...
      *----------------------------------------------------------------*
       CALL-ZUW00FGO-002.
               EXEC CICS LINK PROGRAM('ZUW00FGO')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW00FGO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-MODEL-0001.
