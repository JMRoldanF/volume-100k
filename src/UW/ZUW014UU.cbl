      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW014UU'.
      ...
      * Called module names
       01  MOD-ZUW01ELO              PIC X(8) VALUE 'ZUW01ELO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01ELO-002.
               CALL 'ZUW01ELO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01ELO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
