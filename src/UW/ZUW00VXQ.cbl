      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00VXQ'.
      ...
      * Called module names
       01  MOD-ZUW01JVO              PIC X(8) VALUE 'ZUW01JVO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01JVO-001.
               CALL 'ZUW01JVO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01JVO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
