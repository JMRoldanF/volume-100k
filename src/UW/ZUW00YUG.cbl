      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00YUG'.
      ...
      * Called module names
       01  MOD-ZUW01RDO              PIC X(8) VALUE 'ZUW01RDO'.
       01  MOD-ZUW01SAQ              PIC X(8) VALUE 'ZUW01SAQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01RDO-001.
               PERFORM CALL-ZUW01SAQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01RDO-001.
               CALL 'ZUW01RDO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01RDO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01SAQ-002.
               CALL 'ZUW01SAQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01SAQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-TAX-BAND-0001.
