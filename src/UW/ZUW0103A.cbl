      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW0103A'.
      ...
      * Called module names
       01  MOD-ZUW01RQR              PIC X(8) VALUE 'ZUW01RQR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01RQR-001.
               PERFORM CALL-ZUW01PB5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01RQR-001.
               CALL 'ZUW01RQR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01RQR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01PB5-002.
