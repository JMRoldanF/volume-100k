      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW0116C'.
      ...
      * Called module names
       01  MOD-ZUW01SSI              PIC X(8) VALUE 'ZUW01SSI'.
       01  MOD-ZUW01TYG              PIC X(8) VALUE 'ZUW01TYG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01SSI-001.
               PERFORM CALL-ZUW01TYG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01SSI-001.
               CALL 'ZUW01SSI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01SSI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01TYG-002.
               CALL 'ZUW01TYG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01TYG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
