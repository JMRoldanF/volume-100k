      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00ROE'.
      ...
      * Called module names
       01  MOD-ZUW01FSG              PIC X(8) VALUE 'ZUW01FSG'.
       01  MOD-ZUW01P9A              PIC X(8) VALUE 'ZUW01P9A'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01FSG-001.
               PERFORM CALL-ZUW01P9A-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01FSG-001.
               CALL 'ZUW01FSG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01FSG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01P9A-002.
               CALL 'ZUW01P9A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01P9A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
