      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00P6Y'.
      ...
      * Called module names
       01  MOD-ZUW01JTG              PIC X(8) VALUE 'ZUW01JTG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01JTG-001.
               PERFORM CALL-ZUW01UXQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01JTG-001.
               CALL 'ZUW01JTG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01JTG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01UXQ-002.
