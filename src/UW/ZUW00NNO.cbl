      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00NNO'.
      ...
      * Called module names
       01  MOD-ZUW01ND8              PIC X(8) VALUE 'ZUW01ND8'.
       01  MOD-ZUW01CO8              PIC X(8) VALUE 'ZUW01CO8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01ND8-001.
               CALL 'ZUW01ND8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01ND8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01CO8-002.
               CALL 'ZUW01CO8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01CO8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
