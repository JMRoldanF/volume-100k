      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00SOB'.
      ...
      * Called module names
       01  MOD-ZUW01DEJ              PIC X(8) VALUE 'ZUW01DEJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01DEJ-002.
               CALL 'ZUW01DEJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01DEJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
