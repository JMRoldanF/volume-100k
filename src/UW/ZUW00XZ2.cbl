      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00XZ2'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01OCI              PIC X(8) VALUE 'ZUW01OCI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01OCI-002.
               CALL 'ZUW01OCI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
