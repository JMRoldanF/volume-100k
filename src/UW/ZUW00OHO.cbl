      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00OHO'.
      ...
      * Called module names
       01  MOD-ZMT01UR3              PIC X(8) VALUE 'ZMT01UR3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01UR3-001.
               PERFORM CALL-ZCL01Q8P-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01UR3-001.
               CALL 'ZMT01UR3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01UR3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01Q8P-002.
