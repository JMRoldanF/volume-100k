      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00X42'.
      ...
      * Called module names
       01  MOD-ZUW01HTS              PIC X(8) VALUE 'ZUW01HTS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01HTS-001.
               PERFORM CALL-ZUW01DHK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01HTS-001.
               CALL 'ZUW01HTS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01HTS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01DHK-002.
