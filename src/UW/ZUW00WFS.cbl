      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00WFS'.
      ...
      * Called module names
       01  MOD-ZUW01EMI              PIC X(8) VALUE 'ZUW01EMI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01EMI-001.
               CALL 'ZUW01EMI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01EMI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
