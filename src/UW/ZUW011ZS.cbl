      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW011ZS'.
      ...
      * Called module names
       01  MOD-ZUW01H1G              PIC X(8) VALUE 'ZUW01H1G'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01L12-001.
               PERFORM CALL-ZUW01H1G-002.
               PERFORM CALL-ZBI0255Q-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZUW01L12-001.
               MOVE 'ZUW01L12' TO WS-SUBNAME-1
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01H1G-002.
               CALL 'ZUW01H1G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01H1G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
