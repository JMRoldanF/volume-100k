      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW010YL'.
      ...
      * Called module names
       01  MOD-ZUW01EWY              PIC X(8) VALUE 'ZUW01EWY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01EWY-001.
               PERFORM CALL-ZUW01Q2A-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01EWY-001.
               CALL 'ZUW01EWY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01EWY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01Q2A-002.
