      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00M4E'.
      ...
      * Called module names
       01  MOD-ZCU01GES              PIC X(8) VALUE 'ZCU01GES'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01GES-001.
               CALL 'ZCU01GES' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01GES FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01H5L-002.
