      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00TL0'.
      ...
      * Called module names
       01  MOD-ZUW01HMK              PIC X(8) VALUE 'ZUW01HMK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01HMK-002.
               CALL 'ZUW01HMK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01HMK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
