      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00SIY'.
      ...
      * Called module names
       01  MOD-ZUW01MFM              PIC X(8) VALUE 'ZUW01MFM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01MFM-001.
               PERFORM CALL-ZUW01QBW-002.
               ...
               PERFORM REFRESH-MANAGED-FUND-0082.
               ...
               PERFORM RECONCILE-VALUE-0092.
               PERFORM VALIDATE-TAX-BAND-0094.
               PERFORM RECONCILE-VALUE-0095.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZUW01MFM-001.
               CALL 'ZUW01MFM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01MFM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01QBW-002.
               MOVE 'ZUW01QBW' TO WS-SUBNAME-2
               CALL WS-SUBNAME-2 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01QBW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
