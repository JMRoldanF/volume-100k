      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00ZFA'.
      ...
      * Called module names
       01  MOD-ZUW01OG4              PIC X(8) VALUE 'ZUW01OG4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01OG4-001.
               CALL 'ZUW01OG4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01OG4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
