      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00OLU'.
      ...
      * Called module names
       01  MOD-ZUW01QEY              PIC X(8) VALUE 'ZUW01QEY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01QEY-001.
               CALL 'ZUW01QEY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01QEY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
