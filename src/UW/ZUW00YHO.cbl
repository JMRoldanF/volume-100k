      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00YHO'.
      ...
      * Called module names
       01  MOD-ZUW01PH2              PIC X(8) VALUE 'ZUW01PH2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01PH2-001.
               CALL 'ZUW01PH2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01PH2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
