      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00M8A'.
      ...
      * Called module names
       01  MOD-ZUW01MYI              PIC X(8) VALUE 'ZUW01MYI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01MYI-001.
               CALL 'ZUW01MYI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01MYI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
