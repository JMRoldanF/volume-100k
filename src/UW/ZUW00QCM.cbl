      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00QCM'.
      ...
      * Called module names
       01  MOD-ZUW01GSA              PIC X(8) VALUE 'ZUW01GSA'.
       01  MOD-ZBI01GTK              PIC X(8) VALUE 'ZBI01GTK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01GSA-001.
               PERFORM CALL-ZBI01GTK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01GSA-001.
               CALL 'ZUW01GSA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01GSA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01GTK-002.
               CALL 'ZBI01GTK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01GTK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
