      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00X3Y'.
      ...
      * Called module names
       01  MOD-ZUW01N10              PIC X(8) VALUE 'ZUW01N10'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01N10-001.
               PERFORM CALL-ZUW01ERS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01N10-001.
               CALL 'ZUW01N10' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01N10 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01ERS-002.
