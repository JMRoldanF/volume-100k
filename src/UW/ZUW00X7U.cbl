      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00X7U'.
      ...
      * Called module names
       01  MOD-ZUW01DTW              PIC X(8) VALUE 'ZUW01DTW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01DTW-001.
               CALL 'ZUW01DTW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01DTW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
