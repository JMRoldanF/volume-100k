      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00R4A'.
      ...
      * Called module names
       01  MOD-ZUW01K7A              PIC X(8) VALUE 'ZUW01K7A'.
       01  MOD-ZUW01QCL              PIC X(8) VALUE 'ZUW01QCL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01K7A-001.
               PERFORM CALL-ZUW01QCL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01K7A-001.
               CALL 'ZUW01K7A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01K7A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01QCL-002.
               CALL 'ZUW01QCL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01QCL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-TAX-BAND-0001.
