      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00WY4'.
      ...
      * Called module names
       01  MOD-ZUW01IL0              PIC X(8) VALUE 'ZUW01IL0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01IL0-001.
               CALL 'ZUW01IL0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01IL0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
