      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW011YD'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01NIC              PIC X(8) VALUE 'ZUW01NIC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01F7I-001.
               PERFORM CALL-ZUW01NIC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01NIC-002.
               CALL 'ZUW01NIC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01NIC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
