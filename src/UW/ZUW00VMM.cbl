      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00VMM'.
      ...
      * Called module names
       01  MOD-ZUW01RWU              PIC X(8) VALUE 'ZUW01RWU'.
       01  MOD-ZCU01UFS              PIC X(8) VALUE 'ZCU01UFS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01RWU-001.
               PERFORM CALL-ZCU01UFS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01RWU-001.
               CALL 'ZUW01RWU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01RWU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01UFS-002.
               CALL 'ZCU01UFS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01UFS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-EXCESS-0001.
