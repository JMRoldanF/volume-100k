      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00546'.
      ...
      * Called module names
       01  MOD-ZUW008JS              PIC X(8) VALUE 'ZUW008JS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW008JS-001.
               EXEC CICS LINK PROGRAM('ZUW008JS')
      ...
      *----------------------------------------------------------------*
       CALL-ZUW00KIC-002.
               MOVE 'ZUW00KIC' TO WS-PROGNAME-4
