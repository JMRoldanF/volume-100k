      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00MU8'.
      ...
      * Called module names
       01  MOD-ZUW01RB6              PIC X(8) VALUE 'ZUW01RB6'.
       01  MOD-ZBI01RF8              PIC X(8) VALUE 'ZBI01RF8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01RB6-001.
               PERFORM CALL-ZBI01RF8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01RB6-001.
               CALL 'ZUW01RB6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01RB6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01RF8-002.
               CALL 'ZBI01RF8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01RF8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
