      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW0114E'.
      ...
      * Called module names
       01  MOD-ZUW01KJK              PIC X(8) VALUE 'ZUW01KJK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01KJK-001.
               CALL 'ZUW01KJK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01KJK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
