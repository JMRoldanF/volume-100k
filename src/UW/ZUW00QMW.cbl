      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00QMW'.
      ...
      * Called module names
       01  MOD-ZUW01R8E              PIC X(8) VALUE 'ZUW01R8E'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01R8E-001.
               CALL 'ZUW01R8E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01R8E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01QGC-002.
