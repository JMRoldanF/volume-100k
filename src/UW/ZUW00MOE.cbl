      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00MOE'.
      ...
      * Called module names
       01  MOD-ZUW01MSY              PIC X(8) VALUE 'ZUW01MSY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01MSY-001.
               CALL 'ZUW01MSY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01MSY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-MAKE-0001.
