      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00SK2'.
      ...
      * Called module names
       01  MOD-ZUW01N7O              PIC X(8) VALUE 'ZUW01N7O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01N7O-001.
               CALL 'ZUW01N7O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01N7O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
