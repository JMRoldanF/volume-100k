      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00QFQ'.
      ...
      * Called module names
       01  MOD-ZUW01TH3              PIC X(8) VALUE 'ZUW01TH3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01TH3-001.
               CALL 'ZUW01TH3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01TH3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
