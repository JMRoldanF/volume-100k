      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00ZRS'.
      ...
      * Called module names
       01  MOD-ZHO01MQI              PIC X(8) VALUE 'ZHO01MQI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01MQI-001.
               CALL 'ZHO01MQI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01MQI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
