      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00636'.
      ...
      * Called module names
       01  MOD-ZUW00JAG              PIC X(8) VALUE 'ZUW00JAG'.
       01  MOD-ZPA00J05              PIC X(8) VALUE 'ZPA00J05'.
       01  MOD-ZHO001KG              PIC X(8) VALUE 'ZHO001KG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW00JAG-002.
               PERFORM CALL-ZPA00J05-003.
               PERFORM CALL-ZHO001KG-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW00KTG-001.
               MOVE 'ZUW00KTG' TO WS-PROGNAME-6
      ...
      *----------------------------------------------------------------*
       CALL-ZUW00JAG-002.
               EXEC CICS LINK PROGRAM('ZUW00JAG')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00J05-003.
               EXEC CICS LINK PROGRAM('ZPA00J05')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA00J05 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO001KG-004.
               EXEC CICS XCTL PROGRAM('ZHO001KG')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO001KG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-005.
