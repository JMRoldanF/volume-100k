      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00WGW'.
      ...
      * Called module names
       01  MOD-ZCU01QEI              PIC X(8) VALUE 'ZCU01QEI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01QEI-001.
               CALL 'ZCU01QEI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01QEI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01SU9-002.
               MOVE 'ZEN01SU9' TO WS-SUBNAME-2
