      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00SV6'.
      ...
      * Called module names
       01  MOD-ZUW01P3Q              PIC X(8) VALUE 'ZUW01P3Q'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01P3Q-001.
               PERFORM CALL-ZCU01UL2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01P3Q-001.
               CALL 'ZUW01P3Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01P3Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01UL2-002.
