      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00TTC'.
      ...
      * Called module names
       01  MOD-ZAG01NHM              PIC X(8) VALUE 'ZAG01NHM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01NHM-001.
               CALL 'ZAG01NHM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01NHM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
