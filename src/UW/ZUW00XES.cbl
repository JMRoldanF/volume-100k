      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00XES'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01J73              PIC X(8) VALUE 'ZCL01J73'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01RNO-001.
               PERFORM CALL-ZCL01J73-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01J73-002.
               CALL 'ZCL01J73' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
