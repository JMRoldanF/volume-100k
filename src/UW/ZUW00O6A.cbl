      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00O6A'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01TCQ              PIC X(8) VALUE 'ZAG01TCQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01TCQ-002.
               CALL 'ZAG01TCQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
