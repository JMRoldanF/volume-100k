      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00SPM'.
      ...
      * Called module names
       01  MOD-ZUW01H5W              PIC X(8) VALUE 'ZUW01H5W'.
       01  MOD-ZUW01PJ0              PIC X(8) VALUE 'ZUW01PJ0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01H5W-001.
               PERFORM CALL-ZUW01PJ0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01H5W-001.
               CALL 'ZUW01H5W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01H5W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01PJ0-002.
               CALL 'ZUW01PJ0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01PJ0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
