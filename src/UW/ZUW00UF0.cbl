      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00UF0'.
      ...
      * Called module names
       01  MOD-ZUW01DM4              PIC X(8) VALUE 'ZUW01DM4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01DM4-001.
               CALL 'ZUW01DM4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01DM4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
