      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00V6S'.
      ...
      * Called module names
       01  MOD-ZUW01P5O              PIC X(8) VALUE 'ZUW01P5O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01P5O-001.
               CALL 'ZUW01P5O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01P5O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
