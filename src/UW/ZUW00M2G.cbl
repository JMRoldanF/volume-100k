      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00M2G'.
      ...
      * Called module names
       01  MOD-ZUW01S3S              PIC X(8) VALUE 'ZUW01S3S'.
       01  MOD-ZUW01ICE              PIC X(8) VALUE 'ZUW01ICE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01S3S-001.
               PERFORM CALL-ZUW01ICE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01S3S-001.
               CALL 'ZUW01S3S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01S3S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01ICE-002.
               CALL 'ZUW01ICE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01ICE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
