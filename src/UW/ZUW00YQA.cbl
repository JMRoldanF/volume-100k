      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00YQA'.
      ...
      * Called module names
       01  MOD-ZUW01I1A              PIC X(8) VALUE 'ZUW01I1A'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01I1A-001.
               PERFORM CALL-ZPA01Q5H-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01I1A-001.
               CALL 'ZUW01I1A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01I1A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01Q5H-002.
