      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW012DI'.
      ...
      * Called module names
       01  MOD-ZUW01UYX              PIC X(8) VALUE 'ZUW01UYX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01UYX-001.
               CALL 'ZUW01UYX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01UYX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
