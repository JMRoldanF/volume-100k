      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW012D4'.
      ...
      * Called module names
       01  MOD-ZRE01D8P              PIC X(8) VALUE 'ZRE01D8P'.
       01  MOD-ZUW01V2Q              PIC X(8) VALUE 'ZUW01V2Q'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01D8P-001.
               PERFORM CALL-ZUW01V2Q-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01D8P-001.
               CALL 'ZRE01D8P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01D8P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01V2Q-002.
               CALL 'ZUW01V2Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01V2Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
