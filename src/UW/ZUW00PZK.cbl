      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00PZK'.
      ...
      * Called module names
       01  MOD-ZUW01H48              PIC X(8) VALUE 'ZUW01H48'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01H48-001.
               CALL 'ZUW01H48' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01H48 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
