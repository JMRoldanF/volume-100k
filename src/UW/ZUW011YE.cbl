      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW011YE'.
      ...
      * Called module names
       01  MOD-ZPA01OH7              PIC X(8) VALUE 'ZPA01OH7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01OH7-001.
               CALL 'ZPA01OH7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01OH7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
