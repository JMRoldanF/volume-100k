      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW01ATK'.
      ...
      * Called module names
       01  MOD-ZUW01Q44              PIC X(8) VALUE 'ZUW01Q44'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01Q44-001.
               CALL 'ZUW01Q44' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01Q44 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
