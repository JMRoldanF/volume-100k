      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00WKS'.
      ...
      * Called module names
       01  MOD-ZUW01TM8              PIC X(8) VALUE 'ZUW01TM8'.
       01  MOD-ZUW01QBC              PIC X(8) VALUE 'ZUW01QBC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01TM8-001.
               PERFORM CALL-ZUW01QBC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01TM8-001.
               CALL 'ZUW01TM8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01QBC-002.
               CALL 'ZUW01QBC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01QBC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
