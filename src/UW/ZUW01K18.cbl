      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW01K18'.
      ...
      * Called module names
       01  MOD-ZUW01SK6              PIC X(8) VALUE 'ZUW01SK6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01SK6-001.
               CALL 'ZUW01SK6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01SK6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
