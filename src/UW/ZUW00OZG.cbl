      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00OZG'.
      ...
      * Called module names
       01  MOD-ZUW01TIW              PIC X(8) VALUE 'ZUW01TIW'.
       01  MOD-ZUW01MF2              PIC X(8) VALUE 'ZUW01MF2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01TIW-001.
               PERFORM CALL-ZUW01MF2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01TIW-001.
               CALL 'ZUW01TIW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01TIW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01MF2-002.
               CALL 'ZUW01MF2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01MF2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
