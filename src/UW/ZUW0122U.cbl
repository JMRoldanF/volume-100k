      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW0122U'.
      ...
      * Called module names
       01  MOD-ZUW01MW0              PIC X(8) VALUE 'ZUW01MW0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01MW0-001.
               CALL 'ZUW01MW0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01MW0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01H66-002.
