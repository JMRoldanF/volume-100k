      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW01252'.
      ...
      * Called module names
       01  MOD-ZUW01DJM              PIC X(8) VALUE 'ZUW01DJM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01DJM-001.
               CALL 'ZUW01DJM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01DJM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
