      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00KAA'.
      ...
      * Called module names
       01  MOD-ZUW00O7E              PIC X(8) VALUE 'ZUW00O7E'.
       01  MOD-ZUW0133I              PIC X(8) VALUE 'ZUW0133I'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW00O7E-001.
               PERFORM CALL-ZUW0133I-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW00O7E-001.
               EXEC CICS LINK PROGRAM('ZUW00O7E')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW00O7E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW0133I-002.
               EXEC CICS LINK PROGRAM('ZUW0133I')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW0133I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
