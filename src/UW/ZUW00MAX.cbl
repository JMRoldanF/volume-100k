      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00MAX'.
      ...
      * Called module names
       ...
       01  MOD-ZNT01PCP              PIC X(8) VALUE 'ZNT01PCP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01N8W-001.
               PERFORM CALL-ZNT01PCP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01PCP-002.
               CALL 'ZNT01PCP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01PCP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
