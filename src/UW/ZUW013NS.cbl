      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW013NS'.
      ...
      * Called module names
       01  MOD-ZCU01CVK              PIC X(8) VALUE 'ZCU01CVK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01CVK-001.
               CALL 'ZCU01CVK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01CVK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
