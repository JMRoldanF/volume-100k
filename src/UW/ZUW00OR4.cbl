      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00OR4'.
      ...
      * Called module names
       01  MOD-ZRE01HLN              PIC X(8) VALUE 'ZRE01HLN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01HLN-001.
               CALL 'ZRE01HLN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01HLN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01MP0-002.
