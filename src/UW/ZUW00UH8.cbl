      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00UH8'.
      ...
      * Called module names
       01  MOD-ZUW01V4E              PIC X(8) VALUE 'ZUW01V4E'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01V4E-001.
               CALL 'ZUW01V4E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01V4E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
