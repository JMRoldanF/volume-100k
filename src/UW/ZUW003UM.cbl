      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW003UM'.
      ...
      * Called module names
       ...
       01  MOD-ZUW007O4              PIC X(8) VALUE 'ZUW007O4'.
       01  MOD-ZCU004PA              PIC X(8) VALUE 'ZCU004PA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW007O4-002.
               PERFORM CALL-ZCU004PA-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW007O4-002.
               EXEC CICS LINK PROGRAM('ZUW007O4')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW007O4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU004PA-003.
               EXEC CICS XCTL PROGRAM('ZCU004PA')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
