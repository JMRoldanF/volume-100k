      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00VG8'.
      ...
      * Called module names
       01  MOD-ZUW01I3I              PIC X(8) VALUE 'ZUW01I3I'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01I3I-001.
               PERFORM CALL-ZUW01UAE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01I3I-001.
               CALL 'ZUW01I3I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01I3I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01UAE-002.
