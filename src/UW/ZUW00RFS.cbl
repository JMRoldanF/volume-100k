      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00RFS'.
      ...
      * Called module names
       01  MOD-ZMT01MKX              PIC X(8) VALUE 'ZMT01MKX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01M8O-001.
               PERFORM CALL-ZMT01MKX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01MKX-002.
               CALL 'ZMT01MKX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01MKX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-COLOUR-0001.
