      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW002QW'.
      ...
      * Called module names
       01  MOD-ZUW008V6              PIC X(8) VALUE 'ZUW008V6'.
       01  MOD-ZUW00DKW              PIC X(8) VALUE 'ZUW00DKW'.
       01  MOD-ZUW003NE              PIC X(8) VALUE 'ZUW003NE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW008V6-001.
               PERFORM CALL-ZUW00DKW-002.
               PERFORM CALL-ZUW003NE-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW008V6-001.
               EXEC CICS LINK PROGRAM('ZUW008V6')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW008V6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW00DKW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW003NE-003.
               EXEC CICS XCTL PROGRAM('ZUW003NE')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
