      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW011IK'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01NYC              PIC X(8) VALUE 'ZUW01NYC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01MZW-001.
               PERFORM CALL-ZUW01NYC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01NYC-002.
               CALL 'ZUW01NYC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01NYC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-MODEL-0001.
