      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00LTJ'.
      ...
      * Called module names
       01  MOD-ZUW01HWT              PIC X(8) VALUE 'ZUW01HWT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01HWT-001.
               CALL 'ZUW01HWT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01HWT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
