      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00UBO'.
      ...
      * Called module names
       01  MOD-ZUW01R98              PIC X(8) VALUE 'ZUW01R98'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01R98-001.
               CALL 'ZUW01R98' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01R98 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
