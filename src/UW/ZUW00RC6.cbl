      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00RC6'.
      ...
      * Called module names
       01  MOD-ZUW01DSI              PIC X(8) VALUE 'ZUW01DSI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01DSI-001.
               CALL 'ZUW01DSI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01DSI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
