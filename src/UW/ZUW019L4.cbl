      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW019L4'.
      ...
      * Called module names
       01  MOD-ZRE01HV3              PIC X(8) VALUE 'ZRE01HV3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01HV3-001.
               CALL 'ZRE01HV3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01HV3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01D6K-002.
               MOVE 'ZUW01D6K' TO WS-SUBNAME-6
