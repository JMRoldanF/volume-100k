      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW01JDW'.
      ...
      * Called module names
       01  MOD-ZHO01E3E              PIC X(8) VALUE 'ZHO01E3E'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01E3E-001.
               CALL 'ZHO01E3E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01E3E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
