      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00WBW'.
      ...
      * Called module names
       01  MOD-ZUW01KV8              PIC X(8) VALUE 'ZUW01KV8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01KV8-001.
               CALL 'ZUW01KV8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01KV8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
