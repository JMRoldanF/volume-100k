      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW011US'.
      ...
      * Called module names
       01  MOD-ZEN01OHB              PIC X(8) VALUE 'ZEN01OHB'.
       01  MOD-ZUW01PGS              PIC X(8) VALUE 'ZUW01PGS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01OHB-001.
               PERFORM CALL-ZUW01PGS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01OHB-001.
               CALL 'ZEN01OHB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01OHB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01PGS-002.
               CALL 'ZUW01PGS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01PGS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
