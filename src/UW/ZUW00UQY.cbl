      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00UQY'.
      ...
      * Called module names
       01  MOD-ZUW01SGA              PIC X(8) VALUE 'ZUW01SGA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01SGA-001.
               CALL 'ZUW01SGA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01SGA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
