      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW011WQ'.
      ...
      * Called module names
       01  MOD-ZUW01LVM              PIC X(8) VALUE 'ZUW01LVM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01LVM-001.
               CALL 'ZUW01LVM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01LVM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
