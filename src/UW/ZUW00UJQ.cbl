      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00UJQ'.
      ...
      * Called module names
       01  MOD-ZUW01LG2              PIC X(8) VALUE 'ZUW01LG2'.
       01  MOD-ZCU01UE4              PIC X(8) VALUE 'ZCU01UE4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01LG2-001.
               PERFORM CALL-ZCU01UE4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01LG2-001.
               CALL 'ZUW01LG2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01LG2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01UE4-002.
               CALL 'ZCU01UE4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01UE4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
