      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00T8I'.
      ...
      * Called module names
       01  MOD-ZUW01UZO              PIC X(8) VALUE 'ZUW01UZO'.
       01  MOD-ZUW01DGA              PIC X(8) VALUE 'ZUW01DGA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01UZO-001.
               CALL 'ZUW01UZO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01UZO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01DGA-002.
               CALL 'ZUW01DGA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01DGA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
