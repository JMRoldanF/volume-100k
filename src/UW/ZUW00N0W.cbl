      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00N0W'.
      ...
      * Called module names
       01  MOD-ZCU01V3Y              PIC X(8) VALUE 'ZCU01V3Y'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01V3Y-002.
               CALL 'ZCU01V3Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
