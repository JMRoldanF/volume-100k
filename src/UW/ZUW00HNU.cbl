      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00HNU'.
      ...
      * Called module names
       01  MOD-ZRE00ZQ1              PIC X(8) VALUE 'ZRE00ZQ1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW00N6G-002.
               PERFORM CALL-ZHO00T6C-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE00ZQ1-001.
               EXEC CICS LINK PROGRAM('ZRE00ZQ1')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE00ZQ1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW00N6G-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00T6C-003.
               MOVE 'ZHO00T6C' TO WS-PROGNAME-8
