      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00LVI'.
      ...
      * Called module names
       01  MOD-ZUW01Q4Y              PIC X(8) VALUE 'ZUW01Q4Y'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01Q4Y-001.
               CALL 'ZUW01Q4Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01Q4Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
