      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW0159A'.
      ...
      * Called module names
       01  MOD-ZBI01LWM              PIC X(8) VALUE 'ZBI01LWM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01LWM-001.
               CALL 'ZBI01LWM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01LWM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01HV6-002.
