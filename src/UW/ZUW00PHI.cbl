      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00PHI'.
      ...
      * Called module names
       01  MOD-ZUW01KNG              PIC X(8) VALUE 'ZUW01KNG'.
       01  MOD-ZUW01O50              PIC X(8) VALUE 'ZUW01O50'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01KNG-001.
               PERFORM CALL-ZUW01O50-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01KNG-001.
               CALL 'ZUW01KNG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01KNG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01O50-002.
               CALL 'ZUW01O50' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01O50 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
