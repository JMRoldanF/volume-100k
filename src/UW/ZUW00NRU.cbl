      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00NRU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CHECK-MANAGED-FUND-0053.
               ...
               PERFORM RESOLVE-REG-NUMBER-0059.
               ...
               PERFORM FORMAT-HOUSE-TYPE-0079.
               ...
               PERFORM DERIVE-STATUS-CODE-0101.
               PERFORM SQL-ACCESS-0102.
               PERFORM NORMALISE-VALUE-0103.
               ...
               PERFORM CHECK-PREMIUM-0109.
               PERFORM AUDIT-MAKE-0110.
               PERFORM SQL-ACCESS-0111.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZUW01L1W-001.
               MOVE 'ZUW01L1W' TO WS-SUBNAME-4
               CALL WS-SUBNAME-4 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01L1W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
