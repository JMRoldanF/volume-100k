      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW0107C'.
      ...
      * Called module names
       01  MOD-ZUW01PZY              PIC X(8) VALUE 'ZUW01PZY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01PZY-001.
               CALL 'ZUW01PZY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01PZY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
