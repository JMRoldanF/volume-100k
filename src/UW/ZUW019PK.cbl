      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW019PK'.
      ...
      * Called module names
       01  MOD-ZUW01HC0              PIC X(8) VALUE 'ZUW01HC0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01HC0-001.
               CALL 'ZUW01HC0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01HC0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01NUG-002.
