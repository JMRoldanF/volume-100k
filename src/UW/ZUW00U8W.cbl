      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00U8W'.
      ...
      * Called module names
       01  MOD-ZUW01TL4              PIC X(8) VALUE 'ZUW01TL4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01TL4-001.
               CALL 'ZUW01TL4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01TL4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
