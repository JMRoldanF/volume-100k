      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW013BK'.
      ...
      * Called module names
       01  MOD-ZUW01SYC              PIC X(8) VALUE 'ZUW01SYC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01SYC-001.
               CALL 'ZUW01SYC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01SYC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
