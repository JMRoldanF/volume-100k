      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00N3O'.
      ...
      * Called module names
       01  MOD-ZUW01RJS              PIC X(8) VALUE 'ZUW01RJS'.
       01  MOD-ZHO01SAI              PIC X(8) VALUE 'ZHO01SAI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01RJS-001.
               CALL 'ZUW01RJS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01RJS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01SAI-002.
               CALL 'ZHO01SAI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01SAI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
