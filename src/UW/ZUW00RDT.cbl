      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00RDT'.
      ...
      * Called module names
       01  MOD-ZUW01E5L              PIC X(8) VALUE 'ZUW01E5L'.
       01  MOD-ZUW01L23              PIC X(8) VALUE 'ZUW01L23'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01E5L-001.
               PERFORM CALL-ZUW01L23-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01E5L-001.
               CALL 'ZUW01E5L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01E5L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01L23-002.
               CALL 'ZUW01L23' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01L23 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
