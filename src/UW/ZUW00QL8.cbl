      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00QL8'.
      ...
      * Called module names
       01  MOD-ZUW01DQK              PIC X(8) VALUE 'ZUW01DQK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01DQK-001.
               CALL 'ZUW01DQK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01DQK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
