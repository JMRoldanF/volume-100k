      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00XA2'.
      ...
      * Called module names
       01  MOD-ZUW01LO4              PIC X(8) VALUE 'ZUW01LO4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01FRM-002.
               PERFORM CALL-ZCU0255O-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZUW01LO4-001.
               CALL 'ZUW01LO4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
