      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00P1E'.
      ...
      * Called module names
       01  MOD-ZUW01RI4              PIC X(8) VALUE 'ZUW01RI4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01RI4-001.
               CALL 'ZUW01RI4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01RI4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
