      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00X0L'.
      ...
      * Called module names
       01  MOD-ZUW01F1F              PIC X(8) VALUE 'ZUW01F1F'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01F1F-001.
               PERFORM CALL-ZUW01MFO-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01F1F-001.
               CALL 'ZUW01F1F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01F1F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01MFO-002.
               MOVE 'ZUW01MFO' TO WS-SUBNAME-7
