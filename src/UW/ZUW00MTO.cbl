      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00MTO'.
      ...
      * Called module names
       01  MOD-ZUW01FTK              PIC X(8) VALUE 'ZUW01FTK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01FTK-001.
               PERFORM CALL-ZUW01IZ6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01FTK-001.
               CALL 'ZUW01FTK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01FTK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01IZ6-002.
