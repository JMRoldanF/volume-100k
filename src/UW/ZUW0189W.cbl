      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW0189W'.
      ...
      * Called module names
       01  MOD-ZUW01R7U              PIC X(8) VALUE 'ZUW01R7U'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01R7U-001.
               PERFORM CALL-ZCL01KTZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01R7U-001.
               CALL 'ZUW01R7U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01R7U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01KTZ-002.
               MOVE 'ZCL01KTZ' TO WS-SUBNAME-5
