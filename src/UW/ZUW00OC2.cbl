      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00OC2'.
      ...
      * Called module names
       01  MOD-ZUW01PUL              PIC X(8) VALUE 'ZUW01PUL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01PUL-001.
               CALL 'ZUW01PUL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01PUL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
