      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW01AOA'.
      ...
      * Called module names
       01  MOD-ZUW01IJM              PIC X(8) VALUE 'ZUW01IJM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01IJM-001.
               CALL 'ZUW01IJM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01IJM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
