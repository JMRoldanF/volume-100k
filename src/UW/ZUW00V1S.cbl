      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00V1S'.
      ...
      * Called module names
       01  MOD-ZUW01IME              PIC X(8) VALUE 'ZUW01IME'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01IME-001.
               CALL 'ZUW01IME' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01IME FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
