      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00Y8I'.
      ...
      * Called module names
       01  MOD-ZUW01P90              PIC X(8) VALUE 'ZUW01P90'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01J0K-001.
               PERFORM CALL-ZUW01P90-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01P90-002.
               CALL 'ZUW01P90' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01P90 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
