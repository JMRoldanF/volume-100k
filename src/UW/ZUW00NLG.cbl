      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00NLG'.
      ...
      * Called module names
       01  MOD-ZRE01L8R              PIC X(8) VALUE 'ZRE01L8R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01L8R-001.
               CALL 'ZRE01L8R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01L8R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
