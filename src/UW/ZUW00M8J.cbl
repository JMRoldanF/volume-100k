      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00M8J'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01EHG              PIC X(8) VALUE 'ZUW01EHG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRT01PCS-001.
               PERFORM CALL-ZUW01EHG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01EHG-002.
               CALL 'ZUW01EHG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01EHG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-EQUITIES-0001.
