      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW002D0'.
      ...
      * Called module names
       ...
       01  MOD-ZAG00FBM              PIC X(8) VALUE 'ZAG00FBM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW00A0A-001.
               PERFORM CALL-ZAG00FBM-002.
               PERFORM CALL-ZEN004U9-003.
               PERFORM CALL-ZMT000GP-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG00FBM-002.
               EXEC CICS LINK PROGRAM('ZAG00FBM')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG00FBM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN004U9-003.
