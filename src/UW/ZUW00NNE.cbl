      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00NNE'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01HKW              PIC X(8) VALUE 'ZUW01HKW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01HKW-002.
               CALL 'ZUW01HKW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01HKW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
