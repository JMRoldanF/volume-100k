      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00X9X'.
      ...
      * Called module names
       01  MOD-ZUW01DHK              PIC X(8) VALUE 'ZUW01DHK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM VALIDATE-REG-NUMBER-0058.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01DHK-001.
               CALL 'ZUW01DHK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01DHK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-COLOUR-0001.
