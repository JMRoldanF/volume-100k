      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW011I0'.
      ...
      * Called module names
       01  MOD-ZUW01TFU              PIC X(8) VALUE 'ZUW01TFU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01TFU-001.
               CALL 'ZUW01TFU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01TFU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
