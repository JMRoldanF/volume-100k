      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00X7R'.
      ...
      * Called module names
       01  MOD-ZUW01SSL              PIC X(8) VALUE 'ZUW01SSL'.
       01  MOD-ZNT01E5N              PIC X(8) VALUE 'ZNT01E5N'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01SSL-001.
               PERFORM CALL-ZNT01E5N-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01SSL-001.
               CALL 'ZUW01SSL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01SSL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZNT01E5N-002.
               CALL 'ZNT01E5N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01E5N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
