      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00U96'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01JBO              PIC X(8) VALUE 'ZUW01JBO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01HA8-001.
               PERFORM CALL-ZUW01JBO-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01JBO-002.
               CALL 'ZUW01JBO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01JBO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
