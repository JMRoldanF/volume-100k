      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW010ZT'.
      ...
      * Called module names
       01  MOD-ZUW01TFP              PIC X(8) VALUE 'ZUW01TFP'.
       01  MOD-ZUW01N9P              PIC X(8) VALUE 'ZUW01N9P'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01TFP-001.
               PERFORM CALL-ZUW01N9P-002.
               ...
               PERFORM COMPUTE-WITH-PROFITS-0029.
               ...
               PERFORM AUDIT-MANAGED-FUND-0053.
               ...
               PERFORM RECONCILE-CC-RATING-0067.
               ...
               PERFORM RESOLVE-AGENT-CODE-0089.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01TFP-001.
               CALL 'ZUW01TFP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01TFP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01N9P-002.
               CALL 'ZUW01N9P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01N9P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-COLOUR-0001.
