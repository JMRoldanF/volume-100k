      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW0123E'.
      ...
      * Called module names
       01  MOD-ZUW01T1E              PIC X(8) VALUE 'ZUW01T1E'.
       01  MOD-ZUW01OQO              PIC X(8) VALUE 'ZUW01OQO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01T1E-001.
               PERFORM CALL-ZUW01OQO-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01T1E-001.
               CALL 'ZUW01T1E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01T1E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01OQO-002.
               CALL 'ZUW01OQO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01OQO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
