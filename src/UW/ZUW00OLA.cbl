      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00OLA'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01GF8              PIC X(8) VALUE 'ZUW01GF8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01GF8-002.
               CALL 'ZUW01GF8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01GF8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
