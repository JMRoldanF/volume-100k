      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00WC6'.
      ...
      * Called module names
       01  MOD-ZUW01FYK              PIC X(8) VALUE 'ZUW01FYK'.
       01  MOD-ZUW01SOW              PIC X(8) VALUE 'ZUW01SOW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01FYK-001.
               PERFORM CALL-ZUW01SOW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01FYK-001.
               CALL 'ZUW01FYK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01FYK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01SOW-002.
               CALL 'ZUW01SOW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01SOW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
