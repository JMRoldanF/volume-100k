      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00TBA'.
      ...
      * Called module names
       01  MOD-ZPA01FLH              PIC X(8) VALUE 'ZPA01FLH'.
       01  MOD-ZUW01U0O              PIC X(8) VALUE 'ZUW01U0O'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01FLH-001.
               PERFORM CALL-ZUW01U0O-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01FLH-001.
               CALL 'ZPA01FLH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01FLH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01U0O-002.
               CALL 'ZUW01U0O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01U0O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
