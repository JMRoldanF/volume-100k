      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW004WO'.
      ...
      * Called module names
       ...
       01  MOD-ZUW00JE2              PIC X(8) VALUE 'ZUW00JE2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO00958-001.
               PERFORM CALL-ZUW008OS-002.
               PERFORM CALL-ZUW00JE2-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW00JE2-003.
               EXEC CICS LINK PROGRAM('ZUW00JE2')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW00JE2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-004.
