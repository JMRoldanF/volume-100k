      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW002E4'.
      ...
      * Called module names
       01  MOD-ZUW00LE0              PIC X(8) VALUE 'ZUW00LE0'.
       01  MOD-ZUW00HF8              PIC X(8) VALUE 'ZUW00HF8'.
       01  MOD-ZPA004LJ              PIC X(8) VALUE 'ZPA004LJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW00LE0-001.
               PERFORM CALL-ZPA004LJ-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW00LE0-001.
               EXEC CICS LINK PROGRAM('ZUW00LE0')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW00LE0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW00HF8-002.
               EXEC CICS LINK PROGRAM('ZUW00HF8')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW00HF8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA004LJ-003.
               EXEC CICS XCTL PROGRAM('ZPA004LJ')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA004LJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-004.
