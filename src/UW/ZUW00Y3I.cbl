      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00Y3I'.
      ...
      * Called module names
       01  MOD-ZUW01O3W              PIC X(8) VALUE 'ZUW01O3W'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01O3W-001.
               CALL 'ZUW01O3W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01O3W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
