      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00QOA'.
      ...
      * Called module names
       01  MOD-ZUW01TSW              PIC X(8) VALUE 'ZUW01TSW'.
       01  MOD-ZPA01TDV              PIC X(8) VALUE 'ZPA01TDV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01TSW-001.
               PERFORM CALL-ZPA01TDV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01TSW-001.
               CALL 'ZUW01TSW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01TSW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01TDV-002.
               CALL 'ZPA01TDV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01TDV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
