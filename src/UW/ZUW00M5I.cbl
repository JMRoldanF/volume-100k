      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00M5I'.
      ...
      * Called module names
       01  MOD-ZBI01DFW              PIC X(8) VALUE 'ZBI01DFW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01DFW-001.
               CALL 'ZBI01DFW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01DFW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01NUG-002.
