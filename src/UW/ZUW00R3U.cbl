      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00R3U'.
      ...
      * Called module names
       01  MOD-ZUW01HRA              PIC X(8) VALUE 'ZUW01HRA'.
       01  MOD-ZUW01H66              PIC X(8) VALUE 'ZUW01H66'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01HRA-001.
               PERFORM CALL-ZUW01H66-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01HRA-001.
               CALL 'ZUW01HRA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01HRA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01H66-002.
               CALL 'ZUW01H66' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01H66 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-MODEL-0001.
