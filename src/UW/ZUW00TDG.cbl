      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00TDG'.
      ...
      * Called module names
       01  MOD-ZUW01G64              PIC X(8) VALUE 'ZUW01G64'.
       01  MOD-ZPL01DKQ              PIC X(8) VALUE 'ZPL01DKQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01G64-001.
               PERFORM CALL-ZPL01DKQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01G64-001.
               CALL 'ZUW01G64' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01G64 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPL01DKQ-002.
               CALL 'ZPL01DKQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPL01DKQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
