      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00ZPU'.
      ...
      * Called module names
       01  MOD-ZHO01PO2              PIC X(8) VALUE 'ZHO01PO2'.
       01  MOD-ZUW01SO2              PIC X(8) VALUE 'ZUW01SO2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01PO2-001.
               CALL 'ZHO01PO2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01PO2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01SO2-002.
               CALL 'ZUW01SO2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01SO2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
