      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00UM8'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01IS8              PIC X(8) VALUE 'ZUW01IS8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01KL8-001.
               PERFORM CALL-ZUW01IS8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01IS8-002.
               CALL 'ZUW01IS8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01IS8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
