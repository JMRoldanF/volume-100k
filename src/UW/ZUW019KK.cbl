      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW019KK'.
      ...
      * Called module names
       01  MOD-ZCU01JBS              PIC X(8) VALUE 'ZCU01JBS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01JBS-001.
               CALL 'ZCU01JBS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01JBS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
