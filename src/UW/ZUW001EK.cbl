      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW001EK'.
      ...
      * Called module names
       01  MOD-ZUW00DAW              PIC X(8) VALUE 'ZUW00DAW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW00DAW-001.
               PERFORM CALL-ZUW0073K-002.
               PERFORM CALL-ZUW00A4G-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW00DAW-001.
               EXEC CICS LINK PROGRAM('ZUW00DAW')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW00DAW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW0073K-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW00A4G-003.
               MOVE 'ZUW00A4G' TO WS-PROGNAME-8
