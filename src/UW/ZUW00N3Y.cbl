      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00N3Y'.
      ...
      * Called module names
       01  MOD-ZEN01I27              PIC X(8) VALUE 'ZEN01I27'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01I27-001.
               CALL 'ZEN01I27' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01I27 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-VALUE-0001.
