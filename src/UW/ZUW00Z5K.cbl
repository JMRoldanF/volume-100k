      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00Z5K'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01GVM              PIC X(8) VALUE 'ZUW01GVM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01NAQ-001.
               PERFORM CALL-ZUW01GVM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01GVM-002.
               CALL 'ZUW01GVM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
