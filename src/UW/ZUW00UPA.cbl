      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00UPA'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01Q1M              PIC X(8) VALUE 'ZUW01Q1M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01Q1M-002.
               CALL 'ZUW01Q1M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01Q1M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
