      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00VBS'.
      ...
      * Called module names
       01  MOD-ZUW01RDY              PIC X(8) VALUE 'ZUW01RDY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01RDY-001.
               CALL 'ZUW01RDY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01RDY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01Q2Q-002.
