      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW011MG'.
      ...
      * Called module names
       01  MOD-ZUW01N1A              PIC X(8) VALUE 'ZUW01N1A'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01N1A-001.
               CALL 'ZUW01N1A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01N1A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
