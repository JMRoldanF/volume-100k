      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00ZT6'.
      ...
      * Called module names
       01  MOD-ZUW01IKG              PIC X(8) VALUE 'ZUW01IKG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01IKG-001.
               CALL 'ZUW01IKG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01IKG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
