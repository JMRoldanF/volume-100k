      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00TMO'.
      ...
      * Called module names
       01  MOD-ZUW01SZ6              PIC X(8) VALUE 'ZUW01SZ6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01SZ6-001.
               PERFORM CALL-ZUW01KRC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01SZ6-001.
               CALL 'ZUW01SZ6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01SZ6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01KRC-002.
