      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00ZGS'.
      ...
      * Called module names
       01  MOD-ZUW01QM0              PIC X(8) VALUE 'ZUW01QM0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01QM0-001.
               CALL 'ZUW01QM0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01QM0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01KJC-002.
