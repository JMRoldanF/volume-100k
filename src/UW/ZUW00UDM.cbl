      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00UDM'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01QVC              PIC X(8) VALUE 'ZUW01QVC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01SEM-001.
               PERFORM CALL-ZUW01QVC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01QVC-002.
               CALL 'ZUW01QVC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01QVC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-MODEL-0001.
