      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00TMP'.
      ...
      * Called module names
       01  MOD-ZUW01NF3              PIC X(8) VALUE 'ZUW01NF3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01NF3-001.
               CALL 'ZUW01NF3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01NF3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
