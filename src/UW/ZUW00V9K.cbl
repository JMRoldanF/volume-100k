      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00V9K'.
      ...
      * Called module names
       01  MOD-ZUW01R2A              PIC X(8) VALUE 'ZUW01R2A'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01R2A-001.
               PERFORM CALL-ZMT01ELF-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01R2A-001.
               CALL 'ZUW01R2A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01R2A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01ELF-002.
