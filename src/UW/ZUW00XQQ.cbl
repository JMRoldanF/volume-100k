      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00XQQ'.
      ...
      * Called module names
       01  MOD-ZUW01GJO              PIC X(8) VALUE 'ZUW01GJO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01GJO-001.
               CALL 'ZUW01GJO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01GJO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
