      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00OL2'.
      ...
      * Called module names
       01  MOD-ZUW01TJT              PIC X(8) VALUE 'ZUW01TJT'.
       01  MOD-ZUW01HR7              PIC X(8) VALUE 'ZUW01HR7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01TJT-001.
               PERFORM CALL-ZUW01HR7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01TJT-001.
               CALL 'ZUW01TJT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01TJT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01HR7-002.
               CALL 'ZUW01HR7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01HR7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
