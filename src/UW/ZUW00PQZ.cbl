      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00PQZ'.
      ...
      * Called module names
       01  MOD-ZUW01PL0              PIC X(8) VALUE 'ZUW01PL0'.
       01  MOD-ZUW01I7F              PIC X(8) VALUE 'ZUW01I7F'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01PL0-001.
               PERFORM CALL-ZUW01I7F-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01PL0-001.
               CALL 'ZUW01PL0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01PL0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01I7F-002.
               CALL 'ZUW01I7F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01I7F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
