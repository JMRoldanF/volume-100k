      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00QVS'.
      ...
      * Called module names
       01  MOD-ZUW01QWG              PIC X(8) VALUE 'ZUW01QWG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01QWG-001.
               CALL 'ZUW01QWG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01QWG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
