      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00820'.
      ...
      * Called module names
       01  MOD-ZUW00OYW              PIC X(8) VALUE 'ZUW00OYW'.
       01  MOD-ZUW01AVS              PIC X(8) VALUE 'ZUW01AVS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW00OYW-001.
               PERFORM CALL-ZUW01AVS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW00OYW-001.
               EXEC CICS LINK PROGRAM('ZUW00OYW')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW00OYW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01AVS-002.
               EXEC CICS LINK PROGRAM('ZUW01AVS')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01AVS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
