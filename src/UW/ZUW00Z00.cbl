      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00Z00'.
      ...
      * Called module names
       01  MOD-ZUW01E9Q              PIC X(8) VALUE 'ZUW01E9Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01E9Q-001.
               CALL 'ZUW01E9Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01E9Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
