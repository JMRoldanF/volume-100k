      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00UO5'.
      ...
      * Called module names
       01  MOD-ZUW01NHF              PIC X(8) VALUE 'ZUW01NHF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01NHF-001.
               CALL 'ZUW01NHF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01NHF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
