      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW01BR6'.
      ...
      * Called module names
       01  MOD-ZUW01SJM              PIC X(8) VALUE 'ZUW01SJM'.
       01  MOD-ZUW01I2E              PIC X(8) VALUE 'ZUW01I2E'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01SJM-001.
               PERFORM CALL-ZUW01I2E-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01SJM-001.
               CALL 'ZUW01SJM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01SJM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01I2E-002.
               CALL 'ZUW01I2E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01I2E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
