      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00MTY'.
      ...
      * Called module names
       01  MOD-ZUW01I42              PIC X(8) VALUE 'ZUW01I42'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01I42-001.
               CALL 'ZUW01I42' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01I42 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
