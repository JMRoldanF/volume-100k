      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00LTA'.
      ...
      * Called module names
       01  MOD-ZUW01QKI              PIC X(8) VALUE 'ZUW01QKI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01QKI-001.
               CALL 'ZUW01QKI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01QKI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
