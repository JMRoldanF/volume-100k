      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00LZ4'.
      ...
      * Called module names
       01  MOD-ZUW01FAE              PIC X(8) VALUE 'ZUW01FAE'.
       01  MOD-ZUW01HI4              PIC X(8) VALUE 'ZUW01HI4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01FAE-001.
               PERFORM CALL-ZUW01HI4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01FAE-001.
               CALL 'ZUW01FAE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01FAE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01HI4-002.
               CALL 'ZUW01HI4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01HI4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
