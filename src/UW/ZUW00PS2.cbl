      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00PS2'.
      ...
      * Called module names
       01  MOD-ZUW01LLM              PIC X(8) VALUE 'ZUW01LLM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01LLM-001.
               PERFORM CALL-ZUW01UQI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01LLM-001.
               CALL 'ZUW01LLM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01LLM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01UQI-002.
               MOVE 'ZUW01UQI' TO WS-SUBNAME-5
