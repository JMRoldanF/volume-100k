      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00PY6'.
      ...
      * Called module names
       01  MOD-ZUW01IWY              PIC X(8) VALUE 'ZUW01IWY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01IWY-001.
               CALL 'ZUW01IWY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01IWY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01T2I-002.
