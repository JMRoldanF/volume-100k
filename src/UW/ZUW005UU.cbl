      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW005UU'.
      ...
      * Called module names
       01  MOD-ZUW00CD0              PIC X(8) VALUE 'ZUW00CD0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW00CD0-001.
               PERFORM CALL-ZUW00HTO-002.
               PERFORM CALL-ZBI000RO-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW00CD0-001.
               EXEC CICS LINK PROGRAM('ZUW00CD0')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW00CD0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW00HTO-002.
               MOVE 'ZUW00HTO' TO WS-PROGNAME-4
      ...
      *----------------------------------------------------------------*
       CALL-ZBI000RO-003.
               EXEC CICS START TRANSID('Z0RO')
                         FROM(WS-KEY-AREA)
                         LENGTH(20)
                         RESP(WS-RESP)
               END-EXEC.
      * TRANSID Z0RO is defined against ZBI000RO
               IF WS-RESP NOT = DFHRESP(NORMAL)
