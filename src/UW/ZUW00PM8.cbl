      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00PM8'.
      ...
      * Called module names
       01  MOD-ZUW01PPY              PIC X(8) VALUE 'ZUW01PPY'.
       01  MOD-ZUW01NMY              PIC X(8) VALUE 'ZUW01NMY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01PPY-001.
               PERFORM CALL-ZUW01NMY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01PPY-001.
               CALL 'ZUW01PPY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01PPY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01NMY-002.
               CALL 'ZUW01NMY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01NMY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
