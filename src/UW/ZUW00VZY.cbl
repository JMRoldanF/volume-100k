      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00VZY'.
      ...
      * Called module names
       01  MOD-ZUW01PZE              PIC X(8) VALUE 'ZUW01PZE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01PZE-001.
               CALL 'ZUW01PZE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01PZE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01G94-002.
