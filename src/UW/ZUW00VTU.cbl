      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00VTU'.
      ...
      * Called module names
       01  MOD-ZUW01MXY              PIC X(8) VALUE 'ZUW01MXY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01MXY-001.
               CALL 'ZUW01MXY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01MXY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
