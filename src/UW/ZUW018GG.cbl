      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW018GG'.
      ...
      * Called module names
       01  MOD-ZUW01I9N              PIC X(8) VALUE 'ZUW01I9N'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01I9N-001.
               CALL 'ZUW01I9N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01I9N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
