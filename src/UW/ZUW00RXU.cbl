      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00RXU'.
      ...
      * Called module names
       01  MOD-ZUW01HIY              PIC X(8) VALUE 'ZUW01HIY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01HIY-001.
               PERFORM CALL-ZUW01LEY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01HIY-001.
               CALL 'ZUW01HIY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01HIY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01LEY-002.
