      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00W30'.
      ...
      * Called module names
       01  MOD-ZUW01URC              PIC X(8) VALUE 'ZUW01URC'.
       01  MOD-ZBI01NP2              PIC X(8) VALUE 'ZBI01NP2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01URC-001.
               CALL 'ZUW01URC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01URC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01NP2-002.
               CALL 'ZBI01NP2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01NP2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
