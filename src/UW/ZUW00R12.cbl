      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00R12'.
      ...
      * Called module names
       01  MOD-ZUW01QDU              PIC X(8) VALUE 'ZUW01QDU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01QDU-001.
               CALL 'ZUW01QDU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01QDU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
