      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00X98'.
      ...
      * Called module names
       01  MOD-ZUW01H0M              PIC X(8) VALUE 'ZUW01H0M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01H0M-001.
               CALL 'ZUW01H0M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01H0M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
