      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00RIK'.
      ...
      * Called module names
       01  MOD-ZUW01DZ6              PIC X(8) VALUE 'ZUW01DZ6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01DZ6-001.
               CALL 'ZUW01DZ6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01DZ6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
