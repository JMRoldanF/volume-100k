      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00UBY'.
      ...
      * Called module names
       01  MOD-ZUW01N0Q              PIC X(8) VALUE 'ZUW01N0Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01N0Q-001.
               CALL 'ZUW01N0Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01N0Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
