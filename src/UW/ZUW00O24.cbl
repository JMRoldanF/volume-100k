      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00O24'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01NV0              PIC X(8) VALUE 'ZUW01NV0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01NV0-002.
               CALL 'ZUW01NV0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01NV0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
