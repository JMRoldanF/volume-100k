      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00T8K'.
      ...
      * Called module names
       01  MOD-ZUW01NSJ              PIC X(8) VALUE 'ZUW01NSJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01NSJ-001.
               CALL 'ZUW01NSJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01NSJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
