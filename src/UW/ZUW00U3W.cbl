      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00U3W'.
      ...
      * Called module names
       01  MOD-ZUW01ONC              PIC X(8) VALUE 'ZUW01ONC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01ONC-001.
               CALL 'ZUW01ONC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01ONC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
