      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00ZH9'.
      ...
      * Called module names
       01  MOD-ZUW01QRR              PIC X(8) VALUE 'ZUW01QRR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01QRR-001.
               CALL 'ZUW01QRR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01QRR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
