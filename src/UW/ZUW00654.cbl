      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00654'.
      ...
      * Called module names
       ...
       01  MOD-ZUW0081G              PIC X(8) VALUE 'ZUW0081G'.
       01  MOD-ZBI005WY              PIC X(8) VALUE 'ZBI005WY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW00J6A-001.
               PERFORM CALL-ZUW0081G-002.
               PERFORM CALL-ZBI005WY-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW0081G-002.
               EXEC CICS LINK PROGRAM('ZUW0081G')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW0081G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI005WY-003.
               EXEC CICS XCTL PROGRAM('ZBI005WY')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
