      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00Z32'.
      ...
      * Called module names
       01  MOD-ZUW01HGQ              PIC X(8) VALUE 'ZUW01HGQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01HGQ-001.
               CALL 'ZUW01HGQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01HGQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
