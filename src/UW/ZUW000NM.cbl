      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW000NM'.
      ...
      * Called module names
       01  MOD-ZUW0097E              PIC X(8) VALUE 'ZUW0097E'.
       01  MOD-ZUW004C4              PIC X(8) VALUE 'ZUW004C4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW00FBO-001.
               PERFORM CALL-ZUW0097E-002.
               PERFORM CALL-ZUW004C4-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW00FBO-001.
               MOVE 'ZUW00FBO' TO WS-PROGNAME-3
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW00FBO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW0097E-002.
               EXEC CICS LINK PROGRAM('ZUW0097E')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW004C4-003.
               EXEC CICS XCTL PROGRAM('ZUW004C4')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW004C4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-004.
