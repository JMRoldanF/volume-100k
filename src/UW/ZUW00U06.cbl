      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00U06'.
      ...
      * Called module names
       01  MOD-ZUW01SJA              PIC X(8) VALUE 'ZUW01SJA'.
       01  MOD-ZUW01H6Y              PIC X(8) VALUE 'ZUW01H6Y'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01SJA-001.
               PERFORM CALL-ZUW01H6Y-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01SJA-001.
               CALL 'ZUW01SJA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01SJA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01H6Y-002.
               CALL 'ZUW01H6Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01H6Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
