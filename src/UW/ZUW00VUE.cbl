      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00VUE'.
      ...
      * Called module names
       01  MOD-ZUW01J28              PIC X(8) VALUE 'ZUW01J28'.
       01  MOD-ZUW01PPO              PIC X(8) VALUE 'ZUW01PPO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01J28-001.
               CALL 'ZUW01J28' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01J28 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01PPO-002.
               CALL 'ZUW01PPO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01PPO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
