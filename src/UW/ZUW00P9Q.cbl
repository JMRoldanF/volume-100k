      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00P9Q'.
      ...
      * Called module names
       01  MOD-ZHO01SRG              PIC X(8) VALUE 'ZHO01SRG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01SRG-001.
               PERFORM CALL-ZRE01SC1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01SRG-001.
               CALL 'ZHO01SRG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01SRG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01SC1-002.
