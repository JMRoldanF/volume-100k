      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00PYG'.
      ...
      * Called module names
       01  MOD-ZUW01KCW              PIC X(8) VALUE 'ZUW01KCW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01KCW-001.
               CALL 'ZUW01KCW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01KCW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
