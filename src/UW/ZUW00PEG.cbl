      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00PEG'.
      ...
      * Called module names
       01  MOD-ZUW01V1W              PIC X(8) VALUE 'ZUW01V1W'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01V1W-001.
               CALL 'ZUW01V1W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01V1W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
