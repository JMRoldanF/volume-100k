      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00TWY'.
      ...
      * Called module names
       01  MOD-ZUW01JRI              PIC X(8) VALUE 'ZUW01JRI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01JRI-001.
               CALL 'ZUW01JRI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01JRI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01M8O-002.
