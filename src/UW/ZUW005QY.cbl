      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW005QY'.
      ...
      * Called module names
       ...
       01  MOD-ZCU001GC              PIC X(8) VALUE 'ZCU001GC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW00GV8-001.
               PERFORM CALL-ZUW00FBE-002.
               PERFORM CALL-ZUW00GUY-004.
               PERFORM CALL-ZUW009HE-005.
               PERFORM CALL-ZCU001GC-006.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW00GV8-001.
               MOVE 'ZUW00GV8' TO WS-PROGNAME-7
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW00GV8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW00FBE-002.
               MOVE 'ZUW00FBE' TO WS-PROGNAME-8
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW00FBE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW00CNK-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU001GC-006.
               EXEC CICS XCTL PROGRAM('ZCU001GC')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU001GC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
