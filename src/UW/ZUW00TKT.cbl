      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00TKT'.
      ...
      * Called module names
       01  MOD-ZUW01O48              PIC X(8) VALUE 'ZUW01O48'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01O48-002.
               CALL 'ZUW01O48' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01O48 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
