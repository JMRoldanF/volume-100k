      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00M08'.
      ...
      * Called module names
       01  MOD-ZBI01P5A              PIC X(8) VALUE 'ZBI01P5A'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01P5A-001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZBI01P5A-001.
               CALL 'ZBI01P5A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
