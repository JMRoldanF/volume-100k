      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW0123Y'.
      ...
      * Called module names
       01  MOD-ZUW01ITW              PIC X(8) VALUE 'ZUW01ITW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01ITW-001.
               CALL 'ZUW01ITW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01ITW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01R6G-002.
