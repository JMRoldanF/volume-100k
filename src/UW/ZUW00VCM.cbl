      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW00VCM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM COMPUTE-BEDROOMS-0017.
               PERFORM SQL-ACCESS-0018.
               PERFORM CHECK-BEDROOMS-0019.
               PERFORM REFRESH-BEDROOMS-0020.
               ...
               PERFORM VALIDATE-PREMIUM-0028.
               PERFORM DERIVE-SUM-ASSURED-0029.
               PERFORM SQL-ACCESS-0030.
               PERFORM RESOLVE-TERM-0032.
               ...
               PERFORM REFRESH-MANAGED-FUND-0062.
               ...
               PERFORM AUDIT-WITH-PROFITS-0070.
               ...
               PERFORM CHECK-VALUE-0088.
               PERFORM CHECK-BROKER-ID-0089.
               PERFORM SQL-ACCESS-0090.
               PERFORM REFRESH-POSTCODE-0091.
               ...
               PERFORM CHECK-WITH-PROFITS-0124.
               ...
               PERFORM EXPAND-MANAGED-FUND-0139.
               PERFORM SQL-ACCESS-0141.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZUW01T8M-001.
               MOVE 'ZUW01T8M' TO WS-SUBNAME-8
               CALL WS-SUBNAME-8 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01T8M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       VALIDATE-VALUE-0001.
      ...
      *----------------------------------------------------------------*
       SQL-ACCESS-0138.
               ...
               END-EXEC.
      *----------------------------------------------------------------*
       EXPAND-MANAGED-FUND-0139.
               INSPECT WS-KEY-CHAR REPLACING ALL SPACES BY '0'.
               IF WS-STATUS-FAILED
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-BROKER-ID-0140.
               PERFORM VARYING WS-IX FROM 1 BY 1
                           UNTIL WS-IX > WS-TABLE-COUNT
                  ADD WS-T-AMOUNT(WS-IX) TO WS-PREMIUM-TOTAL
                  IF WS-T-AMOUNT(WS-IX) = ZERO
