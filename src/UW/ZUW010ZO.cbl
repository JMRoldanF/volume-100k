      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW010ZO'.
      ...
      * Called module names
       01  MOD-ZUW01GNA              PIC X(8) VALUE 'ZUW01GNA'.
       01  MOD-ZPA01GUH              PIC X(8) VALUE 'ZPA01GUH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01GNA-001.
               PERFORM CALL-ZPA01GUH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01GNA-001.
               CALL 'ZUW01GNA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01GNA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01GUH-002.
               CALL 'ZPA01GUH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01GUH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
