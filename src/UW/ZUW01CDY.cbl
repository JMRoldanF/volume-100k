      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZUW01CDY'.
      ...
      * Called module names
       01  MOD-ZUW01N9M              PIC X(8) VALUE 'ZUW01N9M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01N9M-001.
               CALL 'ZUW01N9M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01N9M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
