      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00JBI'.
      ...
      * Called module names
       01  MOD-ZAG00U08              PIC X(8) VALUE 'ZAG00U08'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG00U08-001.
               PERFORM CALL-ZUW01PIQ-002.
               PERFORM CALL-ZMT0255L-003.
               PERFORM REFRESH-BROKER-ID-0001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZAG00U08-001.
               EXEC CICS LINK PROGRAM('ZAG00U08')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG00U08 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01PIQ-002.
