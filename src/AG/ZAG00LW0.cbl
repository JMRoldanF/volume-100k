      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00LW0'.
      ...
      * Called module names
       01  MOD-ZAG01GME              PIC X(8) VALUE 'ZAG01GME'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01GME-002.
               CALL 'ZAG01GME' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
