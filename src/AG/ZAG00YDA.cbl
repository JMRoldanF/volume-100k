      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00YDA'.
      ...
      * Called module names
       01  MOD-ZAG01LNL              PIC X(8) VALUE 'ZAG01LNL'.
       01  MOD-ZAG01RQ5              PIC X(8) VALUE 'ZAG01RQ5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01LNL-001.
               PERFORM CALL-ZAG01RQ5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01LNL-001.
               CALL 'ZAG01LNL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01LNL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01RQ5-002.
               CALL 'ZAG01RQ5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01RQ5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
