      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00TRC'.
      ...
      * Called module names
       01  MOD-ZAG01KPM              PIC X(8) VALUE 'ZAG01KPM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01KPM-001.
               PERFORM CALL-ZAG01QXI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01KPM-001.
               CALL 'ZAG01KPM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01KPM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01QXI-002.
