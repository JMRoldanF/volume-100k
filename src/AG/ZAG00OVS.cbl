      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00OVS'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01GEW              PIC X(8) VALUE 'ZAG01GEW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01GEW-002.
               CALL 'ZAG01GEW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01GEW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       NORMALISE-MAKE-0001.
