      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00V8O'.
      ...
      * Called module names
       01  MOD-ZAG01EB2              PIC X(8) VALUE 'ZAG01EB2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01EB2-001.
               CALL 'ZAG01EB2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01EB2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
