      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00WKQ'.
      ...
      * Called module names
       01  MOD-ZAG01FXO              PIC X(8) VALUE 'ZAG01FXO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01FXO-001.
               CALL 'ZAG01FXO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01FXO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
