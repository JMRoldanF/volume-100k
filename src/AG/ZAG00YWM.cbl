      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00YWM'.
      ...
      * Called module names
       01  MOD-ZHO01MCW              PIC X(8) VALUE 'ZHO01MCW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01MCW-001.
               PERFORM CALL-ZCL01IDX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01MCW-001.
               CALL 'ZHO01MCW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01MCW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01IDX-002.
