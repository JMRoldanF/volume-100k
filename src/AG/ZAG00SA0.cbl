      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00SA0'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01GKG              PIC X(8) VALUE 'ZAG01GKG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01GKG-002.
               CALL 'ZAG01GKG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01GKG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
