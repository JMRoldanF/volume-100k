      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00FD6'.
      ...
      * Called module names
       01  MOD-ZAG00ZZO              PIC X(8) VALUE 'ZAG00ZZO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG00ZZO-001.
               EXEC CICS LINK PROGRAM('ZAG00ZZO')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG00ZZO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG00WUO-002.
