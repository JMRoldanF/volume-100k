      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG01BD8'.
      ...
      * Called module names
       01  MOD-ZMT01T5B              PIC X(8) VALUE 'ZMT01T5B'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01T5B-001.
               PERFORM CALL-ZAG01TAI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01T5B-001.
               CALL 'ZMT01T5B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01T5B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01TAI-002.
