      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00XYQ'.
      ...
      * Called module names
       01  MOD-ZAG01R0U              PIC X(8) VALUE 'ZAG01R0U'.
       01  MOD-ZAG01FAM              PIC X(8) VALUE 'ZAG01FAM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01R0U-001.
               PERFORM CALL-ZAG01FAM-002.
               PERFORM CALL-ZAG0255S-003.
               PERFORM RECONCILE-HOUSE-TYPE-0001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZAG01R0U-001.
               CALL 'ZAG01R0U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01R0U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01FAM-002.
               CALL 'ZAG01FAM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01FAM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
