      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00P12'.
      ...
      * Called module names
       01  MOD-ZAG01DPY              PIC X(8) VALUE 'ZAG01DPY'.
       01  MOD-ZAG01GVU              PIC X(8) VALUE 'ZAG01GVU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM REFRESH-MAKE-0107.
               PERFORM SQL-ACCESS-0108.
               PERFORM EXPAND-POSTCODE-0109.
               PERFORM COMPUTE-MANAGED-FUND-0110.
               PERFORM SQL-ACCESS-0111.
               PERFORM VALIDATE-BEDROOMS-0112.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZAG01DPY-001.
               CALL 'ZAG01DPY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01DPY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01GVU-002.
               CALL 'ZAG01GVU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01GVU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
