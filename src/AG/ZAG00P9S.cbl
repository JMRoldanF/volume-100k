      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00P9S'.
      ...
      * Called module names
       01  MOD-ZAG01TH6              PIC X(8) VALUE 'ZAG01TH6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01TH6-001.
               CALL 'ZAG01TH6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01TH6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
