      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00QG6'.
      ...
      * Called module names
       01  MOD-ZAG01HDM              PIC X(8) VALUE 'ZAG01HDM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01HDM-001.
               PERFORM CALL-ZAG01JBW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01HDM-001.
               CALL 'ZAG01HDM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
