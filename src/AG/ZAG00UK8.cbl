      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00UK8'.
      ...
      * Called module names
       01  MOD-ZAG01MKK              PIC X(8) VALUE 'ZAG01MKK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01MKK-001.
               CALL 'ZAG01MKK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01MKK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RECONCILE-MAKE-0001.
