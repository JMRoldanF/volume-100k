      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG001RK'.
      ...
      * Called module names
       01  MOD-ZAG00DH8              PIC X(8) VALUE 'ZAG00DH8'.
       01  MOD-ZAG00ASK              PIC X(8) VALUE 'ZAG00ASK'.
       01  MOD-ZAG00C6A              PIC X(8) VALUE 'ZAG00C6A'.
       01  MOD-ZAG00H9W              PIC X(8) VALUE 'ZAG00H9W'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG00DH8-001.
               PERFORM CALL-ZAG009VI-002.
               PERFORM CALL-ZAG00ASK-003.
               PERFORM CALL-ZAG00C6A-004.
               PERFORM CALL-ZAG00H9W-005.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG00DH8-001.
               EXEC CICS LINK PROGRAM('ZAG00DH8')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG00DH8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG009VI-002.
               MOVE 'ZAG009VI' TO WS-PROGNAME-4
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG009VI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG00ASK-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG00C6A-004.
               EXEC CICS LINK PROGRAM('ZAG00C6A')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG00C6A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG00H9W-005.
               EXEC CICS LINK PROGRAM('ZAG00H9W')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG00H9W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
