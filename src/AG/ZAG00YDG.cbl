      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00YDG'.
      ...
      * Called module names
       01  MOD-ZAG01GE4              PIC X(8) VALUE 'ZAG01GE4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01GE4-001.
               PERFORM CALL-ZAG01F28-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01GE4-001.
               CALL 'ZAG01GE4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01GE4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01F28-002.
