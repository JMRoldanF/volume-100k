      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00LNE'.
      ...
      * Called module names
       01  MOD-ZAG01RXW              PIC X(8) VALUE 'ZAG01RXW'.
       01  MOD-ZAG01HM8              PIC X(8) VALUE 'ZAG01HM8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01RXW-001.
               PERFORM CALL-ZAG01HM8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01RXW-001.
               CALL 'ZAG01RXW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01RXW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01HM8-002.
               CALL 'ZAG01HM8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01HM8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
