      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00YX5'.
      ...
      * Called module names
       01  MOD-ZAG01U2C              PIC X(8) VALUE 'ZAG01U2C'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01U2C-001.
               PERFORM CALL-ZIF01I4E-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01U2C-001.
               CALL 'ZAG01U2C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01U2C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIF01I4E-002.
