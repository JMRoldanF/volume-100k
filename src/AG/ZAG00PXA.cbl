      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00PXA'.
      ...
      * Called module names
       01  MOD-ZUW01MCK              PIC X(8) VALUE 'ZUW01MCK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01MCK-001.
               CALL 'ZUW01MCK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01MCK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
