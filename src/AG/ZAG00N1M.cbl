      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00N1M'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01PIH              PIC X(8) VALUE 'ZAG01PIH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01M4S-001.
               PERFORM CALL-ZAG01PIH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01PIH-002.
               CALL 'ZAG01PIH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01PIH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
