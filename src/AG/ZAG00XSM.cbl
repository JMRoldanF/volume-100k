      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00XSM'.
      ...
      * Called module names
       01  MOD-ZAG01QQA              PIC X(8) VALUE 'ZAG01QQA'.
       01  MOD-ZEN01N27              PIC X(8) VALUE 'ZEN01N27'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01QQA-001.
               PERFORM CALL-ZEN01N27-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01QQA-001.
               CALL 'ZAG01QQA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01N27-002.
               CALL 'ZEN01N27' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01N27 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
