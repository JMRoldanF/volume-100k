      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00NFV'.
      ...
      * Called module names
       01  MOD-ZAG01IGF              PIC X(8) VALUE 'ZAG01IGF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01IGF-001.
               CALL 'ZAG01IGF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01IGF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01JC1-002.
