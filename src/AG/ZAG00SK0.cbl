      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00SK0'.
      ...
      * Called module names
       01  MOD-ZAG01MNW              PIC X(8) VALUE 'ZAG01MNW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01MNW-001.
               CALL 'ZAG01MNW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01MNW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
