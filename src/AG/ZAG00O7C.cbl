      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00O7C'.
      ...
      * Called module names
       01  MOD-ZAG01INQ              PIC X(8) VALUE 'ZAG01INQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01INQ-001.
               PERFORM CALL-ZAG01M5U-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01INQ-001.
               CALL 'ZAG01INQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01INQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01M5U-002.
               MOVE 'ZAG01M5U' TO WS-SUBNAME-4
