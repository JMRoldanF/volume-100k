      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG01CRS'.
      ...
      * Called module names
       01  MOD-ZAG01U98              PIC X(8) VALUE 'ZAG01U98'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01U98-001.
               CALL 'ZAG01U98' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01U98 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
