      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG012LO'.
      ...
      * Called module names
       01  MOD-ZAG01RYG              PIC X(8) VALUE 'ZAG01RYG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01RYG-001.
               CALL 'ZAG01RYG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01RYG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
