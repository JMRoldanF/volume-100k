      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG0128W'.
      ...
      * Called module names
       01  MOD-ZAG01CZA              PIC X(8) VALUE 'ZAG01CZA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01CZA-001.
               CALL 'ZAG01CZA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01CZA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
