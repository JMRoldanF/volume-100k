      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00YOK'.
      ...
      * Called module names
       01  MOD-ZAG01H3C              PIC X(8) VALUE 'ZAG01H3C'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01H3C-001.
               CALL 'ZAG01H3C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01H3C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
