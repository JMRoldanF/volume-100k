      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00O0O'.
      ...
      * Called module names
       01  MOD-ZAG01LJC              PIC X(8) VALUE 'ZAG01LJC'.
       01  MOD-ZAG01QC4              PIC X(8) VALUE 'ZAG01QC4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01LJC-001.
               CALL 'ZAG01LJC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01LJC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01QC4-002.
               CALL 'ZAG01QC4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01QC4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
