      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00XXC'.
      ...
      * Called module names
       01  MOD-ZAG01TVC              PIC X(8) VALUE 'ZAG01TVC'.
       01  MOD-ZMT01OGZ              PIC X(8) VALUE 'ZMT01OGZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01TVC-001.
               PERFORM CALL-ZMT01OGZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01TVC-001.
               CALL 'ZAG01TVC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01TVC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01OGZ-002.
               CALL 'ZMT01OGZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01OGZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-EXCESS-0001.
