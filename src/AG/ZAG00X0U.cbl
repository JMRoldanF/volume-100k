      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00X0U'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01FO8              PIC X(8) VALUE 'ZAG01FO8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01KPC-001.
               PERFORM CALL-ZAG01FO8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01FO8-002.
               CALL 'ZAG01FO8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01FO8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
