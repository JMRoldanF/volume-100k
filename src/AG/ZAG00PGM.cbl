      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00PGM'.
      ...
      * Called module names
       01  MOD-ZAG01LPG              PIC X(8) VALUE 'ZAG01LPG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01LPG-001.
               PERFORM CALL-ZMT0255L-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZAG01LPG-001.
               CALL 'ZAG01LPG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
