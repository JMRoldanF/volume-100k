      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00WE2'.
      ...
      * Called module names
       01  MOD-ZAG01IMW              PIC X(8) VALUE 'ZAG01IMW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01IMW-001.
               CALL 'ZAG01IMW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01IMW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01RKA-002.
