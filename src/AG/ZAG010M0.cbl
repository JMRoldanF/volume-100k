      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG010M0'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01P3E              PIC X(8) VALUE 'ZAG01P3E'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01P3E-002.
               CALL 'ZAG01P3E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01P3E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
