      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00QQ6'.
      ...
      * Called module names
       01  MOD-ZAG01JQC              PIC X(8) VALUE 'ZAG01JQC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01JQC-001.
               CALL 'ZAG01JQC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01JQC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
