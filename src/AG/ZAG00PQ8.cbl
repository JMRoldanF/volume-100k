      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00PQ8'.
      ...
      * Called module names
       01  MOD-ZAG01NJ7              PIC X(8) VALUE 'ZAG01NJ7'.
       01  MOD-ZAG01LNQ              PIC X(8) VALUE 'ZAG01LNQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01NJ7-001.
               PERFORM CALL-ZAG01LNQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01NJ7-001.
               CALL 'ZAG01NJ7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01NJ7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01LNQ-002.
               CALL 'ZAG01LNQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01LNQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
