      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00Y3G'.
      ...
      * Called module names
       01  MOD-ZAG01Q06              PIC X(8) VALUE 'ZAG01Q06'.
       01  MOD-ZAG01GGA              PIC X(8) VALUE 'ZAG01GGA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01Q06-001.
               PERFORM CALL-ZAG01GGA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01Q06-001.
               CALL 'ZAG01Q06' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01Q06 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01GGA-002.
               CALL 'ZAG01GGA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01GGA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
