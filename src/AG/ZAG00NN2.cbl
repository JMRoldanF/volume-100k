      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00NN2'.
      ...
      * Called module names
       01  MOD-ZPA01PCL              PIC X(8) VALUE 'ZPA01PCL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01PCL-001.
               PERFORM CALL-ZAG01PCU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01PCL-001.
               CALL 'ZPA01PCL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01PCL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01PCU-002.
