      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG011VU'.
      ...
      * Called module names
       01  MOD-ZAG01FCA              PIC X(8) VALUE 'ZAG01FCA'.
       01  MOD-ZCU01KWQ              PIC X(8) VALUE 'ZCU01KWQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01FCA-001.
               PERFORM CALL-ZCU01KWQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01FCA-001.
               CALL 'ZAG01FCA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01FCA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01KWQ-002.
               CALL 'ZCU01KWQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01KWQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
