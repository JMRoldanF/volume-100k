      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00MY1'.
      ...
      * Called module names
       01  MOD-ZAG01KMV              PIC X(8) VALUE 'ZAG01KMV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01KMV-001.
               CALL 'ZAG01KMV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01KMV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
