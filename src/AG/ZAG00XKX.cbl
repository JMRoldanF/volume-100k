      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00XKX'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01MN7              PIC X(8) VALUE 'ZAG01MN7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01U1P-001.
               PERFORM CALL-ZAG01MN7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01MN7-002.
               CALL 'ZAG01MN7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01MN7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
