      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00UFS'.
      ...
      * Called module names
       01  MOD-ZAG01T0I              PIC X(8) VALUE 'ZAG01T0I'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01T0I-001.
               CALL 'ZAG01T0I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01T0I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
