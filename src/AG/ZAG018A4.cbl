      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG018A4'.
      ...
      * Called module names
       01  MOD-ZHO01IX0              PIC X(8) VALUE 'ZHO01IX0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01IX0-001.
               CALL 'ZHO01IX0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01IX0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
