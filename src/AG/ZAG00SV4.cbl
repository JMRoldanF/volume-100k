      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00SV4'.
      ...
      * Called module names
       01  MOD-ZAG01UJS              PIC X(8) VALUE 'ZAG01UJS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01UJS-001.
               PERFORM CALL-ZAG01SO0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01UJS-001.
               CALL 'ZAG01UJS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01UJS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01SO0-002.
