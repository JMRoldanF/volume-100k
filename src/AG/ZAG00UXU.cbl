      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00UXU'.
      ...
      * Called module names
       01  MOD-ZAG01LH4              PIC X(8) VALUE 'ZAG01LH4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01LH4-001.
               CALL 'ZAG01LH4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01LH4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
