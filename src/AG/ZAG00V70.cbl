      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00V70'.
      ...
      * Called module names
       01  MOD-ZAG01Q56              PIC X(8) VALUE 'ZAG01Q56'.
       01  MOD-ZAG01SD6              PIC X(8) VALUE 'ZAG01SD6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01Q56-001.
               PERFORM CALL-ZAG01SD6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01Q56-001.
               CALL 'ZAG01Q56' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01Q56 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01SD6-002.
               CALL 'ZAG01SD6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01SD6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
