      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00P7Q'.
      ...
      * Called module names
       01  MOD-ZPA01EE5              PIC X(8) VALUE 'ZPA01EE5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01EE5-001.
               CALL 'ZPA01EE5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01EE5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01LBU-002.
