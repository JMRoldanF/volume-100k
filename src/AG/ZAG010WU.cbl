      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG010WU'.
      ...
      * Called module names
       01  MOD-ZAG01GK6              PIC X(8) VALUE 'ZAG01GK6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01GK6-001.
               CALL 'ZAG01GK6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01GK6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01E3A-002.
