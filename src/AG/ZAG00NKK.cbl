      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00NKK'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01Q6Z              PIC X(8) VALUE 'ZAG01Q6Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01Q6Z-002.
               CALL 'ZAG01Q6Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01Q6Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
