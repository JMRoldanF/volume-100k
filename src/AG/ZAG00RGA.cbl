      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00RGA'.
      ...
      * Called module names
       01  MOD-ZAG01N04              PIC X(8) VALUE 'ZAG01N04'.
       01  MOD-ZAG01DB8              PIC X(8) VALUE 'ZAG01DB8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01N04-001.
               CALL 'ZAG01N04' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01N04 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01DB8-002.
               CALL 'ZAG01DB8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01DB8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
