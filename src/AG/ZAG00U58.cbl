      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00U58'.
      ...
      * Called module names
       01  MOD-ZAG01RRI              PIC X(8) VALUE 'ZAG01RRI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01RRI-001.
               CALL 'ZAG01RRI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01RRI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
