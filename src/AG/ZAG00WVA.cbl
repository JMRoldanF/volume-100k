      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00WVA'.
      ...
      * Called module names
       01  MOD-ZAG01S1I              PIC X(8) VALUE 'ZAG01S1I'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01S1I-001.
               PERFORM CALL-ZAG01NNQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01S1I-001.
               CALL 'ZAG01S1I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
