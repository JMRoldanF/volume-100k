      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00TKY'.
      ...
      * Called module names
       01  MOD-ZAG01RC8              PIC X(8) VALUE 'ZAG01RC8'.
       01  MOD-ZAG01LL0              PIC X(8) VALUE 'ZAG01LL0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01RC8-001.
               PERFORM CALL-ZAG01LL0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01RC8-001.
               CALL 'ZAG01RC8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01RC8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01LL0-002.
               CALL 'ZAG01LL0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01LL0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-MODEL-0001.
