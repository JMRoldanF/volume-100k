      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG0126M'.
      ...
      * Called module names
       01  MOD-ZAG01L35              PIC X(8) VALUE 'ZAG01L35'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01L35-001.
               CALL 'ZAG01L35' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01L35 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
