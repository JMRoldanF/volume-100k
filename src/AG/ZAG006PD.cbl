      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG006PD'.
      ...
      * Called module names
       01  MOD-ZAG00XBY              PIC X(8) VALUE 'ZAG00XBY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG00XBY-001.
               EXEC CICS LINK PROGRAM('ZAG00XBY')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG00XBY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
