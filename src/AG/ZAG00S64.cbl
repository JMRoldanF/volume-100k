      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00S64'.
      ...
      * Called module names
       01  MOD-ZAG01S7C              PIC X(8) VALUE 'ZAG01S7C'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01S7C-001.
               PERFORM CALL-ZAG01V38-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01S7C-001.
               CALL 'ZAG01S7C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01S7C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01V38-002.
