      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG0113I'.
      ...
      * Called module names
       01  MOD-ZUW01J6Y              PIC X(8) VALUE 'ZUW01J6Y'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01J6Y-001.
               CALL 'ZUW01J6Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01J6Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
