      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00Y6I'.
      ...
      * Called module names
       01  MOD-ZAG01SEK              PIC X(8) VALUE 'ZAG01SEK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01SEK-001.
               CALL 'ZAG01SEK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01SEK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
