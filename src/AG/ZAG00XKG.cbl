      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00XKG'.
      ...
      * Called module names
       01  MOD-ZAG01RQA              PIC X(8) VALUE 'ZAG01RQA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01RQA-001.
               PERFORM CALL-ZAG01N34-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01RQA-001.
               CALL 'ZAG01RQA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
