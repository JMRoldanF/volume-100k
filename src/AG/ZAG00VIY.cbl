      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00VIY'.
      ...
      * Called module names
       01  MOD-ZAG01M1O              PIC X(8) VALUE 'ZAG01M1O'.
       01  MOD-ZUW01PXG              PIC X(8) VALUE 'ZUW01PXG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01M1O-001.
               PERFORM CALL-ZUW01PXG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01M1O-001.
               CALL 'ZAG01M1O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01M1O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01PXG-002.
               CALL 'ZUW01PXG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01PXG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
