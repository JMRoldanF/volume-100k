      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00MTP'.
      ...
      * Called module names
       01  MOD-ZAG01D24              PIC X(8) VALUE 'ZAG01D24'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAC01DAV-001.
               PERFORM CALL-ZAG01D24-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZAC01DAV-001.
               MOVE 'ZAC01DAV' TO WS-SUBNAME-4
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01D24-002.
               CALL 'ZAG01D24' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01D24 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       WRITE-ERROR-MESSAGE.
