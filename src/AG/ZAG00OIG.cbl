      ...
      * Called module names
       01  MOD-ZAG01RS0              PIC X(8) VALUE 'ZAG01RS0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01RS0-001.
               PERFORM CALL-ZAG01CZ8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01RS0-001.
               CALL 'ZAG01RS0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01RS0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01CZ8-002.
