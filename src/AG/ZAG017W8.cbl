      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG017W8'.
      ...
      * Called module names
       01  MOD-ZAG01UCA              PIC X(8) VALUE 'ZAG01UCA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01UCA-001.
               CALL 'ZAG01UCA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01UCA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
