      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00PNK'.
      ...
      * Called module names
       01  MOD-ZHO01K4M              PIC X(8) VALUE 'ZHO01K4M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01K4M-001.
               CALL 'ZHO01K4M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01K4M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
