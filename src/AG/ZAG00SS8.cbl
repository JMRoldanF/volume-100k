      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00SS8'.
      ...
      * Called module names
       01  MOD-ZAG01KPY              PIC X(8) VALUE 'ZAG01KPY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01KPY-001.
               PERFORM CALL-ZAC01OJR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01KPY-001.
               CALL 'ZAG01KPY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01KPY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAC01OJR-002.
               MOVE 'ZAC01OJR' TO WS-SUBNAME-8
