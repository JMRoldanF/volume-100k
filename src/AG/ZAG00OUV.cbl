      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00OUV'.
      ...
      * Called module names
       01  MOD-ZAG01J5W              PIC X(8) VALUE 'ZAG01J5W'.
       01  MOD-ZAC01OS4              PIC X(8) VALUE 'ZAC01OS4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01J5W-001.
               PERFORM CALL-ZAC01OS4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01J5W-001.
               CALL 'ZAG01J5W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01J5W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAC01OS4-002.
               CALL 'ZAC01OS4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01OS4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
