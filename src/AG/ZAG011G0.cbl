      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG011G0'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01GEC              PIC X(8) VALUE 'ZAG01GEC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01SZ4-001.
               PERFORM CALL-ZAG01GEC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01GEC-002.
               CALL 'ZAG01GEC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01GEC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
