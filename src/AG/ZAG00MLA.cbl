      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00MLA'.
      ...
      * Called module names
       01  MOD-ZAG01MDW              PIC X(8) VALUE 'ZAG01MDW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01MDW-001.
               CALL 'ZAG01MDW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01MDW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
