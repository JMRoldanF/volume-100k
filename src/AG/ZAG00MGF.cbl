      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00MGF'.
      ...
      * Called module names
       01  MOD-ZAG01EBI              PIC X(8) VALUE 'ZAG01EBI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01EBI-001.
               CALL 'ZAG01EBI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01EBI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
