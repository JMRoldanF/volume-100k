      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00X6O'.
      ...
      * Called module names
       01  MOD-ZAG01JIK              PIC X(8) VALUE 'ZAG01JIK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01JIK-001.
               CALL 'ZAG01JIK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01JIK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
