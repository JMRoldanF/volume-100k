      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00X1L'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01P2X              PIC X(8) VALUE 'ZAG01P2X'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIF01EJ5-001.
               PERFORM CALL-ZAG01P2X-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01P2X-002.
               CALL 'ZAG01P2X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01P2X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-VALUE-0001.
