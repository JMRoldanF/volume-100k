      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00X6M'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01PQ6              PIC X(8) VALUE 'ZAG01PQ6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAC01TER-001.
               PERFORM CALL-ZAG01PQ6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01PQ6-002.
               CALL 'ZAG01PQ6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01PQ6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
