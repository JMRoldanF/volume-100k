      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00TWW'.
      ...
      * Called module names
       01  MOD-ZAG01EJO              PIC X(8) VALUE 'ZAG01EJO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01EJO-001.
               CALL 'ZAG01EJO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01EJO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
