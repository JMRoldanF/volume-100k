      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00VUC'.
      ...
      * Called module names
       01  MOD-ZAG01MHI              PIC X(8) VALUE 'ZAG01MHI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01MHI-001.
               CALL 'ZAG01MHI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01MHI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-BEDROOMS-0001.
