      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG011VK'.
      ...
      * Called module names
       01  MOD-ZAG01QBU              PIC X(8) VALUE 'ZAG01QBU'.
       01  MOD-ZAG01HC8              PIC X(8) VALUE 'ZAG01HC8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01QBU-001.
               PERFORM CALL-ZAG01HC8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01QBU-001.
               CALL 'ZAG01QBU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01QBU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01HC8-002.
               CALL 'ZAG01HC8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01HC8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
