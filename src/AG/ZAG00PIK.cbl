      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00PIK'.
      ...
      * Called module names
       01  MOD-ZAG01GJM              PIC X(8) VALUE 'ZAG01GJM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01GJM-001.
               CALL 'ZAG01GJM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01GJM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
