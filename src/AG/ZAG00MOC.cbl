      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00MOC'.
      ...
      * Called module names
       01  MOD-ZAG01GUQ              PIC X(8) VALUE 'ZAG01GUQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01GUQ-001.
               CALL 'ZAG01GUQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01GUQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
