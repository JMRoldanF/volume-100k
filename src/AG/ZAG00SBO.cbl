      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00SBO'.
      ...
      * Called module names
       01  MOD-ZAG01K0C              PIC X(8) VALUE 'ZAG01K0C'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01K0C-001.
               CALL 'ZAG01K0C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01K0C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
