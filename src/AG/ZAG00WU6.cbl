      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00WU6'.
      ...
      * Called module names
       01  MOD-ZBI01O2Y              PIC X(8) VALUE 'ZBI01O2Y'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01O2Y-001.
               CALL 'ZBI01O2Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01O2Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
