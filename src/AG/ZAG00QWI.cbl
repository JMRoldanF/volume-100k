      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00QWI'.
      ...
      * Called module names
       01  MOD-ZAG01GIV              PIC X(8) VALUE 'ZAG01GIV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01GIV-001.
               CALL 'ZAG01GIV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01GIV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
