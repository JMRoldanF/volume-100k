      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00T72'.
      ...
      * Called module names
       01  MOD-ZAG01KEI              PIC X(8) VALUE 'ZAG01KEI'.
       01  MOD-ZAG01UHK              PIC X(8) VALUE 'ZAG01UHK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01KEI-001.
               PERFORM CALL-ZAG01UHK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01KEI-001.
               CALL 'ZAG01KEI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01KEI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01UHK-002.
               CALL 'ZAG01UHK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01UHK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
