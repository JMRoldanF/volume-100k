      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00PV2'.
      ...
      * Called module names
       01  MOD-ZAG01SDG              PIC X(8) VALUE 'ZAG01SDG'.
       01  MOD-ZAG01DEA              PIC X(8) VALUE 'ZAG01DEA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01SDG-001.
               CALL 'ZAG01SDG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01DEA-002.
               CALL 'ZAG01DEA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01DEA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-EXCESS-0001.
