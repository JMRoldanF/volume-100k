      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00Y7M'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01PES              PIC X(8) VALUE 'ZAG01PES'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01PES-002.
               CALL 'ZAG01PES' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01PES FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
