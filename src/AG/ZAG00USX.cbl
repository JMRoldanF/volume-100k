      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00USX'.
      ...
      * Called module names
       01  MOD-ZAG01PBM              PIC X(8) VALUE 'ZAG01PBM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01PBM-001.
               CALL 'ZAG01PBM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01PBM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
