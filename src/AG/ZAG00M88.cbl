      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00M88'.
      ...
      * Called module names
       01  MOD-ZAG01FLQ              PIC X(8) VALUE 'ZAG01FLQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01FLQ-001.
               PERFORM CALL-ZAG01FPM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01FLQ-001.
               CALL 'ZAG01FLQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01FLQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01FPM-002.
