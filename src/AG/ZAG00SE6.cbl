      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00SE6'.
      ...
      * Called module names
       01  MOD-ZUW01O8W              PIC X(8) VALUE 'ZUW01O8W'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01O8W-001.
               CALL 'ZUW01O8W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01O8W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-COLOUR-0001.
