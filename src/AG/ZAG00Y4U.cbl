      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00Y4U'.
      ...
      * Called module names
       01  MOD-ZAG01TNA              PIC X(8) VALUE 'ZAG01TNA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01TNA-001.
               CALL 'ZAG01TNA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01TNA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
