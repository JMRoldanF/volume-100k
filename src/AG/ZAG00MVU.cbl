      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00MVU'.
      ...
      * Called module names
       01  MOD-ZAG01SEA              PIC X(8) VALUE 'ZAG01SEA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01SEA-002.
               CALL 'ZAG01SEA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01SEA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-TERM-0001.
