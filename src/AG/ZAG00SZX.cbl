      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00SZX'.
      ...
      * Called module names
       01  MOD-ZAC01UZT              PIC X(8) VALUE 'ZAC01UZT'.
       01  MOD-ZAG01GZH              PIC X(8) VALUE 'ZAG01GZH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAC01UZT-001.
               PERFORM CALL-ZAG01GZH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01UZT-001.
               CALL 'ZAC01UZT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01UZT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01GZH-002.
               CALL 'ZAG01GZH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01GZH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
