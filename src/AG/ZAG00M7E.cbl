      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00M7E'.
      ...
      * Called module names
       01  MOD-ZAG01F3E              PIC X(8) VALUE 'ZAG01F3E'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01F3E-001.
               CALL 'ZAG01F3E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01F3E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
