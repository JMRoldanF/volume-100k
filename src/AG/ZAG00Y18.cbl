      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00Y18'.
      ...
      * Called module names
       01  MOD-ZAG01MEV              PIC X(8) VALUE 'ZAG01MEV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01MEV-001.
               CALL 'ZAG01MEV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01MEV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
