      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG010FM'.
      ...
      * Called module names
       01  MOD-ZAG01MPA              PIC X(8) VALUE 'ZAG01MPA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01MPA-001.
               CALL 'ZAG01MPA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01MPA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
