      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00O90'.
      ...
      * Called module names
       01  MOD-ZAG01GTW              PIC X(8) VALUE 'ZAG01GTW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01GTW-001.
               CALL 'ZAG01GTW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01GTW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
