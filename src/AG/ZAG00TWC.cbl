      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00TWC'.
      ...
      * Called module names
       01  MOD-ZRE01EA7              PIC X(8) VALUE 'ZRE01EA7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01EA7-001.
               PERFORM CALL-ZAG01G1K-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01EA7-001.
               CALL 'ZRE01EA7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01EA7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01G1K-002.
