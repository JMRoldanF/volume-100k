      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00YCW'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01F2U              PIC X(8) VALUE 'ZAG01F2U'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01O8D-001.
               PERFORM CALL-ZAG01F2U-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01F2U-002.
               CALL 'ZAG01F2U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
