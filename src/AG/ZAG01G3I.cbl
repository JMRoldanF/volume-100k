      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG01G3I'.
      ...
      * Called module names
       01  MOD-ZAG01TX0              PIC X(8) VALUE 'ZAG01TX0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01TX0-001.
               CALL 'ZAG01TX0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01TX0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
