      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00V1Q'.
      ...
      * Called module names
       01  MOD-ZAG01GTM              PIC X(8) VALUE 'ZAG01GTM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01GTM-001.
               CALL 'ZAG01GTM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01GTM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
