      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00QT8'.
      ...
      * Called module names
       01  MOD-ZCL01H4N              PIC X(8) VALUE 'ZCL01H4N'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01H4N-001.
               CALL 'ZCL01H4N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01H4N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
