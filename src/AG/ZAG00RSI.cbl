      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00RSI'.
      ...
      * Called module names
       01  MOD-ZAG01DMC              PIC X(8) VALUE 'ZAG01DMC'.
       01  MOD-ZBI01GHW              PIC X(8) VALUE 'ZBI01GHW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01DMC-001.
               PERFORM CALL-ZBI01GHW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01DMC-001.
               CALL 'ZAG01DMC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01DMC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01GHW-002.
               CALL 'ZBI01GHW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01GHW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
