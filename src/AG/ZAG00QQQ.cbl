      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00QQQ'.
      ...
      * Called module names
       01  MOD-ZAG01P7U              PIC X(8) VALUE 'ZAG01P7U'.
       01  MOD-ZAG01URU              PIC X(8) VALUE 'ZAG01URU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01P7U-001.
               PERFORM CALL-ZAG01URU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01P7U-001.
               CALL 'ZAG01P7U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01P7U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01URU-002.
               CALL 'ZAG01URU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01URU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
