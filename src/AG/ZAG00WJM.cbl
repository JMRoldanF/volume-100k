      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00WJM'.
      ...
      * Called module names
       01  MOD-ZAG01STU              PIC X(8) VALUE 'ZAG01STU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01STU-001.
               CALL 'ZAG01STU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01STU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
