      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00TZY'.
      ...
      * Called module names
       01  MOD-ZAG01MQY              PIC X(8) VALUE 'ZAG01MQY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01MQY-001.
               CALL 'ZAG01MQY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01MQY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
