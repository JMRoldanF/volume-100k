      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00M60'.
      ...
      * Called module names
       01  MOD-ZAG01QCY              PIC X(8) VALUE 'ZAG01QCY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01QCY-001.
               PERFORM CALL-ZAG01J7G-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01QCY-001.
               CALL 'ZAG01QCY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01QCY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01J7G-002.
