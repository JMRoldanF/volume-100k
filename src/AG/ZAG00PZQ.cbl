      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00PZQ'.
      ...
      * Called module names
       01  MOD-ZAC01N52              PIC X(8) VALUE 'ZAC01N52'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAC01N52-001.
               PERFORM CALL-ZAG01JTA-002.
               PERFORM CALL-ZCL0255P-003.
               PERFORM RECONCILE-AGENT-CODE-0001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZAC01N52-001.
               CALL 'ZAC01N52' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01N52 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01JTA-002.
