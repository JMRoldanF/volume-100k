      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00SOO'.
      ...
      * Called module names
       01  MOD-ZAG01J0T              PIC X(8) VALUE 'ZAG01J0T'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01P6I-001.
               PERFORM CALL-ZAG01J0T-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01J0T-002.
               CALL 'ZAG01J0T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01J0T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
