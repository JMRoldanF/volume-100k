      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG009QI'.
      ...
      * Called module names
       01  MOD-ZAG00M60              PIC X(8) VALUE 'ZAG00M60'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG00M60-001.
               EXEC CICS LINK PROGRAM('ZAG00M60')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG00M60 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
