      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00LR1'.
      ...
      * Called module names
       01  MOD-ZAG01QS7              PIC X(8) VALUE 'ZAG01QS7'.
       01  MOD-ZAC01KGY              PIC X(8) VALUE 'ZAC01KGY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01QS7-001.
               PERFORM CALL-ZAC01KGY-002.
               ...
               PERFORM RESOLVE-BEDROOMS-0121.
               PERFORM RECONCILE-BROKER-ID-0122.
               PERFORM SQL-ACCESS-0123.
               PERFORM DERIVE-TERM-0124.
               PERFORM APPLY-NCD-YEARS-0125.
               PERFORM COMPUTE-REG-NUMBER-0127.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01QS7-001.
               CALL 'ZAG01QS7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01QS7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAC01KGY-002.
               CALL 'ZAC01KGY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01KGY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
