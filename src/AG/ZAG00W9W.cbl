      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00W9W'.
      ...
      * Called module names
       01  MOD-ZAG01FK2              PIC X(8) VALUE 'ZAG01FK2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01FK2-002.
               CALL 'ZAG01FK2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01FK2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
