      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00OD5'.
      ...
      * Called module names
       01  MOD-ZAG01OF9              PIC X(8) VALUE 'ZAG01OF9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01OF9-001.
               CALL 'ZAG01OF9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01OF9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
