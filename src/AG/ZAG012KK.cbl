      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG012KK'.
      ...
      * Called module names
       01  MOD-ZAG01UY8              PIC X(8) VALUE 'ZAG01UY8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01UY8-001.
               CALL 'ZAG01UY8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01UY8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
