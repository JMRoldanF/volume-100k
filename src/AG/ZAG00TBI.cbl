      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00TBI'.
      ...
      * Called module names
       01  MOD-ZAG01GX8              PIC X(8) VALUE 'ZAG01GX8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01GX8-001.
               CALL 'ZAG01GX8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01GX8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
