      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00NUL'.
      ...
      * Called module names
       01  MOD-ZAG01FUI              PIC X(8) VALUE 'ZAG01FUI'.
       01  MOD-ZAG01FJQ              PIC X(8) VALUE 'ZAG01FJQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01FUI-001.
               PERFORM CALL-ZAG01FJQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01FUI-001.
               CALL 'ZAG01FUI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01FUI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01FJQ-002.
               CALL 'ZAG01FJQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01FJQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       VALIDATE-VALUE-0001.
