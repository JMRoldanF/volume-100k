      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00S96'.
      ...
      * Called module names
       01  MOD-ZBI01IBQ              PIC X(8) VALUE 'ZBI01IBQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01IBQ-001.
               CALL 'ZBI01IBQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01IBQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
