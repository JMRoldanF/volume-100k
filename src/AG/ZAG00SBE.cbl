      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00SBE'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01TXK              PIC X(8) VALUE 'ZAG01TXK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01TXK-002.
               CALL 'ZAG01TXK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01TXK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
