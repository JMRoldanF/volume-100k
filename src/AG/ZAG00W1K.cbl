      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00W1K'.
      ...
      * Called module names
       01  MOD-ZAG01H2I              PIC X(8) VALUE 'ZAG01H2I'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01H2I-001.
               CALL 'ZAG01H2I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01H2I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
