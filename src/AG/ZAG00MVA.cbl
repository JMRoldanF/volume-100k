      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00MVA'.
      ...
      * Called module names
       01  MOD-ZAG01FTI              PIC X(8) VALUE 'ZAG01FTI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01FTI-001.
               PERFORM CALL-ZEN01U1B-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01FTI-001.
               CALL 'ZAG01FTI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01FTI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01U1B-002.
