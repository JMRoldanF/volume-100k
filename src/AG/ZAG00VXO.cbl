      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00VXO'.
      ...
      * Called module names
       01  MOD-ZAG01OB2              PIC X(8) VALUE 'ZAG01OB2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01OB2-001.
               PERFORM CALL-ZAG01J1C-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01OB2-001.
               CALL 'ZAG01OB2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01OB2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01J1C-002.
