      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00THC'.
      ...
      * Called module names
       01  MOD-ZAG01SW2              PIC X(8) VALUE 'ZAG01SW2'.
       01  MOD-ZAG01GT2              PIC X(8) VALUE 'ZAG01GT2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01SW2-001.
               PERFORM CALL-ZAG01GT2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01SW2-001.
               CALL 'ZAG01SW2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01SW2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01GT2-002.
               CALL 'ZAG01GT2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01GT2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-MAKE-0001.
