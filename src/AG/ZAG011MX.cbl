      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG011MX'.
      ...
      * Called module names
       01  MOD-ZIF01DI5              PIC X(8) VALUE 'ZIF01DI5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIF01DI5-001.
               CALL 'ZIF01DI5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIF01DI5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
