      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00RME'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01KC0              PIC X(8) VALUE 'ZAG01KC0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01DOS-001.
               PERFORM CALL-ZAG01KC0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01KC0-002.
               CALL 'ZAG01KC0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01KC0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
