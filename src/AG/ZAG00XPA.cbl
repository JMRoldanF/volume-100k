      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00XPA'.
      ...
      * Called module names
       01  MOD-ZAG01JUI              PIC X(8) VALUE 'ZAG01JUI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01JUI-001.
               CALL 'ZAG01JUI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01JUI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
