      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00ZCG'.
      ...
      * Called module names
       01  MOD-ZAG01JN0              PIC X(8) VALUE 'ZAG01JN0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01JN0-001.
               CALL 'ZAG01JN0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01JN0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01TXU-002.
               MOVE 'ZAG01TXU' TO WS-SUBNAME-8
