      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00PZ8'.
      ...
      * Called module names
       01  MOD-ZAG01UPW              PIC X(8) VALUE 'ZAG01UPW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01UPW-001.
               PERFORM CALL-ZAG01TI0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01UPW-001.
               CALL 'ZAG01UPW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01UPW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01TI0-002.
