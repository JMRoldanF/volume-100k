      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG0119W'.
      ...
      * Called module names
       01  MOD-ZAG01FXE              PIC X(8) VALUE 'ZAG01FXE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01FXE-001.
               PERFORM CALL-ZAG01PT8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01FXE-001.
               CALL 'ZAG01FXE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01FXE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01PT8-002.
