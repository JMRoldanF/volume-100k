      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00W5Q'.
      ...
      * Called module names
       01  MOD-ZAG01MNM              PIC X(8) VALUE 'ZAG01MNM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01MNM-001.
               PERFORM CALL-ZAG01H32-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01MNM-001.
               CALL 'ZAG01MNM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01MNM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01H32-002.
