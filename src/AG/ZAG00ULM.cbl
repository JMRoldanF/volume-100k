      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00ULM'.
      ...
      * Called module names
       01  MOD-ZBI01MAS              PIC X(8) VALUE 'ZBI01MAS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01MAS-001.
               CALL 'ZBI01MAS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01MAS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
