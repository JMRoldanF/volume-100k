      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00QS4'.
      ...
      * Called module names
       01  MOD-ZAG01F02              PIC X(8) VALUE 'ZAG01F02'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01F02-001.
               CALL 'ZAG01F02' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01F02 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
