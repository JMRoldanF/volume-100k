      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00UZ8'.
      ...
      * Called module names
       01  MOD-ZAG01LEW              PIC X(8) VALUE 'ZAG01LEW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01LEW-001.
               CALL 'ZAG01LEW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01LEW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
