      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG010N4'.
      ...
      * Called module names
       01  MOD-ZAG01NKO              PIC X(8) VALUE 'ZAG01NKO'.
       01  MOD-ZAG01OXA              PIC X(8) VALUE 'ZAG01OXA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01NKO-001.
               PERFORM CALL-ZAG01OXA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01NKO-001.
               CALL 'ZAG01NKO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01NKO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01OXA-002.
               CALL 'ZAG01OXA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01OXA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
