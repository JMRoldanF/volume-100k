      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00OHC'.
      ...
      * Called module names
       01  MOD-ZEN01H3H              PIC X(8) VALUE 'ZEN01H3H'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01H3H-001.
               CALL 'ZEN01H3H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01H3H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
