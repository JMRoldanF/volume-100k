      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00QRU'.
      ...
      * Called module names
       01  MOD-ZAG01SSQ              PIC X(8) VALUE 'ZAG01SSQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01SSQ-001.
               CALL 'ZAG01SSQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01SSQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01E2G-002.
