      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00ZK8'.
      ...
      * Called module names
       01  MOD-ZAG01JFS              PIC X(8) VALUE 'ZAG01JFS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01JFS-001.
               CALL 'ZAG01JFS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01JFS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
