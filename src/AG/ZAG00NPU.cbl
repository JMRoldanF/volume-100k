      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00NPU'.
      ...
      * Called module names
       01  MOD-ZAG01DKY              PIC X(8) VALUE 'ZAG01DKY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01DKY-001.
               CALL 'ZAG01DKY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01DKY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
