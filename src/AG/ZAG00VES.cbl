      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00VES'.
      ...
      * Called module names
       01  MOD-ZAG01NSG              PIC X(8) VALUE 'ZAG01NSG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01NSG-001.
               CALL 'ZAG01NSG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01NSG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
