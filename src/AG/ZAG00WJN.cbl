      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00WJN'.
      ...
      * Called module names
       01  MOD-ZAG01L6V              PIC X(8) VALUE 'ZAG01L6V'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01L6V-001.
               PERFORM CALL-ZAC01FGX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01L6V-001.
               CALL 'ZAG01L6V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01L6V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAC01FGX-002.
               MOVE 'ZAC01FGX' TO WS-SUBNAME-6
