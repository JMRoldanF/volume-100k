      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00PQM'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01KJI              PIC X(8) VALUE 'ZAG01KJI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01L21-001.
               PERFORM CALL-ZAG01KJI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01KJI-002.
               CALL 'ZAG01KJI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01KJI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
