      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00YCK'.
      ...
      * Called module names
       01  MOD-ZAG01MSN              PIC X(8) VALUE 'ZAG01MSN'.
       01  MOD-ZAG01SNS              PIC X(8) VALUE 'ZAG01SNS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01MSN-001.
               PERFORM CALL-ZAG01SNS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01MSN-001.
               CALL 'ZAG01MSN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01MSN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01SNS-002.
               CALL 'ZAG01SNS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01SNS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
