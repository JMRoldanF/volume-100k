      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG012JQ'.
      ...
      * Called module names
       01  MOD-ZAG01R8C              PIC X(8) VALUE 'ZAG01R8C'.
       01  MOD-ZAG01TV2              PIC X(8) VALUE 'ZAG01TV2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01R8C-001.
               PERFORM CALL-ZAG01TV2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01R8C-001.
               CALL 'ZAG01R8C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01R8C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01TV2-002.
               CALL 'ZAG01TV2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01TV2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
