      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00X2S'.
      ...
      * Called module names
       01  MOD-ZAG01IC2              PIC X(8) VALUE 'ZAG01IC2'.
       01  MOD-ZAG01KJ8              PIC X(8) VALUE 'ZAG01KJ8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01IC2-001.
               PERFORM CALL-ZAG01KJ8-002.
               ...
               PERFORM EXPAND-STATUS-CODE-0038.
               ...
               PERFORM REFRESH-BEDROOMS-0103.
               PERFORM DERIVE-TERM-0104.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZAG01IC2-001.
               CALL 'ZAG01IC2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01IC2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01KJ8-002.
               CALL 'ZAG01KJ8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01KJ8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-MODEL-0001.
