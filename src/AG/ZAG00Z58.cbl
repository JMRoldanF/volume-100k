      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00Z58'.
      ...
      * Called module names
       01  MOD-ZAG01KWK              PIC X(8) VALUE 'ZAG01KWK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01KWK-001.
               CALL 'ZAG01KWK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01KWK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
