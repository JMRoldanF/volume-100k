      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00XFK'.
      ...
      * Called module names
       01  MOD-ZHO01RFO              PIC X(8) VALUE 'ZHO01RFO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01RFO-001.
               PERFORM CALL-ZAG01R14-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01RFO-001.
               CALL 'ZHO01RFO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01RFO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01R14-002.
