      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG0166U'.
      ...
      * Called module names
       01  MOD-ZAG01GI8              PIC X(8) VALUE 'ZAG01GI8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01GI8-001.
               CALL 'ZAG01GI8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01GI8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01OSA-002.
