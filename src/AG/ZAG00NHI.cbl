      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00NHI'.
      ...
      * Called module names
       01  MOD-ZAG01I7M              PIC X(8) VALUE 'ZAG01I7M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01I7M-001.
               CALL 'ZAG01I7M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01I7M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
