      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00X8C'.
      ...
      * Called module names
       01  MOD-ZAG01E5S              PIC X(8) VALUE 'ZAG01E5S'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01E5S-001.
               PERFORM CALL-ZAG01GQU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01E5S-001.
               CALL 'ZAG01E5S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01E5S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01GQU-002.
