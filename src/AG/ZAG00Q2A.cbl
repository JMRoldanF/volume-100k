      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00Q2A'.
      ...
      * Called module names
       01  MOD-ZAG01IWW              PIC X(8) VALUE 'ZAG01IWW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01IWW-001.
               CALL 'ZAG01IWW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01IWW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
