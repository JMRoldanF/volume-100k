      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00UHQ'.
      ...
      * Called module names
       01  MOD-ZAG01IEA              PIC X(8) VALUE 'ZAG01IEA'.
       01  MOD-ZAG01LA6              PIC X(8) VALUE 'ZAG01LA6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01IEA-001.
               PERFORM CALL-ZAG01LA6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01IEA-001.
               CALL 'ZAG01IEA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01IEA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01LA6-002.
               CALL 'ZAG01LA6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01LA6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-VALUE-0001.
