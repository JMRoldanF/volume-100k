      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00MIW'.
      ...
      * Called module names
       01  MOD-ZIF01OXM              PIC X(8) VALUE 'ZIF01OXM'.
       01  MOD-ZAG01GKZ              PIC X(8) VALUE 'ZAG01GKZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIF01OXM-001.
               PERFORM CALL-ZAG01GKZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZIF01OXM-001.
               CALL 'ZIF01OXM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIF01OXM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01GKZ-002.
               CALL 'ZAG01GKZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01GKZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
