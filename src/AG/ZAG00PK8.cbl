      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00PK8'.
      ...
      * Called module names
       01  MOD-ZAG01QZQ              PIC X(8) VALUE 'ZAG01QZQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01QZQ-001.
               PERFORM CALL-ZAG01PNY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01QZQ-001.
               CALL 'ZAG01QZQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01QZQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01PNY-002.
               MOVE 'ZAG01PNY' TO WS-SUBNAME-1
