      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00SQE'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01OKI              PIC X(8) VALUE 'ZAG01OKI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01OKI-002.
               CALL 'ZAG01OKI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01OKI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-POSTCODE-0001.
