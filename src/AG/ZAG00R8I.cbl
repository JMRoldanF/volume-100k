      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00R8I'.
      ...
      * Called module names
       01  MOD-ZAG01EEY              PIC X(8) VALUE 'ZAG01EEY'.
       01  MOD-ZAG01OEY              PIC X(8) VALUE 'ZAG01OEY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01EEY-001.
               PERFORM CALL-ZAG01OEY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01EEY-001.
               CALL 'ZAG01EEY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01EEY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01OEY-002.
               CALL 'ZAG01OEY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01OEY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
