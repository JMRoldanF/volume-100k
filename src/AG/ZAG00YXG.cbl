      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00YXG'.
      ...
      * Called module names
       01  MOD-ZAG01NP4              PIC X(8) VALUE 'ZAG01NP4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01NP4-001.
               CALL 'ZAG01NP4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01NP4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
