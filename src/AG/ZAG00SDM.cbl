      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00SDM'.
      ...
      * Called module names
       01  MOD-ZAG01OP8              PIC X(8) VALUE 'ZAG01OP8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01OP8-001.
               CALL 'ZAG01OP8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01OP8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
