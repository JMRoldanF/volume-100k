      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00LPK'.
      ...
      * Called module names
       01  MOD-ZAG01GH1              PIC X(8) VALUE 'ZAG01GH1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01GH1-001.
               CALL 'ZAG01GH1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01GH1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
