      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00UDK'.
      ...
      * Called module names
       01  MOD-ZAG01MWI              PIC X(8) VALUE 'ZAG01MWI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01MWI-001.
               CALL 'ZAG01MWI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01MWI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
