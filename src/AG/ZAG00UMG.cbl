      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00UMG'.
      ...
      * Called module names
       01  MOD-ZAG01HQ4              PIC X(8) VALUE 'ZAG01HQ4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01HQ4-001.
               CALL 'ZAG01HQ4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01HQ4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
