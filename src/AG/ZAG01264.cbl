      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG01264'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01HO6              PIC X(8) VALUE 'ZAG01HO6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01Q7E-001.
               PERFORM CALL-ZAG01HO6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01HO6-002.
               CALL 'ZAG01HO6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01HO6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
