      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00Z7Z'.
      ...
      * Called module names
       01  MOD-ZAG01JET              PIC X(8) VALUE 'ZAG01JET'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01JET-001.
               CALL 'ZAG01JET' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01JET FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
