      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00VC0'.
      ...
      * Called module names
       01  MOD-ZAG01ONK              PIC X(8) VALUE 'ZAG01ONK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01ONK-001.
               CALL 'ZAG01ONK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01ONK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
