      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00XRS'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01L1B              PIC X(8) VALUE 'ZPA01L1B'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01L1B-002.
               CALL 'ZPA01L1B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01L1B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
