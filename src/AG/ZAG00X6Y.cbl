      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00X6Y'.
      ...
      * Called module names
       01  MOD-ZAG01EH6              PIC X(8) VALUE 'ZAG01EH6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01EH6-001.
               CALL 'ZAG01EH6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01EH6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01SF4-002.
