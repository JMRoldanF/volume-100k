      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG012KU'.
      ...
      * Called module names
       01  MOD-ZAG01OEE              PIC X(8) VALUE 'ZAG01OEE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01OEE-001.
               CALL 'ZAG01OEE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01OEE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
