      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00Y0Y'.
      ...
      * Called module names
       01  MOD-ZEN01KI9              PIC X(8) VALUE 'ZEN01KI9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01KI9-001.
               PERFORM CALL-ZCU01HTM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01KI9-001.
               CALL 'ZEN01KI9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01KI9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01HTM-002.
