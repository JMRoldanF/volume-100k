      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00TDG'.
      ...
      * Called module names
       01  MOD-ZMT01OH9              PIC X(8) VALUE 'ZMT01OH9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01OH9-001.
               CALL 'ZMT01OH9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01OH9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
