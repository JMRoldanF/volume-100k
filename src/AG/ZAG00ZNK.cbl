      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00ZNK'.
      ...
      * Called module names
       01  MOD-ZEN01DG3              PIC X(8) VALUE 'ZEN01DG3'.
       01  MOD-ZAG01CMS              PIC X(8) VALUE 'ZAG01CMS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01DG3-001.
               PERFORM CALL-ZAG01CMS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01DG3-001.
               CALL 'ZEN01DG3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01DG3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01CMS-002.
               CALL 'ZAG01CMS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01CMS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
