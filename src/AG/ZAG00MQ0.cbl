      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00MQ0'.
      ...
      * Called module names
       01  MOD-ZAG01TL2              PIC X(8) VALUE 'ZAG01TL2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01TL2-001.
               CALL 'ZAG01TL2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01TL2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
