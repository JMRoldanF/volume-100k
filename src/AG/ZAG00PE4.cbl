      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00PE4'.
      ...
      * Called module names
       01  MOD-ZAG01TBW              PIC X(8) VALUE 'ZAG01TBW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01TBW-001.
               PERFORM CALL-ZMT01END-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01TBW-001.
               CALL 'ZAG01TBW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01TBW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01END-002.
