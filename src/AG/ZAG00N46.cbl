      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00N46'.
      ...
      * Called module names
       01  MOD-ZAG01L6A              PIC X(8) VALUE 'ZAG01L6A'.
       01  MOD-ZAG01DKO              PIC X(8) VALUE 'ZAG01DKO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01L6A-001.
               PERFORM CALL-ZAG01DKO-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01L6A-001.
               CALL 'ZAG01L6A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01L6A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01DKO-002.
               CALL 'ZAG01DKO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01DKO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
