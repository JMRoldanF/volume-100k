      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG019ZI'.
      ...
      * Called module names
       01  MOD-ZAG01DBS              PIC X(8) VALUE 'ZAG01DBS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01DBS-001.
               CALL 'ZAG01DBS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01DBS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
