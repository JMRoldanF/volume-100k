      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00ZM6'.
      ...
      * Called module names
       01  MOD-ZBI01QVI              PIC X(8) VALUE 'ZBI01QVI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01QVI-001.
               CALL 'ZBI01QVI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01QVI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       VALIDATE-MAKE-0001.
