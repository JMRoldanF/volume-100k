      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00NM8'.
      ...
      * Called module names
       01  MOD-ZAG01V3S              PIC X(8) VALUE 'ZAG01V3S'.
       01  MOD-ZAG01NLI              PIC X(8) VALUE 'ZAG01NLI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01V3S-001.
               PERFORM CALL-ZAG01NLI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01V3S-001.
               CALL 'ZAG01V3S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01V3S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01NLI-002.
               CALL 'ZAG01NLI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
