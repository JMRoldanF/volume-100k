      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00NU0'.
      ...
      * Called module names
       01  MOD-ZAG01U6Q              PIC X(8) VALUE 'ZAG01U6Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01U6Q-001.
               CALL 'ZAG01U6Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01U6Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
