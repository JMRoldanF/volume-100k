      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00XAK'.
      ...
      * Called module names
       01  MOD-ZMT01RC1              PIC X(8) VALUE 'ZMT01RC1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01RC1-001.
               CALL 'ZMT01RC1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01RC1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
