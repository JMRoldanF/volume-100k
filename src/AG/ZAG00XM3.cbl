      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00XM3'.
      ...
      * Called module names
       01  MOD-ZAG01D6B              PIC X(8) VALUE 'ZAG01D6B'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01D6B-001.
               PERFORM CALL-ZAG01R8L-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01D6B-001.
               CALL 'ZAG01D6B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01D6B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01R8L-002.
