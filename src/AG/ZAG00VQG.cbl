      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00VQG'.
      ...
      * Called module names
       01  MOD-ZAG01NAO              PIC X(8) VALUE 'ZAG01NAO'.
       01  MOD-ZAG01EZ8              PIC X(8) VALUE 'ZAG01EZ8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01NAO-001.
               CALL 'ZAG01NAO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01EZ8-002.
               CALL 'ZAG01EZ8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01EZ8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
