      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG010Y8'.
      ...
      * Called module names
       01  MOD-ZAG01LMO              PIC X(8) VALUE 'ZAG01LMO'.
       01  MOD-ZAG01MX2              PIC X(8) VALUE 'ZAG01MX2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01LMO-001.
               CALL 'ZAG01LMO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01LMO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01MX2-002.
               CALL 'ZAG01MX2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01MX2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
