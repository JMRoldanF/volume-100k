      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00YMH'.
      ...
      * Called module names
       01  MOD-ZAG01TF6              PIC X(8) VALUE 'ZAG01TF6'.
       01  MOD-ZAG01MGM              PIC X(8) VALUE 'ZAG01MGM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01TF6-001.
               PERFORM CALL-ZAG01MGM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01TF6-001.
               CALL 'ZAG01TF6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01TF6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01MGM-002.
               CALL 'ZAG01MGM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01MGM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-MAKE-0001.
