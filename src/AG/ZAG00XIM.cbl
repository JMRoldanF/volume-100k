      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00XIM'.
      ...
      * Called module names
       01  MOD-ZAG01DUO              PIC X(8) VALUE 'ZAG01DUO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01DUO-001.
               PERFORM CALL-ZAG01M8M-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01DUO-001.
               CALL 'ZAG01DUO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01DUO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01M8M-002.
