      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00ZVC'.
      ...
      * Called module names
       01  MOD-ZAG01EG2              PIC X(8) VALUE 'ZAG01EG2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01EG2-001.
               PERFORM CALL-ZAG01F3O-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01EG2-001.
               CALL 'ZAG01EG2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01EG2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01F3O-002.
