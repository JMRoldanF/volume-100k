      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00SHI'.
      ...
      * Called module names
       01  MOD-ZAG01SMW              PIC X(8) VALUE 'ZAG01SMW'.
       01  MOD-ZAG01DSG              PIC X(8) VALUE 'ZAG01DSG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01SMW-001.
               PERFORM CALL-ZAG01DSG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01SMW-001.
               CALL 'ZAG01SMW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01SMW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01DSG-002.
               CALL 'ZAG01DSG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01DSG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
