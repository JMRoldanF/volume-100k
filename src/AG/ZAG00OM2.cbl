      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00OM2'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01RHI              PIC X(8) VALUE 'ZAG01RHI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01RHI-002.
               CALL 'ZAG01RHI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01RHI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
