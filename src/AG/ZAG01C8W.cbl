      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG01C8W'.
      ...
      * Called module names
       01  MOD-ZUW01N24              PIC X(8) VALUE 'ZUW01N24'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01N24-001.
               PERFORM CALL-ZAG01MR8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01N24-001.
               CALL 'ZUW01N24' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01N24 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01MR8-002.
