      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00QP2'.
      ...
      * Called module names
       01  MOD-ZAG01QFG              PIC X(8) VALUE 'ZAG01QFG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01QFG-001.
               CALL 'ZAG01QFG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01QFG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
