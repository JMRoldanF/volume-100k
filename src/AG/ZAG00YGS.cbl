      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00YGS'.
      ...
      * Called module names
       01  MOD-ZBI01MYY              PIC X(8) VALUE 'ZBI01MYY'.
       01  MOD-ZRE01O9X              PIC X(8) VALUE 'ZRE01O9X'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01MYY-001.
               PERFORM CALL-ZRE01O9X-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01MYY-001.
               CALL 'ZBI01MYY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01MYY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01O9X-002.
               CALL 'ZRE01O9X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01O9X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
