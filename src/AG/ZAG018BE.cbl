      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG018BE'.
      ...
      * Called module names
       01  MOD-ZAG01F28              PIC X(8) VALUE 'ZAG01F28'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01F28-001.
               CALL 'ZAG01F28' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01F28 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
