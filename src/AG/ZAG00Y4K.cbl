      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00Y4K'.
      ...
      * Called module names
       01  MOD-ZAG01JK8              PIC X(8) VALUE 'ZAG01JK8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01JK8-001.
               CALL 'ZAG01JK8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01JK8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01KM0-002.
