      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG011ZE'.
      ...
      * Called module names
       01  MOD-ZAG01DA4              PIC X(8) VALUE 'ZAG01DA4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01DA4-001.
               CALL 'ZAG01DA4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01DA4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-COLOUR-0001.
