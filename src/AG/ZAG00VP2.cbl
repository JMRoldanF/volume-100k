      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00VP2'.
      ...
      * Called module names
       01  MOD-ZAG01QW4              PIC X(8) VALUE 'ZAG01QW4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01QW4-001.
               CALL 'ZAG01QW4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01QW4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01L18-002.
               MOVE 'ZBI01L18' TO WS-SUBNAME-3
