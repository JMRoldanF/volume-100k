      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00293'.
      ...
      * Called module names
       01  MOD-ZAG00DZT              PIC X(8) VALUE 'ZAG00DZT'.
       01  MOD-ZAG008GG              PIC X(8) VALUE 'ZAG008GG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG00DZT-001.
               EXEC CICS LINK PROGRAM('ZAG00DZT')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG00DZT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG008GG-002.
               EXEC CICS LINK PROGRAM('ZAG008GG')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG008GG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
