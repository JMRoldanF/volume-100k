      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00YZO'.
      ...
      * Called module names
       01  MOD-ZAG01IJK              PIC X(8) VALUE 'ZAG01IJK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01IJK-001.
               CALL 'ZAG01IJK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01IJK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
