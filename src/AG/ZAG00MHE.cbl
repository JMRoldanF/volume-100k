      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00MHE'.
      ...
      * Called module names
       01  MOD-ZAG01RXM              PIC X(8) VALUE 'ZAG01RXM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01RXM-001.
               CALL 'ZAG01RXM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01RXM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
