      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00TXQ'.
      ...
      * Called module names
       01  MOD-ZRE01URJ              PIC X(8) VALUE 'ZRE01URJ'.
       01  MOD-ZAG01H9G              PIC X(8) VALUE 'ZAG01H9G'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01URJ-001.
               PERFORM CALL-ZAG01H9G-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01URJ-001.
               CALL 'ZRE01URJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01URJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01H9G-002.
               CALL 'ZAG01H9G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01H9G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
