      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00QAM'.
      ...
      * Called module names
       01  MOD-ZAG01GFG              PIC X(8) VALUE 'ZAG01GFG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01GFG-001.
               PERFORM CALL-ZHO01LBE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01GFG-001.
               CALL 'ZAG01GFG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01GFG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01LBE-002.
