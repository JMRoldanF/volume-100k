      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00POO'.
      ...
      * Called module names
       01  MOD-ZAG01QKQ              PIC X(8) VALUE 'ZAG01QKQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01QKQ-001.
               CALL 'ZAG01QKQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01QKQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
