      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00T0Y'.
      ...
      * Called module names
       01  MOD-ZAG01N9A              PIC X(8) VALUE 'ZAG01N9A'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01N9A-001.
               CALL 'ZAG01N9A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01N9A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
