      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00SLY'.
      ...
      * Called module names
       01  MOD-ZMT01PJV              PIC X(8) VALUE 'ZMT01PJV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01PJV-001.
               CALL 'ZMT01PJV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01PJV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
