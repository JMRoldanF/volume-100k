      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00O04'.
      ...
      * Called module names
       01  MOD-ZAG01TFS              PIC X(8) VALUE 'ZAG01TFS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01TFS-001.
               CALL 'ZAG01TFS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01TFS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
