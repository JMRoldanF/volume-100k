      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00YOP'.
      ...
      * Called module names
       01  MOD-ZAG01UJ3              PIC X(8) VALUE 'ZAG01UJ3'.
       01  MOD-ZAG01R6V              PIC X(8) VALUE 'ZAG01R6V'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01UJ3-001.
               PERFORM CALL-ZAG01R6V-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01UJ3-001.
               CALL 'ZAG01UJ3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01UJ3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01R6V-002.
               CALL 'ZAG01R6V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01R6V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-TAX-BAND-0001.
