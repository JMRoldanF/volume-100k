      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG0125U'.
      ...
      * Called module names
       01  MOD-ZCU01QQ6              PIC X(8) VALUE 'ZCU01QQ6'.
       01  MOD-ZAG01RZK              PIC X(8) VALUE 'ZAG01RZK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01QQ6-001.
               CALL 'ZCU01QQ6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01QQ6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01RZK-002.
               CALL 'ZAG01RZK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01RZK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
