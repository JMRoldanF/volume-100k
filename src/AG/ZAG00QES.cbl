      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00QES'.
      ...
      * Called module names
       01  MOD-ZAG01ONU              PIC X(8) VALUE 'ZAG01ONU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01ONU-001.
               CALL 'ZAG01ONU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01ONU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
