      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00R3B'.
      ...
      * Called module names
       01  MOD-ZAG01DLQ              PIC X(8) VALUE 'ZAG01DLQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01DLQ-001.
               CALL 'ZAG01DLQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01DLQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
