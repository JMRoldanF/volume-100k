      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00QWU'.
      ...
      * Called module names
       01  MOD-ZAG01L0Q              PIC X(8) VALUE 'ZAG01L0Q'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01L0Q-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZAG01LPQ-001.
               MOVE 'ZAG01LPQ' TO WS-SUBNAME-4
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01L0Q-002.
               CALL 'ZAG01L0Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01L0Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       WRITE-ERROR-MESSAGE.
