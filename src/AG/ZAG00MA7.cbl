      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00MA7'.
      ...
      * Called module names
       01  MOD-ZAG01P3F              PIC X(8) VALUE 'ZAG01P3F'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01P3F-001.
               CALL 'ZAG01P3F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01P3F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-MODEL-0001.
