      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00Z69'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01US8              PIC X(8) VALUE 'ZAG01US8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIF01I8V-001.
               PERFORM CALL-ZAG01US8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01US8-002.
               CALL 'ZAG01US8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01US8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
