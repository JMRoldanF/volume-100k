      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00Y9K'.
      ...
      * Called module names
       01  MOD-ZAG01T8A              PIC X(8) VALUE 'ZAG01T8A'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01T8A-001.
               CALL 'ZAG01T8A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01T8A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
