      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00PEO'.
      ...
      * Called module names
       01  MOD-ZAG01TQ2              PIC X(8) VALUE 'ZAG01TQ2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01TQ2-001.
               PERFORM CALL-ZAG01FF2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01TQ2-001.
               CALL 'ZAG01TQ2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01TQ2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01FF2-002.
               MOVE 'ZAG01FF2' TO WS-SUBNAME-3
