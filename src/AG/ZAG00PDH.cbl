      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00PDH'.
      ...
      * Called module names
       01  MOD-ZAG01CZH              PIC X(8) VALUE 'ZAG01CZH'.
       01  MOD-ZAG01GD3              PIC X(8) VALUE 'ZAG01GD3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01CZH-001.
               PERFORM CALL-ZAG01GD3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01CZH-001.
               CALL 'ZAG01CZH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01CZH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01GD3-002.
               CALL 'ZAG01GD3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01GD3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
