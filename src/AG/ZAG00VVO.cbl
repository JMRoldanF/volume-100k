      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00VVO'.
      ...
      * Called module names
       01  MOD-ZAG01KNS              PIC X(8) VALUE 'ZAG01KNS'.
       01  MOD-ZAC01NF7              PIC X(8) VALUE 'ZAC01NF7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01KNS-001.
               PERFORM CALL-ZAC01NF7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01KNS-001.
               CALL 'ZAG01KNS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01KNS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAC01NF7-002.
               CALL 'ZAC01NF7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01NF7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
