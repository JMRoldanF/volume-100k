      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00WQ0'.
      ...
      * Called module names
       01  MOD-ZAG01H7I              PIC X(8) VALUE 'ZAG01H7I'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01H7I-001.
               CALL 'ZAG01H7I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01H7I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
