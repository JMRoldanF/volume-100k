      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG011WY'.
      ...
      * Called module names
       01  MOD-ZAG01TN0              PIC X(8) VALUE 'ZAG01TN0'.
       01  MOD-ZAG01E6W              PIC X(8) VALUE 'ZAG01E6W'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01TN0-001.
               PERFORM CALL-ZAG01E6W-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01TN0-001.
               CALL 'ZAG01TN0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01TN0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01E6W-002.
               CALL 'ZAG01E6W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01E6W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
