      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00NZP'.
      ...
      * Called module names
       01  MOD-ZAG01P33              PIC X(8) VALUE 'ZAG01P33'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01P33-001.
               CALL 'ZAG01P33' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01P33 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
