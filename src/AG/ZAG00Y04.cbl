      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00Y04'.
      ...
      * Called module names
       01  MOD-ZCU01R42              PIC X(8) VALUE 'ZCU01R42'.
       01  MOD-ZAG01PVG              PIC X(8) VALUE 'ZAG01PVG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01R42-001.
               PERFORM CALL-ZAG01PVG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01R42-001.
               CALL 'ZCU01R42' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01R42 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01PVG-002.
               CALL 'ZAG01PVG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01PVG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
