      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00XCS'.
      ...
      * Called module names
       01  MOD-ZAG01JCQ              PIC X(8) VALUE 'ZAG01JCQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01JCQ-001.
               CALL 'ZAG01JCQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01JCQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
