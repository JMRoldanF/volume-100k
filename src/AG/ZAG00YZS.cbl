      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00YZS'.
      ...
      * Called module names
       01  MOD-ZAG01L81              PIC X(8) VALUE 'ZAG01L81'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01L81-001.
               CALL 'ZAG01L81' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01L81 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIF01GGA-002.
