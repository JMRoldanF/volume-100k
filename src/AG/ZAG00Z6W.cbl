      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00Z6W'.
      ...
      * Called module names
       01  MOD-ZAG01HSC              PIC X(8) VALUE 'ZAG01HSC'.
       01  MOD-ZAG01MVE              PIC X(8) VALUE 'ZAG01MVE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01HSC-001.
               PERFORM CALL-ZAG01MVE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01HSC-001.
               CALL 'ZAG01HSC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01HSC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01MVE-002.
               CALL 'ZAG01MVE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01MVE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
