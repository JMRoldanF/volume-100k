      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00E4U'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01AM5              PIC X(8) VALUE 'ZEN01AM5'.
       01  MOD-ZAG018P4              PIC X(8) VALUE 'ZAG018P4'.
       01  MOD-ZAG01I1S              PIC X(8) VALUE 'ZAG01I1S'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG00W5Q-001.
               PERFORM CALL-ZEN01AM5-002.
               PERFORM CALL-ZAG018P4-003.
               PERFORM CALL-ZAG01I1S-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01AM5-002.
               EXEC CICS LINK PROGRAM('ZEN01AM5')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01AM5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG018P4-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01I1S-004.
               CALL 'ZAG01I1S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01I1S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-005.
