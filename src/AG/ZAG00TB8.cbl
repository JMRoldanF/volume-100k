      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00TB8'.
      ...
      * Called module names
       01  MOD-ZAG01J8K              PIC X(8) VALUE 'ZAG01J8K'.
       01  MOD-ZEN01NH7              PIC X(8) VALUE 'ZEN01NH7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01J8K-001.
               PERFORM CALL-ZEN01NH7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01J8K-001.
               CALL 'ZAG01J8K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01J8K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01NH7-002.
               CALL 'ZEN01NH7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01NH7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
