      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG011MO'.
      ...
      * Called module names
       01  MOD-ZAG01FRA              PIC X(8) VALUE 'ZAG01FRA'.
       01  MOD-ZAG01GAG              PIC X(8) VALUE 'ZAG01GAG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01FRA-001.
               CALL 'ZAG01FRA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01FRA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01GAG-002.
               CALL 'ZAG01GAG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
