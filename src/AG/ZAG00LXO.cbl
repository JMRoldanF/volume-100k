      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00LXO'.
      ...
      * Called module names
       01  MOD-ZAG01J4O              PIC X(8) VALUE 'ZAG01J4O'.
       01  MOD-ZAG01MK0              PIC X(8) VALUE 'ZAG01MK0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01J4O-001.
               PERFORM CALL-ZAG01MK0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01J4O-001.
               CALL 'ZAG01J4O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01J4O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01MK0-002.
               CALL 'ZAG01MK0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01MK0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
