      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00PMQ'.
      ...
      * Called module names
       01  MOD-ZAG01H82              PIC X(8) VALUE 'ZAG01H82'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01H82-001.
               PERFORM CALL-ZAG01V4C-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01H82-001.
               CALL 'ZAG01H82' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01H82 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01V4C-002.
               MOVE 'ZAG01V4C' TO WS-SUBNAME-6
