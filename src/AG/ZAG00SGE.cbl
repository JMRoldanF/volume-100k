      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00SGE'.
      ...
      * Called module names
       01  MOD-ZAG01FRU              PIC X(8) VALUE 'ZAG01FRU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01FRU-001.
               CALL 'ZAG01FRU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01FRU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01JGM-002.
