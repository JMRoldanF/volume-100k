      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00XNM'.
      ...
      * Called module names
       01  MOD-ZAG01KQ6              PIC X(8) VALUE 'ZAG01KQ6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01KQ6-001.
               CALL 'ZAG01KQ6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01KQ6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
