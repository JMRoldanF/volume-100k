      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00VM0'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01S22              PIC X(8) VALUE 'ZAG01S22'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01S22-002.
               CALL 'ZAG01S22' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01S22 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
