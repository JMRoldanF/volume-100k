      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG01278'.
      ...
      * Called module names
       01  MOD-ZAG01UXY              PIC X(8) VALUE 'ZAG01UXY'.
       01  MOD-ZAG01QX8              PIC X(8) VALUE 'ZAG01QX8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01UXY-001.
               PERFORM CALL-ZAG01QX8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01UXY-001.
               CALL 'ZAG01UXY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01QX8-002.
               CALL 'ZAG01QX8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
