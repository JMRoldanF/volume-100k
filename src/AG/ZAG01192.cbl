      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG01192'.
      ...
      * Called module names
       01  MOD-ZAG01JMG              PIC X(8) VALUE 'ZAG01JMG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01JMG-001.
               CALL 'ZAG01JMG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01JMG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-TAX-BAND-0001.
