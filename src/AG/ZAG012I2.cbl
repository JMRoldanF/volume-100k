      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG012I2'.
      ...
      * Called module names
       01  MOD-ZAG01O1C              PIC X(8) VALUE 'ZAG01O1C'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01O1C-001.
               CALL 'ZAG01O1C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01O1C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
