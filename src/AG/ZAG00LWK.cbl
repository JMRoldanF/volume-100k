      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00LWK'.
      ...
      * Called module names
       01  MOD-ZAG01ENU              PIC X(8) VALUE 'ZAG01ENU'.
       01  MOD-ZRE01QEB              PIC X(8) VALUE 'ZRE01QEB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01ENU-001.
               PERFORM CALL-ZRE01QEB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01ENU-001.
               CALL 'ZAG01ENU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01ENU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01QEB-002.
               CALL 'ZRE01QEB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01QEB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
