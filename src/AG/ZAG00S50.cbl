      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00S50'.
      ...
      * Called module names
       01  MOD-ZMT01UQT              PIC X(8) VALUE 'ZMT01UQT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01UQT-001.
               CALL 'ZMT01UQT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01UQT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01HIM-002.
