      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG011CY'.
      ...
      * Called module names
       01  MOD-ZAG01RZU              PIC X(8) VALUE 'ZAG01RZU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01RZU-001.
               PERFORM CALL-ZHO01P1A-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01RZU-001.
               CALL 'ZAG01RZU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01RZU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01P1A-002.
