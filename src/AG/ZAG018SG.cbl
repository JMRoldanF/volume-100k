      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG018SG'.
      ...
      * Called module names
       01  MOD-ZAG01D6I              PIC X(8) VALUE 'ZAG01D6I'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01D6I-001.
               CALL 'ZAG01D6I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01D6I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
