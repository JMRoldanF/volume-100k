      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG01AIG'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01V1T              PIC X(8) VALUE 'ZAG01V1T'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAC01DXV-001.
               PERFORM CALL-ZAG01V1T-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01V1T-002.
               CALL 'ZAG01V1T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01V1T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
