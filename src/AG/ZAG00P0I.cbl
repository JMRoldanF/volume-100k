      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00P0I'.
      ...
      * Called module names
       01  MOD-ZAG01EU8              PIC X(8) VALUE 'ZAG01EU8'.
       01  MOD-ZAG01HLO              PIC X(8) VALUE 'ZAG01HLO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01EU8-001.
               CALL 'ZAG01EU8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01EU8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01HLO-002.
               CALL 'ZAG01HLO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
