      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00TJN'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01HRF              PIC X(8) VALUE 'ZAG01HRF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01HRF-002.
               CALL 'ZAG01HRF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01HRF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
