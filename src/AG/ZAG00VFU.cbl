      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00VFU'.
      ...
      * Called module names
       01  MOD-ZAG01NJI              PIC X(8) VALUE 'ZAG01NJI'.
       01  MOD-ZAG01PS3              PIC X(8) VALUE 'ZAG01PS3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01NJI-001.
               PERFORM CALL-ZAG01PS3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01NJI-001.
               CALL 'ZAG01NJI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01NJI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01PS3-002.
               CALL 'ZAG01PS3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01PS3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
