      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00W1A'.
      ...
      * Called module names
       01  MOD-ZAG01JX0              PIC X(8) VALUE 'ZAG01JX0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01JX0-001.
               CALL 'ZAG01JX0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01JX0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
