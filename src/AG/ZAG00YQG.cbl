      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00YQG'.
      ...
      * Called module names
       01  MOD-ZAG01K7E              PIC X(8) VALUE 'ZAG01K7E'.
       01  MOD-ZAG01O2A              PIC X(8) VALUE 'ZAG01O2A'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01K7E-001.
               PERFORM CALL-ZAG01O2A-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01K7E-001.
               CALL 'ZAG01K7E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01K7E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01O2A-002.
               CALL 'ZAG01O2A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01O2A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-EQUITIES-0001.
