      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00XSC'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01IP4              PIC X(8) VALUE 'ZAG01IP4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01MZK-001.
               PERFORM CALL-ZAG01IP4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01IP4-002.
               CALL 'ZAG01IP4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01IP4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
