      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00XJG'.
      ...
      * Called module names
       01  MOD-ZAG01UPM              PIC X(8) VALUE 'ZAG01UPM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01UPM-001.
               CALL 'ZAG01UPM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01UPM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
