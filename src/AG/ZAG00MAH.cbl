      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00MAH'.
      ...
      * Called module names
       01  MOD-ZAG01GJH              PIC X(8) VALUE 'ZAG01GJH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01GJH-001.
               PERFORM CALL-ZAG01LSJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01GJH-001.
               CALL 'ZAG01GJH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01GJH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01LSJ-002.
               MOVE 'ZAG01LSJ' TO WS-SUBNAME-7
