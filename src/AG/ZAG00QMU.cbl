      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00QMU'.
      ...
      * Called module names
       01  MOD-ZAG01UW0              PIC X(8) VALUE 'ZAG01UW0'.
       01  MOD-ZAG01NV8              PIC X(8) VALUE 'ZAG01NV8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01UW0-001.
               PERFORM CALL-ZAG01NV8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01UW0-001.
               CALL 'ZAG01UW0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01UW0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01NV8-002.
               CALL 'ZAG01NV8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01NV8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       NORMALISE-TERM-0001.
