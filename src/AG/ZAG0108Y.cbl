      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG0108Y'.
      ...
      * Called module names
       01  MOD-ZMT01G77              PIC X(8) VALUE 'ZMT01G77'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01G77-001.
               CALL 'ZMT01G77' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01G77 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
