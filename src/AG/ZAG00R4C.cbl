      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00R4C'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01PDE              PIC X(8) VALUE 'ZAG01PDE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01M2S-001.
               PERFORM CALL-ZAG01PDE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01PDE-002.
               CALL 'ZAG01PDE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01PDE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
