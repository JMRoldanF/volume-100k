      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00VXY'.
      ...
      * Called module names
       01  MOD-ZAG01G7Y              PIC X(8) VALUE 'ZAG01G7Y'.
       01  MOD-ZAG01HAK              PIC X(8) VALUE 'ZAG01HAK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01G7Y-001.
               PERFORM CALL-ZAG01HAK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01G7Y-001.
               CALL 'ZAG01G7Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01G7Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01HAK-002.
               CALL 'ZAG01HAK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01HAK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
