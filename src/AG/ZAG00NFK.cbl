      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00NFK'.
      ...
      * Called module names
       01  MOD-ZAG01G2Y              PIC X(8) VALUE 'ZAG01G2Y'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01G2Y-001.
               CALL 'ZAG01G2Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01G2Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
