      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00WZ6'.
      ...
      * Called module names
       01  MOD-ZAG01N7H              PIC X(8) VALUE 'ZAG01N7H'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01N7H-001.
               CALL 'ZAG01N7H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01N7H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
