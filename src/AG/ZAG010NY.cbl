      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG010NY'.
      ...
      * Called module names
       01  MOD-ZAG01ND6              PIC X(8) VALUE 'ZAG01ND6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01ND6-001.
               CALL 'ZAG01ND6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01ND6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01LOC-002.
