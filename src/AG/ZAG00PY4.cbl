      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00PY4'.
      ...
      * Called module names
       01  MOD-ZAG01NNG              PIC X(8) VALUE 'ZAG01NNG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM APPLY-WITH-PROFITS-0080.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01NNG-001.
               CALL 'ZAG01NNG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01NNG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
