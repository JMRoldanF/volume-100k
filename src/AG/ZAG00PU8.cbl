      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00PU8'.
      ...
      * Called module names
       01  MOD-ZAG01N2M              PIC X(8) VALUE 'ZAG01N2M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01N2M-001.
               CALL 'ZAG01N2M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01N2M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
