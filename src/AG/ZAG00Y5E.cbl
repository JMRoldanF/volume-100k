      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00Y5E'.
      ...
      * Called module names
       01  MOD-ZAG01LYC              PIC X(8) VALUE 'ZAG01LYC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01LYC-001.
               CALL 'ZAG01LYC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01LYC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-EXCESS-0001.
