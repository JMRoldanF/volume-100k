      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00SB4'.
      ...
      * Called module names
       01  MOD-ZAG01U16              PIC X(8) VALUE 'ZAG01U16'.
       01  MOD-ZUW01NE2              PIC X(8) VALUE 'ZUW01NE2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01U16-001.
               CALL 'ZAG01U16' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01U16 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01NE2-002.
               CALL 'ZUW01NE2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01NE2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
