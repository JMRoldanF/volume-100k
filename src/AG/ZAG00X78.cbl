      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00X78'.
      ...
      * Called module names
       01  MOD-ZAG01USY              PIC X(8) VALUE 'ZAG01USY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01USY-001.
               CALL 'ZAG01USY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01USY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-VALUE-0001.
