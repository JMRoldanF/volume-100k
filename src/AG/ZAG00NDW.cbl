      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00NDW'.
      ...
      * Called module names
       01  MOD-ZAG01JTY              PIC X(8) VALUE 'ZAG01JTY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01JTY-001.
               PERFORM CALL-ZAG01K9I-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01JTY-001.
               CALL 'ZAG01JTY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01JTY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01K9I-002.
               MOVE 'ZAG01K9I' TO WS-SUBNAME-1
