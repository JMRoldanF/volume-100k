      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00ONR'.
      ...
      * Called module names
       01  MOD-ZAG01HDP              PIC X(8) VALUE 'ZAG01HDP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01HDP-001.
               CALL 'ZAG01HDP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01HDP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
