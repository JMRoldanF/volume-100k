      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00XMS'.
      ...
      * Called module names
       01  MOD-ZAG01FGQ              PIC X(8) VALUE 'ZAG01FGQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01FGQ-001.
               CALL 'ZAG01FGQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01FGQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
