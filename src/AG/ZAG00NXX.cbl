      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00NXX'.
      ...
      * Called module names
       01  MOD-ZAG01UJ2              PIC X(8) VALUE 'ZAG01UJ2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01UJ2-001.
               CALL 'ZAG01UJ2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01UJ2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
