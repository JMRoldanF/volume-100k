      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00Z4Y'.
      ...
      * Called module names
       01  MOD-ZAG01RGY              PIC X(8) VALUE 'ZAG01RGY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01RGY-001.
               CALL 'ZAG01RGY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01RGY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
