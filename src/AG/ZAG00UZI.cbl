      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00UZI'.
      ...
      * Called module names
       01  MOD-ZAG01Q2Y              PIC X(8) VALUE 'ZAG01Q2Y'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01Q2Y-001.
               CALL 'ZAG01Q2Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01Q2Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
