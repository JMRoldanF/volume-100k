      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00X0A'.
      ...
      * Called module names
       01  MOD-ZAG01LCE              PIC X(8) VALUE 'ZAG01LCE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01LCE-002.
               CALL 'ZAG01LCE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01LCE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
