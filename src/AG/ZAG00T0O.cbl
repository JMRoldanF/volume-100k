      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00T0O'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01NBI              PIC X(8) VALUE 'ZAG01NBI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01OUS-001.
               PERFORM CALL-ZAG01NBI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01NBI-002.
               CALL 'ZAG01NBI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01NBI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
