      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG01D68'.
      ...
      * Called module names
       01  MOD-ZAG01T3K              PIC X(8) VALUE 'ZAG01T3K'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01T3K-001.
               CALL 'ZAG01T3K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01T3K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
