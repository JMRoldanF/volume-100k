      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00LZC'.
      ...
      * Called module names
       01  MOD-ZAG01DYU              PIC X(8) VALUE 'ZAG01DYU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01DYU-001.
               CALL 'ZAG01DYU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01DYU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
