      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00UDA'.
      ...
      * Called module names
       01  MOD-ZAG01ES0              PIC X(8) VALUE 'ZAG01ES0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01ES0-001.
               CALL 'ZAG01ES0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01ES0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
