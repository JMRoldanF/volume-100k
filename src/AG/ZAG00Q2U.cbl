      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00Q2U'.
      ...
      * Called module names
       01  MOD-ZAG01L6K              PIC X(8) VALUE 'ZAG01L6K'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01L6K-001.
               CALL 'ZAG01L6K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01L6K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01T30-002.
