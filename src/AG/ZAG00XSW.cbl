      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00XSW'.
      ...
      * Called module names
       01  MOD-ZAG01GRO              PIC X(8) VALUE 'ZAG01GRO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01GRO-001.
               CALL 'ZAG01GRO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
