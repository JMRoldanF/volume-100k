      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00QA4'.
      ...
      * Called module names
       01  MOD-ZAG01MBA              PIC X(8) VALUE 'ZAG01MBA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01MBA-001.
               PERFORM CALL-ZAG01KDN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01MBA-001.
               CALL 'ZAG01MBA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01MBA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01KDN-002.
