      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00QW0'.
      ...
      * Called module names
       01  MOD-ZAG01Q5G              PIC X(8) VALUE 'ZAG01Q5G'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01Q5G-001.
               CALL 'ZAG01Q5G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01Q5G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-TERM-0001.
