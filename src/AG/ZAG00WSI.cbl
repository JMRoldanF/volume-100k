      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00WSI'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01ICM              PIC X(8) VALUE 'ZAG01ICM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01ICM-002.
               CALL 'ZAG01ICM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01ICM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
