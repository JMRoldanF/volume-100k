      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG010X4'.
      ...
      * Called module names
       01  MOD-ZAG01GN8              PIC X(8) VALUE 'ZAG01GN8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01GN8-001.
               CALL 'ZAG01GN8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01GN8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-PREMIUM-0001.
