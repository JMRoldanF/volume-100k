      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00MY2'.
      ...
      * Called module names
       01  MOD-ZAG01GXS              PIC X(8) VALUE 'ZAG01GXS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01GXS-001.
               CALL 'ZAG01GXS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01GXS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
