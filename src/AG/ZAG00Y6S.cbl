      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00Y6S'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01N2W              PIC X(8) VALUE 'ZAG01N2W'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01MQ4-001.
               PERFORM CALL-ZAG01N2W-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01N2W-002.
               CALL 'ZAG01N2W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01N2W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
