      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00MRO'.
      ...
      * Called module names
       01  MOD-ZAG01SKY              PIC X(8) VALUE 'ZAG01SKY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01SKY-001.
               CALL 'ZAG01SKY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01SKY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
