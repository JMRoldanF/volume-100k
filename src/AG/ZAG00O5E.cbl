      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00O5E'.
      ...
      * Called module names
       01  MOD-ZAG01IKO              PIC X(8) VALUE 'ZAG01IKO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01IKO-001.
               CALL 'ZAG01IKO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01IKO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
