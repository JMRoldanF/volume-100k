      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00P7T'.
      ...
      * Called module names
       01  MOD-ZAG01DHY              PIC X(8) VALUE 'ZAG01DHY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01DHY-001.
               CALL 'ZAG01DHY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01DHY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
