      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00WTC'.
      ...
      * Called module names
       01  MOD-ZAG01K7K              PIC X(8) VALUE 'ZAG01K7K'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01K7K-001.
               PERFORM CALL-ZAG01GCO-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01K7K-001.
               CALL 'ZAG01K7K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01K7K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01GCO-002.
