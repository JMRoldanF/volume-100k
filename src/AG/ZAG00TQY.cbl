      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00TQY'.
      ...
      * Called module names
       01  MOD-ZAC01OJR              PIC X(8) VALUE 'ZAC01OJR'.
       01  MOD-ZAG01N2Y              PIC X(8) VALUE 'ZAG01N2Y'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAC01OJR-001.
               PERFORM CALL-ZAG01N2Y-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01OJR-001.
               CALL 'ZAC01OJR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01OJR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01N2Y-002.
               CALL 'ZAG01N2Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01N2Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
