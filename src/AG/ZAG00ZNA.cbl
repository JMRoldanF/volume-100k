      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00ZNA'.
      ...
      * Called module names
       01  MOD-ZAG01S7M              PIC X(8) VALUE 'ZAG01S7M'.
       01  MOD-ZAG01P66              PIC X(8) VALUE 'ZAG01P66'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01S7M-001.
               PERFORM CALL-ZAG01P66-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01S7M-001.
               CALL 'ZAG01S7M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01S7M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01P66-002.
               CALL 'ZAG01P66' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01P66 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-MAKE-0001.
