      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00WGU'.
      ...
      * Called module names
       01  MOD-ZRE01OJX              PIC X(8) VALUE 'ZRE01OJX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01OJX-001.
               CALL 'ZRE01OJX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01OJX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
