      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00RLZ'.
      ...
      * Called module names
       01  MOD-ZAG01PBE              PIC X(8) VALUE 'ZAG01PBE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01PBE-001.
               PERFORM CALL-ZIF01OT5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01PBE-001.
               CALL 'ZAG01PBE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01PBE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIF01OT5-002.
