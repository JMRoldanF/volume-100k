      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG004EN'.
      ...
      * Called module names
       ...
       01  MOD-ZIF00IKT              PIC X(8) VALUE 'ZIF00IKT'.
       01  MOD-ZAG00BMR              PIC X(8) VALUE 'ZAG00BMR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG00L7K-001.
               PERFORM CALL-ZIF00IKT-002.
               PERFORM CALL-ZAG00LLI-003.
               PERFORM CALL-ZAG00BMR-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZIF00IKT-002.
               EXEC CICS LINK PROGRAM('ZIF00IKT')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIF00IKT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG00LLI-003.
               MOVE 'ZAG00LLI' TO WS-PROGNAME-2
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG00LLI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG00BMR-004.
               EXEC CICS LINK PROGRAM('ZAG00BMR')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG00BMR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-005.
