      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00S5K'.
      ...
      * Called module names
       01  MOD-ZAG01Q6A              PIC X(8) VALUE 'ZAG01Q6A'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01Q6A-001.
               PERFORM CALL-ZAG01MHS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01Q6A-001.
               CALL 'ZAG01Q6A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01Q6A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01MHS-002.
