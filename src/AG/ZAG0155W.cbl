      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG0155W'.
      ...
      * Called module names
       01  MOD-ZAG01KAM              PIC X(8) VALUE 'ZAG01KAM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01KAM-001.
               CALL 'ZAG01KAM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01KAM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
