      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00O0E'.
      ...
      * Called module names
       01  MOD-ZAG01CVY              PIC X(8) VALUE 'ZAG01CVY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01CVY-001.
               CALL 'ZAG01CVY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01CVY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
