      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00XHI'.
      ...
      * Called module names
       01  MOD-ZAG01GCY              PIC X(8) VALUE 'ZAG01GCY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01GCY-001.
               CALL 'ZAG01GCY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01GCY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
