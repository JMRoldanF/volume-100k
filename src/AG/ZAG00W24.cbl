      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00W24'.
      ...
      * Called module names
       01  MOD-ZAG01QGU              PIC X(8) VALUE 'ZAG01QGU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01QGU-001.
               CALL 'ZAG01QGU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01QGU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01PPW-002.
