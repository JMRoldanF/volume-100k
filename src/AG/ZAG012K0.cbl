      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG012K0'.
      ...
      * Called module names
       01  MOD-ZPA01P7L              PIC X(8) VALUE 'ZPA01P7L'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01P7L-001.
               CALL 'ZPA01P7L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01P7L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
