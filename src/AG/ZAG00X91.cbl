      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00X91'.
      ...
      * Called module names
       01  MOD-ZIF01O4H              PIC X(8) VALUE 'ZIF01O4H'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIF01O4H-001.
               CALL 'ZIF01O4H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIF01O4H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
               MOVE 'ZEN0255N' TO WS-PROGNAME-2
