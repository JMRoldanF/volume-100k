      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00W1C'.
      ...
      * Called module names
       01  MOD-ZAG01KNB              PIC X(8) VALUE 'ZAG01KNB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01KNB-001.
               CALL 'ZAG01KNB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01KNB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
