      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00YS2'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01PQA              PIC X(8) VALUE 'ZAG01PQA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01PQA-002.
               CALL 'ZAG01PQA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01PQA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
