      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00WGK'.
      ...
      * Called module names
       01  MOD-ZAG01NI6              PIC X(8) VALUE 'ZAG01NI6'.
       01  MOD-ZRE01T2F              PIC X(8) VALUE 'ZRE01T2F'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01NI6-001.
               PERFORM CALL-ZRE01T2F-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01NI6-001.
               CALL 'ZAG01NI6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01NI6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01T2F-002.
               CALL 'ZRE01T2F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01T2F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
