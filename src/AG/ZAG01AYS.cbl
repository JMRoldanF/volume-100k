      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG01AYS'.
      ...
      * Called module names
       01  MOD-ZAG01DEK              PIC X(8) VALUE 'ZAG01DEK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01DEK-001.
               CALL 'ZAG01DEK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01DEK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
      ...
      *----------------------------------------------------------------*
       FILE-ACCESS-0021.
               EXEC CICS REWRITE FILE('KSDSAG60')
                         FROM(KSDSAG60-REC)
                         LENGTH(WS-FILE-LEN)
                         RIDFLD(WS-KEY-AREA)
                         RESP(WS-RESP)
