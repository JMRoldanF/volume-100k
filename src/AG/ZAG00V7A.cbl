      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00V7A'.
      ...
      * Called module names
       01  MOD-ZAG01NR2              PIC X(8) VALUE 'ZAG01NR2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01NR2-001.
               CALL 'ZAG01NR2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01NR2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
