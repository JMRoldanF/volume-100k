      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00P3A'.
      ...
      * Called module names
       01  MOD-ZAG01OCQ              PIC X(8) VALUE 'ZAG01OCQ'.
       01  MOD-ZUW01TFA              PIC X(8) VALUE 'ZUW01TFA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01OCQ-001.
               PERFORM CALL-ZUW01TFA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01OCQ-001.
               CALL 'ZAG01OCQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01OCQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01TFA-002.
               CALL 'ZUW01TFA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
