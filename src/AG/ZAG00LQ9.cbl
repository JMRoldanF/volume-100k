      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00LQ9'.
      ...
      * Called module names
       01  MOD-ZAG01EGS              PIC X(8) VALUE 'ZAG01EGS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01EGS-001.
               PERFORM CALL-ZAG01JV7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01EGS-001.
               CALL 'ZAG01EGS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01EGS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01JV7-002.
               MOVE 'ZAG01JV7' TO WS-SUBNAME-5
