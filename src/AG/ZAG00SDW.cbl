      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00SDW'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01I86              PIC X(8) VALUE 'ZAG01I86'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01I86-002.
               CALL 'ZAG01I86' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01I86 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-MODEL-0001.
