      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00PPS'.
      ...
      * Called module names
       01  MOD-ZAG01G4W              PIC X(8) VALUE 'ZAG01G4W'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01G4W-001.
               CALL 'ZAG01G4W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01G4W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
