      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00UE5'.
      ...
      * Called module names
       01  MOD-ZAG01PKM              PIC X(8) VALUE 'ZAG01PKM'.
       01  MOD-ZAG01SEC              PIC X(8) VALUE 'ZAG01SEC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01PKM-001.
               PERFORM CALL-ZAG01SEC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01PKM-001.
               CALL 'ZAG01PKM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01PKM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01SEC-002.
               CALL 'ZAG01SEC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01SEC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
