      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00ZLW'.
      ...
      * Called module names
       01  MOD-ZAG01O6C              PIC X(8) VALUE 'ZAG01O6C'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01O6C-001.
               CALL 'ZAG01O6C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01O6C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
