      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG012C9'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01G2R              PIC X(8) VALUE 'ZAG01G2R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01G2R-002.
               CALL 'ZAG01G2R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01G2R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
