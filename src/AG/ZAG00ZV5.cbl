      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00ZV5'.
      ...
      * Called module names
       01  MOD-ZIF01QZ5              PIC X(8) VALUE 'ZIF01QZ5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIF01QZ5-001.
               CALL 'ZIF01QZ5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIF01QZ5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-MAKE-0001.
