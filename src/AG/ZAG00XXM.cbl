      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00XXM'.
      ...
      * Called module names
       01  MOD-ZAG01ESU              PIC X(8) VALUE 'ZAG01ESU'.
       01  MOD-ZCL01L6H              PIC X(8) VALUE 'ZCL01L6H'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01ESU-001.
               PERFORM CALL-ZCL01L6H-002.
               ...
               PERFORM EXPAND-MANAGED-FUND-0010.
               ...
               PERFORM CHECK-POSTCODE-0103.
               PERFORM REFRESH-STATUS-CODE-0104.
               PERFORM SQL-ACCESS-0105.
               PERFORM CHECK-TERM-0106.
               PERFORM REFRESH-STATUS-CODE-0107.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZAG01ESU-001.
               CALL 'ZAG01ESU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01ESU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01L6H-002.
               CALL 'ZCL01L6H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01L6H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-VALUE-0001.
