      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG01RF0'.
      ...
      * Called module names
       01  MOD-ZRE01U0L              PIC X(8) VALUE 'ZRE01U0L'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01U0L-001.
               CALL 'ZRE01U0L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01U0L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
