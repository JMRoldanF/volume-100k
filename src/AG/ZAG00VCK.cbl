      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00VCK'.
      ...
      * Called module names
       01  MOD-ZAG01MAU              PIC X(8) VALUE 'ZAG01MAU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01MAU-001.
               CALL 'ZAG01MAU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01MAU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
