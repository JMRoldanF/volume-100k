      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00LPW'.
      ...
      * Called module names
       01  MOD-ZAG01FCK              PIC X(8) VALUE 'ZAG01FCK'.
       01  MOD-ZAG01SX6              PIC X(8) VALUE 'ZAG01SX6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01FCK-001.
               PERFORM CALL-ZAG01SX6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01FCK-001.
               CALL 'ZAG01FCK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01FCK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01SX6-002.
               CALL 'ZAG01SX6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01SX6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
