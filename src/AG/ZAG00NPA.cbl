      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00NPA'.
      ...
      * Called module names
       01  MOD-ZAG01R3W              PIC X(8) VALUE 'ZAG01R3W'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01R3W-001.
               CALL 'ZAG01R3W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01R3W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
