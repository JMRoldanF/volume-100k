      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00UQV'.
      ...
      * Called module names
       01  MOD-ZAG01IPQ              PIC X(8) VALUE 'ZAG01IPQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01IPQ-001.
               PERFORM CALL-ZAG01I11-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01IPQ-001.
               CALL 'ZAG01IPQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01IPQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01I11-002.
