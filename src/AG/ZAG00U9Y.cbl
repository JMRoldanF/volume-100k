      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00U9Y'.
      ...
      * Called module names
       01  MOD-ZBI01KDC              PIC X(8) VALUE 'ZBI01KDC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01KDC-001.
               CALL 'ZBI01KDC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01KDC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
