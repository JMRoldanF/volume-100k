      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG003EL'.
      ...
      * Called module names
       ...
       01  MOD-ZAG00B2G              PIC X(8) VALUE 'ZAG00B2G'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAC00B4Y-001.
               PERFORM CALL-ZAG00B2G-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG00B2G-002.
               EXEC CICS LINK PROGRAM('ZAG00B2G')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG00B2G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
