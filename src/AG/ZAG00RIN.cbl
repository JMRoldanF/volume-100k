      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00RIN'.
      ...
      * Called module names
       01  MOD-ZAG01PVQ              PIC X(8) VALUE 'ZAG01PVQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01PVQ-001.
               CALL 'ZAG01PVQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01PVQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
