      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00NDM'.
      ...
      * Called module names
       01  MOD-ZHO01OMU              PIC X(8) VALUE 'ZHO01OMU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01OMU-001.
               CALL 'ZHO01OMU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01OMU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
