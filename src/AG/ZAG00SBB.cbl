      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00SBB'.
      ...
      * Called module names
       01  MOD-ZAG01MU2              PIC X(8) VALUE 'ZAG01MU2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01MU2-002.
               CALL 'ZAG01MU2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01MU2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
