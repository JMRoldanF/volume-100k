      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG012FA'.
      ...
      * Called module names
       01  MOD-ZAG01IPE              PIC X(8) VALUE 'ZAG01IPE'.
       01  MOD-ZPA01FFX              PIC X(8) VALUE 'ZPA01FFX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01IPE-001.
               PERFORM CALL-ZPA01FFX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01IPE-001.
               CALL 'ZAG01IPE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01IPE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01FFX-002.
               CALL 'ZPA01FFX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01FFX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
