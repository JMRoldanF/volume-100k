      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG012FU'.
      ...
      * Called module names
       01  MOD-ZAG01IXQ              PIC X(8) VALUE 'ZAG01IXQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01IXQ-001.
               CALL 'ZAG01IXQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01IXQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       VALIDATE-MAKE-0001.
