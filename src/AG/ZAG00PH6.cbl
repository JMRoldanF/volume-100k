      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00PH6'.
      ...
      * Called module names
       01  MOD-ZAG01RWS              PIC X(8) VALUE 'ZAG01RWS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01RWS-001.
               CALL 'ZAG01RWS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01RWS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
