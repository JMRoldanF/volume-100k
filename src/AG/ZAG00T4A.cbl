      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00T4A'.
      ...
      * Called module names
       01  MOD-ZPA01QG1              PIC X(8) VALUE 'ZPA01QG1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01GHY-001.
               PERFORM CALL-ZPA01QG1-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZAG01GHY-001.
               MOVE 'ZAG01GHY' TO WS-SUBNAME-1
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01QG1-002.
               CALL 'ZPA01QG1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01QG1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       WRITE-ERROR-MESSAGE.
