      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00NHQ'.
      ...
      * Called module names
       01  MOD-ZAG01JBH              PIC X(8) VALUE 'ZAG01JBH'.
       01  MOD-ZAG01IW5              PIC X(8) VALUE 'ZAG01IW5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01JBH-001.
               PERFORM CALL-ZAG01IW5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01JBH-001.
               CALL 'ZAG01JBH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01JBH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01IW5-002.
               CALL 'ZAG01IW5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01IW5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-VALUE-0001.
