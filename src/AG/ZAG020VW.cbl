      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG020VW'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01ML4              PIC X(8) VALUE 'ZAG01ML4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01O6W-001.
               PERFORM CALL-ZEN01N9Z-002.
               PERFORM CALL-ZAG01ML4-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01ML4-003.
               CALL 'ZAG01ML4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
