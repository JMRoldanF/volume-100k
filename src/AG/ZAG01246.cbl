      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG01246'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01EEE              PIC X(8) VALUE 'ZAG01EEE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01EEE-002.
               CALL 'ZAG01EEE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01EEE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-TERM-0001.
