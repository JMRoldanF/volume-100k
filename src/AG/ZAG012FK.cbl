      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG012FK'.
      ...
      * Called module names
       01  MOD-ZBI01GD6              PIC X(8) VALUE 'ZBI01GD6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01GD6-002.
               CALL 'ZBI01GD6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01GD6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
