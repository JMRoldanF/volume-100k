      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00V48'.
      ...
      * Called module names
       01  MOD-ZAG01PE8              PIC X(8) VALUE 'ZAG01PE8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01PE8-001.
               CALL 'ZAG01PE8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01PE8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
