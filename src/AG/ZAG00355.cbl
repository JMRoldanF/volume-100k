      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00355'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG00J21-001.
               PERFORM CALL-ZAG00GAI-002.
               PERFORM CALL-ZAG000NS-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG00J21-001.
               MOVE 'ZAG00J21' TO WS-PROGNAME-4
      ...
      *----------------------------------------------------------------*
       CALL-ZAG00GAI-002.
               MOVE 'ZAG00GAI' TO WS-PROGNAME-5
      ...
      *----------------------------------------------------------------*
       CALL-ZAG000NS-003.
               EXEC CICS START TRANSID('Z0NS')
                         FROM(WS-KEY-AREA)
                         LENGTH(20)
                         RESP(WS-RESP)
               END-EXEC.
      * TRANSID Z0NS is defined against ZAG000NS
               IF WS-RESP NOT = DFHRESP(NORMAL)
