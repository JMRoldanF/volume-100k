      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00MQK'.
      ...
      * Called module names
       01  MOD-ZAG01RLE              PIC X(8) VALUE 'ZAG01RLE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01RLE-001.
               CALL 'ZAG01RLE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01RLE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01E6W-002.
