      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG01700'.
      ...
      * Called module names
       01  MOD-ZAG01MD2              PIC X(8) VALUE 'ZAG01MD2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01MD2-001.
               CALL 'ZAG01MD2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01MD2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
