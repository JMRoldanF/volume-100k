      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00OHW'.
      ...
      * Called module names
       01  MOD-ZAG01U7A              PIC X(8) VALUE 'ZAG01U7A'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01U7A-001.
               CALL 'ZAG01U7A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01U7A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
