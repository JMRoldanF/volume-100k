      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG01WOS'.
      ...
      * Called module names
       01  MOD-ZAG01KRU              PIC X(8) VALUE 'ZAG01KRU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01KRU-001.
               PERFORM CALL-ZHO01H8Q-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01KRU-001.
               CALL 'ZAG01KRU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01KRU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01H8Q-002.
               MOVE 'ZHO01H8Q' TO WS-SUBNAME-1
