      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00ZFS'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01DDH              PIC X(8) VALUE 'ZPA01DDH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01E62-001.
               PERFORM CALL-ZPA01DDH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01DDH-002.
               CALL 'ZPA01DDH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
