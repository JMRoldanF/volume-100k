      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00NZK'.
      ...
      * Called module names
       01  MOD-ZCU01UCG              PIC X(8) VALUE 'ZCU01UCG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01UCG-001.
               PERFORM CALL-ZAG01TLW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01UCG-001.
               CALL 'ZCU01UCG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01UCG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01TLW-002.
