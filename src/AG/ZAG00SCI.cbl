      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00SCI'.
      ...
      * Called module names
       01  MOD-ZAG01P84              PIC X(8) VALUE 'ZAG01P84'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01P84-001.
               CALL 'ZAG01P84' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01P84 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01J44-002.
