      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG020DU'.
      ...
      * Called module names
       01  MOD-ZAG01TYE              PIC X(8) VALUE 'ZAG01TYE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01TYE-001.
               PERFORM CALL-ZAG01SWC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01TYE-001.
               CALL 'ZAG01TYE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
