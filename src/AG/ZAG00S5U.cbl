      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00S5U'.
      ...
      * Called module names
       01  MOD-ZAG01KV6              PIC X(8) VALUE 'ZAG01KV6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01KV6-001.
               PERFORM CALL-ZAG01TNA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01KV6-001.
               CALL 'ZAG01KV6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01KV6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01TNA-002.
               MOVE 'ZAG01TNA' TO WS-SUBNAME-4
