      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00X7B'.
      ...
      * Called module names
       01  MOD-ZAG01KP5              PIC X(8) VALUE 'ZAG01KP5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01KP5-001.
               CALL 'ZAG01KP5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01KP5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
