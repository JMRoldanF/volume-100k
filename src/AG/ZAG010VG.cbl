      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG010VG'.
      ...
      * Called module names
       01  MOD-ZAG01OW6              PIC X(8) VALUE 'ZAG01OW6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01OW6-001.
               CALL 'ZAG01OW6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01OW6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
