      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00YP4'.
      ...
      * Called module names
       01  MOD-ZAG01N40              PIC X(8) VALUE 'ZAG01N40'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01N40-001.
               CALL 'ZAG01N40' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01N40 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
