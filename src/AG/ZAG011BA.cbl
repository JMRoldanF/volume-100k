      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG011BA'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01UOJ              PIC X(8) VALUE 'ZPA01UOJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01UOJ-002.
               CALL 'ZPA01UOJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01UOJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
