      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00TF4'.
      ...
      * Called module names
       01  MOD-ZMT01KZ5              PIC X(8) VALUE 'ZMT01KZ5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01L4C-001.
               PERFORM CALL-ZMT01KZ5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01KZ5-002.
               CALL 'ZMT01KZ5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
