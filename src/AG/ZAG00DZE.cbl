      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00DZE'.
      ...
      * Called module names
       ...
       01  MOD-ZAC0189M              PIC X(8) VALUE 'ZAC0189M'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG00YCP-001.
               PERFORM CALL-ZAC0189M-002.
               PERFORM CALL-ZAC018TW-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG00YCP-001.
               EXEC CICS LINK PROGRAM('ZAG00YCP')
      ...
      *----------------------------------------------------------------*
       CALL-ZAC0189M-002.
               EXEC CICS LINK PROGRAM('ZAC0189M')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC018TW-003.
               MOVE 'ZAC018TW' TO WS-PROGNAME-4
