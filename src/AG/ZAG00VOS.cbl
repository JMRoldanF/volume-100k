      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00VOS'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01U9S              PIC X(8) VALUE 'ZAG01U9S'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01DJ0-001.
               PERFORM CALL-ZAG01U9S-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01U9S-002.
               CALL 'ZAG01U9S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01U9S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
