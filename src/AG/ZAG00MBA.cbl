      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00MBA'.
      ...
      * Called module names
       01  MOD-ZAG01LQA              PIC X(8) VALUE 'ZAG01LQA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01LQA-001.
               PERFORM CALL-ZAG01ELC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01LQA-001.
               CALL 'ZAG01LQA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01LQA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01ELC-002.
