      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG01MAU'.
      ...
      * Called module names
       01  MOD-ZPA01PYT              PIC X(8) VALUE 'ZPA01PYT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01PYT-001.
               CALL 'ZPA01PYT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01PYT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
