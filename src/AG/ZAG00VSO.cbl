      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00VSO'.
      ...
      * Called module names
       01  MOD-ZAG01KTI              PIC X(8) VALUE 'ZAG01KTI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01KTI-001.
               CALL 'ZAG01KTI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01KTI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-PREMIUM-0001.
