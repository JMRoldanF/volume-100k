      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00ZPS'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01SNM              PIC X(8) VALUE 'ZCU01SNM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01SNM-002.
               CALL 'ZCU01SNM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01SNM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
