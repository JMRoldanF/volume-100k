      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00YOA'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01LQU              PIC X(8) VALUE 'ZAG01LQU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01LQU-002.
               CALL 'ZAG01LQU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01LQU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
