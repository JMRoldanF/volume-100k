      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00O86'.
      ...
      * Called module names
       01  MOD-ZEN01J8P              PIC X(8) VALUE 'ZEN01J8P'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01J8P-001.
               CALL 'ZEN01J8P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01J8P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01TGM-002.
               MOVE 'ZAG01TGM' TO WS-SUBNAME-6
