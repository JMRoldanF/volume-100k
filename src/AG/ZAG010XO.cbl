      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG010XO'.
      ...
      * Called module names
       01  MOD-ZAG01MTG              PIC X(8) VALUE 'ZAG01MTG'.
       01  MOD-ZAG01HGY              PIC X(8) VALUE 'ZAG01HGY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01MTG-001.
               CALL 'ZAG01MTG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01MTG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01HGY-002.
               CALL 'ZAG01HGY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01HGY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-MODEL-0001.
