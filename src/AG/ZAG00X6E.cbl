      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00X6E'.
      ...
      * Called module names
       01  MOD-ZAG01M8C              PIC X(8) VALUE 'ZAG01M8C'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01M8C-001.
               CALL 'ZAG01M8C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01M8C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-POSTCODE-0001.
