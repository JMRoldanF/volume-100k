      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00Y90'.
      ...
      * Called module names
       01  MOD-ZAG01SY0              PIC X(8) VALUE 'ZAG01SY0'.
       01  MOD-ZAG01I9K              PIC X(8) VALUE 'ZAG01I9K'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01SY0-001.
               PERFORM CALL-ZAG01I9K-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01SY0-001.
               CALL 'ZAG01SY0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01SY0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01I9K-002.
               CALL 'ZAG01I9K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01I9K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-EXCESS-0001.
