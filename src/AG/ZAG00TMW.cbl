      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00TMW'.
      ...
      * Called module names
       01  MOD-ZAG01U5C              PIC X(8) VALUE 'ZAG01U5C'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01U5C-001.
               CALL 'ZAG01U5C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01U5C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
