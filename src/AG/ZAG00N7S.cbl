      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00N7S'.
      ...
      * Called module names
       01  MOD-ZAG01GW4              PIC X(8) VALUE 'ZAG01GW4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01GW4-001.
               CALL 'ZAG01GW4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01GW4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
