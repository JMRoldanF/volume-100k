      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00UWG'.
      ...
      * Called module names
       01  MOD-ZAG01KDO              PIC X(8) VALUE 'ZAG01KDO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01KDO-001.
               CALL 'ZAG01KDO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01KDO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01EMG-002.
