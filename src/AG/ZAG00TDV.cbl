      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00TDV'.
      ...
      * Called module names
       01  MOD-ZAG01SO5              PIC X(8) VALUE 'ZAG01SO5'.
       01  MOD-ZAG01GLO              PIC X(8) VALUE 'ZAG01GLO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01SO5-001.
               PERFORM CALL-ZAG01GLO-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01SO5-001.
               CALL 'ZAG01SO5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01SO5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01GLO-002.
               CALL 'ZAG01GLO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01GLO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
