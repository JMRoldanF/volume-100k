      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00U30'.
      ...
      * Called module names
       01  MOD-ZAG01K70              PIC X(8) VALUE 'ZAG01K70'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01K70-001.
               CALL 'ZAG01K70' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01K70 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
