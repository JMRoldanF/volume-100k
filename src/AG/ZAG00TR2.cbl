      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00TR2'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01DT0              PIC X(8) VALUE 'ZAG01DT0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01IQ8-001.
               PERFORM CALL-ZAG01DT0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01DT0-002.
               CALL 'ZAG01DT0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01DT0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
