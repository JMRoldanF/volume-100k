      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00FY4'.
      ...
      * Called module names
       ...
       01  MOD-ZMT00XJ9              PIC X(8) VALUE 'ZMT00XJ9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00XJ9-002.
               EXEC CICS LINK PROGRAM('ZMT00XJ9')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00XJ9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
