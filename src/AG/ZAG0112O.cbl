      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG0112O'.
      ...
      * Called module names
       01  MOD-ZAG01OK8              PIC X(8) VALUE 'ZAG01OK8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01OK8-001.
               PERFORM CALL-ZAG01SCW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01OK8-001.
               CALL 'ZAG01OK8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01OK8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01SCW-002.
