      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00QYS'.
      ...
      * Called module names
       01  MOD-ZAG01EQW              PIC X(8) VALUE 'ZAG01EQW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01EQW-001.
               CALL 'ZAG01EQW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01EQW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
