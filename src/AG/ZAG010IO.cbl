      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG010IO'.
      ...
      * Called module names
       01  MOD-ZAG01LAQ              PIC X(8) VALUE 'ZAG01LAQ'.
       01  MOD-ZAG01OLC              PIC X(8) VALUE 'ZAG01OLC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01LAQ-001.
               PERFORM CALL-ZAG01OLC-002.
               ...
               PERFORM COMPUTE-BROKER-ID-0031.
               ...
               PERFORM REFRESH-CC-RATING-0092.
               ...
               PERFORM COMPUTE-WITH-PROFITS-0106.
               PERFORM DERIVE-NCD-YEARS-0107.
               PERFORM SQL-ACCESS-0108.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZAG01LAQ-001.
               CALL 'ZAG01LAQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01LAQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01OLC-002.
               CALL 'ZAG01OLC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01OLC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
