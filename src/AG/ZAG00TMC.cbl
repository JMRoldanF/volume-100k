      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00TMC'.
      ...
      * Called module names
       01  MOD-ZAG01V06              PIC X(8) VALUE 'ZAG01V06'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01V06-001.
               PERFORM CALL-ZAG01G6U-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01V06-001.
               CALL 'ZAG01V06' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01V06 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01G6U-002.
