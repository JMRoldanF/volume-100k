      ...
      * Called module names
       ...
       01  MOD-ZAG01D7O              PIC X(8) VALUE 'ZAG01D7O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01D7O-002.
               CALL 'ZAG01D7O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
      ...
      *----------------------------------------------------------------*
       FILE-ACCESS-0012.
               EXEC CICS REWRITE FILE('KSDSAG45')
                         FROM(KSDSAG45-REC)
                         LENGTH(WS-FILE-LEN)
                         RIDFLD(WS-KEY-AREA)
                         RESP(WS-RESP)
