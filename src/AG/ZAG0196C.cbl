      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG0196C'.
      ...
      * Called module names
       01  MOD-ZAG01F7K              PIC X(8) VALUE 'ZAG01F7K'.
       01  MOD-ZAG01R2I              PIC X(8) VALUE 'ZAG01R2I'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01F7K-001.
               PERFORM CALL-ZAG01R2I-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01F7K-001.
               CALL 'ZAG01F7K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01F7K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01R2I-002.
               CALL 'ZAG01R2I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
