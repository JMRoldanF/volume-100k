      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00UD0'.
      ...
      * Called module names
       01  MOD-ZAG01UZM              PIC X(8) VALUE 'ZAG01UZM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01UZM-001.
               CALL 'ZAG01UZM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01UZM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
