      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00WBA'.
      ...
      * Called module names
       01  MOD-ZAG01PRU              PIC X(8) VALUE 'ZAG01PRU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01PRU-001.
               CALL 'ZAG01PRU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01PRU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
