      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00ULW'.
      ...
      * Called module names
       01  MOD-ZMT01FR3              PIC X(8) VALUE 'ZMT01FR3'.
       01  MOD-ZAG01R46              PIC X(8) VALUE 'ZAG01R46'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01FR3-001.
               PERFORM CALL-ZAG01R46-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01FR3-001.
               CALL 'ZMT01FR3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01FR3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01R46-002.
               CALL 'ZAG01R46' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01R46 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
