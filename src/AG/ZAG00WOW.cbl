      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAG00WOW'.
      ...
      * Called module names
       01  MOD-ZAG01IPO              PIC X(8) VALUE 'ZAG01IPO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01IPO-001.
               CALL 'ZAG01IPO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01IPO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-EXCESS-0001.
