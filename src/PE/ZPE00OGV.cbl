      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00OGV'.
      ...
      * Called module names
       ...
       01  MOD-ZPE01HML              PIC X(8) VALUE 'ZPE01HML'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01HML-002.
               CALL 'ZPE01HML' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01HML FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
