      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00OCU'.
      ...
      * Called module names
       ...
       01  MOD-ZPE01S3Q              PIC X(8) VALUE 'ZPE01S3Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01S3Q-002.
               CALL 'ZPE01S3Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01S3Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
