      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00LZT'.
      ...
      * Called module names
       01  MOD-ZPE01RGL              PIC X(8) VALUE 'ZPE01RGL'.
       01  MOD-ZBR01OM7              PIC X(8) VALUE 'ZBR01OM7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPE01RGL-001.
               PERFORM CALL-ZBR01OM7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01RGL-001.
               CALL 'ZPE01RGL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01RGL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBR01OM7-002.
               CALL 'ZBR01OM7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01OM7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
