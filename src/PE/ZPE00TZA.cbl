      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00TZA'.
      ...
      * Called module names
       01  MOD-ZPE01FKC              PIC X(8) VALUE 'ZPE01FKC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPE01FKC-001.
               PERFORM CALL-ZRT01IFU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01FKC-001.
               CALL 'ZPE01FKC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
