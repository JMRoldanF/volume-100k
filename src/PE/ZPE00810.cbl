      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00810'.
      ...
      * Called module names
       ...
       01  MOD-ZPE018UL              PIC X(8) VALUE 'ZPE018UL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPE00TZA-001.
               PERFORM CALL-ZPE018UL-002.
               PERFORM CALL-ZPE01TV7-003.
               PERFORM CALL-ZRT01CRH-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE00TZA-001.
               EXEC CICS LINK PROGRAM('ZPE00TZA')
      ...
      *----------------------------------------------------------------*
       CALL-ZPE018UL-002.
               EXEC CICS LINK PROGRAM('ZPE018UL')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE018UL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPE01TV7-003.
               MOVE 'ZPE01TV7' TO WS-SUBNAME-8
