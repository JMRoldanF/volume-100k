      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00NQM'.
      ...
      * Called module names
       ...
       01  MOD-ZPE01M4Q              PIC X(8) VALUE 'ZPE01M4Q'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPE01TCO-001.
               PERFORM CALL-ZPE01M4Q-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01M4Q-002.
               CALL 'ZPE01M4Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01M4Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
