      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00OXJ'.
      ...
      * Called module names
       01  MOD-ZPE01G6V              PIC X(8) VALUE 'ZPE01G6V'.
       01  MOD-ZPE01RDY              PIC X(8) VALUE 'ZPE01RDY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPE01G6V-001.
               PERFORM CALL-ZPE01RDY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01G6V-001.
               CALL 'ZPE01G6V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01G6V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPE01RDY-002.
               CALL 'ZPE01RDY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01RDY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
