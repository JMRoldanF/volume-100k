      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00SNT'.
      ...
      * Called module names
       01  MOD-ZPE01NZC              PIC X(8) VALUE 'ZPE01NZC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPE01NZC-001.
               PERFORM CALL-ZPE01TC9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01NZC-001.
               CALL 'ZPE01NZC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01NZC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPE01TC9-002.
