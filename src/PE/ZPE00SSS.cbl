      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00SSS'.
      ...
      * Called module names
       ...
       01  MOD-ZPE01IFA              PIC X(8) VALUE 'ZPE01IFA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01IFA-002.
               CALL 'ZPE01IFA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01IFA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-MODEL-0001.
