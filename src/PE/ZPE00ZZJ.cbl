      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00ZZJ'.
      ...
      * Called module names
       01  MOD-ZPE01HAA              PIC X(8) VALUE 'ZPE01HAA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01HAA-001.
               CALL 'ZPE01HAA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01HAA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
