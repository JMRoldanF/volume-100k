      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00YWG'.
      ...
      * Called module names
       01  MOD-ZPE01DU1              PIC X(8) VALUE 'ZPE01DU1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01DU1-001.
               CALL 'ZPE01DU1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01DU1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
