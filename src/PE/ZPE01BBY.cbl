      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE01BBY'.
      ...
      * Called module names
       01  MOD-ZBR01JRC              PIC X(8) VALUE 'ZBR01JRC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01JRC-001.
               CALL 'ZBR01JRC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01JRC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-VALUE-0001.
