      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00XZP'.
      ...
      * Called module names
       01  MOD-ZPE01TLS              PIC X(8) VALUE 'ZPE01TLS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01TLS-001.
               CALL 'ZPE01TLS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01TLS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
