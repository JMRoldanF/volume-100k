      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00L7B'.
      ...
      * Called module names
       ...
       01  MOD-ZPE01S4D              PIC X(8) VALUE 'ZPE01S4D'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPE00TP1-001.
               PERFORM CALL-ZPE00XMQ-002.
               PERFORM CALL-ZPE01S4D-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01S4D-003.
               CALL 'ZPE01S4D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01S4D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-004.
