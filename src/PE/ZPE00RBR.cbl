      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00RBR'.
      ...
      * Called module names
       ...
       01  MOD-ZPE01DGY              PIC X(8) VALUE 'ZPE01DGY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPE01E1S-001.
               PERFORM CALL-ZPE01DGY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01DGY-002.
               CALL 'ZPE01DGY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01DGY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
