      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE01069'.
      ...
      * Called module names
       01  MOD-ZPE01SY8              PIC X(8) VALUE 'ZPE01SY8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01SY8-002.
               CALL 'ZPE01SY8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01SY8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
