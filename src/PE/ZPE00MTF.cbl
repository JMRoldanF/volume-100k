      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00MTF'.
      ...
      * Called module names
       01  MOD-ZPE01SXQ              PIC X(8) VALUE 'ZPE01SXQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPE01QLY-001.
               PERFORM CALL-ZPE01SXQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01SXQ-002.
               CALL 'ZPE01SXQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01SXQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
