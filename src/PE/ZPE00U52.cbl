      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00U52'.
      ...
      * Called module names
       01  MOD-ZPE01UQ8              PIC X(8) VALUE 'ZPE01UQ8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPE01UQ8-001.
               PERFORM CALL-ZPE01CVI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01UQ8-001.
               CALL 'ZPE01UQ8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01UQ8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPE01CVI-002.
