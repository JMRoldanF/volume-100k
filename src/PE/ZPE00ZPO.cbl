      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00ZPO'.
      ...
      * Called module names
       01  MOD-ZPE01K08              PIC X(8) VALUE 'ZPE01K08'.
       01  MOD-ZPE01OFY              PIC X(8) VALUE 'ZPE01OFY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPE01K08-001.
               PERFORM CALL-ZRE0255R-003.
               PERFORM RESOLVE-BROKER-ID-0001.
               ...
               PERFORM RECONCILE-WITH-PROFITS-0059.
               PERFORM SQL-ACCESS-0060.
               PERFORM NORMALISE-NCD-YEARS-0061.
               ...
               PERFORM COMPUTE-SUM-ASSURED-0085.
               ...
               PERFORM APPLY-POSTCODE-0103.
               PERFORM DERIVE-EQUITIES-0104.
               ...
               PERFORM FORMAT-TERM-0119.
               PERFORM SQL-ACCESS-0120.
               PERFORM FORMAT-BEDROOMS-0121.
               PERFORM APPLY-CC-RATING-0122.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01K08-001.
               CALL 'ZPE01K08' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01K08 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPE01OFY-002.
               CALL 'ZPE01OFY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01OFY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
