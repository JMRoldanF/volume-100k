      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00ZJM'.
      ...
      * Called module names
       01  MOD-ZPE01M6R              PIC X(8) VALUE 'ZPE01M6R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01M6R-001.
               CALL 'ZPE01M6R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01M6R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
