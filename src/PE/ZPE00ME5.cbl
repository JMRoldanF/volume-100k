      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00ME5'.
      ...
      * Called module names
       01  MOD-ZPE01EL4              PIC X(8) VALUE 'ZPE01EL4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01EL4-001.
               CALL 'ZPE01EL4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01EL4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPE01N30-002.
               MOVE 'ZPE01N30' TO WS-SUBNAME-4
