      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00X7X'.
      ...
      * Called module names
       01  MOD-ZPE01QQS              PIC X(8) VALUE 'ZPE01QQS'.
       01  MOD-ZRT01DX7              PIC X(8) VALUE 'ZRT01DX7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPE01QQS-001.
               PERFORM CALL-ZRT01DX7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01QQS-001.
               CALL 'ZPE01QQS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01QQS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRT01DX7-002.
               CALL 'ZRT01DX7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRT01DX7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-VALUE-0001.
