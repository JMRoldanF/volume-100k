      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00LYC'.
      ...
      * Called module names
       01  MOD-ZPE01JYX              PIC X(8) VALUE 'ZPE01JYX'.
       01  MOD-ZPE01UBE              PIC X(8) VALUE 'ZPE01UBE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01JYX-001.
               CALL 'ZPE01JYX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01JYX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPE01UBE-002.
               CALL 'ZPE01UBE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01UBE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
