      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00NH6'.
      ...
      * Called module names
       01  MOD-ZPE01K5X              PIC X(8) VALUE 'ZPE01K5X'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01K5X-001.
               CALL 'ZPE01K5X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01K5X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
