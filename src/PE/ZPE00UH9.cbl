      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00UH9'.
      ...
      * Called module names
       01  MOD-ZPE01TTV              PIC X(8) VALUE 'ZPE01TTV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01TTV-001.
               CALL 'ZPE01TTV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01TTV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-PREMIUM-0001.
