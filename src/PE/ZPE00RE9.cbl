      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00RE9'.
      ...
      * Called module names
       01  MOD-ZPE01SBX              PIC X(8) VALUE 'ZPE01SBX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPE01SBX-001.
               PERFORM CALL-ZBR01TB3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01SBX-001.
               CALL 'ZPE01SBX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01SBX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBR01TB3-002.
