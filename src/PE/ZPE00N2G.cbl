      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00N2G'.
      ...
      * Called module names
       01  MOD-ZPE01O1P              PIC X(8) VALUE 'ZPE01O1P'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01O1P-001.
               CALL 'ZPE01O1P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01O1P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
