      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00QS4'.
      ...
      * Called module names
       01  MOD-ZPE01IT0              PIC X(8) VALUE 'ZPE01IT0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01IT0-001.
               CALL 'ZPE01IT0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01IT0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
