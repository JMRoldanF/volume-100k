      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00HD3'.
      ...
      * Called module names
       01  MOD-ZPE00QS7              PIC X(8) VALUE 'ZPE00QS7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE00QS7-001.
               EXEC CICS LINK PROGRAM('ZPE00QS7')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE00QS7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
