      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00NIF'.
      ...
      * Called module names
       01  MOD-ZPE01NG8              PIC X(8) VALUE 'ZPE01NG8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPE01DVJ-001.
               PERFORM CALL-ZPE01NG8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01NG8-002.
               CALL 'ZPE01NG8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01NG8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
