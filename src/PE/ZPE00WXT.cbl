      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00WXT'.
      ...
      * Called module names
       01  MOD-ZPE01F6P              PIC X(8) VALUE 'ZPE01F6P'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01F6P-001.
               CALL 'ZPE01F6P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01F6P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPE01DGY-002.
