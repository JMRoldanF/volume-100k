      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00TXZ'.
      ...
      * Called module names
       01  MOD-ZPE01I2E              PIC X(8) VALUE 'ZPE01I2E'.
       01  MOD-ZPE01KGG              PIC X(8) VALUE 'ZPE01KGG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPE01I2E-001.
               PERFORM CALL-ZPE01KGG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01I2E-001.
               CALL 'ZPE01I2E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01I2E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPE01KGG-002.
               CALL 'ZPE01KGG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01KGG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
