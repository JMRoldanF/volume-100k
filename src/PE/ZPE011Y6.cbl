      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE011Y6'.
      ...
      * Called module names
       01  MOD-ZRT01TOA              PIC X(8) VALUE 'ZRT01TOA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRT01TOA-001.
               CALL 'ZRT01TOA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRT01TOA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-VALUE-0001.
