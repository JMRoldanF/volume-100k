      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE0108U'.
      ...
      * Called module names
       01  MOD-ZPE01V0T              PIC X(8) VALUE 'ZPE01V0T'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01V0T-001.
               CALL 'ZPE01V0T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01V0T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
