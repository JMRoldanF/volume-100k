      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00UUN'.
      ...
      * Called module names
       01  MOD-ZPE01CME              PIC X(8) VALUE 'ZPE01CME'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01CME-001.
               CALL 'ZPE01CME' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01CME FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
