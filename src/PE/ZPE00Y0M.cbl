      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00Y0M'.
      ...
      * Called module names
       01  MOD-ZPE01K3D              PIC X(8) VALUE 'ZPE01K3D'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPE01K3D-001.
               PERFORM CALL-ZPE01G2H-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01K3D-001.
               CALL 'ZPE01K3D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01K3D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPE01G2H-002.
