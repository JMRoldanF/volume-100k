      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00QEQ'.
      ...
      * Called module names
       01  MOD-ZPE01I59              PIC X(8) VALUE 'ZPE01I59'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPE01I59-001.
               CALL 'ZPE01I59' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPE01I59 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
