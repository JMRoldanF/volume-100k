      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPE00W9R'.
      ...
      * Called module names
       01  MOD-ZBR01R3R              PIC X(8) VALUE 'ZBR01R3R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01R3R-001.
               CALL 'ZBR01R3R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01R3R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
