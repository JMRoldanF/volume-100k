      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00PVN'.
      ...
      * Called module names
       01  MOD-ZFL01URO              PIC X(8) VALUE 'ZFL01URO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01URO-001.
               CALL 'ZFL01URO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01URO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
