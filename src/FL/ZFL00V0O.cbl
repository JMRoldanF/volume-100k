      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00V0O'.
      ...
      * Called module names
       01  MOD-ZFL01UVY              PIC X(8) VALUE 'ZFL01UVY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01UVY-001.
               CALL 'ZFL01UVY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01UVY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
