      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00QGJ'.
      ...
      * Called module names
       01  MOD-ZFL01UJV              PIC X(8) VALUE 'ZFL01UJV'.
       01  MOD-ZEX01OLY              PIC X(8) VALUE 'ZEX01OLY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFL01UJV-001.
               PERFORM CALL-ZEX01OLY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01UJV-001.
               CALL 'ZFL01UJV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01UJV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEX01OLY-002.
               CALL 'ZEX01OLY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEX01OLY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-COLOUR-0001.
