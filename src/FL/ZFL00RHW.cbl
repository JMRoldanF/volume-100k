      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00RHW'.
      ...
      * Called module names
       ...
       01  MOD-ZFL01D7Y              PIC X(8) VALUE 'ZFL01D7Y'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFL01U11-001.
               PERFORM CALL-ZFL01D7Y-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01D7Y-002.
               CALL 'ZFL01D7Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01D7Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
