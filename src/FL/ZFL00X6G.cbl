      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00X6G'.
      ...
      * Called module names
       01  MOD-ZFL01JWH              PIC X(8) VALUE 'ZFL01JWH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01JWH-001.
               CALL 'ZFL01JWH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01JWH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-MODEL-0001.
