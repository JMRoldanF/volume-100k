      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00P59'.
      ...
      * Called module names
       ...
       01  MOD-ZFL01KII              PIC X(8) VALUE 'ZFL01KII'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFL01UCZ-001.
               PERFORM CALL-ZFL01KII-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01KII-002.
               CALL 'ZFL01KII' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01KII FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
