      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00UCV'.
      ...
      * Called module names
       01  MOD-ZFL01TX2              PIC X(8) VALUE 'ZFL01TX2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01TX2-001.
               CALL 'ZFL01TX2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01TX2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-MAKE-0001.
