      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL011HF'.
      ...
      * Called module names
       01  MOD-ZFL01V3O              PIC X(8) VALUE 'ZFL01V3O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01V3O-001.
               CALL 'ZFL01V3O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01V3O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZQU01UFV-002.
