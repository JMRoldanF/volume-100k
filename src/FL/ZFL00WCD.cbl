      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00WCD'.
      ...
      * Called module names
       01  MOD-ZFL01UC0              PIC X(8) VALUE 'ZFL01UC0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01UC0-001.
               CALL 'ZFL01UC0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01UC0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-VALUE-0001.
