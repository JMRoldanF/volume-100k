      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00QEU'.
      ...
      * Called module names
       01  MOD-ZFL01KMU              PIC X(8) VALUE 'ZFL01KMU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01KMU-001.
               CALL 'ZFL01KMU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01KMU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
