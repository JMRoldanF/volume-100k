      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00ZXX'.
      ...
      * Called module names
       01  MOD-ZFL01PM4              PIC X(8) VALUE 'ZFL01PM4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01PM4-001.
               CALL 'ZFL01PM4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01PM4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
