      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00ZOS'.
      ...
      * Called module names
       01  MOD-ZEX01F2Q              PIC X(8) VALUE 'ZEX01F2Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEX01F2Q-001.
               CALL 'ZEX01F2Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEX01F2Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-MODEL-0001.
