      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00TI7'.
      ...
      * Called module names
       ...
       01  MOD-ZFL01FXN              PIC X(8) VALUE 'ZFL01FXN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01FXN-002.
               CALL 'ZFL01FXN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01FXN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
