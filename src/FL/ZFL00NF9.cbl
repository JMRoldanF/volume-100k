      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00NF9'.
      ...
      * Called module names
       01  MOD-ZFL01R5V              PIC X(8) VALUE 'ZFL01R5V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01R5V-001.
               CALL 'ZFL01R5V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01R5V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFL01ERJ-002.
               MOVE 'ZFL01ERJ' TO WS-SUBNAME-8
