      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL010BS'.
      ...
      * Called module names
       01  MOD-ZFL01GYH              PIC X(8) VALUE 'ZFL01GYH'.
       01  MOD-ZFL01IWQ              PIC X(8) VALUE 'ZFL01IWQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFL01GYH-001.
               PERFORM CALL-ZFL01IWQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01GYH-001.
               CALL 'ZFL01GYH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01IWQ-002.
               CALL 'ZFL01IWQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01IWQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-MAKE-0001.
