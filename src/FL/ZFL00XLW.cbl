      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00XLW'.
      ...
      * Called module names
       01  MOD-ZFL01GPK              PIC X(8) VALUE 'ZFL01GPK'.
       01  MOD-ZCP01MZM              PIC X(8) VALUE 'ZCP01MZM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01GPK-001.
               CALL 'ZFL01GPK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01GPK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCP01MZM-002.
               CALL 'ZCP01MZM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01MZM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
