      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00TNO'.
      ...
      * Called module names
       01  MOD-ZFL01FD8              PIC X(8) VALUE 'ZFL01FD8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01FD8-001.
               CALL 'ZFL01FD8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01FD8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
