      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00Q5F'.
      ...
      * Called module names
       01  MOD-ZCP01T38              PIC X(8) VALUE 'ZCP01T38'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01T38-001.
               CALL 'ZCP01T38' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01T38 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
