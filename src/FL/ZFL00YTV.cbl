      ******************************************************************
      * ZFL00YTV - COMMERCIAL FLEET                                    *
      ******************************************************************
      *
      *  Generated volume-test source. Layer 2,
      *  type data_db2, domain FLEET.
      ******************************************************************
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00YTV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM DERIVE-AGENT-CODE-0097.
       ...
       SQL-ACCESS-0015.
               EXEC SQL
                     ...
                     SELECT POLICYNUMBER, PAYMENT
                       FROM GENAFL.CONTACT A
                       JOIN GENAFL.CUSTOMER B
