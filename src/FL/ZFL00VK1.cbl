      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00VK1'.
      ...
      * Called module names
       01  MOD-ZFL01KHK              PIC X(8) VALUE 'ZFL01KHK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01KHK-001.
               CALL 'ZFL01KHK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01KHK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
