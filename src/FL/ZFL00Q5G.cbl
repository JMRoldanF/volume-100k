      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00Q5G'.
      ...
      * Called module names
       01  MOD-ZFL01US9              PIC X(8) VALUE 'ZFL01US9'.
       01  MOD-ZFL01PYC              PIC X(8) VALUE 'ZFL01PYC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFL01US9-001.
               PERFORM CALL-ZFL01PYC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01US9-001.
               CALL 'ZFL01US9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01US9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFL01PYC-002.
               CALL 'ZFL01PYC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01PYC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
