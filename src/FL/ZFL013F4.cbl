      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL013F4'.
      ...
      * Called module names
       ...
       01  MOD-ZFL01RTK              PIC X(8) VALUE 'ZFL01RTK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBA01QFV-001.
               PERFORM CALL-ZFL01RTK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01RTK-002.
               CALL 'ZFL01RTK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01RTK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
