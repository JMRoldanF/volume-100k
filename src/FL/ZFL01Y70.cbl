      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL01Y70'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFL01HKS-001.
               PERFORM CALL-ZFL01NL3-002.
               PERFORM CALL-ZFL01PHO-003.
               PERFORM CALL-ZFL00UCV-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL00UCV-004.
               MOVE 'ZFL00UCV' TO WS-SUBNAME-5
               CALL WS-SUBNAME-5 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL00UCV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
