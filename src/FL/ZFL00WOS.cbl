      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00WOS'.
      ...
      * Called module names
       01  MOD-ZEX01JR3              PIC X(8) VALUE 'ZEX01JR3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEX01JR3-001.
               PERFORM CALL-ZFL01M20-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEX01JR3-001.
               CALL 'ZEX01JR3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEX01JR3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFL01M20-002.
               MOVE 'ZFL01M20' TO WS-SUBNAME-6
