      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00LM9'.
      ...
      * Called module names
       01  MOD-ZFL01MH2              PIC X(8) VALUE 'ZFL01MH2'.
       01  MOD-ZFL01L5D              PIC X(8) VALUE 'ZFL01L5D'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFL01MH2-001.
               PERFORM CALL-ZFL01L5D-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01MH2-001.
               CALL 'ZFL01MH2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01MH2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFL01L5D-002.
               CALL 'ZFL01L5D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01L5D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
