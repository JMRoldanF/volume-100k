      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00RCQ'.
      ...
      * Called module names
       01  MOD-ZQU01E9R              PIC X(8) VALUE 'ZQU01E9R'.
       01  MOD-ZFL01MAD              PIC X(8) VALUE 'ZFL01MAD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZQU01E9R-001.
               PERFORM CALL-ZFL01MAD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZQU01E9R-001.
               CALL 'ZQU01E9R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU01E9R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFL01MAD-002.
               CALL 'ZFL01MAD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01MAD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
