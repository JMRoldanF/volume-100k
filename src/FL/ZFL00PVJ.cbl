      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00PVJ'.
      ...
      * Called module names
       01  MOD-ZFL01KZV              PIC X(8) VALUE 'ZFL01KZV'.
       01  MOD-ZFL01V4F              PIC X(8) VALUE 'ZFL01V4F'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFL01KZV-001.
               PERFORM CALL-ZFL01V4F-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01KZV-001.
               CALL 'ZFL01KZV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01KZV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFL01V4F-002.
               CALL 'ZFL01V4F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01V4F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
