      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00ZHO'.
      ...
      * Called module names
       01  MOD-ZEX01QJQ              PIC X(8) VALUE 'ZEX01QJQ'.
       01  MOD-ZFL01KG1              PIC X(8) VALUE 'ZFL01KG1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEX01QJQ-001.
               PERFORM CALL-ZFL01KG1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEX01QJQ-001.
               CALL 'ZEX01QJQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEX01QJQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFL01KG1-002.
               CALL 'ZFL01KG1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01KG1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
