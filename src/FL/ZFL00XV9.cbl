      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00XV9'.
      ...
      * Called module names
       ...
       01  MOD-ZFL01SW9              PIC X(8) VALUE 'ZFL01SW9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFL01MHA-001.
               PERFORM CALL-ZFL01SW9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01SW9-002.
               CALL 'ZFL01SW9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01SW9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
