      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00Y35'.
      ...
      * Called module names
       01  MOD-ZFL01KZT              PIC X(8) VALUE 'ZFL01KZT'.
       01  MOD-ZFL01TKQ              PIC X(8) VALUE 'ZFL01TKQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01KZT-001.
               CALL 'ZFL01KZT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01KZT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFL01TKQ-002.
               CALL 'ZFL01TKQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01TKQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
