      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00WJM'.
      ...
      * Called module names
       01  MOD-ZFL01MY3              PIC X(8) VALUE 'ZFL01MY3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01MY3-001.
               CALL 'ZFL01MY3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01MY3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBA01SE4-002.
