      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL011UV'.
      ...
      * Called module names
       01  MOD-ZCP01NQZ              PIC X(8) VALUE 'ZCP01NQZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01NQZ-001.
               CALL 'ZCP01NQZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01NQZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
