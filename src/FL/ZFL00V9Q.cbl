      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00V9Q'.
      ...
      * Called module names
       01  MOD-ZFL01KOL              PIC X(8) VALUE 'ZFL01KOL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01KOL-001.
               CALL 'ZFL01KOL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01KOL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
