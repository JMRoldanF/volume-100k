      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00WWZ'.
      ...
      * Called module names
       01  MOD-ZFL01U2A              PIC X(8) VALUE 'ZFL01U2A'.
       01  MOD-ZEX01LV4              PIC X(8) VALUE 'ZEX01LV4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFL01U2A-001.
               PERFORM CALL-ZEX01LV4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01U2A-001.
               CALL 'ZFL01U2A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01U2A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEX01LV4-002.
               CALL 'ZEX01LV4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEX01LV4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
