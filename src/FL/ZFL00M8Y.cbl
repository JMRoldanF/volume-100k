      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00M8Y'.
      ...
      * Called module names
       01  MOD-ZQU01KUL              PIC X(8) VALUE 'ZQU01KUL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZQU01KUL-002.
               CALL 'ZQU01KUL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZQU01KUL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
