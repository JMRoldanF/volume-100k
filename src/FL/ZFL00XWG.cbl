      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00XWG'.
      ...
      * Called module names
       01  MOD-ZBA01SE3              PIC X(8) VALUE 'ZBA01SE3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBA01SE3-001.
               PERFORM CALL-ZFL01ELU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBA01SE3-001.
               CALL 'ZBA01SE3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBA01SE3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFL01ELU-002.
