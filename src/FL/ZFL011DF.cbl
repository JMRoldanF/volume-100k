      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL011DF'.
      ...
      * Called module names
       01  MOD-ZFL01IFL              PIC X(8) VALUE 'ZFL01IFL'.
       01  MOD-ZFL01CRJ              PIC X(8) VALUE 'ZFL01CRJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFL01IFL-001.
               PERFORM CALL-ZFL01CRJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01IFL-001.
               CALL 'ZFL01IFL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01IFL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFL01CRJ-002.
               CALL 'ZFL01CRJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01CRJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
