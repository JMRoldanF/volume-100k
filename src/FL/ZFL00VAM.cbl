      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00VAM'.
      ...
      * Called module names
       01  MOD-ZFL01QIF              PIC X(8) VALUE 'ZFL01QIF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01QIF-001.
               CALL 'ZFL01QIF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01QIF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-EXCESS-0001.
