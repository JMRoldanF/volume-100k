      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL00TQZ'.
      ...
      * Called module names
       ...
       01  MOD-ZFL01HGP              PIC X(8) VALUE 'ZFL01HGP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFL01GGD-001.
               PERFORM CALL-ZFL01HGP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01HGP-002.
               CALL 'ZFL01HGP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01HGP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
