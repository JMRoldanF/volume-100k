      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFL011VZ'.
      ...
      * Called module names
       01  MOD-ZFL01UVC              PIC X(8) VALUE 'ZFL01UVC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01UVC-001.
               CALL 'ZFL01UVC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01UVC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCP01QWN-002.
