      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBA00QDG'.
      ...
      * Called module names
       01  MOD-ZBA01QE9              PIC X(8) VALUE 'ZBA01QE9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBA01QE9-001.
               CALL 'ZBA01QE9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBA01QE9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
