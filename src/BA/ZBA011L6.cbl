      ******************************************************************
      * ZBA011L6 - BATCH CONTROL                                       *
      ******************************************************************
      *
      *  Generated volume-test source. Layer 2,
      *  type data_db2, domain BATCH.
      ******************************************************************
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBA011L6'.
      ...
      * Called module names
       01  MOD-ZLI01ISU              PIC X(8) VALUE 'ZLI01ISU'.
       01  MOD-ZBA01SQ2              PIC X(8) VALUE 'ZBA01SQ2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLI01ISU-001.
               PERFORM CALL-ZBA01SQ2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLI01ISU-001.
               CALL 'ZLI01ISU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLI01ISU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBA01SQ2-002.
               CALL 'ZBA01SQ2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBA01SQ2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
       ...
       SQL-ACCESS-0015.
               EXEC SQL
                     ...
                     SELECT POLICYNUMBER, PAYMENT
                       FROM GENABA.EXCESS A
                       JOIN GENABA.CUSTOMER B
