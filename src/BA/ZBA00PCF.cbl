      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBA00PCF'.
      ...
      * Called module names
       01  MOD-ZBR01QD5              PIC X(8) VALUE 'ZBR01QD5'.
       01  MOD-ZBA01IX1              PIC X(8) VALUE 'ZBA01IX1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBR01QD5-001.
               PERFORM CALL-ZBA01IX1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01QD5-001.
               CALL 'ZBR01QD5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01QD5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBA01IX1-002.
               CALL 'ZBA01IX1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBA01IX1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
