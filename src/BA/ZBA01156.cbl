      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBA01156'.
      ...
      * Called module names
       01  MOD-ZBA01HB3              PIC X(8) VALUE 'ZBA01HB3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBA01HB3-001.
               CALL 'ZBA01HB3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBA01HB3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-MODEL-0001.
