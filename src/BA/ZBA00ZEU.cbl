      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBA00ZEU'.
      ...
      * Called module names
       01  MOD-ZBA01TTE              PIC X(8) VALUE 'ZBA01TTE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBA01TTE-001.
               PERFORM CALL-ZBA01S2J-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBA01TTE-001.
               CALL 'ZBA01TTE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBA01TTE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBA01S2J-002.
