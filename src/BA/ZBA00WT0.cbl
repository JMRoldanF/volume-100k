      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBA00WT0'.
      ...
      * Called module names
       01  MOD-ZBA01O7X              PIC X(8) VALUE 'ZBA01O7X'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBA01O7X-001.
               CALL 'ZBA01O7X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBA01O7X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSC01KV9-002.
