      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBA00T5D'.
      ...
      * Called module names
       ...
       01  MOD-ZBA01UW4              PIC X(8) VALUE 'ZBA01UW4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBA01UW4-002.
               CALL 'ZBA01UW4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBA01UW4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
