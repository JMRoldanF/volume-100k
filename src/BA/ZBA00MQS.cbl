      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBA00MQS'.
      ...
      * Called module names
       ...
       01  MOD-ZBA01S0H              PIC X(8) VALUE 'ZBA01S0H'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBA01F6E-001.
               PERFORM CALL-ZBA01S0H-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBA01S0H-002.
               CALL 'ZBA01S0H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBA01S0H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
