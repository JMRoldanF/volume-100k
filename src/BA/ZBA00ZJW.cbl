      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBA00ZJW'.
      ...
      * Called module names
       ...
       01  MOD-ZBA01T5R              PIC X(8) VALUE 'ZBA01T5R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBA01T5R-002.
               CALL 'ZBA01T5R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBA01T5R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
