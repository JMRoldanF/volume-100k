      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBA00RRK'.
      ...
      * Called module names
       ...
       01  MOD-ZBA01FDK              PIC X(8) VALUE 'ZBA01FDK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBA01FDK-002.
               CALL 'ZBA01FDK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBA01FDK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
