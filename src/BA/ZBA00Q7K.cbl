      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBA00Q7K'.
      ...
      * Called module names
       01  MOD-ZBA01J2M              PIC X(8) VALUE 'ZBA01J2M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBA01J2M-001.
               CALL 'ZBA01J2M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBA01J2M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
