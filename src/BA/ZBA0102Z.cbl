      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBA0102Z'.
      ...
      * Called module names
       01  MOD-ZBA01RO5              PIC X(8) VALUE 'ZBA01RO5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBA01RO5-001.
               CALL 'ZBA01RO5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBA01RO5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
