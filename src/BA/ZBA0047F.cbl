      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBA0047F'.
      ...
      * Called module names
       01  MOD-ZBA00KA3              PIC X(8) VALUE 'ZBA00KA3'.
       01  MOD-ZBA00JCT              PIC X(8) VALUE 'ZBA00JCT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBA00KA3-001.
               PERFORM CALL-ZBA00JCT-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBA00KA3-001.
               EXEC CICS LINK PROGRAM('ZBA00KA3')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBA00KA3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBA00JCT-002.
               EXEC CICS LINK PROGRAM('ZBA00JCT')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBA00JCT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
