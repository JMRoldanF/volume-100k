      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBA00NOR'.
      ...
      * Called module names
       01  MOD-ZBR01P37              PIC X(8) VALUE 'ZBR01P37'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01P37-001.
               CALL 'ZBR01P37' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01P37 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBA01TYY-002.
