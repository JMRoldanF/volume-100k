      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBA00NY5'.
      ...
      * Called module names
       01  MOD-ZBA01F1Q              PIC X(8) VALUE 'ZBA01F1Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBA01F1Q-001.
               CALL 'ZBA01F1Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBA01F1Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBA01U43-002.
