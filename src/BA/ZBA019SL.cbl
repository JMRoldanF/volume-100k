      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBA019SL'.
      ...
      * Called module names
       01  MOD-ZBA01DVG              PIC X(8) VALUE 'ZBA01DVG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBA01DVG-001.
               CALL 'ZBA01DVG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBA01DVG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
