      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBA00YS1'.
      ...
      * Called module names
       01  MOD-ZBA01HBH              PIC X(8) VALUE 'ZBA01HBH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBA01HBH-001.
               CALL 'ZBA01HBH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBA01HBH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
