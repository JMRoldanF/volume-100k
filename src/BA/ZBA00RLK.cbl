      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBA00RLK'.
      ...
      * Called module names
       01  MOD-ZBA01SSG              PIC X(8) VALUE 'ZBA01SSG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBA01SSG-001.
               PERFORM CALL-ZBA01MXU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBA01SSG-001.
               CALL 'ZBA01SSG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBA01SSG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBA01MXU-002.
