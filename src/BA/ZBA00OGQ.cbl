      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBA00OGQ'.
      ...
      * Called module names
       01  MOD-ZBA01ODB              PIC X(8) VALUE 'ZBA01ODB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBA01ODB-001.
               CALL 'ZBA01ODB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
