      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBA00YMO'.
      ...
      * Called module names
       01  MOD-ZBA01HBY              PIC X(8) VALUE 'ZBA01HBY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBA01HBY-001.
               PERFORM CALL-ZBA01LE1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBA01HBY-001.
               CALL 'ZBA01HBY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBA01HBY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBA01LE1-002.
