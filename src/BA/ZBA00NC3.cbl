      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBA00NC3'.
      ...
      * Called module names
       01  MOD-ZBA01P4X              PIC X(8) VALUE 'ZBA01P4X'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBA01UP7-001.
               PERFORM CALL-ZBA01P4X-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBA01P4X-002.
               CALL 'ZBA01P4X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBA01P4X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
