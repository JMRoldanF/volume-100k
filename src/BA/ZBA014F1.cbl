      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBA014F1'.
      ...
      * Called module names
       01  MOD-ZBA01MKS              PIC X(8) VALUE 'ZBA01MKS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBA01MKS-001.
               CALL 'ZBA01MKS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBA01MKS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
