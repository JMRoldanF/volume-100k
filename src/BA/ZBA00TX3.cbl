      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBA00TX3'.
      ...
      * Called module names
       01  MOD-ZSC01PAP              PIC X(8) VALUE 'ZSC01PAP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSC01PAP-001.
               CALL 'ZSC01PAP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC01PAP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
