      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCP00QHC'.
      ...
      * Called module names
       01  MOD-ZCP01CTP              PIC X(8) VALUE 'ZCP01CTP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01CTP-001.
               CALL 'ZCP01CTP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01CTP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
