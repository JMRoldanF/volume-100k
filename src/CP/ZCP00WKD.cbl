      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCP00WKD'.
      ...
      * Called module names
       01  MOD-ZCP01GUB              PIC X(8) VALUE 'ZCP01GUB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01GUB-001.
               CALL 'ZCP01GUB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01GUB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
