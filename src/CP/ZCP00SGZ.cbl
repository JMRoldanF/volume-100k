      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCP00SGZ'.
      ...
      * Called module names
       01  MOD-ZCP01HNN              PIC X(8) VALUE 'ZCP01HNN'.
       01  MOD-ZCP01SCV              PIC X(8) VALUE 'ZCP01SCV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCP01HNN-001.
               PERFORM CALL-ZCP01SCV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01HNN-001.
               CALL 'ZCP01HNN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01HNN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCP01SCV-002.
               CALL 'ZCP01SCV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01SCV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
