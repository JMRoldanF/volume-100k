      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCP00ZNH'.
      ...
      * Called module names
       01  MOD-ZCP01P8X              PIC X(8) VALUE 'ZCP01P8X'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01P8X-001.
               CALL 'ZCP01P8X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01P8X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCP01ND9-002.
