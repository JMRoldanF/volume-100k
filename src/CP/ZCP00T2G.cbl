      ******************************************************************
      * ZCP00T2G - COMPLIANCE CHECKS                                   *
      ******************************************************************
      *
      *  Generated volume-test source. Layer 2,
      *  type data_db2, domain COMPLNC.
      ******************************************************************
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCP00T2G'.
      ...
      * Called module names
       01  MOD-ZCP01S1F              PIC X(8) VALUE 'ZCP01S1F'.
       01  MOD-ZCP01JSU              PIC X(8) VALUE 'ZCP01JSU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01S1F-001.
               CALL 'ZCP01S1F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01S1F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCP01JSU-002.
               CALL 'ZCP01JSU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01JSU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
       ...
       SQL-ACCESS-0009.
               EXEC SQL
                     ...
                     SELECT POLICYNUMBER, PAYMENT
                       FROM GENACP.EXCESS A
                       JOIN GENACP.CUSTOMER B
