      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCP01B36'.
      ...
      * Called module names
       01  MOD-ZCU01S39              PIC X(8) VALUE 'ZCU01S39'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01S39-001.
               CALL 'ZCU01S39' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01S39 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
