      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCP00WEY'.
      ...
      * Called module names
       01  MOD-ZCP01IRN              PIC X(8) VALUE 'ZCP01IRN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCP01IRN-001.
               PERFORM CALL-ZCP01NQZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01IRN-001.
               CALL 'ZCP01IRN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01IRN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCP01NQZ-002.
