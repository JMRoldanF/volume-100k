      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCP012ED'.
      ...
      * Called module names
       01  MOD-ZCP01HD0              PIC X(8) VALUE 'ZCP01HD0'.
       01  MOD-ZCP01MT8              PIC X(8) VALUE 'ZCP01MT8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCP01HD0-001.
               PERFORM CALL-ZCP01MT8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01HD0-001.
               CALL 'ZCP01HD0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01HD0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCP01MT8-002.
               CALL 'ZCP01MT8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01MT8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
