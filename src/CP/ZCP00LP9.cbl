      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCP00LP9'.
      ...
      * Called module names
       01  MOD-ZIV01EFX              PIC X(8) VALUE 'ZIV01EFX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIV01EFX-001.
               PERFORM CALL-ZCP01J3M-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01EFX-001.
               CALL 'ZIV01EFX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01EFX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCP01J3M-002.
