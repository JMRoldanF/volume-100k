      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCP00PYS'.
      ...
      * Called module names
       01  MOD-ZCP01I0T              PIC X(8) VALUE 'ZCP01I0T'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01I0T-001.
               CALL 'ZCP01I0T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01I0T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
