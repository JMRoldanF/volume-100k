      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCP00UQ4'.
      ...
      * Called module names
       01  MOD-ZCU01MVA              PIC X(8) VALUE 'ZCU01MVA'.
       01  MOD-ZCP01QWN              PIC X(8) VALUE 'ZCP01QWN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01MVA-001.
               PERFORM CALL-ZCP01QWN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01MVA-001.
               CALL 'ZCU01MVA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01MVA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCP01QWN-002.
               CALL 'ZCP01QWN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01QWN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
