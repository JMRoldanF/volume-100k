      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCP00UHD'.
      ...
      * Called module names
       01  MOD-ZCP01KV6              PIC X(8) VALUE 'ZCP01KV6'.
       01  MOD-ZRN01DIC              PIC X(8) VALUE 'ZRN01DIC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCP01KV6-001.
               PERFORM CALL-ZRN01DIC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01KV6-001.
               CALL 'ZCP01KV6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01KV6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRN01DIC-002.
               CALL 'ZRN01DIC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRN01DIC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
