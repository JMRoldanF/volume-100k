      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCP00ME8'.
      ...
      * Called module names
       01  MOD-ZCP01O83              PIC X(8) VALUE 'ZCP01O83'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01O83-001.
               CALL 'ZCP01O83' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01O83 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
