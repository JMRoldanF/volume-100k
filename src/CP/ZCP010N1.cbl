      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCP010N1'.
      ...
      * Called module names
       01  MOD-ZCP01NFX              PIC X(8) VALUE 'ZCP01NFX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01NFX-001.
               CALL 'ZCP01NFX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01NFX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCP01OYZ-002.
