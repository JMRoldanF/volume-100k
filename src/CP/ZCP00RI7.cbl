      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCP00RI7'.
      ...
      * Called module names
       01  MOD-ZCP01PE9              PIC X(8) VALUE 'ZCP01PE9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01PE9-001.
               CALL 'ZCP01PE9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01PE9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCP01GUB-002.
