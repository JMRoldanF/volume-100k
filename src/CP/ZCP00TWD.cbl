      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCP00TWD'.
      ...
      * Called module names
       01  MOD-ZCP01SL2              PIC X(8) VALUE 'ZCP01SL2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01SL2-001.
               CALL 'ZCP01SL2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01SL2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
