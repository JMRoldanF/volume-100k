      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCP00RFC'.
      ...
      * Called module names
       01  MOD-ZCP01S5L              PIC X(8) VALUE 'ZCP01S5L'.
       01  MOD-ZCP01QT7              PIC X(8) VALUE 'ZCP01QT7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCP01S5L-001.
               PERFORM CALL-ZCP01QT7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01S5L-001.
               CALL 'ZCP01S5L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01S5L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCP01QT7-002.
               CALL 'ZCP01QT7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01QT7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
