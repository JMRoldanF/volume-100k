      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCP00Z78'.
      ...
      * Called module names
       01  MOD-ZCP01QZ3              PIC X(8) VALUE 'ZCP01QZ3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01QZ3-001.
               CALL 'ZCP01QZ3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01QZ3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
