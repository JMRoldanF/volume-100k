      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCP0103V'.
      ...
      * Called module names
       ...
       01  MOD-ZCP01TIC              PIC X(8) VALUE 'ZCP01TIC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCP01GL1-001.
               PERFORM CALL-ZCP01TIC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01TIC-002.
               CALL 'ZCP01TIC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01TIC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
