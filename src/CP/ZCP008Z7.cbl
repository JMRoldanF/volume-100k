      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCP008Z7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCP014KG-002.
               PERFORM CALL-ZCP015DU-003.
               PERFORM CALL-ZCP01ND9-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP00V7G-001.
               MOVE 'ZCP00V7G' TO WS-PROGNAME-1
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP00V7G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCP014KG-002.
               MOVE 'ZCP014KG' TO WS-PROGNAME-2
      ...
      *----------------------------------------------------------------*
       CALL-ZCP015DU-003.
               MOVE 'ZCP015DU' TO WS-PROGNAME-3
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP015DU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCP01ND9-004.
               MOVE 'ZCP01ND9' TO WS-SUBNAME-4
