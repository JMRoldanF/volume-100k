      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCP01AJG'.
      ...
      * Called module names
       01  MOD-ZCP01EQ7              PIC X(8) VALUE 'ZCP01EQ7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCP01EQ7-001.
               PERFORM CALL-ZRN01E4C-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01EQ7-001.
               CALL 'ZCP01EQ7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01EQ7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRN01E4C-002.
               MOVE 'ZRN01E4C' TO WS-SUBNAME-7
