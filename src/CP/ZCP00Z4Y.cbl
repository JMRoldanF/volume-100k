      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCP00Z4Y'.
      ...
      * Called module names
       01  MOD-ZCP01DAM              PIC X(8) VALUE 'ZCP01DAM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCP01DAM-001.
               PERFORM CALL-ZCP01CTU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01DAM-001.
               CALL 'ZCP01DAM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
