      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCP00UN8'.
      ...
      * Called module names
       01  MOD-ZCP01RBI              PIC X(8) VALUE 'ZCP01RBI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01RBI-001.
               CALL 'ZCP01RBI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01RBI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIV01GO0-002.
