      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCP00VZ5'.
      ...
      * Called module names
       01  MOD-ZCP01QUL              PIC X(8) VALUE 'ZCP01QUL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01QUL-001.
               CALL 'ZCP01QUL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01QUL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
