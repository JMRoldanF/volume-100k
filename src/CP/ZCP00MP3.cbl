      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCP00MP3'.
      ...
      * Called module names
       01  MOD-ZCP01INJ              PIC X(8) VALUE 'ZCP01INJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01INJ-001.
               CALL 'ZCP01INJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01INJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
