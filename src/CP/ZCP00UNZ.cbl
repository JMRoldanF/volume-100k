      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCP00UNZ'.
      ...
      * Called module names
       01  MOD-ZCP01RPR              PIC X(8) VALUE 'ZCP01RPR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRN01LN3-001.
               PERFORM CALL-ZCP01RPR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01RPR-002.
               CALL 'ZCP01RPR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01RPR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
