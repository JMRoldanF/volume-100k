      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCP00UQI'.
      ...
      * Called module names
       01  MOD-ZCP01GC0              PIC X(8) VALUE 'ZCP01GC0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01GC0-001.
               CALL 'ZCP01GC0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01GC0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
