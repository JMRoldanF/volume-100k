      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCP00YHE'.
      ...
      * Called module names
       01  MOD-ZCP01UIT              PIC X(8) VALUE 'ZCP01UIT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCP01UIT-001.
               PERFORM CALL-ZCP01M6O-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01UIT-001.
               CALL 'ZCP01UIT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01UIT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCP01M6O-002.
               MOVE 'ZCP01M6O' TO WS-SUBNAME-2
