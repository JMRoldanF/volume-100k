      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCP004Z4'.
      ...
      * Called module names
       01  MOD-ZCP009F6              PIC X(8) VALUE 'ZCP009F6'.
       01  MOD-ZCP00FHZ              PIC X(8) VALUE 'ZCP00FHZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCP008UB-001.
               PERFORM CALL-ZCP009F6-002.
               PERFORM CALL-ZCP00FHZ-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP008UB-001.
               MOVE 'ZCP008UB' TO WS-PROGNAME-3
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP008UB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCP009F6-002.
               EXEC CICS LINK PROGRAM('ZCP009F6')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP009F6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCP00FHZ-003.
               EXEC CICS LINK PROGRAM('ZCP00FHZ')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP00FHZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-004.
