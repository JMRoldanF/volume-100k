      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCP00QYV'.
      ...
      * Called module names
       ...
       01  MOD-ZCP01JZ0              PIC X(8) VALUE 'ZCP01JZ0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCP01JZ0-002.
               CALL 'ZCP01JZ0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCP01JZ0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
