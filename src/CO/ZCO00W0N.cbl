      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00W0N'.
      ...
      * Called module names
       01  MOD-ZAR01QEL              PIC X(8) VALUE 'ZAR01QEL'.
       01  MOD-ZCO01K92              PIC X(8) VALUE 'ZCO01K92'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAR01QEL-001.
               PERFORM CALL-ZCO01K92-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01QEL-001.
               CALL 'ZAR01QEL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01QEL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCO01K92-002.
               CALL 'ZCO01K92' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01K92 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
