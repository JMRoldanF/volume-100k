      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00LUH'.
      ...
      * Called module names
       ...
       01  MOD-ZCO01DMI              PIC X(8) VALUE 'ZCO01DMI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01DMI-002.
               CALL 'ZCO01DMI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01DMI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
