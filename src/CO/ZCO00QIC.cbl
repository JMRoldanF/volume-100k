      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00QIC'.
      ...
      * Called module names
       ...
       01  MOD-ZCO01DBH              PIC X(8) VALUE 'ZCO01DBH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01DBH-002.
               CALL 'ZCO01DBH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01DBH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
