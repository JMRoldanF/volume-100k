      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00LPH'.
      ...
      * Called module names
       01  MOD-ZCO01TFU              PIC X(8) VALUE 'ZCO01TFU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01TFU-002.
               CALL 'ZCO01TFU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01TFU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
