      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00O3L'.
      ...
      * Called module names
       01  MOD-ZCO01UP6              PIC X(8) VALUE 'ZCO01UP6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01UP6-001.
               CALL 'ZCO01UP6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01UP6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
