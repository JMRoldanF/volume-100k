      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00N29'.
      ...
      * Called module names
       01  MOD-ZCO01F8Q              PIC X(8) VALUE 'ZCO01F8Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01F8Q-001.
               CALL 'ZCO01F8Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01F8Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
