      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO012KU'.
      ...
      * Called module names
       01  MOD-ZHO01KEH              PIC X(8) VALUE 'ZHO01KEH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01KEH-001.
               PERFORM CALL-ZCO01HMQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01KEH-001.
               CALL 'ZHO01KEH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01KEH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCO01HMQ-002.
