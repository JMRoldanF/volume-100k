      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00M7L'.
      ...
      * Called module names
       01  MOD-ZCO01QPN              PIC X(8) VALUE 'ZCO01QPN'.
       01  MOD-ZCO01OVO              PIC X(8) VALUE 'ZCO01OVO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCO01QPN-001.
               PERFORM CALL-ZCO01OVO-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01QPN-001.
               CALL 'ZCO01QPN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01QPN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCO01OVO-002.
               CALL 'ZCO01OVO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01OVO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-PREMIUM-0001.
