      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00LYU'.
      ...
      * Called module names
       01  MOD-ZCO01DY9              PIC X(8) VALUE 'ZCO01DY9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01DY9-001.
               CALL 'ZCO01DY9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01DY9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
