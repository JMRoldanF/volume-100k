      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO01275'.
      ...
      * Called module names
       01  MOD-ZCO01JNR              PIC X(8) VALUE 'ZCO01JNR'.
       01  MOD-ZCO01PZK              PIC X(8) VALUE 'ZCO01PZK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCO01JNR-001.
               PERFORM CALL-ZCO01PZK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01JNR-001.
               CALL 'ZCO01JNR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01JNR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCO01PZK-002.
               CALL 'ZCO01PZK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01PZK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
