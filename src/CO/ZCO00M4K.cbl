      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00M4K'.
      ...
      * Called module names
       01  MOD-ZCO01JW6              PIC X(8) VALUE 'ZCO01JW6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01JW6-001.
               CALL 'ZCO01JW6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01JW6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZNT01F6L-002.
