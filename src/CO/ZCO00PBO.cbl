      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00PBO'.
      ...
      * Called module names
       01  MOD-ZNT01JG8              PIC X(8) VALUE 'ZNT01JG8'.
       01  MOD-ZCO01QED              PIC X(8) VALUE 'ZCO01QED'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZNT01JG8-001.
               PERFORM CALL-ZCO01QED-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01JG8-001.
               CALL 'ZNT01JG8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01JG8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCO01QED-002.
               CALL 'ZCO01QED' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01QED FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
