      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00WB7'.
      ...
      * Called module names
       01  MOD-ZCO01CMI              PIC X(8) VALUE 'ZCO01CMI'.
       01  MOD-ZHO01QFF              PIC X(8) VALUE 'ZHO01QFF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01CMI-001.
               CALL 'ZCO01CMI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01CMI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01QFF-002.
               CALL 'ZHO01QFF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01QFF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
