      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO010NK'.
      ...
      * Called module names
       01  MOD-ZCO01QJF              PIC X(8) VALUE 'ZCO01QJF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01QJF-001.
               CALL 'ZCO01QJF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01QJF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
