      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00SER'.
      ...
      * Called module names
       01  MOD-ZCO01ONE              PIC X(8) VALUE 'ZCO01ONE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01ONE-001.
               CALL 'ZCO01ONE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01ONE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
