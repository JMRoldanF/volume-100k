      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO0121Z'.
      ...
      * Called module names
       01  MOD-ZCO01COI              PIC X(8) VALUE 'ZCO01COI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01COI-001.
               CALL 'ZCO01COI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01COI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
