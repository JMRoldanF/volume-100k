      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO01NXA'.
      ...
      * Called module names
       01  MOD-ZCO01UDC              PIC X(8) VALUE 'ZCO01UDC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01UDC-001.
               CALL 'ZCO01UDC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01UDC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
