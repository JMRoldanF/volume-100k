      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00WTU'.
      ...
      * Called module names
       01  MOD-ZCO01SVN              PIC X(8) VALUE 'ZCO01SVN'.
       01  MOD-ZCO01QOX              PIC X(8) VALUE 'ZCO01QOX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01SVN-001.
               CALL 'ZCO01SVN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01SVN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCO01QOX-002.
               CALL 'ZCO01QOX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01QOX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
