      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO010YZ'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01SVS              PIC X(8) VALUE 'ZHO01SVS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01SVS-002.
               CALL 'ZHO01SVS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01SVS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
