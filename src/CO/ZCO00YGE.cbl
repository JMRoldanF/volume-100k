      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00YGE'.
      ...
      * Called module names
       01  MOD-ZHO01HMI              PIC X(8) VALUE 'ZHO01HMI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01HMI-001.
               CALL 'ZHO01HMI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01HMI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCO01LFK-002.
