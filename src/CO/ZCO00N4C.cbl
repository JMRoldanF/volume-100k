      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00N4C'.
      ...
      * Called module names
       01  MOD-ZCO01SAB              PIC X(8) VALUE 'ZCO01SAB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01SAB-001.
               CALL 'ZCO01SAB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01SAB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
