      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO01A2K'.
      ...
      * Called module names
       01  MOD-ZCO01TJD              PIC X(8) VALUE 'ZCO01TJD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01TJD-001.
               CALL 'ZCO01TJD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01TJD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
