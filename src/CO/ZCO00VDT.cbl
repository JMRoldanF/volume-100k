      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00VDT'.
      ...
      * Called module names
       01  MOD-ZCO01GLD              PIC X(8) VALUE 'ZCO01GLD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01GLD-001.
               CALL 'ZCO01GLD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01GLD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
