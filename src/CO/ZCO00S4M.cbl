      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00S4M'.
      ...
      * Called module names
       01  MOD-ZAR01DJW              PIC X(8) VALUE 'ZAR01DJW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01DJW-001.
               CALL 'ZAR01DJW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01DJW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
