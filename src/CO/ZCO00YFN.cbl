      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00YFN'.
      ...
      * Called module names
       01  MOD-ZCO01SHP              PIC X(8) VALUE 'ZCO01SHP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01SHP-002.
               CALL 'ZCO01SHP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
