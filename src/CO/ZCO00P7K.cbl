      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00P7K'.
      ...
      * Called module names
       ...
       01  MOD-ZCO01ONT              PIC X(8) VALUE 'ZCO01ONT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01ONT-002.
               CALL 'ZCO01ONT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01ONT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
