      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00TC8'.
      ...
      * Called module names
       01  MOD-ZCO01KHF              PIC X(8) VALUE 'ZCO01KHF'.
       01  MOD-ZCO01G35              PIC X(8) VALUE 'ZCO01G35'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCO01KHF-001.
               PERFORM CALL-ZCO01G35-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01KHF-001.
               CALL 'ZCO01KHF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01G35-002.
               CALL 'ZCO01G35' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
