      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00Y04'.
      ...
      * Called module names
       01  MOD-ZAR01TY6              PIC X(8) VALUE 'ZAR01TY6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01TY6-001.
               CALL 'ZAR01TY6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01TY6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCO01PN4-002.
