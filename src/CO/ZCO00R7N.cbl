      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00R7N'.
      ...
      * Called module names
       01  MOD-ZCO01P6V              PIC X(8) VALUE 'ZCO01P6V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01P6V-002.
               CALL 'ZCO01P6V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01P6V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
