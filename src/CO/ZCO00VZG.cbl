      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00VZG'.
      ...
      * Called module names
       01  MOD-ZCO01RAG              PIC X(8) VALUE 'ZCO01RAG'.
       01  MOD-ZCO01Q0B              PIC X(8) VALUE 'ZCO01Q0B'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCO01RAG-001.
               PERFORM CALL-ZCO01Q0B-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01RAG-001.
               CALL 'ZCO01RAG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01RAG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCO01Q0B-002.
               CALL 'ZCO01Q0B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
