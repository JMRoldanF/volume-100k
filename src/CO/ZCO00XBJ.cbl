      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00XBJ'.
      ...
      * Called module names
       ...
       01  MOD-ZCO01EDR              PIC X(8) VALUE 'ZCO01EDR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPN01MHY-001.
               PERFORM CALL-ZCO01EDR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01EDR-002.
               CALL 'ZCO01EDR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01EDR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
