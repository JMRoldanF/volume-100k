      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00YV6'.
      ...
      * Called module names
       01  MOD-ZCO01GQS              PIC X(8) VALUE 'ZCO01GQS'.
       01  MOD-ZCO01MY8              PIC X(8) VALUE 'ZCO01MY8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCO01GQS-001.
               PERFORM CALL-ZCO01MY8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01GQS-001.
               CALL 'ZCO01GQS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01GQS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCO01MY8-002.
               CALL 'ZCO01MY8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01MY8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
