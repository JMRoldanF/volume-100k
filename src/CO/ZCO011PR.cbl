      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO011PR'.
      ...
      * Called module names
       01  MOD-ZCO01HVO              PIC X(8) VALUE 'ZCO01HVO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01HVO-001.
               CALL 'ZCO01HVO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01HVO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
