      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00WBF'.
      ...
      * Called module names
       01  MOD-ZCO01IOJ              PIC X(8) VALUE 'ZCO01IOJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01IOJ-001.
               CALL 'ZCO01IOJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01IOJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
