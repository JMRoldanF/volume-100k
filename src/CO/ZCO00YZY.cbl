      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00YZY'.
      ...
      * Called module names
       01  MOD-ZCO01TPI              PIC X(8) VALUE 'ZCO01TPI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCO01TPI-001.
               PERFORM CALL-ZCO01QQ2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01TPI-001.
               CALL 'ZCO01TPI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
