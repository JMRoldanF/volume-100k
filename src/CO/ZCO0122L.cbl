      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO0122L'.
      ...
      * Called module names
       01  MOD-ZCO01ISJ              PIC X(8) VALUE 'ZCO01ISJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01ISJ-001.
               CALL 'ZCO01ISJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01ISJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
