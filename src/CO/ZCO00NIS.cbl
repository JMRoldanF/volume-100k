      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00NIS'.
      ...
      * Called module names
       01  MOD-ZCO01SV2              PIC X(8) VALUE 'ZCO01SV2'.
       01  MOD-ZCO01TDS              PIC X(8) VALUE 'ZCO01TDS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCO01SV2-001.
               PERFORM CALL-ZCO01TDS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01SV2-001.
               CALL 'ZCO01SV2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01SV2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCO01TDS-002.
               CALL 'ZCO01TDS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01TDS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
