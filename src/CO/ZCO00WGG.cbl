      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00WGG'.
      ...
      * Called module names
       01  MOD-ZCO01SM7              PIC X(8) VALUE 'ZCO01SM7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01SM7-001.
               CALL 'ZCO01SM7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01SM7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-POSTCODE-0001.
