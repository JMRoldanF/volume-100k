      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO011PO'.
      ...
      * Called module names
       01  MOD-ZCO01GBY              PIC X(8) VALUE 'ZCO01GBY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01GBY-001.
               CALL 'ZCO01GBY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01GBY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
