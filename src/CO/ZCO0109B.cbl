      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO0109B'.
      ...
      * Called module names
       01  MOD-ZCO01F6B              PIC X(8) VALUE 'ZCO01F6B'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCO01F6B-001.
               PERFORM CALL-ZNT01GMQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01F6B-001.
               CALL 'ZCO01F6B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01F6B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZNT01GMQ-002.
