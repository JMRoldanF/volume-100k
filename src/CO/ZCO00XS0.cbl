      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00XS0'.
      ...
      * Called module names
       01  MOD-ZNT01M8K              PIC X(8) VALUE 'ZNT01M8K'.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01M8K-001.
               CALL 'ZNT01M8K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01M8K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
