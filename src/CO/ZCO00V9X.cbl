      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00V9X'.
      ...
      * Called module names
       01  MOD-ZCO01SR2              PIC X(8) VALUE 'ZCO01SR2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCO01SR2-001.
               PERFORM CALL-ZCO01ION-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01SR2-001.
               CALL 'ZCO01SR2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01SR2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCO01ION-002.
