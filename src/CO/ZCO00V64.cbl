      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00V64'.
      ...
      * Called module names
       01  MOD-ZCO01E1Y              PIC X(8) VALUE 'ZCO01E1Y'.
       01  MOD-ZCO01SQ8              PIC X(8) VALUE 'ZCO01SQ8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCO01E1Y-001.
               PERFORM CALL-ZCO01SQ8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01E1Y-001.
               CALL 'ZCO01E1Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01E1Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCO01SQ8-002.
               CALL 'ZCO01SQ8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01SQ8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
