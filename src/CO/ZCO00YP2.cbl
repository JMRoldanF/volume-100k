      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00YP2'.
      ...
      * Called module names
       01  MOD-ZCO01KEG              PIC X(8) VALUE 'ZCO01KEG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCO01KEG-001.
               PERFORM CALL-ZCO01NJH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01KEG-001.
               CALL 'ZCO01KEG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01KEG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCO01NJH-002.
