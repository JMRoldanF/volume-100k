      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCO00SYG'.
      ...
      * Called module names
       01  MOD-ZCO01IUP              PIC X(8) VALUE 'ZCO01IUP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01IUP-001.
               CALL 'ZCO01IUP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01IUP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
