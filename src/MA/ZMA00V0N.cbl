      ******************************************************************
      * ZMA00V0N - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00V0N'.
      ...
      * Called module names
       01  MOD-ZMA01OHF              PIC X(8) VALUE 'ZMA01OHF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMA01OHF-001.
               PERFORM CALL-ZCU0255O-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZMA01OHF-001.
               CALL 'ZMA01OHF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
