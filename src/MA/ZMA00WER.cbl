      ******************************************************************
      * ZMA00WER - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00WER'.
      ...
      * Called module names
       01  MOD-ZMA01QWS              PIC X(8) VALUE 'ZMA01QWS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMA01QWS-001.
               PERFORM CALL-ZMA01HU1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01QWS-001.
               CALL 'ZMA01QWS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01QWS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMA01HU1-002.
