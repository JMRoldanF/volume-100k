      ******************************************************************
      * ZMA00VM8 - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00VM8'.
      ...
      * Called module names
       01  MOD-ZMA01ELE              PIC X(8) VALUE 'ZMA01ELE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01ELE-001.
               CALL 'ZMA01ELE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01ELE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-TERM-0001.
