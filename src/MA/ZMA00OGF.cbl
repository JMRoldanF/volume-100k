      ******************************************************************
      * ZMA00OGF - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00OGF'.
      ...
      * Called module names
       01  MOD-ZTY01H5V              PIC X(8) VALUE 'ZTY01H5V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01H5V-001.
               CALL 'ZTY01H5V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01H5V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
