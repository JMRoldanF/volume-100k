      ******************************************************************
      * ZMA00OAN - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00OAN'.
      ...
      * Called module names
       01  MOD-ZTY01FA8              PIC X(8) VALUE 'ZTY01FA8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01FA8-001.
               CALL 'ZTY01FA8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01FA8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
