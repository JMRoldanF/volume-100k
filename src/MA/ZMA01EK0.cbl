      ******************************************************************
      * ZMA01EK0 - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA01EK0'.
      ...
      * Called module names
       01  MOD-ZMA01LZA              PIC X(8) VALUE 'ZMA01LZA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01LZA-001.
               CALL 'ZMA01LZA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01LZA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
