      ******************************************************************
      * ZMA012H7 - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA012H7'.
      ...
      * Called module names
       01  MOD-ZMA01TKB              PIC X(8) VALUE 'ZMA01TKB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01TKB-001.
               CALL 'ZMA01TKB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01TKB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
