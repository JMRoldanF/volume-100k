      ******************************************************************
      * ZMA00XTA - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00XTA'.
      ...
      * Called module names
       ...
       01  MOD-ZPR01QAI              PIC X(8) VALUE 'ZPR01QAI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR01QAI-002.
               CALL 'ZPR01QAI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01QAI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
