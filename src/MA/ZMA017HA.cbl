      ******************************************************************
      * ZMA017HA - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA017HA'.
      ...
      * Called module names
       ...
       01  MOD-ZMA01EOY              PIC X(8) VALUE 'ZMA01EOY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMA01PV2-001.
               PERFORM CALL-ZMA01EOY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01EOY-002.
               CALL 'ZMA01EOY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01EOY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
