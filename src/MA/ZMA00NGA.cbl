      ******************************************************************
      * ZMA00NGA - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00NGA'.
      ...
      * Called module names
       01  MOD-ZTY01JCS              PIC X(8) VALUE 'ZTY01JCS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTY01JCS-001.
               PERFORM CALL-ZMA01UQY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01JCS-001.
               CALL 'ZTY01JCS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01JCS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMA01UQY-002.
