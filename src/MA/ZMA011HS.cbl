      ******************************************************************
      * ZMA011HS - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA011HS'.
      ...
      * Called module names
       01  MOD-ZMA01MNS              PIC X(8) VALUE 'ZMA01MNS'.
       01  MOD-ZMA01Q81              PIC X(8) VALUE 'ZMA01Q81'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMA01MNS-001.
               PERFORM CALL-ZMA01Q81-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01MNS-001.
               CALL 'ZMA01MNS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01Q81-002.
               CALL 'ZMA01Q81' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01Q81 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-TAX-BAND-0001.
