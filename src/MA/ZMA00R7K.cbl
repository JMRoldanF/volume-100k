      ******************************************************************
      * ZMA00R7K - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00R7K'.
      ...
      * Called module names
       ...
       01  MOD-ZSE01QOW              PIC X(8) VALUE 'ZSE01QOW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMA01HK5-001.
               PERFORM CALL-ZSE01QOW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01QOW-002.
               CALL 'ZSE01QOW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01QOW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
