      ******************************************************************
      * ZMA00K9K - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00K9K'.
      ...
      * Called module names
       01  MOD-ZMA00XO0              PIC X(8) VALUE 'ZMA00XO0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMA0123O-001.
               PERFORM CALL-ZMA00XO0-002.
               PERFORM CALL-ZMA00LQ5-003.
               PERFORM CALL-ZEN0255N-004.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZMA0123O-001.
               MOVE 'ZMA0123O' TO WS-PROGNAME-6
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA0123O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMA00XO0-002.
               EXEC CICS LINK PROGRAM('ZMA00XO0')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA00XO0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMA00LQ5-003.
