      ******************************************************************
      * ZMA00TP4 - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00TP4'.
      ...
      * Called module names
       01  MOD-ZMA01CR4              PIC X(8) VALUE 'ZMA01CR4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01CR4-001.
               CALL 'ZMA01CR4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01CR4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
