      ******************************************************************
      * ZMA01192 - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA01192'.
      ...
      * Called module names
       ...
       01  MOD-ZMA01UWC              PIC X(8) VALUE 'ZMA01UWC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMA01HSD-001.
               PERFORM CALL-ZMA01UWC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01UWC-002.
               CALL 'ZMA01UWC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01UWC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
