      ******************************************************************
      * ZMA010FQ - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA010FQ'.
      ...
      * Called module names
       01  MOD-ZMA01H44              PIC X(8) VALUE 'ZMA01H44'.
       01  MOD-ZMA01PT7              PIC X(8) VALUE 'ZMA01PT7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMA01H44-001.
               PERFORM CALL-ZMA01PT7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01H44-001.
               CALL 'ZMA01H44' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01H44 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMA01PT7-002.
               CALL 'ZMA01PT7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01PT7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
