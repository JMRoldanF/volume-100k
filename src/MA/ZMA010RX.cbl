      ******************************************************************
      * ZMA010RX - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      *  Generated volume-test source. Layer 2,
      *  type data_db2, domain MARINE.
      ******************************************************************
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA010RX'.
      ...
      * Called module names
       01  MOD-ZMA01RJV              PIC X(8) VALUE 'ZMA01RJV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM COMPUTE-HOUSE-TYPE-0008.
       ...
       SQL-ACCESS-0027.
               EXEC SQL
                     ...
                     SELECT POLICYNUMBER, PAYMENT
                       FROM GENAMA.PREMIUM A
                       JOIN GENAMA.CUSTOMER B
