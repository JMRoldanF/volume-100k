      ******************************************************************
      * ZMA00XM0 - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00XM0'.
      ...
      * Called module names
       01  MOD-ZMA01QS9              PIC X(8) VALUE 'ZMA01QS9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01QS9-001.
               CALL 'ZMA01QS9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01QS9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPR01R0R-002.
