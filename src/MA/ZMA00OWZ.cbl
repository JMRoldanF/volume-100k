      ******************************************************************
      * ZMA00OWZ - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00OWZ'.
      ...
      * Called module names
       01  MOD-ZMA01DII              PIC X(8) VALUE 'ZMA01DII'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMA01DII-001.
               PERFORM CALL-ZMA01NTV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01DII-001.
               CALL 'ZMA01DII' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01DII FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMA01NTV-002.
