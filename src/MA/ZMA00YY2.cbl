      ******************************************************************
      * ZMA00YY2 - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00YY2'.
      ...
      * Called module names
       01  MOD-ZTY01LI1              PIC X(8) VALUE 'ZTY01LI1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01LI1-001.
               CALL 'ZTY01LI1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01LI1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
