      ******************************************************************
      * ZMA00AE3 - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00AE3'.
      ...
      * Called module names
       ...
       01  MOD-ZMA00RGR              PIC X(8) VALUE 'ZMA00RGR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA00RGR-002.
               EXEC CICS LINK PROGRAM('ZMA00RGR')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA00RGR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTY01F6G-003.
