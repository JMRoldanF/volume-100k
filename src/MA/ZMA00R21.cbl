      ******************************************************************
      * ZMA00R21 - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00R21'.
      ...
      * Called module names
       01  MOD-ZMA01RBA              PIC X(8) VALUE 'ZMA01RBA'.
       01  MOD-ZMA01JVE              PIC X(8) VALUE 'ZMA01JVE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01RBA-001.
               CALL 'ZMA01RBA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01RBA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMA01JVE-002.
               CALL 'ZMA01JVE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
