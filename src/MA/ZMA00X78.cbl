      ******************************************************************
      * ZMA00X78 - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00X78'.
      ...
      * Called module names
       01  MOD-ZMA01RWY              PIC X(8) VALUE 'ZMA01RWY'.
       01  MOD-ZMA01KP7              PIC X(8) VALUE 'ZMA01KP7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMA01RWY-001.
               PERFORM CALL-ZMA01KP7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01RWY-001.
               CALL 'ZMA01RWY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01RWY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMA01KP7-002.
               CALL 'ZMA01KP7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01KP7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
