      ******************************************************************
      * ZMA014Q8 - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA014Q8'.
      ...
      * Called module names
       01  MOD-ZMA01SQP              PIC X(8) VALUE 'ZMA01SQP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01SQP-001.
               CALL 'ZMA01SQP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01SQP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
