      ******************************************************************
      * ZMA00ZOE - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00ZOE'.
      ...
      * Called module names
       ...
       01  MOD-ZMA01V3Z              PIC X(8) VALUE 'ZMA01V3Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01V3Z-002.
               CALL 'ZMA01V3Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01V3Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
