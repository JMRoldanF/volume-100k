      ******************************************************************
      * ZMA00XIO - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00XIO'.
      ...
      * Called module names
       01  MOD-ZMA01SAS              PIC X(8) VALUE 'ZMA01SAS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01SAS-001.
               CALL 'ZMA01SAS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01SAS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
