      ******************************************************************
      * ZMA010QC - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA010QC'.
      ...
      * Called module names
       ...
       01  MOD-ZMA01E4A              PIC X(8) VALUE 'ZMA01E4A'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMA01SG5-001.
               PERFORM CALL-ZMA01E4A-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01E4A-002.
               CALL 'ZMA01E4A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01E4A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-PREMIUM-0001.
