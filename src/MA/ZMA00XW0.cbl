      ******************************************************************
      * ZMA00XW0 - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00XW0'.
      ...
      * Called module names
       ...
       01  MOD-ZMA01N43              PIC X(8) VALUE 'ZMA01N43'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTY01O9G-001.
               PERFORM CALL-ZMA01N43-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01N43-002.
               CALL 'ZMA01N43' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01N43 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
