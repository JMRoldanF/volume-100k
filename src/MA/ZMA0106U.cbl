      ******************************************************************
      * ZMA0106U - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA0106U'.
      ...
      * Called module names
       01  MOD-ZSE01IPB              PIC X(8) VALUE 'ZSE01IPB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01IPB-001.
               CALL 'ZSE01IPB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01IPB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-MODEL-0001.
