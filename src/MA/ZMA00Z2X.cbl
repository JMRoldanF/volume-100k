      ******************************************************************
      * ZMA00Z2X - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00Z2X'.
      ...
      * Called module names
       01  MOD-ZMA01DNG              PIC X(8) VALUE 'ZMA01DNG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01DNG-001.
               CALL 'ZMA01DNG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01DNG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
