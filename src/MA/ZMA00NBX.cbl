      ******************************************************************
      * ZMA00NBX - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00NBX'.
      ...
      * Called module names
       01  MOD-ZMA01QWX              PIC X(8) VALUE 'ZMA01QWX'.
       01  MOD-ZMA01I7M              PIC X(8) VALUE 'ZMA01I7M'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMA01QWX-001.
               PERFORM CALL-ZMA01I7M-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01QWX-001.
               CALL 'ZMA01QWX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01QWX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMA01I7M-002.
               CALL 'ZMA01I7M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01I7M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
