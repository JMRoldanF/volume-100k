      ******************************************************************
      * ZMA00WLH - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00WLH'.
      ...
      * Called module names
       01  MOD-ZMA01MM9              PIC X(8) VALUE 'ZMA01MM9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01MM9-001.
               CALL 'ZMA01MM9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01MM9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
