      ******************************************************************
      * ZMA00ZAB - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00ZAB'.
      ...
      * Called module names
       01  MOD-ZMA01L78              PIC X(8) VALUE 'ZMA01L78'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01L78-002.
               CALL 'ZMA01L78' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01L78 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
