      ******************************************************************
      * ZMA00P3D - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00P3D'.
      ...
      * Called module names
       ...
       01  MOD-ZMA01TVN              PIC X(8) VALUE 'ZMA01TVN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMA01EV0-001.
               PERFORM CALL-ZMA01TVN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01TVN-002.
               CALL 'ZMA01TVN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01TVN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
