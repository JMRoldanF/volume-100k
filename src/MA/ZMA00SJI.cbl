      ******************************************************************
      * ZMA00SJI - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00SJI'.
      ...
      * Called module names
       01  MOD-ZTY01DL2              PIC X(8) VALUE 'ZTY01DL2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01DL2-001.
               CALL 'ZTY01DL2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01DL2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
