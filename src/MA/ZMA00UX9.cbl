      ******************************************************************
      * ZMA00UX9 - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00UX9'.
      ...
      * Called module names
       01  MOD-ZMA01SBC              PIC X(8) VALUE 'ZMA01SBC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01SBC-001.
               CALL 'ZMA01SBC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01SBC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
