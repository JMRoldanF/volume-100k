      ******************************************************************
      * ZMA00OZN - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00OZN'.
      ...
      * Called module names
       01  MOD-ZMA01GKT              PIC X(8) VALUE 'ZMA01GKT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMA01GKT-001.
               PERFORM CALL-ZMA01K5S-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01GKT-001.
               CALL 'ZMA01GKT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01GKT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMA01K5S-002.
