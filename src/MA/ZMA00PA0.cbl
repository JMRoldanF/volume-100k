      ******************************************************************
      * ZMA00PA0 - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00PA0'.
      ...
      * Called module names
       ...
       01  MOD-ZMA01I8Q              PIC X(8) VALUE 'ZMA01I8Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01I8Q-002.
               CALL 'ZMA01I8Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01I8Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
