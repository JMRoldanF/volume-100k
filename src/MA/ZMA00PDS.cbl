      ******************************************************************
      * ZMA00PDS - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00PDS'.
      ...
      * Called module names
       01  MOD-ZMA01LH4              PIC X(8) VALUE 'ZMA01LH4'.
       01  MOD-ZMA01QSL              PIC X(8) VALUE 'ZMA01QSL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMA01LH4-001.
               PERFORM CALL-ZMA01QSL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01LH4-001.
               CALL 'ZMA01LH4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01LH4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMA01QSL-002.
               CALL 'ZMA01QSL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01QSL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
