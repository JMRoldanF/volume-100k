      ******************************************************************
      * ZMA00R70 - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00R70'.
      ...
      * Called module names
       01  MOD-ZMA01KI0              PIC X(8) VALUE 'ZMA01KI0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01KI0-001.
               CALL 'ZMA01KI0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01KI0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
