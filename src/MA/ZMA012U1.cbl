      ******************************************************************
      * ZMA012U1 - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA012U1'.
      ...
      * Called module names
       01  MOD-ZMA01NUR              PIC X(8) VALUE 'ZMA01NUR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01NUR-001.
               CALL 'ZMA01NUR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01NUR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
