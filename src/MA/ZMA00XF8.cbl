      ******************************************************************
      * ZMA00XF8 - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00XF8'.
      ...
      * Called module names
       01  MOD-ZTY01NNX              PIC X(8) VALUE 'ZTY01NNX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTY01NNX-001.
               PERFORM CALL-ZMA01QKB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01NNX-001.
               CALL 'ZTY01NNX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01NNX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMA01QKB-002.
