      ******************************************************************
      * ZMA00TQW - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00TQW'.
      ...
      * Called module names
       ...
       01  MOD-ZMA01V3K              PIC X(8) VALUE 'ZMA01V3K'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMA01TVN-001.
               PERFORM CALL-ZMA01V3K-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01V3K-002.
               CALL 'ZMA01V3K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01V3K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
