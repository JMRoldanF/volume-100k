      ******************************************************************
      * ZMA00MGO - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00MGO'.
      ...
      * Called module names
       ...
       01  MOD-ZPR01OQ9              PIC X(8) VALUE 'ZPR01OQ9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMA01Q5K-001.
               PERFORM CALL-ZPR01OQ9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR01OQ9-002.
               CALL 'ZPR01OQ9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01OQ9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
