      ******************************************************************
      * ZMA00WA9 - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00WA9'.
      ...
      * Called module names
       01  MOD-ZMA01OUP              PIC X(8) VALUE 'ZMA01OUP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01OUP-001.
               CALL 'ZMA01OUP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01OUP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
