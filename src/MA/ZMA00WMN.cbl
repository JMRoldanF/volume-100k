      ******************************************************************
      * ZMA00WMN - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00WMN'.
      ...
      * Called module names
       ...
       01  MOD-ZMA01SM1              PIC X(8) VALUE 'ZMA01SM1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01SM1-002.
               CALL 'ZMA01SM1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01SM1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
