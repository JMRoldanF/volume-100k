      ******************************************************************
      * ZMA011MB - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA011MB'.
      ...
      * Called module names
       01  MOD-ZPR01HY0              PIC X(8) VALUE 'ZPR01HY0'.
       01  MOD-ZMA01F9P              PIC X(8) VALUE 'ZMA01F9P'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPR01HY0-001.
               PERFORM CALL-ZMA01F9P-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR01HY0-001.
               CALL 'ZPR01HY0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01HY0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMA01F9P-002.
               CALL 'ZMA01F9P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01F9P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
