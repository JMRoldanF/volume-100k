      ******************************************************************
      * ZMA01VZE - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      ******************************************************************
       ...
       FILE-CONTROL.
               SELECT INPUT-FILE  ASSIGN TO DDMAIN34
                         ORGANIZATION IS SEQUENTIAL
                         FILE STATUS  IS WS-FILE-STATUS.
               SELECT OUTPUT-FILE ASSIGN TO DDMAOT34
                         ORGANIZATION IS SEQUENTIAL
                         FILE STATUS  IS WS-FILE-STATUS.
               SELECT REPORT-FILE ASSIGN TO DDMARP34
                         ORGANIZATION IS SEQUENTIAL
                         FILE STATUS  IS WS-FILE-STATUS.
       DATA DIVISION.
       FILE SECTION.
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA01VZE'.
      ...
      * Called module names
       01  MOD-ZMA01EWS              PIC X(8) VALUE 'ZMA01EWS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMA01EWS-001.
               PERFORM CALL-ZMA01M8G-002.
               PERFORM CALL-ZMA01NGC-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01EWS-001.
               CALL 'ZMA01EWS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01EWS FAILED' TO EM-VARIABLE
