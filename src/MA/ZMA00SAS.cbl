      ******************************************************************
      * ZMA00SAS - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00SAS'.
      ...
      * Called module names
       01  MOD-ZSE01SZ3              PIC X(8) VALUE 'ZSE01SZ3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01SZ3-001.
               CALL 'ZSE01SZ3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01SZ3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
