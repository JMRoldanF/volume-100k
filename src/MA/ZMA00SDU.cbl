      ******************************************************************
      * ZMA00SDU - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00SDU'.
      ...
      * Called module names
       01  MOD-ZMA01FNX              PIC X(8) VALUE 'ZMA01FNX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMA01FNX-001.
               PERFORM CALL-ZMA01SK4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01FNX-001.
               CALL 'ZMA01FNX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01FNX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMA01SK4-002.
