      ******************************************************************
      * ZMA00X5G - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00X5G'.
      ...
      * Called module names
       01  MOD-ZMA01T73              PIC X(8) VALUE 'ZMA01T73'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01T73-001.
               CALL 'ZMA01T73' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01T73 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
