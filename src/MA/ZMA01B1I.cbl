      ******************************************************************
      * ZMA01B1I - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA01B1I'.
      ...
      * Called module names
       01  MOD-ZMA01GYP              PIC X(8) VALUE 'ZMA01GYP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMA01GYP-001.
               PERFORM CALL-ZMA01KI0-002.
               PERFORM CALL-ZHO0255M-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZMA01GYP-001.
               CALL 'ZMA01GYP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01GYP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMA01KI0-002.
               MOVE 'ZMA01KI0' TO WS-SUBNAME-4
