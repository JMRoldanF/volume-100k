      ******************************************************************
      * ZMA011NP - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA011NP'.
      ...
      * Called module names
       01  MOD-ZMA01IU2              PIC X(8) VALUE 'ZMA01IU2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01IU2-001.
               CALL 'ZMA01IU2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01IU2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
