      ******************************************************************
      * ZMA00RT8 - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00RT8'.
      ...
      * Called module names
       01  MOD-ZMA01SMN              PIC X(8) VALUE 'ZMA01SMN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01SMN-001.
               CALL 'ZMA01SMN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01SMN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
