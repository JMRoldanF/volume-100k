      ******************************************************************
      * ZMA00QLI - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00QLI'.
      ...
      * Called module names
       01  MOD-ZMA01LGA              PIC X(8) VALUE 'ZMA01LGA'.
       01  MOD-ZMA01TZ1              PIC X(8) VALUE 'ZMA01TZ1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMA01LGA-001.
               PERFORM CALL-ZMA01TZ1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01LGA-001.
               CALL 'ZMA01LGA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01LGA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMA01TZ1-002.
               CALL 'ZMA01TZ1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01TZ1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
