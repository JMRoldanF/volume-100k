      ******************************************************************
      * ZMA00MV4 - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00MV4'.
      ...
      * Called module names
       01  MOD-ZMA01QVK              PIC X(8) VALUE 'ZMA01QVK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01QVK-001.
               CALL 'ZMA01QVK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01QVK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
