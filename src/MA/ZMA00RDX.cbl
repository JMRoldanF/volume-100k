      ******************************************************************
      * ZMA00RDX - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00RDX'.
      ...
      * Called module names
       01  MOD-ZSE01RZI              PIC X(8) VALUE 'ZSE01RZI'.
       01  MOD-ZMA01UMT              PIC X(8) VALUE 'ZMA01UMT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSE01RZI-001.
               PERFORM CALL-ZMA01UMT-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01RZI-001.
               CALL 'ZSE01RZI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01RZI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMA01UMT-002.
               CALL 'ZMA01UMT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01UMT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
