      ******************************************************************
      * ZMA00TPG - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00TPG'.
      ...
      * Called module names
       01  MOD-ZMA01MNG              PIC X(8) VALUE 'ZMA01MNG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01MNG-001.
               CALL 'ZMA01MNG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01MNG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
