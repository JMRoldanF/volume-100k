      ******************************************************************
      * ZMA0108P - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA0108P'.
      ...
      * Called module names
       01  MOD-ZTY01I4N              PIC X(8) VALUE 'ZTY01I4N'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01I4N-001.
               CALL 'ZTY01I4N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01I4N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
