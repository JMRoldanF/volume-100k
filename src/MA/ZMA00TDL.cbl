      ******************************************************************
      * ZMA00TDL - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00TDL'.
      ...
      * Called module names
       ...
       01  MOD-ZMA01NBX              PIC X(8) VALUE 'ZMA01NBX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01NBX-002.
               CALL 'ZMA01NBX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01NBX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
