      ******************************************************************
      * ZMA00SOD - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00SOD'.
      ...
      * Called module names
       01  MOD-ZMA01TO5              PIC X(8) VALUE 'ZMA01TO5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01TO5-002.
               CALL 'ZMA01TO5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01TO5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
