      ******************************************************************
      * ZMA00NPO - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00NPO'.
      ...
      * Called module names
       01  MOD-ZMA01L7Z              PIC X(8) VALUE 'ZMA01L7Z'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMA01L7Z-001.
               PERFORM CALL-ZMA01HFS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01L7Z-001.
               CALL 'ZMA01L7Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
