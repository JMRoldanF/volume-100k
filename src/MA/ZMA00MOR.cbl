      ******************************************************************
      * ZMA00MOR - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00MOR'.
      ...
      * Called module names
       01  MOD-ZMA01GMO              PIC X(8) VALUE 'ZMA01GMO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01GMO-001.
               CALL 'ZMA01GMO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01GMO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
