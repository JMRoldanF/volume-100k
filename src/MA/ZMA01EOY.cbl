      ******************************************************************
      * ZMA01EOY - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA01EOY'.
      ...
      * Called module names
       01  MOD-ZMA01M57              PIC X(8) VALUE 'ZMA01M57'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMA01M57-001.
               CALL 'ZMA01M57' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMA01M57 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
