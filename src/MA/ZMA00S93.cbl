      ******************************************************************
      * ZMA00S93 - MARINE CARGO AND HULL                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZMA00S93'.
      ...
      * Called module names
       01  MOD-ZSE01NSG              PIC X(8) VALUE 'ZSE01NSG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01NSG-001.
               CALL 'ZSE01NSG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01NSG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
