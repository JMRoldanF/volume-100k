      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS010AD'.
      ...
      * Called module names
       01  MOD-ZRS01GU2              PIC X(8) VALUE 'ZRS01GU2'.
       01  MOD-ZRS01P0B              PIC X(8) VALUE 'ZRS01P0B'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRS01GU2-001.
               PERFORM CALL-ZRS01P0B-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01GU2-001.
               CALL 'ZRS01GU2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01GU2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRS01P0B-002.
               CALL 'ZRS01P0B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01P0B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
