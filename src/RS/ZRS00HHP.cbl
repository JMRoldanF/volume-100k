      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00HHP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS00WUQ-001.
               MOVE 'ZRS00WUQ' TO WS-PROGNAME-3
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS00WUQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRS01DFV-002.
               MOVE 'ZRS01DFV' TO WS-SUBNAME-4
