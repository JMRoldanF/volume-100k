      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00VCS'.
      ...
      * Called module names
       01  MOD-ZRS01NO8              PIC X(8) VALUE 'ZRS01NO8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01NO8-001.
               CALL 'ZRS01NO8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01NO8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
