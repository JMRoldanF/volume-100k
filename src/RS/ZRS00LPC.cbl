      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00LPC'.
      ...
      * Called module names
       ...
       01  MOD-ZRS01SKJ              PIC X(8) VALUE 'ZRS01SKJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRG01UG1-001.
               PERFORM CALL-ZRS01SKJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01SKJ-002.
               CALL 'ZRS01SKJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01SKJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
