      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00ZPS'.
      ...
      * Called module names
       ...
       01  MOD-ZRS01D0M              PIC X(8) VALUE 'ZRS01D0M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01D0M-002.
               CALL 'ZRS01D0M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01D0M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
