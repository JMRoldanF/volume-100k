      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00BMC'.
      ...
      * Called module names
       ...
       01  MOD-ZRS0171Q              PIC X(8) VALUE 'ZRS0171Q'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFR00ZQ0-002.
               PERFORM CALL-ZRS0171Q-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS0171Q-003.
               EXEC CICS LINK PROGRAM('ZRS0171Q')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS0171Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-004.
