      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00YNN'.
      ...
      * Called module names
       ...
       01  MOD-ZRS01PCB              PIC X(8) VALUE 'ZRS01PCB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRS01I3S-001.
               PERFORM CALL-ZRS01PCB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01PCB-002.
               CALL 'ZRS01PCB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
