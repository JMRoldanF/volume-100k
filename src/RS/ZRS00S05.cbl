      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00S05'.
      ...
      * Called module names
       01  MOD-ZFR01P3C              PIC X(8) VALUE 'ZFR01P3C'.
       01  MOD-ZRS01F3X              PIC X(8) VALUE 'ZRS01F3X'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM DERIVE-MAKE-0103.
               PERFORM AUDIT-HOUSE-TYPE-0104.
               PERFORM SQL-ACCESS-0105.
               PERFORM RECONCILE-SUM-ASSURED-0106.
               PERFORM APPLY-AGENT-CODE-0107.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZFR01P3C-001.
               CALL 'ZFR01P3C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01P3C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRS01F3X-002.
               CALL 'ZRS01F3X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01F3X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
