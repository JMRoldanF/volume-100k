      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00VPE'.
      ...
      * Called module names
       01  MOD-ZRS01EJ9              PIC X(8) VALUE 'ZRS01EJ9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01EJ9-001.
               CALL 'ZRS01EJ9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01EJ9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
