      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00LXW'.
      ...
      * Called module names
       01  MOD-ZRS01P3K              PIC X(8) VALUE 'ZRS01P3K'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRS01P3K-001.
               PERFORM CALL-ZRS01OI8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01P3K-001.
               CALL 'ZRS01P3K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01P3K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRS01OI8-002.
