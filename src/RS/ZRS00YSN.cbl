      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00YSN'.
      ...
      * Called module names
       01  MOD-ZRS01RPW              PIC X(8) VALUE 'ZRS01RPW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01RD9-001.
               MOVE 'ZRS01RD9' TO WS-SUBNAME-6
               CALL WS-SUBNAME-6 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01RD9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRS01RPW-002.
               CALL 'ZRS01RPW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
