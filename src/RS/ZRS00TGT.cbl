      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00TGT'.
      ...
      * Called module names
       01  MOD-ZRS01UV6              PIC X(8) VALUE 'ZRS01UV6'.
       01  MOD-ZRS01GPY              PIC X(8) VALUE 'ZRS01GPY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01UV6-001.
               CALL 'ZRS01UV6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01GPY-002.
               CALL 'ZRS01GPY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
