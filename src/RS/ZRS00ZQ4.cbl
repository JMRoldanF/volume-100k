      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00ZQ4'.
      ...
      * Called module names
       01  MOD-ZRS01TFX              PIC X(8) VALUE 'ZRS01TFX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01TFX-001.
               CALL 'ZRS01TFX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01TFX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
