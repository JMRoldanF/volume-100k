      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00YSV'.
      ...
      * Called module names
       01  MOD-ZRS01MWN              PIC X(8) VALUE 'ZRS01MWN'.
       01  MOD-ZRS01HPH              PIC X(8) VALUE 'ZRS01HPH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRS01MWN-001.
               PERFORM CALL-ZRS01HPH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01MWN-001.
               CALL 'ZRS01MWN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01MWN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRS01HPH-002.
               CALL 'ZRS01HPH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01HPH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
