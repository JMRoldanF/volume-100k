      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00U55'.
      ...
      * Called module names
       01  MOD-ZRS01HB5              PIC X(8) VALUE 'ZRS01HB5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01HB5-001.
               CALL 'ZRS01HB5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01HB5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
