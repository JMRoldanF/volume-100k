      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00UNK'.
      ...
      * Called module names
       01  MOD-ZRG01ONH              PIC X(8) VALUE 'ZRG01ONH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRG01ONH-001.
               PERFORM CALL-ZRS01UVZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01ONH-001.
               CALL 'ZRG01ONH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01ONH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRS01UVZ-002.
