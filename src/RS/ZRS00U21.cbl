      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00U21'.
      ...
      * Called module names
       01  MOD-ZRS01LDR              PIC X(8) VALUE 'ZRS01LDR'.
       01  MOD-ZRS01F0X              PIC X(8) VALUE 'ZRS01F0X'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRS01LDR-001.
               PERFORM CALL-ZRS01F0X-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01LDR-001.
               CALL 'ZRS01LDR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01LDR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRS01F0X-002.
               CALL 'ZRS01F0X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01F0X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
