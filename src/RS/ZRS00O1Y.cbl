      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00O1Y'.
      ...
      * Called module names
       01  MOD-ZRS01QX1              PIC X(8) VALUE 'ZRS01QX1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01QX1-001.
               CALL 'ZRS01QX1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01QX1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
