      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00UZV'.
      ...
      * Called module names
       ...
       01  MOD-ZFR01ELY              PIC X(8) VALUE 'ZFR01ELY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRS01KGL-001.
               PERFORM CALL-ZFR01ELY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01ELY-002.
               CALL 'ZFR01ELY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01ELY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
