      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00QCM'.
      ...
      * Called module names
       01  MOD-ZRS01N4G              PIC X(8) VALUE 'ZRS01N4G'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRS01N4G-001.
               PERFORM CALL-ZRS01I7T-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01N4G-001.
               CALL 'ZRS01N4G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01N4G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRS01I7T-002.
