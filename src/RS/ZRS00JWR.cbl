      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00JWR'.
      ...
      * Called module names
       01  MOD-ZRS00PQ4              PIC X(8) VALUE 'ZRS00PQ4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS00PQ4-001.
               EXEC CICS LINK PROGRAM('ZRS00PQ4')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS00PQ4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRS01QGJ-002.
