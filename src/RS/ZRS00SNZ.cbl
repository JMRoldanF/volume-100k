      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00SNZ'.
      ...
      * Called module names
       ...
       01  MOD-ZRS01RTU              PIC X(8) VALUE 'ZRS01RTU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01RTU-002.
               CALL 'ZRS01RTU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01RTU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
