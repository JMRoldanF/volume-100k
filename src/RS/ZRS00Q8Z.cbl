      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00Q8Z'.
      ...
      * Called module names
       01  MOD-ZRS01UEX              PIC X(8) VALUE 'ZRS01UEX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01UEX-001.
               CALL 'ZRS01UEX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01UEX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-TAX-BAND-0001.
