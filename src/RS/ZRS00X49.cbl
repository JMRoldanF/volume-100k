      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00X49'.
      ...
      * Called module names
       01  MOD-ZRS01U0X              PIC X(8) VALUE 'ZRS01U0X'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRS01P8N-001.
               PERFORM CALL-ZRS01U0X-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01U0X-002.
               CALL 'ZRS01U0X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01U0X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
