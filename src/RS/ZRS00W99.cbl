      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00W99'.
      ...
      * Called module names
       01  MOD-ZRS01TYN              PIC X(8) VALUE 'ZRS01TYN'.
       01  MOD-ZRS01NEI              PIC X(8) VALUE 'ZRS01NEI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01TYN-001.
               CALL 'ZRS01TYN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01TYN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRS01NEI-002.
               CALL 'ZRS01NEI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01NEI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
