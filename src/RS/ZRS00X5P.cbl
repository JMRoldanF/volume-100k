      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00X5P'.
      ...
      * Called module names
       ...
       01  MOD-ZRS01DVQ              PIC X(8) VALUE 'ZRS01DVQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRN01Q04-001.
               PERFORM CALL-ZRS01DVQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01DVQ-002.
               CALL 'ZRS01DVQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01DVQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
