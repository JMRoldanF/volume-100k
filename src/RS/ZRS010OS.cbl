      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS010OS'.
      ...
      * Called module names
       01  MOD-ZRS01DDL              PIC X(8) VALUE 'ZRS01DDL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM NORMALISE-BEDROOMS-0080.
               ...
               PERFORM EXPAND-BEDROOMS-0113.
               PERFORM EXPAND-AGENT-CODE-0115.
               PERFORM CHECK-AGENT-CODE-0116.
               ...
               PERFORM FORMAT-AGENT-CODE-0122.
               PERFORM SQL-ACCESS-0123.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZRS01DDL-001.
               CALL 'ZRS01DDL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01DDL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-MODEL-0001.
