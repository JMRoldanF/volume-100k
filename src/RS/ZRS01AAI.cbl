      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS01AAI'.
      ...
      * Called module names
       01  MOD-ZRS01Q33              PIC X(8) VALUE 'ZRS01Q33'.
       01  MOD-ZRS01EAS              PIC X(8) VALUE 'ZRS01EAS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRS01Q33-001.
               PERFORM CALL-ZRS01EAS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01Q33-001.
               CALL 'ZRS01Q33' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01Q33 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRS01EAS-002.
               CALL 'ZRS01EAS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01EAS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
