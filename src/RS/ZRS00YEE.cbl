      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00YEE'.
      ...
      * Called module names
       01  MOD-ZRS01JQ7              PIC X(8) VALUE 'ZRS01JQ7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01JQ7-001.
               CALL 'ZRS01JQ7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01JQ7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
