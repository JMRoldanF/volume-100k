      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS001WR'.
      ...
      * Called module names
       01  MOD-ZRS00H0D              PIC X(8) VALUE 'ZRS00H0D'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRS00H0D-001.
               PERFORM CALL-ZRS00J8Q-002.
               PERFORM CALL-ZRS001P5-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS00H0D-001.
               EXEC CICS LINK PROGRAM('ZRS00H0D')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS00H0D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRS00J8Q-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS001P5-003.
               EXEC CICS START TRANSID('Z1P5')
                         FROM(WS-KEY-AREA)
                         LENGTH(20)
                         RESP(WS-RESP)
               END-EXEC.
      * TRANSID Z1P5 is defined against ZRS001P5
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS001P5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-004.
