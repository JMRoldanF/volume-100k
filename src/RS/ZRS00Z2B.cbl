      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00Z2B'.
      ...
      * Called module names
       01  MOD-ZRG01QM5              PIC X(8) VALUE 'ZRG01QM5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01QM5-001.
               CALL 'ZRG01QM5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01QM5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
