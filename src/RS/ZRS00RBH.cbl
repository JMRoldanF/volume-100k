      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00RBH'.
      ...
      * Called module names
       01  MOD-ZRS01EH3              PIC X(8) VALUE 'ZRS01EH3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRS01EH3-001.
               PERFORM CALL-ZLB01D7K-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01EH3-001.
               CALL 'ZRS01EH3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01EH3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZLB01D7K-002.
