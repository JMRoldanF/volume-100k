      ******************************************************************
      * ZRS010GV - TECHNICAL RESERVING                                 *
      ******************************************************************
      *
      *  Generated volume-test source. Layer 2,
      *  type data_db2, domain RESERVE.
      ******************************************************************
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS010GV'.
      ...
      * Called module names
       01  MOD-ZRS01SH1              PIC X(8) VALUE 'ZRS01SH1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM RECONCILE-WITH-PROFITS-0026.
               ...
               PERFORM RECONCILE-BEDROOMS-0113.
               PERFORM SQL-ACCESS-0114.
               PERFORM VALIDATE-WITH-PROFITS-0115.
               PERFORM RESOLVE-EQUITIES-0116.
               ...
               PERFORM COMPUTE-REG-NUMBER-0122.
               PERFORM SQL-ACCESS-0123.
               PERFORM RESOLVE-NCD-YEARS-0124.
               PERFORM REFRESH-NCD-YEARS-0125.
               PERFORM SQL-ACCESS-0126.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZRS01SH1-001.
               CALL 'ZRS01SH1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01SH1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-VALUE-0001.
       ...
       SQL-ACCESS-0009.
               EXEC SQL
                     ...
                     SELECT POLICYNUMBER, PAYMENT
                       FROM GENARS.COMMISSION A
                       JOIN GENARS.CUSTOMER B
