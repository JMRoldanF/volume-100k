      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00M1I'.
      ...
      * Called module names
       01  MOD-ZRS01TPH              PIC X(8) VALUE 'ZRS01TPH'.
       01  MOD-ZRS01DCY              PIC X(8) VALUE 'ZRS01DCY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRS01TPH-001.
               PERFORM CALL-ZRS01DCY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01TPH-001.
               CALL 'ZRS01TPH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01TPH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRS01DCY-002.
               CALL 'ZRS01DCY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01DCY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
