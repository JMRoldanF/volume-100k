      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS012JR'.
      ...
      * Called module names
       01  MOD-ZFR01SJ0              PIC X(8) VALUE 'ZFR01SJ0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFR01SJ0-001.
               PERFORM CALL-ZRS01U9I-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01SJ0-001.
               CALL 'ZFR01SJ0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01SJ0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRS01U9I-002.
               MOVE 'ZRS01U9I' TO WS-SUBNAME-8
