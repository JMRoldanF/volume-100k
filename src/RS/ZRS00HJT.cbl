      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00HJT'.
      ...
      * Called module names
       ...
       01  MOD-ZRS01A5D              PIC X(8) VALUE 'ZRS01A5D'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRS010AD-001.
               PERFORM CALL-ZRS011T4-002.
               PERFORM CALL-ZRS01A5D-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS010AD-001.
               MOVE 'ZRS010AD' TO WS-PROGNAME-7
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS010AD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRS011T4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01A5D-003.
               EXEC CICS LINK PROGRAM('ZRS01A5D')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01A5D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-004.
