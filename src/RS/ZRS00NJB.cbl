      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZRS00NJB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRG01RZ7-001.
               PERFORM CALL-ZRS01GWJ-002.
               PERFORM CALL-ZEN0255N-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZRG01RZ7-001.
               MOVE 'ZRG01RZ7' TO WS-SUBNAME-5
