      ******************************************************************
      * ZSU00M7H - SURRENDER AND MATURITY                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSU00M7H'.
      ...
      * Called module names
       01  MOD-ZEN01MJQ              PIC X(8) VALUE 'ZEN01MJQ'.
       01  MOD-ZAC01T4P              PIC X(8) VALUE 'ZAC01T4P'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01MJQ-001.
               CALL 'ZEN01MJQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01MJQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAC01T4P-002.
               CALL 'ZAC01T4P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01T4P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
