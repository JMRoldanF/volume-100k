      ******************************************************************
      * ZSU00MHB - SURRENDER AND MATURITY                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSU00MHB'.
      ...
      * Called module names
       01  MOD-ZSU01OO1              PIC X(8) VALUE 'ZSU01OO1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSU01OO1-001.
               CALL 'ZSU01OO1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01OO1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSU01CQI-002.
