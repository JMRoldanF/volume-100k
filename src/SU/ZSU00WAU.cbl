      ******************************************************************
      * ZSU00WAU - SURRENDER AND MATURITY                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSU00WAU'.
      ...
      * Called module names
       01  MOD-ZSU01UTI              PIC X(8) VALUE 'ZSU01UTI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSU01UTI-001.
               CALL 'ZSU01UTI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01UTI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAU01I6Y-002.
