      ******************************************************************
      * ZSU00YWN - SURRENDER AND MATURITY                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSU00YWN'.
      ...
      * Called module names
       ...
       01  MOD-ZAC01NAP              PIC X(8) VALUE 'ZAC01NAP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01NAP-002.
               CALL 'ZAC01NAP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01NAP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
