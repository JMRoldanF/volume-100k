      ******************************************************************
      * ZSU012KH - SURRENDER AND MATURITY                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSU012KH'.
      ...
      * Called module names
       01  MOD-ZSU01P5X              PIC X(8) VALUE 'ZSU01P5X'.
       01  MOD-ZSU01RG8              PIC X(8) VALUE 'ZSU01RG8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSU01P5X-001.
               PERFORM CALL-ZSU01RG8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSU01P5X-001.
               CALL 'ZSU01P5X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01P5X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSU01RG8-002.
               CALL 'ZSU01RG8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01RG8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
