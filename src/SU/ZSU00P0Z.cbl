      ******************************************************************
      * ZSU00P0Z - SURRENDER AND MATURITY                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSU00P0Z'.
      ...
      * Called module names
       01  MOD-ZRS01KU4              PIC X(8) VALUE 'ZRS01KU4'.
       01  MOD-ZSU01L7R              PIC X(8) VALUE 'ZSU01L7R'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM FORMAT-REG-NUMBER-0089.
      ...
      *----------------------------------------------------------------*
       CALL-ZRS01KU4-001.
               CALL 'ZRS01KU4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01KU4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSU01L7R-002.
               CALL 'ZSU01L7R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01L7R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
