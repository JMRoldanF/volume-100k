      ******************************************************************
      * ZSU00PI5 - SURRENDER AND MATURITY                              *
      ******************************************************************
      *
      *  Generated volume-test source. Layer 2,
      *  type data_db2, domain SURRNDR.
      ******************************************************************
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSU00PI5'.
      ...
      * Called module names
       01  MOD-ZSU01UBN              PIC X(8) VALUE 'ZSU01UBN'.
       01  MOD-ZSU01G3H              PIC X(8) VALUE 'ZSU01G3H'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSU01UBN-001.
               PERFORM CALL-ZSU01G3H-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSU01UBN-001.
               CALL 'ZSU01UBN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01UBN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSU01G3H-002.
               CALL 'ZSU01G3H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01G3H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       ...
       SQL-ACCESS-0009.
               EXEC SQL
                     ...
                     SELECT POLICYNUMBER, PAYMENT
                       FROM GENASU.CONTACT A
                       JOIN GENASU.CUSTOMER B
