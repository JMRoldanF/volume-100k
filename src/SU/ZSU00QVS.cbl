      ******************************************************************
      * ZSU00QVS - SURRENDER AND MATURITY                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSU00QVS'.
      ...
      * Called module names
       ...
       01  MOD-ZSU01NFG              PIC X(8) VALUE 'ZSU01NFG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSU01CP8-001.
               PERFORM CALL-ZSU01NFG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSU01NFG-002.
               CALL 'ZSU01NFG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01NFG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
