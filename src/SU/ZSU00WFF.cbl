      ******************************************************************
      * ZSU00WFF - SURRENDER AND MATURITY                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSU00WFF'.
      ...
      * Called module names
       01  MOD-ZAC01SUH              PIC X(8) VALUE 'ZAC01SUH'.
       01  MOD-ZAC01L3T              PIC X(8) VALUE 'ZAC01L3T'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAC01SUH-001.
               PERFORM CALL-ZAC01L3T-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01SUH-001.
               CALL 'ZAC01SUH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01SUH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAC01L3T-002.
               CALL 'ZAC01L3T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01L3T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
