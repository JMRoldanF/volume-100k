      ******************************************************************
      * ZSU00LN5 - SURRENDER AND MATURITY                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSU00LN5'.
      ...
      * Called module names
       01  MOD-ZAC01P87              PIC X(8) VALUE 'ZAC01P87'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01P87-001.
               CALL 'ZAC01P87' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01P87 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-PREMIUM-0001.
