      ******************************************************************
      * ZSU00VD8 - SURRENDER AND MATURITY                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSU00VD8'.
      ...
      * Called module names
       01  MOD-ZSU01E9C              PIC X(8) VALUE 'ZSU01E9C'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSU01E9C-001.
               CALL 'ZSU01E9C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01E9C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
