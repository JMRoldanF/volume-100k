      ******************************************************************
      * ZSU00O18 - SURRENDER AND MATURITY                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSU00O18'.
      ...
      * Called module names
       ...
       01  MOD-ZAU01GUZ              PIC X(8) VALUE 'ZAU01GUZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAU01GUZ-002.
               CALL 'ZAU01GUZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAU01GUZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
