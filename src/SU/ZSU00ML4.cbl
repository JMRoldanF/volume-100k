      ******************************************************************
      * ZSU00ML4 - SURRENDER AND MATURITY                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSU00ML4'.
      ...
      * Called module names
       01  MOD-ZEN01TI1              PIC X(8) VALUE 'ZEN01TI1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01TI1-001.
               PERFORM CALL-ZRE0255R-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZEN01TI1-001.
               CALL 'ZEN01TI1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
