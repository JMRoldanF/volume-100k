      ******************************************************************
      * ZSU0110V - SURRENDER AND MATURITY                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSU0110V'.
      ...
      * Called module names
       01  MOD-ZSU01UBX              PIC X(8) VALUE 'ZSU01UBX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSU01UBX-001.
               CALL 'ZSU01UBX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01UBX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
