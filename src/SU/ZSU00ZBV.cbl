      ******************************************************************
      * ZSU00ZBV - SURRENDER AND MATURITY                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSU00ZBV'.
      ...
      * Called module names
       01  MOD-ZSU01JM7              PIC X(8) VALUE 'ZSU01JM7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSU01JM7-001.
               CALL 'ZSU01JM7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01JM7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-EXCESS-0001.
