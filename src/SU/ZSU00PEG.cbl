      ******************************************************************
      * ZSU00PEG - SURRENDER AND MATURITY                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSU00PEG'.
      ...
      * Called module names
       01  MOD-ZSU01LRV              PIC X(8) VALUE 'ZSU01LRV'.
       01  MOD-ZSU01DR6              PIC X(8) VALUE 'ZSU01DR6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSU01LRV-001.
               PERFORM CALL-ZSU01DR6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSU01LRV-001.
               CALL 'ZSU01LRV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZSU01DR6-002.
               CALL 'ZSU01DR6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01DR6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
