      ******************************************************************
      * ZSU00KTB - SURRENDER AND MATURITY                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSU00KTB'.
      ...
      * Called module names
       01  MOD-ZSU00NZO              PIC X(8) VALUE 'ZSU00NZO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSU00NZO-001.
               EXEC CICS LINK PROGRAM('ZSU00NZO')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU00NZO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
