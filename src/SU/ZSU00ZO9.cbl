      ******************************************************************
      * ZSU00ZO9 - SURRENDER AND MATURITY                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSU00ZO9'.
      ...
      * Called module names
       01  MOD-ZSU01RUQ              PIC X(8) VALUE 'ZSU01RUQ'.
       01  MOD-ZSU01HM0              PIC X(8) VALUE 'ZSU01HM0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSU01RUQ-001.
               PERFORM CALL-ZSU01HM0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSU01RUQ-001.
               CALL 'ZSU01RUQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01RUQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSU01HM0-002.
               CALL 'ZSU01HM0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01HM0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-PREMIUM-0001.
