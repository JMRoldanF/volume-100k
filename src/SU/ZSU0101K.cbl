      ******************************************************************
      * ZSU0101K - SURRENDER AND MATURITY                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSU0101K'.
      ...
      * Called module names
       01  MOD-ZSU01F0E              PIC X(8) VALUE 'ZSU01F0E'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSU01F0E-001.
               CALL 'ZSU01F0E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01F0E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
