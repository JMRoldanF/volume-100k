      ******************************************************************
      * ZSU00OZP - SURRENDER AND MATURITY                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSU00OZP'.
      ...
      * Called module names
       01  MOD-ZSU01J7J              PIC X(8) VALUE 'ZSU01J7J'.
       01  MOD-ZSU01I9D              PIC X(8) VALUE 'ZSU01I9D'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSU01J7J-001.
               CALL 'ZSU01J7J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01J7J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSU01I9D-002.
               CALL 'ZSU01I9D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01I9D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
