      ******************************************************************
      * ZSU011D8 - SURRENDER AND MATURITY                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSU011D8'.
      ...
      * Called module names
       ...
       01  MOD-ZSU01HTB              PIC X(8) VALUE 'ZSU01HTB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRS01MPV-001.
               PERFORM CALL-ZSU01HTB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSU01HTB-002.
               CALL 'ZSU01HTB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01HTB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
