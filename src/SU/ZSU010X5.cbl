      ******************************************************************
      * ZSU010X5 - SURRENDER AND MATURITY                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSU010X5'.
      ...
      * Called module names
       01  MOD-ZSU01L38              PIC X(8) VALUE 'ZSU01L38'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSU01KNM-001.
               PERFORM CALL-ZSU01L38-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSU01L38-002.
               CALL 'ZSU01L38' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
