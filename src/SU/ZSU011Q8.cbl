      ******************************************************************
      * ZSU011Q8 - SURRENDER AND MATURITY                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSU011Q8'.
      ...
      * Called module names
       01  MOD-ZSU01P4F              PIC X(8) VALUE 'ZSU01P4F'.
       01  MOD-ZRS01M2L              PIC X(8) VALUE 'ZRS01M2L'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSU01P4F-001.
               PERFORM CALL-ZRS01M2L-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSU01P4F-001.
               CALL 'ZSU01P4F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01P4F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRS01M2L-002.
               CALL 'ZRS01M2L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRS01M2L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
