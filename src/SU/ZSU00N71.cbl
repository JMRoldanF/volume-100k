      ******************************************************************
      * ZSU00N71 - SURRENDER AND MATURITY                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSU00N71'.
      ...
      * Called module names
       01  MOD-ZSU01N14              PIC X(8) VALUE 'ZSU01N14'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSU01N14-001.
               CALL 'ZSU01N14' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01N14 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
