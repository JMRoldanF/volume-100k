      ******************************************************************
      * ZSU00YM8 - SURRENDER AND MATURITY                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSU00YM8'.
      ...
      * Called module names
       01  MOD-ZSU01UGJ              PIC X(8) VALUE 'ZSU01UGJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSU01UGJ-001.
               CALL 'ZSU01UGJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01UGJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
