      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSL00UTN'.
      ...
      * Called module names
       01  MOD-ZSL01JZZ              PIC X(8) VALUE 'ZSL01JZZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSL01JZZ-001.
               PERFORM CALL-ZSL01SMM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSL01JZZ-001.
               CALL 'ZSL01JZZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSL01JZZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSL01SMM-002.
