      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSL00MWA'.
      ...
      * Called module names
       01  MOD-ZCO01HZW              PIC X(8) VALUE 'ZCO01HZW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCO01HZW-001.
               CALL 'ZCO01HZW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCO01HZW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-EXCESS-0001.
