      ******************************************************************
      * ZSL00UFH - SALVAGE DISPOSAL                                    *
      ******************************************************************
      *
      *  Generated volume-test source. Layer 2,
      *  type data_db2, domain SALVAGE.
      ******************************************************************
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSL00UFH'.
      ...
      * Called module names
       01  MOD-ZSL01I78              PIC X(8) VALUE 'ZSL01I78'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CHECK-STATUS-CODE-0092.
               ...
               PERFORM FORMAT-MODEL-0109.
               PERFORM CHECK-NCD-YEARS-0110.
               PERFORM DERIVE-VALUE-0112.
               PERFORM DERIVE-TAX-BAND-0113.
               PERFORM SQL-ACCESS-0114.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZSL01I78-001.
               CALL 'ZSL01I78' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSL01I78 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       ...
       SQL-ACCESS-0003.
               EXEC SQL
                     ...
                     SELECT POLICYNUMBER, PAYMENT
                       FROM GENASL.RENEWAL A
                       JOIN GENASL.CUSTOMER B
