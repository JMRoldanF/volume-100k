      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSL00VSA'.
      ...
      * Called module names
       01  MOD-ZSL01OJP              PIC X(8) VALUE 'ZSL01OJP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSL01OJP-001.
               CALL 'ZSL01OJP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSL01OJP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSL01JK9-002.
