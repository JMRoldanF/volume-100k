      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSL00MHP'.
      ...
      * Called module names
       01  MOD-ZSL01EOB              PIC X(8) VALUE 'ZSL01EOB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSL01EOB-001.
               CALL 'ZSL01EOB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSL01EOB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
