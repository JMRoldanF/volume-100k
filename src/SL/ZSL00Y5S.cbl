      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSL00Y5S'.
      ...
      * Called module names
       01  MOD-ZSL01M8N              PIC X(8) VALUE 'ZSL01M8N'.
       01  MOD-ZSL01DF6              PIC X(8) VALUE 'ZSL01DF6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSL01M8N-001.
               CALL 'ZSL01M8N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSL01M8N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSL01DF6-002.
               CALL 'ZSL01DF6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
