      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSL00WM9'.
      ...
      * Called module names
       ...
       01  MOD-ZRT01EJ0              PIC X(8) VALUE 'ZRT01EJ0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIF01OFT-001.
               PERFORM CALL-ZRT01EJ0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRT01EJ0-002.
               CALL 'ZRT01EJ0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRT01EJ0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
