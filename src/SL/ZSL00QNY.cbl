      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSL00QNY'.
      ...
      * Called module names
       01  MOD-ZSL01MM3              PIC X(8) VALUE 'ZSL01MM3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSL01MM3-001.
               PERFORM CALL-ZSL01K15-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSL01MM3-001.
               CALL 'ZSL01MM3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSL01MM3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSL01K15-002.
