      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSL00MFA'.
      ...
      * Called module names
       01  MOD-ZSL01LQT              PIC X(8) VALUE 'ZSL01LQT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSL01LQT-001.
               CALL 'ZSL01LQT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSL01LQT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
