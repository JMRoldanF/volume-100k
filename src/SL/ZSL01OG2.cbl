      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSL01OG2'.
      ...
      * Called module names
       01  MOD-ZSL01L8D              PIC X(8) VALUE 'ZSL01L8D'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSL01L8D-001.
               CALL 'ZSL01L8D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSL01L8D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
