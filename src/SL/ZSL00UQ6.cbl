      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSL00UQ6'.
      ...
      * Called module names
       01  MOD-ZIF01SJT              PIC X(8) VALUE 'ZIF01SJT'.
       01  MOD-ZSL01NSM              PIC X(8) VALUE 'ZSL01NSM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIF01SJT-001.
               PERFORM CALL-ZSL01NSM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZIF01SJT-001.
               CALL 'ZIF01SJT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIF01SJT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSL01NSM-002.
               CALL 'ZSL01NSM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSL01NSM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
