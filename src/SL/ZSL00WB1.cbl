      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSL00WB1'.
      ...
      * Called module names
       01  MOD-ZSL01PJW              PIC X(8) VALUE 'ZSL01PJW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSL01PJW-001.
               CALL 'ZSL01PJW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSL01PJW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
