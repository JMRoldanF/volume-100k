      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSL00TNN'.
      ...
      * Called module names
       01  MOD-ZSL01LPK              PIC X(8) VALUE 'ZSL01LPK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSL01LPK-001.
               CALL 'ZSL01LPK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSL01LPK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
