      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSL004L2'.
      ...
      * Called module names
       ...
       01  MOD-ZIF00ALG              PIC X(8) VALUE 'ZIF00ALG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSL00FC9-001.
               PERFORM CALL-ZIF00ALG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZIF00ALG-002.
               EXEC CICS LINK PROGRAM('ZIF00ALG')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIF00ALG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
