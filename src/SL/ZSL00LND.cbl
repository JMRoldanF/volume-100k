      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSL00LND'.
      ...
      * Called module names
       01  MOD-ZSL01FNU              PIC X(8) VALUE 'ZSL01FNU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSL01FNU-001.
               PERFORM CALL-ZSL01PT0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSL01FNU-001.
               CALL 'ZSL01FNU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSL01FNU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSL01PT0-002.
