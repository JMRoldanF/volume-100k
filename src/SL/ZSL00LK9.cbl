      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSL00LK9'.
      ...
      * Called module names
       01  MOD-ZSL00MZN              PIC X(8) VALUE 'ZSL00MZN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSL00MZN-001.
               EXEC CICS LINK PROGRAM('ZSL00MZN')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSL00MZN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSL01OZA-002.
