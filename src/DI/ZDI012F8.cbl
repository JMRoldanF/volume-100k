      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDI012F8'.
      ...
      * Called module names
       01  MOD-ZDI01TG2              PIC X(8) VALUE 'ZDI01TG2'.
       01  MOD-ZDI01RV0              PIC X(8) VALUE 'ZDI01RV0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZDI01TG2-001.
               PERFORM CALL-ZDI01RV0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZDI01TG2-001.
               CALL 'ZDI01TG2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDI01TG2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZDI01RV0-002.
               CALL 'ZDI01RV0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDI01RV0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
