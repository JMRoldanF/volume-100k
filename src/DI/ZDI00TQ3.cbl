      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDI00TQ3'.
      ...
      * Called module names
       01  MOD-ZDI01GTH              PIC X(8) VALUE 'ZDI01GTH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZDI01GTH-001.
               PERFORM CALL-ZDI01ELJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZDI01GTH-001.
               CALL 'ZDI01GTH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDI01GTH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZDI01ELJ-002.
