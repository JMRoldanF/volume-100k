      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDI00M9X'.
      ...
      * Called module names
       01  MOD-ZPR01PEZ              PIC X(8) VALUE 'ZPR01PEZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR01PEZ-001.
               CALL 'ZPR01PEZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01PEZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
