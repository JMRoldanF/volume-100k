      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDI00NY0'.
      ...
      * Called module names
       01  MOD-ZLB01Q5X              PIC X(8) VALUE 'ZLB01Q5X'.
       01  MOD-ZDI01D5E              PIC X(8) VALUE 'ZDI01D5E'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZLB01Q5X-001.
               PERFORM CALL-ZDI01D5E-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01Q5X-001.
               CALL 'ZLB01Q5X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01Q5X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZDI01D5E-002.
               CALL 'ZDI01D5E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDI01D5E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
