      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDI00PVR'.
      ...
      * Called module names
       01  MOD-ZDI01R5U              PIC X(8) VALUE 'ZDI01R5U'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZDI01R5U-001.
               PERFORM CALL-ZUW01LXH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZDI01R5U-001.
               CALL 'ZDI01R5U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDI01R5U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01LXH-002.
