      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDI00UHX'.
      ...
      * Called module names
       01  MOD-ZDI01ISH              PIC X(8) VALUE 'ZDI01ISH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDI01ISH-001.
               CALL 'ZDI01ISH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDI01ISH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
