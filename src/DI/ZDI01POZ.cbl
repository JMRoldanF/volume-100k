      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDI01POZ'.
      ...
      * Called module names
       01  MOD-ZDI01G54              PIC X(8) VALUE 'ZDI01G54'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDI01G54-001.
               CALL 'ZDI01G54' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDI01G54 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
