      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDI011RF'.
      ...
      * Called module names
       01  MOD-ZPR01LH3              PIC X(8) VALUE 'ZPR01LH3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR01LH3-001.
               CALL 'ZPR01LH3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01LH3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
