      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDI00ZZ2'.
      ...
      * Called module names
       01  MOD-ZLB01OES              PIC X(8) VALUE 'ZLB01OES'.
      ...
      *----------------------------------------------------------------*
       CALL-ZLB01OES-001.
               CALL 'ZLB01OES' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZLB01OES FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-TERM-0001.
