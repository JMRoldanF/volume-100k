      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDI01A2D'.
      ...
      * Called module names
       01  MOD-ZDI01UBD              PIC X(8) VALUE 'ZDI01UBD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDI01UBD-001.
               CALL 'ZDI01UBD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       FILE-ACCESS-0006.
               EXEC CICS DELETE FILE('KSDSDI45')
                         RIDFLD(WS-KEY-AREA)
                         RESP(WS-RESP)
               END-EXEC.
               EVALUATE WS-RESP
