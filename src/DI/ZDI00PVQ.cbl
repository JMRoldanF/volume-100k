      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDI00PVQ'.
      ...
      * Called module names
       ...
       01  MOD-ZDI01H7C              PIC X(8) VALUE 'ZDI01H7C'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDI01H7C-002.
               CALL 'ZDI01H7C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDI01H7C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
