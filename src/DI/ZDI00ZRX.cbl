      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDI00ZRX'.
      ...
      * Called module names
       01  MOD-ZDI01JJF              PIC X(8) VALUE 'ZDI01JJF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDI01JJF-001.
               CALL 'ZDI01JJF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDI01JJF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
