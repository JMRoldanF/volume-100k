      ******************************************************************
      * ZDI00Q1N - DISCOUNT SCHEMES                                    *
      ******************************************************************
      *
      *  Generated volume-test source. Layer 2,
      *  type data_db2, domain DISCONT.
      ******************************************************************
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDI00Q1N'.
      ...
      * Called module names
       01  MOD-ZDI01DQX              PIC X(8) VALUE 'ZDI01DQX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDI01DQX-001.
               CALL 'ZDI01DQX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDI01DQX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
       ...
       SQL-ACCESS-0006.
               EXEC SQL
                     ...
                     SELECT POLICYNUMBER, PAYMENT
                       FROM GENADI.ENDORSE A
                       JOIN GENADI.CUSTOMER B
