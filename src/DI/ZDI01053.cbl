      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDI01053'.
      ...
      * Called module names
       01  MOD-ZDI01L7O              PIC X(8) VALUE 'ZDI01L7O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDI01L7O-001.
               CALL 'ZDI01L7O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDI01L7O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
