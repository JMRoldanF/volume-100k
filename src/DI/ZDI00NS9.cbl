      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDI00NS9'.
      ...
      * Called module names
       01  MOD-ZDI01TZJ              PIC X(8) VALUE 'ZDI01TZJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDI01TZJ-001.
               CALL 'ZDI01TZJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDI01TZJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
