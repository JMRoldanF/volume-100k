      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDI012SB'.
      ...
      * Called module names
       ...
       01  MOD-ZDI01RKT              PIC X(8) VALUE 'ZDI01RKT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDI01RKT-002.
               CALL 'ZDI01RKT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDI01RKT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
