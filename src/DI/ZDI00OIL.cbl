      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDI00OIL'.
      ...
      * Called module names
       ...
       01  MOD-ZDI01K1J              PIC X(8) VALUE 'ZDI01K1J'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDI01K1J-002.
               CALL 'ZDI01K1J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDI01K1J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
