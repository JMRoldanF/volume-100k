      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDI00VYX'.
      ...
      * Called module names
       ...
       01  MOD-ZDI01TMG              PIC X(8) VALUE 'ZDI01TMG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDI01TMG-002.
               CALL 'ZDI01TMG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDI01TMG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
