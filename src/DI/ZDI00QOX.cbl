      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDI00QOX'.
      ...
      * Called module names
       01  MOD-ZDI01R66              PIC X(8) VALUE 'ZDI01R66'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDI01R66-001.
               CALL 'ZDI01R66' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDI01R66 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-BEDROOMS-0001.
