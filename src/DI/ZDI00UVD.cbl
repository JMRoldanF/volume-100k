      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDI00UVD'.
      ...
      * Called module names
       ...
       01  MOD-ZDI01KVO              PIC X(8) VALUE 'ZDI01KVO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDI01KVO-002.
               CALL 'ZDI01KVO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDI01KVO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
