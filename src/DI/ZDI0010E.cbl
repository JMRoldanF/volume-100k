      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZDI0010E'.
      ...
      * Called module names
       01  MOD-ZIV00F4C              PIC X(8) VALUE 'ZIV00F4C'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIV00F4C-001.
               PERFORM CALL-ZDI00GZA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV00F4C-001.
               EXEC CICS LINK PROGRAM('ZIV00F4C')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV00F4C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZDI00GZA-002.
