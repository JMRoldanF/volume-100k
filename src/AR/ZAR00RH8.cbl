      ******************************************************************
      * ZAR00RH8 - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR00RH8'.
      ...
      * Called module names
       01  MOD-ZAR01EVL              PIC X(8) VALUE 'ZAR01EVL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01EVL-001.
               CALL 'ZAR01EVL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01EVL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
