      ******************************************************************
      * ZAR00ROF - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR00ROF'.
      ...
      * Called module names
       01  MOD-ZAR01P2T              PIC X(8) VALUE 'ZAR01P2T'.
       01  MOD-ZAR01OTW              PIC X(8) VALUE 'ZAR01OTW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAR01P2T-001.
               PERFORM CALL-ZAR01OTW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01P2T-001.
               CALL 'ZAR01P2T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01P2T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAR01OTW-002.
               CALL 'ZAR01OTW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01OTW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
