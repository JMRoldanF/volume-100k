      ******************************************************************
      * ZAR00QEC - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR00QEC'.
      ...
      * Called module names
       01  MOD-ZAR01RG7              PIC X(8) VALUE 'ZAR01RG7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01RG7-001.
               CALL 'ZAR01RG7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
