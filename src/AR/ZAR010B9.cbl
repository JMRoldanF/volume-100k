      ******************************************************************
      * ZAR010B9 - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR010B9'.
      ...
      * Called module names
       ...
       01  MOD-ZAR01QYB              PIC X(8) VALUE 'ZAR01QYB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAR01MY9-001.
               PERFORM CALL-ZAR01QYB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01QYB-002.
               CALL 'ZAR01QYB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01QYB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
