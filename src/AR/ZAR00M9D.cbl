      ******************************************************************
      * ZAR00M9D - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR00M9D'.
      ...
      * Called module names
       01  MOD-ZRG01P6Z              PIC X(8) VALUE 'ZRG01P6Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01P6Z-001.
               CALL 'ZRG01P6Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01P6Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
