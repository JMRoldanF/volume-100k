      ******************************************************************
      * ZAR00Y29 - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR00Y29'.
      ...
      * Called module names
       ...
       01  MOD-ZDI01G3R              PIC X(8) VALUE 'ZDI01G3R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDI01G3R-002.
               CALL 'ZDI01G3R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDI01G3R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
