      ******************************************************************
      * ZAR011YA - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR011YA'.
      ...
      * Called module names
       ...
       01  MOD-ZAR01QCB              PIC X(8) VALUE 'ZAR01QCB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01QCB-002.
               CALL 'ZAR01QCB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01QCB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-MODEL-0001.
