      ******************************************************************
      * ZAR00VPO - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR00VPO'.
      ...
      * Called module names
       01  MOD-ZAR01EKL              PIC X(8) VALUE 'ZAR01EKL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01EKL-001.
               CALL 'ZAR01EKL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01EKL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
