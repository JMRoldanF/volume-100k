      ******************************************************************
      * ZAR00T77 - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR00T77'.
      ...
      * Called module names
       01  MOD-ZAR01LCJ              PIC X(8) VALUE 'ZAR01LCJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01LCJ-001.
               CALL 'ZAR01LCJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01LCJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
