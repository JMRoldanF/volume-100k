      ******************************************************************
      * ZAR00RY4 - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR00RY4'.
      ...
      * Called module names
       01  MOD-ZDI01V2U              PIC X(8) VALUE 'ZDI01V2U'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDI01V2U-001.
               CALL 'ZDI01V2U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDI01V2U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
