      ******************************************************************
      * ZAR01PP1 - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR01PP1'.
      ...
      * Called module names
       01  MOD-ZAR01THY              PIC X(8) VALUE 'ZAR01THY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01THY-001.
               CALL 'ZAR01THY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01THY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
