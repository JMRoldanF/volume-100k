      ******************************************************************
      * ZAR00S0T - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR00S0T'.
      ...
      * Called module names
       01  MOD-ZAR01G3C              PIC X(8) VALUE 'ZAR01G3C'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01G3C-001.
               CALL 'ZAR01G3C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01G3C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFL01U11-002.
