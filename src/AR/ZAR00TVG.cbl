      ******************************************************************
      * ZAR00TVG - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR00TVG'.
      ...
      * Called module names
       ...
       01  MOD-ZFL01MXT              PIC X(8) VALUE 'ZFL01MXT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFL01MXT-002.
               CALL 'ZFL01MXT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFL01MXT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-VALUE-0001.
