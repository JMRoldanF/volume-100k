      ******************************************************************
      * ZAR00WJK - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR00WJK'.
      ...
      * Called module names
       01  MOD-ZAR01SCE              PIC X(8) VALUE 'ZAR01SCE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01SCE-001.
               CALL 'ZAR01SCE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01SCE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
