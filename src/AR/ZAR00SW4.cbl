      ******************************************************************
      * ZAR00SW4 - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR00SW4'.
      ...
      * Called module names
       01  MOD-ZDI01HBG              PIC X(8) VALUE 'ZDI01HBG'.
       01  MOD-ZAR01E5F              PIC X(8) VALUE 'ZAR01E5F'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZDI01HBG-001.
               PERFORM CALL-ZAR01E5F-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZDI01HBG-001.
               CALL 'ZDI01HBG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDI01HBG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAR01E5F-002.
               CALL 'ZAR01E5F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01E5F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
