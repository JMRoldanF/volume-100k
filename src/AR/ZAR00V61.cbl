      ******************************************************************
      * ZAR00V61 - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR00V61'.
      ...
      * Called module names
       01  MOD-ZSE01SLF              PIC X(8) VALUE 'ZSE01SLF'.
       01  MOD-ZAR01CN3              PIC X(8) VALUE 'ZAR01CN3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSE01SLF-001.
               PERFORM CALL-ZAR01CN3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01SLF-001.
               CALL 'ZSE01SLF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01SLF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAR01CN3-002.
               CALL 'ZAR01CN3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01CN3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
