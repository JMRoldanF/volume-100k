      ******************************************************************
      * ZAR00MMZ - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR00MMZ'.
      ...
      * Called module names
       01  MOD-ZAR01ELM              PIC X(8) VALUE 'ZAR01ELM'.
       01  MOD-ZAR01HL7              PIC X(8) VALUE 'ZAR01HL7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAR01ELM-001.
               PERFORM CALL-ZAR01HL7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01ELM-001.
               CALL 'ZAR01ELM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01ELM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAR01HL7-002.
               CALL 'ZAR01HL7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01HL7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
