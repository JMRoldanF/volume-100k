      ******************************************************************
      * ZAR00UEC - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR00UEC'.
      ...
      * Called module names
       01  MOD-ZAR01PRC              PIC X(8) VALUE 'ZAR01PRC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01PRC-001.
               CALL 'ZAR01PRC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01PRC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
