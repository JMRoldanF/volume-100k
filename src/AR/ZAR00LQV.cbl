      ******************************************************************
      * ZAR00LQV - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR00LQV'.
      ...
      * Called module names
       01  MOD-ZAR01EFV              PIC X(8) VALUE 'ZAR01EFV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01EFV-001.
               CALL 'ZAR01EFV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01EFV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZDI01NLK-002.
