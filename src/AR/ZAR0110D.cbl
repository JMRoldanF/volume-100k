      ******************************************************************
      * ZAR0110D - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR0110D'.
      ...
      * Called module names
       01  MOD-ZAR01Q8H              PIC X(8) VALUE 'ZAR01Q8H'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAR01Q8H-001.
               PERFORM CALL-ZDI01KDK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01Q8H-001.
               CALL 'ZAR01Q8H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01Q8H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZDI01KDK-002.
