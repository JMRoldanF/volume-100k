      ******************************************************************
      * ZAR00NWM - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR00NWM'.
      ...
      * Called module names
       01  MOD-ZAR01J99              PIC X(8) VALUE 'ZAR01J99'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01J99-001.
               CALL 'ZAR01J99' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01J99 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-EQUITIES-0001.
