      ******************************************************************
      * ZAR00ZCF - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR00ZCF'.
      ...
      * Called module names
       01  MOD-ZAR01L60              PIC X(8) VALUE 'ZAR01L60'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAR01S9E-001.
               PERFORM CALL-ZAR01L60-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01L60-002.
               CALL 'ZAR01L60' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01L60 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
