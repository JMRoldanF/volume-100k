      ******************************************************************
      * ZAR00R5Q - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR00R5Q'.
      ...
      * Called module names
       01  MOD-ZAR01MSV              PIC X(8) VALUE 'ZAR01MSV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01MSV-001.
               CALL 'ZAR01MSV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01MSV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAR01SZC-002.
