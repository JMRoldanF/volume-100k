      ******************************************************************
      * ZAR00V10 - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR00V10'.
      ...
      * Called module names
       01  MOD-ZAR01IT4              PIC X(8) VALUE 'ZAR01IT4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAR01IT4-001.
               PERFORM CALL-ZAR01IXD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01IT4-001.
               CALL 'ZAR01IT4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01IT4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAR01IXD-002.
