      ******************************************************************
      * ZAR001BD - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR001BD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAR0084L-001.
               PERFORM CALL-ZAR00C97-002.
               PERFORM CALL-ZRG00EF8-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG00EF8-003.
               MOVE 'ZRG00EF8' TO WS-PROGNAME-1
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG00EF8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-004.
