      ******************************************************************
      * ZAR012GD - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR012GD'.
      ...
      * Called module names
       01  MOD-ZAR01S97              PIC X(8) VALUE 'ZAR01S97'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01S97-001.
               CALL 'ZAR01S97' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01S97 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
