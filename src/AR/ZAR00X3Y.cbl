      ******************************************************************
      * ZAR00X3Y - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR00X3Y'.
      ...
      * Called module names
       01  MOD-ZAR01FC3              PIC X(8) VALUE 'ZAR01FC3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01FC3-001.
               CALL 'ZAR01FC3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01FC3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAR01DUW-002.
