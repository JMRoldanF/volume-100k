      ******************************************************************
      * ZAR00ZSQ - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR00ZSQ'.
      ...
      * Called module names
       01  MOD-ZRG01K9P              PIC X(8) VALUE 'ZRG01K9P'.
       01  MOD-ZAR01GWK              PIC X(8) VALUE 'ZAR01GWK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRG01K9P-001.
               PERFORM CALL-ZAR01GWK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRG01K9P-001.
               CALL 'ZRG01K9P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRG01K9P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAR01GWK-002.
               CALL 'ZAR01GWK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01GWK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
