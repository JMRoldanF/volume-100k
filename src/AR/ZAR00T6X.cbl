      ******************************************************************
      * ZAR00T6X - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR00T6X'.
      ...
      * Called module names
       01  MOD-ZDI01KYV              PIC X(8) VALUE 'ZDI01KYV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZDI01KYV-001.
               PERFORM CALL-ZAR01S3N-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZDI01KYV-001.
               CALL 'ZDI01KYV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01S3N-002.
               MOVE 'ZAR01S3N' TO WS-SUBNAME-8
               CALL WS-SUBNAME-8 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01S3N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
