      ******************************************************************
      * ZAR00MF8 - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR00MF8'.
      ...
      * Called module names
       01  MOD-ZDI01O4F              PIC X(8) VALUE 'ZDI01O4F'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDI01O4F-001.
               CALL 'ZDI01O4F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDI01O4F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAR01NT2-002.
