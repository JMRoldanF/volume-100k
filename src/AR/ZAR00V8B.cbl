      ******************************************************************
      * ZAR00V8B - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR00V8B'.
      ...
      * Called module names
       01  MOD-ZAR01KPB              PIC X(8) VALUE 'ZAR01KPB'.
       01  MOD-ZAR01FHS              PIC X(8) VALUE 'ZAR01FHS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAR01KPB-001.
               PERFORM CALL-ZAR01FHS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01KPB-001.
               CALL 'ZAR01KPB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01KPB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAR01FHS-002.
               CALL 'ZAR01FHS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01FHS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
