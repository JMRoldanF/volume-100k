      ******************************************************************
      * ZAR01BL4 - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR01BL4'.
      ...
      * Called module names
       01  MOD-ZSE01QJP              PIC X(8) VALUE 'ZSE01QJP'.
       01  MOD-ZAR01UWB              PIC X(8) VALUE 'ZAR01UWB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01QJP-001.
               CALL 'ZSE01QJP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01UWB-002.
               CALL 'ZAR01UWB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01UWB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
