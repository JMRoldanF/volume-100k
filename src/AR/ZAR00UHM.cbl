      ******************************************************************
      * ZAR00UHM - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR00UHM'.
      ...
      * Called module names
       01  MOD-ZAR01IZN              PIC X(8) VALUE 'ZAR01IZN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAR01QXD-001.
               PERFORM CALL-ZAR01IZN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAR01IZN-002.
               CALL 'ZAR01IZN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAR01IZN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
