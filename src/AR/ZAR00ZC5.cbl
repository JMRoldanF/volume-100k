      ******************************************************************
      * ZAR00ZC5 - ARCHIVAL AND RETENTION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAR00ZC5'.
      ...
      * Called module names
       01  MOD-ZSE01TWH              PIC X(8) VALUE 'ZSE01TWH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01TWH-001.
               CALL 'ZSE01TWH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01TWH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
