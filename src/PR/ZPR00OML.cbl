      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR00OML'.
      ...
      * Called module names
       01  MOD-ZSU01JSG              PIC X(8) VALUE 'ZSU01JSG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSU01JSG-001.
               CALL 'ZSU01JSG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01JSG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
