      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR00YUB'.
      ...
      * Called module names
       01  MOD-ZAC01RPC              PIC X(8) VALUE 'ZAC01RPC'.
       01  MOD-ZPR01D9M              PIC X(8) VALUE 'ZPR01D9M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01RPC-001.
               CALL 'ZAC01RPC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01RPC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPR01D9M-002.
               CALL 'ZPR01D9M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01D9M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
