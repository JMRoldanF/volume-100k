      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR00G7O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR00MMP-001.
               MOVE 'ZPR00MMP' TO WS-PROGNAME-6
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR00MMP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01JA2-002.
