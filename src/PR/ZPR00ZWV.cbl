      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR00ZWV'.
      ...
      * Called module names
       ...
       01  MOD-ZGW01ERQ              PIC X(8) VALUE 'ZGW01ERQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPR01HZR-001.
               PERFORM CALL-ZGW01ERQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01ERQ-002.
               CALL 'ZGW01ERQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01ERQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
