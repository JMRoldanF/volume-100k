      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR00UT4'.
      ...
      * Called module names
       ...
       01  MOD-ZSU01H72              PIC X(8) VALUE 'ZSU01H72'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPR01E7Q-001.
               PERFORM CALL-ZSU01H72-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSU01H72-002.
               CALL 'ZSU01H72' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01H72 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
