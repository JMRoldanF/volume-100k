      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR014H5'.
      ...
      * Called module names
       01  MOD-ZPR01Q77              PIC X(8) VALUE 'ZPR01Q77'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR01Q77-001.
               CALL 'ZPR01Q77' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01Q77 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-BEDROOMS-0001.
