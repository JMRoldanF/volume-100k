      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR00UA1'.
      ...
      * Called module names
       01  MOD-ZCL01SIY              PIC X(8) VALUE 'ZCL01SIY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01SIY-001.
               CALL 'ZCL01SIY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01SIY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
