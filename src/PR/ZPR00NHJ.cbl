      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR00NHJ'.
      ...
      * Called module names
       01  MOD-ZPR01IC2              PIC X(8) VALUE 'ZPR01IC2'.
       01  MOD-ZPR01TDU              PIC X(8) VALUE 'ZPR01TDU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPR01IC2-001.
               PERFORM CALL-ZPR01TDU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR01IC2-001.
               CALL 'ZPR01IC2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01IC2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPR01TDU-002.
               CALL 'ZPR01TDU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
