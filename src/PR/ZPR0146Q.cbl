      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR0146Q'.
      ...
      * Called module names
       01  MOD-ZPR01RIW              PIC X(8) VALUE 'ZPR01RIW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR01RIW-001.
               CALL 'ZPR01RIW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01RIW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
