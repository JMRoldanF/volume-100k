      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR00EDO'.
      ...
      * Called module names
       ...
       01  MOD-ZGW00U0J              PIC X(8) VALUE 'ZGW00U0J'.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW00U0J-002.
               EXEC CICS LINK PROGRAM('ZGW00U0J')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW00U0J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
