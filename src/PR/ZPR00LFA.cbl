      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR00LFA'.
      ...
      * Called module names
       01  MOD-ZPR00ZS2              PIC X(8) VALUE 'ZPR00ZS2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR00ZS2-001.
               EXEC CICS LINK PROGRAM('ZPR00ZS2')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR00ZS2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
