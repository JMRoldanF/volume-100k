      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR00S2E'.
      ...
      * Called module names
       01  MOD-ZGW01P38              PIC X(8) VALUE 'ZGW01P38'.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01P38-001.
               CALL 'ZGW01P38' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01P38 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
