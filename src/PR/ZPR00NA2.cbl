      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR00NA2'.
      ...
      * Called module names
       01  MOD-ZPR01EWZ              PIC X(8) VALUE 'ZPR01EWZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR01EWZ-001.
               CALL 'ZPR01EWZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01EWZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
