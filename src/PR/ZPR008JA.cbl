      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR008JA'.
      ...
      * Called module names
       01  MOD-ZGW00PDM              PIC X(8) VALUE 'ZGW00PDM'.
       01  MOD-ZPR015S2              PIC X(8) VALUE 'ZPR015S2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZGW00PDM-001.
               PERFORM CALL-ZSU018KG-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW00PDM-001.
               EXEC CICS LINK PROGRAM('ZGW00PDM')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW00PDM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPR015S2-002.
               EXEC CICS LINK PROGRAM('ZPR015S2')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR015S2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSU018KG-003.
