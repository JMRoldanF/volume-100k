      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR00YS8'.
      ...
      * Called module names
       01  MOD-ZCL01U15              PIC X(8) VALUE 'ZCL01U15'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01U15-001.
               CALL 'ZCL01U15' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01U15 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
