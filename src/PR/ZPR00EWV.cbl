      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR00EWV'.
      ...
      * Called module names
       01  MOD-ZPR00MD9              PIC X(8) VALUE 'ZPR00MD9'.
       01  MOD-ZPR011O9              PIC X(8) VALUE 'ZPR011O9'.
       01  MOD-ZPR00WDE              PIC X(8) VALUE 'ZPR00WDE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPR00MD9-001.
               PERFORM CALL-ZPR011O9-002.
               PERFORM CALL-ZPR00WDE-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR00MD9-001.
               EXEC CICS LINK PROGRAM('ZPR00MD9')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR00MD9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPR011O9-002.
               EXEC CICS LINK PROGRAM('ZPR011O9')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR011O9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPR00WDE-003.
               EXEC CICS LINK PROGRAM('ZPR00WDE')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR00WDE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-004.
