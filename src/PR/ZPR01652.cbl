      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR01652'.
      ...
      * Called module names
       01  MOD-ZPR01KL0              PIC X(8) VALUE 'ZPR01KL0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR01KL0-001.
               CALL 'ZPR01KL0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01KL0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
