      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR0114J'.
      ...
      * Called module names
       01  MOD-ZPR01RZC              PIC X(8) VALUE 'ZPR01RZC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR01RZC-001.
               CALL 'ZPR01RZC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01RZC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
