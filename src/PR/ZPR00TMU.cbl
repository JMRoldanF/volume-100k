      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR00TMU'.
      ...
      * Called module names
       01  MOD-ZPR01IZ1              PIC X(8) VALUE 'ZPR01IZ1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPR01IZ1-001.
               PERFORM CALL-ZPR01KUD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR01IZ1-001.
               CALL 'ZPR01IZ1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01IZ1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPR01KUD-002.
