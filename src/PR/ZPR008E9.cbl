      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR008E9'.
      ...
      * Called module names
       01  MOD-ZPR00ZYB              PIC X(8) VALUE 'ZPR00ZYB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPR00ZYB-001.
               PERFORM CALL-ZPR00X8V-002.
               PERFORM CALL-ZPR01BP9-003.
               PERFORM CALL-ZPR01AAM-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR00ZYB-001.
               EXEC CICS LINK PROGRAM('ZPR00ZYB')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR00ZYB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPR00X8V-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR01AAM-004.
               MOVE 'ZPR01AAM' TO WS-PROGNAME-1
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01AAM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPR01T6W-005.
