      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR0020B'.
      ...
      * Called module names
       01  MOD-ZPR009IR              PIC X(8) VALUE 'ZPR009IR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPR009KU-001.
               PERFORM CALL-ZPR009IR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR009KU-001.
               MOVE 'ZPR009KU' TO WS-PROGNAME-5
      ...
      *----------------------------------------------------------------*
       CALL-ZPR009IR-002.
               EXEC CICS LINK PROGRAM('ZPR009IR')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR009IR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAC00CBX-003.
               MOVE 'ZAC00CBX' TO WS-PROGNAME-6
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC00CBX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
