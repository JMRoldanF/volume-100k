      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR00RRZ'.
      ...
      * Called module names
       01  MOD-ZPR01MNY              PIC X(8) VALUE 'ZPR01MNY'.
       01  MOD-ZPR01H68              PIC X(8) VALUE 'ZPR01H68'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR01MNY-001.
               CALL 'ZPR01MNY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01MNY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPR01H68-002.
               CALL 'ZPR01H68' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01H68 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
