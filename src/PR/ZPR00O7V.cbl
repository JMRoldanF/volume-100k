      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR00O7V'.
      ...
      * Called module names
       01  MOD-ZPR01OYU              PIC X(8) VALUE 'ZPR01OYU'.
       01  MOD-ZPR01FA4              PIC X(8) VALUE 'ZPR01FA4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPR01OYU-001.
               PERFORM CALL-ZPR01FA4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR01OYU-001.
               CALL 'ZPR01OYU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01OYU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPR01FA4-002.
               CALL 'ZPR01FA4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01FA4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
