      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR012FW'.
      ...
      * Called module names
       01  MOD-ZPR01N1E              PIC X(8) VALUE 'ZPR01N1E'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR01N1E-001.
               CALL 'ZPR01N1E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01N1E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       NORMALISE-MAKE-0001.
