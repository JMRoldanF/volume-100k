      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR00QUD'.
      ...
      * Called module names
       01  MOD-ZGW01LJQ              PIC X(8) VALUE 'ZGW01LJQ'.
       01  MOD-ZSU01LVL              PIC X(8) VALUE 'ZSU01LVL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZGW01LJQ-001.
               PERFORM CALL-ZSU01LVL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZGW01LJQ-001.
               CALL 'ZGW01LJQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZGW01LJQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSU01LVL-002.
               CALL 'ZSU01LVL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01LVL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
