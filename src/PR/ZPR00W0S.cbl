      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR00W0S'.
      ...
      * Called module names
       01  MOD-ZSU01T8O              PIC X(8) VALUE 'ZSU01T8O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSU01T8O-001.
               CALL 'ZSU01T8O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01T8O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
