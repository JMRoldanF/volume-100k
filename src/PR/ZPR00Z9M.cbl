      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR00Z9M'.
      ...
      * Called module names
       ...
       01  MOD-ZPR01QA1              PIC X(8) VALUE 'ZPR01QA1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR01QA1-002.
               CALL 'ZPR01QA1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01QA1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
