      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR012EQ'.
      ...
      * Called module names
       01  MOD-ZPR01U1D              PIC X(8) VALUE 'ZPR01U1D'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR01U1D-001.
               CALL 'ZPR01U1D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01U1D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPR01OGX-002.
