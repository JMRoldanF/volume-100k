      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR00XTZ'.
      ...
      * Called module names
       01  MOD-ZCL01SYG              PIC X(8) VALUE 'ZCL01SYG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01SYG-001.
               CALL 'ZCL01SYG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01SYG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPR01QP9-002.
