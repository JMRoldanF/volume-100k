      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR00I3W'.
      ...
      * Called module names
       01  MOD-ZPR00YK2              PIC X(8) VALUE 'ZPR00YK2'.
       01  MOD-ZPR00SW2              PIC X(8) VALUE 'ZPR00SW2'.
       01  MOD-ZCL014W5              PIC X(8) VALUE 'ZCL014W5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPR00YK2-001.
               PERFORM CALL-ZPR00SW2-002.
               PERFORM CALL-ZCL014W5-003.
               PERFORM CALL-ZPR01I2X-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR00YK2-001.
               EXEC CICS LINK PROGRAM('ZPR00YK2')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR00YK2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPR00SW2-002.
               EXEC CICS LINK PROGRAM('ZPR00SW2')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR00SW2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL014W5-003.
               EXEC CICS LINK PROGRAM('ZCL014W5')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL014W5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPR01I2X-004.
