      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR00OAR'.
      ...
      * Called module names
       01  MOD-ZPR01KSR              PIC X(8) VALUE 'ZPR01KSR'.
       01  MOD-ZSU01UN0              PIC X(8) VALUE 'ZSU01UN0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPR01KSR-001.
               PERFORM CALL-ZSU01UN0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR01KSR-001.
               CALL 'ZPR01KSR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01KSR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSU01UN0-002.
               CALL 'ZSU01UN0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSU01UN0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
