      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR00RER'.
      ...
      * Called module names
       01  MOD-ZAC01RCB              PIC X(8) VALUE 'ZAC01RCB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01RCB-001.
               CALL 'ZAC01RCB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01RCB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
