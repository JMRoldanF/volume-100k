      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPR00NO2'.
      ...
      * Called module names
       01  MOD-ZPR01PSQ              PIC X(8) VALUE 'ZPR01PSQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPR01PSQ-001.
               PERFORM CALL-ZPR01U3R-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPR01PSQ-001.
               CALL 'ZPR01PSQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPR01PSQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPR01U3R-002.
