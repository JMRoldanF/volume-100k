      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00LU5'.
      ...
      * Called module names
       01  MOD-ZCL01O0F              PIC X(8) VALUE 'ZCL01O0F'.
       01  MOD-ZPN01ML4              PIC X(8) VALUE 'ZPN01ML4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01O0F-001.
               PERFORM CALL-ZPN01ML4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01O0F-001.
               CALL 'ZCL01O0F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01O0F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPN01ML4-002.
               CALL 'ZPN01ML4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01ML4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
