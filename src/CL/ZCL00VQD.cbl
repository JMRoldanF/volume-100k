      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00VQD'.
      ...
      * Called module names
       01  MOD-ZCL01GCL              PIC X(8) VALUE 'ZCL01GCL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01GCL-001.
               CALL 'ZCL01GCL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01GCL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
