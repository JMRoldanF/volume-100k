      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00Y2J'.
      ...
      * Called module names
       01  MOD-ZCL01MUH              PIC X(8) VALUE 'ZCL01MUH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01MUH-001.
               CALL 'ZCL01MUH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01MUH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-MAKE-0001.
