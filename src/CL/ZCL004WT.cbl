      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL004WT'.
      ...
      * Called module names
       01  MOD-ZCL009P1              PIC X(8) VALUE 'ZCL009P1'.
       01  MOD-ZCL00B9P              PIC X(8) VALUE 'ZCL00B9P'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL009P1-001.
               PERFORM CALL-ZCL00B9P-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL009P1-001.
               EXEC CICS LINK PROGRAM('ZCL009P1')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL009P1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL00B9P-002.
               EXEC CICS LINK PROGRAM('ZCL00B9P')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL00B9P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
