      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL010K9'.
      ...
      * Called module names
       01  MOD-ZCL01QNF              PIC X(8) VALUE 'ZCL01QNF'.
       01  MOD-ZCL01S65              PIC X(8) VALUE 'ZCL01S65'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01QNF-001.
               PERFORM CALL-ZCL01S65-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01QNF-001.
               CALL 'ZCL01QNF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01QNF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01S65-002.
               CALL 'ZCL01S65' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01S65 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
