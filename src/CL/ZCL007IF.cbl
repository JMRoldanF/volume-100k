      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL007IF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL00QIB-001.
               PERFORM CALL-ZCL01D33-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL00QIB-001.
               MOVE 'ZCL00QIB' TO WS-PROGNAME-3
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL00QIB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01D33-002.
