      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00S7Z'.
      ...
      * Called module names
       01  MOD-ZCL01K95              PIC X(8) VALUE 'ZCL01K95'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01K95-001.
               CALL 'ZCL01K95' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01K95 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
