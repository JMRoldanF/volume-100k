      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL01KU9'.
      ...
      * Called module names
       01  MOD-ZCL01Q1H              PIC X(8) VALUE 'ZCL01Q1H'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01Q1H-001.
               CALL 'ZCL01Q1H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01Q1H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
