      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL01AT5'.
      ...
      * Called module names
       01  MOD-ZHO01UJW              PIC X(8) VALUE 'ZHO01UJW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01UJW-002.
               CALL 'ZHO01UJW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01UJW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
