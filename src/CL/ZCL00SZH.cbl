      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00SZH'.
      ...
      * Called module names
       01  MOD-ZAG01UMK              PIC X(8) VALUE 'ZAG01UMK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01UMK-001.
               CALL 'ZAG01UMK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01UMK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
