      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00MSZ'.
      ...
      * Called module names
       01  MOD-ZMT01IK7              PIC X(8) VALUE 'ZMT01IK7'.
       01  MOD-ZCL01PGD              PIC X(8) VALUE 'ZCL01PGD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01IK7-001.
               CALL 'ZMT01IK7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01IK7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01PGD-002.
               CALL 'ZCL01PGD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01PGD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
