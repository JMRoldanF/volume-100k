      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00X29'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01JI8              PIC X(8) VALUE 'ZCL01JI8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01G83-001.
               PERFORM CALL-ZCL01JI8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01JI8-002.
               CALL 'ZCL01JI8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01JI8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
