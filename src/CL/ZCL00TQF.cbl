      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00TQF'.
      ...
      * Called module names
       01  MOD-ZCL01JLJ              PIC X(8) VALUE 'ZCL01JLJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01JLJ-001.
               CALL 'ZCL01JLJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01JLJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
