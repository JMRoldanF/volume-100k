      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00VZD'.
      ...
      * Called module names
       01  MOD-ZCL01T5B              PIC X(8) VALUE 'ZCL01T5B'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01T5B-001.
               PERFORM CALL-ZCL01JE1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01T5B-001.
               CALL 'ZCL01T5B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01T5B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01JE1-002.
