      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00P4V'.
      ...
      * Called module names
       01  MOD-ZCL01PEZ              PIC X(8) VALUE 'ZCL01PEZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01PEZ-002.
               CALL 'ZCL01PEZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01PEZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
