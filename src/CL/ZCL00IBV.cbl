      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00IBV'.
      ...
      * Called module names
       01  MOD-ZCL00OBZ              PIC X(8) VALUE 'ZCL00OBZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL00YLZ-001.
               MOVE 'ZCL00YLZ' TO WS-PROGNAME-6
      ...
      *----------------------------------------------------------------*
       CALL-ZCL00OBZ-002.
               EXEC CICS LINK PROGRAM('ZCL00OBZ')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL00OBZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL018SN-003.
