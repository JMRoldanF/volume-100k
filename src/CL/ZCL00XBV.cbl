      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00XBV'.
      ...
      * Called module names
       01  MOD-ZCL01I0V              PIC X(8) VALUE 'ZCL01I0V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01I0V-001.
               CALL 'ZCL01I0V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01I0V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
