      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00NRP'.
      ...
      * Called module names
       01  MOD-ZCL01MMP              PIC X(8) VALUE 'ZCL01MMP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01MMP-001.
               CALL 'ZCL01MMP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01MMP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
