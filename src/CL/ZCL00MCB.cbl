      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00MCB'.
      ...
      * Called module names
       01  MOD-ZCL01MZ7              PIC X(8) VALUE 'ZCL01MZ7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01MZ7-001.
               CALL 'ZCL01MZ7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01MZ7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
