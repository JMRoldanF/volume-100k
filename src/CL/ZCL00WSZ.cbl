      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00WSZ'.
      ...
      * Called module names
       01  MOD-ZCU01SEG              PIC X(8) VALUE 'ZCU01SEG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01SEG-001.
               CALL 'ZCU01SEG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01SEG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-TERM-0001.
