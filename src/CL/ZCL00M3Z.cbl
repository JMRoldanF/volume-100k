      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00M3Z'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01KFA              PIC X(8) VALUE 'ZBI01KFA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01KFA-002.
               CALL 'ZBI01KFA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01KFA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
