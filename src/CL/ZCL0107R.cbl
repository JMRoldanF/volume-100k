      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL0107R'.
      ...
      * Called module names
       01  MOD-ZCL01M0H              PIC X(8) VALUE 'ZCL01M0H'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01M0H-001.
               CALL 'ZCL01M0H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01M0H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
