      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00Y1D'.
      ...
      * Called module names
       01  MOD-ZCL01GCV              PIC X(8) VALUE 'ZCL01GCV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01GCV-001.
               CALL 'ZCL01GCV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01GCV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01QXN-002.
