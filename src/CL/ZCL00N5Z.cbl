      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00N5Z'.
      ...
      * Called module names
       01  MOD-ZCL01EUB              PIC X(8) VALUE 'ZCL01EUB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01EUB-001.
               CALL 'ZCL01EUB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01EUB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
