      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00PFZ'.
      ...
      * Called module names
       01  MOD-ZCL01NYH              PIC X(8) VALUE 'ZCL01NYH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01NYH-001.
               CALL 'ZCL01NYH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01NYH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
