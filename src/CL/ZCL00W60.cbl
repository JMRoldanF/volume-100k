      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00W60'.
      ...
      * Called module names
       01  MOD-ZCL01O3C              PIC X(8) VALUE 'ZCL01O3C'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01O3C-001.
               CALL 'ZCL01O3C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01O3C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
