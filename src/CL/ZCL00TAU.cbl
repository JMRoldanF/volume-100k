      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00TAU'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01GTS              PIC X(8) VALUE 'ZCL01GTS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01NN2-001.
               PERFORM CALL-ZCL01GTS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01GTS-002.
               CALL 'ZCL01GTS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01GTS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-COLOUR-0001.
