      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL0095V'.
      ...
      * Called module names
       01  MOD-ZCL0122P              PIC X(8) VALUE 'ZCL0122P'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL0122P-002.
               PERFORM CALL-ZUW015DG-003.
               PERFORM CALL-ZBI01SU2-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL00MVH-001.
               MOVE 'ZCL00MVH' TO WS-PROGNAME-5
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL00MVH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0122P-002.
               EXEC CICS LINK PROGRAM('ZCL0122P')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL0122P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW015DG-003.
