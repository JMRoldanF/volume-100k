      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00ZAF'.
      ...
      * Called module names
       01  MOD-ZCL01P77              PIC X(8) VALUE 'ZCL01P77'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01P77-001.
               CALL 'ZCL01P77' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01P77 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
