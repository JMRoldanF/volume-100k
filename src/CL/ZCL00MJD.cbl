      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00MJD'.
      ...
      * Called module names
       01  MOD-ZCL01NTF              PIC X(8) VALUE 'ZCL01NTF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01NTF-001.
               CALL 'ZCL01NTF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01NTF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
