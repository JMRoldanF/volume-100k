      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00TEH'.
      ...
      * Called module names
       01  MOD-ZCL01GVR              PIC X(8) VALUE 'ZCL01GVR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01GVR-001.
               CALL 'ZCL01GVR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01GVR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
