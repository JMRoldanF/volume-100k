      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00YBX'.
      ...
      * Called module names
       01  MOD-ZCL01MCN              PIC X(8) VALUE 'ZCL01MCN'.
       01  MOD-ZCL01O5D              PIC X(8) VALUE 'ZCL01O5D'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01MCN-001.
               CALL 'ZCL01MCN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01MCN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01O5D-002.
               CALL 'ZCL01O5D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01O5D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
