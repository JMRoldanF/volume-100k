      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00MXZ'.
      ...
      * Called module names
       01  MOD-ZCL01Q3Z              PIC X(8) VALUE 'ZCL01Q3Z'.
       01  MOD-ZRE01JED              PIC X(8) VALUE 'ZRE01JED'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01Q3Z-001.
               PERFORM CALL-ZRE01JED-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01Q3Z-001.
               CALL 'ZCL01Q3Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01Q3Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01JED-002.
               CALL 'ZRE01JED' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01JED FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
