      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00PJL'.
      ...
      * Called module names
       01  MOD-ZCL01LFD              PIC X(8) VALUE 'ZCL01LFD'.
       01  MOD-ZCL01HED              PIC X(8) VALUE 'ZCL01HED'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01LFD-001.
               PERFORM CALL-ZCL01HED-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01LFD-001.
               CALL 'ZCL01LFD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01LFD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01HED-002.
               CALL 'ZCL01HED' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01HED FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-TERM-0001.
