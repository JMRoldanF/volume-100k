      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00RQ7'.
      ...
      * Called module names
       01  MOD-ZAG01JGM              PIC X(8) VALUE 'ZAG01JGM'.
       01  MOD-ZCL01MCP              PIC X(8) VALUE 'ZCL01MCP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01JGM-001.
               PERFORM CALL-ZCL01MCP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01JGM-001.
               CALL 'ZAG01JGM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01JGM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01MCP-002.
               CALL 'ZCL01MCP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01MCP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
