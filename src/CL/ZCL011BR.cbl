      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL011BR'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01IIN              PIC X(8) VALUE 'ZCL01IIN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01LJT-001.
               PERFORM CALL-ZCL01IIN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01IIN-002.
               CALL 'ZCL01IIN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
