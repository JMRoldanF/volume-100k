      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00PMV'.
      ...
      * Called module names
       01  MOD-ZCL01T5P              PIC X(8) VALUE 'ZCL01T5P'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01T5P-001.
               CALL 'ZCL01T5P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01T5P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
