      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00NCZ'.
      ...
      * Called module names
       01  MOD-ZCL01RTX              PIC X(8) VALUE 'ZCL01RTX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01RTX-001.
               CALL 'ZCL01RTX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01RTX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
