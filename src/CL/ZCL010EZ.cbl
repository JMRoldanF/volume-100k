      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL010EZ'.
      ...
      * Called module names
       01  MOD-ZCL01MRF              PIC X(8) VALUE 'ZCL01MRF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01MRF-001.
               CALL 'ZCL01MRF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01MRF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
