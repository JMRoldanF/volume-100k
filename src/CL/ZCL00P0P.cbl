      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00P0P'.
      ...
      * Called module names
       01  MOD-ZCL01DJH              PIC X(8) VALUE 'ZCL01DJH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01DJH-001.
               CALL 'ZCL01DJH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01DJH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
