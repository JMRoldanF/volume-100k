      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00SDJ'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01JNH              PIC X(8) VALUE 'ZCL01JNH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01JNH-002.
               CALL 'ZCL01JNH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01JNH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
