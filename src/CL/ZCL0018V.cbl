      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL0018V'.
      ...
      * Called module names
       01  MOD-ZCL00FUP              PIC X(8) VALUE 'ZCL00FUP'.
       01  MOD-ZCL00IAR              PIC X(8) VALUE 'ZCL00IAR'.
       01  MOD-ZAG0056M              PIC X(8) VALUE 'ZAG0056M'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL00FUP-001.
               PERFORM CALL-ZCL00IAR-002.
               PERFORM CALL-ZAG00API-003.
               PERFORM CALL-ZAG0056M-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL00FUP-001.
               EXEC CICS LINK PROGRAM('ZCL00FUP')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL00FUP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL00IAR-002.
               EXEC CICS LINK PROGRAM('ZCL00IAR')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL00IAR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG00API-003.
               MOVE 'ZAG00API' TO WS-PROGNAME-6
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG00API FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0056M-004.
               EXEC CICS XCTL PROGRAM('ZAG0056M')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG0056M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-005.
