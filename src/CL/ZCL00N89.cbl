      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00N89'.
      ...
      * Called module names
       01  MOD-ZCL01SBP              PIC X(8) VALUE 'ZCL01SBP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01SBP-001.
               CALL 'ZCL01SBP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01SBP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
