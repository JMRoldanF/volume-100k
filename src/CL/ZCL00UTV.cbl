      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00UTV'.
      ...
      * Called module names
       01  MOD-ZCL01O69              PIC X(8) VALUE 'ZCL01O69'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01O69-001.
               CALL 'ZCL01O69' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01O69 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
