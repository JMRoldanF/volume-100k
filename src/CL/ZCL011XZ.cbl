      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL011XZ'.
      ...
      * Called module names
       01  MOD-ZAG01N2C              PIC X(8) VALUE 'ZAG01N2C'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01N2C-001.
               CALL 'ZAG01N2C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01N2C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
