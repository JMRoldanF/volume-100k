      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00SLL'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01OUP              PIC X(8) VALUE 'ZCL01OUP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01OUP-002.
               CALL 'ZCL01OUP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01OUP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-EXCESS-0001.
