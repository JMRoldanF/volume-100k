      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00U2X'.
      ...
      * Called module names
       01  MOD-ZCL01HJ3              PIC X(8) VALUE 'ZCL01HJ3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01HJ3-001.
               PERFORM CALL-ZCL01DX3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01HJ3-001.
               CALL 'ZCL01HJ3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01HJ3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01DX3-002.
