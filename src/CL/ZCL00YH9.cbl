      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00YH9'.
      ...
      * Called module names
       01  MOD-ZCL01G9J              PIC X(8) VALUE 'ZCL01G9J'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01G9J-001.
               CALL 'ZCL01G9J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01G9J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
