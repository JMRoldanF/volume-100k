      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00Z3R'.
      ...
      * Called module names
       01  MOD-ZCL01FMH              PIC X(8) VALUE 'ZCL01FMH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01FMH-001.
               CALL 'ZCL01FMH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01FMH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
