      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL000FQ'.
      ...
      * Called module names
       01  MOD-ZPN006M7              PIC X(8) VALUE 'ZPN006M7'.
       01  MOD-ZCL00J2K              PIC X(8) VALUE 'ZCL00J2K'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPN006M7-001.
               PERFORM CALL-ZCL00J2K-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN006M7-001.
               EXEC CICS LINK PROGRAM('ZPN006M7')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN006M7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL00J2K-002.
               EXEC CICS LINK PROGRAM('ZCL00J2K')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL00J2K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
