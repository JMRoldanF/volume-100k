      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL011RB'.
      ...
      * Called module names
       01  MOD-ZCL01PFJ              PIC X(8) VALUE 'ZCL01PFJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01PFJ-001.
               CALL 'ZCL01PFJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01PFJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-TAX-BAND-0001.
