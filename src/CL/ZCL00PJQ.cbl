      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00PJQ'.
      ...
      * Called module names
       01  MOD-ZCL01H33              PIC X(8) VALUE 'ZCL01H33'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01H33-001.
               CALL 'ZCL01H33' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01H33 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-BEDROOMS-0001.
