      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00XHV'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01KY2              PIC X(8) VALUE 'ZCL01KY2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01LTW-001.
               PERFORM CALL-ZCL01KY2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01KY2-002.
               CALL 'ZCL01KY2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
