      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00VT5'.
      ...
      * Called module names
       01  MOD-ZEN01G65              PIC X(8) VALUE 'ZEN01G65'.
       01  MOD-ZCL01NCJ              PIC X(8) VALUE 'ZCL01NCJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01G65-001.
               PERFORM CALL-ZCL01NCJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01G65-001.
               CALL 'ZEN01G65' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01G65 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01NCJ-002.
               CALL 'ZCL01NCJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01NCJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-TERM-0001.
