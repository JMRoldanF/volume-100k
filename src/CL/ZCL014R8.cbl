      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL014R8'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01ULP              PIC X(8) VALUE 'ZCL01ULP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01M2P-001.
               PERFORM CALL-ZCL01ULP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01ULP-002.
               CALL 'ZCL01ULP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01ULP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
