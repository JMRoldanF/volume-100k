      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00O2J'.
      ...
      * Called module names
       01  MOD-ZCL01JJL              PIC X(8) VALUE 'ZCL01JJL'.
       01  MOD-ZCL01M2F              PIC X(8) VALUE 'ZCL01M2F'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01JJL-001.
               PERFORM CALL-ZCL01M2F-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01JJL-001.
               CALL 'ZCL01JJL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01JJL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01M2F-002.
               CALL 'ZCL01M2F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
