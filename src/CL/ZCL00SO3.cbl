      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00SO3'.
      ...
      * Called module names
       01  MOD-ZCL01H4D              PIC X(8) VALUE 'ZCL01H4D'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01H4D-001.
               PERFORM CALL-ZCL01JT1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01H4D-001.
               CALL 'ZCL01H4D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01H4D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01JT1-002.
