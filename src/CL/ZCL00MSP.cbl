      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00MSP'.
      ...
      * Called module names
       01  MOD-ZCL01HS9              PIC X(8) VALUE 'ZCL01HS9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01HS9-001.
               CALL 'ZCL01HS9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01HS9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
