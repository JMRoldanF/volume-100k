      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL011FN'.
      ...
      * Called module names
       01  MOD-ZCL01P8B              PIC X(8) VALUE 'ZCL01P8B'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01P8B-001.
               CALL 'ZCL01P8B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01P8B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-MAKE-0001.
