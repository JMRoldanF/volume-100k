      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00XQB'.
      ...
      * Called module names
       01  MOD-ZCL01H6V              PIC X(8) VALUE 'ZCL01H6V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01H6V-001.
               CALL 'ZCL01H6V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
