      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00RTT'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01EO1              PIC X(8) VALUE 'ZCL01EO1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01EO1-002.
               CALL 'ZCL01EO1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01EO1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
