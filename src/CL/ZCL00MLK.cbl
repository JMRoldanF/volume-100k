      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00MLK'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01FKQ              PIC X(8) VALUE 'ZCL01FKQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01KW6-001.
               PERFORM CALL-ZCL01FKQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01FKQ-002.
               CALL 'ZCL01FKQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01FKQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-EXCESS-0001.
