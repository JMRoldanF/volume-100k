      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL012KH'.
      ...
      * Called module names
       01  MOD-ZCL01N51              PIC X(8) VALUE 'ZCL01N51'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01N51-001.
               CALL 'ZCL01N51' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01N51 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
