      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00SCF'.
      ...
      * Called module names
       01  MOD-ZCL01OYV              PIC X(8) VALUE 'ZCL01OYV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01OYV-001.
               CALL 'ZCL01OYV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01OYV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
