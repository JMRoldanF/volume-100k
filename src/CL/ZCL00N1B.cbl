      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00N1B'.
      ...
      * Called module names
       01  MOD-ZCL01E9B              PIC X(8) VALUE 'ZCL01E9B'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01E9B-001.
               PERFORM CALL-ZEN01IB3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01E9B-001.
               CALL 'ZCL01E9B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01E9B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01IB3-002.
