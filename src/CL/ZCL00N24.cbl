      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00N24'.
      ...
      * Called module names
       01  MOD-ZCL01J5Y              PIC X(8) VALUE 'ZCL01J5Y'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01J5Y-001.
               PERFORM CALL-ZCL01G92-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01J5Y-001.
               CALL 'ZCL01J5Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01J5Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01G92-002.
