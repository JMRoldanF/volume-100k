      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00ZEL'.
      ...
      * Called module names
       01  MOD-ZCL01RVB              PIC X(8) VALUE 'ZCL01RVB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01RVB-001.
               CALL 'ZCL01RVB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01RVB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01RK7-002.
               MOVE 'ZCL01RK7' TO WS-SUBNAME-8
