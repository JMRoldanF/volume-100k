      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL011KN'.
      ...
      * Called module names
       01  MOD-ZCL01GOT              PIC X(8) VALUE 'ZCL01GOT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01GOT-001.
               PERFORM CALL-ZCL01QGR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01GOT-001.
               CALL 'ZCL01GOT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01GOT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01QGR-002.
