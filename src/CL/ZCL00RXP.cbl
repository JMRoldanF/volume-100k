      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00RXP'.
      ...
      * Called module names
       01  MOD-ZCL01GRL              PIC X(8) VALUE 'ZCL01GRL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01GRL-001.
               CALL 'ZCL01GRL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01GRL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
