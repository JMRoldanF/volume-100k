      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00VRM'.
      ...
      * Called module names
       01  MOD-ZCL01NOQ              PIC X(8) VALUE 'ZCL01NOQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01NOQ-001.
               PERFORM CALL-ZCL01NNP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01NOQ-001.
               CALL 'ZCL01NOQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01NOQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01NNP-002.
