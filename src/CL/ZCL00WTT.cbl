      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00WTT'.
      ...
      * Called module names
       01  MOD-ZCL01NV5              PIC X(8) VALUE 'ZCL01NV5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01NV5-001.
               CALL 'ZCL01NV5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01NV5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
