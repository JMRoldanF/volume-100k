      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00ZFZ'.
      ...
      * Called module names
       01  MOD-ZCL01JD7              PIC X(8) VALUE 'ZCL01JD7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01JD7-001.
               CALL 'ZCL01JD7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01JD7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01GE9-002.
