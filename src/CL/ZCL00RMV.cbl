      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00RMV'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01POP              PIC X(8) VALUE 'ZCL01POP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01POP-002.
               CALL 'ZCL01POP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01POP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
