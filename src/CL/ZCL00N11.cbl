      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00N11'.
      ...
      * Called module names
       01  MOD-ZCL01UIV              PIC X(8) VALUE 'ZCL01UIV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01UIV-001.
               PERFORM CALL-ZCL01ULD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01UIV-001.
               CALL 'ZCL01UIV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01UIV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01ULD-002.
