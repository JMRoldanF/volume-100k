      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00RZN'.
      ...
      * Called module names
       01  MOD-ZCL01K3L              PIC X(8) VALUE 'ZCL01K3L'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01K3L-001.
               PERFORM CALL-ZCL01MMP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01K3L-001.
               CALL 'ZCL01K3L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01K3L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01MMP-002.
