      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00NEX'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01CTD              PIC X(8) VALUE 'ZCL01CTD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01CTD-002.
               CALL 'ZCL01CTD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01CTD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
