      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00PZZ'.
      ...
      * Called module names
       01  MOD-ZCL01OT1              PIC X(8) VALUE 'ZCL01OT1'.
       01  MOD-ZCL01RR5              PIC X(8) VALUE 'ZCL01RR5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01OT1-001.
               CALL 'ZCL01OT1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01OT1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01RR5-002.
               CALL 'ZCL01RR5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01RR5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-MODEL-0001.
