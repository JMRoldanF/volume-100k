      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL005K5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL00DXT-001.
               PERFORM CALL-ZCL00GGX-002.
               PERFORM CALL-ZEN00HG5-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL00DXT-001.
               MOVE 'ZCL00DXT' TO WS-PROGNAME-5
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL00DXT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL00GGX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN00HG5-003.
               MOVE 'ZEN00HG5' TO WS-PROGNAME-6
