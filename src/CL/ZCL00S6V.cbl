      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00S6V'.
      ...
      * Called module names
       01  MOD-ZCL01T4B              PIC X(8) VALUE 'ZCL01T4B'.
       01  MOD-ZCL01UF9              PIC X(8) VALUE 'ZCL01UF9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01T4B-001.
               PERFORM CALL-ZCL01UF9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01T4B-001.
               CALL 'ZCL01T4B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01T4B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01UF9-002.
               CALL 'ZCL01UF9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01UF9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
