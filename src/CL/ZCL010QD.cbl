      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL010QD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01RYX-001.
               PERFORM CALL-ZCL01IGP-002.
               PERFORM CALL-ZCU0255O-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCL01RYX-001.
               MOVE 'ZCL01RYX' TO WS-SUBNAME-7
