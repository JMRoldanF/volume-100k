      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00MBI'.
      ...
      * Called module names
       01  MOD-ZCL01EC3              PIC X(8) VALUE 'ZCL01EC3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01EC3-001.
               PERFORM CALL-ZCL01R4D-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01EC3-001.
               CALL 'ZCL01EC3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01EC3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01R4D-002.
               MOVE 'ZCL01R4D' TO WS-SUBNAME-3
