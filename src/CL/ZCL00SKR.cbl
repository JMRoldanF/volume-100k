      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00SKR'.
      ...
      * Called module names
       01  MOD-ZCL01ISX              PIC X(8) VALUE 'ZCL01ISX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01ISX-001.
               CALL 'ZCL01ISX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01ISX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-COLOUR-0001.
