      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL010O5'.
      ...
      * Called module names
       01  MOD-ZEN01PQB              PIC X(8) VALUE 'ZEN01PQB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01PQB-001.
               CALL 'ZEN01PQB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01PQB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01UL3-002.
               MOVE 'ZCL01UL3' TO WS-SUBNAME-4
