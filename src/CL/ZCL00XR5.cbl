      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00XR5'.
      ...
      * Called module names
       01  MOD-ZCL01KXB              PIC X(8) VALUE 'ZCL01KXB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01KXB-001.
               CALL 'ZCL01KXB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01KXB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
