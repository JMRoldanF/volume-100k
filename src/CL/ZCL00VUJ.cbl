      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00VUJ'.
      ...
      * Called module names
       01  MOD-ZCL01D9H              PIC X(8) VALUE 'ZCL01D9H'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01D9H-001.
               CALL 'ZCL01D9H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01D9H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01CXT-002.
