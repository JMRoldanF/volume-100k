      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00OLF'.
      ...
      * Called module names
       01  MOD-ZCL01G7L              PIC X(8) VALUE 'ZCL01G7L'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01G7L-001.
               CALL 'ZCL01G7L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01G7L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
