      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00RH1'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01R57              PIC X(8) VALUE 'ZCL01R57'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01T9B-001.
               PERFORM CALL-ZCL01R57-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01R57-002.
               CALL 'ZCL01R57' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01R57 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
