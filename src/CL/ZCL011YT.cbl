      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL011YT'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01SZ1              PIC X(8) VALUE 'ZCL01SZ1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01SZ1-002.
               CALL 'ZCL01SZ1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
