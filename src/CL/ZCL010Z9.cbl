      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL010Z9'.
      ...
      * Called module names
       01  MOD-ZCL01CSJ              PIC X(8) VALUE 'ZCL01CSJ'.
       01  MOD-ZCL01UWR              PIC X(8) VALUE 'ZCL01UWR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01CSJ-001.
               CALL 'ZCL01CSJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01CSJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01UWR-002.
               CALL 'ZCL01UWR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01UWR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
