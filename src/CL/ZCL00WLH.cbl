      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00WLH'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01JAZ              PIC X(8) VALUE 'ZCL01JAZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01JAZ-002.
               CALL 'ZCL01JAZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01JAZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
