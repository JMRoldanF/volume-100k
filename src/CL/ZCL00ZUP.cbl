      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00ZUP'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01H0R              PIC X(8) VALUE 'ZCL01H0R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01H0R-002.
               CALL 'ZCL01H0R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01H0R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
