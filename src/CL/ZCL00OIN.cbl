      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00OIN'.
      ...
      * Called module names
       01  MOD-ZUW01L9Y              PIC X(8) VALUE 'ZUW01L9Y'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01L9Y-001.
               CALL 'ZUW01L9Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01L9Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
