      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00R35'.
      ...
      * Called module names
       01  MOD-ZCL01HDJ              PIC X(8) VALUE 'ZCL01HDJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01HDJ-001.
               PERFORM CALL-ZCL01RNT-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01HDJ-001.
               CALL 'ZCL01HDJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
