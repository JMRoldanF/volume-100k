      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00U98'.
      ...
      * Called module names
       01  MOD-ZCL01EN8              PIC X(8) VALUE 'ZCL01EN8'.
       01  MOD-ZCL01HMT              PIC X(8) VALUE 'ZCL01HMT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01EN8-001.
               CALL 'ZCL01EN8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01EN8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01HMT-002.
               CALL 'ZCL01HMT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01HMT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
