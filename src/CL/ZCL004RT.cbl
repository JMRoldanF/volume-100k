      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL004RT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL00GY5-001.
               PERFORM CALL-ZCL00EDX-002.
               PERFORM CALL-ZMT0024Z-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL00GY5-001.
               MOVE 'ZCL00GY5' TO WS-PROGNAME-2
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL00GY5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL00EDX-002.
               MOVE 'ZCL00EDX' TO WS-PROGNAME-3
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL00EDX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0024Z-003.
