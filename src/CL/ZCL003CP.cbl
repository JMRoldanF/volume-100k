      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL003CP'.
      ...
      * Called module names
       01  MOD-ZMT00I9J              PIC X(8) VALUE 'ZMT00I9J'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT00I9J-001.
               PERFORM CALL-ZCL009ER-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00I9J-001.
               EXEC CICS LINK PROGRAM('ZMT00I9J')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00I9J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL009ER-002.
