      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00ZPL'.
      ...
      * Called module names
       01  MOD-ZCL01J7I              PIC X(8) VALUE 'ZCL01J7I'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01J7I-001.
               CALL 'ZCL01J7I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01J7I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
