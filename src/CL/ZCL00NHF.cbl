      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00NHF'.
      ...
      * Called module names
       01  MOD-ZMT01HT9              PIC X(8) VALUE 'ZMT01HT9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01HT9-001.
               CALL 'ZMT01HT9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01HT9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
