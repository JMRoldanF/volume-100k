      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL01045'.
      ...
      * Called module names
       01  MOD-ZCL01LH1              PIC X(8) VALUE 'ZCL01LH1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01LH1-001.
               CALL 'ZCL01LH1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01LH1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
