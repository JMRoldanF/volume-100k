      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL013E7'.
      ...
      * Called module names
       01  MOD-ZCL01SUL              PIC X(8) VALUE 'ZCL01SUL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01SUL-001.
               CALL 'ZCL01SUL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01SUL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
