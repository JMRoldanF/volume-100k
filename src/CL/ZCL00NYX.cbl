      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00NYX'.
      ...
      * Called module names
       01  MOD-ZCL01CVL              PIC X(8) VALUE 'ZCL01CVL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01CVL-001.
               CALL 'ZCL01CVL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01CVL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01TQ9-002.
