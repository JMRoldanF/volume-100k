      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00WPN'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01I0B              PIC X(8) VALUE 'ZCL01I0B'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01I0B-002.
               CALL 'ZCL01I0B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01I0B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-MAKE-0001.
