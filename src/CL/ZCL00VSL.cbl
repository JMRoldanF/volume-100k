      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00VSL'.
      ...
      * Called module names
       01  MOD-ZMT01D3J              PIC X(8) VALUE 'ZMT01D3J'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01D3J-001.
               CALL 'ZMT01D3J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01D3J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
