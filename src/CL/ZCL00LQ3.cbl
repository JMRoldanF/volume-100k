      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00LQ3'.
      ...
      * Called module names
       01  MOD-ZCL01FN1              PIC X(8) VALUE 'ZCL01FN1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01FN1-002.
               CALL 'ZCL01FN1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01FN1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
