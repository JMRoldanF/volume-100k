      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL01CFR'.
      ...
      * Called module names
       01  MOD-ZCU01KTY              PIC X(8) VALUE 'ZCU01KTY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01KTY-001.
               CALL 'ZCU01KTY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01KTY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
