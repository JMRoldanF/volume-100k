      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL016IF'.
      ...
      * Called module names
       01  MOD-ZCL01J4B              PIC X(8) VALUE 'ZCL01J4B'.
       01  MOD-ZCL01SVP              PIC X(8) VALUE 'ZCL01SVP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01J4B-001.
               PERFORM CALL-ZCL01SVP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01J4B-001.
               CALL 'ZCL01J4B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01J4B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01SVP-002.
               CALL 'ZCL01SVP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01SVP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
