      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00T2I'.
      ...
      * Called module names
       ...
       01  MOD-ZAU01H0B              PIC X(8) VALUE 'ZAU01H0B'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01T43-001.
               PERFORM CALL-ZAU01H0B-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAU01H0B-002.
               CALL 'ZAU01H0B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAU01H0B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
