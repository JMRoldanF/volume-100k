      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL004ZV'.
      ...
      * Called module names
       01  MOD-ZCL00I4N              PIC X(8) VALUE 'ZCL00I4N'.
       01  MOD-ZCL00J9R              PIC X(8) VALUE 'ZCL00J9R'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL00I4N-001.
               PERFORM CALL-ZCL00J9R-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL00I4N-001.
               EXEC CICS LINK PROGRAM('ZCL00I4N')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL00I4N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL00J9R-002.
               EXEC CICS LINK PROGRAM('ZCL00J9R')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL00J9R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
