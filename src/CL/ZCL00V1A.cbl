      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00V1A'.
      ...
      * Called module names
       01  MOD-ZCL01G9E              PIC X(8) VALUE 'ZCL01G9E'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01G9E-001.
               CALL 'ZCL01G9E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01G9E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
