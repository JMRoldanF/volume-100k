      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00XM5'.
      ...
      * Called module names
       01  MOD-ZEN01SI1              PIC X(8) VALUE 'ZEN01SI1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01SI1-001.
               CALL 'ZEN01SI1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01SI1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
