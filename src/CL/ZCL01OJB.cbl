      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL01OJB'.
      ...
      * Called module names
       01  MOD-ZPA01I0Z              PIC X(8) VALUE 'ZPA01I0Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01I0Z-001.
               CALL 'ZPA01I0Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01I0Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
