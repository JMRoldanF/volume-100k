      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00ZF5'.
      ...
      * Called module names
       01  MOD-ZCL01DYH              PIC X(8) VALUE 'ZCL01DYH'.
       01  MOD-ZCL01TI7              PIC X(8) VALUE 'ZCL01TI7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01DYH-001.
               PERFORM CALL-ZCL01TI7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01DYH-001.
               CALL 'ZCL01DYH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01DYH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01TI7-002.
               CALL 'ZCL01TI7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01TI7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
