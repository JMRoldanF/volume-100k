      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00O1F'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01NTR              PIC X(8) VALUE 'ZCL01NTR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01NTR-002.
               CALL 'ZCL01NTR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01NTR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
