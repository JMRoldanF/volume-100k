      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00CNP'.
      ...
      * Called module names
       01  MOD-ZAG00SUA              PIC X(8) VALUE 'ZAG00SUA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG00SUA-001.
               PERFORM CALL-ZCL00PDH-002.
               PERFORM CALL-ZCL01P9P-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG00SUA-001.
               EXEC CICS LINK PROGRAM('ZAG00SUA')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG00SUA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL00PDH-002.
