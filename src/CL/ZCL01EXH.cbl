      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL01EXH'.
      ...
      * Called module names
       01  MOD-ZCL01MM5              PIC X(8) VALUE 'ZCL01MM5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01MM5-001.
               CALL 'ZCL01MM5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01MM5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
