      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL01C7P'.
      ...
      * Called module names
       01  MOD-ZEN01PJD              PIC X(8) VALUE 'ZEN01PJD'.
       01  MOD-ZMT01I4X              PIC X(8) VALUE 'ZMT01I4X'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01PJD-001.
               CALL 'ZEN01PJD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01PJD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01I4X-002.
               CALL 'ZMT01I4X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
      ...
      *----------------------------------------------------------------*
       FILE-ACCESS-0003.
               EXEC CICS DELETE FILE('KSDSCL20')
                         RIDFLD(WS-KEY-AREA)
                         RESP(WS-RESP)
               END-EXEC.
               EVALUATE WS-RESP
