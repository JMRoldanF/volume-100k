      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00BS1'.
      ...
      * Called module names
       01  MOD-ZCL00WPX              PIC X(8) VALUE 'ZCL00WPX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL00WPX-001.
               EXEC CICS LINK PROGRAM('ZCL00WPX')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL00WPX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
