      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00VSK'.
      ...
      * Called module names
       01  MOD-ZAU01HR5              PIC X(8) VALUE 'ZAU01HR5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAU01HR5-001.
               PERFORM CALL-ZCL01EC3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAU01HR5-001.
               CALL 'ZAU01HR5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAU01HR5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01EC3-002.
               MOVE 'ZCL01EC3' TO WS-SUBNAME-6
