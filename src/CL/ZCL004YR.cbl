      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL004YR'.
      ...
      * Called module names
       01  MOD-ZMT00EED              PIC X(8) VALUE 'ZMT00EED'.
       01  MOD-ZCL00DMP              PIC X(8) VALUE 'ZCL00DMP'.
       01  MOD-ZPA008S3              PIC X(8) VALUE 'ZPA008S3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT00EED-001.
               PERFORM CALL-ZCL00DMP-002.
               PERFORM CALL-ZPA008S3-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT00EED-001.
               EXEC CICS LINK PROGRAM('ZMT00EED')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT00EED FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL00DMP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA008S3-003.
               EXEC CICS LINK PROGRAM('ZPA008S3')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA008S3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-004.
