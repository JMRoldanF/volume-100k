      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00M1K'.
      ...
      * Called module names
       01  MOD-ZCL01EO6              PIC X(8) VALUE 'ZCL01EO6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01EO6-001.
               CALL 'ZCL01EO6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01EO6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-TERM-0001.
