      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00ZKP'.
      ...
      * Called module names
       01  MOD-ZCL01NW9              PIC X(8) VALUE 'ZCL01NW9'.
       01  MOD-ZCL01NDD              PIC X(8) VALUE 'ZCL01NDD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01NW9-001.
               CALL 'ZCL01NW9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01NW9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01NDD-002.
               CALL 'ZCL01NDD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01NDD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
