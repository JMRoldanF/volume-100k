      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00X1V'.
      ...
      * Called module names
       01  MOD-ZCL01LHL              PIC X(8) VALUE 'ZCL01LHL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01LHL-001.
               PERFORM CALL-ZMT01ROJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01LHL-001.
               CALL 'ZCL01LHL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
