      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00MJT'.
      ...
      * Called module names
       01  MOD-ZCL01Q5D              PIC X(8) VALUE 'ZCL01Q5D'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01Q5D-001.
               CALL 'ZCL01Q5D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01Q5D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01HO3-002.
