      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00YDX'.
      ...
      * Called module names
       01  MOD-ZCL01H89              PIC X(8) VALUE 'ZCL01H89'.
       01  MOD-ZCL01DFV              PIC X(8) VALUE 'ZCL01DFV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01H89-001.
               PERFORM CALL-ZCL01DFV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01H89-001.
               CALL 'ZCL01H89' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01H89 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01DFV-002.
               CALL 'ZCL01DFV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01DFV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
