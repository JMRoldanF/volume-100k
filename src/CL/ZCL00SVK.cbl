      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00SVK'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01H5Y              PIC X(8) VALUE 'ZCL01H5Y'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01H5Y-002.
               CALL 'ZCL01H5Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
