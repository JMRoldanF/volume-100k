      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00ORM'.
      ...
      * Called module names
       01  MOD-ZPN01N2Z              PIC X(8) VALUE 'ZPN01N2Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01N2Z-001.
               CALL 'ZPN01N2Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01N2Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-EQUITIES-0001.
