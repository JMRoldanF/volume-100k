      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00LRR'.
      ...
      * Called module names
       01  MOD-ZCL01RMZ              PIC X(8) VALUE 'ZCL01RMZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01RMZ-001.
               CALL 'ZCL01RMZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01RMZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01IB5-002.
