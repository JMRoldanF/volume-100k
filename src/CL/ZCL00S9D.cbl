      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00S9D'.
      ...
      * Called module names
       01  MOD-ZCL01JWD              PIC X(8) VALUE 'ZCL01JWD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01JWD-001.
               CALL 'ZCL01JWD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01JWD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01Q7V-002.
