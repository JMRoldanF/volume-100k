      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00P4B'.
      ...
      * Called module names
       01  MOD-ZCL01RJ3              PIC X(8) VALUE 'ZCL01RJ3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01RJ3-001.
               CALL 'ZCL01RJ3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01RJ3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01MSJ-002.
               MOVE 'ZCL01MSJ' TO WS-SUBNAME-3
