      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00SLB'.
      ...
      * Called module names
       01  MOD-ZCL01I65              PIC X(8) VALUE 'ZCL01I65'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM RESOLVE-NCD-YEARS-0065.
               ...
               PERFORM COMPUTE-TERM-0101.
               PERFORM SQL-ACCESS-0102.
               PERFORM DERIVE-BEDROOMS-0103.
               PERFORM SQL-ACCESS-0105.
               PERFORM REFRESH-STATUS-CODE-0106.
               PERFORM EXPAND-COLOUR-0107.
               PERFORM SQL-ACCESS-0108.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCL01I65-001.
               CALL 'ZCL01I65' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01I65 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
