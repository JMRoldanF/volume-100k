      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00SM5'.
      ...
      * Called module names
       01  MOD-ZBI01TNI              PIC X(8) VALUE 'ZBI01TNI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01TNI-001.
               CALL 'ZBI01TNI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01TNI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
