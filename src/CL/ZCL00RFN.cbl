      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00RFN'.
      ...
      * Called module names
       01  MOD-ZEN01EL7              PIC X(8) VALUE 'ZEN01EL7'.
       01  MOD-ZCL01LWB              PIC X(8) VALUE 'ZCL01LWB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01EL7-001.
               PERFORM CALL-ZCL01LWB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01EL7-001.
               CALL 'ZEN01EL7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01EL7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01LWB-002.
               CALL 'ZCL01LWB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01LWB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-VALUE-0001.
