      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00YSX'.
      ...
      * Called module names
       01  MOD-ZCL01M89              PIC X(8) VALUE 'ZCL01M89'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01M89-001.
               PERFORM CALL-ZCL01H25-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01M89-001.
               CALL 'ZCL01M89' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01M89 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01H25-002.
