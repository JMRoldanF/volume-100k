      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00XN7'.
      ...
      * Called module names
       01  MOD-ZCL01TJB              PIC X(8) VALUE 'ZCL01TJB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01TJB-001.
               CALL 'ZCL01TJB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01TJB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
