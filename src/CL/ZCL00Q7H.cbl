      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00Q7H'.
      ...
      * Called module names
       01  MOD-ZCL01JZ5              PIC X(8) VALUE 'ZCL01JZ5'.
       01  MOD-ZCL01MTN              PIC X(8) VALUE 'ZCL01MTN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01JZ5-001.
               PERFORM CALL-ZCL01MTN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01JZ5-001.
               CALL 'ZCL01JZ5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01JZ5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01MTN-002.
               CALL 'ZCL01MTN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01MTN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
