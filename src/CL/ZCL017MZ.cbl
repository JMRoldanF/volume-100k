      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL017MZ'.
      ...
      * Called module names
       01  MOD-ZCL01ILF              PIC X(8) VALUE 'ZCL01ILF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01ILF-001.
               CALL 'ZCL01ILF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01ILF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
