      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL012E2'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01ECS              PIC X(8) VALUE 'ZCL01ECS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01ECS-002.
               CALL 'ZCL01ECS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01ECS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
