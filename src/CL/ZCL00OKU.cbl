      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00OKU'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01RAQ              PIC X(8) VALUE 'ZCL01RAQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01FZW-001.
               PERFORM CALL-ZCL01RAQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01RAQ-002.
               CALL 'ZCL01RAQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01RAQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
