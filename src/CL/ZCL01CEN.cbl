      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL01CEN'.
      ...
      * Called module names
       01  MOD-ZCL01F9P              PIC X(8) VALUE 'ZCL01F9P'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01F9P-001.
               CALL 'ZCL01F9P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01F9P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
