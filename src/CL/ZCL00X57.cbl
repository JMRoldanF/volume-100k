      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00X57'.
      ...
      * Called module names
       01  MOD-ZCL01TQT              PIC X(8) VALUE 'ZCL01TQT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01TQT-001.
               CALL 'ZCL01TQT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01TQT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-MAKE-0001.
