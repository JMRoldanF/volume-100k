      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00Z1J'.
      ...
      * Called module names
       01  MOD-ZCL01D8N              PIC X(8) VALUE 'ZCL01D8N'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01D8N-001.
               CALL 'ZCL01D8N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01D8N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
