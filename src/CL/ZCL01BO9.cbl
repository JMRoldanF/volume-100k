      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL01BO9'.
      ...
      * Called module names
       01  MOD-ZCL01LZ3              PIC X(8) VALUE 'ZCL01LZ3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01LZ3-001.
               CALL 'ZCL01LZ3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01LZ3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
