      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00OF7'.
      ...
      * Called module names
       01  MOD-ZCL01N9C              PIC X(8) VALUE 'ZCL01N9C'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01P2A-001.
               PERFORM CALL-ZCL01N9C-002.
               PERFORM CALL-ZRE0255R-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCL01P2A-001.
               MOVE 'ZCL01P2A' TO WS-SUBNAME-2
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01N9C-002.
               CALL 'ZCL01N9C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01N9C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
