      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00XWP'.
      ...
      * Called module names
       01  MOD-ZEN01LFV              PIC X(8) VALUE 'ZEN01LFV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01LFV-001.
               CALL 'ZEN01LFV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01LFV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01TU6-002.
