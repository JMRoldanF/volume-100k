      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00SQV'.
      ...
      * Called module names
       01  MOD-ZUW01FVI              PIC X(8) VALUE 'ZUW01FVI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01FVI-001.
               CALL 'ZUW01FVI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01FVI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01G8Z-002.
