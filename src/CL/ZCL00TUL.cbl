      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00TUL'.
      ...
      * Called module names
       01  MOD-ZCL01FS1              PIC X(8) VALUE 'ZCL01FS1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM NORMALISE-REG-NUMBER-0089.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01FS1-001.
               CALL 'ZCL01FS1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01FS1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-TERM-0001.
