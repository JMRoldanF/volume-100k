      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00NG8'.
      ...
      * Called module names
       01  MOD-ZPN01SOV              PIC X(8) VALUE 'ZPN01SOV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01SOV-001.
               CALL 'ZPN01SOV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01SOV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
