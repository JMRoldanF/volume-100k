      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL0120P'.
      ...
      * Called module names
       01  MOD-ZCN01KLY              PIC X(8) VALUE 'ZCN01KLY'.
       01  MOD-ZTX01PF3              PIC X(8) VALUE 'ZTX01PF3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCN01KLY-001.
               PERFORM CALL-ZTX01PF3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCN01KLY-001.
               CALL 'ZCN01KLY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCN01KLY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTX01PF3-002.
               CALL 'ZTX01PF3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
