      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00ZOV'.
      ...
      * Called module names
       01  MOD-ZRE01S21              PIC X(8) VALUE 'ZRE01S21'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01S21-001.
               CALL 'ZRE01S21' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01S21 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-MODEL-0001.
