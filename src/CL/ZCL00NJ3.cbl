      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00NJ3'.
      ...
      * Called module names
       01  MOD-ZCL01NSX              PIC X(8) VALUE 'ZCL01NSX'.
       01  MOD-ZCL01O7D              PIC X(8) VALUE 'ZCL01O7D'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01NSX-001.
               PERFORM CALL-ZCL01O7D-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01NSX-001.
               CALL 'ZCL01NSX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01NSX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01O7D-002.
               CALL 'ZCL01O7D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01O7D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
