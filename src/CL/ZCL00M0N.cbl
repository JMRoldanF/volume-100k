      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00M0N'.
      ...
      * Called module names
       01  MOD-ZCL01O2X              PIC X(8) VALUE 'ZCL01O2X'.
       01  MOD-ZCL01Q1R              PIC X(8) VALUE 'ZCL01Q1R'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01O2X-001.
               PERFORM CALL-ZCL01Q1R-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01O2X-001.
               CALL 'ZCL01O2X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01Q1R-002.
               CALL 'ZCL01Q1R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01Q1R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
