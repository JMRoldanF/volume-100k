      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00SOD'.
      ...
      * Called module names
       01  MOD-ZCL01M9X              PIC X(8) VALUE 'ZCL01M9X'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01M9X-001.
               CALL 'ZCL01M9X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01M9X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
