      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00UA4'.
      ...
      * Called module names
       01  MOD-ZTX01GAY              PIC X(8) VALUE 'ZTX01GAY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01GAY-001.
               CALL 'ZTX01GAY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01GAY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
