      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00OPB'.
      ...
      * Called module names
       01  MOD-ZCL01FLN              PIC X(8) VALUE 'ZCL01FLN'.
       01  MOD-ZEN01KZR              PIC X(8) VALUE 'ZEN01KZR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01FLN-001.
               CALL 'ZCL01FLN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01FLN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01KZR-002.
               CALL 'ZEN01KZR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01KZR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-PREMIUM-0001.
