      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL014C6'.
      ...
      * Called module names
       01  MOD-ZCL01N5W              PIC X(8) VALUE 'ZCL01N5W'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01N5W-001.
               CALL 'ZCL01N5W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01N5W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
