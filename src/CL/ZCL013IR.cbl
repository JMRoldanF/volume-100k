      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL013IR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAU01T3M-001.
               PERFORM CALL-ZCL01G7R-002.
               PERFORM CALL-ZMT0255L-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZAU01T3M-001.
               MOVE 'ZAU01T3M' TO WS-SUBNAME-4
