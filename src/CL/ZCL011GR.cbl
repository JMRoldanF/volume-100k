      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL011GR'.
      ...
      * Called module names
       01  MOD-ZCL01SUB              PIC X(8) VALUE 'ZCL01SUB'.
       01  MOD-ZCL01DM9              PIC X(8) VALUE 'ZCL01DM9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01SUB-001.
               PERFORM CALL-ZCL01DM9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01SUB-001.
               CALL 'ZCL01SUB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01SUB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01DM9-002.
               CALL 'ZCL01DM9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01DM9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
