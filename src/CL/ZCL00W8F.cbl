      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00W8F'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01PVD              PIC X(8) VALUE 'ZCL01PVD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01PVD-002.
               CALL 'ZCL01PVD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01PVD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
