      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00YPB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01GE9-001.
               PERFORM CALL-ZCL01DRJ-002.
               PERFORM RECONCILE-MAKE-0001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCL01GE9-001.
               MOVE 'ZCL01GE9' TO WS-SUBNAME-6
