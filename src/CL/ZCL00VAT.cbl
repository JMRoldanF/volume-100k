      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00VAT'.
      ...
      * Called module names
       01  MOD-ZCL01D2J              PIC X(8) VALUE 'ZCL01D2J'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01D2J-001.
               CALL 'ZCL01D2J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01D2J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
