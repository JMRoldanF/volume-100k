      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00UM4'.
      ...
      * Called module names
       01  MOD-ZCL01EZD              PIC X(8) VALUE 'ZCL01EZD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAU01RH1-001.
               PERFORM CALL-ZCL01EZD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01EZD-002.
               CALL 'ZCL01EZD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
