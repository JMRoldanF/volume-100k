      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00ZPP'.
      ...
      * Called module names
       01  MOD-ZCL01IA1              PIC X(8) VALUE 'ZCL01IA1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01IA1-001.
               CALL 'ZCL01IA1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01IA1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
