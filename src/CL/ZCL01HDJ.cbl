      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL01HDJ'.
      ...
      * Called module names
       01  MOD-ZPA01TPT              PIC X(8) VALUE 'ZPA01TPT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01TPT-001.
               CALL 'ZPA01TPT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01TPT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
