      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00P41'.
      ...
      * Called module names
       01  MOD-ZCL01JR3              PIC X(8) VALUE 'ZCL01JR3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01JR3-001.
               CALL 'ZCL01JR3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01JR3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
