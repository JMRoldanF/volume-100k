      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00WKX'.
      ...
      * Called module names
       01  MOD-ZCL01TUF              PIC X(8) VALUE 'ZCL01TUF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01TUF-001.
               CALL 'ZCL01TUF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01TUF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
