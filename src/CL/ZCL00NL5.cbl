      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00NL5'.
      ...
      * Called module names
       01  MOD-ZCL01R26              PIC X(8) VALUE 'ZCL01R26'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01R26-001.
               CALL 'ZCL01R26' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01R26 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
