      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00Q3L'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01GR1              PIC X(8) VALUE 'ZCL01GR1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01GR1-002.
               CALL 'ZCL01GR1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01GR1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
