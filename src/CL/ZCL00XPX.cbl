      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00XPX'.
      ...
      * Called module names
       01  MOD-ZTX01I04              PIC X(8) VALUE 'ZTX01I04'.
       01  MOD-ZCL01UEB              PIC X(8) VALUE 'ZCL01UEB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTX01I04-001.
               PERFORM CALL-ZCL01UEB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01I04-001.
               CALL 'ZTX01I04' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01I04 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01UEB-002.
               CALL 'ZCL01UEB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01UEB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
