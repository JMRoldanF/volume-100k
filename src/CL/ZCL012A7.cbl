      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL012A7'.
      ...
      * Called module names
       01  MOD-ZHO01GQY              PIC X(8) VALUE 'ZHO01GQY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01GQY-001.
               PERFORM CALL-ZUW01F2C-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01GQY-001.
               CALL 'ZHO01GQY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01GQY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01F2C-002.
