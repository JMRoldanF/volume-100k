      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL01LKD'.
      ...
      * Called module names
       01  MOD-ZCL01FM7              PIC X(8) VALUE 'ZCL01FM7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01FM7-001.
               CALL 'ZCL01FM7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01FM7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
