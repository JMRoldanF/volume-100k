      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00MGH'.
      ...
      * Called module names
       01  MOD-ZCL01IBP              PIC X(8) VALUE 'ZCL01IBP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01IBP-001.
               PERFORM CALL-ZCL01QI5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01IBP-001.
               CALL 'ZCL01IBP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01IBP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01QI5-002.
