      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00Y5V'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01LRB              PIC X(8) VALUE 'ZCL01LRB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01MBL-001.
               PERFORM CALL-ZCL01LRB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01LRB-002.
               CALL 'ZCL01LRB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01LRB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
