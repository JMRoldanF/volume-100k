      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00LVE'.
      ...
      * Called module names
       01  MOD-ZCL01R85              PIC X(8) VALUE 'ZCL01R85'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01R85-001.
               CALL 'ZCL01R85' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01R85 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
