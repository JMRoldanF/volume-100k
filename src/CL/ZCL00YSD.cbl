      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00YSD'.
      ...
      * Called module names
       01  MOD-ZHO01TBG              PIC X(8) VALUE 'ZHO01TBG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01TBG-001.
               CALL 'ZHO01TBG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01TBG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
