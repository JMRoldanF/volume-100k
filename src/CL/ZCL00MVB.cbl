      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00MVB'.
      ...
      * Called module names
       ...
       01  MOD-ZCN01RP9              PIC X(8) VALUE 'ZCN01RP9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCN01RP9-002.
               CALL 'ZCN01RP9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCN01RP9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
