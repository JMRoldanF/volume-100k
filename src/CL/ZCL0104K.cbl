      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL0104K'.
      ...
      * Called module names
       01  MOD-ZCL01UST              PIC X(8) VALUE 'ZCL01UST'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01UST-001.
               CALL 'ZCL01UST' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01UST FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
