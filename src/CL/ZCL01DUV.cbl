      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL01DUV'.
      ...
      * Called module names
       01  MOD-ZCL01URR              PIC X(8) VALUE 'ZCL01URR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01URR-001.
               CALL 'ZCL01URR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01URR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
