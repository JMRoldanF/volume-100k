      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00O01'.
      ...
      * Called module names
       01  MOD-ZCL01ETB              PIC X(8) VALUE 'ZCL01ETB'.
       01  MOD-ZCL01MVV              PIC X(8) VALUE 'ZCL01MVV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01ETB-001.
               PERFORM CALL-ZCL01MVV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01ETB-001.
               CALL 'ZCL01ETB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01ETB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01MVV-002.
               CALL 'ZCL01MVV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01MVV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
