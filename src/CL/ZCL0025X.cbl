      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL0025X'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL008OX-001.
               PERFORM CALL-ZCL00KKF-002.
               PERFORM CALL-ZCL005A5-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL00KKF-002.
               MOVE 'ZCL00KKF' TO WS-PROGNAME-8
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL00KKF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL005A5-003.
               EXEC CICS START TRANSID('Z5A5')
                         FROM(WS-KEY-AREA)
                         LENGTH(20)
                         RESP(WS-RESP)
               END-EXEC.
      * TRANSID Z5A5 is defined against ZCL005A5
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL005A5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-004.
