      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL0103J'.
      ...
      * Called module names
       01  MOD-ZPN01PML              PIC X(8) VALUE 'ZPN01PML'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01PML-001.
               CALL 'ZPN01PML' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01PML FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
