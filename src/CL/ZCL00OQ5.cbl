      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00OQ5'.
      ...
      * Called module names
       01  MOD-ZRE01LFF              PIC X(8) VALUE 'ZRE01LFF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01LFF-001.
               CALL 'ZRE01LFF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01LFF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
