      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL0117L'.
      ...
      * Called module names
       01  MOD-ZCL01E7X              PIC X(8) VALUE 'ZCL01E7X'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01E7X-001.
               CALL 'ZCL01E7X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01E7X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
