      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00Q98'.
      ...
      * Called module names
       01  MOD-ZCL01SDR              PIC X(8) VALUE 'ZCL01SDR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01SDR-001.
               CALL 'ZCL01SDR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01SDR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
