      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00O0B'.
      ...
      * Called module names
       01  MOD-ZCL01QI5              PIC X(8) VALUE 'ZCL01QI5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01QI5-001.
               CALL 'ZCL01QI5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01QI5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01FTZ-002.
