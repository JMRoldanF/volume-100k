      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00TTR'.
      ...
      * Called module names
       01  MOD-ZCL01SYH              PIC X(8) VALUE 'ZCL01SYH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01SYH-001.
               CALL 'ZCL01SYH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01SYH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
