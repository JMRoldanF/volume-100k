      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00NPA'.
      ...
      * Called module names
       01  MOD-ZCL01KB7              PIC X(8) VALUE 'ZCL01KB7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01KB7-001.
               CALL 'ZCL01KB7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01KB7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
