      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00O1P'.
      ...
      * Called module names
       01  MOD-ZCL01GPX              PIC X(8) VALUE 'ZCL01GPX'.
       01  MOD-ZCL01PKT              PIC X(8) VALUE 'ZCL01PKT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01GPX-001.
               PERFORM CALL-ZCL01PKT-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01GPX-001.
               CALL 'ZCL01GPX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01GPX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01PKT-002.
               CALL 'ZCL01PKT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01PKT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
