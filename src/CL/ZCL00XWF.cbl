      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00XWF'.
      ...
      * Called module names
       01  MOD-ZMT01LP9              PIC X(8) VALUE 'ZMT01LP9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01LP9-001.
               PERFORM CALL-ZHO01O3O-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01LP9-001.
               CALL 'ZMT01LP9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01LP9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01O3O-002.
