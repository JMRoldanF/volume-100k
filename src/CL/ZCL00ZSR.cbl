      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00ZSR'.
      ...
      * Called module names
       01  MOD-ZAG01G74              PIC X(8) VALUE 'ZAG01G74'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01G74-001.
               CALL 'ZAG01G74' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01G74 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
