      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00YSO'.
      ...
      * Called module names
       01  MOD-ZCL01RMV              PIC X(8) VALUE 'ZCL01RMV'.
       01  MOD-ZCL01JN0              PIC X(8) VALUE 'ZCL01JN0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01RMV-001.
               PERFORM CALL-ZCL01JN0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01RMV-001.
               CALL 'ZCL01RMV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01RMV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01JN0-002.
               CALL 'ZCL01JN0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01JN0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-COLOUR-0001.
