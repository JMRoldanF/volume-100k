      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00X5Z'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01LYO              PIC X(8) VALUE 'ZCL01LYO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01RZZ-001.
               PERFORM CALL-ZCL01LYO-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01LYO-002.
               CALL 'ZCL01LYO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01LYO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
