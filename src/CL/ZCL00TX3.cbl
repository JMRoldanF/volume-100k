      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00TX3'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01N5A              PIC X(8) VALUE 'ZCU01N5A'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01N5A-002.
               CALL 'ZCU01N5A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01N5A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
