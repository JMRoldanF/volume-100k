      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00V4P'.
      ...
      * Called module names
       01  MOD-ZCL01KXV              PIC X(8) VALUE 'ZCL01KXV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01KXV-001.
               CALL 'ZCL01KXV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01KXV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01ORX-002.
