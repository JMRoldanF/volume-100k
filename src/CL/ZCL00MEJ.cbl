      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00MEJ'.
      ...
      * Called module names
       01  MOD-ZCL01MJX              PIC X(8) VALUE 'ZCL01MJX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01MJX-001.
               CALL 'ZCL01MJX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01MJX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
