      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00YU1'.
      ...
      * Called module names
       01  MOD-ZCU01R2E              PIC X(8) VALUE 'ZCU01R2E'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01R2E-001.
               CALL 'ZCU01R2E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01R2E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
