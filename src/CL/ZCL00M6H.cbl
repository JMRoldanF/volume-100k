      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00M6H'.
      ...
      * Called module names
       01  MOD-ZTX01NSN              PIC X(8) VALUE 'ZTX01NSN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTX01NSN-001.
               PERFORM CALL-ZCL01NAZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTX01NSN-001.
               CALL 'ZTX01NSN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTX01NSN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01NAZ-002.
               MOVE 'ZCL01NAZ' TO WS-SUBNAME-1
