      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL000Y6'.
      ...
      * Called module names
       01  MOD-ZCL00J3Y              PIC X(8) VALUE 'ZCL00J3Y'.
       01  MOD-ZCL004L8              PIC X(8) VALUE 'ZCL004L8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL00J1R-001.
               PERFORM CALL-ZCL00J3Y-002.
               PERFORM CALL-ZCL004L8-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL00J1R-001.
               MOVE 'ZCL00J1R' TO WS-PROGNAME-6
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL00J1R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL00J3Y-002.
               EXEC CICS LINK PROGRAM('ZCL00J3Y')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL00J3Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL004L8-003.
               EXEC CICS XCTL PROGRAM('ZCL004L8')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL004L8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-004.
