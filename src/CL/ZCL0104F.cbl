      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL0104F'.
      ...
      * Called module names
       01  MOD-ZCL01D1Z              PIC X(8) VALUE 'ZCL01D1Z'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01ELT-001.
               PERFORM CALL-ZCL01D1Z-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01D1Z-002.
               CALL 'ZCL01D1Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01D1Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
