      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00RB7'.
      ...
      * Called module names
       01  MOD-ZCL01IOH              PIC X(8) VALUE 'ZCL01IOH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01IOH-001.
               PERFORM CALL-ZCL01IR9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01IOH-001.
               CALL 'ZCL01IOH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01IOH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01IR9-002.
