      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00U55'.
      ...
      * Called module names
       01  MOD-ZCL01JI7              PIC X(8) VALUE 'ZCL01JI7'.
       01  MOD-ZCL01EAZ              PIC X(8) VALUE 'ZCL01EAZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01JI7-001.
               PERFORM CALL-ZCL01EAZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01JI7-001.
               CALL 'ZCL01JI7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01JI7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01EAZ-002.
               CALL 'ZCL01EAZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01EAZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
