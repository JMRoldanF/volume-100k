      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL004FB'.
      ...
      * Called module names
       ...
       01  MOD-ZCL00KOL              PIC X(8) VALUE 'ZCL00KOL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL00HFX-001.
               PERFORM CALL-ZHO007WI-002.
               PERFORM CALL-ZCL00KOL-003.
               PERFORM CALL-ZCU003R4-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL00HFX-001.
               MOVE 'ZCL00HFX' TO WS-PROGNAME-2
      ...
      *----------------------------------------------------------------*
       CALL-ZCL00KOL-003.
               EXEC CICS LINK PROGRAM('ZCL00KOL')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL00KOL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU003R4-004.
               EXEC CICS START TRANSID('Z3R4')
                         FROM(WS-KEY-AREA)
                         LENGTH(20)
                         RESP(WS-RESP)
               END-EXEC.
      * TRANSID Z3R4 is defined against ZCU003R4
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU003R4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-005.
