      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL001NL'.
      ...
      * Called module names
       ...
       01  MOD-ZCL00JL5              PIC X(8) VALUE 'ZCL00JL5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL009FV-001.
               PERFORM CALL-ZCL00JL5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL00JL5-002.
               EXEC CICS LINK PROGRAM('ZCL00JL5')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL00JL5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL007AN-003.
