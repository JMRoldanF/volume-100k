      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00PSH'.
      ...
      * Called module names
       01  MOD-ZCL01RXJ              PIC X(8) VALUE 'ZCL01RXJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01RXJ-001.
               CALL 'ZCL01RXJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01RXJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
