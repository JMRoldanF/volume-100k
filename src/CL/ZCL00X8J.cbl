      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00X8J'.
      ...
      * Called module names
       01  MOD-ZCL01IUV              PIC X(8) VALUE 'ZCL01IUV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01IUV-001.
               CALL 'ZCL01IUV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01IUV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
