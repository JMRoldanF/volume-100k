      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00NY6'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01MNH              PIC X(8) VALUE 'ZCL01MNH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01ENU-001.
               PERFORM CALL-ZCL01MNH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01MNH-002.
               CALL 'ZCL01MNH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01MNH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
