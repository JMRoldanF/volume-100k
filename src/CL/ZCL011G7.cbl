      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL011G7'.
      ...
      * Called module names
       01  MOD-ZCL01LSZ              PIC X(8) VALUE 'ZCL01LSZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01KHR-001.
               PERFORM CALL-ZCL01LSZ-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCL01KHR-001.
               MOVE 'ZCL01KHR' TO WS-SUBNAME-1
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01LSZ-002.
               CALL 'ZCL01LSZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01LSZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       WRITE-ERROR-MESSAGE.
