      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00QS1'.
      ...
      * Called module names
       01  MOD-ZCU01U1W              PIC X(8) VALUE 'ZCU01U1W'.
       01  MOD-ZCL01UL3              PIC X(8) VALUE 'ZCL01UL3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01U1W-001.
               PERFORM CALL-ZCL01UL3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01U1W-001.
               CALL 'ZCU01U1W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01U1W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01UL3-002.
               CALL 'ZCL01UL3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01UL3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
