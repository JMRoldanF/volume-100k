      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00PR3'.
      ...
      * Called module names
       01  MOD-ZCL01JUF              PIC X(8) VALUE 'ZCL01JUF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01JUF-001.
               PERFORM CALL-ZMT01FC3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01JUF-001.
               CALL 'ZCL01JUF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01JUF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01FC3-002.
