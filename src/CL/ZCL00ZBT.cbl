      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00ZBT'.
      ...
      * Called module names
       01  MOD-ZCL01JP5              PIC X(8) VALUE 'ZCL01JP5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01JP5-001.
               CALL 'ZCL01JP5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01JP5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
