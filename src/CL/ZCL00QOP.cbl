      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00QOP'.
      ...
      * Called module names
       01  MOD-ZCL01RFR              PIC X(8) VALUE 'ZCL01RFR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01RFR-001.
               CALL 'ZCL01RFR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01RFR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
