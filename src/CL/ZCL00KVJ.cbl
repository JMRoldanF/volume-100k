      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00KVJ'.
      ...
      * Called module names
       01  MOD-ZCL01149              PIC X(8) VALUE 'ZCL01149'.
       01  MOD-ZCL01T05              PIC X(8) VALUE 'ZCL01T05'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01149-001.
               PERFORM CALL-ZCL00RWB-002.
               PERFORM CALL-ZCU01E18-003.
               PERFORM CALL-ZCL01T05-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01149-001.
               EXEC CICS LINK PROGRAM('ZCL01149')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01149 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL00RWB-002.
               MOVE 'ZCL00RWB' TO WS-PROGNAME-5
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL00RWB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01E18-003.
               MOVE 'ZCU01E18' TO WS-SUBNAME-6
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01T05-004.
               CALL 'ZCL01T05' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01T05 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-005.
