      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00OH9'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01OKZ              PIC X(8) VALUE 'ZCL01OKZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01OKZ-002.
               CALL 'ZCL01OKZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01OKZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
