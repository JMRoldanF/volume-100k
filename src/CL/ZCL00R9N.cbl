      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00R9N'.
      ...
      * Called module names
       01  MOD-ZCL01SNH              PIC X(8) VALUE 'ZCL01SNH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01SNH-002.
               CALL 'ZCL01SNH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01SNH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
