      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00RNZ'.
      ...
      * Called module names
       01  MOD-ZCL01SSX              PIC X(8) VALUE 'ZCL01SSX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01SSX-001.
               CALL 'ZCL01SSX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01SSX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-MODEL-0001.
