      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00QNL'.
      ...
      * Called module names
       01  MOD-ZCL01CZH              PIC X(8) VALUE 'ZCL01CZH'.
       01  MOD-ZCL01R89              PIC X(8) VALUE 'ZCL01R89'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01CZH-001.
               PERFORM CALL-ZCL01R89-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01CZH-001.
               CALL 'ZCL01CZH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01CZH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01R89-002.
               CALL 'ZCL01R89' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01R89 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
