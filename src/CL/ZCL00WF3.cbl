      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00WF3'.
      ...
      * Called module names
       01  MOD-ZCL01IQP              PIC X(8) VALUE 'ZCL01IQP'.
       01  MOD-ZCL01J5P              PIC X(8) VALUE 'ZCL01J5P'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01IQP-001.
               PERFORM CALL-ZCL01J5P-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01IQP-001.
               CALL 'ZCL01IQP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01IQP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01J5P-002.
               CALL 'ZCL01J5P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01J5P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
