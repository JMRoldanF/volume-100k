      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00OTA'.
      ...
      * Called module names
       01  MOD-ZCN01N5I              PIC X(8) VALUE 'ZCN01N5I'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCN01N5I-001.
               CALL 'ZCN01N5I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCN01N5I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01N39-002.
