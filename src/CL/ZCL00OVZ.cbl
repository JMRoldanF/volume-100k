      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00OVZ'.
      ...
      * Called module names
       01  MOD-ZCL01IER              PIC X(8) VALUE 'ZCL01IER'.
       01  MOD-ZCL01ITH              PIC X(8) VALUE 'ZCL01ITH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01IER-001.
               PERFORM CALL-ZCL01ITH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01IER-001.
               CALL 'ZCL01IER' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01IER FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01ITH-002.
               CALL 'ZCL01ITH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01ITH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
