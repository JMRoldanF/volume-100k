      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00OBZ'.
      ...
      * Called module names
       01  MOD-ZCL01GDZ              PIC X(8) VALUE 'ZCL01GDZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01GDZ-001.
               CALL 'ZCL01GDZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01GDZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
