      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00V77'.
      ...
      * Called module names
       01  MOD-ZCL01E5F              PIC X(8) VALUE 'ZCL01E5F'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01E5F-001.
               CALL 'ZCL01E5F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01E5F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
