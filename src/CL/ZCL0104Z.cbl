      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL0104Z'.
      ...
      * Called module names
       01  MOD-ZCL01HNJ              PIC X(8) VALUE 'ZCL01HNJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01HNJ-001.
               CALL 'ZCL01HNJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01HNJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
