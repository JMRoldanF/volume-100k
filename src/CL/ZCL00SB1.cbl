      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00SB1'.
      ...
      * Called module names
       01  MOD-ZAG01STK              PIC X(8) VALUE 'ZAG01STK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01STK-001.
               PERFORM CALL-ZCL01HYN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01STK-001.
               CALL 'ZAG01STK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
