      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00XHP'.
      ...
      * Called module names
       01  MOD-ZCL01DG5              PIC X(8) VALUE 'ZCL01DG5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01DG5-001.
               CALL 'ZCL01DG5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01DG5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
