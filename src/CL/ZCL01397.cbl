      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL01397'.
      ...
      * Called module names
       01  MOD-ZCL01S5B              PIC X(8) VALUE 'ZCL01S5B'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01S5B-001.
               CALL 'ZCL01S5B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01S5B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-VALUE-0001.
