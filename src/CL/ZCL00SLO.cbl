      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00SLO'.
      ...
      * Called module names
       01  MOD-ZCL01UCR              PIC X(8) VALUE 'ZCL01UCR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01UCR-001.
               CALL 'ZCL01UCR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01UCR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
