      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00L13'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01815              PIC X(8) VALUE 'ZCL01815'.
       01  MOD-ZCL01LVR              PIC X(8) VALUE 'ZCL01LVR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL00MD5-001.
               PERFORM CALL-ZCL01815-002.
               PERFORM CALL-ZCL01LVR-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01815-002.
               EXEC CICS LINK PROGRAM('ZCL01815')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01815 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01LVR-003.
               CALL 'ZCL01LVR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01LVR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-004.
