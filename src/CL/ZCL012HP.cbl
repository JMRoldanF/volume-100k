      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL012HP'.
      ...
      * Called module names
       01  MOD-ZCU01LC0              PIC X(8) VALUE 'ZCU01LC0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01LC0-001.
               CALL 'ZCU01LC0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01LC0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01MIT-002.
