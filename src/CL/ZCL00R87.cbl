      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00R87'.
      ...
      * Called module names
       01  MOD-ZCL01J08              PIC X(8) VALUE 'ZCL01J08'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01J08-001.
               CALL 'ZCL01J08' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01J08 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
