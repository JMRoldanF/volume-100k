      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00LQD'.
      ...
      * Called module names
       01  MOD-ZCL01O23              PIC X(8) VALUE 'ZCL01O23'.
       01  MOD-ZCL01UGX              PIC X(8) VALUE 'ZCL01UGX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01O23-001.
               PERFORM CALL-ZCL01UGX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01O23-001.
               CALL 'ZCL01O23' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01O23 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01UGX-002.
               CALL 'ZCL01UGX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01UGX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
