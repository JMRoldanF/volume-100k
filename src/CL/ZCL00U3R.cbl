      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00U3R'.
      ...
      * Called module names
       01  MOD-ZCL01P5J              PIC X(8) VALUE 'ZCL01P5J'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01P5J-001.
               PERFORM CALL-ZCL01NYR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01P5J-001.
               CALL 'ZCL01P5J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01P5J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01NYR-002.
