      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL013J7'.
      ...
      * Called module names
       01  MOD-ZBI01PMI              PIC X(8) VALUE 'ZBI01PMI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01PMI-001.
               CALL 'ZBI01PMI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01PMI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
