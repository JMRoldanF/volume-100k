      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00UFP'.
      ...
      * Called module names
       01  MOD-ZCL01P9Z              PIC X(8) VALUE 'ZCL01P9Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01P9Z-001.
               CALL 'ZCL01P9Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01P9Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01E69-002.
