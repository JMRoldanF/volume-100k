      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00YSL'.
      ...
      * Called module names
       01  MOD-ZCL01RXL              PIC X(8) VALUE 'ZCL01RXL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01RXL-001.
               CALL 'ZCL01RXL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01RXL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
