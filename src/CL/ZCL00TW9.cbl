      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00TW9'.
      ...
      * Called module names
       01  MOD-ZCL01KZJ              PIC X(8) VALUE 'ZCL01KZJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01KZJ-001.
               CALL 'ZCL01KZJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01KZJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
