      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00TV4'.
      ...
      * Called module names
       01  MOD-ZCL01KML              PIC X(8) VALUE 'ZCL01KML'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01KML-001.
               CALL 'ZCL01KML' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01KML FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCN01UR7-002.
