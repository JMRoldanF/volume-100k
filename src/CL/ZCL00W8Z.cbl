      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00W8Z'.
      ...
      * Called module names
       01  MOD-ZCL01KSL              PIC X(8) VALUE 'ZCL01KSL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01KSL-001.
               PERFORM CALL-ZCL01M5R-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01KSL-001.
               CALL 'ZCL01KSL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01KSL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01M5R-002.
