      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00OXN'.
      ...
      * Called module names
       01  MOD-ZCL01H07              PIC X(8) VALUE 'ZCL01H07'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01H07-001.
               CALL 'ZCL01H07' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01H07 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01FTZ-002.
