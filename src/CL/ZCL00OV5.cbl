      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00OV5'.
      ...
      * Called module names
       01  MOD-ZCL01T1T              PIC X(8) VALUE 'ZCL01T1T'.
       01  MOD-ZPA01N3R              PIC X(8) VALUE 'ZPA01N3R'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01T1T-001.
               PERFORM CALL-ZPA01N3R-002.
               ...
               PERFORM AUDIT-SUM-ASSURED-0110.
               PERFORM SQL-ACCESS-0111.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCL01T1T-001.
               CALL 'ZCL01T1T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01T1T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01N3R-002.
               CALL 'ZPA01N3R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01N3R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
