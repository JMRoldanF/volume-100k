      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL016RV'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01GNY              PIC X(8) VALUE 'ZCU01GNY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01GNY-002.
               CALL 'ZCU01GNY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
