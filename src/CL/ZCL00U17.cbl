      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00U17'.
      ...
      * Called module names
       01  MOD-ZCL01PXB              PIC X(8) VALUE 'ZCL01PXB'.
       01  MOD-ZCL01P0E              PIC X(8) VALUE 'ZCL01P0E'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01PXB-001.
               PERFORM CALL-ZCL01P0E-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01PXB-001.
               CALL 'ZCL01PXB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01PXB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01P0E-002.
               CALL 'ZCL01P0E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01P0E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-MODEL-0001.
