      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL012FR'.
      ...
      * Called module names
       ...
       01  MOD-ZPN01T4I              PIC X(8) VALUE 'ZPN01T4I'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPN01HF3-001.
               PERFORM CALL-ZPN01T4I-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01T4I-002.
               CALL 'ZPN01T4I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01T4I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-VALUE-0001.
