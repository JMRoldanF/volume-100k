      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00YG5'.
      ...
      * Called module names
       01  MOD-ZCL01E23              PIC X(8) VALUE 'ZCL01E23'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01NCJ-001.
               PERFORM CALL-ZCL01E23-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01E23-002.
               CALL 'ZCL01E23' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01E23 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
