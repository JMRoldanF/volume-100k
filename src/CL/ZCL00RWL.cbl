      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00RWL'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01H43              PIC X(8) VALUE 'ZCL01H43'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01LML-001.
               PERFORM CALL-ZCL01H43-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01H43-002.
               CALL 'ZCL01H43' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01H43 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
