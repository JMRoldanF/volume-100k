      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00SMF'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01DFB              PIC X(8) VALUE 'ZCL01DFB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01KE2-001.
               PERFORM CALL-ZCL01DFB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01DFB-002.
               CALL 'ZCL01DFB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01DFB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
