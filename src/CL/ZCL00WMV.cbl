      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00WMV'.
      ...
      * Called module names
       01  MOD-ZCL01D79              PIC X(8) VALUE 'ZCL01D79'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01D79-001.
               PERFORM CALL-ZBI01I6G-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01D79-001.
               CALL 'ZCL01D79' USING DFHCOMMAREA
                         WS-STATUS-CODE.
