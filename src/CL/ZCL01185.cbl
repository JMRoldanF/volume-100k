      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL01185'.
      ...
      * Called module names
       01  MOD-ZCL01JCN              PIC X(8) VALUE 'ZCL01JCN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01JCN-001.
               CALL 'ZCL01JCN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01JCN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-MAKE-0001.
