      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL0140Z'.
      ...
      * Called module names
       01  MOD-ZCL01RLB              PIC X(8) VALUE 'ZCL01RLB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01RLB-001.
               CALL 'ZCL01RLB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01RLB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
