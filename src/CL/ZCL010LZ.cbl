      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL010LZ'.
      ...
      * Called module names
       01  MOD-ZCL01P7X              PIC X(8) VALUE 'ZCL01P7X'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01P7X-001.
               PERFORM CALL-ZCL01I28-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01P7X-001.
               CALL 'ZCL01P7X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01P7X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01I28-002.
