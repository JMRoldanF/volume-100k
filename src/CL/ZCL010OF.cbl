      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL010OF'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01PH7              PIC X(8) VALUE 'ZCL01PH7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01S9R-001.
               PERFORM CALL-ZCL01PH7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01PH7-002.
               CALL 'ZCL01PH7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
