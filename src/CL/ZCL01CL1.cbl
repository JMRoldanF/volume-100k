      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL01CL1'.
      ...
      * Called module names
       01  MOD-ZCL01UXL              PIC X(8) VALUE 'ZCL01UXL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01UXL-001.
               PERFORM CALL-ZCL01SQP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01UXL-001.
               CALL 'ZCL01UXL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01UXL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01SQP-002.
