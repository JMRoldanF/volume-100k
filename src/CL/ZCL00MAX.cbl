      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00MAX'.
      ...
      * Called module names
       01  MOD-ZCL01G1R              PIC X(8) VALUE 'ZCL01G1R'.
       01  MOD-ZCL01PQ3              PIC X(8) VALUE 'ZCL01PQ3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01G1R-001.
               PERFORM CALL-ZCL01PQ3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01G1R-001.
               CALL 'ZCL01G1R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01G1R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01PQ3-002.
               CALL 'ZCL01PQ3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01PQ3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
