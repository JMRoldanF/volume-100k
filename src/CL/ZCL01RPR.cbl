      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL01RPR'.
      ...
      * Called module names
       01  MOD-ZCL01TJV              PIC X(8) VALUE 'ZCL01TJV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01TJV-001.
               CALL 'ZCL01TJV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01TJV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       NORMALISE-TERM-0001.
