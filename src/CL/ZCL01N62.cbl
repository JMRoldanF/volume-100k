      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL01N62'.
      ...
      * Called module names
       01  MOD-ZCL01SSV              PIC X(8) VALUE 'ZCL01SSV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01SSV-001.
               CALL 'ZCL01SSV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01SSV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
