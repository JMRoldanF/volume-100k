      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00ZZP'.
      ...
      * Called module names
       01  MOD-ZCL01UQD              PIC X(8) VALUE 'ZCL01UQD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01UQD-001.
               CALL 'ZCL01UQD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01UQD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01NS9-002.
