      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL007Y9'.
      ...
      * Called module names
       01  MOD-ZCL00WCV              PIC X(8) VALUE 'ZCL00WCV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL00WCV-001.
               EXEC CICS LINK PROGRAM('ZCL00WCV')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL00WCV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
