      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00RTS'.
      ...
      * Called module names
       01  MOD-ZCL01PUJ              PIC X(8) VALUE 'ZCL01PUJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01PUJ-001.
               CALL 'ZCL01PUJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01PUJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
