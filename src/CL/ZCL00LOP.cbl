      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00LOP'.
      ...
      * Called module names
       01  MOD-ZCL01GDP              PIC X(8) VALUE 'ZCL01GDP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01GDP-001.
               CALL 'ZCL01GDP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01GDP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
