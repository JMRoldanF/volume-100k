      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00RAD'.
      ...
      * Called module names
       01  MOD-ZBI01D3Y              PIC X(8) VALUE 'ZBI01D3Y'.
       01  MOD-ZMT01K3R              PIC X(8) VALUE 'ZMT01K3R'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01D3Y-001.
               PERFORM CALL-ZMT01K3R-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01D3Y-001.
               CALL 'ZBI01D3Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01D3Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01K3R-002.
               CALL 'ZMT01K3R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01K3R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-VALUE-0001.
