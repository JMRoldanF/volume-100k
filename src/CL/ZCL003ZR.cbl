      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL003ZR'.
      ...
      * Called module names
       ...
       01  MOD-ZCL00IGL              PIC X(8) VALUE 'ZCL00IGL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA00ANB-001.
               PERFORM CALL-ZAG00D32-002.
               PERFORM CALL-ZUW009HE-003.
               PERFORM CALL-ZCL00CRL-004.
               PERFORM CALL-ZCL00IGL-005.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00ANB-001.
               MOVE 'ZPA00ANB' TO WS-PROGNAME-8
      ...
      *----------------------------------------------------------------*
       CALL-ZCL00IGL-005.
               EXEC CICS LINK PROGRAM('ZCL00IGL')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL00IGL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
