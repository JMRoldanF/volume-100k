      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL011O9'.
      ...
      * Called module names
       01  MOD-ZCL01HPR              PIC X(8) VALUE 'ZCL01HPR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01HPR-001.
               CALL 'ZCL01HPR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01HPR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
