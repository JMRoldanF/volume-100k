      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00R0X'.
      ...
      * Called module names
       01  MOD-ZRE01HGN              PIC X(8) VALUE 'ZRE01HGN'.
       01  MOD-ZCL01R9N              PIC X(8) VALUE 'ZCL01R9N'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01HGN-001.
               PERFORM CALL-ZCL01R9N-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01HGN-001.
               CALL 'ZRE01HGN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01HGN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01R9N-002.
               CALL 'ZCL01R9N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01R9N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
