      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00LYP'.
      ...
      * Called module names
       01  MOD-ZEN01K4N              PIC X(8) VALUE 'ZEN01K4N'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01K4N-001.
               PERFORM CALL-ZCL01O69-002.
               PERFORM CALL-ZEN0255N-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZEN01K4N-001.
               CALL 'ZEN01K4N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
