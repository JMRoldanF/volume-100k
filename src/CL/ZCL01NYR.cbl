      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL01NYR'.
      ...
      * Called module names
       01  MOD-ZCL01EQT              PIC X(8) VALUE 'ZCL01EQT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01EQT-001.
               CALL 'ZCL01EQT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01EQT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
