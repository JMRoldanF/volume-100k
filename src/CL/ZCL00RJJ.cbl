      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00RJJ'.
      ...
      * Called module names
       01  MOD-ZRE01O2P              PIC X(8) VALUE 'ZRE01O2P'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01O2P-001.
               PERFORM CALL-ZCL01HZR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01O2P-001.
               CALL 'ZRE01O2P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01O2P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01HZR-002.
