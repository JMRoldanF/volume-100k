      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00VCH'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01OSR              PIC X(8) VALUE 'ZCL01OSR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01QJ9-001.
               PERFORM CALL-ZCL01OSR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01OSR-002.
               CALL 'ZCL01OSR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01OSR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
