      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00127'.
      ...
      * Called module names
       01  MOD-ZCL009MJ              PIC X(8) VALUE 'ZCL009MJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL009MJ-001.
               PERFORM CALL-ZCL00E47-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL009MJ-001.
               EXEC CICS LINK PROGRAM('ZCL009MJ')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL009MJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL00E47-002.
               MOVE 'ZCL00E47' TO WS-PROGNAME-5
