      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL0181F'.
      ...
      * Called module names
       01  MOD-ZCL01GPD              PIC X(8) VALUE 'ZCL01GPD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01GPD-001.
               CALL 'ZCL01GPD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01GPD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
