      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00WC1'.
      ...
      * Called module names
       01  MOD-ZCL01NZL              PIC X(8) VALUE 'ZCL01NZL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01NZL-001.
               CALL 'ZCL01NZL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01NZL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
