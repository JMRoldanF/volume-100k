      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL010OZ'.
      ...
      * Called module names
       01  MOD-ZMT01PMD              PIC X(8) VALUE 'ZMT01PMD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01PMD-001.
               CALL 'ZMT01PMD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01PMD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
