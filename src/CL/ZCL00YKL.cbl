      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00YKL'.
      ...
      * Called module names
       01  MOD-ZCL01IO7              PIC X(8) VALUE 'ZCL01IO7'.
       01  MOD-ZCL01PW7              PIC X(8) VALUE 'ZCL01PW7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01IO7-001.
               CALL 'ZCL01IO7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01PW7-002.
               CALL 'ZCL01PW7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01PW7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
