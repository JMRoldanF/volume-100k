      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL0117S'.
      ...
      * Called module names
       01  MOD-ZCL01PVI              PIC X(8) VALUE 'ZCL01PVI'.
       01  MOD-ZCL01SVX              PIC X(8) VALUE 'ZCL01SVX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01PVI-001.
               PERFORM CALL-ZCL01SVX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01PVI-001.
               CALL 'ZCL01PVI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01PVI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01SVX-002.
               CALL 'ZCL01SVX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01SVX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
