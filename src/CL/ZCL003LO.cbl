      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL003LO'.
      ...
      * Called module names
       01  MOD-ZCL00JWG              PIC X(8) VALUE 'ZCL00JWG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL00JWG-001.
               PERFORM CALL-ZCL00FU2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL00JWG-001.
               EXEC CICS LINK PROGRAM('ZCL00JWG')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL00JWG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL00FU2-002.
