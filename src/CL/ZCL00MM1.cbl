      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00MM1'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01NO3              PIC X(8) VALUE 'ZMT01NO3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01NO3-002.
               CALL 'ZMT01NO3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01NO3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
