      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL0128Y'.
      ...
      * Called module names
       01  MOD-ZCL01M5Y              PIC X(8) VALUE 'ZCL01M5Y'.
       01  MOD-ZCL01KFI              PIC X(8) VALUE 'ZCL01KFI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01M5Y-001.
               PERFORM CALL-ZCL01KFI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01M5Y-001.
               CALL 'ZCL01M5Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01M5Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01KFI-002.
               CALL 'ZCL01KFI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01KFI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
