      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL01117'.
      ...
      * Called module names
       01  MOD-ZCL01D5L              PIC X(8) VALUE 'ZCL01D5L'.
       01  MOD-ZCL01G2L              PIC X(8) VALUE 'ZCL01G2L'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01D5L-001.
               PERFORM CALL-ZCL01G2L-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01D5L-001.
               CALL 'ZCL01D5L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01D5L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01G2L-002.
               CALL 'ZCL01G2L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01G2L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
