      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00OR9'.
      ...
      * Called module names
       01  MOD-ZCL01NKB              PIC X(8) VALUE 'ZCL01NKB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01NKB-001.
               CALL 'ZCL01NKB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01NKB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01ERX-002.
