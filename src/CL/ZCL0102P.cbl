      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL0102P'.
      ...
      * Called module names
       01  MOD-ZCL01H2E              PIC X(8) VALUE 'ZCL01H2E'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01H2E-001.
               CALL 'ZCL01H2E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01H2E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-EXCESS-0001.
