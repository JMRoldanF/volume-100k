      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00VSB'.
      ...
      * Called module names
       01  MOD-ZCL01NPV              PIC X(8) VALUE 'ZCL01NPV'.
       01  MOD-ZCL01RDT              PIC X(8) VALUE 'ZCL01RDT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01NPV-001.
               PERFORM CALL-ZCL01RDT-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01NPV-001.
               CALL 'ZCL01NPV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01NPV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01RDT-002.
               CALL 'ZCL01RDT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01RDT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
