      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00WGH'.
      ...
      * Called module names
       01  MOD-ZCL01TTV              PIC X(8) VALUE 'ZCL01TTV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01TTV-001.
               CALL 'ZCL01TTV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01TTV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
