      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL0129N'.
      ...
      * Called module names
       01  MOD-ZAG01KSO              PIC X(8) VALUE 'ZAG01KSO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01KSO-001.
               PERFORM CALL-ZCL01QNF-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01KSO-001.
               CALL 'ZAG01KSO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01KSO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01QNF-002.
