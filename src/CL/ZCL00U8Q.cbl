      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00U8Q'.
      ...
      * Called module names
       01  MOD-ZCL01P63              PIC X(8) VALUE 'ZCL01P63'.
       01  MOD-ZCL01U14              PIC X(8) VALUE 'ZCL01U14'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01P63-001.
               PERFORM CALL-ZCL01U14-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01P63-001.
               CALL 'ZCL01P63' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01P63 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01U14-002.
               CALL 'ZCL01U14' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01U14 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-TERM-0001.
