      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00NLL'.
      ...
      * Called module names
       01  MOD-ZCL01Q67              PIC X(8) VALUE 'ZCL01Q67'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01UXB-001.
               PERFORM CALL-ZCL01Q67-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01UXB-001.
               MOVE 'ZCL01UXB' TO WS-SUBNAME-5
               CALL WS-SUBNAME-5 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01UXB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01Q67-002.
               CALL 'ZCL01Q67' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
