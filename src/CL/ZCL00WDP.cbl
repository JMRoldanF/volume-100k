      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00WDP'.
      ...
      * Called module names
       01  MOD-ZHO01JKW              PIC X(8) VALUE 'ZHO01JKW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01N6Z-001.
               PERFORM CALL-ZHO01JKW-002.
               PERFORM CALL-ZHO0255M-003.
               PERFORM NORMALISE-TAX-BAND-0001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCL01N6Z-001.
               MOVE 'ZCL01N6Z' TO WS-SUBNAME-3
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01JKW-002.
               CALL 'ZHO01JKW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01JKW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
