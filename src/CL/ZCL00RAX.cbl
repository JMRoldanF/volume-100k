      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00RAX'.
      ...
      * Called module names
       01  MOD-ZCL01OEB              PIC X(8) VALUE 'ZCL01OEB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01OEB-001.
               CALL 'ZCL01OEB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01OEB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
