      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00VXB'.
      ...
      * Called module names
       01  MOD-ZCL01RHF              PIC X(8) VALUE 'ZCL01RHF'.
       01  MOD-ZCL01RTD              PIC X(8) VALUE 'ZCL01RTD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01RHF-001.
               PERFORM CALL-ZCL01RTD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01RHF-001.
               CALL 'ZCL01RHF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01RHF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01RTD-002.
               CALL 'ZCL01RTD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01RTD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
