      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL010JP'.
      ...
      * Called module names
       01  MOD-ZCL01HYN              PIC X(8) VALUE 'ZCL01HYN'.
       01  MOD-ZCL01Q5X              PIC X(8) VALUE 'ZCL01Q5X'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01HYN-001.
               PERFORM CALL-ZCL01Q5X-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01HYN-001.
               CALL 'ZCL01HYN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01HYN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01Q5X-002.
               CALL 'ZCL01Q5X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01Q5X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
