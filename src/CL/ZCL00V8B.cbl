      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00V8B'.
      ...
      * Called module names
       01  MOD-ZCL01PNB              PIC X(8) VALUE 'ZCL01PNB'.
       01  MOD-ZCL01SU1              PIC X(8) VALUE 'ZCL01SU1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01PNB-001.
               PERFORM CALL-ZCL01SU1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01PNB-001.
               CALL 'ZCL01PNB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01PNB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01SU1-002.
               CALL 'ZCL01SU1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01SU1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
