      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00Y9H'.
      ...
      * Called module names
       01  MOD-ZCL01EUF              PIC X(8) VALUE 'ZCL01EUF'.
       01  MOD-ZCL01GO9              PIC X(8) VALUE 'ZCL01GO9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01EUF-001.
               PERFORM CALL-ZCL01GO9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01EUF-001.
               CALL 'ZCL01EUF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01EUF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01GO9-002.
               CALL 'ZCL01GO9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01GO9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
