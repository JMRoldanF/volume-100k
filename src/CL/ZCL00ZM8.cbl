      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00ZM8'.
      ...
      * Called module names
       01  MOD-ZCL01HNQ              PIC X(8) VALUE 'ZCL01HNQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01HNQ-002.
               CALL 'ZCL01HNQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
