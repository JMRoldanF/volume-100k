      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL010FA'.
      ...
      * Called module names
       01  MOD-ZCL01KP8              PIC X(8) VALUE 'ZCL01KP8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01KP8-001.
               CALL 'ZCL01KP8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01KP8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-PREMIUM-0001.
