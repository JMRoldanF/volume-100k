      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00RVH'.
      ...
      * Called module names
       01  MOD-ZCL01GOJ              PIC X(8) VALUE 'ZCL01GOJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01GOJ-001.
               CALL 'ZCL01GOJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01GOJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
