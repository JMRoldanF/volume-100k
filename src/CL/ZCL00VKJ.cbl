      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00VKJ'.
      ...
      * Called module names
       01  MOD-ZCL01MWF              PIC X(8) VALUE 'ZCL01MWF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01MWF-001.
               PERFORM CALL-ZCL01UHH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01MWF-001.
               CALL 'ZCL01MWF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01MWF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01UHH-002.
