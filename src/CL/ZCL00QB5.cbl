      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00QB5'.
      ...
      * Called module names
       01  MOD-ZCL01FAR              PIC X(8) VALUE 'ZCL01FAR'.
       01  MOD-ZCL01IYX              PIC X(8) VALUE 'ZCL01IYX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01FAR-001.
               PERFORM CALL-ZCL01IYX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01FAR-001.
               CALL 'ZCL01FAR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01FAR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01IYX-002.
               CALL 'ZCL01IYX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01IYX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
