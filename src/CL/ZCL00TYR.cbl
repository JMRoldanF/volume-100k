      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00TYR'.
      ...
      * Called module names
       01  MOD-ZRE01JX9              PIC X(8) VALUE 'ZRE01JX9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01JX9-001.
               PERFORM CALL-ZCL01JP5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01JX9-001.
               CALL 'ZRE01JX9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01JX9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01JP5-002.
