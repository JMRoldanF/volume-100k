      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00Y77'.
      ...
      * Called module names
       01  MOD-ZCL01NT9              PIC X(8) VALUE 'ZCL01NT9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01NT9-001.
               CALL 'ZCL01NT9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01NT9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
