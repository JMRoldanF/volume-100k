      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00YZB'.
      ...
      * Called module names
       01  MOD-ZCL01IU1              PIC X(8) VALUE 'ZCL01IU1'.
       01  MOD-ZCL01JEV              PIC X(8) VALUE 'ZCL01JEV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01IU1-001.
               PERFORM CALL-ZCL01JEV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01IU1-001.
               CALL 'ZCL01IU1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01IU1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01JEV-002.
               CALL 'ZCL01JEV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01JEV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
