      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00TK5'.
      ...
      * Called module names
       01  MOD-ZCL01QSR              PIC X(8) VALUE 'ZCL01QSR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01QSR-001.
               CALL 'ZCL01QSR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01QSR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
