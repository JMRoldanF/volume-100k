      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00RF3'.
      ...
      * Called module names
       01  MOD-ZCL01GHB              PIC X(8) VALUE 'ZCL01GHB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01GHB-001.
               CALL 'ZCL01GHB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01GHB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01JAZ-002.
               MOVE 'ZCL01JAZ' TO WS-SUBNAME-1
