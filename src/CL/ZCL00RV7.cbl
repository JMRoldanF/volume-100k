      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00RV7'.
      ...
      * Called module names
       01  MOD-ZUW01ENC              PIC X(8) VALUE 'ZUW01ENC'.
       01  MOD-ZCL01EHD              PIC X(8) VALUE 'ZCL01EHD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01ENC-001.
               PERFORM CALL-ZCL01EHD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01ENC-001.
               CALL 'ZUW01ENC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01ENC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01EHD-002.
               CALL 'ZCL01EHD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01EHD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
