      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00OPL'.
      ...
      * Called module names
       01  MOD-ZCL01TRD              PIC X(8) VALUE 'ZCL01TRD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01TRD-001.
               CALL 'ZCL01TRD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01TRD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
