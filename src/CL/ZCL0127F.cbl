      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL0127F'.
      ...
      * Called module names
       01  MOD-ZCL01UTF              PIC X(8) VALUE 'ZCL01UTF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01UTF-001.
               CALL 'ZCL01UTF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01UTF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-MODEL-0001.
