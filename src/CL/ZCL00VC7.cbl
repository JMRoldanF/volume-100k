      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00VC7'.
      ...
      * Called module names
       01  MOD-ZCL01SGP              PIC X(8) VALUE 'ZCL01SGP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01SGP-001.
               CALL 'ZCL01SGP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01SGP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
