      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00XYX'.
      ...
      * Called module names
       01  MOD-ZCL01M5H              PIC X(8) VALUE 'ZCL01M5H'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01M5H-001.
               CALL 'ZCL01M5H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01M5H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
