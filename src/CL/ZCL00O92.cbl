      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00O92'.
      ...
      * Called module names
       01  MOD-ZCL01EF8              PIC X(8) VALUE 'ZCL01EF8'.
       01  MOD-ZCL01DJL              PIC X(8) VALUE 'ZCL01DJL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01EF8-001.
               PERFORM CALL-ZCL01DJL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01EF8-001.
               CALL 'ZCL01EF8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01EF8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01DJL-002.
               CALL 'ZCL01DJL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01DJL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
