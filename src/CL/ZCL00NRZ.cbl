      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00NRZ'.
      ...
      * Called module names
       01  MOD-ZCL01JSH              PIC X(8) VALUE 'ZCL01JSH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01JSH-001.
               CALL 'ZCL01JSH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01JSH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
