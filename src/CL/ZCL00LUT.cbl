      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00LUT'.
      ...
      * Called module names
       01  MOD-ZCL01E19              PIC X(8) VALUE 'ZCL01E19'.
       01  MOD-ZBI01THE              PIC X(8) VALUE 'ZBI01THE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01E19-001.
               PERFORM CALL-ZBI01THE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01E19-001.
               CALL 'ZCL01E19' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01E19 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01THE-002.
               CALL 'ZBI01THE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
