      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00TMT'.
      ...
      * Called module names
       01  MOD-ZCL01E7N              PIC X(8) VALUE 'ZCL01E7N'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01E7N-001.
               CALL 'ZCL01E7N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01E7N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
