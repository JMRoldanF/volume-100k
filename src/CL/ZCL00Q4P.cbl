      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00Q4P'.
      ...
      * Called module names
       01  MOD-ZCL01FXV              PIC X(8) VALUE 'ZCL01FXV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01FXV-001.
               PERFORM CALL-ZCL01F8L-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01FXV-001.
               CALL 'ZCL01FXV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01FXV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01F8L-002.
