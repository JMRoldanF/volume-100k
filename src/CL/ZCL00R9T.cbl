      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00R9T'.
      ...
      * Called module names
       01  MOD-ZCL01EXH              PIC X(8) VALUE 'ZCL01EXH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01EXH-001.
               CALL 'ZCL01EXH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01EXH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
