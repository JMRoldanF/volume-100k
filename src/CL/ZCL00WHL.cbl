      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00WHL'.
      ...
      * Called module names
       01  MOD-ZCL01MSJ              PIC X(8) VALUE 'ZCL01MSJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01MSJ-001.
               PERFORM CALL-ZCL01IXD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01MSJ-001.
               CALL 'ZCL01MSJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01MSJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01IXD-002.
