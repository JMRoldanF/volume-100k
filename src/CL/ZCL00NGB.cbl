      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00NGB'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01UI1              PIC X(8) VALUE 'ZCL01UI1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01MLM-001.
               PERFORM CALL-ZCL01UI1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01UI1-002.
               CALL 'ZCL01UI1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01UI1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
