      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00PAV'.
      ...
      * Called module names
       01  MOD-ZCL01FKM              PIC X(8) VALUE 'ZCL01FKM'.
       01  MOD-ZCL01QKW              PIC X(8) VALUE 'ZCL01QKW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01FKM-001.
               PERFORM CALL-ZCL01QKW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01FKM-001.
               CALL 'ZCL01FKM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01FKM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01QKW-002.
               CALL 'ZCL01QKW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01QKW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
