      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00MJP'.
      ...
      * Called module names
       01  MOD-ZCL01N9Z              PIC X(8) VALUE 'ZCL01N9Z'.
       01  MOD-ZCL01RGR              PIC X(8) VALUE 'ZCL01RGR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01N9Z-001.
               CALL 'ZCL01N9Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01N9Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01RGR-002.
               CALL 'ZCL01RGR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01RGR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
