      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00PTL'.
      ...
      * Called module names
       01  MOD-ZCL01K6X              PIC X(8) VALUE 'ZCL01K6X'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01K6X-001.
               PERFORM CALL-ZCL01LC1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01K6X-001.
               CALL 'ZCL01K6X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01K6X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01LC1-002.
