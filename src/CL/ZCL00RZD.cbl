      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00RZD'.
      ...
      * Called module names
       01  MOD-ZCL01LXF              PIC X(8) VALUE 'ZCL01LXF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01LXF-001.
               CALL 'ZCL01LXF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01LXF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
