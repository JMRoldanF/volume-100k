      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00ZP5'.
      ...
      * Called module names
       01  MOD-ZCL01FXB              PIC X(8) VALUE 'ZCL01FXB'.
       01  MOD-ZCL01OCD              PIC X(8) VALUE 'ZCL01OCD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01FXB-001.
               PERFORM CALL-ZCL01OCD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01FXB-001.
               CALL 'ZCL01FXB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01FXB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01OCD-002.
               CALL 'ZCL01OCD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01OCD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-MAKE-0001.
