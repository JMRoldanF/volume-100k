      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00MXQ'.
      ...
      * Called module names
       01  MOD-ZCL01DG7              PIC X(8) VALUE 'ZCL01DG7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01DG7-001.
               CALL 'ZCL01DG7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01DG7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
