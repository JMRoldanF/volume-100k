      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL014E1'.
      ...
      * Called module names
       01  MOD-ZCL01UU9              PIC X(8) VALUE 'ZCL01UU9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01UU9-001.
               CALL 'ZCL01UU9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01UU9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
