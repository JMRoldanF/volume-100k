      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL012BL'.
      ...
      * Called module names
       01  MOD-ZCL01FL3              PIC X(8) VALUE 'ZCL01FL3'.
       01  MOD-ZCL01RUR              PIC X(8) VALUE 'ZCL01RUR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01FL3-001.
               PERFORM CALL-ZCL01RUR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01FL3-001.
               CALL 'ZCL01FL3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01FL3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01RUR-002.
               CALL 'ZCL01RUR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01RUR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
