      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00QLD'.
      ...
      * Called module names
       01  MOD-ZCL01RQ1              PIC X(8) VALUE 'ZCL01RQ1'.
       01  MOD-ZCL01FQN              PIC X(8) VALUE 'ZCL01FQN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01RQ1-001.
               CALL 'ZCL01RQ1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01RQ1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01FQN-002.
               CALL 'ZCL01FQN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01FQN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
