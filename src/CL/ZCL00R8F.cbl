      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00R8F'.
      ...
      * Called module names
       01  MOD-ZCL01QSP              PIC X(8) VALUE 'ZCL01QSP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01QSP-001.
               CALL 'ZCL01QSP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01QSP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
