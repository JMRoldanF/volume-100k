      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00PEV'.
      ...
      * Called module names
       01  MOD-ZCL01IJ7              PIC X(8) VALUE 'ZCL01IJ7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01IJ7-001.
               CALL 'ZCL01IJ7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01IJ7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
