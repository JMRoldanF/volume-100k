      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00SEX'.
      ...
      * Called module names
       01  MOD-ZCL01NLP              PIC X(8) VALUE 'ZCL01NLP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01NLP-001.
               CALL 'ZCL01NLP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01NLP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
