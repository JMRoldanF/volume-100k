      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL011BH'.
      ...
      * Called module names
       01  MOD-ZHO01EW0              PIC X(8) VALUE 'ZHO01EW0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01EW0-001.
               CALL 'ZHO01EW0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01EW0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
