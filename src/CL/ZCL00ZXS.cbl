      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00ZXS'.
      ...
      * Called module names
       01  MOD-ZCL01U1S              PIC X(8) VALUE 'ZCL01U1S'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01U1S-001.
               CALL 'ZCL01U1S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01U1S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCN01MPD-002.
