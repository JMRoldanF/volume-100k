      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00W0N'.
      ...
      * Called module names
       01  MOD-ZBI01KS2              PIC X(8) VALUE 'ZBI01KS2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01KS2-001.
               CALL 'ZBI01KS2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01KS2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-MODEL-0001.
