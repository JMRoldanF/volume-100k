      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00T42'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01L8Y              PIC X(8) VALUE 'ZCL01L8Y'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01L8Y-002.
               CALL 'ZCL01L8Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01L8Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
