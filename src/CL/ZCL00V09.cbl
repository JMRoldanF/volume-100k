      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00V09'.
      ...
      * Called module names
       01  MOD-ZCL01KZ9              PIC X(8) VALUE 'ZCL01KZ9'.
       01  MOD-ZCL01J37              PIC X(8) VALUE 'ZCL01J37'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01KZ9-001.
               CALL 'ZCL01KZ9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01J37-002.
               CALL 'ZCL01J37' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01J37 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
