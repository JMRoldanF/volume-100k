      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00YUG'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01ENW              PIC X(8) VALUE 'ZCL01ENW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01ENW-002.
               CALL 'ZCL01ENW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01ENW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
