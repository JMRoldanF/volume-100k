      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00OHT'.
      ...
      * Called module names
       01  MOD-ZCL01S51              PIC X(8) VALUE 'ZCL01S51'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01S51-001.
               CALL 'ZCL01S51' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01S51 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
