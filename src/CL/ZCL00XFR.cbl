      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00XFR'.
      ...
      * Called module names
       01  MOD-ZCL01DPW              PIC X(8) VALUE 'ZCL01DPW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01DPW-001.
               PERFORM CALL-ZCL01JBK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01DPW-001.
               CALL 'ZCL01DPW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
