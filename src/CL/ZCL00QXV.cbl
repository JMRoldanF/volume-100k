      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00QXV'.
      ...
      * Called module names
       01  MOD-ZCL01UC7              PIC X(8) VALUE 'ZCL01UC7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01UC7-001.
               PERFORM CALL-ZCL01KNV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01UC7-001.
               CALL 'ZCL01UC7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01UC7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01KNV-002.
