      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00QDV'.
      ...
      * Called module names
       ...
       01  MOD-ZCL01OTV              PIC X(8) VALUE 'ZCL01OTV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01SIN-001.
               PERFORM CALL-ZCL01OTV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01OTV-002.
               CALL 'ZCL01OTV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
