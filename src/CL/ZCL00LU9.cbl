      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00LU9'.
      ...
      * Called module names
       01  MOD-ZCL01PFT              PIC X(8) VALUE 'ZCL01PFT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01PFT-001.
               PERFORM RECONCILE-NCD-YEARS-0001.
               PERFORM VALIDATE-SUM-ASSURED-0002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCL01PFT-001.
               CALL 'ZCL01PFT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01PFT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
