      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00SGV'.
      ...
      * Called module names
       01  MOD-ZCL01I33              PIC X(8) VALUE 'ZCL01I33'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01I33-001.
               CALL 'ZCL01I33' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01I33 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
