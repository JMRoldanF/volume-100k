      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00X4N'.
      ...
      * Called module names
       01  MOD-ZCL01D1P              PIC X(8) VALUE 'ZCL01D1P'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01D1P-001.
               CALL 'ZCL01D1P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01D1P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01G2L-002.
