      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00LZT'.
      ...
      * Called module names
       01  MOD-ZCL01F0J              PIC X(8) VALUE 'ZCL01F0J'.
       01  MOD-ZHO01UO2              PIC X(8) VALUE 'ZHO01UO2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01F0J-001.
               PERFORM CALL-ZHO01UO2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01F0J-001.
               CALL 'ZCL01F0J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01F0J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01UO2-002.
               CALL 'ZHO01UO2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01UO2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
