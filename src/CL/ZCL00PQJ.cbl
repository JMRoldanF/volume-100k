      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00PQJ'.
      ...
      * Called module names
       01  MOD-ZEN01PD9              PIC X(8) VALUE 'ZEN01PD9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01PD9-001.
               PERFORM CALL-ZCL01EGJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01PD9-001.
               CALL 'ZEN01PD9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01PD9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01EGJ-002.
               MOVE 'ZCL01EGJ' TO WS-SUBNAME-6
