      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL0151X'.
      ...
      * Called module names
       01  MOD-ZCL01LK3              PIC X(8) VALUE 'ZCL01LK3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01LK3-001.
               CALL 'ZCL01LK3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01LK3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
