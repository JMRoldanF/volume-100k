      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00ZK5'.
      ...
      * Called module names
       01  MOD-ZCL01ULX              PIC X(8) VALUE 'ZCL01ULX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01ULX-001.
               CALL 'ZCL01ULX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01ULX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
