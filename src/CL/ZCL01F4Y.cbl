      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL01F4Y'.
      ...
      * Called module names
       01  MOD-ZCL01O1R              PIC X(8) VALUE 'ZCL01O1R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01O1R-001.
               CALL 'ZCL01O1R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01O1R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
