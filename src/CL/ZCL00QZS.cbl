      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00QZS'.
      ...
      * Called module names
       01  MOD-ZCL01O7Y              PIC X(8) VALUE 'ZCL01O7Y'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01O7Y-001.
               CALL 'ZCL01O7Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01O7Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
