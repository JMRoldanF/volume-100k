      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00ZYV'.
      ...
      * Called module names
       01  MOD-ZCL01K2H              PIC X(8) VALUE 'ZCL01K2H'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01K2H-001.
               CALL 'ZCL01K2H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01K2H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
