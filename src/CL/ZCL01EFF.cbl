      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL01EFF'.
      ...
      * Called module names
       01  MOD-ZAG01R32              PIC X(8) VALUE 'ZAG01R32'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01R32-001.
               CALL 'ZAG01R32' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01R32 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
