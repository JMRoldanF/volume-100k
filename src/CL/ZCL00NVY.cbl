      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00NVY'.
      ...
      * Called module names
       01  MOD-ZCL01GR0              PIC X(8) VALUE 'ZCL01GR0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01GR0-002.
               CALL 'ZCL01GR0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
