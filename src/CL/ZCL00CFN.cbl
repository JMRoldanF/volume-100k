      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00CFN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL00QZJ-001.
               MOVE 'ZCL00QZJ' TO WS-PROGNAME-1
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01249-002.
               EXEC CICS LINK PROGRAM('ZMT01249')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
