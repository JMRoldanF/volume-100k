      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00XZ0'.
      ...
      * Called module names
       01  MOD-ZCL01TXG              PIC X(8) VALUE 'ZCL01TXG'.
       01  MOD-ZCL01LEG              PIC X(8) VALUE 'ZCL01LEG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01TXG-001.
               PERFORM CALL-ZCL01LEG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01TXG-001.
               CALL 'ZCL01TXG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01TXG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01LEG-002.
               CALL 'ZCL01LEG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01LEG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
