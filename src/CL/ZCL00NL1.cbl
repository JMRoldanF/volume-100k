      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00NL1'.
      ...
      * Called module names
       01  MOD-ZCL01KFJ              PIC X(8) VALUE 'ZCL01KFJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01KFJ-001.
               CALL 'ZCL01KFJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01KFJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
