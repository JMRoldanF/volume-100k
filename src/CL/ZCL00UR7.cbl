      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00UR7'.
      ...
      * Called module names
       01  MOD-ZCL01IDY              PIC X(8) VALUE 'ZCL01IDY'.
       01  MOD-ZCL01SOP              PIC X(8) VALUE 'ZCL01SOP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01IDY-001.
               CALL 'ZCL01IDY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01IDY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01SOP-002.
               CALL 'ZCL01SOP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01SOP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
