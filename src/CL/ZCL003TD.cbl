      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL003TD'.
      ...
      * Called module names
       01  MOD-ZCL00H21              PIC X(8) VALUE 'ZCL00H21'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL00997-001.
               PERFORM CALL-ZCL00H21-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL00997-001.
               MOVE 'ZCL00997' TO WS-PROGNAME-5
      ...
      *----------------------------------------------------------------*
       CALL-ZCL00H21-002.
               EXEC CICS LINK PROGRAM('ZCL00H21')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL00H21 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO003YA-003.
