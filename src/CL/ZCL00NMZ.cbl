      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00NMZ'.
      ...
      * Called module names
       01  MOD-ZCL01IL5              PIC X(8) VALUE 'ZCL01IL5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01IL5-001.
               PERFORM CALL-ZCL01NPL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01IL5-001.
               CALL 'ZCL01IL5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01IL5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01NPL-002.
