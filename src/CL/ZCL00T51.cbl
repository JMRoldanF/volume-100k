      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00T51'.
      ...
      * Called module names
       01  MOD-ZEN01N7H              PIC X(8) VALUE 'ZEN01N7H'.
       01  MOD-ZCL01NUL              PIC X(8) VALUE 'ZCL01NUL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01N7H-001.
               PERFORM CALL-ZCL01NUL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01N7H-001.
               CALL 'ZEN01N7H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01N7H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01NUL-002.
               CALL 'ZCL01NUL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01NUL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
