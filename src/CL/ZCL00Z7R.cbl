      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00Z7R'.
      ...
      * Called module names
       01  MOD-ZCL01HFD              PIC X(8) VALUE 'ZCL01HFD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01HFD-001.
               CALL 'ZCL01HFD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01HFD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
