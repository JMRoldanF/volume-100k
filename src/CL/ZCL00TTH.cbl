      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00TTH'.
      ...
      * Called module names
       01  MOD-ZCL01PAJ              PIC X(8) VALUE 'ZCL01PAJ'.
       01  MOD-ZCL01KH7              PIC X(8) VALUE 'ZCL01KH7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01PAJ-001.
               PERFORM CALL-ZCL01KH7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01PAJ-001.
               CALL 'ZCL01PAJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01PAJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01KH7-002.
               CALL 'ZCL01KH7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01KH7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
