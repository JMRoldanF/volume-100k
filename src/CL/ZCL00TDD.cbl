      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00TDD'.
      ...
      * Called module names
       01  MOD-ZCL01J9B              PIC X(8) VALUE 'ZCL01J9B'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01J9B-001.
               CALL 'ZCL01J9B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01J9B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
