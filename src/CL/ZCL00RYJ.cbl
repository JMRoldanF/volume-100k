      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00RYJ'.
      ...
      * Called module names
       01  MOD-ZCL01P8L              PIC X(8) VALUE 'ZCL01P8L'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01Q6H-001.
               PERFORM CALL-ZCL01P8L-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01P8L-002.
               CALL 'ZCL01P8L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01P8L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
