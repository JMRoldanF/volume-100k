      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL0127L'.
      ...
      * Called module names
       01  MOD-ZCN01SIX              PIC X(8) VALUE 'ZCN01SIX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCN01SIX-001.
               CALL 'ZCN01SIX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCN01SIX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
