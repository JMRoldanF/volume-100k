      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00YYR'.
      ...
      * Called module names
       01  MOD-ZCL01DNX              PIC X(8) VALUE 'ZCL01DNX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01DNX-001.
               CALL 'ZCL01DNX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01DNX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
