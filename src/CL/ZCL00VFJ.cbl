      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCL00VFJ'.
      ...
      * Called module names
       01  MOD-ZCL01GK3              PIC X(8) VALUE 'ZCL01GK3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01GK3-002.
               CALL 'ZCL01GK3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01GK3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
