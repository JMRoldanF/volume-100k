      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00U6J'.
      ...
      * Called module names
       01  MOD-ZCU01PR8              PIC X(8) VALUE 'ZCU01PR8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01PR8-001.
               CALL 'ZCU01PR8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01PR8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
