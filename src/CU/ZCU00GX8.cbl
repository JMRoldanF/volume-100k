      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00GX8'.
      ...
      * Called module names
       01  MOD-ZCU00SGD              PIC X(8) VALUE 'ZCU00SGD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEX01QCQ-002.
               PERFORM CALL-ZHO0255M-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCU00SGD-001.
               EXEC CICS LINK PROGRAM('ZCU00SGD')
