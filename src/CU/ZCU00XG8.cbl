      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00XG8'.
      ...
      * Called module names
       01  MOD-ZBR01SUB              PIC X(8) VALUE 'ZBR01SUB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01SUB-001.
               CALL 'ZBR01SUB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01SUB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
