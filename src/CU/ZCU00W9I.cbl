      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00W9I'.
      ...
      * Called module names
       01  MOD-ZCU01HAG              PIC X(8) VALUE 'ZCU01HAG'.
       01  MOD-ZCU01I2I              PIC X(8) VALUE 'ZCU01I2I'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01HAG-001.
               PERFORM CALL-ZCU01I2I-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01HAG-001.
               CALL 'ZCU01HAG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01HAG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01I2I-002.
               CALL 'ZCU01I2I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01I2I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
