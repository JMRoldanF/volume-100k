      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00YW8'.
      ...
      * Called module names
       01  MOD-ZCU01PJY              PIC X(8) VALUE 'ZCU01PJY'.
       01  MOD-ZCU01HC4              PIC X(8) VALUE 'ZCU01HC4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01PJY-001.
               CALL 'ZCU01PJY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01PJY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01HC4-002.
               CALL 'ZCU01HC4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01HC4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
