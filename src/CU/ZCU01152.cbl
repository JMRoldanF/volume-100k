      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01152'.
      ...
      * Called module names
       01  MOD-ZCU01OPE              PIC X(8) VALUE 'ZCU01OPE'.
       01  MOD-ZCU01ITG              PIC X(8) VALUE 'ZCU01ITG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01OPE-001.
               PERFORM CALL-ZCU01ITG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01OPE-001.
               CALL 'ZCU01OPE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01OPE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01ITG-002.
               CALL 'ZCU01ITG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01ITG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
