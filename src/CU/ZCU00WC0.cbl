      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00WC0'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01IOG              PIC X(8) VALUE 'ZCU01IOG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01LCY-001.
               PERFORM CALL-ZCU01IOG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01IOG-002.
               CALL 'ZCU01IOG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
