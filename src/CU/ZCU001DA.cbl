      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU001DA'.
      ...
      * Called module names
       ...
       01  MOD-ZPA000ZJ              PIC X(8) VALUE 'ZPA000ZJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU00HZM-002.
               PERFORM CALL-ZPA000ZJ-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA000ZJ-003.
               EXEC CICS XCTL PROGRAM('ZPA000ZJ')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA000ZJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-004.
