      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00VBC'.
      ...
      * Called module names
       01  MOD-ZCU01OE0              PIC X(8) VALUE 'ZCU01OE0'.
       01  MOD-ZCU01KSK              PIC X(8) VALUE 'ZCU01KSK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01OE0-001.
               PERFORM CALL-ZCU01KSK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01OE0-001.
               CALL 'ZCU01OE0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01KSK-002.
               CALL 'ZCU01KSK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01KSK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
