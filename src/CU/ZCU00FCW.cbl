      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00FCW'.
      ...
      * Called module names
       01  MOD-ZCU00VGM              PIC X(8) VALUE 'ZCU00VGM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU00VGM-001.
               PERFORM CALL-ZCU01ATO-002.
               PERFORM CALL-ZCU014ZO-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU00VGM-001.
               EXEC CICS LINK PROGRAM('ZCU00VGM')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00VGM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01ATO-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU014ZO-003.
               MOVE 'ZCU014ZO' TO WS-PROGNAME-8
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU014ZO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
