      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00VE2'.
      ...
      * Called module names
       01  MOD-ZCU01SCX              PIC X(8) VALUE 'ZCU01SCX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01SCX-001.
               CALL 'ZCU01SCX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01SCX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-TERM-0001.
