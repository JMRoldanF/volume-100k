      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00L67'.
      ...
      * Called module names
       01  MOD-ZCU01FZB              PIC X(8) VALUE 'ZCU01FZB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU00YEV-001.
               MOVE 'ZCU00YEV' TO WS-PROGNAME-4
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00YEV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01FZB-002.
               CALL 'ZCU01FZB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01FZB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
