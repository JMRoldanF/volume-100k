      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00G7G'.
      ...
      * Called module names
       01  MOD-ZCU00VEY              PIC X(8) VALUE 'ZCU00VEY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU00VEY-001.
               PERFORM CALL-ZCU01H4C-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU00VEY-001.
               EXEC CICS LINK PROGRAM('ZCU00VEY')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00VEY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01H4C-002.
               MOVE 'ZCU01H4C' TO WS-SUBNAME-7
