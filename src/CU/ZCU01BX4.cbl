      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01BX4'.
      ...
      * Called module names
       01  MOD-ZCU01JTA              PIC X(8) VALUE 'ZCU01JTA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01JTA-001.
               CALL 'ZCU01JTA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01JTA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-MODEL-0001.
