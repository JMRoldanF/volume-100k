      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00WES'.
      ...
      * Called module names
       01  MOD-ZCU01DYG              PIC X(8) VALUE 'ZCU01DYG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01DYG-001.
               PERFORM CALL-ZPA01GB1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01DYG-001.
               CALL 'ZCU01DYG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01DYG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01GB1-002.
