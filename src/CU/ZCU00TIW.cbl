      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00TIW'.
      ...
      * Called module names
       01  MOD-ZCU01NDM              PIC X(8) VALUE 'ZCU01NDM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01NDM-001.
               CALL 'ZCU01NDM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01NDM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
