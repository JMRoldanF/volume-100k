      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU010XC'.
      ...
      * Called module names
       01  MOD-ZCU01E58              PIC X(8) VALUE 'ZCU01E58'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01E58-001.
               CALL 'ZCU01E58' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01E58 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
