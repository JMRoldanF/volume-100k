      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00OPC'.
      ...
      * Called module names
       01  MOD-ZCU01CWR              PIC X(8) VALUE 'ZCU01CWR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01CWR-001.
               CALL 'ZCU01CWR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01CWR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-MAKE-0001.
