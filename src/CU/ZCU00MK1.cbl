      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00MK1'.
      ...
      * Called module names
       01  MOD-ZCU01GOH              PIC X(8) VALUE 'ZCU01GOH'.
       01  MOD-ZBR01MP3              PIC X(8) VALUE 'ZBR01MP3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01GOH-001.
               PERFORM CALL-ZBR01MP3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01GOH-001.
               CALL 'ZCU01GOH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01GOH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBR01MP3-002.
               CALL 'ZBR01MP3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01MP3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
