      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU011PM'.
      ...
      * Called module names
       01  MOD-ZCU01UEO              PIC X(8) VALUE 'ZCU01UEO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01UEO-001.
               PERFORM CALL-ZPA01P1R-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01UEO-001.
               CALL 'ZCU01UEO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01UEO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01P1R-002.
