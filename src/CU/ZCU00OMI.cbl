      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00OMI'.
      ...
      * Called module names
       01  MOD-ZCU01MEC              PIC X(8) VALUE 'ZCU01MEC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01MEC-002.
               CALL 'ZCU01MEC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01MEC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
