      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00QLC'.
      ...
      * Called module names
       01  MOD-ZUW01PZ4              PIC X(8) VALUE 'ZUW01PZ4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01PZ4-001.
               PERFORM CALL-ZCU01NXC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01PZ4-001.
               CALL 'ZUW01PZ4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01PZ4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01NXC-002.
