      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU011MA'.
      ...
      * Called module names
       01  MOD-ZBI01R5I              PIC X(8) VALUE 'ZBI01R5I'.
       01  MOD-ZHO01EFM              PIC X(8) VALUE 'ZHO01EFM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01R5I-001.
               PERFORM CALL-ZHO01EFM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01R5I-001.
               CALL 'ZBI01R5I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01R5I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01EFM-002.
               CALL 'ZHO01EFM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01EFM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
