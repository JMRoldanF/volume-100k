      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU017II'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01TFE              PIC X(8) VALUE 'ZCU01TFE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01TFE-002.
               CALL 'ZCU01TFE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
