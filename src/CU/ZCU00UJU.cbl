      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00UJU'.
      ...
      * Called module names
       01  MOD-ZCU01FL2              PIC X(8) VALUE 'ZCU01FL2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01FL2-002.
               CALL 'ZCU01FL2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
