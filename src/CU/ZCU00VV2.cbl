      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00VV2'.
      ...
      * Called module names
       01  MOD-ZCU01QUW              PIC X(8) VALUE 'ZCU01QUW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01QUW-001.
               CALL 'ZCU01QUW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01QUW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01J68-002.
               MOVE 'ZCU01J68' TO WS-SUBNAME-3
