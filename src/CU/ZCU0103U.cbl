      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU0103U'.
      ...
      * Called module names
       01  MOD-ZCU01HII              PIC X(8) VALUE 'ZCU01HII'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01HII-001.
               CALL 'ZCU01HII' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01HII FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
