      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00QDA'.
      ...
      * Called module names
       01  MOD-ZCU01JWM              PIC X(8) VALUE 'ZCU01JWM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01JWM-001.
               CALL 'ZCU01JWM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01JWM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
