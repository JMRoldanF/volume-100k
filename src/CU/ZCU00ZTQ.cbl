      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00ZTQ'.
      ...
      * Called module names
       01  MOD-ZCU01ILE              PIC X(8) VALUE 'ZCU01ILE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01ILE-001.
               CALL 'ZCU01ILE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01ILE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
