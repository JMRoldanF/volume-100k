      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00RZW'.
      ...
      * Called module names
       01  MOD-ZAG01NUO              PIC X(8) VALUE 'ZAG01NUO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01NUO-001.
               PERFORM CALL-ZCU01CYC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01NUO-001.
               CALL 'ZAG01NUO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01NUO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01CYC-002.
               MOVE 'ZCU01CYC' TO WS-SUBNAME-2
