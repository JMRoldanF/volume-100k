      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU006JY'.
      ...
      * Called module names
       01  MOD-ZCU00UUY              PIC X(8) VALUE 'ZCU00UUY'.
       01  MOD-ZCU012A6              PIC X(8) VALUE 'ZCU012A6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU00UUY-001.
               PERFORM CALL-ZCU012A6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU00UUY-001.
               EXEC CICS LINK PROGRAM('ZCU00UUY')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00UUY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU012A6-002.
               EXEC CICS LINK PROGRAM('ZCU012A6')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
