      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00S1A'.
      ...
      * Called module names
       01  MOD-ZCU01SKK              PIC X(8) VALUE 'ZCU01SKK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01SKK-001.
               PERFORM CALL-ZCU01SXW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01SKK-001.
               CALL 'ZCU01SKK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01SKK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01SXW-002.
