      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01A1C'.
      ...
      * Called module names
       01  MOD-ZCU01L02              PIC X(8) VALUE 'ZCU01L02'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01L02-001.
               CALL 'ZCU01L02' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01L02 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
