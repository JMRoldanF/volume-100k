      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00SDI'.
      ...
      * Called module names
       01  MOD-ZCU01SWS              PIC X(8) VALUE 'ZCU01SWS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01SWS-001.
               CALL 'ZCU01SWS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01SWS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
