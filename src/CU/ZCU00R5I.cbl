      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00R5I'.
      ...
      * Called module names
       01  MOD-ZBR01MM1              PIC X(8) VALUE 'ZBR01MM1'.
       01  MOD-ZCU01KEX              PIC X(8) VALUE 'ZCU01KEX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBR01MM1-001.
               PERFORM CALL-ZCU01KEX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01MM1-001.
               CALL 'ZBR01MM1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01MM1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01KEX-002.
               CALL 'ZCU01KEX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01KEX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
