      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU013P0'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01N3W              PIC X(8) VALUE 'ZCU01N3W'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01OKC-001.
               PERFORM CALL-ZCU01N3W-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01N3W-002.
               CALL 'ZCU01N3W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01N3W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
