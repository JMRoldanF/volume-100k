      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU010JC'.
      ...
      * Called module names
       ...
       01  MOD-ZBR01M9F              PIC X(8) VALUE 'ZBR01M9F'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01QD2-001.
               PERFORM CALL-ZBR01M9F-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01M9F-002.
               CALL 'ZBR01M9F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01M9F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
