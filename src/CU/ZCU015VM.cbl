      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU015VM'.
      ...
      * Called module names
       01  MOD-ZCU01E40              PIC X(8) VALUE 'ZCU01E40'.
       01  MOD-ZCU01DZ0              PIC X(8) VALUE 'ZCU01DZ0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01E40-001.
               PERFORM CALL-ZCU01DZ0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01E40-001.
               CALL 'ZCU01E40' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01E40 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01DZ0-002.
               CALL 'ZCU01DZ0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
