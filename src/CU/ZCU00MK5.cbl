      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00MK5'.
      ...
      * Called module names
       01  MOD-ZCU01SK9              PIC X(8) VALUE 'ZCU01SK9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01SK9-001.
               PERFORM FORMAT-MODEL-0001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCU01SK9-001.
               CALL 'ZCU01SK9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
