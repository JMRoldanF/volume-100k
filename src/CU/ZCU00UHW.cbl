      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00UHW'.
      ...
      * Called module names
       01  MOD-ZCU01HVU              PIC X(8) VALUE 'ZCU01HVU'.
       01  MOD-ZCU01RN8              PIC X(8) VALUE 'ZCU01RN8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01HVU-001.
               PERFORM CALL-ZCU01RN8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01HVU-001.
               CALL 'ZCU01HVU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01HVU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01RN8-002.
               CALL 'ZCU01RN8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01RN8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
