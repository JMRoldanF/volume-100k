      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU0178S'.
      ...
      * Called module names
       01  MOD-ZRE01HVN              PIC X(8) VALUE 'ZRE01HVN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01HVN-001.
               CALL 'ZRE01HVN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01HVN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
