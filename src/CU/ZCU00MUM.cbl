      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00MUM'.
      ...
      * Called module names
       01  MOD-ZCU01U4O              PIC X(8) VALUE 'ZCU01U4O'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01U4O-001.
               PERFORM CALL-ZCU01O4A-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01U4O-001.
               CALL 'ZCU01U4O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01U4O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01O4A-002.
