      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00P6I'.
      ...
      * Called module names
       01  MOD-ZCU01PXK              PIC X(8) VALUE 'ZCU01PXK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01PXK-001.
               CALL 'ZCU01PXK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01PXK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
