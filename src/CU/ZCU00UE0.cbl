      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00UE0'.
      ...
      * Called module names
       01  MOD-ZCU01I87              PIC X(8) VALUE 'ZCU01I87'.
       01  MOD-ZCU01N01              PIC X(8) VALUE 'ZCU01N01'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01I87-001.
               PERFORM CALL-ZCU01N01-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01I87-001.
               CALL 'ZCU01I87' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01I87 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01N01-002.
               CALL 'ZCU01N01' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01N01 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
