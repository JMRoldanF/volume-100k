      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00RYS'.
      ...
      * Called module names
       01  MOD-ZCU01DB4              PIC X(8) VALUE 'ZCU01DB4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01DB4-001.
               CALL 'ZCU01DB4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01DB4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01LF2-002.
