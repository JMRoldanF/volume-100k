      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00LZS'.
      ...
      * Called module names
       01  MOD-ZBI01TVU              PIC X(8) VALUE 'ZBI01TVU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01TVU-001.
               CALL 'ZBI01TVU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01TVU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01KOE-002.
