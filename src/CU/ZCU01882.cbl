      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01882'.
      ...
      * Called module names
       01  MOD-ZCU01D0U              PIC X(8) VALUE 'ZCU01D0U'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01D0U-001.
               CALL 'ZCU01D0U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01D0U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01KZK-002.
