      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00Y64'.
      ...
      * Called module names
       01  MOD-ZCU01HT2              PIC X(8) VALUE 'ZCU01HT2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01HT2-001.
               CALL 'ZCU01HT2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01HT2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
