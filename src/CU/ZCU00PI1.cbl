      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00PI1'.
      ...
      * Called module names
       01  MOD-ZCU01HW6              PIC X(8) VALUE 'ZCU01HW6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01HW6-001.
               CALL 'ZCU01HW6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01HW6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
