      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU010Y4'.
      ...
      * Called module names
       01  MOD-ZCU01S50              PIC X(8) VALUE 'ZCU01S50'.
       01  MOD-ZBI01DOS              PIC X(8) VALUE 'ZBI01DOS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01S50-001.
               PERFORM CALL-ZBI01DOS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01S50-001.
               CALL 'ZCU01S50' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01S50 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01DOS-002.
               CALL 'ZBI01DOS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01DOS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
