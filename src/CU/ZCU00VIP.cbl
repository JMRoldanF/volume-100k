      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00VIP'.
      ...
      * Called module names
       01  MOD-ZCU01STI              PIC X(8) VALUE 'ZCU01STI'.
       01  MOD-ZCU01HQT              PIC X(8) VALUE 'ZCU01HQT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01STI-001.
               PERFORM CALL-ZCU01HQT-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01STI-001.
               CALL 'ZCU01STI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01STI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01HQT-002.
               CALL 'ZCU01HQT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01HQT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
