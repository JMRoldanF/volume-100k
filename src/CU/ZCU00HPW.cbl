      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00HPW'.
      ...
      * Called module names
       01  MOD-ZCU00Z6S              PIC X(8) VALUE 'ZCU00Z6S'.
       01  MOD-ZCU01K94              PIC X(8) VALUE 'ZCU01K94'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU00Z6S-001.
               PERFORM CALL-ZCU017QU-002.
               PERFORM CALL-ZCU01O36-003.
               PERFORM CALL-ZCU01K94-004.
               PERFORM FORMAT-WITH-PROFITS-0001.
               PERFORM FORMAT-WITH-PROFITS-0002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCU00Z6S-001.
               EXEC CICS LINK PROGRAM('ZCU00Z6S')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00Z6S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU017QU-002.
               MOVE 'ZCU017QU' TO WS-PROGNAME-1
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU017QU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01O36-003.
               MOVE 'ZCU01O36' TO WS-SUBNAME-2
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01K94-004.
               CALL 'ZCU01K94' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01K94 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-005.
