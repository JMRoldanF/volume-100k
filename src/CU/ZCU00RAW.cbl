      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00RAW'.
      ...
      * Called module names
       01  MOD-ZCU01GS4              PIC X(8) VALUE 'ZCU01GS4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01GS4-001.
               CALL 'ZCU01GS4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01GS4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
