      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU0124W'.
      ...
      * Called module names
       01  MOD-ZCU01S9G              PIC X(8) VALUE 'ZCU01S9G'.
       01  MOD-ZCU01DZU              PIC X(8) VALUE 'ZCU01DZU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01S9G-001.
               CALL 'ZCU01S9G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01S9G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01DZU-002.
               CALL 'ZCU01DZU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
