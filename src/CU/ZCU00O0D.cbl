      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00O0D'.
      ...
      * Called module names
       01  MOD-ZCU01PWJ              PIC X(8) VALUE 'ZCU01PWJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01PWJ-001.
               CALL 'ZCU01PWJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01PWJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-MODEL-0001.
