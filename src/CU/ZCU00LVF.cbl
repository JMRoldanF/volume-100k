      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00LVF'.
      ...
      * Called module names
       01  MOD-ZCU01RI6              PIC X(8) VALUE 'ZCU01RI6'.
       01  MOD-ZCU01S0Y              PIC X(8) VALUE 'ZCU01S0Y'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01RI6-001.
               PERFORM CALL-ZCU01S0Y-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01RI6-001.
               CALL 'ZCU01RI6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01RI6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01S0Y-002.
               CALL 'ZCU01S0Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01S0Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
