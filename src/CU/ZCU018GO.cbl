      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU018GO'.
      ...
      * Called module names
       01  MOD-ZCU01HF6              PIC X(8) VALUE 'ZCU01HF6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01HF6-001.
               CALL 'ZCU01HF6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01HF6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
