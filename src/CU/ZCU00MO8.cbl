      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00MO8'.
      ...
      * Called module names
       01  MOD-ZCU01JPY              PIC X(8) VALUE 'ZCU01JPY'.
       01  MOD-ZBI01HL2              PIC X(8) VALUE 'ZBI01HL2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01JPY-001.
               CALL 'ZCU01JPY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01JPY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01HL2-002.
               CALL 'ZBI01HL2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01HL2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
