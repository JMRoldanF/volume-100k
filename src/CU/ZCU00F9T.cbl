      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00F9T'.
      ...
      * Called module names
       01  MOD-ZCU00RB3              PIC X(8) VALUE 'ZCU00RB3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU00RB3-001.
               EXEC CICS LINK PROGRAM('ZCU00RB3')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00RB3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
