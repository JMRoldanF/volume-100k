      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00YSC'.
      ...
      * Called module names
       01  MOD-ZCU01EFE              PIC X(8) VALUE 'ZCU01EFE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01EFE-001.
               CALL 'ZCU01EFE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01EFE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
