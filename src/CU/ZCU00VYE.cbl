      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00VYE'.
      ...
      * Called module names
       01  MOD-ZCU01OW2              PIC X(8) VALUE 'ZCU01OW2'.
       01  MOD-ZCU01I46              PIC X(8) VALUE 'ZCU01I46'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01OW2-001.
               PERFORM CALL-ZCU01I46-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01OW2-001.
               CALL 'ZCU01OW2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01OW2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01I46-002.
               CALL 'ZCU01I46' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01I46 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
