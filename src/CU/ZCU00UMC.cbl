      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00UMC'.
      ...
      * Called module names
       01  MOD-ZCU01OT0              PIC X(8) VALUE 'ZCU01OT0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01OT0-001.
               CALL 'ZCU01OT0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01OT0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
