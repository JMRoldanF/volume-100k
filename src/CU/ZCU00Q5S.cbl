      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00Q5S'.
      ...
      * Called module names
       01  MOD-ZPA01SJ1              PIC X(8) VALUE 'ZPA01SJ1'.
       01  MOD-ZCU01PYE              PIC X(8) VALUE 'ZCU01PYE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01SJ1-001.
               PERFORM CALL-ZCU01PYE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01SJ1-001.
               CALL 'ZPA01SJ1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01SJ1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01PYE-002.
               CALL 'ZCU01PYE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01PYE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
