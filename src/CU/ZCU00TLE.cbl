      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00TLE'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01LNH              PIC X(8) VALUE 'ZRE01LNH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01JAY-001.
               PERFORM CALL-ZRE01LNH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01LNH-002.
               CALL 'ZRE01LNH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01LNH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
