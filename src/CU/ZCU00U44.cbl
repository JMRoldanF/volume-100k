      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00U44'.
      ...
      * Called module names
       01  MOD-ZCU01MRV              PIC X(8) VALUE 'ZCU01MRV'.
       01  MOD-ZCU01MCV              PIC X(8) VALUE 'ZCU01MCV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01MRV-001.
               CALL 'ZCU01MRV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01MRV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01MCV-002.
               CALL 'ZCU01MCV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01MCV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
