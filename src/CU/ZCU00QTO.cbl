      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00QTO'.
      ...
      * Called module names
       01  MOD-ZCU01RQ0              PIC X(8) VALUE 'ZCU01RQ0'.
       01  MOD-ZCU01RAG              PIC X(8) VALUE 'ZCU01RAG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01RQ0-001.
               PERFORM CALL-ZCU01RAG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01RQ0-001.
               CALL 'ZCU01RQ0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01RQ0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01RAG-002.
               CALL 'ZCU01RAG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01RAG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
