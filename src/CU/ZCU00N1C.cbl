      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00N1C'.
      ...
      * Called module names
       01  MOD-ZCU01IKR              PIC X(8) VALUE 'ZCU01IKR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01IKR-001.
               CALL 'ZCU01IKR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01IKR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
