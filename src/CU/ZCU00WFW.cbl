      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00WFW'.
      ...
      * Called module names
       01  MOD-ZCU01ERW              PIC X(8) VALUE 'ZCU01ERW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01ERW-001.
               CALL 'ZCU01ERW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01ERW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-MAKE-0001.
