      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00W34'.
      ...
      * Called module names
       01  MOD-ZCU01FS0              PIC X(8) VALUE 'ZCU01FS0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01FS0-001.
               CALL 'ZCU01FS0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01FS0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01E2M-002.
               MOVE 'ZCU01E2M' TO WS-SUBNAME-4
