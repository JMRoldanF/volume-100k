      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00N4W'.
      ...
      * Called module names
       01  MOD-ZEN01T2B              PIC X(8) VALUE 'ZEN01T2B'.
       01  MOD-ZCU01H38              PIC X(8) VALUE 'ZCU01H38'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01T2B-001.
               PERFORM CALL-ZCU01H38-002.
               PERFORM REFRESH-WITH-PROFITS-0001.
               PERFORM AUDIT-CC-RATING-0002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZEN01T2B-001.
               CALL 'ZEN01T2B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01T2B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01H38-002.
               CALL 'ZCU01H38' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01H38 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
