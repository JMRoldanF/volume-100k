      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00NUQ'.
      ...
      * Called module names
       01  MOD-ZCU01T2M              PIC X(8) VALUE 'ZCU01T2M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01T2M-001.
               CALL 'ZCU01T2M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
