      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01NPK'.
      ...
      * Called module names
       01  MOD-ZCU01KDU              PIC X(8) VALUE 'ZCU01KDU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01KDU-001.
               CALL 'ZCU01KDU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01KDU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
