      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00U0O'.
      ...
      * Called module names
       01  MOD-ZCU01GYI              PIC X(8) VALUE 'ZCU01GYI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01GYI-001.
               CALL 'ZCU01GYI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01GYI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
