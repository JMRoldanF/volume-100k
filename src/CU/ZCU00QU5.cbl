      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00QU5'.
      ...
      * Called module names
       01  MOD-ZCU01HWS              PIC X(8) VALUE 'ZCU01HWS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01HWS-001.
               CALL 'ZCU01HWS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01HWS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
