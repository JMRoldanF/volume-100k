      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU010KI'.
      ...
      * Called module names
       01  MOD-ZCU01NCS              PIC X(8) VALUE 'ZCU01NCS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01NCS-001.
               CALL 'ZCU01NCS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01NCS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
