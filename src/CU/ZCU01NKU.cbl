      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01NKU'.
      ...
      * Called module names
       01  MOD-ZCU01RPG              PIC X(8) VALUE 'ZCU01RPG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01RPG-001.
               CALL 'ZCU01RPG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01RPG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
