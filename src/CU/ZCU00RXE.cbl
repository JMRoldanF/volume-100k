      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00RXE'.
      ...
      * Called module names
       01  MOD-ZCL01RRZ              PIC X(8) VALUE 'ZCL01RRZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01RRZ-001.
               CALL 'ZCL01RRZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01RRZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
