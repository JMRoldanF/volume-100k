      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01791'.
      ...
      * Called module names
       01  MOD-ZCU01RN9              PIC X(8) VALUE 'ZCU01RN9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01RN9-001.
               CALL 'ZCU01RN9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01RN9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
