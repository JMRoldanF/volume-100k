      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU000H9'.
      ...
      * Called module names
       01  MOD-ZCU00HDQ              PIC X(8) VALUE 'ZCU00HDQ'.
       01  MOD-ZCU00HQM              PIC X(8) VALUE 'ZCU00HQM'.
       01  MOD-ZCU004MT              PIC X(8) VALUE 'ZCU004MT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU00HDQ-001.
               PERFORM CALL-ZCU00HQM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU00HDQ-001.
               EXEC CICS LINK PROGRAM('ZCU00HDQ')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00HDQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU00HQM-002.
               EXEC CICS LINK PROGRAM('ZCU00HQM')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00HQM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU004MT-003.
               EXEC CICS XCTL PROGRAM('ZCU004MT')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU004MT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
