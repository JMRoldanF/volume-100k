      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU011MU'.
      ...
      * Called module names
       01  MOD-ZCU01QE8              PIC X(8) VALUE 'ZCU01QE8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01QE8-001.
               CALL 'ZCU01QE8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01QE8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
