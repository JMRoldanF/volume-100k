      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00S1U'.
      ...
      * Called module names
       01  MOD-ZCU01LES              PIC X(8) VALUE 'ZCU01LES'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01LES-001.
               CALL 'ZCU01LES' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01LES FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-PREMIUM-0001.
