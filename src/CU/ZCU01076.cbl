      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01076'.
      ...
      * Called module names
       01  MOD-ZCU01QTI              PIC X(8) VALUE 'ZCU01QTI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01QTI-001.
               PERFORM CALL-ZCU01H7E-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01QTI-001.
               CALL 'ZCU01QTI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01QTI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01H7E-002.
