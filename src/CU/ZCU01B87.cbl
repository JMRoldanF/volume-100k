      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01B87'.
      ...
      * Called module names
       01  MOD-ZCU01QS3              PIC X(8) VALUE 'ZCU01QS3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01QS3-001.
               PERFORM CALL-ZCU01CRC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01QS3-001.
               CALL 'ZCU01QS3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01QS3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01CRC-002.
