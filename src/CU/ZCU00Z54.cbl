      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00Z54'.
      ...
      * Called module names
       01  MOD-ZUW01TC8              PIC X(8) VALUE 'ZUW01TC8'.
       01  MOD-ZCU01EHW              PIC X(8) VALUE 'ZCU01EHW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01TC8-001.
               CALL 'ZUW01TC8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01TC8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01EHW-002.
               CALL 'ZCU01EHW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01EHW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
