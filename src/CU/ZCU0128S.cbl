      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU0128S'.
      ...
      * Called module names
       01  MOD-ZCU01LDE              PIC X(8) VALUE 'ZCU01LDE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01LDE-001.
               PERFORM CALL-ZCU01UM6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01LDE-001.
               CALL 'ZCU01LDE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01LDE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01UM6-002.
