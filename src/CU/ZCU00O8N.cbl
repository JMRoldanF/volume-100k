      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00O8N'.
      ...
      * Called module names
       01  MOD-ZSL01H66              PIC X(8) VALUE 'ZSL01H66'.
       01  MOD-ZCU01Q1E              PIC X(8) VALUE 'ZCU01Q1E'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSL01H66-001.
               PERFORM CALL-ZCU01Q1E-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSL01H66-001.
               CALL 'ZSL01H66' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSL01H66 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01Q1E-002.
               CALL 'ZCU01Q1E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01Q1E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-BEDROOMS-0001.
