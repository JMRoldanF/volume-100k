      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00XBP'.
      ...
      * Called module names
       01  MOD-ZCU01UKV              PIC X(8) VALUE 'ZCU01UKV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01UKV-001.
               CALL 'ZCU01UKV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01UKV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
