      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU002JR'.
      ...
      * Called module names
       01  MOD-ZCU00D3N              PIC X(8) VALUE 'ZCU00D3N'.
       01  MOD-ZCU004IW              PIC X(8) VALUE 'ZCU004IW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU00D3N-001.
               PERFORM CALL-ZCU00G1C-002.
               PERFORM CALL-ZCU004IW-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU00D3N-001.
               EXEC CICS LINK PROGRAM('ZCU00D3N')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00D3N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU00G1C-002.
               MOVE 'ZCU00G1C' TO WS-PROGNAME-6
      ...
      *----------------------------------------------------------------*
       CALL-ZCU004IW-003.
               EXEC CICS XCTL PROGRAM('ZCU004IW')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU004IW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-004.
