      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00Y9E'.
      ...
      * Called module names
       01  MOD-ZCU01MWQ              PIC X(8) VALUE 'ZCU01MWQ'.
       01  MOD-ZCU01PAO              PIC X(8) VALUE 'ZCU01PAO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01MWQ-001.
               PERFORM CALL-ZCU01PAO-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01MWQ-001.
               CALL 'ZCU01MWQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01MWQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01PAO-002.
               CALL 'ZCU01PAO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01PAO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
