      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00X56'.
      ...
      * Called module names
       01  MOD-ZCU01L9I              PIC X(8) VALUE 'ZCU01L9I'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01L9I-001.
               CALL 'ZCU01L9I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01L9I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
