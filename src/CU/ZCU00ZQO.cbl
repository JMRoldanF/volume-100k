      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00ZQO'.
      ...
      * Called module names
       01  MOD-ZCU01MLF              PIC X(8) VALUE 'ZCU01MLF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01MLF-001.
               CALL 'ZCU01MLF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01MLF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01T7H-002.
               MOVE 'ZCU01T7H' TO WS-SUBNAME-6
