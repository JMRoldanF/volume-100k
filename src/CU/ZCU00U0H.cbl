      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00U0H'.
      ...
      * Called module names
       01  MOD-ZBR01FLC              PIC X(8) VALUE 'ZBR01FLC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01FLC-001.
               CALL 'ZBR01FLC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01FLC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSL01MKR-002.
