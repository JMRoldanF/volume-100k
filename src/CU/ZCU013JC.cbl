      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU013JC'.
      ...
      * Called module names
       01  MOD-ZCU01T3K              PIC X(8) VALUE 'ZCU01T3K'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01T3K-001.
               CALL 'ZCU01T3K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01T3K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
