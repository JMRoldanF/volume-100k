      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00NNI'.
      ...
      * Called module names
       01  MOD-ZCU01K1W              PIC X(8) VALUE 'ZCU01K1W'.
       01  MOD-ZCU01EH2              PIC X(8) VALUE 'ZCU01EH2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01K1W-001.
               PERFORM CALL-ZCU01EH2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01K1W-001.
               CALL 'ZCU01K1W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01K1W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01EH2-002.
               CALL 'ZCU01EH2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01EH2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
