      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00TJG'.
      ...
      * Called module names
       01  MOD-ZCU01PUI              PIC X(8) VALUE 'ZCU01PUI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01PUI-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCU01O9K-001.
               MOVE 'ZCU01O9K' TO WS-SUBNAME-6
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01PUI-002.
               CALL 'ZCU01PUI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
