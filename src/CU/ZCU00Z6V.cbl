      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00Z6V'.
      ...
      * Called module names
       01  MOD-ZBR01O0D              PIC X(8) VALUE 'ZBR01O0D'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBR01O0D-001.
               PERFORM CALL-ZBR01RM8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01O0D-001.
               CALL 'ZBR01O0D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01O0D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBR01RM8-002.
