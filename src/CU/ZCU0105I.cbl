      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU0105I'.
      ...
      * Called module names
       01  MOD-ZCU01N32              PIC X(8) VALUE 'ZCU01N32'.
       01  MOD-ZCU01ET0              PIC X(8) VALUE 'ZCU01ET0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01N32-001.
               CALL 'ZCU01N32' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01N32 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01ET0-002.
               CALL 'ZCU01ET0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01ET0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
