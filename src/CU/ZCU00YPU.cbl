      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00YPU'.
      ...
      * Called module names
       01  MOD-ZCL01F4P              PIC X(8) VALUE 'ZCL01F4P'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01F4P-001.
               CALL 'ZCL01F4P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01F4P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
