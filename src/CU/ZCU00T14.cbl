      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00T14'.
      ...
      * Called module names
       01  MOD-ZCU01QN4              PIC X(8) VALUE 'ZCU01QN4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01QN4-001.
               CALL 'ZCU01QN4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01QN4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-MODEL-0001.
