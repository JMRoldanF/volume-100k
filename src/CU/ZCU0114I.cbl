      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU0114I'.
      ...
      * Called module names
       01  MOD-ZCU01GKW              PIC X(8) VALUE 'ZCU01GKW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01GKW-001.
               PERFORM CALL-ZRE01S67-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01GKW-001.
               CALL 'ZCU01GKW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01GKW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01S67-002.
