      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00PYK'.
      ...
      * Called module names
       01  MOD-ZCU01K81              PIC X(8) VALUE 'ZCU01K81'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01K81-001.
               PERFORM CALL-ZCU01LE3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01K81-001.
               CALL 'ZCU01K81' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01K81 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01LE3-002.
