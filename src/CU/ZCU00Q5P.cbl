      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00Q5P'.
      ...
      * Called module names
       01  MOD-ZCU01JBP              PIC X(8) VALUE 'ZCU01JBP'.
       01  MOD-ZCU01G9N              PIC X(8) VALUE 'ZCU01G9N'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01JBP-001.
               PERFORM CALL-ZCU01G9N-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01JBP-001.
               CALL 'ZCU01JBP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01JBP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01G9N-002.
               CALL 'ZCU01G9N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01G9N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
