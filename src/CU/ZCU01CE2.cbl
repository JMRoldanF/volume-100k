      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01CE2'.
      ...
      * Called module names
       01  MOD-ZCU01F94              PIC X(8) VALUE 'ZCU01F94'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01F94-001.
               CALL 'ZCU01F94' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01F94 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01OAY-002.
