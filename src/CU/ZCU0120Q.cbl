      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU0120Q'.
      ...
      * Called module names
       01  MOD-ZCU01LB6              PIC X(8) VALUE 'ZCU01LB6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01LB6-001.
               CALL 'ZCU01LB6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01LB6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
