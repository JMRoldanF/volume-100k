      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU014A4'.
      ...
      * Called module names
       01  MOD-ZCU01JJ0              PIC X(8) VALUE 'ZCU01JJ0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01JJ0-001.
               PERFORM CALL-ZAG0255S-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCU01JJ0-001.
               CALL 'ZCU01JJ0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
