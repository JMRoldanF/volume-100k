      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00PCM'.
      ...
      * Called module names
       01  MOD-ZCU01K12              PIC X(8) VALUE 'ZCU01K12'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01K12-001.
               CALL 'ZCU01K12' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01K12 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
