      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00KEQ'.
      ...
      * Called module names
       01  MOD-ZCU00UXN              PIC X(8) VALUE 'ZCU00UXN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU00UXN-001.
               EXEC CICS LINK PROGRAM('ZCU00UXN')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00UXN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
