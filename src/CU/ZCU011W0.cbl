      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU011W0'.
      ...
      * Called module names
       01  MOD-ZCU01IZ0              PIC X(8) VALUE 'ZCU01IZ0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01IZ0-001.
               CALL 'ZCU01IZ0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01IZ0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
