      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00ZP2'.
      ...
      * Called module names
       01  MOD-ZCU01GFC              PIC X(8) VALUE 'ZCU01GFC'.
       01  MOD-ZCU01FZ7              PIC X(8) VALUE 'ZCU01FZ7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01GFC-001.
               PERFORM CALL-ZCU01FZ7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01GFC-001.
               CALL 'ZCU01GFC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01GFC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01FZ7-002.
               CALL 'ZCU01FZ7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01FZ7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
