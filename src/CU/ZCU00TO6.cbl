      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00TO6'.
      ...
      * Called module names
       01  MOD-ZCU01HVK              PIC X(8) VALUE 'ZCU01HVK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01RP6-001.
               PERFORM CALL-ZCU01HVK-002.
               PERFORM CALL-ZRE0255R-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCU01RP6-001.
               MOVE 'ZCU01RP6' TO WS-SUBNAME-6
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01HVK-002.
               CALL 'ZCU01HVK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01HVK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
