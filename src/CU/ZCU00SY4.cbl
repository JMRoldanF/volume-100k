      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00SY4'.
      ...
      * Called module names
       01  MOD-ZCU01OTN              PIC X(8) VALUE 'ZCU01OTN'.
       01  MOD-ZCU01MSX              PIC X(8) VALUE 'ZCU01MSX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01OTN-001.
               PERFORM CALL-ZCU01MSX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01OTN-001.
               CALL 'ZCU01OTN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01OTN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01MSX-002.
               CALL 'ZCU01MSX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01MSX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
