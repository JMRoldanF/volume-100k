      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU0041Y'.
      ...
      * Called module names
       01  MOD-ZCU007PC              PIC X(8) VALUE 'ZCU007PC'.
       01  MOD-ZCU006VC              PIC X(8) VALUE 'ZCU006VC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU006VC-002.
               PERFORM CALL-ZCU008BU-003.
               PERFORM CALL-ZCL0005Z-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU007PC-001.
               EXEC CICS LINK PROGRAM('ZCU007PC')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU007PC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU006VC-002.
               EXEC CICS LINK PROGRAM('ZCU006VC')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU006VC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU008BU-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL0005Z-004.
               EXEC CICS START TRANSID('Z05Z')
                         FROM(WS-KEY-AREA)
                         LENGTH(20)
                         RESP(WS-RESP)
               END-EXEC.
      * TRANSID Z05Z is defined against ZCL0005Z
               IF WS-RESP NOT = DFHRESP(NORMAL)
