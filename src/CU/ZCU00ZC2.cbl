      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00ZC2'.
      ...
      * Called module names
       01  MOD-ZCU01TRM              PIC X(8) VALUE 'ZCU01TRM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01MTC-001.
               PERFORM CALL-ZCU01TRM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01TRM-002.
               CALL 'ZCU01TRM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01TRM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
