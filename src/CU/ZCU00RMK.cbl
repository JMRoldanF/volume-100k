      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00RMK'.
      ...
      * Called module names
       01  MOD-ZBI01EJC              PIC X(8) VALUE 'ZBI01EJC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CHECK-WITH-PROFITS-0071.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01EJC-001.
               CALL 'ZBI01EJC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01EJC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
