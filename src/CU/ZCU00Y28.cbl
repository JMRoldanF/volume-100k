      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00Y28'.
      ...
      * Called module names
       01  MOD-ZCU01KGM              PIC X(8) VALUE 'ZCU01KGM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01KGM-001.
               CALL 'ZCU01KGM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01KGM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01NAK-002.
