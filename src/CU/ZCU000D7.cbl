      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU000D7'.
      ...
      * Called module names
       01  MOD-ZCU00AWF              PIC X(8) VALUE 'ZCU00AWF'.
       01  MOD-ZEX00FNS              PIC X(8) VALUE 'ZEX00FNS'.
       01  MOD-ZSL00HNB              PIC X(8) VALUE 'ZSL00HNB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU00AWF-001.
               PERFORM CALL-ZEX00FNS-002.
               PERFORM CALL-ZCU00FNY-003.
               PERFORM CALL-ZSL00HNB-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU00AWF-001.
               EXEC CICS LINK PROGRAM('ZCU00AWF')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00AWF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEX00FNS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU00FNY-003.
               MOVE 'ZCU00FNY' TO WS-PROGNAME-5
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00FNY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSL00HNB-004.
               EXEC CICS LINK PROGRAM('ZSL00HNB')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSL00HNB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
