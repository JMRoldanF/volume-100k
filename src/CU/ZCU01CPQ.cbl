      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01CPQ'.
      ...
      * Called module names
       01  MOD-ZPA01IVT              PIC X(8) VALUE 'ZPA01IVT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01IVT-001.
               CALL 'ZPA01IVT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
