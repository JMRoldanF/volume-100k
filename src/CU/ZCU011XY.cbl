      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU011XY'.
      ...
      * Called module names
       01  MOD-ZCU01RY2              PIC X(8) VALUE 'ZCU01RY2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01RY2-001.
               CALL 'ZCU01RY2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01RY2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-MODEL-0001.
