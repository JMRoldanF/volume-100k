      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00TW8'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01R4W              PIC X(8) VALUE 'ZCU01R4W'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01R4W-002.
               CALL 'ZCU01R4W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
