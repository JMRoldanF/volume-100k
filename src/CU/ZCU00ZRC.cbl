      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00ZRC'.
      ...
      * Called module names
       01  MOD-ZHO01J1Q              PIC X(8) VALUE 'ZHO01J1Q'.
       01  MOD-ZHO01H9A              PIC X(8) VALUE 'ZHO01H9A'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01J1Q-001.
               PERFORM CALL-ZHO01H9A-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01J1Q-001.
               CALL 'ZHO01J1Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01J1Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01H9A-002.
               CALL 'ZHO01H9A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01H9A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
