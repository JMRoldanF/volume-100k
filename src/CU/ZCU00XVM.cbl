      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00XVM'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01G1N              PIC X(8) VALUE 'ZCU01G1N'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01G1N-002.
               CALL 'ZCU01G1N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01G1N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-EQUITIES-0001.
