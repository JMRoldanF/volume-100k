      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00PP3'.
      ...
      * Called module names
       01  MOD-ZEX01TSR              PIC X(8) VALUE 'ZEX01TSR'.
       01  MOD-ZCU01NRY              PIC X(8) VALUE 'ZCU01NRY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEX01TSR-001.
               PERFORM CALL-ZCU01NRY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEX01TSR-001.
               CALL 'ZEX01TSR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEX01TSR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01NRY-002.
               CALL 'ZCU01NRY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01NRY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
