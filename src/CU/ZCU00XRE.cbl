      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00XRE'.
      ...
      * Called module names
       01  MOD-ZMT01KJL              PIC X(8) VALUE 'ZMT01KJL'.
       01  MOD-ZCU01P4O              PIC X(8) VALUE 'ZCU01P4O'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01KJL-001.
               PERFORM CALL-ZCU01P4O-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01KJL-001.
               CALL 'ZMT01KJL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01KJL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01P4O-002.
               CALL 'ZCU01P4O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01P4O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
