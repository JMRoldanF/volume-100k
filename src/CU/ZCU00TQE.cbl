      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00TQE'.
      ...
      * Called module names
       01  MOD-ZCL01U8V              PIC X(8) VALUE 'ZCL01U8V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01U8V-001.
               CALL 'ZCL01U8V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01U8V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
