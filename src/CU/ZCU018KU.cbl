      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU018KU'.
      ...
      * Called module names
       01  MOD-ZCU01SU0              PIC X(8) VALUE 'ZCU01SU0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01SU0-001.
               CALL 'ZCU01SU0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01SU0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
