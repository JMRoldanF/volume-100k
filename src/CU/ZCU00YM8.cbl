      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00YM8'.
      ...
      * Called module names
       01  MOD-ZCU01G4S              PIC X(8) VALUE 'ZCU01G4S'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01G4S-001.
               PERFORM CALL-ZCU01QWA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01G4S-001.
               CALL 'ZCU01G4S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01G4S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01QWA-002.
