      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU0104Y'.
      ...
      * Called module names
       01  MOD-ZCU01IB4              PIC X(8) VALUE 'ZCU01IB4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01IB4-001.
               CALL 'ZCU01IB4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01IB4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
