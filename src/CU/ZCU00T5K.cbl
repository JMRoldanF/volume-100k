      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00T5K'.
      ...
      * Called module names
       01  MOD-ZCU01PMQ              PIC X(8) VALUE 'ZCU01PMQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01PMQ-001.
               PERFORM CALL-ZCU01J68-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01PMQ-001.
               CALL 'ZCU01PMQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01PMQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01J68-002.
