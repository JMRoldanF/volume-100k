      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00KT7'.
      ...
      * Called module names
       01  MOD-ZCU00PNX              PIC X(8) VALUE 'ZCU00PNX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU00PNX-001.
               EXEC CICS LINK PROGRAM('ZCU00PNX')
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01BYR-002.
               MOVE 'ZCU01BYR' TO WS-PROGNAME-5
