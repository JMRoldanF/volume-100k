      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU010MQ'.
      ...
      * Called module names
       01  MOD-ZCU01NM8              PIC X(8) VALUE 'ZCU01NM8'.
       01  MOD-ZCU01F1W              PIC X(8) VALUE 'ZCU01F1W'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01NM8-001.
               PERFORM CALL-ZCU01F1W-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01NM8-001.
               CALL 'ZCU01NM8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01NM8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01F1W-002.
               CALL 'ZCU01F1W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01F1W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-PREMIUM-0001.
