      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00Q72'.
      ...
      * Called module names
       01  MOD-ZCU01L25              PIC X(8) VALUE 'ZCU01L25'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01L25-001.
               PERFORM CALL-ZCU01E9Q-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01L25-001.
               CALL 'ZCU01L25' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01L25 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01E9Q-002.
