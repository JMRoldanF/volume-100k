      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00P0Y'.
      ...
      * Called module names
       01  MOD-ZCU01J0O              PIC X(8) VALUE 'ZCU01J0O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01J0O-001.
               CALL 'ZCU01J0O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01J0O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01S8M-002.
