      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00O7S'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01F6M              PIC X(8) VALUE 'ZCU01F6M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01F6M-002.
               CALL 'ZCU01F6M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01F6M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
