      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU015W5'.
      ...
      * Called module names
       01  MOD-ZEX01DJX              PIC X(8) VALUE 'ZEX01DJX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEX01DJX-001.
               CALL 'ZEX01DJX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEX01DJX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
