      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU0195E'.
      ...
      * Called module names
       01  MOD-ZCU01HP6              PIC X(8) VALUE 'ZCU01HP6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01HP6-001.
               CALL 'ZCU01HP6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01HP6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
