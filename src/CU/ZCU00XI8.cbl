      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00XI8'.
      ...
      * Called module names
       01  MOD-ZCU01IHI              PIC X(8) VALUE 'ZCU01IHI'.
       01  MOD-ZCU01Q66              PIC X(8) VALUE 'ZCU01Q66'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01IHI-001.
               PERFORM CALL-ZCU01Q66-002.
               PERFORM EXPAND-REG-NUMBER-0001.
               PERFORM DERIVE-REG-NUMBER-0002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCU01IHI-001.
               CALL 'ZCU01IHI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01IHI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01Q66-002.
               CALL 'ZCU01Q66' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01Q66 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
