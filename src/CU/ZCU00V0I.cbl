      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00V0I'.
      ...
      * Called module names
       01  MOD-ZCU01UU8              PIC X(8) VALUE 'ZCU01UU8'.
       01  MOD-ZCU01FMQ              PIC X(8) VALUE 'ZCU01FMQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01UU8-001.
               PERFORM CALL-ZCU01FMQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01UU8-001.
               CALL 'ZCU01UU8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01UU8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01FMQ-002.
               CALL 'ZCU01FMQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01FMQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
