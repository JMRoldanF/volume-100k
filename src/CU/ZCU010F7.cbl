      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU010F7'.
      ...
      * Called module names
       01  MOD-ZCU01DV1              PIC X(8) VALUE 'ZCU01DV1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01DV1-001.
               CALL 'ZCU01DV1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01DV1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01QHR-002.
