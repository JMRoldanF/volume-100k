      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00UMM'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01L6L              PIC X(8) VALUE 'ZPA01L6L'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01L6L-002.
               CALL 'ZPA01L6L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01L6L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
