      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00PT0'.
      ...
      * Called module names
       01  MOD-ZCU01L0W              PIC X(8) VALUE 'ZCU01L0W'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01L0W-001.
               CALL 'ZCU01L0W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01L0W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
