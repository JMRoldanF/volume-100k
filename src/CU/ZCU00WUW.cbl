      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00WUW'.
      ...
      * Called module names
       01  MOD-ZCU01GHU              PIC X(8) VALUE 'ZCU01GHU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01GHU-001.
               CALL 'ZCU01GHU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01GHU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
