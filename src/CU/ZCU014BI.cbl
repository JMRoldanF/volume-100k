      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU014BI'.
      ...
      * Called module names
       01  MOD-ZCU01GRK              PIC X(8) VALUE 'ZCU01GRK'.
       01  MOD-ZCU01KE4              PIC X(8) VALUE 'ZCU01KE4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01GRK-001.
               PERFORM CALL-ZCU01KE4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01GRK-001.
               CALL 'ZCU01GRK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01GRK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01KE4-002.
               CALL 'ZCU01KE4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01KE4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
