      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00LYH'.
      ...
      * Called module names
       01  MOD-ZCU01QRQ              PIC X(8) VALUE 'ZCU01QRQ'.
       01  MOD-ZCU01UD3              PIC X(8) VALUE 'ZCU01UD3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01QRQ-001.
               PERFORM CALL-ZCU01UD3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01QRQ-001.
               CALL 'ZCU01QRQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01QRQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01UD3-002.
               CALL 'ZCU01UD3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01UD3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-COLOUR-0001.
