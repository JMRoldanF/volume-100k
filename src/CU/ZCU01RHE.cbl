      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01RHE'.
      ...
      * Called module names
       01  MOD-ZCU01H8S              PIC X(8) VALUE 'ZCU01H8S'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01H8S-001.
               CALL 'ZCU01H8S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01H8S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
