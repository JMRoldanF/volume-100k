      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01CVA'.
      ...
      * Called module names
       01  MOD-ZRE01ULF              PIC X(8) VALUE 'ZRE01ULF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01ULF-001.
               CALL 'ZRE01ULF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01ULF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
