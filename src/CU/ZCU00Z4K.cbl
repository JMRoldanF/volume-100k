      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00Z4K'.
      ...
      * Called module names
       01  MOD-ZCU01JH2              PIC X(8) VALUE 'ZCU01JH2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01JH2-001.
               CALL 'ZCU01JH2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01JH2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
