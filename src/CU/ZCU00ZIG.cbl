      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00ZIG'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01M38              PIC X(8) VALUE 'ZCU01M38'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01M38-002.
               CALL 'ZCU01M38' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01M38 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
