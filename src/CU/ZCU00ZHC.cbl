      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00ZHC'.
      ...
      * Called module names
       01  MOD-ZCU01QJS              PIC X(8) VALUE 'ZCU01QJS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01QJS-001.
               CALL 'ZCU01QJS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01QJS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
