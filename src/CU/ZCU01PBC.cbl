      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01PBC'.
      ...
      * Called module names
       01  MOD-ZRE01S85              PIC X(8) VALUE 'ZRE01S85'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01S85-001.
               CALL 'ZRE01S85' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01S85 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
