      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00YE2'.
      ...
      * Called module names
       01  MOD-ZCU01JR4              PIC X(8) VALUE 'ZCU01JR4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01JR4-001.
               CALL 'ZCU01JR4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01JR4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
