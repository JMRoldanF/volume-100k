      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00VB2'.
      ...
      * Called module names
       01  MOD-ZCU01E1S              PIC X(8) VALUE 'ZCU01E1S'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01E1S-001.
               PERFORM CALL-ZCU01PJO-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01E1S-001.
               CALL 'ZCU01E1S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01E1S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01PJO-002.
