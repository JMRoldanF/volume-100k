      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00ZJA'.
      ...
      * Called module names
       01  MOD-ZEN01EVH              PIC X(8) VALUE 'ZEN01EVH'.
       01  MOD-ZCU01TJ0              PIC X(8) VALUE 'ZCU01TJ0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01EVH-001.
               PERFORM CALL-ZCU01TJ0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01EVH-001.
               CALL 'ZEN01EVH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01EVH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01TJ0-002.
               CALL 'ZCU01TJ0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01TJ0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
