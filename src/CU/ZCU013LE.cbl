      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU013LE'.
      ...
      * Called module names
       01  MOD-ZUW01P9K              PIC X(8) VALUE 'ZUW01P9K'.
       01  MOD-ZCU01IDM              PIC X(8) VALUE 'ZCU01IDM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01P9K-001.
               PERFORM CALL-ZCU01IDM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01P9K-001.
               CALL 'ZUW01P9K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01P9K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01IDM-002.
               CALL 'ZCU01IDM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01IDM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
