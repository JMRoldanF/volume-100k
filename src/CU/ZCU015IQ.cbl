      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU015IQ'.
      ...
      * Called module names
       01  MOD-ZBR01JUK              PIC X(8) VALUE 'ZBR01JUK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01JUK-001.
               CALL 'ZBR01JUK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01JUK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
