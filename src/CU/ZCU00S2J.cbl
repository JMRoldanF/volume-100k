      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00S2J'.
      ...
      * Called module names
       01  MOD-ZCU01TEZ              PIC X(8) VALUE 'ZCU01TEZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01TEZ-001.
               CALL 'ZCU01TEZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01TEZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
