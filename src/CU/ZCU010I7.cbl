      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU010I7'.
      ...
      * Called module names
       01  MOD-ZCU01O9N              PIC X(8) VALUE 'ZCU01O9N'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01O9N-001.
               CALL 'ZCU01O9N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01O9N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01NWI-002.
