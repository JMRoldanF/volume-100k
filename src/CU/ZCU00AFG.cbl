      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00AFG'.
      ...
      * Called module names
       01  MOD-ZEX00OGH              PIC X(8) VALUE 'ZEX00OGH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEX00OGH-001.
               EXEC CICS LINK PROGRAM('ZEX00OGH')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEX00OGH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
