      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU013IC'.
      ...
      * Called module names
       01  MOD-ZCU01TIQ              PIC X(8) VALUE 'ZCU01TIQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01TIQ-001.
               PERFORM CALL-ZCU01SZA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01TIQ-001.
               CALL 'ZCU01TIQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01TIQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01SZA-002.
