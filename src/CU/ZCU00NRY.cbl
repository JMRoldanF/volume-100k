      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00NRY'.
      ...
      * Called module names
       01  MOD-ZCU01IBO              PIC X(8) VALUE 'ZCU01IBO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01IBO-001.
               PERFORM CALL-ZCU01JKY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01IBO-001.
               CALL 'ZCU01IBO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01IBO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01JKY-002.
