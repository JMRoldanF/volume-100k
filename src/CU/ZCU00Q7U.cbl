      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00Q7U'.
      ...
      * Called module names
       01  MOD-ZEX01FKI              PIC X(8) VALUE 'ZEX01FKI'.
       01  MOD-ZCU01T25              PIC X(8) VALUE 'ZCU01T25'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEX01FKI-001.
               PERFORM CALL-ZCU01T25-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEX01FKI-001.
               CALL 'ZEX01FKI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEX01FKI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01T25-002.
               CALL 'ZCU01T25' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01T25 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
