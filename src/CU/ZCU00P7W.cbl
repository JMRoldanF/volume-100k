      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00P7W'.
      ...
      * Called module names
       01  MOD-ZRE01D3F              PIC X(8) VALUE 'ZRE01D3F'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01D3F-001.
               CALL 'ZRE01D3F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01D3F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
