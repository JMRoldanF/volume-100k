      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00SBU'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01SAU              PIC X(8) VALUE 'ZCU01SAU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01SAU-002.
               CALL 'ZCU01SAU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
