      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01FL2'.
      ...
      * Called module names
       01  MOD-ZCU01I9G              PIC X(8) VALUE 'ZCU01I9G'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01I9G-001.
               CALL 'ZCU01I9G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01I9G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
