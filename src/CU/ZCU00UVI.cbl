      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00UVI'.
      ...
      * Called module names
       01  MOD-ZCU01QBQ              PIC X(8) VALUE 'ZCU01QBQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01QBQ-001.
               CALL 'ZCU01QBQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01QBQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
