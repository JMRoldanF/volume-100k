      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00PCW'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01PYY              PIC X(8) VALUE 'ZCU01PYY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01I00-001.
               PERFORM CALL-ZCU01PYY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01PYY-002.
               CALL 'ZCU01PYY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01PYY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
