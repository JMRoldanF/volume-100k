      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00QEO'.
      ...
      * Called module names
       01  MOD-ZCU01R8I              PIC X(8) VALUE 'ZCU01R8I'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01R8I-001.
               CALL 'ZCU01R8I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01R8I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
