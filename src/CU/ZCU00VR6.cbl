      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00VR6'.
      ...
      * Called module names
       01  MOD-ZCU01T6S              PIC X(8) VALUE 'ZCU01T6S'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01T6S-001.
               CALL 'ZCU01T6S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01T6S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
