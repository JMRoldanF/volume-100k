      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00PPZ'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01SAM              PIC X(8) VALUE 'ZCU01SAM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01SAM-002.
               CALL 'ZCU01SAM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
