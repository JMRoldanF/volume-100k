      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00N2Y'.
      ...
      * Called module names
       01  MOD-ZCU01GV6              PIC X(8) VALUE 'ZCU01GV6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01GV6-001.
               CALL 'ZCU01GV6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01GV6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
