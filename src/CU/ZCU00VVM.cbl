      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00VVM'.
      ...
      * Called module names
       01  MOD-ZCU01F2G              PIC X(8) VALUE 'ZCU01F2G'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01F2G-001.
               CALL 'ZCU01F2G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01F2G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
