      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00YAX'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01OIS              PIC X(8) VALUE 'ZCU01OIS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEX01RSI-001.
               PERFORM CALL-ZCU01OIS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01OIS-002.
               CALL 'ZCU01OIS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01OIS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
