      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00R3E'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01D46              PIC X(8) VALUE 'ZCU01D46'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01T68-001.
               PERFORM CALL-ZCU01D46-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01D46-002.
               CALL 'ZCU01D46' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01D46 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-EQUITIES-0001.
