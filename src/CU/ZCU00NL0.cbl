      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00NL0'.
      ...
      * Called module names
       01  MOD-ZCU01GWA              PIC X(8) VALUE 'ZCU01GWA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01GWA-001.
               CALL 'ZCU01GWA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01GWA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
