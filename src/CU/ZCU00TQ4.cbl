      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00TQ4'.
      ...
      * Called module names
       01  MOD-ZCU01J9K              PIC X(8) VALUE 'ZCU01J9K'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01J9K-001.
               CALL 'ZCU01J9K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01J9K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
