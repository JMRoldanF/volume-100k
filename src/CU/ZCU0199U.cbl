      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU0199U'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01LZC              PIC X(8) VALUE 'ZCU01LZC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01LZC-002.
               CALL 'ZCU01LZC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
