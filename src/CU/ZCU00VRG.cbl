      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00VRG'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01F8A              PIC X(8) VALUE 'ZCU01F8A'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01F8A-002.
               CALL 'ZCU01F8A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
