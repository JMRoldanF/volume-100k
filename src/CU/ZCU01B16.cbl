      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01B16'.
      ...
      * Called module names
       01  MOD-ZCU01ONB              PIC X(8) VALUE 'ZCU01ONB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01ONB-001.
               CALL 'ZCU01ONB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01ONB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
