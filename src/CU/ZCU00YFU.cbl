      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00YFU'.
      ...
      * Called module names
       01  MOD-ZCU01LOI              PIC X(8) VALUE 'ZCU01LOI'.
       01  MOD-ZPA01CU1              PIC X(8) VALUE 'ZPA01CU1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01LOI-001.
               PERFORM CALL-ZPA01CU1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01LOI-001.
               CALL 'ZCU01LOI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01LOI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01CU1-002.
               CALL 'ZPA01CU1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01CU1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
