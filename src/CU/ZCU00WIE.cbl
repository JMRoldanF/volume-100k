      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00WIE'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01R8S              PIC X(8) VALUE 'ZCU01R8S'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01R8S-002.
               CALL 'ZCU01R8S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01R8S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
