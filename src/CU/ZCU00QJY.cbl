      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00QJY'.
      ...
      * Called module names
       01  MOD-ZCU01J5E              PIC X(8) VALUE 'ZCU01J5E'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01J5E-001.
               CALL 'ZCU01J5E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01J5E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01GEI-002.
