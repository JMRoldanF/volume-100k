      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00V39'.
      ...
      * Called module names
       01  MOD-ZCU01T2S              PIC X(8) VALUE 'ZCU01T2S'.
       01  MOD-ZCU01CZ1              PIC X(8) VALUE 'ZCU01CZ1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01T2S-001.
               PERFORM CALL-ZCU01CZ1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01T2S-001.
               CALL 'ZCU01T2S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01T2S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01CZ1-002.
               CALL 'ZCU01CZ1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01CZ1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
