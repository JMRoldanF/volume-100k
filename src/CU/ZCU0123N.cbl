      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU0123N'.
      ...
      * Called module names
       01  MOD-ZCU01L6X              PIC X(8) VALUE 'ZCU01L6X'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01L6X-001.
               CALL 'ZCU01L6X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01L6X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEX01DUE-002.
