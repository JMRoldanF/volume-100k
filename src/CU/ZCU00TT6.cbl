      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00TT6'.
      ...
      * Called module names
       01  MOD-ZCU01SJG              PIC X(8) VALUE 'ZCU01SJG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01SJG-001.
               PERFORM CALL-ZCU01DTG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01SJG-001.
               CALL 'ZCU01SJG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01SJG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01DTG-002.
               MOVE 'ZCU01DTG' TO WS-SUBNAME-5
