      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00NEC'.
      ...
      * Called module names
       01  MOD-ZCU01K8A              PIC X(8) VALUE 'ZCU01K8A'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01K8A-001.
               CALL 'ZCU01K8A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01K8A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-TERM-0001.
