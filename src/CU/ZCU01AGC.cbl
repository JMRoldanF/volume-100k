      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01AGC'.
      ...
      * Called module names
       01  MOD-ZCU01HU6              PIC X(8) VALUE 'ZCU01HU6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01HU6-001.
               CALL 'ZCU01HU6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01HU6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-PREMIUM-0001.
