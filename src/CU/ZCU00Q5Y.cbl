      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00Q5Y'.
      ...
      * Called module names
       01  MOD-ZCU01TLT              PIC X(8) VALUE 'ZCU01TLT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01TLT-001.
               CALL 'ZCU01TLT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01TLT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
