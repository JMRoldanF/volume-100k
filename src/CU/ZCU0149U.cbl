      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU0149U'.
      ...
      * Called module names
       01  MOD-ZCU01RJ2              PIC X(8) VALUE 'ZCU01RJ2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01IV4-001.
               PERFORM CALL-ZCU01RJ2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01RJ2-002.
               CALL 'ZCU01RJ2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01RJ2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
