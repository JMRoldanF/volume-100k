      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00RR0'.
      ...
      * Called module names
       01  MOD-ZRE01I4J              PIC X(8) VALUE 'ZRE01I4J'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01I4J-001.
               CALL 'ZRE01I4J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01I4J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
