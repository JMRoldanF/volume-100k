      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00VZS'.
      ...
      * Called module names
       01  MOD-ZCU01FQC              PIC X(8) VALUE 'ZCU01FQC'.
       01  MOD-ZCU01OEU              PIC X(8) VALUE 'ZCU01OEU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01FQC-001.
               PERFORM CALL-ZCU01OEU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01FQC-001.
               CALL 'ZCU01FQC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01FQC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01OEU-002.
               CALL 'ZCU01OEU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01OEU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
