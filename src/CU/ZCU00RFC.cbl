      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00RFC'.
      ...
      * Called module names
       01  MOD-ZCU01KPI              PIC X(8) VALUE 'ZCU01KPI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01KPI-001.
               CALL 'ZCU01KPI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01KPI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
