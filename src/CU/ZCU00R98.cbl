      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00R98'.
      ...
      * Called module names
       01  MOD-ZCU01TJU              PIC X(8) VALUE 'ZCU01TJU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01PNA-001.
               PERFORM CALL-ZCU01TJU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01TJU-002.
               CALL 'ZCU01TJU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01TJU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
