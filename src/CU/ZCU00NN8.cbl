      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00NN8'.
      ...
      * Called module names
       01  MOD-ZCU01MBA              PIC X(8) VALUE 'ZCU01MBA'.
       01  MOD-ZCU01EGS              PIC X(8) VALUE 'ZCU01EGS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01MBA-001.
               CALL 'ZCU01MBA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01MBA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01EGS-002.
               CALL 'ZCU01EGS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01EGS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-VALUE-0001.
