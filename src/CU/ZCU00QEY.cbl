      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00QEY'.
      ...
      * Called module names
       01  MOD-ZCU01CXI              PIC X(8) VALUE 'ZCU01CXI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01CXI-001.
               CALL 'ZCU01CXI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01CXI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01JE0-002.
