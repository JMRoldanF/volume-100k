      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00OHI'.
      ...
      * Called module names
       01  MOD-ZRE01DML              PIC X(8) VALUE 'ZRE01DML'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01DML-001.
               PERFORM CALL-ZCU01NS2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01DML-001.
               CALL 'ZRE01DML' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01DML FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01NS2-002.
