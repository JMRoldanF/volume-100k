      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01H2T'.
      ...
      * Called module names
       01  MOD-ZCU01OLB              PIC X(8) VALUE 'ZCU01OLB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01OLB-001.
               CALL 'ZCU01OLB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01OLB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
