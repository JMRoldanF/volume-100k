      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00QH6'.
      ...
      * Called module names
       01  MOD-ZCU01DV4              PIC X(8) VALUE 'ZCU01DV4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01DV4-001.
               PERFORM CALL-ZCU01DSW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01DV4-001.
               CALL 'ZCU01DV4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01DV4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01DSW-002.
               MOVE 'ZCU01DSW' TO WS-SUBNAME-5
