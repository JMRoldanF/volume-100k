      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU013YQ'.
      ...
      * Called module names
       01  MOD-ZCU01E9A              PIC X(8) VALUE 'ZCU01E9A'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01E9A-001.
               CALL 'ZCU01E9A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01E9A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
