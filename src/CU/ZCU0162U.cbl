      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU0162U'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01QMA              PIC X(8) VALUE 'ZCU01QMA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01QMA-002.
               CALL 'ZCU01QMA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01QMA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
