      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU010MV'.
      ...
      * Called module names
       01  MOD-ZCU01Q5V              PIC X(8) VALUE 'ZCU01Q5V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01Q5V-001.
               CALL 'ZCU01Q5V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01Q5V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEX01UQR-002.
