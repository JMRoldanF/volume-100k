      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU010LQ'.
      ...
      * Called module names
       01  MOD-ZCU01GUG              PIC X(8) VALUE 'ZCU01GUG'.
       01  MOD-ZCU01K5U              PIC X(8) VALUE 'ZCU01K5U'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01GUG-001.
               PERFORM CALL-ZCU01K5U-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01GUG-001.
               CALL 'ZCU01GUG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01GUG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01K5U-002.
               CALL 'ZCU01K5U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01K5U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
