      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01N1O'.
      ...
      * Called module names
       01  MOD-ZCU01E6S              PIC X(8) VALUE 'ZCU01E6S'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01E6S-001.
               CALL 'ZCU01E6S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01E6S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
