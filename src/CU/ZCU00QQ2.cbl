      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00QQ2'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01M4C              PIC X(8) VALUE 'ZCU01M4C'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01M4C-002.
               CALL 'ZCU01M4C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01M4C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
