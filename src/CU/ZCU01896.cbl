      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01896'.
      ...
      * Called module names
       01  MOD-ZCU01S8C              PIC X(8) VALUE 'ZCU01S8C'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01S8C-001.
               PERFORM CALL-ZCU01UMQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01S8C-001.
               CALL 'ZCU01S8C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01S8C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01UMQ-002.
