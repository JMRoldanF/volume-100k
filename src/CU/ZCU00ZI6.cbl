      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00ZI6'.
      ...
      * Called module names
       01  MOD-ZCU01PNK              PIC X(8) VALUE 'ZCU01PNK'.
       01  MOD-ZEN01IE5              PIC X(8) VALUE 'ZEN01IE5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01PNK-001.
               PERFORM CALL-ZEN01IE5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01PNK-001.
               CALL 'ZCU01PNK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01PNK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01IE5-002.
               CALL 'ZEN01IE5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01IE5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
