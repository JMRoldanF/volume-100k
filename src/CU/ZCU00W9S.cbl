      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00W9S'.
      ...
      * Called module names
       01  MOD-ZCU01EWW              PIC X(8) VALUE 'ZCU01EWW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01EWW-001.
               CALL 'ZCU01EWW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01EWW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01QWA-002.
