      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00X42'.
      ...
      * Called module names
       ...
       01  MOD-ZUW01ML6              PIC X(8) VALUE 'ZUW01ML6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01ML6-002.
               CALL 'ZUW01ML6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
