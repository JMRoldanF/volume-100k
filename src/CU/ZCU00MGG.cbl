      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00MGG'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01JFV              PIC X(8) VALUE 'ZMT01JFV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01JFV-002.
               CALL 'ZMT01JFV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01JFV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
