      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00YDW'.
      ...
      * Called module names
       01  MOD-ZBI01PSM              PIC X(8) VALUE 'ZBI01PSM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01PSM-001.
               PERFORM CALL-ZCU01Q8E-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01PSM-001.
               CALL 'ZBI01PSM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01PSM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01Q8E-002.
