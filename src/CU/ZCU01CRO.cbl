      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01CRO'.
      ...
      * Called module names
       01  MOD-ZCU01UVM              PIC X(8) VALUE 'ZCU01UVM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01UVM-001.
               CALL 'ZCU01UVM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01UVM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
