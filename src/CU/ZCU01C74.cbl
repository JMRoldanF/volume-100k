      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01C74'.
      ...
      * Called module names
       01  MOD-ZCU01R88              PIC X(8) VALUE 'ZCU01R88'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01R88-002.
               CALL 'ZCU01R88' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01R88 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-EQUITIES-0001.
