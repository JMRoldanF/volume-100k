      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00LTE'.
      ...
      * Called module names
       01  MOD-ZCU01S8W              PIC X(8) VALUE 'ZCU01S8W'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01S8W-001.
               CALL 'ZCU01S8W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01S8W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
