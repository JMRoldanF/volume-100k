      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01BWU'.
      ...
      * Called module names
       01  MOD-ZPA01PY9              PIC X(8) VALUE 'ZPA01PY9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01PY9-001.
               PERFORM CALL-ZCU01H6K-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01PY9-001.
               CALL 'ZPA01PY9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01PY9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01H6K-002.
