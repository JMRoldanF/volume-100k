      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00R02'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01L66              PIC X(8) VALUE 'ZCU01L66'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01ETA-001.
               PERFORM CALL-ZCU01L66-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01L66-002.
               CALL 'ZCU01L66' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
