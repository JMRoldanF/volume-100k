      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00YD2'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01JYK              PIC X(8) VALUE 'ZCU01JYK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01GFY-001.
               PERFORM CALL-ZCU01JYK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01JYK-002.
               CALL 'ZCU01JYK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01JYK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
