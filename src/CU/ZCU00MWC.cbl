      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00MWC'.
      ...
      * Called module names
       01  MOD-ZCU01NCD              PIC X(8) VALUE 'ZCU01NCD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01NCD-001.
               CALL 'ZCU01NCD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01NCD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-COLOUR-0001.
