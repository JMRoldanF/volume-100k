      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00NHE'.
      ...
      * Called module names
       01  MOD-ZCU01P94              PIC X(8) VALUE 'ZCU01P94'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01P94-001.
               CALL 'ZCU01P94' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01P94 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
