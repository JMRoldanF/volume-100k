      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01C4M'.
      ...
      * Called module names
       01  MOD-ZCU01QZM              PIC X(8) VALUE 'ZCU01QZM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01QZM-001.
               CALL 'ZCU01QZM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01QZM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
