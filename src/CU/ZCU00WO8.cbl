      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00WO8'.
      ...
      * Called module names
       01  MOD-ZCU01ORC              PIC X(8) VALUE 'ZCU01ORC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01ORC-001.
               CALL 'ZCU01ORC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01ORC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01U1W-002.
