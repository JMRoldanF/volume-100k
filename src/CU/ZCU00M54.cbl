      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00M54'.
      ...
      * Called module names
       01  MOD-ZCU01KJ3              PIC X(8) VALUE 'ZCU01KJ3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01KJ3-001.
               CALL 'ZCU01KJ3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01KJ3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
