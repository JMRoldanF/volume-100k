      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00NMO'.
      ...
      * Called module names
       01  MOD-ZCU01QAM              PIC X(8) VALUE 'ZCU01QAM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01QAM-001.
               CALL 'ZCU01QAM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01QAM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
