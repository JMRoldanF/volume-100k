      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00ZKE'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01LJI              PIC X(8) VALUE 'ZCU01LJI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01ESQ-001.
               PERFORM CALL-ZCU01LJI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01LJI-002.
               CALL 'ZCU01LJI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01LJI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
