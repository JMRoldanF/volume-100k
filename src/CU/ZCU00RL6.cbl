      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00RL6'.
      ...
      * Called module names
       01  MOD-ZCU01SUK              PIC X(8) VALUE 'ZCU01SUK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01SUK-001.
               CALL 'ZCU01SUK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01SUK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
