      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01L8M'.
      ...
      * Called module names
       01  MOD-ZCU01CSG              PIC X(8) VALUE 'ZCU01CSG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01CSG-001.
               CALL 'ZCU01CSG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01CSG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
