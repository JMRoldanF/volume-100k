      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00XTW'.
      ...
      * Called module names
       01  MOD-ZCU01U58              PIC X(8) VALUE 'ZCU01U58'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01U58-001.
               CALL 'ZCU01U58' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01U58 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
