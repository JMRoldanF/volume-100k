      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU010AI'.
      ...
      * Called module names
       01  MOD-ZCL01RWZ              PIC X(8) VALUE 'ZCL01RWZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01RWZ-001.
               PERFORM CALL-ZCU01KA8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01RWZ-001.
               CALL 'ZCL01RWZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01RWZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01KA8-002.
