      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00Z0K'.
      ...
      * Called module names
       01  MOD-ZCU01TIA              PIC X(8) VALUE 'ZCU01TIA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01TIA-001.
               PERFORM CALL-ZCU01SIK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01TIA-001.
               CALL 'ZCU01TIA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01TIA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01SIK-002.
