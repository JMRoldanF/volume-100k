      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00QSU'.
      ...
      * Called module names
       01  MOD-ZCU01JQE              PIC X(8) VALUE 'ZCU01JQE'.
       01  MOD-ZCU01S0V              PIC X(8) VALUE 'ZCU01S0V'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01JQE-001.
               PERFORM CALL-ZCU01S0V-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01JQE-001.
               CALL 'ZCU01JQE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01JQE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01S0V-002.
               CALL 'ZCU01S0V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01S0V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
