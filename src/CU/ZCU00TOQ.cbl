      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00TOQ'.
      ...
      * Called module names
       01  MOD-ZUW01SVU              PIC X(8) VALUE 'ZUW01SVU'.
       01  MOD-ZCU01V1Q              PIC X(8) VALUE 'ZCU01V1Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01SVU-001.
               CALL 'ZUW01SVU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01SVU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01V1Q-002.
               CALL 'ZCU01V1Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
