      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00LZ8'.
      ...
      * Called module names
       01  MOD-ZCU01U6C              PIC X(8) VALUE 'ZCU01U6C'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01U6C-001.
               CALL 'ZCU01U6C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01U6C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-EXCESS-0001.
