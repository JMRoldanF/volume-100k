      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU010SA'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01GSE              PIC X(8) VALUE 'ZCU01GSE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01GSE-002.
               CALL 'ZCU01GSE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
