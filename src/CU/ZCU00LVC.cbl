      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00LVC'.
      ...
      * Called module names
       01  MOD-ZCU01PDA              PIC X(8) VALUE 'ZCU01PDA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01PDA-001.
               PERFORM CALL-ZCU01TMC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01PDA-001.
               CALL 'ZCU01PDA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
