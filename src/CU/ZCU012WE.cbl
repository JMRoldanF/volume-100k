      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU012WE'.
      ...
      * Called module names
       01  MOD-ZCU01GDE              PIC X(8) VALUE 'ZCU01GDE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01GDE-002.
               CALL 'ZCU01GDE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
