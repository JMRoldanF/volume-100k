      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00UAF'.
      ...
      * Called module names
       01  MOD-ZBR01K3W              PIC X(8) VALUE 'ZBR01K3W'.
       01  MOD-ZCU01NQ9              PIC X(8) VALUE 'ZCU01NQ9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBR01K3W-001.
               PERFORM CALL-ZCU01NQ9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01K3W-001.
               CALL 'ZBR01K3W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01K3W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01NQ9-002.
               CALL 'ZCU01NQ9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01NQ9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
