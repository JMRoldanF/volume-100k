      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00MQQ'.
      ...
      * Called module names
       01  MOD-ZCU01UZI              PIC X(8) VALUE 'ZCU01UZI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01UZI-001.
               CALL 'ZCU01UZI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01UZI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
