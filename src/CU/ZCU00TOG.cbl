      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00TOG'.
      ...
      * Called module names
       01  MOD-ZCU01TZO              PIC X(8) VALUE 'ZCU01TZO'.
       01  MOD-ZCU01DRI              PIC X(8) VALUE 'ZCU01DRI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01TZO-001.
               PERFORM CALL-ZCU01DRI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01TZO-001.
               CALL 'ZCU01TZO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01TZO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01DRI-002.
               CALL 'ZCU01DRI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01DRI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
