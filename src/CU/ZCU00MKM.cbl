      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00MKM'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01SVE              PIC X(8) VALUE 'ZCU01SVE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01SVE-002.
               CALL 'ZCU01SVE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
