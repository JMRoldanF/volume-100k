      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00O32'.
      ...
      * Called module names
       01  MOD-ZCU01GWK              PIC X(8) VALUE 'ZCU01GWK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01GWK-001.
               CALL 'ZCU01GWK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01GWK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
