      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00OH5'.
      ...
      * Called module names
       01  MOD-ZCU01EIY              PIC X(8) VALUE 'ZCU01EIY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01EIY-001.
               CALL 'ZCU01EIY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01EIY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
