      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU0143G'.
      ...
      * Called module names
       01  MOD-ZCU01IM8              PIC X(8) VALUE 'ZCU01IM8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01IM8-001.
               CALL 'ZCU01IM8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01IM8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
