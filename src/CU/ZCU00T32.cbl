      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00T32'.
      ...
      * Called module names
       01  MOD-ZCU01F8U              PIC X(8) VALUE 'ZCU01F8U'.
       01  MOD-ZCU01SLO              PIC X(8) VALUE 'ZCU01SLO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01F8U-001.
               PERFORM CALL-ZCU01SLO-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01F8U-001.
               CALL 'ZCU01F8U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01F8U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01SLO-002.
               CALL 'ZCU01SLO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01SLO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
