      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01RD8'.
      ...
      * Called module names
       01  MOD-ZHO01NL2              PIC X(8) VALUE 'ZHO01NL2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01NL2-001.
               CALL 'ZHO01NL2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01NL2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
