      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00N5Q'.
      ...
      * Called module names
       01  MOD-ZCU01PS0              PIC X(8) VALUE 'ZCU01PS0'.
       01  MOD-ZCU01F0I              PIC X(8) VALUE 'ZCU01F0I'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01PS0-001.
               PERFORM CALL-ZCU01F0I-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01PS0-001.
               CALL 'ZCU01PS0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01PS0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01F0I-002.
               CALL 'ZCU01F0I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01F0I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
