      ...
      * Called module names
       01  MOD-ZCU01LCI              PIC X(8) VALUE 'ZCU01LCI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01LCI-002.
               CALL 'ZCU01LCI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01LCI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RECONCILE-MAKE-0001.
