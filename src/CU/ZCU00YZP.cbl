      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00YZP'.
      ...
      * Called module names
       01  MOD-ZCU01GEO              PIC X(8) VALUE 'ZCU01GEO'.
       01  MOD-ZBR01TI8              PIC X(8) VALUE 'ZBR01TI8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01GEO-001.
               PERFORM CALL-ZBR01TI8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01GEO-001.
               CALL 'ZCU01GEO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01GEO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBR01TI8-002.
               CALL 'ZBR01TI8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01TI8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
