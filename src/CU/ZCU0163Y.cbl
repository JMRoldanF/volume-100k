      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU0163Y'.
      ...
      * Called module names
       01  MOD-ZCU01MSS              PIC X(8) VALUE 'ZCU01MSS'.
       01  MOD-ZCU01E86              PIC X(8) VALUE 'ZCU01E86'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01MSS-001.
               PERFORM CALL-ZCU01E86-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01MSS-001.
               CALL 'ZCU01MSS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01MSS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01E86-002.
               CALL 'ZCU01E86' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01E86 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
