      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU0100S'.
      ...
      * Called module names
       01  MOD-ZCU01O0E              PIC X(8) VALUE 'ZCU01O0E'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01O0E-001.
               CALL 'ZCU01O0E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01O0E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01H9W-002.
