      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU004KK'.
      ...
      * Called module names
       01  MOD-ZCU00KFY              PIC X(8) VALUE 'ZCU00KFY'.
       01  MOD-ZCU00CNO              PIC X(8) VALUE 'ZCU00CNO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU00KFY-001.
               EXEC CICS LINK PROGRAM('ZCU00KFY')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00KFY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU00CNO-002.
               EXEC CICS LINK PROGRAM('ZCU00CNO')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00CNO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
