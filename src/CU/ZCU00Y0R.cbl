      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00Y0R'.
      ...
      * Called module names
       01  MOD-ZCU01JXY              PIC X(8) VALUE 'ZCU01JXY'.
       01  MOD-ZCU01CXA              PIC X(8) VALUE 'ZCU01CXA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01JXY-001.
               PERFORM CALL-ZCU01CXA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01JXY-001.
               CALL 'ZCU01JXY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01JXY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01CXA-002.
               CALL 'ZCU01CXA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01CXA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
