      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00QL2'.
      ...
      * Called module names
       01  MOD-ZCU01EMC              PIC X(8) VALUE 'ZCU01EMC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01EMC-001.
               CALL 'ZCU01EMC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01EMC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
