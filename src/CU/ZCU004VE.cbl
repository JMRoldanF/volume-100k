      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU004VE'.
      ...
      * Called module names
       01  MOD-ZCU00D0Q              PIC X(8) VALUE 'ZCU00D0Q'.
       01  MOD-ZCU00KUY              PIC X(8) VALUE 'ZCU00KUY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU00D0Q-001.
               EXEC CICS LINK PROGRAM('ZCU00D0Q')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00D0Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU00KUY-002.
               EXEC CICS LINK PROGRAM('ZCU00KUY')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00KUY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
