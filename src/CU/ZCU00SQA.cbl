      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00SQA'.
      ...
      * Called module names
       01  MOD-ZCU01L0M              PIC X(8) VALUE 'ZCU01L0M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01L0M-001.
               CALL 'ZCU01L0M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01L0M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01CYM-002.
