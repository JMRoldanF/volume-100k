      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00RUC'.
      ...
      * Called module names
       01  MOD-ZCU01KOE              PIC X(8) VALUE 'ZCU01KOE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01KOE-001.
               CALL 'ZCU01KOE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01KOE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
