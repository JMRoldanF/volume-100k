      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU016SO'.
      ...
      * Called module names
       01  MOD-ZCU01PBW              PIC X(8) VALUE 'ZCU01PBW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01PBW-001.
               CALL 'ZCU01PBW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01PBW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
