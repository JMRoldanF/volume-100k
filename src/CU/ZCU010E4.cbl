      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU010E4'.
      ...
      * Called module names
       01  MOD-ZCU01STG              PIC X(8) VALUE 'ZCU01STG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01STG-001.
               CALL 'ZCU01STG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01STG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
