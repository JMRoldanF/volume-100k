      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU012KQ'.
      ...
      * Called module names
       01  MOD-ZCU01NA0              PIC X(8) VALUE 'ZCU01NA0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01NA0-001.
               CALL 'ZCU01NA0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01NA0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01FJ7-002.
               MOVE 'ZRE01FJ7' TO WS-SUBNAME-2
