      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00WGQ'.
      ...
      * Called module names
       01  MOD-ZCU01S82              PIC X(8) VALUE 'ZCU01S82'.
       01  MOD-ZCU01KY4              PIC X(8) VALUE 'ZCU01KY4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01S82-001.
               PERFORM CALL-ZCU01KY4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01S82-001.
               CALL 'ZCU01S82' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01S82 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01KY4-002.
               CALL 'ZCU01KY4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01KY4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
