      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00UNQ'.
      ...
      * Called module names
       01  MOD-ZCU01FXK              PIC X(8) VALUE 'ZCU01FXK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01FXK-002.
               CALL 'ZCU01FXK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01FXK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
