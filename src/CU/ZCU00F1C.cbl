      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00F1C'.
      ...
      * Called module names
       01  MOD-ZCU00WNZ              PIC X(8) VALUE 'ZCU00WNZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU00WNZ-001.
               EXEC CICS LINK PROGRAM('ZCU00WNZ')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00WNZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSL01QRL-002.
