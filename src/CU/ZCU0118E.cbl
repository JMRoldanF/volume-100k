      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU0118E'.
      ...
      * Called module names
       01  MOD-ZCU01GTS              PIC X(8) VALUE 'ZCU01GTS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01GTS-001.
               CALL 'ZCU01GTS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01GTS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
