      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU0125Q'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01OPO              PIC X(8) VALUE 'ZCU01OPO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01OPO-002.
               CALL 'ZCU01OPO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01OPO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
