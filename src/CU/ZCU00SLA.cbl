      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00SLA'.
      ...
      * Called module names
       01  MOD-ZCU01QZC              PIC X(8) VALUE 'ZCU01QZC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01QZC-001.
               CALL 'ZCU01QZC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01QZC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
