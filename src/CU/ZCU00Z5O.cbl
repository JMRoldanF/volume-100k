      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00Z5O'.
      ...
      * Called module names
       01  MOD-ZCU01UVW              PIC X(8) VALUE 'ZCU01UVW'.
       01  MOD-ZCU01FXU              PIC X(8) VALUE 'ZCU01FXU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01UVW-001.
               PERFORM CALL-ZCU01FXU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01UVW-001.
               CALL 'ZCU01UVW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01UVW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01FXU-002.
               CALL 'ZCU01FXU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01FXU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-EXCESS-0001.
