      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00U2V'.
      ...
      * Called module names
       01  MOD-ZCU01JT2              PIC X(8) VALUE 'ZCU01JT2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01JT2-001.
               CALL 'ZCU01JT2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01JT2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
