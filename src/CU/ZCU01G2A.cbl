      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01G2A'.
      ...
      * Called module names
       01  MOD-ZCU01L8O              PIC X(8) VALUE 'ZCU01L8O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01L8O-001.
               CALL 'ZCU01L8O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01L8O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
