      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00Z46'.
      ...
      * Called module names
       01  MOD-ZCU01QVU              PIC X(8) VALUE 'ZCU01QVU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01QVU-001.
               CALL 'ZCU01QVU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01QVU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
