      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00PDL'.
      ...
      * Called module names
       01  MOD-ZCU01OH4              PIC X(8) VALUE 'ZCU01OH4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01OH4-001.
               CALL 'ZCU01OH4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01OH4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
