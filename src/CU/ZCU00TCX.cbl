      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00TCX'.
      ...
      * Called module names
       01  MOD-ZCU01O13              PIC X(8) VALUE 'ZCU01O13'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01FI3-001.
               PERFORM CALL-ZCU01O13-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01O13-002.
               CALL 'ZCU01O13' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01O13 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
