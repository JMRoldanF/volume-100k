      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00W5W'.
      ...
      * Called module names
       01  MOD-ZCU01PMG              PIC X(8) VALUE 'ZCU01PMG'.
       01  MOD-ZCU01KIA              PIC X(8) VALUE 'ZCU01KIA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01PMG-001.
               PERFORM CALL-ZCU01KIA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01PMG-001.
               CALL 'ZCU01PMG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01PMG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01KIA-002.
               CALL 'ZCU01KIA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01KIA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
