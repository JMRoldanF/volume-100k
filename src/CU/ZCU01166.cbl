      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01166'.
      ...
      * Called module names
       01  MOD-ZCU01RYW              PIC X(8) VALUE 'ZCU01RYW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01RYW-001.
               CALL 'ZCU01RYW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01RYW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
