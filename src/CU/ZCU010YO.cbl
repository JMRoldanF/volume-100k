      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU010YO'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01RVU              PIC X(8) VALUE 'ZCU01RVU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01RVU-002.
               CALL 'ZCU01RVU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
