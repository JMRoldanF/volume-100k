      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01ISM'.
      ...
      * Called module names
       01  MOD-ZCU01L20              PIC X(8) VALUE 'ZCU01L20'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01L20-001.
               CALL 'ZCU01L20' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01L20 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
