      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00YKU'.
      ...
      * Called module names
       01  MOD-ZCU01CZQ              PIC X(8) VALUE 'ZCU01CZQ'.
       01  MOD-ZCU01QI4              PIC X(8) VALUE 'ZCU01QI4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01CZQ-001.
               PERFORM CALL-ZCU01QI4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01CZQ-001.
               CALL 'ZCU01CZQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01CZQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01QI4-002.
               CALL 'ZCU01QI4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01QI4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
