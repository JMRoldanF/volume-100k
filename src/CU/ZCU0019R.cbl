      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU0019R'.
      ...
      * Called module names
       01  MOD-ZCU00F0V              PIC X(8) VALUE 'ZCU00F0V'.
       01  MOD-ZCU00EBY              PIC X(8) VALUE 'ZCU00EBY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU00F0V-001.
               PERFORM CALL-ZCU00EBY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU00F0V-001.
               EXEC CICS LINK PROGRAM('ZCU00F0V')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00F0V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU00EBY-002.
               EXEC CICS LINK PROGRAM('ZCU00EBY')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00EBY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
