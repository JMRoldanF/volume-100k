      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00QR6'.
      ...
      * Called module names
       01  MOD-ZCU01SQY              PIC X(8) VALUE 'ZCU01SQY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01SQY-001.
               CALL 'ZCU01SQY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01SQY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
