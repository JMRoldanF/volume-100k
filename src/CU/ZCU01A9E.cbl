      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01A9E'.
      ...
      * Called module names
       01  MOD-ZCU01I14              PIC X(8) VALUE 'ZCU01I14'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01I14-001.
               PERFORM CALL-ZEN0255N-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCU01I14-001.
               CALL 'ZCU01I14' USING DFHCOMMAREA
                         WS-STATUS-CODE.
