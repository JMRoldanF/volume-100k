      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00W0C'.
      ...
      * Called module names
       01  MOD-ZCU01I0K              PIC X(8) VALUE 'ZCU01I0K'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01I0K-001.
               CALL 'ZCU01I0K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01I0K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
