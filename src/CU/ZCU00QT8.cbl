      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00QT8'.
      ...
      * Called module names
       01  MOD-ZCU01L2S              PIC X(8) VALUE 'ZCU01L2S'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01L2S-001.
               CALL 'ZCU01L2S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01L2S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-TERM-0001.
