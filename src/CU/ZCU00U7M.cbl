      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00U7M'.
      ...
      * Called module names
       01  MOD-ZCU01DW8              PIC X(8) VALUE 'ZCU01DW8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01DW8-001.
               CALL 'ZCU01DW8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01DW8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
