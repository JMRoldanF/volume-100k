      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01AOY'.
      ...
      * Called module names
       01  MOD-ZCU01PW6              PIC X(8) VALUE 'ZCU01PW6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01PW6-001.
               PERFORM CALL-ZCU01DNM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01PW6-001.
               CALL 'ZCU01PW6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01PW6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01DNM-002.
