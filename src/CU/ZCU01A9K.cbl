      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01A9K'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01QEV              PIC X(8) VALUE 'ZCU01QEV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01ULX-001.
               PERFORM CALL-ZCU01QEV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01QEV-002.
               CALL 'ZCU01QEV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01QEV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
