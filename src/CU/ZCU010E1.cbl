      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU010E1'.
      ...
      * Called module names
       01  MOD-ZCU01HF9              PIC X(8) VALUE 'ZCU01HF9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01HF9-001.
               CALL 'ZCU01HF9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01HF9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
