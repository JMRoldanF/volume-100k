      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00VOO'.
      ...
      * Called module names
       01  MOD-ZRE01HZJ              PIC X(8) VALUE 'ZRE01HZJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01HZJ-001.
               PERFORM CALL-ZCU01PCQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01HZJ-001.
               CALL 'ZRE01HZJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01HZJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01PCQ-002.
               MOVE 'ZCU01PCQ' TO WS-SUBNAME-2
