      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00RJP'.
      ...
      * Called module names
       01  MOD-ZCU01EXP              PIC X(8) VALUE 'ZCU01EXP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01EXP-001.
               CALL 'ZCU01EXP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01EXP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
