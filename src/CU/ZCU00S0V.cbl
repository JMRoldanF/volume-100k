      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00S0V'.
      ...
      * Called module names
       01  MOD-ZCU01T5W              PIC X(8) VALUE 'ZCU01T5W'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01T5W-001.
               CALL 'ZCU01T5W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01T5W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-EQUITIES-0001.
