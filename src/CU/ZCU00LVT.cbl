      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00LVT'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01ROQ              PIC X(8) VALUE 'ZCU01ROQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01ROQ-002.
               CALL 'ZCU01ROQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01ROQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
