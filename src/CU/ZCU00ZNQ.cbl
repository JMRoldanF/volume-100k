      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00ZNQ'.
      ...
      * Called module names
       01  MOD-ZCL01HAR              PIC X(8) VALUE 'ZCL01HAR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01HAR-001.
               CALL 'ZCL01HAR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01HAR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
