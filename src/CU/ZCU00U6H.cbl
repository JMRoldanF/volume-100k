      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00U6H'.
      ...
      * Called module names
       01  MOD-ZCU01NVP              PIC X(8) VALUE 'ZCU01NVP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01NVP-001.
               PERFORM CALL-ZBR01FYY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01NVP-001.
               CALL 'ZCU01NVP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01NVP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBR01FYY-002.
