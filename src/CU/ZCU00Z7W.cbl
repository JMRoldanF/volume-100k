      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00Z7W'.
      ...
      * Called module names
       01  MOD-ZCU01HSS              PIC X(8) VALUE 'ZCU01HSS'.
       01  MOD-ZCU01M5Q              PIC X(8) VALUE 'ZCU01M5Q'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01HSS-001.
               PERFORM CALL-ZCU01M5Q-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01HSS-001.
               CALL 'ZCU01HSS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01HSS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01M5Q-002.
               CALL 'ZCU01M5Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01M5Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
