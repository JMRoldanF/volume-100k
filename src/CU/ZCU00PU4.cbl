      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00PU4'.
      ...
      * Called module names
       01  MOD-ZCU01TAY              PIC X(8) VALUE 'ZCU01TAY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01TAY-001.
               CALL 'ZCU01TAY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01TAY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01K9X-002.
