      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00PAE'.
      ...
      * Called module names
       01  MOD-ZCU01HOW              PIC X(8) VALUE 'ZCU01HOW'.
       01  MOD-ZCU01KEY              PIC X(8) VALUE 'ZCU01KEY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01HOW-001.
               PERFORM CALL-ZCU01KEY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01HOW-001.
               CALL 'ZCU01HOW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01HOW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01KEY-002.
               CALL 'ZCU01KEY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01KEY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
