      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU010E5'.
      ...
      * Called module names
       01  MOD-ZCU01RFD              PIC X(8) VALUE 'ZCU01RFD'.
       01  MOD-ZCU01ME1              PIC X(8) VALUE 'ZCU01ME1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01RFD-001.
               PERFORM CALL-ZCU01ME1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01RFD-001.
               CALL 'ZCU01RFD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01RFD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01ME1-002.
               CALL 'ZCU01ME1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01ME1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
