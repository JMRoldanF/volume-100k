      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU0124C'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01D96              PIC X(8) VALUE 'ZCU01D96'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01IAA-001.
               PERFORM CALL-ZCU01D96-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01D96-002.
               CALL 'ZCU01D96' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01D96 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
