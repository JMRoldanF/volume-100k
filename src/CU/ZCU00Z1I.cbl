      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00Z1I'.
      ...
      * Called module names
       01  MOD-ZCU01K9Y              PIC X(8) VALUE 'ZCU01K9Y'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01K9Y-001.
               CALL 'ZCU01K9Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01K9Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
