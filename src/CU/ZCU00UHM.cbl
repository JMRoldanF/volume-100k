      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00UHM'.
      ...
      * Called module names
       01  MOD-ZCU01EEK              PIC X(8) VALUE 'ZCU01EEK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01EEK-001.
               CALL 'ZCU01EEK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01EEK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
