      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00VRQ'.
      ...
      * Called module names
       01  MOD-ZRE01H6X              PIC X(8) VALUE 'ZRE01H6X'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01H6X-001.
               CALL 'ZRE01H6X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01H6X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
