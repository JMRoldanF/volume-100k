      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00TN5'.
      ...
      * Called module names
       01  MOD-ZBR01CPP              PIC X(8) VALUE 'ZBR01CPP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01CPP-001.
               CALL 'ZBR01CPP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01CPP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01GTX-002.
               MOVE 'ZCU01GTX' TO WS-SUBNAME-4
