      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU002P2'.
      ...
      * Called module names
       01  MOD-ZCU00H02              PIC X(8) VALUE 'ZCU00H02'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU00DFQ-002.
               PERFORM CALL-ZCU00JE6-003.
               PERFORM CALL-ZCU00EDC-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU00H02-001.
               EXEC CICS LINK PROGRAM('ZCU00H02')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00H02 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU00DFQ-002.
               MOVE 'ZCU00DFQ' TO WS-PROGNAME-3
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00DFQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU00JE6-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU00EDC-004.
               MOVE 'ZCU00EDC' TO WS-PROGNAME-4
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00EDC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-005.
