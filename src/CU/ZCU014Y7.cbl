      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU014Y7'.
      ...
      * Called module names
       01  MOD-ZCU01NJA              PIC X(8) VALUE 'ZCU01NJA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01NJA-001.
               PERFORM CALL-ZBR01LMN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01NJA-001.
               CALL 'ZCU01NJA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01NJA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBR01LMN-002.
               MOVE 'ZBR01LMN' TO WS-SUBNAME-8
