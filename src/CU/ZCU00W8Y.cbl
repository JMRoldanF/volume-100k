      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00W8Y'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01QK2              PIC X(8) VALUE 'ZCU01QK2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01DGO-001.
               PERFORM CALL-ZCU01QK2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01QK2-002.
               CALL 'ZCU01QK2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01QK2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-VALUE-0001.
