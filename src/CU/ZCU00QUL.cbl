      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00QUL'.
      ...
      * Called module names
       01  MOD-ZCU01MAE              PIC X(8) VALUE 'ZCU01MAE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01MAE-001.
               CALL 'ZCU01MAE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01MAE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
