      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00YNA'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01D88              PIC X(8) VALUE 'ZCU01D88'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01GTX-001.
               PERFORM CALL-ZCU01D88-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01D88-002.
               CALL 'ZCU01D88' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01D88 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
