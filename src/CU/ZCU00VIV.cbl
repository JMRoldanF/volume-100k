      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00VIV'.
      ...
      * Called module names
       01  MOD-ZCU01UE7              PIC X(8) VALUE 'ZCU01UE7'.
       01  MOD-ZCU01EA4              PIC X(8) VALUE 'ZCU01EA4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01UE7-001.
               PERFORM CALL-ZCU01EA4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01UE7-001.
               CALL 'ZCU01UE7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01UE7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01EA4-002.
               CALL 'ZCU01EA4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01EA4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
