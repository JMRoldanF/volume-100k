      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00XXB'.
      ...
      * Called module names
       01  MOD-ZCU01QDL              PIC X(8) VALUE 'ZCU01QDL'.
       01  MOD-ZCU01RE1              PIC X(8) VALUE 'ZCU01RE1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01QDL-001.
               PERFORM CALL-ZCU01RE1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01QDL-001.
               CALL 'ZCU01QDL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01QDL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01RE1-002.
               CALL 'ZCU01RE1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01RE1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
