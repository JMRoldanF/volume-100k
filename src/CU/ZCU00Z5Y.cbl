      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00Z5Y'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01PNU              PIC X(8) VALUE 'ZCU01PNU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01PNU-002.
               CALL 'ZCU01PNU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01PNU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
