      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00N06'.
      ...
      * Called module names
       01  MOD-ZCU01T6I              PIC X(8) VALUE 'ZCU01T6I'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01T6I-002.
               CALL 'ZCU01T6I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01T6I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
