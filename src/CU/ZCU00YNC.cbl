      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00YNC'.
      ...
      * Called module names
       01  MOD-ZBI01H0I              PIC X(8) VALUE 'ZBI01H0I'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01H0I-001.
               CALL 'ZBI01H0I' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01H0I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       VALIDATE-VALUE-0001.
