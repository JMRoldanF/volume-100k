      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00SB0'.
      ...
      * Called module names
       01  MOD-ZCU01F76              PIC X(8) VALUE 'ZCU01F76'.
       01  MOD-ZCU01R1A              PIC X(8) VALUE 'ZCU01R1A'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01F76-001.
               PERFORM CALL-ZCU01R1A-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01F76-001.
               CALL 'ZCU01F76' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01F76 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01R1A-002.
               CALL 'ZCU01R1A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01R1A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
