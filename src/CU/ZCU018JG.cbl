      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU018JG'.
      ...
      * Called module names
       01  MOD-ZCU01GDY              PIC X(8) VALUE 'ZCU01GDY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01GDY-001.
               CALL 'ZCU01GDY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01GDY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01IDW-002.
