      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00YQ4'.
      ...
      * Called module names
       01  MOD-ZCU01NYG              PIC X(8) VALUE 'ZCU01NYG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01NYG-001.
               CALL 'ZCU01NYG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01NYG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
