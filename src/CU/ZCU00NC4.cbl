      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00NC4'.
      ...
      * Called module names
       01  MOD-ZCU01D00              PIC X(8) VALUE 'ZCU01D00'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01D00-001.
               CALL 'ZCU01D00' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01D00 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
