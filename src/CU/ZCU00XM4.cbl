      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00XM4'.
      ...
      * Called module names
       01  MOD-ZCU01Q34              PIC X(8) VALUE 'ZCU01Q34'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01Q34-001.
               CALL 'ZCU01Q34' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01Q34 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
