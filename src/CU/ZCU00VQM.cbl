      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00VQM'.
      ...
      * Called module names
       01  MOD-ZCU01F0S              PIC X(8) VALUE 'ZCU01F0S'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01F0S-001.
               CALL 'ZCU01F0S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01F0S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
