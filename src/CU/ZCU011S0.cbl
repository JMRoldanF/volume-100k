      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU011S0'.
      ...
      * Called module names
       01  MOD-ZCU01K1S              PIC X(8) VALUE 'ZCU01K1S'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01K1S-001.
               CALL 'ZCU01K1S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01K1S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01S3H-002.
