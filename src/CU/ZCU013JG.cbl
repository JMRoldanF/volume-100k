      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU013JG'.
      ...
      * Called module names
       01  MOD-ZPA01KZD              PIC X(8) VALUE 'ZPA01KZD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01KZD-001.
               CALL 'ZPA01KZD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01KZD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
