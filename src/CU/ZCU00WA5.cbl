      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00WA5'.
      ...
      * Called module names
       01  MOD-ZCU01TL1              PIC X(8) VALUE 'ZCU01TL1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01TL1-001.
               CALL 'ZCU01TL1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01TL1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
