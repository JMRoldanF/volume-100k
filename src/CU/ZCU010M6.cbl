      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU010M6'.
      ...
      * Called module names
       01  MOD-ZCU01MZQ              PIC X(8) VALUE 'ZCU01MZQ'.
       01  MOD-ZCU01PZI              PIC X(8) VALUE 'ZCU01PZI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01MZQ-001.
               PERFORM CALL-ZCU01PZI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01MZQ-001.
               CALL 'ZCU01MZQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01MZQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01PZI-002.
               CALL 'ZCU01PZI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01PZI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
