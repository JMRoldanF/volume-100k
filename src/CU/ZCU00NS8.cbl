      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00NS8'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01NNM              PIC X(8) VALUE 'ZCU01NNM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBR01LBY-001.
               PERFORM CALL-ZCU01NNM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01NNM-002.
               CALL 'ZCU01NNM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01NNM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
