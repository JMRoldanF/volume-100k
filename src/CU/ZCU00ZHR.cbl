      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00ZHR'.
      ...
      * Called module names
       01  MOD-ZCU01UPB              PIC X(8) VALUE 'ZCU01UPB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01UPB-001.
               CALL 'ZCU01UPB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01UPB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-MODEL-0001.
