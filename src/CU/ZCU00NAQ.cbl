      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00NAQ'.
      ...
      * Called module names
       01  MOD-ZCU01H0Q              PIC X(8) VALUE 'ZCU01H0Q'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01H0Q-001.
               CALL 'ZCU01H0Q' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01H0Q FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
