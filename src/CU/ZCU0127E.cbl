      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU0127E'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01JPI              PIC X(8) VALUE 'ZAG01JPI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01JPI-002.
               CALL 'ZAG01JPI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01JPI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
