      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00XOE'.
      ...
      * Called module names
       01  MOD-ZCU01FQH              PIC X(8) VALUE 'ZCU01FQH'.
       01  MOD-ZCU01UUQ              PIC X(8) VALUE 'ZCU01UUQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01FQH-001.
               PERFORM CALL-ZCU01UUQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01FQH-001.
               CALL 'ZCU01FQH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01FQH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01UUQ-002.
               CALL 'ZCU01UUQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01UUQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
