      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00QA8'.
      ...
      * Called module names
       01  MOD-ZRE01RT5              PIC X(8) VALUE 'ZRE01RT5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01RT5-002.
               CALL 'ZRE01RT5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01RT5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
