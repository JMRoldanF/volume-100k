      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU0166G'.
      ...
      * Called module names
       01  MOD-ZBI01KQ4              PIC X(8) VALUE 'ZBI01KQ4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01KQ4-001.
               CALL 'ZBI01KQ4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01KQ4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
