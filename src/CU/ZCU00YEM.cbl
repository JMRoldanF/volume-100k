      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00YEM'.
      ...
      * Called module names
       01  MOD-ZCU01G3U              PIC X(8) VALUE 'ZCU01G3U'.
       01  MOD-ZCU01SSF              PIC X(8) VALUE 'ZCU01SSF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01G3U-001.
               PERFORM CALL-ZCU01SSF-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01G3U-001.
               CALL 'ZCU01G3U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01G3U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01SSF-002.
               CALL 'ZCU01SSF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01SSF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
