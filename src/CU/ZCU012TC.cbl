      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU012TC'.
      ...
      * Called module names
       01  MOD-ZCU01NLE              PIC X(8) VALUE 'ZCU01NLE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01NLE-001.
               CALL 'ZCU01NLE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01NLE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-EQUITIES-0001.
