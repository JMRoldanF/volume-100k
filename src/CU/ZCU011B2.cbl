      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU011B2'.
      ...
      * Called module names
       01  MOD-ZCU01KQR              PIC X(8) VALUE 'ZCU01KQR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01KQR-001.
               CALL 'ZCU01KQR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01KQR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
