      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00NII'.
      ...
      * Called module names
       01  MOD-ZCU01GB6              PIC X(8) VALUE 'ZCU01GB6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01GB6-001.
               CALL 'ZCU01GB6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01GB6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
