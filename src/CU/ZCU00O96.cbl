      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00O96'.
      ...
      * Called module names
       01  MOD-ZCU01G6G              PIC X(8) VALUE 'ZCU01G6G'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01G6G-001.
               CALL 'ZCU01G6G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01G6G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
