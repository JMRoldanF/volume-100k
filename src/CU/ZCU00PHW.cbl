      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00PHW'.
      ...
      * Called module names
       01  MOD-ZCU01NB4              PIC X(8) VALUE 'ZCU01NB4'.
       01  MOD-ZCU01DGO              PIC X(8) VALUE 'ZCU01DGO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01NB4-001.
               PERFORM CALL-ZCU01DGO-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01NB4-001.
               CALL 'ZCU01NB4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01NB4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01DGO-002.
               CALL 'ZCU01DGO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01DGO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
