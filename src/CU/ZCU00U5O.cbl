      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00U5O'.
      ...
      * Called module names
       01  MOD-ZCU01KH0              PIC X(8) VALUE 'ZCU01KH0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01KH0-001.
               CALL 'ZCU01KH0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01KH0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
