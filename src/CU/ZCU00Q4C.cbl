      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00Q4C'.
      ...
      * Called module names
       ...
       01  MOD-ZBR01NBV              PIC X(8) VALUE 'ZBR01NBV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01NBV-002.
               CALL 'ZBR01NBV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01NBV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
