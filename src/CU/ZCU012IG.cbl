      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU012IG'.
      ...
      * Called module names
       ...
       01  MOD-ZBR01CQD              PIC X(8) VALUE 'ZBR01CQD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01EIL-001.
               PERFORM CALL-ZBR01CQD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01CQD-002.
               CALL 'ZBR01CQD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01CQD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
