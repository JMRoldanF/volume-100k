      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU016EI'.
      ...
      * Called module names
       01  MOD-ZCU01JB8              PIC X(8) VALUE 'ZCU01JB8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01JB8-001.
               CALL 'ZCU01JB8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01JB8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
