      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01NS2'.
      ...
      * Called module names
       01  MOD-ZBI01J8S              PIC X(8) VALUE 'ZBI01J8S'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01J8S-001.
               CALL 'ZBI01J8S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01J8S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
