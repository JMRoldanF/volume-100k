      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00NR4'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01GIC              PIC X(8) VALUE 'ZHO01GIC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01R60-001.
               PERFORM CALL-ZHO01GIC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01GIC-002.
               CALL 'ZHO01GIC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01GIC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
