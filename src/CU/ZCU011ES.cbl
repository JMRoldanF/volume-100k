      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU011ES'.
      ...
      * Called module names
       01  MOD-ZCU01SIW              PIC X(8) VALUE 'ZCU01SIW'.
       01  MOD-ZCU01E90              PIC X(8) VALUE 'ZCU01E90'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01SIW-001.
               PERFORM CALL-ZCU01E90-002.
               ...
               PERFORM FORMAT-MODEL-0073.
               PERFORM DERIVE-HOUSE-TYPE-0074.
               PERFORM SQL-ACCESS-0075.
               PERFORM NORMALISE-SUM-ASSURED-0076.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01SIW-001.
               CALL 'ZCU01SIW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01SIW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01E90-002.
               CALL 'ZCU01E90' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01E90 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
