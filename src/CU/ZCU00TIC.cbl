      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00TIC'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01FT4              PIC X(8) VALUE 'ZCU01FT4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01S1E-001.
               PERFORM CALL-ZCU01FT4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01FT4-002.
               CALL 'ZCU01FT4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01FT4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
