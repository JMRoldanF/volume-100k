      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU018UU'.
      ...
      * Called module names
       01  MOD-ZCU01P5S              PIC X(8) VALUE 'ZCU01P5S'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01P5S-001.
               CALL 'ZCU01P5S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
