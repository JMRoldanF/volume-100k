      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00U6S'.
      ...
      * Called module names
       01  MOD-ZCU01NFK              PIC X(8) VALUE 'ZCU01NFK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01NFK-001.
               PERFORM CALL-ZCU01SOG-002.
               PERFORM CALL-ZMT0255L-003.
               PERFORM VALIDATE-PREMIUM-0001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCU01NFK-001.
               CALL 'ZCU01NFK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01NFK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01SOG-002.
