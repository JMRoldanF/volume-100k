      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00OLP'.
      ...
      * Called module names
       01  MOD-ZCU01DO1              PIC X(8) VALUE 'ZCU01DO1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01DO1-001.
               PERFORM CALL-ZSL01JME-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01DO1-001.
               CALL 'ZCU01DO1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01DO1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSL01JME-002.
