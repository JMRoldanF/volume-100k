      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00WI3'.
      ...
      * Called module names
       01  MOD-ZCU01DNA              PIC X(8) VALUE 'ZCU01DNA'.
       01  MOD-ZCU01DXT              PIC X(8) VALUE 'ZCU01DXT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01DNA-001.
               PERFORM CALL-ZCU01DXT-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01DNA-001.
               CALL 'ZCU01DNA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01DNA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01DXT-002.
               CALL 'ZCU01DXT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01DXT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
