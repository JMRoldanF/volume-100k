      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00ZGS'.
      ...
      * Called module names
       01  MOD-ZCU01TRW              PIC X(8) VALUE 'ZCU01TRW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01TRW-001.
               CALL 'ZCU01TRW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01TRW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
