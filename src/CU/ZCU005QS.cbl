      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU005QS'.
      ...
      * Called module names
       01  MOD-ZPA00GEJ              PIC X(8) VALUE 'ZPA00GEJ'.
       01  MOD-ZCU00E7I              PIC X(8) VALUE 'ZCU00E7I'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU00KS6-001.
               PERFORM CALL-ZCU00BBW-002.
               PERFORM CALL-ZPA00GEJ-003.
               PERFORM CALL-ZCU00E7I-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU00KS6-001.
               MOVE 'ZCU00KS6' TO WS-PROGNAME-3
      ...
      *----------------------------------------------------------------*
       CALL-ZCU00BBW-002.
               MOVE 'ZCU00BBW' TO WS-PROGNAME-4
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00BBW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA00GEJ-003.
               EXEC CICS LINK PROGRAM('ZPA00GEJ')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA00GEJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU00E7I-004.
               EXEC CICS LINK PROGRAM('ZCU00E7I')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00E7I FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-005.
