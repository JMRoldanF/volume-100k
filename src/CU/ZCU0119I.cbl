      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU0119I'.
      ...
      * Called module names
       01  MOD-ZCU01DP0              PIC X(8) VALUE 'ZCU01DP0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01DP0-001.
               CALL 'ZCU01DP0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01DP0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
