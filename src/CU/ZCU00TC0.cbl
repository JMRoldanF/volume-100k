      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00TC0'.
      ...
      * Called module names
       01  MOD-ZCU01S8T              PIC X(8) VALUE 'ZCU01S8T'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01S8T-001.
               PERFORM CALL-ZCU01FZB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01S8T-001.
               CALL 'ZCU01S8T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01S8T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01FZB-002.
