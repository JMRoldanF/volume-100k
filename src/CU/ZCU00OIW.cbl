      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00OIW'.
      ...
      * Called module names
       01  MOD-ZCU01RGI              PIC X(8) VALUE 'ZCU01RGI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01RGI-001.
               CALL 'ZCU01RGI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01RGI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
