      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00W3C'.
      ...
      * Called module names
       01  MOD-ZCU01OY7              PIC X(8) VALUE 'ZCU01OY7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01OY7-002.
               CALL 'ZCU01OY7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01OY7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
