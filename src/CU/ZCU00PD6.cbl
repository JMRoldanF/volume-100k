      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00PD6'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01K4O              PIC X(8) VALUE 'ZCU01K4O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01K4O-002.
               CALL 'ZCU01K4O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01K4O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
