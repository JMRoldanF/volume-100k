      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00UYU'.
      ...
      * Called module names
       01  MOD-ZCU01FRQ              PIC X(8) VALUE 'ZCU01FRQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01FRQ-001.
               CALL 'ZCU01FRQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01FRQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
