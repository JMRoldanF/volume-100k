      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00W7A'.
      ...
      * Called module names
       01  MOD-ZCU01RI8              PIC X(8) VALUE 'ZCU01RI8'.
       01  MOD-ZHO01MA4              PIC X(8) VALUE 'ZHO01MA4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01RI8-001.
               PERFORM CALL-ZHO01MA4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01RI8-001.
               CALL 'ZCU01RI8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01MA4-002.
               CALL 'ZHO01MA4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01MA4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
