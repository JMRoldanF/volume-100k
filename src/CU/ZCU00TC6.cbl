      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00TC6'.
      ...
      * Called module names
       01  MOD-ZCU01J5O              PIC X(8) VALUE 'ZCU01J5O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01J5O-001.
               CALL 'ZCU01J5O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01J5O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
