      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00PG8'.
      ...
      * Called module names
       01  MOD-ZCU01UPS              PIC X(8) VALUE 'ZCU01UPS'.
       01  MOD-ZCU01FJO              PIC X(8) VALUE 'ZCU01FJO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01UPS-001.
               PERFORM CALL-ZCU01FJO-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01UPS-001.
               CALL 'ZCU01UPS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01UPS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01FJO-002.
               CALL 'ZCU01FJO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01FJO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
