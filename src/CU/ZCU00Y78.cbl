      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00Y78'.
      ...
      * Called module names
       01  MOD-ZCU01IRS              PIC X(8) VALUE 'ZCU01IRS'.
       01  MOD-ZCU01E04              PIC X(8) VALUE 'ZCU01E04'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01IRS-001.
               PERFORM CALL-ZCU01E04-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01IRS-001.
               CALL 'ZCU01IRS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01IRS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01E04-002.
               CALL 'ZCU01E04' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01E04 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
