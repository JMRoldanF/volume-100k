      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00TCS'.
      ...
      * Called module names
       01  MOD-ZCU01JSQ              PIC X(8) VALUE 'ZCU01JSQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01JSQ-001.
               CALL 'ZCU01JSQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01JSQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
