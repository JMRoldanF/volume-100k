      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00SM4'.
      ...
      * Called module names
       01  MOD-ZCU01H0G              PIC X(8) VALUE 'ZCU01H0G'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01H0G-001.
               CALL 'ZCU01H0G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01H0G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01GVS-002.
               MOVE 'ZBI01GVS' TO WS-SUBNAME-2
