      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00ZTA'.
      ...
      * Called module names
       01  MOD-ZCU01S3M              PIC X(8) VALUE 'ZCU01S3M'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01U4Y-001.
               PERFORM CALL-ZCU01S3M-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01S3M-002.
               CALL 'ZCU01S3M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01S3M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
