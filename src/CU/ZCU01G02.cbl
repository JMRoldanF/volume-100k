      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01G02'.
      ...
      * Called module names
       01  MOD-ZEN01JKN              PIC X(8) VALUE 'ZEN01JKN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01JKN-001.
               CALL 'ZEN01JKN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01JKN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
