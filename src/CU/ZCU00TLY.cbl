      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00TLY'.
      ...
      * Called module names
       01  MOD-ZCU01RTC              PIC X(8) VALUE 'ZCU01RTC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01RTC-001.
               CALL 'ZCU01RTC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01RTC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
