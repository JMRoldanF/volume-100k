      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00YIM'.
      ...
      * Called module names
       01  MOD-ZRE01LO1              PIC X(8) VALUE 'ZRE01LO1'.
       01  MOD-ZCU01DZA              PIC X(8) VALUE 'ZCU01DZA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01LO1-001.
               CALL 'ZRE01LO1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01LO1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01DZA-002.
               CALL 'ZCU01DZA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01DZA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
