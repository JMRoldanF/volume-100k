      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00R7U'.
      ...
      * Called module names
       01  MOD-ZCU01CUQ              PIC X(8) VALUE 'ZCU01CUQ'.
       01  MOD-ZCU01J0E              PIC X(8) VALUE 'ZCU01J0E'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01CUQ-001.
               PERFORM CALL-ZCU01J0E-002.
               PERFORM CALL-ZBI0255Q-003.
               PERFORM FORMAT-REG-NUMBER-0001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCU01CUQ-001.
               CALL 'ZCU01CUQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01CUQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01J0E-002.
               CALL 'ZCU01J0E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01J0E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
