      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00NXQ'.
      ...
      * Called module names
       01  MOD-ZCU01LJV              PIC X(8) VALUE 'ZCU01LJV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01LJV-001.
               CALL 'ZCU01LJV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01LJV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
