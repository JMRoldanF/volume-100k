      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00V30'.
      ...
      * Called module names
       01  MOD-ZCU01SVY              PIC X(8) VALUE 'ZCU01SVY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01SVY-001.
               CALL 'ZCU01SVY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01SVY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
