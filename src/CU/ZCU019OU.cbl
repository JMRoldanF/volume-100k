      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU019OU'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01NCI              PIC X(8) VALUE 'ZCU01NCI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01KEE-001.
               PERFORM CALL-ZCU01NCI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01NCI-002.
               CALL 'ZCU01NCI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01NCI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
