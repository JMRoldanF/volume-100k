      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00N52'.
      ...
      * Called module names
       01  MOD-ZBR01FSR              PIC X(8) VALUE 'ZBR01FSR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBR01FSR-001.
               PERFORM CALL-ZCU01OS3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01FSR-001.
               CALL 'ZBR01FSR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01FSR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01OS3-002.
