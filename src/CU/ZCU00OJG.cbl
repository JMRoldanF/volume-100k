      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00OJG'.
      ...
      * Called module names
       01  MOD-ZCU01NPA              PIC X(8) VALUE 'ZCU01NPA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01NPA-001.
               CALL 'ZCU01NPA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01NPA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
