      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00T8C'.
      ...
      * Called module names
       01  MOD-ZMT01HXP              PIC X(8) VALUE 'ZMT01HXP'.
       01  MOD-ZCU01F5S              PIC X(8) VALUE 'ZCU01F5S'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01HXP-001.
               PERFORM CALL-ZCU01F5S-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01HXP-001.
               CALL 'ZMT01HXP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01HXP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01F5S-002.
               CALL 'ZCU01F5S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01F5S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
