      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00ZHH'.
      ...
      * Called module names
       01  MOD-ZCU01J9V              PIC X(8) VALUE 'ZCU01J9V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01J9V-001.
               CALL 'ZCU01J9V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01J9V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
