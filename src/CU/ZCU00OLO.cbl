      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00OLO'.
      ...
      * Called module names
       01  MOD-ZCU01RKQ              PIC X(8) VALUE 'ZCU01RKQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01RKQ-001.
               CALL 'ZCU01RKQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01RKQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-VALUE-0001.
