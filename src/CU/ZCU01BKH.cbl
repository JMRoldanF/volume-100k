      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01BKH'.
      ...
      * Called module names
       01  MOD-ZBR01IUI              PIC X(8) VALUE 'ZBR01IUI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01IUI-001.
               CALL 'ZBR01IUI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01IUI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
