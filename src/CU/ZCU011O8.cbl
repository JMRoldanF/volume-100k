      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU011O8'.
      ...
      * Called module names
       01  MOD-ZCU01TJK              PIC X(8) VALUE 'ZCU01TJK'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01TJK-001.
               PERFORM CALL-ZCU01IIC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01TJK-001.
               CALL 'ZCU01TJK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01TJK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01IIC-002.
