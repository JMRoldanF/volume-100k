      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00WI4'.
      ...
      * Called module names
       01  MOD-ZCU01RJW              PIC X(8) VALUE 'ZCU01RJW'.
       01  MOD-ZRE01E6B              PIC X(8) VALUE 'ZRE01E6B'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01RJW-001.
               PERFORM CALL-ZRE01E6B-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01RJW-001.
               CALL 'ZCU01RJW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01RJW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01E6B-002.
               CALL 'ZRE01E6B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01E6B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
