      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00PRC'.
      ...
      * Called module names
       01  MOD-ZMT01FMD              PIC X(8) VALUE 'ZMT01FMD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01FMD-001.
               CALL 'ZMT01FMD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01FMD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
