      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00W2U'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01TEC              PIC X(8) VALUE 'ZBI01TEC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01TEC-002.
               CALL 'ZBI01TEC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01TEC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
