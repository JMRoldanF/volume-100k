      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00Q1M'.
      ...
      * Called module names
       01  MOD-ZCU01R6K              PIC X(8) VALUE 'ZCU01R6K'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01R6K-001.
               PERFORM CALL-ZCU01J9A-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01R6K-001.
               CALL 'ZCU01R6K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01R6K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01J9A-002.
               MOVE 'ZCU01J9A' TO WS-SUBNAME-2
