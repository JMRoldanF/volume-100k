      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU014FO'.
      ...
      * Called module names
       01  MOD-ZCU01GO8              PIC X(8) VALUE 'ZCU01GO8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01GO8-001.
               CALL 'ZCU01GO8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01GO8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
