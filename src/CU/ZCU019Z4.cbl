      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU019Z4'.
      ...
      * Called module names
       01  MOD-ZCU01QF2              PIC X(8) VALUE 'ZCU01QF2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01QF2-001.
               CALL 'ZCU01QF2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01QF2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       VALIDATE-TERM-0001.
