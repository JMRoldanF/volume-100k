      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00WJU'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01RZ4              PIC X(8) VALUE 'ZCU01RZ4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01RZ4-002.
               CALL 'ZCU01RZ4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01RZ4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
