      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00R2K'.
      ...
      * Called module names
       01  MOD-ZCU01U08              PIC X(8) VALUE 'ZCU01U08'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01U08-001.
               PERFORM CALL-ZCU01P5I-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01U08-001.
               CALL 'ZCU01U08' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01U08 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01P5I-002.
               MOVE 'ZCU01P5I' TO WS-SUBNAME-4
