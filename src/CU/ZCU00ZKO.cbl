      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00ZKO'.
      ...
      * Called module names
       01  MOD-ZCU01S5A              PIC X(8) VALUE 'ZCU01S5A'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01S5A-001.
               PERFORM CALL-ZCU01RVA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01S5A-001.
               CALL 'ZCU01S5A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01S5A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01RVA-002.
