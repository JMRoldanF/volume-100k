      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU0004A'.
      ...
      * Called module names
       01  MOD-ZCU00JZK              PIC X(8) VALUE 'ZCU00JZK'.
       01  MOD-ZCU00JG4              PIC X(8) VALUE 'ZCU00JG4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU00JZK-001.
               PERFORM CALL-ZCU00JG4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU00JZK-001.
               EXEC CICS LINK PROGRAM('ZCU00JZK')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00JZK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU00JG4-002.
               EXEC CICS LINK PROGRAM('ZCU00JG4')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00JG4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
