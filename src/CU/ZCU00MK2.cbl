      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00MK2'.
      ...
      * Called module names
       01  MOD-ZCU01M1A              PIC X(8) VALUE 'ZCU01M1A'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01M1A-001.
               CALL 'ZCU01M1A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01M1A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
