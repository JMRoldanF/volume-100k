      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00MX4'.
      ...
      * Called module names
       01  MOD-ZCU01RLK              PIC X(8) VALUE 'ZCU01RLK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01RLK-001.
               CALL 'ZCU01RLK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01RLK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
