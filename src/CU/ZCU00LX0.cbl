      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00LX0'.
      ...
      * Called module names
       01  MOD-ZCU01MRY              PIC X(8) VALUE 'ZCU01MRY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01Q2A-001.
               PERFORM CALL-ZCU01MRY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01MRY-002.
               CALL 'ZCU01MRY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01MRY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
