      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00PTA'.
      ...
      * Called module names
       01  MOD-ZCU01JNQ              PIC X(8) VALUE 'ZCU01JNQ'.
       01  MOD-ZCU01DN2              PIC X(8) VALUE 'ZCU01DN2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01JNQ-001.
               PERFORM CALL-ZCU01DN2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01JNQ-001.
               CALL 'ZCU01JNQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01JNQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01DN2-002.
               CALL 'ZCU01DN2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01DN2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
