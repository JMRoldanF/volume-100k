      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU01BOC'.
      ...
      * Called module names
       01  MOD-ZCU01J3D              PIC X(8) VALUE 'ZCU01J3D'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01J3D-001.
               CALL 'ZCU01J3D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01J3D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
