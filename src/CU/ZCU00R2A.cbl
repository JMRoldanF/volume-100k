      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00R2A'.
      ...
      * Called module names
       01  MOD-ZCU01KHQ              PIC X(8) VALUE 'ZCU01KHQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01KHQ-001.
               CALL 'ZCU01KHQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01KHQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
