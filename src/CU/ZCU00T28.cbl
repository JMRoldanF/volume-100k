      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00T28'.
      ...
      * Called module names
       01  MOD-ZCU01KSU              PIC X(8) VALUE 'ZCU01KSU'.
       01  MOD-ZCU01OA4              PIC X(8) VALUE 'ZCU01OA4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01KSU-001.
               PERFORM CALL-ZCU01OA4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01KSU-001.
               CALL 'ZCU01KSU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01KSU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01OA4-002.
               CALL 'ZCU01OA4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01OA4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
