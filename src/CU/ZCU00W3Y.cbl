      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00W3Y'.
      ...
      * Called module names
       01  MOD-ZCU01F26              PIC X(8) VALUE 'ZCU01F26'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01F26-001.
               PERFORM CALL-ZCU01IKK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01F26-001.
               CALL 'ZCU01F26' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01F26 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01IKK-002.
