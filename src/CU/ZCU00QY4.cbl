      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00QY4'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01V2A              PIC X(8) VALUE 'ZCU01V2A'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01V2A-002.
               CALL 'ZCU01V2A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01V2A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
