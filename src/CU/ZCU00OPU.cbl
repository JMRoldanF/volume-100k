      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00OPU'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01M9M              PIC X(8) VALUE 'ZCU01M9M'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01SXM-001.
               PERFORM CALL-ZCU01M9M-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01M9M-002.
               CALL 'ZCU01M9M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01M9M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
