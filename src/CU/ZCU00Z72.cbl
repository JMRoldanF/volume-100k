      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00Z72'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01EN6              PIC X(8) VALUE 'ZCU01EN6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01QYS-001.
               PERFORM CALL-ZCU01EN6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01EN6-002.
               CALL 'ZCU01EN6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01EN6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
