      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00MWK'.
      ...
      * Called module names
       01  MOD-ZCU01E5O              PIC X(8) VALUE 'ZCU01E5O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01E5O-001.
               CALL 'ZCU01E5O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01E5O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
