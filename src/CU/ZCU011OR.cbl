      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU011OR'.
      ...
      * Called module names
       01  MOD-ZCU01N6K              PIC X(8) VALUE 'ZCU01N6K'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01N6K-001.
               CALL 'ZCU01N6K' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01N6K FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
