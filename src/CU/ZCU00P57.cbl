      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00P57'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01PN3              PIC X(8) VALUE 'ZCU01PN3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01TP1-001.
               PERFORM CALL-ZCU01PN3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01PN3-002.
               CALL 'ZCU01PN3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01PN3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
