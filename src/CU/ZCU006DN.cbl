      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU006DN'.
      ...
      * Called module names
       ...
       01  MOD-ZCU00OXE              PIC X(8) VALUE 'ZCU00OXE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU00OXE-002.
               PERFORM CALL-ZCU00YXJ-003.
               PERFORM CALL-ZCU01FEI-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU00OXE-002.
               EXEC CICS LINK PROGRAM('ZCU00OXE')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU00OXE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU00YXJ-003.
               MOVE 'ZCU00YXJ' TO WS-PROGNAME-3
