      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00TFJ'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01PQI              PIC X(8) VALUE 'ZCU01PQI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01NNM-001.
               PERFORM CALL-ZCU01PQI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01PQI-002.
               CALL 'ZCU01PQI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01PQI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
