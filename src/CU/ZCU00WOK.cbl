      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00WOK'.
      ...
      * Called module names
       01  MOD-ZCU01IC5              PIC X(8) VALUE 'ZCU01IC5'.
       01  MOD-ZCU01UNM              PIC X(8) VALUE 'ZCU01UNM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01IC5-001.
               PERFORM CALL-ZCU01UNM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01IC5-001.
               CALL 'ZCU01IC5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01IC5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01UNM-002.
               CALL 'ZCU01UNM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01UNM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-TERM-0001.
