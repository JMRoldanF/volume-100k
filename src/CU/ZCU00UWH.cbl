      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZCU00UWH'.
      ...
      * Called module names
       ...
       01  MOD-ZCU01FWR              PIC X(8) VALUE 'ZCU01FWR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01FWR-002.
               CALL 'ZCU01FWR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01FWR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
