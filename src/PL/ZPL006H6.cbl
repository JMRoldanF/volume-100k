      ******************************************************************
      * ZPL006H6 - POLICY ADMINISTRATION                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPL006H6'.
      ...
      * Called module names
       ...
       01  MOD-ZPL017CR              PIC X(8) VALUE 'ZPL017CR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPL00X3R-001.
               PERFORM CALL-ZPL00SYC-002.
               PERFORM CALL-ZPL012H2-003.
               PERFORM CALL-ZPL017CR-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZPL00SYC-002.
               MOVE 'ZPL00SYC' TO WS-PROGNAME-6
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPL00SYC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPL012H2-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZPL017CR-004.
               EXEC CICS LINK PROGRAM('ZPL017CR')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPL017CR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-005.
