      ******************************************************************
      * ZPL00SE0 - POLICY ADMINISTRATION                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPL00SE0'.
      ...
      * Called module names
       01  MOD-ZPL01TFV              PIC X(8) VALUE 'ZPL01TFV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPL01TFV-001.
               CALL 'ZPL01TFV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPL01TFV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
