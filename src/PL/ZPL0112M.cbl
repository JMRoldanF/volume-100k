      ******************************************************************
      * ZPL0112M - POLICY ADMINISTRATION                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPL0112M'.
      ...
      * Called module names
       ...
       01  MOD-ZPL01IHP              PIC X(8) VALUE 'ZPL01IHP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPL01S36-001.
               PERFORM CALL-ZPL01IHP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPL01IHP-002.
               CALL 'ZPL01IHP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPL01IHP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
