      ******************************************************************
      * ZPL00RZ6 - POLICY ADMINISTRATION                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPL00RZ6'.
      ...
      * Called module names
       01  MOD-ZPL01SRB              PIC X(8) VALUE 'ZPL01SRB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPL01SRB-001.
               CALL 'ZPL01SRB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPL01SRB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
