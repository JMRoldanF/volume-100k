      ******************************************************************
      * ZPL00UD6 - POLICY ADMINISTRATION                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPL00UD6'.
      ...
      * Called module names
       01  MOD-ZPL01F2M              PIC X(8) VALUE 'ZPL01F2M'.
       01  MOD-ZPL01U9M              PIC X(8) VALUE 'ZPL01U9M'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPL01F2M-001.
               PERFORM CALL-ZPL01U9M-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPL01F2M-001.
               CALL 'ZPL01F2M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPL01F2M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPL01U9M-002.
               CALL 'ZPL01U9M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPL01U9M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
