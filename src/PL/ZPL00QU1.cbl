      ******************************************************************
      * ZPL00QU1 - POLICY ADMINISTRATION                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPL00QU1'.
      ...
      * Called module names
       01  MOD-ZCL01N3C              PIC X(8) VALUE 'ZCL01N3C'.
       01  MOD-ZPL01L03              PIC X(8) VALUE 'ZPL01L03'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01N3C-001.
               PERFORM CALL-ZPL01L03-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01N3C-001.
               CALL 'ZCL01N3C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01N3C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPL01L03-002.
               CALL 'ZPL01L03' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPL01L03 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
