      ******************************************************************
      * ZPL00U5U - POLICY ADMINISTRATION                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPL00U5U'.
      ...
      * Called module names
       01  MOD-ZPL01IQS              PIC X(8) VALUE 'ZPL01IQS'.
       01  MOD-ZPL01CQX              PIC X(8) VALUE 'ZPL01CQX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPL01IQS-001.
               PERFORM CALL-ZPL01CQX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPL01IQS-001.
               CALL 'ZPL01IQS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPL01IQS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPL01CQX-002.
               CALL 'ZPL01CQX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPL01CQX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
