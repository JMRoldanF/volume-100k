      ******************************************************************
      * ZPL00ZMG - POLICY ADMINISTRATION                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPL00ZMG'.
      ...
      * Called module names
       01  MOD-ZPL01FM6              PIC X(8) VALUE 'ZPL01FM6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPL01FM6-001.
               CALL 'ZPL01FM6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPL01FM6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPL01TM2-002.
               MOVE 'ZPL01TM2' TO WS-SUBNAME-4
