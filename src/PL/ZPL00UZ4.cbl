      ******************************************************************
      * ZPL00UZ4 - POLICY ADMINISTRATION                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPL00UZ4'.
      ...
      * Called module names
       01  MOD-ZPL01KSH              PIC X(8) VALUE 'ZPL01KSH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPL01KSH-001.
               CALL 'ZPL01KSH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPL01KSH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
