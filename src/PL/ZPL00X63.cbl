      ******************************************************************
      * ZPL00X63 - POLICY ADMINISTRATION                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPL00X63'.
      ...
      * Called module names
       01  MOD-ZPL01HP8              PIC X(8) VALUE 'ZPL01HP8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPL01HP8-001.
               CALL 'ZPL01HP8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPL01HP8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-TERM-0001.
