      ******************************************************************
      * ZPL00YYX - POLICY ADMINISTRATION                               *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPL00YYX'.
      ...
      * Called module names
       01  MOD-ZPL01OWB              PIC X(8) VALUE 'ZPL01OWB'.
       01  MOD-ZPL01GWM              PIC X(8) VALUE 'ZPL01GWM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPL01OWB-001.
               PERFORM CALL-ZPL01GWM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPL01OWB-001.
               CALL 'ZPL01OWB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPL01OWB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPL01GWM-002.
               CALL 'ZPL01GWM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPL01GWM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
