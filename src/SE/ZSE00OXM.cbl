      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSE00OXM'.
      ...
      * Called module names
       01  MOD-ZSE01DNI              PIC X(8) VALUE 'ZSE01DNI'.
       01  MOD-ZSE01LMR              PIC X(8) VALUE 'ZSE01LMR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01DNI-001.
               CALL 'ZSE01DNI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01LMR-002.
               CALL 'ZSE01LMR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01LMR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
