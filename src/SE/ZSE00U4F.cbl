      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSE00U4F'.
      ...
      * Called module names
       01  MOD-ZSE01TRC              PIC X(8) VALUE 'ZSE01TRC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSE01TRC-001.
               PERFORM CALL-ZCL01EUB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01TRC-001.
               CALL 'ZSE01TRC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01TRC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01EUB-002.
