      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSE00TP2'.
      ...
      * Called module names
       01  MOD-ZSE01SQF              PIC X(8) VALUE 'ZSE01SQF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01SQF-001.
               CALL 'ZSE01SQF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01SQF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
