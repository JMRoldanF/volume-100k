      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSE00NAQ'.
      ...
      * Called module names
       01  MOD-ZSE01J0A              PIC X(8) VALUE 'ZSE01J0A'.
       01  MOD-ZSE01FXA              PIC X(8) VALUE 'ZSE01FXA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSE01J0A-001.
               PERFORM CALL-ZSE01FXA-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01J0A-001.
               CALL 'ZSE01J0A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01J0A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSE01FXA-002.
               CALL 'ZSE01FXA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01FXA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
