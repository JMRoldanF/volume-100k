      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSE00RA5'.
      ...
      * Called module names
       01  MOD-ZSE01NKL              PIC X(8) VALUE 'ZSE01NKL'.
       01  MOD-ZSE01SUD              PIC X(8) VALUE 'ZSE01SUD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSE01NKL-001.
               PERFORM CALL-ZSE01SUD-002.
               ...
               PERFORM VALIDATE-SUM-ASSURED-0052.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01NKL-001.
               CALL 'ZSE01NKL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01NKL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSE01SUD-002.
               CALL 'ZSE01SUD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01SUD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
