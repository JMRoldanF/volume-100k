      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSE00OT3'.
      ...
      * Called module names
       01  MOD-ZSE01JQS              PIC X(8) VALUE 'ZSE01JQS'.
       01  MOD-ZSE01RK7              PIC X(8) VALUE 'ZSE01RK7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSE01JQS-001.
               PERFORM CALL-ZSE01RK7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01JQS-001.
               CALL 'ZSE01JQS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01JQS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSE01RK7-002.
               CALL 'ZSE01RK7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01RK7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
