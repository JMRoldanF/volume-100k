      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSE010TU'.
      ...
      * Called module names
       01  MOD-ZSE01PHJ              PIC X(8) VALUE 'ZSE01PHJ'.
       01  MOD-ZSE01QRN              PIC X(8) VALUE 'ZSE01QRN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSE01PHJ-001.
               PERFORM CALL-ZSE01QRN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01PHJ-001.
               CALL 'ZSE01PHJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01PHJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSE01QRN-002.
               CALL 'ZSE01QRN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01QRN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
