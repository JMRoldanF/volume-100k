      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSE00SXQ'.
      ...
      * Called module names
       01  MOD-ZSE01T7D              PIC X(8) VALUE 'ZSE01T7D'.
       01  MOD-ZIV01NC9              PIC X(8) VALUE 'ZIV01NC9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSE01T7D-001.
               PERFORM CALL-ZIV01NC9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01T7D-001.
               CALL 'ZSE01T7D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01T7D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIV01NC9-002.
               CALL 'ZIV01NC9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01NC9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
