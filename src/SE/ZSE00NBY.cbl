      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSE00NBY'.
      ...
      * Called module names
       01  MOD-ZCL01DXK              PIC X(8) VALUE 'ZCL01DXK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01DXK-001.
               CALL 'ZCL01DXK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01DXK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
