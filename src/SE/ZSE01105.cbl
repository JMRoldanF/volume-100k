      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSE01105'.
      ...
      * Called module names
       01  MOD-ZSE01EGW              PIC X(8) VALUE 'ZSE01EGW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM RECONCILE-AGENT-CODE-0071.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01EGW-001.
               CALL 'ZSE01EGW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01EGW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
