      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSE00VFG'.
      ...
      * Called module names
       01  MOD-ZSE01P6P              PIC X(8) VALUE 'ZSE01P6P'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01P6P-001.
               CALL 'ZSE01P6P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01P6P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSE01U0C-002.
