      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSE00NWS'.
      ...
      * Called module names
       01  MOD-ZSE01SBW              PIC X(8) VALUE 'ZSE01SBW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01SBW-001.
               CALL 'ZSE01SBW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01SBW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
