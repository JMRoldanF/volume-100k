      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSE00YVP'.
      ...
      * Called module names
       01  MOD-ZSE01OUL              PIC X(8) VALUE 'ZSE01OUL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSE01EXN-001.
               PERFORM CALL-ZSE01OUL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01OUL-002.
               CALL 'ZSE01OUL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01OUL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
