      ...
      ******************************************************************
       ...
       FILE-CONTROL.
               SELECT INPUT-FILE  ASSIGN TO DDSEIN43
                         ORGANIZATION IS SEQUENTIAL
                         FILE STATUS  IS WS-FILE-STATUS.
               SELECT OUTPUT-FILE ASSIGN TO DDSEOT43
                         ORGANIZATION IS SEQUENTIAL
                         FILE STATUS  IS WS-FILE-STATUS.
               SELECT REPORT-FILE ASSIGN TO DDSERP43
                         ORGANIZATION IS SEQUENTIAL
                         FILE STATUS  IS WS-FILE-STATUS.
       DATA DIVISION.
       FILE SECTION.
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSE01V5N'.
      ...
      * Called module names
       ...
       01  MOD-ZSE01FOI              PIC X(8) VALUE 'ZSE01FOI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01FOI-003.
               CALL 'ZSE01FOI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01FOI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
