      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSE00XVR'.
      ...
      * Called module names
       ...
       01  MOD-ZSE01EXN              PIC X(8) VALUE 'ZSE01EXN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIV01IZ3-001.
               PERFORM CALL-ZSE01EXN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01EXN-002.
               CALL 'ZSE01EXN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01EXN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
