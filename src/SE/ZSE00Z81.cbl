      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSE00Z81'.
      ...
      * Called module names
       01  MOD-ZSE01EBE              PIC X(8) VALUE 'ZSE01EBE'.
       01  MOD-ZIV01HN5              PIC X(8) VALUE 'ZIV01HN5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01EBE-001.
               CALL 'ZSE01EBE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01EBE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIV01HN5-002.
               CALL 'ZIV01HN5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01HN5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
