      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSE00P1U'.
      ...
      * Called module names
       01  MOD-ZSE01N7O              PIC X(8) VALUE 'ZSE01N7O'.
       01  MOD-ZSE01N61              PIC X(8) VALUE 'ZSE01N61'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSE01N7O-001.
               PERFORM CALL-ZSE01N61-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01N7O-001.
               CALL 'ZSE01N7O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01N7O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSE01N61-002.
               CALL 'ZSE01N61' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
