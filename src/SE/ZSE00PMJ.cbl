      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSE00PMJ'.
      ...
      * Called module names
       01  MOD-ZIV01KCR              PIC X(8) VALUE 'ZIV01KCR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01KCR-001.
               CALL 'ZIV01KCR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01KCR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSE01ITZ-002.
