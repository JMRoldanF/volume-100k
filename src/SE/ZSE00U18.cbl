      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSE00U18'.
      ...
      * Called module names
       01  MOD-ZSE01UXG              PIC X(8) VALUE 'ZSE01UXG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSE01UXG-001.
               PERFORM CALL-ZSE01CS5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01UXG-001.
               CALL 'ZSE01UXG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01UXG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSE01CS5-002.
