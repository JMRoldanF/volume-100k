      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSE00O5F'.
      ...
      * Called module names
       01  MOD-ZSE01IFB              PIC X(8) VALUE 'ZSE01IFB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01IFB-001.
               CALL 'ZSE01IFB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01IFB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
