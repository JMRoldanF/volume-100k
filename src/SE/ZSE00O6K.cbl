      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSE00O6K'.
      ...
      * Called module names
       01  MOD-ZSE01KSF              PIC X(8) VALUE 'ZSE01KSF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01KSF-001.
               CALL 'ZSE01KSF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01KSF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZSE01SMW-002.
