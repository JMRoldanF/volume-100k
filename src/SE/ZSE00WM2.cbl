      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSE00WM2'.
      ...
      * Called module names
       01  MOD-ZSE01G7N              PIC X(8) VALUE 'ZSE01G7N'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01G7N-001.
               CALL 'ZSE01G7N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01G7N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
