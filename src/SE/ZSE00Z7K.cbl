      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSE00Z7K'.
      ...
      * Called module names
       ...
       01  MOD-ZSE01SAI              PIC X(8) VALUE 'ZSE01SAI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZSE01L9L-001.
               PERFORM CALL-ZSE01SAI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01SAI-002.
               CALL 'ZSE01SAI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01SAI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
