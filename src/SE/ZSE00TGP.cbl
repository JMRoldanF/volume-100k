      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSE00TGP'.
      ...
      * Called module names
       01  MOD-ZSE01R3S              PIC X(8) VALUE 'ZSE01R3S'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01R3S-001.
               CALL 'ZSE01R3S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01R3S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
