      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSE012JM'.
      ...
      * Called module names
       ...
       01  MOD-ZSE01GIC              PIC X(8) VALUE 'ZSE01GIC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIV01JDR-001.
               PERFORM CALL-ZSE01GIC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZSE01GIC-002.
               CALL 'ZSE01GIC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSE01GIC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
