      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZSE00U9F'.
      ...
      * Called module names
       01  MOD-ZIV01DED              PIC X(8) VALUE 'ZIV01DED'.
       01  MOD-ZIV01D8R              PIC X(8) VALUE 'ZIV01D8R'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZIV01DED-001.
               PERFORM CALL-ZIV01D8R-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZIV01DED-001.
               CALL 'ZIV01DED' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01DED FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZIV01D8R-002.
               CALL 'ZIV01D8R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZIV01D8R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-TERM-0001.
