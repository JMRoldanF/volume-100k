      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBR00WPQ'.
      ...
      * Called module names
       01  MOD-ZSC01KVP              PIC X(8) VALUE 'ZSC01KVP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSC01KVP-001.
               CALL 'ZSC01KVP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC01KVP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
