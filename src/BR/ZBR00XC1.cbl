      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBR00XC1'.
      ...
      * Called module names
       01  MOD-ZBR01E0J              PIC X(8) VALUE 'ZBR01E0J'.
       01  MOD-ZBR01JHJ              PIC X(8) VALUE 'ZBR01JHJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBR01E0J-001.
               PERFORM CALL-ZBR01JHJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01E0J-001.
               CALL 'ZBR01E0J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01E0J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBR01JHJ-002.
               CALL 'ZBR01JHJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01JHJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
