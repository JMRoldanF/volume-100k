      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBR00YXS'.
      ...
      * Called module names
       01  MOD-ZAC01HXN              PIC X(8) VALUE 'ZAC01HXN'.
       01  MOD-ZBR01EQE              PIC X(8) VALUE 'ZBR01EQE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAC01HXN-001.
               PERFORM CALL-ZBR01EQE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01HXN-001.
               CALL 'ZAC01HXN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01HXN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBR01EQE-002.
               CALL 'ZBR01EQE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01EQE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
