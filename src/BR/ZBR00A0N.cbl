      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBR00A0N'.
      ...
      * Called module names
       ...
       01  MOD-ZBR01GAJ              PIC X(8) VALUE 'ZBR01GAJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBR00NWG-001.
               PERFORM CALL-ZBR01GAJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01GAJ-002.
               CALL 'ZBR01GAJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
