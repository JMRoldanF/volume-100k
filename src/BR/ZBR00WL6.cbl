      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBR00WL6'.
      ...
      * Called module names
       01  MOD-ZBR01OLM              PIC X(8) VALUE 'ZBR01OLM'.
       01  MOD-ZBR01JWU              PIC X(8) VALUE 'ZBR01JWU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBR01OLM-001.
               PERFORM CALL-ZBR01JWU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01OLM-001.
               CALL 'ZBR01OLM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01OLM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBR01JWU-002.
               CALL 'ZBR01JWU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01JWU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
