      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBR00OMZ'.
      ...
      * Called module names
       01  MOD-ZBR01EEX              PIC X(8) VALUE 'ZBR01EEX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01EEX-001.
               CALL 'ZBR01EEX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01EEX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
