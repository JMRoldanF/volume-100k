      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBR00PRM'.
      ...
      * Called module names
       01  MOD-ZBR01D8H              PIC X(8) VALUE 'ZBR01D8H'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM RESOLVE-SUM-ASSURED-0067.
               ...
               PERFORM RECONCILE-VALUE-0112.
               PERFORM RECONCILE-ROOF-TYPE-0113.
               PERFORM SQL-ACCESS-0114.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZBR01D8H-001.
               CALL 'ZBR01D8H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01D8H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
