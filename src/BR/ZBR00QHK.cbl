      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBR00QHK'.
      ...
      * Called module names
       01  MOD-ZBR01RM8              PIC X(8) VALUE 'ZBR01RM8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01RM8-001.
               CALL 'ZBR01RM8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01RM8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
