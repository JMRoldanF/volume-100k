      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBR00MB2'.
      ...
      * Called module names
       01  MOD-ZBR01GBM              PIC X(8) VALUE 'ZBR01GBM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01GBM-001.
               CALL 'ZBR01GBM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01GBM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-PREMIUM-0001.
