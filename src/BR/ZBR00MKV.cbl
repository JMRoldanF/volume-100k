      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBR00MKV'.
      ...
      * Called module names
       01  MOD-ZBR01DOG              PIC X(8) VALUE 'ZBR01DOG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBR01DOG-001.
               PERFORM CALL-ZWF01R6D-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01DOG-001.
               CALL 'ZBR01DOG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01DOG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZWF01R6D-002.
