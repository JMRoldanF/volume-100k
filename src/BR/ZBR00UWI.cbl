      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBR00UWI'.
      ...
      * Called module names
       01  MOD-ZBR01KT1              PIC X(8) VALUE 'ZBR01KT1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01KT1-001.
               CALL 'ZBR01KT1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01KT1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMA01TZ1-002.
