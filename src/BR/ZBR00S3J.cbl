      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBR00S3J'.
      ...
      * Called module names
       01  MOD-ZAV01H4B              PIC X(8) VALUE 'ZAV01H4B'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAV01H4B-001.
               PERFORM CALL-ZBR01MRK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01H4B-001.
               CALL 'ZAV01H4B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01H4B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBR01MRK-002.
               MOVE 'ZBR01MRK' TO WS-SUBNAME-3
