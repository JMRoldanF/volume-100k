      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBR00UJ7'.
      ...
      * Called module names
       01  MOD-ZBR01QUO              PIC X(8) VALUE 'ZBR01QUO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01QUO-001.
               CALL 'ZBR01QUO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01QUO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
