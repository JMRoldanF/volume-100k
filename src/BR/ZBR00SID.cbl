      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBR00SID'.
      ...
      * Called module names
       01  MOD-ZBR01E18              PIC X(8) VALUE 'ZBR01E18'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01E18-001.
               CALL 'ZBR01E18' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01E18 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
