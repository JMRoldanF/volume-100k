      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBR00ZOH'.
      ...
      * Called module names
       01  MOD-ZBR01QHK              PIC X(8) VALUE 'ZBR01QHK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01QHK-001.
               CALL 'ZBR01QHK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01QHK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
