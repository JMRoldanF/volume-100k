      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBR00XEA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM VALIDATE-BROKER-ID-0107.
               PERFORM SQL-ACCESS-0108.
               PERFORM CHECK-VALUE-0109.
               ...
               PERFORM NORMALISE-REG-NUMBER-0145.
      ...
      *----------------------------------------------------------------*
       SQL-ACCESS-0144.
               ...
               END-IF.
      *----------------------------------------------------------------*
       NORMALISE-REG-NUMBER-0145.
               INSPECT WS-KEY-CHAR REPLACING ALL SPACES BY '0'.
               IF WS-STATUS-FAILED
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-HOUSE-TYPE-0146.
               EXEC CICS ASKTIME ABSTIME(ABS-TIME)
               END-EXEC.
               EXEC CICS FORMATTIME ABSTIME(ABS-TIME)
                         MMDDYYYY(DATE1)
