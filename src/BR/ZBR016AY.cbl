      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBR016AY'.
      ...
      * Called module names
       01  MOD-ZBR01DTQ              PIC X(8) VALUE 'ZBR01DTQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01DTQ-001.
               CALL 'ZBR01DTQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01DTQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
