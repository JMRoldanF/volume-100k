      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBR00V0C'.
      ...
      * Called module names
       01  MOD-ZBR01ORO              PIC X(8) VALUE 'ZBR01ORO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01ORO-001.
               CALL 'ZBR01ORO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01ORO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
