      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBR00C2M'.
      ...
      * Called module names
       01  MOD-ZBR00MHU              PIC X(8) VALUE 'ZBR00MHU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR00MHU-001.
               EXEC CICS LINK PROGRAM('ZBR00MHU')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR00MHU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
