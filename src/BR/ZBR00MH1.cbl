      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBR00MH1'.
      ...
      * Called module names
       01  MOD-ZBR01TB3              PIC X(8) VALUE 'ZBR01TB3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01TB3-001.
               CALL 'ZBR01TB3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01TB3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
