      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBR00YVA'.
      ...
      * Called module names
       01  MOD-ZBR01U0R              PIC X(8) VALUE 'ZBR01U0R'.
       01  MOD-ZBR01KJZ              PIC X(8) VALUE 'ZBR01KJZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBR01U0R-001.
               PERFORM CALL-ZBR01KJZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01U0R-001.
               CALL 'ZBR01U0R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01U0R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBR01KJZ-002.
               CALL 'ZBR01KJZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01KJZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
