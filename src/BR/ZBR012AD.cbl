      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBR012AD'.
      ...
      * Called module names
       01  MOD-ZBR01E03              PIC X(8) VALUE 'ZBR01E03'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01E03-001.
               CALL 'ZBR01E03' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01E03 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
