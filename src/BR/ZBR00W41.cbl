      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBR00W41'.
      ...
      * Called module names
       01  MOD-ZBR01UGO              PIC X(8) VALUE 'ZBR01UGO'.
       01  MOD-ZBR01P0G              PIC X(8) VALUE 'ZBR01P0G'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBR01UGO-001.
               PERFORM CALL-ZBR01P0G-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01UGO-001.
               CALL 'ZBR01UGO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01UGO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBR01P0G-002.
               CALL 'ZBR01P0G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01P0G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
