      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBR010XW'.
      ...
      * Called module names
       01  MOD-ZBR01L2L              PIC X(8) VALUE 'ZBR01L2L'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01L2L-001.
               CALL 'ZBR01L2L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01L2L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
