      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBR00UA5'.
      ...
      * Called module names
       01  MOD-ZSC01UEK              PIC X(8) VALUE 'ZSC01UEK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZSC01UEK-001.
               CALL 'ZSC01UEK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZSC01UEK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
