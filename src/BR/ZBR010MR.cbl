      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBR010MR'.
      ...
      * Called module names
       01  MOD-ZBR01J54              PIC X(8) VALUE 'ZBR01J54'.
       01  MOD-ZBR01PLV              PIC X(8) VALUE 'ZBR01PLV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBR01J54-001.
               PERFORM CALL-ZBR01PLV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBR01J54-001.
               CALL 'ZBR01J54' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01J54 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBR01PLV-002.
               CALL 'ZBR01PLV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBR01PLV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
