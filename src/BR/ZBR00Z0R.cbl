      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZBR00Z0R'.
      ...
      * Called module names
       01  MOD-ZAC01M6N              PIC X(8) VALUE 'ZAC01M6N'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAC01M6N-001.
               CALL 'ZAC01M6N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAC01M6N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAV01LQ7-002.
