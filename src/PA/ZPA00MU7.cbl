      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00MU7'.
      ...
      * Called module names
       01  MOD-ZPA01U35              PIC X(8) VALUE 'ZPA01U35'.
       01  MOD-ZBI01N8E              PIC X(8) VALUE 'ZBI01N8E'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01U35-001.
               PERFORM CALL-ZBI01N8E-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01U35-001.
               CALL 'ZPA01U35' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01U35 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01N8E-002.
               CALL 'ZBI01N8E' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01N8E FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
