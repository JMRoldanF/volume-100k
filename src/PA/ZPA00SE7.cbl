      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00SE7'.
      ...
      * Called module names
       01  MOD-ZPA01E9F              PIC X(8) VALUE 'ZPA01E9F'.
       01  MOD-ZEN01QAB              PIC X(8) VALUE 'ZEN01QAB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01E9F-001.
               PERFORM CALL-ZEN01QAB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01E9F-001.
               CALL 'ZPA01E9F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01E9F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01QAB-002.
               CALL 'ZEN01QAB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01QAB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
