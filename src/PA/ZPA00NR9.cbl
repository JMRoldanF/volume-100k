      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00NR9'.
      ...
      * Called module names
       01  MOD-ZPA01PL7              PIC X(8) VALUE 'ZPA01PL7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01PL7-001.
               CALL 'ZPA01PL7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01PL7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-COLOUR-0001.
