      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00QN5'.
      ...
      * Called module names
       01  MOD-ZPA01HUV              PIC X(8) VALUE 'ZPA01HUV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01HUV-001.
               PERFORM CALL-ZPA01HUV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01HUV-001.
               CALL 'ZPA01HUV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01HUV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01HUV-002.
