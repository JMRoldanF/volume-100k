      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA010XP'.
      ...
      * Called module names
       01  MOD-ZPA01P67              PIC X(8) VALUE 'ZPA01P67'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01P67-001.
               CALL 'ZPA01P67' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01P67 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-COLOUR-0001.
