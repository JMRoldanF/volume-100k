      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00FB3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA00VTJ-002.
               PERFORM CALL-ZPA01355-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00VTJ-002.
               MOVE 'ZPA00VTJ' TO WS-PROGNAME-5
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01355-003.
               MOVE 'ZPA01355' TO WS-PROGNAME-6
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01355 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-004.
