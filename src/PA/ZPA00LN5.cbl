      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00LN5'.
      ...
      * Called module names
       01  MOD-ZPA01N2N              PIC X(8) VALUE 'ZPA01N2N'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01N2N-001.
               CALL 'ZPA01N2N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01N2N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
