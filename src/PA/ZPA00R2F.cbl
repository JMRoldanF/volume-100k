      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00R2F'.
      ...
      * Called module names
       01  MOD-ZPA01IUP              PIC X(8) VALUE 'ZPA01IUP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01IUP-001.
               CALL 'ZPA01IUP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01IUP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
