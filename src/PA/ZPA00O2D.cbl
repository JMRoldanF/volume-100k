      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00O2D'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01TM7              PIC X(8) VALUE 'ZPA01TM7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01TM7-002.
               CALL 'ZPA01TM7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01TM7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
