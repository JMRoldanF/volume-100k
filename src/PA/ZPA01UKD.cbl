      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA01UKD'.
      ...
      * Called module names
       01  MOD-ZCU01OD6              PIC X(8) VALUE 'ZCU01OD6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01OD6-001.
               CALL 'ZCU01OD6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01OD6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
