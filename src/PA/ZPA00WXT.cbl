      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00WXT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM APPLY-NCD-YEARS-0028.
               PERFORM RESOLVE-STATUS-CODE-0029.
               PERFORM SQL-ACCESS-0030.
               PERFORM EXPAND-MANAGED-FUND-0031.
               ...
               PERFORM RESOLVE-NCD-YEARS-0092.
               ...
               PERFORM REFRESH-ROOF-TYPE-0107.
               ...
               PERFORM RECONCILE-TERM-0136.
               PERFORM APPLY-STATUS-CODE-0137.
               PERFORM SQL-ACCESS-0138.
               PERFORM EXPAND-MAKE-0139.
               PERFORM COMPUTE-BROKER-ID-0140.
               PERFORM SQL-ACCESS-0141.
               PERFORM AUDIT-EQUITIES-0142.
               PERFORM DERIVE-STATUS-CODE-0143.
               PERFORM FORMAT-STATUS-CODE-0145.
               PERFORM AUDIT-BEDROOMS-0146.
               PERFORM SQL-ACCESS-0147.
               PERFORM CHECK-STATUS-CODE-0148.
               PERFORM EXPAND-PREMIUM-0149.
               PERFORM SQL-ACCESS-0150.
               PERFORM VALIDATE-REG-NUMBER-0152.
      ...
      *----------------------------------------------------------------*
       SQL-ACCESS-0081.
               ...
               END-IF.
      *----------------------------------------------------------------*
       RECONCILE-CC-RATING-0082.
               UNSTRING WS-KEY-CHAR DELIMITED BY '/'
                             INTO WS-KEY-CUSTOMER
                                  WS-KEY-POLICY
               END-UNSTRING.
      *----------------------------------------------------------------*
       DERIVE-REG-NUMBER-0083.
               EVALUATE TRUE
                  WHEN WS-PREMIUM-TOTAL < 999
                       MOVE 1 TO WS-PREMIUM-BAND
                  WHEN WS-PREMIUM-TOTAL < 4999
