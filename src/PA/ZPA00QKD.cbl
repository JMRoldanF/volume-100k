      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00QKD'.
      ...
      * Called module names
       01  MOD-ZPA01MSX              PIC X(8) VALUE 'ZPA01MSX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01MSX-001.
               PERFORM CALL-ZPA01NV9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01MSX-001.
               CALL 'ZPA01MSX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01MSX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01NV9-002.
