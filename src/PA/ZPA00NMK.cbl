      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00NMK'.
      ...
      * Called module names
       01  MOD-ZCR01G0J              PIC X(8) VALUE 'ZCR01G0J'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCR01G0J-001.
               CALL 'ZCR01G0J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCR01G0J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
