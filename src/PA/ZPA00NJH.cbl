      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00NJH'.
      ...
      * Called module names
       01  MOD-ZPA01FOT              PIC X(8) VALUE 'ZPA01FOT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01FOT-001.
               CALL 'ZPA01FOT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01FOT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-EQUITIES-0001.
