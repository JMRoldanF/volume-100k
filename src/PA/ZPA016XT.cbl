      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA016XT'.
      ...
      * Called module names
       01  MOD-ZPA01HHJ              PIC X(8) VALUE 'ZPA01HHJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01HHJ-001.
               CALL 'ZPA01HHJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01HHJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
