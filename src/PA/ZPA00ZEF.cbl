      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00ZEF'.
      ...
      * Called module names
       01  MOD-ZPA01NYB              PIC X(8) VALUE 'ZPA01NYB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01NYB-001.
               CALL 'ZPA01NYB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01NYB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
