      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA01D0Z'.
      ...
      * Called module names
       01  MOD-ZMT01SLV              PIC X(8) VALUE 'ZMT01SLV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01SLV-001.
               CALL 'ZMT01SLV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01SLV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
