      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00ODR'.
      ...
      * Called module names
       01  MOD-ZPA01FPD              PIC X(8) VALUE 'ZPA01FPD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01FPD-001.
               CALL 'ZPA01FPD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01FPD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-TAX-BAND-0001.
