      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00OQT'.
      ...
      * Called module names
       01  MOD-ZPA01EUT              PIC X(8) VALUE 'ZPA01EUT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01EUT-001.
               CALL 'ZPA01EUT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01EUT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
