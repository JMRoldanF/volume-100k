      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA0108P'.
      ...
      * Called module names
       01  MOD-ZPA01V2F              PIC X(8) VALUE 'ZPA01V2F'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01V2F-001.
               CALL 'ZPA01V2F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01V2F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
