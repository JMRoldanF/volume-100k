      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA013LJ'.
      ...
      * Called module names
       01  MOD-ZPA01RIN              PIC X(8) VALUE 'ZPA01RIN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01RIN-001.
               CALL 'ZPA01RIN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01RIN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
