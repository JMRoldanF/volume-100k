      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA003D3'.
      ...
      * Called module names
       01  MOD-ZPA00EDH              PIC X(8) VALUE 'ZPA00EDH'.
       01  MOD-ZPA00DW9              PIC X(8) VALUE 'ZPA00DW9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA00EDH-001.
               PERFORM CALL-ZPA00DW9-002.
               PERFORM CALL-ZPA00CRF-003.
               PERFORM CALL-ZPA00J8R-004.
               PERFORM CALL-ZPA00I8D-005.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00EDH-001.
               EXEC CICS LINK PROGRAM('ZPA00EDH')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA00EDH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA00DW9-002.
               EXEC CICS LINK PROGRAM('ZPA00DW9')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA00DW9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA00CRF-003.
               MOVE 'ZPA00CRF' TO WS-PROGNAME-1
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00J8R-004.
               MOVE 'ZPA00J8R' TO WS-PROGNAME-2
