      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00SSG'.
      ...
      * Called module names
       01  MOD-ZPA01J10              PIC X(8) VALUE 'ZPA01J10'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01J10-001.
               CALL 'ZPA01J10' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01J10 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01J6T-002.
