      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00N51'.
      ...
      * Called module names
       01  MOD-ZPA01H8X              PIC X(8) VALUE 'ZPA01H8X'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01H8X-001.
               PERFORM CALL-ZBI01IZW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01H8X-001.
               CALL 'ZPA01H8X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
