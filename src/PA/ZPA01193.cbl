      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA01193'.
      ...
      * Called module names
       01  MOD-ZPA01PPD              PIC X(8) VALUE 'ZPA01PPD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01PPD-001.
               CALL 'ZPA01PPD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01PPD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
