      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA01ATJ'.
      ...
      * Called module names
       01  MOD-ZPA01RJR              PIC X(8) VALUE 'ZPA01RJR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01RJR-001.
               CALL 'ZPA01RJR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01RJR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
