      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00VM1'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01OTF              PIC X(8) VALUE 'ZPA01OTF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01OTF-002.
               CALL 'ZPA01OTF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01OTF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
