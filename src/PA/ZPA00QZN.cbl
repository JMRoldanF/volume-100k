      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00QZN'.
      ...
      * Called module names
       ...
       01  MOD-ZAG01EVC              PIC X(8) VALUE 'ZAG01EVC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01OHH-001.
               PERFORM CALL-ZAG01EVC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01EVC-002.
               CALL 'ZAG01EVC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
