      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00WUR'.
      ...
      * Called module names
       ...
       01  MOD-ZHO01QPA              PIC X(8) VALUE 'ZHO01QPA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01QPA-002.
               CALL 'ZHO01QPA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01QPA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
