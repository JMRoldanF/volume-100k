      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00ZPJ'.
      ...
      * Called module names
       01  MOD-ZPA01SYL              PIC X(8) VALUE 'ZPA01SYL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01SYL-001.
               CALL 'ZPA01SYL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01SYL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
