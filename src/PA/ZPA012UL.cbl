      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA012UL'.
      ...
      * Called module names
       01  MOD-ZPA01CZ1              PIC X(8) VALUE 'ZPA01CZ1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01CZ1-001.
               CALL 'ZPA01CZ1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01CZ1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
