      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00SQ5'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01RYR              PIC X(8) VALUE 'ZPA01RYR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01U4J-001.
               PERFORM CALL-ZPA01RYR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01RYR-002.
               CALL 'ZPA01RYR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01RYR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
