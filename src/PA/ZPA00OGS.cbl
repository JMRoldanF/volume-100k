      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00OGS'.
      ...
      * Called module names
       01  MOD-ZPA01IL4              PIC X(8) VALUE 'ZPA01IL4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01IL4-001.
               CALL 'ZPA01IL4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01IL4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01IKE-002.
               MOVE 'ZPA01IKE' TO WS-SUBNAME-1
