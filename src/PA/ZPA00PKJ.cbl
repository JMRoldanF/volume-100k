      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00PKJ'.
      ...
      * Called module names
       01  MOD-ZPA01TBX              PIC X(8) VALUE 'ZPA01TBX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01TBX-001.
               CALL 'ZPA01TBX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01TBX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
