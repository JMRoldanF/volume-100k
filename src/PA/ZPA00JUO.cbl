      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00JUO'.
      ...
      * Called module names
       ...
       01  MOD-ZPA00SBH              PIC X(8) VALUE 'ZPA00SBH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00TZ4-002.
               EXEC CICS LINK PROGRAM('ZPA00TZ4')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00SBH-003.
               EXEC CICS LINK PROGRAM('ZPA00SBH')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
