      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00UFT'.
      ...
      * Called module names
       01  MOD-ZEN01JHB              PIC X(8) VALUE 'ZEN01JHB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01JHB-001.
               PERFORM CALL-ZPA01I8H-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01JHB-001.
               CALL 'ZEN01JHB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01JHB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01I8H-002.
