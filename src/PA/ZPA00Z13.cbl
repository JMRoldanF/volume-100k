      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00Z13'.
      ...
      * Called module names
       01  MOD-ZPA01LS9              PIC X(8) VALUE 'ZPA01LS9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01LS9-001.
               CALL 'ZPA01LS9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01LS9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
