      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00ZBX'.
      ...
      * Called module names
       01  MOD-ZPA01M6F              PIC X(8) VALUE 'ZPA01M6F'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01M6F-001.
               CALL 'ZPA01M6F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01M6F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
