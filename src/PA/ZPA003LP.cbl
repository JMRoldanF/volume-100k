      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA003LP'.
      ...
      * Called module names
       ...
       01  MOD-ZPA00H5R              PIC X(8) VALUE 'ZPA00H5R'.
       01  MOD-ZAG00IPU              PIC X(8) VALUE 'ZAG00IPU'.
       01  MOD-ZRE000LL              PIC X(8) VALUE 'ZRE000LL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA00H5R-002.
               PERFORM CALL-ZPA00FGX-003.
               PERFORM CALL-ZAG00IPU-004.
               PERFORM CALL-ZRE000LL-005.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00H5R-002.
               EXEC CICS LINK PROGRAM('ZPA00H5R')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00FGX-003.
               MOVE 'ZPA00FGX' TO WS-PROGNAME-8
      ...
      *----------------------------------------------------------------*
       CALL-ZRE000LL-005.
               EXEC CICS XCTL PROGRAM('ZRE000LL')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE000LL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-006.
