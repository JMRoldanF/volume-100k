      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00XJH'.
      ...
      * Called module names
       01  MOD-ZPA01M8N              PIC X(8) VALUE 'ZPA01M8N'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01M8N-001.
               CALL 'ZPA01M8N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01M8N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
