      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA010FN'.
      ...
      * Called module names
       01  MOD-ZPA01JEP              PIC X(8) VALUE 'ZPA01JEP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01JEP-001.
               CALL 'ZPA01JEP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01JEP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
