      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00W40'.
      ...
      * Called module names
       01  MOD-ZPT01II9              PIC X(8) VALUE 'ZPT01II9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPT01II9-001.
               CALL 'ZPT01II9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01II9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
