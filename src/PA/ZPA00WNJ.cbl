      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00WNJ'.
      ...
      * Called module names
       01  MOD-ZPA01LZR              PIC X(8) VALUE 'ZPA01LZR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01LZR-001.
               CALL 'ZPA01LZR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01LZR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01L8L-002.
