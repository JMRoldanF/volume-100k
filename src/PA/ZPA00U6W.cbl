      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00U6W'.
      ...
      * Called module names
       01  MOD-ZPA01O2U              PIC X(8) VALUE 'ZPA01O2U'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01O2U-001.
               CALL 'ZPA01O2U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01O2U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
