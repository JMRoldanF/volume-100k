      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00UZJ'.
      ...
      * Called module names
       01  MOD-ZPA01QIJ              PIC X(8) VALUE 'ZPA01QIJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01QIJ-001.
               CALL 'ZPA01QIJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01QIJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
