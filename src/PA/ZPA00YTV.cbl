      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00YTV'.
      ...
      * Called module names
       01  MOD-ZPA01O9P              PIC X(8) VALUE 'ZPA01O9P'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01O9P-001.
               PERFORM CALL-ZPA01LFH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01O9P-001.
               CALL 'ZPA01O9P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
