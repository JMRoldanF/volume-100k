      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00S1Q'.
      ...
      * Called module names
       01  MOD-ZPT01IV8              PIC X(8) VALUE 'ZPT01IV8'.
       01  MOD-ZPA01EKE              PIC X(8) VALUE 'ZPA01EKE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPT01IV8-001.
               CALL 'ZPT01IV8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01IV8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01EKE-002.
               CALL 'ZPA01EKE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01EKE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
