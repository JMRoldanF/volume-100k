      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00SA9'.
      ...
      * Called module names
       01  MOD-ZCR01LIW              PIC X(8) VALUE 'ZCR01LIW'.
       01  MOD-ZPT01FW0              PIC X(8) VALUE 'ZPT01FW0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCR01LIW-001.
               PERFORM CALL-ZPT01FW0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCR01LIW-001.
               CALL 'ZCR01LIW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCR01LIW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPT01FW0-002.
               CALL 'ZPT01FW0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01FW0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
