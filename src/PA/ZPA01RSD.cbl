      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA01RSD'.
      ...
      * Called module names
       01  MOD-ZPA01SZP              PIC X(8) VALUE 'ZPA01SZP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01SZP-001.
               CALL 'ZPA01SZP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01SZP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
