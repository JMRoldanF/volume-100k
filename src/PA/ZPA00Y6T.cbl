      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00Y6T'.
      ...
      * Called module names
       01  MOD-ZPA01QHF              PIC X(8) VALUE 'ZPA01QHF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01QHF-001.
               PERFORM CALL-ZPA01RTR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01QHF-001.
               CALL 'ZPA01QHF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01QHF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01RTR-002.
