      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00D9H'.
      ...
      * Called module names
       01  MOD-ZCL00NE3              PIC X(8) VALUE 'ZCL00NE3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL00NE3-001.
               PERFORM CALL-ZRE01A15-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL00NE3-001.
               EXEC CICS LINK PROGRAM('ZCL00NE3')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL00NE3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01A15-002.
