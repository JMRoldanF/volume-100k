      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00Q0D'.
      ...
      * Called module names
       01  MOD-ZUW01KVI              PIC X(8) VALUE 'ZUW01KVI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01KVI-001.
               CALL 'ZUW01KVI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01KVI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-MODEL-0001.
