      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA01B3T'.
      ...
      * Called module names
       01  MOD-ZPA01DFZ              PIC X(8) VALUE 'ZPA01DFZ'.
       01  MOD-ZPA01KJT              PIC X(8) VALUE 'ZPA01KJT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01DFZ-001.
               PERFORM CALL-ZPA01KJT-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01DFZ-001.
               CALL 'ZPA01DFZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01DFZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01KJT-002.
               CALL 'ZPA01KJT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01KJT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
