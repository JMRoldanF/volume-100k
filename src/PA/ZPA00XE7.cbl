      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00XE7'.
      ...
      * Called module names
       01  MOD-ZPA01SV9              PIC X(8) VALUE 'ZPA01SV9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01SV9-001.
               CALL 'ZPA01SV9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01SV9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
