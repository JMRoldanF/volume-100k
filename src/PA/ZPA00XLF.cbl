      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00XLF'.
      ...
      * Called module names
       01  MOD-ZPA01DV9              PIC X(8) VALUE 'ZPA01DV9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01DV9-001.
               CALL 'ZPA01DV9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01DV9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
