      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA012CT'.
      ...
      * Called module names
       01  MOD-ZPA01MEH              PIC X(8) VALUE 'ZPA01MEH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01MEH-001.
               CALL 'ZPA01MEH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01MEH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
