      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA01139'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01NAP              PIC X(8) VALUE 'ZPA01NAP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01K8F-001.
               PERFORM CALL-ZPA01NAP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01NAP-002.
               CALL 'ZPA01NAP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01NAP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
