      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA01C51'.
      ...
      * Called module names
       01  MOD-ZPA01SBJ              PIC X(8) VALUE 'ZPA01SBJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01SBJ-001.
               CALL 'ZPA01SBJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01SBJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
