      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00LSZ'.
      ...
      * Called module names
       01  MOD-ZPT01QX5              PIC X(8) VALUE 'ZPT01QX5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPT01QX5-001.
               CALL 'ZPT01QX5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01QX5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
