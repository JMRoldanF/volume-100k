      ...
      * Called module names
       01  MOD-ZPA01SZZ              PIC X(8) VALUE 'ZPA01SZZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01SZZ-001.
               PERFORM CALL-ZPA01CNN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01SZZ-001.
               CALL 'ZPA01SZZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01SZZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01CNN-002.
               MOVE 'ZPA01CNN' TO WS-SUBNAME-6
