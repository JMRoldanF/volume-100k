      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA014SV'.
      ...
      * Called module names
       01  MOD-ZPA01H3D              PIC X(8) VALUE 'ZPA01H3D'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01H3D-001.
               PERFORM CALL-ZPA01L7P-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01H3D-001.
               CALL 'ZPA01H3D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01H3D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01L7P-002.
