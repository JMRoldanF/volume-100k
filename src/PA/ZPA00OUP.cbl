      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00OUP'.
      ...
      * Called module names
       01  MOD-ZPA01OGN              PIC X(8) VALUE 'ZPA01OGN'.
       01  MOD-ZPA01IX7              PIC X(8) VALUE 'ZPA01IX7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01OGN-001.
               PERFORM CALL-ZPA01IX7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01OGN-001.
               CALL 'ZPA01OGN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01OGN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01IX7-002.
               CALL 'ZPA01IX7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01IX7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
