      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00YI7'.
      ...
      * Called module names
       01  MOD-ZPA01RP1              PIC X(8) VALUE 'ZPA01RP1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01RP1-001.
               PERFORM CALL-ZPA01D7X-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01RP1-001.
               CALL 'ZPA01RP1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01RP1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01D7X-002.
               MOVE 'ZPA01D7X' TO WS-SUBNAME-4
