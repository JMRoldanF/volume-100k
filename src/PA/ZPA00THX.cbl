      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00THX'.
      ...
      * Called module names
       01  MOD-ZUW01LGM              PIC X(8) VALUE 'ZUW01LGM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01LGM-001.
               CALL 'ZUW01LGM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01LGM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
