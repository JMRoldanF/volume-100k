      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00RR9'.
      ...
      * Called module names
       01  MOD-ZPT01F91              PIC X(8) VALUE 'ZPT01F91'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPT01F91-001.
               CALL 'ZPT01F91' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01F91 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
