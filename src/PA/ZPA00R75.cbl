      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00R75'.
      ...
      * Called module names
       01  MOD-ZCL01QDZ              PIC X(8) VALUE 'ZCL01QDZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01QDZ-002.
               CALL 'ZCL01QDZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01QDZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
