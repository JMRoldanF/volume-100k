      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00VMV'.
      ...
      * Called module names
       01  MOD-ZHO01LAA              PIC X(8) VALUE 'ZHO01LAA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01LAA-001.
               CALL 'ZHO01LAA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01LAA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
