      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA0050J'.
      ...
      * Called module names
       01  MOD-ZHO00E6W              PIC X(8) VALUE 'ZHO00E6W'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO00E6W-001.
               PERFORM CALL-ZPA00E9B-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO00E6W-001.
               EXEC CICS LINK PROGRAM('ZHO00E6W')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO00E6W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA00E9B-002.
