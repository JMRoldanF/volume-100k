      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00N8X'.
      ...
      * Called module names
       01  MOD-ZPA01SHD              PIC X(8) VALUE 'ZPA01SHD'.
       01  MOD-ZAG01HOG              PIC X(8) VALUE 'ZAG01HOG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01SHD-001.
               PERFORM CALL-ZAG01HOG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01SHD-001.
               CALL 'ZPA01SHD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01SHD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01HOG-002.
               CALL 'ZAG01HOG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01HOG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
