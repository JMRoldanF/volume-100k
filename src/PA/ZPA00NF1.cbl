      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00NF1'.
      ...
      * Called module names
       01  MOD-ZPA01HM9              PIC X(8) VALUE 'ZPA01HM9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01HM9-001.
               PERFORM CALL-ZPA01U35-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01HM9-001.
               CALL 'ZPA01HM9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01HM9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01U35-002.
               MOVE 'ZPA01U35' TO WS-SUBNAME-8
