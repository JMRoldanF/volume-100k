      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA01C65'.
      ...
      * Called module names
       01  MOD-ZPA01DOL              PIC X(8) VALUE 'ZPA01DOL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01DOL-001.
               CALL 'ZPA01DOL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01DOL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
