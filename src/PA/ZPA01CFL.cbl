      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA01CFL'.
      ...
      * Called module names
       01  MOD-ZPA01T81              PIC X(8) VALUE 'ZPA01T81'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01T81-001.
               CALL 'ZPA01T81' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01T81 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
