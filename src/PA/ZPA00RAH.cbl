      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00RAH'.
      ...
      * Called module names
       01  MOD-ZCU01OTA              PIC X(8) VALUE 'ZCU01OTA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01OTA-001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCU01OTA-001.
               CALL 'ZCU01OTA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
