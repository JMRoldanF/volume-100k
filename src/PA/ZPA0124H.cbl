      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA0124H'.
      ...
      * Called module names
       01  MOD-ZPA01S5Z              PIC X(8) VALUE 'ZPA01S5Z'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01S5Z-001.
               PERFORM CALL-ZPA01GHF-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01S5Z-001.
               CALL 'ZPA01S5Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01GHF-002.
               MOVE 'ZPA01GHF' TO WS-SUBNAME-6
               CALL WS-SUBNAME-6 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01GHF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
