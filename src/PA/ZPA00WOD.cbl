      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00WOD'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01TVX              PIC X(8) VALUE 'ZPA01TVX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01IMN-001.
               PERFORM CALL-ZPA01TVX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01TVX-002.
               CALL 'ZPA01TVX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01TVX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
