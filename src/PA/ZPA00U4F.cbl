      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00U4F'.
      ...
      * Called module names
       01  MOD-ZPA01K2B              PIC X(8) VALUE 'ZPA01K2B'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01K2B-001.
               PERFORM CALL-ZUW01CWU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01K2B-001.
               CALL 'ZPA01K2B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01K2B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01CWU-002.
