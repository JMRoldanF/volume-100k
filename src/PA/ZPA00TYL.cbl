      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00TYL'.
      ...
      * Called module names
       01  MOD-ZCU01UAS              PIC X(8) VALUE 'ZCU01UAS'.
       01  MOD-ZPA01ORR              PIC X(8) VALUE 'ZPA01ORR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCU01UAS-001.
               PERFORM CALL-ZPA01ORR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01UAS-001.
               CALL 'ZCU01UAS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01UAS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01ORR-002.
               CALL 'ZPA01ORR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01ORR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
