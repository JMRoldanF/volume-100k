      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA018YV'.
      ...
      * Called module names
       01  MOD-ZPA01DFP              PIC X(8) VALUE 'ZPA01DFP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01SCX-001.
               PERFORM CALL-ZPA01DFP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01DFP-002.
               CALL 'ZPA01DFP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
