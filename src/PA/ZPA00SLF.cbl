      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00SLF'.
      ...
      * Called module names
       01  MOD-ZPA01UXF              PIC X(8) VALUE 'ZPA01UXF'.
       01  MOD-ZPA01JQD              PIC X(8) VALUE 'ZPA01JQD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01UXF-001.
               PERFORM CALL-ZPA01JQD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01UXF-001.
               CALL 'ZPA01UXF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01UXF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01JQD-002.
               CALL 'ZPA01JQD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
