      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA011ST'.
      ...
      * Called module names
       01  MOD-ZPA01FPX              PIC X(8) VALUE 'ZPA01FPX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01FPX-001.
               PERFORM CALL-ZMT0255L-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZPA01FPX-001.
               CALL 'ZPA01FPX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
