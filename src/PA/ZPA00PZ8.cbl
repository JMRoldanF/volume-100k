      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00PZ8'.
      ...
      * Called module names
       01  MOD-ZPA01LRG              PIC X(8) VALUE 'ZPA01LRG'.
       01  MOD-ZCR01OUO              PIC X(8) VALUE 'ZCR01OUO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01LRG-001.
               CALL 'ZPA01LRG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZCR01OUO-002.
               CALL 'ZCR01OUO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCR01OUO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
