      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00V5X'.
      ...
      * Called module names
       01  MOD-ZPA01SE1              PIC X(8) VALUE 'ZPA01SE1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01SE1-001.
               CALL 'ZPA01SE1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01SE1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
