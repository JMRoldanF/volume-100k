      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA01L8T'.
      ...
      * Called module names
       01  MOD-ZPA01K5D              PIC X(8) VALUE 'ZPA01K5D'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01K5D-001.
               CALL 'ZPA01K5D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01K5D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
