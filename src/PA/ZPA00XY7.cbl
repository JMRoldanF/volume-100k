      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00XY7'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01M3D              PIC X(8) VALUE 'ZPA01M3D'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01QXJ-001.
               PERFORM CALL-ZPA01M3D-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01M3D-002.
               CALL 'ZPA01M3D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01M3D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
