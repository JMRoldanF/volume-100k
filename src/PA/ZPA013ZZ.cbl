      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA013ZZ'.
      ...
      * Called module names
       01  MOD-ZPA01T2R              PIC X(8) VALUE 'ZPA01T2R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01T2R-001.
               CALL 'ZPA01T2R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01T2R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
