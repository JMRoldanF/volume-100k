      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00VOJ'.
      ...
      * Called module names
       01  MOD-ZPA01QTD              PIC X(8) VALUE 'ZPA01QTD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01QTD-001.
               CALL 'ZPA01QTD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01QTD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
