      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA010O9'.
      ...
      * Called module names
       01  MOD-ZPA01HQF              PIC X(8) VALUE 'ZPA01HQF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01HQF-001.
               CALL 'ZPA01HQF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01HQF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
