      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00U8L'.
      ...
      * Called module names
       01  MOD-ZPA01DWN              PIC X(8) VALUE 'ZPA01DWN'.
       01  MOD-ZPA01NRX              PIC X(8) VALUE 'ZPA01NRX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01DWN-001.
               CALL 'ZPA01DWN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01DWN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01NRX-002.
               CALL 'ZPA01NRX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01NRX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
