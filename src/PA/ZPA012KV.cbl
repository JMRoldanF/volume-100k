      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA012KV'.
      ...
      * Called module names
       01  MOD-ZPA01OBN              PIC X(8) VALUE 'ZPA01OBN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01OBN-002.
               CALL 'ZPA01OBN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01OBN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
