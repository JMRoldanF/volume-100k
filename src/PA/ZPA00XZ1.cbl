      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00XZ1'.
      ...
      * Called module names
       01  MOD-ZPA01RPL              PIC X(8) VALUE 'ZPA01RPL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01RPL-001.
               PERFORM CALL-ZMT01SHF-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01RPL-001.
               CALL 'ZPA01RPL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01RPL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01SHF-002.
