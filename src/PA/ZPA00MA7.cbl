      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00MA7'.
      ...
      * Called module names
       01  MOD-ZPA01MAV              PIC X(8) VALUE 'ZPA01MAV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01MAV-001.
               CALL 'ZPA01MAV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01MAV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
