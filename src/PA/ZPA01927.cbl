      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA01927'.
      ...
      * Called module names
       01  MOD-ZPA01EMH              PIC X(8) VALUE 'ZPA01EMH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01EMH-001.
               CALL 'ZPA01EMH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01EMH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
