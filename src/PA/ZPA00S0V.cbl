      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00S0V'.
      ...
      * Called module names
       01  MOD-ZPA01PRB              PIC X(8) VALUE 'ZPA01PRB'.
       01  MOD-ZPA01J9Z              PIC X(8) VALUE 'ZPA01J9Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01PRB-001.
               CALL 'ZPA01PRB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01PRB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01J9Z-002.
               CALL 'ZPA01J9Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01J9Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
