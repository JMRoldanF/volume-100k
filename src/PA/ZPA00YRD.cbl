      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00YRD'.
      ...
      * Called module names
       01  MOD-ZPA01DZF              PIC X(8) VALUE 'ZPA01DZF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01DZF-001.
               CALL 'ZPA01DZF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01DZF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
