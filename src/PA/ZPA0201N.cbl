      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA0201N'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01RQ5              PIC X(8) VALUE 'ZPA01RQ5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01RQ5-002.
               CALL 'ZPA01RQ5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01RQ5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA010X5-003.
               CALL 'ZPA010X5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
