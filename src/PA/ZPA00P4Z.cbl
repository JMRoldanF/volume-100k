      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00P4Z'.
      ...
      * Called module names
       01  MOD-ZPA01I4V              PIC X(8) VALUE 'ZPA01I4V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01I4V-001.
               CALL 'ZPA01I4V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01I4V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
