      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00MGA'.
      ...
      * Called module names
       01  MOD-ZPA01F5D              PIC X(8) VALUE 'ZPA01F5D'.
       01  MOD-ZCR01Q0A              PIC X(8) VALUE 'ZCR01Q0A'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01F5D-001.
               PERFORM CALL-ZCR01Q0A-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01F5D-001.
               CALL 'ZPA01F5D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01F5D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCR01Q0A-002.
               CALL 'ZCR01Q0A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCR01Q0A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
