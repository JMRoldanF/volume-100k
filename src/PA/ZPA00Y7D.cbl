      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00Y7D'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01UKX              PIC X(8) VALUE 'ZPA01UKX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01UKX-002.
               CALL 'ZPA01UKX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01UKX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
