      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00ZZ0'.
      ...
      * Called module names
       01  MOD-ZPA01GEZ              PIC X(8) VALUE 'ZPA01GEZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01GEZ-001.
               CALL 'ZPA01GEZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01GEZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
