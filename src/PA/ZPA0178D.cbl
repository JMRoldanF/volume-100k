      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA0178D'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01NOB              PIC X(8) VALUE 'ZPA01NOB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01L47-001.
               PERFORM CALL-ZPA01NOB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01NOB-002.
               CALL 'ZPA01NOB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01NOB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
