      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00R4D'.
      ...
      * Called module names
       01  MOD-ZPA01IJB              PIC X(8) VALUE 'ZPA01IJB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01IJB-001.
               CALL 'ZPA01IJB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01IJB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
