      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00Y7Q'.
      ...
      * Called module names
       01  MOD-ZPA01NAO              PIC X(8) VALUE 'ZPA01NAO'.
       01  MOD-ZPA01KYZ              PIC X(8) VALUE 'ZPA01KYZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01NAO-001.
               PERFORM CALL-ZPA01KYZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01NAO-001.
               CALL 'ZPA01NAO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01NAO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01KYZ-002.
               CALL 'ZPA01KYZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01KYZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
