      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00S8D'.
      ...
      * Called module names
       01  MOD-ZAG01RZA              PIC X(8) VALUE 'ZAG01RZA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01RZA-001.
               PERFORM CALL-ZPA01ER7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01RZA-001.
               CALL 'ZAG01RZA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01RZA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01ER7-002.
               MOVE 'ZPA01ER7' TO WS-SUBNAME-2
