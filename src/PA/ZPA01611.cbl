      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA01611'.
      ...
      * Called module names
       01  MOD-ZPA01QON              PIC X(8) VALUE 'ZPA01QON'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01QON-001.
               CALL 'ZPA01QON' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01QON FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-EXCESS-0001.
