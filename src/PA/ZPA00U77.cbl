      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00U77'.
      ...
      * Called module names
       01  MOD-ZCU01J4A              PIC X(8) VALUE 'ZCU01J4A'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01J4A-001.
               CALL 'ZCU01J4A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01J4A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
