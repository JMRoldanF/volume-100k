      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00VOE'.
      ...
      * Called module names
       01  MOD-ZPA01T12              PIC X(8) VALUE 'ZPA01T12'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01T12-001.
               CALL 'ZPA01T12' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01T12 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
