      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA011X9'.
      ...
      * Called module names
       01  MOD-ZUW01L1C              PIC X(8) VALUE 'ZUW01L1C'.
       01  MOD-ZPA01HGP              PIC X(8) VALUE 'ZPA01HGP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01L1C-001.
               PERFORM CALL-ZPA01HGP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01L1C-001.
               CALL 'ZUW01L1C' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01L1C FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01HGP-002.
               CALL 'ZPA01HGP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01HGP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
