      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00U09'.
      ...
      * Called module names
       01  MOD-ZPA01N8R              PIC X(8) VALUE 'ZPA01N8R'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01N8R-001.
               CALL 'ZPA01N8R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01N8R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
