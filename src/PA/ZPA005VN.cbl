      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA005VN'.
      ...
      * Called module names
       01  MOD-ZPA00G0X              PIC X(8) VALUE 'ZPA00G0X'.
       01  MOD-ZPA00K81              PIC X(8) VALUE 'ZPA00K81'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA00G0X-001.
               PERFORM CALL-ZPA00K81-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00G0X-001.
               EXEC CICS LINK PROGRAM('ZPA00G0X')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA00G0X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA00K81-002.
               EXEC CICS LINK PROGRAM('ZPA00K81')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA00K81 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
