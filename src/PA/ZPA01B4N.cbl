      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA01B4N'.
      ...
      * Called module names
       01  MOD-ZAG01U7U              PIC X(8) VALUE 'ZAG01U7U'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01KXP-001.
               PERFORM CALL-ZAG01U7U-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01U7U-002.
               CALL 'ZAG01U7U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01U7U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
