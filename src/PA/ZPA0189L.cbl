      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA0189L'.
      ...
      * Called module names
       01  MOD-ZPA01JUT              PIC X(8) VALUE 'ZPA01JUT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01JUT-001.
               CALL 'ZPA01JUT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01JUT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
