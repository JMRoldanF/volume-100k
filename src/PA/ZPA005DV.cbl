      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA005DV'.
      ...
      * Called module names
       01  MOD-ZPA00CIT              PIC X(8) VALUE 'ZPA00CIT'.
       01  MOD-ZPA00LAX              PIC X(8) VALUE 'ZPA00LAX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA00CIT-001.
               PERFORM CALL-ZPA00LAX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00CIT-001.
               EXEC CICS LINK PROGRAM('ZPA00CIT')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA00CIT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA00LAX-002.
               EXEC CICS LINK PROGRAM('ZPA00LAX')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA00LAX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
