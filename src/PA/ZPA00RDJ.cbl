      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00RDJ'.
      ...
      * Called module names
       01  MOD-ZPA01O4Z              PIC X(8) VALUE 'ZPA01O4Z'.
       01  MOD-ZPA01GZH              PIC X(8) VALUE 'ZPA01GZH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01O4Z-001.
               PERFORM CALL-ZPA01GZH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01O4Z-001.
               CALL 'ZPA01O4Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01O4Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01GZH-002.
               CALL 'ZPA01GZH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01GZH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
