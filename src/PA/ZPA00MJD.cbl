      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00MJD'.
      ...
      * Called module names
       01  MOD-ZPA01M1F              PIC X(8) VALUE 'ZPA01M1F'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01M1F-001.
               CALL 'ZPA01M1F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01M1F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
