      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00ZN1'.
      ...
      * Called module names
       01  MOD-ZPA01F3F              PIC X(8) VALUE 'ZPA01F3F'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01F3F-001.
               CALL 'ZPA01F3F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01F3F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
