      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00SJH'.
      ...
      * Called module names
       01  MOD-ZHO01OFW              PIC X(8) VALUE 'ZHO01OFW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01OFW-001.
               CALL 'ZHO01OFW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01OFW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
