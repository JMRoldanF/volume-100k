      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00RS9'.
      ...
      * Called module names
       01  MOD-ZPA01OGD              PIC X(8) VALUE 'ZPA01OGD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01GEN-001.
               PERFORM CALL-ZPA01OGD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01OGD-002.
               CALL 'ZPA01OGD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01OGD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
