      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00N3N'.
      ...
      * Called module names
       01  MOD-ZPA01G2P              PIC X(8) VALUE 'ZPA01G2P'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01G2P-001.
               CALL 'ZPA01G2P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01G2P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
