      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00UD1'.
      ...
      * Called module names
       01  MOD-ZPA01PNP              PIC X(8) VALUE 'ZPA01PNP'.
       01  MOD-ZAG01KYI              PIC X(8) VALUE 'ZAG01KYI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01PNP-001.
               PERFORM CALL-ZAG01KYI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01PNP-001.
               CALL 'ZPA01PNP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01PNP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01KYI-002.
               CALL 'ZAG01KYI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01KYI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
