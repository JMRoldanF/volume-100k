      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00WRZ'.
      ...
      * Called module names
       01  MOD-ZPA01HKB              PIC X(8) VALUE 'ZPA01HKB'.
       01  MOD-ZPA01SOB              PIC X(8) VALUE 'ZPA01SOB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01HKB-001.
               PERFORM CALL-ZPA01SOB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01HKB-001.
               CALL 'ZPA01HKB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01HKB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01SOB-002.
               CALL 'ZPA01SOB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01SOB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
