      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00TT1'.
      ...
      * Called module names
       01  MOD-ZPA01NWX              PIC X(8) VALUE 'ZPA01NWX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01NWX-001.
               CALL 'ZPA01NWX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01NWX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
