      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00PW7'.
      ...
      * Called module names
       01  MOD-ZPA01JHH              PIC X(8) VALUE 'ZPA01JHH'.
       01  MOD-ZPA01NEL              PIC X(8) VALUE 'ZPA01NEL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01JHH-001.
               PERFORM CALL-ZPA01NEL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01JHH-001.
               CALL 'ZPA01JHH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01JHH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01NEL-002.
               CALL 'ZPA01NEL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01NEL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
