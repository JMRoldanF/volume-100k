      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00QB7'.
      ...
      * Called module names
       01  MOD-ZPA01HWJ              PIC X(8) VALUE 'ZPA01HWJ'.
       01  MOD-ZPA01KAX              PIC X(8) VALUE 'ZPA01KAX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01HWJ-001.
               PERFORM CALL-ZPA01KAX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01HWJ-001.
               CALL 'ZPA01HWJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01HWJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01KAX-002.
               CALL 'ZPA01KAX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01KAX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
