      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00PN1'.
      ...
      * Called module names
       01  MOD-ZRE01V1T              PIC X(8) VALUE 'ZRE01V1T'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01V1T-001.
               CALL 'ZRE01V1T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01V1T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
