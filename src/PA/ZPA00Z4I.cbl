      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00Z4I'.
      ...
      * Called module names
       01  MOD-ZPA01DNL              PIC X(8) VALUE 'ZPA01DNL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01DNL-001.
               CALL 'ZPA01DNL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01DNL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
