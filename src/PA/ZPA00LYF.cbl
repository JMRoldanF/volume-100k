      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00LYF'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01SN1              PIC X(8) VALUE 'ZPA01SN1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01SN1-002.
               CALL 'ZPA01SN1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01SN1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
