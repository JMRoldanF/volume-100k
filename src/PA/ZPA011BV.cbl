      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA011BV'.
      ...
      * Called module names
       01  MOD-ZPA01CSN              PIC X(8) VALUE 'ZPA01CSN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01CSN-001.
               CALL 'ZPA01CSN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01CSN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
