      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA01B25'.
      ...
      * Called module names
       01  MOD-ZMT01PAP              PIC X(8) VALUE 'ZMT01PAP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01PAP-001.
               CALL 'ZMT01PAP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01PAP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
