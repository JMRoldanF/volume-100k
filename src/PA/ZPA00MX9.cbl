      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00MX9'.
      ...
      * Called module names
       01  MOD-ZPA01I5P              PIC X(8) VALUE 'ZPA01I5P'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01U21-001.
               PERFORM CALL-ZPA01I5P-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01I5P-002.
               CALL 'ZPA01I5P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
