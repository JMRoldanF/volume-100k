      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00TCX'.
      ...
      * Called module names
       01  MOD-ZCL01LW1              PIC X(8) VALUE 'ZCL01LW1'.
       01  MOD-ZPA01ITL              PIC X(8) VALUE 'ZPA01ITL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01LW1-001.
               PERFORM CALL-ZPA01ITL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01LW1-001.
               CALL 'ZCL01LW1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01LW1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01ITL-002.
               CALL 'ZPA01ITL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01ITL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       VALIDATE-MODEL-0001.
