      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00X1F'.
      ...
      * Called module names
       01  MOD-ZPA01IJV              PIC X(8) VALUE 'ZPA01IJV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01IJV-001.
               PERFORM CALL-ZPA01FK3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01IJV-001.
               CALL 'ZPA01IJV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01IJV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01FK3-002.
