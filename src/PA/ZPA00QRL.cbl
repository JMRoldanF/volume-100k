      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00QRL'.
      ...
      * Called module names
       01  MOD-ZPA01TY5              PIC X(8) VALUE 'ZPA01TY5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM FORMAT-AGENT-CODE-0100.
               ...
               PERFORM EXPAND-MODEL-0112.
               PERFORM NORMALISE-HOUSE-TYPE-0113.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZPA01TY5-001.
               CALL 'ZPA01TY5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01TY5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
