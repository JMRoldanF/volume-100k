      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA010IP'.
      ...
      * Called module names
       01  MOD-ZPA01JP9              PIC X(8) VALUE 'ZPA01JP9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01JP9-001.
               CALL 'ZPA01JP9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01JP9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01K5X-002.
