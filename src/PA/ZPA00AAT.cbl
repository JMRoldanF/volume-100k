      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00AAT'.
      ...
      * Called module names
       01  MOD-ZPA01233              PIC X(8) VALUE 'ZPA01233'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01233-001.
               EXEC CICS LINK PROGRAM('ZPA01233')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01233 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-COLOUR-0001.
