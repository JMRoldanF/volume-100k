      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00IHT'.
      ...
      * Called module names
       01  MOD-ZPA00YOL              PIC X(8) VALUE 'ZPA00YOL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00YOL-001.
               EXEC CICS LINK PROGRAM('ZPA00YOL')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA00YOL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
