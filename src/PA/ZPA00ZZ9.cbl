      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00ZZ9'.
      ...
      * Called module names
       01  MOD-ZPA01LIT              PIC X(8) VALUE 'ZPA01LIT'.
       01  MOD-ZPA01O63              PIC X(8) VALUE 'ZPA01O63'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01LIT-001.
               CALL 'ZPA01LIT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01LIT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01O63-002.
               CALL 'ZPA01O63' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
