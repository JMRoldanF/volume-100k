      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00RH5'.
      ...
      * Called module names
       01  MOD-ZPA01RS3              PIC X(8) VALUE 'ZPA01RS3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01RS3-001.
               PERFORM CALL-ZPA01LKH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01RS3-001.
               CALL 'ZPA01RS3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01RS3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01LKH-002.
