      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA0143B'.
      ...
      * Called module names
       01  MOD-ZBI01ONI              PIC X(8) VALUE 'ZBI01ONI'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01ONI-001.
               CALL 'ZBI01ONI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01ONI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
