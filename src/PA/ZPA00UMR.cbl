      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00UMR'.
      ...
      * Called module names
       01  MOD-ZPA01OQX              PIC X(8) VALUE 'ZPA01OQX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01OQX-001.
               PERFORM CALL-ZEN01L1F-002.
               ...
               PERFORM FORMAT-STATUS-CODE-0074.
               ...
               PERFORM NORMALISE-SUM-ASSURED-0122.
               ...
               PERFORM RECONCILE-ROOF-TYPE-0130.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZPA01OQX-001.
               CALL 'ZPA01OQX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01OQX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01L1F-002.
               MOVE 'ZEN01L1F' TO WS-SUBNAME-7
