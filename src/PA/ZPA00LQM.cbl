      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00LQM'.
      ...
      * Called module names
       01  MOD-ZPA01ELP              PIC X(8) VALUE 'ZPA01ELP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01ELP-001.
               PERFORM CALL-ZPA01TQF-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01ELP-001.
               CALL 'ZPA01ELP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01ELP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01TQF-002.
