      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00Y73'.
      ...
      * Called module names
       01  MOD-ZPA01DCN              PIC X(8) VALUE 'ZPA01DCN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01DCN-001.
               CALL 'ZPA01DCN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01DCN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
