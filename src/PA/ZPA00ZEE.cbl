      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00ZEE'.
      ...
      * Called module names
       01  MOD-ZPA01M19              PIC X(8) VALUE 'ZPA01M19'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01M19-001.
               CALL 'ZPA01M19' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01M19 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
