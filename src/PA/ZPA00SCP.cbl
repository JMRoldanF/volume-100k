      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00SCP'.
      ...
      * Called module names
       01  MOD-ZPA01P46              PIC X(8) VALUE 'ZPA01P46'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01P46-001.
               CALL 'ZPA01P46' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01P46 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01S50-002.
