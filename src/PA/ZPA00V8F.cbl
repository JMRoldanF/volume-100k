      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00V8F'.
      ...
      * Called module names
       01  MOD-ZPA01OMH              PIC X(8) VALUE 'ZPA01OMH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01OMH-001.
               CALL 'ZPA01OMH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01OMH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
