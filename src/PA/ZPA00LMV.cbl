      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00LMV'.
      ...
      * Called module names
       01  MOD-ZPA01J8B              PIC X(8) VALUE 'ZPA01J8B'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01J8B-001.
               CALL 'ZPA01J8B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01J8B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
