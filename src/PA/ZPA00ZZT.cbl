      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00ZZT'.
      ...
      * Called module names
       01  MOD-ZPA01KAD              PIC X(8) VALUE 'ZPA01KAD'.
       01  MOD-ZEN01IWH              PIC X(8) VALUE 'ZEN01IWH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01KAD-001.
               PERFORM CALL-ZEN01IWH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01KAD-001.
               CALL 'ZPA01KAD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01KAD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01IWH-002.
               CALL 'ZEN01IWH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01IWH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-EXCESS-0001.
