      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00ZDB'.
      ...
      * Called module names
       01  MOD-ZPA01FSF              PIC X(8) VALUE 'ZPA01FSF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01FSF-001.
               PERFORM CALL-ZPA01T27-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01FSF-001.
               CALL 'ZPA01FSF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01FSF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01T27-002.
