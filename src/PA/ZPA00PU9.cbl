      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00PU9'.
      ...
      * Called module names
       01  MOD-ZPA01RXD              PIC X(8) VALUE 'ZPA01RXD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01RXD-001.
               CALL 'ZPA01RXD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01RXD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-TAX-BAND-0001.
