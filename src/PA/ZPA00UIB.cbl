      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00UIB'.
      ...
      * Called module names
       01  MOD-ZPA01URV              PIC X(8) VALUE 'ZPA01URV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01URV-001.
               CALL 'ZPA01URV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01URV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01IRD-002.
