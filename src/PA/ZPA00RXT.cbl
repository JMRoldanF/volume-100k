      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00RXT'.
      ...
      * Called module names
       01  MOD-ZPA01GED              PIC X(8) VALUE 'ZPA01GED'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZBI01URS-001.
               PERFORM CALL-ZPA01GED-002.
               PERFORM CALL-ZCU0255O-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZBI01URS-001.
               MOVE 'ZBI01URS' TO WS-SUBNAME-7
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01GED-002.
               CALL 'ZPA01GED' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01GED FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
