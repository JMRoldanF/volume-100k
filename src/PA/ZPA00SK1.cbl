      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00SK1'.
      ...
      * Called module names
       01  MOD-ZPA01FZN              PIC X(8) VALUE 'ZPA01FZN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01FZN-001.
               CALL 'ZPA01FZN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01FZN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01HRD-002.
