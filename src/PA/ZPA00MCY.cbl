      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00MCY'.
      ...
      * Called module names
       01  MOD-ZPA01FRU              PIC X(8) VALUE 'ZPA01FRU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01FRU-001.
               CALL 'ZPA01FRU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01FRU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPT01N0C-002.
