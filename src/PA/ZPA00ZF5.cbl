      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00ZF5'.
      ...
      * Called module names
       01  MOD-ZPA01CUK              PIC X(8) VALUE 'ZPA01CUK'.
       01  MOD-ZPA01KS2              PIC X(8) VALUE 'ZPA01KS2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01CUK-001.
               PERFORM CALL-ZPA01KS2-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01CUK-001.
               CALL 'ZPA01CUK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01CUK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01KS2-002.
               CALL 'ZPA01KS2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01KS2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
