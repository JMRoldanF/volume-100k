      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA0030B'.
      ...
      * Called module names
       01  MOD-ZPA00B85              PIC X(8) VALUE 'ZPA00B85'.
       01  MOD-ZPA00LJT              PIC X(8) VALUE 'ZPA00LJT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA00B85-001.
               PERFORM CALL-ZPA00LJT-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00B85-001.
               EXEC CICS LINK PROGRAM('ZPA00B85')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA00B85 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA00LJT-002.
               EXEC CICS LINK PROGRAM('ZPA00LJT')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA00LJT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
