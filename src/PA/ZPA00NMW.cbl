      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00NMW'.
      ...
      * Called module names
       01  MOD-ZCR01TYZ              PIC X(8) VALUE 'ZCR01TYZ'.
       01  MOD-ZPA01IKE              PIC X(8) VALUE 'ZPA01IKE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCR01TYZ-001.
               PERFORM CALL-ZPA01IKE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCR01TYZ-001.
               CALL 'ZCR01TYZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCR01TYZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01IKE-002.
               CALL 'ZPA01IKE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01IKE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-COLOUR-0001.
