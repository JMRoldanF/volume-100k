      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00TWN'.
      ...
      * Called module names
       01  MOD-ZPA01EB3              PIC X(8) VALUE 'ZPA01EB3'.
       01  MOD-ZPA01OD1              PIC X(8) VALUE 'ZPA01OD1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01EB3-001.
               PERFORM CALL-ZPA01OD1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01EB3-001.
               CALL 'ZPA01EB3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01EB3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01OD1-002.
               CALL 'ZPA01OD1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01OD1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
