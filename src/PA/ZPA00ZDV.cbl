      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00ZDV'.
      ...
      * Called module names
       01  MOD-ZPA01SR3              PIC X(8) VALUE 'ZPA01SR3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01SR3-001.
               CALL 'ZPA01SR3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01SR3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01Q9N-002.
