      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00STH'.
      ...
      * Called module names
       01  MOD-ZPA01UIP              PIC X(8) VALUE 'ZPA01UIP'.
       01  MOD-ZPA01V0R              PIC X(8) VALUE 'ZPA01V0R'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01UIP-001.
               PERFORM CALL-ZPA01V0R-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01UIP-001.
               CALL 'ZPA01UIP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01UIP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01V0R-002.
               CALL 'ZPA01V0R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01V0R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
