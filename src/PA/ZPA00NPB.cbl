      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00NPB'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01P35              PIC X(8) VALUE 'ZPA01P35'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01DPP-001.
               PERFORM CALL-ZPA01P35-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01P35-002.
               CALL 'ZPA01P35' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01P35 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-EXCESS-0001.
