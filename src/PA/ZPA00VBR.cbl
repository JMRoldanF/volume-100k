      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00VBR'.
      ...
      * Called module names
       01  MOD-ZPA01D1J              PIC X(8) VALUE 'ZPA01D1J'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01D1J-002.
               CALL 'ZPA01D1J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01D1J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
