      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA0124R'.
      ...
      * Called module names
       01  MOD-ZAG01RHS              PIC X(8) VALUE 'ZAG01RHS'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG01RHS-001.
               PERFORM CALL-ZPA01LH5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01RHS-001.
               CALL 'ZAG01RHS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01RHS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01LH5-002.
               MOVE 'ZPA01LH5' TO WS-SUBNAME-1
