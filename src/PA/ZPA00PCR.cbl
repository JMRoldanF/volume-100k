      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00PCR'.
      ...
      * Called module names
       01  MOD-ZPA01JPT              PIC X(8) VALUE 'ZPA01JPT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01JPT-001.
               CALL 'ZPA01JPT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01JPT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
