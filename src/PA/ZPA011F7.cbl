      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA011F7'.
      ...
      * Called module names
       01  MOD-ZHO01PZQ              PIC X(8) VALUE 'ZHO01PZQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01PZQ-001.
               CALL 'ZHO01PZQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01PZQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-VALUE-0001.
