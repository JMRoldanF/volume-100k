      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00RC5'.
      ...
      * Called module names
       01  MOD-ZPA01KCB              PIC X(8) VALUE 'ZPA01KCB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01KCB-001.
               CALL 'ZPA01KCB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01KCB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
