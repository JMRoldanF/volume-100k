      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00PJZ'.
      ...
      * Called module names
       01  MOD-ZPA01L11              PIC X(8) VALUE 'ZPA01L11'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01L11-001.
               CALL 'ZPA01L11' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01L11 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
