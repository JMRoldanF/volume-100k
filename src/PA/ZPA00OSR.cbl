      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00OSR'.
      ...
      * Called module names
       01  MOD-ZPA01GU7              PIC X(8) VALUE 'ZPA01GU7'.
       01  MOD-ZBI01QG8              PIC X(8) VALUE 'ZBI01QG8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01GU7-001.
               PERFORM CALL-ZBI01QG8-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01GU7-001.
               CALL 'ZPA01GU7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01GU7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01QG8-002.
               CALL 'ZBI01QG8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
