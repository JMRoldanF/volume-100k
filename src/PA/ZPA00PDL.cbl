      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00PDL'.
      ...
      * Called module names
       01  MOD-ZEN01TQ7              PIC X(8) VALUE 'ZEN01TQ7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01TQ7-001.
               PERFORM CALL-ZEN0255N-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZEN01TQ7-001.
               CALL 'ZEN01TQ7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
