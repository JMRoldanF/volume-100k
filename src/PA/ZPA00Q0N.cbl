      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00Q0N'.
      ...
      * Called module names
       01  MOD-ZPA01JTF              PIC X(8) VALUE 'ZPA01JTF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01JTF-001.
               CALL 'ZPA01JTF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01JTF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01PD5-002.
