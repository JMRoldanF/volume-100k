      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00Q7V'.
      ...
      * Called module names
       01  MOD-ZPA01U3P              PIC X(8) VALUE 'ZPA01U3P'.
       01  MOD-ZPA01IEV              PIC X(8) VALUE 'ZPA01IEV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01U3P-001.
               PERFORM CALL-ZPA01IEV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01U3P-001.
               CALL 'ZPA01U3P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01U3P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01IEV-002.
               CALL 'ZPA01IEV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
