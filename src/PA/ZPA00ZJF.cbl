      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00ZJF'.
      ...
      * Called module names
       01  MOD-ZPA01RGZ              PIC X(8) VALUE 'ZPA01RGZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01RGZ-001.
               CALL 'ZPA01RGZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01RGZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
