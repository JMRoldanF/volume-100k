      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00PPJ'.
      ...
      * Called module names
       01  MOD-ZEN01L8N              PIC X(8) VALUE 'ZEN01L8N'.
       01  MOD-ZPA01UXP              PIC X(8) VALUE 'ZPA01UXP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01L8N-001.
               PERFORM CALL-ZPA01UXP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01L8N-001.
               CALL 'ZEN01L8N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01L8N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01UXP-002.
               CALL 'ZPA01UXP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01UXP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
