      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA004XR'.
      ...
      * Called module names
       01  MOD-ZPA0069J              PIC X(8) VALUE 'ZPA0069J'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA008FB-001.
               PERFORM CALL-ZPA0069J-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA008FB-001.
               MOVE 'ZPA008FB' TO WS-PROGNAME-1
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA008FB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA0069J-002.
               EXEC CICS LINK PROGRAM('ZPA0069J')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA0069J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
