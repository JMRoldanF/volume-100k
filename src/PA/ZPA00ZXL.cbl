      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00ZXL'.
      ...
      * Called module names
       01  MOD-ZPA01KJ9              PIC X(8) VALUE 'ZPA01KJ9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01KJ9-001.
               CALL 'ZPA01KJ9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01KJ9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
