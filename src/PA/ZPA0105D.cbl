      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA0105D'.
      ...
      * Called module names
       01  MOD-ZPA01UJT              PIC X(8) VALUE 'ZPA01UJT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01UJT-001.
               CALL 'ZPA01UJT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01UJT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
