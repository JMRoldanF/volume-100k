      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00VUN'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01F0D              PIC X(8) VALUE 'ZPA01F0D'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01QZ7-001.
               PERFORM CALL-ZPA01F0D-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01F0D-002.
               CALL 'ZPA01F0D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01F0D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
