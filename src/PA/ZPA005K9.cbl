      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA005K9'.
      ...
      * Called module names
       01  MOD-ZCL00JBP              PIC X(8) VALUE 'ZCL00JBP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL00JBP-001.
               PERFORM CALL-ZPA009VJ-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL00JBP-001.
               EXEC CICS LINK PROGRAM('ZCL00JBP')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL00JBP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA009QT-002.
               MOVE 'ZPA009QT' TO WS-PROGNAME-8
      ...
      *----------------------------------------------------------------*
       CALL-ZPA009VJ-003.
               MOVE 'ZPA009VJ' TO WS-PROGNAME-1
      ...
      *----------------------------------------------------------------*
       CALL-ZUW000SM-004.
               EXEC CICS START TRANSID('Z0SM')
                         FROM(WS-KEY-AREA)
                         LENGTH(20)
                         RESP(WS-RESP)
               END-EXEC.
      * TRANSID Z0SM is defined against ZUW000SM
               IF WS-RESP NOT = DFHRESP(NORMAL)
