      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA0110H'.
      ...
      * Called module names
       01  MOD-ZPA01OVN              PIC X(8) VALUE 'ZPA01OVN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01OVN-001.
               CALL 'ZPA01OVN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01OVN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
