      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00XR9'.
      ...
      * Called module names
       01  MOD-ZPA01I1T              PIC X(8) VALUE 'ZPA01I1T'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01I1T-001.
               CALL 'ZPA01I1T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01I1T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01MAB-002.
