      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00TBT'.
      ...
      * Called module names
       01  MOD-ZPA01Q3J              PIC X(8) VALUE 'ZPA01Q3J'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01Q3J-001.
               PERFORM CALL-ZPA01GMF-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01Q3J-001.
               CALL 'ZPA01Q3J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01Q3J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01GMF-002.
