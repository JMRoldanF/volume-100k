      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA021WV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01E81-001.
               PERFORM CALL-ZRE01LTL-002.
               PERFORM CALL-ZPA01R2J-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01E81-001.
               MOVE 'ZPA01E81' TO WS-SUBNAME-8
               CALL WS-SUBNAME-8 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01E81 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01LTL-002.
               MOVE 'ZRE01LTL' TO WS-SUBNAME-1
