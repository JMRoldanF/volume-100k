      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00UQD'.
      ...
      * Called module names
       01  MOD-ZPA01GDT              PIC X(8) VALUE 'ZPA01GDT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01GDT-001.
               CALL 'ZPA01GDT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01GDT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
