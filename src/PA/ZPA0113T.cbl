      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA0113T'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01P1H              PIC X(8) VALUE 'ZPA01P1H'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01FTT-001.
               PERFORM CALL-ZPA01P1H-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01P1H-002.
               CALL 'ZPA01P1H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01P1H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
