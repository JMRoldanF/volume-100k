      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00ZP9'.
      ...
      * Called module names
       01  MOD-ZPA01J3B              PIC X(8) VALUE 'ZPA01J3B'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01J3B-001.
               CALL 'ZPA01J3B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01J3B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
