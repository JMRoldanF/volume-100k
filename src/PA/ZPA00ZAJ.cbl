      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00ZAJ'.
      ...
      * Called module names
       01  MOD-ZPA01ENV              PIC X(8) VALUE 'ZPA01ENV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01ENV-001.
               PERFORM CALL-ZPA01HDX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01ENV-001.
               CALL 'ZPA01ENV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01ENV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01HDX-002.
