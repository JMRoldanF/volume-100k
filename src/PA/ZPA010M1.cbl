      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA010M1'.
      ...
      * Called module names
       01  MOD-ZPA01QFH              PIC X(8) VALUE 'ZPA01QFH'.
       01  MOD-ZPA01MFL              PIC X(8) VALUE 'ZPA01MFL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01QFH-001.
               PERFORM CALL-ZPA01MFL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01QFH-001.
               CALL 'ZPA01QFH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01QFH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01MFL-002.
               CALL 'ZPA01MFL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01MFL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
               MOVE 'ZCL0255P' TO WS-PROGNAME-3
