      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA010TV'.
      ...
      * Called module names
       01  MOD-ZPA01FV8              PIC X(8) VALUE 'ZPA01FV8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01FV8-001.
               CALL 'ZPA01FV8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01FV8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
