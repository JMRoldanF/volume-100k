      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00OL1'.
      ...
      * Called module names
       01  MOD-ZPA01I5T              PIC X(8) VALUE 'ZPA01I5T'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01I5T-001.
               CALL 'ZPA01I5T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01I5T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
