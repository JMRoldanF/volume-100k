      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00VYJ'.
      ...
      * Called module names
       01  MOD-ZPA01SW3              PIC X(8) VALUE 'ZPA01SW3'.
       01  MOD-ZPA01D0F              PIC X(8) VALUE 'ZPA01D0F'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01SW3-001.
               CALL 'ZPA01SW3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01SW3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01D0F-002.
               CALL 'ZPA01D0F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01D0F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-TERM-0001.
