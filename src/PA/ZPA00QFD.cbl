      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00QFD'.
      ...
      * Called module names
       01  MOD-ZPA01STB              PIC X(8) VALUE 'ZPA01STB'.
       01  MOD-ZPA01NOV              PIC X(8) VALUE 'ZPA01NOV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01STB-001.
               PERFORM CALL-ZPA01NOV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01STB-001.
               CALL 'ZPA01STB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01STB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01NOV-002.
               CALL 'ZPA01NOV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01NOV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
