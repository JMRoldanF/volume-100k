      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA013KU'.
      ...
      * Called module names
       01  MOD-ZPA01GDK              PIC X(8) VALUE 'ZPA01GDK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01GDK-001.
               CALL 'ZPA01GDK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01GDK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
