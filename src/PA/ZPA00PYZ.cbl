      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00PYZ'.
      ...
      * Called module names
       01  MOD-ZPA01TNB              PIC X(8) VALUE 'ZPA01TNB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01TNB-001.
               PERFORM CALL-ZPA01LHP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01TNB-001.
               CALL 'ZPA01TNB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
