      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00QWW'.
      ...
      * Called module names
       01  MOD-ZPA01SEP              PIC X(8) VALUE 'ZPA01SEP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01FPV-001.
               PERFORM CALL-ZPA01SEP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01SEP-002.
               CALL 'ZPA01SEP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01SEP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
