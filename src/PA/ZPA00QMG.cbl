      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00QMG'.
      ...
      * Called module names
       01  MOD-ZPA01QS2              PIC X(8) VALUE 'ZPA01QS2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01QS2-001.
               CALL 'ZPA01QS2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01QS2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
