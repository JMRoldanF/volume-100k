      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00LOZ'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01SGG              PIC X(8) VALUE 'ZPA01SGG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01SGG-002.
               CALL 'ZPA01SGG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
