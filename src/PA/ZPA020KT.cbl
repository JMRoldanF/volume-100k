      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA020KT'.
      ...
      * Called module names
       01  MOD-ZPA01QZR              PIC X(8) VALUE 'ZPA01QZR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01QZR-001.
               CALL 'ZPA01QZR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
