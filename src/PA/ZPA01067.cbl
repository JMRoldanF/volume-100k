      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA01067'.
      ...
      * Called module names
       01  MOD-ZPA01UY9              PIC X(8) VALUE 'ZPA01UY9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01UY9-001.
               CALL 'ZPA01UY9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01UY9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01IRD-002.
