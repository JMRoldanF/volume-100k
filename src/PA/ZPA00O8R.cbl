      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00O8R'.
      ...
      * Called module names
       01  MOD-ZPA01CP1              PIC X(8) VALUE 'ZPA01CP1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01CP1-002.
               CALL 'ZPA01CP1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01CP1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
