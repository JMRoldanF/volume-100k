      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00PHR'.
      ...
      * Called module names
       01  MOD-ZPA01NFT              PIC X(8) VALUE 'ZPA01NFT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01NFT-001.
               PERFORM CALL-ZPA01QXJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01NFT-001.
               CALL 'ZPA01NFT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01NFT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01QXJ-002.
