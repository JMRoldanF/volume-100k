      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00S1P'.
      ...
      * Called module names
       01  MOD-ZEN01V1Z              PIC X(8) VALUE 'ZEN01V1Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01V1Z-001.
               CALL 'ZEN01V1Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01V1Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
