      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00VS5'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01FCX              PIC X(8) VALUE 'ZMT01FCX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01FCX-002.
               CALL 'ZMT01FCX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
