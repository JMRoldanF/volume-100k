      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA01BON'.
      ...
      * Called module names
       01  MOD-ZPA01LU7              PIC X(8) VALUE 'ZPA01LU7'.
       01  MOD-ZPA01EL3              PIC X(8) VALUE 'ZPA01EL3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01LU7-001.
               PERFORM CALL-ZPA01EL3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01LU7-001.
               CALL 'ZPA01LU7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01LU7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01EL3-002.
               CALL 'ZPA01EL3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01EL3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
