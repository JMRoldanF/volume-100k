      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA019YZ'.
      ...
      * Called module names
       01  MOD-ZPA01SPZ              PIC X(8) VALUE 'ZPA01SPZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01SPZ-001.
               CALL 'ZPA01SPZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01SPZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
