      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00VWV'.
      ...
      * Called module names
       01  MOD-ZMT01UMD              PIC X(8) VALUE 'ZMT01UMD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01UMD-001.
               CALL 'ZMT01UMD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01UMD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01F9G-002.
