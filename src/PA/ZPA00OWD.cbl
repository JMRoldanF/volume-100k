      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00OWD'.
      ...
      * Called module names
       01  MOD-ZPA01OM7              PIC X(8) VALUE 'ZPA01OM7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01OM7-001.
               CALL 'ZPA01OM7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01OM7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
