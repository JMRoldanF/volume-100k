      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00PLX'.
      ...
      * Called module names
       01  MOD-ZPA01MVZ              PIC X(8) VALUE 'ZPA01MVZ'.
       01  MOD-ZBI01H3A              PIC X(8) VALUE 'ZBI01H3A'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01MVZ-001.
               CALL 'ZPA01MVZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01MVZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01H3A-002.
               CALL 'ZBI01H3A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01H3A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
