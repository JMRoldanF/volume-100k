      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA01R6I'.
      ...
      * Called module names
       01  MOD-ZPA01KIZ              PIC X(8) VALUE 'ZPA01KIZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01KIZ-001.
               CALL 'ZPA01KIZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01KIZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
