      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA004WX'.
      ...
      * Called module names
       01  MOD-ZPA007W5              PIC X(8) VALUE 'ZPA007W5'.
       01  MOD-ZPA00AV3              PIC X(8) VALUE 'ZPA00AV3'.
       01  MOD-ZRE003HH              PIC X(8) VALUE 'ZRE003HH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA007W5-001.
               PERFORM CALL-ZRE003HH-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA007W5-001.
               EXEC CICS LINK PROGRAM('ZPA007W5')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA007W5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA00AV3-002.
               EXEC CICS LINK PROGRAM('ZPA00AV3')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA00AV3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE003HH-003.
               EXEC CICS XCTL PROGRAM('ZRE003HH')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE003HH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-004.
