      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA0003V'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAG0067A-001.
               PERFORM CALL-ZPA00GRV-002.
               PERFORM CALL-ZMT002JZ-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT002JZ-003.
               EXEC CICS START TRANSID('Z2JZ')
                         ...
                         RESP(WS-RESP)
               END-EXEC.
      * TRANSID Z2JZ is defined against ZMT002JZ
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT002JZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-004.
