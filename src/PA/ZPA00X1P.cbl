      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00X1P'.
      ...
      * Called module names
       01  MOD-ZPA01O4F              PIC X(8) VALUE 'ZPA01O4F'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01O4F-001.
               CALL 'ZPA01O4F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01O4F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
