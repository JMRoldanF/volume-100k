      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00TFF'.
      ...
      * Called module names
       01  MOD-ZPA01M8X              PIC X(8) VALUE 'ZPA01M8X'.
       01  MOD-ZPA01IMD              PIC X(8) VALUE 'ZPA01IMD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01M8X-001.
               PERFORM CALL-ZPA01IMD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01M8X-001.
               CALL 'ZPA01M8X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01M8X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01IMD-002.
               CALL 'ZPA01IMD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01IMD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-VALUE-0001.
