      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00M0R'.
      ...
      * Called module names
       01  MOD-ZPA01OSV              PIC X(8) VALUE 'ZPA01OSV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01OSV-001.
               CALL 'ZPA01OSV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01OSV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
