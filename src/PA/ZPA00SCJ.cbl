      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00SCJ'.
      ...
      * Called module names
       01  MOD-ZPA01PXZ              PIC X(8) VALUE 'ZPA01PXZ'.
       01  MOD-ZPA01G6L              PIC X(8) VALUE 'ZPA01G6L'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01PXZ-001.
               PERFORM CALL-ZPA01G6L-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01PXZ-001.
               CALL 'ZPA01PXZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01G6L-002.
               CALL 'ZPA01G6L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01G6L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
