      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00P5J'.
      ...
      * Called module names
       01  MOD-ZPA01RL5              PIC X(8) VALUE 'ZPA01RL5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01RL5-001.
               CALL 'ZPA01RL5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01RL5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01DH3-002.
