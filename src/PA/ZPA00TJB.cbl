      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00TJB'.
      ...
      * Called module names
       01  MOD-ZPA01FQR              PIC X(8) VALUE 'ZPA01FQR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01FQR-001.
               CALL 'ZPA01FQR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01FQR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-MAKE-0001.
