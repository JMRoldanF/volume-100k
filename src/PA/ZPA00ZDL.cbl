      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00ZDL'.
      ...
      * Called module names
       01  MOD-ZPA01TNV              PIC X(8) VALUE 'ZPA01TNV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01TNV-001.
               PERFORM CALL-ZEN01HIR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01TNV-001.
               CALL 'ZPA01TNV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01TNV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01HIR-002.
