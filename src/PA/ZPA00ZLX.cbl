      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00ZLX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM VALIDATE-CC-RATING-0007.
               ...
               PERFORM CHECK-PREMIUM-0131.
               PERFORM SQL-ACCESS-0132.
               PERFORM VALIDATE-EQUITIES-0133.
               PERFORM COMPUTE-WITH-PROFITS-0134.
               PERFORM SQL-ACCESS-0135.
               PERFORM FORMAT-BROKER-ID-0136.
               PERFORM FORMAT-EXCESS-0137.
               PERFORM SQL-ACCESS-0138.
               PERFORM AUDIT-MANAGED-FUND-0139.
               PERFORM FORMAT-NCD-YEARS-0140.
               PERFORM SQL-ACCESS-0141.
               PERFORM FORMAT-ROOF-TYPE-0142.
               PERFORM RESOLVE-MANAGED-FUND-0143.
               PERFORM SQL-ACCESS-0144.
               PERFORM REFRESH-STATUS-CODE-0145.
               ...
               PERFORM CHECK-SUM-ASSURED-0157.
               PERFORM DERIVE-WITH-PROFITS-0158.
               PERFORM SQL-ACCESS-0159.
               PERFORM CHECK-ROOF-TYPE-0160.
       ...
       SQL-ACCESS-0006.
               EXEC SQL
                     SELECT POLICYNUMBER, ISSUEDATE, EXPIRYDATE,
                       ...
                       FROM GENAPA.DISCOUNT
                      WHERE CUSTOMERNUMBER = :HV-CUSTOMER-NUM
               END-EXEC.
      *----------------------------------------------------------------*
       VALIDATE-CC-RATING-0007.
