      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00TOB'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01H6F              PIC X(8) VALUE 'ZPA01H6F'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01HLP-001.
               PERFORM CALL-ZPA01H6F-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01H6F-002.
               CALL 'ZPA01H6F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
