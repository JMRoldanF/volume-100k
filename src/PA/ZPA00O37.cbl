      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00O37'.
      ...
      * Called module names
       01  MOD-ZPA01H29              PIC X(8) VALUE 'ZPA01H29'.
       01  MOD-ZRE01CQ3              PIC X(8) VALUE 'ZRE01CQ3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01H29-001.
               PERFORM CALL-ZRE01CQ3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01H29-001.
               CALL 'ZPA01H29' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01H29 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE01CQ3-002.
               CALL 'ZRE01CQ3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01CQ3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
