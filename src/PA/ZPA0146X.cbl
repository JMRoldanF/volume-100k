      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA0146X'.
      ...
      * Called module names
       01  MOD-ZPA01N6D              PIC X(8) VALUE 'ZPA01N6D'.
       01  MOD-ZPA01V3Y              PIC X(8) VALUE 'ZPA01V3Y'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01N6D-001.
               PERFORM CALL-ZPA01V3Y-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01N6D-001.
               CALL 'ZPA01N6D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01N6D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01V3Y-002.
               CALL 'ZPA01V3Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01V3Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
