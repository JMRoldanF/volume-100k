      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00NB5'.
      ...
      * Called module names
       01  MOD-ZPA01FJ9              PIC X(8) VALUE 'ZPA01FJ9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01FJ9-001.
               CALL 'ZPA01FJ9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01FJ9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01SD7-002.
