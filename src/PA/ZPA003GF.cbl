      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA003GF'.
      ...
      * Called module names
       ...
       01  MOD-ZPA00L53              PIC X(8) VALUE 'ZPA00L53'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN00FUX-001.
               PERFORM CALL-ZCU00AE0-002.
               PERFORM CALL-ZPA00L53-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN00FUX-001.
               MOVE 'ZEN00FUX' TO WS-PROGNAME-4
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN00FUX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU00AE0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00L53-003.
               EXEC CICS LINK PROGRAM('ZPA00L53')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA00L53 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-004.
