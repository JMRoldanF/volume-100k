      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00VHB'.
      ...
      * Called module names
       01  MOD-ZPA01NC3              PIC X(8) VALUE 'ZPA01NC3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01NC3-001.
               PERFORM CALL-ZPA01DMN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01NC3-001.
               CALL 'ZPA01NC3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01NC3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01DMN-002.
