      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00TN7'.
      ...
      * Called module names
       01  MOD-ZPA01E63              PIC X(8) VALUE 'ZPA01E63'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01E63-001.
               CALL 'ZPA01E63' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01E63 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
