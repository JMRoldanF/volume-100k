      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00NVH'.
      ...
      * Called module names
       01  MOD-ZPA01QX0              PIC X(8) VALUE 'ZPA01QX0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01QX0-001.
               CALL 'ZPA01QX0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01QX0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
