      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA004XH'.
      ...
      * Called module names
       01  MOD-ZPA00J4V              PIC X(8) VALUE 'ZPA00J4V'.
       01  MOD-ZPA008YR              PIC X(8) VALUE 'ZPA008YR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA00J4V-001.
               PERFORM CALL-ZPA008YR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00J4V-001.
               EXEC CICS LINK PROGRAM('ZPA00J4V')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA00J4V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA008YR-002.
               EXEC CICS LINK PROGRAM('ZPA008YR')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA008YR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
