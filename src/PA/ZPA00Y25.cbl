      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00Y25'.
      ...
      * Called module names
       01  MOD-ZPA01S00              PIC X(8) VALUE 'ZPA01S00'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01S00-001.
               PERFORM CALL-ZPA01M68-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01S00-001.
               CALL 'ZPA01S00' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01S00 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01M68-002.
