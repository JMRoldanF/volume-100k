      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00XK2'.
      ...
      * Called module names
       01  MOD-ZPA01T3O              PIC X(8) VALUE 'ZPA01T3O'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01T3O-001.
               PERFORM CALL-ZPA01PA3-002.
               PERFORM CALL-ZEN0255N-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZPA01T3O-001.
               CALL 'ZPA01T3O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
