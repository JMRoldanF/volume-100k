      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA0123D'.
      ...
      * Called module names
       01  MOD-ZPA01GRZ              PIC X(8) VALUE 'ZPA01GRZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01G0H-001.
               PERFORM CALL-ZPA01GRZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01GRZ-002.
               CALL 'ZPA01GRZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01GRZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
