      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00W9D'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01K1F              PIC X(8) VALUE 'ZRE01K1F'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01S7X-001.
               PERFORM CALL-ZRE01K1F-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01K1F-002.
               CALL 'ZRE01K1F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01K1F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
