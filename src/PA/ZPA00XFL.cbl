      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00XFL'.
      ...
      * Called module names
       01  MOD-ZPA01TA9              PIC X(8) VALUE 'ZPA01TA9'.
       01  MOD-ZBI01SDY              PIC X(8) VALUE 'ZBI01SDY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01TA9-001.
               PERFORM CALL-ZBI01SDY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01TA9-001.
               CALL 'ZPA01TA9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01TA9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI01SDY-002.
               CALL 'ZBI01SDY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01SDY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
