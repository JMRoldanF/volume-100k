      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00UR7'.
      ...
      * Called module names
       01  MOD-ZPA01OQ3              PIC X(8) VALUE 'ZPA01OQ3'.
       01  MOD-ZPA01RWJ              PIC X(8) VALUE 'ZPA01RWJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01OQ3-001.
               PERFORM CALL-ZPA01RWJ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01OQ3-001.
               CALL 'ZPA01OQ3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01OQ3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01RWJ-002.
               CALL 'ZPA01RWJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01RWJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
