      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00XND'.
      ...
      * Called module names
       01  MOD-ZPA01S87              PIC X(8) VALUE 'ZPA01S87'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01S87-001.
               CALL 'ZPA01S87' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01S87 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01MN3-002.
               MOVE 'ZPA01MN3' TO WS-SUBNAME-4
