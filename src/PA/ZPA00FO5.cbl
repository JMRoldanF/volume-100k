      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00FO5'.
      ...
      * Called module names
       01  MOD-ZPA00P0T              PIC X(8) VALUE 'ZPA00P0T'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00P0T-001.
               EXEC CICS LINK PROGRAM('ZPA00P0T')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA00P0T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01HHN-002.
