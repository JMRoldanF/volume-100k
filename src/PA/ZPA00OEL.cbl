      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00OEL'.
      ...
      * Called module names
       01  MOD-ZPA01ESB              PIC X(8) VALUE 'ZPA01ESB'.
       01  MOD-ZPA01Q4D              PIC X(8) VALUE 'ZPA01Q4D'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01ESB-001.
               PERFORM CALL-ZPA01Q4D-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01ESB-001.
               CALL 'ZPA01ESB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01ESB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01Q4D-002.
               CALL 'ZPA01Q4D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01Q4D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-VALUE-0001.
