      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00XCQ'.
      ...
      * Called module names
       01  MOD-ZPA01KCW              PIC X(8) VALUE 'ZPA01KCW'.
       01  MOD-ZPA01CON              PIC X(8) VALUE 'ZPA01CON'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01KCW-001.
               PERFORM CALL-ZPA01CON-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01KCW-001.
               CALL 'ZPA01KCW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01KCW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01CON-002.
               CALL 'ZPA01CON' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01CON FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
