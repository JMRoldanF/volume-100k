      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA000W7'.
      ...
      * Called module names
       01  MOD-ZPA00AD1              PIC X(8) VALUE 'ZPA00AD1'.
       01  MOD-ZPA00CG1              PIC X(8) VALUE 'ZPA00CG1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA00AD1-001.
               PERFORM CALL-ZPA00CG1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00AD1-001.
               EXEC CICS LINK PROGRAM('ZPA00AD1')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA00AD1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA00CG1-002.
               EXEC CICS LINK PROGRAM('ZPA00CG1')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA00CG1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
