      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00WE3'.
      ...
      * Called module names
       01  MOD-ZEN01G1F              PIC X(8) VALUE 'ZEN01G1F'.
       01  MOD-ZPA01KRL              PIC X(8) VALUE 'ZPA01KRL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01G1F-001.
               PERFORM CALL-ZPA01KRL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01G1F-001.
               CALL 'ZEN01G1F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01G1F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01KRL-002.
               CALL 'ZPA01KRL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01KRL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
