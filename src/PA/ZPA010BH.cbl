      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA010BH'.
      ...
      * Called module names
       01  MOD-ZPA01ESV              PIC X(8) VALUE 'ZPA01ESV'.
       01  MOD-ZCU01IGY              PIC X(8) VALUE 'ZCU01IGY'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01ESV-001.
               PERFORM CALL-ZCU01IGY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01ESV-001.
               CALL 'ZPA01ESV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01ESV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01IGY-002.
               CALL 'ZCU01IGY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01IGY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
