      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00VPD'.
      ...
      * Called module names
       01  MOD-ZPA01PW1              PIC X(8) VALUE 'ZPA01PW1'.
       01  MOD-ZPA01USP              PIC X(8) VALUE 'ZPA01USP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01PW1-001.
               PERFORM CALL-ZPA01USP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01PW1-001.
               CALL 'ZPA01PW1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01PW1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01USP-002.
               CALL 'ZPA01USP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01USP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
