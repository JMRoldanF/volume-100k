      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA011PH'.
      ...
      * Called module names
       01  MOD-ZPA01QNT              PIC X(8) VALUE 'ZPA01QNT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01QNT-002.
               CALL 'ZPA01QNT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01QNT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
