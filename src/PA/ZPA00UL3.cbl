      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00UL3'.
      ...
      * Called module names
       01  MOD-ZPA01NXH              PIC X(8) VALUE 'ZPA01NXH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01NXH-001.
               CALL 'ZPA01NXH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01NXH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-MODEL-0001.
