      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA010YJ'.
      ...
      * Called module names
       01  MOD-ZPA01KHL              PIC X(8) VALUE 'ZPA01KHL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01KHL-001.
               CALL 'ZPA01KHL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01KHL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
