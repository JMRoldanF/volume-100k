      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA017I3'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01GHP              PIC X(8) VALUE 'ZPA01GHP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01GHP-002.
               CALL 'ZPA01GHP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01GHP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
