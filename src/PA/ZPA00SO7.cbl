      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00SO7'.
      ...
      * Called module names
       01  MOD-ZPA01IAZ              PIC X(8) VALUE 'ZPA01IAZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01IAZ-001.
               PERFORM CALL-ZCU01EOK-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01IAZ-001.
               CALL 'ZPA01IAZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01IAZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01EOK-002.
