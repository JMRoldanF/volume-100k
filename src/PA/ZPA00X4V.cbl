      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00X4V'.
      ...
      * Called module names
       01  MOD-ZPA01S42              PIC X(8) VALUE 'ZPA01S42'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01S42-001.
               CALL 'ZPA01S42' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01S42 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
