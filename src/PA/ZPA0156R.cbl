      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA0156R'.
      ...
      * Called module names
       01  MOD-ZPA01PAD              PIC X(8) VALUE 'ZPA01PAD'.
       01  MOD-ZHO01TUM              PIC X(8) VALUE 'ZHO01TUM'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01PAD-001.
               PERFORM CALL-ZHO01TUM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01PAD-001.
               CALL 'ZPA01PAD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01PAD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO01TUM-002.
               CALL 'ZHO01TUM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01TUM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
