      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00TD7'.
      ...
      * Called module names
       01  MOD-ZPA01GAH              PIC X(8) VALUE 'ZPA01GAH'.
       01  MOD-ZCL01JAF              PIC X(8) VALUE 'ZCL01JAF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01GAH-001.
               PERFORM CALL-ZCL01JAF-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01GAH-001.
               CALL 'ZPA01GAH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01GAH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01JAF-002.
               CALL 'ZCL01JAF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01JAF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
