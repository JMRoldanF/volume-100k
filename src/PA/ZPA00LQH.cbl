      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00LQH'.
      ...
      * Called module names
       ...
       01  MOD-ZBI01HLC              PIC X(8) VALUE 'ZBI01HLC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01IQT-001.
               PERFORM CALL-ZBI01HLC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01HLC-002.
               CALL 'ZBI01HLC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01HLC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
