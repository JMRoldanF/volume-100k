      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA010RB'.
      ...
      * Called module names
       ...
       01  MOD-ZMT01JU1              PIC X(8) VALUE 'ZMT01JU1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01JU1-002.
               CALL 'ZMT01JU1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01JU1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-MAKE-0001.
