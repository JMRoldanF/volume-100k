      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00RX9'.
      ...
      * Called module names
       01  MOD-ZCU01N50              PIC X(8) VALUE 'ZCU01N50'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01N50-001.
               CALL 'ZCU01N50' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01N50 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
