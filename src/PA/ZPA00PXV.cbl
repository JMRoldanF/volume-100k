      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00PXV'.
      ...
      * Called module names
       01  MOD-ZPA01KQ7              PIC X(8) VALUE 'ZPA01KQ7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01KQ7-001.
               CALL 'ZPA01KQ7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01KQ7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
