      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00M5R'.
      ...
      * Called module names
       01  MOD-ZPA01LWZ              PIC X(8) VALUE 'ZPA01LWZ'.
       01  MOD-ZUW01MBQ              PIC X(8) VALUE 'ZUW01MBQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01LWZ-001.
               PERFORM CALL-ZUW01MBQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01LWZ-001.
               CALL 'ZPA01LWZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01MBQ-002.
               CALL 'ZUW01MBQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01MBQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
