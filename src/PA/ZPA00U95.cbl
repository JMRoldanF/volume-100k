      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00U95'.
      ...
      * Called module names
       01  MOD-ZPA01NZ5              PIC X(8) VALUE 'ZPA01NZ5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01NZ5-001.
               CALL 'ZPA01NZ5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01NZ5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
