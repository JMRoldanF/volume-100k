      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00YA5'.
      ...
      * Called module names
       01  MOD-ZAG01T9Y              PIC X(8) VALUE 'ZAG01T9Y'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAG01T9Y-001.
               CALL 'ZAG01T9Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAG01T9Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
