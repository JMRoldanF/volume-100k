      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00Q71'.
      ...
      * Called module names
       01  MOD-ZPA01MH9              PIC X(8) VALUE 'ZPA01MH9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01MH9-001.
               CALL 'ZPA01MH9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01MH9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-VALUE-0001.
