      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00USI'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01S3G              PIC X(8) VALUE 'ZPA01S3G'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCR01OIN-001.
               PERFORM CALL-ZPA01S3G-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01S3G-002.
               CALL 'ZPA01S3G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01S3G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
