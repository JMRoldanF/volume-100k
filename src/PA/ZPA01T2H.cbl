      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA01T2H'.
      ...
      * Called module names
       01  MOD-ZMT01PWD              PIC X(8) VALUE 'ZMT01PWD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01PWD-001.
               CALL 'ZMT01PWD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01PWD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
