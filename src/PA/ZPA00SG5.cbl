      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00SG5'.
      ...
      * Called module names
       01  MOD-ZPA01MW9              PIC X(8) VALUE 'ZPA01MW9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01MW9-001.
               CALL 'ZPA01MW9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01MW9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
