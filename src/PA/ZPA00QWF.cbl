      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00QWF'.
      ...
      * Called module names
       01  MOD-ZCR01KPD              PIC X(8) VALUE 'ZCR01KPD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCR01KPD-001.
               CALL 'ZCR01KPD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCR01KPD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
