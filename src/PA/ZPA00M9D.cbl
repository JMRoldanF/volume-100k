      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00M9D'.
      ...
      * Called module names
       01  MOD-ZCU01R9W              PIC X(8) VALUE 'ZCU01R9W'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01R9W-001.
               CALL 'ZCU01R9W' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01R9W FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
