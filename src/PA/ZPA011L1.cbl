      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA011L1'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01FCL              PIC X(8) VALUE 'ZPA01FCL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01FCL-002.
               CALL 'ZPA01FCL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01FCL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
