      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00Q40'.
      ...
      * Called module names
       01  MOD-ZPT01HJZ              PIC X(8) VALUE 'ZPT01HJZ'.
       01  MOD-ZPA01N2M              PIC X(8) VALUE 'ZPA01N2M'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPT01HJZ-001.
               PERFORM CALL-ZPA01N2M-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPT01HJZ-001.
               CALL 'ZPT01HJZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01HJZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01N2M-002.
               CALL 'ZPA01N2M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01N2M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
