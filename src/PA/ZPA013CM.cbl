      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA013CM'.
      ...
      * Called module names
       01  MOD-ZPA01NPH              PIC X(8) VALUE 'ZPA01NPH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01NPH-001.
               CALL 'ZPA01NPH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01NPH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
