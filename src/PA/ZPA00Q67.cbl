      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00Q67'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01EXL              PIC X(8) VALUE 'ZPA01EXL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01EXL-002.
               CALL 'ZPA01EXL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01EXL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-COLOUR-0001.
