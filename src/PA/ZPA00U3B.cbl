      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00U3B'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01M1P              PIC X(8) VALUE 'ZPA01M1P'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01M1P-002.
               CALL 'ZPA01M1P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01M1P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
