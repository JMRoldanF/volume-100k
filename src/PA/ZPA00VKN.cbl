      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00VKN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM RESOLVE-ROOF-TYPE-0019.
               ...
               PERFORM RECONCILE-SUM-ASSURED-0097.
               ...
               PERFORM REFRESH-VALUE-0116.
               PERFORM SQL-ACCESS-0117.
               PERFORM FORMAT-POSTCODE-0118.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN0255N-001.
               MOVE 'ZEN0255N' TO WS-PROGNAME-6
