      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00ZK9'.
      ...
      * Called module names
       01  MOD-ZPA01H01              PIC X(8) VALUE 'ZPA01H01'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01H01-001.
               CALL 'ZPA01H01' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01H01 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
