      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00E2D'.
      ...
      * Called module names
       01  MOD-ZPA00V5D              PIC X(8) VALUE 'ZPA00V5D'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA00V5D-001.
               PERFORM CALL-ZCU00UPE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00V5D-001.
               EXEC CICS LINK PROGRAM('ZPA00V5D')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA00V5D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU00UPE-002.
