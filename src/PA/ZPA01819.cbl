      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA01819'.
      ...
      * Called module names
       01  MOD-ZPA01IPP              PIC X(8) VALUE 'ZPA01IPP'.
       01  MOD-ZPA01RTH              PIC X(8) VALUE 'ZPA01RTH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01IPP-001.
               PERFORM CALL-ZPA01RTH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01IPP-001.
               CALL 'ZPA01IPP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01IPP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01RTH-002.
               CALL 'ZPA01RTH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01RTH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
