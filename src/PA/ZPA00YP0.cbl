      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00YP0'.
      ...
      * Called module names
       01  MOD-ZCR01PWH              PIC X(8) VALUE 'ZCR01PWH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM EXPAND-REG-NUMBER-0035.
               ...
               PERFORM NORMALISE-TAX-BAND-0074.
      ...
      *----------------------------------------------------------------*
       CALL-ZCR01PWH-001.
               CALL 'ZCR01PWH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCR01PWH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
