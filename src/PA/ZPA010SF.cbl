      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA010SF'.
      ...
      * Called module names
       01  MOD-ZPA01ER7              PIC X(8) VALUE 'ZPA01ER7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01ER7-001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZPA01ER7-001.
               CALL 'ZPA01ER7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
