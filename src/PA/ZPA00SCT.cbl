      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00SCT'.
      ...
      * Called module names
       01  MOD-ZPA01V3T              PIC X(8) VALUE 'ZPA01V3T'.
       01  MOD-ZPA01OZT              PIC X(8) VALUE 'ZPA01OZT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01V3T-001.
               PERFORM CALL-ZPA01OZT-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01V3T-001.
               CALL 'ZPA01V3T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01V3T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01OZT-002.
               CALL 'ZPA01OZT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01OZT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
