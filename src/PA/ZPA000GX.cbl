      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA000GX'.
      ...
      * Called module names
       01  MOD-ZPA00C1L              PIC X(8) VALUE 'ZPA00C1L'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA00C1L-001.
               PERFORM CALL-ZPA0090P-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00C1L-001.
               EXEC CICS LINK PROGRAM('ZPA00C1L')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA00C1L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA0090P-002.
