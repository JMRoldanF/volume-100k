      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA000CR'.
      ...
      * Called module names
       ...
       01  MOD-ZPA0091T              PIC X(8) VALUE 'ZPA0091T'.
       01  MOD-ZCU000R2              PIC X(8) VALUE 'ZCU000R2'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA0091T-002.
               PERFORM CALL-ZCU000R2-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA0091T-002.
               EXEC CICS LINK PROGRAM('ZPA0091T')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA0091T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU000R2-003.
               EXEC CICS XCTL PROGRAM('ZCU000R2')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU000R2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-004.
