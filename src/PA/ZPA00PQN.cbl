      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00PQN'.
      ...
      * Called module names
       01  MOD-ZPA01SIH              PIC X(8) VALUE 'ZPA01SIH'.
       01  MOD-ZMT01R53              PIC X(8) VALUE 'ZMT01R53'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01SIH-001.
               PERFORM CALL-ZMT01R53-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01SIH-001.
               CALL 'ZPA01SIH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01SIH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT01R53-002.
               CALL 'ZMT01R53' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01R53 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-TERM-0001.
