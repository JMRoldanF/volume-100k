      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA014YF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01DOB-001.
               PERFORM CALL-ZMT01LPJ-002.
               PERFORM CALL-ZEN0255N-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZPA01DOB-001.
               MOVE 'ZPA01DOB' TO WS-SUBNAME-4
