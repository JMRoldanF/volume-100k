      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00T87'.
      ...
      * Called module names
       01  MOD-ZPA01KNP              PIC X(8) VALUE 'ZPA01KNP'.
       01  MOD-ZUW01MZW              PIC X(8) VALUE 'ZUW01MZW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01KNP-001.
               PERFORM CALL-ZUW01MZW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01KNP-001.
               CALL 'ZPA01KNP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01KNP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01MZW-002.
               CALL 'ZUW01MZW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01MZW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
