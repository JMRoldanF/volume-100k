      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00MD4'.
      ...
      * Called module names
       01  MOD-ZPA01IYF              PIC X(8) VALUE 'ZPA01IYF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01IYF-001.
               PERFORM CALL-ZPA01UDV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01IYF-001.
               CALL 'ZPA01IYF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01IYF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01UDV-002.
               MOVE 'ZPA01UDV' TO WS-SUBNAME-3
