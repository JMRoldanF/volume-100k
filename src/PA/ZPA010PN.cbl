      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA010PN'.
      ...
      * Called module names
       01  MOD-ZPA01OBX              PIC X(8) VALUE 'ZPA01OBX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01OBX-001.
               CALL 'ZPA01OBX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01OBX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
