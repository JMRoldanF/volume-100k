      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00Z53'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01MUG              PIC X(8) VALUE 'ZPA01MUG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01NCZ-001.
               PERFORM CALL-ZPA01MUG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01MUG-002.
               CALL 'ZPA01MUG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
