      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA010FX'.
      ...
      * Called module names
       01  MOD-ZPA01PWB              PIC X(8) VALUE 'ZPA01PWB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01PWB-001.
               PERFORM CALL-ZAG01GH4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01PWB-001.
               CALL 'ZPA01PWB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01PWB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG01GH4-002.
