      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00MST'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01NRD              PIC X(8) VALUE 'ZPA01NRD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01NRD-002.
               CALL 'ZPA01NRD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01NRD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
