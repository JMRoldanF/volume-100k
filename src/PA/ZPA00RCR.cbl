      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00RCR'.
      ...
      * Called module names
       01  MOD-ZPA01F1G              PIC X(8) VALUE 'ZPA01F1G'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01F1G-001.
               CALL 'ZPA01F1G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01F1G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
