      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00QER'.
      ...
      * Called module names
       01  MOD-ZPA01N3P              PIC X(8) VALUE 'ZPA01N3P'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01N3P-001.
               CALL 'ZPA01N3P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01N3P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
