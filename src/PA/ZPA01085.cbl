      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA01085'.
      ...
      * Called module names
       01  MOD-ZPA01MI3              PIC X(8) VALUE 'ZPA01MI3'.
       01  MOD-ZPA01M6P              PIC X(8) VALUE 'ZPA01M6P'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01MI3-001.
               PERFORM CALL-ZPA01M6P-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01MI3-001.
               CALL 'ZPA01MI3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01MI3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01M6P-002.
               CALL 'ZPA01M6P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01M6P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
