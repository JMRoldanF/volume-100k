      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00NMT'.
      ...
      * Called module names
       01  MOD-ZPA01SH3              PIC X(8) VALUE 'ZPA01SH3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01SH3-001.
               PERFORM CALL-ZPA01K3P-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01SH3-001.
               CALL 'ZPA01SH3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01SH3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01K3P-002.
