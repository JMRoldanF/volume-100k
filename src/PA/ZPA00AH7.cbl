      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00AH7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA00NXD-001.
               PERFORM CALL-ZPA010K3-002.
               PERFORM CALL-ZPA01ROR-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00NXD-001.
               MOVE 'ZPA00NXD' TO WS-PROGNAME-7
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA00NXD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA010K3-002.
