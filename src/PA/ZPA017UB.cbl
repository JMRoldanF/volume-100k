      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA017UB'.
      ...
      * Called module names
       01  MOD-ZPA01QPH              PIC X(8) VALUE 'ZPA01QPH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01QPH-002.
               CALL 'ZPA01QPH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01QPH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
