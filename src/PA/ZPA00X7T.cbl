      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00X7T'.
      ...
      * Called module names
       01  MOD-ZPA01FFN              PIC X(8) VALUE 'ZPA01FFN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01FFN-001.
               CALL 'ZPA01FFN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01FFN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
