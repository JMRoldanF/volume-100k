      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00WJ2'.
      ...
      * Called module names
       01  MOD-ZPA01LVM              PIC X(8) VALUE 'ZPA01LVM'.
       01  MOD-ZPT01H1T              PIC X(8) VALUE 'ZPT01H1T'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01LVM-001.
               PERFORM CALL-ZPT01H1T-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01LVM-001.
               CALL 'ZPA01LVM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01LVM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPT01H1T-002.
               CALL 'ZPT01H1T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01H1T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
