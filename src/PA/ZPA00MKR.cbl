      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00MKR'.
      ...
      * Called module names
       01  MOD-ZPA01HD3              PIC X(8) VALUE 'ZPA01HD3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01HD3-001.
               CALL 'ZPA01HD3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01HD3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
