      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00W45'.
      ...
      * Called module names
       01  MOD-ZPA01P0Z              PIC X(8) VALUE 'ZPA01P0Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01P0Z-001.
               CALL 'ZPA01P0Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01P0Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
