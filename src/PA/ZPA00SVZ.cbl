      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00SVZ'.
      ...
      * Called module names
       01  MOD-ZPA01PML              PIC X(8) VALUE 'ZPA01PML'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01PML-001.
               CALL 'ZPA01PML' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01PML FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
