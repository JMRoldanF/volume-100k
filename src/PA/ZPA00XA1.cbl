      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00XA1'.
      ...
      * Called module names
       01  MOD-ZPA01PP3              PIC X(8) VALUE 'ZPA01PP3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01PP3-001.
               CALL 'ZPA01PP3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01PP3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-COLOUR-0001.
