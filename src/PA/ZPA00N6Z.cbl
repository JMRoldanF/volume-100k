      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00N6Z'.
      ...
      * Called module names
       01  MOD-ZPA01NEV              PIC X(8) VALUE 'ZPA01NEV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01NEV-001.
               CALL 'ZPA01NEV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01NEV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
