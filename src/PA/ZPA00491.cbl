      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00491'.
      ...
      * Called module names
       01  MOD-ZPA0083N              PIC X(8) VALUE 'ZPA0083N'.
       01  MOD-ZPA00L8Z              PIC X(8) VALUE 'ZPA00L8Z'.
       01  MOD-ZPA00GWV              PIC X(8) VALUE 'ZPA00GWV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA0083N-001.
               PERFORM CALL-ZPA00L8Z-002.
               PERFORM CALL-ZPA00GWV-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA0083N-001.
               EXEC CICS LINK PROGRAM('ZPA0083N')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA0083N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA00L8Z-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00GWV-003.
               EXEC CICS LINK PROGRAM('ZPA00GWV')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA00GWV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
