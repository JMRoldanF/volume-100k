      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00R7P'.
      ...
      * Called module names
       01  MOD-ZPA01L9N              PIC X(8) VALUE 'ZPA01L9N'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01L9N-001.
               PERFORM CALL-ZPA01KG7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01L9N-001.
               CALL 'ZPA01L9N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01L9N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01KG7-002.
