      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00W7Z'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01OCR              PIC X(8) VALUE 'ZPA01OCR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01PAN-001.
               PERFORM CALL-ZPA01OCR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01OCR-002.
               CALL 'ZPA01OCR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01OCR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
