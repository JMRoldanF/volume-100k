      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00UZT'.
      ...
      * Called module names
       01  MOD-ZPA01UO9              PIC X(8) VALUE 'ZPA01UO9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01UO9-001.
               CALL 'ZPA01UO9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01UO9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
