      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00UNL'.
      ...
      * Called module names
       01  MOD-ZPA01CX3              PIC X(8) VALUE 'ZPA01CX3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01CX3-002.
               CALL 'ZPA01CX3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01CX3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
