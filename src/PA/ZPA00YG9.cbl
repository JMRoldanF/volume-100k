      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00YG9'.
      ...
      * Called module names
       01  MOD-ZCU01LI4              PIC X(8) VALUE 'ZCU01LI4'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01LI4-001.
               CALL 'ZCU01LI4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01LI4 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
