      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00VCV'.
      ...
      * Called module names
       01  MOD-ZEN01QH9              PIC X(8) VALUE 'ZEN01QH9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01QH9-001.
               CALL 'ZEN01QH9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01QH9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
