      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA017X3'.
      ...
      * Called module names
       01  MOD-ZPA01FS5              PIC X(8) VALUE 'ZPA01FS5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01FS5-001.
               CALL 'ZPA01FS5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01FS5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-VALUE-0001.
