      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00FUY'.
      ...
      * Called module names
       01  MOD-ZPA00XAQ              PIC X(8) VALUE 'ZPA00XAQ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA00XAQ-001.
               PERFORM CALL-ZPA01AUR-002.
               PERFORM CALL-ZPT01CY9-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00XAQ-001.
               EXEC CICS LINK PROGRAM('ZPA00XAQ')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA00XAQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01AUR-002.
