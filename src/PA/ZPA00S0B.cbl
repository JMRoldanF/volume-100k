      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00S0B'.
      ...
      * Called module names
       01  MOD-ZPA01SUP              PIC X(8) VALUE 'ZPA01SUP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01SUP-001.
               PERFORM CALL-ZPA01QQB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01SUP-001.
               CALL 'ZPA01SUP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01SUP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01QQB-002.
