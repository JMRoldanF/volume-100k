      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA0122T'.
      ...
      * Called module names
       01  MOD-ZPA01COR              PIC X(8) VALUE 'ZPA01COR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01COR-001.
               CALL 'ZPA01COR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01COR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
