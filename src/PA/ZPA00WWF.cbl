      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00WWF'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01T13              PIC X(8) VALUE 'ZPA01T13'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01GLV-001.
               PERFORM CALL-ZPA01T13-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01T13-002.
               CALL 'ZPA01T13' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
