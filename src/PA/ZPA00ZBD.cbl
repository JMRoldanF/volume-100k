      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00ZBD'.
      ...
      * Called module names
       01  MOD-ZPA01KAN              PIC X(8) VALUE 'ZPA01KAN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01KAN-001.
               PERFORM CALL-ZPA01F49-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01KAN-001.
               CALL 'ZPA01KAN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01KAN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01F49-002.
