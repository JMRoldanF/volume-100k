      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00Y9B'.
      ...
      * Called module names
       01  MOD-ZPA01FNP              PIC X(8) VALUE 'ZPA01FNP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01FNP-001.
               CALL 'ZPA01FNP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01FNP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
