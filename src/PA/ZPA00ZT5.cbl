      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00ZT5'.
      ...
      * Called module names
       01  MOD-ZPA01EAT              PIC X(8) VALUE 'ZPA01EAT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01EAT-001.
               CALL 'ZPA01EAT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01EAT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
