      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA001BH'.
      ...
      * Called module names
       ...
       01  MOD-ZPA00H8T              PIC X(8) VALUE 'ZPA00H8T'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00H8T-002.
               EXEC CICS LINK PROGRAM('ZPA00H8T')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA00H8T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
