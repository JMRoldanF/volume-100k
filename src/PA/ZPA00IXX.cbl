      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00IXX'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01BW5              PIC X(8) VALUE 'ZPA01BW5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01BW5-003.
               EXEC CICS LINK PROGRAM('ZPA01BW5')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01BW5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01ANP-004.
               MOVE 'ZPA01ANP' TO WS-PROGNAME-4
