      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00Q5X'.
      ...
      * Called module names
       01  MOD-ZHO01H5O              PIC X(8) VALUE 'ZHO01H5O'.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01H5O-001.
               CALL 'ZHO01H5O' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01H5O FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
