      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA004HN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA00HAR-001.
               PERFORM CALL-ZPA00ATZ-002.
               PERFORM CALL-ZHO001XI-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00HAR-001.
               MOVE 'ZPA00HAR' TO WS-PROGNAME-4
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00ATZ-002.
               MOVE 'ZPA00ATZ' TO WS-PROGNAME-5
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA00ATZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO001XI-003.
