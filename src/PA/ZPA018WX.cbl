      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA018WX'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01GF7              PIC X(8) VALUE 'ZPA01GF7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01R0B-001.
               PERFORM CALL-ZPA01GF7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01GF7-002.
               CALL 'ZPA01GF7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01GF7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
