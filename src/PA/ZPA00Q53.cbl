      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00Q53'.
      ...
      * Called module names
       01  MOD-ZPA01ND7              PIC X(8) VALUE 'ZPA01ND7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01ND7-001.
               CALL 'ZPA01ND7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01ND7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01RFV-002.
