      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00ZS1'.
      ...
      * Called module names
       01  MOD-ZPA01R51              PIC X(8) VALUE 'ZPA01R51'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01R51-001.
               CALL 'ZPA01R51' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01R51 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
