      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00SPV'.
      ...
      * Called module names
       01  MOD-ZEN01JW1              PIC X(8) VALUE 'ZEN01JW1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01JW1-001.
               CALL 'ZEN01JW1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01JW1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01GST-002.
