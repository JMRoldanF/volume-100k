      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00SWT'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01JYZ              PIC X(8) VALUE 'ZPA01JYZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01D25-001.
               PERFORM CALL-ZPA01JYZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01JYZ-002.
               CALL 'ZPA01JYZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01JYZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
