      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00OSH'.
      ...
      * Called module names
       01  MOD-ZRE01OG1              PIC X(8) VALUE 'ZRE01OG1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01OG1-001.
               CALL 'ZRE01OG1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01OG1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
