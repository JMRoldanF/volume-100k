      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00YZZ'.
      ...
      * Called module names
       01  MOD-ZCL01SPB              PIC X(8) VALUE 'ZCL01SPB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01SPB-001.
               CALL 'ZCL01SPB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01SPB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
