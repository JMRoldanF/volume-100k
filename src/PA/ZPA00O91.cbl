      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00O91'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRE01RJ5-001.
               PERFORM CALL-ZMT01JIN-002.
               PERFORM CALL-ZRE0255R-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZRE01RJ5-001.
               MOVE 'ZRE01RJ5' TO WS-SUBNAME-2
