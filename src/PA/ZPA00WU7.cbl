      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00WU7'.
      ...
      * Called module names
       01  MOD-ZUW01OIC              PIC X(8) VALUE 'ZUW01OIC'.
       01  MOD-ZPA01JVD              PIC X(8) VALUE 'ZPA01JVD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZUW01OIC-001.
               PERFORM CALL-ZPA01JVD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZUW01OIC-001.
               CALL 'ZUW01OIC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01OIC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01JVD-002.
               CALL 'ZPA01JVD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01JVD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
