      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00UJF'.
      ...
      * Called module names
       01  MOD-ZCL01MZH              PIC X(8) VALUE 'ZCL01MZH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01MZH-001.
               CALL 'ZCL01MZH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01MZH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
