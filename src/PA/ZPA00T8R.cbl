      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00T8R'.
      ...
      * Called module names
       01  MOD-ZPA01ETF              PIC X(8) VALUE 'ZPA01ETF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01ETF-001.
               CALL 'ZPA01ETF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01ETF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
