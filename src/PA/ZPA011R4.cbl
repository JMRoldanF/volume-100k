      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA011R4'.
      ...
      * Called module names
       01  MOD-ZPA01IFC              PIC X(8) VALUE 'ZPA01IFC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01IFC-001.
               CALL 'ZPA01IFC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01IFC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
