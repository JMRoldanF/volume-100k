      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA012BZ'.
      ...
      * Called module names
       ...
       01  MOD-ZRE01LJL              PIC X(8) VALUE 'ZRE01LJL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01LJL-002.
               CALL 'ZRE01LJL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01LJL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
