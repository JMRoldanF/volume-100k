      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00Z2U'.
      ...
      * Called module names
       ...
       01  MOD-ZCR01JM0              PIC X(8) VALUE 'ZCR01JM0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01HCI-001.
               PERFORM CALL-ZCR01JM0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZCR01JM0-002.
               CALL 'ZCR01JM0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCR01JM0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
