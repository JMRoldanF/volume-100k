      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA01BLB'.
      ...
      * Called module names
       01  MOD-ZPA01LWF              PIC X(8) VALUE 'ZPA01LWF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01LWF-001.
               CALL 'ZPA01LWF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01LWF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
