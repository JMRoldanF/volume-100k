      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA01AAV'.
      ...
      * Called module names
       01  MOD-ZPA01PRA              PIC X(8) VALUE 'ZPA01PRA'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01PRA-001.
               CALL 'ZPA01PRA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01PRA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01Q9N-002.
