      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00XK1'.
      ...
      * Called module names
       01  MOD-ZPA01DIH              PIC X(8) VALUE 'ZPA01DIH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01DIH-001.
               CALL 'ZPA01DIH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01DIH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
