      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA014MH'.
      ...
      * Called module names
       01  MOD-ZPA01I87              PIC X(8) VALUE 'ZPA01I87'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01I87-001.
               CALL 'ZPA01I87' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01I87 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
