      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00TDH'.
      ...
      * Called module names
       01  MOD-ZPA01O5J              PIC X(8) VALUE 'ZPA01O5J'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01O5J-001.
               CALL 'ZPA01O5J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01O5J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
