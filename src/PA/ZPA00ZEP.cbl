      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00ZEP'.
      ...
      * Called module names
       01  MOD-ZBI01ML2              PIC X(8) VALUE 'ZBI01ML2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZBI01ML2-001.
               CALL 'ZBI01ML2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZBI01ML2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
