      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA0128D'.
      ...
      * Called module names
       01  MOD-ZPA01HA1              PIC X(8) VALUE 'ZPA01HA1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01MF1-001.
               PERFORM CALL-ZPA01HA1-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZPA01MF1-001.
               MOVE 'ZPA01MF1' TO WS-SUBNAME-1
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01HA1-002.
               CALL 'ZPA01HA1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01HA1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       WRITE-ERROR-MESSAGE.
