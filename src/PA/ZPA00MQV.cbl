      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00MQV'.
      ...
      * Called module names
       01  MOD-ZPA01OKJ              PIC X(8) VALUE 'ZPA01OKJ'.
       01  MOD-ZUW01S9M              PIC X(8) VALUE 'ZUW01S9M'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01OKJ-001.
               PERFORM CALL-ZUW01S9M-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01OKJ-001.
               CALL 'ZPA01OKJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01OKJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZUW01S9M-002.
               CALL 'ZUW01S9M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZUW01S9M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
