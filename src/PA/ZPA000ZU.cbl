      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA000ZU'.
      ...
      * Called module names
       01  MOD-ZPA0089T              PIC X(8) VALUE 'ZPA0089T'.
       01  MOD-ZCR00DTQ              PIC X(8) VALUE 'ZCR00DTQ'.
       01  MOD-ZPA00GEF              PIC X(8) VALUE 'ZPA00GEF'.
       01  MOD-ZPA00GBN              PIC X(8) VALUE 'ZPA00GBN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA0089T-001.
               PERFORM CALL-ZCR00DTQ-002.
               PERFORM CALL-ZPA00GEF-003.
               PERFORM CALL-ZPA00GBN-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA0089T-001.
               EXEC CICS LINK PROGRAM('ZPA0089T')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA0089T FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCR00DTQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00GEF-003.
               EXEC CICS LINK PROGRAM('ZPA00GEF')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA00GEF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA00GBN-004.
               EXEC CICS LINK PROGRAM('ZPA00GBN')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA00GBN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-005.
