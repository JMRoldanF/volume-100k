      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00WV1'.
      ...
      * Called module names
       01  MOD-ZPA01T6X              PIC X(8) VALUE 'ZPA01T6X'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01T6X-001.
               CALL 'ZPA01T6X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01T6X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-VALUE-0001.
