      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00SPB'.
      ...
      * Called module names
       01  MOD-ZHO01JPC              PIC X(8) VALUE 'ZHO01JPC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZHO01JPC-001.
               PERFORM CALL-ZCU01PS0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZHO01JPC-001.
               CALL 'ZHO01JPC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZHO01JPC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU01PS0-002.
