      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00M7Z'.
      ...
      * Called module names
       01  MOD-ZPA01MRT              PIC X(8) VALUE 'ZPA01MRT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01MRT-001.
               PERFORM CALL-ZPA01OQX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01MRT-001.
               CALL 'ZPA01MRT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01MRT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01OQX-002.
