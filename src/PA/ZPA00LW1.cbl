      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00LW1'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01LR5              PIC X(8) VALUE 'ZPA01LR5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01LR5-002.
               CALL 'ZPA01LR5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
