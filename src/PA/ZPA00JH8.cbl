      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00JH8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00TE8-001.
               MOVE 'ZPA00TE8' TO WS-PROGNAME-3
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA00TE8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA019NL-002.
               MOVE 'ZPA019NL' TO WS-PROGNAME-4
