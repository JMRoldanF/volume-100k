      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00WFR'.
      ...
      * Called module names
       01  MOD-ZPA01MCJ              PIC X(8) VALUE 'ZPA01MCJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01MCJ-001.
               CALL 'ZPA01MCJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01MCJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
