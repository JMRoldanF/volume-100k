      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00PRH'.
      ...
      * Called module names
       01  MOD-ZRE01M4F              PIC X(8) VALUE 'ZRE01M4F'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRE01M4F-001.
               CALL 'ZRE01M4F' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRE01M4F FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
