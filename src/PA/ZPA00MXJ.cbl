      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00MXJ'.
      ...
      * Called module names
       01  MOD-ZPA01NEB              PIC X(8) VALUE 'ZPA01NEB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01NEB-001.
               CALL 'ZPA01NEB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01NEB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
