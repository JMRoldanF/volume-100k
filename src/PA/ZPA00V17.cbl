      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00V17'.
      ...
      * Called module names
       01  MOD-ZEN01QXN              PIC X(8) VALUE 'ZEN01QXN'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01QXN-001.
               CALL 'ZEN01QXN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01QXN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-VALUE-0001.
