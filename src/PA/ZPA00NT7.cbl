      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00NT7'.
      ...
      * Called module names
       01  MOD-ZCL01GE9              PIC X(8) VALUE 'ZCL01GE9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01UA3-001.
               PERFORM CALL-ZCL01GE9-002.
               PERFORM CALL-ZRE0255R-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZPA01UA3-001.
               MOVE 'ZPA01UA3' TO WS-SUBNAME-1
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01GE9-002.
               CALL 'ZCL01GE9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01GE9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
