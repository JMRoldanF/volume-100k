      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA005GI'.
      ...
      * Called module names
       01  MOD-ZPA00GYC              PIC X(8) VALUE 'ZPA00GYC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA00GYC-001.
               EXEC CICS LINK PROGRAM('ZPA00GYC')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA00GYC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA00JP6-002.
               MOVE 'ZPA00JP6' TO WS-PROGNAME-6
