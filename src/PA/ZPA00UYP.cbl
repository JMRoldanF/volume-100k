      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00UYP'.
      ...
      * Called module names
       01  MOD-ZPA01IKZ              PIC X(8) VALUE 'ZPA01IKZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01IKZ-001.
               CALL 'ZPA01IKZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01IKZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
