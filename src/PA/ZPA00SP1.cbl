      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00SP1'.
      ...
      * Called module names
       01  MOD-ZCU01U26              PIC X(8) VALUE 'ZCU01U26'.
       01  MOD-ZPA01H1Z              PIC X(8) VALUE 'ZPA01H1Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCU01U26-001.
               CALL 'ZCU01U26' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCU01U26 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01H1Z-002.
               CALL 'ZPA01H1Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
