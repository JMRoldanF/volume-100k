      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00UGX'.
      ...
      * Called module names
       01  MOD-ZPA01E3L              PIC X(8) VALUE 'ZPA01E3L'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01E3L-001.
               PERFORM CALL-ZPA01L4X-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01E3L-001.
               CALL 'ZPA01E3L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01E3L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01L4X-002.
