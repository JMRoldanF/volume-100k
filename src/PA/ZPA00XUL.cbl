      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00XUL'.
      ...
      * Called module names
       01  MOD-ZPA01DSH              PIC X(8) VALUE 'ZPA01DSH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01DSH-001.
               CALL 'ZPA01DSH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01DSH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
