      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00YHN'.
      ...
      * Called module names
       01  MOD-ZPA01IQ9              PIC X(8) VALUE 'ZPA01IQ9'.
       01  MOD-ZPA01IS7              PIC X(8) VALUE 'ZPA01IS7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01IQ9-001.
               PERFORM CALL-ZPA01IS7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01IQ9-001.
               CALL 'ZPA01IQ9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01IQ9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01IS7-002.
               CALL 'ZPA01IS7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01IS7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
