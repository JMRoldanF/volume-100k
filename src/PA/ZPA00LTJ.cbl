      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00LTJ'.
      ...
      * Called module names
       01  MOD-ZPA01KWV              PIC X(8) VALUE 'ZPA01KWV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01KWV-001.
               CALL 'ZPA01KWV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01KWV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
