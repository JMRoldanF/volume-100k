      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00WBL'.
      ...
      * Called module names
       01  MOD-ZPA01IE1              PIC X(8) VALUE 'ZPA01IE1'.
       01  MOD-ZPA01NDH              PIC X(8) VALUE 'ZPA01NDH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01IE1-001.
               PERFORM CALL-ZPA01NDH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01IE1-001.
               CALL 'ZPA01IE1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01IE1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01NDH-002.
               CALL 'ZPA01NDH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01NDH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
