      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA012AB'.
      ...
      * Called module names
       01  MOD-ZPA01GA7              PIC X(8) VALUE 'ZPA01GA7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01GA7-001.
               CALL 'ZPA01GA7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01GA7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
