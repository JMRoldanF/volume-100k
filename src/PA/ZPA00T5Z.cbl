      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00T5Z'.
      ...
      * Called module names
       01  MOD-ZPA01E95              PIC X(8) VALUE 'ZPA01E95'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01E95-001.
               PERFORM CALL-ZEN01CMN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01E95-001.
               CALL 'ZPA01E95' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01E95 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN01CMN-002.
