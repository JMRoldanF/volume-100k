      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA0105N'.
      ...
      * Called module names
       01  MOD-ZPA01QP7              PIC X(8) VALUE 'ZPA01QP7'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01QP7-001.
               CALL 'ZPA01QP7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01QP7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
