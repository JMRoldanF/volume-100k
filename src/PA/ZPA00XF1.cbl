      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00XF1'.
      ...
      * Called module names
       01  MOD-ZPA01QEX              PIC X(8) VALUE 'ZPA01QEX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01QEX-001.
               CALL 'ZPA01QEX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01QEX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-002.
