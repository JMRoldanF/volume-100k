      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00X0V'.
      ...
      * Called module names
       01  MOD-ZEN01IN1              PIC X(8) VALUE 'ZEN01IN1'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01IN1-001.
               CALL 'ZEN01IN1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01IN1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
