      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00RXW'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01MIM              PIC X(8) VALUE 'ZPA01MIM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01MIM-002.
               CALL 'ZPA01MIM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01MIM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
