      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00V8P'.
      ...
      * Called module names
       01  MOD-ZPA01QVB              PIC X(8) VALUE 'ZPA01QVB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01QVB-002.
               CALL 'ZPA01QVB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
