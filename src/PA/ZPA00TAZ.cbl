      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00TAZ'.
      ...
      * Called module names
       01  MOD-ZPA01QDT              PIC X(8) VALUE 'ZPA01QDT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01QDT-001.
               CALL 'ZPA01QDT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01QDT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
