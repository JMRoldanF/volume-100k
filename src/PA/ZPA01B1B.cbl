      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA01B1B'.
      ...
      * Called module names
       01  MOD-ZPA01V3J              PIC X(8) VALUE 'ZPA01V3J'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01V3J-001.
               CALL 'ZPA01V3J' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01V3J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01IBJ-002.
               MOVE 'ZPA01IBJ' TO WS-SUBNAME-3
