      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00W1B'.
      ...
      * Called module names
       01  MOD-ZPA01N4V              PIC X(8) VALUE 'ZPA01N4V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01N4V-002.
               CALL 'ZPA01N4V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01N4V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
