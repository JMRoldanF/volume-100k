      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00BEM'.
      ...
      * Called module names
       ...
       01  MOD-ZPA01LEO              PIC X(8) VALUE 'ZPA01LEO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCR00NFE-001.
               PERFORM CALL-ZPT0198U-002.
               PERFORM CALL-ZPA01LEO-003.
               PERFORM CALL-ZPA01ME9-004.
      ...
      *----------------------------------------------------------------*
       CALL-ZPT0198U-002.
               MOVE 'ZPT0198U' TO WS-PROGNAME-7
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01LEO-003.
               CALL 'ZPA01LEO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
