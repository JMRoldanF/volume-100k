      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00V9J'.
      ...
      * Called module names
       01  MOD-ZPA01PM1              PIC X(8) VALUE 'ZPA01PM1'.
       01  MOD-ZPA01O95              PIC X(8) VALUE 'ZPA01O95'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01PM1-001.
               PERFORM CALL-ZPA01O95-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01PM1-001.
               CALL 'ZPA01PM1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01PM1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01O95-002.
               CALL 'ZPA01O95' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01O95 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
