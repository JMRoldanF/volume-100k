      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00P81'.
      ...
      * Called module names
       01  MOD-ZPA01URB              PIC X(8) VALUE 'ZPA01URB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01URB-001.
               CALL 'ZPA01URB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01URB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
