      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00UY5'.
      ...
      * Called module names
       01  MOD-ZPA01QBV              PIC X(8) VALUE 'ZPA01QBV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01QBV-001.
               CALL 'ZPA01QBV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01QBV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
