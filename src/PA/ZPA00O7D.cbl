      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00O7D'.
      ...
      * Called module names
       01  MOD-ZPA01G2Z              PIC X(8) VALUE 'ZPA01G2Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01G2Z-001.
               CALL 'ZPA01G2Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01G2Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-VALUE-0001.
