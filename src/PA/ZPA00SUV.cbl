      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00SUV'.
      ...
      * Called module names
       01  MOD-ZPA01MQ5              PIC X(8) VALUE 'ZPA01MQ5'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01MQ5-001.
               CALL 'ZPA01MQ5' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01MQ5 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
