      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPA00QPX'.
      ...
      * Called module names
       01  MOD-ZPA01JKC              PIC X(8) VALUE 'ZPA01JKC'.
       01  MOD-ZPA01J21              PIC X(8) VALUE 'ZPA01J21'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPA01JKC-001.
               PERFORM CALL-ZPA01J21-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPA01JKC-001.
               CALL 'ZPA01JKC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01JKC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPA01J21-002.
               CALL 'ZPA01J21' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPA01J21 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
