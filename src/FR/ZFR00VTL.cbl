      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00VTL'.
      ...
      * Called module names
       01  MOD-ZFR01MNN              PIC X(8) VALUE 'ZFR01MNN'.
       01  MOD-ZNT01LTC              PIC X(8) VALUE 'ZNT01LTC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFR01MNN-001.
               PERFORM CALL-ZNT01LTC-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01MNN-001.
               CALL 'ZFR01MNN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01MNN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZNT01LTC-002.
               CALL 'ZNT01LTC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01LTC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
