      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR0197Z'.
      ...
      * Called module names
       01  MOD-ZFR01DIT              PIC X(8) VALUE 'ZFR01DIT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01DIT-001.
               CALL 'ZFR01DIT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01DIT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
