      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00A3J'.
      ...
      * Called module names
       01  MOD-ZFR00TVD              PIC X(8) VALUE 'ZFR00TVD'.
       01  MOD-ZFR019DB              PIC X(8) VALUE 'ZFR019DB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFR00TVD-001.
               PERFORM CALL-ZFR019DB-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR00TVD-001.
               EXEC CICS LINK PROGRAM('ZFR00TVD')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR00TVD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFR019DB-002.
               EXEC CICS LINK PROGRAM('ZFR019DB')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR019DB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
