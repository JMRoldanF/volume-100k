      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00YT2'.
      ...
      * Called module names
       ...
       01  MOD-ZFR01TE3              PIC X(8) VALUE 'ZFR01TE3'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFR01GB1-001.
               PERFORM CALL-ZFR01TE3-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01TE3-002.
               CALL 'ZFR01TE3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01TE3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
