      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00OGL'.
      ...
      * Called module names
       01  MOD-ZCL01G32              PIC X(8) VALUE 'ZCL01G32'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01G32-001.
               CALL 'ZCL01G32' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01G32 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
