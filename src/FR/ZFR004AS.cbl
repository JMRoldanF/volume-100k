      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR004AS'.
      ...
      * Called module names
       ...
       01  MOD-ZFR008AH              PIC X(8) VALUE 'ZFR008AH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR008AH-002.
               EXEC CICS LINK PROGRAM('ZFR008AH')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR008AH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
