      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00XDZ'.
      ...
      * Called module names
       ...
       01  MOD-ZFR01MGR              PIC X(8) VALUE 'ZFR01MGR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZNT01DNP-001.
               PERFORM CALL-ZFR01MGR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01MGR-002.
               CALL 'ZFR01MGR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01MGR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
