      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00M51'.
      ...
      * Called module names
       01  MOD-ZFR01S1N              PIC X(8) VALUE 'ZFR01S1N'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01S1N-001.
               CALL 'ZFR01S1N' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01S1N FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
