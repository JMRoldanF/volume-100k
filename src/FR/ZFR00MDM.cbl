      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00MDM'.
      ...
      * Called module names
       01  MOD-ZFR01J1S              PIC X(8) VALUE 'ZFR01J1S'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01J1S-001.
               CALL 'ZFR01J1S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01J1S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFR01KFK-002.
               MOVE 'ZFR01KFK' TO WS-SUBNAME-8
