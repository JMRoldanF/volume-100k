      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00OWE'.
      ...
      * Called module names
       01  MOD-ZFR01FC0              PIC X(8) VALUE 'ZFR01FC0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01FC0-001.
               CALL 'ZFR01FC0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01FC0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
