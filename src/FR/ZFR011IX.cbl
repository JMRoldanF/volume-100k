      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR011IX'.
      ...
      * Called module names
       01  MOD-ZFR01KIO              PIC X(8) VALUE 'ZFR01KIO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01KIO-001.
               CALL 'ZFR01KIO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01KIO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-MODEL-0001.
