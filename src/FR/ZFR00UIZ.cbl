      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00UIZ'.
      ...
      * Called module names
       01  MOD-ZFR01OO0              PIC X(8) VALUE 'ZFR01OO0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01OO0-001.
               CALL 'ZFR01OO0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01OO0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
