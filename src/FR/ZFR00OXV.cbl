      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00OXV'.
      ...
      * Called module names
       01  MOD-ZCL01KYK              PIC X(8) VALUE 'ZCL01KYK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01KYK-001.
               CALL 'ZCL01KYK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01KYK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
