      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00P9W'.
      ...
      * Called module names
       ...
       01  MOD-ZFR01MEM              PIC X(8) VALUE 'ZFR01MEM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01MEM-002.
               CALL 'ZFR01MEM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01MEM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
