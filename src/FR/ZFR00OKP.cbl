      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00OKP'.
      ...
      * Called module names
       01  MOD-ZFR01OOF              PIC X(8) VALUE 'ZFR01OOF'.
       01  MOD-ZFR01H1G              PIC X(8) VALUE 'ZFR01H1G'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFR01OOF-001.
               PERFORM CALL-ZFR01H1G-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01OOF-001.
               CALL 'ZFR01OOF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01OOF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFR01H1G-002.
               CALL 'ZFR01H1G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01H1G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
