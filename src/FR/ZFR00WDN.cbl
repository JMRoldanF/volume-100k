      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00WDN'.
      ...
      * Called module names
       ...
       01  MOD-ZFR01P5L              PIC X(8) VALUE 'ZFR01P5L'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01P5L-002.
               CALL 'ZFR01P5L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
