      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR01264'.
      ...
      * Called module names
       01  MOD-ZFR01KQB              PIC X(8) VALUE 'ZFR01KQB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01KQB-001.
               CALL 'ZFR01KQB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01KQB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
