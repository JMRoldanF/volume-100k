      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR019JE'.
      ...
      * Called module names
       ...
       01  MOD-ZFR01LIP              PIC X(8) VALUE 'ZFR01LIP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFR01DKN-001.
               PERFORM CALL-ZFR01LIP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01LIP-002.
               CALL 'ZFR01LIP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01LIP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
