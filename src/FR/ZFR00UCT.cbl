      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00UCT'.
      ...
      * Called module names
       01  MOD-ZFR01KM7              PIC X(8) VALUE 'ZFR01KM7'.
       01  MOD-ZFR01DJ0              PIC X(8) VALUE 'ZFR01DJ0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFR01KM7-001.
               PERFORM CALL-ZFR01DJ0-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01KM7-001.
               CALL 'ZFR01KM7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01DJ0-002.
               CALL 'ZFR01DJ0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01DJ0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
