      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00UQC'.
      ...
      * Called module names
       01  MOD-ZFR01O6T              PIC X(8) VALUE 'ZFR01O6T'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFR01O6T-001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZFR01O6T-001.
               CALL 'ZFR01O6T' USING DFHCOMMAREA
                         WS-STATUS-CODE.
