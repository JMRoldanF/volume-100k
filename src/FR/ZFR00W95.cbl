      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00W95'.
      ...
      * Called module names
       01  MOD-ZCL01NVJ              PIC X(8) VALUE 'ZCL01NVJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCL01NVJ-001.
               CALL 'ZCL01NVJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCL01NVJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       REFRESH-TERM-0001.
