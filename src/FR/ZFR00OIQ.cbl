      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00OIQ'.
      ...
      * Called module names
       01  MOD-ZFR01MFX              PIC X(8) VALUE 'ZFR01MFX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01MFX-001.
               CALL 'ZFR01MFX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01MFX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
