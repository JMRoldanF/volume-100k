      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR0141S'.
      ...
      * Called module names
       01  MOD-ZFR01J1R              PIC X(8) VALUE 'ZFR01J1R'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFR01J1R-001.
               PERFORM CALL-ZFR01CY1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01J1R-001.
               CALL 'ZFR01J1R' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01J1R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFR01CY1-002.
               MOVE 'ZFR01CY1' TO WS-SUBNAME-5
      ...
      *----------------------------------------------------------------*
       FILE-ACCESS-0003.
               EXEC CICS DELETE FILE('KSDSFR54')
                         RIDFLD(WS-KEY-AREA)
                         RESP(WS-RESP)
               END-EXEC.
               EVALUATE WS-RESP
