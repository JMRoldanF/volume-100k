      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00UYE'.
      ...
      * Called module names
       ...
       01  MOD-ZFR01CMR              PIC X(8) VALUE 'ZFR01CMR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01CMR-002.
               CALL 'ZFR01CMR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
