      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR011O0'.
      ...
      * Called module names
       01  MOD-ZFR01SX0              PIC X(8) VALUE 'ZFR01SX0'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFR01SX0-001.
               PERFORM CALL-ZFR01N3G-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01SX0-001.
               CALL 'ZFR01SX0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01SX0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFR01N3G-002.
