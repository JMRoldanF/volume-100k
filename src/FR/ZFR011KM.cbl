      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR011KM'.
      ...
      * Called module names
       ...
       01  MOD-ZFR01MWL              PIC X(8) VALUE 'ZFR01MWL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZNT01ED0-001.
               PERFORM CALL-ZFR01MWL-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01MWL-002.
               CALL 'ZFR01MWL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01MWL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
