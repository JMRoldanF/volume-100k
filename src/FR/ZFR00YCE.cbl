      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00YCE'.
      ...
      * Called module names
       01  MOD-ZFR01FKJ              PIC X(8) VALUE 'ZFR01FKJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01FKJ-002.
               CALL 'ZFR01FKJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
