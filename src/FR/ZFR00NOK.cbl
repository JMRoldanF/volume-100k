      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00NOK'.
      ...
      * Called module names
       01  MOD-ZFR01CNR              PIC X(8) VALUE 'ZFR01CNR'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01CNR-001.
               CALL 'ZFR01CNR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01CNR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
