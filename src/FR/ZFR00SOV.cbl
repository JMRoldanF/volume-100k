      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00SOV'.
      ...
      * Called module names
       01  MOD-ZFR01MVB              PIC X(8) VALUE 'ZFR01MVB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFR01MVB-001.
               PERFORM CALL-ZRC01MIU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01MVB-001.
               CALL 'ZFR01MVB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01MVB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRC01MIU-002.
