      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR01257'.
      ...
      * Called module names
       ...
       01  MOD-ZNT01SLX              PIC X(8) VALUE 'ZNT01SLX'.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01SLX-002.
               CALL 'ZNT01SLX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01SLX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
