      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00LUQ'.
      ...
      * Called module names
       01  MOD-ZFR01UJ9              PIC X(8) VALUE 'ZFR01UJ9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFR01UJ9-001.
               PERFORM CALL-ZFR01MVW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01UJ9-001.
               CALL 'ZFR01UJ9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01UJ9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFR01MVW-002.
