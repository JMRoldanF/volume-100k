      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00Z1K'.
      ...
      * Called module names
       ...
       01  MOD-ZFR01FN6              PIC X(8) VALUE 'ZFR01FN6'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFR01N3G-001.
               PERFORM CALL-ZFR01FN6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01FN6-002.
               CALL 'ZFR01FN6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01FN6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-EXCESS-0001.
