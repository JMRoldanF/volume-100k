      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR0112F'.
      ...
      * Called module names
       01  MOD-ZFR01EKD              PIC X(8) VALUE 'ZFR01EKD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01EKD-001.
               CALL 'ZFR01EKD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01EKD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFR01LH6-002.
