      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00Q7V'.
      ...
      * Called module names
       01  MOD-ZFR01TRB              PIC X(8) VALUE 'ZFR01TRB'.
       01  MOD-ZFR01KMX              PIC X(8) VALUE 'ZFR01KMX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFR01TRB-001.
               PERFORM CALL-ZFR01KMX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01TRB-001.
               CALL 'ZFR01TRB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01TRB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFR01KMX-002.
               CALL 'ZFR01KMX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01KMX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
