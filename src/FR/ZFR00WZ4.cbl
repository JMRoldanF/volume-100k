      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00WZ4'.
      ...
      * Called module names
       01  MOD-ZNT01K64              PIC X(8) VALUE 'ZNT01K64'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZNT01K64-001.
               PERFORM CALL-ZFR01NR1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01K64-001.
               CALL 'ZNT01K64' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZNT01K64 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFR01NR1-002.
