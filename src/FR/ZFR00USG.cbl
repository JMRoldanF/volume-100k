      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00USG'.
      ...
      * Called module names
       01  MOD-ZFR01SBO              PIC X(8) VALUE 'ZFR01SBO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01SBO-001.
               CALL 'ZFR01SBO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01SBO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFR01MFX-002.
