      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00QLQ'.
      ...
      * Called module names
       01  MOD-ZCL01LIC              PIC X(8) VALUE 'ZCL01LIC'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZCL01LIC-001.
               PERFORM CALL-ZMT0255L-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZCL01LIC-001.
               CALL 'ZCL01LIC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
