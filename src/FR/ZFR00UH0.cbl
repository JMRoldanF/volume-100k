      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00UH0'.
      ...
      * Called module names
       01  MOD-ZFR01PGA              PIC X(8) VALUE 'ZFR01PGA'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFR01PGA-001.
               PERFORM CALL-ZNT01LEQ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01PGA-001.
               CALL 'ZFR01PGA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01PGA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZNT01LEQ-002.
