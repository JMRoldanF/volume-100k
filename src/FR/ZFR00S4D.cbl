      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00S4D'.
      ...
      * Called module names
       01  MOD-ZFR01GY6              PIC X(8) VALUE 'ZFR01GY6'.
       01  MOD-ZFR01SW7              PIC X(8) VALUE 'ZFR01SW7'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFR01GY6-001.
               PERFORM CALL-ZFR01SW7-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01GY6-001.
               CALL 'ZFR01GY6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01GY6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFR01SW7-002.
               CALL 'ZFR01SW7' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01SW7 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
