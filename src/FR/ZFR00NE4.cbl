      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00NE4'.
      ...
      * Called module names
       01  MOD-ZFR01RCJ              PIC X(8) VALUE 'ZFR01RCJ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01RCJ-001.
               CALL 'ZFR01RCJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01RCJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
