      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00M55'.
      ...
      * Called module names
       01  MOD-ZFR01E1P              PIC X(8) VALUE 'ZFR01E1P'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZFR01E1P-001.
               PERFORM CALL-ZCL01DV6-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZFR01E1P-001.
               CALL 'ZFR01E1P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01E1P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL01DV6-002.
