      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR010GQ'.
      ...
      * Called module names
       ...
       01  MOD-ZNT01NH4              PIC X(8) VALUE 'ZNT01NH4'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZRC01NYD-001.
               PERFORM CALL-ZNT01NH4-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZNT01NH4-002.
               CALL 'ZNT01NH4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
