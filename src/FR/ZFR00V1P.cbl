      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZFR00V1P'.
      ...
      * Called module names
       01  MOD-ZRC01QHC              PIC X(8) VALUE 'ZRC01QHC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZRC01QHC-001.
               CALL 'ZRC01QHC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZRC01QHC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
