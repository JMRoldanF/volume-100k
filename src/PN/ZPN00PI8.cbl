      ******************************************************************
      * ZPN00PI8 - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN00PI8'.
      ...
      * Called module names
       01  MOD-ZPN01JKQ              PIC X(8) VALUE 'ZPN01JKQ'.
       01  MOD-ZPN01RC9              PIC X(8) VALUE 'ZPN01RC9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01JKQ-001.
               CALL 'ZPN01JKQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01JKQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPN01RC9-002.
               CALL 'ZPN01RC9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01RC9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
