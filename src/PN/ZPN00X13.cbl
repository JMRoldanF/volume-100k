      ******************************************************************
      * ZPN00X13 - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN00X13'.
      ...
      * Called module names
       01  MOD-ZPN01MET              PIC X(8) VALUE 'ZPN01MET'.
       01  MOD-ZPN01Q8V              PIC X(8) VALUE 'ZPN01Q8V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01MET-001.
               CALL 'ZPN01MET' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01MET FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPN01Q8V-002.
               CALL 'ZPN01Q8V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
