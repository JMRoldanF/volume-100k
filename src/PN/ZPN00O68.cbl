      ******************************************************************
      * ZPN00O68 - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN00O68'.
      ...
      * Called module names
       01  MOD-ZPN01IXI              PIC X(8) VALUE 'ZPN01IXI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPN01IXI-001.
               PERFORM CALL-ZPN01J1A-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01IXI-001.
               CALL 'ZPN01IXI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01IXI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPN01J1A-002.
