      ******************************************************************
      * ZPN00TVA - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN00TVA'.
      ...
      * Called module names
       01  MOD-ZPN01M16              PIC X(8) VALUE 'ZPN01M16'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01M16-001.
               CALL 'ZPN01M16' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01M16 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
