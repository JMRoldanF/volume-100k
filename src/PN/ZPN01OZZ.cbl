      ******************************************************************
      * ZPN01OZZ - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN01OZZ'.
      ...
      * Called module names
       01  MOD-ZPN01TZQ              PIC X(8) VALUE 'ZPN01TZQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01TZQ-001.
               CALL 'ZPN01TZQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01TZQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
