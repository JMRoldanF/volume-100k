      ******************************************************************
      * ZPN00XPP - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN00XPP'.
      ...
      * Called module names
       ...
       01  MOD-ZPN01MQD              PIC X(8) VALUE 'ZPN01MQD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPN01D0C-001.
               PERFORM CALL-ZPN01MQD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01MQD-002.
               CALL 'ZPN01MQD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01MQD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
