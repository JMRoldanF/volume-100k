      ******************************************************************
      * ZPN00ZZ9 - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN00ZZ9'.
      ...
      * Called module names
       01  MOD-ZPN01GSE              PIC X(8) VALUE 'ZPN01GSE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM NORMALISE-BEDROOMS-0095.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01GSE-001.
               CALL 'ZPN01GSE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01GSE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-002.
