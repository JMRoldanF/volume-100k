      ******************************************************************
      * ZPN00O3D - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN00O3D'.
      ...
      * Called module names
       01  MOD-ZTY01EDF              PIC X(8) VALUE 'ZTY01EDF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01EDF-001.
               CALL 'ZTY01EDF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01EDF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
