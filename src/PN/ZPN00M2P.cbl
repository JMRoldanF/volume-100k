      ******************************************************************
      * ZPN00M2P - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN00M2P'.
      ...
      * Called module names
       01  MOD-ZPN01RKQ              PIC X(8) VALUE 'ZPN01RKQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01RKQ-001.
               CALL 'ZPN01RKQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01RKQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPN01IHI-002.
