      ******************************************************************
      * ZPN00WCL - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN00WCL'.
      ...
      * Called module names
       01  MOD-ZPN01IY9              PIC X(8) VALUE 'ZPN01IY9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01IY9-001.
               CALL 'ZPN01IY9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01IY9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-EXCESS-0001.
