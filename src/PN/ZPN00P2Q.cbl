      ******************************************************************
      * ZPN00P2Q - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN00P2Q'.
      ...
      * Called module names
       01  MOD-ZPN01SBK              PIC X(8) VALUE 'ZPN01SBK'.
       01  MOD-ZPN01K4U              PIC X(8) VALUE 'ZPN01K4U'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPN01SBK-001.
               PERFORM CALL-ZPN01K4U-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01SBK-001.
               CALL 'ZPN01SBK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01SBK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPN01K4U-002.
               CALL 'ZPN01K4U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01K4U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
               MOVE 'ZCL0255P' TO WS-PROGNAME-4
