      ******************************************************************
      * ZPN00WA6 - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN00WA6'.
      ...
      * Called module names
       01  MOD-ZPN01GU8              PIC X(8) VALUE 'ZPN01GU8'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPN01GU8-001.
               PERFORM CALL-ZTY01LWR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01GU8-001.
               CALL 'ZPN01GU8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01GU8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTY01LWR-002.
