      ******************************************************************
      * ZPN00Z86 - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN00Z86'.
      ...
      * Called module names
       01  MOD-ZPN01EMH              PIC X(8) VALUE 'ZPN01EMH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01EMH-001.
               CALL 'ZPN01EMH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01EMH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
