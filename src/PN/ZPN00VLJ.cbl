      ******************************************************************
      * ZPN00VLJ - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN00VLJ'.
      ...
      * Called module names
       01  MOD-ZTY01MPF              PIC X(8) VALUE 'ZTY01MPF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTY01MPF-001.
               PERFORM CALL-ZPN01JV5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01MPF-001.
               CALL 'ZTY01MPF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01MPF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPN01JV5-002.
