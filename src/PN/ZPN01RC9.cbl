      ******************************************************************
      * ZPN01RC9 - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN01RC9'.
      ...
      * Called module names
       01  MOD-ZTY01EEP              PIC X(8) VALUE 'ZTY01EEP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01EEP-001.
               CALL 'ZTY01EEP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01EEP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
