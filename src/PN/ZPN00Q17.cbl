      ******************************************************************
      * ZPN00Q17 - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN00Q17'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPN01LEV-001.
               PERFORM CALL-ZPN01UHM-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01LEV-001.
               MOVE 'ZPN01LEV' TO WS-SUBNAME-1
               CALL WS-SUBNAME-1 USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01LEV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPN01UHM-002.
               MOVE 'ZPN01UHM' TO WS-SUBNAME-2
