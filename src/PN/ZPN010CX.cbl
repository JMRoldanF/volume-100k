      ******************************************************************
      * ZPN010CX - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN010CX'.
      ...
      * Called module names
       01  MOD-ZPN01FB4              PIC X(8) VALUE 'ZPN01FB4'.
       01  MOD-ZPN01KOB              PIC X(8) VALUE 'ZPN01KOB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01FB4-001.
               CALL 'ZPN01FB4' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01KOB-002.
               CALL 'ZPN01KOB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01KOB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
