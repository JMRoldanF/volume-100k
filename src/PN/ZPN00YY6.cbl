      ******************************************************************
      * ZPN00YY6 - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN00YY6'.
      ...
      * Called module names
       01  MOD-ZPN01PZU              PIC X(8) VALUE 'ZPN01PZU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01PZU-001.
               CALL 'ZPN01PZU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01PZU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
