      ******************************************************************
      * ZPN012EV - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN012EV'.
      ...
      * Called module names
       01  MOD-ZPN01D14              PIC X(8) VALUE 'ZPN01D14'.
       01  MOD-ZPN01OQP              PIC X(8) VALUE 'ZPN01OQP'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPN01D14-001.
               PERFORM CALL-ZPN01OQP-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01D14-001.
               CALL 'ZPN01D14' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01D14 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPN01OQP-002.
               CALL 'ZPN01OQP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01OQP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
