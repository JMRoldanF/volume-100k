      ******************************************************************
      * ZPN00SXW - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN00SXW'.
      ...
      * Called module names
       01  MOD-ZCR01IIL              PIC X(8) VALUE 'ZCR01IIL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCR01IIL-001.
               CALL 'ZCR01IIL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCR01IIL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
