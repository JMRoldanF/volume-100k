      ******************************************************************
      * ZPN01012 - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN01012'.
      ...
      * Called module names
       01  MOD-ZPN01U8D              PIC X(8) VALUE 'ZPN01U8D'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPN01U8D-001.
               PERFORM CALL-ZPN01PRX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01U8D-001.
               CALL 'ZPN01U8D' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01U8D FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPN01PRX-002.
