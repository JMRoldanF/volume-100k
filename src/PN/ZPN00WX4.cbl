      ******************************************************************
      * ZPN00WX4 - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN00WX4'.
      ...
      * Called module names
       01  MOD-ZPN01UVV              PIC X(8) VALUE 'ZPN01UVV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01UVV-001.
               CALL 'ZPN01UVV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01UVV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPN01RKQ-002.
