      ******************************************************************
      * ZPN00QVT - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN00QVT'.
      ...
      * Called module names
       01  MOD-ZPN01Q29              PIC X(8) VALUE 'ZPN01Q29'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPN01Q29-001.
               PERFORM VALIDATE-CC-RATING-0001.
               PERFORM FORMAT-EQUITIES-0002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZPN01Q29-001.
               CALL 'ZPN01Q29' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01Q29 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
