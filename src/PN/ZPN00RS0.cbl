      ******************************************************************
      * ZPN00RS0 - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN00RS0'.
      ...
      * Called module names
       ...
       01  MOD-ZCR01PUS              PIC X(8) VALUE 'ZCR01PUS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCR01PUS-002.
               CALL 'ZCR01PUS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCR01PUS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
