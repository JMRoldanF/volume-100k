      ******************************************************************
      * ZPN010K7 - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN010K7'.
      ...
      * Called module names
       01  MOD-ZPN01GBO              PIC X(8) VALUE 'ZPN01GBO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01GBO-001.
               CALL 'ZPN01GBO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01GBO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
