      ******************************************************************
      * ZPN00YPA - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN00YPA'.
      ...
      * Called module names
       ...
       01  MOD-ZPN01DFW              PIC X(8) VALUE 'ZPN01DFW'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01DFW-002.
               CALL 'ZPN01DFW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01DFW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
