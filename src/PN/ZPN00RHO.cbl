      ******************************************************************
      * ZPN00RHO - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN00RHO'.
      ...
      * Called module names
       01  MOD-ZPN01NWK              PIC X(8) VALUE 'ZPN01NWK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01NWK-001.
               CALL 'ZPN01NWK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01NWK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
