      ******************************************************************
      * ZPN00UR3 - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN00UR3'.
      ...
      * Called module names
       ...
       01  MOD-ZTY01S7G              PIC X(8) VALUE 'ZTY01S7G'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01S7G-002.
               CALL 'ZTY01S7G' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01S7G FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
