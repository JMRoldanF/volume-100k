      ******************************************************************
      * ZPN0109T - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN0109T'.
      ...
      * Called module names
       01  MOD-ZPN01CXH              PIC X(8) VALUE 'ZPN01CXH'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01CXH-001.
               CALL 'ZPN01CXH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01CXH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
