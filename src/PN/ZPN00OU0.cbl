      ******************************************************************
      * ZPN00OU0 - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN00OU0'.
      ...
      * Called module names
       ...
       01  MOD-ZPN01U47              PIC X(8) VALUE 'ZPN01U47'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTY01JQH-001.
               PERFORM CALL-ZPN01U47-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01U47-002.
               CALL 'ZPN01U47' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01U47 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
