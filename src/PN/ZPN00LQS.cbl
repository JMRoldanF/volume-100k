      ******************************************************************
      * ZPN00LQS - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN00LQS'.
      ...
      * Called module names
       01  MOD-ZPN01JXU              PIC X(8) VALUE 'ZPN01JXU'.
       01  MOD-ZPN01LUS              PIC X(8) VALUE 'ZPN01LUS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01JXU-001.
               CALL 'ZPN01JXU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01JXU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPN01LUS-002.
               CALL 'ZPN01LUS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01LUS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
