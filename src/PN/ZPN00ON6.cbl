      ******************************************************************
      * ZPN00ON6 - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN00ON6'.
      ...
      * Called module names
       ...
       01  MOD-ZPN01MZQ              PIC X(8) VALUE 'ZPN01MZQ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01MZQ-002.
               CALL 'ZPN01MZQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01MZQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       RESOLVE-COLOUR-0001.
