      ******************************************************************
      * ZPN00WTC - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN00WTC'.
      ...
      * Called module names
       01  MOD-ZPN01ETM              PIC X(8) VALUE 'ZPN01ETM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01ETM-001.
               CALL 'ZPN01ETM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01ETM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
