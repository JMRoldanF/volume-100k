      ******************************************************************
      * ZPN00TBO - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN00TBO'.
      ...
      * Called module names
       01  MOD-ZPN01TSG              PIC X(8) VALUE 'ZPN01TSG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPN01TSG-001.
               PERFORM CALL-ZPN01TCS-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01TSG-001.
               CALL 'ZPN01TSG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
