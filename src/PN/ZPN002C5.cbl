      ******************************************************************
      * ZPN002C5 - PENSION ADMINISTRATION                              *
      ******************************************************************
      *
      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPN002C5'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPN00A4Y-001.
               PERFORM CALL-ZCR00DJX-002.
               PERFORM CALL-ZPN00AL6-003.
               PERFORM CALL-ZHO0255M-004.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZPN00A4Y-001.
               MOVE 'ZPN00A4Y' TO WS-PROGNAME-8
               ...
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN00A4Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCR00DJX-002.
               MOVE 'ZCR00DJX' TO WS-PROGNAME-1
      ...
      *----------------------------------------------------------------*
       CALL-ZPN00AL6-003.
               MOVE 'ZPN00AL6' TO WS-PROGNAME-2
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN00AL6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-004.
