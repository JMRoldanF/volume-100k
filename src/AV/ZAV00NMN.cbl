      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00NMN'.
      ...
      * Called module names
       01  MOD-ZAV01FCO              PIC X(8) VALUE 'ZAV01FCO'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAV01FCO-001.
               PERFORM CALL-ZAV01HT5-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01FCO-001.
               CALL 'ZAV01FCO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01FCO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAV01HT5-002.
