      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV0122E'.
      ...
      * Called module names
       01  MOD-ZAV01EO3              PIC X(8) VALUE 'ZAV01EO3'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01EO3-001.
               CALL 'ZAV01EO3' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01EO3 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
