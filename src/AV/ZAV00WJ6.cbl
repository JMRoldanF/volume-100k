      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00WJ6'.
      ...
      * Called module names
       01  MOD-ZAV01ORG              PIC X(8) VALUE 'ZAV01ORG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAV01CSR-001.
               PERFORM CALL-ZAV01ORG-002.
               PERFORM CALL-ZRE0255R-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZAV01CSR-001.
               MOVE 'ZAV01CSR' TO WS-SUBNAME-8
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01ORG-002.
               CALL 'ZAV01ORG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01ORG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
