      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00QL0'.
      ...
      * Called module names
       01  MOD-ZMT01LWM              PIC X(8) VALUE 'ZMT01LWM'.
       01  MOD-ZAV01P05              PIC X(8) VALUE 'ZAV01P05'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01LWM-001.
               PERFORM CALL-ZAV01P05-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01LWM-001.
               CALL 'ZMT01LWM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01LWM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAV01P05-002.
               CALL 'ZAV01P05' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01P05 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-TERM-0001.
