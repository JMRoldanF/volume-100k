      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00TX2'.
      ...
      * Called module names
       01  MOD-ZAV01RBP              PIC X(8) VALUE 'ZAV01RBP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01RBP-001.
               CALL 'ZAV01RBP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01RBP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAV01P69-002.
