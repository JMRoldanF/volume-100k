      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00TL2'.
      ...
      * Called module names
       ...
       01  MOD-ZAV01OPC              PIC X(8) VALUE 'ZAV01OPC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01OPC-002.
               CALL 'ZAV01OPC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01OPC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
