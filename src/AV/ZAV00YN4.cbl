      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00YN4'.
      ...
      * Called module names
       01  MOD-ZAV01P8Z              PIC X(8) VALUE 'ZAV01P8Z'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAV01P8Z-001.
               PERFORM CALL-ZAV01IPH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01P8Z-001.
               CALL 'ZAV01P8Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01P8Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAV01IPH-002.
