      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00SVM'.
      ...
      * Called module names
       01  MOD-ZAV01SFD              PIC X(8) VALUE 'ZAV01SFD'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01SFD-001.
               CALL 'ZAV01SFD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01SFD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
