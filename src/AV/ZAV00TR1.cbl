      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00TR1'.
      ...
      * Called module names
       01  MOD-ZAV01J32              PIC X(8) VALUE 'ZAV01J32'.
       01  MOD-ZAV01KOH              PIC X(8) VALUE 'ZAV01KOH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAV01J32-001.
               PERFORM CALL-ZAV01KOH-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01J32-001.
               CALL 'ZAV01J32' USING DFHCOMMAREA
                         WS-STATUS-CODE.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01KOH-002.
               CALL 'ZAV01KOH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01KOH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
