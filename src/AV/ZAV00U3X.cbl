      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00U3X'.
      ...
      * Called module names
       01  MOD-ZAV01DPL              PIC X(8) VALUE 'ZAV01DPL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01DPL-001.
               CALL 'ZAV01DPL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01DPL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAV01RKY-002.
