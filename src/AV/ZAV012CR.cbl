      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV012CR'.
      ...
      * Called module names
       01  MOD-ZAV01MHU              PIC X(8) VALUE 'ZAV01MHU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01MHU-001.
               CALL 'ZAV01MHU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01MHU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
