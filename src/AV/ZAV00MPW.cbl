      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00MPW'.
      ...
      * Called module names
       01  MOD-ZAV01D0A              PIC X(8) VALUE 'ZAV01D0A'.
       01  MOD-ZAV01F51              PIC X(8) VALUE 'ZAV01F51'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAV01D0A-001.
               PERFORM CALL-ZAV01F51-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01D0A-001.
               CALL 'ZAV01D0A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01D0A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAV01F51-002.
               CALL 'ZAV01F51' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01F51 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
