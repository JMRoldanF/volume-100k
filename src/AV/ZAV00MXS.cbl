      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00MXS'.
      ...
      * Called module names
       01  MOD-ZAV01SOH              PIC X(8) VALUE 'ZAV01SOH'.
       01  MOD-ZAV01ESR              PIC X(8) VALUE 'ZAV01ESR'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAV01SOH-001.
               PERFORM CALL-ZAV01ESR-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01SOH-001.
               CALL 'ZAV01SOH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01SOH FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAV01ESR-002.
               CALL 'ZAV01ESR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01ESR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-EXCESS-0001.
