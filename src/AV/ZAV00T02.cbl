      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00T02'.
      ...
      * Called module names
       01  MOD-ZAV01KJW              PIC X(8) VALUE 'ZAV01KJW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAV01KJW-001.
               PERFORM CALL-ZAV01QLV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01KJW-001.
               CALL 'ZAV01KJW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01KJW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAV01QLV-002.
