      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00RVK'.
      ...
      * Called module names
       01  MOD-ZAV01EUM              PIC X(8) VALUE 'ZAV01EUM'.
       01  MOD-ZAV01DVZ              PIC X(8) VALUE 'ZAV01DVZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAV01EUM-001.
               PERFORM CALL-ZAV01DVZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01EUM-001.
               CALL 'ZAV01EUM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01EUM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAV01DVZ-002.
               CALL 'ZAV01DVZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01DVZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
