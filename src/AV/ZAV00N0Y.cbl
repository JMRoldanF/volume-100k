      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00N0Y'.
      ...
      * Called module names
       01  MOD-ZDI01CU6              PIC X(8) VALUE 'ZDI01CU6'.
       01  MOD-ZAV01SR9              PIC X(8) VALUE 'ZAV01SR9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZDI01CU6-001.
               CALL 'ZDI01CU6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDI01CU6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAV01SR9-002.
               CALL 'ZAV01SR9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01SR9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
