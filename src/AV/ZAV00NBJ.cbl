      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00NBJ'.
      ...
      * Called module names
       01  MOD-ZAV01EHY              PIC X(8) VALUE 'ZAV01EHY'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01EHY-001.
               CALL 'ZAV01EHY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01EHY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
