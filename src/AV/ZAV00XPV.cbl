      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00XPV'.
      ...
      * Called module names
       01  MOD-ZAV01SY9              PIC X(8) VALUE 'ZAV01SY9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01SY9-001.
               CALL 'ZAV01SY9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01SY9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
