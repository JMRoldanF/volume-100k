      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00QMV'.
      ...
      * Called module names
       01  MOD-ZMT01OGN              PIC X(8) VALUE 'ZMT01OGN'.
       01  MOD-ZAV01NVV              PIC X(8) VALUE 'ZAV01NVV'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01OGN-001.
               PERFORM CALL-ZAV01NVV-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01OGN-001.
               CALL 'ZMT01OGN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01OGN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAV01NVV-002.
               CALL 'ZAV01NVV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01NVV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
