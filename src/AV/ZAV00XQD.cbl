      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00XQD'.
      ...
      * Called module names
       ...
       01  MOD-ZAV01FR9              PIC X(8) VALUE 'ZAV01FR9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAV01H5L-001.
               PERFORM CALL-ZAV01FR9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01FR9-002.
               CALL 'ZAV01FR9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01FR9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
