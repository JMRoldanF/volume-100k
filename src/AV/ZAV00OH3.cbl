      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00OH3'.
      ...
      * Called module names
       01  MOD-ZAV01IJZ              PIC X(8) VALUE 'ZAV01IJZ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAV01FDC-001.
               PERFORM CALL-ZAV01IJZ-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01IJZ-002.
               CALL 'ZAV01IJZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
