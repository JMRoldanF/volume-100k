      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00SVO'.
      ...
      * Called module names
       01  MOD-ZAV01G3S              PIC X(8) VALUE 'ZAV01G3S'.
       01  MOD-ZFR01KFK              PIC X(8) VALUE 'ZFR01KFK'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01G3S-001.
               CALL 'ZAV01G3S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01G3S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZFR01KFK-002.
               CALL 'ZFR01KFK' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZFR01KFK FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
