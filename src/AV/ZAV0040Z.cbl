      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV0040Z'.
      ...
      * Called module names
       01  MOD-ZAV00D2J              PIC X(8) VALUE 'ZAV00D2J'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAV00D2J-001.
               PERFORM CALL-ZDI00DDZ-002.
               PERFORM CALL-ZAV001IM-003.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV00D2J-001.
               EXEC CICS LINK PROGRAM('ZAV00D2J')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV00D2J FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZDI00DDZ-002.
               MOVE 'ZDI00DDZ' TO WS-PROGNAME-2
               ...
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZDI00DDZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAV001IM-003.
               EXEC CICS START TRANSID('Z1IM')
                         FROM(WS-KEY-AREA)
                         LENGTH(20)
                         RESP(WS-RESP)
               END-EXEC.
      * TRANSID Z1IM is defined against ZAV001IM
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV001IM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
