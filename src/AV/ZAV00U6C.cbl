      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00U6C'.
      ...
      * Called module names
       ...
       01  MOD-ZAV01CMG              PIC X(8) VALUE 'ZAV01CMG'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01CMG-002.
               CALL 'ZAV01CMG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01CMG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
