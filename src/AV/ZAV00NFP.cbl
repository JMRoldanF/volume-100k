      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00NFP'.
      ...
      * Called module names
       01  MOD-ZAV01F0V              PIC X(8) VALUE 'ZAV01F0V'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01F0V-001.
               CALL 'ZAV01F0V' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01F0V FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-002.
