      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV010S5'.
      ...
      * Called module names
       01  MOD-ZAV01FPB              PIC X(8) VALUE 'ZAV01FPB'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAV01FPB-001.
               PERFORM CALL-ZAV01P69-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01FPB-001.
               CALL 'ZAV01FPB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01FPB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAV01P69-002.
