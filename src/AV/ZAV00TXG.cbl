      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00TXG'.
      ...
      * Called module names
       01  MOD-ZAV01JHZ              PIC X(8) VALUE 'ZAV01JHZ'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01JHZ-001.
               CALL 'ZAV01JHZ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01JHZ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
