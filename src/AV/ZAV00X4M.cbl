      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00X4M'.
      ...
      * Called module names
       01  MOD-ZAV01DRA              PIC X(8) VALUE 'ZAV01DRA'.
       01  MOD-ZAV01I4X              PIC X(8) VALUE 'ZAV01I4X'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAV01DRA-001.
               PERFORM CALL-ZAV01I4X-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01DRA-001.
               CALL 'ZAV01DRA' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01DRA FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAV01I4X-002.
               CALL 'ZAV01I4X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01I4X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
