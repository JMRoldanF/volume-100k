      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00SH0'.
      ...
      * Called module names
       01  MOD-ZAV01IXH              PIC X(8) VALUE 'ZAV01IXH'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAV01IXH-001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZAV01IXH-001.
               CALL 'ZAV01IXH' USING DFHCOMMAREA
                         WS-STATUS-CODE.
