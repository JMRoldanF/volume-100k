      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00ZWT'.
      ...
      * Called module names
       01  MOD-ZAV01QQL              PIC X(8) VALUE 'ZAV01QQL'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAV01QQL-001.
               PERFORM CALL-ZDI01H2W-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01QQL-001.
               CALL 'ZAV01QQL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01QQL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZDI01H2W-002.
