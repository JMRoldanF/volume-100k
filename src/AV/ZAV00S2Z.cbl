      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00S2Z'.
      ...
      * Called module names
       ...
       01  MOD-ZAV01DWF              PIC X(8) VALUE 'ZAV01DWF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01DWF-002.
               CALL 'ZAV01DWF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
