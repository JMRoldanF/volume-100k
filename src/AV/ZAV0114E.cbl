      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV0114E'.
      ...
      * Called module names
       ...
       01  MOD-ZAV01NBG              PIC X(8) VALUE 'ZAV01NBG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAV01OZP-001.
               PERFORM CALL-ZAV01NBG-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01NBG-002.
               CALL 'ZAV01NBG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01NBG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       APPLY-TAX-BAND-0001.
