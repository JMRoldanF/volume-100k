      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00M3D'.
      ...
      * Called module names
       01  MOD-ZAV01G0H              PIC X(8) VALUE 'ZAV01G0H'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01G0H-001.
               CALL 'ZAV01G0H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01G0H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
