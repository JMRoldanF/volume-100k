      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00OHF'.
      ...
      * Called module names
       01  MOD-ZAV01V02              PIC X(8) VALUE 'ZAV01V02'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01V02-001.
               CALL 'ZAV01V02' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01V02 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
