      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00PMC'.
      ...
      * Called module names
       01  MOD-ZAV01DNQ              PIC X(8) VALUE 'ZAV01DNQ'.
       01  MOD-ZAV01GUN              PIC X(8) VALUE 'ZAV01GUN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAV01DNQ-001.
               PERFORM CALL-ZAV01GUN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01DNQ-001.
               CALL 'ZAV01DNQ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01DNQ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAV01GUN-002.
               CALL 'ZAV01GUN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01GUN FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
