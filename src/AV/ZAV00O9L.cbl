      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00O9L'.
      ...
      * Called module names
       ...
       01  MOD-ZAV01OKC              PIC X(8) VALUE 'ZAV01OKC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01OKC-002.
               CALL 'ZAV01OKC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01OKC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAG0255S-003.
