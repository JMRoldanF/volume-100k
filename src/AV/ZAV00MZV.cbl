      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00MZV'.
      ...
      * Called module names
       01  MOD-ZAV01U4U              PIC X(8) VALUE 'ZAV01U4U'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAV01U4U-001.
               PERFORM CALL-ZHO0255M-002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZAV01U4U-001.
               CALL 'ZAV01U4U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
