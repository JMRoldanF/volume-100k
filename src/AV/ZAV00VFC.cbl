      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00VFC'.
      ...
      * Called module names
       01  MOD-ZAV01MTI              PIC X(8) VALUE 'ZAV01MTI'.
       01  MOD-ZAV01MUE              PIC X(8) VALUE 'ZAV01MUE'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01MTI-001.
               CALL 'ZAV01MTI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01MTI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAV01MUE-002.
               CALL 'ZAV01MUE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01MUE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
