      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV010HQ'.
      ...
      * Called module names
       ...
       01  MOD-ZAV01KQF              PIC X(8) VALUE 'ZAV01KQF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZAV01RHL-001.
               PERFORM CALL-ZAV01KQF-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZAV01KQF-002.
               CALL 'ZAV01KQF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAV01KQF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
