      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZAV00QGU'.
      ...
      * Called module names
       01  MOD-ZMT01H8B              PIC X(8) VALUE 'ZMT01H8B'.
       01  MOD-ZED01S0Z              PIC X(8) VALUE 'ZED01S0Z'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZMT01H8B-001.
               PERFORM CALL-ZED01S0Z-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZMT01H8B-001.
               CALL 'ZMT01H8B' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMT01H8B FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZED01S0Z-002.
               CALL 'ZED01S0Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZED01S0Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
