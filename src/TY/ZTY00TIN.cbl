      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY00TIN'.
      ...
      * Called module names
       01  MOD-ZTY01EST              PIC X(8) VALUE 'ZTY01EST'.
       01  MOD-ZTY01OWD              PIC X(8) VALUE 'ZTY01OWD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTY01EST-001.
               PERFORM CALL-ZTY01OWD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01EST-001.
               CALL 'ZTY01EST' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01EST FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTY01OWD-002.
               CALL 'ZTY01OWD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01OWD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
