      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY00ZUA'.
      ...
      * Called module names
       01  MOD-ZTY01S01              PIC X(8) VALUE 'ZTY01S01'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01S01-001.
               CALL 'ZTY01S01' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01S01 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
