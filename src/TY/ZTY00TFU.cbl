      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY00TFU'.
      ...
      * Called module names
       01  MOD-ZTY01IJT              PIC X(8) VALUE 'ZTY01IJT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01IJT-001.
               CALL 'ZTY01IJT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01IJT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
