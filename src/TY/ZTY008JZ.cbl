      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY008JZ'.
      ...
      * Called module names
       01  MOD-ZEN0101R              PIC X(8) VALUE 'ZEN0101R'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN0101R-001.
               PERFORM CALL-ZTY00WZW-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN0101R-001.
               EXEC CICS LINK PROGRAM('ZEN0101R')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN0101R FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTY00WZW-002.
