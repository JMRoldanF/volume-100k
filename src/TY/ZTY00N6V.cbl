      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY00N6V'.
      ...
      * Called module names
       01  MOD-ZTY01FR8              PIC X(8) VALUE 'ZTY01FR8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01FR8-001.
               CALL 'ZTY01FR8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01FR8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
