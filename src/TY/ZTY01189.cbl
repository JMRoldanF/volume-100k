      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY01189'.
      ...
      * Called module names
       01  MOD-ZTY01EB0              PIC X(8) VALUE 'ZTY01EB0'.
       01  MOD-ZTY01N13              PIC X(8) VALUE 'ZTY01N13'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTY01EB0-001.
               PERFORM CALL-ZTY01N13-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01EB0-001.
               CALL 'ZTY01EB0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01EB0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTY01N13-002.
               CALL 'ZTY01N13' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
