      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY011NR'.
      ...
      * Called module names
       01  MOD-ZTY01S61              PIC X(8) VALUE 'ZTY01S61'.
       01  MOD-ZTY01IFD              PIC X(8) VALUE 'ZTY01IFD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTY01S61-001.
               PERFORM CALL-ZTY01IFD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01S61-001.
               CALL 'ZTY01S61' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01S61 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTY01IFD-002.
               CALL 'ZTY01IFD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01IFD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
