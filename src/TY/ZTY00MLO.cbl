      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY00MLO'.
      ...
      * Called module names
       01  MOD-ZTY01GLU              PIC X(8) VALUE 'ZTY01GLU'.
       01  MOD-ZTY01IMF              PIC X(8) VALUE 'ZTY01IMF'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTY01GLU-001.
               PERFORM CALL-ZTY01IMF-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01GLU-001.
               CALL 'ZTY01GLU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01GLU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTY01IMF-002.
               CALL 'ZTY01IMF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01IMF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
