      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY00QG8'.
      ...
      * Called module names
       01  MOD-ZTY01ONC              PIC X(8) VALUE 'ZTY01ONC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01ONC-001.
               CALL 'ZTY01ONC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01ONC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       EXPAND-COLOUR-0001.
