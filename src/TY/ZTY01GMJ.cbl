      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY01GMJ'.
      ...
      * Called module names
       01  MOD-ZTY01QXM              PIC X(8) VALUE 'ZTY01QXM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01QXM-001.
               CALL 'ZTY01QXM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01QXM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-TAX-BAND-0001.
