      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY00PI3'.
      ...
      * Called module names
       01  MOD-ZTY01LWR              PIC X(8) VALUE 'ZTY01LWR'.
       01  MOD-ZPN01EWX              PIC X(8) VALUE 'ZPN01EWX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTY01LWR-001.
               PERFORM CALL-ZPN01EWX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01LWR-001.
               CALL 'ZTY01LWR' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01LWR FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPN01EWX-002.
               CALL 'ZPN01EWX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01EWX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
