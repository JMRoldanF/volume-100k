      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY00XQX'.
      ...
      * Called module names
       01  MOD-ZEN01ILT              PIC X(8) VALUE 'ZEN01ILT'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM EXPAND-WITH-PROFITS-0112.
               PERFORM SQL-ACCESS-0114.
               PERFORM RECONCILE-HOUSE-TYPE-0115.
               PERFORM DERIVE-BEDROOMS-0116.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZEN01ILT-001.
               CALL 'ZEN01ILT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01ILT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
