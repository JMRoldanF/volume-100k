      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY00P3Q'.
      ...
      * Called module names
       01  MOD-ZTY01KPU              PIC X(8) VALUE 'ZTY01KPU'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01KPU-001.
               CALL 'ZTY01KPU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01KPU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
