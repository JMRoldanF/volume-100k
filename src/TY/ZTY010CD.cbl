      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY010CD'.
      ...
      * Called module names
       ...
       01  MOD-ZTY01GNM              PIC X(8) VALUE 'ZTY01GNM'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01GNM-002.
               CALL 'ZTY01GNM' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01GNM FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
