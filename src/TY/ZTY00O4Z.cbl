      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY00O4Z'.
      ...
      * Called module names
       01  MOD-ZTY01KLV              PIC X(8) VALUE 'ZTY01KLV'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01KLV-001.
               CALL 'ZTY01KLV' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01KLV FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
