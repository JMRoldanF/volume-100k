      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY00PUU'.
      ...
      * Called module names
       01  MOD-ZTY01KYS              PIC X(8) VALUE 'ZTY01KYS'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01KYS-001.
               CALL 'ZTY01KYS' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01KYS FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-002.
