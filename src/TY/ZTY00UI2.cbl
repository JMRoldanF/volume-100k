      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY00UI2'.
      ...
      * Called module names
       01  MOD-ZTY01ENP              PIC X(8) VALUE 'ZTY01ENP'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01ENP-001.
               CALL 'ZTY01ENP' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01ENP FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
