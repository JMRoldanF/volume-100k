      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY010QV'.
      ...
      * Called module names
       ...
       01  MOD-ZTY01FPX              PIC X(8) VALUE 'ZTY01FPX'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZEN01U8C-001.
               PERFORM CALL-ZTY01FPX-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01FPX-002.
               CALL 'ZTY01FPX' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01FPX FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
