      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY00O4R'.
      ...
      * Called module names
       01  MOD-ZTY01GG6              PIC X(8) VALUE 'ZTY01GG6'.
       01  MOD-ZTY01SG2              PIC X(8) VALUE 'ZTY01SG2'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01GG6-001.
               CALL 'ZTY01GG6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01GG6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTY01SG2-002.
               CALL 'ZTY01SG2' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01SG2 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
