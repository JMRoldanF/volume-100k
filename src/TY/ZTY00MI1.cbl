      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY00MI1'.
      ...
      * Called module names
       01  MOD-ZTY01I4P              PIC X(8) VALUE 'ZTY01I4P'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01I4P-001.
               CALL 'ZTY01I4P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01I4P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
