      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY00W50'.
      ...
      * Called module names
       01  MOD-ZTY01H8S              PIC X(8) VALUE 'ZTY01H8S'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01H8S-001.
               CALL 'ZTY01H8S' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01H8S FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-002.
