      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY00PX1'.
      ...
      * Called module names
       01  MOD-ZTY01EYF              PIC X(8) VALUE 'ZTY01EYF'.
       01  MOD-ZTY01MNE              PIC X(8) VALUE 'ZTY01MNE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTY01EYF-001.
               PERFORM CALL-ZTY01MNE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01EYF-001.
               CALL 'ZTY01EYF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01EYF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTY01MNE-002.
               CALL 'ZTY01MNE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01MNE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
