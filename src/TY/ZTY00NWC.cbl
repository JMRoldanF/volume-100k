      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY00NWC'.
      ...
      * Called module names
       01  MOD-ZPN01MZG              PIC X(8) VALUE 'ZPN01MZG'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPN01MZG-002.
               PERFORM EXPAND-MANAGED-FUND-0001.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZTY01R2F-001.
               MOVE 'ZTY01R2F' TO WS-SUBNAME-6
      ...
      *----------------------------------------------------------------*
       CALL-ZPN01MZG-002.
               CALL 'ZPN01MZG' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPN01MZG FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
