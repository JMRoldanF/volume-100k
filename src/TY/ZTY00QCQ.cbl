      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY00QCQ'.
      ...
      * Called module names
       01  MOD-ZTY01MVT              PIC X(8) VALUE 'ZTY01MVT'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01MVT-001.
               CALL 'ZTY01MVT' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01MVT FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-002.
