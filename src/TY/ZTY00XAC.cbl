      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY00XAC'.
      ...
      * Called module names
       ...
       01  MOD-ZTY01FJU              PIC X(8) VALUE 'ZTY01FJU'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTY01GMJ-001.
               PERFORM CALL-ZTY01FJU-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01FJU-002.
               CALL 'ZTY01FJU' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01FJU FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZBI0255Q-003.
