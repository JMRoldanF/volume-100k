      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY00QQY'.
      ...
      * Called module names
       01  MOD-ZTY01QJ6              PIC X(8) VALUE 'ZTY01QJ6'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01QJ6-001.
               CALL 'ZTY01QJ6' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01QJ6 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
