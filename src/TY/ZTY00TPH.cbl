      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY00TPH'.
      ...
      * Called module names
       01  MOD-ZTY01OW0              PIC X(8) VALUE 'ZTY01OW0'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01OW0-001.
               CALL 'ZTY01OW0' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01OW0 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       AUDIT-MAKE-0001.
