      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY00MSH'.
      ...
      * Called module names
       01  MOD-ZTY01Q3P              PIC X(8) VALUE 'ZTY01Q3P'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTY01Q3P-001.
               PERFORM CALL-ZTY01CQH-002.
               PERFORM AUDIT-SUM-ASSURED-0001.
               PERFORM AUDIT-STATUS-CODE-0002.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZTY01Q3P-001.
               CALL 'ZTY01Q3P' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01Q3P FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTY01CQH-002.
