      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY00SP0'.
      ...
      * Called module names
       01  MOD-ZTY01S79              PIC X(8) VALUE 'ZTY01S79'.
       01  MOD-ZTY01OHN              PIC X(8) VALUE 'ZTY01OHN'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTY01S79-001.
               PERFORM CALL-ZTY01OHN-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01S79-001.
               CALL 'ZTY01S79' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01S79 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTY01OHN-002.
               CALL 'ZTY01OHN' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
