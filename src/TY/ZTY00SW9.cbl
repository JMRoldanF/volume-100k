      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY00SW9'.
      ...
      * Called module names
       ...
       01  MOD-ZTY01JGE              PIC X(8) VALUE 'ZTY01JGE'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTY01T4E-001.
               PERFORM CALL-ZTY01JGE-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01JGE-002.
               CALL 'ZTY01JGE' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01JGE FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZRE0255R-003.
