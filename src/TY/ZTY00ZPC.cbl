      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY00ZPC'.
      ...
      * Called module names
       01  MOD-ZEN01T9Z              PIC X(8) VALUE 'ZEN01T9Z'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01T9Z-001.
               CALL 'ZEN01T9Z' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01T9Z FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-002.
