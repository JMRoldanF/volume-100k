      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY00UTY'.
      ...
      * Called module names
       01  MOD-ZTY01KBF              PIC X(8) VALUE 'ZTY01KBF'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01KBF-001.
               CALL 'ZTY01KBF' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01KBF FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
