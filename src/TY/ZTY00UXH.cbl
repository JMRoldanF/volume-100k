      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY00UXH'.
      ...
      * Called module names
       01  MOD-ZTY01PLL              PIC X(8) VALUE 'ZTY01PLL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTY01PLL-001.
               CALL 'ZTY01PLL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTY01PLL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       COMPUTE-EXCESS-0001.
