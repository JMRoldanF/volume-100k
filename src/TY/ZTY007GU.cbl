      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZTY007GU'.
      ...
      * Called module names
       ...
       01  MOD-ZEN01524              PIC X(8) VALUE 'ZEN01524'.
      ...
      *----------------------------------------------------------------*
       CALL-ZEN01524-002.
               EXEC CICS LINK PROGRAM('ZEN01524')
                         COMMAREA(DFHCOMMAREA)
                         LENGTH(WS-CALEN)
                         RESP(WS-RESP)
               END-EXEC.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZEN01524 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTY01KYS-003.
