      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPT010YF'.
      ...
      * Called module names
       01  MOD-ZPT01KUY              PIC X(8) VALUE 'ZPT01KUY'.
       01  MOD-ZPT01Q94              PIC X(8) VALUE 'ZPT01Q94'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPT01KUY-001.
               PERFORM CALL-ZPT01Q94-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPT01KUY-001.
               CALL 'ZPT01KUY' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01KUY FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPT01Q94-002.
               CALL 'ZPT01Q94' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01Q94 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-VALUE-0001.
