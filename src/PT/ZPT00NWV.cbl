      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPT00NWV'.
      ...
      * Called module names
       01  MOD-ZPT01K76              PIC X(8) VALUE 'ZPT01K76'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPT01K76-001.
               CALL 'ZPT01K76' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01K76 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCR01M1E-002.
