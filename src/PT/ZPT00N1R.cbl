      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPT00N1R'.
      ...
      * Called module names
       01  MOD-ZPT01ETC              PIC X(8) VALUE 'ZPT01ETC'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPT01ETC-001.
               CALL 'ZPT01ETC' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01ETC FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
