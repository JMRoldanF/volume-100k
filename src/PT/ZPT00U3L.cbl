      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPT00U3L'.
      ...
      * Called module names
       01  MOD-ZPT01N8U              PIC X(8) VALUE 'ZPT01N8U'.
       01  MOD-ZPT01LC1              PIC X(8) VALUE 'ZPT01LC1'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPT01N8U-001.
               PERFORM CALL-ZPT01LC1-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPT01N8U-001.
               CALL 'ZPT01N8U' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01N8U FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPT01LC1-002.
               CALL 'ZPT01LC1' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01LC1 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
