      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPT00QI8'.
      ...
      * Called module names
       01  MOD-ZPT01FL8              PIC X(8) VALUE 'ZPT01FL8'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPT01FL8-001.
               CALL 'ZPT01FL8' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01FL8 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
