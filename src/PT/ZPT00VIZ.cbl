      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPT00VIZ'.
      ...
      * Called module names
       ...
       01  MOD-ZPT01DTI              PIC X(8) VALUE 'ZPT01DTI'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPT01L0S-001.
               PERFORM CALL-ZPT01DTI-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPT01DTI-002.
               CALL 'ZPT01DTI' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01DTI FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       DERIVE-MODEL-0001.
