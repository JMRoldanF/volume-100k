      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPT00ZG4'.
      ...
      * Called module names
       01  MOD-ZPT01LBL              PIC X(8) VALUE 'ZPT01LBL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPT01LBL-001.
               CALL 'ZPT01LBL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01LBL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
