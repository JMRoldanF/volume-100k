      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPT010LE'.
      ...
      * Called module names
       01  MOD-ZPT01NMB              PIC X(8) VALUE 'ZPT01NMB'.
       01  MOD-ZPT01PZD              PIC X(8) VALUE 'ZPT01PZD'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPT01NMB-001.
               PERFORM CALL-ZPT01PZD-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPT01NMB-001.
               CALL 'ZPT01NMB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01NMB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPT01PZD-002.
               CALL 'ZPT01PZD' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01PZD FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZHO0255M-003.
