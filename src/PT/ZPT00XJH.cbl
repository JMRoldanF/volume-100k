      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPT00XJH'.
      ...
      * Called module names
       01  MOD-ZPT01NBL              PIC X(8) VALUE 'ZPT01NBL'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPT01NBL-001.
               CALL 'ZPT01NBL' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01NBL FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CHECK-TERM-0001.
