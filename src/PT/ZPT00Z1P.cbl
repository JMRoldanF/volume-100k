      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPT00Z1P'.
      ...
      * Called module names
       01  MOD-ZPT01KN9              PIC X(8) VALUE 'ZPT01KN9'.
       01  MOD-ZPT01L7L              PIC X(8) VALUE 'ZPT01L7L'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPT01KN9-001.
               PERFORM CALL-ZPT01L7L-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPT01KN9-001.
               CALL 'ZPT01KN9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01KN9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPT01L7L-002.
               CALL 'ZPT01L7L' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01L7L FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCU0255O-003.
