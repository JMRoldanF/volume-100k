      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPT00VTJ'.
      ...
      * Called module names
       ...
       01  MOD-ZCR01K8M              PIC X(8) VALUE 'ZCR01K8M'.
      ...
      *----------------------------------------------------------------*
       CALL-ZCR01K8M-002.
               CALL 'ZCR01K8M' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZCR01K8M FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-003.
