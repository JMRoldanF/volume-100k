      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPT011SP'.
      ...
      * Called module names
       ...
       01  MOD-ZPT01LM9              PIC X(8) VALUE 'ZPT01LM9'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZTR01DEQ-001.
               PERFORM CALL-ZPT01LM9-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPT01LM9-002.
               CALL 'ZPT01LM9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01LM9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
