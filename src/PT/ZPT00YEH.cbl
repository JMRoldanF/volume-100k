      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPT00YEH'.
      ...
      * Called module names
       01  MOD-ZPT01MGJ              PIC X(8) VALUE 'ZPT01MGJ'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPT01MGJ-002.
               PERFORM CALL-ZMT0255L-003.
               EXEC CICS RETURN END-EXEC.
      *----------------------------------------------------------------*
       CALL-ZAN01EHZ-001.
               MOVE 'ZAN01EHZ' TO WS-SUBNAME-6
      ...
      *----------------------------------------------------------------*
       CALL-ZPT01MGJ-002.
               CALL 'ZPT01MGJ' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01MGJ FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMT0255L-003.
