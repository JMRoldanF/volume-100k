      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPT00XB5'.
      ...
      * Called module names
       ...
       01  MOD-ZPT01G1Y              PIC X(8) VALUE 'ZPT01G1Y'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPT01G8Q-001.
               PERFORM CALL-ZPT01G1Y-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPT01G1Y-002.
               CALL 'ZPT01G1Y' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01G1Y FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZEN0255N-003.
