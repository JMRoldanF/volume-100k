      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPT00RNG'.
      ...
      * Called module names
       01  MOD-ZPT01QNB              PIC X(8) VALUE 'ZPT01QNB'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPT01QNB-001.
               CALL 'ZPT01QNB' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01QNB FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
