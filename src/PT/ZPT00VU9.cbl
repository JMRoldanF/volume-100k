      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPT00VU9'.
      ...
      * Called module names
       01  MOD-ZPT01GIW              PIC X(8) VALUE 'ZPT01GIW'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPT01GIW-001.
               PERFORM CALL-ZMB01D74-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPT01GIW-001.
               CALL 'ZPT01GIW' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01GIW FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZMB01D74-002.
               MOVE 'ZMB01D74' TO WS-SUBNAME-7
