      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPT00W3A'.
      ...
      * Called module names
       01  MOD-ZAN01E5A              PIC X(8) VALUE 'ZAN01E5A'.
      ...
      *----------------------------------------------------------------*
       CALL-ZAN01E5A-001.
               CALL 'ZAN01E5A' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZAN01E5A FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZTR01NEN-002.
               MOVE 'ZTR01NEN' TO WS-SUBNAME-3
