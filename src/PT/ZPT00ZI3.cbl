      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPT00ZI3'.
      ...
      * Called module names
       01  MOD-ZTR01ST9              PIC X(8) VALUE 'ZTR01ST9'.
      ...
      *----------------------------------------------------------------*
       CALL-ZTR01ST9-001.
               CALL 'ZTR01ST9' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZTR01ST9 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
