      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPT00RO1'.
      ...
      * Called module names
       01  MOD-ZPT01S4X              PIC X(8) VALUE 'ZPT01S4X'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPT01S4X-001.
               CALL 'ZPT01S4X' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01S4X FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZPT01GGW-002.
