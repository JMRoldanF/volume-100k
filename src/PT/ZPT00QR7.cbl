      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPT00QR7'.
      ...
      * Called module names
       01  MOD-ZPT01RYO              PIC X(8) VALUE 'ZPT01RYO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPT01RYO-001.
               CALL 'ZPT01RYO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01RYO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZCL0255P-002.
