      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPT00VJB'.
      ...
      * Called module names
       01  MOD-ZPT01G63              PIC X(8) VALUE 'ZPT01G63'.
      ...
      *----------------------------------------------------------------*
       CALL-ZPT01G63-002.
               CALL 'ZPT01G63' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01G63 FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       FORMAT-EXCESS-0001.
