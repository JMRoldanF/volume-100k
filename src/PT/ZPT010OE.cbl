      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPT010OE'.
      ...
      * Called module names
       01  MOD-ZPT01F9H              PIC X(8) VALUE 'ZPT01F9H'.
      ...
      *----------------------------------------------------------------*
       MAINLINE SECTION.
               ...
               PERFORM CALL-ZPT01F9H-001.
               PERFORM CALL-ZAN01TIY-002.
      ...
      *----------------------------------------------------------------*
       CALL-ZPT01F9H-001.
               CALL 'ZPT01F9H' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZPT01F9H FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
       CALL-ZAN01TIY-002.
