      ...
      * Error message structure
       01  ERROR-MSG.
             ...
             03 FILLER                 PIC X(9)  VALUE ' ZPT00WYC'.
      ...
      * Called module names
       ...
       01  MOD-ZMB01RKO              PIC X(8) VALUE 'ZMB01RKO'.
      ...
      *----------------------------------------------------------------*
       CALL-ZMB01RKO-002.
               CALL 'ZMB01RKO' USING DFHCOMMAREA
                         WS-STATUS-CODE.
               IF WS-RESP NOT = DFHRESP(NORMAL)
                  MOVE ' LINK ZMB01RKO FAILED' TO EM-VARIABLE
                  PERFORM WRITE-ERROR-MESSAGE
               END-IF.
      *----------------------------------------------------------------*
